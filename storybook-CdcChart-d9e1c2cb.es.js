...
import { _ as Kr, P as _y, D as Ny, C as Oy, A as Fy, d as bi, F as tp, g as My } from "./storybook-Filters-731a7a2c.es.js";
import { L as Ud, a as zy } from "./storybook-coveUpdateWorker-efd75fb0.es.js";
...
import { t as Gy, a as wn, b as Ef, L as cp, c as ql, g as Ei, f as Ih, S as dp, M as wd, D as Zy } from "./storybook-DataTable-339952a4.es.js";
...
import { a as st } from "./storybook-Icon-b09f76c0.es.js";
import { a as Pn, b as Rn, c as Dn, d as _n, A as Pi, D as lg } from "./storybook-DataTransform-1390427f.es.js";
import { C as sg, V as ug, a as yp } from "./storybook-footnoteSymbols-def02d7f.es.js";
import { S as Ct, T as et, C as lt, D as cg } from "./storybook-DataTableEditor-9b82b900.es.js";
...
import { A as gu } from "./storybook-Accordion-dbc41a5b.es.js";
...
function Jh(e, t, n, a, i, l, d, f, u, m) {
  var y = rg(), x = y.invert, S = y.domain, R = m(".%L"), T = m(":%S"), F = m("%I:%M"), k = m("%I %p"), h = m("%a %d"), L = m("%b %d"), O = m("%B"), C = m("%Y");
  function N(_) {
    return (u(_) < _ ? R : f(_) < _ ? T : d(_) < _ ? F : l(_) < _ ? k : a(_) < _ ? i(_) < _ ? h : L : n(_) < _ ? O : C)(_);
  }
...
function cm(e) {
  ...
  return (0, Mo.useEffect)(function() {
    ...
    return S.current && L.observe(S.current), function() {
      window.cancelAnimationFrame(R.current), L.disconnect(), h != null && h.cancel && h.cancel();
    };
...
function Dv(e) {
  var t = e.dateTime, n = e.date, a = e.time, i = e.periods, l = e.days, d = e.shortDays, f = e.months, u = e.shortMonths, m = Ql(i), y = Jl(i), x = Ql(l), S = Jl(l), R = Ql(d), T = Jl(d), F = Ql(f), k = Jl(f), h = Ql(u), L = Jl(u), O = {
    a: te,
    A: se,
    b: G,
    B: Q,
  ...
  function V(Ae, me, Fe) {
    ...
    return ue ? (Ae.m = L.get(ue[0].toLowerCase()), Fe + ue[0].length) : -1;
  }
  function Y(Ae, me, Fe) {
...
class Gx {
  ...
  diff(t) {
    ...
    if (this.animations = Object.entries(this.merged).reduce((F, k) => {
      let h = k[0], L = k[1], O = F[h] || {};
      const C = Wt.num(L), N = Wt.str(L) && !L.startsWith("#") && !/\d/.test(L) && !Tm[L], _ = Wt.arr(L), B = !C && !_ && !N;
      let q = Wt.und(i[h]) ? L : i[h], U = C || _ || N ? L : 1, ne = Rr(u, h);
      T && (U = T.animations[h].parent);
      let re = O.parent, V = O.interpolation, Y = Wo(T ? U.getPayload() : U), J, Z = L;
      B && (Z = Yu({
        range: [0, 1],
        output: [L, L]
      })(1));
      ...
      if (x || Q && G || K) {
        ...
        }), Rr(S, h) && re.setValue(B ? U : L, !1), fn({}, F, {
          [h]: fn({}, O, {
            name: h,
            parent: re,
            interpolation: V,
...
function Jx(e, t, n) {
  ...
  return ce.useImperativeHandle(a.ref, () => ({
    ...
    stop: (L) => Array.from(h.current.instances).forEach((O) => O[1].stop(L)),
    get controllers() {
      return Array.from(h.current.instances).map((L) => L[1]);
    }
  })), h.current = eb(h.current, a), h.current.changed && h.current.transitions.forEach((L) => {
    const O = L.slot, C = L.from, N = L.to, _ = L.config, B = L.trail, q = L.key, U = L.item;
    ...
    const ne = h.current.instances.get(q), re = fn({}, T, {
      ...
      ref: R,
      onRest: (V) => {
        h.current.mounted && (L.destroyed && (!R && !d && Kp(h, q), m && m(U)), !Array.from(h.current.instances).some((Z) => !Z[1].idle) && (R || d) && h.current.deleted.length > 0 && Kp(h), x && x(U, O, V));
      },
      onStart: S && (() => S(U, O)),
      onFrame: y && ((V) => y(U, O, V)),
      delay: B,
...
function eb(e, t) {
  let n = e.first, a = e.prevProps, i = Kr(e, ["first", "prevProps"]), l = Zd(t), d = l.items, f = l.keys, u = l.initial, m = l.from, y = l.enter, x = l.leave, S = l.update, R = l.trail, T = R === void 0 ? 0 : R, F = l.unique, k = l.config, h = l.order, L = h === void 0 ? [Fu, Nd, Od] : h, O = Zd(a), C = O.keys, N = O.items, _ = fn({}, i.current), B = [...i.deleted], q = Object.keys(_), U = new Set(q), ne = new Set(f), re = f.filter((ae) => !U.has(ae)), V = i.transitions.filter((ae) => !ae.destroyed && !ne.has(ae.originalKey)).map((ae) => ae.originalKey), Y = f.filter((ae) => U.has(ae)), J = -T;
  for (; L.length; )
    switch (L.shift()) {
      case Fu: {
        re.forEach((te, se) => {
...
function ku(e, t, n, a, i, l, d) {
  var f = e - n, u = t - a, m = (d ? l : -l) / $o(f * f + u * u), y = m * u, x = -m * f, S = e + y, R = t + x, T = n + y, F = a + x, k = (S + T) / 2, h = (R + F) / 2, L = T - S, O = F - R, C = L * L + O * O, N = i - l, _ = S * F - T * R, B = (O < 0 ? -1 : 1) * $o(Vy(0, N * N * C - _ * _)), q = (_ * O - L * B) / C, U = (-_ * L - O * B) / C, ne = (_ * O + L * B) / C, re = (-_ * L + O * B) / C, V = q - k, Y = U - h, J = ne - k, Z = re - h;
...
function Tb() {
  ...
  function u() {
    ...
    if (f || (f = m = yc()), S < x && (y = S, S = x, x = y), !(S > Zn))
      ...
      var h = R, L = T, O = R, C = T, N = F, _ = F, B = d.apply(this, arguments) / 2, q = B > Zn && (a ? +a.apply(this, arguments) : $o(x * x + S * S)), U = kd(ip(S - x) / 2, +n.apply(this, arguments)), ne = U, re = U, V, Y;
      if (q > Zn) {
        var J = op(q / x * Hr(B)), Z = op(q / S * Hr(B));
        (N -= J * 2) > Zn ? (J *= k ? 1 : -1, O += J, C -= J) : (N = 0, O = C = (R + T) / 2), (_ -= Z * 2) > Zn ? (Z *= k ? 1 : -1, h += Z, L -= Z) : (_ = 0, h = L = (R + T) / 2);
      }
      var ae = S * Si(h), te = S * Hr(h), se = x * Si(C), G = x * Hr(C);
      if (U > Zn) {
        var Q = S * Si(L), K = S * Hr(L), W = x * Si(O), Ce = x * Hr(O), xe;
...
function Cb() {
  ...
  function u(y) {
    var x, S, R, T = y.length, F, k = !1, h, L = new Array(T), O = new Array(T);
    for (l == null && (f = d(h = yc())), x = 0; x <= T; ++x) {
      ...
      k && (L[x] = +e(F, x, y), O[x] = +n(F, x, y), f.point(t ? +t(F, x, y) : L[x], a ? +a(F, x, y) : O[x]));
    }
    if (h)
...
function Pb() {
  ...
  function d(f) {
    var u, m = f.length, y, x, S = 0, R = new Array(m), T = new Array(m), F = +a.apply(this, arguments), k = Math.min(Nu, Math.max(-Nu, i.apply(this, arguments) - F)), h, L = Math.min(Math.abs(k) / m, l.apply(this, arguments)), O = L * (k < 0 ? -1 : 1), C;
    for (u = 0; u < m; ++u)
...
function d0(e) {
  var t = e.className, n = e.top, a = e.left, i = e.data, l = i === void 0 ? [] : i, d = e.centroid, f = e.innerRadius, u = f === void 0 ? 0 : f, m = e.outerRadius, y = e.cornerRadius, x = e.startAngle, S = e.endAngle, R = e.padAngle, T = e.padRadius, F = e.pieSort, k = e.pieSortValues, h = e.pieValue, L = e.children, O = e.fill, C = O === void 0 ? "" : O, N = c0(e, u0), _ = o0({
    innerRadius: u,
    outerRadius: m,
    cornerRadius: y,
    padRadius: T
...
function w0(e) {
  var t = e.className, n = e.top, a = e.left, i = e.keys, l = e.data, d = e.curve, f = e.defined, u = e.x, m = e.x0, y = e.x1, x = e.y0, S = e.y1, R = e.value, T = e.order, F = e.offset, k = e.color, h = e.children, L = k0(e, E0), O = s0({
    keys: i,
    value: R,
    order: T,
    offset: F
...
function A0(e) {
  var t = e.className, n = e.top, a = e.left, i = e.keys, l = e.data, d = e.curve, f = e.defined, u = e.x, m = e.x0, y = e.x1, x = e.y0, S = e.y1, R = e.value, T = e.order, F = e.offset, k = e.color, h = e.children, L = C0(e, T0);
...
function _0(e) {
  var t = e.data, n = e.className, a = e.top, i = e.left, l = e.x, d = e.y0, f = d === void 0 ? Ym : d, u = e.y1, m = u === void 0 ? Xm : u, y = e.xScale, x = e.yScale, S = e.color, R = e.keys, T = e.value, F = e.order, k = e.offset, h = e.children, L = D0(e, R0), O = zf();
...
function F0(e) {
  var t = e.data, n = e.className, a = e.top, i = e.left, l = e.y, d = e.x0, f = d === void 0 ? Ym : d, u = e.x1, m = u === void 0 ? Xm : u, y = e.xScale, x = e.yScale, S = e.color, R = e.keys, T = e.value, F = e.order, k = e.offset, h = e.children, L = O0(e, N0), O = zf();
  R && O.keys(R), T && bn(O.value, T), F && O.order(If(F)), k && O.offset($f(k));
  ...
  try {
    ...
    if (i === "x" || i === "y")
      for (var x = n.map(function(Y) {
        ...
        for (var L = f.getPointAtLength(h), O = L[i]; k < m - 1 && F[k + 1](O); )
          k += 1;
        y[k].push(L);
      }
    else {
...
function Jm(e) {
  var t = e.children;
  e.getRects;
  var n = e.left, a = n === void 0 ? 0 : n, i = e.offsetLeft, l = i === void 0 ? 10 : i, d = e.offsetTop, f = d === void 0 ? 10 : d, u = e.parentRect, m = e.rect, y = e.style, x = y === void 0 ? Zm : y, S = e.top, R = S === void 0 ? 0 : S, T = e.unstyled, F = T === void 0 ? !1 : T, k = e.nodeRef, h = Z0(e, G0), L, O = !1, C = !1;
  if (m && u) {
    var N = a, _ = R;
    if (u.width) {
    ...
    N = O ? N - m.width - l : N + l, _ = C ? _ - m.height - f : _ + f, N = Math.round(N), _ = Math.round(_), L = "translate(" + N + "px, " + _ + "px)";
  }
...
const ey = X0(Jm), ty = (e) => {
  const { tableData: t, config: n, formatNumber: a, capitalize: i, formatDate: l, formatTooltipsDate: d, parseDate: f, setSharedFilter: u, isDraggingAnnotation: m } = ce.useContext(Et), { xScale: y, yScale: x, showTooltip: S, hideTooltip: R } = e, { xAxis: T, visualizationType: F, orientation: k, yAxis: h, runtime: L } = n, O = (te, se) => {
    var Ce;
    ...
    var xe;
    const K = G.general.showMissingDataLabel && (!se || se === "null");
    ...
    try {
      ...
      if ((te = n.series) == null || te.forEach((K) => {
        ...
        switch (F) {
          case "Combo":
            se = [L.xAxis.dataKey, ...L == null ? void 0 : L.seriesKeys, ...Q];
            break;
          case "Forecasting":
            se = [L.xAxis.dataKey, ...G, ...Q];
            break;
          case "Line":
            se = [L.xAxis.dataKey, ...L == null ? void 0 : L.seriesKeys];
            break;
          case "Area Chart":
            se = [L.xAxis.dataKey, ...L == null ? void 0 : L.seriesKeys];
            break;
          case "Bar":
            se = k === "vertical" ? [L.xAxis.dataKey, ...L == null ? void 0 : L.seriesKeys] : [L.yAxis.dataKey, ...L == null ? void 0 : L.seriesKeys];
            break;
          case "Pie":
            se = [L.xAxis.dataKey, ...L == null ? void 0 : L.seriesKeys];
          default:
      ...
      return n.dashboard && (se = [L.xAxis.dataKey, ...L == null ? void 0 : L.barSeriesKeys, ...L == null ? void 0 : L.lineSeriesKeys, ...G, ...Q]), se;
    } catch (se) {
...
const uy = (e, t, n, a) => (i) => {
  ...
  if (l === "Deviation Bar") {
    const [h, L] = hs[e.twoColor.palette], O = {
      datum: "X",
      index: 0,
  ...
  if (l === "Bar" && d === "regular" && y && (f == null ? void 0 : f.length) === 1) {
    ...
    t.forEach((C) => L.add(C[y]));
    const O = Array.from(L).map((C, N) => ({
      datum: C,
      index: N,
      text: C,
      value: h[N]
  ...
  if (((R = u == null ? void 0 : u.forecastingSeriesKeys) == null ? void 0 : R.length) > 0) {
    let h = [];
    return (F = (T = e.runtime) == null ? void 0 : T.forecastingSeriesKeys) == null || F.map((L, O) => {
      var C;
      return (C = L == null ? void 0 : L.stages) == null ? void 0 : C.map((N, _) => {
        var U, ne, re, V;
...
const gS = function(e) {
  return e === void 0 && (e = {}), { name: "flip", options: e, async fn(t) {
    var n;
    const { placement: a, middlewareData: i, rects: l, initialPlacement: d, platform: f, elements: u } = t, { mainAxis: m = !0, crossAxis: y = !0, fallbackPlacements: x, fallbackStrategy: S = "bestFit", fallbackAxisSideDirection: R = "none", flipAlignment: T = !0, ...F } = e, k = Ni(a), h = Ni(d) === d, L = await (f.isRTL == null ? void 0 : f.isRTL(u.floating)), O = x || (h || !T ? [lc(d)] : function(re) {
      const V = lc(re);
      return [Id(re), V, Id(V)];
    }(d));
    ...
    if (m && _.push(N[k]), y) {
      const { main: re, cross: V } = mS(a, l, L);
      _.push(N[re], N[V]);
    }
  ...
  return e === void 0 && (e = 0), { name: "offset", options: e, async fn(t) {
    const { x: n, y: a } = t, i = await async function(l, d) {
      ...
      let { mainAxis: h, crossAxis: L, alignmentAxis: O } = typeof k == "number" ? { mainAxis: k, crossAxis: 0, alignmentAxis: null } : { mainAxis: 0, crossAxis: 0, alignmentAxis: null, ...k };
      return S && typeof O == "number" && (L = S === "end" ? -1 * O : O), R ? { x: L * F, y: h * T } : { x: h * T, y: L * F };
    }(t, e);
...
function xs(e, t, n, a) {
  ...
  if (f) {
    ...
    for (; h && a && k !== F; ) {
      const L = jo(h), O = h.getBoundingClientRect(), C = getComputedStyle(h);
      O.x += (h.clientLeft + parseFloat(C.paddingLeft)) * L.x, O.y += (h.clientTop + parseFloat(C.paddingTop)) * L.y, x *= L.x, S *= L.y, R *= L.x, T *= L.y, x += O.x, S += O.y, h = Er(h).frameElement;
    }
  }
...
const ES = { getClippingRect: function(e) {
  ...
  const l = n === "clippingAncestors" ? function(m, y) {
    ...
    for (; Oa(F) && !Kf(F); ) {
      const k = Yr(F), h = vf(F);
      (T ? h || R : h || k.position !== "static" || !R || !["absolute", "fixed"].includes(R.position)) ? R = k : S = S.filter((L) => L !== F), F = bs(F);
    }
    return y.set(m, S), S;
  ...
  return (async (d, f, u) => {
    ...
    let F = await S.getElementRects({ reference: d, floating: f, strategy: y }), { x: k, y: h } = uh(F, m, T), L = m, O = {}, C = 0;
    for (let N = 0; N < R.length; N++) {
      const { name: _, fn: B } = R[N], { x: q, y: U, data: ne, reset: re } = await B({ x: k, y: h, initialPlacement: m, placement: L, strategy: y, middlewareData: O, rects: F, platform: S, elements: { reference: d, floating: f } });
      k = q ?? k, h = U ?? h, O = { ...O, [_]: { ...O[_], ...ne } }, C > 50 && console.warn(["Floating UI: The middleware lifecycle appears to be running in an", "infinite loop. This is usually caused by a `reset` continually", "being returned without a break condition."].join(" ")), re && C <= 50 && (C++, typeof re == "object" && (re.placement && (L = re.placement), re.rects && (F = re.rects === !0 ? await S.getElementRects({ reference: d, floating: f, strategy: y }) : re.rects), { x: k, y: h } = uh(F, L, T)), N = -1);
    }
    return { x: k, y: h, placement: L, strategy: y, middlewareData: O };
  })(e, t, { ...i, platform: l });
};
...
const xh = async ({ elementReference: e = null, tooltipReference: t = null, tooltipArrowReference: n = null, place: a = "top", offset: i = 10, strategy: l = "absolute", middlewares: d = [vS(Number(i)), gS(), xS({ padding: 5 })] }) => {
  ...
  return n ? (f.push({ name: "arrow", options: u = { element: n, padding: 5 }, async fn(m) {
    ...
    const h = cy(x), L = { x: S, y: R }, O = ks(T), C = Uf(O), N = await k.getDimensions(y), _ = O === "y" ? "top" : "left", B = O === "y" ? "bottom" : "right", q = F.reference[C] + F.reference[O] - L[O] - F.floating[C], U = L[O] - F.reference[O], ne = await (k.getOffsetParent == null ? void 0 : k.getOffsetParent(y));
    ...
    return { [O]: L[O] - (te ? Z < Y ? Y - Z : J - Z : 0), data: { [O]: ae, centerOffset: Z - ae } };
...
const bh = ({ id: e, className: t, classNameArrow: n, variant: a = "dark", anchorId: i, anchorSelect: l, place: d = "top", offset: f = 10, events: u = ["hover"], positionStrategy: m = "absolute", middlewares: y, wrapper: x, children: S = null, delayShow: R = 0, delayHide: T = 0, float: F = !1, noArrow: k = !1, clickable: h = !1, closeOnEsc: L = !1, style: O, position: C, afterShow: N, afterHide: _, content: B, html: q, isOpen: U, setIsOpen: ne, activeAnchor: re, setActiveAnchor: V }) => {
  ...
  ce.useEffect(() => {
    ...
    yt && bt.add({ current: yt }), L && window.addEventListener("keydown", Ve);
    const _t = [];
    u.find((Kt) => Kt === "click") && (window.addEventListener("click", tt), _t.push({ event: "click", listener: mt })), u.find((Kt) => Kt === "hover") && (_t.push({ event: "mouseenter", listener: _e }, { event: "mouseleave", listener: we }, { event: "focus", listener: _e }, { event: "blur", listener: we }), F && _t.push({ event: "mousemove", listener: Qe }));
    const an = () => {
      Ae.current = !0;
    }, on = () => {
      Ae.current = !1, Ie();
    };
    return h && ((Ge = Y.current) === null || Ge === void 0 || Ge.addEventListener("mouseenter", an), (dt = Y.current) === null || dt === void 0 || dt.addEventListener("mouseleave", on)), _t.forEach(({ event: Kt, listener: Jt }) => {
      bt.forEach((Yt) => {
        var At;
      ...
      var Kt, Jt;
      u.find((Yt) => Yt === "click") && window.removeEventListener("click", tt), L && window.removeEventListener("keydown", Ve), h && ((Kt = Y.current) === null || Kt === void 0 || Kt.removeEventListener("mouseenter", an), (Jt = Y.current) === null || Jt === void 0 || Jt.removeEventListener("mouseleave", on)), _t.forEach(({ event: Yt, listener: At }) => {
        bt.forEach((zt) => {
          var Vt;
          (Vt = zt.current) === null || Vt === void 0 || Vt.removeEventListener(Yt, At);
        });
      });
    };
  }, [Ce, je, me, L, u]), ce.useEffect(() => {
    let Ge = l ?? "";
...
}, ky = ({ id: e, anchorId: t, anchorSelect: n, content: a, html: i, className: l, classNameArrow: d, variant: f = "dark", place: u = "top", offset: m = 10, wrapper: y = "div", children: x = null, events: S = ["hover"], positionStrategy: R = "absolute", middlewares: T, delayShow: F = 0, delayHide: k = 0, float: h = !1, noArrow: L = !1, clickable: O = !1, closeOnEsc: C = !1, style: N, position: _, isOpen: B, setIsOpen: q, afterShow: U, afterHide: ne }) => {
  ...
  const mt = { id: e, anchorId: t, anchorSelect: n, className: l, classNameArrow: d, content: re, html: Y, place: Z, variant: te, offset: G, wrapper: je, events: Ae, positionStrategy: Fe, middlewares: T, delayShow: K, delayHide: Ce, float: fe, noArrow: L, clickable: O, closeOnEsc: C, style: N, position: _, isOpen: B, setIsOpen: q, afterShow: U, afterHide: ne, activeAnchor: de, setActiveAnchor: (tt) => Le(tt) };
...
function _S() {
  ...
  function T() {
    ...
    return F(Z), k(Z), h(Z), L(Z), N(Z), Th(Z), Z;
  }
  T.update = function(Z) {
    return Th(Z), Z;
  }, T.nodeId = function(Z) {
...
`), ve;
  ...
  var Jt = Math.clz32 ? Math.clz32 : zt, Yt = Math.log, At = Math.LN2;
  function zt(g) {
  ...
  var $e = typeof Object.is == "function" ? Object.is : Vt, en = null, wt = null, $t = null, pt = null, tn = !1, xn = !1, Ft = 0, nn = null, Ln = 0;
  function Xt() {
    if (en === null)
      throw Error(t(321));
    return en;
  ...
  function Tn() {
    return pt === null ? $t === null ? (tn = !1, $t = pt = jt()) : (tn = !0, pt = $t) : pt.next === null ? (tn = !1, pt = pt.next = jt()) : (tn = !0, pt = pt.next), pt;
  }
  function Hn() {
    wt = en = null, xn = !1, $t = null, Ln = 0, pt = nn = null;
  }
  function Mn(g, A) {
  ...
  function Wn(g, A) {
    if (en = Xt(), pt = Tn(), A = A === void 0 ? null : A, pt !== null) {
    ...
    if (typeof z == "function")
      if (z.prototype && z.prototype.isReactComponent) {
        ...
        if (typeof be == "object" && be !== null && typeof be.render == "function" && be.$$typeof === void 0)
          ...
          j = A.treeContext, A.treeContext = Kt(j, 1, 0);
          try {
            Ke(g, A, be);
          } finally {
            A.treeContext = j;
      ...
      switch (be = A.blockedSegment, ve = Y(be.chunks, z, j, g.responseState, be.formatContext), be.lastPushedText = !1, De = be.formatContext, be.formatContext = O(De, z, j), It(g, A, ve), be.formatContext = De, z) {
        case "area":
        case "base":
        case "br":
        case "col":
          ...
          if (ot.status === 0) {
            ...
            try {
              ...
              if (Hn(), typeof vt == "object" && vt !== null && typeof vt.then == "function") {
                ...
                if (oe === null ? He(Ue, le) : (oe.pendingTasks--, oe.forceClientRender || (oe.forceClientRender = !0, oe.errorDigest = ye, oe.parentFlushed && Ue.clientRenderedBoundaries.push(oe))), Ue.allPendingTasks--, Ue.allPendingTasks === 0) {
...
function zS() {
  ...
  var e = ce;
  function t(v) {
    for (var P = "https://reactjs.org/docs/error-decoder.html?invariant=" + v, I = 1; I < arguments.length; I++)
      P += "&args[]=" + encodeURIComponent(arguments[I]);
  ...
  function i(v, P) {
    if (P.length !== 0)
      if (512 < P.length)
        0 < a && (v.enqueue(new Uint8Array(n.buffer, 0, a)), n = new Uint8Array(512), a = 0), v.enqueue(P);
      else {
        var I = n.length - a;
        I < P.length && (I === 0 ? v.enqueue(n) : (n.set(P.subarray(0, I), a), v.enqueue(n), P = P.subarray(I)), n = new Uint8Array(512), a = 0), n.set(P, a), a += P.length;
      }
  }
  function l(v, P) {
    return i(v, P), !0;
  ...
  function y(v, P) {
    typeof v.error == "function" ? v.error(P) : v.close();
  }
  ...
  function k(v, P, I, X, Ee, Se, ze) {
    this.acceptsBooleans = P === 2 || P === 3 || P === 4, this.attributeName = X, this.attributeNamespace = Ee, this.mustUseProperty = I, this.propertyName = v, this.type = P, this.sanitizeURL = Se, this.removeEmptyString = ze;
  }
  var h = {};
  ...
  Object.keys(C).forEach(function(v) {
    N.forEach(function(P) {
      P = P + v.charAt(0).toUpperCase() + v.substring(1), C[P] = C[v];
    });
  });
  var _ = /["'&<>]/;
  function B(v) {
    ...
    if (P) {
      ...
      for (X = P.index; X < v.length; X++) {
        ...
        Ee !== X && (I += v.substring(Ee, X)), Ee = X + 1, I += P;
      }
  ...
  function se(v, P, I, X, Ee) {
    v = v === void 0 ? "" : v, P = P === void 0 ? re : m('<script nonce="' + B(P) + '">');
    var Se = [];
    if (I !== void 0 && Se.push(P, u(("" + I).replace(ae, te)), V), X !== void 0)
      for (I = 0; I < X.length; I++)
        Se.push(Y, u(B(X[I])), Z);
    if (Ee !== void 0)
      for (X = 0; X < Ee.length; X++)
        Se.push(J, u(B(Ee[X])), Z);
    return { bootstrapChunks: Se, startInlineScript: P, placeholderPrefix: m(v + "P:"), segmentPrefix: m(v + "S:"), boundaryPrefix: v + "B:", idPrefix: v, nextSuspenseID: 0, sentCompleteSegmentFunction: !1, sentCompleteBoundaryFunction: !1, sentClientRenderFunction: !1 };
  }
  function G(v, P) {
  ...
  var W = m("<!-- -->");
  function Ce(v, P, I, X) {
    return P === "" ? X : (X && v.push(W), v.push(u(B(P))), !0);
  }
    ...
    for (var X in I)
      if (x.call(I, X)) {
        ...
        if (Ee != null && typeof Ee != "boolean" && Ee !== "") {
          ...
          P ? (P = !1, v.push(fe, Se, Re, Ee)) : v.push(je, Se, Re, Ee);
        }
      }
    P || v.push(Fe);
  }
  ...
  function de(v, P, I, X) {
    ...
    if (!(2 < I.length) || I[0] !== "o" && I[0] !== "O" || I[1] !== "n" && I[1] !== "N") {
      if (P = h.hasOwnProperty(I) ? h[I] : null, P !== null) {
        switch (typeof X) {
          case "function":
          case "symbol":
            return;
        ...
        switch (I = u(P.attributeName), P.type) {
          case 3:
            X && v.push(Ae, I, ue);
            break;
          case 4:
          ...
          case 6:
            ...
            break;
          default:
            P.sanitizeURL && (X = "" + X), v.push(Ae, I, me, u(B(X)), Fe);
        }
      } else if (F(I)) {
        switch (typeof X) {
          case "function":
          case "symbol":
            return;
          case "boolean":
            if (P = I.toLowerCase().slice(0, 5), P !== "data-" && P !== "aria-")
              return;
        }
...
` && v.push(tt), Se;
      ...
      case "missing-glyph":
        return mt(v, I, P, X);
      case "html":
        return Ee.insertionMode === 0 && v.push(Je), mt(v, I, P, X);
      default:
        if (P.indexOf("-") === -1 && typeof I.is != "string")
          return mt(v, I, P, X);
        v.push(we(P)), ze = Se = null;
        for (Dt in I)
  ...
  var dt = m("</"), bt = m(">"), yt = m('<template id="'), _t = m('"></template>'), an = m("<!--$-->"), on = m('<!--$?--><template id="'), Kt = m('"></template>'), Jt = m("<!--$!-->"), Yt = m("<!--/$-->"), At = m("<template"), zt = m('"'), Vt = m(' data-dgst="');
  ...
  var wt = m('<div hidden id="'), $t = m('">'), pt = m("</div>"), tn = m('<svg aria-hidden="true" style="display:none" id="'), xn = m('">'), Ft = m("</svg>"), nn = m('<math aria-hidden="true" style="display:none" id="'), Ln = m('">'), Xt = m("</math>"), jt = m('<table hidden id="'), Tn = m('">'), Hn = m("</table>"), Mn = m('<table hidden><tbody id="'), qt = m('">'), Wn = m("</tbody></table>"), Vn = m('<table hidden><tr id="'), Cn = m('">'), Sn = m("</tr></table>"), jn = m('<table hidden><colgroup id="'), zn = m('">'), Un = m("</colgroup></table>");
  function Ne(v, P, I, X) {
    switch (I.insertionMode) {
      case 0:
      case 1:
        return i(v, wt), i(v, P.segmentPrefix), i(v, u(X.toString(16))), l(v, $t);
      case 2:
        return i(v, tn), i(v, P.segmentPrefix), i(v, u(X.toString(16))), l(v, xn);
      case 3:
        return i(v, nn), i(v, P.segmentPrefix), i(v, u(X.toString(16))), l(v, Ln);
      case 4:
        return i(v, jt), i(v, P.segmentPrefix), i(v, u(X.toString(16))), l(v, Tn);
      case 5:
        return i(v, Mn), i(v, P.segmentPrefix), i(v, u(X.toString(16))), l(v, qt);
      case 6:
        return i(v, Vn), i(v, P.segmentPrefix), i(v, u(X.toString(16))), l(v, Cn);
      case 7:
        return i(
          v,
          jn
        ), i(v, P.segmentPrefix), i(v, u(X.toString(16))), l(v, zn);
      default:
        throw Error(t(397));
    }
  }
  ...
  function Ue(v) {
    ...
    if (typeof v == "object")
      switch (v.$$typeof) {
        ...
        case g:
          return P = v.displayName || null, P !== null ? P : Ue(v.type) || "Memo";
        case A:
  ...
  function Oe(v) {
    var P = v.parent;
    P !== null && Oe(P), v.context._currentValue = v.value;
  }
  function vt(v, P) {
    if (v.context._currentValue = v.parentValue, v = v.parent, v === null)
      throw Error(t(402));
    v.depth === P.depth ? le(v, P) : vt(v, P);
  }
  function gn(v, P) {
    var I = P.parent;
    if (I === null)
      throw Error(t(402));
    v.depth === I.depth ? le(v, I) : gn(v, I), P.context._currentValue = P.value;
  }
  function kn(v) {
    var P = oe;
    P !== v && (P === null ? Oe(v) : v === null ? ye(P) : P.depth === v.depth ? le(P, v) : P.depth > v.depth ? vt(P, v) : gn(P, v), oe = v);
  }
  ...
  function In(v, P, I, X) {
    ...
    var ze = P.contextType;
    if (v.context = typeof ze == "object" && ze !== null ? ze._currentValue : X, ze = P.getDerivedStateFromProps, typeof ze == "function" && (ze = ze(I, Ee), Ee = ze == null ? Ee : Nt({}, Ee, ze), v.state = Ee), typeof P.getDerivedStateFromProps != "function" && typeof v.getSnapshotBeforeUpdate != "function" && (typeof v.UNSAFE_componentWillMount == "function" || typeof v.componentWillMount == "function"))
      if (P = v.state, typeof v.componentWillMount == "function" && v.componentWillMount(), typeof v.UNSAFE_componentWillMount == "function" && v.UNSAFE_componentWillMount(), P !== v.state && dr.enqueueReplaceState(v, v.state, null), Se.queue !== null && 0 < Se.queue.length)
        if (P = Se.queue, ze = Se.replace, Se.queue = null, Se.replace = !1, ze && P.length === 1)
          v.state = P[0];
        else {
          for (Se = ze ? P[0] : v.state, Ee = !0, ze = ze ? 1 : 0; ze < P.length; ze++) {
            var Xe = P[ze];
  ...
  function fr(v, P, I) {
    ...
    if (30 < Se) {
      var ze = Ee - Ee % 5;
      return Se = (X & (1 << ze) - 1).toString(32), X >>= ze, Ee -= ze, { id: 1 << 32 - qr(P) + Ee | I << Ee | X, overflow: Se + v };
    }
  ...
  function $i(v, P, I) {
    if (pr = gr(), rn = Wa(), mr) {
      var X = rn.queue;
      if (P = X.dispatch, yr !== null && (I = yr.get(X), I !== void 0)) {
        yr.delete(X), X = rn.memoizedState;
        do
          X = v(X, I.action), I = I.next;
        while (I !== null);
        return rn.memoizedState = X, [X, P];
      }
      return [rn.memoizedState, P];
    }
    return v = v === Ii ? typeof P == "function" ? P() : P : I !== void 0 ? I(P) : P, rn.memoizedState = v, v = rn.queue = { last: null, dispatch: null }, v = v.dispatch = tl.bind(null, pr, v), [rn.memoizedState, v];
  }
  function Bi(v, P) {
    if (pr = gr(), rn = Wa(), P = P === void 0 ? null : P, rn !== null) {
      ...
      if (I !== null && P !== null) {
        ...
        e:
          if (X === null)
            ...
            for (var Ee = 0; Ee < X.length && Ee < P.length; Ee++)
              if (!Ha(P[Ee], X[Ee])) {
                X = !1;
                break e;
              }
    ...
    return v = v(), rn.memoizedState = [v, P], v;
  }
  function tl(v, P, I) {
    if (25 <= fa)
      throw Error(t(301));
    if (v === pr)
      if (Kn = !0, v = { action: I, next: null }, yr === null && (yr = /* @__PURE__ */ new Map()), I = yr.get(P), I === void 0)
        yr.set(P, v);
      else {
        for (P = I; P.next !== null; )
          P = P.next;
  ...
  var ha = { readContext: function(v) {
    ...
    return P === null ? (v = { current: v }, rn.memoizedState = v) : P;
  }, useState: function(v) {
    return $i(Ii, v);
    ...
    var v = Gr.treeContext, P = v.overflow;
    v = v.id, v = (v & ~(1 << 32 - qr(v) - 1)).toString(32) + P;
    var I = ma;
    if (I === null)
      throw Error(t(404));
    return P = Tr++, v = ":" + I.idPrefix + "R" + v, 0 < P && (v += "H" + P.toString(32)), v + ":";
  }, useMutableSource: function(v, P) {
    return gr(), P(v._source);
  }, useSyncExternalStore: function(v, P, I) {
    if (I === void 0)
      throw Error(t(407));
    return I();
  ...
  function Fr(v, P, I, X, Ee, Se) {
    return { status: 0, id: -1, index: P, parentFlushed: !1, chunks: [], children: [], formatContext: X, boundary: I, lastPushedText: Ee, textEmbedded: Se };
  }
  function Mr(v, P) {
  ...
  function ya(v, P) {
    ...
    I(P), I = v.onFatalError, I(P), v.destination !== null ? (v.status = 2, y(v.destination, P)) : (v.status = 1, v.fatalError = P);
  }
  function Hi(v, P, I, X, Ee) {
    for (pr = {}, Gr = P, Tr = 0, v = I(X, Ee); Kn; )
  ...
  function Ka(v, P, I, X) {
    ...
    if (Se != null) {
      ...
      P.legacyContext = X, Yn(v, P, Ee), P.legacyContext = ze;
    } else
      Yn(v, P, Ee);
  }
  function Wi(v, P) {
    if (v && v.defaultProps) {
      P = Nt({}, P), v = v.defaultProps;
      for (var I in v)
        P[I] === void 0 && (P[I] = v[I]);
      return P;
    }
  ...
  function ga(v, P, I, X, Ee) {
    if (typeof I == "function")
      if (I.prototype && I.prototype.isReactComponent) {
        Ee = ht(I, P.legacyContext);
        var Se = I.contextType;
        Se = new I(X, typeof Se == "object" && Se !== null ? Se._currentValue : Ee), In(Se, I, X, Ee), Ka(v, P, Se, I);
      } else {
        Se = ht(I, P.legacyContext), Ee = Hi(v, P, I, X, Se);
        var ze = Tr !== 0;
        if (typeof Ee == "object" && Ee !== null && typeof Ee.render == "function" && Ee.$$typeof === void 0)
          In(Ee, I, X, Se), Ka(v, P, Ee, I);
        else if (ze) {
          X = P.treeContext, P.treeContext = fr(X, 1, 0);
          try {
            Yn(v, P, Ee);
          } finally {
            P.treeContext = X;
      ...
      switch (Ee = P.blockedSegment, Se = Ge(Ee.chunks, I, X, v.responseState, Ee.formatContext), Ee.lastPushedText = !1, ze = Ee.formatContext, Ee.formatContext = K(ze, I, X), va(v, P, Se), Ee.formatContext = ze, I) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      switch (I) {
        ...
        case En:
          e: {
            I = P.blockedBoundary, Ee = P.blockedSegment, Se = X.fallback, X = X.children, ze = /* @__PURE__ */ new Set();
            ...
            Dt.parentFlushed = !0, P.blockedBoundary = Xe, P.blockedSegment = Dt;
            try {
              if (va(
                v,
                P,
              ...
              P.blockedBoundary = I, P.blockedSegment = Ee;
            }
            P = Ua(v, Se, I, xt, ze, P.legacyContext, P.context, P.treeContext), v.pingedTasks.push(P);
          }
          return;
      }
      if (typeof I == "object" && I !== null)
        switch (I.$$typeof) {
          case cn:
            if (X = Hi(v, P, I.render, X, Ee), Tr !== 0) {
              I = P.treeContext, P.treeContext = fr(I, 1, 0);
              try {
                Yn(v, P, X);
              } finally {
                P.treeContext = I;
            ...
            return;
          case g:
            I = I.type, X = Wi(I, X), ga(v, P, I, X, Ee);
            return;
          case ln:
            if (Ee = X.children, I = I._context, X = X.value, Se = I._currentValue, I._currentValue = X, ze = oe, oe = X = { parent: ze, depth: ze === null ? 0 : ze.depth + 1, context: I, parentValue: Se, value: X }, P.context = X, Yn(v, P, Ee), v = oe, v === null)
              throw Error(t(403));
            X = v.parentValue, v.context._currentValue = X === ve ? v.context._defaultValue : X, v = oe = v.parent, P.context = v;
            return;
          case mn:
            X = X.children, X = X(I._currentValue), Yn(v, P, X);
            return;
          case A:
            Ee = I._init, I = Ee(I._payload), X = Wi(I, X), ga(v, P, I, X, void 0);
            return;
        }
      throw Error(t(
        130,
  ...
  function Yn(v, P, I) {
    if (P.node = I, typeof I == "object" && I !== null) {
      switch (I.$$typeof) {
        case Ot:
          ga(v, P, I.type, I.props, I.ref);
          return;
        case Gt:
          throw Error(t(257));
        case A:
          var X = I._init;
          I = X(I._payload), Yn(v, P, I);
          return;
      }
      if (ne(I)) {
        Vi(v, P, I);
    ...
    typeof I == "string" ? (X = P.blockedSegment, X.lastPushedText = Ce(P.blockedSegment.chunks, I, v.responseState, X.lastPushedText)) : typeof I == "number" && (X = P.blockedSegment, X.lastPushedText = Ce(P.blockedSegment.chunks, "" + I, v.responseState, X.lastPushedText));
  }
  function Vi(v, P, I) {
    for (var X = I.length, Ee = 0; Ee < X; Ee++) {
      var Se = P.treeContext;
      P.treeContext = fr(Se, X, Ee);
      try {
        va(v, P, I[Ee]);
      } finally {
        P.treeContext = Se;
  ...
  function va(v, P, I) {
    var X = P.blockedSegment.formatContext, Ee = P.legacyContext, Se = P.context;
    try {
      return Yn(v, P, I);
    } catch (xt) {
      if (Va(), typeof xt == "object" && xt !== null && typeof xt.then == "function") {
        I = xt;
        var ze = P.blockedSegment, Xe = Fr(v, ze.chunks.length, null, ze.formatContext, ze.lastPushedText, !0);
        ze.children.push(Xe), ze.lastPushedText = !1, v = Ua(v, P.node, P.blockedBoundary, Xe, P.abortSet, P.legacyContext, P.context, P.treeContext).ping, I.then(v, v), P.blockedSegment.formatContext = X, P.legacyContext = Ee, P.context = Se, kn(Se);
      } else
        throw P.blockedSegment.formatContext = X, P.legacyContext = Ee, P.context = Se, kn(Se), xt;
    }
  }
  function al(v) {
    var P = v.blockedBoundary;
    v = v.blockedSegment, v.status = 3, Ui(this, P, v);
  }
  function ji(v, P, I) {
    var X = v.blockedBoundary;
    v.blockedSegment.status = 3, X === null ? (P.allPendingTasks--, P.status !== 2 && (P.status = 2, P.destination !== null && P.destination.close())) : (X.pendingTasks--, X.forceClientRender || (X.forceClientRender = !0, v = I === void 0 ? Error(t(432)) : I, X.errorDigest = P.onError(v), X.parentFlushed && P.clientRenderedBoundaries.push(X)), X.fallbackAbortableTasks.forEach(function(Ee) {
      return ji(Ee, P, I);
    }), X.fallbackAbortableTasks.clear(), P.allPendingTasks--, P.allPendingTasks === 0 && (X = P.onAllReady, X()));
  }
  function xa(v, P) {
    if (P.chunks.length === 0 && P.children.length === 1 && P.children[0].boundary === null) {
      var I = P.children[0];
      I.id = P.id, I.parentFlushed = !0, I.status === 1 && xa(v, I);
    } else
  ...
  function Ui(v, P, I) {
    if (P === null) {
      ...
      v.pendingRootTasks--, v.pendingRootTasks === 0 && (v.onShellError = Qr, P = v.onShellReady, P());
    } else
      P.pendingTasks--, P.forceClientRender || (P.pendingTasks === 0 ? (I.parentFlushed && I.status === 1 && xa(P, I), P.parentFlushed && v.completedBoundaries.push(P), P.fallbackAbortableTasks.forEach(al, v), P.fallbackAbortableTasks.clear()) : I.parentFlushed && I.status === 1 && (xa(P, I), P.completedSegments.length === 1 && P.parentFlushed && v.partialBoundaries.push(P)));
    v.allPendingTasks--, v.allPendingTasks === 0 && (v = v.onAllReady, v());
  }
  function Ki(v) {
    if (v.status !== 2) {
      var P = oe, I = Zr.current;
      Zr.current = ha;
      var X = ma;
      ma = v.responseState;
      try {
  ...
  function ba(v, P, I) {
    switch (I.parentFlushed = !0, I.status) {
      case 0:
        ...
        return I.lastPushedText = !1, I.textEmbedded = !1, v = v.responseState, i(P, yt), i(P, v.placeholderPrefix), v = u(X.toString(16)), i(P, v), l(P, _t);
      case 1:
        I.status = 2;
        var Ee = !0;
        X = I.chunks;
        ...
        for (; Se < X.length - 1; Se++)
          i(P, X[Se]);
        return Se < X.length && (Ee = l(P, X[Se])), Ee;
      default:
        throw Error(t(390));
    }
  }
  function Sa(v, P, I) {
    ...
    if (X.parentFlushed = !0, X.forceClientRender)
      X = X.errorDigest, l(P, Jt), i(P, At), X && (i(P, Vt), i(P, u(B(X))), i(P, zt)), l(P, $e), ba(v, P, I);
      ...
      Ee = m(Ee.boundaryPrefix + Se.toString(16)), X = X.id = Ee, en(P, v.responseState, X), ba(v, P, I);
    } else if (X.byteSize > v.progressiveChunkSize)
      X.rootSegmentID = v.nextSegmentId++, v.completedBoundaries.push(X), en(P, v.responseState, X.id), ba(v, P, I);
    else {
      if (l(P, an), I = X.completedSegments, I.length !== 1)
        throw Error(t(391));
      Sa(v, P, I[0]);
    }
    return l(P, Yt);
  ...
  function Yi(v, P, I) {
    return Ne(P, v.responseState, I.formatContext, I.id), Sa(v, P, I), ut(P, I.formatContext);
  }
  function Xi(v, P, I) {
    for (var X = I.completedSegments, Ee = 0; Ee < X.length; Ee++)
      qi(v, P, I, X[Ee]);
    if (X.length = 0, v = v.responseState, X = I.id, I = I.rootSegmentID, i(P, v.startInlineScript), v.sentCompleteBoundaryFunction ? i(P, nt) : (v.sentCompleteBoundaryFunction = !0, i(P, He)), X === null)
      throw Error(t(395));
    return I = u(I.toString(16)), i(P, X), i(P, at), i(P, v.segmentPrefix), i(P, I), l(P, kt);
  }
  function qi(v, P, I, X) {
    if (X.status === 2)
      return !0;
    ...
    return Yi(v, P, X), v = v.responseState, i(P, v.startInlineScript), v.sentCompleteSegmentFunction ? i(P, $) : (v.sentCompleteSegmentFunction = !0, i(P, ft)), i(P, v.segmentPrefix), Ee = u(Ee.toString(16)), i(P, Ee), i(P, Me), i(P, v.placeholderPrefix), i(P, Ee), l(P, Ye);
  }
  function Ya(v, P) {
    ...
    try {
      ...
      if (I !== null && v.pendingRootTasks === 0) {
        Sa(v, P, I), v.completedRootSegment = null;
      ...
      for (Se = 0; Se < Ee.length; Se++) {
        ...
        if (i(X, Xe.startInlineScript), Xe.sentClientRenderFunction ? i(X, Ke) : (Xe.sentClientRenderFunction = !0, i(
          ...
          throw Error(t(395));
        i(X, xt), i(X, Mt), (Dt || Pt || sn) && (i(X, Bt), i(X, u(Rt(Dt || "")))), (Pt || sn) && (i(X, Bt), i(X, u(Rt(Pt || "")))), sn && (i(X, Bt), i(X, u(Rt(sn)))), l(X, It);
      }
      Ee.splice(0, Se);
      var Xn = v.completedBoundaries;
      for (Se = 0; Se < Xn.length; Se++)
        Xi(v, P, Xn[Se]);
      Xn.splice(0, Se), d(P), n = new Uint8Array(512), a = 0;
      ...
      d(P), v.allPendingTasks === 0 && v.pingedTasks.length === 0 && v.clientRenderedBoundaries.length === 0 && v.completedBoundaries.length === 0 && P.close();
    }
  }
  function Gi(v, P) {
    try {
  ...
  return Au.renderToReadableStream = function(v, P) {
    return new Promise(function(I, X) {
      var Ee, Se, ze = new Promise(function(Pt, sn) {
        Se = Pt, Ee = sn;
      }), Xe = ja(v, se(P ? P.identifierPrefix : void 0, P ? P.nonce : void 0, P ? P.bootstrapScriptContent : void 0, P ? P.bootstrapScripts : void 0, P ? P.bootstrapModules : void 0), Q(P ? P.namespaceURI : void 0), P ? P.progressiveChunkSize : void 0, P ? P.onError : void 0, Se, function() {
  ...
  return Lh || (Lh = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    };
    {
      ...
      we = function(o, c, b, w) {
        ...
        var Be = Q(c), rt = Be !== null && Be.type === _;
        ...
        return typeof b == "boolean" && G(c, b, Be, !1) ? (b ? i('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.', b, c, c, b, c) : i('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.', b, c, c, b, c, c, c), Je[c] = !0, !0) : rt ? !0 : G(c, b, Be, !1) ? (Je[c] = !0, !1) : ((b === "false" || b === "true") && Be !== null && Be.type === U && (i("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", b, c, b === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', c, b), Je[c] = !0), !0);
      };
    }
    ...
    {
      var Kt = /^(?:webkit|moz|o)[A-Z]/, Jt = /^-ms-/, Yt = /-(.)/g, At = /;\s*$/, zt = {}, Vt = {}, $e = !1, en = !1, wt = function(o) {
        return o.replace(Yt, function(c, b) {
          return b.toUpperCase();
        });
      }, $t = function(o) {
        zt.hasOwnProperty(o) && zt[o] || (zt[o] = !0, i(
        ...
        zt.hasOwnProperty(o) && zt[o] || (zt[o] = !0, i("Unsupported vendor-prefixed style property %s. Did you mean %s?", o, o.charAt(0).toUpperCase() + o.slice(1)));
      }, tn = function(o, c) {
      ...
      on = function(o, c) {
        o.indexOf("-") > -1 ? $t(o) : Kt.test(o) ? pt(o) : At.test(c) && tn(o, c), typeof c == "number" && (isNaN(c) ? xn(o, c) : isFinite(c) || Ft(o, c));
      };
    }
    var nn = on, Ln = /["'&<>]/;
    function Xt(o) {
    ...
    var He = 0, nt = 1, at = 2, kt = 3, Lt = 4, Ke = 5, Mt = 6, It = 7;
    function Bt(o, c) {
      return {
        insertionMode: o,
        selectedValue: c
    ...
    function gt(o, c, b) {
      ...
      return o.insertionMode >= Lt || o.insertionMode === He ? Bt(nt, null) : o;
    }
    var Rt = null;
    function Nt(o) {
    ...
    function g(o, c, b) {
      ...
      for (var M in b)
        if (N.call(b, M)) {
          var ee = b[M];
          if (!(ee == null || typeof ee == "boolean" || ee === "")) {
            var pe = void 0, Te = void 0, Be = M.indexOf("--") === 0;
            Be ? (pe = jt(M), O(ee, M), Te = jt(("" + ee).trim())) : (nn(M, ee), pe = mn(M), typeof ee == "number" ? ee !== 0 && !N.call(je, M) ? Te = ee + "px" : Te = "" + ee : (O(ee, M), Te = jt(("" + ee).trim()))), w ? (w = !1, o.push(cn, pe, En, Te)) : o.push(qn, pe, En, Te);
          }
        }
      w || o.push(j);
    }
        ...
        if (M !== null) {
          ...
          switch (M.type) {
            ...
            case V:
              ...
              break;
            default:
              M.sanitizeURL && (L(w, ee), w = "" + w, Vn(w)), o.push(A, pe, z, jt(w), j);
          }
        } else if (se(b)) {
          switch (typeof w) {
            case "function":
    ...
    function fr(o, c, b, w) {
      ...
      o.push(Kn("option"));
      var ee = null, pe = null, Te = null, Be = null;
      for (var rt in c)
        if (N.call(c, rt)) {
          var ct = c[rt];
          if (ct == null)
      ...
      if (M != null) {
        var Tt;
        if (pe !== null ? (L(pe, "value"), Tt = "" + pe) : (Be !== null && (vt || (vt = !0, i("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), Tt = In(ee)), Sn(M))
          ...
          L(M, "select.value"), "" + M === Tt && o.push(wr);
      } else
        Te && o.push(wr);
      return o.push(De), ot(o, Be, ee), ee;
    }
    function qr(o, c, b) {
...
` && o.push(Gr), w !== null && (L(w, "value"), o.push(Gt("" + w))), null;
    }
    function Jo(o, c, b, w) {
      o.push(Kn(b));
      for (var M in c)
...
` && o.push(Gr), M;
    ...
    function yr(o, c, b, w, M) {
      switch (mt(c, b), Ve(c, b), an(c, b, null), !b.suppressContentEditableWarning && b.contentEditable && b.children != null && i("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional."), M.insertionMode !== at && M.insertionMode !== kt && c.indexOf("-") === -1 && typeof b.is != "string" && c.toLowerCase() !== c && i("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", c), c) {
        ...
        case "missing-glyph":
          return Ha(o, b, c, w);
        case "html":
          return M.insertionMode === He && o.push(Tr), Ha(o, b, c, w);
        default:
    ...
    var ga = '<div hidden id="', Yn = '">', Vi = "</div>", va = '<svg aria-hidden="true" style="display:none" id="', al = '">', ji = "</svg>", xa = '<math aria-hidden="true" style="display:none" id="', Ui = '">', Ki = "</math>", ba = '<table hidden id="', Sa = '">', Yi = "</table>", Xi = '<table hidden><tbody id="', qi = '">', Ya = "</tbody></table>", Gi = '<table hidden><tr id="', v = '">', P = "</tr></table>", I = '<table hidden><colgroup id="', X = '">', Ee = "</colgroup></table>";
    function Se(o, c, b, w) {
...
`), Be = w.stack.split(`
`), rt = Te.length - 1, ct = Be.length - 1; rt >= 1 && ct >= 0 && Te[rt] !== Be[ct]; )
            ct--;
          for (; rt >= 1 && ct >= 0; rt--, ct--)
            if (Te[rt] !== Be[ct]) {
              if (rt !== 1 || ct !== 1)
                do
                  if (rt--, ct--, ct < 0 || Te[rt] !== Be[ct]) {
                    var Tt = `
          ...
          if (ee(o, pe)) {
            ...
            try {
              if (typeof o[pe] != "function") {
                var Be = Error((w || "React class") + ": " + b + " type `" + pe + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof o[pe] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
...
Please update the following components: %s`,
    ...
    function Yc(o, c, b, w) {
      if (o.queue !== null && o.queue.length > 0) {
        ...
        if (o.queue = null, o.replace = !1, ee && M.length === 1)
          ...
          for (var pe = ee ? M[0] : c.state, Te = !0, Be = ee ? 1 : 0; Be < M.length; Be++) {
            var rt = M[Be], ct = typeof rt == "function" ? rt.call(c, pe, b, w) : rt;
    ...
    function go(o, c, b, w) {
      ...
      typeof Be == "function" && (o.state = jc(o, c, Be, M, b)), typeof c.getDerivedStateFromProps != "function" && typeof o.getSnapshotBeforeUpdate != "function" && (typeof o.UNSAFE_componentWillMount == "function" || typeof o.componentWillMount == "function") && (Kc(c, o), Yc(ee, o, b, w));
    }
    var vo = {
      id: 1,
      overflow: ""
    ...
    function Pl(o, c, b) {
      var w = o.id, M = o.overflow, ee = xo(w) - 1, pe = w & ~(1 << ee), Te = b + 1, Be = xo(c) + ee;
      if (Be > 30) {
      ...
      if (o !== ko && (oa = "useReducer"), Ht = Lr(), Qt = Eo(), lr) {
        ...
        if (On !== null) {
          ...
          if (ee !== void 0) {
            ...
            do {
              var Be = Te.action;
              xr = !0, pe = o(pe, Be), xr = !1, Te = Te.next;
            } while (Te !== null);
...
` + w.stack;
    ...
    function Fl(o, c, b, w, M, ee, pe, Te, Be) {
    ...
    function Js(o, c, b) {
      sr(c, "Suspense");
      var w = c.blockedBoundary, M = c.blockedSegment, ee = b.fallback, pe = b.children, Te = /* @__PURE__ */ new Set(), Be = Pr(o, Te), rt = M.chunks.length, ct = $r(
        o,
        rt,
        Be,
        M.formatContext,
      ...
      try {
        if (Ro(o, c, pe), As(Tt.chunks, o.responseState, Tt.lastPushedText, Tt.textEmbedded), Tt.status = la, yi(Be, Tt), Be.pendingTasks === 0) {
          ur(c);
          return;
        }
      } catch (Fn) {
    ...
    function hi(o, c, b, w, M) {
      ...
      b.props !== M && (Vl || i("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", yn(w) || "a component"), Vl = !0);
      {
        ...
        if (pe != null) {
          var Te = c.legacyContext, Be = ea(b, w, Te, pe);
          c.legacyContext = Be, rr(o, c, ee), c.legacyContext = Te;
          return;
        }
      }
      rr(o, c, ee);
    ...
    function yd(o, c, b, w, M) {
      ...
      if (pe) {
        var Te = c.treeContext, Be = 1, rt = 0;
        c.treeContext = Pl(Te, Be, rt);
        try {
          rr(o, c, ee);
        } finally {
          c.treeContext = Te;
    ...
    function nr(o, c, b, w, M) {
      sr(c, "Lazy");
      var ee = b._payload, pe = b._init, Te = pe(ee), Be = au(Te, w);
      Kl(o, c, Te, Be, M), ur(c);
    }
    function Kl(o, c, b, w, M) {
    ...
    function Yl(o, c, b) {
      if (c.node = b, typeof b == "object" && b !== null) {
        switch (b.$$typeof) {
          ...
          case to: {
            var Te = b, Be = Te._payload, rt = Te._init, ct;
            try {
              ct = rt(Be);
            } catch (Fo) {
    ...
    function vi(o, c, b) {
      switch (b.parentFlushed = !0, b.status) {
        ...
        case la: {
          b.status = Zs;
          for (var M = !0, ee = b.chunks, pe = 0, Te = b.children, Be = 0; Be < Te.length; Be++) {
            for (var rt = Te[Be]; pe < rt.index; pe++)
              u(c, ee[pe]);
            M = xi(o, c, rt);
          }
...
function $S() {
  return Ph || (Ph = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    {
      var yt = {}, _t = /^on./, an = /^on[^A-Z]/, on = new RegExp("^(aria)-[" + se + "]*$"), Kt = new RegExp("^(aria)[A-Z][" + se + "]*$");
      bt = function(s, p, E, D) {
        if (U.call(yt, p) && yt[p])
          return !0;
        var H = p.toLowerCase();
    ...
    {
      var zt = /^(?:webkit|moz|o)[A-Z]/, Vt = /^-ms-/, $e = /-(.)/g, en = /;\s*$/, wt = {}, $t = {}, pt = !1, tn = !1, xn = function(s) {
        ...
        $t.hasOwnProperty(p) && $t[p] || ($t[p] = !0, i(`Style property values shouldn't contain a semicolon. Try "%s: %s" instead.`, s, p.replace(en, "")));
      }, Xt = function(s, p) {
      ...
      At = function(s, p) {
        s.indexOf("-") > -1 ? Ft(s) : zt.test(s) ? nn(s) : en.test(p) && Ln(s, p), typeof p == "number" && (isNaN(p) ? Xt(s, p) : isFinite(p) || jt(s, p));
      };
    }
    var Tn = At, Hn = /["'&<>]/;
    function Mn(s) {
    ...
    function kt(s, p, E, D, H) {
      ...
      if (E !== void 0 && Pe.push(he, k(He(E)), ft), D !== void 0)
    ...
    var Lt = 0, Ke = 1, Mt = 2, It = 3, Bt = 4, gt = 5, Rt = 6, Nt = 7;
    function Ot(s, p) {
      return {
        insertionMode: s,
        selectedValue: p
    ...
    function Gt(s) {
      var p = s === "http://www.w3.org/2000/svg" ? Mt : s === "http://www.w3.org/1998/Math/MathML" ? It : Lt;
      return Ot(p, null);
    }
    function pn(s, p, E) {
      switch (p) {
...
` && s.push(Tr), H;
    ...
    function Va(s, p, E, D, H) {
      switch (we(p, E), Ge(p, E), Yt(p, E, null), !E.suppressContentEditableWarning && E.contentEditable && E.children != null && i("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional."), H.insertionMode !== Mt && H.insertionMode !== It && p.indexOf("-") === -1 && typeof E.is != "string" && p.toLowerCase() !== p && i("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", p), p) {
        case "select":
          return Qo(s, E, D);
        case "option":
          return el(s, E, D, H);
    ...
    var ji = h('<div hidden id="'), xa = h('">'), Ui = h("</div>"), Ki = h('<svg aria-hidden="true" style="display:none" id="'), ba = h('">'), Sa = h("</svg>"), Yi = h('<math aria-hidden="true" style="display:none" id="'), Xi = h('">'), qi = h("</math>"), Ya = h('<table hidden id="'), Gi = h('">'), v = h("</table>"), P = h('<table hidden><tbody id="'), I = h('">'), X = h("</tbody></table>"), Ee = h('<table hidden><tr id="'), Se = h('">'), ze = h("</tr></table>"), Xe = h('<table hidden><colgroup id="'), xt = h('">'), Dt = h("</colgroup></table>");
    function Pt(s, p, E, D) {
      switch (E.insertionMode) {
        ...
        case gt:
          return x(s, P), x(s, p.segmentPrefix), x(s, k(D.toString(16))), S(s, I);
        case Rt:
...
Please update the following components: %s`,
    ...
    function go(s, p, E) {
      ...
      if (o > 30) {
        var c = ie - ie % 5, b = (1 << c) - 1, w = (he & b).toString(32), M = he >> c, ee = ie - c, pe = vo(p) + ee, Te = Pe << ee, Be = Te | M, rt = w + H;
        return {
          id: 1 << pe | Be,
          overflow: rt
        };
...
` + D.stack;
    ...
    function Br(s, p) {
      ...
      D(p), s.destination !== null ? (s.status = sa, L(s.destination, p)) : (s.status = Ol, s.fatalError = p);
    }
    function Il(s, p, E) {
      $r(p, "Suspense");
...
const BS = ({ width: e, height: t, runtime: n }) => {
  ...
  if (ce.useEffect(() => {
    ...
    return;
  const k = a == null ? void 0 : a.data[0], h = Array.from(new Set((fe = k == null ? void 0 : k.links) == null ? void 0 : fe.flatMap((de) => [de.source, de.target]))), L = {
  ...
  const C = 50, N = _S().nodeWidth(i.nodeSize.nodeWidth).nodePadding(i.nodePadding).iterations(i.iterations).nodeAlign(AS).extent([
    ...
    const Le = L.nodes.find((qe) => qe.id === de), ke = [], Ie = [];
    ...
    return m !== de.id && m !== "" && !mt.includes(de.id) && (Ve = i.nodeColor.inactive, tt = i.opacity.nodeOpacityInactive), /* @__PURE__ */ r.createElement(it, { className: "", key: Le }, /* @__PURE__ */ r.createElement(
      ...
      {
        x: de.x0 + ke,
        textAnchor: L.nodes.length - 1 === Le ? "end" : "start",
        verticalAnchor: "end",
        y: (de.y1 + de.y0) / 2 - 30,
      ...
      St,
      {
        ...
        fill: i.nodeFontColor,
        fontWeight: "bold",
        textAnchor: L.nodes.length === Le ? "end" : "start",
        className: "node-text",
        verticalAnchor: "end",
        style: { pointerEvents: "auto", cursor: "pointer" },
        onClick: () => x(de.id),
  ...
  }), W = L.nodes.reduce((de, Le) => Math.max(de, Le.depth), -1), xe = L.nodes.filter((de) => de.depth === W).map((de, Le) => {
    var _e, we;
    let { textPositionHorizontal: ke, textPositionVertical: Ie, classStyle: qe, storyNodes: Qe } = q(de.id), { sourceNodes: mt } = U(m), tt = i.opacity.nodeOpacityDefault, Ve = i.nodeColor.default;
...
function VS(e) {
  ...
  return y.map(function(R) {
    var T, F = R.value, k = R.index, h = R.from, L = R.to, O = R.formattedValue, C = (T = d[k]) != null ? T : {}, N = Math.max(10, typeof C.fontSize == "number" && C.fontSize || 0), _ = L.y + (n && a !== ir.top ? N : 0);
    return /* @__PURE__ */ r.createElement(it, {
      key: "visx-tick-" + F + "-" + k,
...
const ds = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  let { transformedData: m, config: y, handleLineType: x, parseDate: S, formatDate: R, formatNumber: T, seriesHighlight: F, colorScale: k, rawData: h, brushConfig: L } = ce.useContext(Et);
  const O = (_ = y.brush) != null && _.active && ((B = L.data) != null && B.length) ? L.data : m;
  if (!O)
    return;
  ...
  const { parseDate: y, config: x } = ce.useContext(Et), { runtime: S, regions: R, visualizationType: T, orientation: F, xAxis: k } = x, h = e.domain(), L = (N) => {
    let _;
...
function Ac(e) {
  var K, W;
  const { config: t, index: n, id: a, className: i, background: l, borderColor: d, borderWidth: f, width: u, height: m, x: y, y: x, onMouseOver: S, onMouseLeave: R, onClick: T, tooltipHtml: F, tooltipId: k, styleOverrides: h, seriesHighlight: L } = e, O = Math.max(0, u), C = Math.max(0, m), N = t.orientation === "horizontal", _ = t.barStyle === "rounded", B = t.visualizationSubType === "stacked", q = t.tipRounding, U = t.visualizationType === "Combo" && ((W = (K = t.runtime) == null ? void 0 : K.barSeriesKeys) == null ? void 0 : W.length), ne = t.runtime.seriesKeys.length, re = t.visualizationType === "Bar" && t.legend.axisAlign && (L != null && L.length) ? L == null ? void 0 : L.length : 0, V = U || re || ne;
...
const mE = () => {
  ...
  return y.visualizationSubType === "stacked" && !F && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(_0, { data: q, keys: _, x: (V) => V[y.runtime.xAxis.dataKey], xScale: n, yScale: a, color: u }, (V) => V.reverse().map(
    (Y) => Y.bars.map((J) => {
      ...
      if (!Q)
        return;
      const K = n(U ? R(se) : se) - (U ? te / 2 : 0), W = y.runtime.xAxis.label ? `${y.runtime.xAxis.label}: ${G}` : G, Ce = O(L), xe = `${y.runtime.seriesLabels[J.key]}: ${Q}`, fe = `<ul>
  ...
  const { yMax: e, yScale: t, xScale: n } = ce.useContext(ws), {
    ...
    setSharedFilter: x,
    transformedData: S
  } = ce.useContext(Et), { barBorderWidth: R, displayNumbersOnBar: T, fontSize: F, getAdditionalColumn: k, hoveredBar: h, isHorizontal: L, isLabelBelowBar: O, onMouseLeaveBar: C, onMouseOverBar: N, updateBars: _, barStackedSeriesKeys: B } = Cc(), { orientation: q, visualizationSubType: U } = l;
  return l.visualizationSubType === "stacked" && L && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(F0, { data: S, keys: B, height: e, y: (ne) => ne[l.runtime.yAxis.dataKey], xScale: n, yScale: t, color: i, offset: "none" }, (ne) => ne.map(
  ...
  if (a.preliminaryData.forEach((L) => {
    (!L.column || L.column === e.key) && L.type === "suppression" && L.value && String(L.value) === String(e.value) && (!L.hideBarSymbol && F ? (m = d > 10 ? 3 : 0, y = 3, S = !0) : (m = 0, y = 0, S = !0));
  ...
  return { barWidthHorizontal: y, barHeight: m, isSuppressed: S, showMissingDataLabel: R, showZeroValueDataLabel: T, getBarY: (L, O) => S || R || T ? a.isLollipopChart ? O - 3 * 2 : O - 3 : L, getAbsentDataLabel: (L) => {
    let O = "";
    String(L) === "0" && (O = ""), S && (O = ""), R && (O = "N/A"), T && (O = "0");
    const N = l(x, `normal ${d / 2}px sans-serif`) < d && d > 10;
    return a.isLollipopChart || N && f ? O : f ? "" : O;
  } };
}, fs = (e) => e == null ? void 0 : /^0(\.0)?$/.test(e.toString()), Lc = (e, t, n) => !!(e === "Line" && (t == null ? void 0 : t.length) < 3 && n), gE = () => {
  ...
  return C.preliminaryData.some((K) => K.value && K.type === "suppression") && (G = _), ae.data.length && (G = ae.data), C.visualizationSubType !== "stacked" && (C.visualizationType === "Bar" || C.visualizationType === "Combo" || Lc(C.visualizationType, G, C.allowLineToBarGraph)) && C.orientation === "vertical" && /* @__PURE__ */ r.createElement(it, null, /* @__PURE__ */ r.createElement(
    ...
    (K) => K.map((W, Ce) => /* @__PURE__ */ r.createElement(it, { className: `bar-group-${W.index}-${W.x0}--${Ce} ${C.orientation}`, key: `bar-group-${W.index}-${W.x0}--${Ce}`, id: `bar-group-${W.index}-${W.x0}--${Ce}`, left: W.x0 }, W.bars.map((xe, fe) => {
      ...
      const ke = q(/[a-zA-Z]/.test(String(xe.value)) ? "" : xe.value, "left"), Ie = C.runtime[L].type === "date" ? B(V(G[W.index][C.runtime.originalXAxis.dataKey])) : G[W.index][C.runtime.originalXAxis.dataKey], qe = xe.value < 0 ? -1 : fe, Qe = x(xe.key, G[W.index][C.runtime.originalXAxis.dataKey]);
      ...
      return /* @__PURE__ */ r.createElement(it, { key: `${W.index}--${fe}` }, /* @__PURE__ */ r.createElement(it, { key: `bar-sub-group-${W.index}-${W.x0}-${Vt}--${fe}` }, Ac({
        ...
        if (!(String(wt.value) === String(xe.value) && wt.value !== "" && pt) || de < 10 || !C.general.showSuppressedSymbol || wt.hideBarSymbol)
          return;
        const Ft = String(wt.symbol).includes("Asterisk"), nn = Ft ? -5 : -8, Ln = Ft ? "middle" : "end", Xt = wt.symbol === "Asterisk" ? de * 1.2 : wt.symbol === "Double Asterisk" ? de : de / 1.5;
  ...
  return u.visualizationSubType !== "stacked" && u.visualizationType === "Bar" && u.orientation === "horizontal" && /* @__PURE__ */ r.createElement(it, null, /* @__PURE__ */ r.createElement(
    ...
    (G) => O(G).map((Q, K) => /* @__PURE__ */ r.createElement(it, { className: `bar-group-${Q.index}-${Q.x0}--${K} ${u.orientation}`, key: `bar-group-${Q.index}-${Q.x0}--${K}`, id: `bar-group-${Q.index}-${Q.x0}--${K}`, top: Q.y }, Q.bars.map((W, Ce) => {
      ...
      const an = Y(J), on = `${u.runtime.seriesLabels[W.key]}: ${qe}`, Kt = `<ul>
      ...
      let Yt = u.runtime.seriesLabels && u.runtime.seriesLabels[W.key] ? d(u.runtime.seriesLabels[W.key]) : d(W.key);
      Yt = C(G.length, Q.index, Yt);
      const At = u.isLollipopChart && u.lollipopColorStyle === "regular", zt = u.isLollipopChart && u.lollipopColorStyle === "two-tone", Vt = fe == null ? void 0 : fe.includes(Qe), $e = re(Qe), en = V(Qe), wt = Vt ? $e : u.barHasBorder === "true" ? "#000" : "transparent", $t = Vt ? en.borderWidth : u.isLollipopChart ? 0 : u.barHasBorder === "true" ? L : 0, pt = fs(W.value) ? "none" : "block";
      Yt && Jt && we && (Jt = Uo("#000", Yt));
      const tn = () => At ? Yt : zt ? ms(Yt).brighten(1) : Vt ? "transparent" : Yt;
...
const bE = ({ xScale: e, yScale: t }) => {
  ...
  return /* @__PURE__ */ r.createElement(it, { className: "scatter-plot", left: a.yAxis.size }, n.map((S, R) => a.runtime.seriesKeys.map((T, F) => {
    const k = a.legend.behavior === "highlight" && d.length > 0 && d.indexOf(T) === -1, h = a.legend.behavior === "highlight" || d.length === 0 || d.indexOf(T) !== -1, L = a.palette ? f[a.palette][F] : "#000";
    let O = {
      filter: "unset",
      opacity: 1,
      stroke: h ? "black" : ""
...
function EE({ height: e, xScale: t }) {
  ...
  const C = Number(a.xAxis.target), N = a.series[0].dataKey, _ = Number(t.domain()[1]), q = n.some((G) => G[N] < 0) || C > 0 || t.domain()[0] < 0, U = a.barHasBorder === "true" ? 1 : 0, ne = a.lollipopSize === "large" ? 7 : a.lollipopSize === "medium" ? 6 : 5, re = a.lollipopSize === "large" ? 14 : a.lollipopSize === "medium" ? 12 : 10, V = Math.max(t(0), Math.min(t(C), t(_))), Y = (G) => {
    if (G == null || x !== "rounded")
      return;
    let Q = {};
    return G === "left" && (Q = { borderRadius: `${L} 0 0 ${L}` }), G === "right" && (Q = { borderRadius: `0 ${L} ${L} 0` }), S === "full" && (Q = { borderRadius: L }), Q;
  }, J = {
    calculate: function() {
...
const wE = ({ xScale: e, yScale: t, height: n, width: a, handleTooltipMouseOver: i, handleTooltipMouseOff: l }) => {
  ...
  return d && /* @__PURE__ */ r.createElement(Or, { component: "ForecastingChart" }, /* @__PURE__ */ r.createElement(it, { className: "forecasting-items", key: "forecasting-items-wrapper", left: Number(x.size) }, (T = R.forecastingSeriesKeys) == null ? void 0 : T.map((F, k) => !F || !F.stages ? !1 : F.stages.map((h, L) => {
    var B;
    ...
    return /* @__PURE__ */ r.createElement(it, { className: `forecasting-areas-combo-${k}`, key: `forecasting-areas--stage-${h.key.replaceAll(" ", "-")}-${k}` }, (B = F.confidenceIntervals) == null ? void 0 : B.map((q, U) => {
      ...
      if (!(q.high === "" || q.low === ""))
        return /* @__PURE__ */ r.createElement(it, { key: `forecasting-areas--stage-${h.key.replaceAll(" ", "-")}--group-${L}-${U}` }, /* @__PURE__ */ r.createElement(
          v0,
          {
            curve: Mu,
            data: C,
...
function Xf({ config: e, yMax: t = 0, data: n = [], updateConfig: a }) {
  ...
  const f = (k) => {
    if (!k)
      return [0];
    let h = [];
    return k.map((L, O) => h = [...h, ...n.map((C) => Number(C[L]))]), h;
  };
...
const RE = (e, t, n, a) => {
  ...
  const { config: t, d: n, tableData: a, displayArea: i, seriesKey: l, tooltipData: d, xScale: f, yScale: u, colorScale: m, parseDate: y, yScaleRight: x, data: S, circleData: R, dataIndex: T, mode: F } = e, { lineDatapointStyle: k } = t, h = (C = t == null ? void 0 : t.series.filter((V) => V.dataKey === l)) == null ? void 0 : C[0], L = (V, Y, J, Z, ae) => {
  ...
  const {
    ...
    yMax: m,
    yScale: y
  } = e, { colorScale: x, config: S, formatNumber: R, handleLineType: T, isNumber: F, parseDate: k, seriesHighlight: h, tableData: L, transformedData: O, updateConfig: C, brushConfig: N, clean: _ } = ce.useContext(Et), { yScaleRight: B } = Xf({ config: S, yMax: m, data: O, updateConfig: C });
  if (!l)
    return;
  ...
  return N.data.length > 0 && ((Y = S.brush) != null && Y.active) && (re = _(N.data), V = _(N.data)), /* @__PURE__ */ r.createElement(Or, { component: "LineChart" }, /* @__PURE__ */ r.createElement(it, { left: Number(S.runtime.yAxis.size) }, " ", (S.runtime.lineSeriesKeys || S.runtime.seriesKeys).map((J, Z) => {
    ...
    const W = RE(L, J, S.preliminaryData, S.xAxis.dataKey);
  ...
  const { lower: L, upper: O } = (e == null ? void 0 : e.confidenceKeys) || {};
  if (L && O && e.visualizationType === "Bar") {
    const C = f < 0 ? 1.1 : 0;
    u = Math.max(n, Math.max(...i.flatMap((N) => [N[O], N[L]])) * 1.15), f = Math.min(t, Math.min(...i.flatMap((N) => [N[O], N[L]])) * 1.15) * C;
  }
  ...
  let L = null, O = null, C = null, N = null, _ = null, B = null, q = null, U = $n({
    domain: [0, 100],
    range: [0, n]
  });
  if (T && (L = FE({ min: i * 1.03, ...e }), L.type = d.useLogScale ? Vr.LOG : Vr.LINEAR, O = zE(R, t), O.rangeRound([0, a]), _ = _h(S, [0, a])), T || (q = _h(k, [0, n], 0.5), L = Du(t, [0, n], 1 - d.barThickness), O = ME(e), _ = Du(S, [0, L.bandwidth()], 0)), d.xAxis.type === "date" && !T) {
    const ne = t ? t.sort() : [];
    L = Du(ne, [0, n], 1 - d.barThickness);
  }
  if (d.xAxis.type === "date-time") {
    let ne = Math.min(...t), re = Math.max(...t);
    ne -= (d.xAxis.padding ? d.xAxis.padding * 0.01 : 0) * (re - ne), re += (d.xAxis.padding ? d.xAxis.padding * 0.01 : 0) * (re - ne), L = Wg({
      domain: [ne, re],
      range: [0, n]
    }), L.type = Vr.TIME;
  ...
  if (d.visualizationType === "Scatter Plot" && d.xAxis.type === "continuous" && (L = $n({
  ...
  if (h === "Forest Plot") {
    ...
    if (y > 480) {
      if (d.forestPlot.type === "Linear" && (L = $n({
    ...
    } else if (d.forestPlot.type === "Linear" && (L = $n({
      domain: [Math.min(...f.map((ae) => parseFloat(ae[d.forestPlot.lower]))) - re, Math.max(...f.map((ae) => parseFloat(ae[d.forestPlot.upper]))) + re],
      range: [Z, n - J],
      type: Vr.LINEAR
  ...
  return { xScale: L, yScale: O, seriesScale: _, g1xScale: N, g2xScale: C, xScaleNoPadding: B, xScaleBrush: q, xScaleAnnotation: U };
}, OE = (e, t, n) => {
  const a = t.domain();
  if (t.type === "time") {
...
const Ts = () => {
  const { config: e } = ce.useContext(Et), { visualizationType: t, series: n, orientation: a, visualizationSubType: i } = e, l = [
    ...
    if ((t === "Bar" || "Combo") && i === "regular")
      return !0;
  }, h = () => ["Line", "Bar", "Area Chart", "Combo"].includes(t) && a === "vertical", L = () => ["Box Plot", "Scatter Plot", "Pie", "Line"].includes(t) ? !1 : n == null ? void 0 : n.some((Ie) => Ie.type === "Bar" || Ie.type === "Paired Bar" || Ie.type === "Deviation Bar"), O = () => {
    switch (t) {
      case "Sankey":
        return !1;
      case "Forest Plot":
  ...
  const { xAxis: f, visualizationType: u, orientation: m } = a, y = (k, h, L, O, C) => {
    let N = [];
    a.xAxis.type === "date-time" && (h = new Date(h), L = new Date(L), O = O.map((q) => new Date(q)), N = C.ticks().map((q) => new Date(q)));
    const _ = (k - h) / (L - h), B = Math.round(_ * (O.length - 1));
    return a.xAxis.type === "date-time" ? N[B] : O[B];
  }, S = ((k, h = !1) => {
    if (u !== "Pie" && m !== "horizontal") {
      if (a.xAxis.type === "date-time") {
        const L = new Date(t.invert(k)), O = a.data.map((_) => new Date(_[a.xAxis.dataKey]).getTime());
        let C = 1 / 0, N = null;
        return O.forEach((_) => {
...
const VE = ({ xScale: e, yScale: t, xScaleAnnotation: n, xMax: a, svgRef: i, onDragStateChange: l }) => {
  ...
  return R && R.map((h, L) => {
    ...
    return /* @__PURE__ */ r.createElement(
      k,
      {
        ...
        onDragEnd: (B) => {
          ...
          if (h.x === n.invert(B.x) && h.y === B.y)
            ...
            q[L] = { ...q[L], x: n.invert(e(U.x)), y: t(U.y) };
          } else
            q[L] = { ...q[L], x: n.invert(B.x), y: B.y };
          S({
            ...d,
            annotations: q
          });
      ...
      h.marker === "circle" && /* @__PURE__ */ r.createElement(Yy, { id: `marker-start--${L}`, className: "circle-subject", stroke: F(h.seriesKey), radius: 8 }),
      h.marker === "arrow" && /* @__PURE__ */ r.createElement(Mh, { fill: "black", id: `marker-start--${L}`, x: C, y: h.y, stroke: "#333", markerWidth: 10, size: 10, strokeWidth: 1, orient: "auto-start-reverse", markerUnits: "userSpaceOnUse" }),
      ...
      /* @__PURE__ */ r.createElement("text", { height: 16, x: C + h.dx, y: h.y + h.dy, className: "annotation__mobile-label", alignmentBaseline: "middle", textAnchor: "middle" }, L + 1)
    );
  });
};
...
const UE = () => {
  ...
  } = ce.useContext(Et), { visualizationType: k, visualizationSubType: h, orientation: L, xAxis: O, yAxis: C, runtime: N, debugSvg: _ } = n, B = () => Lc(n.visualizationType, R, n.allowLineToBarGraph);
  let [q] = i;
  n && n.legend && !n.legend.hide && ((Vn = n.legend) == null ? void 0 : Vn.position) !== "bottom" && ["lg", "md"].includes(a) && (q = q * 0.73);
  const { horizontal: U } = n.heights, ne = L === "horizontal" || n.visualizationType === "Forest Plot", re = !0, V = isNaN(parseInt(N.xAxis.labelOffset)) ? 0 : parseInt(N.xAxis.labelOffset), Y = isNaN(parseInt(N.yAxis.labelOffset)) ? 0 : parseInt(N.yAxis.labelOffset), J = isNaN(parseInt(N.xAxis.size)) ? 0 : parseInt(N.xAxis.size);
  let Z = n.aspectRatio ? q * n.aspectRatio : n.visualizationType === "Forest Plot" ? n.heights.vertical : n.heights[L];
  Z = Number(Z);
  const ae = q - N.yAxis.size - (k === "Combo" ? n.yAxis.rightAxisSize : 0);
  let te = Z - (L === "horizontal" ? 0 : J);
  Z += L === "horizontal" ? J : 0, n.visualizationType === "Forest Plot" && (Z = Z + n.data.length * n.forestPlot.rowHeight, te = te + n.data.length * n.forestPlot.rowHeight, q = i[0]), (Cn = n.brush) != null && Cn.active && (Z = Z + ((Sn = n.brush) == null ? void 0 : Sn.height));
  ...
  const Kt = (Ne, ut) => {
    if (n.useLogScale && Ne === 0.1 && (Ne = 0), !(n.data && !n.data[ut] && k === "Forest Plot"))
      return n.visualizationType === "Forest Plot" ? n.data[ut][n.xAxis.dataKey] : wn(N.yAxis) ? l(x(Ne)) : L === "vertical" && qe - Ie < 3 ? d(Ne, "left", re, !1, !1, "1") : L === "vertical" ? d(Ne, "left", re) : Ne;
  }, Jt = (Ne) => (n.useLogScale && Ne === 0.1 && (Ne = 0), wn(N.xAxis) && n.visualizationType !== "Forest Plot" ? l(Ne) : L === "horizontal" && n.visualizationType !== "Forest Plot" ? d(Ne, "left", re) : n.xAxis.type === "continuous" && n.visualizationType !== "Forest Plot" ? d(Ne, "bottom", re) : n.visualizationType === "Forest Plot" ? d(Ne, "left", n.dataFormat.abbreviated, n.runtime.xAxis.prefix, n.runtime.xAxis.suffix, Number(n.dataFormat.roundTo)) : Ne), Yt = (Ne) => {
  ...
  }, { tooltipData: At, showTooltip: zt, hideTooltip: Vt, tooltipOpen: $e, tooltipLeft: en, tooltipTop: wt } = Gm(), {
    handleTooltipMouseOver: $t,
  ...
  }, jt = Number(L === "horizontal" ? n.xAxis.size : n.yAxis.size), Tn = { small: 16, medium: 18, large: 20 }, Hn = () => n.visualizationType === "Forest Plot" ? n.data.length : Yt("yAxis"), Mn = () => {
  ...
  return isNaN(q) ? /* @__PURE__ */ r.createElement(r.Fragment, null) : /* @__PURE__ */ r.createElement(Or, { component: "LinearChart" }, /* @__PURE__ */ r.createElement("div", { style: { width: `${q}px`, overflow: "visible" }, className: "tooltip-boundary" }, /* @__PURE__ */ r.createElement(
    ...
    " ",
    !["Spark Line", "Forest Plot"].includes(k) && /* @__PURE__ */ r.createElement(JS, { scale: we, tickLength: n.useLogScale ? 6 : 8, left: Number(N.yAxis.size) - n.yAxis.axisPadding, label: N.yAxis.label || N.yAxis.label, stroke: "#333", tickFormat: (Ne, ut) => Kt(Ne, ut), numTicks: Hn() }, (Ne) => {
      ...
      return /* @__PURE__ */ r.createElement(it, { className: "left-axis" }, Ne.ticks.map(($, Me) => {
        const Ye = Ne.ticks[0].to.y, He = 15, nt = String($.value).startsWith("1") || $.value === 0.1 ? "block" : "none", at = nt === "block" ? 7 : 0, kt = { x: $.to.x - at, y: $.to.y }, Lt = $.index !== 0 || n.xAxis.hideAxis;
        return /* @__PURE__ */ r.createElement(it, { key: `vx-tick-${$.value}-${Me}`, className: "vx-axis-tick" }, !N.yAxis.hideTicks && /* @__PURE__ */ r.createElement(un, { key: `${$.value}--hide-hideTicks`, from: $.from, to: n.useLogScale ? kt : $.to, stroke: n.yAxis.tickColor, display: L === "horizontal" ? "none" : "block" }), N.yAxis.gridLines && Lt ? /* @__PURE__ */ r.createElement(un, { key: `${$.value}--hide-hideGridLines`, display: (n.useLogScale && nt).toString(), from: { x: $.from.x + ae, y: $.from.y }, to: $.from, stroke: "rgba(0,0,0,0.3)" }) : "", L === "horizontal" && h !== "stacked" && n.yAxis.labelPlacement === "On Date/Category Axis" && !n.yAxis.hideLabel && /* @__PURE__ */ r.createElement(
          St,
          {
            transform: `translate(${$.to.x - 5}, ${n.isLollipopChart ? $.to.y - Ye : $.to.y - Ye + (Number(n.barHeight * n.series.length) - He) / 2}) rotate(-${n.runtime.horizontal && n.runtime.yAxis.tickRotation || 0})`,
            verticalAnchor: "start",
            textAnchor: "end"
          },
          $.formattedValue
        ), L === "horizontal" && h === "stacked" && n.yAxis.labelPlacement === "On Date/Category Axis" && !n.yAxis.hideLabel && /* @__PURE__ */ r.createElement(St, { transform: `translate(${$.to.x - 5}, ${$.to.y - Ye + (Number(n.barHeight) - He) / 2}) rotate(-${N.horizontal ? N.yAxis.tickRotation : 0})`, verticalAnchor: "start", textAnchor: "end" }, $.formattedValue), L === "horizontal" && k === "Paired Bar" && !n.yAxis.hideLabel && /* @__PURE__ */ r.createElement(St, { transform: `translate(${$.to.x - 5}, ${$.to.y - Ye + Number(n.barHeight) / 2}) rotate(-${N.horizontal ? N.yAxis.tickRotation : 0})`, textAnchor: "end", verticalAnchor: "middle" }, $.formattedValue), L === "horizontal" && k === "Deviation Bar" && !n.yAxis.hideLabel && /* @__PURE__ */ r.createElement(St, { transform: `translate(${$.to.x - 5}, ${n.isLollipopChart ? $.to.y - Ye + 2 : $.to.y - Ye + Number(n.barHeight) / 2}) rotate(-${N.horizontal ? N.yAxis.tickRotation : 0})`, textAnchor: "end", verticalAnchor: "middle" }, $.formattedValue), L === "vertical" && k !== "Paired Bar" && !n.yAxis.hideLabel && /* @__PURE__ */ r.createElement(
          St,
          {
    ...
    k !== "Paired Bar" && k !== "Spark Line" && /* @__PURE__ */ r.createElement(
      zu,
      {
        ...
        numTicks: Yt("xAxis"),
        tickStroke: "#333",
        tickValues: n.xAxis.manual ? OE(de, _e, n.xAxis.type === "date-time" ? Yt("xAxis") : Mn()) : void 0
      },
      (Ne) => {
        const ut = n.visualizationType !== "Forest Plot" ? (Ne.axisToPoint.x - Ne.axisFromPoint.x) / 2 : i[0] / 2, ft = (gt) => /\s/.test(gt), $ = Ne.ticks.some((gt) => ft(gt.value)), Me = 8, Ye = Math.max(...Ne.ticks.map((gt) => f(gt.formattedValue, `normal ${Tn[n.fontSize]}px sans-serif`))), He = $ ? 180 : 100, nt = Ne.ticks.map((gt) => f(gt.formattedValue, `normal ${Tn[n.fontSize]}px sans-serif`)), at = nt.reduce((gt, Rt) => gt + Rt, He), kt = (ae - at) / (Ne.ticks.length - 1);
        let Lt = [0];
        ...
        const Mt = Ke && n.isResponsiveTicks ? Ye + Me + 20 : 0;
        Number(n.xAxis.tickRotation) > 0 && Number(n.xAxis.tickRotation), n.dynamicMarginTop = Mt, n.xAxis.tickWidthMax = Ye;
        let It = 40;
        const Bt = /* @__PURE__ */ r.createElement(it, { className: "bottom-axis", width: i[0] }, Ne.ticks.map((gt, Rt, Nt) => {
          ...
          return mn > It && (It = mn), /* @__PURE__ */ r.createElement(it, { key: `vx-tick-${gt.value}-${Rt}`, className: "vx-axis-tick" }, !n.xAxis.hideTicks && /* @__PURE__ */ r.createElement(un, { from: gt.from, to: L === "horizontal" && n.useLogScale ? pn : gt.to, stroke: n.xAxis.tickColor, strokeWidth: Ot === "block" && n.useLogScale ? 1.3 : 1 }), !n.xAxis.hideLabel && /* @__PURE__ */ r.createElement(
            St,
            {
        ...
        }), !n.xAxis.hideAxis && /* @__PURE__ */ r.createElement(un, { from: Ne.axisFromPoint, to: Ne.axisToPoint, stroke: "#333" }), /* @__PURE__ */ r.createElement(St, { x: ut, y: It + 20 + V, textAnchor: "middle", verticalAnchor: "start", fontWeight: "bold", fill: n.xAxis.labelColor }, Ne.label));
        return Ae.current && Ae.current.setAttribute("height", Number(Z) + Number(It) + (N.xAxis.label ? 50 : 0) + "px"), Bt;
      }
    ),
    k === "Paired Bar" && Wn(),
    ...
    (k === "Area Chart" && n.visualizationSubType === "regular" || k === "Combo") && /* @__PURE__ */ r.createElement(fE, { xScale: _e, yScale: we, yMax: te, xMax: ae, chartRef: Ae, width: ae, height: te, handleTooltipMouseOver: $t, handleTooltipMouseOff: tn, tooltipData: At, showTooltip: zt }),
    (k === "Area Chart" && n.visualizationSubType === "stacked" || k === "Combo") && /* @__PURE__ */ r.createElement(hE, { xScale: _e, yScale: we, yMax: te, xMax: ae, chartRef: Ae, width: ae, height: te, handleTooltipMouseOver: $t, handleTooltipMouseOff: tn, tooltipData: At, showTooltip: zt }),
    ...
    n.yAxis.anchors && n.yAxis.anchors.map((Ne, ut) => {
      ...
      if (!Ne.value)
        return;
      const $ = L === "horizontal" && k === "Bar" ? n.barHeight / 4 : 0;
      if (ft)
        return (
          // prettier-ignore
          /* @__PURE__ */ r.createElement(
    ...
    n.visualizationType !== "Bar" && n.visualizationType !== "Combo" && /* @__PURE__ */ r.createElement(Yf, { xScale: _e, handleTooltipClick: pt, handleTooltipMouseOff: tn, handleTooltipMouseOver: $t, showTooltip: zt, hideTooltip: Vt, tooltipData: At, yMax: te, width: q }),
    Xt && zt && At && n.visual.verticalHoverLine && /* @__PURE__ */ r.createElement(it, { key: "tooltipLine-vertical", className: "vertical-tooltip-line" }, /* @__PURE__ */ r.createElement(un, { from: { x: At.dataXPosition - 10, y: 0 }, to: { x: At.dataXPosition - 10, y: te }, stroke: "black", strokeWidth: 1, pointerEvents: "none", strokeDasharray: "5,5", className: "vertical-tooltip-line" })),
    Xt && zt && At && n.visual.horizontalHoverLine && /* @__PURE__ */ r.createElement(it, { key: "tooltipLine-horizontal", className: "horizontal-tooltip-line", left: n.yAxis.size ? n.yAxis.size : 0 }, /* @__PURE__ */ r.createElement(un, { from: { x: 0, y: At.dataYPosition }, to: { x: ae, y: At.dataYPosition }, stroke: "black", strokeWidth: 1, pointerEvents: "none", strokeDasharray: "5,5", className: "horizontal-tooltip-line" })),
...
const KE = (e) => {
  ...
  let x = Number(t);
  const { minValue: S, maxValue: R } = Pc(i, a), T = { top: 5, right: 10, bottom: 10, left: 10 }, F = Number(n), k = x - i.runtime.yAxis.size, h = F - T.top - 20, L = (V) => i.runtime.xAxis.type === "date" ? l(V[i.runtime.originalXAxis.dataKey]).getTime() : V[i.runtime.originalXAxis.dataKey], O = (V, Y) => V[Y];
  let C, N;
  ...
  return /* @__PURE__ */ r.createElement(Or, { component: "SparkLine" }, /* @__PURE__ */ r.createElement("svg", { role: "img", "aria-label": y(i), width: t, height: 100, className: "sparkline", tabIndex: 0 }, /* @__PURE__ */ r.createElement("title", null, `Spark line graphic with the title ${i.title ? i.title : "No Title Found"}`), ((re = i.runtime.lineSeriesKeys) == null ? void 0 : re.length) > 0 ? i.runtime.lineSeriesKeys : i.runtime.seriesKeys.map((V, Y) => /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(
    ...
    a.map((J, Z) => /* @__PURE__ */ r.createElement(it, { key: `series-${V}-point-${Z}` }, /* @__PURE__ */ r.createElement(St, { display: i.labels ? "block" : "none", x: C(L(J)), y: N(O(J, V)), fill: m ? m(i.runtime.seriesLabels ? i.runtime.seriesLabels[V] : V) : "#000", textAnchor: "middle" }, u(J[V])))),
    /* @__PURE__ */ r.createElement(
      Nr,
      {
        curve: xc,
  ...
  return /* @__PURE__ */ r.createElement(r.Fragment, null, e.regions && e.regions.map(({ label: u, color: m, from: y, to: x, background: S, range: R = "Custom" }, T) => {
    ...
    ), (e.regions[T].toType === "Fixed" || !e.regions[T].toType) && /* @__PURE__ */ r.createElement(et, { value: x, label: "To Value", fieldName: "to", updateField: (k, h, L, O) => n(L, O, T) }));
...
const mk = (e) => {
  ...
  const { updateConfig: t, config: n, unfilteredData: a, dimensions: i, isDraggingAnnotation: l } = ce.useContext(Et), d = (S, R, T) => {
    var L;
    const F = (L = document.querySelector(".chart-container > div > svg")) == null ? void 0 : L.getBoundingClientRect(), k = [F.width, F.height], h = [...n == null ? void 0 : n.annotations];
  ...
  return /* @__PURE__ */ r.createElement(gu, { key: e.name }, /* @__PURE__ */ r.createElement(gu.Section, { title: e.name, key: e.name }, /* @__PURE__ */ r.createElement("label", { key: "key-1" }, "Show Annotation Dropdown", /* @__PURE__ */ r.createElement(
    ...
    return /* @__PURE__ */ r.createElement(gu, { key: R }, /* @__PURE__ */ r.createElement(gu.Section, { title: S.text ? S.text.substring(0, 15) + "..." : `Annotation ${R + 1}` }, /* @__PURE__ */ r.createElement("div", { className: "annotation-group" }, /* @__PURE__ */ r.createElement("label", null, "Annotation Text:", /* @__PURE__ */ r.createElement("textarea", { rows: 5, value: S.text, onChange: (_) => d(_.target.value, "text", R) })), /* @__PURE__ */ r.createElement("label", null, "Opacity", /* @__PURE__ */ r.createElement("br", null), /* @__PURE__ */ r.createElement(
      ...
      {
        type: "checkbox",
        checked: ((O = (L = n == null ? void 0 : n.annotations[R]) == null ? void 0 : L.edit) == null ? void 0 : O.label) || !1,
        onChange: (_) => {
          const B = hr.cloneDeep(n == null ? void 0 : n.annotations);
...
const yk = ({ config: e, updateConfig: t, data: n }) => {
  ...
  return /* @__PURE__ */ r.createElement(r.Fragment, null, e.preliminaryData && ((L = e.preliminaryData) == null ? void 0 : L.map(({ circleSize: O, column: C, displayLegend: N, displayTable: _, displayTooltip: B, label: q, seriesKey: U, style: ne, symbol: re, type: V, value: Y, hideBarSymbol: J, hideLineStyle: Z }, ae) => {
    var te, se;
  ...
  const { hasRightAxis: Yt } = Xf({ config: e, yMax: e.yAxis.size, data: e.data, updateConfig: t }), At = (oe, le) => ({
    ...le
  }), zt = {
    animate: !1,
    animateReplay: !0,
    ...
    let dr = { ...e, [oe]: kn };
    Vt(dr), t(dr);
  }, [en, wt] = ce.useState(!0), [$t, pt] = ce.useState(!1);
  if (i)
    return null;
  ce.useEffect(() => {
    var oe;
  ...
  const Me = (oe) => {
    ...
    return Bt ? oe : Xt(!1).filter((le) => le !== e.xAxis.dataKey);
  }, Rt = (oe) => {
  ...
  return /* @__PURE__ */ r.createElement(Gf.Provider, { value: Gt }, /* @__PURE__ */ r.createElement(Or, { component: "EditorPanel" }, /* @__PURE__ */ r.createElement(Ud.Sidebar, { displayPanel: en, isDashboard: y, title: "Configure Chart", onBackClick: Hn }, /* @__PURE__ */ r.createElement(Pi, { allowZeroExpanded: !0 }, /* @__PURE__ */ r.createElement(ua.General, { name: "General" }), /* @__PURE__ */ r.createElement(ua.ForestPlot, { name: "Forest Plot Settings" }), /* @__PURE__ */ r.createElement(ua.Sankey, { name: "Sankey" }), e.visualizationType !== "Pie" && e.visualizationType !== "Forest Plot" && e.visualizationType !== "Sankey" && /* @__PURE__ */ r.createElement(Pn, null, /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Dn, null, "Data Series ", (!e.series || e.series.length === 0 || e.visualizationType === "Paired Bar" && e.series.length < 2) && /* @__PURE__ */ r.createElement($u, { width: "25", className: "warning-icon" }))), /* @__PURE__ */ r.createElement(_n, null, (!e.series || e.series.length === 0) && e.visualizationType !== "Paired Bar" && /* @__PURE__ */ r.createElement("p", { className: "warning" }, "At least one series is required"), (!e.series || e.series.length === 0 || e.series.length < 2) && e.visualizationType === "Paired Bar" && /* @__PURE__ */ r.createElement("p", { className: "warning" }, "Select two data series for paired bar chart (e.g., Male and Female)."), /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(
  ...
  ), /* @__PURE__ */ r.createElement("div", { className: "viewport-overrides" }, /* @__PURE__ */ r.createElement("label", null, /* @__PURE__ */ r.createElement("button", { onClick: () => pt(!$t), className: "edit-label" }, "Step Count: viewport overrides ", /* @__PURE__ */ r.createElement("span", { style: { transform: `rotate(${$t ? "90deg" : "0deg"})` } }, ">"))), $t && /* @__PURE__ */ r.createElement("div", { className: "edit-block" }, Object.keys(Qf).map((oe) => /* @__PURE__ */ r.createElement(
    et,
    {
  ...
  ), /* @__PURE__ */ r.createElement("div", { className: "viewport-overrides" }, /* @__PURE__ */ r.createElement("label", null, /* @__PURE__ */ r.createElement("button", { onClick: () => pt(!$t), className: "edit-label" }, "Number of ticks: viewport overrides ", /* @__PURE__ */ r.createElement("span", { style: { transform: `rotate(${$t ? "90deg" : "0deg"})` } }, ">"))), $t && /* @__PURE__ */ r.createElement("div", { className: "edit-block" }, Object.keys(Qf).map((oe) => /* @__PURE__ */ r.createElement(
    et,
    {
    ...
    "button",
    {
      ...
      onClick: (ye) => {
        ...
        Oe.splice(le, 1), $e("legend", null, "seriesHighlight", Oe), Oe.length || L();
      }
    },
    "Remove"
  ), /* @__PURE__ */ r.createElement(
...
function Jk({ configUrl: e, config: t, isEditor: n = !1, isDebug: a = !1, isDashboard: i = !1, setConfig: l, setEditing: d, hostname: f, link: u, setSharedFilter: m, setSharedFilterValue: y, dashboardConfig: x }) {
  ...
  const { barBorderClass: Le, lineDatapointClass: ke, contentClasses: Ie, sparkLineStyles: qe } = dg(h), Qe = ce.useId(), mt = () => Lc(h.visualizationType, B, h.allowLineToBarGraph), tt = async () => {
    ...
    if (h.dataUrl) {
      ...
      let Ye = Object.fromEntries(new URLSearchParams(Me.search)), He = !1;
      if (($ = h.filters) == null || $.forEach((kt) => {
        kt.type === "url" && Ye[kt.queryParameter] !== decodeURIComponent(kt.active) && (Ye[kt.queryParameter] = kt.active, He = !0);
      }), (!h.formattedData || h.formattedData.urlFiltered) && !He)
        return;
    ...
    let He = { ...jd, ...$ };
    He.filters && He.filters.forEach((at, kt) => {
      const Lt = My(at);
      Lt && (He.filters[kt].active = Lt);
    }), He.visualizationType === "Box Plot" && (He.legend.hide = !0), He.table.show === void 0 && (He.table.show = !i), He.series.forEach((at) => {
      (at.tooltip === void 0 || at.tooltip === null) && (at.tooltip = !0), at.axis || (at.axis = "Left");
    }), Me && (He.data = Me);
    const nt = { ...await zy(He) };
    _e(nt, Me);
  }, _e = ($, Me) => {
    var at, kt, Lt;
    let Ye = Me || O;
    ...
    if ($.exclusions && $.exclusions.active)
      if ($.xAxis.type === "categorical" && ((at = $.exclusions.keys) == null ? void 0 : at.length) > 0)
        He = Ye.filter((Ke) => !$.exclusions.keys.includes(Ke[$.xAxis.dataKey]));
      else if (wn($.xAxis) && ($.exclusions.dateStart || $.exclusions.dateEnd) && $.xAxis.dateParseFormat) {
        const Ke = (Rt) => new Date(Rt).getTime();
        let Mt = Ke($.exclusions.dateStart), It = Ke($.exclusions.dateEnd) + 86399999, Bt = typeof Mt !== void 0 && isNaN(Mt) === !1, gt = typeof It !== void 0 && isNaN(It) === !1;
        Bt && gt ? He = Ye.filter((Rt) => Ke(Rt[$.xAxis.dataKey]) >= Mt && Ke(Rt[$.xAxis.dataKey]) <= It) : Bt ? He = Ye.filter((Rt) => Ke(Rt[$.xAxis.dataKey]) >= Mt) : gt && (He = Ye.filter((Rt) => Ke(Rt[$.xAxis.dataKey]) <= It));
      } else
        He = Me || O;
    else
      He = Me || O;
    _(He);
    let nt = [];
    if ($.filters && ($.filters.forEach((Ke, Mt) => {
      let It = [];
      It = Ke.orderedValues || we(Ke.columnName, He).sort(Ke.order === "desc" ? bk : xk), $.filters[Mt].values = It, $.filters[Mt].active = !$.filters[Mt].active || It.indexOf($.filters[Mt].active) === -1 ? It[0] : $.filters[Mt].active, $.filters[Mt].filterStyle = $.filters[Mt].filterStyle ? $.filters[Mt].filterStyle : "dropdown";
    }), nt = bi($.filters, He), q(nt)), $.xAxis.type === "date-time" && h.orientation === "horizontal" && ($.xAxis.type = "date"), $.runtime = {}, $.runtime.seriesLabels = {}, $.runtime.seriesLabelsAll = [], $.runtime.originalXAxis = $.xAxis, $.visualizationType === "Pie" ? ($.runtime.seriesKeys = (Me || Ye).map((Ke) => Ke[$.xAxis.dataKey]), $.runtime.seriesLabelsAll = $.runtime.seriesKeys) : $.runtime.seriesKeys = $.series ? $.series.map((Ke) => ($.runtime.seriesLabels[Ke.dataKey] = Ke.name || Ke.label || Ke.dataKey, $.runtime.seriesLabelsAll.push(Ke.name || Ke.dataKey), Ke.dataKey)) : [], $.visualizationType === "Box Plot" && $.series) {
      let Ke = He ? He.map((Nt) => Nt[$.xAxis.dataKey]) : Ye.map((Nt) => Nt[$.xAxis.dataKey]), Mt = He ? He.map((Nt) => {
        var Ot;
      ...
      Bt.forEach((Nt) => {
        try {
          ...
          let Ot = He ? He.filter((j) => j[$.xAxis.dataKey] === Nt) : Ye.filter((j) => j[$.xAxis.dataKey] === Nt), Gt = Ot.map((j) => {
            var be;
      ...
      }), gt = JSON.parse(JSON.stringify(Rt)), gt.map((Nt) => (Nt.columnIqr = void 0, Nt.nonOutlierValues = void 0, Nt.columnLowerBounds = void 0, Nt.columnUpperBounds = void 0, null)), $.boxplot.allValues = Mt, $.boxplot.categories = Bt, $.boxplot.plots = Rt, $.boxplot.tableData = gt;
    }
    ...
    let Ye = h.visualizationType === "Bar" && h.visualizationSubType === "horizontal" ? h.xAxis.dataKey : h.yAxis.sortKey, He = parseFloat($[Ye]), nt = parseFloat(Me[Ye]);
    return He < nt ? h.sortData === "ascending" ? 1 : -1 : He > nt ? h.sortData === "ascending" ? -1 : 1 : 0;
  }, Ge = new Ry(($) => {
    for (let Me of $) {
      let { width: Ye, height: He } = Me.contentRect, nt = Dy(Ye), at = 32, kt = 350;
      V(nt), n && (Ye = Ye - kt), Me.target.dataset.lollipop === "true" && (Ye = Ye - 2.5), Ye = Ye - at, J([Ye, He]);
    }
  }), dt = ce.useCallback(($) => {
    $ !== null && Ge.observe($), se($);
  }, []);
  ...
  ce.useEffect(() => {
    ...
    if (Z && Z[0] && !Z[0].hasOwnProperty("active")) {
      let Me = { ...h };
      delete Me.filters, L(Me), q(bi(Z, N));
    }
    ...
    if (O && h.xAxis && (($ = h.runtime) != null && $.seriesKeys)) {
      ...
      let He = h.customColors || Ye[Me], nt = h.runtime.seriesKeys.length, at;
      for (; nt > He.length; )
        He = He.concat(He);
      He = He.slice(0, nt), at = () => Ho({
  ...
  const yt = ($) => {
    ...
    const Me = [...U];
    let Ye = $.datum;
    h.runtime.seriesLabels && h.runtime.seriesKeys.forEach((He) => {
      h.runtime.seriesLabels[He] === $.datum && (Ye = He);
  ...
  }, Kt = ($) => Xd(h.runtime[an].dateDisplayFormat)($), Jt = ($) => Xd(h.tooltips.dateDisplayFormat)($);
  function Yt($, Me) {
    ...
    return He.font = Me || getComputedStyle(document.body).font, Math.ceil(He.measureText($).width);
  }
  const At = ($, Me, Ye = !1, He, nt, at) => {
    if (isNaN($) || !$)
      return $;
    const kt = $ < 0;
    (Me === void 0 || !Me) && (Me = "left"), kt && ($ = Math.abs($));
    let {
      dataFormat: { commas: Lt, abbreviated: Ke, roundTo: Mt, prefix: It, suffix: Bt, rightRoundTo: gt, bottomRoundTo: Rt, rightPrefix: Nt, rightSuffix: Ot, bottomPrefix: Gt, bottomSuffix: pn, bottomAbbreviated: Nn }
    } = h;
    ...
    if (Me === "left" || Me === void 0) {
      let En;
      at !== void 0 ? En = at ? Number(at) : 0 : En = Mt ? Number(Mt) : 0, ln = {
    ...
    let cn = "";
    return Ke && Me === "left" && Ye && ($ = Nh(parseFloat($))), Nn && Me === "bottom" && Ye && ($ = Nh(parseFloat($))), He && Me === "left" ? cn = He + cn : It && Me === "left" && (cn += It), Nt && Me === "right" && (cn += Nt), Gt && Me === "bottom" && (cn += Gt), cn += $, nt && Me === "left" ? cn += nt : Bt && Me === "left" && (cn += Bt), Ot && Me === "right" && (cn += Ot), pn && Me === "bottom" && (cn += pn), kt && (cn = "-" + cn), String(cn);
  }, zt = {
    ...
    if (Object.keys(h.columns).length > 0 && Object.keys(h.columns).forEach(function(nt) {
      var at = h.columns[nt];
      at.name === Me && (He = at);
    }), He === void 0 && (He = h.type === "chart" ? h.dataFormat : h.primary, He.useCommas = He.commas, He.roundToPlace = He.roundTo ? He.roundTo : ""), He) {
      let nt = !1, at = 0;
      Number($) && (He.roundToPlace >= 0 && (nt = He.roundToPlace ? He.roundToPlace !== "" || He.roundToPlace !== null : !1, at = He.roundToPlace ? Number(He.roundToPlace) : 0, He.hasOwnProperty("roundToPlace") && nt && (Ye = Number($).toFixed(at))), He.hasOwnProperty("useCommas") && He.useCommas === !0 && (Ye = Number($).toLocaleString("en-US", {
        style: "decimal",
        minimumFractionDigits: nt ? at : 0,
        maximumFractionDigits: nt ? at : 5
      }))), Ye = (He.prefix || "") + Ye + (He.suffix || "");
    }
    return Ye;
  }, en = () => {
    const $ = (Ye) => {
