...
const R = ({ currentOptions: r = [], label: f, handleSubGroupSelect: y, userSelectedLabel: E, userSearchTerm: N }) => {
  ...
  }, [r, r.subGrouping]), N = r.active, o = ((C = r.subGrouping) == null ? void 0 : C.active) ?? "", [c, w] = u.useState(""), [v, k] = u.useState(o !== "" ? `${N} - ${o}` : ""), [n, i] = u.useState(!1), [p, l] = u.useState(!1), d = u.useRef(null), A = u.useRef(null), F = (a, t) => {
    d.current.focus();
    const s = `${a} - ${t}`;
    w(""), l(!1), k(s), y([a, t]);
  }, K = (a) => {
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement("div", { id: "nested-dropdown-container", className: "nested-dropdown", onKeyUp: K }, /* @__PURE__ */ e.createElement("div", { className: "nested-dropdown-input-container", "aria-label": "searchInput", role: "textbox" }, /* @__PURE__ */ e.createElement(
    "input",
    {
