...
function Ku() {
  ...
  function s() {
    ...
    if (o || (o = u = Sa()), m < h && (d = m, m = h, h = d), !(m > xt))
      ...
      if (z > xt) {
        var I = m * fn(b), Z = m * Wt(b), U = h * fn(x), ce = h * Wt(x), de;
        if (v < Vn && (de = Hu(P, V, U, ce, I, Z, q, j))) {
          var he = P - de[0], we = V - de[1], Te = I - de[0], ke = Z - de[1], ee = 1 / Wt(zu((he * Te + we * ke) / (zn(he * he + we * we) * zn(Te * Te + ke * ke))) / 2), K = zn(de[0] * de[0] + de[1] * de[1]);
          $ = Bi(z, (h - K) / (ee - 1)), C = Bi(z, (m - K) / (ee + 1));
        }
      }
      A > xt ? C > xt ? (k = Ma(U, ce, P, V, m, C, g), _ = Ma(I, Z, q, j, m, C, g), o.moveTo(k.cx + k.x01, k.cy + k.y01), C < z ? o.arc(k.cx, k.cy, C, gt(k.y01, k.x01), gt(_.y01, _.x01), !g) : (o.arc(k.cx, k.cy, C, gt(k.y01, k.x01), gt(k.y11, k.x11), !g), o.arc(0, 0, m, gt(k.cy + k.y11, k.cx + k.x11), gt(_.cy + _.y11, _.cx + _.x11), !g), o.arc(_.cx, _.cy, C, gt(_.y11, _.x11), gt(_.y01, _.x01), !g))) : (o.moveTo(P, V), o.arc(0, 0, m, f, b, !g)) : o.moveTo(P, V), !(h > xt) || !(w > xt) ? o.lineTo(q, j) : $ > xt ? (k = Ma(q, j, I, Z, h, -$, g), _ = Ma(P, V, U, ce, h, -$, g), o.lineTo(k.cx + k.x01, k.cy + k.y01), $ < z ? o.arc(k.cx, k.cy, $, gt(k.y01, k.x01), gt(_.y01, _.x01), !g) : (o.arc(k.cx, k.cy, $, gt(k.y01, k.x01), gt(k.y11, k.x11), !g), o.arc(0, 0, h, gt(k.cy + k.y11, k.cx + k.x11), gt(_.cy + _.y11, _.cx + _.x11), g), o.arc(_.cx, _.cy, $, gt(_.y11, _.x11), gt(_.y01, _.x01), !g))) : o.arc(0, 0, h, S, x, g);
    }
    if (o.closePath(), u)
...
function vm(e) {
  ...
  function A(ee, K) {
    return function(G) {
      var F = [], pe = -1, ne = 0, fe = ee.length, oe, ue, Oe;
      for (G instanceof Date || (G = /* @__PURE__ */ new Date(+G)); ++pe < fe; )
        ee.charCodeAt(pe) === 37 && (F.push(ee.slice(ne, pe)), (ue = So[oe = ee.charAt(++pe)]) != null ? oe = ee.charAt(++pe) : ue = oe === "e" ? " " : "0", (Oe = K[oe]) && (oe = Oe(G, ue)), F.push(oe), ne = pe + 1);
  ...
  function T(ee, K, G, F) {
    for (var pe = 0, ne = K.length, fe = G.length, oe, ue; pe < ne; ) {
      if (F >= fe)
        return -1;
      if (oe = K.charCodeAt(pe++), oe === 37) {
        if (oe = K.charAt(pe++), ue = w[oe in So ? K.charAt(pe++) : oe], !ue || (F = ue(ee, G, F)) < 0)
          return -1;
    ...
    if (this.animations = Object.entries(this.merged).reduce((v, g) => {
      ...
      if (h || I && j || Z) {
        if (S || w)
          ...
          x.interpolation ? (k = x.interpolation, x.interpolation.updateConfig(ce)) : k = C.interpolate(ce);
        }
...
const Pp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  const { tableData: t, config: n, formatNumber: a, capitalize: r, formatDate: l, parseDate: c, setSharedFilter: o } = R.useContext(ze), { xScale: s, yScale: u, showTooltip: d, hideTooltip: h } = e, { xAxis: m, visualizationType: y, orientation: p, yAxis: v, runtime: g } = n, f = (_, O) => {
    ...
    Z.push(...U(n.columns));
    const ce = T(I, Z), de = t.filter((K) => K[m.dataKey] === A(V)), he = p === "vertical" ? ce : de;
    ...
    const we = (K) => {
      ...
      for (const [ne, fe] of Object.entries(K)) {
        ...
        let ue = null;
        n.visualizationType === "Pie" ? ue = j == null ? void 0 : j.data[fe.name] : ue = he[0][fe.name];
        const Oe = fu(ue, "left", !0, n, oe);
        fe.tooltips && G.push([fe.label, Oe]);
      }
      const pe = [];
      return G.forEach((ne) => {
        pe.push([ne[0], ne[1]]);
        ...
        ...z().filter(Boolean).flatMap((ne) => he[0][ne] ? [[ne, a(he[0][ne], we(ne))]] : [])
      ), [...F, ...pe];
    })();
    if (!ke)
      return;
...
const Ba = ({ startAngle: e, endAngle: t }) => ({
  ...
  const z = ({ arcs: P, path: V, getKey: q }) => {
    ...
    return R.useEffect(() => {
    ...
    }, [d]), /* @__PURE__ */ i.createElement(i.Fragment, null, j.map(({ item: I, props: Z, key: U }, ce) => /* @__PURE__ */ i.createElement(be, { className: I.data[n.xAxis.dataKey], key: `${U}-${ce}`, style: { opacity: n.legend.behavior === "highlight" && r.length > 0 && r.indexOf(I.data[n.runtime.xAxis.dataKey]) === -1 ? 0.5 : 1 } }, /* @__PURE__ */ i.createElement(
      Wo.path,
      {
        d: $h(
      ...
      const [U, ce] = V.centroid(I), de = I.endAngle - I.startAngle >= 0.1;
      let he = "#FFF";
      return l(I.data[n.runtime.xAxis.dataKey]) && Qt.contrast(he, l(I.data[n.runtime.xAxis.dataKey])) < 3.5 && (he = "000"), /* @__PURE__ */ i.createElement(Wo.g, { key: Z }, de && /* @__PURE__ */ i.createElement($e, { style: { fill: he }, x: U, y: ce, dy: ".33em", textAnchor: "middle", pointerEvents: "none" }, Math.round((I.endAngle - I.startAngle) * 180 / Math.PI / 360 * 100) + "%"));
    }));
  };
  let [$] = a;
...
function Oi(e) {
  var t = e.children, n = t === void 0 ? Dp : t, a = e.axisClassName, r = e.hideAxisLine, l = r === void 0 ? !1 : r, c = e.hideTicks, o = c === void 0 ? !1 : c, s = e.hideZero, u = s === void 0 ? !1 : s, d = e.innerRef, h = e.left, m = h === void 0 ? 0 : h, y = e.numTicks, p = y === void 0 ? 10 : y, v = e.orientation, g = v === void 0 ? bt.bottom : v, f = e.rangePadding, b = f === void 0 ? 0 : f, x = e.scale, S = e.tickFormat, w = e.tickLength, A = w === void 0 ? 8 : w, D = e.tickValues, T = e.top, z = T === void 0 ? 0 : T, $ = Bp(e, Fp), C = S ?? zp(x), k = g === bt.left, _ = g === bt.top, O = _ || g === bt.bottom, N = $p(x), P = k || _ ? -1 : 1, V = x.range(), q = Rp(b), j = Wa({
    ...
    y: 0
  }, O), Z = (D ?? wf(x, p)).filter(function(ce) {
    return !u || ce !== 0 && ce !== "0";
  }).map(function(ce, de) {
    return {
      value: ce,
    ...
    var de = ce.value, he = ce.index, we = kf(N(de));
    return {
      value: de,
      index: he,
      from: Wa({
  ...
  return e === void 0 && (e = {}), { name: "flip", options: e, async fn(t) {
    ...
    h || y === "none" || x.push(...function(C, k, _, O) {
      ...
      let P = function(V, q, j) {
        const I = ["left", "right"], Z = ["right", "left"], U = ["top", "bottom"], ce = ["bottom", "top"];
        switch (V) {
          case "top":
          case "bottom":
...
en = Qo, function() {
  ...
  function w(K, G, F) {
    ...
    var ue = F.map(function(Oe) {
      return "" + Oe;
    });
    ue.unshift("Warning: " + G), Function.prototype.apply.call(console[K], console, ue);
  }
  var A = /^(.*)[\\\/]/;
  function D(K) {
    if (K == null)
  ...
  function V(K, G, F, pe, ne) {
    var fe, oe = {}, ue = null, Oe = null;
    for (fe in F !== void 0 && (ue = "" + F), function(xe) {
      if (N.call(xe, "key")) {
    ...
    return function(xe, le, te, Fe, se, Ne, Se) {
...
Check the top-level render call using <` + oe + ">.");
  ...
  function we(K) {
    ...
    if (F != null && typeof F != "string") {
      ...
      if (G) {
        var pe = D(F);
        (function(ne, fe, oe, ue, Oe) {
          var Ke = Function.call.bind(Object.prototype.hasOwnProperty);
          for (var Ce in ne)
            if (Ke(ne, Ce)) {
              var xe = void 0;
              try {
                if (typeof ne[Ce] != "function") {
                  var le = Error((ue || "React class") + ": " + oe + " type `" + Ce + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof ne[Ce] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                  throw le.name = "Invariant Violation", le;
                }
                xe = ne[Ce](fe, Ce, ue, oe, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
              } catch (te) {
                xe = te;
              }
              !xe || xe instanceof Error || ($(Oe), S("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", ue || "React class", oe, Ce, typeof xe), $(null)), xe instanceof Error && !(xe.message in T) && (T[xe.message] = !0, $(Oe), S("Failed %s type: %s", oe, xe.message), $(null));
            }
        })(G, K.props, "prop", pe, K);
      } else
...
Check your code at ` + te.fileName.replace(/^.*[\\\/]/, "") + ":" + te.lineNumber + "." : "";
      ...
      ue += Ke || U(), K === null ? Oe = "null" : Array.isArray(K) ? Oe = "array" : K !== void 0 && K.$$typeof === t ? (Oe = "<" + (D(K.type) || "Unknown") + " />", ue = " Did you accidentally export a JSX literal instead of a component?") : Oe = typeof K, S("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Oe, ue);
    }
    var Ce = V(K, G, F, ne, fe);
    if (Ce == null)
      return Ce;
    if (oe) {
      var xe = G.children;
    ...
    return K === en.Fragment ? function(te) {
      for (var Fe = Object.keys(te.props), se = 0; se < Fe.length; se++) {
        var Ne = Fe[se];
...
const es = ({ id: e, className: t, classNameArrow: n, variant: a = "dark", anchorId: r, anchorSelect: l, place: c = "top", offset: o = 10, events: s = ["hover"], positionStrategy: u = "absolute", middlewares: d, wrapper: h, children: m = null, delayShow: y = 0, delayHide: p = 0, float: v = !1, noArrow: g = !1, clickable: f = !1, closeOnEsc: b = !1, style: x, position: S, afterShow: w, afterHide: A, content: D, html: T, isOpen: z, setIsOpen: $, activeAnchor: C, setActiveAnchor: k }) => {
  const _ = R.useRef(null), O = R.useRef(null), N = R.useRef(null), P = R.useRef(null), [V, q] = R.useState({}), [j, I] = R.useState({}), [Z, U] = R.useState(!1), [ce, de] = R.useState(!1), he = R.useRef(!1), we = R.useRef(null), { anchorRefs: Te, setActiveAnchor: ke } = Yc(e), ee = R.useRef(!1), [K, G] = R.useState([]), F = R.useRef(!1);
  ...
  const ne = (se = p) => {
    ...
    const Se = (Ne = se.currentTarget) !== null && Ne !== void 0 ? Ne : se.target;
    k(Se), ke({ current: Se }), P.current && clearTimeout(P.current);
  }, oe = () => {
    f ? ne(p || 100) : p ? ne() : pe(!1), N.current && clearTimeout(N.current);
  }, ue = ({ x: se, y: Ne }) => {
    Go({ place: c, offset: o, elementReference: { getBoundingClientRect: () => ({ x: se, y: Ne, width: 0, height: 0, top: Ne, left: se, right: se, bottom: Ne }) }, tooltipReference: _.current, tooltipArrowReference: O.current, strategy: u, middlewares: d }).then((Se) => {
      Object.keys(Se.tooltipStyles).length && q(Se.tooltipStyles), Object.keys(Se.tooltipArrowStyles).length && I(Se.tooltipArrowStyles);
    });
  }, Oe = (se) => {
    if (!se)
      return;
    const Ne = se, Se = { x: Ne.clientX, y: Ne.clientY };
    ue(Se), we.current = Se;
  }, Ke = (se) => {
    fe(se), p && ne();
  }, Ce = (se) => {
    const Ne = document.querySelector(`[id='${r}']`);
    Ne != null && Ne.contains(se.target) || K.some((Se) => Se.contains(se.target)) || pe(!1);
  }, xe = (se) => {
    se.key === "Escape" && pe(!1);
  ...
  R.useEffect(() => {
    ...
    const _e = [];
    s.find((et) => et === "click") && (window.addEventListener("click", Ce), _e.push({ event: "click", listener: Ke })), s.find((et) => et === "hover") && (_e.push({ event: "mouseenter", listener: le }, { event: "mouseleave", listener: te }, { event: "focus", listener: le }, { event: "blur", listener: te }), v && _e.push({ event: "mousemove", listener: Oe }));
    const Ge = () => {
      ee.current = !0;
    }, nt = () => {
      ee.current = !1, oe();
    };
    return f && ((se = _.current) === null || se === void 0 || se.addEventListener("mouseenter", Ge), (Ne = _.current) === null || Ne === void 0 || Ne.addEventListener("mouseleave", nt)), _e.forEach(({ event: et, listener: ft }) => {
      Se.forEach((at) => {
        var Je;
      ...
      var et, ft;
      s.find((at) => at === "click") && window.removeEventListener("click", Ce), b && window.removeEventListener("keydown", xe), f && ((et = _.current) === null || et === void 0 || et.removeEventListener("mouseenter", Ge), (ft = _.current) === null || ft === void 0 || ft.removeEventListener("mouseleave", nt)), _e.forEach(({ event: at, listener: Je }) => {
        Se.forEach((Et) => {
          var Yt;
  ...
  }, [ce, Te, K, b, s]), R.useEffect(() => {
    let se = l ?? "";
    !se && e && (se = `[data-tooltip-id='${e}']`);
    const Ne = new MutationObserver((Se) => {
      const B = [];
      Se.forEach((_e) => {
        if (_e.type === "attributes" && _e.attributeName === "data-tooltip-id" && _e.target.getAttribute("data-tooltip-id") === e && B.push(_e.target), _e.type === "childList" && (C && [..._e.removedNodes].some((Ge) => !!Ge.contains(C) && (de(!1), pe(!1), k(null), !0)), se))
          try {
            const Ge = [..._e.addedNodes].filter((nt) => nt.nodeType === 1);
            B.push(...Ge.filter((nt) => nt.matches(se))), B.push(...Ge.flatMap((nt) => [...nt.querySelectorAll(se)]));
          } catch {
          }
      }), B.length && G((_e) => [..._e, ...B]);
    });
    ...
    S ? ue(S) : v ? we.current && ue(we.current) : Go({ place: c, offset: o, elementReference: C, tooltipReference: _.current, tooltipArrowReference: O.current, strategy: u, middlewares: d }).then((se) => {
      F.current && (Object.keys(se.tooltipStyles).length && q(se.tooltipStyles), Object.keys(se.tooltipArrowStyles).length && I(se.tooltipArrowStyles));
    });
  }, [Z, C, D, T, c, o, u, S]), R.useEffect(() => {
    var se;
    const Ne = document.querySelector(`[id='${r}']`), Se = [...K, Ne];
    C && Se.includes(C) || k((se = K[0]) !== null && se !== void 0 ? se : Ne);
  }, [r, K, C]), R.useEffect(() => () => {
  ...
  return ce ? Sn.exports.jsxs(h, { id: e, role: "tooltip", className: Zo("react-tooltip", hn.tooltip, hn[a], t, { [hn.show]: Fe, [hn.fixed]: u === "fixed", [hn.clickable]: f }), style: { ...x, ...V }, ref: _, children: [T && Sn.exports.jsx(fy, { content: T }) || D || m, Sn.exports.jsx(h, { className: Zo("react-tooltip-arrow", hn.arrow, n, { [hn["no-arrow"]]: g }), style: j, ref: O })] }) : null;
  ...
  const [C, k] = R.useState(a), [_, O] = R.useState(r), [N, P] = R.useState(s), [V, q] = R.useState(o), [j, I] = R.useState(u), [Z, U] = R.useState(v), [ce, de] = R.useState(g), [he, we] = R.useState(f), [Te, ke] = R.useState(d), [ee, K] = R.useState(m), [G, F] = R.useState(y), [pe, ne] = R.useState(null), { anchorRefs: fe, activeAnchor: oe } = Yc(e), ue = (Ce) => Ce == null ? void 0 : Ce.getAttributeNames().reduce((xe, le) => {
    var te;
  ...
  R.useEffect(() => {
    ...
    if (te && xe.add({ current: te }), !xe.size)
      return () => null;
    const Fe = (Ce = pe ?? te) !== null && Ce !== void 0 ? Ce : oe.current, se = new MutationObserver((Se) => {
      Se.forEach((B) => {
        var _e;
    ...
    if (Fe) {
      const Se = ue(Fe);
      Oe(Se), se.observe(Fe, Ne);
    }
    return () => {
      se.disconnect();
    };
  }, [fe, oe, pe, t, n]);
  const Ke = { id: e, anchorId: t, anchorSelect: n, className: l, classNameArrow: c, content: C, html: _, place: N, variant: V, offset: j, wrapper: Te, events: ee, positionStrategy: G, middlewares: p, delayShow: Z, delayHide: ce, float: he, noArrow: b, clickable: x, closeOnEsc: S, style: w, position: A, isOpen: D, setIsOpen: T, afterShow: z, afterHide: $, activeAnchor: pe, setActiveAnchor: (Ce) => ne(Ce) };
  ...
  return s.visualizationSubType === "stacked" && v && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(Gd, { data: l, keys: s.runtime.barSeriesKeys || s.runtime.seriesKeys, height: r, y: (z) => z[s.runtime.yAxis.dataKey], xScale: t, yScale: n, color: c, offset: "none" }, (z) => z.map(
    ($) => x($.bars).map((C, k) => {
      ...
      return Qt.contrast(N, C.color) < 4.9 && (N = "#FFFFFF"), /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("style", null, `
  ...
  return o.visualizationSubType !== "stacked" && (o.visualizationType === "Bar" || o.visualizationType === "Combo") && o.orientation === "vertical" && /* @__PURE__ */ i.createElement(be, null, /* @__PURE__ */ i.createElement(
    ...
    (N) => w(N).map((P, V) => /* @__PURE__ */ i.createElement(be, { className: `bar-group-${P.index}-${P.x0}--${V} ${o.orientation}`, key: `bar-group-${P.index}-${P.x0}--${V}`, id: `bar-group-${P.index}-${P.x0}--${V}`, left: a / N.length * P.index }, P.bars.map((q, j) => {
      ...
      let U = o.legend.behavior === "highlight" && p.length > 0 && p.indexOf(q.key) === -1, ce = o.legend.behavior === "highlight" || p.length === 0 || p.indexOf(q.key) !== -1, de = Math.abs(n(q.value) - n(I)), he = q.value >= 0 && m(q.value) ? q.y : n(0), we = a / N.length * (o.barThickness || 0.8), Te = a / N.length * (1 - (o.barThickness || 0.8)) / 2;
      o.isLollipopChart && (Te = a / N.length / 2 - T / 2);
      let ke = o.isLollipopChart ? T : we / P.bars.length, ee = u(q.value, "left"), K = o.runtime[D].type === "date" ? s(y(_[P.index][o.runtime.originalXAxis.dataKey])) : _[P.index][o.runtime.originalXAxis.dataKey];
      ...
      const Oe = o.isLollipopChart && o.lollipopColorStyle === "regular", Ke = o.isLollipopChart && o.lollipopColorStyle === "two-tone", Ce = Z == null ? void 0 : Z.includes(K), xe = $(K), le = C(K), te = Ce ? xe : o.barHasBorder === "true" ? "#000" : "transparent", Fe = Ce ? le.borderWidth : o.isLollipopChart ? 0 : o.barHasBorder === "true" ? b : 0, Ne = {
        background: ((Se) => Oe ? Se : Ke ? Qt(Se).brighten(1) : Ce ? "transparent" : Se)(ue),
        borderColor: te,
        borderStyle: "solid",
        borderWidth: Fe,
        width: ke,
      ...
      ), /* @__PURE__ */ i.createElement($e, { display: o.labels && ce ? "block" : "none", opacity: U ? 0.5 : 1, x: ke * (q.index + 0.5) + Te, y: he - 5, fill: oe, textAnchor: "middle" }, ee), o.isLollipopChart && o.lollipopShape === "circle" && /* @__PURE__ */ i.createElement(
        "circle",
        {
  ...
  return s.visualizationSubType !== "stacked" && s.visualizationType === "Bar" && s.orientation === "horizontal" && /* @__PURE__ */ i.createElement(be, null, /* @__PURE__ */ i.createElement(
    ...
    (P) => w(P).map((V, q) => /* @__PURE__ */ i.createElement(be, { className: `bar-group-${V.index}-${V.x0}--${q} ${s.orientation}`, key: `bar-group-${V.index}-${V.x0}--${q}`, id: `bar-group-${V.index}-${V.x0}--${q}`, top: V.y }, V.bars.map((j, I) => {
      ...
      let ce = s.legend.behavior === "highlight" && o.length > 0 && o.indexOf(j.key) === -1, de = s.legend.behavior === "highlight" || o.length === 0 || o.indexOf(j.key) !== -1, he = s.barHeight, we = j.value >= 0 && y(j.value) ? j.y : n(0);
      ...
      let ne = p(G, `normal ${T[s.fontSize]}px sans-serif`) < ke - 5, fe = ne ? "end" : "start", oe = "start", ue = ne ? -5 : 5, Oe = 10;
      F === "below" && (fe = ne ? "start" : "end", ue = ne ? 5 : -5, s.isLollipopChart && (oe = "end", Oe = -10));
      const Ke = j.value < 0 ? -1 : I, Ce = S(Ke);
      ...
      se && Fe && Qt.contrast(Fe, se) < 4.9 && (Fe = ne ? "#FFFFFF" : "#000000");
      const at = {
        background: (() => Ne ? se : Se ? Qt(se).brighten(1) : B ? "transparent" : se)(),
        borderColor: nt,
        borderStyle: "solid",
        borderWidth: et,
        width: ke,
      ...
      return /* @__PURE__ */ i.createElement(be, { key: `${V.index}--${I}` }, /* @__PURE__ */ i.createElement("style", null, `
                        ...
                        .Combo #barGroup${V.index} div {
                          transform-origin: 0 ${we + he}px;
                        }
                      `), /* @__PURE__ */ i.createElement(be, { key: `bar-sub-group-${V.index}-${V.x0}-${we}--${I}` }, /* @__PURE__ */ i.createElement(
        "foreignObject",
        {
          id: `barGroup${V.index}`,
...
function Xc(e) {
  var t = e.left, n = t === void 0 ? 0 : t, a = e.top, r = a === void 0 ? 0 : a, l = e.className, c = e.max, o = e.min, s = e.firstQuartile, u = e.thirdQuartile, d = e.median, h = e.boxWidth, m = h === void 0 ? 10 : h, y = e.fill, p = e.fillOpacity, v = e.stroke, g = e.strokeWidth, f = e.rx, b = f === void 0 ? 2 : f, x = e.ry, S = x === void 0 ? 2 : x, w = e.valueScale, A = e.outliers, D = A === void 0 ? [] : A, T = e.horizontal, z = e.medianProps, $ = z === void 0 ? {} : z, C = e.maxProps, k = C === void 0 ? {} : C, _ = e.minProps, O = _ === void 0 ? {} : _, N = e.boxProps, P = N === void 0 ? {} : N, V = e.outlierProps, q = V === void 0 ? {} : V, j = e.container, I = j === void 0 ? !1 : j, Z = e.containerProps, U = Z === void 0 ? {} : Z, ce = e.children, de = T ? r : n, he = de + (m || 0) / 2, we = w.range(), Te = w(o ?? 0), ke = w(s ?? 0), ee = w(d ?? 0), K = w(u ?? 0), G = w(c ?? 0), F = {
    ...
    container: {
      x1: de,
      x2: m || 0,
      y1: Math.min.apply(Math, we),
      y2: Math.abs(we[0] - we[1])
    }
  };
  return T && (F.max = pn(F.max), F.maxToThird = pn(F.maxToThird), F.box.y1 = ke, F.box = pn(F.box), F.median = pn(F.median), F.minToFirst = pn(F.minToFirst), F.min = pn(F.min), F.container = pn(F.container), F.container.y1 = Math.min.apply(Math, we)), ce ? /* @__PURE__ */ i.createElement(i.Fragment, null, ce(F)) : /* @__PURE__ */ i.createElement(be, {
...
function Cy({ height: e, xScale: t }) {
  ...
  const S = Number(a.xAxis.target), w = a.series[0].dataKey, A = Number(t.domain()[1]), T = n.some((I) => I[w] < 0) || S > 0 || t.domain()[0] < 0, z = a.barHasBorder === "true" ? 1 : 0, $ = a.lollipopSize === "large" ? 7 : a.lollipopSize === "medium" ? 6 : 5, C = a.lollipopSize === "large" ? 14 : a.lollipopSize === "medium" ? 12 : 10, k = Math.max(t(0), Math.min(t(S), t(A))), _ = (I) => {
    ...
    calculate: function() {
      const Z = n[0][w] < S ? "left" : "right", U = `${a.xAxis.targetLabel} ${r(a.xAxis.target || 0, "left")}`, ce = c(U, `bold ${x[a.fontSize]}px sans-serif`);
      let de = a.isLollipopChart ? $ / 2 : Number(a.barHeight) / 2, he = 0, we = 0, Te = !1;
      Z === "right" && (he = -10, Te = ce - he < k, we = k - ce), Z === "left" && (he = 10, Te = t(A) - k > ce + he, we = k), this.text = U, this.y = de, this.x = we, this.padding = he, this.showLabel = a.xAxis.showTargetLabel ? Te : !1;
    }
  };
  O.calculate();
  ...
  return R.useEffect(() => {
    ...
    const U = Number(I[w]), ce = a.isLollipopChart ? $ : Number(a.barHeight), de = Number(a.barSpace), he = Math.abs(t(U) - k), we = t(U), Te = U > S ? k : we, ke = U < S ? "left" : "right";
    let ee = 0;
    ee = Z !== 0 ? (de + ce + z) * Z : ee;
    const K = (de + ce + z) * n.length;
    a.heights.horizontal = K;
    const F = c(r(U, "left"), `normal ${x[a.fontSize]}px sans-serif`) < he - 6, pe = we, ne = ee + ce / 2, fe = we, oe = ee + ce / 2, ue = we, Oe = ee - ce / 2, Ke = _(ke), [Ce, xe] = l[p.palette], le = { left: Ce, right: xe }, Fe = Qt.contrast("#000000", le[ke]) < 4.9 ? "#FFFFFF" : "#000000";
    ...
    return /* @__PURE__ */ i.createElement(be, { key: `deviation-bar-${a.orientation}-${w}-${Z}` }, /* @__PURE__ */ i.createElement(
      ...
      /* @__PURE__ */ i.createElement("div", { style: { width: he, height: ce, border: `${z}px solid #333`, backgroundColor: le[ke], ...Ke } })
    ), a.yAxis.displayNumbersOnBar && /* @__PURE__ */ i.createElement($e, { verticalAnchor: "middle", x: pe, y: ne, ...se[ke] }, r(I[w], "left")), a.isLollipopChart && a.lollipopShape === "circle" && /* @__PURE__ */ i.createElement("circle", { cx: fe, cy: oe, r: C / 2, fill: le[ke], style: { filter: "unset", opacity: 1 } }), a.isLollipopChart && a.lollipopShape === "square" && /* @__PURE__ */ i.createElement("rect", { x: ue, y: Oe, width: C, height: C, fill: le[ke], style: { opacity: 1, filter: "unset" } }));
...
const _y = (e) => {
  ...
  let g = "#000000";
  Qt.contrast(g, y.color) < 4.9 && (y.labelColor = "#FFFFFF"), Qt.contrast(g, p.color) < 4.9 && (p.labelColor = "#FFFFFF");
...
const cg = Sl, ug = (e) => {
  ...
  return isNaN($) ? /* @__PURE__ */ i.createElement(i.Fragment, null) : /* @__PURE__ */ i.createElement(Rt, { component: "LinearChart" }, /* @__PURE__ */ i.createElement("div", { style: { width: `${$}px`, height: `${O}px`, overflow: "visible" }, className: "tooltip-boundary" }, /* @__PURE__ */ i.createElement("svg", { width: "100%", height: "100%", className: `linear ${l.animate ? "animated" : ""} ${de && l.animate ? "animate" : ""} ${z && "debug"}`, role: "img", "aria-label": d(l), ref: Te, style: { overflow: "visible" } }, /* @__PURE__ */ i.createElement(Pt, { width: $, height: O, fill: "transparent" }), " ", l.regions ? l.regions.map((Y) => {
  ...
  }) : "", !["Spark Line", "Forest Plot"].includes(x) && /* @__PURE__ */ i.createElement(Kp, { scale: ue, tickLength: l.useLogScale ? 6 : 8, left: Number(T.yAxis.size) - l.yAxis.axisPadding, label: T.yAxis.label, stroke: "#333", tickFormat: (Y, ve) => se(Y, ve), numTicks: Xn() }, (Y) => {
    ...
    (Y) => {
      ...
      const re = ge && l.isResponsiveTicks ? Tt + vt + 20 : 0, Le = Number(l.xAxis.tickRotation) > 0 ? Number(l.xAxis.tickRotation) : 0;
      return l.dynamicMarginTop = re, l.xAxis.tickWidthMax = Tt, /* @__PURE__ */ i.createElement(be, { className: "bottom-axis" }, Y.ticks.map((Pe, it, wt) => {
        ...
        {
          x: ve,
          y: l.orientation === "horizontal" ? re || l.xAxis.labelOffset : l.isResponsiveTicks && re && !k ? re : Number(Le) && !l.isResponsiveTicks && !k ? Number(Le + Tt / 1.3) : Number(l.xAxis.labelOffset),
          textAnchor: "middle",
          fontWeight: "bold",
  ...
  )), x === "Deviation Bar" && /* @__PURE__ */ i.createElement(Cy, { animatedChart: de, xScale: oe, yScale: ue, width: N, height: P }), x === "Paired Bar" && /* @__PURE__ */ i.createElement(My, { originalWidth: $, width: N, height: P }), x === "Scatter Plot" && /* @__PURE__ */ i.createElement(
    wy,
    {
      xScale: oe,
      yScale: ue,
  ...
  ), l.yAxis.anchors && l.yAxis.anchors.map((Y) => /* @__PURE__ */ i.createElement(qe, { strokeDasharray: m(Y.lineStyle), stroke: "rgba(0,0,0,1)", className: "customAnchor", from: { x: 0 + l.yAxis.size, y: ue(Y.value) }, to: { x: N, y: ue(Y.value) }, display: T.horizontal ? "none" : "block" })), x === "Forest Plot" && /* @__PURE__ */ i.createElement(
    _y,
    {
      xScale: oe,
      yScale: ue,
  ...
  ), ["Line", "Bar", "Combo", "Area Chart"].includes(l.visualizationType) && !k && /* @__PURE__ */ i.createElement(ug, { xScaleBrush: le, yScale: ue, xMax: N, yMax: P }), x !== "Bar" && x !== "Paired Bar" && x !== "Box Plot" && x !== "Area Chart" && x !== "Scatter Plot" && x !== "Deviation Bar" && x !== "Forecasting" && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(ns, { xScale: oe, yScale: ue, getXAxisData: ee, getYAxisData: K, xMax: N, yMax: P, seriesStyle: l.series })), l.yAxis.anchors && l.yAxis.anchors.map((Y, ve) => {
    let Me = ue(Y.value);
    if (!Y.value)
      return;
    ...
    if (((O = f == null ? void 0 : f.forecastingSeriesKeys) == null ? void 0 : O.length) > 0) {
      ...
      return (P = (N = e.runtime) == null ? void 0 : N.forecastingSeriesKeys) == null || P.map((q, j) => {
        ...
        return (I = q == null ? void 0 : q.stages) == null ? void 0 : I.map((Z, U) => {
          var he, we, Te, ke;
          let ce = (he = Za[Z.color]) != null && he[2] ? (we = Za[Z.color]) == null ? void 0 : we[2] : (Te = u[Z.color]) != null && Te[2] ? (ke = u[Z.color]) == null ? void 0 : ke[2] : "#ccc";
          const de = {
            datum: Z.key,
            index: U,
            text: Z.key,
...
const Qa = (e) => /* @__PURE__ */ R.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", ...e }, /* @__PURE__ */ R.createElement("path", { fill: "currentColor", d: "M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zm-248 50c-25.405 0-46 20.595-46 46s20.595 46 46 46 46-20.595 46-46-20.595-46-46-46zm-43.673-165.346l7.418 136c.347 6.364 5.609 11.346 11.982 11.346h48.546c6.373 0 11.635-4.982 11.982-11.346l7.418-136c.375-6.874-5.098-12.654-11.982-12.654h-63.383c-6.884 0-12.356 5.78-11.981 12.654z" })), aa = R.memo(({ label: e, value: t, options: n, fieldName: a, section: r = null, subsection: l = null, required: c = !1, tooltip: o, updateField: s, initial: u, ...d }) => {
  ...
  const { config: e, updateConfig: t, transformedData: n, loading: a, colorPalettes: r, twoColorPalette: l, unfilteredData: c, excludedData: o, isDashboard: s, setParentConfig: u, missingRequiredSections: d, isDebug: h, setFilteredData: m, lineOptions: y, rawData: p } = R.useContext(ze), { minValue: v, maxValue: g, existPositiveValue: f, isAllLine: b } = $i(e, c), { twoColorPalettes: x, sequential: S, nonSequential: w } = qg(e, t), {
    ...
    visSupportsValueAxisGridLines: we,
  ...
  const { hasRightAxis: Fe } = dl({ config: e, yMax: e.yAxis.size, data: e.data, updateConfig: t }), se = (L, M) => ({
    ...M
  }), Ne = {
    animate: !1,
    animateReplay: !0,
  ...
  const re = ["Area Chart", "Combo", "Line", "Bar", "Forecasting"], Le = [
  ...
  return /* @__PURE__ */ i.createElement(Rt, { component: "EditorPanel" }, e.newViz && /* @__PURE__ */ i.createElement(ve, null), e.newViz === void 0 && e.runtime && e.runtime.editorErrorMessage && /* @__PURE__ */ i.createElement(Y, null), /* @__PURE__ */ i.createElement("button", { className: _e ? "editor-toggle" : "editor-toggle collapsed", title: _e ? "Collapse Editor" : "Expand Editor", onClick: un }), /* @__PURE__ */ i.createElement("section", { className: `${_e ? "editor-panel cove" : "hidden editor-panel cove"}${s ? " dashboard" : ""}` }, /* @__PURE__ */ i.createElement("div", { "aria-level": "2", role: "heading", className: "heading-2" }, "Configure Chart"), /* @__PURE__ */ i.createElement("section", { className: "form-container" }, /* @__PURE__ */ i.createElement(vn, { allowZeroExpanded: !0 }, /* @__PURE__ */ i.createElement(lt, null, " ", /* @__PURE__ */ i.createElement(ot, null, /* @__PURE__ */ i.createElement(st, null, "General")), /* @__PURE__ */ i.createElement(ct, null, /* @__PURE__ */ i.createElement(He, { value: e.visualizationType, fieldName: "visualizationType", label: "Chart Type", updateField: B, options: A }), (e.visualizationType === "Bar" || e.visualizationType === "Combo" || e.visualizationType === "Area Chart") && /* @__PURE__ */ i.createElement(He, { value: e.visualizationSubType || "Regular", fieldName: "visualizationSubType", label: "Chart Subtype", updateField: B, options: ["regular", "stacked"] }), e.visualizationType === "Area Chart" && e.visualizationSubType === "stacked" && /* @__PURE__ */ i.createElement(He, { value: e.stackedAreaChartLineType || "Linear", fieldName: "stackedAreaChartLineType", label: "Stacked Area Chart Line Type", updateField: B, options: Object.keys(Ei) }), e.visualizationType === "Bar" && /* @__PURE__ */ i.createElement(He, { value: e.orientation || "vertical", fieldName: "orientation", label: "Orientation", updateField: B, options: ["vertical", "horizontal"] }), e.visualizationType === "Deviation Bar" && /* @__PURE__ */ i.createElement(He, { label: "Orientation", options: ["horizontal"] }), (e.visualizationType === "Bar" || e.visualizationType === "Deviation Bar") && /* @__PURE__ */ i.createElement(He, { value: e.isLollipopChart ? "lollipop" : e.barStyle || "flat", fieldName: "barStyle", label: "bar style", updateField: B, options: Xn() }), (e.visualizationType === "Bar" || e.visualizationType === "Deviation Bar") && e.barStyle === "rounded" && /* @__PURE__ */ i.createElement(He, { value: e.tipRounding || "top", fieldName: "tipRounding", label: "tip rounding", updateField: B, options: ["top", "full"] }), (e.visualizationType === "Bar" || e.visualizationType === "Deviation Bar") && e.barStyle === "rounded" && /* @__PURE__ */ i.createElement(He, { value: e.roundingStyle || "standard", fieldName: "roundingStyle", label: "rounding style", updateField: B, options: ["standard", "shallow", "finger"] }), e.visualizationType === "Bar" && e.orientation === "horizontal" && /* @__PURE__ */ i.createElement(He, { value: e.yAxis.labelPlacement || "Below Bar", section: "yAxis", fieldName: "labelPlacement", label: "Label Placement", updateField: B, options: ["Below Bar", "On Date/Category Axis"] }), _() ? /* @__PURE__ */ i.createElement(Ae, { value: e.yAxis.displayNumbersOnBar, section: "yAxis", fieldName: "displayNumbersOnBar", label: e.isLollipopChart ? "Display Numbers after Bar" : "Display Numbers on Bar", updateField: B }) : k() && /* @__PURE__ */ i.createElement(Ae, { value: e.labels, fieldName: "labels", label: "Display label on data", updateField: B }), e.visualizationType === "Pie" && /* @__PURE__ */ i.createElement(He, { fieldName: "pieType", label: "Pie Chart Type", updateField: B, options: ["Regular", "Donut"] }), /* @__PURE__ */ i.createElement(
    ...
    "select",
    {
      value: e.columns[L] ? e.columns[L].name : Le[0],
      onChange: (M) => {
    ...
    var Q;
    return /* @__PURE__ */ i.createElement("ul", { ...H.droppableProps, className: "sort-list", ref: H.innerRef, style: { marginTop: "1em" } }, (Q = e.filters[M]) == null ? void 0 : Q.values.map((je, kt) => /* @__PURE__ */ i.createElement(hs, { key: je, draggableId: `draggableFilter-${je}`, index: kt }, (Bt, Zn) => /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement("div", { className: Zn.isDragging ? "currently-dragging" : "", style: se(Zn.isDragging, Bt.draggableProps.style), ref: Bt.innerRef, ...Bt.draggableProps, ...Bt.dragHandleProps }, je)))), H.placeholder);
...
function gx({ configUrl: e, config: t, isEditor: n = !1, isDebug: a = !1, isDashboard: r = !1, setConfig: l, setEditing: c, hostname: o, link: s, setSharedFilter: u, setSharedFilterValue: d, dashboardConfig: h }) {
  var vt, Tt;
  const m = new Mu(), [y, p] = R.useState(!0), [v, g] = R.useState(null), [f, b] = R.useState({}), [x, S] = R.useState(f.data || []), [w, A] = R.useState(void 0), [D, T] = R.useState(void 0), [z, $] = R.useState([]), [C, k] = R.useState("lg"), [_, O] = R.useState([]), [N, P] = R.useState(), [V, q] = R.useState(), [j, I] = R.useState(!1), [Z, U] = R.useState([]), [ce] = R.useState(`cove-${Math.random().toString(16).slice(-4)}`);
  let de = R.useRef(/* @__PURE__ */ new Map()), he = R.useRef();
  a && console.log("Chart config, isEditor", f, n);
  let { legend: we, title: Te, description: ke, visualizationType: ee } = f;
  n && (!Te || Te === "") && (Te = "Chart Title"), f.table && (!((vt = f.table) != null && vt.label) || ((Tt = f.table) == null ? void 0 : Tt.label) === "") && (f.table.label = "Data Table");
  const { barBorderClass: K, lineDatapointClass: G, contentClasses: F, sparkLineStyles: pe } = Nu(f), ne = f.showSidebar ? "#legend" : f != null && f.title ? `#dataTableSection__${f.title.replace(/\s/g, "")}` : "#dataTableSection", fe = (E, J) => E.toString().localeCompare(J.toString(), "en", { numeric: !0 }), oe = (E, J) => J.toString().localeCompare(E.toString(), "en", { numeric: !0 }), ue = (E, J = !1) => {
    ...
    if (E.exclusions && E.exclusions.active)
      if (E.xAxis.type === "categorical" && ((ge = E.exclusions.keys) == null ? void 0 : ge.length) > 0)
        ...
        let Le = re(E.exclusions.dateStart), Pe = re(E.exclusions.dateEnd) + 86399999, it = typeof Le !== void 0 && isNaN(Le) === !1, wt = typeof Pe !== void 0 && isNaN(Pe) === !1;
        it && wt ? ie = ae.filter((Ie) => re(Ie[E.xAxis.dataKey]) >= Le && re(Ie[E.xAxis.dataKey]) <= Pe) : it ? ie = ae.filter((Ie) => re(Ie[E.xAxis.dataKey]) >= Le) : wt && (ie = ae.filter((Ie) => re(Ie[E.xAxis.dataKey]) <= Pe));
      } else
        ie = J || x;
    else
      ie = J || x;
    A(ie);
    let ye = [];
    if (E.filters && (E.filters.forEach((re, Le) => {
      let Pe = [];
      Pe = re.orderedValues || Fe(re.columnName, ie).sort(re.order === "desc" ? oe : fe), E.filters[Le].values = Pe, E.filters[Le].active = E.filters[Le].active || Pe[0], E.filters[Le].filterStyle = E.filters[Le].filterStyle ? E.filters[Le].filterStyle : "dropdown";
      ...
      let re = ie ? ie.map((Re) => Re[E.xAxis.dataKey]) : ae.map((Re) => Re[E.xAxis.dataKey]), Le = ie ? ie.map((Re) => {
        var Ye;
      ...
      }), wt = JSON.parse(JSON.stringify(Ie)), wt.map((Re) => (Re.columnIqr = void 0, Re.nonOutlierValues = void 0, Re.columnLowerBounds = void 0, Re.columnUpperBounds = void 0, null)), E.boxplot.allValues = Le, E.boxplot.categories = it, E.boxplot.plots = Ie, E.boxplot.tableData = wt;
    }
  ...
  const Je = (E) => {
    ...
    let {
      dataFormat: { commas: Le, abbreviated: Pe, roundTo: it, prefix: wt, suffix: Ie, rightRoundTo: Ft, bottomRoundTo: Re, rightPrefix: Ye, rightSuffix: Qe, bottomPrefix: rt, bottomSuffix: Lt, bottomAbbreviated: pt }
    } = f;
    ...
    J === "left" && Le && Pe && ae || J === "bottom" && Le && Pe && ae ? E = E : E = E.toLocaleString("en-US", yt);
    let tt = "";
    ...
    try {
      ...
      if (de.current.has(ye)) {
        ...
        if ((J = runtimeLegend[ge]) != null && J.disabled)
          return !1;
        let re = (ae = runtimeLegend.find((Le) => Le.bin === ge)) == null ? void 0 : ae.color;
    ...
    const J = we.position === "bottom" || ["sm", "xs", "xxs"].includes(C), ae = E.orientation === "horizontal", ie = Number(E.xAxis.tickRotation) > 0 ? Number(E.xAxis.tickRotation) : 0, ye = E.brush.active, ge = 20, re = E.brush.height;
    let Le = 0;
    return !J && ae && E.xAxis.label && (Le = E.runtime.xAxis.size + E.xAxis.labelOffset), !J && ae && !E.xAxis.label && (Le = 0), !ae && !J && E.xAxis.label && ie && !E.isResponsiveTicks && (Le = ye ? re + E.xAxis.tickWidthMax + -E.xAxis.size + E.xAxis.labelOffset + ge : E.xAxis.tickWidthMax + ge + -E.xAxis.size + E.xAxis.labelOffset), !ae && !J && !E.xAxis.label && ie && E.isResponsiveTicks, !ae && !J && !E.xAxis.label && ie && !E.dynamicMarginTop && !E.isResponsiveTicks && (Le = ye ? E.xAxis.tickWidthMax + re + ge + -E.xAxis.size : 0), !ae && !J && E.xAxis.label && !ie && !E.isResponsiveTicks && (Le = ye ? re + -E.xAxis.size + E.xAxis.labelOffset + ge : -E.xAxis.size + E.xAxis.labelOffset + ge), !ae && !J && E.xAxis.label && E.dynamicMarginTop && E.isResponsiveTicks && (Le = ye ? re + E.xAxis.labelOffset + -E.xAxis.size + E.xAxis.tickWidthMax : E.dynamicMarginTop + -E.xAxis.size + ge), !ae && !J && !E.xAxis.label && E.dynamicMarginTop && E.isResponsiveTicks && (Le = ye ? re + E.xAxis.labelOffset + -E.xAxis.size + E.xAxis.tickWidthMax : E.dynamicMarginTop + -E.xAxis.size - ge), !ae && !J && E.xAxis.label && !E.dynamicMarginTop && E.isResponsiveTicks && (Le = ye ? re + E.xAxis.labelOffset + -E.xAxis.size + 25 : E.xAxis.labelOffset + -E.xAxis.size + ge), !ae && !J && !E.xAxis.label && !E.dynamicMarginTop && E.isResponsiveTicks && (Le = -E.xAxis.size + ge + E.xAxis.labelOffset), !ae && !J && !E.xAxis.label && !ie && !E.dynamicMarginTop && !E.isResponsiveTicks && (Le = ye ? re + -E.xAxis.size + E.xAxis.labelOffset : 0), `${Le}px`;
  };
  ...
  return f.visualizationType === "Spark Line" && ut.push("type-sparkline"), n && ut.push("spacing-wrapper"), n && ut.push("isEditor"), /* @__PURE__ */ i.createElement(ze.Provider, { value: Ee }, /* @__PURE__ */ i.createElement("div", { className: `${ut.join(" ")}`, ref: Se, "data-lollipop": f.isLollipopChart, "data-download-id": ce }, un));
}
export {
  gx as C
};
