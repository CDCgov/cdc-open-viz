...
import { A as $e, a as re, b as le, c as oe, d as ce, e as Ze } from "./storybook-index-66852bf6.es.js";
import { a as fe, W as Je } from "./storybook-Icon-736fb775.es.js";
...
import { L as ne, a as Ke } from "./storybook-coveUpdateWorker-785760a1.es.js";
import { T as et, H as ge } from "./storybook-index-e5bf02db.es.js";
import { a as tt, g as at } from "./storybook-isSolr-cb863e7a.es.js";
import { D as nt } from "./storybook-DataTransform-e292f51b.es.js";
import { n as rt } from "./storybook-numberFromString-24623c03.es.js";
import { f as lt } from "./storybook-fetchRemoteData-8fd8b50f.es.js";
...
function it(t, l, m) {
  var h = this, u = p.useRef(null), C = p.useRef(0), y = p.useRef(null), N = p.useRef([]), F = p.useRef(), c = p.useRef(), a = p.useRef(t), _ = p.useRef(!0);
  a.current = t;
  var R = !l && l !== 0 && typeof window < "u";
  if (typeof t != "function")
    throw new TypeError("Expected a function");
  l = +l || 0, m = m || {};
  var j = !!m.leading, V = "trailing" in m ? !!m.trailing : !0, P = "maxWait" in m, M = P ? Math.max(+m.maxWait || 0, l) : null;
  ...
  var S = p.useMemo(function() {
    var A = function(D) {
      ...
      return N.current = F.current = null, C.current = D, c.current = a.current.apply(U, I);
    }, X = function(D, I) {
      R && cancelAnimationFrame(y.current), y.current = R ? requestAnimationFrame(D) : setTimeout(D, I);
    }, G = function(D) {
      if (!_.current)
        return !1;
      var I = D - u.current, U = D - C.current;
      return !u.current || I >= l || I < 0 || P && U >= M;
    }, W = function(D) {
      ...
      if (G(D))
        return W(D);
      if (_.current) {
        var I = D - u.current, U = D - C.current, r = l - I, o = P ? Math.min(r, M - U) : r;
        X(k, o);
      }
    }, J = function() {
      ...
      if (N.current = D, F.current = h, u.current = U, r) {
        if (!y.current && _.current)
          return C.current = u.current, X(k, l), j ? A(u.current) : c.current;
        if (P)
    ...
    return J.cancel = function() {
      y.current && (R ? cancelAnimationFrame(y.current) : clearTimeout(y.current)), C.current = 0, N.current = u.current = F.current = y.current = null;
...
function mt(t) {
  var l = p.useState(he(t)), m = l[0], h = l[1], u = p.useCallback(function(C) {
    return h(he(C));
  }, []);
  return [m, u];
}
function ut(t, l, m) {
  var h = m && m.equalityFn || st, u = mt(t), C = u[0], y = u[1], N = it(p.useCallback(function(c) {
    return y(c);
  }, [y]), l, m), F = p.useRef(t);
  return h(F.current, t) || (N(t), F.current = t), [C, N];
}
const $ = p.memo(({ label: t, section: l = null, subsection: m = null, fieldName: h, updateField: u, value: C, tooltip: y, type: N = "input", i: F = null, min: c = null, max: a = null, ..._ }) => {
  const [R, j] = p.useState(C), [V] = ut(R, 500);
  p.useEffect(() => {
    typeof V == "string" && C !== V && u(l, m, h, V, F);
  }, [V, l, m, h, F, C, u]);
  let P = m ? `${l}-${m}-${h}` : `${l}-${m}-${h}`;
  const M = (A) => {
...
}), ee = p.memo(({ label: t, value: l, fieldName: m, section: h = null, subsection: u = null, tooltip: C, updateField: y, ...N }) => /* @__PURE__ */ e.createElement("label", { className: "checkbox" }, /* @__PURE__ */ e.createElement(
  "input",
  {
    type: "checkbox",
    name: m,
...
), /* @__PURE__ */ e.createElement("span", { className: "edit-label column-heading" }, t), /* @__PURE__ */ e.createElement("span", { className: "cove-icon" }, C))), ae = p.memo(({ label: t, value: l, options: m, fieldName: h, section: u = null, subsection: C = null, required: y = !1, updateField: N, initial: F, ...c }) => {
  let a = "";
  if (Array.isArray(m))
  ...
  var k, J, D, I, U;
  const { config: t, updateConfig: l, loading: m, data: h, setParentConfig: u, isDashboard: C, isEditor: y } = p.useContext(Re), [N, F] = p.useState(!0), c = Ye(t, l, !0);
  p.useEffect(() => {
    if (u) {
      const r = _();
      delete r.newViz, u(r);
  ...
  return m ? null : /* @__PURE__ */ e.createElement(Qe, { component: "EditorPanel" }, /* @__PURE__ */ e.createElement(ne.Sidebar, { isEditor: !0, config: t, title: "Configure Data Bites", onBackClick: a, displayPanel: N }, /* @__PURE__ */ e.createElement("section", { className: "form-container" }, /* @__PURE__ */ e.createElement("form", null, /* @__PURE__ */ e.createElement($e, { allowZeroExpanded: !0 }, /* @__PURE__ */ e.createElement(re, null, " ", /* @__PURE__ */ e.createElement(le, null, /* @__PURE__ */ e.createElement(oe, null, "General")), /* @__PURE__ */ e.createElement(ce, null, /* @__PURE__ */ e.createElement(ae, { value: t.biteStyle, fieldName: "biteStyle", label: "Data Bite Style", updateField: c, options: ht, initial: "Select" }), /* @__PURE__ */ e.createElement($, { value: t.title, fieldName: "title", label: "Title", placeholder: "Data Bite Title", updateField: c }), /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("option", { value: "" }, "- Select Option -"),
    M(o).map((d, E) => /* @__PURE__ */ e.createElement("option", { value: d, key: E }, d))
...
const gt = (t) => {
  const { configUrl: l, config: m, isDashboard: h = !1, isEditor: u = !1, setConfig: C, link: y } = t, N = {
    config: m ?? ie,
    loading: !0,
    currentViewport: "lg",
    coveLoadedHasRan: !1,
    ...
    s.data = f;
    const z = { ...await Ke(s) };
    d({ ...ie, ...z }), c({ type: "SET_LOADING", payload: !1 });
  }, x = (s = !0) => {
    if (!M || !S)
      return "";
    const f = (n) => {
    ...
    }, z = (n) => (a.dataFormat.ignoreZeros && (T = T.filter((i) => i && i)), T.length), B = (n) => {
      if (n == null) {
      ...
      const i = "en-US";
      let v = parseFloat(n).toLocaleString(i, {
        useGrouping: !0,
    ...
    switch (K.length ? K.forEach((n) => {
      let i = rt(n[M]);
      typeof i == "number" && T.push(i);
    }) : a.dataColumn && a.data && (T = a.data.map((n) => Number(n[a.dataColumn]))), S) {
      case Be:
        g = z();
        break;
      case ze:
  ...
  const te = p.useCallback(() => {
    ...
    if (A.display === "dynamic" && A.options && ((B = A.options) == null ? void 0 : B.length) > 0) {
      ...
      A.options.forEach((H, Y) => {
        var n, i;
        let g = H.arguments, { source: K, alt: T } = H;
        w === !1 && g.length > 0 && g[0].operator.length > 0 && g[0].threshold.length > 0 && s[g[0].operator](O, g[0].threshold) && (g[1] !== void 0 ? ((n = g[1].operator) == null ? void 0 : n.length) > 0 && ((i = g[1].threshold) == null ? void 0 : i.length) > 0 && s[g[1].operator](O, g[1].threshold) && (f = K, T !== "" && T !== void 0 && (z = T), w = !0) : (f = K, T !== "" && T !== void 0 && (z = T), w = !0));
      });
    }
