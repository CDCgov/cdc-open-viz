...
import { B as i } from "./storybook-Button-63da743c.es.js";
...
const N = (m) => {
  ...
  return p.useEffect(() => {
    ...
    {
      onChange: (t) => {
        t.target.value && (!a.dataDescription.valueKeysTallSupport || a.dataDescription.valueKeysTallSupport.indexOf(t.target.value) === -1) && r("valueKeysTallSupport", [
          ...a.dataDescription.valueKeysTallSupport || [],
          t.target.value
        ]);
      }
    },
    /* @__PURE__ */ React.createElement("option", { value: "" }, "Choose an option"),
    Object.keys(a.data[0]).filter(
      (t) => !a.dataDescription.valueKeysTallSupport || a.dataDescription.valueKeysTallSupport.indexOf(t) === -1
    ).map((t, n) => /* @__PURE__ */ React.createElement("option", { value: t, key: `value-keys-option-${n}` }, t))
    ...
    {
      onChange: (t) => {
        t.target.value && r("ignoredKeys", [
          ...a.dataDescription.ignoredKeys || [],
          t.target.value
        ]), t.target.value = "";
      }
    },
    /* @__PURE__ */ React.createElement("option", { value: "" }, "Choose an option"),
    Object.keys(a.data[0]).filter(
      (t) => !a.dataDescription.ignoredKeys || a.dataDescription.ignoredKeys.indexOf(t) === -1
    ).map((t, n) => /* @__PURE__ */ React.createElement("option", { value: t, key: `ignored-keys-option-${n}` }, t))
