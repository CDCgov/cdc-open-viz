...
import { _ as Kr, P as _y, D as Ny, C as Oy, A as Fy, d as bi, F as tp, g as My } from "./storybook-Filters-085415ef.es.js";
...
import { C as sg, V as ug, a as yp } from "./storybook-footnoteSymbols-c8ec8308.es.js";
...
const VE = ({ xScale: e, yScale: t, xScaleAnnotation: n, xMax: a, svgRef: i, onDragStateChange: l }) => {
  ...
  return R && R.map((h, P) => {
    ...
    return /* @__PURE__ */ r.createElement(
      ...
      h.marker === "circle" && /* @__PURE__ */ r.createElement(Yy, { className: "circle-subject", stroke: F(h.seriesKey), radius: 8 }),
