...
}(), d = typeof window < "u" && typeof document < "u" && window.document === document, f = function() {
...
var x = 20, A = ["top", "right", "bottom", "left", "width", "height", "size", "weight"], z = typeof MutationObserver < "u", T = (
  ...
  function() {
    ...
    return e.prototype.addObserver = function(t) {
      ...
      var n = t.propertyName, r = n === void 0 ? "" : n, i = A.some(function(o) {
        return !!~r.indexOf(o);
      });
      i && this.refresh();
...
function D(e) {
  ...
  if (!t && !n)
    return g;
  var r = c(e).getComputedStyle(e), i = C(r), o = i.left + i.right, s = i.top + i.bottom, a = h(r.width), u = h(r.height);
...
var W = (
  ...
  function() {
    function e(t) {
      ...
      if (!arguments.length)
        throw new TypeError("1 argument required, but only 0 present.");
      var n = T.getInstance(), r = new H(t, n, this);
      w.set(this, r);
    }
    return e;
  }()
...
const k = (e) => !!(e != null && e.includes("wt=csv")), q = (e) => !!(e != null && e.includes("wt=json")), _ = {
  lg: 1200,
  md: 992,
  sm: 768,
  xs: 576,
