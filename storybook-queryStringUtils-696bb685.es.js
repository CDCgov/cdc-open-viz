import { r as N, R as i } from "./storybook-index-45401197.es.js";
import { S as I, b as G } from "./storybook-Icon-ee109bed.es.js";
...
function X(e) {
  var t = new FileReader(), r = M(t), n = /charset=([A-Za-z0-9_-]+)/.exec(e.type), s = n ? n[1] : "utf-8";
...
function q(e, t) {
  return new Promise(function(r, n) {
    ...
    o.onload = function() {
      ...
      s.url.indexOf("file://") === 0 && (o.status < 200 || o.status > 599) ? a.status = 200 : a.status = o.status, a.url = "responseURL" in o ? o.responseURL : a.headers.get("X-Request-URL");
