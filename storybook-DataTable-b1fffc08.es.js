import { R as d, r as LA } from "./storybook-index-45401197.es.js";
import { L as Tt, E as kr } from "./storybook-Loading-f180d060.es.js";
import { P as hs } from "./storybook-papaparse.min-b07ddc33.es.js";
import { u as ar, a as aa, t as sr, b as sa, c as Ke, d as ds, e as be, f as Le, g as ps, h as xe } from "./storybook-year-bedc547d.es.js";
...
function vs(e) {
  var A = e.dateTime, t = e.date, r = e.time, n = e.periods, a = e.days, s = e.shortDays, B = e.months, i = e.shortMonths, o = le(n), c = ue(n), l = le(a), u = ue(a), Q = le(s), g = ue(s), w = le(B), f = ue(B), C = le(i), F = ue(i), K = {
    a: AA,
    A: FA,
    b: iA,
    B: QA,
  ...
  K.x = h(t, K), K.X = h(r, K), K.c = h(A, K), y.x = h(t, y), y.X = h(r, y), y.c = h(A, y);
  function h(H, L) {
    return function(T) {
      var U = [], uA = -1, k = 0, wA = H.length, fA, _A, Vr;
      for (T instanceof Date || (T = /* @__PURE__ */ new Date(+T)); ++uA < wA; )
        H.charCodeAt(uA) === 37 && (U.push(H.slice(k, uA)), (_A = Pr[fA = H.charAt(++uA)]) != null ? fA = H.charAt(++uA) : _A = fA === "e" ? " " : "0", (Vr = L[fA]) && (fA = Vr(T, _A)), U.push(fA), k = uA + 1);
      return U.push(H.slice(k, uA)), U.join("");
    };
  }
  function b(H, L) {
    return function(T) {
      var U = ce(1900, void 0, 1), uA = I(U, H, T += "", 0), k, wA;
      if (uA != T.length)
        return null;
      if ("Q" in U)
        return new Date(U.Q);
      ...
      if (L && !("Z" in U) && (U.Z = 0), "p" in U && (U.H = U.H % 12 + U.p * 12), U.m === void 0 && (U.m = "q" in U ? U.q : 0), "V" in U) {
        if (U.V < 1 || U.V > 53)
          return null;
        "w" in U || (U.w = 1), "Z" in U ? (k = Ot(ce(U.y, 0, 1)), wA = k.getUTCDay(), k = wA > 4 || wA === 0 ? ar.ceil(k) : ar(k), k = aa.offset(k, (U.V - 1) * 7), U.y = k.getUTCFullYear(), U.m = k.getUTCMonth(), U.d = k.getUTCDate() + (U.w + 6) % 7) : (k = Mt(ce(U.y, 0, 1)), wA = k.getDay(), k = wA > 4 || wA === 0 ? sr.ceil(k) : sr(k), k = sa.offset(k, (U.V - 1) * 7), U.y = k.getFullYear(), U.m = k.getMonth(), U.d = k.getDate() + (U.w + 6) % 7);
      } else
  ...
  function I(H, L, T, U) {
    for (var uA = 0, k = L.length, wA = T.length, fA, _A; uA < k; ) {
      ...
      if (fA = L.charCodeAt(uA++), fA === 37) {
        if (fA = L.charAt(uA++), _A = m[fA in Pr ? L.charAt(uA++) : fA], !_A || (U = _A(H, T, U)) < 0)
          return -1;
...
function AB(e, A) {
  return e = ia(e), S(be.count(Ke(e), e) + (Ke(e).getDay() === 4), A, 2);
}
function eB(e) {
  return e.getDay();
}
...
function cB(e, A) {
  return S(1 + aa.count(Le(e), e), A, 3);
}
function oa(e, A) {
...
function fB(e, A) {
  return S(ps.count(Le(e) - 1, e), A, 2);
}
function ca(e) {
  var A = e.getUTCDay();
...
function CB(e, A) {
  return e = ca(e), S(xe.count(Le(e), e) + (Le(e).getUTCDay() === 4), A, 2);
}
function UB(e) {
  return e.getUTCDay();
}
function FB(e, A) {
  return S(ar.count(Le(e) - 1, e), A, 2);
}
function hB(e, A) {
...
const An = (e) => {
  ...
  a && (e = Math.abs(e));
  let {
    dataFormat: { commas: s, abbreviated: B, roundTo: i, prefix: o, suffix: c, rightRoundTo: l, bottomRoundTo: u, rightPrefix: Q, rightSuffix: g, bottomPrefix: w, bottomSuffix: f, bottomAbbreviated: C }
  } = r;
  ...
  if (A === "left") {
    ...
    let R;
    F !== void 0 ? R = !!F : R = !!r.dataFormat.commas, b = {
      useGrouping: R,
  ...
  let I = "";
  return B && A === "left" && t && (e = An(parseFloat(e))), C && A === "bottom" && t && (e = An(parseFloat(e))), y !== void 0 && A === "left" ? I = y + I : o && A === "left" && (I = o + I), Q && A === "right" && (I += Q), w && A === "bottom" && (I += w), I += e, m !== void 0 && A === "left" ? I += m : c && A === "left" && (I += c), g && A === "right" && (I += g), f && A === "bottom" && (I += f), a && (I = "-" + I), String(I);
...
function ua({ fill: e, borderColor: A, display: t = "inline-block", viewport: r }) {
  ...
  return /* @__PURE__ */ d.createElement("span", { className: "legend-item", style: a });
}
/*!
...
var KB = function(e) {
  ...
  for (r = 0; r < t; r += 4)
    a = Ce[e.charCodeAt(r)], s = Ce[e.charCodeAt(r + 1)], B = Ce[e.charCodeAt(r + 2)], i = Ce[e.charCodeAt(r + 3)], c[n++] = a << 2 | s >> 4, c[n++] = (s & 15) << 4 | B >> 2, c[n++] = (B & 3) << 6 | i & 63;
  return o;
}, bB = function(e) {
  ...
  var t = KB(e), r = Array.isArray(t) ? LB(t) : new Uint32Array(t), n = Array.isArray(t) ? bB(t) : new Uint16Array(t), a = 24, s = nn(n, a / 2, r[4] / 2), B = r[5] === 2 ? nn(n, (a + r[4]) / 2) : kB(r, Math.ceil((a + r[4]) / 4));
...
var JB = "", sn = 50, WB = 1, Qa = 2, wa = 3, YB = 4, ZB = 5, Bn = 7, fa = 8, on = 9, OA = 10, cr = 11, cn = 12, lr = 13, zB = 14, Ue = 15, ur = 16, ke = 17, ge = 18, jB = 19, ln = 20, gr = 21, Qe = 22, Gt = 23, jA = 24, CA = 25, Fe = 26, he = 27, qA = 28, qB = 29, JA = 30, $B = 31, _e = 32, Pe = 33, Qr = 34, wr = 35, fr = 36, De = 37, Cr = 38, Bt = 39, it = 40, Vt = 41, Ca = 42, Ai = 43, ei = [9001, 65288], Ua = "!", x = "×", Xe = "÷", Ur = _B(JB), KA = [JA, fr], Fr = [WB, Qa, wa, ZB], Fa = [OA, fa], un = [he, Fe], ti = Fr.concat(Fa), gn = [Cr, Bt, it, Qr, wr], ri = [Ue, lr], ni = function(e, A) {
  ...
  if (Fr.indexOf(i) !== -1)
    return Ua;
  if (Fr.indexOf(c) !== -1 || Fa.indexOf(c) !== -1)
    return x;
  if (Qn(a, A) === fa)
    return Xe;
  if (Ur.get(e[a]) === cr || (i === _e || i === Pe) && Ur.get(e[B]) === cr || i === Bn || c === Bn || i === on || [OA, lr, Ue].indexOf(i) === -1 && c === on || [ke, ge, jB, jA, qA].indexOf(c) !== -1 || Qn(a, A) === Qe || kt(Gt, Qe, a, A) || kt([ke, ge], gr, a, A) || kt(cn, cn, a, A))
    return x;
  if (i === OA)
    return Xe;
  if (i === Gt || c === Gt)
  ...
  if (c === ur || i === ur)
    return Xe;
  if ([lr, Ue, gr].indexOf(c) !== -1 || i === zB || o === fr && ri.indexOf(i) !== -1 || i === qA && c === fr || c === ln || KA.indexOf(c) !== -1 && i === CA || KA.indexOf(i) !== -1 && c === CA || i === he && [De, _e, Pe].indexOf(c) !== -1 || [De, _e, Pe].indexOf(i) !== -1 && c === Fe || KA.indexOf(i) !== -1 && un.indexOf(c) !== -1 || un.indexOf(i) !== -1 && KA.indexOf(c) !== -1 || // (PR | PO) × ( OP | HY )? NU
  [he, Fe].indexOf(i) !== -1 && (c === CA || [Qe, Ue].indexOf(c) !== -1 && A[B + 1] === CA) || // ( OP | HY ) × NU
  [Qe, Ue].indexOf(i) !== -1 && c === CA || // NU ×	(NU | SY | IS)
  i === CA && [CA, qA, jA].indexOf(c) !== -1)
    return x;
  if ([CA, qA, jA, ke, ge].indexOf(c) !== -1)
    for (var l = a; l >= 0; ) {
      var u = A[l];
      if (u === CA)
        return x;
  ...
  if ([he, Fe].indexOf(c) !== -1)
    for (var l = [ke, ge].indexOf(i) !== -1 ? s : a; l >= 0; ) {
      var u = A[l];
      if (u === CA)
        return x;
      if ([qA, jA].indexOf(u) !== -1)
  ...
  if (Cr === i && [Cr, Bt, Qr, wr].indexOf(c) !== -1 || [Bt, Qr].indexOf(i) !== -1 && [Bt, it].indexOf(c) !== -1 || [it, wr].indexOf(i) !== -1 && c === it || gn.indexOf(i) !== -1 && [ln, Fe].indexOf(c) !== -1 || gn.indexOf(c) !== -1 && i === he || KA.indexOf(i) !== -1 && KA.indexOf(c) !== -1 || i === jA && KA.indexOf(c) !== -1 || KA.concat(CA).indexOf(i) !== -1 && c === Qe && ei.indexOf(e[B]) === -1 || KA.concat(CA).indexOf(c) !== -1 && i === ge)
    return x;
  if (i === Vt && c === Vt) {
  ...
  (A.wordBreak === "break-all" || A.wordBreak === "break-word") && (n = n.map(function(B) {
    return [CA, JA, Ca].indexOf(B) !== -1 ? De : B;
  }));
...
}, oi = 1, ci = 2, Me = 4, wn = 8, Qt = 10, fn = 47, He = 92, li = 9, ui = 32, Je = 34, we = 61, gi = 35, Qi = 36, wi = 37, We = 39, Ye = 40, fe = 41, fi = 95, gA = 45, Ci = 33, Ui = 60, Fi = 62, hi = 64, di = 91, pi = 93, Ei = 61, Hi = 123, Ze = 63, vi = 125, Cn = 124, mi = 126, Ii = 128, Un = 65533, _t = 42, WA = 43, yi = 44, Ki = 58, bi = 59, Te = 46, Li = 0, xi = 8, Di = 11, Ti = 14, Si = 31, Mi = 127, mA = -1, ha = 48, da = 97, pa = 101, Oi = 102, Ni = 117, Ri = 122, Ea = 65, Ha = 69, va = 70, Gi = 85, Vi = 90, BA = function(e) {
  return e >= ha && e <= 57;
}, ki = function(e) {
  ...
  return e === WA || e === gA ? BA(A) ? !0 : A === Te && BA(t) : BA(e === Te ? A : e);
}, Yi = function(e) {
  var A = 0, t = 1;
  (e[A] === WA || e[A] === gA) && (e[A] === gA && (t = -1), A++);
  for (var r = []; BA(e[A]); )
    r.push(e[A++]);
  ...
  for (var a = []; BA(e[A]); )
    a.push(e[A++]);
  var s = a.length, B = s ? parseInt(Z.apply(void 0, a), 10) : 0;
  (e[A] === Ha || e[A] === pa) && A++;
  var i = 1;
  (e[A] === WA || e[A] === gA) && (e[A] === gA && (i = -1), A++);
  for (var o = []; BA(e[A]); )
    o.push(e[A++]);
    ...
    return e.prototype.write = function(A) {
      ...
      if (r) {
        var n = parseInt(Z.apply(void 0, A.map(function(i) {
          return i === Ze ? ha : i;
        })), 16), a = parseInt(Z.apply(void 0, A.map(function(i) {
          return i === Ze ? va : i;
        })), 16);
        return { type: 30, start: n, end: a };
      }
      var s = parseInt(Z.apply(void 0, A), 16);
      if (this.peekCodePoint(0) === gA && $A(this.peekCodePoint(1))) {
        this.consumeCodePoint(), t = this.consumeCodePoint();
        for (var B = []; $A(t) && B.length < 6; )
          B.push(t), t = this.consumeCodePoint();
        var a = parseInt(Z.apply(void 0, B), 16);
      ...
      do {
        ...
        if (n === He) {
          ...
          a !== mA && a !== void 0 && (a === Qt ? (t += this.consumeStringSlice(r), r = -1, this._value.shift()) : MA(n, a) && (t += this.consumeStringSlice(r), t += Z(this.consumeEscapedCodePoint()), r = -1));
        }
        r++;
      } while (!0);
    }, e.prototype.consumeNumber = function() {
      var A = [], t = Me, r = this.peekCodePoint(0);
      for ((r === WA || r === gA) && A.push(this.consumeCodePoint()); BA(this.peekCodePoint(0)); )
      ...
      if ((r === Ha || r === pa) && ((n === WA || n === gA) && BA(a) || BA(n)))
        for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), t = wn; BA(this.peekCodePoint(0)); )
          A.push(this.consumeCodePoint());
      return [Yi(A), t];
  ...
  return e.number;
}, ba = "deg", La = "grad", xa = "rad", Da = "turn", mt = {
  name: "angle",
  parse: function(e, A) {
    if (A.type === 15)
      switch (A.unit) {
  ...
  return e.type === 15 && (e.unit === ba || e.unit === La || e.unit === xa || e.unit === Da);
}, Sa = function(e) {
...
var pn = function(e, A) {
  var t = A.filter(Be), r = t[0], n = t[1], a = t[2], s = t[3], B = (r.type === 17 ? pA(r.number) : mt.parse(e, r)) / (Math.PI * 2), i = z(n) ? n.number / 100 : 0, o = z(a) ? a.number / 100 : 0, c = typeof s < "u" && z(s) ? _(s, 1) : 1;
  if (i === 0)
    return RA(o * 255, o * 255, o * 255, 1);
  var l = o <= 0.5 ? o * (i + 1) : o + i - o * i, u = o * 2 - l, Q = Xt(u, l, B + 1 / 3), g = Xt(u, l, B), w = Xt(u, l, B - 1 / 3);
  ...
  switch (e.size) {
    ...
    case 3:
      if (e.shape === 0)
        ...
        var B = Math.max(Math.abs(t), Math.abs(t - n)) / Math.max(Math.abs(A), Math.abs(A - r)), l = Hn(r, n, A, t, !1), o = l[0], c = l[1];
        a = HA(o - A, (c - t) / B), s = B * a;
      }
      break;
  }
  ...
  return IA(A).forEach(function(i, o) {
    ...
    if (c.type === 18) {
      if (c.name === "from") {
        ...
        r.push({ stop: aA, color: l });
      } else if (c.name === "to") {
        var l = GA.parse(e, c.values[0]);
        r.push({ stop: NA, color: l });
      } else if (c.name === "color-stop") {
        var u = c.values.filter(Be);
        if (u.length === 2) {
...
var $c = function(e) {
  ...
  var o = typeof ArrayBuffer < "u" && typeof Uint8Array < "u" && typeof Uint8Array.prototype.slice < "u" ? new ArrayBuffer(A) : new Array(A), c = Array.isArray(o) ? o : new Uint8Array(o);
  for (r = 0; r < t; r += 4)
    a = pe[e.charCodeAt(r)], s = pe[e.charCodeAt(r + 1)], B = pe[e.charCodeAt(r + 2)], i = pe[e.charCodeAt(r + 3)], c[n++] = a << 2 | s >> 4, c[n++] = (s & 15) << 4 | B >> 2, c[n++] = (B & 3) << 6 | i & 63;
  return o;
}, Al = function(e) {
  for (var A = e.length, t = [], r = 0; r < A; r += 2)
    t.push(e[r + 1] << 8 | e[r]);
  ...
  for (var A = e.length, t = [], r = 0; r < A; r += 4)
    t.push(e[r + 3] << 24 | e[r + 2] << 16 | e[r + 1] << 8 | e[r]);
  return t;
}, ZA = 5, Mr = 6 + 5, Jt = 2, tl = Mr - ZA, Ja = 65536 >> ZA, rl = 1 << ZA, Wt = rl - 1, nl = 1024 >> ZA, al = Ja + nl, sl = al, Bl = 32, il = sl + Bl, ol = 65536 >> Mr, cl = 1 << tl, ll = cl - 1, bn = function(e, A, t) {
  return e.slice ? e.slice(A, t) : new Uint16Array(Array.prototype.slice.call(e, A, t));
}, ul = function(e, A, t) {
  return e.slice ? e.slice(A, t) : new Uint32Array(Array.prototype.slice.call(e, A, t));
}, gl = function(e, A) {
  var t = $c(e), r = Array.isArray(t) ? el(t) : new Uint32Array(t), n = Array.isArray(t) ? Al(t) : new Uint16Array(t), a = 24, s = bn(n, a / 2, r[4] / 2), B = r[5] === 2 ? bn(n, (a + r[4]) / 2) : ul(r, Math.ceil((a + r[4]) / 4));
...
var fl = 1, Yt = 2, Zt = 3, xn = 4, Dn = 5, Cl = 7, Tn = 8, zt = 9, jt = 10, Sn = 11, Mn = 12, On = 13, Nn = 14, qt = 15, Ul = function(e) {
      ...
      if (nA.SUPPORT_RANGE_BOUNDS) {
        ...
        if (i.length > 1) {
          ...
          o.forEach(function(u) {
            a.push(new Ie(u, DA.fromDOMRectList(e, Vn(r, c + s, u.length).getClientRects()))), c += u.length;
          });
        } else
          a.push(new Ie(B, DA.fromDOMRectList(e, i)));
      } else {
        var l = r.splitText(B.length);
        a.push(new Ie(B, xl(e, r))), r = l;
      }
    else
...
}, re = 1, TA = 2, SA = 4, Ee = 8, bA = function(e, A, t, r, n, a) {
  if (e < -9999 || e > 9999)
  ...
  switch (A) {
    ...
    case 47:
      return bA(e, "零壹貳參肆伍陸柒捌玖", Zn, "負", n, re | TA | SA | Ee);
    case 42:
      return bA(e, "零一二三四五六七八九", Yn, "负", n, TA | SA | Ee);
    case 41:
      return bA(e, "零壹贰叁肆伍陆柒捌玖", Zn, "负", n, re | TA | SA | Ee);
    case 26:
      return bA(e, "〇一二三四五六七八九", "十百千万", zn, n, 0);
    case 25:
      return bA(e, "零壱弐参四伍六七八九", "拾百千万", zn, n, re | TA | SA);
    case 31:
      return bA(e, "영일이삼사오육칠팔구", "십백천만", Ar, a, re | TA | SA);
    case 33:
      return bA(e, "零一二三四五六七八九", "十百千萬", Ar, a, 0);
    case 32:
      return bA(e, "零壹貳參四五六七八九", "拾百千", Ar, a, re | TA | SA);
    case 18:
  ...
  function() {
    ...
    return e.prototype.toIFrame = function(A, t) {
      ...
      if (r && ae(A) && (mr(A) || ct(A))) {
        ...
        return c && n.appendChild(c), this.counters.pop(i), (a && (this.options.copyStyles || ct(A)) && !as(A) || t) && er(a, n), (A.scrollTop !== 0 || A.scrollLeft !== 0) && this.scrolledElements.push([n, A.scrollLeft, A.scrollTop]), (Ft(A) || ht(A)) && (Ft(n) || ht(n)) && (n.value = A.value), n;
      }
      return A.cloneNode(!1);
        ...
        if (!(!B || !s || s === "none" || s === "-moz-alt-content" || r.display === "none")) {
          ...
          er(r, o), i.content.forEach(function(l) {
            if (l.type === 0)
              ...
              if (l.name === "attr") {
                var Q = l.values.filter(G);
                Q.length && o.appendChild(B.createTextNode(A.getAttribute(Q[0].value) || ""));
              } else if (l.name === "counter") {
                var g = l.values.filter(Be), w = g[0], f = g[1];
                if (w && G(w)) {
                  var C = a.counters.getCounterValue(w.value), F = f && G(f) ? pr.parse(a.context, f.value) : 3;
                  o.appendChild(B.createTextNode(Se(C, F, !1)));
                }
              } else if (l.name === "counters") {
                var K = l.values.filter(Be), w = K[0], y = K[1], f = K[2];
                if (w && G(w)) {
                  var m = a.counters.getCounterValues(w.value), h = f && G(f) ? pr.parse(a.context, f.value) : 3, b = y && y.type === 0 ? y.value : "", I = m.map(function(j) {
                    return Se(j, h, !1);
                  }).join(b);
...
var ru = function(e, A) {
  ...
  function() {
    function e(A) {
      var t = A.styles, r = A.bounds, n = de(t.borderTopLeftRadius, r.width, r.height), a = n[0], s = n[1], B = de(t.borderTopRightRadius, r.width, r.height), i = B[0], o = B[1], c = de(t.borderBottomRightRadius, r.width, r.height), l = c[0], u = c[1], Q = de(t.borderBottomLeftRadius, r.width, r.height), g = Q[0], w = Q[1], f = [];
      f.push((a + i) / r.width), f.push((g + l) / r.width), f.push((s + w) / r.height), f.push((o + u) / r.height);
      var C = Math.max.apply(Math, f);
      C > 1 && (a /= C, s /= C, i /= C, o /= C, l /= C, u /= C, g /= C, w /= C);
      var F = r.width - i, K = r.height - u, y = r.width - l, m = r.height - w, h = t.borderTopWidth, b = t.borderRightWidth, I = t.borderBottomWidth, v = t.borderLeftWidth, R = _(t.paddingTop, A.bounds.width), j = _(t.paddingRight, A.bounds.width), q = _(t.paddingBottom, A.bounds.width), D = _(t.paddingLeft, A.bounds.width);
      this.topLeftBorderDoubleOuterBox = a > 0 || s > 0 ? X(r.left + v / 3, r.top + h / 3, a - v / 3, s - h / 3, N.TOP_LEFT) : new p(r.left + v / 3, r.top + h / 3), this.topRightBorderDoubleOuterBox = a > 0 || s > 0 ? X(r.left + F, r.top + h / 3, i - b / 3, o - h / 3, N.TOP_RIGHT) : new p(r.left + r.width - b / 3, r.top + h / 3), this.bottomRightBorderDoubleOuterBox = l > 0 || u > 0 ? X(r.left + y, r.top + K, l - b / 3, u - I / 3, N.BOTTOM_RIGHT) : new p(r.left + r.width - b / 3, r.top + r.height - I / 3), this.bottomLeftBorderDoubleOuterBox = g > 0 || w > 0 ? X(r.left + v / 3, r.top + m, g - v / 3, w - I / 3, N.BOTTOM_LEFT) : new p(r.left + v / 3, r.top + r.height - I / 3), this.topLeftBorderDoubleInnerBox = a > 0 || s > 0 ? X(r.left + v * 2 / 3, r.top + h * 2 / 3, a - v * 2 / 3, s - h * 2 / 3, N.TOP_LEFT) : new p(r.left + v * 2 / 3, r.top + h * 2 / 3), this.topRightBorderDoubleInnerBox = a > 0 || s > 0 ? X(r.left + F, r.top + h * 2 / 3, i - b * 2 / 3, o - h * 2 / 3, N.TOP_RIGHT) : new p(r.left + r.width - b * 2 / 3, r.top + h * 2 / 3), this.bottomRightBorderDoubleInnerBox = l > 0 || u > 0 ? X(r.left + y, r.top + K, l - b * 2 / 3, u - I * 2 / 3, N.BOTTOM_RIGHT) : new p(r.left + r.width - b * 2 / 3, r.top + r.height - I * 2 / 3), this.bottomLeftBorderDoubleInnerBox = g > 0 || w > 0 ? X(r.left + v * 2 / 3, r.top + m, g - v * 2 / 3, w - I * 2 / 3, N.BOTTOM_LEFT) : new p(r.left + v * 2 / 3, r.top + r.height - I * 2 / 3), this.topLeftBorderStroke = a > 0 || s > 0 ? X(r.left + v / 2, r.top + h / 2, a - v / 2, s - h / 2, N.TOP_LEFT) : new p(r.left + v / 2, r.top + h / 2), this.topRightBorderStroke = a > 0 || s > 0 ? X(r.left + F, r.top + h / 2, i - b / 2, o - h / 2, N.TOP_RIGHT) : new p(r.left + r.width - b / 2, r.top + h / 2), this.bottomRightBorderStroke = l > 0 || u > 0 ? X(r.left + y, r.top + K, l - b / 2, u - I / 2, N.BOTTOM_RIGHT) : new p(r.left + r.width - b / 2, r.top + r.height - I / 2), this.bottomLeftBorderStroke = g > 0 || w > 0 ? X(r.left + v / 2, r.top + m, g - v / 2, w - I / 2, N.BOTTOM_LEFT) : new p(r.left + v / 2, r.top + r.height - I / 2), this.topLeftBorderBox = a > 0 || s > 0 ? X(r.left, r.top, a, s, N.TOP_LEFT) : new p(r.left, r.top), this.topRightBorderBox = i > 0 || o > 0 ? X(r.left + F, r.top, i, o, N.TOP_RIGHT) : new p(r.left + r.width, r.top), this.bottomRightBorderBox = l > 0 || u > 0 ? X(r.left + y, r.top + K, l, u, N.BOTTOM_RIGHT) : new p(r.left + r.width, r.top + r.height), this.bottomLeftBorderBox = g > 0 || w > 0 ? X(r.left, r.top + m, g, w, N.BOTTOM_LEFT) : new p(r.left, r.top + r.height), this.topLeftPaddingBox = a > 0 || s > 0 ? X(r.left + v, r.top + h, Math.max(0, a - v), Math.max(0, s - h), N.TOP_LEFT) : new p(r.left + v, r.top + h), this.topRightPaddingBox = i > 0 || o > 0 ? X(r.left + Math.min(F, r.width - b), r.top + h, F > r.width + b ? 0 : Math.max(0, i - b), Math.max(0, o - h), N.TOP_RIGHT) : new p(r.left + r.width - b, r.top + h), this.bottomRightPaddingBox = l > 0 || u > 0 ? X(r.left + Math.min(y, r.width - v), r.top + Math.min(K, r.height - I), Math.max(0, l - b), Math.max(0, u - I), N.BOTTOM_RIGHT) : new p(r.left + r.width - b, r.top + r.height - I), this.bottomLeftPaddingBox = g > 0 || w > 0 ? X(r.left + v, r.top + Math.min(m, r.height - I), Math.max(0, g - v), Math.max(0, w - I), N.BOTTOM_LEFT) : new p(r.left + v, r.top + r.height - I), this.topLeftContentBox = a > 0 || s > 0 ? X(r.left + v + D, r.top + h + R, Math.max(0, a - (v + D)), Math.max(0, s - (h + R)), N.TOP_LEFT) : new p(r.left + v + D, r.top + h + R), this.topRightContentBox = i > 0 || o > 0 ? X(r.left + Math.min(F, r.width + v + D), r.top + h + R, F > r.width + v + D ? 0 : i - v + D, o - (h + R), N.TOP_RIGHT) : new p(r.left + r.width - (b + j), r.top + h + R), this.bottomRightContentBox = l > 0 || u > 0 ? X(r.left + Math.min(y, r.width - (v + D)), r.top + Math.min(K, r.height + h + R), Math.max(0, l - (b + j)), u - (I + q), N.BOTTOM_RIGHT) : new p(r.left + r.width - (b + j), r.top + r.height - (I + q)), this.bottomLeftContentBox = g > 0 || w > 0 ? X(r.left + v + D, r.top + m, Math.max(0, g - (v + D)), w - (I + q), N.BOTTOM_LEFT) : new p(r.left + v + D, r.top + r.height - (I + q));
    }
    return e;
  }()
), N;
...
var X = function(e, A, t, r, n) {
  ...
  e.container.elements.forEach(function(n) {
    ...
    if (a || s) {
      var o = a || n.styles.isPositioned() ? t : A, c = new ls(B);
  ...
  return br(A, t, t, r), gs(A.container, r), t;
}, Aa = function(e, A) {
  switch (A) {
    case 0:
  ...
  var r = Du(ne(e.styles.backgroundOrigin, A), e), n = Tu(ne(e.styles.backgroundClip, A), e), a = Su(ne(e.styles.backgroundSize, A), t, r), s = a[0], B = a[1], i = de(ne(e.styles.backgroundPosition, A), r.width - s, r.height - B), o = Mu(ne(e.styles.backgroundRepeat, A), i, a, r, n), c = Math.round(r.left + i[0]), l = Math.round(r.top + i[1]);
  return [o, c, l, s, B];
}, te = function(e) {
  return G(e) && e.value === se.AUTO;
}, st = function(e) {
  ...
  var i = st(a);
  if (G(s) && (s.value === se.CONTAIN || s.value === se.COVER)) {
    if (st(a)) {
  ...
  if (i) {
    var C = 0, F = 0;
    return z(s) ? C = _(s, t.width) : z(B) && (F = _(B, t.height)), te(s) ? C = F * a : (!B || te(B)) && (F = C / a), [C, F];
  }
  var K = null, y = null;
  if (z(s) ? K = _(s, t.width) : B && z(B) && (y = _(B, t.height)), K !== null && (!B || te(B)) && (y = c && l ? K / r * n : t.height), y !== null && te(s) && (K = c && l ? y / n * r : t.width), K !== null && y !== null)
    return [K, y];
  ...
  function(e) {
    ...
    return A.prototype.applyEffects = function(t) {
      ...
      return cA(this, void 0, void 0, function() {
        var r, n, a, s, B, i, F, F, o, c, l, u, y, Q, g, m, w, f, C, F, K, y, m;
          ...
          switch (h.label) {
            case 0:
              this.applyEffects(t.getEffects(
                4
                /* CONTENT */
              )), r = t.container, n = t.curves, a = r.styles, s = 0, B = r.textNodes, h.label = 1;
            case 1:
            ...
            case 14:
              if (r instanceof Nr && (l = Math.min(r.bounds.width, r.bounds.height), r.type === Ct ? r.checked && (this.ctx.save(), this.path([
                ...
                new p(r.bounds.left + l * 0.39363, r.bounds.top + l * 0.79)
              ]), this.ctx.fillStyle = tA(kn), this.ctx.fill(), this.ctx.restore()) : r.type === Ut && r.checked && (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(r.bounds.left + l / 2, r.bounds.top + l / 2, l / 4, 0, Math.PI * 2, !0), this.ctx.fillStyle = tA(kn), this.ctx.fill(), this.ctx.restore())), Vu(r) && r.value.length) {
                switch (u = this.createFontStyle(a), y = u[0], Q = u[1], g = this.fontMetrics.getMetrics(y, Q).baseline, this.ctx.font = y, this.ctx.fillStyle = tA(a.color), this.ctx.textBaseline = "alphabetic", this.ctx.textAlign = _u(r.styles.textAlign), m = Et(r), w = 0, r.styles.textAlign) {
                  case 1:
                    w += m.width / 2;
                    break;
                  case 2:
                ...
                f = m.add(w, 0, 0, -m.height / 2 + 1), this.ctx.save(), this.path([
                  new p(m.left, m.top),
                  new p(m.left + m.width, m.top),
                  new p(m.left + m.width, m.top + m.height),
                  new p(m.left, m.top + m.height)
                ]), this.ctx.clip(), this.renderTextWithLetterSpacing(new Ie(r.value, f), a.letterSpacing, g), this.ctx.restore(), this.ctx.textBaseline = "alphabetic", this.ctx.textAlign = "left";
              }
              if (!eA(
                r.styles.display,
                2048
      ...
      return cA(this, void 0, void 0, function() {
        var r, n, C, a, s, C, B, i, C, o, c, C, l, u, C, Q, g, C, w, f, C;
        return sA(this, function(F) {
          switch (F.label) {
            ...
            case 6:
              F.sent(), a = 0, s = t.nonInlineLevel, F.label = 7;
            case 7:
            ...
            case 9:
              return a++, [3, 7];
            case 10:
              B = 0, i = t.nonPositionedFloats, F.label = 11;
            case 11:
            ...
            case 25:
              return Q++, [3, 23];
            case 26:
              w = 0, f = t.positiveZIndex, F.label = 27;
            case 27:
          ...
          switch (o.label) {
            case 0:
              r = t.styles.backgroundImage.length - 1, n = function(c) {
                var l, u, Q, R, $, AA, D, W, I, g, R, $, AA, D, W, w, f, C, F, K, y, m, h, b, I, v, R, j, q, D, W, UA, $, AA, FA, iA, QA, O, P, M, V, J;
                return sA(this, function(oA) {
                  switch (oA.label) {
                    case 0:
                      if (c.type !== 0)
                        return [3, 5];
                      l = void 0, u = c.url, oA.label = 1;
                    case 1:
                      return oA.trys.push([1, 3, , 4]), [4, a.context.cache.match(u)];
                    case 2:
                      return l = oA.sent(), [3, 4];
                    case 3:
                      return oA.sent(), a.context.logger.error("Error loading background-image " + u), [3, 4];
                    case 4:
                      return l && (Q = nr(t, r, [
                        l.width,
                        l.height,
                        l.width / l.height
                      ]), R = Q[0], $ = Q[1], AA = Q[2], D = Q[3], W = Q[4], I = a.ctx.createPattern(a.resizeImage(l, D, W), "repeat"), a.renderRepeat(R, I, $, AA)), [3, 6];
                    case 5:
                      mo(c) ? (g = nr(t, r, [null, null, null]), R = g[0], $ = g[1], AA = g[2], D = g[3], W = g[4], w = ho(c.angle, D, W), f = w[0], C = w[1], F = w[2], K = w[3], y = w[4], m = document.createElement("canvas"), m.width = D, m.height = W, h = m.getContext("2d"), b = h.createLinearGradient(C, K, F, y), En(c.stops, f).forEach(function(lA) {
                        return b.addColorStop(lA.stop, tA(lA.color));
                      }), h.fillStyle = b, h.fillRect(0, 0, D, W), D > 0 && W > 0 && (I = a.ctx.createPattern(m, "repeat"), a.renderRepeat(R, I, $, AA))) : Io(c) && (v = nr(t, r, [
                        null,
                        null,
                        null
                      ]), R = v[0], j = v[1], q = v[2], D = v[3], W = v[4], UA = c.position.length === 0 ? [Tr] : c.position, $ = _(UA[0], D), AA = _(UA[UA.length - 1], W), FA = po(c, $, AA, D, W), iA = FA[0], QA = FA[1], iA > 0 && QA > 0 && (O = a.ctx.createRadialGradient(j + $, q + AA, 0, j + $, q + AA, iA), En(c.stops, iA * 2).forEach(function(lA) {
                        return O.addColorStop(lA.stop, tA(lA.color));
                      }), a.path(R), a.ctx.fillStyle = O, iA !== QA ? (P = t.bounds.left + 0.5 * t.bounds.width, M = t.bounds.top + 0.5 * t.bounds.height, V = QA / iA, J = 1 / V, a.ctx.save(), a.ctx.translate(P, M), a.ctx.transform(1, 0, 0, V, 0, 0), a.ctx.translate(-P, -M), a.ctx.fillRect(j, J * (q - M) + M, D, W * J), a.ctx.restore()) : a.ctx.fill())), oA.label = 6;
                    case 6:
                      return r--, [
                        2
                        /*return*/
      ...
      return cA(this, void 0, void 0, function() {
        ...
        return sA(this, function(i) {
          switch (i.label) {
            ...
            case 2:
              return s = bu(a, n), this.path(s), this.ctx.fillStyle = tA(t), this.ctx.fill(), B = Lu(a, n), this.path(B), this.ctx.fill(), [
                2
                /*return*/
              ];
          }
          ...
          switch (u.label) {
            ...
            case 1:
              u.sent(), this.ctx.restore(), r.boxShadow.slice(0).reverse().forEach(function(Q) {
                l.ctx.save();
                var g = dt(t.curves), w = Q.inset ? 0 : Ru, f = yu(g, -w + (Q.inset ? 1 : -1) * Q.spread.number, (Q.inset ? 1 : -1) * Q.spread.number, Q.spread.number * (Q.inset ? -2 : 2), Q.spread.number * (Q.inset ? -2 : 2));
      ...
      return cA(this, void 0, void 0, function() {
        var B, i, o, c, l, u, Q, g, w, f, C, F, K, y, m, h, m, h;
        return sA(this, function(b) {
          return this.ctx.save(), B = xu(a, n), i = Aa(a, n), s === 2 && (this.path(i), this.ctx.clip()), dA(i[0]) ? (o = i[0].start.x, c = i[0].start.y) : (o = i[0].x, c = i[0].y), dA(i[1]) ? (l = i[1].end.x, u = i[1].end.y) : (l = i[1].x, u = i[1].y), n === 0 || n === 2 ? Q = Math.abs(o - l) : Q = Math.abs(c - u), this.ctx.beginPath(), s === 3 ? this.formatPath(B) : this.formatPath(i.slice(0, 2)), g = r < 3 ? r * 3 : r * 2, w = r < 3 ? r * 2 : r, s === 3 && (g = r, w = r), f = !0, Q <= g * 2 ? f = !1 : Q <= g * 2 + w ? (C = Q / (2 * g + w), g *= C, w *= C) : (F = Math.floor((Q + w) / (g + w)), K = (Q - F * g) / (F - 1), y = (Q - (F + 1) * g) / F, w = y <= 0 || Math.abs(w - K) < Math.abs(w - y) ? K : y), f && (s === 3 ? this.ctx.setLineDash([0, g + w]) : this.ctx.setLineDash([g, w])), s === 3 ? (this.ctx.lineCap = "round", this.ctx.lineWidth = r) : this.ctx.lineWidth = r * 2 + 1.1, this.ctx.strokeStyle = tA(t), this.ctx.stroke(), this.ctx.setLineDash([]), s === 2 && (dA(i[0]) && (m = i[3], h = i[0], this.ctx.beginPath(), this.formatPath([new p(m.end.x, m.end.y), new p(h.start.x, h.start.y)]), this.ctx.stroke()), dA(i[1]) && (m = i[1], h = i[2], this.ctx.beginPath(), this.formatPath([new p(m.end.x, m.end.y), new p(h.start.x, h.start.y)]), this.ctx.stroke())), this.ctx.restore(), [
            2
            /*return*/
          ];
        });
...
var ju = function(e, A) {
  return cA(void 0, void 0, void 0, function() {
    var t, r, n, a, s, B, i, o, c, l, u, Q, g, w, f, C, F, K, y, m, b, h, b, I, v, R, j, q, D, W, UA, $, AA, FA, iA, QA, O, P, M, V;
    return sA(this, function(J) {
      switch (J.label) {
        case 0:
          ...
          }, B = new DA(s.scrollX, s.scrollY, s.windowWidth, s.windowHeight), i = new Zu(a, B), o = ($ = A.foreignObjectRendering) !== null && $ !== void 0 ? $ : !1, c = {
            allowTaint: (AA = A.allowTaint) !== null && AA !== void 0 ? AA : !1,
            onclone: A.onclone,
            ignoreElements: A.ignoreElements,
            inlineImages: o,
            copyStyles: o
          }, i.logger.debug("Starting document clone with size " + B.width + "x" + B.height + " scrolled to " + -B.left + "," + -B.top), l = new jn(i, e, c), u = l.clonedReferenceElement, u ? [4, l.toIFrame(t, B)] : [2, Promise.reject("Unable to find element in cloned iframe")];
        case 1:
          return Q = J.sent(), g = Rr(u) || ql(u) ? IB(u.ownerDocument) : Ht(i, u), w = g.width, f = g.height, C = g.left, F = g.top, K = qu(i, u, A.backgroundColor), y = {
            canvas: A.canvas,
            backgroundColor: K,
            scale: (iA = (FA = A.scale) !== null && FA !== void 0 ? FA : r.devicePixelRatio) !== null && iA !== void 0 ? iA : 1,
            x: ((QA = A.x) !== null && QA !== void 0 ? QA : 0) + C,
            y: ((O = A.y) !== null && O !== void 0 ? O : 0) + F,
            width: (P = A.width) !== null && P !== void 0 ? P : Math.ceil(w),
            height: (M = A.height) !== null && M !== void 0 ? M : Math.ceil(f)
          }, o ? (i.logger.debug("Document cloned, using foreign object rendering"), b = new Ju(i, y), [4, b.render(u)]) : [3, 3];
        case 2:
          return m = J.sent(), [3, 5];
        case 3:
          return i.logger.debug("Document cloned, element located at " + C + "," + F + " with size " + w + "x" + f + " using computed rendering"), i.logger.debug("Starting DOM parsing"), h = es(i, u), K === h.styles.backgroundColor && (h.styles.backgroundColor = xA.TRANSPARENT), i.logger.debug("Starting renderer for element at " + y.x + "," + y.y + " with size " + y.width + "x" + y.height), b = new Gu(i, y), [4, b.render(h)];
        case 4:
          m = J.sent(), J.label = 5;
        case 5:
          return (!((V = A.removeContainer) !== null && V !== void 0) || V) && (jn.destroy(Q) || i.logger.error("Cannot detach cloned iframe as it is not in the DOM anymore")), i.logger.debug("Finished rendering"), [2, m];
      }
    });
  });
}, qu = function(e, A, t) {
...
const lt = {
  ...
  return /* @__PURE__ */ d.createElement("button", { className: a.join(" "), title: r, onClick: () => fs(e, t, n), style: { lineHeight: "1.4em" } }, lt[t]);
}, tg = ({ config: e, dashboardDataConfig: A }) => {
  var r;
  let t = A || e;
  return t.dataFileSourceType === "url" && t.dataFileName && e.table.showDownloadUrl ? /* @__PURE__ */ d.createElement("a", { href: t.dataFileName, title: lt.link, target: "_blank" }, lt.link) : (r = e == null ? void 0 : e.table) != null && r.showDownloadUrl && t.dataUrl ? /* @__PURE__ */ d.createElement("a", { href: t.dataUrl, title: "Link to view full data set", target: "_blank" }, lt.link) : null;
}, rg = ({ children: e, classes: A }) => /* @__PURE__ */ d.createElement("section", { className: A.join(" ") }, /* @__PURE__ */ d.createElement("span", null, e)), ie = () => null;
ie.Section = rg;
ie.Link = tg;
ie.Button = eg;
ie.generateMedia = fs;
const ng = ({ rawData: e, fileName: A, headerColor: t, skipId: r }) => {
  ...
  return /* @__PURE__ */ d.createElement("a", { download: A, type: "button", onClick: s, href: URL.createObjectURL(a), "aria-label": "Download this data in a CSV file format.", className: `${t} no-border`, id: `${r}`, "data-html2canvas-ignore": !0, role: "button" }, "Download Data (CSV)");
}, ag = {
  AL: "Alabama",
  AK: "Alaska",
  AS: "American Samoa",
  ...
  if (((c = r.xAxis) == null ? void 0 : c.dataKey) === t.column && r.xAxis.type === "date") {
    let l = Br(r.xAxis.dateParseFormat, s), u = Br(r.xAxis.dateParseFormat, B);
  ...
  if (A === ((i = t.xAxis) == null ? void 0 : i.dataKey))
    a = ((o = t.xAxis) == null ? void 0 : o.type) === "date" ? mB(((c = t.table) == null ? void 0 : c.dateDisplayFormat) || ((l = t.xAxis) == null ? void 0 : l.dateDisplayFormat), Br((u = t.xAxis) == null ? void 0 : u.dateParseFormat, s)) : s;
  else {
    let g = "left", w = t.series ? t.series.filter((F) => (F == null ? void 0 : F.axis) === "Left") : [], f = t.series ? t.series.filter((F) => (F == null ? void 0 : F.axis) === "Right") : [];
    w.map((F) => {
      F.dataKey === A && (g = "left");
    }), f.map((F) => {
      F.dataKey === A && (g = "right");
    ...
    let C = sg(A, t);
    C ? a = t.dataFormat ? en(r[e][A], g, !1, t, C) : r[e][A] : a = t.dataFormat ? en(r[e][A], g, !1, t) : r[e][A];
  }
  return (Q = t.preliminaryData) == null || Q.forEach((g) => {
    const w = String(g.value) === String(s), f = !g.column || g.column === A;
    if (w && f && g.displayTable && g.type === "suppression")
      switch (t.visualizationType) {
        case "Combo":
          a = t.runtime.barSeriesKeys.includes(A) ? g.iconCode : t.runtime.lineSeriesKeys.includes(A) ? g.lineCode : "";
          break;
        case "Bar":
          a = g.iconCode;
          break;
  ...
  var B, i, o, c;
  const r = Es.cloneDeep(e.columns) || {}, n = Object.values(r).filter((l) => l.dataTable === !1).map((l) => l.name);
  let a = [];
  e.visualizationType !== "Pie" ? (a = A ? [(B = e.xAxis) == null ? void 0 : B.dataKey] : [], e.series ? e.series.forEach((l) => {
    a.push(l.dataKey);
  }) : t && t.length > 0 && (a = Object.keys(t[0]))) : a = A ? [(i = e.xAxis) == null ? void 0 : i.dataKey, (o = e.yAxis) == null ? void 0 : o.dataKey] : [(c = e.yAxis) == null ? void 0 : c.dataKey], Object.keys(r).forEach(function(l) {
    var g;
    var u = r[l];
    const Q = a.includes(u.name);
    u.name !== ((g = e.xAxis) == null ? void 0 : g.dataKey) && u.dataTable === !0 && !Q && a.push(u.name);
  });
  const s = Object.values(r).reduce((l, u) => (u.order !== void 0 && (l[u.name] = u.order - 1), l), {});
  return a = a.filter((l) => !n.includes(l)), a.forEach((l, u) => {
    s[l] === void 0 && (Object.values(s).includes(u) ? s[l] = u + 1 : s[l] = u);
  }), a.sort((l, u) => s[l] - s[u]), a;
}, Lr = () => /* @__PURE__ */ d.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 10 5" }, /* @__PURE__ */ d.createElement("path", { d: "M0 5l5-5 5 5z" })), xr = () => /* @__PURE__ */ d.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 10 5" }, /* @__PURE__ */ d.createElement("path", { d: "M0 0l5 5 5-5z" })), Fs = (e) => {
  const A = e.as;
  ...
  var l;
  const s = (l = t.table) == null ? void 0 : l.groupBy;
  if (!e)
    return;
  let B = Us(t, A, e);
  if (s) {
    let u = B.filter((Q) => Q !== s);
    u.length != B.length && (B = u);
  }
  const i = (u, Q) => {
    let g = ["sort"];
    return u.column === Q && u.asc && g.push("sort-asc"), u.column === Q && u.desc && g.push("sort-desc"), g.join(" ");
  }, o = ({ text: u, config: Q, sortBy: g }) => {
    ...
    if ((u !== "__series__" || u !== "") && (f = `${u} `), (u === "__series__" || u === "") && !Q.table.indexLabel && (f = w), (u === "__series__" || u === "") && Q.table.indexLabel && (f = Q.table.indexLabel), f !== w)
      return /* @__PURE__ */ d.createElement("span", { className: "cdcdataviz-sr-only" }, `Press command, modifier, or enter key to sort by ${f} in ${g.column !== f ? "ascending" : g.column === "desc" ? "descending" : "ascending"}  order`);
  }, c = ({ column: u, text: Q, config: g }) => {
    let w = "Not Applicable";
    return Q === "__series__" && g.table.indexLabel ? `${g.table.indexLabel} ` : Q === "__series__" && !g.table.indexLabel ? /* @__PURE__ */ d.createElement(Fs, { as: "span" }, w) : Q;
  };
  if (A) {
    if (a) {
      const u = /row[_-]?type/i, Q = B.findIndex((g) => u.test(g));
      Q > -1 && B.splice(Q, 1);
    }
    return /* @__PURE__ */ d.createElement("tr", null, B.map((u, Q) => {
      const g = Cs(u, t);
      return /* @__PURE__ */ d.createElement(
        "th",
        {
          ...
          scope: "col",
          onClick: () => {
            a || r({ column: u, asc: n.column === u ? !n.asc : !1, colIndex: Q });
          },
          onKeyDown: (w) => {
            a || w.keyCode === 13 && r({ column: u, asc: n.column === u ? !n.asc : !1, colIndex: Q });
          },
          className: i(n, g),
          ...n.column === u ? n.asc ? { "aria-sort": "ascending" } : { "aria-sort": "descending" } : null
        },
        /* @__PURE__ */ d.createElement(c, { text: g, column: u, config: t }),
        u === n.column && /* @__PURE__ */ d.createElement("span", { className: "sort-icon" }, n.asc ? /* @__PURE__ */ d.createElement(xr, null) : /* @__PURE__ */ d.createElement(Lr, null)),
        /* @__PURE__ */ d.createElement(o, { sortBy: n, config: t, text: g })
      );
    }));
  } else {
    const u = t.visualizationType === "Pie" ? 1 : 0;
    return /* @__PURE__ */ d.createElement("tr", null, ["__series__", ...Object.keys(e)].slice(u).map((Q, g) => {
      var C;
      let w = (C = t.xAxis) == null ? void 0 : C.dataKey, f = Q !== "__series__" ? XA(Q, w, t, e) : "__series__";
      return /* @__PURE__ */ d.createElement(
        "th",
        {
          style: { minWidth: (t.table.cellMinWidth || 0) + "px" },
          ...
          onKeyDown: (F) => {
            F.keyCode === 13 && r({ column: f, asc: n.column === f ? !n.asc : !1, colIndex: g });
          },
          className: i(n, f),
          ...n.column === f ? n.asc ? { "aria-sort": "ascending" } : { "aria-sort": "descending" } : null
        },
        /* @__PURE__ */ d.createElement(c, { text: f, column: w, config: t }),
        g === n.colIndex && /* @__PURE__ */ d.createElement("span", { className: "sort-icon" }, n.asc ? /* @__PURE__ */ d.createElement(xr, null) : /* @__PURE__ */ d.createElement(Lr, null)),
        /* @__PURE__ */ d.createElement(o, { text: f, config: t, sortBy: n })
      );
    }));
  }
}, og = ({ categories: e }) => {
  ...
  return A === "__series__" && t.table.indexLabel ? `${t.table.indexLabel} ` : A === "__series__" && !t.table.indexLabel ? /* @__PURE__ */ d.createElement(Fs, { as: "span" }, r) : A;
}, lg = ({ columns: e, config: A, indexTitle: t, sortBy: r, setSortBy: n }) => /* @__PURE__ */ d.createElement("tr", null, Object.keys(e).filter((a) => e[a].dataTable === !0 && e[a].name).map((a, s) => {
  var i;
  let B;
  return a !== "geo" ? B = e[a].label ? e[a].label : e[a].name : B = A.type === "map" ? t : (i = A.xAxis) == null ? void 0 : i.dataKey, A.type === "map" && (B === void 0 || B === "") && (B = "Location"), /* @__PURE__ */ d.createElement(
    "th",
    {
    ...
    /* @__PURE__ */ d.createElement(cg, { text: B, config: A, column: a }),
    r.column === a && /* @__PURE__ */ d.createElement("span", { className: "sort-icon" }, r.asc ? /* @__PURE__ */ d.createElement(xr, null) : /* @__PURE__ */ d.createElement(Lr, null)),
    /* @__PURE__ */ d.createElement("span", { className: "cdcdataviz-sr-only" }, `Sort by ${B} in ${r.column === a && r.asc ? "ascending" : "descending"} order`)
  );
  ...
  return /* @__PURE__ */ d.createElement(
    ...
    /* @__PURE__ */ d.createElement(Hs, { display: e ? "minus" : "plus", base: !0 }),
    t
  );
...
const Qg = ({ markup: e, row: A, columns: t, navigationHandler: r, mapZoomHandler: n }) => t.navigate && A[t.navigate.name] ? /* @__PURE__ */ d.createElement(
  "span",
  {
  ...
  e,
  gg(A[t.navigate.name]) && /* @__PURE__ */ d.createElement(ug, { className: "inline-icon" })
  ...
  e
) : /* @__PURE__ */ d.createElement(d.Fragment, null, e), wg = ({ rows: e, columns: A, runtimeData: t, config: r, applyLegendToRow: n, displayGeoName: a, formatLegendLocation: s, displayDataAsText: B, navigationHandler: i, setFilteredCountryCode: o, viewport: c }) => e.map(
  (l) => Object.keys(A).filter((u) => A[u].dataTable === !0 && A[u].name).map((u) => {
    let Q;
    if (u === "geo") {
      const g = t[l], w = n(g);
      let f;
      ...
      if (r.general.geoType !== "single-state" && r.general.geoType !== "us-county" || r.general.type === "us-geocode") {
        const F = (K) => K.charAt(0).toUpperCase() + K.slice(1);
        f = a(l), f = String(f).startsWith("region") ? F(f) : f;
      } else
        f = s(l);
      Q = /* @__PURE__ */ d.createElement("div", { className: "col-12" }, /* @__PURE__ */ d.createElement(ua, { viewport: c, fill: w[0] }), /* @__PURE__ */ d.createElement(Qg, { markup: f, row: g, columns: A, navigationHandler: i, mapZoomHandler: C }));
    } else {
      let g = "", w = r.columns[u].name;
      const { specialClasses: f } = r.legend;
      f && f.length && typeof f[0] == "object" && f.forEach((C) => {
        C.key === w && String(t[l][C.key]) === C.value && (g = C.label);
      }), Q = B(g || t[l][w], u);
    }
    return Q;
  })
  ...
  var l;
  const i = (l = t.table) == null ? void 0 : l.groupBy, o = Us(t, r, A), c = () => !n && n.colIndex === null ? o : o.sort((u, Q) => {
    ...
    if (g)
      return ut(g[u], g[Q], n, t);
    if (g === void 0 && w)
      return ut(w[u], w[Q], n, t);
  });
  if (r)
    if (i) {
      const u = {};
      return e.forEach((Q) => {
        let g, w = [];
        o.forEach((f, C) => {
          i === f ? g = XA(Q, f, t, A) : w.push(XA(Q, f, t, A));
        }), u[g] ? u[g].push(w) : u[g] = [w];
      }), u;
    } else
      return e.map((u) => {
        if (s) {
          let Q, g = [];
          return o.forEach((w, f) => {
            w.match(/row[_-]?type/i) ? Q = XA(u, w, t, A) : g.push(XA(u, w, t, A));
          }), [Q, ...g];
        } else
          return o.map((Q, g) => XA(u, Q, t, A));
      });
  else
    return c().map((u) => {
      const Q = Cs(u, t);
      return (t.visualizationType !== "Pie" ? [
        /* @__PURE__ */ d.createElement(d.Fragment, null, a && a(Q) && /* @__PURE__ */ d.createElement(ua, { viewport: B, fill: a(Q) }), Q)
      ] : []).concat(e.map((w, f) => XA(w, u, t, A)));
    });
  ...
  var $, AA, FA, iA, QA;
  const { config: A, dataConfig: t, tableTitle: r, vizTitle: n, rawData: a, runtimeData: s, headerColor: B, expandDataTable: i, columns: o, viewport: c, formatLegendLocation: l, tabbingId: u, wrapColumns: Q } = e, g = Fg(s), [w, f] = LA.useState(i), [C, F] = LA.useState({ column: A.type === "map" ? "geo" : "date", asc: !1, colIndex: null }), [K, y] = LA.useState(""), m = !(A.type === "chart" && !(($ = A.table) != null && $.showVertical)), b = `btn__${Math.random().toString(16).substr(2, 8)}`, I = {
  ...
  switch (LA.useEffect(() => {
    ...
    w === !0 && K !== O && y(O), w === !1 && K !== P && y(P);
  }, [w]), A.visualizationType) {
    case "Box Plot":
      if (!A.boxplot)
        return /* @__PURE__ */ d.createElement(Tt, null);
      break;
    case "Line":
      if (!g)
        return /* @__PURE__ */ d.createElement(Tt, null);
  ...
  const v = Object.keys(g).filter((O) => O != "columns"), R = m ? v.sort((O, P) => {
    let M, V;
    if (A.type === "map" && A.columns) {
      const J = A.columns[C.column].name;
      M = g[O][J], V = g[P][J];
    }
    return (A.type === "chart" || A.type === "dashboard") && (M = g[O][C.column], V = g[P][C.column]), !M && !V && A.type === "chart" && A.xAxis && A.xAxis.type === "date-time" && (M = gt(A.runtime.xAxis.dateParseFormat)(g[O][A.xAxis.dataKey]), V = gt(A.runtime.xAxis.dateParseFormat)(g[P][A.xAxis.dataKey])), M && V ? ut(M, V, C, A) : 0;
  }) : v, j = {
    maxHeight: A.table.limitHeight && `${A.table.height}px`,
    OverflowY: "scroll"
  }, q = !!Object.keys((a == null ? void 0 : a[0]) || {}).find((O) => O.match(/row[_-]?type/i)), D = LA.useMemo(() => A.type === "map" ? A.table.caption ? A.table.caption : `Data table showing data for the ${I[A.general.geoType]} figure.` : A.table.caption ? A.table.caption : `Data table showing data for the ${A.type} figure.`, [A.table.caption]), W = (AA = A == null ? void 0 : A.regions) == null ? void 0 : AA.every((O) => {
  ...
  if (A.visualizationType !== "Box Plot") {
    const O = () => {
      var M;
      return ((M = A.general) == null ? void 0 : M.geoType) === "us-county" ? a.map((V) => ({ FullGeoName: l(V[A.columns.geo.name]), ...V })) : a;
    }, P = () => {
      var J, oA, lA;
      const M = ["download-links"], V = ((J = A.legend) == null ? void 0 : J.position) === "bottom" || ["sm", "xs", "xxs"].includes(c);
      return (oA = A.brush) != null && oA.active && !V && M.push("brush-active"), (lA = A.brush) != null && lA.active && A.legend.hide && M.push("brush-active"), M;
    };
    return /* @__PURE__ */ d.createElement(kr, { component: "DataTable" }, /* @__PURE__ */ d.createElement(ie.Section, { classes: P() }, /* @__PURE__ */ d.createElement(ie.Link, { config: A, dashboardDataConfig: t }), (A.table.download || ((iA = A.general) == null ? void 0 : iA.showDownloadButton)) && /* @__PURE__ */ d.createElement(ng, { rawData: O(), fileName: `${n || "data-table"}.csv`, headerColor: B })), /* @__PURE__ */ d.createElement("section", { id: u.replace("#", ""), className: `data-table-container ${c}`, "aria-label": K }, /* @__PURE__ */ d.createElement(ra, { skipId: b, skipMessage: "Skip Data Table" }), A.table.collapsible !== !1 && /* @__PURE__ */ d.createElement(na, { expanded: w, setExpanded: f, fontSize: A.fontSize, tableTitle: r, viewport: c }), /* @__PURE__ */ d.createElement("div", { className: "table-container", style: j }, /* @__PURE__ */ d.createElement(
      St,
      {
        viewport: c,
        wrapColumns: Q,
        childrenMatrix: A.type === "map" ? wg({ rows: R, wrapColumns: Q, ...e, runtimeData: g, viewport: c }) : fg({ rows: R, ...e, runtimeData: g, isVertical: m, sortBy: C, hasRowType: q, viewport: c }),
        tableName: A.type,
        caption: D,
        stickyHeader: !0,
        hasRowType: q,
        headContent: A.type === "map" ? /* @__PURE__ */ d.createElement(lg, { columns: o, ...e, sortBy: C, setSortBy: F }) : /* @__PURE__ */ d.createElement(ig, { data: g, ...e, hasRowType: q, isVertical: m, sortBy: C, setSortBy: F }),
        tableOptions: { className: `${w ? "data-table" : "data-table cdcdataviz-sr-only"}${m ? "" : " horizontal"}`, "aria-live": "assertive", "aria-rowcount": (QA = A == null ? void 0 : A.data) != null && QA.length ? A.data.length : -1, hidden: !w },
        fontSize: A.fontSize
      }
    ), W && A.regions && A.regions.length > 0 && A.visualizationType !== "Box Plot" && /* @__PURE__ */ d.createElement(
      St,
      {
        viewport: c,
        wrapColumns: Q,
    ...
    ))), /* @__PURE__ */ d.createElement("div", { id: b, className: "cdcdataviz-sr-only" }, "Skipped data table."));
  } else
    return /* @__PURE__ */ d.createElement(kr, { component: "DataTable" }, /* @__PURE__ */ d.createElement("section", { id: u.replace("#", ""), className: `data-table-container ${c}`, "aria-label": K }, /* @__PURE__ */ d.createElement(ra, { skipId: b, skipMessage: "Skip Data Table" }), /* @__PURE__ */ d.createElement(na, { expanded: w, setExpanded: f, tableTitle: r }), /* @__PURE__ */ d.createElement("div", { className: "table-container", style: j }, /* @__PURE__ */ d.createElement(
      St,
      {
        viewport: c,
        wrapColumns: Q,
        childrenMatrix: Ug({ rows: UA, config: A }),
        tableName: A.visualizationType,
        caption: D,
        stickyHeader: !0,
        headContent: /* @__PURE__ */ d.createElement(og, { categories: A.boxplot.categories }),
