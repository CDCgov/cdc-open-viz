...
import { e as p } from "./storybook-configHelpers-a0be6ce6.es.js";
import { s as e } from "./storybook-scatterplot-image-download-5c0763bc.es.js";
...
t.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: `{
  args: {
    config: editConfigKeys(scatterPlotDownloadImage, [{
      path: ['filters', '0', 'filterStyle'],
      value: 'tab-simple'
    }])
  }
