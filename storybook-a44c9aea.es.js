import { R as d, r as A } from "./storybook-e61d95ab.es.js";
import { g as ut } from "./storybook-c5d32002.es.js";
import { E as ct, H as Lt, L as kt } from "./storybook-e806525d.es.js";
import { u as Pt, c as Ut, p as ke } from "./storybook-ae809cc1.es.js";
import { A as ae } from "./storybook-7101b92a.es.js";
import { I as Pe } from "./storybook-aa0a1b09.es.js";
import "./storybook-329ae7fd.es.js";
import "./storybook-a729838e.es.js";
...
}, b = 1, dt = 2, ft = 4, C = 8, Se = 16, G = 32, U = 64, Re = {
  a: {
    content: b | C,
    self: !1,
    type: b | C | G | U
...
["address", "main", "div", "figure", "p", "pre"].forEach(H({
  content: b,
  type: b | U
}));
["abbr", "b", "bdi", "bdo", "cite", "code", "data", "dfn", "em", "i", "kbd", "mark", "q", "ruby", "samp", "strong", "sub", "sup", "time", "u", "var"].forEach(H({
  content: C,
  type: b | C | U
}));
["p", "pre"].forEach(H({
...
["s", "small", "span", "del", "ins"].forEach(H({
  content: C,
  type: b | C
}));
["article", "aside", "footer", "header", "nav", "section", "blockquote"].forEach(H({
  content: b,
  type: b | dt | U
}));
...
["audio", "canvas", "iframe", "img", "video"].forEach(H({
  type: b | C | Se | U
}));
const Te = Object.freeze(Re), It = ["applet", "base", "body", "command", "embed", "frame", "frameset", "head", "html", "link", "meta", "noscript", "object", "script", "style", "title"], Dt = Object.keys(Te).filter((t) => t !== "canvas" && t !== "iframe"), w = 1, qt = 2, W = 3, V = 4, ht = 5, Ue = Object.freeze({
  alt: w,
  cite: w,
  class: w,
  colspan: W,
...
`), n = n.replace(/\n/g, "<br/>"), n;
  ...
  createContainer(e) {
    ...
    if (e.match(Jt)) {
      ...
      o.innerHTML = this.convertLineBreaks(this.props.escapeHtml ? Ft(e) : e);
    return o;
  }
  /**
      ...
      if (h.nodeType === Ie) {
        ...
        if (o && !(l && !this.isTagAllowed(m))) {
          ...
          if (R === null)
            return;
          if (typeof R < "u") {
            u.push(/* @__PURE__ */ d.cloneElement(R, {
              key: S
            }));
            return;
          }
        ...
        if (!(a || n && m !== "br") && this.isTagAllowed(m) && (s || this.canRenderChild(r, E))) {
          var i;
          this.keyIndex += 1;
          const S = this.extractAttributes(g), R = {
            tagName: m
          };
          S && (R.attributes = S), E.void && (R.selfClose = E.void), u.push(/* @__PURE__ */ d.createElement(pt, {
            ...R,
            key: this.keyIndex
...
var _e = { exports: {} }, mt = function(e, r) {
  return function() {
...
function Ne() {
  var t = {};
  function e(n, s) {
    Y(t[s]) && Y(n) ? t[s] = Ne(t[s], n) : Y(n) ? t[s] = Ne({}, n) : Ae(n) ? t[s] = n.slice() : t[s] = n;
  }
...
var bt = function(e, r, a) {
  ...
  if (a)
    ...
    var s = [];
    $.forEach(r, function(u, c) {
      u === null || typeof u > "u" || ($.isArray(u) ? c = c + "[]" : u = [u], $.forEach(u, function(i) {
        $.isDate(i) ? i = i.toISOString() : $.isObject(i) && (i = JSON.stringify(i)), s.push(De(c) + "=" + De(i));
      }));
    }), n = s.join("&");
  }
  if (n) {
...
var ue, He;
function wr() {
  return He || (He = 1, ue = function(e, r) {
...
function Je() {
  if (We)
    return pe;
  We = 1;
  var t = L, e = yr(), r = br(), a = bt, n = Sr(), s = Rr(), o = Tr(), l = St(), u = wt, c = ee();
  return pe = function(i) {
    return new Promise(function(E, g) {
      var N = i.data, S = i.headers, R = i.responseType, v;
      function T() {
      ...
      function M() {
        if (f) {
          var y = "getAllResponseHeaders" in f ? s(f.getAllResponseHeaders()) : null, k = !R || R === "text" || R === "json" ? f.responseText : f.response, D = {
            data: k,
            status: f.status,
      ...
      }), t.isUndefined(i.withCredentials) || (f.withCredentials = !!i.withCredentials), R && R !== "json" && (f.responseType = i.responseType), typeof i.onDownloadProgress == "function" && f.addEventListener("progress", i.onDownloadProgress), typeof i.onUploadProgress == "function" && f.upload && f.upload.addEventListener("progress", i.onUploadProgress), (i.cancelToken || i.signal) && (v = function(y) {
...
var te = {
  ...
  transformRequest: [function(e, r) {
    return Ge(r, "Accept"), Ge(r, "Content-Type"), _.isFormData(e) || _.isArrayBuffer(e) || _.isBuffer(e) || _.isStream(e) || _.isFile(e) || _.isBlob(e) ? e : _.isArrayBufferView(e) ? e.buffer : _.isURLSearchParams(e) ? (Ke(r, "application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : _.isObject(e) || r && r["Content-Type"] === "application/json" ? (Ke(r, "application/json"), xr(e)) : e;
  }],
  transformResponse: [function(e) {
    var r = this.transitional || te.transitional, a = r && r.silentJSONParsing, n = r && r.forcedJSONParsing, s = !a && this.responseType === "json";
    if (s || n && _.isString(e) && e.length)
      try {
        return JSON.parse(e);
      } catch (o) {
        if (s)
...
var Xe = L, ve = kr, Pr = Rt(), Ur = Oe, Ir = ee();
function Ee(t) {
...
var Mr = {
  assertOptions: Br,
  validators: Le
}, Nt = L, jr = bt, et = mr, tt = Dr, re = Tt, _t = Mr, F = _t.validators;
function J(t) {
...
var st = L, zr = mt, X = Hr, Wr = Tt, Jr = Oe;
function At(t) {
...
I.isAxiosError = Vr();
_e.exports = I;
_e.exports.default = I;
var Gr = _e.exports, Kr = Gr;
const Yr = /* @__PURE__ */ ut(Kr), xt = A.createContext({}), Xr = ["theme-blue", "theme-purple", "theme-brown", "theme-teal", "theme-pink", "theme-orange", "theme-slate", "theme-indigo", "theme-cyan", "theme-green", "theme-amber"], Qr = A.memo((t) => {
  const { config: e, updateConfig: r, loading: a, data: n, setParentConfig: s, isDashboard: o } = A.useContext(xt), [l, u] = A.useState(!0), [c, h] = A.useState(!1), i = (v, T, f, x) => {
    if (v === null && T === null) {
      let p = { ...e, [f]: x };
    ...
    T !== null && (B ? (O = [...e[v]], O[T] = { ...O[T], [f]: x }) : typeof x == "string" ? O[T] = x : O = { ...e[v], [T]: { ...e[v][T], [f]: x } });
    let M = { ...e, [v]: O };
    r(M);
  };
  A.useEffect(() => {
  ...
  }, S = A.memo(({ label: v, value: T, fieldName: f, section: x = null, subsection: B = null, tooltip: O, updateField: M, ...p }) => /* @__PURE__ */ d.createElement("label", { className: "checkbox" }, /* @__PURE__ */ d.createElement(
    "input",
    {
      type: "checkbox",
      name: f,
...
const en = (t) => {
  const { configUrl: e, config: r, isDashboard: a = !1, isEditor: n = !1, setConfig: s } = t, o = { config: r ?? z, loading: !0, urlMarkup: "", markupError: null, errorMessage: null, coveLoadedHasRan: !1 }, [l, u] = A.useReducer(Zr, o), { config: c, loading: h, urlMarkup: i, markupError: m, errorMessage: E, coveLoadedHasRan: g } = l, N = A.useRef(), { innerContainerClasses: S, contentClasses: R } = Pt(c);
  let { title: v } = c;
  const T = (p) => {
    ...
    const k = { ...await Ut(p) };
    T({ ...z, ...k }), u({ type: "SET_LOADING", payload: !1 });
  }, []);
  A.useEffect(() => {
    if (m) {
  ...
  }, [r == null ? void 0 : r.data]), A.useEffect(() => {
    x().catch((p) => console.log(p));
  }, [x]);
  let O = /* @__PURE__ */ d.createElement(kt, null), M = ["markup-include"];
  if (h === !1) {
    let p = /* @__PURE__ */ d.createElement("div", { className: M.join(" "), ref: N }, v && /* @__PURE__ */ d.createElement("header", { className: `cove-component__header ${c.theme}`, "aria-hidden": "true" }, Lt(v), " ", a), /* @__PURE__ */ d.createElement("div", { className: `cove-component__content ${R.join(" ")}` }, /* @__PURE__ */ d.createElement("div", { className: `${S.join(" ")}` }, /* @__PURE__ */ d.createElement("div", { className: "cove-component__content-wrap" }, !m && i && /* @__PURE__ */ d.createElement(Qt, { content: B(i) }), m && c.srcUrl && /* @__PURE__ */ d.createElement("div", { className: "warning" }, E)))));
    O = /* @__PURE__ */ d.createElement("div", { className: `cove markup-include ${c.theme}` }, n && /* @__PURE__ */ d.createElement(Qr, null, p), !n && p);
  }
  return /* @__PURE__ */ d.createElement(ct, { component: "CdcMarkupInclude" }, /* @__PURE__ */ d.createElement(xt.Provider, { value: { config: c, updateConfig: T, loading: h, data: c.data, setParentConfig: s, isDashboard: a } }, O));
}, dn = {
