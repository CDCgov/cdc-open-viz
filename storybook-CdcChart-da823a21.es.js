...
import { _ as Ur, P as Ny, D as Dy, C as Oy, A as _y, b as bi, F as rp, g as Fy } from "./storybook-Filters-6333eab3.es.js";
import { L as Ud, a as My } from "./storybook-coveUpdateWorker-785760a1.es.js";
...
import { p as ip, e as Si, s as Br, c as Vt, h as op, a as mc, f as qn, t as Ru, i as $o, m as Ed, j as lp, k as Gn, l as sp, n as Hy, o as Wy, G as Vy, q as Iu, r as dr, u as $u, g as jo, T as kt, b as Bu, I as up } from "./storybook-InputToggle-375413f7.es.js";
import { t as jy, a as Cn, f as wf, L as cp, b as Xl, g as Ei, S as Uy, M as kd, D as Ky } from "./storybook-DataTable-c925ca2f.es.js";
import { E as Or, L as Yy } from "./storybook-Loading-f180d060.es.js";
import { b as yc, t as Xy, e as zh, f as dp, g as Gy, h as qy, j as Zy, k as fp, m as Qy, G as at, c as Ln } from "./storybook-Group-e6c0d0df.es.js";
...
import { e as ps, a as Rn, b as Nn, c as Dn, d as On, A as Pi } from "./storybook-index-66852bf6.es.js";
import { _ as ar } from "./storybook-lodash-c15d8e1c.es.js";
import { i as Hh, m as Td, c as Wh, j as fu, k as pu, l as hu, n as pp, o as tg, p as hp, b as Vh, d as jh } from "./storybook-year-bedc547d.es.js";
import { a as ft } from "./storybook-Icon-736fb775.es.js";
import { C as ng, V as rg, a as mp } from "./storybook-footnoteSymbols-7d34fcba.es.js";
import { S as Lt, T as Qe, C as ot, D as ag } from "./storybook-DataTableEditor-6a05ff32.es.js";
import { T as ve } from "./storybook-Tooltip-edc0f7ab.es.js";
import { I as Ma } from "./storybook-InputSelect-20478396.es.js";
import { C as Nu } from "./storybook-icon-check-50959323.es.js";
...
function Ag(e) {
  ...
  let i = 10, a, l;
  function f() {
    return a = Cg(i), l = wg(i), n()[0] < 0 ? (a = Tp(a), l = Tp(l), e(Eg, kg)) : e(Ep, kp), t;
  }
  return t.base = function(d) {
    ...
    if (!(i % 1) && R - S < w) {
      ...
      m.length * 2 < w && (m = dp(h, y, w));
    } else
      m = dp(S, R, Math.min(R - S, w)).map(l);
    return v ? m.reverse() : m;
  }, t.tickFormat = (d, u) => {
    if (d == null && (d = 10), u == null && (u = i === 10 ? "s" : ","), typeof u != "function" && (!(i % 1) && (u = Gy(u)).precision == null && (u.trim = !0), u = qy(u)), d === 1 / 0)
      return u;
...
function Gh() {
  ...
  return e.copy = () => zh(e, Gh()).base(e.base()), yc.apply(e, arguments), e;
}
const Hu = Hh(() => {
}, (e, t) => {
  e.setTime(+e + t);
...
function qh(e, t, n, i, a, l, f, d, u, h) {
  var y = Qy(), v = y.invert, S = y.domain, R = h(".%L"), k = h(":%S"), F = h("%I:%M"), w = h("%I %p"), m = h("%a %d"), _ = h("%b %d"), N = h("%B"), P = h("%Y");
  function O(L) {
    return (u(L) < L ? R : d(L) < L ? k : f(L) < L ? F : l(L) < L ? w : i(L) < L ? a(L) < L ? m : _ : n(L) < L ? N : P)(L);
  }
  return y.invert = function(L) {
    return new Date(v(L));
  }, y.domain = function(L) {
    return arguments.length ? S(Array.from(L, Dg)) : S().map(Ng);
  }, y.ticks = function(L) {
    var U = S();
    ...
    return zh(y, qh(e, t, n, i, a, l, f, d, u, h));
  }, y;
}
function Og() {
  return yc.apply(qh(Pg, Rg, Wh, Bh, jh, Vh, $h, Ih, Jl, jy).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
...
}, wp = "ResizeObserver loop completed with undelivered notifications.", Ug = function() {
  var e;
  typeof ErrorEvent == "function" ? e = new ErrorEvent("error", {
    message: wp
  }) : (e = document.createEvent("Event"), e.initEvent("error", !1, !1), e.message = wp), window.dispatchEvent(e);
}, hs;
(function(e) {
...
var Ni = function(e) {
...
}(), Yd = new rv(), Dp = function(e) {
  !Du && e > 0 && Yd.start(), Du += e, !Du && Yd.stop();
}, av = function(e) {
  ...
  return e;
}(), gu = /* @__PURE__ */ new WeakMap(), Op = function(e, t) {
  ...
  return e.connect = function(t, n) {
    ...
    Op(a.observationTargets, n) < 0 && (l && Ri.push(a), a.observationTargets.push(new iv(n, i && i.box)), Dp(1), Yd.schedule());
  }, e.unobserve = function(t, n) {
    var i = gu.get(t), a = Op(i.observationTargets, n), l = i.observationTargets.length === 1;
...
var _p = sm, Ra = lm(zy), cv = lm(Iy), Mo = pv(de), dv = uv, fv = ["className", "children", "debounceTime", "ignoreDimensions", "parentSizeStyles", "enableDebounceLeadingCall"];
function om(e) {
...
function sm(e) {
  var t = e.className, n = e.children, i = e.debounceTime, a = i === void 0 ? 300 : i, l = e.ignoreDimensions, f = l === void 0 ? mv : l, d = e.parentSizeStyles, u = d === void 0 ? {
    ...
    return (0, cv.default)(function(N) {
      w(function(P) {
        var O = Object.keys(P), L = O.filter(function(W) {
          return P[W] !== N[W];
  ...
  return (0, Mo.useEffect)(function() {
    var _ = new dv.ResizeObserver(function(N) {
      N === void 0 && (N = []), N.forEach(function(P) {
        var O = P.contentRect, L = O.left, U = O.top, W = O.width, Z = O.height;
...
var mm = zi(0), Uu = zi(1), Ev = zi(2), kv = zi(3), Ko = zi(4), Tv = zi(5), wv = zi(6);
mm.range;
Uu.range;
Ev.range;
kv.range;
...
function Cv(e) {
  var t = e.dateTime, n = e.date, i = e.time, a = e.periods, l = e.days, f = e.shortDays, d = e.months, u = e.shortMonths, h = Zl(a), y = Ql(a), v = Zl(l), S = Ql(l), R = Zl(f), k = Ql(f), F = Zl(d), w = Ql(d), m = Zl(u), _ = Ql(u), N = {
    a: re,
    A: le,
    b: q,
    B: j,
  ...
  function L(Ee, he) {
    return function(Pe) {
      var ee = [], Oe = -1, Te = 0, Ue = Ee.length, qe, et, Je;
      for (Pe instanceof Date || (Pe = /* @__PURE__ */ new Date(+Pe)); ++Oe < Ue; )
        Ee.charCodeAt(Oe) === 37 && (ee.push(Ee.slice(Te, Oe)), (et = Fp[qe = Ee.charAt(++Oe)]) != null ? qe = Ee.charAt(++Oe) : et = qe === "e" ? " " : "0", (Je = he[qe]) && (qe = Je(Pe, et)), ee.push(qe), Te = Oe + 1);
      return ee.push(Ee.slice(Te, Oe)), ee.join("");
    };
  }
  function U(Ee, he) {
    return function(Pe) {
      var ee = ql(1900, void 0, 1), Oe = W(ee, Ee, Pe += "", 0), Te, Ue;
      if (Oe != Pe.length)
        return null;
      if ("Q" in ee)
      ...
      if (he && !("Z" in ee) && (ee.Z = 0), "p" in ee && (ee.H = ee.H % 12 + ee.p * 12), ee.m === void 0 && (ee.m = "q" in ee ? ee.q : 0), "V" in ee) {
        if (ee.V < 1 || ee.V > 53)
          return null;
        "w" in ee || (ee.w = 1), "Z" in ee ? (Te = Rd(ql(ee.y, 0, 1)), Ue = Te.getUTCDay(), Te = Ue > 4 || Ue === 0 ? Uu.ceil(Te) : Uu(Te), Te = hm.offset(Te, (ee.V - 1) * 7), ee.y = Te.getUTCFullYear(), ee.m = Te.getUTCMonth(), ee.d = Te.getUTCDate() + (ee.w + 6) % 7) : (Te = Pd(ql(ee.y, 0, 1)), Ue = Te.getDay(), Te = Ue > 4 || Ue === 0 ? ju.ceil(Te) : ju(Te), Te = dm.offset(Te, (ee.V - 1) * 7), ee.y = Te.getFullYear(), ee.m = Te.getMonth(), ee.d = Te.getDate() + (ee.w + 6) % 7);
      } else
        ("W" in ee || "U" in ee) && ("w" in ee || (ee.w = "u" in ee ? ee.u % 7 : "W" in ee ? 1 : 0), Ue = "Z" in ee ? Rd(ql(ee.y, 0, 1)).getUTCDay() : Pd(ql(ee.y, 0, 1)).getDay(), ee.m = 0, ee.d = "W" in ee ? (ee.w + 6) % 7 + ee.W * 7 - (Ue + 5) % 7 : ee.w + ee.U * 7 - (Ue + 6) % 7);
      return "Z" in ee ? (ee.H += ee.Z / 100 | 0, ee.M += ee.Z % 100, Rd(ee)) : Pd(ee);
    };
  }
  function W(Ee, he, Pe, ee) {
    for (var Oe = 0, Te = he.length, Ue = Pe.length, qe, et; Oe < Te; ) {
      if (ee >= Ue)
        return -1;
      if (qe = he.charCodeAt(Oe++), qe === 37) {
        if (qe = he.charAt(Oe++), et = O[qe in Fp ? he.charAt(Oe++) : qe], !et || (ee = et(Ee, Pe, ee)) < 0)
          return -1;
      } else if (qe != Pe.charCodeAt(ee++))
        return -1;
    }
    return ee;
  }
  ...
  function V(Ee, he, Pe) {
    ...
    return ee ? (Ee.m = _.get(ee[0].toLowerCase()), Pe + ee[0].length) : -1;
  }
  function K(Ee, he, Pe) {
    var ee = F.exec(he.slice(Pe));
    return ee ? (Ee.m = w.get(ee[0].toLowerCase()), Pe + ee[0].length) : -1;
  }
  function X(Ee, he, Pe) {
    return W(Ee, t, he, Pe);
  }
...
function rx(e, t) {
  return Gt(ju.count(ms(e) - 1, e), t, 2);
}
function ax(e, t) {
...
function bx(e, t) {
  return Gt(Uu.count(ys(e) - 1, e), t, 2);
}
function Sx(e, t) {
...
const Mx = (e) => Bt.fun(e) && !(e.prototype instanceof r.Component), zx = (e) => de.forwardRef((n, i) => {
  const a = Sm(), l = de.useRef(!0), f = de.useRef(null), d = de.useRef(null), u = de.useCallback((S) => {
    const R = f.current, k = () => {
      let F = !1;
      d.current && (F = Of.fn(d.current, f.current.getAnimatedValue())), (!d.current || F === !1) && a();
    };
    f.current = new Fx(S, k), R && R.detach();
  }, []);
  de.useEffect(() => () => {
    l.current = !1, f.current && f.current.detach();
  }, []), de.useImperativeHandle(i, () => Ox(d)), u(n);
...
const Di = /* @__PURE__ */ new Set(), Am = () => {
  ...
  for (let t of Di) {
    ...
    for (let i = 0; i < t.configs.length; i++) {
      ...
      for (let d = 0; d < a.animatedValues.length; d++) {
        ...
        if (a.duration !== void 0)
          ...
          for (let _ = 0; _ < k; ++_) {
            let N = -a.tension * (v - y), P = -a.friction * R, O = (N + P) / a.mass;
          ...
          l = F || w && m, u.lastVelocity = R, u.lastTime = e;
        }
    ...
    t.props.onFrame && t.props.onFrame(t.values), n || (Di.delete(t), t.stop(!0));
  }
  return Di.size ? Tm(Am) : rs = !1, rs;
}, Ix = (e) => {
  Di.has(e) || Di.add(e), rs || (rs = !0, Tm(Am));
}, $x = (e) => {
...
class Yo extends Gd {
  constructor(t, n, i, a) {
    super(), this.calc = void 0, this.payload = t instanceof Gd && !(t instanceof Yo) ? t.getPayload() : Array.isArray(t) ? t : [t], this.calc = Yu(n, i, a);
  }
  getValue() {
...
class Ux {
  ...
  diff(t) {
    ...
    if (this.animations = Object.entries(this.merged).reduce((F, w) => {
      let m = w[0], _ = w[1], N = F[m] || {};
      const P = Bt.num(_), O = Bt.str(_) && !_.startsWith("#") && !/\d/.test(_) && !km[_], L = Bt.arr(_), U = !P && !L && !O;
      let W = Bt.und(a[m]) ? _ : a[m], Z = P || L || O ? _ : 1, ce = Rr(u, m);
      k && (Z = k.animations[m].parent);
      let te = N.parent, V = N.interpolation, K = Ho(k ? Z.getPayload() : Z), X, B = _;
      U && (B = Ku({
        range: [0, 1],
        output: [_, _]
      })(1));
      let oe = V && V.getValue();
      const le = !Bt.und(te) && N.animatedValues.some((ue) => !ue.done), q = !Bt.equ(B, oe), j = !Bt.equ(B, N.previous), J = !Bt.equ(ce, N.config);
      if (v || j && q || J) {
        if (P || O)
          te = V = N.parent || new qd(W);
        else if (L)
          te = V = N.parent || new Vx(W);
        else if (U) {
          let ue = N.interpolation && N.interpolation.calc(N.parent.value);
          ue = ue !== void 0 && !v ? ue : W, N.parent ? (te = N.parent, te.setValue(0, !1)) : te = new qd(0);
          const De = {
            output: [ue, _]
          };
          N.interpolation ? (V = N.interpolation, N.interpolation.updateConfig(De)) : V = te.interpolate(De);
        }
        return K = Ho(k ? Z.getPayload() : Z), X = Ho(te.getPayload()), v && !U && te.setValue(W, !1), this.hasChanged = !0, X.forEach((ue) => {
          ue.startPosition = ue.value, ue.lastPosition = ue.value, ue.lastVelocity = le ? ue.lastVelocity : void 0, ue.lastTime = le ? ue.lastTime : void 0, ue.startTime = wm(), ue.done = !1, ue.animatedStyles.clear();
        }), Rr(S, m) && te.setValue(U ? Z : _, !1), pn({}, F, {
          [m]: pn({}, N, {
            name: m,
            parent: te,
            interpolation: V,
        ...
        return q ? F : (U && (te.setValue(1, !1), V.updateConfig({
          output: [B, B]
...
let Kx = 0;
const Ou = "enter", Dd = "leave", Od = "update", Yx = (e, t) => (typeof t == "function" ? e.map(t) : Ho(t)).map(String), Zd = (e) => {
...
function Xx(e, t, n) {
  ...
  return de.useImperativeHandle(i.ref, () => ({
    ...
    stop: (_) => Array.from(m.current.instances).forEach((N) => N[1].stop(_)),
    get controllers() {
    ...
    const N = _.slot, P = _.from, O = _.to, L = _.config, U = _.trail, W = _.key, Z = _.item;
    ...
    const ce = m.current.instances.get(W), te = pn({}, k, {
      ...
      ref: R,
      onRest: (V) => {
        m.current.mounted && (_.destroyed && (!R && !f && Up(m, W), h && h(Z)), !Array.from(m.current.instances).some((B) => !B[1].idle) && (R || f) && m.current.deleted.length > 0 && Up(m), v && v(Z, N, V));
      },
      onStart: S && (() => S(Z, N)),
      onFrame: y && ((V) => y(Z, N, V)),
      delay: U,
...
function Gx(e, t) {
  let n = e.first, i = e.prevProps, a = Ur(e, ["first", "prevProps"]), l = Zd(t), f = l.items, d = l.keys, u = l.initial, h = l.from, y = l.enter, v = l.leave, S = l.update, R = l.trail, k = R === void 0 ? 0 : R, F = l.unique, w = l.config, m = l.order, _ = m === void 0 ? [Ou, Dd, Od] : m, N = Zd(i), P = N.keys, O = N.items, L = pn({}, a.current), U = [...a.deleted], W = Object.keys(L), Z = new Set(W), ce = new Set(d), te = d.filter((oe) => !Z.has(oe)), V = a.transitions.filter((oe) => !oe.destroyed && !ce.has(oe.originalKey)).map((oe) => oe.originalKey), K = d.filter((oe) => Z.has(oe)), X = -k;
  for (; _.length; )
    switch (_.shift()) {
      case Ou: {
        te.forEach((re, le) => {
          F && U.find((ue) => ue.originalKey === re) && (U = U.filter((ue) => ue.originalKey !== re));
          const q = d.indexOf(re), j = f[q], J = n && u !== void 0 ? "initial" : Ou;
          L[re] = {
            slot: J,
            originalKey: re,
            key: F ? String(re) : Kx++,
      ...
      case Dd: {
        V.forEach((re) => {
          const le = P.indexOf(re), q = O[le], j = Dd;
          U.unshift(pn({}, L[re], {
            slot: j,
            destroyed: !0,
      ...
      case Od: {
        K.forEach((re) => {
          const le = d.indexOf(re), q = f[le], j = Od;
          L[re] = pn({}, L[re], {
            item: q,
            slot: j,
            trail: X = X + k,
  ...
  return U.forEach((oe) => {
    let re = oe.left;
    oe.right;
    let le = Ur(oe, ["left", "right"]), q;
    (q = B.findIndex((j) => j.originalKey === re)) !== -1 && (q += 1), q = Math.max(0, q), B = [...B.slice(0, q), le, ...B.slice(q)];
  }), pn({}, a, {
...
class qx extends Em {
  constructor(t) {
    t === void 0 && (t = {}), super(), t.transform && !(t.transform instanceof Nr) && (t = Of.transform(t)), this.payload = t;
  }
}
const Xu = {
  transparent: 0,
...
const Zx = new RegExp("rgb" + gc(Dr, Dr, Dr)), Qx = new RegExp("rgba" + gc(Dr, Dr, Dr, Dr)), Jx = new RegExp("hsl" + gc(Dr, Gu, Gu)), eb = new RegExp("hsla" + gc(Dr, Gu, Gu, Dr)), tb = /^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, nb = /^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, rb = /^#([0-9a-fA-F]{6})$/, ab = /^#([0-9a-fA-F]{8})$/;
function ib(e) {
  let t;
...
function Kp(e, t, n) {
  const i = n < 0.5 ? n * (1 + t) : n + t - n * t, a = 2 * n - i, l = _d(a, i, e + 1 / 3), f = _d(a, i, e), d = _d(a, i, e - 1 / 3);
...
const bu = /[+\-]?(?:0|[1-9]\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, ob = /(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))/gi, lb = new RegExp(`(${Object.keys(Xu).join("|")})`, "g"), sb = (e) => {
  const t = e.output.map((a) => a.replace(ob, Gp)).map((a) => a.replace(lb, Gp)), n = t[0].match(bu).map(() => []);
  t.forEach((a) => {
...
Rx((e, t) => {
  if (e.nodeType && e.setAttribute !== void 0) {
    ...
    for (let y in u) {
      const v = h ? y : qp[y] || (qp[y] = y.replace(/([A-Z])/g, (S) => "-" + S.toLowerCase()));
...
function Su(e, t, n, i, a, l, f) {
  var d = e - n, u = t - i, h = (f ? l : -l) / $o(d * d + u * u), y = h * u, v = -h * d, S = e + y, R = t + v, k = n + y, F = i + v, w = (S + k) / 2, m = (R + F) / 2, _ = k - S, N = F - R, P = _ * _ + N * N, O = a - l, L = S * F - k * R, U = (N < 0 ? -1 : 1) * $o(Wy(0, O * O * P - L * L)), W = (L * N - _ * U) / P, Z = (-L * _ - N * U) / P, ce = (L * N + _ * U) / P, te = (-L * _ + N * U) / P, V = W - w, K = Z - m, X = ce - w, B = te - m;
...
function bb() {
  ...
  function u() {
    var h, y, v = +e.apply(this, arguments), S = +t.apply(this, arguments), R = a.apply(this, arguments) - op, k = l.apply(this, arguments) - op, F = lp(k - R), w = k > R;
    if (d || (d = h = mc()), S < v && (y = S, S = v, v = y), !(S > qn))
      d.moveTo(0, 0);
    else if (F > Ru - qn)
      d.moveTo(S * Si(R), S * Br(R)), d.arc(0, 0, S, R, k, !w), v > qn && (d.moveTo(v * Si(k), v * Br(k)), d.arc(0, 0, v, k, R, w));
    else {
      var m = R, _ = k, N = R, P = k, O = F, L = F, U = f.apply(this, arguments) / 2, W = U > qn && (i ? +i.apply(this, arguments) : $o(v * v + S * S)), Z = Ed(lp(S - v) / 2, +n.apply(this, arguments)), ce = Z, te = Z, V, K;
      if (W > qn) {
        var X = sp(W / v * Br(U)), B = sp(W / S * Br(U));
        (O -= X * 2) > qn ? (X *= w ? 1 : -1, N += X, P -= X) : (O = 0, N = P = (R + k) / 2), (L -= B * 2) > qn ? (B *= w ? 1 : -1, m += B, _ -= B) : (L = 0, m = _ = (R + k) / 2);
      }
      var oe = S * Si(m), re = S * Br(m), le = v * Si(P), q = v * Br(P);
      if (Z > qn) {
        var j = S * Si(_), J = S * Br(_), ue = v * Si(N), De = v * Br(N), be;
        if (F < ip && (be = xb(oe, re, ue, De, j, J, le, q))) {
      ...
      L > qn ? te > qn ? (V = Su(ue, De, oe, re, S, te, w), K = Su(j, J, le, q, S, te, w), d.moveTo(V.cx + V.x01, V.cy + V.y01), te < Z ? d.arc(V.cx, V.cy, te, Gn(V.y01, V.x01), Gn(K.y01, K.x01), !w) : (d.arc(V.cx, V.cy, te, Gn(V.y01, V.x01), Gn(V.y11, V.x11), !w), d.arc(0, 0, S, Gn(V.cy + V.y11, V.cx + V.x11), Gn(K.cy + K.y11, K.cx + K.x11), !w), d.arc(K.cx, K.cy, te, Gn(K.y11, K.x11), Gn(K.y01, K.x01), !w))) : (d.moveTo(oe, re), d.arc(0, 0, S, m, _, !w)) : d.moveTo(oe, re), !(v > qn) || !(O > qn) ? d.lineTo(le, q) : ce > qn ? (V = Su(le, q, j, J, v, -ce, w), K = Su(oe, re, ue, De, v, -ce, w), d.lineTo(V.cx + V.x01, V.cy + V.y01), ce < Z ? d.arc(V.cx, V.cy, ce, Gn(V.y01, V.x01), Gn(K.y01, K.x01), !w) : (d.arc(V.cx, V.cy, ce, Gn(V.y01, V.x01), Gn(V.y11, V.x11), !w), d.arc(0, 0, v, Gn(V.cy + V.y11, V.cx + V.x11), Gn(K.cy + K.y11, K.cx + K.x11), w), d.arc(K.cx, K.cy, ce, Gn(K.y11, K.x11), Gn(K.y01, K.x01), !w))) : d.arc(0, 0, v, P, N, w);
    }
    if (d.closePath(), h)
...
function Rm() {
  var e = _f, t = Ff, n = Vt(!0), i = null, a = vc, l = null;
  function f(d) {
...
function Sb() {
  var e = _f, t = null, n = Vt(0), i = Ff, a = Vt(!0), l = null, f = vc, d = null;
  function u(y) {
    var v, S, R, k = y.length, F, w = !1, m, _ = new Array(k), N = new Array(k);
    for (l == null && (d = f(m = mc())), v = 0; v <= k; ++v) {
      ...
      w && (_[v] = +e(F, v, y), N[v] = +n(F, v, y), d.point(t ? +t(F, v, y) : _[v], i ? +i(F, v, y) : N[v]));
    }
    if (m)
...
function Tb() {
  ...
  function f(d) {
    var u, h = d.length, y, v, S = 0, R = new Array(h), k = new Array(h), F = +i.apply(this, arguments), w = Math.min(Ru, Math.max(-Ru, a.apply(this, arguments) - F)), m, _ = Math.min(Math.abs(w) / h, l.apply(this, arguments)), N = _ * (w < 0 ? -1 : 1), P;
    for (u = 0; u < h; ++u)
...
function Ab(e) {
  var t = wb, n = Cb, i = _f, a = Ff, l = null;
  function f() {
...
const Ob = function e(t) {
  function n(i) {
    return t === 1 ? new xc(i) : new Om(i, t);
  }
...
const zb = function e(t) {
  function n(i) {
    return t ? new _m(i, t) : new Mf(i, 0);
  }
...
function Bf() {
  ...
  return a.keys = function(l) {
    ...
    return arguments.length ? (t = l == null ? Go : typeof l == "function" ? l : Vt(Qd.call(l)), a) : t;
  }, a.offset = function(l) {
...
function Jb(e) {
  var t = e.length, n, i, a = e.map(Wm), l = qb(e), f = 0, d = 0, u = [], h = [];
  for (n = 0; n < t; ++n)
...
function n0(e) {
  var t = e === void 0 ? {} : e, n = t.startAngle, i = t.endAngle, a = t.padAngle, l = t.value, f = t.sort, d = t.sortValues, u = Tb();
...
function o0(e) {
  var t = e.className, n = e.top, i = e.left, a = e.data, l = a === void 0 ? [] : a, f = e.centroid, d = e.innerRadius, u = d === void 0 ? 0 : d, h = e.outerRadius, y = e.cornerRadius, v = e.startAngle, S = e.endAngle, R = e.padAngle, k = e.padRadius, F = e.pieSort, w = e.pieSortValues, m = e.pieValue, _ = e.children, N = e.fill, P = N === void 0 ? "" : N, O = i0(e, a0), L = t0({
    innerRadius: u,
    outerRadius: h,
    cornerRadius: y,
    padRadius: k
  ...
  return _ ? /* @__PURE__ */ r.createElement(r.Fragment, null, _({
    ...
    }, O)), f == null ? void 0 : f(L.centroid(Z), Z));
  }));
}
...
function p0(e) {
  var t = e.children, n = e.x, i = e.x0, a = e.x1, l = e.y, f = e.y0, d = e.y1, u = e.data, h = u === void 0 ? [] : u, y = e.defined, v = y === void 0 ? function() {
    return !0;
  } : y, S = e.className, R = e.curve, k = e.innerRef, F = f0(e, d0), w = Vf({
    x: n,
    x0: i,
    x1: a,
    y: l,
...
function y0(e) {
  var t = e.x, n = e.x0, i = e.x1, a = e.y, l = e.y1, f = e.y0, d = e.yScale, u = e.data, h = u === void 0 ? [] : u, y = e.defined, v = y === void 0 ? function() {
    return !0;
  } : y, S = e.className, R = e.curve, k = e.innerRef, F = e.children, w = m0(e, h0), m = Vf({
    x: t,
    x0: n,
    x1: i,
    defined: v,
...
function x0(e) {
  var t = e.className, n = e.top, i = e.left, a = e.keys, l = e.data, f = e.curve, d = e.defined, u = e.x, h = e.x0, y = e.x1, v = e.y0, S = e.y1, R = e.value, k = e.order, F = e.offset, w = e.color, m = e.children, _ = v0(e, g0), N = r0({
    keys: a,
    value: R,
    order: k,
    offset: F
...
function E0(e) {
  var t = e.className, n = e.top, i = e.left, a = e.keys, l = e.data, f = e.curve, d = e.defined, u = e.x, h = e.x0, y = e.x1, v = e.y0, S = e.y1, R = e.value, k = e.order, F = e.offset, w = e.color, m = e.children, _ = S0(e, b0);
...
function jm(e) {
  var t = e.data, n = e.className, i = e.top, a = e.left, l = e.x0, f = e.x0Scale, d = e.x1Scale, u = e.yScale, h = e.color, y = e.keys, v = e.height, S = e.children, R = T0(e, k0), k = jf(d), F = t.map(function(w, m) {
    return {
      index: m,
      x0: f(l(w)),
      bars: y.map(function(_, N) {
        var P = w[_];
        return {
          index: N,
          key: _,
...
function A0(e) {
  var t = e.data, n = e.className, i = e.top, a = e.left, l = e.x, f = e.y0, d = f === void 0 ? Um : f, u = e.y1, h = u === void 0 ? Km : u, y = e.xScale, v = e.yScale, S = e.color, R = e.keys, k = e.value, F = e.order, w = e.offset, m = e.children, _ = C0(e, w0), N = Bf();
  R && N.keys(R), k && bn(N.value, k), F && N.order(Hf(F)), w && N.offset(Wf(w));
  var P = N(t), O = jf(y), L = P.map(function(U, W) {
    var Z = U.key;
    return {
      index: W,
      key: Z,
      bars: U.map(function(ce, te) {
        var V = (v(d(ce)) || 0) - (v(h(ce)) || 0), K = v(h(ce)), X = "bandwidth" in y ? y(l(ce.data)) : Math.max((y(l(ce.data)) || 0) - O / 2);
        return {
          bar: ce,
          key: Z,
          index: te,
...
function R0(e) {
  var t = e.data, n = e.className, i = e.top, a = e.left, l = e.y, f = e.x0, d = f === void 0 ? Um : f, u = e.x1, h = u === void 0 ? Km : u, y = e.xScale, v = e.yScale, S = e.color, R = e.keys, k = e.value, F = e.order, w = e.offset, m = e.children, _ = P0(e, L0), N = Bf();
  R && N.keys(R), k && bn(N.value, k), F && N.order(Hf(F)), w && N.offset(Wf(w));
  var P = N(t), O = jf(v), L = P.map(function(U, W) {
    var Z = U.key;
    return {
      index: W,
      key: Z,
...
var D0 = "__visx_splitpath_svg_path_measurement_id", ih = function() {
  return !0;
};
function O0(e) {
  ...
  try {
    ...
    if (a === "x" || a === "y")
      for (var v = n.map(function(K) {
        ...
        for (var _ = d.getPointAtLength(m), N = _[a]; w < h - 1 && F[w + 1](N); )
          w += 1;
        y[w].push(_);
      }
    else {
      var P = n.map(function(K) {
        return K.length;
      }), O = P.reduce(function(K, X) {
        return K + X;
      }, 0), L = u / Math.max(1, O - 1), U = P.slice(0, h - 1);
      U.unshift(0);
      for (var W = 2; W < h; W += 1)
        U[W] += U[W - 1];
      for (var Z = 0; Z < h; Z += 1)
...
var Gm = {
  ...
  var n = e.className, i = e.top, a = e.left, l = e.offsetLeft, f = l === void 0 ? 10 : l, d = e.offsetTop, u = d === void 0 ? 10 : d, h = e.style, y = h === void 0 ? Gm : h, v = e.children, S = e.unstyled, R = S === void 0 ? !1 : S, k = e.applyPositionStyle, F = k === void 0 ? !1 : k, w = $0(e, I0);
...
function Zm(e) {
  var t = e.children;
  e.getRects;
  var n = e.left, i = n === void 0 ? 0 : n, a = e.offsetLeft, l = a === void 0 ? 10 : a, f = e.offsetTop, d = f === void 0 ? 10 : f, u = e.parentRect, h = e.rect, y = e.style, v = y === void 0 ? Gm : y, S = e.top, R = S === void 0 ? 0 : S, k = e.unstyled, F = k === void 0 ? !1 : k, w = e.nodeRef, m = K0(e, U0), _, N = !1, P = !1;
  if (h && u) {
    var O = i, L = R;
    if (u.width) {
      var U = O + l + h.width - u.width, W = h.width - O - l;
      N = U > 0 && U > W;
    } else {
      var Z = O + l + h.width - window.innerWidth, ce = h.width - O - l;
      N = Z > 0 && Z > ce;
    }
    if (u.height) {
    ...
    O = N ? O - h.width - l : O + l, L = P ? L - h.height - d : L + d, O = Math.round(O), L = Math.round(L), _ = "translate(" + O + "px, " + L + "px)";
  }
...
const Jm = (e) => {
  const { tableData: t, config: n, formatNumber: i, capitalize: a, formatDate: l, formatTooltipsDate: f, parseDate: d, setSharedFilter: u } = de.useContext(Ct), { xScale: h, yScale: y, showTooltip: v, hideTooltip: S } = e, { xAxis: R, visualizationType: k, orientation: F, yAxis: w, runtime: m } = n, _ = (B, oe) => {
    ...
    let le = !1;
    return B.series.forEach((q) => {
      q.hideZeroValue && oe === "0" && re === q.dataKey && (le = !0), q.hideNullValue && isNaN(oe) && re === q.dataKey && (le = !0);
    }), le;
  }, P = (B, oe) => {
    B.stopPropagation();
    const re = sh(B), { x: le, y: q } = re, { data: j, arc: J } = oe ?? {}, ue = U(le - Number(n.yAxis.size || 0)), De = k !== "Pie" ? n.series.filter((ee) => ee.tooltip === !0).map((ee) => ee.dataKey) : n.series.map((ee) => ee.dataKey);
    De.push(n.xAxis.dataKey), n.visualizationType === "Forecasting" && n.series.map((ee) => {
      ee.confidenceIntervals.map((Oe) => {
        Oe.showInTooltip && (De.push(Oe.high), De.push(Oe.low));
      });
    });
    function be(ee) {
      let Oe = [];
      for (let Te in ee)
        ee.hasOwnProperty(Te) && Oe.push(ee[Te].name);
      return Oe;
    }
    De.push(...be(n.columns)), De.push(...be(n.columns));
    const ye = ce(ue, De), Le = t.filter((ee) => ee[R.dataKey] === W(q)), ae = F === "vertical" ? ye : Le, Ie = (ee) => {
      const Oe = n.series.filter((Ue) => Ue.dataKey === ee)[0];
      return Oe != null && Oe.axis ? String(Oe.axis).toLowerCase() : "left";
    }, he = (() => {
      var qe, et, Je;
      const ee = n.columns, Oe = [], Te = [];
      for (const [st, Ke] of Object.entries(ee)) {
        ...
        let Be = null;
        n.visualizationType === "Pie" ? Be = J == null ? void 0 : J.data[Ke.name] : Be = (qe = ae[0]) == null ? void 0 : qe[Ke.name];
        const $e = wf(Be, "left", !0, n, We);
        Ke.tooltips && Oe.push([Ke.label, $e]);
      }
      const Ue = [];
      return Oe.forEach((st) => {
        Ue.push([st[0], st[1]]);
      }), k === "Pie" && Te.push(
        // ignore
        [n.xAxis.dataKey, j],
      ...
      ), k === "Forest Plot" && Te.push([n.xAxis.dataKey, W(q)]), k !== "Pie" && k !== "Forest Plot" && Te.push(
        ...(Je = (et = te()) == null ? void 0 : et.filter((st) => {
          ...
          let We = st === n.xAxis.dataKey ? (Ge = ae[0]) == null ? void 0 : Ge[st] : i((pt = ae[0]) == null ? void 0 : pt[st], Ie(st));
          We = Ke ? "N/A" : We;
    ...
    if (k !== "Pie" && F !== "horizontal") {
      if (h.type === "point" || R.type === "continuous" || Cn(R)) {
        let re = null, le = Number.MAX_VALUE, q = B;
        return t.forEach((j) => {
          const J = Cn(R) ? h(d(j[R.dataKey])) : h(j[R.dataKey]);
          let ue = n.barHeight;
          const De = Math.abs(Number(J - q + (oe ? ue * 2 : 0)));
          De <= le && (le = De, re = (Cn(R), j[R.dataKey]));
        }), re;
      }
      ...
      if (Cn(R) && k !== "Combo" && F !== "horizontal") {
        const re = vp((J) => d(J[n.xAxis.dataKey])).left, le = h.invert(B), q = re(n.data, le, 1);
        return d(n.data[q - 1][n.xAxis.dataKey]);
      }
    }
  }, W = (B, oe) => {
    if (k === "Pie")
    ...
    return t.forEach((q, j) => {
      const J = y(k !== "Forest Plot" ? q[n.xAxis.dataKey] : j), ue = Math.abs(J - B);
      ue < re && (re = ue, le = oe ? q[oe] : q[n.xAxis.dataKey]);
    }), le;
  }, Z = (B) => {
    var oe, re;
    try {
      const le = sh(B), { x: q } = le;
      if (!q)
        throw new Error("COVE: no x value in handleTooltipClick.");
      let j = U(q, !0), J = (oe = n.data) == null ? void 0 : oe.filter((ue) => ue[n.xAxis.dataKey] === j);
      if (!j)
    ...
    try {
      let re;
      return R.type === "categorical" ? re = t.filter((q) => q[R.dataKey] === B) : re = t.filter((q) => q[R.dataKey] === B), !re || re.length === 0 ? [] : re.map((q) => Object.fromEntries(Object.entries(q).filter(([j, J]) => oe.includes(j))));
    } catch (re) {
    ...
    try {
      let oe, re = [], le = [];
      if ((B = n.series) == null || B.forEach((q) => {
        q.type === "Forecasting" && (re.push(q.stageColumn), q == null || q.confidenceIntervals.forEach((j) => {
    ...
    var re, le;
    let oe = n.series.filter((q) => q.dataKey === B);
  ...
  return {
    ...
    TooltipListItem: ({ item: B }) => {
      const [oe, re] = B, [le, q, j] = re;
      if (k === "Forest Plot")
        return le === n.xAxis.dataKey ? /* @__PURE__ */ r.createElement("li", { className: "tooltip-heading" }, `${a(n.xAxis.dataKey ? `${n.xAxis.dataKey}: ` : "")} ${Cn(w) ? l(d(le, !1)) : q}`) : /* @__PURE__ */ r.createElement("li", { className: "tooltip-body" }, `${K(le)}: ${i(q, "left")}`);
      const J = n.tooltips.dateDisplayFormat ? f(d(q, !1)) : l(d(q, !1));
      return k === "Bar" && F === "horizontal" && le === n.xAxis.dataKey ? /* @__PURE__ */ r.createElement("li", { className: "tooltip-heading" }, `${a(n.runtime.yAxis.label ? `${n.runtime.yAxis.label}: ` : "")} ${n.xAxis.type === "date" ? J : q}`) : le === n.xAxis.dataKey ? /* @__PURE__ */ r.createElement("li", { className: "tooltip-heading" }, `${a(n.runtime.xAxis.label ? `${n.runtime.xAxis.label}: ` : "")} ${Cn(R) ? J : q}`) : /* @__PURE__ */ r.createElement("li", { className: "tooltip-body" }, `${K(le)}: ${q}`);
    },
    tooltipStyles: V
  };
};
...
function ay(e) {
  var t = e.className, n = e.style, i = n === void 0 ? uS : n, a = e.scale, l = e.shape, f = e.domain, d = e.fill, u = d === void 0 ? uh : d, h = e.size, y = h === void 0 ? uh : h, v = e.labelFormat, S = v === void 0 ? ry : v, R = e.labelTransform, k = R === void 0 ? oS : R, F = e.shapeWidth, w = F === void 0 ? 15 : F, m = e.shapeHeight, _ = m === void 0 ? 15 : m, N = e.shapeMargin, P = N === void 0 ? "2px 4px 2px 0" : N, O = e.shapeStyle, L = e.labelAlign, U = L === void 0 ? "left" : L, W = e.labelFlex, Z = W === void 0 ? "1" : W, ce = e.labelMargin, te = ce === void 0 ? "0 4px" : ce, V = e.itemMargin, K = V === void 0 ? "0" : V, X = e.direction, B = X === void 0 ? "column" : X, oe = e.itemDirection, re = oe === void 0 ? "row" : oe, le = e.legendLabelProps, q = e.children, j = sS(e, lS), J = f || ("domain" in a ? a.domain() : []), ue = k({
    scale: a,
    labelFormat: S
  }), De = J.map(ue);
  return q ? /* @__PURE__ */ r.createElement(r.Fragment, null, q(De)) : /* @__PURE__ */ r.createElement("div", {
    className: Ln("visx-legend", t),
    style: ls({}, i, {
      flexDirection: B
    })
  }, De.map(function(be, ye) {
...
const Sc = (e, t) => {
  ...
  return k.checkFontColor = (w, m, _) => {
    ...
    const m = {};
    return w == null ? void 0 : w.filter((N) => {
...
const ly = (e, t, n, i) => (a) => {
  ...
  if (l === "Deviation Bar") {
    const [m, _] = Iu[e.twoColor.palette], N = {
      datum: "X",
      index: 0,
  ...
  if (((R = u == null ? void 0 : u.forecastingSeriesKeys) == null ? void 0 : R.length) > 0) {
    let m = [];
    return (F = (k = e.runtime) == null ? void 0 : k.forecastingSeriesKeys) == null || F.map((_, N) => {
      var P;
      return (P = _ == null ? void 0 : _.stages) == null ? void 0 : P.map((O, L) => {
        var Z, ce, te, V;
        let U = (Z = $u[O.color]) != null && Z[2] ? (ce = $u[O.color]) == null ? void 0 : ce[2] : (te = dr[O.color]) != null && te[2] ? (V = dr[O.color]) == null ? void 0 : V[2] : "#ccc";
        const W = {
          datum: O.key,
          index: L,
          text: O.key,
    ...
    }), e.runtime.barSeriesKeys && e.runtime.barSeriesKeys.forEach((_, N) => {
  ...
  if ((e.visualizationType === "Bar" || e.visualizationType === "Combo") && e.visualizationSubType === "regular" && e.suppressedData) {
    const m = a.length - 1;
    let _ = [];
    return (w = e.suppressedData) == null || w.forEach(({ label: N, icon: P }, O) => {
      if (N && P) {
        const L = {
          datum: N,
          index: m + O,
  ...
  const { transformedData: t, config: n, colorScale: i, currentViewport: a, dimensions: l, highlight: f, highlightReset: d, seriesHighlight: u } = de.useContext(Ct), { tooltipData: h, showTooltip: y, hideTooltip: v, tooltipOpen: S, tooltipLeft: R, tooltipTop: k } = Xm(), { handleTooltipMouseOver: F, handleTooltipMouseOff: w, TooltipListItem: m } = Jm({
    xScale: !1,
    yScale: !1,
    showTooltip: y,
    hideTooltip: v
  }), [_, N] = de.useState(void 0), [P, O] = de.useState(!1), L = Object.values(n.columns).filter((j) => j.showInViz), U = L.length > 0, W = U ? "pivotColumn" : void 0, Z = de.useMemo(() => {
    if (U) {
      let j = [];
      const J = n.yAxis.dataKey, ue = L.map((ye) => ye.name), De = [J, ...ue], be = n.xAxis.dataKey;
      return t.forEach((ye) => {
        De.forEach((Le) => {
          const ae = ye[Le];
          ae && j.push({
    ...
    if (U) {
      const j = {};
      Z.forEach((De) => {
        j[De[n.xAxis.dataKey]] || (j[De[n.xAxis.dataKey]] = !0);
      });
  ...
  de.useEffect(() => {
    document.querySelector(".isEditor") && O((J) => !0);
  }), de.useEffect(() => {
  ...
  const K = ({ arcs: j, path: J, getKey: ue }) => {
    ...
    }, [h]), /* @__PURE__ */ r.createElement(r.Fragment, null, De.map(({ item: be, props: ye, key: Le }, ae) => /* @__PURE__ */ r.createElement(at, { className: be.data[n.xAxis.dataKey], key: `${Le}-${ae}`, style: { opacity: n.legend.behavior === "highlight" && u.length > 0 && u.indexOf(be.data[n.runtime.xAxis.dataKey]) === -1 ? 0.5 : 1 } }, /* @__PURE__ */ r.createElement(
      Zp.path,
      {
        d: Wx(
  ...
  const q = ly(n, [], Z, ce);
  return /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(Or, { component: "PieChart" }, /* @__PURE__ */ r.createElement("svg", { width: oe * 2, height: B, className: `animated-pie group ${n.animate === !1 || P ? "animated" : ""}`, role: "img", "aria-label": hf(n) }, /* @__PURE__ */ r.createElement(at, { top: re, left: oe }, /* @__PURE__ */ r.createElement(
    o0,
    {
      data: _ || Z,
...
const bS = function(e) {
  return e === void 0 && (e = {}), { name: "flip", options: e, async fn(t) {
    var n;
    const { placement: i, middlewareData: a, rects: l, initialPlacement: f, platform: d, elements: u } = t, { mainAxis: h = !0, crossAxis: y = !0, fallbackPlacements: v, fallbackStrategy: S = "bestFit", fallbackAxisSideDirection: R = "none", flipAlignment: k = !0, ...F } = e, w = Oi(i), m = Oi(f) === f, _ = await (d.isRTL == null ? void 0 : d.isRTL(u.floating)), N = v || (m || !k ? [oc(f)] : function(te) {
      const V = oc(te);
      return [Id(te), V, Id(V)];
    }(f));
    v || R === "none" || N.push(...function(te, V, K, X) {
      const B = bs(te);
      let oe = function(re, le, q) {
        const j = ["left", "right"], J = ["right", "left"], ue = ["top", "bottom"], De = ["bottom", "top"];
        switch (re) {
          case "top":
          case "bottom":
            return q ? le ? J : j : le ? j : J;
          case "left":
          case "right":
            return le ? ue : De;
          default:
    ...
    const P = [f, ...N], O = await uy(t, F), L = [];
    let U = ((n = a.flip) == null ? void 0 : n.overflows) || [];
    if (h && L.push(O[w]), y) {
      const { main: te, cross: V } = vS(i, l, _);
      L.push(O[te], O[V]);
    }
  ...
  return e === void 0 && (e = 0), { name: "offset", options: e, async fn(t) {
    const { x: n, y: i } = t, a = await async function(l, f) {
      const { placement: d, platform: u, elements: h } = l, y = await (u.isRTL == null ? void 0 : u.isRTL(h.floating)), v = Oi(d), S = bs(d), R = Ss(d) === "x", k = ["left", "top"].includes(v) ? -1 : 1, F = y && R ? -1 : 1, w = typeof f == "function" ? f(l) : f;
      let { mainAxis: m, crossAxis: _, alignmentAxis: N } = typeof w == "number" ? { mainAxis: w, crossAxis: 0, alignmentAxis: null } : { mainAxis: 0, crossAxis: 0, alignmentAxis: null, ...w };
      return S && typeof N == "number" && (_ = S === "end" ? -1 * N : N), R ? { x: _ * F, y: m * k } : { x: m * k, y: _ * F };
    }(t, e);
  ...
  return e === void 0 && (e = {}), { name: "shift", options: e, async fn(t) {
    const { x: n, y: i, placement: a } = t, { mainAxis: l = !0, crossAxis: f = !1, limiter: d = { fn: (w) => {
      let { x: m, y: _ } = w;
      return { x: m, y: _ };
    } }, ...u } = e, h = { x: n, y: i }, y = await uy(t, u), v = Ss(Oi(a)), S = v === "x" ? "y" : "x";
    let R = h[v], k = h[S];
    if (l) {
      const w = v === "y" ? "bottom" : "right";
      R = vf(R + y[v === "y" ? "top" : "left"], R, R - y[w]);
    }
    if (f) {
      const w = S === "y" ? "bottom" : "right";
      k = vf(k + y[S === "y" ? "top" : "left"], k, k - y[w]);
    }
...
function gs(e, t, n, i) {
  ...
  if (d) {
    ...
    for (; m && i && w !== F; ) {
      const _ = Vo(m), N = m.getBoundingClientRect(), P = getComputedStyle(m);
      N.x += (m.clientLeft + parseFloat(P.paddingLeft)) * _.x, N.y += (m.clientTop + parseFloat(P.paddingTop)) * _.y, v *= _.x, S *= _.y, R *= _.x, k *= _.y, v += N.x, S += N.y, m = Er(m).frameElement;
    }
  }
...
function gy(e) {
  const t = vs(e);
  return Gf(t) ? t.ownerDocument.body : Xr(t) && Ec(t) ? t : gy(t);
}
function vy(e, t) {
  var n;
  t === void 0 && (t = []);
...
const wS = { getClippingRect: function(e) {
  ...
  return (async (f, d, u) => {
    ...
    let F = await S.getElementRects({ reference: f, floating: d, strategy: y }), { x: w, y: m } = ch(F, h, k), _ = h, N = {}, P = 0;
    for (let O = 0; O < R.length; O++) {
      const { name: L, fn: U } = R[O], { x: W, y: Z, data: ce, reset: te } = await U({ x: w, y: m, initialPlacement: h, placement: _, strategy: y, middlewareData: N, rects: F, platform: S, elements: { reference: f, floating: d } });
      w = W ?? w, m = Z ?? m, N = { ...N, [L]: { ...N[L], ...ce } }, P > 50 && console.warn(["Floating UI: The middleware lifecycle appears to be running in an", "infinite loop. This is usually caused by a `reset` continually", "being returned without a break condition."].join(" ")), te && P <= 50 && (P++, typeof te == "object" && (te.placement && (_ = te.placement), te.rects && (F = te.rects === !0 ? await S.getElementRects({ reference: f, floating: d, strategy: y }) : te.rects), { x: w, y: m } = ch(F, _, k)), O = -1);
    }
    return { x: w, y: m, placement: _, strategy: y, middlewareData: N };
  })(e, t, { ...a, platform: l });
};
var Na, _i = { exports: {} }, gh = {};
...
Na = gh, function() {
  ...
  Na.Fragment = 60107;
  var i = 60108, a = 60114, l = 60109, f = 60110, d = 60112, u = 60113, h = 60120, y = 60115, v = 60116, S = 60121, R = 60122, k = 60117, F = 60129, w = 60131;
  if (typeof Symbol == "function" && Symbol.for) {
    var m = Symbol.for;
    t = m("react.element"), n = m("react.portal"), Na.Fragment = m("react.fragment"), i = m("react.strict_mode"), a = m("react.profiler"), l = m("react.provider"), f = m("react.context"), d = m("react.forward_ref"), u = m("react.suspense"), h = m("react.suspense_list"), y = m("react.memo"), v = m("react.lazy"), S = m("react.block"), R = m("react.server.block"), k = m("react.fundamental"), m("react.scope"), m("react.opaque.id"), F = m("react.debug_trace_mode"), m("react.offscreen"), w = m("react.legacy_hidden");
  }
  var _ = typeof Symbol == "function" && Symbol.iterator, N = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  function P(he) {
    for (var Pe = arguments.length, ee = new Array(Pe > 1 ? Pe - 1 : 0), Oe = 1; Oe < Pe; Oe++)
      ee[Oe - 1] = arguments[Oe];
    O("error", he, ee);
  }
  function O(he, Pe, ee) {
    var Oe = N.ReactDebugCurrentFrame, Te = "";
    if (Z) {
      var Ue = U(Z.type), qe = Z._owner;
      Te += function(Je, st, Ke) {
        var We = "";
        if (st) {
        ...
        return `
    in ` + (Je || "Unknown") + We;
      }(Ue, Z._source, qe && U(qe.type));
    }
    (Te += Oe.getStackAddendum()) !== "" && (Pe += "%s", ee = ee.concat([Te]));
  ...
  function U(he) {
    ...
    if (typeof he == "object")
      switch (he.$$typeof) {
        ...
        case d:
          return Oe = he, Te = he.render, Ue = "ForwardRef", qe = Te.displayName || Te.name || "", Oe.displayName || (qe !== "" ? Ue + "(" + qe + ")" : Ue);
        case y:
          return U(he.type);
        case S:
          return U(he.render);
  ...
  function re(he, Pe, ee, Oe, Te) {
    var Ue, qe = {}, et = null, Je = null;
    for (Ue in ee !== void 0 && (et = "" + ee), function(We) {
      ...
      B.call(Pe, Ue) && !oe.hasOwnProperty(Ue) && (qe[Ue] = Pe[Ue]);
    if (he && he.defaultProps) {
      var st = he.defaultProps;
      for (Ue in st)
        qe[Ue] === void 0 && (qe[Ue] = st[Ue]);
    }
    if (et || Je) {
    ...
    return function(We, Be, $e, ht, Ge, pt, gt) {
    ...
    }(he, et, Je, Te, Oe, X.current, qe);
  }
  K = {};
  var le, q = N.ReactCurrentOwner;
  function j(he) {
    Z = he;
  }
  function J(he) {
  ...
  function be(he, Pe) {
    if (he._store && !he._store.validated && he.key == null) {
      ...
      var ee = function(Te) {
        var Ue = ue();
        if (!Ue) {
          var qe = typeof Te == "string" ? Te : Te.displayName || Te.name;
          qe && (Ue = `
...
Check the top-level render call using <` + qe + ">.");
      ...
      if (!De[ee]) {
        De[ee] = !0;
        var Oe = "";
        he && he._owner && he._owner !== q.current && (Oe = " It was passed a child from " + U(he._owner.type) + "."), j(he), P('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', ee, Oe), j(null);
      }
    }
  }
  function ye(he, Pe) {
  ...
  function Le(he) {
    ...
    if (ee != null && typeof ee != "string") {
      ...
      if (Pe) {
        var Oe = U(ee);
        (function(Te, Ue, qe, et, Je) {
          var st = Function.call.bind(Object.prototype.hasOwnProperty);
          for (var Ke in Te)
            if (st(Te, Ke)) {
              var We = void 0;
              try {
                if (typeof Te[Ke] != "function") {
                  var Be = Error((et || "React class") + ": " + qe + " type `" + Ke + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof Te[Ke] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                  throw Be.name = "Invariant Violation", Be;
                }
                We = Te[Ke](Ue, Ke, et, qe, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
              } catch ($e) {
                We = $e;
              }
              !We || We instanceof Error || (ce(Je), P("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", et || "React class", qe, Ke, typeof We), ce(null)), We instanceof Error && !(We.message in W) && (W[We.message] = !0, ce(Je), P("Failed %s type: %s", qe, We.message), ce(null));
            }
        })(Pe, he.props, "prop", Oe, he);
      } else
  ...
  function ae(he, Pe, ee, Oe, Te, Ue) {
    var qe = function($e) {
      return typeof $e == "string" || typeof $e == "function" || $e === Na.Fragment || $e === a || $e === F || $e === i || $e === u || $e === h || $e === w || typeof $e == "object" && $e !== null && ($e.$$typeof === v || $e.$$typeof === y || $e.$$typeof === l || $e.$$typeof === f || $e.$$typeof === d || $e.$$typeof === k || $e.$$typeof === S || $e[0] === R);
    }(he);
    if (!qe) {
      var et = "";
...
Check your code at ` + $e.fileName.replace(/^.*[\\\/]/, "") + ":" + $e.lineNumber + "." : "";
    ...
    return he === Na.Fragment ? function($e) {
      for (var ht = Object.keys($e.props), Ge = 0; Ge < ht.length; Ge++) {
        var pt = ht[Ge];
...
const bh = async ({ elementReference: e = null, tooltipReference: t = null, tooltipArrowReference: n = null, place: i = "top", offset: a = 10, strategy: l = "absolute", middlewares: f = [SS(Number(a)), bS(), ES({ padding: 5 })] }) => {
  ...
  return n ? (d.push({ name: "arrow", options: u = { element: n, padding: 5 }, async fn(h) {
    const { element: y, padding: v = 0 } = u || {}, { x: S, y: R, placement: k, rects: F, platform: w } = h;
    if (y == null)
      return console.warn("Floating UI: No `element` was passed to the `arrow` middleware."), {};
    const m = sy(v), _ = { x: S, y: R }, N = Ss(k), P = Xf(N), O = await w.getDimensions(y), L = N === "y" ? "top" : "left", U = N === "y" ? "bottom" : "right", W = F.reference[P] + F.reference[N] - _[N] - F.floating[P], Z = _[N] - F.reference[N], ce = await (w.getOffsetParent == null ? void 0 : w.getOffsetParent(y));
    let te = ce ? N === "y" ? ce.clientHeight || 0 : ce.clientWidth || 0 : 0;
    te === 0 && (te = F.floating[P]);
    const V = W / 2 - Z / 2, K = m[L], X = te - O[P] - m[U], B = te / 2 - O[P] / 2 + V, oe = vf(K, B, X), re = bs(k) != null && B != oe && F.reference[P] / 2 - (B < K ? m[L] : m[U]) - O[P] / 2 < 0;
    return { [N]: _[N] - (re ? B < K ? K - B : X - B : 0), data: { [N]: oe, centerOffset: B - oe } };
...
const Sh = ({ id: e, className: t, classNameArrow: n, variant: i = "dark", anchorId: a, anchorSelect: l, place: f = "top", offset: d = 10, events: u = ["hover"], positionStrategy: h = "absolute", middlewares: y, wrapper: v, children: S = null, delayShow: R = 0, delayHide: k = 0, float: F = !1, noArrow: w = !1, clickable: m = !1, closeOnEsc: _ = !1, style: N, position: P, afterShow: O, afterHide: L, content: U, html: W, isOpen: Z, setIsOpen: ce, activeAnchor: te, setActiveAnchor: V }) => {
  const K = de.useRef(null), X = de.useRef(null), B = de.useRef(null), oe = de.useRef(null), [re, le] = de.useState({}), [q, j] = de.useState({}), [J, ue] = de.useState(!1), [De, be] = de.useState(!1), ye = de.useRef(!1), Le = de.useRef(null), { anchorRefs: ae, setActiveAnchor: Ie } = by(e), Ee = de.useRef(!1), [he, Pe] = de.useState([]), ee = de.useRef(!1);
  ...
  const Oe = (Ge) => {
    ee.current && (Ge && be(!0), setTimeout(() => {
      ee.current && (ce == null || ce(Ge), Z === void 0 && ue(Ge));
    }, 10));
  };
  de.useEffect(() => {
    if (Z === void 0)
    ...
    J !== ye.current && (ye.current = J, J ? O == null || O() : L == null || L());
  }, [J]);
  const Te = (Ge = k) => {
    ...
    const gt = (pt = Ge.currentTarget) !== null && pt !== void 0 ? pt : Ge.target;
    V(gt), Ie({ current: gt }), oe.current && clearTimeout(oe.current);
  }, qe = () => {
    m ? Te(k || 100) : k ? Te() : Oe(!1), B.current && clearTimeout(B.current);
  }, et = ({ x: Ge, y: pt }) => {
    bh({ place: f, offset: d, elementReference: { getBoundingClientRect: () => ({ x: Ge, y: pt, width: 0, height: 0, top: pt, left: Ge, right: Ge, bottom: pt }) }, tooltipReference: K.current, tooltipArrowReference: X.current, strategy: h, middlewares: y }).then((gt) => {
      Object.keys(gt.tooltipStyles).length && le(gt.tooltipStyles), Object.keys(gt.tooltipArrowStyles).length && j(gt.tooltipArrowStyles);
    });
  }, Je = (Ge) => {
    if (!Ge)
      return;
    const pt = Ge, gt = { x: pt.clientX, y: pt.clientY };
    et(gt), Le.current = gt;
  }, st = (Ge) => {
    Ue(Ge), k && Te();
  }, Ke = (Ge) => {
    const pt = document.querySelector(`[id='${a}']`);
    pt != null && pt.contains(Ge.target) || he.some((gt) => gt.contains(Ge.target)) || Oe(!1);
  }, We = (Ge) => {
    Ge.key === "Escape" && Oe(!1);
  }, Be = xh(Ue, 50), $e = xh(qe, 50);
  de.useEffect(() => {
    var Ge, pt;
    const gt = new Set(ae);
    he.forEach((vt) => {
    ...
    ut && gt.add({ current: ut }), _ && window.addEventListener("keydown", We);
    const Rt = [];
    ...
    return m && ((Ge = K.current) === null || Ge === void 0 || Ge.addEventListener("mouseenter", tn), (pt = K.current) === null || pt === void 0 || pt.addEventListener("mouseleave", Xt)), Rt.forEach(({ event: vt, listener: Nt }) => {
      gt.forEach((hn) => {
        var on;
      ...
      var vt, Nt;
      u.find((hn) => hn === "click") && window.removeEventListener("click", Ke), _ && window.removeEventListener("keydown", We), m && ((vt = K.current) === null || vt === void 0 || vt.removeEventListener("mouseenter", tn), (Nt = K.current) === null || Nt === void 0 || Nt.removeEventListener("mouseleave", Xt)), Rt.forEach(({ event: hn, listener: on }) => {
        gt.forEach((qt) => {
          var yn;
  ...
  }, [De, ae, he, _, u]), de.useEffect(() => {
    let Ge = l ?? "";
    !Ge && e && (Ge = `[data-tooltip-id='${e}']`);
    const pt = new MutationObserver((gt) => {
      const ut = [];
      gt.forEach((Rt) => {
        if (Rt.type === "attributes" && Rt.attributeName === "data-tooltip-id" && Rt.target.getAttribute("data-tooltip-id") === e && ut.push(Rt.target), Rt.type === "childList" && (te && [...Rt.removedNodes].some((tn) => !!tn.contains(te) && (be(!1), Oe(!1), V(null), !0)), Ge))
          try {
            const tn = [...Rt.addedNodes].filter((Xt) => Xt.nodeType === 1);
            ut.push(...tn.filter((Xt) => Xt.matches(Ge))), ut.push(...tn.flatMap((Xt) => [...Xt.querySelectorAll(Ge)]));
          } catch {
          }
    ...
    P ? et(P) : F ? Le.current && et(Le.current) : bh({ place: f, offset: d, elementReference: te, tooltipReference: K.current, tooltipArrowReference: X.current, strategy: h, middlewares: y }).then((Ge) => {
      ee.current && (Object.keys(Ge.tooltipStyles).length && le(Ge.tooltipStyles), Object.keys(Ge.tooltipArrowStyles).length && j(Ge.tooltipArrowStyles));
    });
  }, [J, te, U, W, f, d, h, P]), de.useEffect(() => {
    var Ge;
    const pt = document.querySelector(`[id='${a}']`), gt = [...he, pt];
    te && gt.includes(te) || V((Ge = he[0]) !== null && Ge !== void 0 ? Ge : pt);
    ...
    if (!Ge && e && (Ge = `[data-tooltip-id='${e}']`), Ge)
      try {
        const pt = Array.from(document.querySelectorAll(Ge));
        Pe(pt);
      } catch {
        Pe([]);
      }
  ...
  return De ? _i.exports.jsxs(v, { id: e, role: "tooltip", className: vh("react-tooltip", Ti.tooltip, Ti[i], t, { [Ti.show]: ht, [Ti.fixed]: h === "fixed", [Ti.clickable]: m }), style: { ...N, ...re }, ref: K, children: [W && _i.exports.jsx(CS, { content: W }) || U || S, _i.exports.jsx(v, { className: vh("react-tooltip-arrow", Ti.arrow, n, { [Ti["no-arrow"]]: w }), style: q, ref: X })] }) : null;
}, Sy = ({ id: e, anchorId: t, anchorSelect: n, content: i, html: a, className: l, classNameArrow: f, variant: d = "dark", place: u = "top", offset: h = 10, wrapper: y = "div", children: v = null, events: S = ["hover"], positionStrategy: R = "absolute", middlewares: k, delayShow: F = 0, delayHide: w = 0, float: m = !1, noArrow: _ = !1, clickable: N = !1, closeOnEsc: P = !1, style: O, position: L, isOpen: U, setIsOpen: W, afterShow: Z, afterHide: ce }) => {
  const [te, V] = de.useState(i), [K, X] = de.useState(a), [B, oe] = de.useState(u), [re, le] = de.useState(d), [q, j] = de.useState(h), [J, ue] = de.useState(F), [De, be] = de.useState(w), [ye, Le] = de.useState(m), [ae, Ie] = de.useState(y), [Ee, he] = de.useState(S), [Pe, ee] = de.useState(R), [Oe, Te] = de.useState(null), { anchorRefs: Ue, activeAnchor: qe } = by(e), et = (Ke) => Ke == null ? void 0 : Ke.getAttributeNames().reduce((We, Be) => {
    var $e;
  ...
  de.useEffect(() => {
    ...
    if ($e && We.add({ current: $e }), !We.size)
      return () => null;
    const ht = (Ke = Oe ?? $e) !== null && Ke !== void 0 ? Ke : qe.current, Ge = new MutationObserver((gt) => {
      gt.forEach((ut) => {
        var Rt;
    ...
    if (ht) {
      const gt = et(ht);
      Je(gt), Ge.observe(ht, pt);
    }
    return () => {
      Ge.disconnect();
    };
  }, [Ue, qe, Oe, t, n]);
  const st = { id: e, anchorId: t, anchorSelect: n, className: l, classNameArrow: f, content: te, html: K, place: B, variant: re, offset: q, wrapper: ae, events: Ee, positionStrategy: Pe, middlewares: k, delayShow: J, delayHide: De, float: ye, noArrow: _, clickable: N, closeOnEsc: P, style: O, position: L, isOpen: U, setIsOpen: W, afterShow: Z, afterHide: ce, activeAnchor: Oe, setActiveAnchor: (Ke) => Te(Ke) };
  return v ? _i.exports.jsx(Sh, { ...st, children: v }) : _i.exports.jsx(Sh, { ...st });
};
function Eh(e, t) {
  let n;
  if (t === void 0)
...
function FS() {
  let e = 0, t = 0, n = 1, i = 1, a = 24, l = 8, f, d = DS, u = NS, h, y, v = OS, S = _S, R = 6;
  function k() {
    const B = { nodes: v.apply(null, arguments), links: S.apply(null, arguments) };
    return F(B), w(B), m(B), _(B), O(B), Ch(B), B;
  }
  k.update = function(B) {
    return Ch(B), B;
  }, k.nodeId = function(B) {
    ...
    return arguments.length ? (u = typeof B == "function" ? B : Tu(B), k) : u;
  ...
  function F({ nodes: B, links: oe }) {
    for (const [le, q] of B.entries())
      q.index = le, q.sourceLinks = [], q.targetLinks = [];
    const re = new Map(B.map((le, q) => [d(le, q, B), le]));
    for (const [le, q] of oe.entries()) {
      q.index = le;
      let { source: j, target: J } = q;
      typeof j != "object" && (j = q.source = wh(re, j)), typeof J != "object" && (J = q.target = wh(re, J)), j.sourceLinks.push(q), J.targetLinks.push(q);
    }
    if (y != null)
      for (const { sourceLinks: le, targetLinks: q } of B)
        le.sort(y), q.sort(y);
  }
  function w({ nodes: B }) {
    for (const oe of B)
  ...
  function m({ nodes: B }) {
    const oe = B.length;
    let re = new Set(B), le = /* @__PURE__ */ new Set(), q = 0;
    for (; re.size; ) {
      for (const j of re) {
        j.depth = q;
  ...
  function N({ nodes: B }) {
    const oe = Eh(B, (q) => q.depth) + 1, re = (n - e - a) / (oe - 1), le = new Array(oe);
    for (const q of B) {
      const j = Math.max(0, Math.min(oe - 1, Math.floor(u.call(null, q, oe))));
      q.layer = j, q.x0 = e + j * re, q.x1 = q.x0 + a, le[j] ? le[j].push(q) : le[j] = [q];
    }
    if (h)
      for (const q of le)
        q.sort(h);
  ...
  function P(B) {
    ...
    for (const re of B) {
      let le = t;
      for (const q of re) {
        q.y0 = le, q.y1 = le + q.value * oe, le = q.y1 + f;
  ...
  function O(B) {
    ...
    for (let re = 0; re < R; ++re) {
      const le = Math.pow(0.99, re), q = Math.max(1 - le, (re + 1) / R);
      U(oe, le, q), L(oe, le, q);
    }
  }
  function L(B, oe, re) {
    for (let le = 1, q = B.length; le < q; ++le) {
      const j = B[le];
      for (const J of j) {
        let ue = 0, De = 0;
  ...
  function U(B, oe, re) {
    for (let le = B.length, q = le - 2; q >= 0; --q) {
      const j = B[q];
      for (const J of j) {
        let ue = 0, De = 0;
  ...
  function Z(B, oe, re, le) {
    for (; re < B.length; ++re) {
      const q = B[re], j = (oe - q.y0) * le;
      j > 1e-6 && (q.y0 += j, q.y1 += j), oe = q.y1 + f;
    }
  }
  function ce(B, oe, re, le) {
    for (; re >= 0; --re) {
      const q = B[re], j = (q.y1 - oe) * le;
      j > 1e-6 && (q.y0 -= j, q.y1 -= j), oe = q.y0 - f;
    }
  }
  ...
  function V(B) {
    if (y === void 0)
      for (const { sourceLinks: oe, targetLinks: re } of B)
        oe.sort(Th), re.sort(kh);
  }
  function K(B, oe) {
    let re = B.y0 - (B.sourceLinks.length - 1) * f / 2;
    for (const { target: le, width: q } of B.sourceLinks) {
      if (le === oe)
        break;
      re += q + f;
    }
    for (const { source: le, width: q } of oe.targetLinks) {
      if (le === B)
        break;
      re -= q;
    }
      ...
      if (n.call(I, Y)) {
        ...
        if (Se != null && typeof Se != "boolean" && Se !== "") {
          if (Y.indexOf("--") === 0) {
            ...
            ge = Y;
            var Ae = P.get(ge);
            Ae !== void 0 || (Ae = k(ge.replace(F, "-$1").toLowerCase().replace(w, "-ms-")), P.set(ge, Ae)), ge = Ae, Se = typeof Se == "number" ? Se === 0 || n.call(v, Y) ? "" + Se : Se + "px" : k(("" + Se).trim());
          }
...
`), ge;
  ...
  var J = Object.assign, ue = Symbol.for("react.element"), De = Symbol.for("react.portal"), be = Symbol.for("react.fragment"), ye = Symbol.for("react.strict_mode"), Le = Symbol.for("react.profiler"), ae = Symbol.for("react.provider"), Ie = Symbol.for("react.context"), Ee = Symbol.for("react.forward_ref"), he = Symbol.for("react.suspense"), Pe = Symbol.for("react.suspense_list"), ee = Symbol.for("react.memo"), Oe = Symbol.for("react.lazy"), Te = Symbol.for("react.scope"), Ue = Symbol.for("react.debug_trace_mode"), qe = Symbol.for("react.legacy_hidden"), et = Symbol.for("react.default_value"), Je = Symbol.iterator;
  function st(g) {
    if (g == null)
      return null;
  ...
  function Ge(g) {
    var C = g.parent;
    C !== null && Ge(C), g.context._currentValue2 = g.value;
  }
  function pt(g, C) {
  ...
  function ut(g) {
    var C = Be;
    C !== g && (C === null ? Ge(g) : g === null ? ht(C) : C.depth === g.depth ? $e(C, g) : C.depth > g.depth ? pt(C, g) : gt(C, g), Be = g);
  }
  ...
  var Nt = Math.clz32 ? Math.clz32 : qt, hn = Math.log, on = Math.LN2;
  function qt(g) {
  ...
  var ze = typeof Object.is == "function" ? Object.is : yn, xt = null, Ht = null, It = null, At = null, xn = !1, Mt = !1, ln = 0, cn = null, Tn = 0;
  function Jt() {
    if (xt === null)
      throw Error(t(321));
    return xt;
  ...
  function Mn() {
    Ht = xt = null, Mt = !1, It = null, Tn = 0, At = cn = null;
  }
  function Hn(g, C) {
  ...
  function Dt(g, C, I, Y, Se) {
    for (xt = {}, Ht = C, ln = 0, g = I(Y, Se); Mt; )
      Mt = !1, ln = 0, Tn += 1, At = null, g = I(Y, Se);
    return Mn(), g;
  }
  function Ze(g, C, I, Y) {
  ...
  function zt(g, C, I, Y, Se) {
    if (typeof I == "function")
      if (I.prototype && I.prototype.isReactComponent) {
        ...
        ge = We(I, C.legacyContext), Se = Dt(g, C, I, Y, ge);
        var Ae = ln !== 0;
      ...
      switch (Se = C.blockedSegment, ge = K(Se.chunks, I, Y, g.responseState, Se.formatContext), Se.lastPushedText = !1, Ae = Se.formatContext, Se.formatContext = N(Ae, I, Y), Ot(g, C, ge), Se.formatContext = Ae, I) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      if (typeof I == "object" && I !== null)
        switch (I.$$typeof) {
          case Ee:
            if (Y = Dt(g, C, I.render, Y, Se), ln !== 0) {
  ...
  function dn(g, C, I) {
    if (C === null) {
      ...
      g.pendingRootTasks--, g.pendingRootTasks === 0 && (g.onShellError = _e, C = g.onShellReady, C());
    } else
  ...
  function Xn(g, C, I, Y) {
    ...
    if (g = Xe(g, q(I, C ? C.identifierPrefix : void 0), { insertionMode: 1, selectedValue: null }, 1 / 0, Zn, void 0, function() {
      rt = !0;
...
function BS() {
  ...
  function w(x, A, z, G, ke, xe, Me) {
    this.acceptsBooleans = A === 2 || A === 3 || A === 4, this.attributeName = G, this.attributeNamespace = ke, this.mustUseProperty = z, this.propertyName = x, this.type = A, this.sanitizeURL = xe, this.removeEmptyString = Me;
  }
  var m = {};
  ...
  function le(x, A, z, G, ke) {
    x = x === void 0 ? "" : x, A = A === void 0 ? te : h('<script nonce="' + U(A) + '">');
    var xe = [];
    if (z !== void 0 && xe.push(A, u(("" + z).replace(oe, re)), V), G !== void 0)
      for (z = 0; z < G.length; z++)
        xe.push(K, u(U(G[z])), B);
    if (ke !== void 0)
      for (G = 0; G < ke.length; G++)
        xe.push(X, u(U(ke[G])), B);
  ...
  var ue = h("<!-- -->");
  function De(x, A, z, G) {
    return A === "" ? G : (G && x.push(ue), x.push(u(U(A))), !0);
  }
      ...
      if (v.call(z, G)) {
        ...
        if (ke != null && typeof ke != "boolean" && ke !== "") {
          if (G.indexOf("--") === 0) {
            ...
            xe = G;
            var Me = be.get(xe);
            Me !== void 0 || (Me = h(U(xe.replace(W, "-$1").toLowerCase().replace(Z, "-ms-"))), be.set(xe, Me)), xe = Me, ke = typeof ke == "number" ? ke === 0 || v.call(P, G) ? u("" + ke) : u(ke + "px") : u(U(("" + ke).trim()));
          }
      ...
      if (A = m.hasOwnProperty(z) ? m[z] : null, A !== null) {
        ...
        switch (z = u(A.attributeName), A.type) {
          case 3:
            ...
            break;
          case 4:
            G === !0 ? x.push(Ee, z, ee) : G !== !1 && x.push(Ee, z, he, u(U(G)), Pe);
            break;
          case 5:
            isNaN(G) || x.push(Ee, z, he, u(U(G)), Pe);
            break;
          case 6:
            !isNaN(G) && 1 <= G && x.push(Ee, z, he, u(U(G)), Pe);
            break;
          default:
            A.sanitizeURL && (G = "" + G), x.push(Ee, z, he, u(U(G)), Pe);
        }
      } else if (F(z)) {
        switch (typeof G) {
          case "function":
  ...
  function st(x, A, z, G) {
    ...
    return x.push(Te), qe(x, ke, z), typeof z == "string" ? (x.push(u(U(z))), null) : z;
  }
  var Ke = h(`
  ...
  function Ge(x, A, z, G, ke) {
    switch (A) {
      case "select":
        ...
        return x.push(Te), qe(x, Me, xe), xe;
      case "option":
        Me = ke.selectedValue, x.push($e("option"));
        var St = Ye = null, _t = null, Pt = null;
        for (xe in z)
          if (v.call(z, xe)) {
            var rn = z[xe];
            if (rn != null)
        ...
        if (Me != null)
          ...
          _t && x.push(Je);
        return x.push(Te), qe(x, Pt, Ye), Ye;
      case "textarea":
        ...
        if (xe === null && Me !== null && (xe = Me), x.push(Te), Pt != null) {
          if (xe != null)
            throw Error(t(92));
...
` && x.push(Ke), xe !== null && x.push(u(U("" + xe))), null;
      case "input":
        ...
        for (Me in z)
          if (v.call(z, Me) && (_t = z[Me], _t != null))
            switch (Me) {
              case "children":
              case "dangerouslySetInnerHTML":
                throw Error(t(399, "input"));
        ...
        return Pt !== null ? Oe(
          ...
          "checked",
          Pt
        ) : St !== null && Oe(x, G, "checked", St), xe !== null ? Oe(x, G, "value", xe) : Ye !== null && Oe(x, G, "value", Ye), x.push(Ue), null;
      case "menuitem":
        x.push($e("menuitem"));
        for (var Un in z)
...
` && x.push(Ke), xe;
      ...
      case "missing-glyph":
        return st(x, z, A, G);
      case "html":
        return ke.insertionMode === 0 && x.push(ht), st(x, z, A, G);
      default:
        if (A.indexOf("-") === -1 && typeof z.is != "string")
          return st(x, z, A, G);
        x.push($e(A)), Me = xe = null;
        for (_t in z)
          if (v.call(z, _t) && (Ye = z[_t], Ye != null))
            switch (_t) {
              case "children":
                xe = Ye;
                break;
              ...
              case "suppressHydrationWarning":
                break;
              default:
                F(_t) && typeof Ye != "function" && typeof Ye != "symbol" && x.push(Ee, u(_t), he, u(U(Ye)), Pe);
            }
        return x.push(Te), qe(x, Me, xe), xe;
    }
  }
  var pt = h("</"), gt = h(">"), ut = h('<template id="'), Rt = h('"></template>'), tn = h("<!--$-->"), Xt = h('<!--$?--><template id="'), vt = h('"></template>'), Nt = h("<!--$!-->"), hn = h("<!--/$-->"), on = h("<template"), qt = h('"'), yn = h(' data-dgst="');
  ...
  var Ht = h('<div hidden id="'), It = h('">'), At = h("</div>"), xn = h('<svg aria-hidden="true" style="display:none" id="'), Mt = h('">'), ln = h("</svg>"), cn = h('<math aria-hidden="true" style="display:none" id="'), Tn = h('">'), Jt = h("</math>"), jt = h('<table hidden id="'), Pn = h('">'), Mn = h("</table>"), Hn = h('<table hidden><tbody id="'), Ut = h('">'), zn = h("</tbody></table>"), Wn = h('<table hidden><tr id="'), An = h('">'), Sn = h("</tr></table>"), Ne = h('<table hidden><colgroup id="'), ct = h('">'), dt = h("</colgroup></table>");
  function $(x, A, z, G) {
    switch (z.insertionMode) {
      case 0:
      case 1:
        return a(x, Ht), a(x, A.segmentPrefix), a(x, u(G.toString(16))), l(x, It);
      case 2:
        return a(x, xn), a(x, A.segmentPrefix), a(x, u(G.toString(16))), l(x, Mt);
      case 3:
        return a(x, cn), a(x, A.segmentPrefix), a(x, u(G.toString(16))), l(x, Tn);
      case 4:
        return a(x, jt), a(x, A.segmentPrefix), a(x, u(G.toString(16))), l(x, Pn);
      case 5:
        return a(x, Hn), a(x, A.segmentPrefix), a(x, u(G.toString(16))), l(x, Ut);
      case 6:
        return a(x, Wn), a(x, A.segmentPrefix), a(x, u(G.toString(16))), l(x, An);
      case 7:
        return a(
          x,
          Ne
        ), a(x, A.segmentPrefix), a(x, u(G.toString(16))), l(x, ct);
      default:
        throw Error(t(397));
    }
  }
  ...
  function $n(x, A, z, G) {
    ...
    if (x.context = typeof Me == "object" && Me !== null ? Me._currentValue : G, Me = A.getDerivedStateFromProps, typeof Me == "function" && (Me = Me(z, ke), ke = Me == null ? ke : dn({}, ke, Me), x.state = ke), typeof A.getDerivedStateFromProps != "function" && typeof x.getSnapshotBeforeUpdate != "function" && (typeof x.UNSAFE_componentWillMount == "function" || typeof x.componentWillMount == "function"))
  ...
  function pr(x, A, z) {
    ...
    if (30 < xe) {
      var Me = ke - ke % 5;
      return xe = (G & (1 << Me) - 1).toString(32), G >>= Me, ke -= Me, { id: 1 << 32 - Gr(A) + ke | z << ke | G, overflow: xe + x };
    }
  ...
  function ja(x, A, z, G, ke, xe, Me, Ye, St) {
    var _t = [], Pt = /* @__PURE__ */ new Set();
    return A = { destination: null, responseState: A, progressiveChunkSize: G === void 0 ? 12800 : G, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: Pt, pingedTasks: _t, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: ke === void 0 ? nl : ke, onAllReady: xe === void 0 ? Qr : xe, onShellReady: Me === void 0 ? Qr : Me, onShellError: Ye === void 0 ? Qr : Ye, onFatalError: St === void 0 ? Qr : St }, z = _r(A, 0, null, z, !1, !1), z.parentFlushed = !0, x = Ua(A, x, null, z, Pt, rt, null, Tr), _t.push(x), A;
  }
  function Ua(x, A, z, G, ke, xe, Me, Ye) {
    x.allPendingTasks++, z === null ? x.pendingRootTasks++ : z.pendingTasks++;
    var St = { node: A, ping: function() {
      var _t = x.pingedTasks;
      _t.push(St), _t.length === 1 && Ki(x);
    }, blockedBoundary: z, blockedSegment: G, abortSet: ke, legacyContext: xe, context: Me, treeContext: Ye };
    return ke.add(St), St;
  }
  ...
  function Ka(x, A, z, G) {
    ...
    if (xe != null) {
      ...
      A.legacyContext = G, jn(x, A, ke), A.legacyContext = Me;
    } else
      jn(x, A, ke);
  }
  function Wi(x, A) {
  ...
  function ya(x, A, z, G, ke) {
    if (typeof z == "function")
      if (z.prototype && z.prototype.isReactComponent) {
        ...
        xe = yt(z, A.legacyContext), ke = Hi(x, A, z, G, xe);
        var Me = wr !== 0;
      ...
      switch (ke = A.blockedSegment, xe = Ge(ke.chunks, z, G, x.responseState, ke.formatContext), ke.lastPushedText = !1, Me = ke.formatContext, ke.formatContext = J(Me, z, G), ga(x, A, xe), ke.formatContext = Me, z) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      switch (z) {
        ...
        case Zn:
          e: {
            z = A.blockedBoundary, ke = A.blockedSegment, xe = G.fallback, G = G.children, Me = /* @__PURE__ */ new Set();
            var Ye = { id: null, rootSegmentID: -1, parentFlushed: !1, pendingTasks: 0, forceClientRender: !1, completedSegments: [], byteSize: 0, fallbackAbortableTasks: Me, errorDigest: null }, St = _r(x, ke.chunks.length, Ye, ke.formatContext, !1, !1);
            ke.children.push(St), ke.lastPushedText = !1;
            var _t = _r(x, 0, null, ke.formatContext, !1, !1);
            _t.parentFlushed = !0, A.blockedBoundary = Ye, A.blockedSegment = _t;
            try {
              if (ga(
                x,
                A,
                G
              ), _t.lastPushedText && _t.textEmbedded && _t.chunks.push(ue), _t.status = 1, va(Ye, _t), Ye.pendingTasks === 0)
                break e;
            } catch (Pt) {
              _t.status = 4, Ye.forceClientRender = !0, Ye.errorDigest = Fr(x, Pt);
            } finally {
      ...
      if (typeof z == "object" && z !== null)
        switch (z.$$typeof) {
          ...
          case g:
            ...
            return;
          case kn:
            if (ke = G.children, z = z._context, G = G.value, xe = z._currentValue, z._currentValue = G, Me = ie, ie = G = { parent: Me, depth: Me === null ? 0 : Me.depth + 1, context: z, parentValue: xe, value: G }, A.context = G, jn(x, A, ke), x = ie, x === null)
              throw Error(t(403));
            G = x.parentValue, x.context._currentValue = G === ge ? x.context._defaultValue : G, x = ie = x.parent, A.context = x;
            return;
          case In:
  ...
  function jn(x, A, z) {
    if (A.node = z, typeof z == "object" && z !== null) {
      ...
      if (z === null || typeof z != "object" ? G = null : (G = Ae && z[Ae] || z["@@iterator"], G = typeof G == "function" ? G : null), G && (G = G.call(z))) {
        if (z = G.next(), !z.done) {
          var ke = [];
          do
    ...
    typeof z == "string" ? (G = A.blockedSegment, G.lastPushedText = De(A.blockedSegment.chunks, z, x.responseState, G.lastPushedText)) : typeof z == "number" && (G = A.blockedSegment, G.lastPushedText = De(A.blockedSegment.chunks, "" + z, x.responseState, G.lastPushedText));
  }
  function Vi(x, A, z) {
  ...
  function ga(x, A, z) {
    ...
    try {
      ...
      if (Va(), typeof St == "object" && St !== null && typeof St.then == "function") {
        z = St;
        var Me = A.blockedSegment, Ye = _r(x, Me.chunks.length, null, Me.formatContext, Me.lastPushedText, !0);
        Me.children.push(Ye), Me.lastPushedText = !1, x = Ua(x, A.node, A.blockedBoundary, Ye, A.abortSet, A.legacyContext, A.context, A.treeContext).ping, z.then(x, x), A.blockedSegment.formatContext = G, A.legacyContext = ke, A.context = xe, wn(xe);
      } else
        throw A.blockedSegment.formatContext = G, A.legacyContext = ke, A.context = xe, wn(xe), St;
    }
  }
  function rl(x) {
  ...
  function xa(x, A, z) {
    switch (z.parentFlushed = !0, z.status) {
      case 0:
        ...
        return z.lastPushedText = !1, z.textEmbedded = !1, x = x.responseState, a(A, ut), a(A, x.placeholderPrefix), x = u(G.toString(16)), a(A, x), l(A, Rt);
      case 1:
        z.status = 2;
        var ke = !0;
        G = z.chunks;
  ...
  function ba(x, A, z) {
    ...
    if (G.parentFlushed = !0, G.forceClientRender)
      G = G.errorDigest, l(A, Nt), a(A, on), G && (a(A, yn), a(A, u(U(G))), a(A, qt)), l(A, ze), xa(x, A, z);
      ...
      ke = h(ke.boundaryPrefix + xe.toString(16)), G = G.id = ke, xt(A, x.responseState, G), xa(x, A, z);
    } else if (G.byteSize > x.progressiveChunkSize)
      G.rootSegmentID = x.nextSegmentId++, x.completedBoundaries.push(G), xt(A, x.responseState, G.id), xa(x, A, z);
    else {
  ...
  function Yi(x, A, z) {
    return $(A, x.responseState, z.formatContext, z.id), ba(x, A, z), _e(A, z.formatContext);
  }
  function Xi(x, A, z) {
    for (var G = z.completedSegments, ke = 0; ke < G.length; ke++)
      Gi(x, A, z, G[ke]);
    if (G.length = 0, x = x.responseState, G = z.id, z = z.rootSegmentID, a(A, x.startInlineScript), x.sentCompleteBoundaryFunction ? a(A, Dt) : (x.sentCompleteBoundaryFunction = !0, a(A, Et)), G === null)
      throw Error(t(395));
    return z = u(z.toString(16)), a(A, G), a(A, Ze), a(A, x.segmentPrefix), a(A, z), l(A, Kt);
  }
  function Gi(x, A, z, G) {
    if (G.status === 2)
      return !0;
    ...
    return Yi(x, A, G), x = x.responseState, a(A, x.startInlineScript), x.sentCompleteSegmentFunction ? a(A, Ve) : (x.sentCompleteSegmentFunction = !0, a(A, Xe)), a(A, x.segmentPrefix), ke = u(ke.toString(16)), a(A, ke), a(A, it), a(A, x.placeholderPrefix), a(A, ke), l(A, nt);
  }
  function Ya(x, A) {
    ...
    try {
      ...
      for (xe = 0; xe < ke.length; xe++) {
        var Me = ke[xe];
        G = A;
        var Ye = x.responseState, St = Me.id, _t = Me.errorDigest, Pt = Me.errorMessage, rn = Me.errorComponentStack;
        if (a(G, Ye.startInlineScript), Ye.sentClientRenderFunction ? a(G, Ft) : (Ye.sentClientRenderFunction = !0, a(
          G,
          zt
        )), St === null)
          throw Error(t(395));
        a(G, St), a(G, mt), (_t || Pt || rn) && (a(G, Tt), a(G, u(Wt(_t || "")))), (Pt || rn) && (a(G, Tt), a(G, u(Wt(Pt || "")))), rn && (a(G, Tt), a(G, u(Wt(rn)))), l(G, Ot);
      }
      ke.splice(0, xe);
  ...
  return wu.renderToReadableStream = function(x, A) {
    return new Promise(function(z, G) {
      ...
      if (A && A.signal) {
        var St = A.signal, _t = function() {
          qi(Ye, St.reason), St.removeEventListener("abort", _t);
        };
...
function HS() {
  return Ph || (Ph = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function i(o) {
      {
        for (var c = arguments.length, b = new Array(c > 1 ? c - 1 : 0), T = 1; T < c; T++)
          b[T - 1] = arguments[T];
        l("warn", o, b);
      }
    }
    ...
    var O = Object.prototype.hasOwnProperty, L = 0, U = 1, W = 2, Z = 3, ce = 4, te = 5, V = 6, K = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", X = K + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", B = new RegExp("^[" + K + "][" + X + "]*$"), oe = {}, re = {};
    function le(o) {
      return O.call(re, o) ? !0 : O.call(oe, o) ? !1 : B.test(o) ? (re[o] = !0, !0) : (oe[o] = !0, a("Invalid attribute name: `%s`", o), !1);
    }
    function q(o, c, b, T) {
      if (b !== null && b.type === L)
        return !1;
    ...
    function J(o, c, b, T, M, Q, fe) {
      this.acceptsBooleans = c === W || c === Z || c === ce, this.attributeName = T, this.attributeNamespace = M, this.mustUseProperty = b, this.propertyName = o, this.type = c, this.sanitizeURL = Q, this.removeEmptyString = fe;
    }
    var ue = {}, De = [
      "children",
    ...
    var Oe = {
      ...
      "aria-rowspan": 0,
      "aria-setsize": 0
    }, Te = {}, Ue = new RegExp("^(aria)-[" + X + "]*$"), qe = new RegExp("^(aria)[A-Z][" + X + "]*$");
    function et(o, c) {
      {
        if (O.call(Te, c) && Te[c])
          return !0;
        if (qe.test(c)) {
          var b = "aria-" + c.slice(4).toLowerCase(), T = Oe.hasOwnProperty(b) ? b : null;
          if (T == null)
            return a("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.", c), Te[c] = !0, !0;
          if (c !== T)
            return a("Invalid ARIA attribute `%s`. Did you mean `%s`?", c, T), Te[c] = !0, !0;
        }
        if (Ue.test(c)) {
          var M = c.toLowerCase(), Q = Oe.hasOwnProperty(M) ? M : null;
          if (Q == null)
            return Te[c] = !0, !1;
          if (c !== Q)
            return a("Unknown ARIA attribute `%s`. Did you mean `%s`?", c, Q), Te[c] = !0, !0;
        }
      }
      return !0;
    }
    ...
    {
      var ht = {}, Ge = /^on./, pt = /^on[^A-Z]/, gt = new RegExp("^(aria)-[" + X + "]*$"), ut = new RegExp("^(aria)[A-Z][" + X + "]*$");
      $e = function(o, c, b, T) {
        if (O.call(ht, c) && ht[c])
          return !0;
        var M = c.toLowerCase();
        ...
        if (T != null) {
          var Q = T.registrationNameDependencies, fe = T.possibleRegistrationNames;
          if (Q.hasOwnProperty(c))
            return !0;
          var we = fe.hasOwnProperty(M) ? fe[M] : null;
          if (we != null)
            return a("Invalid event handler property `%s`. Did you mean `%s`?", c, we), ht[c] = !0, !0;
          if (Ge.test(c))
        ...
        return typeof b == "boolean" && q(c, b, He, !1) ? (b ? a('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.', b, c, c, b, c) : a('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.', b, c, c, b, c, c, c), ht[c] = !0, !0) : tt ? !0 : q(c, b, He, !1) ? (ht[c] = !0, !1) : ((b === "false" || b === "true") && He !== null && He.type === Z && (a("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", b, c, b === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', c, b), ht[c] = !0), !0);
      };
    }
    ...
    {
      var vt = /^(?:webkit|moz|o)[A-Z]/, Nt = /^-ms-/, hn = /-(.)/g, on = /;\s*$/, qt = {}, yn = {}, ze = !1, xt = !1, Ht = function(o) {
    ...
    function Jt(o) {
      ...
      for (Q = b.index; Q < c.length; Q++) {
        ...
        fe !== Q && (M += c.substring(fe, Q)), fe = Q + 1, M += T;
      }
    ...
    var Ne = "<script>", ct = "<\/script>", dt = '<script src="', $ = '<script type="module" src="', _e = '" async=""><\/script>';
    function Xe(o) {
      return P(o), ("" + o).replace(Ve, it);
    }
    var Ve = /(<\/|<)(s)(cript)/gi, it = function(o, c, b, T) {
      return "" + c + (b === "s" ? "\\u0073" : "\\u0053") + T;
    };
    function nt(o, c, b, T, M) {
      var Q = o === void 0 ? "" : o, fe = c === void 0 ? Ne : '<script nonce="' + jt(c) + '">', we = [];
      if (b !== void 0 && we.push(fe, Xe(b), ct), T !== void 0)
        for (var He = 0; He < T.length; He++)
          we.push(dt, jt(T[He]), _e);
      if (M !== void 0)
    ...
    var Et = 0, Dt = 1, Ze = 2, Kt = 3, zt = 4, Ft = 5, mt = 6, Ot = 7;
    function Tt(o, c) {
      return {
        insertionMode: o,
        selectedValue: c
    ...
    function Yt(o, c, b) {
      ...
      return o.insertionMode >= zt || o.insertionMode === Et ? Tt(Dt, null) : o;
    }
    var Wt = null;
    function dn(o) {
    ...
    var Zt = "<!-- -->";
    function En(o, c, b, T) {
      return c === "" ? T : (T && o.push(Zt), o.push(nn(c)), !0);
    }
    function un(o, c, b, T) {
      b && T && o.push(Zt);
    }
      ...
      for (var M in b)
        if (O.call(b, M)) {
          ...
          if (!(Q == null || typeof Q == "boolean" || Q === "")) {
            var fe = void 0, we = void 0, He = M.indexOf("--") === 0;
            He ? (fe = jt(M), N(Q, M), we = jt(("" + Q).trim())) : (cn(M, Q), fe = In(M), typeof Q == "number" ? Q !== 0 && !O.call(ae, M) ? we = Q + "px" : we = "" + Q : (N(Q, M), we = jt(("" + Q).trim()))), T ? (T = !1, o.push(Yn, fe, Zn, we)) : o.push(Xn, fe, Zn, we);
          }
        }
      T || o.push(Y);
    }
        ...
        if (M !== null) {
          ...
          switch (M.type) {
            case Z:
              ...
              return;
            case ce:
              T === !0 ? o.push(C, fe, Se) : T === !1 || o.push(C, fe, I, jt(T), Y);
              return;
            case te:
              isNaN(T) || o.push(C, fe, I, jt(T), Y);
              break;
            case V:
              !isNaN(T) && T >= 1 && o.push(C, fe, I, jt(T), Y);
              break;
            default:
              M.sanitizeURL && (_(T, Q), T = "" + T, Wn(T)), o.push(C, fe, I, jt(T), Y);
          }
        } else if (le(b)) {
          switch (typeof T) {
            case "function":
    ...
    function wn(o, c) {
      {
        ...
        if (b != null) {
          var T = Sn(b);
          o.multiple && !T ? a("The `%s` prop supplied to <select> must be an array if `multiple` is true.", c) : !o.multiple && T && a("The `%s` prop supplied to <select> must be a scalar value if `multiple` is false.", c);
        }
      }
    }
    function fr(o, c, b) {
      Pe("select", c), wn(c, "value"), wn(c, "defaultValue"), c.value !== void 0 && c.defaultValue !== void 0 && !se && (a("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://reactjs.org/link/controlled-components"), se = !0), o.push(Vn("select"));
      var T = null, M = null;
      for (var Q in c)
        if (O.call(c, Q)) {
          var fe = c[Q];
    ...
    function pr(o, c, b, T) {
      ...
      o.push(Vn("option"));
      var Q = null, fe = null, we = null, He = null;
      for (var tt in c)
        if (O.call(c, tt)) {
          var lt = c[tt];
          if (lt == null)
          ...
          switch (tt) {
            case "children":
              ...
              break;
            case "selected":
              we = lt, gn || (a("Use the `defaultValue` or `value` props on <select> instead of setting `selected` on <option>."), gn = !0);
              break;
            case "dangerouslySetInnerHTML":
              He = lt;
              break;
      ...
      if (M != null) {
        var wt;
        if (fe !== null ? (_(fe, "value"), wt = "" + fe) : (He !== null && (bt || (bt = !0, a("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), wt = $n(Q)), Sn(M))
    ...
    function Gr(o, c, b) {
      ...
      var T = null, M = null, Q = null, fe = null;
      for (var we in c)
        if (O.call(c, we)) {
          var He = c[we];
          if (He == null)
      ...
      return Q !== null ? ge(o, b, "checked", Q) : fe !== null && ge(o, b, "checked", fe), T !== null ? ge(o, b, "value", T) : M !== null && ge(o, b, "value", M), o.push(je), null;
    }
    function Zo(o, c, b) {
      ...
      if (T === null && M !== null && (T = M), o.push(Ae), Q != null) {
        ...
        if (O.call(c, fe)) {
          ...
          switch (fe) {
            ...
            case "suppressHydrationWarning":
              break;
            default:
              le(fe) && typeof we != "function" && typeof we != "symbol" && o.push(C, fe, I, jt(we), Y);
              break;
          }
        }
...
` && o.push(qr), M;
    ...
    function yr(o, c, b, T, M) {
      switch (st(c, b), We(c, b), tn(c, b, null), !b.suppressContentEditableWarning && b.contentEditable && b.children != null && a("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional."), M.insertionMode !== Ze && M.insertionMode !== Kt && c.indexOf("-") === -1 && typeof b.is != "string" && c.toLowerCase() !== c && a("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", c), c) {
        ...
        case "missing-glyph":
          return Ha(o, b, c, T);
        case "html":
          return M.insertionMode === Et && o.push(wr), Ha(o, b, c, T);
        default:
          return c.indexOf("-") === -1 && typeof b.is != "string" ? Ha(o, b, c, T) : hr(o, b, c, T);
      }
    }
    var da = "</", gr = ">";
    function Qn(o, c, b) {
    ...
    function Wa(o, c) {
      for (var b = c.bootstrapChunks, T = 0; T < b.length - 1; T++)
        u(o, b[T]);
    ...
    function ma(o, c, b, T, M) {
      var Q;
      return Q = h(o, fa), u(o, ha), b && (u(o, nl), u(o, jt(b)), u(o, Zr)), T && (u(o, Qr), u(o, jt(T)), u(o, Zr)), M && (u(o, ja), u(o, jt(M)), u(o, Zr)), Q = h(o, Ua), Q;
    }
    function Hi(o, c) {
      return h(o, pa);
    }
    ...
    function xe(o, c, b, T) {
      switch (b.insertionMode) {
        case Et:
        case Dt:
          return u(o, ya), u(o, c.segmentPrefix), u(o, T.toString(16)), h(o, jn);
        case Ze:
          return u(o, ga), u(o, c.segmentPrefix), u(o, T.toString(16)), h(o, rl);
        case Kt:
          return u(o, va), u(o, c.segmentPrefix), u(o, T.toString(16)), h(o, Ui);
        case zt:
          return u(o, xa), u(o, c.segmentPrefix), u(o, T.toString(16)), h(o, ba);
        case Ft:
          return u(o, Xi), u(o, c.segmentPrefix), u(o, T.toString(16)), h(o, Gi);
        case mt:
          return u(o, qi), u(o, c.segmentPrefix), u(o, T.toString(16)), h(o, x);
        case Ot:
          return u(o, z), u(o, c.segmentPrefix), u(o, T.toString(16)), h(o, G);
        default:
    ...
    function er(o, c, b) {
      ...
      var T = b.toString(16);
      return u(o, T), u(o, Un), u(o, c.placeholderPrefix), u(o, T), h(o, Jn);
    }
    ...
    var Nc = _t + ';$RX("', Dc = '$RX("', Oc = '"', _c = ")<\/script>", al = ",";
    function Fc(o, c, b, T, M, Q) {
      if (u(o, c.startInlineScript), c.sentClientRenderFunction ? u(o, Dc) : (c.sentClientRenderFunction = !0, u(o, Nc)), b === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return u(o, b), u(o, Oc), (T || M || Q) && (u(o, al), u(o, il(T || ""))), (M || Q) && (u(o, al), u(o, il(M || ""))), Q && (u(o, al), u(o, il(Q))), h(o, _c);
    }
    var Mc = /[<\u2028\u2029]/g;
    function il(o) {
    ...
    function Ts(o, c, b, T) {
      return b.generateStaticMarkup ? (o.push(jt(c)), !1) : En(o, c, b, T);
    }
    function ws(o, c, b, T) {
    ...
    function ll(o, c) {
      return c.generateStaticMarkup ? !0 : _r(o);
    }
    function or(o, c, b, T, M) {
      return c.generateStaticMarkup ? !0 : ma(o, c, b, T, M);
    }
    function Ic(o, c) {
    ...
    function gl() {
      {
        if (ka === 0) {
          fl = console.log, pl = console.info, hl = console.warn, ml = console.error, yl = console.group, Ns = console.groupCollapsed, Ds = console.groupEnd;
          var o = {
            configurable: !0,
            enumerable: !0,
            value: no,
...
`), He = T.stack.split(`
`), tt = we.length - 1, lt = He.length - 1; tt >= 1 && lt >= 0 && we[tt] !== He[lt]; )
            lt--;
          for (; tt >= 1 && lt >= 0; tt--, lt--)
            if (we[tt] !== He[lt]) {
              if (tt !== 1 || lt !== 1)
                do
                  if (tt--, lt--, lt < 0 || we[tt] !== He[lt]) {
                    var wt = `
` + we[tt].replace(" at new ", " at ");
      ...
      if (typeof o == "object")
        switch (o.$$typeof) {
          case Za:
            return bl(o.render);
          case cl:
            return wa(o.type, c, b);
          case to: {
            var T = o, M = T._payload, Q = T._init;
            try {
              return wa(Q(M), c, b);
            } catch {
            }
    ...
    function Jr(o) {
      if (o) {
        var c = o._owner, b = wa(o.type, o._source, c ? c.type : null);
        ao.setExtraStackFrame(b);
      } else
        ao.setExtraStackFrame(null);
    }
    function El(o, c, b, T, M) {
      {
        var Q = Function.call.bind(O);
        for (var fe in o)
          if (Q(o, fe)) {
            var we = void 0;
            try {
              ...
              we = o[fe](c, fe, T, b, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (tt) {
              we = tt;
            }
            we && !(we instanceof Error) && (Jr(M), a("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", T || "React class", b, fe, typeof we), Jr(null)), we instanceof Error && !(we.message in Sl) && (Sl[we.message] = !0, Jr(M), a("Failed %s type: %s", b, we.message), Jr(null));
          }
      }
    }
    var kl;
    ...
    function lo(o) {
      var c = vr, b = o;
      c !== b && (c === null ? ai(b) : b === null ? wl(c) : c.depth === b.depth ? ri(c, b) : c.depth > b.depth ? Ms(c, b) : zs(c, b), vr = b);
    }
    function ii(o, c) {
      var b;
    ...
    function $s(o, c) {
      {
        var b = o.constructor, T = b && mn(b) || "ReactClass", M = T + "." + c;
        if (uo[M])
          return;
...
Please check the code for the %s component.`, c, c, T), uo[M] = !0;
      }
    }
    var Bs = {
      ...
      enqueueSetState: function(o, c, b) {
        var T = so(o);
        T.queue === null ? $s(o, "setState") : (T.queue.push(c), b != null && La(b, "setState"));
      },
      enqueueReplaceState: function(o, c, b) {
        var T = so(o);
        T.replace = !0, T.queue = [c], b != null && La(b, "setState");
      },
    ...
    function Vc(o, c, b, T, M) {
      var Q = b(M, T);
      po(c, Q);
      var fe = Q == null ? T : tr({}, T, Q);
      return fe;
    }
    function jc(o, c, b) {
      ...
      var we = new o(c, T);
      {
        if (typeof o.getDerivedStateFromProps == "function" && (we.state === null || we.state === void 0)) {
          ...
          oi.has(He) || (oi.add(He), a("`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.", He, we.state === null ? "null" : "undefined", He));
        }
        if (typeof o.getDerivedStateFromProps == "function" || typeof we.getSnapshotBeforeUpdate == "function") {
          var tt = null, lt = null, wt = null;
          if (typeof we.componentWillMount == "function" && we.componentWillMount.__suppressDeprecationWarning !== !0 ? tt = "componentWillMount" : typeof we.UNSAFE_componentWillMount == "function" && (tt = "UNSAFE_componentWillMount"), typeof we.componentWillReceiveProps == "function" && we.componentWillReceiveProps.__suppressDeprecationWarning !== !0 ? lt = "componentWillReceiveProps" : typeof we.UNSAFE_componentWillReceiveProps == "function" && (lt = "UNSAFE_componentWillReceiveProps"), typeof we.componentWillUpdate == "function" && we.componentWillUpdate.__suppressDeprecationWarning !== !0 ? wt = "componentWillUpdate" : typeof we.UNSAFE_componentWillUpdate == "function" && (wt = "UNSAFE_componentWillUpdate"), tt !== null || lt !== null || wt !== null) {
...
Please update the following components: %s`,
    ...
    function Kc(o, c, b, T) {
      if (o.queue !== null && o.queue.length > 0) {
        ...
        if (o.queue = null, o.replace = !1, Q && M.length === 1)
          ...
          for (var fe = Q ? M[0] : c.state, we = !0, He = Q ? 1 : 0; He < M.length; He++) {
            var tt = M[He], lt = typeof tt == "function" ? tt.call(c, fe, b, T) : tt;
            lt != null && (we ? (we = !1, fe = tr({}, fe, lt)) : tr(fe, lt));
          }
          c.state = fe;
        }
      } else
    ...
    function go(o, c, b, T) {
      ...
      if (typeof fe == "object" && fe !== null ? o.context = Ca(fe) : o.context = T, o.state === b) {
        var we = mn(c) || "Component";
        ho.has(we) || (ho.add(we), a("%s: It is not recommended to assign props directly to state because updates to props won't be reflected in state. In most cases, it is better to use props directly.", we));
      }
      var He = c.getDerivedStateFromProps;
      typeof He == "function" && (o.state = Vc(o, c, He, M, b)), typeof c.getDerivedStateFromProps != "function" && typeof o.getSnapshotBeforeUpdate != "function" && (typeof o.UNSAFE_componentWillMount == "function" || typeof o.componentWillMount == "function") && (Uc(c, o), Kc(Q, o, b, T));
    }
    var vo = {
      id: 1,
      overflow: ""
    ...
    function Yc(o) {
      var c = o.overflow, b = o.id, T = b & ~Xc(b);
      return T.toString(32) + c;
    }
    function Ll(o, c, b) {
      var T = o.id, M = o.overflow, Q = xo(T) - 1, fe = T & ~(1 << Q), we = b + 1, He = xo(c) + Q;
      if (He > 30) {
        var tt = Q - Q % 5, lt = (1 << tt) - 1, wt = (fe & lt).toString(32), fn = fe >> tt, Fn = Q - tt, cr = xo(c) + Fn, uu = we << Fn, cu = uu | fn, du = wt + M;
        return {
          id: 1 << cr | cu,
          overflow: du
        };
      } else {
        var Fo = we << Q, Ay = Fo | fe, Ly = M;
        return {
          id: 1 << He | Ay,
          overflow: Ly
        };
    ...
    var Gc = Math.clz32 ? Math.clz32 : Cr, qc = Math.log, Zc = Math.LN2;
    function Cr(o) {
      var c = o >>> 0;
      return c === 0 ? 32 : 31 - (qc(c) / Zc | 0) | 0;
    }
    function Pl(o, c) {
...
Incoming: %s`, oa, "[" + o.join(", ") + "]", "[" + c.join(", ") + "]");
    ...
    function Jc(o, c, b, T) {
      for (; aa; )
        aa = !1, So = 0, Ar += 1, Qt = null, b = o(c, T);
      return si(), b;
    }
    function Vs() {
      var o = So !== 0;
    ...
    function Us(o, c, b) {
      if (o !== ko && (oa = "useReducer"), $t = Lr(), Qt = Eo(), lr) {
        ...
        if (_n !== null) {
          ...
          if (Q !== void 0) {
            _n.delete(T);
            var fe = Qt.memoizedState, we = Q;
            do {
              var He = we.action;
              xr = !0, fe = o(fe, He), xr = !1, we = we.next;
            } while (we !== null);
        ...
        var lt = Qt.queue = {
          last: null,
          dispatch: null
        }, wt = lt.dispatch = ad.bind(null, $t, lt);
...
` + T.stack;
    ...
    var zr = n.ReactCurrentDispatcher, Co = n.ReactDebugCurrentFrame, Ao = 0, la = 1, Gs = 2, Ol = 3, sa = 4, ud = 0, qs = 1, br = 2, cd = 12800;
    function dd(o) {
      return console.error(o), null;
    }
    function di() {
    }
    function _l(o, c, b, T, M, Q, fe, we, He) {
      var tt = [], lt = /* @__PURE__ */ new Set(), wt = {
        destination: null,
        responseState: c,
        progressiveChunkSize: T === void 0 ? cd : T,
        status: ud,
        fatalError: null,
        nextSegmentId: 0,
        allPendingTasks: 0,
      ...
      fn.parentFlushed = !0;
      var Fn = fi(wt, o, null, fn, lt, Mr, Tl, vo);
    ...
    var Sr = null;
    function Fl() {
      return Sr === null || Sr.componentStack === null ? "" : Dl(Sr.componentStack);
    }
    function sr(o, c) {
      o.componentStack = {
        tag: 0,
    ...
    function Po(o, c) {
      ...
      T(c), o.destination !== null ? (o.status = br, k(o.destination, c)) : (o.status = qs, o.fatalError = c);
    }
    function Zs(o, c, b) {
      sr(c, "Suspense");
      var T = c.blockedBoundary, M = c.blockedSegment, Q = b.fallback, fe = b.children, we = /* @__PURE__ */ new Set(), He = Pr(o, we), tt = M.chunks.length, lt = Ir(
        o,
        tt,
        He,
        M.formatContext,
      ...
      wt.parentFlushed = !0, c.blockedBoundary = He, c.blockedSegment = wt;
      try {
        if (Ro(o, c, fe), ws(wt.chunks, o.responseState, wt.lastPushedText, wt.textEmbedded), wt.status = la, yi(He, wt), He.pendingTasks === 0) {
          ur(c);
          return;
        }
      } catch (Fn) {
        ...
        c.blockedBoundary = T, c.blockedSegment = M;
      }
      var fn = fi(o, Q, T, lt, we, c.legacyContext, c.context, c.treeContext);
      fn.componentStack = c.componentStack, o.pingedTasks.push(fn), ur(c);
    }
    function Qs(o, c, b, T) {
      sr(c, b);
      var M = c.blockedSegment, Q = yr(M.chunks, b, T, o.responseState, M.formatContext);
      M.lastPushedText = !1;
      var fe = M.formatContext;
      M.formatContext = Yt(fe, b, T), Ro(o, c, Q), M.formatContext = fe, Qn(M.chunks, b), M.lastPushedText = !1, ur(c);
    }
    function fd(o) {
      return o.prototype && o.prototype.isReactComponent;
    }
    function Il(o, c, b, T, M) {
      var Q = {};
      Rl(c, Q);
      var fe = b(T, M);
      return Jc(b, T, fe, M);
    }
    function hi(o, c, b, T, M) {
      var Q = b.render();
      b.props !== M && (Wl || a("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", mn(T) || "a component"), Wl = !0);
      {
        ...
        if (fe != null) {
          var we = c.legacyContext, He = ea(b, T, we, fe);
          c.legacyContext = He, rr(o, c, Q), c.legacyContext = we;
          return;
        }
      }
      rr(o, c, Q);
    ...
    function Js(o, c, b, T) {
      Ml(c, b);
      var M = Fs(b, c.legacyContext), Q = jc(b, T, M);
      go(Q, b, T, M), hi(o, c, Q, b, T), ur(c);
    }
    ...
    function pd(o, c, b, T) {
      ...
      if (
        ...
        go(fe, b, T, M), hi(o, c, fe, b, T);
      } else if (hd(b), we) {
        var lt = c.treeContext, wt = 1, fn = 0;
        c.treeContext = Ll(lt, wt, fn);
        try {
          rr(o, c, fe);
        } finally {
          c.treeContext = lt;
    ...
    function md(o, c, b, T, M) {
      Pa(c, b.render);
      var Q = Il(o, c, b.render, T, M), fe = Vs();
      if (fe) {
        var we = c.treeContext, He = 1, tt = 0;
        c.treeContext = Ll(we, He, tt);
        try {
          rr(o, c, Q);
        } finally {
          c.treeContext = we;
    ...
    function yd(o, c, b, T, M) {
      var Q = b.type, fe = nu(Q, T);
      Ul(o, c, Q, fe, M);
    }
    function jl(o, c, b, T) {
    ...
    function gd(o, c, b, T) {
      var M = b._context, Q = T.value, fe = T.children, we;
      we = c.context, c.context = ii(M, Q), rr(o, c, fe), c.context = Cl(M), we !== c.context && a("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    function nr(o, c, b, T, M) {
      sr(c, "Lazy");
      var Q = b._payload, fe = b._init, we = fe(Q), He = nu(we, T);
      Ul(o, c, we, He, M), ur(c);
    }
    function Ul(o, c, b, T, M) {
      ...
      switch (b) {
        ...
        case ul: {
          sr(c, "SuspenseList"), rr(o, c, T.children), ur(c);
          return;
        }
        case $c:
    ...
    function Kl(o, c, b) {
      if (c.node = b, typeof b == "object" && b !== null) {
        switch (b.$$typeof) {
          case As: {
            var T = b, M = T.type, Q = T.props, fe = T.ref;
            Ul(o, c, M, Q, fe);
            return;
          }
          case sl:
          ...
          case to: {
            var we = b, He = we._payload, tt = we._init, lt;
            try {
              lt = tt(He);
            } catch (Fo) {
      ...
      if (typeof b == "string") {
        ...
        cu.lastPushedText = Ts(c.blockedSegment.chunks, b, o.responseState, cu.lastPushedText);
        return;
      }
      if (typeof b == "number") {
    ...
    function vd(o, c, b) {
      var T = c.blockedSegment, M = T.chunks.length, Q = Ir(
        o,
        M,
        null,
        T.formatContext,
    ...
    function Ro(o, c, b) {
      var T = c.blockedSegment.formatContext, M = c.legacyContext, Q = c.context, fe = null;
      fe = c.componentStack;
      try {
        return rr(o, c, b);
      } catch (we) {
        if (si(), typeof we == "object" && we !== null && typeof we.then == "function") {
          vd(o, c, we), c.blockedSegment.formatContext = T, c.legacyContext = M, c.context = Q, lo(Q), c.componentStack = fe;
          return;
        } else
          throw c.blockedSegment.formatContext = T, c.legacyContext = M, c.context = Q, lo(Q), c.componentStack = fe, we;
      }
    }
    function No(o, c, b, T) {
      var M = pi(o, T);
      if (c === null ? Po(o, T) : (c.pendingTasks--, c.forceClientRender || (c.forceClientRender = !0, c.errorDigest = M, zl(c, T), c.parentFlushed && o.clientRenderedBoundaries.push(c))), o.allPendingTasks--, o.allPendingTasks === 0) {
        var Q = o.onAllReady;
        Q();
      }
    }
    function iu(o) {
      var c = this, b = o.blockedBoundary, T = o.blockedSegment;
      T.status = Ol, gi(c, b, T);
    }
    function ou(o, c, b) {
      ...
      if (M.status = Ol, T === null)
        ...
        if (T.pendingTasks--, !T.forceClientRender) {
          ...
          T.parentFlushed && c.clientRenderedBoundaries.push(T);
        }
        if (T.fallbackAbortableTasks.forEach(function(tt) {
          return ou(tt, c, b);
        }), T.fallbackAbortableTasks.clear(), c.allPendingTasks--, c.allPendingTasks === 0) {
          var He = c.onAllReady;
          He();
        }
      }
    ...
    function Do(o, c) {
      ...
      if (b.status === Ao) {
        ...
        T = Sr, Sr = c;
        try {
          rr(o, c, c.node), ws(b.chunks, o.responseState, b.lastPushedText, b.textEmbedded), c.abortSet.delete(c), b.status = la, gi(o, c.blockedBoundary, b);
        } catch (Q) {
    ...
    function lu(o) {
      if (o.status !== br) {
        ...
        try {
          ...
          Q.splice(0, fe), o.destination !== null && _o(o, o.destination);
        } catch (He) {
          pi(o, He), Po(o, He);
        } finally {
          wo(M), zr.current = b, Co.getCurrentStack = T, b === Xs && lo(c);
        }
      }
    }
    function vi(o, c, b) {
      switch (b.parentFlushed = !0, b.status) {
        case Ao: {
          ...
          return b.lastPushedText = !1, b.textEmbedded = !1, $i(c, o.responseState, T);
        }
        case la: {
          b.status = Gs;
          for (var M = !0, Q = b.chunks, fe = 0, we = b.children, He = 0; He < we.length; He++) {
            for (var tt = we[He]; fe < tt.index; fe++)
              u(c, Q[fe]);
            M = xi(o, c, tt);
          }
    ...
    function xi(o, c, b) {
      ...
      if (T.parentFlushed = !0, T.forceClientRender)
        return or(c, o.responseState, T.errorDigest, T.errorMessage, T.errorComponentStack), vi(o, c, b), Cs(c, o.responseState);
      if (T.pendingTasks > 0) {
        ...
        if (T.byteSize > o.progressiveChunkSize)
          return T.rootSegmentID = o.nextSegmentId++, o.completedBoundaries.push(T), Fr(c, o.responseState, T.id), vi(o, c, b), Ka(c, o.responseState);
        ll(c, o.responseState);
        var Q = T.completedSegments;
        if (Q.length !== 1)
    ...
    function Oo(o, c, b) {
      ...
      return T.length = 0, Rc(c, o.responseState, b.id, b.rootSegmentID);
    }
    function bd(o, c, b) {
      for (var T = b.completedSegments, M = 0; M < T.length; M++) {
        var Q = T[M];
    ...
    function su(o, c, b, T) {
      ...
      var M = T.id;
      if (M === -1) {
        var Q = T.id = b.rootSegmentID;
        if (Q === -1)
          throw new Error("A root segment ID must have been assigned by now. This is a bug in React.");
        return Yl(o, c, T);
      } else
        return Yl(o, c, T), er(c, o.responseState, M);
    }
    function _o(o, c) {
      try {
    ...
    function D(o, c, b, T) {
      ...
      var lt = _l(o, zc(b, c ? c.identifierPrefix : void 0), ol(), 1 / 0, E, void 0, tt, void 0, void 0);
      if (Sd(lt), p(lt, T), s(lt, we), M)
        throw Q;
      if (!He)
  ...
  return Rh || (Rh = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function v(s, p) {
      if (p.length !== 0) {
        ...
        var E = p, D = u.length - h;
        D < E.length && (D === 0 ? s.enqueue(u) : (u.set(E.subarray(0, D), h), s.enqueue(u), E = E.subarray(D)), u = new Uint8Array(d), h = 0), u.set(E, h), h += E.length;
      }
    }
    function S(s, p) {
      return v(s, p), !0;
    ...
    function L(s, p) {
      if (P(s))
        return a("The provided `%s` attribute is an unsupported type %s. This value must be coerced to a string before before using it here.", p, N(s)), O(s);
    }
    function U(s, p) {
      if (P(s))
        return a("The provided `%s` CSS property is an unsupported type %s. This value must be coerced to a string before before using it here.", p, N(s)), O(s);
    }
    function W(s) {
      if (P(s))
        return a("The provided HTML markup uses a value of unsupported type %s. This value must be coerced to a string before before using it here.", N(s)), O(s);
    }
    var Z = Object.prototype.hasOwnProperty, ce = 0, te = 1, V = 2, K = 3, X = 4, B = 5, oe = 6, re = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", le = re + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", q = new RegExp("^[" + re + "][" + le + "]*$"), j = {}, J = {};
    function ue(s) {
      return Z.call(J, s) ? !0 : Z.call(j, s) ? !1 : q.test(s) ? (J[s] = !0, !0) : (j[s] = !0, a("Invalid attribute name: `%s`", s), !1);
    }
    function De(s, p, E, D) {
      if (E !== null && E.type === ce)
        return !1;
    ...
    function ye(s, p, E, D, H, ne, pe) {
      this.acceptsBooleans = p === V || p === K || p === X, this.attributeName = D, this.attributeNamespace = H, this.mustUseProperty = E, this.propertyName = s, this.type = p, this.sanitizeURL = ne, this.removeEmptyString = pe;
    }
    var Le = {}, ae = [
      "children",
      "dangerouslySetInnerHTML",
    ...
    function Ue(s, p) {
      Te[p.type] || p.onChange || p.onInput || p.readOnly || p.disabled || p.value == null || a("You provided a `value` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultValue`. Otherwise, set either `onChange` or `readOnly`."), p.onChange || p.readOnly || p.disabled || p.checked == null || a("You provided a `checked` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultChecked`. Otherwise, set either `onChange` or `readOnly`.");
    }
    function qe(s, p) {
      if (s.indexOf("-") === -1)
    ...
    function We(s, p) {
      {
        if (Z.call(Je, p) && Je[p])
          return !0;
        if (Ke.test(p)) {
          var E = "aria-" + p.slice(4).toLowerCase(), D = et.hasOwnProperty(E) ? E : null;
          if (D == null)
            return a("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.", p), Je[p] = !0, !0;
          if (p !== D)
            return a("Invalid ARIA attribute `%s`. Did you mean `%s`?", p, D), Je[p] = !0, !0;
        }
        if (st.test(p)) {
    ...
    };
    {
      ...
      gt = function(s, p, E, D) {
        ...
        if (D != null) {
          var ne = D.registrationNameDependencies, pe = D.possibleRegistrationNames;
        ...
        return typeof E == "boolean" && De(p, E, o, !1) ? (E ? a('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.', E, p, p, E, p) : a('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.', E, p, p, E, p, p, p), ut[p] = !0, !0) : c ? !0 : De(p, E, o, !1) ? (ut[p] = !0, !1) : ((E === "false" || E === "true") && o !== null && o.type === K && (a("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", E, p, E === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', p, E), ut[p] = !0), !0);
      };
    }
    var Nt = function(s, p, E) {
      {
        ...
        var pe = D.map(function(Ce) {
          return "`" + Ce + "`";
        }).join(", ");
        D.length === 1 ? a("Invalid value for prop %s on <%s> tag. Either remove it from the element, or pass a string or number value to keep it in the DOM. For details, see https://reactjs.org/link/attribute-behavior ", pe, s) : D.length > 1 && a("Invalid values for props %s on <%s> tag. Either remove them from the element, or pass a string or number value to keep them in the DOM. For details, see https://reactjs.org/link/attribute-behavior ", pe, s);
      }
    };
    function hn(s, p, E) {
      qe(s, p) || Nt(s, p, E);
    ...
    {
      var qt = /^(?:webkit|moz|o)[A-Z]/, yn = /^-ms-/, ze = /-(.)/g, xt = /;\s*$/, Ht = {}, It = {}, At = !1, xn = !1, Mt = function(s) {
      ...
      on = function(s, p) {
        s.indexOf("-") > -1 ? ln(s) : qt.test(s) ? cn(s) : xt.test(p) && Tn(s, p), typeof p == "number" && (isNaN(p) ? Jt(s, p) : isFinite(p) || jt(s, p));
      };
    }
    var Pn = on, Mn = /["'&<>]/;
    function Hn(s) {
      ...
      for (ne = E.index; ne < p.length; ne++) {
        ...
        pe !== ne && (H += p.substring(pe, ne)), pe = ne + 1, H += D;
      }
    ...
    var _e = m("<script>"), Xe = m("<\/script>"), Ve = m('<script src="'), it = m('<script type="module" src="'), nt = m('" async=""><\/script>');
    function Et(s) {
      return W(s), ("" + s).replace(Dt, Ze);
    }
    var Dt = /(<\/|<)(s)(cript)/gi, Ze = function(s, p, E, D) {
      return "" + p + (E === "s" ? "\\u0073" : "\\u0053") + D;
    };
    function Kt(s, p, E, D, H) {
      var ne = s === void 0 ? "" : s, pe = p === void 0 ? _e : m('<script nonce="' + Ut(p) + '">'), Ce = [];
      if (E !== void 0 && Ce.push(pe, w(Et(E)), Xe), D !== void 0)
        for (var o = 0; o < D.length; o++)
          Ce.push(Ve, w(Ut(D[o])), nt);
      if (H !== void 0)
        for (var c = 0; c < H.length; c++)
          Ce.push(it, w(Ut(H[c])), nt);
      return {
        bootstrapChunks: Ce,
    ...
    var zt = 0, Ft = 1, mt = 2, Ot = 3, Tt = 4, Yt = 5, Wt = 6, dn = 7;
    function sn(s, p) {
      return {
        insertionMode: s,
        selectedValue: p
    ...
    function nn(s) {
      var p = s === "http://www.w3.org/2000/svg" ? mt : s === "http://www.w3.org/1998/Math/MathML" ? Ot : zt;
      return sn(p, null);
    }
    function Zt(s, p, E) {
      switch (p) {
    ...
    var Yn = m("<!-- -->");
    function Zn(s, p, E, D) {
      return p === "" ? D : (D && s.push(Yn), s.push(w(In(p))), !0);
    }
    function Xn(s, p, E, D) {
      E && D && s.push(Yn);
    }
      ...
      for (var H in E)
        if (Z.call(E, H)) {
          ...
          if (!(ne == null || typeof ne == "boolean" || ne === "")) {
            ...
            o ? (pe = w(Ut(H)), U(ne, H), Ce = w(Ut(("" + ne).trim()))) : (Pn(H, ne), pe = C(H), typeof ne == "number" ? ne !== 0 && !Z.call(Pe, H) ? Ce = w(ne + "px") : Ce = w("" + ne) : (U(ne, H), Ce = w(Ut(("" + ne).trim())))), D ? (D = !1, s.push(I, pe, Y, Ce)) : s.push(Se, pe, Y, Ce);
          }
        }
      D || s.push(rt);
    }
    ...
    function ie(s, p, E, D) {
      ...
      if (
        ...
        if (H !== null) {
          ...
          var ne = H.attributeName, pe = w(ne);
          switch (H.type) {
            case K:
              D && s.push(Ae, pe, yt);
              return;
            case X:
              D === !0 ? s.push(Ae, pe, yt) : D === !1 || s.push(Ae, pe, je, w(Ut(D)), rt);
              return;
            case B:
              isNaN(D) || s.push(Ae, pe, je, w(Ut(D)), rt);
              break;
            case oe:
              !isNaN(D) && D >= 1 && s.push(Ae, pe, je, w(Ut(D)), rt);
              break;
            default:
              H.sanitizeURL && (L(D, ne), D = "" + D, ct(D)), s.push(Ae, pe, je, w(Ut(D)), rt);
          }
        } else if (ue(E)) {
          switch (typeof D) {
            case "function":
    ...
    function Re(s, p, E) {
      if (p != null) {
        ...
        if (typeof p != "object" || !("__html" in p))
          throw new Error("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information.");
        var D = p.__html;
        D != null && (W(D), s.push(w("" + D)));
      }
    }
    var bt = !1, gn = !1, wn = !1, fr = !1, $n = !1, Tr = !1, pr = !1;
    function Gr(s, p) {
      {
        var E = s[p];
        if (E != null) {
          var D = $(E);
          s.multiple && !D ? a("The `%s` prop supplied to <select> must be an array if `multiple` is true.", p) : !s.multiple && D && a("The `%s` prop supplied to <select> must be a scalar value if `multiple` is false.", p);
        }
      }
    }
    function Zo(s, p, E) {
      Ue("select", p), Gr(p, "value"), Gr(p, "defaultValue"), p.value !== void 0 && p.defaultValue !== void 0 && !wn && (a("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://reactjs.org/link/controlled-components"), wn = !0), s.push(Qn("select"));
      var D = null, H = null;
      for (var ne in p)
        if (Z.call(p, ne)) {
          var pe = p[ne];
    ...
    function Jo(s, p, E, D) {
      ...
      if (H != null) {
        var T;
        if (pe !== null ? (L(pe, "value"), T = "" + pe) : (o !== null && (Tr || (Tr = !0, a("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), T = Qo(ne)), $(H))
    ...
    function Ha(s, p, E) {
      ...
      var D = null, H = null, ne = null, pe = null;
      for (var Ce in p)
        if (Z.call(p, Ce)) {
          var o = p[Ce];
          if (o == null)
      ...
      return ne !== null ? ie(s, E, "checked", ne) : pe !== null && ie(s, E, "checked", pe), D !== null ? ie(s, E, "value", D) : H !== null && ie(s, E, "value", H), s.push(me), null;
    }
    function hr(s, p, E) {
      ...
      if (D === null && H !== null && (D = H), s.push(se), ne != null) {
...
` && s.push(wr), D !== null && (L(D, "value"), s.push(w(In("" + D)))), null;
    }
    function qr(s, p, E, D) {
      s.push(Qn(E));
      for (var H in p)
    ...
    function mr(s, p, E, D) {
      ...
      return s.push(se), Re(s, ne, H), typeof H == "string" ? (s.push(w(In(H))), null) : H;
    }
    function Vn(s, p, E, D) {
      s.push(Qn(E));
      var H = null, ne = null;
        ...
        if (Z.call(p, pe)) {
          ...
          switch (pe) {
            ...
            case "suppressHydrationWarning":
              break;
            default:
              ue(pe) && typeof Ce != "function" && typeof Ce != "symbol" && s.push(Ae, w(pe), je, w(Ut(Ce)), rt);
              break;
          }
        }
...
` && s.push(wr), H;
    ...
    function Va(s, p, E, D, H) {
      switch ($e(p, E), Ge(p, E), hn(p, E, null), !E.suppressContentEditableWarning && E.contentEditable && E.children != null && a("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional."), H.insertionMode !== mt && H.insertionMode !== Ot && p.indexOf("-") === -1 && typeof E.is != "string" && p.toLowerCase() !== p && a("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", p), p) {
        case "select":
          return Zo(s, E, D);
        case "option":
          return Jo(s, E, D, H);
        ...
        case "missing-glyph":
          return mr(s, E, p, D);
        case "html":
          return H.insertionMode === zt && s.push(Wa), mr(s, E, p, D);
        default:
          return p.indexOf("-") === -1 && typeof E.is != "string" ? mr(s, E, p, D) : Vn(s, E, p, D);
      }
    }
    var Ii = m("</"), $i = m(">");
    function Bi(s, p, E) {
    ...
    function jn(s, p, E, D, H) {
      var ne;
      return ne = S(s, Qr), v(s, Ua), E && (v(s, Fr), v(s, w(Ut(E))), v(s, _r)), D && (v(s, ma), v(s, w(Ut(D))), v(s, _r)), H && (v(s, Hi), v(s, w(Ut(H))), v(s, _r)), ne = S(s, Ka), ne;
    }
    function Vi(s, p) {
      return S(s, ja);
    }
    ...
    var ji = m('<div hidden id="'), va = m('">'), Ui = m("</div>"), Ki = m('<svg aria-hidden="true" style="display:none" id="'), xa = m('">'), ba = m("</svg>"), Yi = m('<math aria-hidden="true" style="display:none" id="'), Xi = m('">'), Gi = m("</math>"), Ya = m('<table hidden id="'), qi = m('">'), x = m("</table>"), A = m('<table hidden><tbody id="'), z = m('">'), G = m("</tbody></table>"), ke = m('<table hidden><tr id="'), xe = m('">'), Me = m("</tr></table>"), Ye = m('<table hidden><colgroup id="'), St = m('">'), _t = m("</colgroup></table>");
    function Pt(s, p, E, D) {
      switch (E.insertionMode) {
        case zt:
        case Ft:
          return v(s, ji), v(s, p.segmentPrefix), v(s, w(D.toString(16))), S(s, va);
        case mt:
          return v(s, Ki), v(s, p.segmentPrefix), v(s, w(D.toString(16))), S(s, xa);
        case Ot:
          return v(s, Yi), v(s, p.segmentPrefix), v(s, w(D.toString(16))), S(s, Xi);
        case Tt:
          return v(s, Ya), v(s, p.segmentPrefix), v(s, w(D.toString(16))), S(s, qi);
        case Yt:
          return v(s, A), v(s, p.segmentPrefix), v(s, w(D.toString(16))), S(s, z);
        case Wt:
          return v(s, ke), v(s, p.segmentPrefix), v(s, w(D.toString(16))), S(s, xe);
        case dn:
          return v(s, Ye), v(s, p.segmentPrefix), v(s, w(D.toString(16))), S(s, St);
        default:
          throw new Error("Unknown insertion mode. This is a bug in React.");
      }
    }
    ...
    function Rc(s, p, E) {
      ...
      var D = w(E.toString(16));
      return v(s, D), v(s, Xa), v(s, p.placeholderPrefix), v(s, D), S(s, Pc);
    }
    var Nc = m(Jn + ';$RC("'), Dc = m('$RC("'), Oc = m('","'), _c = m('")<\/script>');
    function al(s, p, E, D) {
      if (v(s, p.startInlineScript), p.sentCompleteBoundaryFunction ? v(s, Dc) : (p.sentCompleteBoundaryFunction = !0, v(s, Nc)), E === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      var H = w(D.toString(16));
      return v(s, E), v(s, Oc), v(s, p.segmentPrefix), v(s, H), S(s, _c);
    }
    var Fc = m(er + ';$RX("'), Mc = m('$RX("'), il = m('"'), zc = m(")<\/script>"), ol = m(",");
    function Ts(s, p, E, D, H, ne) {
      if (v(s, p.startInlineScript), p.sentClientRenderFunction ? v(s, Mc) : (p.sentClientRenderFunction = !0, v(s, Fc)), E === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return v(s, E), v(s, il), (D || H || ne) && (v(s, ol), v(s, w(ll(D || "")))), (H || ne) && (v(s, ol), v(s, w(ll(H || "")))), ne && (v(s, ol), v(s, w(ll(ne)))), S(s, zc);
    }
    var ws = /[<\u2028\u2029]/g;
    function ll(s) {
...
` + Ce[c].replace(" at new ", " at ");
        ...
        ei = !1, no.current = ne, Ds(), Error.prepareStackTrace = H;
      }
    ...
    function xl(s, p, E) {
      ...
      if (typeof s == "object")
        switch (s.$$typeof) {
          ...
          case Ea: {
            var D = s, H = D._payload, ne = D._init;
            try {
              return xl(ne(H), p, E);
            } catch {
            }
          ...
          if (ne(s, pe)) {
            ...
            try {
              if (typeof s[pe] != "function") {
                var o = Error((D || "React class") + ": " + E + " type `" + pe + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof s[pe] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw o.name = "Invariant Violation", o;
              }
              Ce = s[pe](p, pe, D, E, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (c) {
              Ce = c;
            }
            Ce && !(Ce instanceof Error) && (wa(H), a("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", D || "React class", E, pe, typeof Ce), wa(null)), Ce instanceof Error && !(Ce.message in bl) && (bl[Ce.message] = !0, wa(H), a("Failed %s type: %s", E, Ce.message), wa(null));
          }
      }
    }
    var ao;
...
Please check the code for the %s component.`, p, p, D), Ca[H] = !0;
      }
    }
    var yo = {
      ...
      enqueueSetState: function(s, p, E) {
        var D = Cl(s);
        D.queue === null ? mo(s, "setState") : (D.queue.push(p), E != null && Aa(E, "setState"));
      },
      enqueueReplaceState: function(s, p, E) {
        var D = Cl(s);
        D.replace = !0, D.queue = [p], E != null && Aa(E, "setState");
      },
    ...
    function Is(s, p, E, D, H) {
      var ne = E(H, D);
      fo(p, ne);
      var pe = ne == null ? D : or({}, D, ne);
      return pe;
    }
    function $s(s, p, E) {
      ...
      var Ce = new s(p, D);
      {
        ...
        if (typeof s.getDerivedStateFromProps == "function" || typeof Ce.getSnapshotBeforeUpdate == "function") {
          var c = null, b = null, T = null;
          if (typeof Ce.componentWillMount == "function" && Ce.componentWillMount.__suppressDeprecationWarning !== !0 ? c = "componentWillMount" : typeof Ce.UNSAFE_componentWillMount == "function" && (c = "UNSAFE_componentWillMount"), typeof Ce.componentWillReceiveProps == "function" && Ce.componentWillReceiveProps.__suppressDeprecationWarning !== !0 ? b = "componentWillReceiveProps" : typeof Ce.UNSAFE_componentWillReceiveProps == "function" && (b = "UNSAFE_componentWillReceiveProps"), typeof Ce.componentWillUpdate == "function" && Ce.componentWillUpdate.__suppressDeprecationWarning !== !0 ? T = "componentWillUpdate" : typeof Ce.UNSAFE_componentWillUpdate == "function" && (T = "UNSAFE_componentWillUpdate"), c !== null || b !== null || T !== null) {
    ...
    function Bs(s, p, E) {
      {
        ...
        H || (p.prototype && typeof p.prototype.render == "function" ? a("%s(...): No `render` method found on the returned component instance: did you accidentally return an object from the constructor?", D) : a("%s(...): No `render` method found on the returned component instance: you may have forgotten to define `render`.", D)), s.getInitialState && !s.getInitialState.isReactClassApproved && !s.state && a("getInitialState was defined on %s, a plain JavaScript class. This is only supported for classes created using React.createClass. Did you mean to define a state property instead?", D), s.getDefaultProps && !s.getDefaultProps.isReactClassApproved && a("getDefaultProps was defined on %s, a plain JavaScript class. This is only supported for classes created using React.createClass. Use a static property to define defaultProps instead.", D), s.propTypes && a("propTypes was defined as an instance property on %s. Use a static property to define propTypes instead.", D), s.contextType && a("contextType was defined as an instance property on %s. Use a static property to define contextType instead.", D), s.contextTypes && a("contextTypes was defined as an instance property on %s. Use a static property to define contextTypes instead.", D), p.contextType && p.contextTypes && !po.has(p) && (po.add(p), a("%s declares both contextTypes and contextType static properties. The legacy contextTypes property will be ignored.", D)), typeof s.componentShouldUpdate == "function" && a("%s has a method called componentShouldUpdate(). Did you mean shouldComponentUpdate()? The name is phrased as a question because the function is expected to return a value.", D), p.prototype && p.prototype.isPureReactComponent && typeof s.shouldComponentUpdate < "u" && a("%s has a method called shouldComponentUpdate(). shouldComponentUpdate should not be used when extending React.PureComponent. Please extend React.Component if shouldComponentUpdate is used.", vn(p) || "A pure component"), typeof s.componentDidUnmount == "function" && a("%s has a method called componentDidUnmount(). But there is no such lifecycle method. Did you mean componentWillUnmount()?", D), typeof s.componentDidReceiveProps == "function" && a("%s has a method called componentDidReceiveProps(). But there is no such lifecycle method. If you meant to update the state in response to changing props, use componentWillReceiveProps(). If you meant to fetch data or run side-effects or mutations after React has updated the UI, use componentDidUpdate().", D), typeof s.componentWillRecieveProps == "function" && a("%s has a method called componentWillRecieveProps(). Did you mean componentWillReceiveProps()?", D), typeof s.UNSAFE_componentWillRecieveProps == "function" && a("%s has a method called UNSAFE_componentWillRecieveProps(). Did you mean UNSAFE_componentWillReceiveProps()?", D);
        var ne = s.props !== E;
        s.props !== void 0 && ne && a("%s(...): When calling super() in `%s`, make sure to pass up the same props that your component's constructor was passed.", D, D), s.defaultProps && a("Setting defaultProps as an instance property on %s is not supported and will be ignored. Instead, define defaultProps as a static property on %s.", D, D), typeof s.getSnapshotBeforeUpdate == "function" && typeof s.componentDidUpdate != "function" && !uo.has(p) && (uo.add(p), a("%s: getSnapshotBeforeUpdate() should be used with componentDidUpdate(). This component defines getSnapshotBeforeUpdate() only.", vn(p))), typeof s.getDerivedStateFromProps == "function" && a("%s: getDerivedStateFromProps() is defined as an instance method and will be ignored. Instead, declare it as a static method.", D), typeof s.getDerivedStateFromError == "function" && a("%s: getDerivedStateFromError() is defined as an instance method and will be ignored. Instead, declare it as a static method.", D), typeof p.getSnapshotBeforeUpdate == "function" && a("%s: getSnapshotBeforeUpdate() is defined as a static method and will be ignored. Instead, declare it as an instance method.", D);
        var pe = s.state;
        pe && (typeof pe != "object" || $(pe)) && a("%s.state: must be set to an object or null", D), typeof s.getChildContext == "function" && typeof p.childContextTypes != "object" && a("%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().", D);
      }
    }
    function Vc(s, p) {
      var E = p.state;
...
Please update the following components: %s`,
      ...
      if (s.queue !== null && s.queue.length > 0) {
        ...
        if (s.queue = null, s.replace = !1, ne && H.length === 1)
          ...
          for (var pe = ne ? H[0] : p.state, Ce = !0, o = ne ? 1 : 0; o < H.length; o++) {
            var c = H[o], b = typeof c == "function" ? c.call(p, pe, E, D) : c;
    ...
    function Hs(s, p, E, D) {
      ...
      if (typeof pe == "object" && pe !== null ? s.context = ii(pe) : s.context = D, s.state === E) {
      ...
      typeof o == "function" && (s.state = Is(s, p, o, H, E)), typeof p.getDerivedStateFromProps != "function" && typeof s.getSnapshotBeforeUpdate != "function" && (typeof s.UNSAFE_componentWillMount == "function" || typeof s.componentWillMount == "function") && (Vc(p, s), jc(ne, s, E, D));
    }
    var Uc = {
      id: 1,
      overflow: ""
    ...
    function Kc(s) {
      var p = s.overflow, E = s.id, D = E & ~Yc(E);
      return D.toString(32) + p;
    }
    function go(s, p, E) {
      var D = s.id, H = s.overflow, ne = vo(D) - 1, pe = D & ~(1 << ne), Ce = E + 1, o = vo(p) + ne;
      if (o > 30) {
        var c = ne - ne % 5, b = (1 << c) - 1, T = (pe & b).toString(32), M = pe >> c, Q = ne - c, fe = vo(p) + Q, we = Ce << Q, He = we | M, tt = T + H;
        return {
          id: 1 << fe | He,
          overflow: tt
        };
      } else {
        var lt = Ce << ne, wt = lt | pe, fn = H;
        return {
          id: 1 << o | wt,
          overflow: fn
        };
    ...
    var Ll = Math.clz32 ? Math.clz32 : Gc, xo = Math.log, Xc = Math.LN2;
    function Gc(s) {
      var p = s >>> 0;
    ...
    var Zc = typeof Object.is == "function" ? Object.is : qc, Cr = null, Pl = null, bo = null, $t = null, na = !1, ra = !1, Qt = 0, lr = null, aa = 0, So = 25, _n = !1, Ar;
    function ia() {
      if (Cr === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
Incoming: %s`, Ar, "[" + s.join(", ") + "]", "[" + p.join(", ") + "]");
      ...
      if (s !== si && (Ar = "useReducer"), Cr = ia(), $t = Lr(), na) {
        ...
        if (lr !== null) {
          ...
          if (ne !== void 0) {
            ...
            do {
              var o = Ce.action;
              _n = !0, pe = s(pe, o), _n = !1, Ce = Ce.next;
            } while (Ce !== null);
        ...
        _n = !0;
        var c;
        s === si ? c = typeof p == "function" ? p() : p : c = E !== void 0 ? E(p) : p, _n = !1, $t.memoizedState = c;
        var b = $t.queue = {
          last: null,
          dispatch: null
    ...
    function ko(s, p) {
      ...
      _n = !0;
      var ne = s();
      return _n = !1, $t.memoizedState = [ne, E], ne;
    }
    function td(s) {
      Cr = ia(), $t = Lr();
...
` + D.stack;
    ...
    var ci = n.ReactCurrentDispatcher, wo = n.ReactDebugCurrentFrame, Dl = 0, zr = 1, Co = 2, Ao = 3, la = 4, Gs = 0, Ol = 1, sa = 2, ud = 12800;
    function qs(s) {
      return console.error(s), null;
    }
    function br() {
    }
    function cd(s, p, E, D, H, ne, pe, Ce, o) {
      var c = [], b = /* @__PURE__ */ new Set(), T = {
        destination: null,
        responseState: p,
        progressiveChunkSize: D === void 0 ? ud : D,
        status: Gs,
        fatalError: null,
        nextSegmentId: 0,
        allPendingTasks: 0,
      ...
      M.parentFlushed = !0;
      var Q = _l(T, s, null, M, b, Jr, Fs, Uc);
      return c.push(Q), T;
    }
    function dd(s, p) {
      var E = s.pingedTasks;
    ...
    function _l(s, p, E, D, H, ne, pe, Ce) {
    ...
    function Ml(s, p) {
      {
        ...
        var D = Pa || fi();
        Pa = null, s.errorMessage = E, s.errorComponentStack = D;
      }
    }
    function ur(s, p) {
      var E = s.onError(p);
    ...
    function $r(s, p) {
      ...
      D(p), s.destination !== null ? (s.status = sa, _(s.destination, p)) : (s.status = Ol, s.fatalError = p);
    }
    function zl(s, p, E) {
      Ir(p, "Suspense");
      var D = p.blockedBoundary, H = p.blockedSegment, ne = E.fallback, pe = E.children, Ce = /* @__PURE__ */ new Set(), o = di(s, Ce), c = H.chunks.length, b = Lo(
        s,
        c,
        o,
        H.formatContext,
      ...
      try {
        if (Kl(s, p, pe), Xn(T.chunks, s.responseState, T.lastPushedText, T.textEmbedded), T.status = zr, No(o, T), o.pendingTasks === 0) {
          sr(p);
          return;
        }
      } catch (Q) {
        T.status = la, o.forceClientRender = !0, o.errorDigest = ur(s, Q), Ml(o, Q);
      } finally {
        p.blockedBoundary = D, p.blockedSegment = H;
      }
      var M = _l(s, ne, D, b, Ce, p.legacyContext, p.context, p.treeContext);
      M.componentStack = p.componentStack, s.pingedTasks.push(M), sr(p);
    }
    function pi(s, p, E, D) {
      Ir(p, E);
      var H = p.blockedSegment, ne = Va(H.chunks, E, D, s.responseState, H.formatContext);
      H.lastPushedText = !1;
      var pe = H.formatContext;
      H.formatContext = Zt(pe, E, D), Kl(s, p, ne), H.formatContext = pe, Bi(H.chunks, E), H.lastPushedText = !1, sr(p);
    }
    function Po(s) {
      return s.prototype && s.prototype.isReactComponent;
    }
    function Zs(s, p, E, D, H) {
      var ne = {};
      Qc(p, ne);
      var pe = E(D, H);
      return Ws(E, D, pe, H);
    }
    function Qs(s, p, E, D, H) {
      var ne = E.render();
      E.props !== H && (mi || a("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", vn(D) || "a component"), mi = !0);
      {
        var pe = D.childContextTypes;
        if (pe != null) {
          var Ce = p.legacyContext, o = kl(E, D, Ce, pe);
    ...
    function fd(s, p, E, D) {
      Fl(p, E);
      var H = El(E, p.legacyContext), ne = $s(E, D, H);
      Hs(ne, E, D, H), Qs(s, p, ne, E, D), sr(p);
    }
    ...
    function pd(s, p, E, D, H) {
      Sr(p, E.render);
      var ne = Zs(s, p, E.render, D, H), pe = Eo();
      if (pe) {
    ...
    function md(s, p, E, D) {
      var H = E._context, ne = D.value, pe = D.children, Ce;
    ...
    function yd(s, p, E, D, H) {
      Ir(p, "Lazy");
      var ne = E._payload, pe = E._init, Ce = pe(ne), o = Vl(Ce, D);
      jl(s, p, Ce, o, H), sr(p);
    }
    function jl(s, p, E, D, H) {
      if (typeof E == "function")
        if (Po(E)) {
          fd(s, p, E, D);
          return;
      ...
      switch (E) {
        ...
        case qa: {
          Ir(p, "SuspenseList"), nr(s, p, D.children), sr(p);
          return;
        }
        case ul:
          throw new Error("ReactDOMServer does not yet support scope components.");
    ...
    function nr(s, p, E) {
      try {
        ...
        throw typeof D == "object" && D !== null && typeof D.then == "function" || (Pa = Pa !== null ? Pa : fi()), D;
      }
    }
    function Ul(s, p, E) {
      if (p.node = E, typeof E == "object" && E !== null) {
        switch (E.$$typeof) {
          case Ic: {
            var D = E, H = D.type, ne = D.props, pe = D.ref;
            jl(s, p, H, ne, pe);
            return;
          }
          case Cs:
    ...
    function rr(s, p, E) {
      var D = p.blockedSegment, H = D.chunks.length, ne = Lo(
        s,
        H,
        null,
        D.formatContext,
      ...
      var pe = _l(s, p.node, p.blockedBoundary, ne, p.abortSet, p.legacyContext, p.context, p.treeContext);
      p.componentStack !== null && (pe.componentStack = p.componentStack.parent);
      var Ce = pe.ping;
      E.then(Ce, Ce);
    }
    function Kl(s, p, E) {
      var D = p.blockedSegment.formatContext, H = p.legacyContext, ne = p.context, pe = null;
      pe = p.componentStack;
      try {
        return nr(s, p, E);
      } catch (Ce) {
        if (Rl(), typeof Ce == "object" && Ce !== null && typeof Ce.then == "function") {
          rr(s, p, Ce), p.blockedSegment.formatContext = D, p.legacyContext = H, p.context = ne, ai(ne), p.componentStack = pe;
          return;
        } else
          throw p.blockedSegment.formatContext = D, p.legacyContext = H, p.context = ne, ai(ne), p.componentStack = pe, Ce;
      }
    }
    function au(s, p, E, D) {
      var H = ur(s, D);
      if (p === null ? $r(s, D) : (p.pendingTasks--, p.forceClientRender || (p.forceClientRender = !0, p.errorDigest = H, Ml(p, D), p.parentFlushed && s.clientRenderedBoundaries.push(p))), s.allPendingTasks--, s.allPendingTasks === 0) {
        var ne = s.onAllReady;
        ne();
      }
    }
    ...
    function yi(s) {
      if (s.status !== sa) {
        ...
        ci.current = Ys;
        var D;
        D = wo.getCurrentStack, wo.getCurrentStack = fi;
        var H = Nl;
        ui(s.responseState);
        try {
          ...
          ne.splice(0, pe), s.destination !== null && Oo(s, s.destination);
        } catch (o) {
          ur(s, o), $r(s, o);
        } finally {
          ui(H), ci.current = E, wo.getCurrentStack = D, E === Ys && ai(p);
        }
      }
    }
    function gi(s, p, E) {
      switch (E.parentFlushed = !0, E.status) {
        case Dl: {
          ...
          return E.lastPushedText = !1, E.textEmbedded = !1, pa(p, s.responseState, D);
        }
        case zr: {
          E.status = Co;
    ...
    function Do(s, p, E) {
      ...
      if (D.parentFlushed = !0, D.forceClientRender)
        return jn(p, s.responseState, D.errorDigest, D.errorMessage, D.errorComponentStack), gi(s, p, E), rl(p, s.responseState);
      if (D.pendingTasks > 0) {
        D.rootSegmentID = s.nextSegmentId++, D.completedSegments.length > 0 && s.partialBoundaries.push(D);
        var H = D.id = un(s.responseState);
        return ya(p, s.responseState, H), gi(s, p, E), ga(p, s.responseState);
      } else {
        if (D.byteSize > s.progressiveChunkSize)
          return D.rootSegmentID = s.nextSegmentId++, s.completedBoundaries.push(D), ya(p, s.responseState, D.id), gi(s, p, E), ga(p, s.responseState);
        Wi(p, s.responseState);
        var ne = D.completedSegments;
        if (ne.length !== 1)
          throw new Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");
        var pe = ne[0];
        return Do(s, p, pe), Vi(p, s.responseState);
      }
    }
    function lu(s, p, E) {
    ...
    function vi(s, p, E) {
      return Pt(p, s.responseState, E.formatContext, E.id), Do(s, p, E), rn(p, E.formatContext);
    }
    function xi(s, p, E) {
      ...
      return D.length = 0, al(p, s.responseState, E.id, E.rootSegmentID);
    }
    function xd(s, p, E) {
      for (var D = E.completedSegments, H = 0; H < D.length; H++) {
        var ne = D[H];
    ...
    function Yl(s, p, E, D) {
      ...
      var H = D.id;
      if (H === -1) {
        var ne = D.id = E.rootSegmentID;
        if (ne === -1)
          throw new Error("A root segment ID must have been assigned by now. This is a bug in React.");
        return vi(s, p, D);
      } else
        return vi(s, p, D), Rc(p, s.responseState, H);
    }
    function Oo(s, p) {
      y();
      try {
        var E = s.completedRootSegment;
        E !== null && s.pendingRootTasks === 0 && (Do(s, p, E), s.completedRootSegment = null, el(p, s.responseState));
      ...
      return new Promise(function(E, D) {
        ...
        if (p && p.signal) {
          var b = p.signal, T = function() {
            _o(c, b.reason), b.removeEventListener("abort", T);
          };
...
const VS = ({ width: e, height: t, runtime: n }) => {
  ...
  if (de.useEffect(() => {
    ...
    return;
  const w = i == null ? void 0 : i.data[0], m = Array.from(new Set((ye = w == null ? void 0 : w.links) == null ? void 0 : ye.flatMap((ae) => [ae.source, ae.target]))), _ = {
    nodes: m.map((ae) => ({ id: ae })),
    links: (Le = w == null ? void 0 : w.links) == null ? void 0 : Le.map((ae) => ({
  ...
  const P = 50, O = FS().nodeWidth(a.nodeSize.nodeWidth).nodePadding(a.nodePadding).iterations(a.iterations).nodeAlign(RS).extent([
  ...
  ]), { nodes: L, links: U } = O(_), W = (ae) => {
    var ee;
    let Ie = 30, Ee = 0, he = "node-value--storynode", Pe = !0;
    return (ee = w == null ? void 0 : w.storyNodeText) != null && ee.every((Oe) => Oe.StoryNode !== ae) && (Pe = !1, Ee = 10, Ie = 8, he = "node-value"), { textPositionHorizontal: Ie, textPositionVertical: Ee, classStyle: he, storyNodes: Pe };
  }, Z = (ae) => {
    const Ie = _.nodes.find((Pe) => Pe.id === ae), Ee = [], he = [];
    return Ie && (U.forEach((Pe) => {
      const ee = Pe.target, Oe = Pe.source;
      ee.id === ae && Ee.push(Oe.id);
    }), Ee.forEach((Pe) => {
      U.forEach((ee) => {
        const Oe = ee.target, Te = ee.source;
        Oe.id === h && Te.id === Pe && he.push(ee);
      });
    })), { sourceNodes: Ee, activeLinks: he };
  }, ce = `${((w == null ? void 0 : w.tooltips.find((ae) => ae.node === h)) || {}).value}`, te = `${((w == null ? void 0 : w.tooltips.find((ae) => ae.node === h)) || {}).summary}`, V = ((w == null ? void 0 : w.tooltips.find((ae) => ae.node === h)) || {}).column1Label, K = ((w == null ? void 0 : w.tooltips.find((ae) => ae.node === h)) || {}).column2Label, X = ((w == null ? void 0 : w.tooltips.find((ae) => ae.node === h)) || {}).column1, B = ((w == null ? void 0 : w.tooltips.find((ae) => ae.node === h)) || {}).column2, oe = ({ columnData: ae }) => /* @__PURE__ */ r.createElement("ul", null, ae == null ? void 0 : ae.map((Ie, Ee) => /* @__PURE__ */ r.createElement("li", { key: Ee }, Ie.label, ": ", Ie.value, " (", Ie.additional_info, "%)"))), re = $a.renderToString(/* @__PURE__ */ r.createElement(oe, { columnData: X })), le = $a.renderToString(/* @__PURE__ */ r.createElement(oe, { columnData: B })), q = `<div class="sankey-chart__tooltip">
                    ...
                    </div>`, j = _.nodes.map((ae, Ie) => {
    var qe, et;
    let { textPositionHorizontal: Ee, textPositionVertical: he, classStyle: Pe, storyNodes: ee } = W(ae.id), { sourceNodes: Oe } = Z(h), Te = a.opacity.nodeOpacityDefault, Ue = a.nodeColor.default;
    return h !== ae.id && h !== "" && !Oe.includes(ae.id) && (Ue = a.nodeColor.inactive, Te = a.opacity.nodeOpacityInactive), /* @__PURE__ */ r.createElement(at, { className: "", key: Ie }, /* @__PURE__ */ r.createElement(
      "rect",
      {
      ...
      (((qe = w == null ? void 0 : w.storyNodeText) == null ? void 0 : qe.find((Je) => Je.StoryNode === ae.id)) || {}).segmentTextBefore
      ...
      (((et = w == null ? void 0 : w.storyNodeText) == null ? void 0 : et.find((Je) => Je.StoryNode === ae.id)) || {}).segmentTextAfter
    ...
    const he = IS()(ae);
    let Pe = a.opacity.LinkOpacityDefault, ee = a.linkColor.default, { activeLinks: Oe } = Z(h);
    return !Oe.includes(ae) && h !== "" && (ee = a.linkColor.inactive, Pe = a.opacity.LinkOpacityInactive), /* @__PURE__ */ r.createElement(
      "path",
      {
        key: Ie,
        d: he,
  ...
  }), ue = _.nodes.reduce((ae, Ie) => Math.max(ae, Ie.depth), -1), be = _.nodes.filter((ae) => ae.depth === ue).map((ae, Ie) => {
    var qe, et;
    let { textPositionHorizontal: Ee, textPositionVertical: he, classStyle: Pe, storyNodes: ee } = W(ae.id), { sourceNodes: Oe } = Z(h), Te = a.opacity.nodeOpacityDefault, Ue = a.nodeColor.default;
    return h !== ae.id && h !== "" && !Oe.includes(ae.id) && (Ue = a.nodeColor.inactive, Te = a.opacity.nodeOpacityInactive), /* @__PURE__ */ r.createElement(at, { className: "", key: Ie, innerRef: (Je) => u.current[Ie] = Je }, /* @__PURE__ */ r.createElement(
      "rect",
      {
        height: ae.y1 - ae.y0 + 2,
        width: O.nodeWidth(),
...
function KS(e) {
  ...
  return y.map(function(R) {
    var k, F = R.value, w = R.index, m = R.from, _ = R.to, N = R.formattedValue, P = (k = f[w]) != null ? k : {}, O = Math.max(10, typeof P.fontSize == "number" && P.fontSize || 0), L = _.y + (n && i !== ir.top ? O : 0);
    return /* @__PURE__ */ r.createElement(at, {
      key: "visx-tick-" + F + "-" + w,
...
function YS(e) {
  var t = e.axisFromPoint, n = e.axisLineClassName, i = e.axisToPoint, a = e.hideAxisLine, l = e.hideTicks, f = e.horizontal, d = e.label, u = d === void 0 ? "" : d, h = e.labelClassName, y = e.labelOffset, v = y === void 0 ? 14 : y, S = e.labelProps, R = S === void 0 ? Nh : S, k = e.orientation, F = k === void 0 ? ir.bottom : k, w = e.scale, m = e.stroke, _ = m === void 0 ? "#222" : m, N = e.strokeDasharray, P = e.strokeWidth, O = P === void 0 ? 1 : P, L = e.tickClassName, U = e.tickComponent, W = e.tickLineProps, Z = e.tickLabelProps, ce = e.tickLength, te = ce === void 0 ? 8 : ce, V = e.tickStroke, K = V === void 0 ? "#222" : V, X = e.tickTransform, B = e.ticks, oe = e.ticksComponent, re = oe === void 0 ? KS : oe, le = uc({}, Nh, typeof Z == "object" ? Z : null), q = B.map(function(J) {
    var ue = J.value, De = J.index;
    return typeof Z == "function" ? Z(ue, De, B) : le;
...
function Tc(e) {
  ...
  }), ue = J.map(function(De) {
    var be = De.value, ye = De.index, Le = Bg(B(be));
    return {
      value: be,
      index: ye,
      from: Au({
...
function nE(e) {
  ...
  return /* @__PURE__ */ r.createElement(Tc, cc({
...
const ds = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  const N = (L = y.brush) != null && L.active && ((U = _.data) != null && U.length) ? _.data : h;
  if (!N)
    return;
  const P = (W) => (Cn(y.xAxis) ? t(S(W[y.xAxis.dataKey], !1)) : t(W[y.xAxis.dataKey])) + (t.bandwidth ? t.bandwidth() / 2 : 0), O = (W, Z, ce = void 0) => n(W[ce.dataKey]);
  return N && /* @__PURE__ */ r.createElement("svg", null, /* @__PURE__ */ r.createElement(Or, { component: "AreaChart" }, /* @__PURE__ */ r.createElement(at, { className: "area-chart", key: "area-wrapper", left: Number(y.yAxis.size) }, (y.runtime.areaSeriesKeys || y.series).map((W, Z) => {
    let ce = N.map((X) => ({
    ...
    return /* @__PURE__ */ r.createElement(r.Fragment, { key: Z }, /* @__PURE__ */ r.createElement(
      Kr,
      {
        ...
        x: (X) => P(X),
        y: (X) => O(X, Z, W),
        stroke: K ? w ? w(y.runtime.seriesLabels ? y.runtime.seriesLabels[W.dataKey] : W.dataKey) : "#000" : "transparent",
        strokeWidth: 2,
        strokeOpacity: 1,
      ...
      {
        key: "area-chart",
        fill: K ? w ? w(y.runtime.seriesLabels ? y.runtime.seriesLabels[W.dataKey] : W.dataKey) : "#000" : "transparent",
  ...
  const S = (F = u.brush) != null && F.active && ((w = u.brush.data) != null && w.length) ? u.brush.data : d;
  if (!S)
    return;
  const R = (m) => {
  ...
  return S && /* @__PURE__ */ r.createElement("svg", { height: Number(n) }, /* @__PURE__ */ r.createElement(Or, { component: "AreaChartStacked" }, /* @__PURE__ */ r.createElement(at, { className: "area-chart", key: "area-wrapper", left: Number(u.yAxis.size) + k / 2, height: Number(n), style: { overflow: "hidden" } }, /* @__PURE__ */ r.createElement(
    E0,
    {
      data: S,
    ...
    ({ stacks: m, path: _ }) => m.map((N, P) => {
      let O = u.legend.behavior === "highlight" && h.length > 0 && h.indexOf(N.key) === -1, L = u.legend.behavior === "highlight" || h.length === 0 || h.indexOf(N.key) !== -1;
      return (
        // prettier-ignore
        /* @__PURE__ */ r.createElement(
          "path",
  ...
  const { config: e, colorPalettes: t, tableData: n, updateConfig: i, parseDate: a, formatDate: l, setSeriesHighlight: f, seriesHighlight: d } = de.useContext(Ct), { orientation: u } = e, [h, y] = de.useState(null), v = u === "horizontal", S = 1, R = e.lollipopSize === "large" ? 7 : e.lollipopSize === "medium" ? 6 : 5, k = e.lollipopSize === "large" ? 14 : e.lollipopSize === "medium" ? 12 : 10, F = e.yAxis.labelPlacement === "Below Bar", w = e.yAxis.displayNumbersOnBar, m = e.orientation === "horizontal" ? "yAxis" : "xAxis", _ = e.barStyle === "rounded", N = e.visualizationSubType === "stacked", P = e.tipRounding, O = e.roundingStyle === "standard" ? "8px" : e.roundingStyle === "shallow" ? "5px" : e.roundingStyle === "finger" ? "15px" : "0px", L = e.runtime.seriesKeys.length, U = { small: 16, medium: 18, large: 20 }, W = Object.keys(e.runtime.seriesLabels).length > 1, ce = e.visualizationType === "Bar" && e.legend.behavior === "isolate" && e.legend.axisAlign && (d != null && d.length) ? d : e.runtime.barSeriesKeys || e.runtime.seriesKeys;
  return de.useEffect(() => {
    ...
    shouldSuppress: (j) => {
      ...
      return (J = e.preliminaryData) == null ? void 0 : J.some((ue) => {
        const De = ue.column ? ue.column === j.key : !0, be = String(j.value) === String(ue.value) && ue.value !== "";
        return De && be && ue.symbol && ue.type === "suppression";
      });
    },
    section: m,
    isRounded: _,
    ...
    applyRadius: (j) => {
      if (j == null || !_)
        return {};
      let J = {};
      return (N && j + 1 === L || !N) && (J = v ? { borderRadius: `0 ${O}  ${O}  0` } : { borderRadius: `${O} ${O} 0 0` }), !N && j === -1 && (J = v ? { borderRadius: `${O} 0  0 ${O} ` } : { borderRadius: ` 0  0 ${O} ${O}` }), P === "full" && N && j === 0 && L > 1 && (J = v ? { borderRadius: `${O} 0 0 ${O}` } : { borderRadius: `0 0 ${O} ${O}` }), P === "full" && (N && j === 0 && L === 1 || !N) && (J = { borderRadius: O }), J;
    },
    updateBars: (j) => {
      ...
      N ? ue = De.stacked : ue = De[e.isLollipopChart ? "lollipop" : "stacked"] * L;
    ...
    assignColorsToValues: (j, J, ue) => {
      if (!e.legend.colorCode && e.series.length > 1)
        return ue;
      const De = e.customColors ?? t[e.palette], be = n.map((Ie) => Ie[e.legend.colorCode]);
      let ye = /* @__PURE__ */ new Map(), Le = [];
      for (let Ie = 0; Ie < be.length; Ie++)
        ye.has(be[Ie]) || ye.set(be[Ie], De[ye.size % De.length]), Le.push(ye.get(be[Ie]));
      for (; Le.length < j; )
        Le = Le.concat(Le);
      return Le[J];
    },
    ...
    getAdditionalColumn: (j, J) => {
      ...
      return Object.keys(ue).forEach((Le) => {
        ...
        }, Ie = wf(ye[e.columns[Le].name], "left", !0, e, ae);
        e.columns[Le].tooltips && De.push([e.columns[Le].label, Ie]);
      }), De.forEach((Le) => {
        be += `${Le[0]} : ${Le[1]} <br/>`;
      }), be;
    },
...
}, Es = de.createContext(null), qf = ({ xScale: e, barWidth: t = 0, totalBarsInGroup: n = 1, yMax: i, handleTooltipMouseOff: a, handleTooltipMouseOver: l, handleTooltipClick: f, tooltipData: d, showTooltip: u, hideTooltip: h }) => {
  const { parseDate: y, config: v } = de.useContext(Ct), { runtime: S, regions: R, visualizationType: k, orientation: F, xAxis: w } = v, m = e.domain(), _ = (O) => {
    ...
    if (!(O != null && O.fromType) || O.fromType === "Fixed") {
      const U = new Date(O.from), W = y(Xl(v.xAxis.dateParseFormat, U)).getTime();
      L = e(W), k === "Bar" && w.type === "date-time" && (L = L - t * n / 2);
    }
    if (O.fromType === "Previous Days") {
      const U = Number(O.from) || 0;
      m.map((te) => Xl(v.xAxis.dateParseFormat, new Date(te)));
      const W = O.toType === "Last Date" ? new Date(m[m.length - 1]).getTime() : new Date(O.to), Z = v.xAxis.type === "categorical" ? Xl(v.xAxis.dateParseFormat, W) : Xl(v.xAxis.dateParseFormat, W), ce = new Date(Z);
  ...
  if (R && F === "vertical")
    return R.map((O) => {
      ...
      ), ce = () => /* @__PURE__ */ r.createElement("rect", { x: L, y: 0, width: W, height: i, fill: O.background, opacity: 0.3 });
      return /* @__PURE__ */ r.createElement(at, { height: 100, fill: "red", className: "regions regions-group--line zzz", key: O.label, onMouseMove: l, onMouseLeave: a, handleTooltipClick: f, tooltipData: JSON.stringify(d), showTooltip: u }, /* @__PURE__ */ r.createElement(Z, null), /* @__PURE__ */ r.createElement(ce, null), /* @__PURE__ */ r.createElement(kt, { x: L + W / 2, y: 5, fill: O.color, verticalAnchor: "start", textAnchor: "middle" }, O.label));
    });
};
function Cc(e) {
  var J, ue;
  const { config: t, index: n, id: i, className: a, background: l, borderColor: f, borderWidth: d, width: u, height: h, x: y, y: v, onMouseOver: S, onMouseLeave: R, onClick: k, tooltipHtml: F, tooltipId: w, styleOverrides: m, seriesHighlight: _ } = e, N = Math.max(0, u), P = Math.max(0, h), O = t.orientation === "horizontal", L = t.barStyle === "rounded", U = t.visualizationSubType === "stacked", W = t.tipRounding, Z = t.visualizationType === "Combo" && ((ue = (J = t.runtime) == null ? void 0 : J.barSeriesKeys) == null ? void 0 : ue.length), ce = t.runtime.seriesKeys.length, te = t.visualizationType === "Bar" && t.legend.axisAlign && (_ != null && _.length) ? _ == null ? void 0 : _.length : 0, V = Z || te || ce;
  ...
  const X = () => `M${y},${v + P}
      ...
      L${y},${v}`;
  let j;
  return n == null || !L ? j = q() : (j = q(), (U && n + 1 === V || !U) && (j = O ? B() : X()), !U && n === -1 && (j = O ? re() : oe()), W === "full" && U && n === 0 && V > 1 && (j = O ? re() : oe()), W === "full" && (U && n === 0 && V === 1 || !U) && (j = le())), /* @__PURE__ */ r.createElement(
    "path",
    {
      id: i,
      className: a,
...
const vE = () => {
  var ce, te;
  const [e, t] = de.useState(0), { xScale: n, yScale: i, seriesScale: a, xMax: l, yMax: f } = de.useContext(Es), { transformedData: d, colorScale: u, seriesHighlight: h, config: y, formatNumber: v, formatDate: S, parseDate: R, setSharedFilter: k } = de.useContext(Ct), { isHorizontal: F, barBorderWidth: w, applyRadius: m, hoveredBar: _, getAdditionalColumn: N, onMouseLeaveBar: P, onMouseOverBar: O, barStackedSeriesKeys: L } = wc(), { orientation: U } = y, W = (ce = y.brush) != null && ce.active && ((te = y.brush.data) != null && te.length) ? y.brush.data : d, Z = y.runtime.xAxis.type === "date-time" || y.runtime.xAxis.type === "date";
  return y.visualizationSubType === "stacked" && !F && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(A0, { data: W, keys: L, x: (V) => V[y.runtime.xAxis.dataKey], xScale: n, yScale: i, color: u }, (V) => V.reverse().map(
    (K) => K.bars.map((X) => {
      ...
      const le = X.bar.data[y.runtime.xAxis.dataKey], q = Z ? S(R(le)) : le, j = v(X.bar ? X.bar.data[X.key] : 0, "left");
      if (!j)
        return;
      const J = n(Z ? R(le) : le) - (Z ? re / 2 : 0), ue = y.runtime.xAxis.label ? `${y.runtime.xAxis.label}: ${q}` : q, De = N(_), be = `${y.runtime.seriesLabels[X.key]}: ${j}`, ye = `<ul>
      ...
      return t(re), /* @__PURE__ */ r.createElement(at, { key: `${K.index}--${X.index}--${U}` }, /* @__PURE__ */ r.createElement(at, { key: `bar-stack-${K.index}-${X.index}`, id: `barStack${K.index}-${X.index}`, className: "stack vertical" }, /* @__PURE__ */ r.createElement(kt, { display: y.labels && oe ? "block" : "none", opacity: B ? 0.5 : 1, x: J + e / 2, y: X.y - 5, fill: "#000", textAnchor: "middle" }, j), Cc({
        ...
        x: J,
        y: X.y,
        onMouseOver: () => O(q, X.key),
        onMouseLeave: P,
        tooltipHtml: ye,
        tooltipId: `cdc-open-viz-tooltip-${y.runtime.uniqueId}`,
        onClick: (Le) => {
          Le.preventDefault(), k && (X[y.xAxis.dataKey] = q, k(y.uid, X));
        },
        styleOverrides: {
  ...
  )), /* @__PURE__ */ r.createElement(qf, { xScale: n, yMax: f, barWidth: e, totalBarsInGroup: 1 }));
}, xE = () => {
  const { yMax: e, yScale: t, xScale: n } = de.useContext(Es), {
    ...
    setSharedFilter: v,
    transformedData: S
  } = de.useContext(Ct), { barBorderWidth: R, displayNumbersOnBar: k, fontSize: F, getAdditionalColumn: w, hoveredBar: m, isHorizontal: _, isLabelBelowBar: N, onMouseLeaveBar: P, onMouseOverBar: O, updateBars: L, barStackedSeriesKeys: U } = wc(), { orientation: W, visualizationSubType: Z } = l;
  return l.visualizationSubType === "stacked" && _ && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(R0, { data: S, keys: U, height: e, y: (ce) => ce[l.runtime.yAxis.dataKey], xScale: n, yScale: t, color: a, offset: "none" }, (ce) => ce.map(
    (te) => L(te.bars).map((V, K) => {
      ...
      const oe = jo("#000", a(l.runtime.seriesLabels[V.key])), re = d(S[V.index][V.key], "left"), le = l.runtime.yAxis.type === "date" ? f(h(S[V.index][l.runtime.originalXAxis.dataKey])) : S[V.index][l.runtime.originalXAxis.dataKey], q = l.runtime.yAxis.label ? `${l.runtime.yAxis.label}: ${le}` : le, j = u(re, `normal ${F[l.fontSize]}px sans-serif`), J = w(m), ue = `${l.runtime.seriesLabels[V.key]}: ${re}`, De = `<ul>
  ...
  return !S && String(e.value) === "0" && i.general.showZeroValueDataLabel && (h = l(v, `normal ${f / 2}px sans-serif`) < f && f > 10 ? 3 : 0, y = 3, k = !0), { barWidthHorizontal: y, barHeight: h, isSuppressed: S, showMissingDataLabel: R, showZeroValueDataLabel: k, getBarY: (_, N) => S || R || k ? N - 3 : _, getBarLabel: (_) => {
    let N = _;
  ...
  const { xScale: e, yScale: t, xMax: n, yMax: i, seriesScale: a } = de.useContext(Es), [l, f] = de.useState(0), [d, u] = de.useState(0), {
    ...
    onMouseOverBar: m,
    section: _
  } = wc(), { colorScale: N, config: P, dashboardConfig: O, tableData: L, formatDate: U, formatNumber: W, getXAxisData: Z, getYAxisData: ce, isNumber: te, parseDate: V, seriesHighlight: K, setSharedFilter: X, transformedData: B, brushConfig: oe, getTextWidth: re } = de.useContext(Ct), { HighLightedBarUtils: le } = Sc(P);
  let q = B;
  return P.preliminaryData.some((J) => J.value && J.type === "suppression") && (q = L), oe.data.length && (q = oe.data), P.visualizationSubType !== "stacked" && (P.visualizationType === "Bar" || P.visualizationType === "Combo" || Ac(P.visualizationType, q, P.allowLineToBarGraph)) && P.orientation === "vertical" && /* @__PURE__ */ r.createElement(at, null, /* @__PURE__ */ r.createElement(
    jm,
    {
      data: q,
    ...
    (J) => J.map((ue, De) => /* @__PURE__ */ r.createElement(at, { className: `bar-group-${ue.index}-${ue.x0}--${De} ${P.orientation}`, key: `bar-group-${ue.index}-${ue.x0}--${De}`, id: `bar-group-${ue.index}-${ue.x0}--${De}`, left: ue.x0 }, ue.bars.map((be, ye) => {
      ...
      let Oe = P.isLollipopChart ? k : a.bandwidth(), Te = be.x + (P.isLollipopChart ? (he / ue.bars.length - k) / 2 : 0) - (P.xAxis.type === "date-time" ? he / 2 : 0);
      f(Oe), u(ue.bars.length);
      const Ue = W(/[a-zA-Z]/.test(String(be.value)) ? "" : be.value, "left"), qe = P.runtime[_].type === "date" ? U(V(q[ue.index][P.runtime.originalXAxis.dataKey])) : q[ue.index][P.runtime.originalXAxis.dataKey], et = be.value < 0 ? -1 : ye, Je = v(be.key, q[ue.index][P.runtime.originalXAxis.dataKey]);
      let st = P.runtime.xAxis.label ? `${P.runtime.xAxis.label}: ${qe}` : qe;
      ...
      const ht = P.isLollipopChart && P.lollipopColorStyle === "regular", Ge = P.isLollipopChart && P.lollipopColorStyle === "two-tone", pt = ae == null ? void 0 : ae.includes(qe), gt = R(qe), ut = S(qe), Rt = pt ? gt : P.barHasBorder === "true" ? "#000" : "transparent", tn = pt ? ut.borderWidth : P.isLollipopChart ? 0 : P.barHasBorder === "true" ? y : 0, { barHeight: Xt, isSuppressed: vt, getBarY: Nt, getBarLabel: hn } = Ey({ bar: be, defaultBarHeight: Pe, config: P, isNumber: te, getTextWidth: re, barWidth: Oe, isVertical: !0, yAxisValue: Ue }), on = hn(Ue), qt = Nt(ee, t(Le)), yn = vt ? "none" : "block", ze = (xt, Ht) => {
        var xn;
        let It = xt, At = Ht || "#f2f2f2";
        if (O && ((xn = O.dashboard.sharedFilters) == null ? void 0 : xn.length) !== 0) {
          const { sharedFilters: Mt } = O.dashboard;
          return It = Mt ? Mt.map((ln) => ln.setBy === P.uid ? ln.resetLabel === ln.active || ln.active === B[ue.index][P.xAxis.dataKey] ? N(P.runtime.seriesLabels[be.key]) : At : N(P.runtime.seriesLabels[be.key]))[0] : N(P.runtime.seriesLabels[be.key]), ht && (It = xt), Ge && (It = ps(xt).brighten(1)), pt && (It = "transparent"), It;
        }
        return Ge && (It = ps(xt).brighten(1)), pt && (It = "transparent"), It;
      };
      return /* @__PURE__ */ r.createElement(at, { key: `${ue.index}--${ye}` }, /* @__PURE__ */ r.createElement(at, { key: `bar-sub-group-${ue.index}-${ue.x0}-${qt}--${ye}` }, Cc({
        config: P,
        index: et,
        ...
        x: Te,
        y: qt,
        onMouseOver: () => m(qe, be.key),
        onMouseLeave: w,
        tooltipHtml: We,
        tooltipId: `cdc-open-viz-tooltip-${P.runtime.uniqueId}`,
        onClick: (xt) => {
          xt.preventDefault(), X && (be[P.xAxis.dataKey] = qe, X(P.uid, be));
        },
        styleOverrides: {
        ...
        if (!(String(xt.value) === String(be.value) && xt.value !== "" && It) || Oe < 10 || !P.general.showSuppressedSymbol || xt.hideBarSymbol)
          return;
        const Mt = String(xt.symbol).includes("Asterisk"), ln = Mt ? -5 : -8, cn = Mt ? "middle" : "end", Tn = xt.symbol === "Asterisk" ? Oe * 1.2 : xt.symbol === "Double Asterisk" ? Oe : Oe / 1.5;
  ...
  ), Object.keys(P.confidenceKeys).length > 0 ? q.map((J) => {
    let ue, De, be, ye, Le = 5;
    return ue = e(Z(J)) + (P.xAxis.type !== "date-time" ? a.range()[1] / 2 : 0), be = t(ce(J, P.confidenceKeys.lower)), ye = t(ce(J, P.confidenceKeys.upper)), /* @__PURE__ */ r.createElement(
      "path",
      {
        key: `confidence-interval-v-${De}-${J[P.runtime.originalXAxis.dataKey]}`,
        stroke: "#333",
        strokeWidth: "px",
        d: `
                    M${ue - Le} ${be}
  ...
  }) : "", /* @__PURE__ */ r.createElement(qf, { xScale: e, yMax: i, barWidth: l, totalBarsInGroup: d }));
}, SE = () => {
  var le;
  const { xScale: e, yScale: t, yMax: n, seriesScale: i } = de.useContext(Es), { transformedData: a, tableData: l, colorScale: f, seriesHighlight: d, config: u, formatNumber: h, formatDate: y, parseDate: v, setSharedFilter: S, isNumber: R, getTextWidth: k, getYAxisData: F, getXAxisData: w } = de.useContext(Ct), { isHorizontal: m, barBorderWidth: _, updateBars: N, assignColorsToValues: P, section: O, fontSize: L, isLabelBelowBar: U, displayNumbersOnBar: W, lollipopBarWidth: Z, lollipopShapeSize: ce, getHighlightedBarColorByValue: te, getHighlightedBarByValue: V, getAdditionalColumn: K, hoveredBar: X, onMouseLeaveBar: B, onMouseOverBar: oe } = wc(), { HighLightedBarUtils: re } = Sc(u);
  return u.visualizationSubType !== "stacked" && u.visualizationType === "Bar" && u.orientation === "horizontal" && /* @__PURE__ */ r.createElement(at, null, /* @__PURE__ */ r.createElement(
    jm,
    {
      data: (le = u.preliminaryData) != null && le.some((q) => q.value && q.type === "suppression") ? l : a,
    ...
    (q) => N(q).map((j, J) => /* @__PURE__ */ r.createElement(at, { className: `bar-group-${j.index}-${j.x0}--${J} ${u.orientation}`, key: `bar-group-${j.index}-${j.x0}--${J}`, id: `bar-group-${j.index}-${j.x0}--${J}`, top: j.y }, j.bars.map((ue, De) => {
      var xn;
      ...
      const Pe = Math.abs(e(ue.value) - e(be)), ee = ue.value >= 0 && R(ue.value), { barWidthHorizontal: Oe, isSuppressed: Te, getBarLabel: Ue } = Ey({ bar: ue, defaultBarWidth: Pe, config: u, isNumber: R, getTextWidth: k, isVertical: !1 }), qe = ue.value < 0 ? Math.abs(e(ue.value)) : e(be), et = h(ue.value, "left"), Je = u.runtime[O].type === "date" ? y(v(a[j.index][u.runtime.originalXAxis.dataKey])) : a[j.index][u.runtime.originalXAxis.dataKey], st = ee ? "above" : "below", Ke = Ue(et), We = k(Je, `normal ${L[u.fontSize]}px sans-serif`), Be = Number(We) < Pe - 5;
      let $e = Be ? "end" : "start", ht = "start", Ge = Be ? -5 : 5, pt = 10;
      st === "below" && ($e = Be ? "start" : "end", Ge = Be ? 5 : -5, u.isLollipopChart && (ht = "end", pt = -10));
      const gt = ue.value < 0 ? -1 : De;
      ...
      Nt = P(q.length, j.index, Nt);
      const hn = u.isLollipopChart && u.lollipopColorStyle === "regular", on = u.isLollipopChart && u.lollipopColorStyle === "two-tone", qt = ye == null ? void 0 : ye.includes(Je), yn = te(Je), ze = V(Je), xt = qt ? yn : u.barHasBorder === "true" ? "#000" : "transparent", Ht = qt ? ze.borderWidth : u.isLollipopChart ? 0 : u.barHasBorder === "true" ? _ : 0, It = Te ? "none" : "block";
      Nt && vt && Be && (vt = jo("#000", Nt));
      const At = () => hn ? Nt : on ? ps(Nt).brighten(1) : qt ? "transparent" : Nt;
      return /* @__PURE__ */ r.createElement(at, { key: `${j.index}--${De}` }, /* @__PURE__ */ r.createElement(at, { key: `bar-sub-group-${j.index}-${j.x0}-${he}--${De}` }, Cc({
        config: u,
        index: gt,
        id: `barGroup${j.index}`,
        background: At(),
    ...
    let j, J, ue, De = 5;
    return j = t(w(q)) - 0.75 * u.barHeight, J = e(F(q, u.confidenceKeys.upper)), ue = e(F(q, u.confidenceKeys.lower)), /* @__PURE__ */ r.createElement(
      "path",
      {
...
function ky(e) {
  var t = e.left, n = t === void 0 ? 0 : t, i = e.top, a = i === void 0 ? 0 : i, l = e.className, f = e.max, d = e.min, u = e.firstQuartile, h = e.thirdQuartile, y = e.median, v = e.boxWidth, S = v === void 0 ? 10 : v, R = e.fill, k = e.fillOpacity, F = e.stroke, w = e.strokeWidth, m = e.rx, _ = m === void 0 ? 2 : m, N = e.ry, P = N === void 0 ? 2 : N, O = e.valueScale, L = e.outliers, U = L === void 0 ? [] : L, W = e.horizontal, Z = e.medianProps, ce = Z === void 0 ? {} : Z, te = e.maxProps, V = te === void 0 ? {} : te, K = e.minProps, X = K === void 0 ? {} : K, B = e.boxProps, oe = B === void 0 ? {} : B, re = e.outlierProps, le = re === void 0 ? {} : re, q = e.container, j = q === void 0 ? !1 : q, J = e.containerProps, ue = J === void 0 ? {} : J, De = e.children, be = W ? a : n, ye = be + (S || 0) / 2, Le = O.range(), ae = O(d ?? 0), Ie = O(u ?? 0), Ee = O(y ?? 0), he = O(h ?? 0), Pe = O(f ?? 0), ee = {
    valueRange: Le,
    center: ye,
    offset: be,
    boxWidth: S,
  ...
  return W && (ee.max = Ai(ee.max), ee.maxToThird = Ai(ee.maxToThird), ee.box.y1 = Ie, ee.box = Ai(ee.box), ee.median = Ai(ee.median), ee.minToFirst = Ai(ee.minToFirst), ee.min = Ai(ee.min), ee.container = Ai(ee.container), ee.container.y1 = Math.min.apply(Math, Le)), De ? /* @__PURE__ */ r.createElement(r.Fragment, null, De(ee)) : /* @__PURE__ */ r.createElement(at, {
    className: Ln("visx-boxplot", l)
  }, U.map(function(Oe, Te) {
    var Ue = W ? O(Oe) : ye, qe = W ? ye : O(Oe);
    return /* @__PURE__ */ r.createElement("circle", Oa({
      key: "visx-boxplot-outlier-" + Te,
    ...
    rx: _,
    ry: P
  }, oe)), /* @__PURE__ */ r.createElement("line", Oa({
    ...
    stroke: F,
    strokeWidth: w
  }, X)), j && /* @__PURE__ */ r.createElement("rect", Oa({
    x: ee.container.x1,
    y: ee.container.y1,
...
const kE = ({ xScale: e, yScale: t }) => {
  ...
  const l = `cdc-open-viz-tooltip-${n.runtime.uniqueId}`, f = (w) => `
    ...
    `, d = (w) => Number(w.columnMax), u = (w) => Number(w.columnMin), h = (w) => Number(w.columnMedian), y = (w) => Number(w.columnThirdQuartile), v = (w) => Number(w.columnFirstQuartile), S = 0.5, R = e.bandwidth(), k = Math.min(40, R), F = dr[n == null ? void 0 : n.palette][0] ? dr[n == null ? void 0 : n.palette][0] : "#000";
  return /* @__PURE__ */ r.createElement(Or, { component: "BoxPlot" }, /* @__PURE__ */ r.createElement(at, { className: "boxplot", key: "boxplot-group" }, a.plots.map((w, m) => {
    const _ = R - k, N = 4;
    return /* @__PURE__ */ r.createElement(at, { key: `boxplotplot-${m}` }, a.plotNonOutlierValues && w.nonOutlierValues.map((P, O) => /* @__PURE__ */ r.createElement("circle", { cx: e(w.columnCategory) + Number(n.yAxis.size) + R / 2, cy: t(P), r: N, fill: "#ccc", style: { opacity: 1, fillOpacity: 1, stroke: "black" }, key: `boxplot-${m}--circle-${O}` })), /* @__PURE__ */ r.createElement(
      ky,
      {
  ...
  const { transformedData: n, config: i, tableData: a, formatNumber: l, seriesHighlight: f, colorPalettes: d } = de.useContext(Ct), u = 4.5, h = Object.keys(i.runtime.seriesLabels).length > 1, y = Object.entries(i.columns).filter(([S, R]) => R.tooltips).map(([S, R]) => [
   ...
   ${y.map(([F, w, m]) => `${F} : ${wf(a[k][w], "left", !1, i, m)}<br/>`).join("")}
</div>`;
...
function wE({ height: e, xScale: t }) {
  const { transformedData: n, config: i, formatNumber: a, twoColorPalette: l, getTextWidth: f, updateConfig: d, parseDate: u, formatDate: h, currentViewport: y } = de.useContext(Ct), { barStyle: v, tipRounding: S, roundingStyle: R, twoColor: k } = i, F = de.useRef([]), [w, m] = de.useState(window.innerWidth), _ = R === "standard" ? "8px" : R === "shallow" ? "5px" : R === "finger" ? "15px" : "0px", N = { small: 16, medium: 18, large: 20 };
  i.barStyle;
  const P = Number(i.xAxis.target), O = i.series[0].dataKey, L = Number(t.domain()[1]), W = n.some((q) => q[O] < 0) || P > 0 || t.domain()[0] < 0, Z = i.barHasBorder === "true" ? 1 : 0, ce = i.lollipopSize === "large" ? 7 : i.lollipopSize === "medium" ? 6 : 5, te = i.lollipopSize === "large" ? 14 : i.lollipopSize === "medium" ? 12 : 10, V = Math.max(t(0), Math.min(t(P), t(L))), K = (q) => {
    if (q == null || v !== "rounded")
      return;
    let j = {};
    return q === "left" && (j = { borderRadius: `${_} 0 0 ${_}` }), q === "right" && (j = { borderRadius: `0 ${_} ${_} 0` }), S === "full" && (j = { borderRadius: _ }), j;
  }, X = {
    calculate: function() {
      const j = n[0][O] < P ? "left" : "right", J = `${i.xAxis.targetLabel} ${a(i.xAxis.target || 0, "left")}`, ue = f(J, `bold ${N[i.fontSize]}px sans-serif`);
      let De = i.isLollipopChart ? ce / 2 : Number(i.barHeight) / 2, be = 0, ye = 0, Le = !1;
      j === "right" && (be = -10, Le = ue - be < V, ye = V - ue), j === "left" && (be = 10, Le = t(L) - V > ue + be, ye = V), this.text = J, this.y = De, this.x = ye, this.padding = be, this.showLabel = i.xAxis.showTargetLabel ? Le : !1;
    }
  };
  X.calculate();
  ...
  return de.useEffect(() => {
    ...
    var q;
    (q = F.current) == null || q.forEach((j, J) => {
      if (!(!j || !j.style)) {
        if (i.animate) {
          const ue = P / L * 100;
  ...
  }, [i.animate, i, re]), /* @__PURE__ */ r.createElement(Or, { component: "Deviation Bar" }, /* @__PURE__ */ r.createElement(at, { left: Number(i.xAxis.size) }, n.map((q, j) => {
    const J = Number(q[O]), ue = i.isLollipopChart ? ce : Number(i.barHeight), De = Number(i.barSpace), be = Math.abs(t(J) - V), ye = t(J), Le = J > P ? V : ye, ae = J < P ? "left" : "right";
    let Ie = 0;
    Ie = j !== 0 ? (De + ue + Z) * j : Ie;
    const Ee = (De + ue + Z) * n.length;
    i.heights.horizontal = Ee;
    const Pe = f(a(J, "left"), `normal ${N[i.fontSize]}px sans-serif`) < be - 6, ee = ye, Oe = Ie + ue / 2, Te = ye, Ue = Ie + ue / 2, qe = ye, et = Ie - ue / 2, Je = K(ae), [st, Ke] = l[k.palette], We = { left: st, right: Ke }, Be = jo("#000", We[ae]);
    let $e = CE(i.isLollipopChart, Pe, te, Be);
    const ht = a(J, "left"), Ge = i.runtime.yAxis.type === "date" ? h(u(n[j][i.runtime.originalXAxis.dataKey])) : n[j][i.runtime.originalXAxis.dataKey];
    let pt = i.runtime.yAxis.label ? `${i.runtime.yAxis.label}: ${Ge}` : Ge, gt = i.runtime.xAxis.label ? `${i.runtime.xAxis.label}: ${ht}` : ht;
    const ut = `<div>
          ${pt}<br />
          ${gt}
            </div>`;
    return /* @__PURE__ */ r.createElement(at, { key: `deviation-bar-${i.orientation}-${O}-${j}` }, /* @__PURE__ */ r.createElement(
      "foreignObject",
      {
        ref: (Rt) => {
          F.current[j] = Rt;
    ...
    ), i.yAxis.displayNumbersOnBar && /* @__PURE__ */ r.createElement(kt, { verticalAnchor: "middle", x: ee, y: Oe, ...$e[ae] }, a(q[O], "left")), i.isLollipopChart && i.lollipopShape === "circle" && /* @__PURE__ */ r.createElement("circle", { cx: Te, cy: Ue, r: te / 2, fill: We[ae], style: { filter: "unset", opacity: 1 } }), i.isLollipopChart && i.lollipopShape === "square" && /* @__PURE__ */ r.createElement("rect", { x: qe, y: et, width: te, height: te, fill: We[ae], style: { opacity: 1, filter: "unset" } }));
...
const AE = ({ xScale: e, yScale: t, height: n, width: i, handleTooltipMouseOver: a, handleTooltipMouseOff: l }) => {
  ...
  return f && /* @__PURE__ */ r.createElement(Or, { component: "ForecastingChart" }, /* @__PURE__ */ r.createElement(at, { className: "forecasting-items", key: "forecasting-items-wrapper", left: Number(v.size) }, (k = R.forecastingSeriesKeys) == null ? void 0 : k.map((F, w) => !F || !F.stages ? !1 : F.stages.map((m, _) => {
    ...
    let O = N === "highlight" && h.length > 0 && h.indexOf(m.key) === -1, L = N === "highlight" || h.length === 0 || h.indexOf(m.key) !== -1;
    return /* @__PURE__ */ r.createElement(at, { className: `forecasting-areas-combo-${w}`, key: `forecasting-areas--stage-${m.key.replaceAll(" ", "-")}-${w}` }, (U = F.confidenceIntervals) == null ? void 0 : U.map((W, Z) => {
      const ce = $u[m.color] || dr[m.color] || !1, te = () => L && ce[2] ? ce[2] : "transparent", V = () => L && ce[1] ? ce[1] : "transparent";
      if (!(W.high === "" || W.low === ""))
        return /* @__PURE__ */ r.createElement(at, { key: `forecasting-areas--stage-${m.key.replaceAll(" ", "-")}--group-${_}-${Z}` }, /* @__PURE__ */ r.createElement(
          p0,
          {
            curve: _u,
            data: P,
        ...
        ), Z === 0 && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(Kr, { data: P, x: (K) => Number(e(Date.parse(K[y.dataKey]))), y: (K) => Number(t(K[W.high])), curve: _u, stroke: V(), strokeWidth: 1, strokeOpacity: 1 }), /* @__PURE__ */ r.createElement(Kr, { data: P, x: (K) => Number(e(Date.parse(K[y.dataKey]))), y: (K) => Number(t(K[W.low])), curve: _u, stroke: V(), strokeWidth: 1, strokeOpacity: 1 })));
    }));
...
function Lc(e, t) {
  const n = e.series.every(({ type: S }) => S === "Bar"), i = e.series.every(({ type: S }) => ["Line", "dashed-sm", "dashed-md", "dashed-lg"].includes(S)), a = (S) => (R) => S.reduce((k, F) => isNaN(Number(R[F])) ? k : k + Number(R[F]), 0), l = () => {
    ...
    if ((e.visualizationType === "Bar" || e.visualizationType === "Deviation Bar") && e.series && e.series.dataKey && (S = Math.max(...t.map((R) => Mu(R[e.series.dataKey]) ? Number(u(R[e.series.dataKey])) : 0))), e.visualizationType === "Combo" && e.visualizationSubType === "stacked" && !n && e.runtime.barSeriesKeys && e.runtime.lineSeriesKeys) {
      const R = t.map(a(e.runtime.barSeriesKeys)), k = Math.max(...t.map((w) => Math.max(...e.runtime.lineSeriesKeys.map((m) => Number(u(w[m])))))), F = Math.max(...R);
      S = Math.max(F, k);
    }
    return S;
  }, f = () => {
...
function Zf({ config: e, yMax: t = 0, data: n = [], updateConfig: i }) {
  ...
  const d = (w) => {
    if (!w)
      return [0];
    let m = [];
    return w.map((_, N) => m = [...m, ...n.map((P) => Number(P[_]))]), m;
  };
...
const OE = (e, t, n, i) => {
  const a = RE(e, t, n), l = NE(e, t, n), f = DE(e, t, i, n);
  return [a, f, l].filter((d) => d.data.length > 0 && d.style !== "");
}, Vd = (e) => {
  var P, O, L, U, W, Z, ce, te;
  const { config: t, d: n, tableData: i, displayArea: a, seriesKey: l, tooltipData: f, xScale: d, yScale: u, colorScale: h, parseDate: y, yScaleRight: v, data: S, circleData: R, dataIndex: k, mode: F } = e, { lineDatapointStyle: w } = t, m = (P = t == null ? void 0 : t.series.filter((V) => V.dataKey === l)) == null ? void 0 : P[0], _ = (V, K, X, B, oe) => {
  ...
  if (F === "HOVER_POINTS" && w === "hover") {
    if (!f || !l || !f.data)
      return;
    let V = (L = (O = f == null ? void 0 : f.data) == null ? void 0 : O[0]) == null ? void 0 : L[1];
    if (!V)
      return;
  ...
  const {
    ...
    yMax: h,
    yScale: y
  } = e, { colorScale: v, config: S, formatNumber: R, handleLineType: k, isNumber: F, parseDate: w, seriesHighlight: m, tableData: _, transformedData: N, updateConfig: P, brushConfig: O, clean: L } = de.useContext(Ct), { yScaleRight: U } = Zf({ config: S, yMax: h, data: N, updateConfig: P });
  if (!l)
    return;
  const { lineDatapointStyle: W, showLineSeriesLabels: Z, legend: ce } = S;
  let te = N, V = _;
  return O.data.length > 0 && ((K = S.brush) != null && K.active) && (te = L(O.data), V = L(O.data)), /* @__PURE__ */ r.createElement(Or, { component: "LineChart" }, /* @__PURE__ */ r.createElement(at, { left: Number(S.runtime.yAxis.size) }, " ", (S.runtime.lineSeriesKeys || S.runtime.seriesKeys).map((X, B) => {
    var be;
    let oe = S.series.filter((ye) => ye.dataKey === X)[0].type;
    const re = S.series.filter((ye) => ye.dataKey === X), le = re[0].axis ? re[0].axis : "left";
    let q = ce.behavior === "highlight" || m.length === 0 || m.indexOf(X) !== -1;
    ...
    const ue = OE(_, X, S.preliminaryData, S.xAxis.dataKey);
    let De = (ye) => u(t(ye)) + (u.bandwidth ? u.bandwidth() / 2 : 0);
    return /* @__PURE__ */ r.createElement(
      at,
      {
        key: `series-${X}`,
      ...
      Z && (S.runtime.lineSeriesKeys || S.runtime.seriesKeys).map((ye) => {
        ...
        return Le ? /* @__PURE__ */ r.createElement("text", { x: De(Le) + 5, y: y(n(Le, ye)), alignmentBaseline: "middle", fill: S.colorMatchLineSeriesLabels && v ? v(S.runtime.seriesLabels[ye] || ye) : "black" }, S.runtime.seriesLabels[ye] || ye) : /* @__PURE__ */ r.createElement(r.Fragment, null);
      })
    );
  ...
  de.useEffect(() => {
    try {
      ...
      for (let U = 0; U < L; U++)
        P.forEach((W) => {
          var Z;
          l.forestPlot[W] && l.forestPlot[W] !== ((Z = O.columns[l.forestPlot[`additionalColumn${U}`]]) == null ? void 0 : Z.name) && (delete O.columns[`additionalColumn${U}`], O.columns[l.forestPlot[W]] = {}, O.columns[l.forestPlot[W]].dataKey = O.forestPlot[W], O.columns[l.forestPlot[W]].name = O.forestPlot[W], O.columns[l.forestPlot[W]].dataTable = !0, O.columns[l.forestPlot[W]].tooltips = !0, O.columns[l.forestPlot[W]].label = O.forestPlot[W]);
        });
  ...
  return /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(at, { width: d }, y.title && /* @__PURE__ */ r.createElement(kt, { className: "forest-plot--title", x: y.type === "Linear" ? i(0) : i(1), y: 0, textAnchor: "middle", verticalAnchor: "start", fontSize: Ei(l.fontSize), fill: "black" }, y.title), y.lineOfNoEffect.show && y.type === "Linear" && /* @__PURE__ */ r.createElement(an, { from: { x: i(0), y: 0 + w }, to: { x: i(0), y: f }, className: "forestplot__line-of-no-effect", stroke: y.regression.baseLineColor || "black" }), y.lineOfNoEffect.show && y.type === "Logarithmic" && /* @__PURE__ */ r.createElement(an, { from: { x: i(1), y: 0 + w }, to: { x: i(1), y: f }, className: "forestplot__line-of-no-effect", stroke: y.regression.baseLineColor || "black" }), t.map((P, O) => {
    ...
    }), U = y.radius.scalingColumn !== "" ? L(t[O][y.radius.scalingColumn]) : 4, W = y.colors.shape ? y.colors.shape : "black", Z = y.colors.line ? y.colors.line : "black", ce = 4;
  ...
  if (!a)
    return { min: d, max: u };
  const v = () => Ac(e.visualizationType, a, e.allowLineToBarGraph), { visualizationType: S, series: R } = e, { max: k, min: F } = e.runtime.yAxis, w = i ? k >= n : k >= 0, m = e.useLogScale ? F >= 0 : F <= 0 && t >= 0 || F <= t && t < 0;
  d = F && m ? F : t, u = k && w ? k : Number.MIN_VALUE;
  const { lower: _, upper: N } = (e == null ? void 0 : e.confidenceKeys) || {};
  if (_ && N && e.visualizationType === "Bar") {
    const P = d < 0 ? 1.1 : 0;
    u = Math.max(n, Math.max(...a.flatMap((O) => [O[N], O[_]])) * 1.15), d = Math.min(t, Math.min(...a.flatMap((O) => [O[N], O[_]])) * 1.15) * P;
  }
    ...
    if ((P == null ? void 0 : P.length) > 0) {
      ...
      P.forEach((Z) => {
        ...
        (ce = Z.confidenceIntervals) == null || ce.map((te) => {
          O.push(te.high), O.push(te.low);
        });
      });
      const L = a.map((Z) => O.map((ce) => Z[ce])), U = Math.max.apply(
        null,
        L.map((Z) => Z[0])
      ), W = Math.min.apply(
        null,
  ...
  const { rawData: u, dimensions: h } = de.useContext(Ct), [y, v] = h, S = f.runtime.barSeriesKeys || f.runtime.seriesKeys, R = f.runtime.xAxis.type, k = f.orientation === "horizontal", F = (Z) => Z[f.runtime.originalXAxis.dataKey], w = d.map((Z) => F(Z)), { visualizationType: m } = f;
  let _ = null, N = null, P = null, O = null, L = null, U = null, W = null;
  if (k && (_ = IE({ min: a * 1.03, ...e }), _.type = f.useLogScale ? Wr.LOG : Wr.LINEAR, N = BE(R, t), N.rangeRound([0, i]), L = Oh(S, [0, i])), k || (W = Oh(w, [0, n], 0.5), _ = Pu(t, [0, n], 1 - f.barThickness), N = $E(e), L = Pu(S, [0, _.bandwidth()], 0)), f.xAxis.type === "date" && !k) {
    const Z = t ? t.sort() : [];
    _ = Pu(Z, [0, n], 1 - f.barThickness);
  }
  if (f.xAxis.type === "date-time") {
    let Z = Math.min(...t), ce = Math.max(...t);
    Z -= (f.xAxis.padding ? f.xAxis.padding * 0.01 : 0) * (ce - Z), ce += (f.xAxis.padding ? f.xAxis.padding * 0.01 : 0) * (ce - Z), _ = zg({
      domain: [Z, ce],
      range: [0, n]
    }), _.type = Wr.TIME;
  ...
  return { xScale: _, yScale: N, seriesScale: L, g1xScale: O, g2xScale: P, xScaleNoPadding: U, xScaleBrush: W };
}, zE = (e, t, n) => {
  const i = t.domain();
  if (t.type === "time") {
...
}) : Bo({ domain: t, padding: 0.5 }), Oh = (e, t, n = 0) => Bo({
  domain: e,
  range: t,
  padding: n
}), Pu = (e, t, n = 0) => Kd({
...
const ks = () => {
  const { config: e } = de.useContext(Ct), { visualizationType: t, series: n, orientation: i, visualizationSubType: a } = e, l = [
    ...
    if ((t === "Bar" || "Combo") && a === "regular")
      return !0;
  }, m = () => ["Line", "Bar", "Area Chart", "Combo"].includes(t) && i === "vertical", _ = () => ["Box Plot", "Scatter Plot", "Pie"].includes(t) ? !1 : n == null ? void 0 : n.some((Ue) => Ue.type === "Bar" || Ue.type === "Paired Bar" || Ue.type === "Deviation Bar"), N = () => {
    switch (t) {
      case "Sankey":
        return !1;
      case "Forest Plot":
  ...
  return {
    ...
    visSupportsPreliminaryData: () => (e == null || e.series.some((Te) => ["Line", "dashed-sm", "dashed-md", "dashed-lg"].includes(Te == null ? void 0 : Te.type)), t === "Line" || t === "Bar" && a === "regular" || t === "Combo"),
    ...
    visSupportsValueAxisGridLines: () => {
      ...
      return !(i === "horizontal" || Te.includes(t));
    },
...
function KE(e) {
  ...
  return /* @__PURE__ */ r.createElement(wy, Tf({
    id: t,
    markerWidth: d,
    markerHeight: d,
    refX: u,
...
const Vr = (e) => {
  ...
  const { transformedData: t, tableData: n, dimensions: i, config: a, parseDate: l, formatDate: f, currentViewport: d, formatNumber: u, handleChartAriaLabels: h, updateConfig: y, handleLineType: v, getTextWidth: S, brushConfig: R } = de.useContext(Ct), { visualizationType: k, visualizationSubType: F, orientation: w, xAxis: m, yAxis: _, runtime: N, debugSvg: P } = a, O = () => Ac(a.visualizationType, t, a.allowLineToBarGraph);
  let [L] = i;
  a && a.legend && !a.legend.hide && ((Hn = a.legend) == null ? void 0 : Hn.position) !== "bottom" && ["lg", "md"].includes(d) && (L = L * 0.73);
  const { horizontal: U } = a.heights, W = w === "horizontal" || a.visualizationType === "Forest Plot", Z = !0, ce = isNaN(parseInt(N.xAxis.labelOffset)) ? 0 : parseInt(N.xAxis.labelOffset), te = isNaN(parseInt(N.yAxis.labelOffset)) ? 0 : parseInt(N.yAxis.labelOffset), V = isNaN(parseInt(N.xAxis.size)) ? 0 : parseInt(N.xAxis.size);
  let K = a.aspectRatio ? L * a.aspectRatio : a.visualizationType === "Forest Plot" ? a.heights.vertical : a.heights[w];
  K = Number(K);
  const X = L - N.yAxis.size - (k === "Combo" ? a.yAxis.rightAxisSize : 0);
  let B = K - (w === "horizontal" ? 0 : V);
  K += w === "horizontal" ? V : 0, a.visualizationType === "Forest Plot" && (K = K + a.data.length * a.forestPlot.rowHeight, B = B + a.data.length * a.forestPlot.rowHeight, L = i[0]), (Ut = a.brush) != null && Ut.active && (K = K + ((zn = a.brush) == null ? void 0 : zn.height));
  const { minValue: oe, maxValue: re, existPositiveValue: le, isAllLine: q } = Lc(a, t), { visSupportsReactTooltip: j } = ks(), { hasTopAxis: J } = HE(a), [ue, De] = de.useState(!1), [be, ye] = de.useState({ x: 0, y: 0 });
  de.useRef(null);
  const Le = de.useRef(), ae = de.useRef(), Ie = Kf(Le, {
    freezeOnceVisible: !1
  }), Ee = (Ne) => Cn(a.runtime.xAxis) ? l(Ne[a.runtime.originalXAxis.dataKey]).getTime() : Ne[a.runtime.originalXAxis.dataKey], he = (Ne, ct) => Ne[ct], Pe = (Wn = a.brush) != null && Wn.active && ((An = R.data) != null && An.length) ? R.data.map((Ne) => Ee(Ne)) : t.map((Ne) => Ee(Ne)), ee = a.orientation === "horizontal" || a.visualizationType === "Forest Plot" ? "yAxis" : "xAxis", Oe = { data: t, tableData: n, config: a, minValue: oe, maxValue: re, isAllLine: q, existPositiveValue: le, xAxisDataMapped: Pe, xMax: X, yMax: B }, { min: Te, max: Ue, leftMax: qe, rightMax: et } = Ty(Oe), { yScaleRight: Je, hasRightAxis: st } = Zf({ config: a, yMax: B, data: t, updateConfig: y }), { xScale: Ke, yScale: We, seriesScale: Be, g1xScale: $e, g2xScale: ht, xScaleNoPadding: Ge, xScaleBrush: pt } = ME({ ...Oe, min: Te, max: Ue, leftMax: qe, rightMax: et, dimensions: i }), [gt, ut] = de.useState(null);
  de.useEffect(() => {
    var Ne;
  ...
  const Rt = (Ne, ct) => {
    if (a.useLogScale && Ne === 0.1 && (Ne = 0), !(a.data && !a.data[ct] && k === "Forest Plot"))
      return a.visualizationType === "Forest Plot" ? a.data[ct][a.xAxis.dataKey] : Cn(N.yAxis) ? f(l(Ne)) : w === "vertical" && Ue - Te < 3 ? u(Ne, "left", Z, !1, !1, "1") : w === "vertical" ? u(Ne, "left", Z) : Ne;
  }, tn = (Ne) => (a.useLogScale && Ne === 0.1 && (Ne = 0), Cn(N.xAxis) && a.visualizationType !== "Forest Plot" ? f(Ne) : w === "horizontal" && a.visualizationType !== "Forest Plot" ? u(Ne, "left", Z) : a.xAxis.type === "continuous" && a.visualizationType !== "Forest Plot" ? u(Ne, "bottom", Z) : a.visualizationType === "Forest Plot" ? u(Ne, "left", a.dataFormat.abbreviated, a.runtime.xAxis.prefix, a.runtime.xAxis.suffix, Number(a.dataFormat.roundTo)) : Ne), Xt = (Ne) => {
    let { numTicks: ct } = N[Ne];
    N[Ne].viewportNumTicks && N[Ne].viewportNumTicks[d] && (ct = N[Ne].viewportNumTicks[d]);
    let dt;
    return Ne === "yAxis" && (dt = W && !ct ? t.length : W && ct ? ct : !W && !ct ? void 0 : !W && ct && ct, dt === void 0 && !a.dataFormat.roundTo && (Number(Ue) <= 3 ? dt = 2 : dt = 4), Number(dt) > Number(Ue) && (dt = Number(Te) < 0 ? Math.round(Ue) * 2 : Math.round(Ue))), Ne === "xAxis" && (dt = W && !ct ? void 0 : W && ct ? ct : !W && !ct ? void 0 : !W && ct && ct, W && dt === void 0 && !a.dataFormat.roundTo && (Ue <= 3 ? dt = 2 : dt = 4), a.visualizationType === "Forest Plot" && (dt = a.yAxis.numTicks !== "" ? a.yAxis.numTicks : 4)), dt;
  }, { tooltipData: vt, showTooltip: Nt, hideTooltip: hn, tooltipOpen: on, tooltipLeft: qt, tooltipTop: yn } = Xm(), {
  ...
  de.useEffect(() => {
    document.querySelector(".isEditor") && De((ct) => !0);
  }), de.useEffect(() => {
  ...
  const ln = () => {
    ...
    return /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(Fu, { top: B, left: Number(N.yAxis.size), label: N.xAxis.label, tickFormat: Cn(N.xAxis) ? f : u, scale: $e, stroke: "#333", tickStroke: "#333", numTicks: N.xAxis.numTicks || void 0 }, (ct) => /* @__PURE__ */ r.createElement(at, { className: "bottom-axis" }, ct.ticks.map((dt, $) => {
      const _e = dt.index !== 0 ? a.yAxis.tickRotation : 0, Xe = dt.index !== 0 && a.yAxis.tickRotation && a.yAxis.tickRotation > 0 ? "end" : "middle", it = S(dt.value, `normal ${Tn[a.fontSize]}px sans-serif`) * Math.sin(_e * (Math.PI / 180)) + 25;
      return it > Ne && (Ne = it), /* @__PURE__ */ r.createElement(at, { key: `vx-tick-${dt.value}-${$}`, className: "vx-axis-tick" }, !N.yAxis.hideTicks && /* @__PURE__ */ r.createElement(an, { from: dt.from, to: dt.to, stroke: "#333" }), !N.yAxis.hideLabel && /* @__PURE__ */ r.createElement(kt, { x: dt.to.x, y: dt.to.y, angle: -_e, verticalAnchor: "start", textAnchor: Xe }, u(dt.value, "left")));
  ...
  return isNaN(L) ? /* @__PURE__ */ r.createElement(r.Fragment, null) : /* @__PURE__ */ r.createElement(Or, { component: "LinearChart" }, /* @__PURE__ */ r.createElement("div", { style: { width: `${L}px`, overflow: "visible" }, className: "tooltip-boundary" }, /* @__PURE__ */ r.createElement(
    ...
    !["Spark Line", "Forest Plot"].includes(k) && /* @__PURE__ */ r.createElement(nE, { scale: We, tickLength: a.useLogScale ? 6 : 8, left: Number(N.yAxis.size) - a.yAxis.axisPadding, label: N.yAxis.label || N.yAxis.label, stroke: "#333", tickFormat: (Ne, ct) => Rt(Ne, ct), numTicks: Jt() }, (Ne) => {
      ...
      return /* @__PURE__ */ r.createElement(at, { className: "left-axis" }, Ne.ticks.map(($, _e) => {
        const Xe = Ne.ticks[0].to.y, Ve = 15, it = String($.value).startsWith("1") || $.value === 0.1 ? "block" : "none", nt = it === "block" ? 7 : 0, Et = { x: $.to.x - nt, y: $.to.y }, Dt = $.index !== 0 || a.xAxis.hideAxis;
        return /* @__PURE__ */ r.createElement(at, { key: `vx-tick-${$.value}-${_e}`, className: "vx-axis-tick" }, !N.yAxis.hideTicks && /* @__PURE__ */ r.createElement(an, { key: `${$.value}--hide-hideTicks`, from: $.from, to: a.useLogScale ? Et : $.to, stroke: a.yAxis.tickColor, display: w === "horizontal" ? "none" : "block" }), N.yAxis.gridLines && Dt ? /* @__PURE__ */ r.createElement(an, { key: `${$.value}--hide-hideGridLines`, display: (a.useLogScale && it).toString(), from: { x: $.from.x + X, y: $.from.y }, to: $.from, stroke: "rgba(0,0,0,0.3)" }) : "", w === "horizontal" && F !== "stacked" && a.yAxis.labelPlacement === "On Date/Category Axis" && !a.yAxis.hideLabel && /* @__PURE__ */ r.createElement(
          kt,
          {
          ...
          $.formattedValue
        ), w === "horizontal" && F === "stacked" && a.yAxis.labelPlacement === "On Date/Category Axis" && !a.yAxis.hideLabel && /* @__PURE__ */ r.createElement(kt, { transform: `translate(${$.to.x - 5}, ${$.to.y - Xe + (Number(a.barHeight) - Ve) / 2}) rotate(-${N.horizontal ? N.yAxis.tickRotation : 0})`, verticalAnchor: "start", textAnchor: "end" }, $.formattedValue), w === "horizontal" && k === "Paired Bar" && !a.yAxis.hideLabel && /* @__PURE__ */ r.createElement(kt, { transform: `translate(${$.to.x - 5}, ${$.to.y - Xe + Number(a.barHeight) / 2}) rotate(-${N.horizontal ? N.yAxis.tickRotation : 0})`, textAnchor: "end", verticalAnchor: "middle" }, $.formattedValue), w === "horizontal" && k === "Deviation Bar" && !a.yAxis.hideLabel && /* @__PURE__ */ r.createElement(kt, { transform: `translate(${$.to.x - 5}, ${a.isLollipopChart ? $.to.y - Xe + 2 : $.to.y - Xe + Number(a.barHeight) / 2}) rotate(-${N.horizontal ? N.yAxis.tickRotation : 0})`, textAnchor: "end", verticalAnchor: "middle" }, $.formattedValue), w === "vertical" && k !== "Paired Bar" && !a.yAxis.hideLabel && /* @__PURE__ */ r.createElement(
          kt,
          {
    ...
    k !== "Paired Bar" && k !== "Spark Line" && /* @__PURE__ */ r.createElement(
      ...
      (Ne) => {
        const ct = a.visualizationType !== "Forest Plot" ? (Ne.axisToPoint.x - Ne.axisFromPoint.x) / 2 : i[0] / 2, dt = (mt) => /\s/.test(mt), $ = Ne.ticks.some((mt) => dt(mt.value)), _e = 8, Xe = Math.max(...Ne.ticks.map((mt) => S(mt.formattedValue, `normal ${Tn[a.fontSize]}px sans-serif`))), Ve = $ ? 180 : 100, it = Ne.ticks.map((mt) => S(mt.formattedValue, `normal ${Tn[a.fontSize]}px sans-serif`)), nt = it.reduce((mt, Ot) => mt + Ot, Ve), Et = (X - nt) / (Ne.ticks.length - 1);
        let Dt = [0];
        for (let mt = 1; mt < it.length; mt++)
          Dt[mt] = Dt[mt - 1] + it[mt - 1] + Et;
        let Ze = !1;
        it.forEach((mt, Ot) => {
          if (Dt[Ot] + it[Ot] > Dt[Ot + 1]) {
            Ze = !0;
            return;
          }
        });
        const Kt = Ze && a.isResponsiveTicks ? Xe + _e + 20 : 0;
        Number(a.xAxis.tickRotation) > 0 && Number(a.xAxis.tickRotation), a.dynamicMarginTop = Kt, a.xAxis.tickWidthMax = Xe;
        let zt = 40;
        const Ft = /* @__PURE__ */ r.createElement(at, { className: "bottom-axis", width: i[0] }, Ne.ticks.map((mt, Ot, Tt) => {
          const Yt = String(mt.value).startsWith("1") || mt.value === 0.1 ? "block" : "none", Wt = Yt === "block" ? 16 : _e, dn = { x: mt.to.x, y: Wt }, sn = S(mt.formattedValue, `normal ${Tn[a.fontSize]}px sans-serif`), nn = 100 / Tt.length;
          ...
          return En > zt && (zt = En), /* @__PURE__ */ r.createElement(at, { key: `vx-tick-${mt.value}-${Ot}`, className: "vx-axis-tick" }, !a.xAxis.hideTicks && /* @__PURE__ */ r.createElement(an, { from: mt.from, to: w === "horizontal" && a.useLogScale ? dn : mt.to, stroke: a.xAxis.tickColor, strokeWidth: Yt === "block" && a.useLogScale ? 1.3 : 1 }), !a.xAxis.hideLabel && /* @__PURE__ */ r.createElement(
            kt,
            {
    ...
    k === "Paired Bar" && Mn(),
    k === "Deviation Bar" && ((Sn = a.series) == null ? void 0 : Sn.length) === 1 && /* @__PURE__ */ r.createElement(wE, { animatedChart: ue, xScale: Ke, yScale: We, width: X, height: B }),
    ...
    !["Paired Bar", "Box Plot", "Area Chart", "Scatter Plot", "Deviation Bar", "Forecasting", "Bar"].includes(k) && !O() && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(Dh, { xScale: Ke, yScale: We, getXAxisData: Ee, getYAxisData: he, xMax: X, yMax: B, seriesStyle: a.series })),
    ...
    a.visualizationType !== "Bar" && a.visualizationType !== "Combo" && /* @__PURE__ */ r.createElement(qf, { xScale: Ke, handleTooltipClick: xt, handleTooltipMouseOff: Ht, handleTooltipMouseOver: ze, showTooltip: Nt, hideTooltip: hn, tooltipData: vt, yMax: B, width: L }),
...
const YE = (e) => {
  ...
  let v = Number(t);
  const { minValue: S, maxValue: R } = Lc(a, i), k = { top: 5, right: 10, bottom: 10, left: 10 }, F = Number(n), w = v - a.runtime.yAxis.size, m = F - k.top - 20, _ = (V) => a.runtime.xAxis.type === "date" ? l(V[a.runtime.originalXAxis.dataKey]).getTime() : V[a.runtime.originalXAxis.dataKey], N = (V, K) => V[K];
  let P, O;
  ...
  if (i) {
    ...
    a.runtime.horizontal ? (P = Kn({
      domain: [V, K],
      range: [0, w]
    }), O = a.runtime.xAxis.type === "date" ? Kn({ domain: [Math.min(...X), Math.max(...X)] }) : Bo({ domain: X, padding: 0.5 }), Bo({
      domain: a.runtime.barSeriesKeys || a.runtime.seriesKeys,
      range: [0, m]
    }), O.rangeRound([0, m])) : (V = V < 0 ? V * 1.11 : V, O = Kn({
      domain: [V, K],
  ...
  return /* @__PURE__ */ r.createElement(Or, { component: "SparkLine" }, /* @__PURE__ */ r.createElement("svg", { role: "img", "aria-label": y(a), width: t, height: 100, className: "sparkline", tabIndex: 0 }, /* @__PURE__ */ r.createElement("title", null, `Spark line graphic with the title ${a.title ? a.title : "No Title Found"}`), ((te = a.runtime.lineSeriesKeys) == null ? void 0 : te.length) > 0 ? a.runtime.lineSeriesKeys : a.runtime.seriesKeys.map((V, K) => /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(
    ...
    i.map((X, B) => /* @__PURE__ */ r.createElement(at, { key: `series-${V}-point-${B}` }, /* @__PURE__ */ r.createElement(kt, { display: a.labels ? "block" : "none", x: P(_(X)), y: O(N(X, V)), fill: h ? h(a.runtime.seriesLabels ? a.runtime.seriesLabels[V] : V) : "#000", textAnchor: "middle" }, u(X[V])))),
    /* @__PURE__ */ r.createElement(
      Kr,
      {
        curve: vc,
  ...
  return /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, e, (!t.forestPlot.estimateField || !t.forestPlot.upper || !t.forestPlot.lower) && /* @__PURE__ */ r.createElement(zu, { width: "25", className: "warning-icon" }))), /* @__PURE__ */ r.createElement(On, null, /* @__PURE__ */ r.createElement(
    Lt,
    {
  ...
  if (i.type === "Forecasting")
    return /* @__PURE__ */ r.createElement("div", { className: "edit-block" }, /* @__PURE__ */ r.createElement("span", { className: "edit-label column-heading" }, "Confidence Interval Groups"), /* @__PURE__ */ r.createElement("fieldset", null, /* @__PURE__ */ r.createElement(Pi, { allowZeroExpanded: !0 }, (f = i == null ? void 0 : i.confidenceIntervals) == null ? void 0 : f.map((d, u) => {
      ...
      return /* @__PURE__ */ r.createElement(Rn, { className: "series-item series-item--chart", key: `${u}` }, /* @__PURE__ */ r.createElement(Nn, { className: "series-item__title" }, /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(Dn, { className: "accordion__button accordion__button" }, "Group ", u + 1, /* @__PURE__ */ r.createElement(
        "button",
        {
  ...
  return /* @__PURE__ */ r.createElement(r.Fragment, null, e.regions && e.regions.map(({ label: u, color: h, from: y, to: v, background: S, range: R = "Custom" }, k) => {
    ...
    return /* @__PURE__ */ r.createElement("div", { className: "edit-block", key: `region-${k}` }, /* @__PURE__ */ r.createElement(
      ...
      "Remove"
    ), /* @__PURE__ */ r.createElement(Qe, { value: u, label: "Region Label", fieldName: "label", i: k, updateField: i }), /* @__PURE__ */ r.createElement("div", { className: "two-col-inputs" }, /* @__PURE__ */ r.createElement(Qe, { value: h, label: "Text Color", fieldName: "color", updateField: (w, m, _, N) => n(_, N, k) }), /* @__PURE__ */ r.createElement(Qe, { value: S, label: "Background", fieldName: "background", updateField: (w, m, _, N) => n(_, N, k) })), /* @__PURE__ */ r.createElement(
      Lt,
      {
    ...
    ), (e.regions[k].toType === "Fixed" || !e.regions[k].toType) && /* @__PURE__ */ r.createElement(Qe, { value: v, label: "To Value", fieldName: "to", updateField: (w, m, _, N) => n(_, N, k) }));
  ...
  return t() ? /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, e)), /* @__PURE__ */ r.createElement(On, null, /* @__PURE__ */ r.createElement(uk, { config: n, updateConfig: i }))) : null;
  ...
  return /* @__PURE__ */ r.createElement(Rn, null, " ", /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, "General")), /* @__PURE__ */ r.createElement(On, null, /* @__PURE__ */ r.createElement(Lt, { value: y, fieldName: "visualizationType", label: "Chart Type", updateField: n, options: i }), d() && t.orientation === "vertical" && /* @__PURE__ */ r.createElement(
    Qe,
    {
      type: "number",
  ...
  return /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, e.name)), /* @__PURE__ */ r.createElement(On, null, /* @__PURE__ */ r.createElement("h4", { style: { fontSize: "18px" } }, "Labels for 5-Number Summary"), /* @__PURE__ */ r.createElement(
    Qe,
    {
      type: "text",
  ...
  return /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, "Visual")), /* @__PURE__ */ r.createElement(On, null, t.isLollipopChart && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement("fieldset", { className: "header" }, /* @__PURE__ */ r.createElement("legend", { className: "edit-label" }, "Lollipop Shape"), /* @__PURE__ */ r.createElement(
    "div",
    {
      onChange: (W) => {
        f(W.target.value);
  ...
  }))), y() && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement("span", null, "Non-Sequential"), /* @__PURE__ */ r.createElement("ul", { className: "color-palette" }, O.map((W) => {
    const Z = {
      backgroundColor: i[W][2]
    }, ce = {
...
const gk = ({ config: e, updateConfig: t, data: n }) => {
  var w, m, _;
  const i = e.visualizationType === "Combo", a = ((w = e.runtime.lineSeriesKeys) == null ? void 0 : w.length) > 0, l = ((m = e.runtime.barSeriesKeys) == null ? void 0 : m.length) > 0, f = i && a, d = i && l, u = () => ar.uniq(ar.flatMap(n, ar.keys)), h = () => e.visualizationType === "Line" || f ? ["effect", "suppression"] : ["suppression"], y = {
    "Dashed Small": "- - -",
    "Dashed Medium": "– –",
    "Dashed Large": "— –",
    "Open Circles": "◯"
  ...
  let R = (N) => {
    ...
    let L = [];
    e.preliminaryData && (L = [...e.preliminaryData]), L[O][N] = P, N === "symbol" && (L[O].iconCode = mp[P]), N === "style" && (L[O].lineCode = y[P]), t({ ...e, preliminaryData: L });
  };
  return /* @__PURE__ */ r.createElement(r.Fragment, null, e.preliminaryData && ((_ = e.preliminaryData) == null ? void 0 : _.map(({ column: N, displayLegend: P, displayTable: O, displayTooltip: L, label: U, seriesKey: W, style: Z, symbol: ce, type: te, value: V, hideBarSymbol: K, hideLineStyle: X }, B) => {
    var oe, re;
    return /* @__PURE__ */ r.createElement("div", { key: `preliminaryData-${B}`, className: "edit-block" }, /* @__PURE__ */ r.createElement("p", null, " ", te === "suppression" ? "Suppressed" : "Effect", " Data"), /* @__PURE__ */ r.createElement(
      ...
      "Remove"
    ), /* @__PURE__ */ r.createElement(Lt, { value: te, initial: e.visualizationType == "Bar" ? "" : "Select", fieldName: "type", label: "Type", updateField: (le, q, j, J) => F(j, J, B), options: h() }), te === "suppression" ? /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(
      Lt,
      {
        ...
        updateField: (le, q, j, J) => F(j, J, B),
        options: (oe = e.runtime) == null ? void 0 : oe.seriesKeys
      }
    ), /* @__PURE__ */ r.createElement(Qe, { value: V, fieldName: "value", label: "Suppressed Data  Value", updateField: (le, q, j, J) => F(j, J, B) }), (f || e.visualizationType === "Line") && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(
      Lt,
      {
    ...
    ), /* @__PURE__ */ r.createElement(ot, { value: X, fieldName: "hideLineStyle", label: "Hide Suppressed line Style", updateField: (le, q, j, J) => F(j, J, B) })), (d || e.visualizationType === "Bar") && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(
      Lt,
      {
    ...
    ), /* @__PURE__ */ r.createElement(ot, { value: K, fieldName: "hideBarSymbol", label: "Hide Suppressed Bar Symbol  ", updateField: (le, q, j, J) => F(j, J, B) })), /* @__PURE__ */ r.createElement(
      Qe,
      {
    ...
    )) : /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(Lt, { value: W, initial: "Select", fieldName: "seriesKey", label: "ASSOCIATE TO SERIES", updateField: (le, q, j, J) => F(j, J, B), options: e.runtime.lineSeriesKeys ?? ((re = e.runtime) == null ? void 0 : re.seriesKeys) }), /* @__PURE__ */ r.createElement(Lt, { value: N, initial: "Select", fieldName: "column", label: "COLUMN WITH CONFIGURATION VALUE", updateField: (le, q, j, J) => F(j, J, B), options: u() }), /* @__PURE__ */ r.createElement(Qe, { value: V, fieldName: "value", label: "VALUE TO TRIGGER", updateField: (le, q, j, J) => F(j, J, B) }), /* @__PURE__ */ r.createElement(Lt, { value: Z, initial: "Select", fieldName: "style", label: "Style", updateField: (le, q, j, J) => F(j, J, B), options: v(te) }), /* @__PURE__ */ r.createElement(Qe, { value: U, fieldName: "label", label: "Label", placeholder: "", updateField: (le, q, j, J) => F(j, J, B) })));
  ...
  const {
    ...
    highlightReset: _,
    dimensions: N
  } = de.useContext(Ct), { minValue: P, maxValue: O, existPositiveValue: L, isAllLine: U } = Lc(e, u), W = { data: i, config: e }, { leftMax: Z, rightMax: ce } = Ty(W), {
    headerColors: te,
    ...
    visSupportsDateCategoryAxisPadding: Te,
  ...
  const { hasRightAxis: hn } = Zf({ config: e, yMax: e.yAxis.size, data: e.data, updateConfig: t }), on = (ie, se) => ({
    ...
    let wn = gn ? [...e[ie], Re] : { ...e[ie], [me]: Re };
    bt(se) && (gn ? (wn = [...e[ie]], wn[se] = { ...wn[se], [me]: Re }) : typeof Re == "string" ? wn[se] = Re : bt(me) && (wn = { ...e[ie], [se]: { ...e[ie][se], [me]: Re } }));
    let fr = { ...e, [ie]: wn };
    yn(fr), t(fr);
  ...
  const Wn = e.orientation === "horizontal" ? "xAxis" : "yAxis", [An, Sn] = de.useState({ maxMsg: "", minMsg: "", rightMaxMessage: "", minMsgRight: "" }), Ne = () => {
    ...
    if (e.visualizationType !== "Combo")
      switch (!0) {
        case (ie && parseFloat(ie) < parseFloat(O) && L):
  ...
  } = Sc(e, t), Tt = e.visualizationType === "Bar" && e.visualizationSubType === "regular" && e.runtime.seriesKeys.length === 1, Yt = () => {
    const ie = i.map((se) => se[e.legend.colorCode]);
    return Tt ? ie : Jt(!1).filter((se) => se !== e.xAxis.dataKey);
  }, Wt = (ie) => {
  ...
  return /* @__PURE__ */ r.createElement(Qf.Provider, { value: nn }, /* @__PURE__ */ r.createElement(Or, { component: "EditorPanel" }, /* @__PURE__ */ r.createElement(Ud.Sidebar, { displayPanel: xt, isDashboard: y, title: "Configure Chart", onBackClick: Mn }, /* @__PURE__ */ r.createElement(Pi, { allowZeroExpanded: !0 }, /* @__PURE__ */ r.createElement(Da.General, { name: "General" }), /* @__PURE__ */ r.createElement(Da.ForestPlot, { name: "Forest Plot Settings" }), /* @__PURE__ */ r.createElement(Da.Sankey, { name: "Sankey" }), e.visualizationType !== "Pie" && e.visualizationType !== "Forest Plot" && e.visualizationType !== "Sankey" && /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, "Data Series ", (!e.series || e.series.length === 0 || e.visualizationType === "Paired Bar" && e.series.length < 2) && /* @__PURE__ */ r.createElement(zu, { width: "25", className: "warning-icon" }))), /* @__PURE__ */ r.createElement(On, null, (!e.series || e.series.length === 0) && e.visualizationType !== "Paired Bar" && /* @__PURE__ */ r.createElement("p", { className: "warning" }, "At least one series is required"), (!e.series || e.series.length === 0 || e.series.length < 2) && e.visualizationType === "Paired Bar" && /* @__PURE__ */ r.createElement("p", { className: "warning" }, "Select two data series for paired bar chart (e.g., Male and Female)."), /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(
    Lt,
    {
  ...
  ), e.series && e.series.length !== 0 && /* @__PURE__ */ r.createElement(Da.Series.Wrapper, { getColumns: Jt }, /* @__PURE__ */ r.createElement("fieldset", null, /* @__PURE__ */ r.createElement("legend", { className: "edit-label float-left" }, "Displaying"), /* @__PURE__ */ r.createElement(ve, { style: { textTransform: "none" } }, /* @__PURE__ */ r.createElement(ve.Target, null, /* @__PURE__ */ r.createElement(ft, { display: "question", style: { marginLeft: "0.5rem" } })), /* @__PURE__ */ r.createElement(ve.Content, null, /* @__PURE__ */ r.createElement("p", null, "A data series is a set of related data points plotted in a chart and typically represented in the chart legend.")))), /* @__PURE__ */ r.createElement(Dy, { onDragEnd: ({ source: ie, destination: se }) => zn(ie.index, se.index) }, /* @__PURE__ */ r.createElement(Oy, { droppableId: "filter_order" }, (ie) => /* @__PURE__ */ r.createElement("ul", { ...ie.droppableProps, className: "series-list", ref: ie.innerRef }, /* @__PURE__ */ r.createElement(Da.Series.List, { series: e.series, getItemStyle: on, sortableItemStyles: qt, chartsWithOptions: Xe }), ie.placeholder))))), e.series && e.series.length <= 1 && e.visualizationType === "Bar" && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement("span", { className: "divider-heading" }, "Confidence Keys"), /* @__PURE__ */ r.createElement(Lt, { value: e.confidenceKeys.upper || "", section: "confidenceKeys", fieldName: "upper", label: "Upper", updateField: ze, initial: "Select", options: Jt() }), /* @__PURE__ */ r.createElement(Lt, { value: e.confidenceKeys.lower || "", section: "confidenceKeys", fieldName: "lower", label: "Lower", updateField: ze, initial: "Select", options: Jt() })), tn() && e.series && e.series.length === 1 && /* @__PURE__ */ r.createElement(Lt, { fieldName: "visualizationType", label: "Rank by Value", initial: "Select", onChange: (ie) => ln(ie.target.value), options: ["asc", "desc"] }), et() && /* @__PURE__ */ r.createElement(gk, { config: e, updateConfig: t, data: i }))), /* @__PURE__ */ r.createElement(Da.BoxPlot, { name: "Measures" }), ut() && /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, e.visualizationType === "Pie" ? "Data Format" : e.orientation === "vertical" ? "Left Value Axis" : "Value Axis", e.visualizationType === "Pie" && !e.yAxis.dataKey && /* @__PURE__ */ r.createElement(zu, { width: "25", className: "warning-icon" }))), /* @__PURE__ */ r.createElement(On, null, e.visualizationType === "Pie" && /* @__PURE__ */ r.createElement(
    Lt,
    {
    ...
    "Remove"
  )))), /* @__PURE__ */ r.createElement(On, null, /* @__PURE__ */ r.createElement("label", null, /* @__PURE__ */ r.createElement("span", null, "Anchor Value"), /* @__PURE__ */ r.createElement(ve, { style: { textTransform: "none" } }, /* @__PURE__ */ r.createElement(ve.Target, null, /* @__PURE__ */ r.createElement(ft, { display: "question", style: { marginLeft: "0.5rem" } })), /* @__PURE__ */ r.createElement(ve.Content, null, /* @__PURE__ */ r.createElement("p", null, "Enter the value as its shown in the data column"))), /* @__PURE__ */ r.createElement(
    "input",
    {
      type: "text",
  ...
  )), /* @__PURE__ */ r.createElement(ot, { value: e.xAxis.manual, section: "xAxis", fieldName: "manual", label: "Manual Ticks", updateField: ze }), Te() && /* @__PURE__ */ r.createElement(
    Qe,
    {
  ...
  ))))), Oe() && (e.xAxis.type === "date-time" || !e.xAxis.manual) && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(
    Qe,
    {
    ...
    "Add Anchor"
  )))), /* @__PURE__ */ r.createElement(Da.Regions, { name: "Regions" }), e.visualizationType !== "Box Plot" && /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, "Columns")), /* @__PURE__ */ r.createElement(On, null, /* @__PURE__ */ r.createElement(ng, { config: e, updateField: ze, deleteColumn: it }), " ")), De() && /* @__PURE__ */ r.createElement(Rn, null, /* @__PURE__ */ r.createElement(Nn, null, /* @__PURE__ */ r.createElement(Dn, null, "Legend")), /* @__PURE__ */ r.createElement(On, null, /* @__PURE__ */ r.createElement(ot, { value: e.legend.reverseLabelOrder, section: "legend", fieldName: "reverseLabelOrder", label: "Reverse Labels", updateField: ze }), /* @__PURE__ */ r.createElement(
    ot,
    {
      value: !!e.legend.hide,
      section: "legend",
    ...
    "button",
    {
      ...
      onClick: (me) => {
        ...
        Re.splice(se, 1), ze("legend", null, "seriesHighlight", Re), Re.length || _();
      }
    },
    "Remove"
  ), /* @__PURE__ */ r.createElement(
...
function eT({ configUrl: e, config: t, isEditor: n = !1, isDebug: i = !1, isDashboard: a = !1, setConfig: l, setEditing: f, hostname: d, link: u, setSharedFilter: h, setSharedFilterValue: y, dashboardConfig: v }) {
  var Pn, Mn, Hn, Ut, zn, Wn, An, Sn, Ne, ct, dt;
  const S = new ug(), [R, k] = de.useState(!0), [F, w] = de.useState(null), [m, _] = de.useState({}), [N, P] = de.useState(m.data || []), [O, L] = de.useState(void 0), [U, W] = de.useState(void 0), [Z, ce] = de.useState(t && ((Mn = (Pn = t == null ? void 0 : t.legend) == null ? void 0 : Pn.seriesHighlight) != null && Mn.length) ? [...(Hn = t == null ? void 0 : t.legend) == null ? void 0 : Hn.seriesHighlight] : []), [te, V] = de.useState("lg"), [K, X] = de.useState([]), [B, oe] = de.useState(), [re, le] = de.useState(), [q, j] = de.useState(!1), [J, ue] = de.useState([]), [De] = de.useState(`cove-${Math.random().toString(16).slice(-4)}`), [be, ye] = de.useState({
    data: [],
    isActive: !1,
    isBrushing: !1
  });
  ...
  const { barBorderClass: Pe, lineDatapointClass: ee, contentClasses: Oe, sparkLineStyles: Te } = ig(m), Ue = de.useId(), qe = (Wn = m.legend) != null && Wn.hide ? m != null && m.title ? `dataTableSection__${m.title.replace(/\s/g, "")}` : "dataTableSection" : Ue, et = () => Ac(m.visualizationType, U, m.allowLineToBarGraph), Je = async () => {
    var $;
    if (m.dataUrl) {
      const _e = new URL(m.runtimeDataUrl || m.dataUrl, window.location.origin);
      ...
      if (($ = m.filters) == null || $.forEach((Et) => {
        ...
        return;
      let it = `${_e.origin}${_e.pathname}${Object.keys(Xe).map((Et, Dt) => {
        let Ze = Dt === 0 ? "?" : "&";
        return Ze += Et + "=", Ze += Xe[Et], Ze;
      }).join("")}`, nt = [];
      try {
        const Et = Mh(_e.href);
        Et === "csv" || tp(it) ? nt = await fetch(it).then((Dt) => Dt.text()).then((Dt) => ap.parse(Dt, {
          header: !0,
          dynamicTyping: !0,
          skipEmptyLines: !0
        }).data) : Et === "json" || np(it) ? nt = await fetch(it).then((Dt) => Dt.json()) : nt = [];
      } catch {
    ...
    let $ = t || await (await fetch(e)).json(), _e = $.data || [];
    const Xe = $.filters ? $.filters.filter((nt) => nt.type === "url").length > 0 : !1;
    if ($.dataUrl && !Xe)
      try {
        const nt = Mh($.dataUrl);
        (nt === "csv" || tp($.dataUrl)) && (_e = await fetch($.dataUrl + `?v=${gp()}`).then((Et) => Et.text()).then((Et) => (Et = Et.replace(/(".*?")|,/g, (...Ze) => Ze[1] || "|"), Et = Et.replace(/["]+/g, ""), ap.parse(Et, {
        ...
        }).data))), (nt === "json" || np($.dataUrl)) && (_e = await fetch($.dataUrl + `?v=${gp()}`).then((Et) => Et.json()));
      } catch {
        console.error(`COVE: Cannot parse URL: ${$.dataUrl}`), _e = [];
      }
    $.dataDescription && (_e = S.autoStandardize(_e), _e = S.developerStandardize(_e, $.dataDescription)), _e && (P(_e), L(_e)), $ !== void 0 && $.table !== void 0 && (!$.table || !$.table.showVertical) && ($.table = $.table || {}, $.table.showVertical = !1);
    let Ve = { ...jd, ...$ };
    Ve.filters && Ve.filters.forEach((nt, Et) => {
      const Dt = Fy(nt);
      Dt && (Ve.filters[Et].active = Dt);
    ...
    if ($.exclusions && $.exclusions.active)
      if ($.xAxis.type === "categorical" && ((nt = $.exclusions.keys) == null ? void 0 : nt.length) > 0)
        ...
        const Ze = (Ot) => new Date(Ot).getTime();
        ...
        Ft && mt ? Ve = Xe.filter((Ot) => Ze(Ot[$.xAxis.dataKey]) >= Kt && Ze(Ot[$.xAxis.dataKey]) <= zt) : Ft ? Ve = Xe.filter((Ot) => Ze(Ot[$.xAxis.dataKey]) >= Kt) : mt && (Ve = Xe.filter((Ot) => Ze(Ot[$.xAxis.dataKey]) <= zt));
      } else
        Ve = _e || N;
    else
      Ve = _e || N;
    ...
    if ($.filters && ($.filters.forEach((Ze, Kt) => {
      ...
      Ft.forEach((Tt) => {
        try {
          ...
          let Yt = Ve ? Ve.filter((g) => g[$.xAxis.dataKey] === Tt) : Xe.filter((g) => g[$.xAxis.dataKey] === Tt), Wt = Yt.map((g) => {
            var C;
      ...
      }), mt = JSON.parse(JSON.stringify(Ot)), mt.map((Tt) => (Tt.columnIqr = void 0, Tt.nonOutlierValues = void 0, Tt.columnLowerBounds = void 0, Tt.columnUpperBounds = void 0, null)), $.boxplot.allValues = Kt, $.boxplot.categories = Ft, $.boxplot.plots = Ot, $.boxplot.tableData = mt;
    }
    ...
    let Xe = m.visualizationType === "Bar" && m.visualizationSubType === "horizontal" ? m.xAxis.dataKey : m.yAxis.sortKey, Ve = parseFloat($[Xe]), it = parseFloat(_e[Xe]);
    return Ve < it ? m.sortData === "ascending" ? 1 : -1 : Ve > it ? m.sortData === "ascending" ? -1 : 1 : 0;
  }, $e = new Py(($) => {
    for (let _e of $) {
      let { width: Xe, height: Ve } = _e.contentRect, it = Ry(Xe), nt = 32, Et = 350;
      V(it), n && (Xe = Xe - Et), _e.target.dataset.lollipop === "true" && (Xe = Xe - 2.5), Xe = Xe - nt, X([Xe, Ve]);
    }
  }), ht = de.useCallback(($) => {
    $ !== null && $e.observe($), le($);
  }, []);
  ...
  de.useEffect(() => {
    ...
    re && !Ge(m) && !q && (og("cove_loaded", { config: m }), j(!0));
  }, [re, m]), de.useEffect(() => {
    const $ = (_e) => {
      let Xe = [];
      Xe.push(_e.detail), oe(Xe);
    };
    return lg("cove_filterData", (_e) => $(_e)), () => {
      sg("cove_filterData", $);
    };
  }, [m]), de.useEffect(() => {
    if (B && B[0] && !B[0].hasOwnProperty("active")) {
      let _e = { ...m };
      delete _e.filters, _(_e), W(bi(B, O));
    }
    ...
    if (N && m.xAxis && (($ = m.runtime) != null && $.seriesKeys)) {
      const _e = ["Paired Bar", "Deviation Bar"].includes(m.visualizationType) ? m.twoColor.palette : m.palette, Xe = { ...dr, ...Iu };
      let Ve = m.customColors || Xe[_e], it = m.runtime.seriesKeys.length, nt;
      for (; it > Ve.length; )
        Ve = Ve.concat(Ve);
  ...
  const pt = ($) => {
    ...
    }), _e.indexOf(Xe) !== -1 ? _e.splice(_e.indexOf(Xe), 1) : _e.push(Xe), ce(_e);
  }, gt = () => {
    try {
      const $ = Le.current;
      if (!$)
    ...
    ce([]);
  }, ut = m.orientation === "horizontal" ? "yAxis" : "xAxis", Rt = ($, _e = !0) => {
    let Xe = bm(m.runtime[ut].dateParseFormat)($);
    return Xe || (_e && (m.runtime.editorErrorMessage = `Error parsing date "${$}". Try reviewing your data and date parse settings in the X Axis section.`), /* @__PURE__ */ new Date());
  ...
  function vt($, _e) {
    ...
    return Ve.font = _e || getComputedStyle(document.body).font, Math.ceil(Ve.measureText($).width);
  }
  const Nt = ($, _e, Xe = !1, Ve, it, nt) => {
    if (isNaN($) || !$)
      return $;
    const Et = $ < 0;
    (_e === void 0 || !_e) && (_e = "left"), Et && ($ = Math.abs($));
    let {
      dataFormat: { commas: Dt, abbreviated: Ze, roundTo: Kt, prefix: zt, suffix: Ft, rightRoundTo: mt, bottomRoundTo: Ot, rightPrefix: Tt, rightSuffix: Yt, bottomPrefix: Wt, bottomSuffix: dn, bottomAbbreviated: sn }
    } = m;
    ...
    const En = () => m.forestPlot.type === "Logarithmic" && !Ot ? 2 : Number(Ot) ? Number(Ot) : 0;
    if (_e === "bottom" && (Zt = {
    ...
    _e === "left" && Dt && Ze && Xe || _e === "bottom" && Dt && Ze && Xe ? $ = $ : $ = $.toLocaleString("en-US", Zt);
    let un = "";
    return Ze && _e === "left" && Xe && ($ = _h(parseFloat($))), sn && _e === "bottom" && Xe && ($ = _h(parseFloat($))), Ve && _e === "left" ? un = Ve + un : zt && _e === "left" && (un += zt), Tt && _e === "right" && (un += Tt), Wt && _e === "bottom" && (un += Wt), un += $, it && _e === "left" ? un += it : Ft && _e === "left" && (un += Ft), Yt && _e === "right" && (un += Yt), dn && _e === "bottom" && (un += dn), Et && (un = "-" + un), String(un);
  }, hn = {
    ...
    try {
      ...
      if (m.type === "navigation") {
        let _e = dr[m.color] || dr.bluegreenreverse;
        return Fh(_e[3]);
      }
      return Fh();
    } catch (_e) {
    ...
    var _e;
    return Array.isArray($) ? m.visualizationType === "Forecasting" ? $ : (_e = m == null ? void 0 : m.xAxis) != null && _e.dataKey ? S.cleanData($, m.xAxis.dataKey) : $ : [];
  }, It = ($) => $;
  ...
  const xn = ($) => {
    ...
    var Xe, Ve, it;
    const $ = (ae == null ? void 0 : ae.position) === "bottom" || ["sm", "xs", "xxs"].includes(te), _e = ["chart-container", "p-relative"];
    return ((Xe = m.legend) == null ? void 0 : Xe.position) === "bottom" && _e.push("bottom"), (Ve = m.legend) != null && Ve.hide && _e.push("legend-hidden"), ee && _e.push(ee), m.barHasBorder || _e.push("chart-bar--no-border"), (it = m.brush) != null && it.active && (v == null ? void 0 : v.type) === "dashboard" && (!$ || m.legend.hide) && _e.push("dashboard-brush"), _e.push(...Oe), _e;
  }, ln = () => {
    var Xe, Ve;
    const $ = ["subtext "], _e = (ae == null ? void 0 : ae.position) === "bottom" || ["sm", "xs", "xxs"].includes(te);
    return m.isResponsiveTicks && $.push("subtext--responsive-ticks "), (Xe = m.brush) != null && Xe.active && !_e && $.push("subtext--brush-active "), (Ve = m.brush) != null && Ve.active && m.legend.hide && $.push("subtext--brush-active "), $;
  };
  if (!R) {
    const $ = /* @__PURE__ */ r.createElement("a", { href: `#data-table-${m.dataKey}`, className: "margin-left-href" }, m.dataKey, " (Go to Table)");
    At = /* @__PURE__ */ r.createElement(r.Fragment, null, n && /* @__PURE__ */ r.createElement(vk, null), /* @__PURE__ */ r.createElement(Ud.Responsive, { isEditor: n }, m.newViz && /* @__PURE__ */ r.createElement(yn, null), m.newViz === void 0 && n && m.runtime && ((An = m.runtime) == null ? void 0 : An.editorErrorMessage) && /* @__PURE__ */ r.createElement(ze, null), !on() && !m.newViz && /* @__PURE__ */ r.createElement("div", { className: `cdc-chart-inner-container cove-component__content type-${xn(m.visualizationType)}`, "aria-label": hf(m), tabIndex: 0 }, /* @__PURE__ */ r.createElement(By, { showTitle: m.showTitle, isDashboard: a, title: Ie, superTitle: m.superTitle, classes: ["chart-title", `${m.theme}`, "cove-component__header"], style: void 0 }), m.filters && !B && m.visualizationType !== "Spark Line" && /* @__PURE__ */ r.createElement(rp, { config: m, setConfig: _, setFilteredData: W, filteredData: U, excludedData: O, filterData: bi, dimensions: K }), /* @__PURE__ */ r.createElement(Uy, { skipId: qe, skipMessage: "Skip Over Chart Container" }), (m == null ? void 0 : m.introText) && m.visualizationType !== "Spark Line" && /* @__PURE__ */ r.createElement("section", { className: "introText" }, Li(m.introText)), /* @__PURE__ */ r.createElement("div", { className: Mt().join(" ") }, m.visualizationType !== "Spark Line" && m.visualizationType !== "Line" && hn[m.visualizationType], m.visualizationType === "Line" && (et() ? hn.Bar : hn.Line), m.visualizationType === "Spark Line" && /* @__PURE__ */ r.createElement(r.Fragment, null, /* @__PURE__ */ r.createElement(rp, { config: m, setConfig: _, setFilteredData: W, filteredData: U, excludedData: O, filterData: bi, dimensions: K }), (m == null ? void 0 : m.introText) && /* @__PURE__ */ r.createElement("section", { className: "introText", style: { padding: "0px 0 35px" } }, Li(m.introText)), /* @__PURE__ */ r.createElement("div", { style: { height: "100px", width: "100%", ...Te } }, /* @__PURE__ */ r.createElement(_p, null, (_e) => /* @__PURE__ */ r.createElement(YE, { width: _e.width, height: _e.height }))), Ee && /* @__PURE__ */ r.createElement("div", { className: "subtext", style: { padding: "35px 0 15px" } }, Li(Ee))), m.visualizationType === "Sankey" && /* @__PURE__ */ r.createElement(_p, { "aria-hidden": "true" }, (_e) => /* @__PURE__ */ r.createElement(VS, { runtime: m.runtime, width: _e.width, height: _e.height })), !m.legend.hide && m.visualizationType !== "Spark Line" && m.visualizationType !== "Sankey" && /* @__PURE__ */ r.createElement(XE, { ref: Le })), a && m.table && m.table.show && m.table.showDataTableLink ? $ : u && u, Ee && m.visualizationType !== "Spark Line" && /* @__PURE__ */ r.createElement("div", { className: ln().join("") }, Li(Ee)), !1, /* @__PURE__ */ r.createElement(kd.Section, { classes: ["download-buttons"] }, m.table.showDownloadImgButton && /* @__PURE__ */ r.createElement(kd.Button, { text: "Download Image", title: "Download Chart as Image", type: "image", state: m, elementToCapture: De }), m.table.showDownloadPdfButton && /* @__PURE__ */ r.createElement(kd.Button, { text: "Download PDF", title: "Download Chart as PDF", type: "pdf", state: m, elementToCapture: De })), (m.xAxis.dataKey && m.table.show && m.visualizationType !== "Spark Line" && m.visualizationType !== "Sankey" || m.visualizationType === "Sankey" && m.table.show) && /* @__PURE__ */ r.createElement(
      Ky,
      {
        config: m,
        ...
        runtimeData: m.visualizationType === "Sankey" ? (dt = (ct = m == null ? void 0 : m.data) == null ? void 0 : ct[0]) == null ? void 0 : dt.tableData : U || O,
  ...
  return /* @__PURE__ */ r.createElement(Ct.Provider, { value: jt }, /* @__PURE__ */ r.createElement(Ud.VisualizationWrapper, { config: m, isEditor: n, currentViewport: te, ref: ht, imageId: De, showEditorPanel: m == null ? void 0 : m.showEditorPanel }, At));
}
export {
  eT as C
};
