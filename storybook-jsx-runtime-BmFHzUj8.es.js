import { r as Ce } from "./storybook-index-9_ikpx_Z.es.js";
var Z = { exports: {} }, F = {};
/**
 * @license React
...
function cr() {
  if (Se) return F;
  Se = 1;
  var M = Ce, C = Symbol.for("react.element"), U = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, A = M.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function P(h, c, T) {
...
function vr() {
  return we || (we = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var R = Object.assign, j = 0, ne, ae, oe, ie, ue, se, fe;
    function le() {
    }
    ...
    function Ne(e, r, t, n, i) {
      {
        ...
        for (var o in e)
          if (u(e, o)) {
            ...
            a && !(a instanceof Error) && (V(i), l("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, o, typeof a), V(null)), a instanceof Error && !(a.message in ve) && (ve[a.message] = !0, V(i), l("Failed %s type: %s", t, a.message), V(null));
          }
      }
    }
    ...
    function er(e, r, t, n, i) {
      {
        ...
        return Qe(e, a, v, i, n, k.current, o);
      }
    }
