import { d as Dn } from "./storybook-2d1b80a2.es.js";
import { _ as ta, m as cl, b as ra } from "./storybook-24c7e847.es.js";
...
var Dl = ra({ "node_modules/prettier/parser-html.js"(Jr, Xr) {
  (function(Ae) {
    if (typeof Jr == "object" && typeof Xr == "object")
      ...
      var Yt = typeof globalThis < "u" ? globalThis : typeof Dn.global < "u" ? Dn.global : typeof self < "u" ? self : this || {};
    ...
    var Ae = (ot, Ne) => () => (Ne || ot((Ne = { exports: {} }).exports, Ne), Ne.exports), Yt = Ae((ot, Ne) => {
      ...
      Ne.exports = Se(typeof globalThis == "object" && globalThis) || Se(typeof window == "object" && window) || Se(typeof self == "object" && self) || Se(typeof Dn.global == "object" && Dn.global) || function() {
        return this;
      ...
      var Se = Yt(), Oe = si(), ee = Se.process, V = Se.Deno, W = ee && ee.versions || V && V.version, Z = W && W.v8, Y, ne;
      ...
      var Se = un(), Oe = dr(), ee = Gn(), V = Xn(), W = Object;
      ...
      var Se = Yt(), Oe = gn(), ee = "__core-js_shared__", V = Se[ee] || Oe(ee, {});
      Ne.exports = V;
    }), zn = Ae((ot, Ne) => {
      var Se = li(), Oe = yn();
      (Ne.exports = function(ee, V) {
      ...
      var Se = Dr(), Oe = xn(), ee = Se({}.hasOwnProperty);
      ...
      var Se = Yt(), Oe = zn(), ee = kr(), V = Hn(), W = Jn(), Z = Xn(), Y = Oe("wks"), ne = Se.Symbol, Fe = ne && ne.for, je = Z ? ne : ne && ne.withoutSetter || V;
      ...
      var Se = gr(), Oe = Or(), ee = Wn(), V = hn(), W = oi(), Z = $r(), Y = TypeError, ne = Z("toPrimitive");
      ...
      var Ne = br(), Se = gr(), Oe = dn(), ee = Lr(), V = fn(), W = En(), Z = kr(), Y = Yn(), ne = Object.getOwnPropertyDescriptor;
      ...
      var Ne = br(), Se = Yn(), Oe = Di(), ee = Wr(), V = En(), W = TypeError, Z = Object.defineProperty, Y = Object.getOwnPropertyDescriptor, ne = "enumerable", Fe = "configurable", je = "writable";
      ...
      var Se = Dr(), Oe = dr(), ee = yn(), V = Se(Function.toString);
      ...
      var Se = fi(), Oe = Yt(), ee = Or(), V = Qn(), W = kr(), Z = yn(), Y = mi(), ne = eu(), Fe = "Object already initialized", je = Oe.TypeError, he = Oe.WeakMap, qe, et, Ze, nt = function(At) {
      ...
      var Se = hr(), Oe = dr(), ee = kr(), V = br(), W = di().CONFIGURABLE, Z = Zn(), Y = hi(), ne = Y.enforce, Fe = Y.get, je = Object.defineProperty, he = V && !Se(function() {
        return je(function() {
      ...
      var Se = Tn(), Oe = Math.max, ee = Math.min;
      Ne.exports = function(V, W) {
        var Z = Se(V);
        return Z < 0 ? Oe(Z + W, 0) : ee(Z, W);
      };
    }), Ci = Ae((ot, Ne) => {
      var Se = Tn(), Oe = Math.min;
      Ne.exports = function(ee) {
      ...
      var Se = fn(), Oe = Ei(), ee = tn(), V = function(W) {
      ...
      var Se = Dr(), Oe = kr(), ee = fn(), V = Fi().indexOf, W = eu(), Z = Se([].push);
      ...
      var Ne = Ai(), Se = vi(), Oe = Se.concat("length", "prototype");
      ...
      var Se = Yt(), Oe = Kn().f, ee = Qn(), V = gi(), W = gn(), Z = Ti(), Y = Bi();
      ...
      var Se = Au(), Oe = sn(), ee = Hr(), V = Se(Se.bind);
      Ne.exports = function(W, Z) {
      ...
      var Se = Cu(), Oe = tn(), ee = Fu(), V = vu(), W = function(Z, Y, ne, Fe, je, he, qe, et) {
      ...
      var Se = Ni(), Oe = dr(), ee = Br(), V = $r(), W = V("toStringTag"), Z = Object, Y = ee(function() {
        return arguments;
      ...
      var Se = Dr(), Oe = hr(), ee = dr(), V = Su(), W = un(), Z = Zn(), Y = function() {
      ...
      var Se = Cu(), Oe = xu(), ee = Or(), V = $r(), W = V("species"), Z = Array;
      ...
      var ot = an(), Ne = bu(), Se = sn(), Oe = xn(), ee = tn(), V = Tu();
      ...
      var Se = $r(), Oe = tu(), ee = Se("iterator"), V = Array.prototype;
      Ne.exports = function(W) {
        return W !== void 0 && (Oe.Array === W || V[ee] === W);
      };
    }), Bu = Ae((ot, Ne) => {
      var Se = Su(), Oe = hn(), ee = nn(), V = tu(), W = $r(), Z = W("iterator");
      Ne.exports = function(Y) {
        if (!ee(Y))
          return Oe(Y, Z) || Oe(Y, "@@iterator") || V[Se(Y)];
      };
    }), Ii = Ae((ot, Ne) => {
      var Se = gr(), Oe = sn(), ee = Wr(), V = mn(), W = Bu(), Z = TypeError;
      Ne.exports = function(Y, ne) {
      ...
      var Se = vu(), Oe = gr(), ee = Wr(), V = mn(), W = Pi(), Z = tn(), Y = Gn(), ne = Ii(), Fe = Bu(), je = ji(), he = TypeError, qe = function(Ze, nt) {
      ...
      var Se = En(), Oe = en(), ee = Lr();
      Ne.exports = function(V, W, Z) {
        var Y = Se(W);
        Y in V ? Oe.f(V, Y, ee(0, Z)) : V[Y] = Z;
      };
    }), $i = Ae(() => {
      var ot = an(), Ne = Li(), Se = Oi();
...
`);
        ...
        var _t = class {
          static create(Me) {
            let { isHost: at, type: Jt, isComponent: er, selector: Ar, exportAs: Er, changeDetection: _r, inputs: xr, outputs: Ir, host: Mr, providers: or, viewProviders: lt, queries: mt, guards: St, viewQueries: xt, entryComponents: Kt, template: sr, componentViewType: lr, rendererType: Qt, componentFactory: Kr } = Me, In = {}, jn = {}, Yu = {};
            Mr != null && Object.keys(Mr).forEach((vr) => {
              let Qr = Mr[vr], cn = vr.match(Ee);
              cn === null ? Yu[vr] = Qr : cn[1] != null ? jn[cn[1]] = Qr : cn[2] != null && (In[cn[2]] = Qr);
            });
            let Ku = {};
...
` && ++yt == ve)); )
      ...
      var Rr = je({ "node_modules/escape-string-regexp/index.js"() {
        ...
        re.exports = Ee;
      } }), Bn = he({ "node_modules/semver/internal/identifiers.js"(L, re) {
        $();
        var ge = /^[0-9]+$/, Ee = (ie, de) => {
      ...
      } }), wn = he({ "node_modules/semver/classes/semver.js"(L, re) {
        $();
        var ge = mr(), { MAX_LENGTH: Ee, MAX_SAFE_INTEGER: Pe } = rn(), { re: ie, t: de } = wr(), Ue = Fr(), { compareIdentifiers: Ge } = Bn(), gt = class {
          constructor(ce, ve) {
        ...
        $();
        var ge = wn(), Ee = (Pe, ie, de) => new ge(Pe, de).compare(new ge(ie, de));
        re.exports = Ee;
      } }), Nr = he({ "node_modules/semver/functions/lt.js"(L, re) {
        $();
        var ge = on(), Ee = (Pe, ie, de) => ge(Pe, ie, de) < 0;
        re.exports = Ee;
      } }), wu = he({ "node_modules/semver/functions/gte.js"(L, re) {
        $();
        var ge = on(), Ee = (Pe, ie, de) => ge(Pe, ie, de) >= 0;
        re.exports = Ee;
      } }), Mi = he({ "src/utils/arrayify.js"(L, re) {
        $(), re.exports = (ge, Ee) => Object.entries(ge).map((Pe) => {
          let [ie, de] = Pe;
          return Object.assign({ [Ee]: ie }, de);
        });
      } }), Nu = he({ "package.json"(L, re) {
        re.exports = { version: "2.8.8" };
      } }), qi = he({ "node_modules/outdent/lib/index.js"(L, re) {
      ...
      } }), _u = he({ "src/main/core-options.js"(L, re) {
        $();
        var { outdent: ge } = qi(), Ee = "Config", Pe = "Editor", ie = "Format", de = "Other", Ue = "Output", Ge = "Global", gt = "Special", ce = { cursorOffset: { since: "1.4.0", category: gt, type: "int", default: -1, range: { start: -1, end: Number.POSITIVE_INFINITY, step: 1 }, description: ge`
    ...
    `, cliCategory: de }, tabWidth: { type: "int", category: Ge, default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 } }, useTabs: { since: "1.0.0", category: Ge, type: "boolean", default: !1, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { since: "2.1.0", category: Ge, type: "choice", default: [{ since: "2.1.0", value: "auto" }], description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
      ...
      } }), Cn = he({ "src/main/support.js"(L, re) {
        $();
        var ge = { compare: on(), lt: Nr(), gte: wu() }, Ee = Mi(), Pe = Nu().version, ie = _u().options;
        function de() {
      ...
      } }), Vi = he({ "src/utils/is-non-empty-array.js"(L, re) {
        $();
        function ge(Ee) {
      ...
      var Gi = je({ "node_modules/strip-ansi/index.js"() {
        $(), wt();
      } });
      function Ji(L) {
      ...
      var Pu = je({ "node_modules/is-fullwidth-code-point/index.js"() {
        $();
      } }), Iu = he({ "node_modules/emoji-regex/index.js"(L, re) {
        $(), re.exports = function() {
      ...
      qe(ju, { default: () => Xi });
      function Xi(L) {
        if (typeof L != "string" || L.length === 0 || (L = ku(L), L.length === 0))
          return 0;
        L = L.replace((0, Lu.default)(), "  ");
        let re = 0;
        for (let ge = 0; ge < L.length; ge++) {
          let Ee = L.codePointAt(ge);
          Ee <= 31 || Ee >= 127 && Ee <= 159 || Ee >= 768 && Ee <= 879 || (Ee > 65535 && ge++, re += Ji(Ee) ? 2 : 1);
        }
        return re;
      }
      var Lu, Wi = je({ "node_modules/string-width/index.js"() {
        $(), Gi(), Pu(), Lu = Ze(Iu());
      } }), ru = he({ "src/utils/get-string-width.js"(L, re) {
        $();
        var ge = (Wi(), nt(ju)).default, Ee = /[^\x20-\x7F]/;
        function Pe(ie) {
          return ie ? Ee.test(ie) ? ge(ie) : ie.length : 0;
        }
        re.exports = Pe;
      } }), nu = he({ "src/utils/text/skip.js"(L, re) {
        $();
        function ge(Ue) {
          return (Ge, gt, ce) => {
      ...
      } }), Ou = he({ "src/utils/text/skip-inline-comment.js"(L, re) {
        $();
        function ge(Ee, Pe) {
          if (Pe === !1)
            return !1;
        ...
        re.exports = ge;
      } }), $u = he({ "src/utils/text/skip-trailing-comment.js"(L, re) {
        $();
        var { skipEverythingButNewLine: ge } = nu();
        function Ee(Pe, ie) {
          return ie === !1 ? !1 : Pe.charAt(ie) === "/" && Pe.charAt(ie + 1) === "/" ? ge(Pe, ie) : ie;
        }
        re.exports = Ee;
      } }), Ru = he({ "src/utils/text/skip-newline.js"(L, re) {
        $();
...
` || Ue === "\r" || Ue === "\u2028" || Ue === "\u2029")
        ...
        re.exports = ge;
      } }), zi = he({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(L, re) {
        $();
        var ge = Ou(), Ee = Ru(), Pe = $u(), { skipSpaces: ie } = nu();
        function de(Ue, Ge) {
          let gt = null, ce = Ge;
          for (; ce !== gt; )
        ...
        re.exports = de;
      } }), uu = he({ "src/common/util.js"(L, re) {
        $();
        var { default: ge } = (Rr(), nt(zr)), Ee = yr(), { getSupportInfo: Pe } = Cn(), ie = Vi(), de = ru(), { skipWhitespace: Ue, skipSpaces: Ge, skipToLineEnd: gt, skipEverythingButNewLine: ce } = nu(), ve = Ou(), Ve = $u(), He = Ru(), Je = zi(), Qe = (lt) => lt[lt.length - 2];
        function yt(lt) {
          return (mt, St, xt) => {
...
`);
      ...
      } }), iu = he({ "vendors/html-tag-names.json"(L, re) {
      ...
      } }), Fn = he({ "src/language-html/utils/array-to-map.js"(L, re) {
        $();
        function ge(Ee) {
        ...
        re.exports = ge;
      } }), Mu = he({ "src/language-html/utils/html-tag-names.js"(L, re) {
        $();
        var { htmlTagNames: ge } = iu(), Ee = Fn(), Pe = Ee(ge);
        re.exports = Pe;
      } }), qu = he({ "vendors/html-element-attributes.json"(L, re) {
      ...
      } }), Vu = he({ "src/language-html/utils/map-object.js"(L, re) {
        $();
        function ge(Ee, Pe) {
        ...
        re.exports = ge;
      } }), Hi = he({ "src/language-html/utils/html-elements-attributes.js"(L, re) {
        $();
        var { htmlElementAttributes: ge } = qu(), Ee = Vu(), Pe = Fn(), ie = Ee(ge, Pe);
        re.exports = ie;
        ...
        re.exports = ge;
      } }), Uu = he({ "src/language-html/pragma.js"(L, re) {
        $();
        function ge(Pe) {
...
` + Pe.replace(/^\s*\n/, "");
      ...
      } }), Gu = he({ "src/language-html/ast.js"(L, re) {
        $();
        ...
        re.exports = { Node: Pe };
      } }), Nn = he({ "src/language-html/conditional-comment.js"(L, re) {
        $();
      ...
      } }), su = he({ "src/language-html/loc.js"(L, re) {
        $();
        function ge(Pe) {
...
`, nexist: "∄", nexists: "∄", Nfr: "𝔑", nfr: "𝔫", ngE: "≧̸", nge: "≱", ngeq: "≱", ngeqq: "≧̸", ngeqslant: "⩾̸", nges: "⩾̸", nGg: "⋙̸", ngsim: "≵", nGt: "≫⃒", ngt: "≯", ngtr: "≯", nGtv: "≫̸", nhArr: "⇎", nharr: "↮", nhpar: "⫲", ni: "∋", nis: "⋼", nisd: "⋺", niv: "∋", NJcy: "Њ", njcy: "њ", nlArr: "⇍", nlarr: "↚", nldr: "‥", nlE: "≦̸", nle: "≰", nLeftarrow: "⇍", nleftarrow: "↚", nLeftrightarrow: "⇎", nleftrightarrow: "↮", nleq: "≰", nleqq: "≦̸", nleqslant: "⩽̸", nles: "⩽̸", nless: "≮", nLl: "⋘̸", nlsim: "≴", nLt: "≪⃒", nlt: "≮", nltri: "⋪", nltrie: "⋬", nLtv: "≪̸", nmid: "∤", NoBreak: "⁠", NonBreakingSpace: " ", Nopf: "ℕ", nopf: "𝕟", Not: "⫬", not: "¬", NotCongruent: "≢", NotCupCap: "≭", NotDoubleVerticalBar: "∦", NotElement: "∉", NotEqual: "≠", NotEqualTilde: "≂̸", NotExists: "∄", NotGreater: "≯", NotGreaterEqual: "≱", NotGreaterFullEqual: "≧̸", NotGreaterGreater: "≫̸", NotGreaterLess: "≹", NotGreaterSlantEqual: "⩾̸", NotGreaterTilde: "≵", NotHumpDownHump: "≎̸", NotHumpEqual: "≏̸", notin: "∉", notindot: "⋵̸", notinE: "⋹̸", notinva: "∉", notinvb: "⋷", notinvc: "⋶", NotLeftTriangle: "⋪", NotLeftTriangleBar: "⧏̸", NotLeftTriangleEqual: "⋬", NotLess: "≮", NotLessEqual: "≰", NotLessGreater: "≸", NotLessLess: "≪̸", NotLessSlantEqual: "⩽̸", NotLessTilde: "≴", NotNestedGreaterGreater: "⪢̸", NotNestedLessLess: "⪡̸", notni: "∌", notniva: "∌", notnivb: "⋾", notnivc: "⋽", NotPrecedes: "⊀", NotPrecedesEqual: "⪯̸", NotPrecedesSlantEqual: "⋠", NotReverseElement: "∌", NotRightTriangle: "⋫", NotRightTriangleBar: "⧐̸", NotRightTriangleEqual: "⋭", NotSquareSubset: "⊏̸", NotSquareSubsetEqual: "⋢", NotSquareSuperset: "⊐̸", NotSquareSupersetEqual: "⋣", NotSubset: "⊂⃒", NotSubsetEqual: "⊈", NotSucceeds: "⊁", NotSucceedsEqual: "⪰̸", NotSucceedsSlantEqual: "⋡", NotSucceedsTilde: "≿̸", NotSuperset: "⊃⃒", NotSupersetEqual: "⊉", NotTilde: "≁", NotTildeEqual: "≄", NotTildeFullEqual: "≇", NotTildeTilde: "≉", NotVerticalBar: "∤", npar: "∦", nparallel: "∦", nparsl: "⫽⃥", npart: "∂̸", npolint: "⨔", npr: "⊀", nprcue: "⋠", npre: "⪯̸", nprec: "⊀", npreceq: "⪯̸", nrArr: "⇏", nrarr: "↛", nrarrc: "⤳̸", nrarrw: "↝̸", nRightarrow: "⇏", nrightarrow: "↛", nrtri: "⋫", nrtrie: "⋭", nsc: "⊁", nsccue: "⋡", nsce: "⪰̸", Nscr: "𝒩", nscr: "𝓃", nshortmid: "∤", nshortparallel: "∦", nsim: "≁", nsime: "≄", nsimeq: "≄", nsmid: "∤", nspar: "∦", nsqsube: "⋢", nsqsupe: "⋣", nsub: "⊄", nsubE: "⫅̸", nsube: "⊈", nsubset: "⊂⃒", nsubseteq: "⊈", nsubseteqq: "⫅̸", nsucc: "⊁", nsucceq: "⪰̸", nsup: "⊅", nsupE: "⫆̸", nsupe: "⊉", nsupset: "⊃⃒", nsupseteq: "⊉", nsupseteqq: "⫆̸", ntgl: "≹", Ntilde: "Ñ", ntilde: "ñ", ntlg: "≸", ntriangleleft: "⋪", ntrianglelefteq: "⋬", ntriangleright: "⋫", ntrianglerighteq: "⋭", Nu: "Ν", nu: "ν", num: "#", numero: "№", numsp: " ", nvap: "≍⃒", nVDash: "⊯", nVdash: "⊮", nvDash: "⊭", nvdash: "⊬", nvge: "≥⃒", nvgt: ">⃒", nvHarr: "⤄", nvinfin: "⧞", nvlArr: "⤂", nvle: "≤⃒", nvlt: "<⃒", nvltrie: "⊴⃒", nvrArr: "⤃", nvrtrie: "⊵⃒", nvsim: "∼⃒", nwarhk: "⤣", nwArr: "⇖", nwarr: "↖", nwarrow: "↖", nwnear: "⤧", Oacute: "Ó", oacute: "ó", oast: "⊛", ocir: "⊚", Ocirc: "Ô", ocirc: "ô", Ocy: "О", ocy: "о", odash: "⊝", Odblac: "Ő", odblac: "ő", odiv: "⨸", odot: "⊙", odsold: "⦼", OElig: "Œ", oelig: "œ", ofcir: "⦿", Ofr: "𝔒", ofr: "𝔬", ogon: "˛", Ograve: "Ò", ograve: "ò", ogt: "⧁", ohbar: "⦵", ohm: "Ω", oint: "∮", olarr: "↺", olcir: "⦾", olcross: "⦻", oline: "‾", olt: "⧀", Omacr: "Ō", omacr: "ō", Omega: "Ω", omega: "ω", Omicron: "Ο", omicron: "ο", omid: "⦶", ominus: "⊖", Oopf: "𝕆", oopf: "𝕠", opar: "⦷", OpenCurlyDoubleQuote: "“", OpenCurlyQuote: "‘", operp: "⦹", oplus: "⊕", Or: "⩔", or: "∨", orarr: "↻", ord: "⩝", order: "ℴ", orderof: "ℴ", ordf: "ª", ordm: "º", origof: "⊶", oror: "⩖", orslope: "⩗", orv: "⩛", oS: "Ⓢ", Oscr: "𝒪", oscr: "ℴ", Oslash: "Ø", oslash: "ø", osol: "⊘", Otilde: "Õ", otilde: "õ", Otimes: "⨷", otimes: "⊗", otimesas: "⨶", Ouml: "Ö", ouml: "ö", ovbar: "⌽", OverBar: "‾", OverBrace: "⏞", OverBracket: "⎴", OverParenthesis: "⏜", par: "∥", para: "¶", parallel: "∥", parsim: "⫳", parsl: "⫽", part: "∂", PartialD: "∂", Pcy: "П", pcy: "п", percnt: "%", period: ".", permil: "‰", perp: "⊥", pertenk: "‱", Pfr: "𝔓", pfr: "𝔭", Phi: "Φ", phi: "φ", phiv: "ϕ", phmmat: "ℳ", phone: "☎", Pi: "Π", pi: "π", pitchfork: "⋔", piv: "ϖ", planck: "ℏ", planckh: "ℎ", plankv: "ℏ", plus: "+", plusacir: "⨣", plusb: "⊞", pluscir: "⨢", plusdo: "∔", plusdu: "⨥", pluse: "⩲", PlusMinus: "±", plusmn: "±", plussim: "⨦", plustwo: "⨧", pm: "±", Poincareplane: "ℌ", pointint: "⨕", Popf: "ℙ", popf: "𝕡", pound: "£", Pr: "⪻", pr: "≺", prap: "⪷", prcue: "≼", prE: "⪳", pre: "⪯", prec: "≺", precapprox: "⪷", preccurlyeq: "≼", Precedes: "≺", PrecedesEqual: "⪯", PrecedesSlantEqual: "≼", PrecedesTilde: "≾", preceq: "⪯", precnapprox: "⪹", precneqq: "⪵", precnsim: "⋨", precsim: "≾", Prime: "″", prime: "′", primes: "ℙ", prnap: "⪹", prnE: "⪵", prnsim: "⋨", prod: "∏", Product: "∏", profalar: "⌮", profline: "⌒", profsurf: "⌓", prop: "∝", Proportion: "∷", Proportional: "∝", propto: "∝", prsim: "≾", prurel: "⊰", Pscr: "𝒫", pscr: "𝓅", Psi: "Ψ", psi: "ψ", puncsp: " ", Qfr: "𝔔", qfr: "𝔮", qint: "⨌", Qopf: "ℚ", qopf: "𝕢", qprime: "⁗", Qscr: "𝒬", qscr: "𝓆", quaternions: "ℍ", quatint: "⨖", quest: "?", questeq: "≟", QUOT: '"', quot: '"', rAarr: "⇛", race: "∽̱", Racute: "Ŕ", racute: "ŕ", radic: "√", raemptyv: "⦳", Rang: "⟫", rang: "⟩", rangd: "⦒", range: "⦥", rangle: "⟩", raquo: "»", Rarr: "↠", rArr: "⇒", rarr: "→", rarrap: "⥵", rarrb: "⇥", rarrbfs: "⤠", rarrc: "⤳", rarrfs: "⤞", rarrhk: "↪", rarrlp: "↬", rarrpl: "⥅", rarrsim: "⥴", Rarrtl: "⤖", rarrtl: "↣", rarrw: "↝", rAtail: "⤜", ratail: "⤚", ratio: "∶", rationals: "ℚ", RBarr: "⤐", rBarr: "⤏", rbarr: "⤍", rbbrk: "❳", rbrace: "}", rbrack: "]", rbrke: "⦌", rbrksld: "⦎", rbrkslu: "⦐", Rcaron: "Ř", rcaron: "ř", Rcedil: "Ŗ", rcedil: "ŗ", rceil: "⌉", rcub: "}", Rcy: "Р", rcy: "р", rdca: "⤷", rdldhar: "⥩", rdquo: "”", rdquor: "”", rdsh: "↳", Re: "ℜ", real: "ℜ", realine: "ℛ", realpart: "ℜ", reals: "ℝ", rect: "▭", REG: "®", reg: "®", ReverseElement: "∋", ReverseEquilibrium: "⇋", ReverseUpEquilibrium: "⥯", rfisht: "⥽", rfloor: "⌋", Rfr: "ℜ", rfr: "𝔯", rHar: "⥤", rhard: "⇁", rharu: "⇀", rharul: "⥬", Rho: "Ρ", rho: "ρ", rhov: "ϱ", RightAngleBracket: "⟩", RightArrow: "→", Rightarrow: "⇒", rightarrow: "→", RightArrowBar: "⇥", RightArrowLeftArrow: "⇄", rightarrowtail: "↣", RightCeiling: "⌉", RightDoubleBracket: "⟧", RightDownTeeVector: "⥝", RightDownVector: "⇂", RightDownVectorBar: "⥕", RightFloor: "⌋", rightharpoondown: "⇁", rightharpoonup: "⇀", rightleftarrows: "⇄", rightleftharpoons: "⇌", rightrightarrows: "⇉", rightsquigarrow: "↝", RightTee: "⊢", RightTeeArrow: "↦", RightTeeVector: "⥛", rightthreetimes: "⋌", RightTriangle: "⊳", RightTriangleBar: "⧐", RightTriangleEqual: "⊵", RightUpDownVector: "⥏", RightUpTeeVector: "⥜", RightUpVector: "↾", RightUpVectorBar: "⥔", RightVector: "⇀", RightVectorBar: "⥓", ring: "˚", risingdotseq: "≓", rlarr: "⇄", rlhar: "⇌", rlm: "‏", rmoust: "⎱", rmoustache: "⎱", rnmid: "⫮", roang: "⟭", roarr: "⇾", robrk: "⟧", ropar: "⦆", Ropf: "ℝ", ropf: "𝕣", roplus: "⨮", rotimes: "⨵", RoundImplies: "⥰", rpar: ")", rpargt: "⦔", rppolint: "⨒", rrarr: "⇉", Rrightarrow: "⇛", rsaquo: "›", Rscr: "ℛ", rscr: "𝓇", Rsh: "↱", rsh: "↱", rsqb: "]", rsquo: "’", rsquor: "’", rthree: "⋌", rtimes: "⋊", rtri: "▹", rtrie: "⊵", rtrif: "▸", rtriltri: "⧎", RuleDelayed: "⧴", ruluhar: "⥨", rx: "℞", Sacute: "Ś", sacute: "ś", sbquo: "‚", Sc: "⪼", sc: "≻", scap: "⪸", Scaron: "Š", scaron: "š", sccue: "≽", scE: "⪴", sce: "⪰", Scedil: "Ş", scedil: "ş", Scirc: "Ŝ", scirc: "ŝ", scnap: "⪺", scnE: "⪶", scnsim: "⋩", scpolint: "⨓", scsim: "≿", Scy: "С", scy: "с", sdot: "⋅", sdotb: "⊡", sdote: "⩦", searhk: "⤥", seArr: "⇘", searr: "↘", searrow: "↘", sect: "§", semi: ";", seswar: "⤩", setminus: "∖", setmn: "∖", sext: "✶", Sfr: "𝔖", sfr: "𝔰", sfrown: "⌢", sharp: "♯", SHCHcy: "Щ", shchcy: "щ", SHcy: "Ш", shcy: "ш", ShortDownArrow: "↓", ShortLeftArrow: "←", shortmid: "∣", shortparallel: "∥", ShortRightArrow: "→", ShortUpArrow: "↑", shy: "­", Sigma: "Σ", sigma: "σ", sigmaf: "ς", sigmav: "ς", sim: "∼", simdot: "⩪", sime: "≃", simeq: "≃", simg: "⪞", simgE: "⪠", siml: "⪝", simlE: "⪟", simne: "≆", simplus: "⨤", simrarr: "⥲", slarr: "←", SmallCircle: "∘", smallsetminus: "∖", smashp: "⨳", smeparsl: "⧤", smid: "∣", smile: "⌣", smt: "⪪", smte: "⪬", smtes: "⪬︀", SOFTcy: "Ь", softcy: "ь", sol: "/", solb: "⧄", solbar: "⌿", Sopf: "𝕊", sopf: "𝕤", spades: "♠", spadesuit: "♠", spar: "∥", sqcap: "⊓", sqcaps: "⊓︀", sqcup: "⊔", sqcups: "⊔︀", Sqrt: "√", sqsub: "⊏", sqsube: "⊑", sqsubset: "⊏", sqsubseteq: "⊑", sqsup: "⊐", sqsupe: "⊒", sqsupset: "⊐", sqsupseteq: "⊒", squ: "□", Square: "□", square: "□", SquareIntersection: "⊓", SquareSubset: "⊏", SquareSubsetEqual: "⊑", SquareSuperset: "⊐", SquareSupersetEqual: "⊒", SquareUnion: "⊔", squarf: "▪", squf: "▪", srarr: "→", Sscr: "𝒮", sscr: "𝓈", ssetmn: "∖", ssmile: "⌣", sstarf: "⋆", Star: "⋆", star: "☆", starf: "★", straightepsilon: "ϵ", straightphi: "ϕ", strns: "¯", Sub: "⋐", sub: "⊂", subdot: "⪽", subE: "⫅", sube: "⊆", subedot: "⫃", submult: "⫁", subnE: "⫋", subne: "⊊", subplus: "⪿", subrarr: "⥹", Subset: "⋐", subset: "⊂", subseteq: "⊆", subseteqq: "⫅", SubsetEqual: "⊆", subsetneq: "⊊", subsetneqq: "⫋", subsim: "⫇", subsub: "⫕", subsup: "⫓", succ: "≻", succapprox: "⪸", succcurlyeq: "≽", Succeeds: "≻", SucceedsEqual: "⪰", SucceedsSlantEqual: "≽", SucceedsTilde: "≿", succeq: "⪰", succnapprox: "⪺", succneqq: "⪶", succnsim: "⋩", succsim: "≿", SuchThat: "∋", Sum: "∑", sum: "∑", sung: "♪", Sup: "⋑", sup: "⊃", sup1: "¹", sup2: "²", sup3: "³", supdot: "⪾", supdsub: "⫘", supE: "⫆", supe: "⊇", supedot: "⫄", Superset: "⊃", SupersetEqual: "⊇", suphsol: "⟉", suphsub: "⫗", suplarr: "⥻", supmult: "⫂", supnE: "⫌", supne: "⊋", supplus: "⫀", Supset: "⋑", supset: "⊃", supseteq: "⊇", supseteqq: "⫆", supsetneq: "⊋", supsetneqq: "⫌", supsim: "⫈", supsub: "⫔", supsup: "⫖", swarhk: "⤦", swArr: "⇙", swarr: "↙", swarrow: "↙", swnwar: "⤪", szlig: "ß", Tab: "	", target: "⌖", Tau: "Τ", tau: "τ", tbrk: "⎴", Tcaron: "Ť", tcaron: "ť", Tcedil: "Ţ", tcedil: "ţ", Tcy: "Т", tcy: "т", tdot: "⃛", telrec: "⌕", Tfr: "𝔗", tfr: "𝔱", there4: "∴", Therefore: "∴", therefore: "∴", Theta: "Θ", theta: "θ", thetasym: "ϑ", thetav: "ϑ", thickapprox: "≈", thicksim: "∼", ThickSpace: "  ", thinsp: " ", ThinSpace: " ", thkap: "≈", thksim: "∼", THORN: "Þ", thorn: "þ", Tilde: "∼", tilde: "˜", TildeEqual: "≃", TildeFullEqual: "≅", TildeTilde: "≈", times: "×", timesb: "⊠", timesbar: "⨱", timesd: "⨰", tint: "∭", toea: "⤨", top: "⊤", topbot: "⌶", topcir: "⫱", Topf: "𝕋", topf: "𝕥", topfork: "⫚", tosa: "⤩", tprime: "‴", TRADE: "™", trade: "™", triangle: "▵", triangledown: "▿", triangleleft: "◃", trianglelefteq: "⊴", triangleq: "≜", triangleright: "▹", trianglerighteq: "⊵", tridot: "◬", trie: "≜", triminus: "⨺", TripleDot: "⃛", triplus: "⨹", trisb: "⧍", tritime: "⨻", trpezium: "⏢", Tscr: "𝒯", tscr: "𝓉", TScy: "Ц", tscy: "ц", TSHcy: "Ћ", tshcy: "ћ", Tstrok: "Ŧ", tstrok: "ŧ", twixt: "≬", twoheadleftarrow: "↞", twoheadrightarrow: "↠", Uacute: "Ú", uacute: "ú", Uarr: "↟", uArr: "⇑", uarr: "↑", Uarrocir: "⥉", Ubrcy: "Ў", ubrcy: "ў", Ubreve: "Ŭ", ubreve: "ŭ", Ucirc: "Û", ucirc: "û", Ucy: "У", ucy: "у", udarr: "⇅", Udblac: "Ű", udblac: "ű", udhar: "⥮", ufisht: "⥾", Ufr: "𝔘", ufr: "𝔲", Ugrave: "Ù", ugrave: "ù", uHar: "⥣", uharl: "↿", uharr: "↾", uhblk: "▀", ulcorn: "⌜", ulcorner: "⌜", ulcrop: "⌏", ultri: "◸", Umacr: "Ū", umacr: "ū", uml: "¨", UnderBar: "_", UnderBrace: "⏟", UnderBracket: "⎵", UnderParenthesis: "⏝", Union: "⋃", UnionPlus: "⊎", Uogon: "Ų", uogon: "ų", Uopf: "𝕌", uopf: "𝕦", UpArrow: "↑", Uparrow: "⇑", uparrow: "↑", UpArrowBar: "⤒", UpArrowDownArrow: "⇅", UpDownArrow: "↕", Updownarrow: "⇕", updownarrow: "↕", UpEquilibrium: "⥮", upharpoonleft: "↿", upharpoonright: "↾", uplus: "⊎", UpperLeftArrow: "↖", UpperRightArrow: "↗", Upsi: "ϒ", upsi: "υ", upsih: "ϒ", Upsilon: "Υ", upsilon: "υ", UpTee: "⊥", UpTeeArrow: "↥", upuparrows: "⇈", urcorn: "⌝", urcorner: "⌝", urcrop: "⌎", Uring: "Ů", uring: "ů", urtri: "◹", Uscr: "𝒰", uscr: "𝓊", utdot: "⋰", Utilde: "Ũ", utilde: "ũ", utri: "▵", utrif: "▴", uuarr: "⇈", Uuml: "Ü", uuml: "ü", uwangle: "⦧", vangrt: "⦜", varepsilon: "ϵ", varkappa: "ϰ", varnothing: "∅", varphi: "ϕ", varpi: "ϖ", varpropto: "∝", vArr: "⇕", varr: "↕", varrho: "ϱ", varsigma: "ς", varsubsetneq: "⊊︀", varsubsetneqq: "⫋︀", varsupsetneq: "⊋︀", varsupsetneqq: "⫌︀", vartheta: "ϑ", vartriangleleft: "⊲", vartriangleright: "⊳", Vbar: "⫫", vBar: "⫨", vBarv: "⫩", Vcy: "В", vcy: "в", VDash: "⊫", Vdash: "⊩", vDash: "⊨", vdash: "⊢", Vdashl: "⫦", Vee: "⋁", vee: "∨", veebar: "⊻", veeeq: "≚", vellip: "⋮", Verbar: "‖", verbar: "|", Vert: "‖", vert: "|", VerticalBar: "∣", VerticalLine: "|", VerticalSeparator: "❘", VerticalTilde: "≀", VeryThinSpace: " ", Vfr: "𝔙", vfr: "𝔳", vltri: "⊲", vnsub: "⊂⃒", vnsup: "⊃⃒", Vopf: "𝕍", vopf: "𝕧", vprop: "∝", vrtri: "⊳", Vscr: "𝒱", vscr: "𝓋", vsubnE: "⫋︀", vsubne: "⊊︀", vsupnE: "⫌︀", vsupne: "⊋︀", Vvdash: "⊪", vzigzag: "⦚", Wcirc: "Ŵ", wcirc: "ŵ", wedbar: "⩟", Wedge: "⋀", wedge: "∧", wedgeq: "≙", weierp: "℘", Wfr: "𝔚", wfr: "𝔴", Wopf: "𝕎", wopf: "𝕨", wp: "℘", wr: "≀", wreath: "≀", Wscr: "𝒲", wscr: "𝓌", xcap: "⋂", xcirc: "◯", xcup: "⋃", xdtri: "▽", Xfr: "𝔛", xfr: "𝔵", xhArr: "⟺", xharr: "⟷", Xi: "Ξ", xi: "ξ", xlArr: "⟸", xlarr: "⟵", xmap: "⟼", xnis: "⋻", xodot: "⨀", Xopf: "𝕏", xopf: "𝕩", xoplus: "⨁", xotime: "⨂", xrArr: "⟹", xrarr: "⟶", Xscr: "𝒳", xscr: "𝓍", xsqcup: "⨆", xuplus: "⨄", xutri: "△", xvee: "⋁", xwedge: "⋀", Yacute: "Ý", yacute: "ý", YAcy: "Я", yacy: "я", Ycirc: "Ŷ", ycirc: "ŷ", Ycy: "Ы", ycy: "ы", yen: "¥", Yfr: "𝔜", yfr: "𝔶", YIcy: "Ї", yicy: "ї", Yopf: "𝕐", yopf: "𝕪", Yscr: "𝒴", yscr: "𝓎", YUcy: "Ю", yucy: "ю", Yuml: "Ÿ", yuml: "ÿ", Zacute: "Ź", zacute: "ź", Zcaron: "Ž", zcaron: "ž", Zcy: "З", zcy: "з", Zdot: "Ż", zdot: "ż", zeetrf: "ℨ", ZeroWidthSpace: "​", Zeta: "Ζ", zeta: "ζ", Zfr: "ℨ", zfr: "𝔷", ZHcy: "Ж", zhcy: "ж", zigrarr: "⇝", Zopf: "ℤ", zopf: "𝕫", Zscr: "𝒵", zscr: "𝓏", zwj: "‍", zwnj: "‌" }, L.NGSP_UNICODE = "", L.NAMED_ENTITIES.ngsp = L.NGSP_UNICODE;
      } }), au = he({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/html_tags.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        var re = ln(), ge = class {
          constructor() {
      ...
      } }), Ju = he({ "node_modules/angular-html-parser/lib/compiler/src/ast_path.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        var re = class {
          constructor(ge) {
        ...
        L.AstPath = re;
      } }), ou = he({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/ast.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        var re = Ju(), ge = class {
        ...
        L.findNode = He;
      } }), Xu = he({ "node_modules/angular-html-parser/lib/compiler/src/assertions.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        function re(Pe, ie) {
          if (ie != null) {
            if (!Array.isArray(ie))
      ...
      } }), Wu = he({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/interpolation_config.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        var re = Xu(), ge = class {
          constructor(Ee, Pe) {
      ...
      } }), lu = he({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/lexer.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        var re = Ft(), ge = Zt(), Ee = Wu(), Pe = ln(), ie;
        (function(z) {
...
`);
        ...
        L.CursorError = rr;
      } }), pu = he({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/parser.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        var re = Zt(), ge = ou(), Ee = lu(), Pe = ln(), ie = class extends re.ParseError {
...
`) {
      ...
      } }), _n = he({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/html_parser.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        var re = au(), ge = pu(), Ee = pu();
        ...
        L.HtmlParser = Pe;
      } }), kn = he({ "node_modules/angular-html-parser/lib/angular-html-parser/src/index.js"(L) {
        $(), Object.defineProperty(L, "__esModule", { value: !0 });
        var re = _n(), ge = ln();
      ...
      $();
      var { ParseSourceSpan: pn, ParseLocation: cu, ParseSourceFile: zu } = Zt(), Yi = ue(), Ki = yr(), An = Pr(), { inferParserByLanguage: Yr } = uu(), Qi = Mu(), Du = Hi(), Hu = Gt(), { hasPragma: Zi } = Uu(), { Node: es } = Gu(), { parseIeConditionalComment: ts } = Nn(), { locStart: rs, locEnd: ns } = su();
      function us(L, re, ge) {
        let { canSelfClose: Ee, normalizeTagName: Pe, normalizeAttributeName: ie, allowHtmComponentClosingTags: de, isTagNameCaseSensitive: Ue, getTagContentType: Ge } = re, gt = kn(), { RecursiveVisitor: ce, visitAll: ve } = ou(), { ParseSourceSpan: Ve } = Zt(), { getHtmlTagDefinition: He } = au(), { rootNodes: Je, errors: Qe } = gt.parse(L, { canSelfClose: Ee, allowHtmComponentClosingTags: de, isTagNameCaseSensitive: Ue, getTagContentType: Ge });
        if (ge.parser === "vue")
        ...
        if (Qe.length > 0) {
          ...
          throw An(st, { start: { line: Ot.line + 1, column: Ot.col + 1 }, end: { line: Vt.line + 1, column: Vt.col + 1 } });
        }
        let yt = (st) => {
          ...
          if (st.type === "element" && (Pe && (!st.namespace || st.namespace === st.tagDefinition.implicitNamespacePrefix || Hu(st)) && (st.name = ct(st.name, (Ot) => Ot in Qi)), ie)) {
            let Ot = Du[st.name] || /* @__PURE__ */ Object.create(null);
            for (let Vt of st.attrs)
              Vt.namespace || (Vt.name = ct(Vt.name, (Ut) => st.name in Du && (Ut in Du["*"] || Ut in Ot)));
          }
        }, $t = (st) => {
          ...
          if (st.type === "element") {
            ...
            !st.namespace || st.namespace === Ot.implicitNamespacePrefix || Hu(st) ? st.tagDefinition = Ot : st.tagDefinition = He("");
          }
        };
      ...
      function Pn(L, re, ge) {
        let Ee = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, { frontMatter: Pe, content: ie } = Ee ? Yi(L) : { frontMatter: null, content: L }, de = new zu(L, re.filepath), Ue = new cu(de, 0, 0, 0), Ge = Ue.moveBy(L.length), gt = { type: "root", sourceSpan: new pn(Ue, Ge), children: us(ie, ge, re) };
        if (Pe) {
          let Ve = new cu(de, 0, 0, 0), He = Ve.moveBy(Pe.raw.length);
          Pe.sourceSpan = new pn(Ve, He), gt.children.unshift(Pe);
        }
        let ce = new es(gt), ve = (Ve, He) => {
          let { offset: Je } = He, Qe = L.slice(0, Je).replace(/[^\n\r]/g, " "), yt = Pn(Qe + Ve, re, ge, !1);
          yt.sourceSpan = new pn(He, Ki(yt.children).sourceSpan.end);
      ...
      function vn() {
        ...
        return { parse: (Ue, Ge, gt) => Pn(Ue, Object.assign({ parser: L }, gt), { canSelfClose: re, normalizeTagName: ge, normalizeAttributeName: Ee, allowHtmComponentClosingTags: Pe, isTagNameCaseSensitive: ie, getTagContentType: de }), hasPragma: Zi, astFormat: "html", locStart: rs, locEnd: ns };
      }
      Ne.exports = { parsers: { html: vn({ name: "html", canSelfClose: !0, normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 }), angular: vn({ name: "angular", canSelfClose: !0 }), vue: vn({ name: "vue", canSelfClose: !0, isTagNameCaseSensitive: !0, getTagContentType: (L, re, ge, Ee) => {
        if (L.toLowerCase() !== "html" && !ge && (L !== "template" || Ee.some((Pe) => {
          let { name: ie, value: de } = Pe;
          return ie === "lang" && de !== "html" && de !== "" && de !== void 0;
        })))
          return kn().TagContentType.RAW_TEXT;
      } }), lwc: vn({ name: "lwc" }) } };
    });
    return Ri();
  });
} }), dl = ra({ "node_modules/prettier/standalone.js"(Jr, Xr) {
  (function(Ae) {
    if (typeof Jr == "object" && typeof Xr == "object")
      Xr.exports = Ae();
    else if (typeof define == "function" && define.amd)
    ...
    var Ae = (ee, V) => () => (V || ee((V = { exports: {} }).exports, V), V.exports), Yt = Ae((ee, V) => {
      ...
      V.exports = W(typeof globalThis == "object" && globalThis) || W(typeof window == "object" && window) || W(typeof self == "object" && self) || W(typeof Dn.global == "object" && Dn.global) || function() {
        return this;
      }() || Function("return this")();
    }), hr = Ae((ee, V) => {
      ...
      var W = Yt(), Z = si(), Y = W.process, ne = W.Deno, Fe = Y && Y.versions || ne && ne.version, je = Fe && Fe.v8, he, qe;
      ...
      var W = un(), Z = dr(), Y = Gn(), ne = Xn(), Fe = Object;
      ...
      var W = Yt(), Z = gn(), Y = "__core-js_shared__", ne = W[Y] || Z(Y, {});
      V.exports = ne;
    }), zn = Ae((ee, V) => {
      var W = li(), Z = yn();
      (V.exports = function(Y, ne) {
      ...
      var W = Dr(), Z = xn(), Y = W({}.hasOwnProperty);
      ...
      var W = Yt(), Z = zn(), Y = kr(), ne = Hn(), Fe = Jn(), je = Xn(), he = Z("wks"), qe = W.Symbol, et = qe && qe.for, Ze = je ? qe : qe && qe.withoutSetter || ne;
      ...
      var W = gr(), Z = Or(), Y = Wn(), ne = hn(), Fe = oi(), je = $r(), he = TypeError, qe = je("toPrimitive");
      ...
      var V = br(), W = gr(), Z = dn(), Y = Lr(), ne = fn(), Fe = En(), je = kr(), he = Yn(), qe = Object.getOwnPropertyDescriptor;
      ...
      var V = br(), W = Yn(), Z = Di(), Y = Wr(), ne = En(), Fe = TypeError, je = Object.defineProperty, he = Object.getOwnPropertyDescriptor, qe = "enumerable", et = "configurable", Ze = "writable";
      ...
      var W = Dr(), Z = dr(), Y = yn(), ne = W(Function.toString);
      ...
      var W = fi(), Z = Yt(), Y = Or(), ne = Qn(), Fe = kr(), je = yn(), he = mi(), qe = eu(), et = "Object already initialized", Ze = Z.TypeError, nt = Z.WeakMap, rt, $, Ft, At = function(ue) {
      ...
      var W = hr(), Z = dr(), Y = kr(), ne = br(), Fe = di().CONFIGURABLE, je = Zn(), he = hi(), qe = he.enforce, et = he.get, Ze = Object.defineProperty, nt = ne && !W(function() {
        return Ze(function() {
        }, "length", { value: 8 }).length !== 8;
      ...
      var W = Tn(), Z = Math.max, Y = Math.min;
      V.exports = function(ne, Fe) {
        var je = W(ne);
      ...
      var W = fn(), Z = Ei(), Y = tn(), ne = function(Fe) {
      ...
      var W = Dr(), Z = kr(), Y = fn(), ne = Fi().indexOf, Fe = eu(), je = W([].push);
      ...
      var V = Ai(), W = vi(), Z = W.concat("length", "prototype");
      ...
      var W = Yt(), Z = Kn().f, Y = Qn(), ne = gi(), Fe = gn(), je = Ti(), he = Bi();
      ...
      var W = Cu(), Z = sn(), Y = Hr(), ne = W(W.bind);
      V.exports = function(Fe, je) {
      ...
      var W = Eu(), Z = tn(), Y = wi(), ne = Fu(), Fe = function(je, he, qe, et, Ze, nt, rt, $) {
      ...
      var W = vu(), Z = dr(), Y = Br(), ne = $r(), Fe = ne("toStringTag"), je = Object, he = Y(function() {
        return arguments;
      ...
      var W = Dr(), Z = hr(), Y = dr(), ne = bu(), Fe = un(), je = Zn(), he = function() {
      ...
      var W = Eu(), Z = Ni(), Y = Or(), ne = $r(), Fe = ne("species"), je = Array;
      ...
      var ee = an(), V = Au(), W = sn(), Z = xn(), Y = tn(), ne = xu();
      ...
      var W = $r(), Z = Tu(), Y = W("iterator"), ne = Array.prototype;
      V.exports = function(Fe) {
        return Fe !== void 0 && (Z.Array === Fe || ne[Y] === Fe);
      };
    }), tu = Ae((ee, V) => {
      var W = bu(), Z = hn(), Y = nn(), ne = Tu(), Fe = $r(), je = Fe("iterator");
      V.exports = function(he) {
        if (!Y(he))
          return Z(he, je) || Z(he, "@@iterator") || ne[W(he)];
      };
    }), Pi = Ae((ee, V) => {
      var W = gr(), Z = sn(), Y = Wr(), ne = mn(), Fe = tu(), je = TypeError;
      V.exports = function(he, qe) {
      ...
      var W = Fu(), Z = gr(), Y = Wr(), ne = mn(), Fe = ki(), je = tn(), he = Gn(), qe = Pi(), et = tu(), Ze = Bu(), nt = TypeError, rt = function(Ft, At) {
        this.stopped = Ft, this.result = At;
      }, $ = rt.prototype;
      V.exports = function(Ft, At, Lt) {
        var qt = Lt && Lt.that, Zt = !!(Lt && Lt.AS_ENTRIES), ue = !!(Lt && Lt.IS_RECORD), yr = !!(Lt && Lt.IS_ITERATOR), Pr = !!(Lt && Lt.INTERRUPTED), zr = W(At, qt), fr, Rr, mr, rn, wr, Fr, Bn, wn = function(Nr) {
          return fr && Ze(fr, "normal", Nr), new rt(!0, Nr);
        }, on = function(Nr) {
          return Zt ? (Y(Nr), Pr ? zr(Nr[0], Nr[1], wn) : zr(Nr[0], Nr[1])) : Pr ? zr(Nr, wn) : zr(Nr);
        };
        if (ue)
          fr = Ft.iterator;
        else if (yr)
        ...
        for (Fr = ue ? Ft.next : fr.next; !(Bn = Z(Fr, fr)).done; ) {
          try {
            wr = on(Bn.value);
          } catch (Nr) {
            Ze(fr, "throw", Nr);
      ...
      var ee = Yt(), V = br(), W = Oi(), Z = $i(), Y = hr(), ne = ee.RegExp, Fe = ne.prototype, je = V && Y(function() {
        var he = !0;
        try {
          ne(".", "d");
        } catch {
      ...
      var ee = an(), V = Au(), W = xn(), Z = tn(), Y = Tn(), ne = xu();
...
`);
      ...
      var Bn = rt({ "node_modules/strip-ansi/index.js"() {
        ue(), wr();
      } });
      function wn(u) {
      ...
      function Mi(u) {
        if (typeof u != "string" || u.length === 0 || (u = Fr(u), u.length === 0))
          return 0;
        u = u.replace((0, Nu.default)(), "  ");
        let l = 0;
        for (let t = 0; t < u.length; t++) {
          let a = u.codePointAt(t);
          a <= 31 || a >= 127 && a <= 159 || a >= 768 && a <= 879 || (a > 65535 && t++, l += wn(a) ? 2 : 1);
        }
        return l;
      }
      var Nu, qi = rt({ "node_modules/string-width/index.js"() {
        ue(), Bn(), on(), Nu = Lt(Nr());
      } }), _u = $({ "src/utils/get-string-width.js"(u, l) {
        ue();
        var t = (qi(), qt(wu)).default, a = /[^\x20-\x7F]/;
        function s(e) {
          return e ? a.test(e) ? t(e) : e.length : 0;
        }
        l.exports = s;
      } }), Cn = $({ "src/document/doc-utils.js"(u, l) {
        ue();
...
`)).parts;
      ...
      } }), Vi = $({ "src/document/doc-printer.js"(u, l) {
        ue();
        var { convertEndOfLineToChars: t } = Rr(), a = mr(), s = _u(), { fill: e, cursor: r, indent: n } = fr(), { isConcat: o, getDocParts: c } = Cn(), y, m = 1, g = 2;
        function p() {
...
` ? S.replace(/\n/g, J) : S;
      ...
      } }), Ui = $({ "src/document/doc-debug.js"(u, l) {
        ue();
        var { isConcat: t, getDocParts: a } = Cn();
        function s(r) {
          if (!r)
            return "";
          if (t(r)) {
        ...
        ue(), l.exports = { builders: fr(), printer: Vi(), utils: Cn(), debug: Ui() };
      } }), ku = {};
      Ft(ku, { default: () => Gi });
      function Gi(u) {
        if (typeof u != "string")
      ...
      var Ji = rt({ "node_modules/escape-string-regexp/index.js"() {
        ue();
      } }), Pu = $({ "node_modules/semver/internal/debug.js"(u, l) {
        ue();
        ...
        l.exports = t;
      } }), Iu = $({ "node_modules/semver/internal/constants.js"(u, l) {
        ue();
      ...
      } }), ju = $({ "node_modules/semver/internal/re.js"(u, l) {
        ue();
        var { MAX_SAFE_COMPONENT_LENGTH: t } = Iu(), a = Pu();
        u = l.exports = {};
      ...
      } }), Xi = $({ "node_modules/semver/internal/parse-options.js"(u, l) {
        ue();
        var t = ["includePrerelease", "loose", "rtl"], a = (s) => s ? typeof s != "object" ? { loose: !0 } : t.filter((e) => s[e]).reduce((e, r) => (e[r] = !0, e), {}) : {};
        l.exports = a;
      } }), Lu = $({ "node_modules/semver/internal/identifiers.js"(u, l) {
        ue();
        var t = /^[0-9]+$/, a = (e, r) => {
      ...
      } }), Wi = $({ "node_modules/semver/classes/semver.js"(u, l) {
        ue();
        var t = Pu(), { MAX_LENGTH: a, MAX_SAFE_INTEGER: s } = Iu(), { re: e, t: r } = ju(), n = Xi(), { compareIdentifiers: o } = Lu(), c = class {
          constructor(y, m) {
        ...
        l.exports = c;
      } }), ru = $({ "node_modules/semver/functions/compare.js"(u, l) {
        ue();
        var t = Wi(), a = (s, e, r) => new t(s, r).compare(new t(e, r));
        l.exports = a;
      } }), nu = $({ "node_modules/semver/functions/lt.js"(u, l) {
        ue();
        var t = ru(), a = (s, e, r) => t(s, e, r) < 0;
        l.exports = a;
      } }), Ou = $({ "node_modules/semver/functions/gte.js"(u, l) {
        ue();
        var t = ru(), a = (s, e, r) => t(s, e, r) >= 0;
        l.exports = a;
      } }), $u = $({ "src/utils/arrayify.js"(u, l) {
        ue(), l.exports = (t, a) => Object.entries(t).map((s) => {
          let [e, r] = s;
          return Object.assign({ [a]: e }, r);
        });
      } }), Ru = $({ "node_modules/outdent/lib/index.js"(u, l) {
      ...
      } }), zi = $({ "src/main/core-options.js"(u, l) {
        ue();
        var { outdent: t } = Ru(), a = "Config", s = "Editor", e = "Format", r = "Other", n = "Output", o = "Global", c = "Special", y = { cursorOffset: { since: "1.4.0", category: c, type: "int", default: -1, range: { start: -1, end: Number.POSITIVE_INFINITY, step: 1 }, description: t`
      Print (to stderr) where a cursor at the given position would move to after formatting.
      This option cannot be used with --range-start and --range-end.
    ...
    `, cliCategory: r }, tabWidth: { type: "int", category: o, default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 } }, useTabs: { since: "1.0.0", category: o, type: "boolean", default: !1, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { since: "2.1.0", category: o, type: "choice", default: [{ since: "2.1.0", value: "auto" }], description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
      ...
      } }), uu = $({ "src/main/support.js"(u, l) {
        ue();
        var t = { compare: ru(), lt: nu(), gte: Ou() }, a = $u(), s = yr().version, e = zi().options;
        function r() {
      ...
      } }), iu = $({ "src/utils/is-non-empty-array.js"(u, l) {
        ue();
        function t(a) {
          return Array.isArray(a) && a.length > 0;
        }
        l.exports = t;
      } }), Fn = $({ "src/utils/text/skip.js"(u, l) {
        ue();
        function t(n) {
          return (o, c, y) => {
            let m = y && y.backwards;
      ...
      } }), Mu = $({ "src/utils/text/skip-inline-comment.js"(u, l) {
        ue();
        function t(a, s) {
          if (s === !1)
            return !1;
        ...
        l.exports = t;
      } }), qu = $({ "src/utils/text/skip-trailing-comment.js"(u, l) {
        ue();
        var { skipEverythingButNewLine: t } = Fn();
        function a(s, e) {
          return e === !1 ? !1 : s.charAt(e) === "/" && s.charAt(e + 1) === "/" ? t(s, e) : e;
        }
        l.exports = a;
      } }), Vu = $({ "src/utils/text/skip-newline.js"(u, l) {
        ue();
        function t(a, s, e) {
          let r = e && e.backwards;
          if (s === !1)
...
` || n === "\r" || n === "\u2028" || n === "\u2029")
        ...
        l.exports = t;
      } }), Hi = $({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(u, l) {
        ue();
        var t = Mu(), a = Vu(), s = qu(), { skipSpaces: e } = Fn();
        function r(n, o) {
          let c = null, y = o;
          for (; y !== c; )
        ...
        ue();
        var { default: t } = (Ji(), qt(ku)), a = mr(), { getSupportInfo: s } = uu(), e = iu(), r = _u(), { skipWhitespace: n, skipSpaces: o, skipToLineEnd: c, skipEverythingButNewLine: y } = Fn(), m = Mu(), g = qu(), p = Vu(), D = Hi(), C = (U) => U[U.length - 2];
        function w(U) {
          return (R, pe, be) => {
...
`);
      ...
      Ft(Uu, { basename: () => Xu, default: () => cu, delimiter: () => pn, dirname: () => ou, extname: () => Wu, isAbsolute: () => ln, join: () => au, normalize: () => su, relative: () => Ju, resolve: () => Nn, sep: () => kn });
      function Gu(u, l) {
      ...
      function Nn() {
        ...
        return u = Gu(lu(u.split("/"), function(s) {
          return !!s;
        }), !l).join("/"), (l ? "/" : "") + u || ".";
      }
      function su(u) {
        var l = ln(u), t = zu(u, -1) === "/";
        return u = Gu(lu(u.split("/"), function(a) {
          return !!a;
      ...
      function Ju(u, l) {
        u = Nn(u).substr(1), l = Nn(l).substr(1);
        function t(c) {
      ...
      var pu, _n, kn, pn, cu, zu, Yi = rt({ "node-modules-polyfills:path"() {
        ue(), pu = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/, _n = function(u) {
          return pu.exec(u).slice(1);
        }, kn = "/", pn = ":", cu = { extname: Wu, basename: Xu, dirname: ou, sep: kn, delimiter: pn, relative: Ju, join: au, isAbsolute: ln, normalize: su, resolve: Nn }, zu = "ab".substr(-1) === "b" ? function(u, l, t) {
          return u.substr(l, t);
        } : function(u, l, t) {
          return l < 0 && (l = u.length + l), u.substr(l, t);
        };
      } }), Ki = $({ "node-modules-polyfills-commonjs:path"(u, l) {
        ue();
        var t = (Yi(), qt(Uu));
        if (t && t.default) {
          l.exports = t.default;
      ...
      Ft(Yr, { __assign: () => Ve, __asyncDelegator: () => Pe, __asyncGenerator: () => Ee, __asyncValues: () => ie, __await: () => ge, __awaiter: () => ts, __classPrivateFieldGet: () => gt, __classPrivateFieldSet: () => ce, __createBinding: () => ns, __decorate: () => Hu, __exportStar: () => us, __extends: () => Qi, __generator: () => rs, __importDefault: () => Ge, __importStar: () => Ue, __makeTemplateObject: () => de, __metadata: () => es, __param: () => Zi, __read: () => vn, __rest: () => Du, __spread: () => L, __spreadArrays: () => re, __values: () => Pn });
      function Qi(u, l) {
        ve(u, l);
        function t() {
          this.constructor = u;
      ...
      function ie(u) {
        ...
        return l ? l.call(u) : (u = typeof Pn == "function" ? Pn(u) : u[Symbol.iterator](), t = {}, a("next"), a("throw"), a("return"), t[Symbol.asyncIterator] = function() {
          return this;
        }, t);
        function a(e) {
          t[e] = u[e] && function(r) {
...
` + w.codeFrame, w;
        ...
        ue();
        var t = Ki(), { UndefinedParserError: a } = An(), { getSupportInfo: s } = uu(), e = Mr(), { resolveParser: r } = xt(), n = { astFormat: "estree", printer: {}, originalText: void 0, locStart: null, locEnd: null };
        function o(m) {
        ...
        l.exports = e;
      } }), In = $({ "src/main/multiparser.js"(u, l) {
        ue();
      ...
      } }), jn = $({ "src/main/ast-to-doc.js"(u, l) {
        ue();
        var t = Kr(), { builders: { hardline: a, addAlignmentToDoc: s }, utils: { propagateBreaks: e } } = wt(), { printComments: r } = Qt(), n = In();
        function o(m, g) {
      ...
      } }), Ku = $({ "src/main/core.js"(u, l) {
        ue();
        var { diffArrays: t } = zr(), { printer: { printDocToString: a }, debug: { printDocToDebug: s } } = wt(), { getAlignmentSize: e } = Gt(), { guessEndOfLine: r, convertEndOfLineToChars: n, countEndOfLineChars: o, normalizeEndOfLine: c } = Rr(), y = Kt().normalize, m = sr(), g = Qt(), p = xt(), D = jn(), C = Yu(), w = "\uFEFF", k = Symbol("cursor");
        function A(f, F, i) {
          let h = F.comments;
...
`);
      ...
      } }), Qu = $({ "src/common/util-shared.js"(u, l) {
        ue();
      ...
      } }), na = $({ "node_modules/esutils/lib/keyword.js"(u, l) {
        ue(), function() {
          var t = cn();
          function a(D) {
            switch (D) {
      ...
      } }), ua = $({ "node_modules/esutils/lib/utils.js"(u) {
        ue(), function() {
          u.ast = Qr(), u.code = cn(), u.keyword = na();
        }();
      } }), bn = $({ "src/language-js/utils/is-block-comment.js"(u, l) {
        ue();
        var t = /* @__PURE__ */ new Set(["Block", "CommentBlock", "MultiLine"]), a = (s) => t.has(s == null ? void 0 : s.type);
        l.exports = a;
      } }), ia = $({ "src/language-js/utils/is-node-matches.js"(u, l) {
        ue();
        function t(s, e) {
          let r = e.split(".");
        ...
        ue();
        var t = ua().keyword.isIdentifierNameES5, { getLast: a, hasNewline: s, skipWhitespace: e, isNonEmptyArray: r, isNextLineEmptyAfterIndex: n, getStringWidth: o } = Gt(), { locStart: c, locEnd: y, hasSameLocStart: m } = or(), g = bn(), p = ia(), D = "(?:(?=.)\\s)", C = new RegExp(`^${D}*:`), w = new RegExp(`^${D}*::`);
        function k(O) {
          var $e, vt;
...
`)) && O.expressions.every(vt);
      ...
      } }), Ln = $({ "src/language-js/print/template-literal.js"(u, l) {
        ue();
...
`) && q.push({ hasLineBreak: !1, cells: [] });
      ...
      } }), sa = $({ "src/language-js/embed/markdown.js"(u, l) {
        ue();
        var { builders: { indent: t, softline: a, literalline: s, dedentToRoot: e } } = wt(), { escapeTemplateCharacters: r } = Ln();
        function n(c, y, m) {
        ...
        l.exports = n;
      } }), aa = $({ "src/language-js/embed/css.js"(u, l) {
        ue();
        var { isNonEmptyArray: t } = Gt(), { builders: { indent: a, hardline: s, softline: e }, utils: { mapDoc: r, replaceEndOfLine: n, cleanDoc: o } } = wt(), { printTemplateExpressions: c } = Ln();
        function y(p, D, C) {
        ...
        l.exports = y;
      } }), oa = $({ "src/language-js/embed/graphql.js"(u, l) {
        ue();
        var { builders: { indent: t, join: a, hardline: s } } = wt(), { escapeTemplateCharacters: e, printTemplateExpressions: r } = Ln();
        function n(c, y, m) {
...
`), _ = P.length, J = D[w], d = _ > 2 && P[0].trim() === "" && P[1].trim() === "", T = _ > 2 && P[_ - 1].trim() === "" && P[_ - 2].trim() === "", f = P.every((i) => /^\s*(?:#[^\n\r]*)?$/.test(i));
        ...
        l.exports = n;
      } }), la = $({ "src/language-js/embed/html.js"(u, l) {
        ue();
        var { builders: { indent: t, line: a, hardline: s, group: e }, utils: { mapDoc: r } } = wt(), { printTemplateExpressions: n, uncookTemplateElementValue: o } = Ln(), c = 0;
        ...
        l.exports = y;
      } }), pa = $({ "src/language-js/embed.js"(u, l) {
        ue();
        var { hasComment: t, CommentCheckFlags: a, isObjectProperty: s } = ur(), e = sa(), r = aa(), n = oa(), o = la();
        function c(d) {
          if (g(d) || w(d) || k(d) || p(d))
            return "css";
          if (x(d))
        ...
        l.exports = y;
      } }), ca = $({ "src/language-js/clean.js"(u, l) {
        ue();
        var t = bn(), a = /* @__PURE__ */ new Set(["range", "raw", "comments", "leadingComments", "trailingComments", "innerComments", "extra", "start", "end", "loc", "flags", "errors", "tokens"]), s = (r) => {
      ...
      Ft(Cs, { EOL: () => as, arch: () => Da, cpus: () => Ts, default: () => ks, endianness: () => Fs, freemem: () => Ss, getNetworkInterfaces: () => _s, hostname: () => As, loadavg: () => vs, networkInterfaces: () => Ns, platform: () => da, release: () => ws, tmpDir: () => is, tmpdir: () => ss, totalmem: () => xs, type: () => Bs, uptime: () => bs });
      function Fs() {
        if (typeof Zu > "u") {
      ...
      var Zu, ss, as, ks, fa = rt({ "node-modules-polyfills:os"() {
        ue(), ss = is, as = `
`, ks = { EOL: as, tmpdir: ss, tmpDir: is, networkInterfaces: Ns, getNetworkInterfaces: _s, release: ws, type: Bs, cpus: Ts, totalmem: xs, freemem: Ss, uptime: bs, loadavg: vs, hostname: As, endianness: Fs };
      } }), ma = $({ "node-modules-polyfills-commonjs:os"(u, l) {
        ue();
        var t = (fa(), qt(Cs));
        if (t && t.default) {
          l.exports = t.default;
          ...
          t && (l.exports = t);
      } }), ha = $({ "node_modules/detect-newline/index.js"(u, l) {
        ue();
        var t = (a) => {
          if (typeof a != "string")
            throw new TypeError("Expected a string");
...
`;
      } }), ga = $({ "node_modules/jest-docblock/build/index.js"(u) {
      ...
      } }), ya = $({ "src/language-js/utils/get-shebang.js"(u, l) {
        ue();
        function t(a) {
          if (!a.startsWith("#!"))
            return "";
...
`);
        ...
        l.exports = t;
      } }), Ps = $({ "src/language-js/pragma.js"(u, l) {
        ue();
        var { parseWithComments: t, strip: a, extract: s, print: e } = ga(), { normalizeEndOfLine: r } = Rr(), n = ya();
        function o(m) {
          let g = n(m);
...
`) + w;
      ...
      } }), Ea = $({ "src/language-js/utils/is-type-cast-comment.js"(u, l) {
        ue();
        var t = bn();
        function a(s) {
      ...
      } }), On = $({ "src/language-js/needs-parens.js"(u, l) {
        ue();
        var t = mr(), a = iu(), { getFunctionParameters: s, getLeftSidePathName: e, hasFlowShorthandAnnotationComment: r, hasNakedLeftSide: n, hasNode: o, isBitwiseOperator: c, startsWithNoLookaheadToken: y, shouldFlatten: m, getPrecedence: g, isCallExpression: p, isMemberExpression: D, isObjectProperty: C, isTSTypeExpression: w } = ur();
        function k(d, T) {
        ...
        l.exports = k;
      } }), js = $({ "src/language-js/print-preprocess.js"(u, l) {
        ue();
        function t(a, s) {
          switch (s.parser) {
            case "json":
        ...
        l.exports = t;
      } }), Ca = $({ "src/language-js/print/html-binding.js"(u, l) {
        ue();
      ...
      } }), os = $({ "src/language-js/print/binaryish.js"(u, l) {
        ue();
      ...
      } }), Fa = $({ "src/language-js/print/angular.js"(u, l) {
        ue();
        var { builders: { join: t, line: a, group: s } } = wt(), { hasNode: e, hasComment: r, getComments: n } = ur(), { printBinaryishExpression: o } = os();
        function c(g, p, D) {
          let C = g.getValue();
...
\r	`, Ie = new RegExp("([" + fe + "]+)"), X = new RegExp("[^" + fe + "]"), se = (Q) => Q.replace(new RegExp("(?:^" + Ie.source + "|" + Ie.source + "$)"), "");
        ...
        l.exports = E;
      } }), Os = $({ "src/language-js/print/member.js"(u, l) {
        ue();
      ...
      } }), va = $({ "src/language-js/print/member-chain.js"(u, l) {
        ue();
        var { printComments: t } = Qt(), { getLast: a, isNextLineEmptyAfterIndex: s, getNextNonSpaceNonCommentCharacterIndex: e } = Gt(), r = On(), { isCallExpression: n, isMemberExpression: o, isFunctionOrArrowExpression: c, isLongCurriedCallExpression: y, isMemberish: m, isNumericLiteral: g, isSimpleCallArgument: p, hasComment: D, CommentCheckFlags: C, isNextLineEmpty: w } = ur(), { locEnd: k } = or(), { builders: { join: A, hardline: N, group: x, indent: P, conditionalGroup: _, breakParent: J, label: d }, utils: { willBreak: T } } = wt(), f = Ls(), { printMemberLookup: F } = Os(), { printOptionalToken: i, printFunctionTypeParameters: h, printBindExpressionCallee: E } = qr();
        function b(S, B, I) {
        ...
        l.exports = b;
      } }), $s = $({ "src/language-js/print/call-expression.js"(u, l) {
        ue();
        var { builders: { join: t, group: a } } = wt(), s = On(), { getCallArguments: e, hasFlowAnnotationComment: r, isCallExpression: n, isMemberish: o, isStringLiteral: c, isTemplateOnItsOwnLine: y, isTestCall: m, iterateCallArgumentsPath: g } = ur(), p = va(), D = Ls(), { printOptionalToken: C, printFunctionTypeParameters: w } = qr();
        function k(N, x, P) {
...
`) : C(X);
      ...
      } }), ti = $({ "src/language-js/print/type-annotation.js"(u, l) {
        ue();
        var { printComments: t, printDanglingComments: a } = Qt(), { isNonEmptyArray: s } = Gt(), { builders: { group: e, join: r, line: n, softline: o, indent: c, align: y, ifBreak: m } } = wt(), g = On(), { locStart: p } = or(), { isSimpleType: D, isObjectType: C, hasLeadingOwnLineComment: w, isObjectTypePropertyAFunction: k, shouldPrintComma: A } = ur(), { printAssignment: N } = fu(), { printFunctionParameters: x, shouldGroupFunctionParameters: P } = ei(), { printArrayItems: _ } = du();
        function J(S) {
          if (D(S) || C(S))
            return !0;
      ...
      } }), mu = $({ "src/language-js/print/property.js"(u, l) {
        ue();
        var { printComments: t } = Qt(), { printString: a, printNumber: s } = Gt(), { isNumericLiteral: e, isSimpleNumber: r, isStringLiteral: n, isStringPropSafeToUnquote: o, rawText: c } = ur(), { printAssignment: y } = fu(), m = /* @__PURE__ */ new WeakMap();
        function g(D, C, w) {
          let k = D.getNode();
          if (k.computed)
            return ["[", w("key"), "]"];
      ...
      } }), ls = $({ "src/language-js/print/decorators.js"(u, l) {
        ue();
      ...
      } }), hu = $({ "src/language-js/print/class.js"(u, l) {
        ue();
        var { isNonEmptyArray: t, createGroupIdMapper: a } = Gt(), { printComments: s, printDanglingComments: e } = Qt(), { builders: { join: r, line: n, hardline: o, softline: c, group: y, indent: m, ifBreak: g } } = wt(), { hasComment: p, CommentCheckFlags: D } = ur(), { getTypeParametersGroupId: C } = ri(), { printMethod: w } = ni(), { printOptionalToken: k, printTypeAnnotation: A, printDefiniteToken: N } = qr(), { printPropertyKey: x } = mu(), { printAssignment: P } = fu(), { printClassMemberDecorators: _ } = ls();
        function J(S, B, I) {
          let q = S.getValue(), G = [];
      ...
      } }), Rs = $({ "src/language-js/print/interface.js"(u, l) {
        ue();
        var { isNonEmptyArray: t } = Gt(), { builders: { join: a, line: s, group: e, indent: r, ifBreak: n } } = wt(), { hasComment: o, identity: c, CommentCheckFlags: y } = ur(), { getTypeParametersGroupId: m } = ri(), { printTypeScriptModifiers: g } = qr();
        function p(D, C, w) {
          let k = D.getValue(), A = [];
      ...
      } }), Ms = $({ "src/language-js/print/module.js"(u, l) {
        ue();
      ...
      } }), ba = $({ "src/language-js/print/flow.js"(u, l) {
        ue();
        var t = lr(), { printDanglingComments: a } = Qt(), { printString: s, printNumber: e } = Gt(), { builders: { hardline: r, softline: n, group: o, indent: c } } = wt(), { getParentExportDeclaration: y, isFunctionNotation: m, isGetterOrSetter: g, rawText: p, shouldPrintComma: D } = ur(), { locStart: C, locEnd: w } = or(), { replaceTextEndOfLine: k } = Cn(), { printClass: A } = hu(), { printOpaqueType: N, printTypeAlias: x, printIntersectionType: P, printUnionType: _, printFunctionType: J, printTupleType: d, printIndexedAccessType: T } = ti(), { printInterface: f } = Rs(), { printTypeParameter: F, printTypeParameters: i } = ri(), { printExportDeclaration: h, printExportAllDeclaration: E } = Ms(), { printArrayItems: b } = du(), { printObject: S } = ps(), { printPropertyKey: B } = mu(), { printOptionalToken: I, printTypeAnnotation: q, printRestSpread: G } = qr();
        function M(j, De, U) {
      ...
      } }), Sa = $({ "src/language-js/utils/is-ts-keyword-type.js"(u, l) {
        ue();
        function t(a) {
          let { type: s } = a;
        ...
        l.exports = t;
      } }), qs = $({ "src/language-js/print/ternary.js"(u, l) {
        ue();
        var { hasNewlineInRange: t } = Gt(), { isJsxNode: a, getComments: s, isCallExpression: e, isMemberExpression: r, isTSTypeExpression: n } = ur(), { locStart: o, locEnd: c } = or(), y = bn(), { builders: { line: m, softline: g, group: p, indent: D, align: C, ifBreak: w, dedent: k, breakParent: A } } = wt();
        function N(d) {
          let T = [d];
      ...
      } }), Vs = $({ "src/language-js/print/statement.js"(u, l) {
        ue();
        var { builders: { hardline: t } } = wt(), a = On(), { getLeftSidePathName: s, hasNakedLeftSide: e, isJsxNode: r, isTheOnlyJsxElementInMarkdown: n, hasComment: o, CommentCheckFlags: c, isNextLineEmpty: y } = ur(), { shouldPrintParamsWithoutParens: m } = ni();
        function g(x, P, _, J) {
      ...
      } }), Us = $({ "src/language-js/print/block.js"(u, l) {
        ue();
        var { printDanglingComments: t } = Qt(), { isNonEmptyArray: a } = Gt(), { builders: { hardline: s, indent: e } } = wt(), { hasComment: r, CommentCheckFlags: n, isNextLineEmpty: o } = ur(), { printHardlineAfterHeritage: c } = hu(), { printBody: y } = Vs();
        function m(p, D, C) {
          let w = p.getValue(), k = [];
      ...
      } }), xa = $({ "src/language-js/print/typescript.js"(u, l) {
        ue();
        var { printDanglingComments: t } = Qt(), { hasNewlineInRange: a } = Gt(), { builders: { join: s, line: e, hardline: r, softline: n, group: o, indent: c, conditionalGroup: y, ifBreak: m } } = wt(), { isStringLiteral: g, getTypeScriptMappedTypeModifier: p, shouldPrintComma: D, isCallExpression: C, isMemberExpression: w } = ur(), k = Sa(), { locStart: A, locEnd: N } = or(), { printOptionalToken: x, printTypeScriptModifiers: P } = qr(), { printTernary: _ } = qs(), { printFunctionParameters: J, shouldGroupFunctionParameters: d } = ei(), { printTemplateLiteral: T } = Ln(), { printArrayItems: f } = du(), { printObject: F } = ps(), { printClassProperty: i, printClassMethod: h } = hu(), { printTypeParameter: E, printTypeParameters: b } = ri(), { printPropertyKey: S } = mu(), { printFunction: B, printMethodInternal: I } = ni(), { printInterface: q } = Rs(), { printBlock: G } = Us(), { printTypeAlias: M, printIntersectionType: te, printUnionType: j, printFunctionType: De, printTupleType: U, printIndexedAccessType: R, printJSDocType: pe } = ti();
        function be(fe, Ie, X) {
          let se = fe.getValue();
      ...
      } }), Ta = $({ "src/language-js/print/comment.js"(u, l) {
        ue();
        var { hasNewline: t } = Gt(), { builders: { join: a, hardline: s }, utils: { replaceTextEndOfLine: e } } = wt(), { isLineComment: r } = ur(), { locStart: n, locEnd: o } = or(), c = bn();
        function y(p, D) {
          let C = p.getValue();
          if (r(C))
...
`);
      ...
      } }), Ba = $({ "src/language-js/print/literal.js"(u, l) {
        ue();
        var { printString: t, printNumber: a } = Gt(), { replaceTextEndOfLine: s } = Cn(), { printDirective: e } = qr();
        function r(y, m) {
          let g = y.getNode();
          switch (g.type) {
            case "RegExpLiteral":
      ...
      } }), wa = $({ "src/language-js/printer-estree.js"(u, l) {
        ue();
        var { printDanglingComments: t } = Qt(), { hasNewline: a } = Gt(), { builders: { join: s, line: e, hardline: r, softline: n, group: o, indent: c }, utils: { replaceTextEndOfLine: y } } = wt(), m = pa(), g = ca(), { insertPragma: p } = Ps(), D = Is(), C = On(), w = js(), { hasFlowShorthandAnnotationComment: k, hasComment: A, CommentCheckFlags: N, isTheOnlyJsxElementInMarkdown: x, isLineComment: P, isNextLineEmpty: _, needsHardlineAfterDanglingComment: J, hasIgnoreComment: d, isCallExpression: T, isMemberExpression: f, markerForIfWithoutBlockAndSameLineComment: F } = ur(), { locStart: i, locEnd: h } = or(), E = bn(), { printHtmlBinding: b, isVueEventBindingExpression: S } = Ca(), { printAngular: B } = Fa(), { printJsx: I, hasJsxIgnoreComment: q } = Aa(), { printFlow: G } = ba(), { printTypescript: M } = xa(), { printOptionalToken: te, printBindExpressionCallee: j, printTypeAnnotation: De, adjustClause: U, printRestSpread: R, printDefiniteToken: pe, printDirective: be } = qr(), { printImportDeclaration: fe, printExportDeclaration: Ie, printExportAllDeclaration: X, printModuleSpecifier: se } = Ms(), { printTernary: we } = qs(), { printTemplateLiteral: _e } = Ln(), { printArray: it } = du(), { printObject: ae } = ps(), { printClass: Q, printClassMethod: me, printClassProperty: Ce } = hu(), { printProperty: Re } = mu(), { printFunction: Xe, printArrowFunction: Ye, printMethod: Ct, printReturnStatement: Rt, printThrowStatement: It } = ni(), { printCallExpression: Et } = $s(), { printVariableDeclarator: bt, printAssignmentExpression: xe } = fu(), { printBinaryishExpression: H } = os(), { printSwitchCaseConsequent: ke } = Vs(), { printMemberExpression: oe } = Os(), { printBlock: Be, printBlockBody: pt } = Us(), { printComment: ut } = Ta(), { printLiteral: Le } = Ba(), { printDecorators: v } = ls();
      ...
      } }), Na = $({ "src/language-js/printer-estree-json.js"(u, l) {
        ue();
        var { builders: { hardline: t, indent: a, join: s } } = wt(), e = js();
        function r(y, m, g) {
          let p = y.getValue();
          switch (p.type) {
            case "JsonRoot":
      ...
      } }), $n = $({ "src/common/common-options.js"(u, l) {
        ue();
        var t = "Common";
      ...
      } }), _a = $({ "src/language-js/options.js"(u, l) {
        ue();
        var t = $n(), a = "JavaScript";
      ...
      } }), ka = $({ "src/language-js/parse/parsers.js"() {
        ue();
      } }), cs = $({ "node_modules/linguist-languages/data/JavaScript.json"(u, l) {
      ...
      } }), Pa = $({ "node_modules/linguist-languages/data/TypeScript.json"(u, l) {
      ...
      } }), Ia = $({ "node_modules/linguist-languages/data/TSX.json"(u, l) {
      ...
      } }), Gs = $({ "node_modules/linguist-languages/data/JSON.json"(u, l) {
      ...
      } }), ja = $({ "node_modules/linguist-languages/data/JSON with Comments.json"(u, l) {
      ...
      } }), La = $({ "node_modules/linguist-languages/data/JSON5.json"(u, l) {
      ...
      } }), Oa = $({ "src/language-js/index.js"(u, l) {
        ue();
        var t = vr(), a = wa(), s = Na(), e = _a(), r = ka(), n = [t(cs(), (c) => ({ since: "0.0.0", parsers: ["babel", "acorn", "espree", "meriyah", "babel-flow", "babel-ts", "flow", "typescript"], vscodeLanguageIds: ["javascript", "mongo"], interpreters: [...c.interpreters, "zx"], extensions: [...c.extensions.filter((y) => y !== ".jsx"), ".wxs"] })), t(cs(), () => ({ name: "Flow", since: "0.0.0", parsers: ["flow", "babel-flow"], vscodeLanguageIds: ["javascript"], aliases: [], filenames: [], extensions: [".js.flow"] })), t(cs(), () => ({ name: "JSX", since: "0.0.0", parsers: ["babel", "babel-flow", "babel-ts", "flow", "typescript", "espree", "meriyah"], vscodeLanguageIds: ["javascriptreact"], aliases: void 0, filenames: void 0, extensions: [".jsx"], group: "JavaScript", interpreters: void 0, tmScope: "source.js.jsx", aceMode: "javascript", codemirrorMode: "jsx", codemirrorMimeType: "text/jsx", color: void 0 })), t(Pa(), () => ({ since: "1.4.0", parsers: ["typescript", "babel-ts"], vscodeLanguageIds: ["typescript"] })), t(Ia(), () => ({ since: "1.4.0", parsers: ["typescript", "babel-ts"], vscodeLanguageIds: ["typescriptreact"] })), t(Gs(), () => ({ name: "JSON.stringify", since: "1.13.0", parsers: ["json-stringify"], vscodeLanguageIds: ["json"], extensions: [".importmap"], filenames: ["package.json", "package-lock.json", "composer.json"] })), t(Gs(), (c) => ({ since: "1.5.0", parsers: ["json"], vscodeLanguageIds: ["json"], extensions: c.extensions.filter((y) => y !== ".jsonl") })), t(ja(), (c) => ({ since: "1.5.0", parsers: ["json"], vscodeLanguageIds: ["jsonc"], filenames: [...c.filenames, ".eslintrc", ".swcrc"] })), t(La(), () => ({ since: "1.13.0", parsers: ["json5"], vscodeLanguageIds: ["json5"] }))], o = { estree: a, "estree-json": s };
        l.exports = { languages: n, options: e, printers: o, parsers: r };
      } }), $a = $({ "src/language-css/clean.js"(u, l) {
        ue();
        ...
        l.exports = e;
      } }), Ds = $({ "src/utils/front-matter/print.js"(u, l) {
        ue();
        ...
        l.exports = s;
      } }), Ra = $({ "src/language-css/embed.js"(u, l) {
        ue();
        var { builders: { hardline: t } } = wt(), a = Ds();
        function s(e, r, n) {
          let o = e.getValue();
        ...
        l.exports = s;
      } }), Js = $({ "src/utils/front-matter/parse.js"(u, l) {
        ue();
        ...
        l.exports = a;
      } }), Ma = $({ "src/language-css/pragma.js"(u, l) {
        ue();
        var t = Ps(), a = Js();
        function s(r) {
...
` : "") + t.insertPragma(o);
      ...
      } }), qa = $({ "src/language-css/utils/index.js"(u, l) {
        ue();
      ...
      } }), Va = $({ "src/utils/line-column-to-index.js"(u, l) {
        ue(), l.exports = function(t, a) {
          let s = 0;
...
`, s) + 1;
      ...
      } }), Ua = $({ "src/language-css/loc.js"(u, l) {
        ue();
        var { skipEverythingButNewLine: t } = Fn(), a = mr(), s = Va();
        function e(p, D) {
...
` || x === "\r") && (k && A.push([w, N]), D = "initial", k = !1);
      ...
      } }), Ga = $({ "src/language-css/utils/is-less-parser.js"(u, l) {
        ue();
        function t(a) {
          return a.parser === "css" || a.parser === "less";
        }
        l.exports = t;
      } }), Ja = $({ "src/language-css/utils/is-scss.js"(u, l) {
        ue();
        function t(a, s) {
          return a === "less" || a === "scss" ? a === "scss" : /(?:\w\s*:\s*[^:}]+|#){|@import[^\n]+(?:url|,)/.test(s);
        }
        l.exports = t;
      } }), Xa = $({ "src/language-css/utils/css-units.evaluate.js"(u, l) {
      ...
      } }), Wa = $({ "src/language-css/utils/print-unit.js"(u, l) {
        ue();
        var t = Xa();
        function a(s) {
          let e = s.toLowerCase();
          ...
          switch (Te.type) {
            ...
            case "value-comma_group": {
              ...
              for (let Gr = 0; Gr < Te.groups.length; ++Gr) {
                var Sr;
                Ht.push(zt[Gr]);
                let Cr = Te.groups[Gr - 1], Nt = Te.groups[Gr], Mt = Te.groups[Gr + 1], ii = Te.groups[Gr + 2];
                if (jr) {
                ...
                if (Nt.type === "value-string" && Nt.quoted) {
                  let ys = Nt.value.lastIndexOf("#{"), Es = Nt.value.lastIndexOf("}");
                  ys !== -1 && Es !== -1 ? cr = ys > Es : ys !== -1 ? cr = !0 : Es !== -1 && (cr = !1);
                }
                if (cr || Et(Nt) || Et(Mt) || Nt.type === "value-atword" && (Nt.value === "" || Nt.value.endsWith("[")) || Mt.type === "value-word" && Mt.value.startsWith("]") || Nt.value === "~" || Nt.value && Nt.value.includes("\\") && Mt && Mt.type !== "value-comment" || Cr && Cr.value && Cr.value.indexOf("\\") === Cr.value.length - 1 && Nt.type === "value-operator" && Nt.value === "/" || Nt.value === "\\" || Ce(Nt, Mt) || Ye(Nt) || Ct(Nt) || Rt(Mt) || Ct(Mt) && we(Mt) || Rt(Nt) && we(Mt) || Nt.value === "--" && Ye(Mt))
                  continue;
                let gs = R(Nt), Qs = R(Mt);
                if ((gs && Ye(Mt) || Qs && Rt(Nt)) && we(Mt) || !Cr && j(Nt) || F(ft, "calc") && (De(Nt) || De(Mt) || U(Nt) || U(Mt)) && we(Mt))
                  continue;
                let pl = (De(Nt) || U(Nt)) && Gr === 0 && (Mt.type === "value-number" || Mt.isHex) && Wt && xe(Wt) && !we(Mt), Zs = ii && ii.type === "value-func" || ii && It(ii) || Nt.type === "value-func" || It(Nt), ea = Mt.type === "value-func" || It(Mt) || Cr && Cr.type === "value-func" || Cr && It(Cr);
                if (!(!(te(Mt) || te(Nt)) && !F(ft, "calc") && !pl && (j(Mt) && !Zs || j(Nt) && !ea || De(Mt) && !Zs || De(Nt) && !ea || U(Mt) || U(Nt)) && (we(Mt) || gs && (!Cr || Cr && R(Cr)))) && !((Pt.parser === "scss" || Pt.parser === "less") && gs && Nt.value === "-" && Be(Mt) && ut(Nt) === pt(Mt.open) && Mt.open.value === "(")) {
                  if (Xe(Nt)) {
      ...
      } }), Ha = $({ "src/language-css/options.js"(u, l) {
        ue();
        var t = $n();
        l.exports = { singleQuote: t.singleQuote };
      } }), Ya = $({ "src/language-css/parsers.js"() {
        ue();
      } }), Ka = $({ "node_modules/linguist-languages/data/CSS.json"(u, l) {
      ...
      } }), Qa = $({ "node_modules/linguist-languages/data/PostCSS.json"(u, l) {
      ...
      } }), Za = $({ "node_modules/linguist-languages/data/Less.json"(u, l) {
      ...
      } }), eo = $({ "node_modules/linguist-languages/data/SCSS.json"(u, l) {
      ...
      } }), to = $({ "src/language-css/index.js"(u, l) {
        ue();
        var t = vr(), a = za(), s = Ha(), e = Ya(), r = [t(Ka(), (o) => ({ since: "1.4.0", parsers: ["css"], vscodeLanguageIds: ["css"], extensions: [...o.extensions, ".wxss"] })), t(Qa(), () => ({ since: "1.4.0", parsers: ["css"], vscodeLanguageIds: ["postcss"] })), t(Za(), () => ({ since: "1.4.0", parsers: ["less"], vscodeLanguageIds: ["less"] })), t(eo(), () => ({ since: "1.4.0", parsers: ["scss"], vscodeLanguageIds: ["scss"] }))], n = { postcss: a };
        l.exports = { languages: r, options: s, printers: n, parsers: e };
      } }), ro = $({ "src/language-handlebars/loc.js"(u, l) {
        ue();
        function t(s) {
      ...
      } }), no = $({ "src/language-handlebars/clean.js"(u, l) {
        ue();
        function t(a, s) {
          if (a.type === "TextNode") {
            let e = a.chars.trim();
      ...
      } }), uo = $({ "src/language-handlebars/html-void-elements.evaluate.js"(u, l) {
        l.exports = ["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"];
      } }), io = $({ "src/language-handlebars/utils.js"(u, l) {
        ue();
        var t = mr(), a = uo();
        function s(x) {
      ...
      } }), so = $({ "src/language-handlebars/printer-glimmer.js"(u, l) {
        ue();
        var { builders: { dedent: t, fill: a, group: s, hardline: e, ifBreak: r, indent: n, join: o, line: c, softline: y }, utils: { getDocParts: m, replaceTextEndOfLine: g } } = wt(), { getPreferredQuote: p, isNonEmptyArray: D } = Gt(), { locStart: C, locEnd: w } = ro(), k = no(), { getNextNode: A, getPreviousNode: N, hasPrettierIgnore: x, isLastNodeOfSiblings: P, isNextNodeOfSomeType: _, isNodeOfSomeType: J, isParentOfSomeType: d, isPreviousNodeOfSomeType: T, isVoid: f, isWhitespaceNode: F } = io(), i = 2;
        function h(H, ke, oe) {
          let Be = H.getValue();
          if (!Be)
            return "";
...
`).length - 1;
      ...
      } }), ao = $({ "src/language-handlebars/parsers.js"() {
        ue();
      } }), oo = $({ "node_modules/linguist-languages/data/Handlebars.json"(u, l) {
      ...
      } }), lo = $({ "src/language-handlebars/index.js"(u, l) {
        ue();
        var t = vr(), a = so(), s = ao(), e = [t(oo(), () => ({ since: "2.3.0", parsers: ["glimmer"], vscodeLanguageIds: ["handlebars"] }))], r = { glimmer: a };
        l.exports = { languages: e, printers: r, parsers: s };
      } }), po = $({ "src/language-graphql/pragma.js"(u, l) {
        ue();
        function t(s) {
          return /^\s*#[^\S\n]*@(?:format|prettier)\s*(?:\n|$)/.test(s);
        }
...
` + s;
      ...
      } }), co = $({ "src/language-graphql/loc.js"(u, l) {
        ue();
        function t(s) {
        ...
        l.exports = { locStart: t, locEnd: a };
      } }), Do = $({ "src/language-graphql/printer-graphql.js"(u, l) {
        ue();
        var { builders: { join: t, hardline: a, line: s, softline: e, group: r, indent: n, ifBreak: o } } = wt(), { isNextLineEmpty: c, isNonEmptyArray: y } = Gt(), { insertPragma: m } = po(), { locStart: g, locEnd: p } = co();
        function D(_, J, d) {
          let T = _.getValue();
          if (!T)
            return "";
...
`) && (J.value = J.value.trim());
      ...
      } }), fo = $({ "src/language-graphql/options.js"(u, l) {
        ue();
        var t = $n();
        l.exports = { bracketSpacing: t.bracketSpacing };
      } }), mo = $({ "src/language-graphql/parsers.js"() {
        ue();
      } }), ho = $({ "node_modules/linguist-languages/data/GraphQL.json"(u, l) {
      ...
      } }), go = $({ "src/language-graphql/index.js"(u, l) {
        ue();
        var t = vr(), a = Do(), s = fo(), e = mo(), r = [t(ho(), () => ({ since: "1.5.0", parsers: ["graphql"], vscodeLanguageIds: ["graphql"] }))], n = { graphql: a };
        l.exports = { languages: r, options: s, printers: n, parsers: e };
      } }), Xs = $({ "node_modules/collapse-white-space/index.js"(u, l) {
        ue(), l.exports = t;
        function t(a) {
          return String(a).replace(/\s+/g, " ");
        }
      } }), Ws = $({ "src/language-markdown/loc.js"(u, l) {
        ue();
        function t(s) {
        ...
        l.exports = { locStart: t, locEnd: a };
      } }), yo = $({ "src/language-markdown/constants.evaluate.js"(u, l) {
        ...
        ue();
        var { getLast: t } = Gt(), { locStart: a, locEnd: s } = Ws(), { cjkPattern: e, kPattern: r, punctuationPattern: n } = yo(), o = ["liquidNode", "inlineCode", "emphasis", "esComment", "strong", "delete", "wikiLink", "link", "linkReference", "image", "imageReference", "footnote", "footnoteReference", "sentence", "whitespace", "word", "break", "inlineMath"], c = [...o, "tableCell", "paragraph", "heading"], y = new RegExp(r), m = new RegExp(n);
        function g(A, N) {
...
`) ? x.slice(0, -1) : x;
      ...
      } }), Eo = $({ "src/language-markdown/embed.js"(u, l) {
        ue();
        var { inferParserByLanguage: t, getMaxContinuousCount: a } = Gt(), { builders: { hardline: s, markAsRoot: e }, utils: { replaceEndOfLine: r } } = wt(), n = Ds(), { getFencedCodeBlockValue: o } = ds();
        function c(y, m, g, p) {
          let D = y.getValue();
        ...
        l.exports = c;
      } }), zs = $({ "src/language-markdown/pragma.js"(u, l) {
        ue();
        var t = Js(), a = ["format", "prettier"];
        function s(e) {
...
${r.content}`;
      ...
      } }), Co = $({ "src/language-markdown/print-preprocess.js"(u, l) {
        ue();
...
` + N.value, position: { start: A.position.start, end: N.position.end } }));
        ...
        l.exports = n;
      } }), Fo = $({ "src/language-markdown/clean.js"(u, l) {
        ue();
        var t = Xs(), { isFrontMatterNode: a } = Gt(), { startWithPragma: s } = zs(), e = /* @__PURE__ */ new Set(["position", "raw"]);
        function r(n, o, c) {
      ...
      } }), Ao = $({ "src/language-markdown/printer-markdown.js"(u, l) {
        ue();
        var t = Xs(), { getLast: a, getMinNotPresentContinuousCount: s, getMaxContinuousCount: e, getStringWidth: r, isNonEmptyArray: n } = Gt(), { builders: { breakParent: o, join: c, line: y, literalline: m, markAsRoot: g, hardline: p, softline: D, ifBreak: C, fill: w, align: k, indent: A, group: N, hardlineWithoutBreakParent: x }, utils: { normalizeDoc: P, replaceTextEndOfLine: _ }, printer: { printDocToString: J } } = wt(), d = Eo(), { insertPragma: T } = zs(), { locStart: f, locEnd: F } = Ws(), i = Co(), h = Fo(), { getFencedCodeBlockValue: E, hasGitDiffFriendlyOrderedList: b, splitText: S, punctuationPattern: B, INLINE_NODE_TYPES: I, INLINE_NODE_WRAPPER_TYPES: q, isAutolink: G } = ds(), M = /* @__PURE__ */ new Set(["importExport"]), te = ["heading", "tableCell", "link", "wikiLink"], j = /* @__PURE__ */ new Set(["listItem", "definition", "footnoteDefinition"]);
        function De(xe, H, ke) {
          let oe = xe.getValue();
          if (Xe(xe))
...
`)
      ...
      } }), vo = $({ "src/language-markdown/options.js"(u, l) {
        ue();
        var t = $n();
        l.exports = { proseWrap: t.proseWrap, singleQuote: t.singleQuote };
      } }), bo = $({ "src/language-markdown/parsers.js"() {
        ue();
      } }), Hs = $({ "node_modules/linguist-languages/data/Markdown.json"(u, l) {
      ...
      } }), So = $({ "src/language-markdown/index.js"(u, l) {
        ue();
        var t = vr(), a = Ao(), s = vo(), e = bo(), r = [t(Hs(), (o) => ({ since: "1.8.0", parsers: ["markdown"], vscodeLanguageIds: ["markdown"], filenames: [...o.filenames, "README"], extensions: o.extensions.filter((c) => c !== ".mdx") })), t(Hs(), () => ({ name: "MDX", since: "1.15.0", parsers: ["mdx"], vscodeLanguageIds: ["mdx"], filenames: [], extensions: [".mdx"] }))], n = { mdast: a };
        l.exports = { languages: r, options: s, printers: n, parsers: e };
      } }), xo = $({ "src/language-html/clean.js"(u, l) {
        ue();
      ...
      } }), To = $({ "src/language-html/constants.evaluate.js"(u, l) {
      ...
      } }), Bo = $({ "src/language-html/utils/is-unknown-namespace.js"(u, l) {
        ue();
        function t(a) {
          return a.type === "element" && !a.hasExplicitNamespace && !["html", "svg"].includes(a.namespace);
        }
        l.exports = t;
      } }), Rn = $({ "src/language-html/utils/index.js"(u, l) {
        ue();
        var { inferParserByLanguage: t, isFrontMatterNode: a } = Gt(), { builders: { line: s, hardline: e, join: r }, utils: { getDocParts: n, replaceTextEndOfLine: o } } = wt(), { CSS_DISPLAY_TAGS: c, CSS_DISPLAY_DEFAULT: y, CSS_WHITE_SPACE_TAGS: m, CSS_WHITE_SPACE_DEFAULT: g } = To(), p = Bo(), D = /* @__PURE__ */ new Set(["	", `
...
`);
      ...
      } }), wo = $({ "node_modules/angular-html-parser/lib/compiler/src/chars.js"(u) {
        ...
        u.isOctalDigit = r;
      } }), No = $({ "node_modules/angular-html-parser/lib/compiler/src/aot/static_symbol.js"(u) {
        ue(), Object.defineProperty(u, "__esModule", { value: !0 });
        var l = class {
          constructor(a, s, e) {
      ...
      } }), _o = $({ "node_modules/angular-html-parser/lib/compiler/src/util.js"(u) {
        ue(), Object.defineProperty(u, "__esModule", { value: !0 });
        var l = /-+([a-z0-9])/g;
        function t(i) {
...
`);
        ...
        u.global = F;
      } }), ko = $({ "node_modules/angular-html-parser/lib/compiler/src/compile_metadata.js"(u) {
        ue(), Object.defineProperty(u, "__esModule", { value: !0 });
        var l = No(), t = _o(), a = /^(?:(?:\[([^\]]+)\])|(?:\(([^\)]+)\)))|(\@[-\w]+)$/;
        function s(E) {
        ...
        u.templateJitUrl = h;
      } }), Po = $({ "node_modules/angular-html-parser/lib/compiler/src/parse_util.js"(u) {
        ue(), Object.defineProperty(u, "__esModule", { value: !0 });
        var l = wo(), t = ko(), a = class {
          constructor(y, m, g, p) {
...
` && ++w == m)); )
      ...
      } }), Io = $({ "src/language-html/print-preprocess.js"(u, l) {
        ue();
        var { ParseSourceSpan: t } = Po(), { htmlTrim: a, getLeadingAndTrailingHtmlWhitespace: s, hasHtmlWhitespace: e, canHaveInterpolation: r, getNodeCssStyleDisplay: n, isDanglingSpaceSensitiveNode: o, isIndentationSensitiveNode: c, isLeadingSpaceSensitiveNode: y, isTrailingSpaceSensitiveNode: m, isWhitespaceSensitiveNode: g, isVueScriptTag: p } = Rn(), D = [w, k, N, P, _, T, J, d, f, x, F];
        function C(i, h) {
          for (let E of D)
            E(i, h);
          return i;
...
`) {
        ...
        l.exports = C;
      } }), jo = $({ "src/language-html/pragma.js"(u, l) {
        ue();
        function t(s) {
...
` + s.replace(/^\s*\n/, "");
        ...
        l.exports = { hasPragma: t, insertPragma: a };
      } }), fs = $({ "src/language-html/loc.js"(u, l) {
        ue();
        function t(s) {
        ...
        l.exports = { locStart: t, locEnd: a };
      } }), gu = $({ "src/language-html/print/tag.js"(u, l) {
        ue();
        var t = lr(), { isNonEmptyArray: a } = Gt(), { builders: { indent: s, join: e, line: r, softline: n, hardline: o }, utils: { replaceTextEndOfLine: c } } = wt(), { locStart: y, locEnd: m } = fs(), { isTextLikeNode: g, getLastDescendant: p, isPreLikeNode: D, hasPrettierIgnore: C, shouldPreserveContent: w, isVueSfcBlock: k } = Rn();
        function A(j, De) {
      ...
      } }), Lo = $({ "node_modules/parse-srcset/src/parse-srcset.js"(u, l) {
        ue(), function(t, a) {
...
` || J === "\f" || J === "\r";
      ...
      } }), Oo = $({ "src/language-html/syntax-attribute.js"(u, l) {
        ue();
        var t = Lo(), { builders: { ifBreak: a, join: s, line: e } } = wt();
        function r(o) {
      ...
      } }), $o = $({ "src/language-html/syntax-vue.js"(u, l) {
        ue();
      ...
      } }), Ys = $({ "src/language-html/get-node-content.js"(u, l) {
        ue();
        var { needsToBorrowParentClosingTagStartMarker: t, printClosingTagStartMarker: a, needsToBorrowLastChildClosingTagEndMarker: s, printClosingTagEndMarker: e, needsToBorrowParentOpeningTagEndMarker: r, printOpeningTagEndMarker: n } = gu();
        function o(c, y) {
        ...
        l.exports = o;
      } }), Ro = $({ "src/language-html/embed.js"(u, l) {
        ue();
        var { builders: { breakParent: t, group: a, hardline: s, indent: e, line: r, fill: n, softline: o }, utils: { mapDoc: c, replaceTextEndOfLine: y } } = wt(), m = Ds(), { printClosingTag: g, printClosingTagSuffix: p, needsToBorrowPrevClosingTagEndMarker: D, printOpeningTagPrefix: C, printOpeningTag: w } = gu(), { printImgSrcset: k, printClassNames: A } = Oo(), { printVueFor: N, printVueBindings: x, isVueEventBindingExpression: P } = $o(), { isScriptLikeTag: _, isVueNonHtmlBlock: J, inferScriptParser: d, htmlTrimPreserveIndentation: T, dedentString: f, unescapeQuoteEntities: F, isVueSlotAttribute: i, isVueSfcBindingsAttribute: h, getTextValueParts: E } = Rn(), b = Ys();
        function S(I, q, G) {
        ...
        l.exports = B;
      } }), Ks = $({ "src/language-html/print/children.js"(u, l) {
        ue();
        var { builders: { breakParent: t, group: a, ifBreak: s, line: e, softline: r, hardline: n }, utils: { replaceTextEndOfLine: o } } = wt(), { locStart: c, locEnd: y } = fs(), { forceBreakChildren: m, forceNextEmptyLine: g, isTextLikeNode: p, hasPrettierIgnore: D, preferHardlineAsLeadingSpaces: C } = Rn(), { printOpeningTagPrefix: w, needsToBorrowNextOpeningTagStartMarker: k, printOpeningTagStartMarker: A, needsToBorrowPrevClosingTagEndMarker: N, printClosingTagEndMarker: x, printClosingTagSuffix: P, needsToBorrowParentClosingTagStartMarker: _ } = gu();
        function J(f, F, i) {
          let h = f.getValue();
      ...
      } }), Mo = $({ "src/language-html/print/element.js"(u, l) {
        ue();
        var { builders: { breakParent: t, dedentToRoot: a, group: s, ifBreak: e, indentIfBreak: r, indent: n, line: o, softline: c }, utils: { replaceTextEndOfLine: y } } = wt(), m = Ys(), { shouldPreserveContent: g, isScriptLikeTag: p, isVueCustomBlock: D, countParents: C, forceBreakContent: w } = Rn(), { printOpeningTagPrefix: k, printOpeningTag: A, printClosingTagSuffix: N, printClosingTag: x, needsToBorrowPrevClosingTagEndMarker: P, needsToBorrowLastChildClosingTagEndMarker: _ } = gu(), { printChildren: J } = Ks();
        function d(T, f, F) {
          let i = T.getValue();
          if (g(i, f))
      ...
      } }), qo = $({ "src/language-html/printer-html.js"(u, l) {
        ue();
        var { builders: { fill: t, group: a, hardline: s, literalline: e }, utils: { cleanDoc: r, getDocParts: n, isConcat: o, replaceTextEndOfLine: c } } = wt(), y = xo(), { countChars: m, unescapeQuoteEntities: g, getTextValueParts: p } = Rn(), D = Io(), { insertPragma: C } = jo(), { locStart: w, locEnd: k } = fs(), A = Ro(), { printClosingTagSuffix: N, printClosingTagEnd: x, printOpeningTagPrefix: P, printOpeningTagStart: _ } = gu(), { printElement: J } = Mo(), { printChildren: d } = Ks();
        function T(f, F, i) {
          let h = f.getValue();
          switch (h.type) {
            case "front-matter":
      ...
      } }), Vo = $({ "src/language-html/options.js"(u, l) {
        ue();
        var t = $n(), a = "HTML";
      ...
      } }), Uo = $({ "src/language-html/parsers.js"() {
        ue();
      } }), ms = $({ "node_modules/linguist-languages/data/HTML.json"(u, l) {
      ...
      } }), Go = $({ "node_modules/linguist-languages/data/Vue.json"(u, l) {
        l.exports = { name: "Vue", type: "markup", color: "#41b883", extensions: [".vue"], tmScope: "text.html.vue", aceMode: "html", languageId: 391 };
      } }), Jo = $({ "src/language-html/index.js"(u, l) {
        ue();
        var t = vr(), a = qo(), s = Vo(), e = Uo(), r = [t(ms(), () => ({ name: "Angular", since: "1.15.0", parsers: ["angular"], vscodeLanguageIds: ["html"], extensions: [".component.html"], filenames: [] })), t(ms(), (o) => ({ since: "1.15.0", parsers: ["html"], vscodeLanguageIds: ["html"], extensions: [...o.extensions, ".mjml"] })), t(ms(), () => ({ name: "Lightning Web Components", since: "1.17.0", parsers: ["lwc"], vscodeLanguageIds: ["html"], extensions: [], filenames: [] })), t(Go(), () => ({ since: "1.10.0", parsers: ["vue"], vscodeLanguageIds: ["vue"] }))], n = { html: a };
        l.exports = { languages: r, printers: n, options: s, parsers: e };
      } }), Xo = $({ "src/language-yaml/pragma.js"(u, l) {
        ue();
        function t(e) {
...
${e}`;
      ...
      } }), Wo = $({ "src/language-yaml/loc.js"(u, l) {
        ue();
        function t(s) {
          return s.position.start.offset;
        }
        ...
        l.exports = { locStart: t, locEnd: a };
      } }), zo = $({ "src/language-yaml/embed.js"(u, l) {
        ue();
        function t(a, s, e, r) {
        ...
        l.exports = t;
      } }), Mn = $({ "src/language-yaml/utils.js"(u, l) {
        ue();
...
`).map((B) => B.slice(E));
      ...
      } }), Ho = $({ "src/language-yaml/print-preprocess.js"(u, l) {
        ue();
        var { defineShortcut: t, mapNode: a } = Mn();
        function s(r) {
          return a(r, e);
        }
        function e(r) {
        ...
        l.exports = s;
      } }), ui = $({ "src/language-yaml/print/misc.js"(u, l) {
        ue();
        var { builders: { softline: t, align: a } } = wt(), { hasEndComments: s, isNextLineEmpty: e, isNode: r } = Mn(), n = /* @__PURE__ */ new WeakMap();
        function o(m, g) {
      ...
      } }), Yo = $({ "src/language-yaml/print/flow-mapping-sequence.js"(u, l) {
        ue();
        var { builders: { ifBreak: t, line: a, softline: s, hardline: e, join: r } } = wt(), { isEmptyNode: n, getLast: o, hasEndComments: c } = Mn(), { printNextEmptyLine: y, alignWithSpaces: m } = ui();
        function g(D, C, w) {
      ...
      } }), Ko = $({ "src/language-yaml/print/mapping-item.js"(u, l) {
        ue();
        var { builders: { conditionalGroup: t, group: a, hardline: s, ifBreak: e, join: r, line: n } } = wt(), { hasLeadingComments: o, hasMiddleComments: c, hasTrailingComment: y, hasEndComments: m, isNode: g, isEmptyNode: p, isInlineNode: D } = Mn(), { alignWithSpaces: C } = ui();
...
`);
        ...
        l.exports = w;
      } }), Qo = $({ "src/language-yaml/print/block.js"(u, l) {
        ue();
        var { builders: { dedent: t, dedentToRoot: a, fill: s, hardline: e, join: r, line: n, literalline: o, markAsRoot: c }, utils: { getDocParts: y } } = wt(), { getAncestorCount: m, getBlockValueLineContents: g, hasIndicatorComment: p, isLastDescendantNode: D, isNode: C } = Mn(), { alignWithSpaces: w } = ui();
        function k(A, N, x) {
        ...
        l.exports = k;
      } }), Zo = $({ "src/language-yaml/printer-yaml.js"(u, l) {
        ue();
        var { builders: { breakParent: t, fill: a, group: s, hardline: e, join: r, line: n, lineSuffix: o, literalline: c }, utils: { getDocParts: y, replaceTextEndOfLine: m } } = wt(), { isPreviousLineEmpty: g } = Gt(), { insertPragma: p, isPragma: D } = Xo(), { locStart: C } = Wo(), w = zo(), { getFlowScalarLineContents: k, getLastDescendantNode: A, hasLeadingComments: N, hasMiddleComments: x, hasTrailingComment: P, hasEndComments: _, hasPrettierIgnore: J, isLastDescendantNode: d, isNode: T, isInlineNode: f } = Mn(), F = Ho(), { alignWithSpaces: i, printNextEmptyLine: h, shouldPrintEndComments: E } = ui(), { printFlowMapping: b, printFlowSequence: S } = Yo(), B = Ko(), I = Qo();
        function q(R, pe, be) {
      ...
      } }), el = $({ "src/language-yaml/options.js"(u, l) {
        ue();
        var t = $n();
        l.exports = { bracketSpacing: t.bracketSpacing, singleQuote: t.singleQuote, proseWrap: t.proseWrap };
      } }), tl = $({ "src/language-yaml/parsers.js"() {
        ue();
      } }), rl = $({ "node_modules/linguist-languages/data/YAML.json"(u, l) {
      ...
      } }), nl = $({ "src/language-yaml/index.js"(u, l) {
        ue();
        var t = vr(), a = Zo(), s = el(), e = tl(), r = [t(rl(), (n) => ({ since: "1.14.0", parsers: ["yaml"], vscodeLanguageIds: ["yaml", "ansible", "home-assistant"], filenames: [...n.filenames.filter((o) => o !== "yarn.lock"), ".prettierrc", ".stylelintrc", ".lintstagedrc"] }))];
        l.exports = { languages: r, printers: { yaml: a }, options: s, parsers: e };
      } }), ul = $({ "src/languages.js"(u, l) {
        ue(), l.exports = [Oa(), to(), lo(), go(), So(), Jo(), nl()];
      } });
      ue();
      var { version: il } = yr(), qn = Ku(), { getSupportInfo: sl } = uu(), al = Qu(), ol = ul(), ll = wt();
      function Sn(u) {
        ...
        return function() {
          ...
          return a[l] = Object.assign(Object.assign({}, e), {}, { plugins: [...ol, ...Array.isArray(r) ? r : Object.values(r)] }), u(...a);
        };
      }
      var hs = Sn(qn.formatWithCursor);
      V.exports = { formatWithCursor: hs, format(u, l) {
        return hs(u, l).formatted;
      }, check(u, l) {
        let { formatted: t } = hs(u, l);
        return t === u;
      }, doc: ll, getSupportInfo: Sn(sl, 0), version: il, util: al, __debug: { parse: Sn(qn.parse), formatAST: Sn(qn.formatAST), formatDoc: Sn(qn.formatDoc), printToDoc: Sn(qn.printToDoc), printDocToString: Sn(qn.printDocToString) } };
    });
    return Oe();
  });
} }), fl = ta(Dl()), ml = ta(dl());
...
var xl = cl(2)((Jr, Xr) => Jr === !1 ? Xr : Jr === "dedent" || Jr === !0 ? hl(Xr) : ml.default.format(Xr, { parser: Jr, plugins: [fl.default], htmlWhitespaceSensitivity: "ignore" }).trim());
export {
  xl as formatter
};
