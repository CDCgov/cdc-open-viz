...
import { r as Ki, R as p0, e as f0, i as bn, _ as m0, f as g0, c as Xi } from "./storybook-975e540d.es.js";
import { L as Ji, v as h0 } from "./storybook-d79fba58.es.js";
import { _ as yn } from "./storybook-70f3d2a3.es.js";
import { k as Qi, l as es, m as b0, n as y0, o as v0, p as E0, _ as ts, q as rs, s as x0, r as ns, t as A0, v as w0, w as S0, x as C0, y as k0, z as _0, A as as, B as T0, C as O0, D as os, E as R0, F as Ja, G as ls, H as is, I as F0, J as D0, K as L0, i as $0, S as cl, L as Aa, b as Wn } from "./storybook-b755f5f3.es.js";
...
var zs = "ScrollArea", [qs, q8] = Xp(zs), [n5, Be] = qs(zs), a5 = b.forwardRef((e, t) => {
...
var Dt = [], tr = null, Gf = b.lazy(async () => {
  let { SyntaxHighlighter: e } = await import("./storybook-ac9946f6.es.js");
  return Dt.length > 0 && (Dt.forEach((t) => {
    e.registerLanguage(...t);
  }), Dt = []), tr === null && (tr = e), { default: (t) => a.createElement(e, { ...t }) };
}), Yf = b.lazy(async () => {
  let [{ SyntaxHighlighter: e }, { formatter: t }] = await Promise.all([import("./storybook-ac9946f6.es.js"), import("./storybook-979eb533.es.js")]);
...
}), { displayName: "Button" }), je = Object.assign(_.form({ boxSizing: "border-box", width: "100%" }), { Field: Zu, Input: vm, Select: Em, Textarea: xm, Button: wm }), Sm = b.lazy(() => import("./storybook-dd60d5c3.es.js").then((e) => ({ default: e.WithTooltip }))), Cm = (e) => a.createElement(b.Suspense, { fallback: a.createElement("div", null) }, a.createElement(Sm, { ...e })), km = b.lazy(() => import("./storybook-dd60d5c3.es.js").then((e) => ({ default: e.WithTooltipPure }))), zu = (e) => a.createElement(b.Suspense, { fallback: a.createElement("div", null) }, a.createElement(km, { ...e }));
...
function zm(e) {
  let t = b.useRef(), r = b.useRef(), n = b.useRef(/* @__PURE__ */ new Map()), { width: o = 1 } = fu({ ref: t }), [l, i] = b.useState(e), [u, s] = b.useState([]), c = b.useRef(e), d = b.useCallback(({ menuName: g, actions: p }) => {
    ...
    return a.createElement(a.Fragment, null, a.createElement(tf, { interactive: !0, visible: f, onVisibleChange: x, placement: "bottom", delayHide: 100, tooltip: a.createElement(Bo, { links: u.map(({ title: y, id: A, color: v, active: E }) => ({ id: A, title: y, color: v, active: E, onClick: (w) => {
      ...
      let w = `index-${E}`;
      return a.createElement(Pr, { id: `tabbutton-${Ji(A) ?? w}`, style: { visibility: "hidden" }, "aria-hidden": !0, tabIndex: -1, ref: (S) => {
        n.current.set(A, S);
...
var Wm = _.div({ display: "block", position: "relative" }, ({ theme: e }) => ({ fontSize: e.typography.size.s2 - 1, background: e.background.content }), ({ bordered: e, theme: t }) => e ? { borderRadius: `0 0 ${t.appBorderRadius - 1}px ${t.appBorderRadius - 1}px` } : {}, ({ absolute: e, bordered: t }) => e ? { height: `calc(100% - ${t ? 42 : 40}px)`, position: "absolute", left: 0 + (t ? 1 : 0), right: 0 + (t ? 1 : 0), bottom: 0 + (t ? 1 : 0), top: 40 + (t ? 1 : 0), overflow: "auto", [`& > *:first-child${qm}`]: { position: "absolute", left: 0 + (t ? 1 : 0), right: 0 + (t ? 1 : 0), bottom: 0 + (t ? 1 : 0), top: 0 + (t ? 1 : 0), height: `calc(100% - ${t ? 2 : 0}px)`, overflow: "auto" } } : {}), $n = b.memo(({ children: e, selected: t, actions: r, absolute: n, bordered: o, tools: l, backgroundColor: i, id: u, menuName: s }) => {
  ...
  return d.length ? a.createElement(Um, { absolute: n, bordered: o, id: u }, a.createElement(Ln, { scrollable: !1, border: !0, backgroundColor: i }, a.createElement(No, { style: { whiteSpace: "normal" }, ref: g, role: "tablist" }, m.map(({ title: f, id: x, active: y, color: A }, v) => {
    let E = `index-${v}`;
    return a.createElement(Pr, { id: `tabbutton-${Ji(x) ?? E}`, ref: (w) => {
      p.current.set(x, w);
...
var $g = /* @__PURE__ */ Bn(Lg), te = $g, Mg = Qi, Bg = f0, Ig = Object.prototype, Pg = Ig.hasOwnProperty;
function Ng(e, t, r) {
  var n = e[t];
  (!(Pg.call(e, t) && Bg(n, r)) || r === void 0 && !(t in e)) && Mg(e, t, r);
}
var jo = Ng, jg = jo, Hg = es, Zg = b0, li = bn, Vg = y0;
function zg(e, t, r, n) {
  if (!li(e))
    return e;
  t = Hg(t, e);
...
var Kg = Yg, Xg = E0, Jg = ts, Qg = rs, eh = x0, th = Object.getOwnPropertySymbols, rh = th ? function(e) {
  for (var t = []; e; )
    Xg(t, Qg(e)), e = Jg(e);
  return t;
} : eh, tc = rh;
...
var ah = nh, oh = bn, lh = ns, ih = ah, sh = Object.prototype, uh = sh.hasOwnProperty;
function ch(e) {
  if (!oh(e))
    return ih(e);
  var t = lh(e), r = [];
...
var Wb = Ub, da = _0, Gb = Wb, Yb = as, Kb = 1 / 0, Xb = da && 1 / Yb(new da([, -0]))[1] == Kb ? function(e) {
  return new da(e);
} : Gb, Jb = Xb, Qb = T0, ey = Vb, ty = qb, ry = O0, ny = Jb, ay = as, oy = 200;
function ly(e, t, r) {
...
function K8({ context: e, docsParameter: t }) {
