...
import { _ as It, T as $e, c as an, s as Za, P as hs, t as lr, u as gu, D as Hl, C as Kl, I as jl, F as xu } from "./storybook-6928251c.es.js";
import { E as Rt, L as vu } from "./storybook-a0c99f4a.es.js";
import { G as be, c as Ze, j as wi, t as bu, k as ps, m as Il, o as Eu, p as Au, q as Tu, s as ql, u as Su } from "./storybook-b0e07e40.es.js";
...
var Zl = Math.abs, yt = Math.atan2, fn = Math.cos, $u = Math.max, Bi = Math.min, Wt = Math.sin, zn = Math.sqrt, gt = 1e-12, Vn = Math.PI, Ja = Vn / 2, la = 2 * Vn;
function zu(e) {
...
function Ku() {
  ...
  function s() {
    ...
    if (o || (o = u = Sa()), h < m && (d = h, h = m, m = d), !(h > gt))
      o.moveTo(0, 0);
    else if (g > la - gt)
      o.moveTo(h * fn(y), h * Wt(y)), o.arc(0, 0, h, y, p, !v), m > gt && (o.moveTo(m * fn(p), m * Wt(p)), o.arc(0, 0, m, p, y, v));
    else {
      var f = y, b = p, x = y, w = p, C = g, T = g, D = c.apply(this, arguments) / 2, k = D > gt && (a ? +a.apply(this, arguments) : zn(m * m + h * h)), z = Bi(Zl(h - m) / 2, +n.apply(this, arguments)), $ = z, N = z, A, P;
      if (k > gt) {
        var L = Jl(k / m * Wt(D)), S = Jl(k / h * Wt(D));
        (C -= L * 2) > gt ? (L *= v ? 1 : -1, x += L, w -= L) : (C = 0, x = w = (y + p) / 2), (T -= S * 2) > gt ? (S *= v ? 1 : -1, f += S, b -= S) : (T = 0, f = b = (y + p) / 2);
      }
      var _ = h * fn(f), R = h * Wt(f), q = m * fn(w), I = m * Wt(w);
      if (z > gt) {
        var j = h * fn(b), G = h * Wt(b), U = m * fn(x), ce = m * Wt(x), ue;
        if (g < Vn && (ue = Hu(_, R, U, ce, j, G, q, I))) {
          var Ee = _ - ue[0], ke = R - ue[1], Se = j - ue[0], de = G - ue[1], Q = 1 / Wt(zu((Ee * Se + ke * de) / (zn(Ee * Ee + ke * ke) * zn(Se * Se + de * de))) / 2), K = zn(ue[0] * ue[0] + ue[1] * ue[1]);
          $ = Bi(z, (m - K) / (Q - 1)), N = Bi(z, (h - K) / (Q + 1));
        }
      }
      T > gt ? N > gt ? (A = Ma(U, ce, _, R, h, N, v), P = Ma(j, G, q, I, h, N, v), o.moveTo(A.cx + A.x01, A.cy + A.y01), N < z ? o.arc(A.cx, A.cy, N, yt(A.y01, A.x01), yt(P.y01, P.x01), !v) : (o.arc(A.cx, A.cy, N, yt(A.y01, A.x01), yt(A.y11, A.x11), !v), o.arc(0, 0, h, yt(A.cy + A.y11, A.cx + A.x11), yt(P.cy + P.y11, P.cx + P.x11), !v), o.arc(P.cx, P.cy, N, yt(P.y11, P.x11), yt(P.y01, P.x01), !v))) : (o.moveTo(_, R), o.arc(0, 0, h, f, b, !v)) : o.moveTo(_, R), !(m > gt) || !(C > gt) ? o.lineTo(q, I) : $ > gt ? (A = Ma(q, I, j, G, m, -$, v), P = Ma(_, R, U, ce, m, -$, v), o.lineTo(A.cx + A.x01, A.cy + A.y01), $ < z ? o.arc(A.cx, A.cy, $, yt(A.y01, A.x01), yt(P.y01, P.x01), !v) : (o.arc(A.cx, A.cy, $, yt(A.y01, A.x01), yt(A.y11, A.x11), !v), o.arc(0, 0, m, yt(A.cy + A.y11, A.cx + A.x11), yt(P.cy + P.y11, P.cx + P.x11), v), o.arc(P.cx, P.cy, $, yt(P.y11, P.x11), yt(P.y01, P.x01), !v))) : o.arc(0, 0, m, w, x, v);
    }
    if (o.closePath(), u)
...
function Uu() {
  var e = qu, t = Iu, n = null, a = Be(0), r = Be(la), l = Be(0);
  function c(o) {
...
const ld = function e(t) {
  function n(a) {
    return t ? new Ms(a, t) : new jr(a, 0);
  }
  return n.alpha = function(a) {
    return e(+a);
  }, n;
...
const od = function e(t) {
  function n(a) {
    return t ? new Ds(a, t) : new Ir(a, 0);
  }
  return n.alpha = function(a) {
    return e(+a);
  }, n;
...
function Id(e) {
  var t = e.className, n = e.top, a = e.left, r = e.keys, l = e.data, c = e.curve, o = e.defined, s = e.x, u = e.x0, d = e.x1, m = e.y0, h = e.y1, y = e.value, p = e.order, g = e.offset, v = e.color, f = e.children, b = jd(e, Kd);
...
function Qd(e) {
  var t = e.data, n = e.className, a = e.top, r = e.left, l = e.x, c = e.y0, o = c === void 0 ? Ks : c, s = e.y1, u = s === void 0 ? js : s, d = e.xScale, m = e.yScale, h = e.color, y = e.keys, p = e.value, g = e.order, v = e.offset, f = e.children, b = Xd(e, Yd), x = Ur();
...
function Gd(e) {
  var t = e.data, n = e.className, a = e.top, r = e.left, l = e.y, c = e.x0, o = c === void 0 ? Ks : c, s = e.x1, u = s === void 0 ? js : s, d = e.xScale, m = e.yScale, h = e.color, y = e.keys, p = e.value, g = e.order, v = e.offset, f = e.children, b = Jd(e, Zd), x = Ur();
  y && x.keys(y), p && Xe(x.value, p), g && x.order(Yr(g)), v && x.offset(Xr(v));
...
function rf() {
  return Is(Gr.apply(null, arguments).paddingInner(1));
}
function qs(e, t) {
  e = e.slice();
...
function df(e) {
  ...
  return t.base = function(o) {
    ...
    if (!(a % 1) && y - h < v) {
      ...
      f.length * 2 < v && (f = Il(u, d, v));
    } else
      f = Il(h, y, Math.min(y - h, v)).map(l);
...
var Ki = /* @__PURE__ */ new Date(), ji = /* @__PURE__ */ new Date();
function Zt(e, t, n, a) {
  function r(l) {
  ...
  return r.floor = function(l) {
    ...
    return Ki.setTime(+l), ji.setTime(+c), e(Ki), e(ji), Math.floor(n(Ki, ji));
  }, r.every = function(l) {
...
var fc = wn(0), ri = wn(1), dm = wn(2), fm = wn(3), jn = wn(4), mm = wn(5), hm = wn(6);
fc.range;
ri.range;
dm.range;
fm.range;
...
var pc = Cn(0), li = Cn(1), pm = Cn(2), ym = Cn(3), In = Cn(4), gm = Cn(5), xm = Cn(6);
pc.range;
li.range;
pm.range;
ym.range;
...
function vm(e) {
  ...
  function T(Q, K) {
    return function(ee) {
      var B = [], ye = -1, oe = 0, fe = Q.length, ae, he, Oe;
      for (ee instanceof Date || (ee = /* @__PURE__ */ new Date(+ee)); ++ye < fe; )
        Q.charCodeAt(ye) === 37 && (B.push(Q.slice(oe, ye)), (he = So[ae = Q.charAt(++ye)]) != null ? ae = Q.charAt(++ye) : he = ae === "e" ? " " : "0", (Oe = K[ae]) && (ae = Oe(ee, he)), B.push(ae), oe = ye + 1);
      return B.push(Q.slice(oe, ye)), B.join("");
    };
  }
  function D(Q, K) {
    return function(ee) {
      var B = Gn(1900, void 0, 1), ye = k(B, Q, ee += "", 0), oe, fe;
      if (ye != ee.length)
        return null;
      if ("Q" in B)
        return new Date(B.Q);
      ...
      if (K && !("Z" in B) && (B.Z = 0), "p" in B && (B.H = B.H % 12 + B.p * 12), B.m === void 0 && (B.m = "q" in B ? B.q : 0), "V" in B) {
        if (B.V < 1 || B.V > 53)
          return null;
        "w" in B || (B.w = 1), "Z" in B ? (oe = qi(Gn(B.y, 0, 1)), fe = oe.getUTCDay(), oe = fe > 4 || fe === 0 ? li.ceil(oe) : li(oe), oe = hc.offset(oe, (B.V - 1) * 7), B.y = oe.getUTCFullYear(), B.m = oe.getUTCMonth(), B.d = oe.getUTCDate() + (B.w + 6) % 7) : (oe = Ii(Gn(B.y, 0, 1)), fe = oe.getDay(), oe = fe > 4 || fe === 0 ? ri.ceil(oe) : ri(oe), oe = dc.offset(oe, (B.V - 1) * 7), B.y = oe.getFullYear(), B.m = oe.getMonth(), B.d = oe.getDate() + (B.w + 6) % 7);
      } else
        ("W" in B || "U" in B) && ("w" in B || (B.w = "u" in B ? B.u % 7 : "W" in B ? 1 : 0), fe = "Z" in B ? qi(Gn(B.y, 0, 1)).getUTCDay() : Ii(Gn(B.y, 0, 1)).getDay(), B.m = 0, B.d = "W" in B ? (B.w + 6) % 7 + B.W * 7 - (fe + 5) % 7 : B.w + B.U * 7 - (fe + 6) % 7);
      return "Z" in B ? (B.H += B.Z / 100 | 0, B.M += B.Z % 100, qi(B)) : Ii(B);
    };
  }
  function k(Q, K, ee, B) {
    for (var ye = 0, oe = K.length, fe = ee.length, ae, he; ye < oe; ) {
      if (B >= fe)
        return -1;
      if (ae = K.charCodeAt(ye++), ae === 37) {
        if (ae = K.charAt(ye++), he = C[ae in So ? K.charAt(ye++) : ae], !he || (B = he(Q, ee, B)) < 0)
          return -1;
  ...
  function z(Q, K, ee) {
    ...
    return B ? (Q.p = d.get(B[0].toLowerCase()), ee + B[0].length) : -1;
  }
  function $(Q, K, ee) {
    var B = y.exec(K.slice(ee));
    return B ? (Q.w = p.get(B[0].toLowerCase()), ee + B[0].length) : -1;
  }
  function N(Q, K, ee) {
    var B = m.exec(K.slice(ee));
    return B ? (Q.w = h.get(B[0].toLowerCase()), ee + B[0].length) : -1;
  }
  function A(Q, K, ee) {
    var B = f.exec(K.slice(ee));
    return B ? (Q.m = b.get(B[0].toLowerCase()), ee + B[0].length) : -1;
  }
  function P(Q, K, ee) {
    var B = g.exec(K.slice(ee));
    return B ? (Q.m = v.get(B[0].toLowerCase()), ee + B[0].length) : -1;
  }
  function L(Q, K, ee) {
    return k(Q, t, K, ee);
  }
...
function Ym(e, t) {
  return e = gc(e), Ve(jn.count(va(e), e) + (va(e).getDay() === 4), t, 2);
}
function Xm(e) {
  return e.getDay();
}
...
function eh(e, t) {
  var n = e.getDay();
  return e = n >= 4 || n === 0 ? jn(e) : jn.ceil(e), Ve(e.getFullYear() % 1e4, t, 4);
}
function th(e) {
...
function dh(e, t) {
  return e = vc(e), Ve(In.count(ba(e), e) + (ba(e).getUTCDay() === 4), t, 2);
}
function fh(e) {
  return e.getUTCDay();
}
...
function gh(e, t) {
  var n = e.getUTCDay();
  return e = n >= 4 || n === 0 ? In(e) : In.ceil(e), Ve(e.getUTCFullYear() % 1e4, t, 4);
}
function xh() {
  return "+0000";
}
...
function Eh(e) {
  return e.to, e.from, e.config, e.onStart, e.onRest, e.onFrame, e.children, e.reset, e.reverse, e.force, e.immediate, e.delay, e.attach, e.destroyed, e.interpolateTo, e.ref, e.lazy, It(e, ["to", "from", "config", "onStart", "onRest", "onFrame", "children", "reset", "reverse", "force", "immediate", "delay", "attach", "destroyed", "interpolateTo", "ref", "lazy"]);
}
function Ui(e) {
  const t = Eh(e);
  if (Fe.und(t))
...
const Ph = (e) => Fe.fun(e) && !(e.prototype instanceof i.Component), Lh = (e) => F.forwardRef((n, a) => {
  ...
  const d = It(u, ["scrollTop", "scrollLeft"]), m = Ph(e) ? void 0 : (h) => o.current = Ah(h, a);
...
class Fh {
  ...
  update(t) {
    if (!t)
      return this;
    const n = Ui(t), a = n.delay, r = a === void 0 ? 0 : a, l = n.to, c = It(n, ["delay", "to"]);
  ...
  diff(t) {
    ...
    if (this.animations = Object.entries(this.merged).reduce((g, v) => {
      ...
      let _ = A && A.getValue();
      const q = !Fe.und(N) && x.animatedValues.some((U) => !U.done), I = !Fe.equ(S, _), j = !Fe.equ(S, x.previous), G = !Fe.equ($, x.config);
      if (m || j && I || G) {
        if (w || C)
          ...
          U = U !== void 0 && !m ? U : k, x.parent ? (N = x.parent, N.setValue(0, !1)) : N = new Er(0);
          const ce = {
            output: [U, b]
          };
          x.interpolation ? (A = x.interpolation, x.interpolation.updateConfig(ce)) : A = N.interpolate(ce);
        }
        return P = Fn(p ? z.getPayload() : z), L = Fn(N.getPayload()), m && !D && N.setValue(k, !1), this.hasChanged = !0, L.forEach((U) => {
        ...
        return I ? g : (D && (N.setValue(1, !1), A.updateConfig({
          output: [S, S]
...
const Ua = "enter", Yi = "leave", Xi = "update", Wh = (e, t) => (typeof t == "function" ? e.map(t) : Fn(t)).map(String), Ar = (e) => {
  let t = e.items, n = e.keys, a = n === void 0 ? (l) => l : n, r = It(e, ["items", "keys"]);
...
function Vh(e, t, n) {
  ...
  r.keys, r.items;
  const d = r.onFrame, m = r.onRest, h = r.onStart, y = r.ref, p = It(r, ["lazy", "unique", "reset", "enter", "leave", "update", "onDestroyed", "keys", "items", "onFrame", "onRest", "onStart", "ref"]), g = Ac(), v = F.useRef(!1), f = F.useRef({
    mounted: !1,
    first: !0,
    deleted: [],
    current: {},
...
function Hh(e, t) {
  let n = e.first, a = e.prevProps, r = It(e, ["first", "prevProps"]), l = Ar(t), c = l.items, o = l.keys, s = l.initial, u = l.from, d = l.enter, m = l.leave, h = l.update, y = l.trail, p = y === void 0 ? 0 : y, g = l.unique, v = l.config, f = l.order, b = f === void 0 ? [Ua, Yi, Xi] : f, x = Ar(a), w = x.keys, C = x.items, T = Ue({}, r.current), D = [...r.deleted], k = Object.keys(T), z = new Set(k), $ = new Set(o), N = o.filter((_) => !z.has(_)), A = r.transitions.filter((_) => !_.destroyed && !$.has(_.originalKey)).map((_) => _.originalKey), P = o.filter((_) => z.has(_)), L = -p;
  for (; b.length; )
    switch (b.shift()) {
      case Ua: {
        N.forEach((R, q) => {
          g && D.find((U) => U.originalKey === R) && (D = D.filter((U) => U.originalKey !== R));
          const I = o.indexOf(R), j = c[I], G = n && s !== void 0 ? "initial" : Ua;
          T[R] = {
            slot: G,
            originalKey: R,
            key: g ? String(R) : Bh++,
      ...
      case Yi: {
        A.forEach((R) => {
          const q = w.indexOf(R), I = C[q], j = Yi;
          D.unshift(Ue({}, T[R], {
            slot: j,
            destroyed: !0,
      ...
      case Xi: {
        P.forEach((R) => {
          const q = o.indexOf(R), I = c[q], j = Xi;
          T[R] = Ue({}, T[R], {
            item: I,
            slot: j,
            trail: L = L + p,
  ...
  return D.forEach((_) => {
    let R = _.left;
    _.right;
    let q = It(_, ["left", "right"]), I;
    (I = S.findIndex((j) => j.originalKey === R)) !== -1 && (I += 1), I = Math.max(0, I), S = [...S.slice(0, I), q, ...S.slice(I)];
  }), Ue({}, r, {
...
const jh = new RegExp("rgb" + Li(zt, zt, zt)), Ih = new RegExp("rgba" + Li(zt, zt, zt, zt)), qh = new RegExp("hsl" + Li(zt, ui, ui)), Uh = new RegExp("hsla" + Li(zt, ui, ui, zt)), Yh = /^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, Xh = /^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, Qh = /^#([0-9a-fA-F]{6})$/, Zh = /^#([0-9a-fA-F]{8})$/;
function Jh(e) {
  let t;
  return typeof e == "number" ? e >>> 0 === e && e >= 0 && e <= 4294967295 ? e : null : (t = Qh.exec(e)) ? parseInt(t[1] + "ff", 16) >>> 0 : ci.hasOwnProperty(e) ? ci[e] : (t = jh.exec(e)) ? (Dn(t[1]) << 24 | // r
  Dn(t[2]) << 16 | // g
  Dn(t[3]) << 8 | // b
  255) >>> // a
  0 : (t = Ih.exec(e)) ? (Dn(t[1]) << 24 | // r
  Dn(t[2]) << 16 | // g
  Dn(t[3]) << 8 | // b
  Ro(t[4])) >>> // a
...
Th((e, t) => {
  if (e.nodeType && e.setAttribute !== void 0) {
    const r = t.style, l = t.children, c = t.scrollTop, o = t.scrollLeft, s = It(t, ["style", "children", "scrollTop", "scrollLeft"]), u = e.nodeName === "filter" || e.parentNode && e.parentNode.nodeName === "filter";
...
const Pp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  const { tableData: t, config: n, formatNumber: a, capitalize: r, formatDate: l, parseDate: c } = F.useContext(ze), { xScale: o, yScale: s, showTooltip: u, hideTooltip: d } = e, { xAxis: m, visualizationType: h, orientation: y, yAxis: p, runtime: g } = n, v = (A, P) => {
    ...
    A.stopPropagation();
    const L = wr(A), { x: S, y: _ } = L, { data: R, arc: q } = P, I = w(S - Number(n.yAxis.size || 0)), j = h !== "Pie" ? n.series.filter((de) => de.tooltip === !0).map((de) => de.dataKey) : n.series.map((de) => de.dataKey);
    j.push(n.xAxis.dataKey), n.visualizationType === "Forecasting" && n.series.map((de) => {
      de.confidenceIntervals.map((Q) => {
        Q.showInTooltip && (j.push(Q.high), j.push(Q.low));
      });
    });
    const G = D(I, j), U = t.filter((de) => de[m.dataKey] === C(_)), ce = y === "vertical" ? G : U;
    h === "Forest Plot" && (t == null || t.filter((de) => de[m.dataKey] === C(_))[0][n.forestPlot.estimateField]);
    const ue = (de) => {
      const Q = n.series.filter((ee) => ee.dataKey === de)[0];
      return Q != null && Q.axis ? String(Q.axis).toLowerCase() : "left";
    }, ke = (() => {
      if (h === "Forest Plot") {
        const de = n.columns, Q = [];
        for (const [ee, B] of Object.entries(de)) {
          const ye = {
            addColPrefix: n.columns[ee].prefix,
            addColSuffix: n.columns[ee].suffix,
            addColRoundTo: n.columns[ee].roundToPlace ? n.columns[ee].roundToPlace : "",
            addColCommas: n.columns[ee].commas
          };
          let oe = C(_, B.name);
          const fe = fu(oe, "left", !0, n, ye);
          B.tooltips && Q.push([B.label, fe]);
        }
        const K = [];
        return K.push([n.xAxis.dataKey, C(_)]), Q.forEach((ee) => {
          K.push([ee[0], ee[1]]);
        }), K;
      }
      return h === "Pie" ? [
      ...
      ] : k().filter(Boolean).flatMap((de, Q) => ce[0][de] ? [[de, ce[0][de], ue(de)]] : []);
    })();
    if (!ke)
      return;
    const Se = v(ke, L);
    ...
    if (h !== "Pie" && y !== "horizontal") {
      if (o.type === "point" || m.type === "continuous" || m.type === "date") {
        ...
        return t.forEach((_) => {
          const R = m.type === "date" ? o(c(_[m.dataKey])) : o(_[m.dataKey]), q = Math.abs(Number(R - S));
          q < L && (L = q, P = m.type === "date" ? c(_[m.dataKey]) : _[m.dataKey]);
        }), P;
      }
    ...
    return t.forEach((_, R) => {
      const q = s(h !== "Forest Plot" ? _[n.xAxis.dataKey] : R), I = Math.abs(q - A);
      I < L && (L = I, S = P ? _[P] : _[n.xAxis.dataKey]);
    }), S;
  }, T = (A) => {
    try {
      const P = wr(A), { x: L } = P;
      ...
      let _ = n.data.filter((R) => R[n.xAxis.dataKey] === S);
      setSharedFilter && setSharedFilter(n.uid, _[0]);
    } catch (P) {
    ...
    try {
      const L = l(A);
      let S;
      return m.type === "categorical" ? S = t.filter((R) => R[m.dataKey] === A) : S = t.filter((R) => l(c(R[m.dataKey])) === L), !S || S.length === 0 ? [] : S.map((R) => Object.fromEntries(Object.entries(R).filter(([q, I]) => P.includes(q))));
    } catch (L) {
    ...
    try {
      let P, L = [], S = [];
      if ((A = n.series) == null || A.forEach((_) => {
        _.type === "Forecasting" && (L.push(_.stageColumn), _ == null || _.confidenceIntervals.forEach((R) => {
    ...
    var L, S;
    let P = n.series.filter((_) => _.dataKey === A);
  ...
  return {
    ...
    TooltipListItem: ({ item: A }) => {
      const [P, L] = A, [S, _, R] = L;
      return h === "Forest Plot" ? S === n.xAxis.dataKey ? /* @__PURE__ */ i.createElement("li", { className: "tooltip-heading" }, `${r(n.xAxis.dataKey ? `${n.xAxis.dataKey}: ` : "")} ${n.yAxis.type === "date" ? l(c(S, !1)) : _}`) : /* @__PURE__ */ i.createElement("li", { className: "tooltip-body" }, `${$(S)}: ${a(_, "left")}`) : h === "Bar" && y === "horizontal" && S === n.xAxis.dataKey ? /* @__PURE__ */ i.createElement("li", { className: "tooltip-heading" }, `${r(n.runtime.yAxis.label ? `${n.runtime.yAxis.label}: ` : "")} ${_}`) : S === n.xAxis.dataKey ? /* @__PURE__ */ i.createElement("li", { className: "tooltip-heading" }, `${r(n.runtime.xAxis.label ? `${n.runtime.xAxis.label}: ` : "")} ${n.xAxis.type === "date", _}`) : /* @__PURE__ */ i.createElement("li", { className: "tooltip-body" }, `${$(S)}: ${a(_, R)}`);
    },
    tooltipStyles: z
  };
};
...
const Ba = ({ startAngle: e, endAngle: t }) => ({
  ...
  const z = ({ arcs: _, path: R, getKey: q }) => {
    const I = Vh(_, q, {
      from: Ba,
      enter: Ba,
      update: Ba,
    ...
    }, [d]), /* @__PURE__ */ i.createElement(i.Fragment, null, I.map(({ item: j, props: G, key: U }, ce) => /* @__PURE__ */ i.createElement(be, { className: j.data[n.xAxis.dataKey], key: `${U}-${ce}`, style: { opacity: n.legend.behavior === "highlight" && r.length > 0 && r.indexOf(j.data[n.runtime.xAxis.dataKey]) === -1 ? 0.5 : 1 } }, /* @__PURE__ */ i.createElement(
      Wo.path,
      {
        d: $h(
        ...
        onMouseEnter: (ue) => v(ue, { data: j.data[n.runtime.xAxis.dataKey], arc: j }),
        onMouseLeave: (ue) => f()
      }
    ))), I.map(({ item: j, key: G }) => {
      const [U, ce] = R.centroid(j), ue = j.endAngle - j.startAngle >= 0.1;
      let Ee = "#FFF";
      return l(j.data[n.runtime.xAxis.dataKey]) && Qt.contrast(Ee, l(j.data[n.runtime.xAxis.dataKey])) < 3.5 && (Ee = "000"), /* @__PURE__ */ i.createElement(Wo.g, { key: G }, ue && /* @__PURE__ */ i.createElement($e, { style: { fill: Ee }, x: U, y: ce, dy: ".33em", textAnchor: "middle", pointerEvents: "none" }, Math.round((j.endAngle - j.startAngle) * 180 / Math.PI / 360 * 100) + "%"));
    }));
  };
  let [$] = a;
  ...
  return F.useEffect(() => {
    if (r.length > 0 && n.legend.behavior !== "highlight") {
      let _ = [];
      t.forEach((R) => {
        r.indexOf(R[n.runtime.xAxis.dataKey]) !== -1 && _.push(R);
      }), w(_);
    } else
      w(void 0);
...
function Oi(e) {
  var t = e.children, n = t === void 0 ? Dp : t, a = e.axisClassName, r = e.hideAxisLine, l = r === void 0 ? !1 : r, c = e.hideTicks, o = c === void 0 ? !1 : c, s = e.hideZero, u = s === void 0 ? !1 : s, d = e.innerRef, m = e.left, h = m === void 0 ? 0 : m, y = e.numTicks, p = y === void 0 ? 10 : y, g = e.orientation, v = g === void 0 ? bt.bottom : g, f = e.rangePadding, b = f === void 0 ? 0 : f, x = e.scale, w = e.tickFormat, C = e.tickLength, T = C === void 0 ? 8 : C, D = e.tickValues, k = e.top, z = k === void 0 ? 0 : k, $ = Bp(e, Fp), N = w ?? zp(x), A = v === bt.left, P = v === bt.top, L = P || v === bt.bottom, S = $p(x), _ = A || P ? -1 : 1, R = x.range(), q = Rp(b), I = Wa({
    ...
    var ue = ce.value, Ee = ce.index, ke = kf(S(ue));
    return {
      value: ue,
      index: Ee,
      from: Wa({
...
function Up(e) {
  var t = e.axisClassName, n = e.labelOffset, a = n === void 0 ? 36 : n, r = e.tickLength, l = r === void 0 ? 8 : r, c = e.tickLabelProps, o = Ip(e, jp), s = typeof c == "function" ? c : yi({}, qp, c);
...
const ly = function(e) {
  return e === void 0 && (e = {}), { name: "flip", options: e, async fn(t) {
    ...
    m || y === "none" || x.push(...function(N, A, P, L) {
      const S = ka(N);
      let _ = function(R, q, I) {
        const j = ["left", "right"], G = ["right", "left"], U = ["top", "bottom"], ce = ["bottom", "top"];
        switch (R) {
          case "top":
          case "bottom":
            return I ? q ? G : j : q ? j : G;
          case "left":
          case "right":
            return q ? U : ce;
          default:
      ...
      return S && (_ = _.map((R) => R + "-" + S), A && (_ = _.concat(_.map(Gi)))), _;
    }(c, p, y, b));
    ...
    if (D = [...D, { placement: a, overflows: T }], !T.every((N) => N <= 0)) {
      ...
      if (!P)
        switch (h) {
          case "bestFit": {
            var $;
            const L = ($ = D.map((S) => [S.placement, S.overflows.filter((_) => _ > 0).reduce((_, R) => _ + R, 0)]).sort((S, _) => S[1] - _[1])[0]) == null ? void 0 : $[0];
            L && (P = L);
            break;
          }
...
const jo = Math.min, pa = Math.max, bi = Math.round;
function Fc(e) {
  const t = qt(e);
...
function Aa(e) {
  if (cn(e) === "html")
    return e;
  const t = e.assignedSlot || e.parentNode || Io(e) && e.host || ln(e);
  return Io(t) ? t.host : t;
}
function Ic(e) {
  const t = Aa(e);
  return cl(t) ? t.ownerDocument.body : Ut(t) && _i(t) ? t : Ic(t);
}
function qc(e, t) {
  var n;
  t === void 0 && (t = []);
  const a = Ic(e), r = a === ((n = e.ownerDocument) == null ? void 0 : n.body), l = Mt(a);
...
const dy = { getClippingRect: function(e) {
  ...
  const l = n === "clippingAncestors" ? function(u, d) {
    ...
    const m = qo(t, d, r);
    return u.top = pa(m.top, u.top), u.right = jo(m.right, u.right), u.bottom = jo(m.bottom, u.bottom), u.left = pa(m.left, u.left), u;
  }, qo(t, o, r));
...
en = Qo, function() {
  ...
  function w(K) {
    for (var ee = arguments.length, B = new Array(ee > 1 ? ee - 1 : 0), ye = 1; ye < ee; ye++)
      B[ye - 1] = arguments[ye];
    C("error", K, B);
  }
  function C(K, ee, B) {
    var ye = x.ReactDebugCurrentFrame, oe = "";
    if (z) {
      var fe = D(z.type), ae = z._owner;
      oe += function(Oe, Ke, Ce) {
        var xe = "";
        if (Ke) {
          var le = Ke.fileName, te = le.replace(T, "");
          if (/^index\./.test(te)) {
            var We = le.match(T);
            if (We) {
              var se = We[1];
    ...
    (oe += ye.getStackAddendum()) !== "" && (ee += "%s", B = B.concat([oe]));
  ...
  function D(K) {
    ...
    if (typeof K == "object")
      switch (K.$$typeof) {
        ...
        case o:
          return ye = K, oe = K.render, fe = "ForwardRef", ae = oe.displayName || oe.name || "", ye.displayName || (ae !== "" ? fe + "(" + ae + ")" : fe);
        case d:
          return D(K.type);
        case h:
          return D(K.render);
  ...
  var N, A, P, L = x.ReactCurrentOwner, S = Object.prototype.hasOwnProperty, _ = { key: !0, ref: !0, __self: !0, __source: !0 };
  function R(K, ee, B, ye, oe) {
    ...
    for (fe in B !== void 0 && (he = "" + B), function(xe) {
    ...
    }(ee) && (Oe = ee.ref, function(xe, le) {
      if (typeof xe.ref == "string" && L.current && le && L.current.stateNode !== le) {
      ...
      S.call(ee, fe) && !_.hasOwnProperty(fe) && (ae[fe] = ee[fe]);
    if (K && K.defaultProps) {
    ...
    if (he || Oe) {
      ...
      he && function(xe, le) {
        var te = function() {
          N || (N = !0, w("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", le));
        };
        te.isReactWarning = !0, Object.defineProperty(xe, "key", { get: te, configurable: !0 });
      }(ae, Ce), Oe && function(xe, le) {
        var te = function() {
          A || (A = !0, w("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", le));
        };
        te.isReactWarning = !0, Object.defineProperty(xe, "ref", { get: te, configurable: !0 });
      }(ae, Ce);
    }
    return function(xe, le, te, We, se, we, Le) {
      var W = { $$typeof: t, type: xe, key: le, ref: te, props: Le, _owner: we, _store: {} };
  ...
  function ue(K, ee) {
    if (K._store && !K._store.validated && K.key == null) {
      ...
      var B = function(oe) {
        var fe = U();
        if (!fe) {
          var ae = typeof oe == "string" ? oe : oe.displayName || oe.name;
          ae && (fe = `
...
Check the top-level render call using <` + ae + ">.");
      ...
      if (!ce[B]) {
        ce[B] = !0;
        var ye = "";
        K && K._owner && K._owner !== I.current && (ye = " It was passed a child from " + D(K._owner.type) + "."), j(K), w('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', B, ye), j(null);
      }
    }
  }
  function Ee(K, ee) {
    if (typeof K == "object") {
      if (Array.isArray(K))
        ...
        if (typeof oe == "function" && oe !== K.entries)
          for (var fe, ae = oe.call(K); !(fe = ae.next()).done; )
  ...
  function ke(K) {
    ...
    if (B != null && typeof B != "string") {
      ...
      if (ee) {
        var ye = D(B);
        (function(oe, fe, ae, he, Oe) {
          var Ke = Function.call.bind(Object.prototype.hasOwnProperty);
          for (var Ce in oe)
            if (Ke(oe, Ce)) {
              var xe = void 0;
              try {
                if (typeof oe[Ce] != "function") {
                  var le = Error((he || "React class") + ": " + ae + " type `" + Ce + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof oe[Ce] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                  throw le.name = "Invariant Violation", le;
                }
                xe = oe[Ce](fe, Ce, he, ae, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
              } catch (te) {
                xe = te;
              }
...
Check your code at ` + te.fileName.replace(/^.*[\\\/]/, "") + ":" + te.lineNumber + "." : "";
      ...
      he += Ke || U(), K === null ? Oe = "null" : Array.isArray(K) ? Oe = "array" : K !== void 0 && K.$$typeof === t ? (Oe = "<" + (D(K.type) || "Unknown") + " />", he = " Did you accidentally export a JSX literal instead of a component?") : Oe = typeof K, w("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Oe, he);
    }
    var Ce = R(K, ee, B, oe, fe);
    if (Ce == null)
      return Ce;
    if (ae) {
      var xe = ee.children;
    ...
    return K === en.Fragment ? function(te) {
      for (var We = Object.keys(te.props), se = 0; se < We.length; se++) {
        ...
        if (we !== "children" && we !== "key") {
          j(te), w("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", we), j(null);
          break;
        }
      }
      te.ref !== null && (j(te), w("Invalid attribute `ref` supplied to `React.Fragment`."), j(null));
    }(Ce) : ke(Ce), Ce;
  }
  var de = function(K, ee, B) {
    return Se(K, ee, B, !1);
  }, Q = function(K, ee, B) {
    return Se(K, ee, B, !0);
  };
...
const Go = async ({ elementReference: e = null, tooltipReference: t = null, tooltipArrowReference: n = null, place: a = "top", offset: r = 10, strategy: l = "absolute", middlewares: c = [oy(Number(r)), ly(), sy({ padding: 5 })] }) => {
  ...
  return n ? (o.push({ name: "arrow", options: s = { element: n, padding: 5 }, async fn(u) {
    ...
    N === 0 && (N = g.floating[w]);
    const A = k / 2 - z / 2, P = f[T], L = N - C[w] - f[D], S = N / 2 - C[w] / 2 + A, _ = Pr(P, S, L), R = ka(p) != null && S != _ && g.reference[w] / 2 - (S < P ? f[T] : f[D]) - C[w] / 2 < 0;
    return { [x]: b[x] - (R ? S < P ? P - S : L - S : 0), data: { [x]: _, centerOffset: S - _ } };
...
const es = ({ id: e, className: t, classNameArrow: n, variant: a = "dark", anchorId: r, anchorSelect: l, place: c = "top", offset: o = 10, events: s = ["hover"], positionStrategy: u = "absolute", middlewares: d, wrapper: m, children: h = null, delayShow: y = 0, delayHide: p = 0, float: g = !1, noArrow: v = !1, clickable: f = !1, closeOnEsc: b = !1, style: x, position: w, afterShow: C, afterHide: T, content: D, html: k, isOpen: z, setIsOpen: $, activeAnchor: N, setActiveAnchor: A }) => {
  const P = F.useRef(null), L = F.useRef(null), S = F.useRef(null), _ = F.useRef(null), [R, q] = F.useState({}), [I, j] = F.useState({}), [G, U] = F.useState(!1), [ce, ue] = F.useState(!1), Ee = F.useRef(!1), ke = F.useRef(null), { anchorRefs: Se, setActiveAnchor: de } = Yc(e), Q = F.useRef(!1), [K, ee] = F.useState([]), B = F.useRef(!1);
  ...
  const ye = (se) => {
    B.current && (se && ue(!0), setTimeout(() => {
      B.current && ($ == null || $(se), z === void 0 && U(se));
    }, 10));
  };
  F.useEffect(() => {
    if (z === void 0)
    ...
    G !== Ee.current && (Ee.current = G, G ? C == null || C() : T == null || T());
  }, [G]);
  const oe = (se = p) => {
    ...
    A(Le), de({ current: Le }), _.current && clearTimeout(_.current);
  }, ae = () => {
    f ? oe(p || 100) : p ? oe() : ye(!1), S.current && clearTimeout(S.current);
  }, he = ({ x: se, y: we }) => {
    Go({ place: c, offset: o, elementReference: { getBoundingClientRect: () => ({ x: se, y: we, width: 0, height: 0, top: we, left: se, right: se, bottom: we }) }, tooltipReference: P.current, tooltipArrowReference: L.current, strategy: u, middlewares: d }).then((Le) => {
      Object.keys(Le.tooltipStyles).length && q(Le.tooltipStyles), Object.keys(Le.tooltipArrowStyles).length && j(Le.tooltipArrowStyles);
    });
  }, Oe = (se) => {
    if (!se)
      return;
    ...
    we != null && we.contains(se.target) || K.some((Le) => Le.contains(se.target)) || ye(!1);
  }, xe = (se) => {
    se.key === "Escape" && ye(!1);
  }, le = Jo(fe, 50), te = Jo(ae, 50);
  F.useEffect(() => {
    var se, we;
    const Le = new Set(Se);
    K.forEach((et) => {
    ...
    const _e = [];
    s.find((et) => et === "click") && (window.addEventListener("click", Ce), _e.push({ event: "click", listener: Ke })), s.find((et) => et === "hover") && (_e.push({ event: "mouseenter", listener: le }, { event: "mouseleave", listener: te }, { event: "focus", listener: le }, { event: "blur", listener: te }), g && _e.push({ event: "mousemove", listener: Oe }));
    const Ge = () => {
      Q.current = !0;
    }, nt = () => {
      Q.current = !1, ae();
  ...
  }, [ce, Se, K, b, s]), F.useEffect(() => {
    let se = l ?? "";
    !se && e && (se = `[data-tooltip-id='${e}']`);
    const we = new MutationObserver((Le) => {
      const W = [];
      Le.forEach((_e) => {
        if (_e.type === "attributes" && _e.attributeName === "data-tooltip-id" && _e.target.getAttribute("data-tooltip-id") === e && W.push(_e.target), _e.type === "childList" && (N && [..._e.removedNodes].some((Ge) => !!Ge.contains(N) && (ue(!1), ye(!1), A(null), !0)), se))
          try {
    ...
    w ? he(w) : g ? ke.current && he(ke.current) : Go({ place: c, offset: o, elementReference: N, tooltipReference: P.current, tooltipArrowReference: L.current, strategy: u, middlewares: d }).then((se) => {
      B.current && (Object.keys(se.tooltipStyles).length && q(se.tooltipStyles), Object.keys(se.tooltipArrowStyles).length && j(se.tooltipArrowStyles));
    });
    ...
    S.current && clearTimeout(S.current), _.current && clearTimeout(_.current);
  }, []), F.useEffect(() => {
    let se = l;
  ...
  return ce ? Sn.exports.jsxs(m, { id: e, role: "tooltip", className: Zo("react-tooltip", hn.tooltip, hn[a], t, { [hn.show]: We, [hn.fixed]: u === "fixed", [hn.clickable]: f }), style: { ...x, ...R }, ref: P, children: [k && Sn.exports.jsx(fy, { content: k }) || D || h, Sn.exports.jsx(m, { className: Zo("react-tooltip-arrow", hn.arrow, n, { [hn["no-arrow"]]: v }), style: I, ref: L })] }) : null;
  ...
  const [N, A] = F.useState(a), [P, L] = F.useState(r), [S, _] = F.useState(s), [R, q] = F.useState(o), [I, j] = F.useState(u), [G, U] = F.useState(g), [ce, ue] = F.useState(v), [Ee, ke] = F.useState(f), [Se, de] = F.useState(d), [Q, K] = F.useState(h), [ee, B] = F.useState(y), [ye, oe] = F.useState(null), { anchorRefs: fe, activeAnchor: ae } = Yc(e), he = (Ce) => Ce == null ? void 0 : Ce.getAttributeNames().reduce((xe, le) => {
    var te;
    return le.startsWith("data-tooltip-") && (xe[le.replace(/^data-tooltip-/, "")] = (te = Ce == null ? void 0 : Ce.getAttribute(le)) !== null && te !== void 0 ? te : null), xe;
  }, {}), Oe = (Ce) => {
    const xe = { place: (le) => {
      var te;
      _((te = le) !== null && te !== void 0 ? te : s);
    }, content: (le) => {
      A(le ?? a);
    }, html: (le) => {
      L(le ?? r);
      ...
      j(le === null ? u : Number(le));
    }, wrapper: (le) => {
      var te;
      de((te = le) !== null && te !== void 0 ? te : d);
    }, events: (le) => {
      const te = le == null ? void 0 : le.split(" ");
      K(te ?? h);
    }, "position-strategy": (le) => {
      var te;
      B((te = le) !== null && te !== void 0 ? te : y);
    }, "delay-show": (le) => {
      U(le === null ? g : Number(le));
    }, "delay-hide": (le) => {
      ue(le === null ? v : Number(le));
    }, float: (le) => {
      ke(le === null ? f : !!le);
    } };
    Object.values(xe).forEach((le) => le(null)), Object.entries(Ce).forEach(([le, te]) => {
      var We;
      (We = xe[le]) === null || We === void 0 || We.call(xe, te);
    });
  };
  F.useEffect(() => {
    A(a);
    ...
    if (!le && e && (le = `[data-tooltip-id='${e}']`), le)
      try {
        document.querySelectorAll(le).forEach((Le) => {
          xe.add({ current: Le });
        });
      } catch {
    ...
    if (te && xe.add({ current: te }), !xe.size)
      return () => null;
    const We = (Ce = ye ?? te) !== null && Ce !== void 0 ? Ce : ae.current, se = new MutationObserver((Le) => {
      Le.forEach((W) => {
        var _e;
  ...
  const Ke = { id: e, anchorId: t, anchorSelect: n, className: l, classNameArrow: c, content: N, html: P, place: S, variant: R, offset: I, wrapper: Se, events: Q, positionStrategy: ee, middlewares: p, delayShow: G, delayHide: ce, float: Ee, noArrow: b, clickable: x, closeOnEsc: w, style: C, position: T, isOpen: D, setIsOpen: k, afterShow: z, afterHide: $, activeAnchor: ye, setActiveAnchor: (Ce) => oe(Ce) };
  ...
  return F.useEffect(() => {
    ...
    updateBars: ($) => {
      ...
      let S = Number(e.barSpace), _ = N.length * (A + L + S);
      return o && (e.heights.horizontal = _), N.map((R, q) => {
        let I = 0;
        return R.index !== 0 && (I = (A + S + L) * q), { ...R, y: I, height: A };
      });
    },
    assignColorsToValues: ($, N, A) => {
      ...
      let S = /* @__PURE__ */ new Map(), _ = [];
      for (let q = 0; q < L.length; q++)
        S.has(L[q]) || S.set(L[q], P[S.size % P.length]), _.push(S.get(L[q]));
      for (; _.length < $; )
        _ = _.concat(_);
      return _[N];
    },
  ...
  return s.visualizationSubType === "stacked" && !y && /* @__PURE__ */ i.createElement(Qd, { data: b, keys: s.runtime.barSeriesKeys || s.runtime.seriesKeys, x: (w) => w[s.runtime.xAxis.dataKey], xScale: t, yScale: n, color: c }, (w) => w.reverse().map(
    (C) => C.bars.map((T) => {
      ...
      const _ = s.runtime.xAxis.label ? `${s.runtime.xAxis.label}: ${A}` : A;
      ...
      const {
        ...
        runtime: { seriesLabels: q }
                    ...
                    <p class="tooltip-heading"><strong>${_}</strong></p>
                    ${R && q && g ? `${q[T.key] || ""}<br/>` : ""}
                    ${S}<br />
                      </div>`;
      return /* @__PURE__ */ i.createElement(be, { key: `${C.index}--${T.index}--${f}` }, /* @__PURE__ */ i.createElement("style", null, `
        ...
        "foreignObject",
        {
          ...
          onClick: (j) => {
            j.preventDefault(), h && (T[s.xAxis.dataKey] = A, h(s.uid, T));
          }
        },
  ...
  return s.visualizationSubType === "stacked" && g && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(Gd, { data: l, keys: s.runtime.barSeriesKeys || s.runtime.seriesKeys, height: r, y: (z) => z[s.runtime.yAxis.dataKey], xScale: t, yScale: n, color: c, offset: "none" }, (z) => z.map(
    ($) => x($.bars).map((N, A) => {
      ...
      let S = "#000000";
      const _ = u(l[N.index][N.key], "left"), R = s.runtime.yAxis.type === "date" ? d(m(l[N.index][s.runtime.originalXAxis.dataKey])) : l[N.index][s.runtime.originalXAxis.dataKey], q = b($.index);
      let I = s.runtime.yAxis.label ? `${s.runtime.yAxis.label}: ${R}` : R, j = s.runtime.xAxis.label ? `${s.runtime.xAxis.label}: ${_}` : _, G = p(_, `normal ${T[s.fontSize]}px sans-serif`);
      f || (j = s.isLegendValue ? `${N.key}: ${_}` : s.runtime.xAxis.label ? `${s.runtime.xAxis.label}: ${_}` : j);
      const U = `<div>
      ...
      return Qt.contrast(S, N.color) < 4.9 && (S = "#FFFFFF"), /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("style", null, `
        ...
        "foreignObject",
        {
          ...
          "data-tooltip-id": `cdc-open-viz-tooltip-${s.runtime.uniqueId}`,
          onClick: (ce) => {
            ce.preventDefault(), h && (N[s.xAxis.dataKey] = _, h(s.uid, N));
          }
        },
  ...
  return u.visualizationSubType !== "stacked" && (u.visualizationType === "Bar" || u.visualizationType === "Combo") && u.orientation === "vertical" && /* @__PURE__ */ i.createElement(be, null, /* @__PURE__ */ i.createElement(
    ...
    (L) => w(L).map((S, _) => /* @__PURE__ */ i.createElement(be, { className: `bar-group-${S.index}-${S.x0}--${_} ${u.orientation}`, key: `bar-group-${S.index}-${S.x0}--${_}`, id: `bar-group-${S.index}-${S.x0}--${_}`, left: a / L.length * S.index }, S.bars.map((R, q) => {
      const I = u.useLogScale ? 0.1 : 0;
      let j = u.highlightedBarValues.map((we) => we.value).filter((we) => we !== void 0);
      j = u.xAxis.type === "date" ? N.formatDates(j) : j;
      let G = u.legend.behavior === "highlight" && s.length > 0 && s.indexOf(R.key) === -1, U = u.legend.behavior === "highlight" || s.length === 0 || s.indexOf(R.key) !== -1, ce = Math.abs(n(R.value) - n(I)), ue = R.value >= 0 && p(R.value) ? R.y : n(0), Ee = a / L.length * (u.barThickness || 0.8), ke = a / L.length * (1 - (u.barThickness || 0.8)) / 2;
      u.isLollipopChart && (ke = a / L.length / 2 - D / 2);
      let Se = u.isLollipopChart ? D : Ee / S.bars.length, de = d(R.value, "left"), Q = u.runtime[T].type === "date" ? m(h(A[S.index][u.runtime.originalXAxis.dataKey])) : A[S.index][u.runtime.originalXAxis.dataKey];
      const K = R.value < 0 ? -1 : q, ee = x(K);
      let B = u.runtime.yAxis.label ? `${u.runtime.yAxis.label}: ${de}` : de, ye = u.runtime.xAxis.label ? `${u.runtime.xAxis.label}: ${Q}` : Q;
      b || (B = u.isLegendValue ? `${R.key}: ${de}` : u.runtime.yAxis.label ? `${u.runtime.yAxis.label}: ${de}` : de);
      const oe = `<ul>
      ...
      const he = u.isLollipopChart && u.lollipopColorStyle === "regular", Oe = u.isLollipopChart && u.lollipopColorStyle === "two-tone", Ke = j == null ? void 0 : j.includes(Q), Ce = z(Q), xe = $(Q), le = Ke ? Ce : u.barHasBorder === "true" ? "#000" : "transparent", te = Ke ? xe.borderWidth : u.isLollipopChart ? 0 : u.barHasBorder === "true" ? f : 0, se = {
      ...
      return /* @__PURE__ */ i.createElement(be, { key: `${S.index}--${q}` }, /* @__PURE__ */ i.createElement("style", null, `
        ...
        "foreignObject",
        {
          ...
          onClick: (we) => {
            we.preventDefault(), y && (R[u.xAxis.dataKey] = Q, y(u.uid, R));
          }
        },
        /* @__PURE__ */ i.createElement("div", { style: se })
      ), /* @__PURE__ */ i.createElement($e, { display: u.labels && U ? "block" : "none", opacity: G ? 0.5 : 1, x: Se * (R.index + 0.5) + ke, y: ue - 5, fill: fe, textAnchor: "middle" }, de), u.isLollipopChart && u.lollipopShape === "circle" && /* @__PURE__ */ i.createElement(
        "circle",
        {
          cx: Se * (S.bars.length - R.index - 1) + ke + k / 3.5,
          cy: R.y,
          r: k / 2,
          fill: ae,
          key: `circle--${R.index}`,
    ...
    return S = t(g(L)), R = n(v(L, u.confidenceKeys.lower)), q = n(v(L, u.confidenceKeys.upper)), /* @__PURE__ */ i.createElement(
      "path",
      {
        key: `confidence-interval-v-${_}-${L[u.runtime.originalXAxis.dataKey]}`,
        stroke: "#333",
        strokeWidth: "px",
        d: `
                    M${S - I} ${R}
  ...
  return s.visualizationSubType !== "stacked" && s.visualizationType === "Bar" && s.orientation === "horizontal" && /* @__PURE__ */ i.createElement(be, null, /* @__PURE__ */ i.createElement(
    Hs,
    {
      ...
      height: a,
      x0: (_) => _[s.runtime.originalXAxis.dataKey],
      x0Scale: n,
      x1Scale: r,
      yScale: t,
      color: () => ""
    },
    (_) => C(_).map((R, q) => /* @__PURE__ */ i.createElement(be, { className: `bar-group-${R.index}-${R.x0}--${q} ${s.orientation}`, key: `bar-group-${R.index}-${R.x0}--${q}`, id: `bar-group-${R.index}-${R.x0}--${q}`, top: R.y }, R.bars.map((I, j) => {
      const G = s.useLogScale ? 0.1 : 0;
      let U = s.highlightedBarValues.map((Je) => Je.value).filter((Je) => Je !== void 0);
      U = s.xAxis.type === "date" ? S.formatDates(U) : U;
      let ce = s.legend.behavior === "highlight" && o.length > 0 && o.indexOf(I.key) === -1, ue = s.legend.behavior === "highlight" || o.length === 0 || o.indexOf(I.key) !== -1, Ee = s.barHeight, ke = I.value >= 0 && y(I.value) ? I.y : n(0);
      const Se = I.value < 0 ? Math.abs(t(I.value)) : t(0), de = Math.abs(t(I.value) - t(G)), Q = s.barHeight, K = u(I.value, "left"), ee = s.runtime[D].type === "date" ? d(m(l[R.index][s.runtime.originalXAxis.dataKey])) : l[R.index][s.runtime.originalXAxis.dataKey], B = I.value < 0 ? "below" : "above";
      let oe = p(ee, `normal ${k[s.fontSize]}px sans-serif`) < de - 5, fe = oe ? "end" : "start", ae = "start", he = oe ? -5 : 5, Oe = 10;
      B === "below" && (fe = oe ? "start" : "end", he = oe ? 5 : -5, s.isLollipopChart && (ae = "end", Oe = -10));
      const Ke = I.value < 0 ? -1 : j, Ce = w(Ke);
      let xe = s.runtime.yAxis.label ? `${s.runtime.yAxis.label}: ${K}` : K, le = s.runtime.xAxis.label ? `${s.runtime.xAxis.label}: ${ee}` : ee;
      x || (le = s.isLegendValue ? `<p className="tooltip-heading">${I.key}: ${ee}</p>` : s.runtime.xAxis.label ? `<p className="tooltip-heading">${s.runtime.xAxis.label}: ${ee}</p>` : ee);
      const te = `<ul>
      ...
      let We = "#000000";
      We = S.checkFontColor(K, U, We);
      let se = s.runtime.seriesLabels && s.runtime.seriesLabels[I.key] ? c(s.runtime.seriesLabels[I.key]) : c(I.key);
      se = T(_.length, R.index, se);
      const we = s.isLollipopChart && s.lollipopColorStyle === "regular", Le = s.isLollipopChart && s.lollipopColorStyle === "two-tone", W = U == null ? void 0 : U.includes(K), _e = P(K), Ge = L(K), nt = W ? _e : s.barHasBorder === "true" ? "#000" : "transparent", et = W ? Ge.borderWidth : s.isLollipopChart ? 0 : s.barHasBorder === "true" ? b : 0;
      se && We && Qt.contrast(We, se) < 4.9 && (We = oe ? "#FFFFFF" : "#000000");
      const at = {
        ...
        borderWidth: et,
        width: de,
        height: s.isLollipopChart ? N : Q,
        ...Ce
      };
      return /* @__PURE__ */ i.createElement(be, { key: `${R.index}--${j}` }, /* @__PURE__ */ i.createElement("style", null, `
                        .linear #barGroup${R.index} div,
                        .Combo #barGroup${R.index} div {
                          transform-origin: 0 ${ke + Ee}px;
                        }
                      `), /* @__PURE__ */ i.createElement(be, { key: `bar-sub-group-${R.index}-${R.x0}-${ke}--${j}` }, /* @__PURE__ */ i.createElement(
        "foreignObject",
        {
          id: `barGroup${R.index}`,
          key: `bar-group-bar-${R.index}-${I.index}-${I.value}-${I.key}`,
          x: Se,
          y: Q * I.index,
          width: de,
          height: s.isLollipopChart ? N : Q,
          ...
          "data-tooltip-id": `cdc-open-viz-tooltip-${s.runtime.uniqueId}`,
          onClick: (Je) => {
            Je.preventDefault(), h && (I[s.xAxis.dataKey] = K, h(s.uid, I));
          }
        },
  ...
  ), Object.keys(s.confidenceKeys).length > 0 ? l.map((_) => {
    let R, q, I, j = 5;
    return R = n(v(_)) - 0.75 * s.barHeight, q = t(g(_, s.confidenceKeys.upper)), I = t(g(_, s.confidenceKeys.lower)), /* @__PURE__ */ i.createElement(
      "path",
      {
        key: `confidence-interval-h-${R}-${_[s.runtime.originalXAxis.dataKey]}`,
        stroke: "#333",
        strokeWidth: "px",
        d: `
                    M${I} ${R - j}
...
function Xc(e) {
  var t = e.left, n = t === void 0 ? 0 : t, a = e.top, r = a === void 0 ? 0 : a, l = e.className, c = e.max, o = e.min, s = e.firstQuartile, u = e.thirdQuartile, d = e.median, m = e.boxWidth, h = m === void 0 ? 10 : m, y = e.fill, p = e.fillOpacity, g = e.stroke, v = e.strokeWidth, f = e.rx, b = f === void 0 ? 2 : f, x = e.ry, w = x === void 0 ? 2 : x, C = e.valueScale, T = e.outliers, D = T === void 0 ? [] : T, k = e.horizontal, z = e.medianProps, $ = z === void 0 ? {} : z, N = e.maxProps, A = N === void 0 ? {} : N, P = e.minProps, L = P === void 0 ? {} : P, S = e.boxProps, _ = S === void 0 ? {} : S, R = e.outlierProps, q = R === void 0 ? {} : R, I = e.container, j = I === void 0 ? !1 : I, G = e.containerProps, U = G === void 0 ? {} : G, ce = e.children, ue = k ? r : n, Ee = ue + (h || 0) / 2, ke = C.range(), Se = C(o ?? 0), de = C(s ?? 0), Q = C(d ?? 0), K = C(u ?? 0), ee = C(c ?? 0), B = {
    valueRange: ke,
    center: Ee,
    offset: ue,
    boxWidth: h,
  ...
  return k && (B.max = pn(B.max), B.maxToThird = pn(B.maxToThird), B.box.y1 = de, B.box = pn(B.box), B.median = pn(B.median), B.minToFirst = pn(B.minToFirst), B.min = pn(B.min), B.container = pn(B.container), B.container.y1 = Math.min.apply(Math, ke)), ce ? /* @__PURE__ */ i.createElement(i.Fragment, null, ce(B)) : /* @__PURE__ */ i.createElement(be, {
    className: Ze("visx-boxplot", l)
  }, D.map(function(ye, oe) {
    var fe = k ? C(ye) : Ee, ae = k ? Ee : C(ye);
    ...
    rx: b,
    ry: w
  }, _)), /* @__PURE__ */ i.createElement("line", tn({
    ...
    stroke: g,
    strokeWidth: v
  }, L)), j && /* @__PURE__ */ i.createElement("rect", tn({
    x: B.container.x1,
    y: B.container.y1,
...
function Cy({ height: e, xScale: t }) {
  ...
  a.barStyle;
  const w = Number(a.xAxis.target), C = a.series[0].dataKey, T = Number(t.domain()[1]), k = n.some((j) => j[C] < 0) || w > 0 || t.domain()[0] < 0, z = a.barHasBorder === "true" ? 1 : 0, $ = a.lollipopSize === "large" ? 7 : a.lollipopSize === "medium" ? 6 : 5, N = a.lollipopSize === "large" ? 14 : a.lollipopSize === "medium" ? 12 : 10, A = Math.max(t(0), Math.min(t(w), t(T))), P = (j) => {
    if (j == null || m !== "rounded")
      return;
    let G = {};
    return j === "left" && (G = { borderRadius: `${b} 0 0 ${b}` }), j === "right" && (G = { borderRadius: `0 ${b} ${b} 0` }), h === "full" && (G = { borderRadius: b }), G;
  }, L = {
    calculate: function() {
      const G = n[0][C] < w ? "left" : "right", U = `${a.xAxis.targetLabel} ${r(a.xAxis.target || 0, "left")}`, ce = c(U, `bold ${x[a.fontSize]}px sans-serif`);
      let ue = a.isLollipopChart ? $ / 2 : Number(a.barHeight) / 2, Ee = 0, ke = 0, Se = !1;
      G === "right" && (Ee = -10, Se = ce - Ee < A, ke = A - ce), G === "left" && (Ee = 10, Se = t(T) - A > ce + Ee, ke = A), this.text = U, this.y = ue, this.x = ke, this.padding = Ee, this.showLabel = a.xAxis.showTargetLabel ? Se : !1;
    }
  };
  L.calculate();
  const S = F.useRef(null), _ = ol(S, {});
  F.useEffect(() => {
    const j = () => {
  ...
  return F.useEffect(() => {
    _ != null && _.isIntersecting && setTimeout(() => {
      q(!0);
    }, 100);
  }, [_ == null ? void 0 : _.isIntersecting, a.animate]), F.useEffect(() => {
    g.current.forEach((j, G) => {
      if (a.animate) {
        const U = w / T * 100;
  ...
  }, [a.animate, a, R]), !a || ((I = a == null ? void 0 : a.series) == null ? void 0 : I.length) !== 1 ? /* @__PURE__ */ i.createElement(i.Fragment, null) : /* @__PURE__ */ i.createElement(Rt, { component: "Deviation Bar" }, /* @__PURE__ */ i.createElement(be, { left: Number(a.xAxis.size) }, n.map((j, G) => {
    const U = Number(j[C]), ce = a.isLollipopChart ? $ : Number(a.barHeight), ue = Number(a.barSpace), Ee = Math.abs(t(U) - A), ke = t(U), Se = U > w ? A : ke, de = U < w ? "left" : "right";
    let Q = 0;
    Q = G !== 0 ? (ue + ce + z) * G : Q;
    const K = (ue + ce + z) * n.length;
    a.heights.horizontal = K;
    const B = c(r(U, "left"), `normal ${x[a.fontSize]}px sans-serif`) < Ee - 6, ye = ke, oe = Q + ce / 2, fe = ke, ae = Q + ce / 2, he = ke, Oe = Q - ce / 2, Ke = P(de), [Ce, xe] = l[p.palette], le = { left: Ce, right: xe }, We = Qt.contrast("#000000", le[de]) < 4.9 ? "#FFFFFF" : "#000000";
    let se = Ny(a.isLollipopChart, B, N, We);
    const we = r(U, "left"), Le = a.runtime.yAxis.type === "date" ? u(s(n[G][a.runtime.originalXAxis.dataKey])) : n[G][a.runtime.originalXAxis.dataKey];
    ...
    return /* @__PURE__ */ i.createElement(be, { key: `deviation-bar-${a.orientation}-${C}-${G}` }, /* @__PURE__ */ i.createElement(
      ...
      /* @__PURE__ */ i.createElement("div", { style: { width: Ee, height: ce, border: `${z}px solid #333`, backgroundColor: le[de], ...Ke } })
    ), a.yAxis.displayNumbersOnBar && /* @__PURE__ */ i.createElement($e, { verticalAnchor: "middle", x: ye, y: oe, ...se[de] }, r(j[C], "left")), a.isLollipopChart && a.lollipopShape === "circle" && /* @__PURE__ */ i.createElement("circle", { cx: fe, cy: ae, r: N / 2, fill: le[de], style: { filter: "unset", opacity: 1 } }), a.isLollipopChart && a.lollipopShape === "square" && /* @__PURE__ */ i.createElement("rect", { x: he, y: Oe, width: N, height: N, fill: le[de], style: { opacity: 1, filter: "unset" } }));
  ...
  return c && /* @__PURE__ */ i.createElement(Rt, { component: "ForecastingChart" }, /* @__PURE__ */ i.createElement(be, { className: "forecasting-items", key: "forecasting-items-wrapper", left: Number(m.size) }, (p = y.forecastingSeriesKeys) == null ? void 0 : p.map((g, v) => !g || !g.stages ? !1 : g.stages.map((f, b) => {
    ...
    return /* @__PURE__ */ i.createElement(be, { className: `forecasting-areas-combo-${v}`, key: `forecasting-areas--stage-${f.key.replaceAll(" ", "-")}-${v}` }, (D = g.confidenceIntervals) == null ? void 0 : D.map((k, z) => {
      ...
      if (!(k.high === "" || k.low === ""))
        ...
        ), z === 0 && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(kn, { data: w, x: (P) => Number(e(Date.parse(P[d.dataKey]))), y: (P) => Number(t(P[k.high])), curve: Ia, stroke: A(), strokeWidth: 1, strokeOpacity: 1 }), /* @__PURE__ */ i.createElement(kn, { data: w, x: (P) => Number(e(Date.parse(P[d.dataKey]))), y: (P) => Number(t(P[k.low])), curve: Ia, stroke: A(), strokeWidth: 1, strokeOpacity: 1 })));
    }));
  ...
  if (c)
    return /* @__PURE__ */ i.createElement(Rt, { component: "LineChart" }, /* @__PURE__ */ i.createElement(be, { left: v.runtime.yAxis.size ? parseInt(v.runtime.yAxis.size) : 66 }, " ", (v.runtime.lineSeriesKeys || v.runtime.seriesKeys).map((z, $) => {
      ...
      return /* @__PURE__ */ i.createElement(
        ...
        y.map((S, _) => {
          const R = v.series.find(({ dataKey: U }) => U === z), { axis: q } = R;
          v.runtime.xAxis.type === "date" ? b(x(S[v.runtime.xAxis.dataKey])) : S[v.runtime.xAxis.dataKey], a(S, z);
          const I = Object.keys(v.runtime.seriesLabels).length > 1, j = q === "Right" ? "rightLabel" : "label";
          let G = v.runtime.yAxis[j];
          return I || (G = v.isLegendValue ? v.runtime.seriesLabels[z] : G), S[z] !== void 0 && S[z] !== "" && S[z] !== null && w(S[z]) && /* @__PURE__ */ i.createElement(be, { key: `series-${z}-point-${_}`, className: "checkwidth" }, /* @__PURE__ */ i.createElement(Pt, { key: "bars", width: Number(r), height: Number(l), fill: "transparent", fillOpacity: 0.05, onMouseMove: (U) => c(U, D), onMouseOut: o, onClick: (U) => m(U, y) }), /* @__PURE__ */ i.createElement($e, { display: v.labels ? "block" : "none", x: e(n(S)), y: P === "Right" ? k(a(S, z)) : t(a(S, z)), fill: "#000", textAnchor: "middle" }, f(S[z], "left")), v.lineDatapointStyle === "hidden" || v.lineDatapointStyle === "always show" && /* @__PURE__ */ i.createElement(ts, { d: S, config: v, seriesKey: z, displayArea: L, tooltipData: h, xScale: e, yScale: t, colorScale: p, parseDate: x, yScaleRight: k }));
        }),
        ...
        /* @__PURE__ */ i.createElement(
          kn,
          {
            ...
            defined: (S, _) => S[z] !== "" && S[z] !== null && S[z] !== void 0
          }
        ),
        v.animate && /* @__PURE__ */ i.createElement(
          kn,
          {
            ...
            shapeRendering: "geometricPrecision",
            strokeDasharray: N ? T(N) : 0,
            defined: (S, _) => w(S[v.runtime.seriesLabels[z]])
          }
        ),
        v.showLineSeriesLabels && (v.runtime.lineSeriesKeys || v.runtime.seriesKeys).map((S) => {
          ...
          return _ ? /* @__PURE__ */ i.createElement("text", { x: e(n(_)) + 5, y: t(a(_, S)), alignmentBaseline: "middle", fill: v.colorMatchLineSeriesLabels && p ? p(v.runtime.seriesLabels[S] || S) : "black" }, v.runtime.seriesLabels[S] || S) : /* @__PURE__ */ i.createElement(i.Fragment, null);
        })
      );
...
const _y = (e) => {
  ...
  if (f === "Forest Plot") {
    ...
    d > 480 ? b = ht({
      domain: [Math.min(...o.map((_) => parseFloat(_[c.forestPlot.lower]))) - N, Math.max(...o.map((_) => parseFloat(_[c.forestPlot.upper]))) + N],
      range: [A, n - P],
      type: "linear"
    }) : b = ht({
      domain: [Math.min(...o.map((_) => parseFloat(_[c.forestPlot.lower]))) - N, Math.max(...o.map((_) => parseFloat(_[c.forestPlot.upper]))) + N],
...
var ja = F;
function Hy(e) {
  var t = (0, ja.useState)(e), n = t[0], a = t[1], r = (0, ja.useRef)(null), l = (0, ja.useCallback)(function(c, o) {
    r.current = o || null, a(c);
  }, [a]);
  return (0, ja.useLayoutEffect)(function() {
...
function eg(e) {
  ...
  var k = (0, Gy.default)(v), z = (0, yn.useCallback)(function(A) {
    A.persist(), w(function(P) {
      var L = P.x, S = L === void 0 ? 0 : L, _ = P.y, R = _ === void 0 ? 0 : _, q = P.dx, I = P.dy, j = new $n.Point({
        x: (S || 0) + q,
        y: (R || 0) + I
      }), G = (0, rs.localPoint)(A) || new $n.Point({
        x: 0,
        y: 0
      }), U = l ? G : j, ce = (0, ls.default)(U, k, g);
      return D((0, $n.subtractPoints)(j, G)), {
        isDragging: !0,
        dx: a ? 0 : P.dx,
        dy: a ? 0 : P.dy,
        x: a ? ce.x : ce.x - P.dx,
    ...
    A.persist(), w(function(P) {
      if (!P.isDragging)
        return P;
      var L = P.x, S = L === void 0 ? 0 : L, _ = P.y, R = _ === void 0 ? 0 : _, q = (0, rs.localPoint)(A) || new $n.Point({
        x: 0,
        y: 0
      }), I = l ? q : (0, $n.sumPoints)(q, T), j = (0, ls.default)(I, k, g);
      return Kt({}, P, {
        dx: j.x - S,
        dy: j.y - R
      });
...
var og = {
  ...
  return n.componentDidUpdate = function(r) {
    ...
    return /* @__PURE__ */ i.createElement(be, {
      ...
      var S = L.dragStart, _ = L.isDragging, R = L.dragMove, q = L.dragEnd;
...
var ss = 2, cs = "steelblue", Sl = /* @__PURE__ */ function(e) {
  ...
  return n.convertRangeToDomain = function(r) {
    ...
    if (!l || !c)
      return null;
    var $, N, A, P, L = u != null && u.left ? u.left : 0, S = u != null && u.top ? u.top : 0, _ = u != null && u.right ? u.right : 0, R = u != null && u.bottom ? u.bottom : 0;
    return p === "chart" ? (A = 0, P = 0, $ = s, N = o) : p === "yAxis" ? (P = 0, N = o, g === "right" ? (A = s, $ = _) : (A = -L, $ = L)) : (A = 0, $ = s, v === "bottom" ? (P = o, N = R) : (P = -S, N = S)), /* @__PURE__ */ i.createElement(Tl, {
      width: $,
      height: N,
      left: A,
      top: P,
...
const cg = Sl, ug = (e) => {
  ...
  let _ = L - (C === "horizontal" ? 0 : k.xAxis.size);
  l.visualizationType === "Forest Plot" && (L = L + l.data.length * l.forestPlot.rowHeight, _ = _ + l.data.length * l.forestPlot.rowHeight), l.brush.active && (L = L + l.brush.height);
  const { minValue: R, maxValue: q, existPositiveValue: I, isAllLine: j } = $i(l, a), { yScaleRight: G, hasRightAxis: U } = dl({ config: l, yMax: _, data: a, updateConfig: m }), { hasTopAxis: ce } = By(l), [ue, Ee] = F.useState(!1), ke = F.useRef(), Se = F.useRef(), de = ol(ke, {
    freezeOnceVisible: !1
  }), Q = (Y) => l.runtime.xAxis.type === "date" ? c(Y[l.runtime.originalXAxis.dataKey]).getTime() : Y[l.runtime.originalXAxis.dataKey], K = (Y, ve) => Y[ve], ee = l.brush.active && ((un = l.brush.data) != null && un.length) ? l.brush.data.map((Y) => Q(Y)) : a.map((Y) => Q(Y)), B = l.orientation === "horizontal" ? "yAxis" : "xAxis", ye = { data: a, config: l, minValue: R, maxValue: q, isAllLine: j, existPositiveValue: I, xAxisDataMapped: ee, xMax: S, yMax: _ }, { min: oe, max: fe } = Dy(ye), { xScale: ae, yScale: he, seriesScale: Oe, g1xScale: Ke, g2xScale: Ce, xScaleNoPadding: xe, xScaleBrush: le } = $y({ ...ye, min: oe, max: fe }), [te, We] = F.useState(null);
  F.useEffect(() => {
    var Y;
    We((Y = Se == null ? void 0 : Se.current) == null ? void 0 : Y.getBoundingClientRect());
  }, [Se, l.legend]);
  const se = (Y, ve) => {
    if (l.useLogScale && Y === 0.1 && (Y = 0), !(l.data && !l.data[ve] && x === "Forest Plot"))
      return l.visualizationType === "Forest Plot" ? l.data[ve][l.xAxis.dataKey] : k.yAxis.type === "date" ? o(c(Y)) : C === "vertical" ? u(Y, "left", P) : Y;
  }, we = (Y) => (l.useLogScale && Y === 0.1 && (Y = 0), k.xAxis.type === "date" ? o(Y) : C === "horizontal" ? u(Y, "left", P) : l.xAxis.type === "continuous" ? u(Y, "bottom", P) : Y), Le = (Y) => {
    const { numTicks: ve } = k[Y];
    let Me;
    return Y === "yAxis" && (Me = A && !ve ? a.length : A && ve ? ve : !A && !ve ? void 0 : !A && ve && ve, Me === void 0 && !l.dataFormat.roundTo && (Number(fe) <= 3 ? Me = 2 : Me = 4), Number(Me) > Number(fe) && (Me = Number(oe) < 0 ? Math.round(fe) * 2 : Math.round(fe))), Y === "xAxis" && (Me = A && !ve ? void 0 : A && ve ? ve : !A && !ve ? void 0 : !A && ve && ve, A && Me === void 0 && !l.dataFormat.roundTo && (fe <= 3 ? Me = 2 : Me = 4)), Me;
  ...
  F.useEffect(() => {
    document.querySelector(".isEditor") && Ee((ve) => !0);
  }), F.useEffect(() => {
    (de == null ? void 0 : de.isIntersecting) === !0 && l.animate && setTimeout(() => {
      Ee((Y) => !0);
    }, 500);
  }, [de == null ? void 0 : de.isIntersecting, l.animate]);
  const Pn = () => {
    const { visualizationType: Y } = l;
    return Y === "Combo" && k.forecastingSeriesKeys > 0 || Y === "Area Chart" || Y === "Line" || Y === "Bar";
  }, Jt = Number(C === "horizontal" ? l.xAxis.size : l.yAxis.size), Xn = () => l.visualizationType === "Forest Plot" ? l.data.length : Le("yAxis");
  return isNaN($) ? /* @__PURE__ */ i.createElement(i.Fragment, null) : /* @__PURE__ */ i.createElement(Rt, { component: "LinearChart" }, /* @__PURE__ */ i.createElement("div", { style: { width: `${$}px`, height: `${L}px`, overflow: "visible" }, className: "tooltip-boundary" }, /* @__PURE__ */ i.createElement("svg", { width: "100%", height: "100%", className: `linear ${l.animate ? "animated" : ""} ${ue && l.animate ? "animate" : ""} ${z && "debug"}`, role: "img", "aria-label": d(l), ref: Se, style: { overflow: "visible" } }, /* @__PURE__ */ i.createElement(Pt, { width: $, height: L, fill: "transparent" }), " ", l.regions ? l.regions.map((Y) => {
    if (!Object.keys(Y).includes("from") || !Object.keys(Y).includes("to"))
      return null;
    let ve, Me, Ae;
    return l.xAxis.type === "date" && (ve = ae(c(Y.from).getTime()), Me = ae(c(Y.to).getTime()), Ae = Me - ve), l.xAxis.type === "categorical" && (ve = ae(Y.from), Me = ae(Y.to), Ae = Me - ve), !ve || !Me ? null : /* @__PURE__ */ i.createElement(be, { className: "regions", left: Number(k.yAxis.size), key: Y.label }, /* @__PURE__ */ i.createElement(
      "path",
      {
        stroke: "#333",
        d: `M${ve} -5
    ...
    ), /* @__PURE__ */ i.createElement("rect", { x: ve, y: 0, width: Ae, height: _, fill: Y.background, opacity: 0.3 }), /* @__PURE__ */ i.createElement($e, { x: ve + Ae / 2, y: 5, fill: Y.color, verticalAnchor: "start", textAnchor: "middle" }, Y.label));
  }) : "", !["Spark Line", "Forest Plot"].includes(x) && /* @__PURE__ */ i.createElement(Kp, { scale: he, tickLength: l.useLogScale ? 6 : 8, left: Number(k.yAxis.size) - l.yAxis.axisPadding, label: k.yAxis.label, stroke: "#333", tickFormat: (Y, ve) => se(Y, ve), numTicks: Xn() }, (Y) => {
    const ve = k.horizontal ? (Y.axisToPoint.y - Y.axisFromPoint.y) / 2 : (Y.axisFromPoint.y - Y.axisToPoint.y) / 2, Me = _ / Y.ticks.length / 2 - _ / Y.ticks.length * (1 - l.barThickness) + 5;
    return /* @__PURE__ */ i.createElement(be, { className: "left-axis" }, Y.ticks.map((Ae, ut) => {
      const xt = Y.ticks[0].to.y, Tt = 15, E = String(Ae.value).startsWith("1") || Ae.value === 0.1 ? "block" : "none", J = E === "block" ? 7 : 0, ne = { x: Ae.to.x - J, y: Ae.to.y };
      return /* @__PURE__ */ i.createElement(be, { key: `vx-tick-${Ae.value}-${ut}`, className: "vx-axis-tick" }, !k.yAxis.hideTicks && /* @__PURE__ */ i.createElement(qe, { key: `${Ae.value}--hide-hideTicks`, from: Ae.from, to: l.useLogScale ? ne : Ae.to, stroke: l.yAxis.tickColor, display: k.horizontal ? "none" : "block" }), k.yAxis.gridLines ? /* @__PURE__ */ i.createElement(qe, { key: `${Ae.value}--hide-hideGridLines`, display: (l.useLogScale && E).toString(), from: { x: Ae.from.x + S, y: Ae.from.y }, to: Ae.from, stroke: "rgba(0,0,0,0.3)" }) : "", C === "horizontal" && w !== "stacked" && l.yAxis.labelPlacement === "On Date/Category Axis" && !l.yAxis.hideLabel && /* @__PURE__ */ i.createElement(
        $e,
        {
          transform: `translate(${Ae.to.x - 5}, ${l.isLollipopChart ? Ae.to.y - xt : Ae.to.y - xt + (Number(l.barHeight * l.series.length) - Tt) / 2}) rotate(-${l.runtime.horizontal && l.runtime.yAxis.tickRotation || 0})`,
          verticalAnchor: "start",
          textAnchor: "end"
        },
        Ae.formattedValue
      ), C === "horizontal" && w === "stacked" && l.yAxis.labelPlacement === "On Date/Category Axis" && !l.yAxis.hideLabel && /* @__PURE__ */ i.createElement($e, { transform: `translate(${Ae.to.x - 5}, ${Ae.to.y - xt + (Number(l.barHeight) - Tt) / 2}) rotate(-${k.horizontal ? k.yAxis.tickRotation : 0})`, verticalAnchor: "start", textAnchor: "end" }, Ae.formattedValue), C === "horizontal" && x === "Paired Bar" && !l.yAxis.hideLabel && /* @__PURE__ */ i.createElement($e, { transform: `translate(${Ae.to.x - 5}, ${Ae.to.y - xt + Number(l.barHeight) / 2}) rotate(-${k.horizontal ? k.yAxis.tickRotation : 0})`, textAnchor: "end", verticalAnchor: "middle" }, Ae.formattedValue), C === "horizontal" && x === "Deviation Bar" && !l.yAxis.hideLabel && /* @__PURE__ */ i.createElement($e, { transform: `translate(${Ae.to.x - 5}, ${l.isLollipopChart ? Ae.to.y - xt + 2 : Ae.to.y - xt + Number(l.barHeight) / 2}) rotate(-${k.horizontal ? k.yAxis.tickRotation : 0})`, textAnchor: "end", verticalAnchor: "middle" }, Ae.formattedValue), C === "vertical" && x !== "Paired Bar" && !l.yAxis.hideLabel && /* @__PURE__ */ i.createElement(
        $e,
        {
          display: l.useLogScale ? E : "block",
          dx: l.useLogScale ? -6 : 0,
          x: l.runtime.horizontal ? Ae.from.x + 2 : Ae.to.x,
          y: Ae.to.y + (l.runtime.horizontal ? Me : 0),
    ...
    }), !l.yAxis.hideAxis && /* @__PURE__ */ i.createElement(qe, { from: Y.axisFromPoint, to: k.horizontal ? { x: 0, y: l.visualizationType === "Forest Plot" ? L : Number(N) } : Y.axisToPoint, stroke: "#000" }), he.domain()[0] < 0 && /* @__PURE__ */ i.createElement(qe, { from: { x: Y.axisFromPoint.x, y: he(0) }, to: { x: S, y: he(0) }, stroke: "#333" }), x === "Bar" && C === "horizontal" && ae.domain()[0] < 0 && /* @__PURE__ */ i.createElement(qe, { from: { x: ae(0), y: 0 }, to: { x: ae(0), y: _ }, stroke: "#333", strokeWidth: 2 }), /* @__PURE__ */ i.createElement($e, { className: "y-label", textAnchor: "middle", verticalAnchor: "start", transform: `translate(${-1 * k.yAxis.size}, ${ve}) rotate(-90)`, fontWeight: "bold", fill: l.yAxis.labelColor }, Y.label));
  }), U && /* @__PURE__ */ i.createElement(Up, { scale: G, left: Number($ - l.yAxis.rightAxisSize), label: l.yAxis.rightLabel, tickFormat: (Y) => u(Y, "right"), numTicks: k.yAxis.rightNumTicks || void 0, labelOffset: 45 }, (Y) => {
    const ve = k.horizontal ? (Y.axisToPoint.y - Y.axisFromPoint.y) / 2 : (Y.axisFromPoint.y - Y.axisToPoint.y) / 2, Me = _ / Y.ticks.length / 2 - _ / Y.ticks.length * (1 - l.barThickness) + 5;
    return /* @__PURE__ */ i.createElement(be, { className: "right-axis" }, Y.ticks.map((Ae, ut) => /* @__PURE__ */ i.createElement(be, { key: `vx-tick-${Ae.value}-${ut}`, className: "vx-axis-tick" }, !k.yAxis.rightHideTicks && /* @__PURE__ */ i.createElement(qe, { from: Ae.from, to: Ae.to, display: k.horizontal ? "none" : "block", stroke: l.yAxis.rightAxisTickColor }), k.yAxis.rightGridLines ? /* @__PURE__ */ i.createElement(qe, { from: { x: Ae.from.x + S, y: Ae.from.y }, to: Ae.from, stroke: "rgba(0,0,0,0.3)" }) : "", !l.yAxis.rightHideLabel && /* @__PURE__ */ i.createElement($e, { x: Ae.to.x, y: Ae.to.y + (k.horizontal ? Me : 0), verticalAnchor: k.horizontal ? "start" : "middle", textAnchor: "start", fill: l.yAxis.rightAxisTickLabelColor }, Ae.formattedValue))), !l.yAxis.rightHideAxis && /* @__PURE__ */ i.createElement(qe, { from: Y.axisFromPoint, to: Y.axisToPoint, stroke: "#333" }), /* @__PURE__ */ i.createElement($e, { className: "y-label", textAnchor: "middle", verticalAnchor: "start", transform: `translate(${l.yAxis.rightLabelOffsetSize ? l.yAxis.rightLabelOffsetSize : 0}, ${ve}) rotate(-90)`, fontWeight: "bold", fill: l.yAxis.rightAxisLabelColor }, Y.label));
    ...
    Ya,
    {
      top: k.horizontal && l.visualizationType !== "Forest Plot" ? Number(N) + Number(l.xAxis.axisPadding) : (l.visualizationType === "Forest Plot", _ + Number(l.xAxis.axisPadding)),
      left: Number(k.yAxis.size),
      label: k.xAxis.label,
      tickFormat: we,
      scale: ae,
    ...
    (Y) => {
      const ve = l.visualizationType !== "Forest Plot" ? (Y.axisToPoint.x - Y.axisFromPoint.x) / 2 : $ / 2, Me = (Ne) => /\s/.test(Ne), Ae = Y.ticks.some((Ne) => Me(Ne.value)), ut = { small: 16, medium: 18, large: 20 }, xt = 8, Tt = Math.max(...Y.ticks.map((Ne) => f(Ne.formattedValue, `normal ${ut[l.fontSize]}px sans-serif`))), E = Ae ? 180 : 100, J = Y.ticks.map((Ne) => f(Ne.formattedValue, `normal ${ut[l.fontSize]}px sans-serif`)), ne = J.reduce((Ne, it) => Ne + it, E), ie = (S - ne) / (Y.ticks.length - 1);
      let pe = [0];
      ...
      const re = ge && l.isResponsiveTicks ? Tt + xt + 20 : 0, Pe = Number(l.xAxis.tickRotation) > 0 ? Number(l.xAxis.tickRotation) : 0;
      return l.dynamicMarginTop = re, l.xAxis.tickWidthMax = Tt, /* @__PURE__ */ i.createElement(be, { className: "bottom-axis" }, Y.ticks.map((Ne, it, wt) => {
        const je = String(Ne.value).startsWith("1") || Ne.value === 0.1 ? "block" : "none", Ft = je === "block" ? 16 : xt, Re = { x: Ne.to.x, y: Ft };
        ...
        return /* @__PURE__ */ i.createElement(be, { key: `vx-tick-${Ne.value}-${it}`, className: "vx-axis-tick" }, !l.xAxis.hideTicks && /* @__PURE__ */ i.createElement(qe, { from: Ne.from, to: C === "horizontal" && l.useLogScale ? Re : Ne.to, stroke: l.xAxis.tickColor, strokeWidth: je === "block" ? 1.3 : 1 }), !l.xAxis.hideLabel && /* @__PURE__ */ i.createElement(
          $e,
          {
            dy: l.orientation === "horizontal" && l.useLogScale ? 8 : 0,
            display: l.orientation === "horizontal" && l.useLogScale ? je : "block",
            x: Ne.to.x,
            y: Ne.to.y,
            angle: rt,
            verticalAnchor: rt < -50 ? "middle" : "start",
            textAnchor: rt ? "end" : "middle",
            width: ge && !l.isResponsiveTicks && !Number(l[B].tickRotation) ? Qe : Ye,
  ...
  ), x === "Paired Bar" && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(Ya, { top: _, left: Number(k.yAxis.size), label: k.xAxis.label, tickFormat: k.xAxis.type === "date" ? o : u, scale: Ke, stroke: "#333", tickStroke: "#333", numTicks: k.xAxis.numTicks || void 0 }, (Y) => /* @__PURE__ */ i.createElement(be, { className: "bottom-axis" }, Y.ticks.map((ve, Me) => {
    const Ae = ve.index !== 0 ? l.yAxis.tickRotation : 0, ut = ve.index !== 0 && l.yAxis.tickRotation && l.yAxis.tickRotation > 0 ? "end" : "middle";
    return /* @__PURE__ */ i.createElement(be, { key: `vx-tick-${ve.value}-${Me}`, className: "vx-axis-tick" }, !k.yAxis.hideTicks && /* @__PURE__ */ i.createElement(qe, { from: ve.from, to: ve.to, stroke: "#333" }), !k.yAxis.hideLabel && /* @__PURE__ */ i.createElement($e, { x: ve.to.x, y: ve.to.y, angle: -Ae, verticalAnchor: "start", textAnchor: ut }, u(ve.value, "left")));
  }), !k.yAxis.hideAxis && /* @__PURE__ */ i.createElement(qe, { from: Y.axisFromPoint, to: Y.axisToPoint, stroke: "#333" }))), /* @__PURE__ */ i.createElement(
    Ya,
    {
      top: _,
      left: Number(k.yAxis.size),
      label: k.xAxis.label,
      tickFormat: k.xAxis.type === "date" ? o : k.xAxis.dataKey !== "Year" ? u : (Y) => Y,
      scale: Ce,
      stroke: "#333",
      tickStroke: "#333",
    ...
    (Y) => /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(be, { className: "bottom-axis" }, Y.ticks.map((ve, Me) => {
      const Ae = ve.index !== 0 ? l.yAxis.tickRotation : 0, ut = ve.index !== 0 && l.yAxis.tickRotation && l.yAxis.tickRotation > 0 ? "end" : "middle";
      return /* @__PURE__ */ i.createElement(be, { key: `vx-tick-${ve.value}-${Me}`, className: "vx-axis-tick" }, !k.yAxis.hideTicks && /* @__PURE__ */ i.createElement(qe, { from: ve.from, to: ve.to, stroke: "#333" }), !k.yAxis.hideLabel && /* @__PURE__ */ i.createElement($e, { x: ve.to.x, y: ve.to.y, angle: -Ae, verticalAnchor: "start", textAnchor: ut }, u(ve.value, "left")));
    }), !k.yAxis.hideAxis && /* @__PURE__ */ i.createElement(qe, { from: Y.axisFromPoint, to: Y.axisToPoint, stroke: "#333" })), /* @__PURE__ */ i.createElement(be, null, /* @__PURE__ */ i.createElement($e, { x: S / 2, y: l.xAxis.labelOffset, stroke: "#333", textAnchor: "middle", verticalAnchor: "start" }, k.xAxis.label)))
  )), x === "Deviation Bar" && /* @__PURE__ */ i.createElement(Cy, { animatedChart: ue, xScale: ae, yScale: he, width: S, height: _ }), x === "Paired Bar" && /* @__PURE__ */ i.createElement(My, { originalWidth: $, width: S, height: _ }), x === "Scatter Plot" && /* @__PURE__ */ i.createElement(
    wy,
    {
      xScale: ae,
      yScale: he,
  ...
  ), x === "Box Plot" && /* @__PURE__ */ i.createElement(ky, { xScale: ae, yScale: he }), (x === "Area Chart" && l.visualizationSubType === "regular" || x === "Combo") && /* @__PURE__ */ i.createElement(gy, { xScale: ae, yScale: he, yMax: _, xMax: S, chartRef: Se, width: S, height: _, handleTooltipMouseOver: at, handleTooltipMouseOff: Et, tooltipData: W, showTooltip: _e }), (x === "Area Chart" && l.visualizationSubType === "stacked" || x === "Combo") && /* @__PURE__ */ i.createElement(vy, { xScale: ae, yScale: he, yMax: _, xMax: S, chartRef: Se, width: S, height: _, handleTooltipMouseOver: at, handleTooltipMouseOff: Et, tooltipData: W, showTooltip: _e }), (x === "Bar" || x === "Combo") && /* @__PURE__ */ i.createElement(
    Sy,
    {
      xScale: ae,
      yScale: he,
  ...
  ), l.yAxis.anchors && l.yAxis.anchors.map((Y) => /* @__PURE__ */ i.createElement(qe, { strokeDasharray: h(Y.lineStyle), stroke: "rgba(0,0,0,1)", className: "customAnchor", from: { x: 0 + l.yAxis.size, y: he(Y.value) }, to: { x: S, y: he(Y.value) }, display: k.horizontal ? "none" : "block" })), x === "Forest Plot" && /* @__PURE__ */ i.createElement(
    _y,
    {
      xScale: ae,
      yScale: he,
  ...
  ), ["Line", "Bar", "Combo", "Area Chart"].includes(l.visualizationType) && !A && /* @__PURE__ */ i.createElement(ug, { xScaleBrush: le, yScale: he, xMax: S, yMax: _ }), x !== "Bar" && x !== "Paired Bar" && x !== "Box Plot" && x !== "Area Chart" && x !== "Scatter Plot" && x !== "Deviation Bar" && x !== "Forecasting" && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(ns, { xScale: ae, yScale: he, getXAxisData: Q, getYAxisData: K, xMax: S, yMax: _, seriesStyle: l.series })), l.yAxis.anchors && l.yAxis.anchors.map((Y, ve) => {
    let Me = he(Y.value);
    if (!Y.value)
      return;
    const Ae = C === "horizontal" && x === "Bar" ? l.barHeight / 4 : 0;
    if (Me)
      return (
        // prettier-ignore
        /* @__PURE__ */ i.createElement(
          qe,
          {
            ...
            strokeDasharray: h(Y.lineStyle),
            stroke: Y.color ? Y.color : "rgba(0,0,0,1)",
            className: "anchor-y",
            from: { x: 0 + Jt, y: Me - Ae },
            to: { x: $ - l.yAxis.rightAxisSize, y: Me - Ae }
          }
        )
      );
    ...
    let Me = T;
    C === "horizontal" && (Me = D);
    let Ae = Me.type === "date" ? ae(c(Y.value, !1)) : ae(Y.value);
    if (Ae)
      return (
        // prettier-ignore
        /* @__PURE__ */ i.createElement(
...
const gg = (e) => {
  ...
  return /* @__PURE__ */ i.createElement(Rt, { component: "SparkLine" }, /* @__PURE__ */ i.createElement("svg", { role: "img", "aria-label": d(r), width: t, height: 100, className: "sparkline", tabIndex: 0 }, ((N = r.runtime.lineSeriesKeys) == null ? void 0 : N.length) > 0 ? r.runtime.lineSeriesKeys : r.runtime.seriesKeys.map((A, P) => /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(
    ...
    a.map((L, S) => {
      let _ = r.runtime.yAxis.label ? `${r.runtime.yAxis.label}: ${s(x(L, A))}` : s(x(L, A)), R = r.runtime.xAxis.label ? `${r.runtime.xAxis.label}: ${L[r.runtime.xAxis.dataKey]}` : L[r.runtime.xAxis.dataKey];
      return `${_}${R}`, r.seriesLabel && `${r.seriesLabel}${A}`, /* @__PURE__ */ i.createElement(be, { key: `series-${A}-point-${S}` }, /* @__PURE__ */ i.createElement($e, { display: r.labels ? "block" : "none", x: w(b(L)), y: C(x(L, A)), fill: u ? u(r.runtime.seriesLabels ? r.runtime.seriesLabels[A] : A) : "#000", textAnchor: "middle" }, s(L[A])));
    }),
    /* @__PURE__ */ i.createElement(
      kn,
      {
...
function lu(e) {
  ...
  }, ce.map(function(ue, Ee) {
    return /* @__PURE__ */ i.createElement(Ti, ga({
      key: "legend-" + ue.text + "-" + Ee,
      margin: P,
      flexDirection: R
...
const Pg = () => {
  const {
    ...
    if (p === "Deviation Bar") {
      const [R, q] = l[e.twoColor.palette], I = {
        datum: "X",
        index: 0,
    ...
    if (p === "Bar" && g === "regular" && N && (v == null ? void 0 : v.length) === 1) {
      ...
      c.forEach((j) => q.add(j[N]));
      const I = Array.from(q).map((j, G) => ({
        datum: j,
        index: G,
        text: j,
        value: R[G]
    ...
    if (((L = f == null ? void 0 : f.forecastingSeriesKeys) == null ? void 0 : L.length) > 0) {
      let R = [];
      return (_ = (S = e.runtime) == null ? void 0 : S.forecastingSeriesKeys) == null || _.map((q, I) => {
        var j;
        return (j = q == null ? void 0 : q.stages) == null ? void 0 : j.map((G, U) => {
          var Ee, ke, Se, de;
          let ce = (Ee = Za[G.color]) != null && Ee[2] ? (ke = Za[G.color]) == null ? void 0 : ke[2] : (Se = u[G.color]) != null && Se[2] ? (de = u[G.color]) == null ? void 0 : de[2] : "#ccc";
          const ue = {
            datum: G.key,
            index: U,
            text: G.key,
    ...
    let $ = 0;
    const N = t.position === "bottom" || ["sm", "xs", "xxs"].includes(d), A = e.orientation === "horizontal", P = Number(e.xAxis.tickRotation) > 0 ? Number(e.xAxis.tickRotation) : 0, L = e.brush.active, S = 25, _ = e.brush.height;
    return !A && N && e.xAxis.label && !e.dynamicMarginTop && !e.isResponsiveTicks && !P && ($ = L ? -e.xAxis.size + e.xAxis.labelOffset + S + _ : -e.xAxis.size + e.xAxis.labelOffset + S), !A && N && e.xAxis.label && !e.dynamicMarginTop && e.isResponsiveTicks && !P && ($ = L ? -e.xAxis.size + e.xAxis.labelOffset + S + _ : -e.xAxis.size + e.xAxis.labelOffset + S), !A && N && e.xAxis.label && !e.dynamicMarginTop && !e.isResponsiveTicks && P && ($ = L ? e.xAxis.tickWidthMax + _ + -e.xAxis.size + e.xAxis.labelOffset + S : e.xAxis.tickWidthMax + -e.xAxis.size + e.xAxis.labelOffset + S), !A && N && !e.xAxis.label && !e.dynamicMarginTop && !e.isResponsiveTicks && P && ($ = L ? e.xAxis.tickWidthMax + _ + -e.xAxis.size + S * 1.4 : e.xAxis.tickWidthMax + -e.xAxis.size + S * 1.3), !A && N && e.xAxis.label && e.dynamicMarginTop && e.isResponsiveTicks && !P && ($ = L ? e.dynamicMarginTop + -e.xAxis.size + S + _ : e.dynamicMarginTop + -e.xAxis.size + S), !A && N && !e.xAxis.label && e.dynamicMarginTop && e.isResponsiveTicks && !P && ($ = L ? e.dynamicMarginTop - S : e.dynamicMarginTop - _ - S), `${$}px`;
  ...
  return t ? e.visualizationType !== "Box Plot" && /* @__PURE__ */ i.createElement("aside", { style: D, id: "legend", className: y.join(" "), role: "region", "aria-label": "legend", tabIndex: 0 }, t.label && /* @__PURE__ */ i.createElement("h2", null, xn(t.label)), t.description && /* @__PURE__ */ i.createElement("p", null, xn(t.description)), /* @__PURE__ */ i.createElement(Cg, { scale: n, itemDirection: "row", labelMargin: "0 20px 0 0", shapeMargin: "0 10px 0" }, ($) => /* @__PURE__ */ i.createElement("div", { className: h.join(" ") }, w($).map((N, A) => {
    ...
    if (e.exclusions.active && ((S = e.exclusions.keys) != null && S.includes(L)))
      return null;
    if (f.seriesLabels) {
      let I = e.runtime.seriesLabelsAll.indexOf(L);
      L = e.runtime.seriesKeys[I], ((_ = f == null ? void 0 : f.forecastingSeriesKeys) == null ? void 0 : _.length) > 0 && (L = N.text);
    }
...
const Qa = (e) => /* @__PURE__ */ F.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", ...e }, /* @__PURE__ */ F.createElement("path", { fill: "currentColor", d: "M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zm-248 50c-25.405 0-46 20.595-46 46s20.595 46 46 46 46-20.595 46-46-20.595-46-46-46zm-43.673-165.346l7.418 136c.347 6.364 5.609 11.346 11.982 11.346h48.546c6.373 0 11.635-4.982 11.982-11.346l7.418-136c.375-6.874-5.098-12.654-11.982-12.654h-63.383c-6.884 0-12.356 5.78-11.981 12.654z" })), aa = F.memo(({ label: e, value: t, options: n, fieldName: a, section: r = null, subsection: l = null, required: c = !1, tooltip: o, updateField: s, initial: u, ...d }) => {
  ...
  return /* @__PURE__ */ i.createElement(hs, { key: n.dataKey, draggableId: `draggableFilter-${n.dataKey}`, index: c }, (o, s) => /* @__PURE__ */ i.createElement("div", { key: c, className: s.isDragging ? "currently-dragging" : "", style: a(s.isDragging, o.draggableProps.style, r), ref: o.innerRef, ...o.draggableProps, ...o.dragHandleProps }, /* @__PURE__ */ i.createElement(vn, { allowZeroExpanded: !0 }, /* @__PURE__ */ i.createElement(lt, { className: "series-item series-item--chart" }, /* @__PURE__ */ i.createElement(ot, { className: "series-item__title" }, /* @__PURE__ */ i.createElement(st, { className: l.includes(t.visualizationType) ? "accordion__button" : "accordion__button hide-arrow" }, /* @__PURE__ */ i.createElement(De, { display: "move", size: 15, style: { cursor: "default" } }), n.dataKey, /* @__PURE__ */ i.createElement(jt.Button.Remove, { series: n, index: c }))), l.includes(t.visualizationType) && /* @__PURE__ */ i.createElement(ct, null, /* @__PURE__ */ i.createElement(jt.Input.Name, { series: n, index: c }), /* @__PURE__ */ i.createElement(jt.Dropdown.SeriesType, { series: n, index: c }), /* @__PURE__ */ i.createElement(jt.Dropdown.AxisPosition, { series: n, index: c }), /* @__PURE__ */ i.createElement(jt.Dropdown.LineType, { series: n, index: c }), /* @__PURE__ */ i.createElement(jt.Dropdown.ForecastingColor, { series: n, index: c }), /* @__PURE__ */ i.createElement(jt.Dropdown.ConfidenceInterval, { series: n, index: c }), /* @__PURE__ */ i.createElement(jt.Checkbox.DisplayInTooltip, { series: n, index: c }))))));
}, Ig = (e) => {
  ...
  let v = /* @__PURE__ */ i.createElement("input", { type: "text", name: p, onChange: g, ...d, value: m });
  return o === "textarea" && (v = /* @__PURE__ */ i.createElement("textarea", { name: p, onChange: g, ...d, value: m })), o === "number" && (v = /* @__PURE__ */ i.createElement("input", { type: "number", name: p, onChange: g, ...d, value: m })), o === "date" && (v = /* @__PURE__ */ i.createElement("input", { type: "date", name: p, onChange: g, ...d, value: m })), /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, e, t), v);
}), Te = F.memo(({ label: e, value: t, fieldName: n, section: a = null, subsection: r = null, tooltip: l, updateField: c, ...o }) => /* @__PURE__ */ i.createElement("label", { className: "checkbox column-heading" }, /* @__PURE__ */ i.createElement(
  "input",
  {
    type: "checkbox",
    name: n,
  ...
  const { config: e, updateConfig: t, transformedData: n, loading: a, colorPalettes: r, twoColorPalette: l, unfilteredData: c, excludedData: o, isDashboard: s, setParentConfig: u, missingRequiredSections: d, isDebug: m, setFilteredData: h, lineOptions: y, rawData: p } = F.useContext(ze), { minValue: g, maxValue: v, existPositiveValue: f, isAllLine: b } = $i(e, c), { twoColorPalettes: x, sequential: w, nonSequential: C } = qg(e, t), {
    ...
    visSupportsValueAxisLabels: Q,
    visSupportsBarSpace: K,
    visSupportsBarThickness: ee,
    visSupportsFootnotes: B,
    visSupportsSuperTitle: ye,
    visSupportsDataCutoff: oe,
  ...
  } = Ug(), { handleFilterOrder: xe, filterOrderOptions: le, filterStyleOptions: te } = gu({ config: e, setConfig: t, filteredData: n, setFilteredData: h });
  F.useEffect(() => {
    let O = [];
    e.series && (O = e.series.map((M) => ({
      ...M,
  ...
  const { hasRightAxis: We } = dl({ config: e, yMax: e.yAxis.size, data: e.data, updateConfig: t }), se = (O, M) => ({
    ...M
  }), we = {
    animate: !1,
    animateReplay: !0,
    ...
    if (m && console.log("#COVE: CHART: EditorPanel: section, subsection, fieldName, newValue", O, M, H, Z), O === "boxplot" && M === "legend") {
      t({
        ...e,
        [O]: {
          ...e[O],
    ...
    const Ie = Array.isArray(e[O]);
    let kt = Ie ? [...e[O], Z] : { ...e[O], [H]: Z };
    M !== null && (Ie ? (kt = [...e[O]], kt[M] = { ...kt[M], [H]: Z }) : typeof Z == "string" ? kt[M] = Z : kt = { ...e[O], [M]: { ...e[O][M], [H]: Z } });
    let Bt = { ...e, [O]: kt };
    Le(Bt), t(Bt);
  }, [_e, Ge] = F.useState(!0);
  if (a)
  ...
  const nt = (O) => {
    ...
    let M = [...e.filters];
    M.splice(O, 1), t({ ...e, filters: M });
  }, ft = (O, M, H) => {
    let Z = [...e.filters];
    Z[M][O] = H, t({ ...e, filters: Z });
  }, at = () => {
    let O = e.filters ? [...e.filters] : [];
    O.push({ values: [] }), t({ ...e, filters: O });
  }, Je = (O) => {
    let M = e.series ? [...e.series] : [], H = Array.from(new Set(n.map((Ie) => Ie[O]))), Z = [];
    H.forEach((Ie) => {
      Z.push({ key: Ie });
    }), e.visualizationType === "Forecasting" ? M.push({ dataKey: O, type: e.visualizationType, stages: Z, stageColumn: O, axis: "Left", tooltip: !0 }) : M.push({ dataKey: O, type: e.visualizationType, axis: "Left", tooltip: !0 }), t({ ...e, series: M });
  }, Et = (O) => {
    const M = e.series[0].dataKey, H = n.sort((Ie, kt) => Ie[M] - kt[M]), Z = O === "asc" ? H : H.reverse();
    t({ ...e }, Z);
  }, Yt = (O) => {
    ...
    if (M !== -1) {
      H.splice(M, 1);
      let Z = { ...e.exclusions, keys: H }, Ie = { ...e, exclusions: Z };
      H.length === 0 && delete Ie.exclusions.keys, t(Ie);
    }
  }, Na = () => {
    let O = {};
    return c.forEach((M) => {
      Object.keys(M).forEach((H) => O[H] = !0);
    }), Object.keys(O);
  }, At = (O = !0) => {
    let M = {};
    if (c.forEach((H) => {
      ...
      Object.keys(M).forEach((Ie) => {
        (e.series && e.series.filter((kt) => kt.dataKey === Ie).length > 0 || e.confidenceKeys && Object.keys(e.confidenceKeys).includes(Ie) && (H && Z || H || Z) && Ie !== H && Ie !== Z) && delete M[Ie];
      });
    }
  ...
  F.useEffect(() => {
    ...
    const O = e.xAxis.anchors.length > 0 ? e.xAxis.anchors : [], M = e.yAxis.anchors.length > 0 ? e.yAxis.anchors : [];
    t({
      ...e,
      xAxis: {
        ...e.xAxis,
  ...
  const xt = e.orientation === "horizontal" ? "xAxis" : "yAxis", [Tt, E] = F.useState({ maxMsg: "", minMsg: "" }), J = () => {
    const O = e[xt].max;
    let M = "";
    switch (!0) {
      case (O && parseFloat(O) < parseFloat(v) && f):
        M = "Max value must be more than " + v;
        break;
    ...
    switch (!0) {
      case (e.useLogScale && ["Line", "Combo", "Bar"].includes(e.visualizationType) && O < 0):
        ...
        break;
      case ((e.visualizationType === "Line" || e.visualizationType === "Spark Line") && O && parseFloat(O) > M):
        H = "Value should not exceed " + g;
        break;
      case (e.visualizationType === "Combo" && b && O && parseFloat(O) > M):
        H = "Value should not exceed " + g;
        break;
      case ((e.visualizationType === "Bar" || e.visualizationType === "Combo" && !b) && O && M > 0 && parseFloat(O) > 0):
        H = e.useLogScale ? "Value must be equal to 0" : "Value must be less than or equal to 0";
        break;
      case (e.visualizationType === "Deviation Bar" && parseFloat(O) >= Math.min(M, e.xAxis.target)):
        H = "Value must be less than " + Math.min(M, e.xAxis.target);
        break;
      case (e.visualizationType !== "Deviation Bar" && O && M < 0 && parseFloat(O) > M):
        H = "Value should not exceed " + g;
        break;
      default:
        H = "";
  ...
  return /* @__PURE__ */ i.createElement(Rt, { component: "EditorPanel" }, e.newViz && /* @__PURE__ */ i.createElement(ve, null), e.newViz === void 0 && e.runtime && e.runtime.editorErrorMessage && /* @__PURE__ */ i.createElement(Y, null), /* @__PURE__ */ i.createElement("button", { className: _e ? "editor-toggle" : "editor-toggle collapsed", title: _e ? "Collapse Editor" : "Expand Editor", onClick: un }), /* @__PURE__ */ i.createElement("section", { className: `${_e ? "editor-panel cove" : "hidden editor-panel cove"}${s ? " dashboard" : ""}` }, /* @__PURE__ */ i.createElement("div", { "aria-level": "2", role: "heading", className: "heading-2" }, "Configure Chart"), /* @__PURE__ */ i.createElement("section", { className: "form-container" }, /* @__PURE__ */ i.createElement(vn, { allowZeroExpanded: !0 }, /* @__PURE__ */ i.createElement(lt, null, " ", /* @__PURE__ */ i.createElement(ot, null, /* @__PURE__ */ i.createElement(st, null, "General")), /* @__PURE__ */ i.createElement(ct, null, /* @__PURE__ */ i.createElement(He, { value: e.visualizationType, fieldName: "visualizationType", label: "Chart Type", updateField: W, options: T }), (e.visualizationType === "Bar" || e.visualizationType === "Combo" || e.visualizationType === "Area Chart") && /* @__PURE__ */ i.createElement(He, { value: e.visualizationSubType || "Regular", fieldName: "visualizationSubType", label: "Chart Subtype", updateField: W, options: ["regular", "stacked"] }), e.visualizationType === "Area Chart" && e.visualizationSubType === "stacked" && /* @__PURE__ */ i.createElement(He, { value: e.stackedAreaChartLineType || "Linear", fieldName: "stackedAreaChartLineType", label: "Stacked Area Chart Line Type", updateField: W, options: Object.keys(Ei) }), e.visualizationType === "Bar" && /* @__PURE__ */ i.createElement(He, { value: e.orientation || "vertical", fieldName: "orientation", label: "Orientation", updateField: W, options: ["vertical", "horizontal"] }), e.visualizationType === "Deviation Bar" && /* @__PURE__ */ i.createElement(He, { label: "Orientation", options: ["horizontal"] }), (e.visualizationType === "Bar" || e.visualizationType === "Deviation Bar") && /* @__PURE__ */ i.createElement(He, { value: e.isLollipopChart ? "lollipop" : e.barStyle || "flat", fieldName: "barStyle", label: "bar style", updateField: W, options: Xn() }), (e.visualizationType === "Bar" || e.visualizationType === "Deviation Bar") && e.barStyle === "rounded" && /* @__PURE__ */ i.createElement(He, { value: e.tipRounding || "top", fieldName: "tipRounding", label: "tip rounding", updateField: W, options: ["top", "full"] }), (e.visualizationType === "Bar" || e.visualizationType === "Deviation Bar") && e.barStyle === "rounded" && /* @__PURE__ */ i.createElement(He, { value: e.roundingStyle || "standard", fieldName: "roundingStyle", label: "rounding style", updateField: W, options: ["standard", "shallow", "finger"] }), e.visualizationType === "Bar" && e.orientation === "horizontal" && /* @__PURE__ */ i.createElement(He, { value: e.yAxis.labelPlacement || "Below Bar", section: "yAxis", fieldName: "labelPlacement", label: "Label Placement", updateField: W, options: ["Below Bar", "On Date/Category Axis"] }), P() ? /* @__PURE__ */ i.createElement(Te, { value: e.yAxis.displayNumbersOnBar, section: "yAxis", fieldName: "displayNumbersOnBar", label: e.isLollipopChart ? "Display Numbers after Bar" : "Display Numbers on Bar", updateField: W }) : A() && /* @__PURE__ */ i.createElement(Te, { value: e.labels, fieldName: "labels", label: "Display label on data", updateField: W }), e.visualizationType === "Pie" && /* @__PURE__ */ i.createElement(He, { fieldName: "pieType", label: "Pie Chart Type", updateField: W, options: ["Regular", "Donut"] }), /* @__PURE__ */ i.createElement(
  ...
  ), /* @__PURE__ */ i.createElement(Te, { value: e.showTitle, fieldName: "showTitle", label: "Show Title", updateField: W }), ye() && /* @__PURE__ */ i.createElement(
    me,
    {
      value: e.superTitle,
      updateField: W,
  ...
  ), e.orientation === "horizontal" && /* @__PURE__ */ i.createElement(me, { value: e.xAxis.labelOffset, section: "xAxis", fieldName: "labelOffset", label: "Label offset", type: "number", className: "number-narrow", updateField: W }), ke() && /* @__PURE__ */ i.createElement(Te, { value: e.yAxis.gridLines, section: "yAxis", fieldName: "gridLines", label: "Show Gridlines", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.yAxis.enablePadding, section: "yAxis", fieldName: "enablePadding", label: "Add Padding to Value Axis Scale", updateField: W }), e.visualizationSubType === "regular" && /* @__PURE__ */ i.createElement(Te, { value: e.useLogScale, fieldName: "useLogScale", label: "use logarithmic scale", updateField: W })), /* @__PURE__ */ i.createElement("span", { className: "divider-heading" }, "Number Formatting"), /* @__PURE__ */ i.createElement(Te, { value: e.dataFormat.commas, section: "dataFormat", fieldName: "commas", label: "Add commas", updateField: W }), /* @__PURE__ */ i.createElement(
    Te,
    {
    ...
    "Add Anchor"
  )), L() && e.orientation === "horizontal" && /* @__PURE__ */ i.createElement("div", { className: "edit-block" }, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, "Anchors"), /* @__PURE__ */ i.createElement(vn, { allowZeroExpanded: !0 }, (Nl = (Cl = e.xAxis) == null ? void 0 : Cl.anchors) == null ? void 0 : Nl.map((O, M) => /* @__PURE__ */ i.createElement(lt, { className: "series-item series-item--chart", key: `xaxis-anchors-${M}` }, /* @__PURE__ */ i.createElement(ot, { className: "series-item__title" }, /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(st, { className: "accordion__button accordion__button" }, "Anchor ", M + 1, /* @__PURE__ */ i.createElement(
    "button",
    {
      className: "series-list__remove",
      onClick: (H) => {
  ...
  )), /* @__PURE__ */ i.createElement(Te, { value: e.yAxis.rightHideAxis, section: "yAxis", fieldName: "rightHideAxis", label: "Hide Axis", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.yAxis.rightHideLabel, section: "yAxis", fieldName: "rightHideLabel", label: "Hide Label", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.yAxis.rightHideTicks, section: "yAxis", fieldName: "rightHideTicks", label: "Hide Ticks", updateField: W }))), /* @__PURE__ */ i.createElement(lt, null, /* @__PURE__ */ i.createElement(ot, null, /* @__PURE__ */ i.createElement(st, null, e.visualizationType === "Pie" ? "Segments" : "Date/Category Axis", !e.xAxis.dataKey && /* @__PURE__ */ i.createElement(Qa, { width: "25", className: "warning-icon" }))), /* @__PURE__ */ i.createElement(ct, null, e.visualizationType !== "Pie" && /* @__PURE__ */ i.createElement(i.Fragment, null, e.visualizationType !== "Forest Plot" && /* @__PURE__ */ i.createElement(He, { value: e.xAxis.type, section: "xAxis", fieldName: "type", label: "Data Type", updateField: W, options: e.visualizationType !== "Scatter Plot" ? ["categorical", "date"] : ["categorical", "continuous", "date"] }), /* @__PURE__ */ i.createElement(Te, { value: e.xAxis.sortDates, section: "xAxis", fieldName: "sortDates", label: "Force Date Scale (Sort Dates)", updateField: W }), " ", /* @__PURE__ */ i.createElement(
    He,
    {
  ...
  ), ["Line", "Bar", "Area Chart", "Combo"].includes(e.visualizationType) && e.orientation === "vertical" && /* @__PURE__ */ i.createElement(Te, { value: e.brush.active, section: "brush", fieldName: "active", label: "Brush Slider ", updateField: W }), e.exclusions.active && /* @__PURE__ */ i.createElement(i.Fragment, null, e.xAxis.type === "categorical" && /* @__PURE__ */ i.createElement(i.Fragment, null, e.exclusions.keys.length > 0 && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("fieldset", null, /* @__PURE__ */ i.createElement("legend", { className: "edit-label" }, "Excluded Keys")), /* @__PURE__ */ i.createElement(Ae, null)), /* @__PURE__ */ i.createElement(
    He,
    {
      fieldName: "visualizationType",
      label: "Add Exclusion",
  ...
  ), e.orientation === "horizontal" ? /* @__PURE__ */ i.createElement(i.Fragment, null, j() && /* @__PURE__ */ i.createElement(Te, { value: e.yAxis.hideAxis, section: "yAxis", fieldName: "hideAxis", label: "Hide Axis", updateField: W }), I() && /* @__PURE__ */ i.createElement(Te, { value: e.yAxis.hideLabel, section: "yAxis", fieldName: "hideLabel", label: "Hide Label", updateField: W })) : /* @__PURE__ */ i.createElement(i.Fragment, null, j() && /* @__PURE__ */ i.createElement(Te, { value: e.xAxis.hideAxis, section: "xAxis", fieldName: "hideAxis", label: "Hide Axis", updateField: W }), I() && /* @__PURE__ */ i.createElement(Te, { value: e.xAxis.hideLabel, section: "xAxis", fieldName: "hideLabel", label: "Hide Label", updateField: W }), G() && /* @__PURE__ */ i.createElement(Te, { value: e.xAxis.hideTicks, section: "xAxis", fieldName: "hideTicks", label: "Hide Ticks", updateField: W })), ((Pl = e.series) == null ? void 0 : Pl.length) === 1 && e.visualizationType === "Bar" && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("label", { htmlFor: "barHighlight" }, "Bar Highlighting"), e.series.length === 1 && Ft.map((O, M) => /* @__PURE__ */ i.createElement("fieldset", null, /* @__PURE__ */ i.createElement("div", { className: "edit-block", key: `highlighted-bar-${M}` }, /* @__PURE__ */ i.createElement("button", { className: "remove-column", onClick: (H) => rt(H, M) }, "Remove"), /* @__PURE__ */ i.createElement("p", null, "Highlighted Bar ", M + 1), /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, "Value"), /* @__PURE__ */ i.createElement("select", { value: e.highlightedBarValues[M].value, onChange: (H) => Ye(H, M) }, /* @__PURE__ */ i.createElement("option", { value: "" }, "- Select Value -"), Re && [...new Set(Re)].sort().map((H) => /* @__PURE__ */ i.createElement("option", { key: `special-class-value-option-${M}-${H}` }, H)))), /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, "Color"), /* @__PURE__ */ i.createElement("input", { type: "text", value: e.highlightedBarValues[M].color ? e.highlightedBarValues[M].color : "", onChange: (H) => Lt(H, M) })), /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, "Border Width"), /* @__PURE__ */ i.createElement("input", { max: "5", min: "0", type: "number", value: e.highlightedBarValues[M].borderWidth ? e.highlightedBarValues[M].borderWidth : "", onChange: (H) => Ot(H, M) })), /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, "Legend Label"), /* @__PURE__ */ i.createElement("input", { type: "text", value: e.highlightedBarValues[M].legendLabel ? e.highlightedBarValues[M].legendLabel : "", onChange: (H) => pt(H, M) }))))), /* @__PURE__ */ i.createElement("button", { className: "btn full-width", onClick: (O) => Qe(O) }, "Add Highlighted Bar"))), e.visualizationType === "Pie" && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(
    Te,
    {
      value: e.exclusions.active,
      section: "exclusions",
  ...
  ), e.exclusions.active && /* @__PURE__ */ i.createElement(i.Fragment, null, e.exclusions.keys.length > 0 && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("fieldset", null, /* @__PURE__ */ i.createElement("legend", { className: "edit-label" }, "Excluded Keys")), /* @__PURE__ */ i.createElement(Ae, null)), /* @__PURE__ */ i.createElement(
    He,
    {
      fieldName: "visualizationType",
      label: "Add Exclusion",
  ...
  ))), L() && e.orientation !== "horizontal" && /* @__PURE__ */ i.createElement("div", { className: "edit-block" }, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, "Anchors"), /* @__PURE__ */ i.createElement(vn, { allowZeroExpanded: !0 }, (Ol = (Ll = e.xAxis) == null ? void 0 : Ll.anchors) == null ? void 0 : Ol.map((O, M) => /* @__PURE__ */ i.createElement(lt, { className: "series-item series-item--chart", key: `xaxis-anchors-2-${M}` }, /* @__PURE__ */ i.createElement(ot, { className: "series-item__title" }, /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(st, { className: "accordion__button accordion__button" }, "Anchor ", M + 1, /* @__PURE__ */ i.createElement(
    "button",
    {
      className: "series-list__remove",
      onClick: (H) => {
    ...
    "Add Anchor"
  )))), ue() && /* @__PURE__ */ i.createElement(lt, null, /* @__PURE__ */ i.createElement(ot, null, /* @__PURE__ */ i.createElement(st, null, "Regions")), /* @__PURE__ */ i.createElement(ct, null, /* @__PURE__ */ i.createElement(Yg, { config: e, updateConfig: t }))), " ", e.visualizationType !== "Box Plot" && e.table.showVertical && /* @__PURE__ */ i.createElement(lt, null, /* @__PURE__ */ i.createElement(ot, null, /* @__PURE__ */ i.createElement(st, null, "Columns")), /* @__PURE__ */ i.createElement(ct, null, e.type !== "navigation" && /* @__PURE__ */ i.createElement("fieldset", { className: "primary-fieldset edit-block" }, /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label" }, "Additional Columns", /* @__PURE__ */ i.createElement(X, { style: { textTransform: "none" } }, /* @__PURE__ */ i.createElement(X.Target, null, /* @__PURE__ */ i.createElement(De, { display: "question", style: { marginLeft: "0.5rem" } })), /* @__PURE__ */ i.createElement(X.Content, null, /* @__PURE__ */ i.createElement("p", null, "You can specify additional columns to display in tooltips and / or the supporting data table."))))), Ne.map((O) => /* @__PURE__ */ i.createElement("fieldset", { className: "edit-block", key: O }, /* @__PURE__ */ i.createElement(
    "button",
    {
      className: "remove-column",
      onClick: (M) => {
        M.preventDefault(), wt(O);
      }
    },
    "Remove"
    ...
    "input",
    {
      ...
      onChange: (M) => {
        je(O, "dataTable", M.target.checked);
      }
    }
  ), /* @__PURE__ */ i.createElement("span", { className: "edit-label" }, "Show in Data Table"))), e.visualizationType === "Forest Plot" && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement("label", { className: "checkbox" }, /* @__PURE__ */ i.createElement(
    "input",
    {
      type: "checkbox",
      checked: e.columns[O].forestPlot || !1,
      onChange: (M) => {
        je(O, "forestPlot", M.target.checked);
      }
    }
    ...
    "input",
    {
      ...
      onChange: (M) => {
        je(O, "forestPlotAlignRight", M.target.checked);
      }
    }
    ...
    "input",
    {
      ...
      onChange: (M) => {
        je(O, "forestPlotStartingPoint", M.target.value);
      }
    }
  ))))))), /* @__PURE__ */ i.createElement(
    "button",
    ...
    "button",
    {
      ...
      onClick: (H) => {
        ...
        Z.splice(M, 1), W("legend", null, "additionalCategories", Z);
      }
    },
    "Remove"
    ...
    "button",
    {
      ...
      onClick: (O) => {
        ...
        M.push(""), W("legend", null, "additionalCategories", M);
      }
    },
    "Add Category"
  )))), q() && /* @__PURE__ */ i.createElement(lt, null, /* @__PURE__ */ i.createElement(ot, null, /* @__PURE__ */ i.createElement(st, null, "Legend")), /* @__PURE__ */ i.createElement(ct, null, /* @__PURE__ */ i.createElement(Te, { value: e.legend.reverseLabelOrder, section: "legend", fieldName: "reverseLabelOrder", label: "Reverse Labels", updateField: W }), /* @__PURE__ */ i.createElement(
    Te,
    {
      value: !!e.legend.hide,
      section: "legend",
  ...
  ), e.visualizationType !== "Box Plot" && /* @__PURE__ */ i.createElement(Te, { value: !!e.legend.showLegendValuesTooltip, section: "legend", fieldName: "showLegendValuesTooltip", label: "Show Legend Values in Tooltip", updateField: W }), e.visualizationType === "Line" && /* @__PURE__ */ i.createElement(Te, { value: e.legend.lineMode, section: "legend", fieldName: "lineMode", label: "Show Lined Style Legend", updateField: W }), e.visualizationType === "Bar" && e.visualizationSubType === "regular" && e.runtime.seriesKeys.length === 1 && /* @__PURE__ */ i.createElement(He, { value: e.legend.colorCode, section: "legend", fieldName: "colorCode", label: "Color code by category", initial: "Select", updateField: W, options: Pn(n) }), /* @__PURE__ */ i.createElement(He, { value: e.legend.behavior, section: "legend", fieldName: "behavior", label: "Legend Behavior (When clicked)", updateField: W, options: ["highlight", "isolate"] }), /* @__PURE__ */ i.createElement(me, { value: e.legend.label, section: "legend", fieldName: "label", label: "Title", updateField: W }), /* @__PURE__ */ i.createElement(He, { value: e.legend.position, section: "legend", fieldName: "position", label: "Position", updateField: W, options: ["right", "left", "bottom"] }), e.legend.position === "bottom" && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(Te, { value: e.legend.singleRow, section: "legend", fieldName: "singleRow", label: "Single Row Legend", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.legend.verticalSorted, section: "legend", fieldName: "verticalSorted", label: "Vertical sorted Legend", updateField: W })), /* @__PURE__ */ i.createElement(me, { type: "textarea", value: e.legend.description, updateField: W, section: "legend", fieldName: "description", label: "Legend Description" }))), Ee() && /* @__PURE__ */ i.createElement(lt, null, /* @__PURE__ */ i.createElement(ot, null, /* @__PURE__ */ i.createElement(st, null, "Filters")), /* @__PURE__ */ i.createElement(ct, null, e.filters && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(
    He,
    {
  ...
  ), /* @__PURE__ */ i.createElement("br", null)), e.filters && /* @__PURE__ */ i.createElement("ul", { className: "filters-list" }, e.filters.map((O, M) => O.type === "url" ? /* @__PURE__ */ i.createElement(i.Fragment, null) : /* @__PURE__ */ i.createElement("fieldset", { className: "edit-block", key: M }, /* @__PURE__ */ i.createElement(
    "button",
    {
      type: "button",
      className: "remove-column",
  ...
  )), /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-filterOrder column-heading" }, "Filter Order"), /* @__PURE__ */ i.createElement("select", { value: O.order ? O.order : "asc", onChange: (H) => ft("order", M, H.target.value) }, le.map((H, Z) => /* @__PURE__ */ i.createElement("option", { value: H.value, key: `filter-${Z}` }, H.label))), O.order === "cust" && /* @__PURE__ */ i.createElement(Hl, { onDragEnd: ({ source: H, destination: Z }) => xe(H.index, Z.index, M, e.filters[M]) }, /* @__PURE__ */ i.createElement(Kl, { droppableId: "filter_order" }, (H) => {
    var Z;
    return /* @__PURE__ */ i.createElement("ul", { ...H.droppableProps, className: "sort-list", ref: H.innerRef, style: { marginTop: "1em" } }, (Z = e.filters[M]) == null ? void 0 : Z.values.map((Ie, kt) => /* @__PURE__ */ i.createElement(hs, { key: Ie, draggableId: `draggableFilter-${Ie}`, index: kt }, (Bt, Zn) => /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement("div", { className: Zn.isDragging ? "currently-dragging" : "", style: se(Zn.isDragging, Bt.draggableProps.style), ref: Bt.innerRef, ...Bt.draggableProps, ...Bt.dragHandleProps }, Ie)))), H.placeholder);
  ...
  )), /* @__PURE__ */ i.createElement(He, { value: e.lollipopColorStyle ? e.lollipopColorStyle : "two-tone", fieldName: "lollipopColorStyle", label: "Lollipop Color Style", updateField: W, options: ["regular", "two-tone"] }), /* @__PURE__ */ i.createElement(He, { value: e.lollipopSize ? e.lollipopSize : "small", fieldName: "lollipopSize", label: "Lollipop Size", updateField: W, options: ["small", "medium", "large"] })), e.visualizationType === "Box Plot" && /* @__PURE__ */ i.createElement("fieldset", { className: "fieldset fieldset--boxplot" }, /* @__PURE__ */ i.createElement("legend", { className: "" }, "Box Plot Settings"), /* @__PURE__ */ i.createElement(He, { value: e.boxplot.borders, fieldName: "borders", section: "boxplot", label: "Box Plot Borders", updateField: W, options: ["true", "false"] }), /* @__PURE__ */ i.createElement(Te, { value: e.boxplot.plotOutlierValues, fieldName: "plotOutlierValues", section: "boxplot", label: "Plot Outliers", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.boxplot.plotNonOutlierValues, fieldName: "plotNonOutlierValues", section: "boxplot", label: "Plot non-outlier values", updateField: W })), /* @__PURE__ */ i.createElement(He, { value: e.fontSize, fieldName: "fontSize", label: "Font Size", updateField: W, options: ["small", "medium", "large"] }), S() && /* @__PURE__ */ i.createElement(He, { value: e.barHasBorder, fieldName: "barHasBorder", label: "Bar Borders", updateField: W, options: ["true", "false"] }), R() && /* @__PURE__ */ i.createElement(Te, { value: e.animate, fieldName: "animate", label: "Animate Visualization", updateField: W }), (((Dl = e.series) == null ? void 0 : Dl.some((O) => O.type === "Line" || O.type === "dashed-lg" || O.type === "dashed-sm" || O.type === "dashed-md")) && e.visualizationType === "Combo" || e.visualizationType === "Line") && /* @__PURE__ */ i.createElement(He, { value: e.lineDatapointStyle, fieldName: "lineDatapointStyle", label: "Line Datapoint Style", updateField: W, options: ["hidden", "hover", "always show"] }), /* @__PURE__ */ i.createElement("label", { className: "header" }, /* @__PURE__ */ i.createElement("span", { className: "edit-label" }, "Header Theme"), /* @__PURE__ */ i.createElement("ul", { className: "color-palette" }, D.map((O) => /* @__PURE__ */ i.createElement(
    "button",
    {
      title: O,
      key: O,
      onClick: (M) => {
        M.preventDefault(), t({ ...e, theme: O });
      },
      className: e.theme === O ? "selected " + O : O
    }
  )))), (z() || z()) && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label" }, "Chart Color Palette")), N() && /* @__PURE__ */ i.createElement(jl, { fieldName: "isPaletteReversed", size: "small", label: "Use selected palette in reverse order", updateField: W, value: e.isPaletteReversed }), $() && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("span", null, "Sequential"), /* @__PURE__ */ i.createElement("ul", { className: "color-palette" }, w.map((O) => {
    const M = {
    ...
    return /* @__PURE__ */ i.createElement(
      "button",
      {
        ...
        key: O,
        onClick: (Ie) => {
          Ie.preventDefault(), t({ ...e, palette: O });
        },
  ...
  }))), _() && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(
    me,
    {
      value: e.dataCutoff,
      type: "number",
  ...
  )), ee() && e.orientation === "horizontal" && !e.isLollipopChart && e.yAxis.labelPlacement !== "On Bar" && /* @__PURE__ */ i.createElement(me, { type: "number", value: e.barHeight || "25", fieldName: "barHeight", label: " Bar Thickness", updateField: W, min: "15" }), (e.visualizationType === "Bar" && e.orientation !== "horizontal" || e.visualizationType === "Combo") && /* @__PURE__ */ i.createElement(me, { value: e.barThickness, type: "number", fieldName: "barThickness", label: "Bar Thickness", updateField: W }), K() && /* @__PURE__ */ i.createElement(me, { type: "number", value: e.barSpace || "15", fieldName: "barSpace", label: "Bar Space", updateField: W, min: "0" }), (e.visualizationType === "Bar" || e.visualizationType === "Line" || e.visualizationType === "Combo") && /* @__PURE__ */ i.createElement(Te, { value: e.topAxis.hasLine, section: "topAxis", fieldName: "hasLine", label: "Add Top Axis Line", updateField: W }), e.visualizationType === "Spark Line" && /* @__PURE__ */ i.createElement("div", { className: "cove-accordion__panel-section checkbox-group" }, /* @__PURE__ */ i.createElement(Te, { value: ($l = e.visual) == null ? void 0 : $l.border, section: "visual", fieldName: "border", label: "Show Border", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: (zl = e.visual) == null ? void 0 : zl.borderColorTheme, section: "visual", fieldName: "borderColorTheme", label: "Use Border Color Theme", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: (Rl = e.visual) == null ? void 0 : Rl.accent, section: "visual", fieldName: "accent", label: "Use Accent Style", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: (Fl = e.visual) == null ? void 0 : Fl.background, section: "visual", fieldName: "background", label: "Use Theme Background Color", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: (Bl = e.visual) == null ? void 0 : Bl.hideBackgroundColor, section: "visual", fieldName: "hideBackgroundColor", label: "Hide Background Color", updateField: W })), (e.visualizationType === "Line" || e.visualizationType === "Combo") && /* @__PURE__ */ i.createElement(Te, { value: e.showLineSeriesLabels, fieldName: "showLineSeriesLabels", label: "Append Series Name to End of Line Charts", updateField: W }), (e.visualizationType === "Line" || e.visualizationType === "Combo") && e.showLineSeriesLabels && /* @__PURE__ */ i.createElement(Te, { value: e.colorMatchLineSeriesLabels, fieldName: "colorMatchLineSeriesLabels", label: "Match Series Color to Name at End of Line Charts", updateField: W }), k() && /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement(Te, { value: e.visual.verticalHoverLine, fieldName: "verticalHoverLine", section: "visual", label: "Vertical Hover Line", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.visual.horizontalHoverLine, fieldName: "horizontalHoverLine", section: "visual", label: "Horizontal Hover Line", updateField: W })), he() && /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, "Tooltip Opacity"), /* @__PURE__ */ i.createElement(
    "input",
    {
      type: "number",
  ...
  ), /* @__PURE__ */ i.createElement(Te, { value: e.table.limitHeight, section: "table", fieldName: "limitHeight", label: "Limit Table Height", updateField: W }), e.table.limitHeight && /* @__PURE__ */ i.createElement(me, { value: e.table.height, section: "table", fieldName: "height", label: "Data Table Height", type: "number", min: "0", max: "500", placeholder: "Height(px)", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.table.expanded, section: "table", fieldName: "expanded", label: "Expanded by Default", updateField: W }), s && /* @__PURE__ */ i.createElement(Te, { value: e.table.showDataTableLink, section: "table", fieldName: "showDataTableLink", label: "Show Data Table Name & Link", updateField: W }), ie && /* @__PURE__ */ i.createElement(Te, { value: e.table.showDownloadUrl, section: "table", fieldName: "showDownloadUrl", label: "Show URL to Automatically Updated Data", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.table.download, section: "table", fieldName: "download", label: "Show Download CSV Link", updateField: W }), /* @__PURE__ */ i.createElement(Te, { value: e.table.showDownloadImgButton, section: "table", fieldName: "showDownloadImgButton", label: "Display Image Button", updateField: W })))), e.type !== "Spark Line" && /* @__PURE__ */ i.createElement(mu, { loadConfig: t, state: e, convertStateToConfig: Me }))));
};
const fs = (e) => {
  const n = /(?:\.([^.]+))?$/.exec(e);
  return n ? n[1] : "";
...
function gx({ configUrl: e, config: t, isEditor: n = !1, isDebug: a = !1, isDashboard: r = !1, setConfig: l, setEditing: c, hostname: o, link: s, setSharedFilter: u, setSharedFilterValue: d, dashboardConfig: m }) {
  var xt, Tt;
  const h = new Mu(), [y, p] = F.useState(!0), [g, v] = F.useState(null), [f, b] = F.useState({}), [x, w] = F.useState(f.data || []), [C, T] = F.useState(void 0), [D, k] = F.useState(void 0), [z, $] = F.useState([]), [N, A] = F.useState("lg"), [P, L] = F.useState([]), [S, _] = F.useState(), [R, q] = F.useState(), [I, j] = F.useState(!1), [G, U] = F.useState([]), [ce] = F.useState(`cove-${Math.random().toString(16).slice(-4)}`);
  let ue = F.useRef(/* @__PURE__ */ new Map()), Ee = F.useRef();
  a && console.log("Chart config, isEditor", f, n);
  let { legend: ke, title: Se, description: de, visualizationType: Q } = f;
  n && (!Se || Se === "") && (Se = "Chart Title"), f.table && (!((xt = f.table) != null && xt.label) || ((Tt = f.table) == null ? void 0 : Tt.label) === "") && (f.table.label = "Data Table");
  const { barBorderClass: K, lineDatapointClass: ee, contentClasses: B, sparkLineStyles: ye } = Nu(f), oe = f.showSidebar ? "#legend" : f != null && f.title ? `#dataTableSection__${f.title.replace(/\s/g, "")}` : "#dataTableSection", fe = (E, J) => E.toString().localeCompare(J.toString(), "en", { numeric: !0 }), ae = (E, J) => J.toString().localeCompare(E.toString(), "en", { numeric: !0 }), he = (E, J = !1) => {
    ...
    if (f.dataUrl) {
      ...
      if (f.filters.forEach((ge) => {
        ge.type === "url" && J[ge.queryParameter] !== decodeURIComponent(ge.active) && (J[ge.queryParameter] = ge.active, ne = !0);
      }), (!f.formattedData || f.formattedData.urlFiltered) && !ne)
        return;
      let ie = `${E.origin}${E.pathname}${Object.keys(J).map((ge, re) => {
        let Pe = re === 0 ? "?" : "&";
        return Pe += ge + "=", Pe += J[ge], Pe;
      }).join("")}`, pe = [];
      try {
        const ge = fs(E.pathname);
        ge === "csv" ? pe = await fetch(ie).then((re) => re.text()).then((re) => Wl.parse(re, {
          header: !0,
          dynamicTyping: !0,
          skipEmptyLines: !0
        }).data) : ge === "json" ? pe = await fetch(ie).then((re) => re.json()) : pe = [];
      } catch {
        console.error(`Cannot parse URL: ${ie}`), pe = [];
      }
      f.dataDescription && (pe = h.autoStandardize(pe), pe = h.developerStandardize(pe, f.dataDescription)), Object.assign(pe, { urlFiltered: !0 }), le({ ...f, runtimeDataUrl: ie, data: pe, formattedData: pe }), pe && (w(pe), T(pe), k(te(f.filters, pe)));
    }
  }, Ke = (E) => {
    switch (E) {
      case "dashed-sm":
    ...
    const ne = E.filters ? E.filters.filter((ge) => ge.type === "url").length > 0 : !1;
    if (E.dataUrl && !ne)
      try {
        const ge = fs(E.dataUrl);
        ge === "csv" && (J = await fetch(E.dataUrl + `?v=${Ql()}`).then((re) => re.text()).then((re) => (re = re.replace(/(".*?")|,/g, (...Ne) => Ne[1] || "|"), re = re.replace(/["]+/g, ""), Wl.parse(re, {
    ...
    if (E.exclusions && E.exclusions.active)
      if (E.xAxis.type === "categorical" && ((ge = E.exclusions.keys) == null ? void 0 : ge.length) > 0)
        ...
        const re = (je) => new Date(je).getTime();
        ...
        it && wt ? ie = ne.filter((je) => re(je[E.xAxis.dataKey]) >= Pe && re(je[E.xAxis.dataKey]) <= Ne) : it ? ie = ne.filter((je) => re(je[E.xAxis.dataKey]) >= Pe) : wt && (ie = ne.filter((je) => re(je[E.xAxis.dataKey]) <= Ne));
      } else
        ie = J || x;
    else
      ie = J || x;
    ...
    if (E.filters && (E.filters.forEach((re, Pe) => {
      ...
      const je = [], Ft = (Re) => {
        Re.sort((St, dn) => St - dn);
        const Ye = Math.floor(Re.length / 2), Qe = Re.length % 2 === 0, rt = Qe ? Re.slice(0, Ye) : Re.slice(0, Ye + 1), Lt = Qe ? Re.slice(Ye) : Re.slice(Ye + 1), pt = Math.floor(rt.length / 2), Ot = Qe ? (rt[pt - 1] + rt[pt]) / 2 : rt[pt], vt = Math.floor(Lt.length / 2), tt = Qe ? (Lt[vt - 1] + Lt[vt]) / 2 : Lt[vt];
        return { q1: Ot, q3: tt };
      };
      if (!it)
        return;
      it.forEach((Re) => {
        try {
          ...
          const pt = Lt.q1, Ot = Lt.q3, vt = Ot - pt, tt = pt - (Ot - pt) * 1.5, St = Ot + (Ot - pt) * 1.5, dn = rt.filter((mt) => mt < tt || mt > St);
          let Ln = Qe;
          Ln = Ln.filter((mt) => !dn.includes(mt));
          const Pa = sa(Qe) || 0, Qn = oa([Pa, pt - 1.5 * vt]);
          je.push({
            columnCategory: Re,
            columnMax: sa([oa(Qe), pt + 1.5 * vt]),
            ...
            columnUpperBounds: sa([oa(rt), pt + 1.5 * vt]),
            columnOutliers: dn,
            values: Qe,
            nonOutlierValues: Ln
          });
      ...
      }), wt = JSON.parse(JSON.stringify(je)), wt.map((Re) => (Re.columnIqr = void 0, Re.nonOutlierValues = void 0, Re.columnLowerBounds = void 0, Re.columnUpperBounds = void 0, null)), E.boxplot.allValues = Pe, E.boxplot.categories = it, E.boxplot.plots = je, E.boxplot.tableData = wt;
    }
    ...
    return J.forEach((ie) => {
      ...
      E.filter((ge) => ge.type !== "url").forEach((ge) => {
        ie[ge.columnName] != ge.active && (pe = !1);
      }), pe && ne.push(ie);
    }), ne;
    ...
    for (let J of E) {
      let { width: ne, height: ie } = J.contentRect, pe = uu(ne), ge = 32, re = 350;
      A(pe), n && (ne = ne - re), J.target.dataset.lollipop === "true" && (ne = ne - 2.5), ne = ne - ge, L([ne, ie]);
    }
  }), Le = F.useCallback((E) => {
  ...
  F.useEffect(() => {
    ...
    R && !W(f) && !I && (Pu("cove_loaded", { config: f }), j(!0));
  }, [R, f]), F.useEffect(() => {
    const E = (J) => {
      let ne = [];
      ne.push(J.detail), _(ne);
    };
  ...
  const Je = (E) => {
  ...
  }, Et = (E, J, ne = !1, ie, pe, ge) => {
    if (isNaN(E) || !E)
      return E;
    const re = E < 0;
    (J === void 0 || !J) && (J = "left"), re && (E = Math.abs(E));
    let {
      dataFormat: { commas: Pe, abbreviated: Ne, roundTo: it, prefix: wt, suffix: je, rightRoundTo: Ft, bottomRoundTo: Re, rightPrefix: Ye, rightSuffix: Qe, bottomPrefix: rt, bottomSuffix: Lt, bottomAbbreviated: pt }
    } = f;
    ...
    if (J === "left" || J === void 0) {
      let St;
      ge !== void 0 ? St = ge ? Number(ge) : 0 : St = it ? Number(it) : 0, vt = {
    ...
    J === "left" && Pe && Ne && ne || J === "bottom" && Pe && Ne && ne ? E = E : E = E.toLocaleString("en-US", vt);
    let tt = "";
    return Ne && J === "left" && ne && (E = Je(parseFloat(E))), pt && J === "bottom" && ne && (E = Je(parseFloat(E))), ie && J === "left" ? tt = ie + tt : wt && J === "left" && (tt += wt), Ye && J === "right" && (tt += Ye), rt && J === "bottom" && (tt += rt), tt += E, pe && J === "left" ? tt += pe : je && J === "left" && (tt += je), Qe && J === "right" && (tt += Qe), Lt && J === "bottom" && (tt += Lt), re && (tt = "-" + tt), String(tt);
  }, Yt = {
    ...
    if (Object.keys(f.columns).length > 0 && Object.keys(f.columns).forEach(function(pe) {
      ...
      let pe = !1, ge = 0;
      Number(E) && (ie.roundToPlace >= 0 && (pe = ie.roundToPlace ? ie.roundToPlace !== "" || ie.roundToPlace !== null : !1, ge = ie.roundToPlace ? Number(ie.roundToPlace) : 0, ie.hasOwnProperty("roundToPlace") && pe && (ne = Number(E).toFixed(ge))), ie.hasOwnProperty("useCommas") && ie.useCommas === !0 && (ne = Number(E).toLocaleString("en-US", {
        style: "decimal",
        minimumFractionDigits: pe ? ge : 0,
        maximumFractionDigits: pe ? ge : 5
    ...
    try {
      ...
      if (ue.current.has(pe)) {
        let ge = ue.current.get(pe);
        if ((J = runtimeLegend[ge]) != null && J.disabled)
          return !1;
        let re = (ne = runtimeLegend.find((Pe) => Pe.bin === ge)) == null ? void 0 : ne.color;
    ...
    const J = ke.position === "bottom" || ["sm", "xs", "xxs"].includes(N), ne = E.orientation === "horizontal", ie = Number(E.xAxis.tickRotation) > 0 ? Number(E.xAxis.tickRotation) : 0, pe = E.brush.active, ge = 20, re = E.brush.height;
    let Pe = 0;
    return !J && ne && E.xAxis.label && (Pe = E.runtime.xAxis.size + E.xAxis.labelOffset), !J && ne && !E.xAxis.label && (Pe = 0), !ne && !J && E.xAxis.label && ie && !E.isResponsiveTicks && (Pe = pe ? re + E.xAxis.tickWidthMax + -E.xAxis.size + E.xAxis.labelOffset + ge : E.xAxis.tickWidthMax + ge + -E.xAxis.size + E.xAxis.labelOffset), !ne && !J && !E.xAxis.label && ie && E.isResponsiveTicks, !ne && !J && !E.xAxis.label && ie && !E.dynamicMarginTop && !E.isResponsiveTicks && (Pe = pe ? E.xAxis.tickWidthMax + re + ge + -E.xAxis.size : 0), !ne && !J && E.xAxis.label && !ie && !E.isResponsiveTicks && (Pe = pe ? re + -E.xAxis.size + E.xAxis.labelOffset + ge : -E.xAxis.size + E.xAxis.labelOffset + ge), !ne && !J && E.xAxis.label && E.dynamicMarginTop && E.isResponsiveTicks && (Pe = pe ? re + E.xAxis.labelOffset + -E.xAxis.size + E.xAxis.tickWidthMax : E.dynamicMarginTop + -E.xAxis.size + ge), !ne && !J && !E.xAxis.label && E.dynamicMarginTop && E.isResponsiveTicks && (Pe = pe ? re + E.xAxis.labelOffset + -E.xAxis.size + E.xAxis.tickWidthMax : E.dynamicMarginTop + -E.xAxis.size - ge), !ne && !J && E.xAxis.label && !E.dynamicMarginTop && E.isResponsiveTicks && (Pe = pe ? re + E.xAxis.labelOffset + -E.xAxis.size + 25 : E.xAxis.labelOffset + -E.xAxis.size + ge), !ne && !J && !E.xAxis.label && !E.dynamicMarginTop && E.isResponsiveTicks && (Pe = -E.xAxis.size + ge + E.xAxis.labelOffset), !ne && !J && !E.xAxis.label && !ie && !E.dynamicMarginTop && !E.isResponsiveTicks && (Pe = pe ? re + -E.xAxis.size + E.xAxis.labelOffset : 0), `${Pe}px`;
  };
  ...
  if (!y) {
    ...
    un = /* @__PURE__ */ i.createElement(i.Fragment, null, n && /* @__PURE__ */ i.createElement(Xg, null), !Nn() && !f.newViz && /* @__PURE__ */ i.createElement("div", { className: "cdc-chart-inner-container" }, /* @__PURE__ */ i.createElement(yu, { showTitle: f.showTitle, isDashboard: r, title: Se, superTitle: f.superTitle, classes: ["chart-title", `${f.theme}`, "cove-component__header"], style: void 0 }), /* @__PURE__ */ i.createElement("a", { id: "skip-chart-container", className: "cdcdataviz-sr-only-focusable", href: oe }, "Skip Over Chart Container"), f.filters && !S && /* @__PURE__ */ i.createElement(xu, { config: f, setConfig: b, setFilteredData: k, filteredData: D, excludedData: C, filterData: te, dimensions: P }), (f == null ? void 0 : f.introText) && f.visualizationType !== "Spark Line" && /* @__PURE__ */ i.createElement("section", { className: "introText" }, xn(f.introText)), /* @__PURE__ */ i.createElement("div", { style: { marginBottom: Xn(f) }, className: `chart-container  p-relative ${f.legend.position === "bottom" ? "bottom" : ""}${f.legend.hide ? " legend-hidden" : ""}${ee}${K} ${B.join(" ")}` }, f.visualizationType !== "Spark Line" && Yt[f.visualizationType], f.visualizationType === "Spark Line" && /* @__PURE__ */ i.createElement(i.Fragment, null, (f == null ? void 0 : f.introText) && /* @__PURE__ */ i.createElement("section", { className: "introText", style: { padding: "0px 0 35px" } }, xn(f.introText)), /* @__PURE__ */ i.createElement("div", { style: { height: "100px", width: "100%", ...ye } }, /* @__PURE__ */ i.createElement(nm, null, (J) => /* @__PURE__ */ i.createElement(gg, { width: J.width, height: J.height }))), de && /* @__PURE__ */ i.createElement("div", { className: "subtext", style: { padding: "35px 0 15px" } }, xn(de))), !f.legend.hide && f.visualizationType !== "Spark Line" && /* @__PURE__ */ i.createElement(Pg, null)), r && f.table && f.table.show && f.table.showDataTableLink ? E : s && s, de && f.visualizationType !== "Spark Line" && /* @__PURE__ */ i.createElement("div", { className: "column " + f.isResponsiveTicks ? "subtext--responsive-ticks" : "subtext" }, xn(de)), /* @__PURE__ */ i.createElement(Ri.Section, { classes: ["download-buttons"] }, f.table.showDownloadImgButton && /* @__PURE__ */ i.createElement(Ri.Button, { text: "Download Image", title: "Download Chart as Image", type: "image", state: f, elementToCapture: ce }), f.table.showDownloadPdfButton && /* @__PURE__ */ i.createElement(Ri.Button, { text: "Download PDF", title: "Download Chart as PDF", type: "pdf", state: f, elementToCapture: ce })), f.xAxis.dataKey && f.table.show && f.visualizationType !== "Spark Line" && /* @__PURE__ */ i.createElement(
      hu,
      {
        config: f,
        rawData: f.data,
  ...
  return f.visualizationType === "Spark Line" && ut.push("type-sparkline"), n && ut.push("spacing-wrapper"), n && ut.push("isEditor"), /* @__PURE__ */ i.createElement(ze.Provider, { value: Ae }, /* @__PURE__ */ i.createElement("div", { className: `${ut.join(" ")}`, ref: Le, "data-lollipop": f.isLollipopChart, "data-download-id": ce }, un));
}
export {
  gx as C
};
