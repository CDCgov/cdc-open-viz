...
import { i as ca, b as bo, a as fr, g as pr } from "./storybook-isSolr-cb863e7a.es.js";
import { C as ct, E as Ot, l as gr, n as mr, M as vr, D as hr, h as Sr, T as wr, d as Mr, a as Na, G as br, O as Ar } from "./storybook-CdcDashboard-abe5e0a0.es.js";
...
import { D as Nr } from "./storybook-DataTransform-e292f51b.es.js";
import { c as nr } from "./storybook-_commonjsHelpers-c5d32002.es.js";
import { f as Ta } from "./storybook-fetchRemoteData-8fd8b50f.es.js";
...
import "./storybook-footnoteSymbols-a744dcae.es.js";
import "./storybook-Footnotes-6f80714a.es.js";
import "./storybook-coveUpdateWorker-86b5b065.es.js";
...
function lu(o) {
  ...
  return !P && f.length > 1 || P && y >= 1 && f.length > y ? !1 : f.every(function(O) {
    var Rn = ar(O, c), M = Fa(Rn, 1), En = M[0], w = rr(O, C, b), un = Fa(w, 1), Nn = un[0];
    return En && Nn;
  });
}
function Po(o) {
...
function ha() {
  ...
  var re = D.useCallback(function(Q) {
    ...
    Q.forEach(function(ge) {
      ...
      fileRejections: ie,
      type: "setFiles"
    }), un && un(te, ie, In), ie.length > 0 && Cn && Cn(ie, In), te.length > 0 && Nn && Nn(te, In);
  }, [$n, O, c, y, P, Rn, un, Nn, Cn, ae]), z = D.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Ie(Q), fe.current = [], Ao(Q) && Promise.resolve(b(Q)).then(function(In) {
      Po(Q) && !An || F(In, Q);
    }), $n({
      type: "reset"
    });
  }, [b, F, An]), rn = D.useCallback(function() {
    if (vn && Va()) {
      $n({
        type: "openDialog"
      }), zn();
    ...
    !ne.current || !ne.current.isEqualNode(Q.target) || (Q.keyCode === 32 || Q.keyCode === 13) && (Q.preventDefault(), rn());
  }, [ne, en, rn]), Gn = D.useCallback(function() {
    $n({
      type: "focus"
    });
...
const Lt = ({ children: o, className: f = "" }) => /* @__PURE__ */ l.createElement("div", { className: `tab-content ${f}` }, o), Lu = (o) => {
  ...
  return /* @__PURE__ */ l.createElement(sr, { ...o, setActiveTab: C, activeTab: f });
}, ku = ({ children: o, className: f = void 0, startingTab: c }) => {
  const [C, b] = D.useState(c);
  return /* @__PURE__ */ l.createElement(sr, { className: f, setActiveTab: b, activeTab: C }, o);
  ...
  return /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("nav", { className: P }, /* @__PURE__ */ l.createElement("ul", { className: "nav nav-fill" }, y)), o[c]);
};
...
function Ou() {
  return Xa || (Xa = 1, function(o, f) {
    (function(c, C) {
      ...
      so.pluginName = "useColumnOrder", un.canResize = !0, M.columnStartResizing = "columnStartResizing", M.columnResizing = "columnResizing", M.columnDoneResizing = "columnDoneResizing", M.resetResize = "resetResize";
      var Co = function(n) {
        ...
        if (t.type === w.setAllFilters) {
          ...
          return y({}, e, {
            ...
            filters: Wn(B, e.filters).filter(function(k) {
              ...
              return !rn(yn.autoRemove, k.value, Z);
            })
          });
        }
      }
...
function Fu(o, f, c) {
  ...
  var Nn = !!c.leading, Cn = "trailing" in c ? !!c.trailing : !0, fn = "maxWait" in c, Vn = fn ? Math.max(+c.maxWait || 0, f) : null, vn = D.useCallback(function(en) {
  ...
  }, [un]), bn = D.useCallback(function(en) {
    if (!w.current)
      return !1;
    ...
    y.current && (un ? cancelAnimationFrame(y.current) : clearTimeout(y.current)), P.current = 0, O.current = b.current = Rn.current = y.current = null;
...
function xu(o, f, c) {
  var C = c && c.equalityFn || Hu, b = Wu(o), P = b[0], y = b[1], O = Fu(D.useCallback(function(M) {
    return y(M);
  }, [y]), f, c), Rn = D.useRef(o);
...
function li() {
  const { config: o, errors: f, tempConfig: c, sharepath: C } = D.useContext(ct), b = (F) => {
  ...
  }, y = new Nr(), [O, Rn] = D.useState(o.dataFileSourceType === "url" ? o.dataFileName : o.dataUrl || ""), [M, En] = D.useState(!!o.dataUrl), [w, un] = D.useState(o.type === "dashboard" || !o.data), [Nn, Cn] = D.useState(void 0), fn = D.useContext(Ot), Vn = {
    ".csv": "text/csv",
    ".json": "application/json"
  }, vn = (F) => F === void 0 ? "" : F > Math.pow(1024, 3) ? Math.round(F / Math.pow(1024, 3) * 100) / 100 + " GB" : F > Math.pow(1024, 2) ? Math.round(F / Math.pow(1024, 2) * 100) / 100 + " MB" : F > 1024 ? Math.round(F / 1024 * 100) / 100 + " KB" : F + " B", Hn = (F, z, rn) => (z.map(function(tn, Gn, jn) {
    if (!jn.find((we) => we.dataKey === tn.dataKey))
      return !1;
  }), !(F.columns.indexOf(rn) < 0)), bn = (F) => ca(O) ? ".csv" : bo(O) ? ".json" : Object.keys(Vn).find((z) => F.pathname.endsWith(z)), Jn = async () => {
    let F;
    try {
    ...
    try {
      await Rr.get(F.toString(), {
        ...
        z = tn.data, rn === ".csv" && ["text/csv", "text/plain"].includes(z.type) || ca(O) ? z = z.slice(0, z.size, "text/csv") : (z.type === "application/json" || rn === ".json" && z.type === "text/plain" || bo(O)) && (z = z.slice(0, z.size, "application/json"));
      });
    } catch (tn) {
      console.error(tn);
  ...
  }, Wn = ([F]) => An(F, Nn, Nn), An = async (F = null, z, rn) => {
    let tn = F;
  ...
  const ae = (F, z, rn) => {
    if (o.type === "dashboard") {
      let tn = { ...o.datasets[F].dataDescription, [z]: rn }, Gn = y.developerStandardize(o.datasets[F].data, tn), jn = { ...o.datasets };
      jn[F] = { ...jn[F], dataDescription: tn, formattedData: Gn }, b({ ...o, datasets: jn });
    } else {
      let tn = { ...o.dataDescription, [z]: rn }, Gn = y.developerStandardize(o.data, tn);
    ...
    let tn = { ...o.datasets };
    rn === !0 ? Object.keys(tn).forEach((Gn) => {
      const jn = Gn === F;
      tn[Gn][z] = jn;
    }) : tn[F][z] = rn, b({ ...o, datasets: tn });
  }, Ee = (F) => {
    let z = { ...o.datasets }, rn = { ...o.visualizations };
    Object.keys(rn).forEach((tn) => {
      rn[tn].dataKey === F && delete rn[tn].dataKey;
    }), delete z[F], b({ ...o, datasets: z, visualizations: rn });
  }, fe = (F, z) => {
    if (F === z)
      return;
    let rn = { ...o.datasets }, tn = { ...o.visualizations }, Gn = 2, jn = z;
    for (; rn[z]; )
      z = jn + "-" + Gn, Gn++;
    rn[z] = rn[F], delete rn[F], Object.keys(tn).forEach((we) => {
      tn[we].dataKey === F && (tn[we].dataKey = z);
    }), b({ ...o, datasets: rn, visualizations: tn });
  };
  let me, re = !1;
  ...
  const Oe = /* @__PURE__ */ l.createElement(l.Fragment, null, o.filters && o.filters.map(
    (F, z) => F.type !== "url" ? /* @__PURE__ */ l.createElement(l.Fragment, null) : /* @__PURE__ */ l.createElement("fieldset", { key: F.key, className: "edit-block url-filters-block" }, /* @__PURE__ */ l.createElement(
      ...
      "input",
      {
        ...
        onChange: (rn) => {
          let tn = [...o.filters];
          tn[z].label = rn.target.value, b({ ...o, filters: tn });
        }
      }
      ...
      "input",
      {
        ...
        onChange: (rn) => {
          let tn = [...o.filters];
          tn[z].queryParameter = rn.target.value, b({ ...o, filters: tn });
        }
      }
    )), /* @__PURE__ */ l.createElement("label", null, /* @__PURE__ */ l.createElement("span", { className: "edit-label column-heading" }, "Values"), " "), /* @__PURE__ */ l.createElement("ul", { className: "value-list" }, F.orderedValues && F.orderedValues.map((rn, tn) => /* @__PURE__ */ l.createElement("li", null, rn, /* @__PURE__ */ l.createElement(
      "input",
      {
        type: "text",
        ...
        onChange: (Gn) => {
          let jn = [...o.filters];
          jn[z].labels = jn[z].labels || {}, jn[z].labels[rn] = Gn.target.value, b({ ...o, filters: jn });
        }
      }
      ...
      "form",
      {
        onSubmit: (rn) => {
          if (rn.preventDefault(), !o.filters[z].orderedValues || o.filters[z].orderedValues.indexOf(rn.target[0].value) === -1) {
            let tn = [...o.filters];
            tn[z].orderedValues = tn[z].orderedValues || [], tn[z].orderedValues.push(rn.target[0].value), tn[z].values = tn[z].orderedValues, tn[z].active || (tn[z].active = rn.target[0].value), rn.target[0].value = "", b({ ...o, filters: tn });
          }
        }
      },
...
function vi() {
  ...
  const C = ({ icon: b, label: P, type: y, subType: O = void 0, orientation: Rn = void 0, stacked: M = !1, generalType: En = "data" }) => {
    ...
    y === "chart" && (w = O === o.visualizationType, un = Rn === o.orientation && M === !0), (y === "dashboard" || y === "data-bite" || y === "markup-include") && (w = !0), y === "chart" && M ? Nn = o.type === y && w && o.visualizationSubType === "stacked" ? "active" : "" : y === "chart" && !M && o.visualizationSubType !== "stacked" && (Nn = o.type === y && w ? "active" : ""), y !== "chart" && (Nn = o.type === y && w && !un ? "active" : "");
    let Cn = () => {
      if (y === o.type)
...
const Ai = (o, f) => {
  ...
  const P = D.useMemo(() => {
    let un = 0;
    return (o != null && o.data || o != null && o.dataUrl) && (o != null && o.type) && (un = 2), { config: bi(o || { newViz: !0, errors: [], currentViewport: "lg" }), errors: [], currentViewport: "lg", globalActive: un, sharepath: C, isDebug: b, hostname: f };
  }, [o]);
  D.useEffect(() => {
    var un;
    Na && ((un = Na) == null || un.init());
  }, []);
  const [y, O] = D.useReducer(Di, P), Rn = (un) => {
    Mi(kt.cloneDeep(un)), O({ type: "EDITOR_TEMP_SAVE", payload: un });
  }, M = new fr((un) => {
    const Nn = un[0], { width: Cn } = Nn.contentRect, fn = pr(Cn);
