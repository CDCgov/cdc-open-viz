import { R as x, r as Z, d as H, e as L, C as P, b as $, a as B, h as F, n as s, c as z, i as bn } from "./storybook-string-CipJGmzE.es.js";
import { i as f, j as v, k as g, l as M, b as vn, d as Mn, c as wn, a as xn, g as Tn, f as Cn } from "./storybook-year-CExuJshh.es.js";
import { i as Nn, l as On, c as _ } from "./storybook-Group-C59Wb054.es.js";
import { R as J } from "./storybook-index-9_ikpx_Z.es.js";
const Q = Math.PI / 180, V = 180 / Math.PI, w = 18, nn = 0.96422, en = 1, tn = 0.82521, rn = 4 / 29, d = 6 / 29, an = 3 * d * d, Rn = d * d * d;
function un(n) {
  if (n instanceof l) return new l(n.l, n.a, n.b, n.opacity);
  if (n instanceof c) return on(n);
...
function Un(n) {
  if (n instanceof c) return new c(n.h, n.c, n.l, n.opacity);
  if (n instanceof l || (n = un(n)), n.a === 0 && n.b === 0) return new c(NaN, 0 < n.l && n.l < 100 ? 0 : NaN, n.l, n.opacity);
...
function on(n) {
  if (isNaN(n.h)) return new l(n.l, 0, 0, n.opacity);
  var e = n.h * Q;
...
function In(n) {
  if (n instanceof h) return new h(n.h, n.s, n.l, n.opacity);
  n instanceof x || (n = Z(n));
