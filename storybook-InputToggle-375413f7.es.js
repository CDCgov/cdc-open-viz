...
import { m as Ce } from "./storybook-memoize-b2d53f3a.es.js";
import "./storybook-lodash-c15d8e1c.es.js";
import { e as Fe } from "./storybook-index-66852bf6.es.js";
  ...
  arcTo: function(e, t, a, n, r) {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(h * u - i * s) > I) || !r)
        ...
        var d = a - o, C = n - l, c = u * u + i * i, g = d * d + C * C, F = Math.sqrt(c), m = Math.sqrt(p), v = r * Math.tan((Z - Math.acos((c + p - g) / (2 * F * m))) / 2), y = v / m, k = v / F;
...
f.lex = function(e, t) {
  ...
  for (s = 0; s < p.length; s++) {
    ...
    var C = d.token, c = d.type, g = d.value, F = d.precedence, m = d.show, v = a[a.length - 1], y;
    ...
    if (o[c] !== !0)
      throw new f.Exception(C + " is not allowed after " + i);
    if (u[c] === !0 && (c = 2, g = f.math.mul, m = "&times;", F = 3, s = s - 1), h = {
      value: g,
      type: c,
      pre: F,
      show: m,
      ...
      v.type === 1 ? (v.value += g, b(n, 1)) : a.push(h), o = $, u = De;
    else if (c === 2)
      ...
      v.type !== 1 && (v = {
        ...
        type: 1,
        pre: 0
      }, a.push(v)), o = Ie, b(n, 1), u = A, v.value += g, v.hasDec = !0;
    } else
      c === 7 && (o = $, u = L, b(n, 1), a.push(h));
    c === 8 ? (o = x, u = A, b(n, d.numberOfArguments + 2), a.push(h), p[s + 1].type !== 4 && (a.push(W), n.push(d.numberOfArguments + 2))) : c === 9 ? (v.type === 9 ? v.value === f.math.add ? (v.value = g, v.show = m, b(n, 1)) : v.value === f.math.sub && m === "-" && (v.value = f.math.add, v.show = "+", b(n, 1)) : v.type !== 5 && v.type !== 7 && v.type !== 1 && v.type !== 3 && v.type !== 13 ? C === "-" && (o = x, u = A, b(n, 2).push(2), a.push(Te), a.push(W)) : (a.push(h), b(n, 2)), o = x, u = A) : c === 10 ? (o = x, u = A, b(n, 2), a.push(h)) : c === 11 ? (o = x, u = A, a.push(h)) : c === 12 ? (o = x, u = A, b(n, 6), a.push(h), p[s + 1].type !== 4 && (a.push(W), n.push(6))) : c === 13 && (o = $, u = L, a.push(h)), b(n, -1), i = C;
  }
  for (y = n.length; y--; )
    a.push(z);
  if (o[5] !== !0)
...
var He = ge, je = xe, ze = Be, Ge = He, Ue = 100, Xe = /(\+|\-|\*|\\|[^a-z]|)(\s*)(\()/g, X, Ke = Ye;
function Ye(e, t) {
...
function et(e) {
  var t = e.verticalAnchor, a = t === void 0 ? "end" : t, n = e.scaleToFit, r = n === void 0 ? !1 : n, o = e.angle, l = e.width, u = e.lineHeight, i = u === void 0 ? "1em" : u, s = e.capHeight, h = s === void 0 ? "0.71em" : s, p = e.children, d = e.style, C = Ve(e, Qe), c = C.x, g = c === void 0 ? 0 : c, F = C.y, m = F === void 0 ? 0 : F, v = !se(g) || !se(m), y = R.useMemo(function() {
    ...
    if (v)
      return "";
    if (Y(g) && Y(m) && Y(l) && r && D.length > 0) {
      var B = D[0].width || 1, q = r === "shrink-only" ? Math.min(l / B, 1) : l / B, T = q, N = g - q * g, U = m - T * m;
      M.push("matrix(" + q + ", 0, 0, " + T + ", " + N + ", " + U + ")");
    }
    return o && M.push("rotate(" + o + ", " + g + ", " + m + ")"), M.length > 0 ? M.join(" ") : "";
  }, [v, g, m, l, r, D, o]);
  return {
    wordsByLines: D,
    startDy: be,
...
function Nt(e) {
  ...
  var p = at(e, tt), d = p.x, C = d === void 0 ? 0 : d, c = p.fontSize, g = et(e), F = g.wordsByLines, m = g.startDy, v = g.transform;
...
var me = {
  ...
  style: void 0,
  attr: void 0
}, he = w.createContext && w.createContext(me), S = globalThis && globalThis.__assign || function() {
