...
const w = ({
  ...
  return a.useEffect(() => {
    ...
    d && /* @__PURE__ */ e.createElement(e.Fragment, null, s === "loader" && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(
      "span",
      {
        className: "cove-button__text",
        style: n ? { width: _ + "px" } : { width: S + "px" }
      },
      /* @__PURE__ */ e.createElement("div", { className: "cove-button__text--loading", style: n ? { opacity: 1 } : null }, m),
      /* @__PURE__ */ e.createElement("div", { className: "cove-button__text--children", style: n ? { opacity: 0 } : null }, d)
    ), /* @__PURE__ */ e.createElement("div", { className: "cove-button__load-spin", style: n ? { width: "28px", opacity: 1 } : null }, /* @__PURE__ */ e.createElement(L, { className: "ms-1", size: 20 }))), s !== "loader" && d)
  );
};
w.propTypes = {
