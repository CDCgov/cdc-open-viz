...
import { C as o } from "./storybook-c11e9ca9.es.js";
...
const C = (d) => {
  const { configureData: l, updateDescriptionProp: r, visualizationKey: c, dataKey: s, config: a, setConfig: i } = d, E = (a == null ? void 0 : a.visualizationType) !== "Forest Plot", p = (a == null ? void 0 : a.visualizationType) !== "Forest Plot", h = (a == null ? void 0 : a.visualizationType) !== "Forest Plot";
  return v.useEffect(() => {
    (a == null ? void 0 : a.visualizationType) === "Forest Plot" && i({
      ...a,
      dataDescription: {
        series: !0,
        horizontal: !1,
    ...
    /* @__PURE__ */ e.createElement(o, null, /* @__PURE__ */ e.createElement("strong", { className: "cove-heading--3" }, "Vertical"), /* @__PURE__ */ e.createElement("p", { className: "mb-1" }, "Values for map geography or chart date/category axis are contained in a single ", /* @__PURE__ */ e.createElement("em", null, "column"), "."), g)
  )), /* @__PURE__ */ e.createElement("div", { className: "column" }, /* @__PURE__ */ e.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ e.createElement(o, null, /* @__PURE__ */ e.createElement("strong", { className: "cove-heading--3" }, "Horizontal"), /* @__PURE__ */ e.createElement("p", { className: "mb-1" }, "Values for map geography or chart date/category axis are contained in a single ", /* @__PURE__ */ e.createElement("em", null, "row")), y)
    ...
    /* @__PURE__ */ e.createElement(o, null, /* @__PURE__ */ e.createElement("strong", { className: "cove-heading--3" }, "Single Row"), /* @__PURE__ */ e.createElement("p", { className: "mb-1" }, "Each row contains the data for an individual series in itself."), b)
  )), /* @__PURE__ */ e.createElement("div", { className: "column" }, /* @__PURE__ */ e.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ e.createElement(o, null, /* @__PURE__ */ e.createElement("strong", { className: "cove-heading--3" }, "Multiple Rows"), /* @__PURE__ */ e.createElement("p", { className: "mb-1" }, "Each series data is broken out into multiple rows."), D)
    ...
    {
      onChange: (t) => {
        t.target.value && (!l.dataDescription.valueKeys || l.dataDescription.valueKeys.indexOf(t.target.value) === -1) && r(c, s, "valueKeys", [...l.dataDescription.valueKeys || [], t.target.value]);
      }
    },
    /* @__PURE__ */ e.createElement("option", { value: "" }, "Choose an option"),
    Object.keys(l.data[0]).filter((t) => !l.dataDescription.valueKeys || l.dataDescription.valueKeys.indexOf(t) === -1).map((t, n) => /* @__PURE__ */ e.createElement("option", { value: t, key: `value-keys-option-${n}` }, t))
    ...
    {
      onClick: () => {
        let m = l.dataDescription.ignoredKeys;
        m.splice(n, 1), r(c, s, "ignoredKeys", m);
      }
    },
    "X"
  )))), /* @__PURE__ */ e.createElement(
