...
const c = {
  ...
  if (e && e !== void 0)
    if (e.includes("–") || e.includes("-")) {
      let n = e.includes("–") ? e.split("–") : e.split("-"), i = e.includes("–") ? "–" : "-", l = n[0].split(" ").map((o) => o.charAt(0).toUpperCase() + o.substring(1).toLowerCase()).join(" "), t = n[1].split(" ").map((o) => o.charAt(0).toUpperCase() + o.substring(1).toLowerCase()).join(" ");
      return l + i + t;
    } else
      return e.split(" ").map((n) => n === "of" ? n : n.charAt(0).toUpperCase() + n.substring(1).toLowerCase()).join(" ");
}, y = (e, n = !0) => {
  if (!n)
    return e;
  const i = Object.keys(u), l = Object.keys(C), t = Object.keys(d), o = Object.keys(h);
  let a = e;
  i.includes(a) && (a = r(u[e][0])), l.includes(a) && (a = r(C[e][0]), a === "U.s. Virgin Islands" && (a = "U.S. Virgin Islands")), t.includes(a) && (a = r(d[e][0])), o.includes(a) && (a = r(h[e]));
  const s = {
  ...
  return Object.keys(s).includes(a) === !0 && (a = s[a]), (a == null ? void 0 : a.length) === 2 || a === "U.S. Virgin Islands" ? a : r(a);
}, g = S.createContext(() => {
}), k = S.createContext({});
export {
  k as C,
