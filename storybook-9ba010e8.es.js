...
import { R as Tn } from "./storybook-e61d95ab.es.js";
import { g as _n } from "./storybook-c5d32002.es.js";
var Sn = { exports: {} };
/*!
...
var Gn = Sn.exports;
const Bn = /* @__PURE__ */ _n(Gn);
var Vn = ["top", "left", "transform", "className", "children", "innerRef"];
function en() {
...
function Kn(n) {
  var e = n.top, r = e === void 0 ? 0 : e, t = n.left, i = t === void 0 ? 0 : t, a = n.transform, f = n.className, o = n.children, s = n.innerRef, u = Xn(n, Vn);
  return /* @__PURE__ */ Tn.createElement("g", en({
    ref: s,
    className: Bn("visx-group", f),
...
function Pn(n) {
  let e, r, t;
  n.length !== 2 ? (e = B, r = (o, s) => B(n(o), s), t = (o, s) => n(o) - s) : (e = n === B || n === Un ? n : Wn, r = n, t = n);
...
const Zn = Pn(B), Jn = Zn.right;
Pn(Yn).center;
const Qn = Jn, ne = Math.sqrt(50), ee = Math.sqrt(10), re = Math.sqrt(2);
function V(n, e, r) {
  const t = (e - n) / Math.max(0, r), i = Math.floor(Math.log10(t)), a = t / Math.pow(10, i), f = a >= ne ? 10 : a >= ee ? 5 : a >= re ? 2 : 1;
  let o, s, u;
...
function ie(n, e, r) {
  e = +e, n = +n, r = +r;
  const t = e < n, i = t ? rn(e, n, r) : rn(n, e, r);
...
function I(n) {
  var e, r;
  return n = (n + "").trim().toLowerCase(), (e = fe.exec(n)) ? (r = e[1].length, e = parseInt(e[1], 16), r === 6 ? pn(e) : r === 3 ? new x(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : r === 8 ? T(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : r === 4 ? T(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = oe.exec(n)) ? new x(e[1], e[2], e[3], 1) : (e = ue.exec(n)) ? new x(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = se.exec(n)) ? T(e[1], e[2], e[3], e[4]) : (e = ce.exec(n)) ? T(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = le.exec(n)) ? wn(e[1], e[2] / 100, e[3] / 100, 1) : (e = he.exec(n)) ? wn(e[1], e[2] / 100, e[3] / 100, e[4]) : xn.hasOwnProperty(n) ? pn(xn[n]) : n === "transparent" ? new x(NaN, NaN, NaN, 0) : null;
}
function pn(n) {
...
function un(n, e) {
  var r = typeof e, t;
  return e == null || r === "boolean" ? Z(e) : (r === "number" ? U : r === "string" ? (t = I(e)) ? (e = t, Nn) : je : e instanceof I ? Nn : e instanceof Date ? ve : Me(e) ? we : Array.isArray(e) ? Ne : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? $e : U)(n, e);
}
function Ae(n, e) {
  return n = +n, e = +e, function(r) {
...
function ze() {
  var n = vn, e = vn, r = un, t, i, a, f = S, o, s, u;
  function l() {
    var d = Math.min(n.length, e.length);
    return f !== S && (f = Ee(n[0], n[d - 1])), o = d > 2 ? Oe : He, s = u = null, c;
  }
  function c(d) {
  ...
  return c.invert = function(d) {
    ...
    return e = Array.from(d), r = Ae, l();
  }, c.clamp = function(d) {
    return arguments.length ? (f = d ? !0 : S, l()) : f !== S;
...
var jn = Array.prototype.map, An = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function Ge(n) {
  var e = n.grouping === void 0 || n.thousands === void 0 ? Rn : Fe(jn.call(n.grouping, Number), n.thousands + ""), r = n.currency === void 0 ? "" : n.currency[0] + "", t = n.currency === void 0 ? "" : n.currency[1] + "", i = n.decimal === void 0 ? "." : n.decimal + "", a = n.numerals === void 0 ? Rn : De(jn.call(n.numerals, String)), f = n.percent === void 0 ? "%" : n.percent + "", o = n.minus === void 0 ? "−" : n.minus + "", s = n.nan === void 0 ? "NaN" : n.nan + "";
  function u(c) {
    c = Y(c);
    var d = c.fill, N = c.align, b = c.sign, H = c.symbol, j = c.zero, O = c.width, J = c.comma, v = c.precision, cn = c.trim, g = c.type;
    g === "n" ? (J = !0, g = "g") : kn[g] || (v === void 0 && (v = 12), cn = !0, g = "g"), (j || d === "0" && N === "=") && (j = !0, d = "0", N = "=");
    var Fn = H === "$" ? r : H === "#" && /[boxX]/.test(g) ? "0" + g.toLowerCase() : "", Dn = H === "$" ? t : /[%p]/.test(g) ? f : "", ln = kn[g], Ln = /[defgprs%]/.test(g);
    ...
    function hn(h) {
      ...
      if (g === "c")
        ...
        h = +h;
        var D = h < 0 || 1 / h < 0;
        if (h = isNaN(h) ? s : ln(Math.abs(h), v), cn && (h = Te(h)), D && +h == 0 && b !== "+" && (D = !1), $ = (D ? b === "(" ? b : o : b === "-" || b === "(" ? "" : b) + $, m = (g === "s" ? An[8 + zn / 3] : "") + m + (D && b === "(" ? ")" : ""), Ln) {
          for (A = -1, dn = h.length; ++A < dn; )
            if (F = h.charCodeAt(A), 48 > F || F > 57) {
              m = (F === 46 ? i + h.slice(A + 1) : h.slice(A)) + m, h = h.slice(0, A);
              break;
            }
        }
      }
      J && !j && (h = e(h, 1 / 0));
      var L = $.length + h.length + m.length, w = L < O ? new Array(O - L + 1).join(d) : "";
      switch (J && j && (h = e(w + h, w.length ? O - m.length : 1 / 0), w = ""), N) {
        case "<":
          h = $ + h + m + w;
          break;
        case "=":
          ...
          break;
        case "^":
          h = w.slice(0, L = w.length >> 1) + $ + h + m + w.slice(L);
          break;
        default:
          h = w + $ + h + m;
          break;
  ...
  function l(c, d) {
    var N = u((c = Y(c), c.type = "f", c)), b = Math.max(-8, Math.min(8, Math.floor(E(d) / 3))) * 3, H = Math.pow(10, -b), j = An[8 + b / 3];
    return function(O) {
      return N(H * O) + j;
    };
  }
...
function We(n) {
  ...
  return n.ticks = function(r) {
    var t = e();
    return te(t[0], t[t.length - 1], r ?? 10);
