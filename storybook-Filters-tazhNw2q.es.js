...
var _e = z((e, t) => ta(t).filter((n) => e === n.descriptor.droppableId).sort((n, o) => n.descriptor.index - o.descriptor.index));
function yr(e) {
...
const Do = (e, t) => t.margin[e.start] + t.borderBox[e.size] / 2, Ea = (e, t) => t.margin[e.end] + t.borderBox[e.size] / 2, Sr = (e, t, r) => t[e.crossAxisStart] + r.margin[e.crossAxisStart] + r.borderBox[e.crossAxisSize] / 2, Nn = ({
  ...
  moveRelativeTo: t,
  isMoving: r
}) => Ie(e.line, t.marginBox[e.start] - Ea(e, r), Sr(e, t.marginBox, r)), Da = ({
  axis: e,
  moveInto: t,
  isMoving: r
...
var xa = ({
  ...
  if (!r.isEnabled)
    return null;
  const u = _e(r.descriptor.id, n), f = Fe(t, r), l = ra({
    isMovingForward: e,
    draggable: t,
    destination: r,
    insideDestination: u,
...
var Ta = ({
  ...
  if (!c)
    return null;
  const u = _e(c.descriptor.id, o), f = Aa({
    pageBorderBoxCenter: t,
    viewport: i,
    destination: c,
    insideDestination: u,
...
var Ha = ({
  ...
  const i = n.axis, a = nt(n.axis, e.displaceBy), c = a.value, u = t[i.start], f = t[i.end], d = St(e, o).find((v) => {
    const b = v.descriptor.id, g = v.page.borderBox, D = g[i.size] / ka, E = ye(b, s), y = Io({
  ...
  if (!c)
    return oa;
  const u = n[c], f = _e(u.descriptor.id, r), l = Ga(u, a);
  return Ha({
...
var Jc = ({
  ...
  announce: o,
  autoScroller: s
}) => Xn(ec, Xc(Ms(Ec(r), Hc(e), yc(e), Cc, Uc, kc, Kc, zc(s), Pc, jc(t), Fc(n, o))));
const Ft = () => ({
  additions: {},
  removals: {},
  modified: {}
...
function Rl(e) {
  ...
  return N.useEffect(function() {
    ...
    return r.current = s, s.id = t, s.setAttribute("aria-live", "assertive"), s.setAttribute("aria-atomic", "true"), Te(s.style, _l), et().appendChild(s), function() {
      setTimeout(function() {
        const c = et();
...
function pu(e) {
  const t = N.useRef(Wt), r = N.useRef(be), n = C(function() {
    return t.current;
  }, []), o = C(function(p) {
    t.current = p;
  }, []), s = B(() => ({
...
function Ru(e) {
  ...
  r(w);
  const I = C((A) => ko(ke(i).getState(), A), []), x = C(() => xe(ke(i).getState()), []), P = B(() => ({
    marshal: g,
    focus: D,
    contextId: t,
    canLift: I,
...
function Xd(e) {
  ...
  return _.createElement(as, Te({}, e, {
    isClone: !1,
    isEnabled: t,
