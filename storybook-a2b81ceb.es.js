import { a as i, F as s, j as e } from "./storybook-8087091f.es.js";
import "react";
import { B as m } from "./storybook-8c5d6d8a.es.js";
import { C as p } from "./storybook-90f6dc9a.es.js";
const g = /* @__PURE__ */ i(s, { children: [
...
] }), b = /* @__PURE__ */ e("table", { children: /* @__PURE__ */ i("tbody", { children: [
  /* @__PURE__ */ i("tr", { children: [
    /* @__PURE__ */ e("th", { children: "Date" }),
...
] }) }), y = /* @__PURE__ */ e("table", { children: /* @__PURE__ */ i("tbody", { children: [
  /* @__PURE__ */ i("tr", { children: [
...
const K = (u) => {
  const { configureData: r, updateDescriptionProp: n, visualizationKey: l, dataKey: d, config: c, setConfig: o } = u;
  return /* @__PURE__ */ i("div", { className: "cove-data-designer__container", children: [
    ...
    r.dataDescription && /* @__PURE__ */ i(s, { children: [
      /* @__PURE__ */ i("div", { className: "mb-2", children: [
      ...
      r.dataDescription.horizontal === !0 && r.dataDescription.series === !0 && /* @__PURE__ */ i("div", { className: "mb-2", children: [
        ...
        /* @__PURE__ */ i(
          ...
          {
            onChange: (t) => {
              n(l, d, "seriesKey", t.target.value);
            },
            defaultValue: r.dataDescription.seriesKey,
            children: [
              /* @__PURE__ */ e("option", { value: "", children: "Choose an option" }),
              Object.keys(r.data[0]).map((t, a) => /* @__PURE__ */ e("option", { value: t, children: t }, a))
            ]
          }
        )
      ] }),
      r.dataDescription.horizontal === !1 && r.dataDescription.series === !0 && /* @__PURE__ */ i(s, { children: [
        /* @__PURE__ */ i("div", { className: "mb-2", children: [
        ...
        r.dataDescription.singleRow === !1 && /* @__PURE__ */ i(s, { children: [
          /* @__PURE__ */ i("div", { className: "mb-2", children: [
            /* @__PURE__ */ e("div", { className: "mb-1", children: "Which property in the dataset represents which series the row is describing?" }),
            /* @__PURE__ */ i(
              "select",
          ...
          /* @__PURE__ */ i("div", { className: "mb-2", children: [
            ...
            r.dataDescription.valueKeys && r.dataDescription.valueKeys.length > 0 && /* @__PURE__ */ e("ul", { className: "value-list", children: r.dataDescription.valueKeys.map((t, a) => /* @__PURE__ */ i("li", { children: [
              t,
              /* @__PURE__ */ e(
                "button",
                {
                  onClick: () => {
                    let h = r.dataDescription.valueKeys;
                    h.splice(a, 1), n(l, d, "valueKeys", h);
                  },
                  children: "X"
                }
              )
            ...
            /* @__PURE__ */ i(
              ...
              {
                onChange: (t) => {
                  t.target.value && (!r.dataDescription.valueKeys || r.dataDescription.valueKeys.indexOf(t.target.value) === -1) && n(l, d, "valueKeys", [...r.dataDescription.valueKeys || [], t.target.value]);
                },
                children: [
                  /* @__PURE__ */ e("option", { value: "", children: "Choose an option" }),
                  Object.keys(r.data[0]).filter((t) => !r.dataDescription.valueKeys || r.dataDescription.valueKeys.indexOf(t) === -1).map((t, a) => /* @__PURE__ */ e("option", { value: t, children: t }, `value-keys-option-${a}`))
                ]
              }
            )
          ] }),
          /* @__PURE__ */ i("div", { className: "mb-2", children: [
            ...
            r.dataDescription.ignoredKeys && r.dataDescription.ignoredKeys.length > 0 && /* @__PURE__ */ e("ul", { className: "value-list", children: r.dataDescription.ignoredKeys.map((t, a) => /* @__PURE__ */ i("li", { children: [
              t,
              /* @__PURE__ */ e(
                "button",
                {
                  onClick: () => {
                    let h = r.dataDescription.ignoredKeys;
                    h.splice(a, 1), n(l, d, "ignoredKeys", h);
                  },
                  children: "X"
                }
              )
            ...
            /* @__PURE__ */ i(
              ...
              {
                onChange: (t) => {
                  t.target.value && n(l, d, "ignoredKeys", [...r.dataDescription.ignoredKeys || [], t.target.value]), t.target.value = "";
                },
                children: [
                  /* @__PURE__ */ e("option", { value: "", children: "Choose an option" }),
                  Object.keys(r.data[0]).filter((t) => !r.dataDescription.ignoredKeys || r.dataDescription.ignoredKeys.indexOf(t) === -1).map((t, a) => /* @__PURE__ */ e("option", { value: t, children: t }, `ignored-keys-option-${a}`))
                ]
              }
            )
          ] })
      ...
      (c == null ? void 0 : c.visualizationType) === "Forest Plot" && /* @__PURE__ */ i(s, { children: [
        /* @__PURE__ */ i("div", { className: "mb-2", children: [
          /* @__PURE__ */ e("div", { className: "mb-1", children: "Which column represents the date/category column?" }),
          /* @__PURE__ */ i(
            "select",
            {
              onChange: (t) => {
        ...
        /* @__PURE__ */ i("div", { className: "mb-2", children: [
          /* @__PURE__ */ e("div", { className: "mb-1", children: "Which shape do you want to use in your forest plot?" }),
          /* @__PURE__ */ i(
            "select",
            {
              onChange: (t) => {
              ...
              children: [
                /* @__PURE__ */ e("option", { value: "", children: "Choose an option" }),
                ["text", "circle", "square", "diamond"].map((t, a) => /* @__PURE__ */ e("option", { value: t, children: t }, a))
              ]
            }
          )
        ] })
