import { _ as ea, m as pl, a as ta } from "./storybook-WithTooltip-V3YHNWJZ-CCD63hZ5.es.js";
var cl = ta({ "node_modules/prettier/parser-html.js"(Jr, Xr) {
  (function(Ae) {
    if (typeof Jr == "object" && typeof Xr == "object") Xr.exports = Ae();
    else if (typeof define == "function" && define.amd) define(Ae);
    else {
    ...
    var Ae = (ot, Ne) => () => (Ne || ot((Ne = { exports: {} }).exports, Ne), Ne.exports), Yt = Ae((ot, Ne) => {
      ...
      Ne.exports = function(ee) {
        if (Se(ee)) throw Oe("Can't call method on " + ee);
        return ee;
      };
    }), dn = Ae((ot, Ne) => {
      var Se = Zr(), Oe = qn();
      ...
      Ne.exports = function(W, Z) {
        var Y, ne;
        if (Z === "string" && Oe(Y = W.toString) && !ee(ne = Se(Y, W)) || Oe(Y = W.valueOf) && !ee(ne = Se(Y, W)) || Z !== "string" && Oe(Y = W.toString) && !ee(ne = Se(Y, W))) return ne;
      ...
      Ne.exports = function(Fe, je) {
        if (!Oe(Fe) || ee(Fe)) return Fe;
        var he = V(Fe, ne), qe;
        if (he) {
          if (je === void 0 && (je = "default"), qe = Se(he, Fe, je), !Oe(qe) || ee(qe)) return qe;
      ...
      ot.f = Ne ? ne : function(Fe, je) {
        if (Fe = V(Fe), je = W(je), Y) try {
          return ne(Fe, je);
        } catch {
        }
        if (Z(Fe, je)) return ee(!Se(Oe.f, Fe, je), Fe[je]);
      };
    }), ci = Ae((ot, Ne) => {
      var Se = br(), Oe = hr();
      Ne.exports = Se && Oe(function() {
      ...
      ot.f = Ne ? Oe ? function(he, qe, et) {
        ...
        if (ee(he), qe = V(qe), ee(et), Se) try {
          return Z(he, qe, et);
        } catch {
        }
        if ("get" in et || "set" in et) throw W("Accessors not supported");
      ...
      var Se = di(), Oe = Yt(), ee = Or(), V = Kn(), W = kr(), Z = gn(), Y = fi(), ne = Zn(), Fe = "Object already initialized", je = Oe.TypeError, he = Oe.WeakMap, qe, et, Ze, nt = function(At) {
        ...
        return function(Lt) {
          var qt;
          if (!ee(Lt) || (qt = et(Lt)).type !== At) throw je("Incompatible receiver, " + At + " required");
          return qt;
        };
      };
      Se || Z.state ? ($ = Z.state || (Z.state = new he()), $.get = $.get, $.has = $.has, $.set = $.set, qe = function(At, Lt) {
        if ($.has(At)) throw je(Fe);
      ...
      Ne.exports = function(W, Z, Y, ne) {
        ...
        if (Se(Y) && ee(Y, je, ne), ne.global) Fe ? W[Z] = Y : V(Z, Y);
        else {
          try {
      ...
      var Se = dn(), Oe = yi(), ee = tn(), V = function(W) {
        return function(Z, Y, ne) {
          ...
          if (W && Y != Y) {
            for (; je > he; ) if (qe = Fe[he++], qe != qe) return !0;
          } else for (; je > he; he++) if ((W || he in Fe) && Fe[he] === Y) return W || he || 0;
          return !W && -1;
        };
      };
      ...
      Ne.exports = function(Y, ne) {
        ...
        for (qe in Fe) !Oe(W, qe) && Oe(Fe, qe) && Z(he, qe);
        for (; ne.length > je; ) Oe(Fe, qe = ne[je++]) && (~V(he, qe) || Z(he, qe));
        return he;
      };
    }), Ai = Ae((ot, Ne) => {
      ...
      Ne.exports = function(ee) {
        if (ee > Oe) throw Se("Maximum allowed index exceeded");
        return ee;
      };
    }), Fu = Ae((ot, Ne) => {
      var Se = Br(), Oe = Dr();
      Ne.exports = function(ee) {
        if (Se(ee) === "Function") return Oe(ee);
      };
    }), Au = Ae((ot, Ne) => {
      ...
      var Se = Eu(), Oe = tn(), ee = Cu(), V = Au(), W = function(Z, Y, ne, Fe, je, he, qe, et) {
        for (var Ze = je, nt = 0, rt = qe ? V(qe, et) : !1, $, Ft; nt < Fe; ) nt in ne && ($ = rt ? rt(ne[nt], nt, Y) : ne[nt], he > 0 && Se($) ? (Ft = Oe($), Ze = W(Z, Y, $, Ft, Ze, he - 1) - 1) : (ee(Ze + 1), Z[Ze] = $), Ze++), nt++;
        return Ze;
      };
      Ne.exports = W;
    }), wi = Ae((ot, Ne) => {
      ...
      Ne.exports = function(Ze, nt, rt) {
        ...
        if (At) ue = Ze.iterator;
        else if (Lt) ue = Ze;
        else {
          if (yr = Fe(Ze), !yr) throw he(V(Ze) + " is not iterable");
          if (W(yr)) {
            for (Pr = 0, zr = Z(Ze); zr > Pr; Pr++) if (fr = wr(Ze[Pr]), fr && Y(et, fr)) return fr;
            return new qe(!1);
          }
          ue = ne(Ze, yr);
        }
        for (Rr = At ? Ze.next : ue.next; !(mr = Oe(Rr, ue)).done; ) {
          ...
          if (typeof fr == "object" && fr && Y(et, fr)) return fr;
        }
        return new qe(!1);
      };
    }), Li = Ae((ot, Ne) => {
      ...
      function Oe(L, re) {
        ...
        if (Object.getOwnPropertySymbols) {
          ...
          for (Pe = 0; Pe < ie.length; Pe++) Ee = ie[Pe], !(re.indexOf(Ee) >= 0) && Object.prototype.propertyIsEnumerable.call(L, Ee) && (ge[Ee] = L[Ee]);
        }
        return ge;
      }
      function ee(L, re) {
        ...
        for (ie = 0; ie < Ee.length; ie++) Pe = Ee[ie], !(re.indexOf(Pe) >= 0) && (ge[Pe] = L[Pe]);
        return ge;
      }
      Bi(), _i(), Oi();
      var V = Object.create, W = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, Y = Object.getOwnPropertyNames, ne = Object.getPrototypeOf, Fe = Object.prototype.hasOwnProperty, je = (L, re) => function() {
        ...
        for (var ge in re) W(L, ge, { get: re[ge], enumerable: !0 });
      }, et = (L, re, ge, Ee) => {
        if (re && typeof re == "object" || typeof re == "function") for (let Pe of Y(re)) !Fe.call(L, Pe) && Pe !== ge && W(L, Pe, { get: () => re[Pe], enumerable: !(Ee = Z(re, Pe)) || Ee.enumerable });
        return L;
      }, Ze = (L, re, ge) => (ge = L != null ? V(ne(L)) : {}, et(!L || !L.__esModule ? W(ge, "default", { value: L, enumerable: !0 }) : ge, L)), nt = (L) => et(W({}, "__esModule", { value: !0 }), L), rt, $ = je({ "<define:process>"() {
        rt = { env: {}, argv: [] };
        ...
        function ge(le) {
          return le.replace(re, function() {
            for (var We = arguments.length, Me = new Array(We), at = 0; at < We; at++) Me[at] = arguments[at];
        ...
        L.ValueTransformer = gt, L.SyncAsync = { assertSync: (le) => {
          if (st(le)) throw new Error("Illegal state: value cannot be a promise");
          return le;
        ...
        function $t(le) {
          ...
          if (le instanceof Array) return "[" + le.map($t).join(", ") + "]";
          if (le == null) return "" + le;
          if (le.overriddenName) return `${le.overriddenName}`;
          if (le.name) return `${le.name}`;
          if (!le.toString) return "object";
          let We = le.toString();
...
`);
        ...
        var ie = 0;
        function de(Me) {
          if (!Me || !Me.reference) return null;
          let at = Me.reference;
          if (at instanceof re.StaticSymbol) return at.name;
          if (at.__anonymousType) return at.__anonymousType;
        ...
        var yt = class {
          constructor(Me) {
            ...
            if (this.encapsulation = at, this.template = Jt, this.templateUrl = er, this.htmlAst = Ar, this.styles = st(Er), this.styleUrls = st(_r), this.externalStylesheets = st(xr), this.animations = Ir ? Vt(Ir) : [], this.ngContentSelectors = Mr || [], or && or.length != 2) throw new Error("'interpolation' should have a start and an end symbol.");
        ...
        var re = Ft(), ge = qt(), Ee = class {
          ...
          moveBy(ce) {
            ...
            for (; He > 0 && ce < 0; ) if (He--, ce++, ve.charCodeAt(He) == re.$LF) {
              Je--;
...
` && ++yt == ve)); ) ;
      ...
      var Rr = je({ "node_modules/escape-string-regexp/index.js"() {
        ...
        var ge = typeof rt == "object" && rt.env && rt.env.NODE_DEBUG && /\bsemver\b/i.test(rt.env.NODE_DEBUG) ? function() {
          for (var Ee = arguments.length, Pe = new Array(Ee), ie = 0; ie < Ee; ie++) Pe[ie] = arguments[ie];
        ...
        var ge = mr(), { MAX_LENGTH: Ee, MAX_SAFE_INTEGER: Pe } = rn(), { re: ie, t: de } = wr(), Ue = Fr(), { compareIdentifiers: Ge } = Tn(), gt = class {
          constructor(ce, ve) {
            if (ve = Ue(ve), ce instanceof gt) {
              if (ce.loose === !!ve.loose && ce.includePrerelease === !!ve.includePrerelease) return ce;
              ce = ce.version;
            } else if (typeof ce != "string") throw new TypeError(`Invalid Version: ${ce}`);
            if (ce.length > Ee) throw new TypeError(`version is longer than ${Ee} characters`);
            ...
            if (!Ve) throw new TypeError(`Invalid Version: ${ce}`);
            if (this.raw = ce, this.major = +Ve[1], this.minor = +Ve[2], this.patch = +Ve[3], this.major > Pe || this.major < 0) throw new TypeError("Invalid major version");
          ...
          comparePre(ce) {
            if (ce instanceof gt || (ce = new gt(ce, this.options)), this.prerelease.length && !ce.prerelease.length) return -1;
            if (!this.prerelease.length && ce.prerelease.length) return 1;
            if (!this.prerelease.length && !ce.prerelease.length) return 0;
            let ve = 0;
            do {
              let Ve = this.prerelease[ve], He = ce.prerelease[ve];
              if (ge("prerelease compare", ve, Ve, He), Ve === void 0 && He === void 0) return 0;
              if (He === void 0) return 1;
              if (Ve === void 0) return -1;
              if (Ve !== He) return Ge(Ve, He);
            } while (++ve);
          }
          compareBuild(ce) {
            ...
            switch (ce) {
              ...
              case "pre":
                if (this.prerelease.length === 0) this.prerelease = [0];
                  ...
                  for (; --Ve >= 0; ) typeof this.prerelease[Ve] == "number" && (this.prerelease[Ve]++, Ve = -2);
        ...
        function ge() {
          for (var ct = [], kt = 0; kt < arguments.length; kt++) ct[kt] = arguments[kt];
        }
        function Ee() {
        ...
        function Ue(ct, kt) {
          for (var $t in kt) de(kt, $t) && (ct[$t] = kt[$t]);
          return ct;
        }
        var Ge = /^[ \t]*(?:\r\n|\r|\n)/, gt = /(?:\r\n|\r|\n)[ \t]*$/, ce = /^(?:[\r\n]|$)/, ve = /(?:\r\n|\r|\n)([ \t]*)(?:[^ \t\r\n]|$)/, Ve = /^[ \t]*[\r\n][ \t\r\n]*$/;
        function He(ct, kt, $t) {
        ...
        function Je(ct, kt) {
          for (var $t = "", ir = 0, st = ct.length; ir < st; ir++) $t += ct[ir], ir < st - 1 && ($t += kt[ir]);
          return $t;
        }
        function Qe(ct) {
        ...
        function yt(ct) {
          var kt = Ee(), $t = Ee();
          function ir(Ot) {
            for (var Vt = [], Ut = 1; Ut < arguments.length; Ut++) Vt[Ut - 1] = arguments[Ut];
            if (Qe(Ot)) {
              var rr = Ot, z = (Vt[0] === ir || Vt[0] === _t) && Ve.test(rr[0]) && ce.test(rr[1]), le = z ? $t : kt, We = le.get(rr);
              if (We || (We = He(rr, z, ct), le.set(rr, We)), Vt.length === 0) return We[0];
              var Me = Je(We, z ? Vt.slice(1) : Vt);
              return Me;
            } else return yt(Ue(Ue({}, ct), Ot || {}));
          }
        ...
        if (L.outdent = _t, L.default = _t, typeof re < "u") try {
    ...
    `, cliCategory: de }, tabWidth: { type: "int", category: Ge, default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 } }, useTabs: { since: "1.0.0", category: Ge, type: "boolean", default: !1, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { since: "2.1.0", category: Ge, type: "choice", default: [{ since: "2.1.0", value: "auto" }], description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
        ...
        function Ue(Ge, gt, ce) {
          ...
          for (let Ve of gt) if (Ve.parsers) {
            for (let He of Ve.parsers) if (!ve.has(He)) {
              ve.add(He);
      ...
      function _u(L) {
        if (typeof L != "string") throw new TypeError(`Expected a \`string\`, got \`${typeof L}\``);
        return L.replace(Vi(), "");
      }
      ...
      qe(Iu, { default: () => Ji });
      function Ji(L) {
        if (typeof L != "string" || L.length === 0 || (L = _u(L), L.length === 0)) return 0;
      ...
      var ju, Xi = je({ "node_modules/string-width/index.js"() {
          ...
          return (Ge, gt, ce) => {
            ...
            for (; He >= 0 && He < Ve; ) {
              ...
              if (Ue instanceof RegExp) {
                if (!Ue.test(Je)) return He;
              } else if (!Ue.includes(Je)) return He;
              ve ? He-- : He++;
            }
        ...
        function ge(Ee, Pe) {
          ...
          if (Ee.charAt(Pe) === "/" && Ee.charAt(Pe + 1) === "*") {
            for (let ie = Pe + 2; ie < Ee.length; ++ie) if (Ee.charAt(ie) === "*" && Ee.charAt(ie + 1) === "/") return ie + 2;
          }
          return Pe;
        }
        re.exports = ge;
...
` || Ue === "\r" || Ue === "\u2028" || Ue === "\u2029") return Pe + 1;
        ...
        function de(Ue, Ge) {
          let gt = null, ce = Ge;
          for (; ce !== gt; ) gt = ce, ce = ie(Ue, ce), ce = ge(Ue, ce), ce = Pe(Ue, ce), ce = Ee(Ue, ce);
          return ce;
        }
        re.exports = de;
          ...
          return (mt, St, xt) => {
            ...
            for (; lr >= 0 && lr < sr; ) {
              ...
              if (lt instanceof RegExp) {
                if (!lt.test(Qt)) return lr;
              } else if (!lt.includes(Qt)) return lr;
              Kt ? lr-- : lr++;
            }
        ...
        function ct(lt, mt, St) {
          for (let xt = mt; xt < St; ++xt) if (lt.charAt(xt) === `
`) return !0;
          return !1;
        }
        ...
        function $t(lt, mt) {
          let St = null, xt = mt;
          for (; xt !== St; ) St = xt, xt = gt(lt, xt), xt = ve(lt, xt), xt = Ge(lt, xt);
        ...
        function Ut(lt, mt) {
          ...
          for (let Kt = St; Kt < lt.length; ++Kt) lt[Kt] === "	" ? xt = xt + mt - xt % mt : xt++;
          return xt;
        }
        function rr(lt, mt) {
...
`);
        ...
        function Jt(lt, mt) {
          ...
          for (let sr = 1; sr < Kt; sr++) if (!xt.get(sr)) return sr;
          return Kt + 1;
        }
        function er(lt, mt) {
        ...
        function ge(Ee, Pe) {
          ...
          for (let [de, Ue] of Object.entries(Ee)) ie[de] = Pe(Ue, de);
          return ie;
        }
        re.exports = ge;
...
` + Pe.replace(/^\s*\n/, "");
        ...
        var ge = { attrs: !0, children: !0 }, Ee = /* @__PURE__ */ new Set(["parent"]), Pe = class {
          constructor() {
            ...
            for (let Ue of /* @__PURE__ */ new Set([...Ee, ...Object.keys(de)])) this.setProperty(Ue, de[Ue]);
          }
          setProperty(de, Ue) {
            if (this[de] !== Ue) {
          ...
          map(de) {
            ...
            if (Ue) for (let Ge in this) Ge in ge || (Ue[Ge] = this[Ge]);
            return de(Ue || this);
          }
          walk(de) {
            for (let Ue in ge) {
              let Ge = this[Ue];
              if (Ge) for (let gt = 0; gt < Ge.length; gt++) Ge[gt].walk(de);
            }
            de(this);
          }
          createChild(de) {
        ...
        function Pe(Ge, gt) {
          if (Ge.value) for (let { regex: ce, parse: ve } of Ee) {
            let Ve = Ge.value.match(ce);
            if (Ve) return ve(Ge, gt, Ve);
          }
          return null;
        }
        ...
        function re(Ue) {
          if (Ue[0] != ":") return [null, Ue];
          let Ge = Ue.indexOf(":", 1);
          if (Ge == -1) throw new Error(`Unsupported format "${Ue}" expecting ":namespace:name"`);
...
`, nexist: "∄", nexists: "∄", Nfr: "𝔑", nfr: "𝔫", ngE: "≧̸", nge: "≱", ngeq: "≱", ngeqq: "≧̸", ngeqslant: "⩾̸", nges: "⩾̸", nGg: "⋙̸", ngsim: "≵", nGt: "≫⃒", ngt: "≯", ngtr: "≯", nGtv: "≫̸", nhArr: "⇎", nharr: "↮", nhpar: "⫲", ni: "∋", nis: "⋼", nisd: "⋺", niv: "∋", NJcy: "Њ", njcy: "њ", nlArr: "⇍", nlarr: "↚", nldr: "‥", nlE: "≦̸", nle: "≰", nLeftarrow: "⇍", nleftarrow: "↚", nLeftrightarrow: "⇎", nleftrightarrow: "↮", nleq: "≰", nleqq: "≦̸", nleqslant: "⩽̸", nles: "⩽̸", nless: "≮", nLl: "⋘̸", nlsim: "≴", nLt: "≪⃒", nlt: "≮", nltri: "⋪", nltrie: "⋬", nLtv: "≪̸", nmid: "∤", NoBreak: "⁠", NonBreakingSpace: " ", Nopf: "ℕ", nopf: "𝕟", Not: "⫬", not: "¬", NotCongruent: "≢", NotCupCap: "≭", NotDoubleVerticalBar: "∦", NotElement: "∉", NotEqual: "≠", NotEqualTilde: "≂̸", NotExists: "∄", NotGreater: "≯", NotGreaterEqual: "≱", NotGreaterFullEqual: "≧̸", NotGreaterGreater: "≫̸", NotGreaterLess: "≹", NotGreaterSlantEqual: "⩾̸", NotGreaterTilde: "≵", NotHumpDownHump: "≎̸", NotHumpEqual: "≏̸", notin: "∉", notindot: "⋵̸", notinE: "⋹̸", notinva: "∉", notinvb: "⋷", notinvc: "⋶", NotLeftTriangle: "⋪", NotLeftTriangleBar: "⧏̸", NotLeftTriangleEqual: "⋬", NotLess: "≮", NotLessEqual: "≰", NotLessGreater: "≸", NotLessLess: "≪̸", NotLessSlantEqual: "⩽̸", NotLessTilde: "≴", NotNestedGreaterGreater: "⪢̸", NotNestedLessLess: "⪡̸", notni: "∌", notniva: "∌", notnivb: "⋾", notnivc: "⋽", NotPrecedes: "⊀", NotPrecedesEqual: "⪯̸", NotPrecedesSlantEqual: "⋠", NotReverseElement: "∌", NotRightTriangle: "⋫", NotRightTriangleBar: "⧐̸", NotRightTriangleEqual: "⋭", NotSquareSubset: "⊏̸", NotSquareSubsetEqual: "⋢", NotSquareSuperset: "⊐̸", NotSquareSupersetEqual: "⋣", NotSubset: "⊂⃒", NotSubsetEqual: "⊈", NotSucceeds: "⊁", NotSucceedsEqual: "⪰̸", NotSucceedsSlantEqual: "⋡", NotSucceedsTilde: "≿̸", NotSuperset: "⊃⃒", NotSupersetEqual: "⊉", NotTilde: "≁", NotTildeEqual: "≄", NotTildeFullEqual: "≇", NotTildeTilde: "≉", NotVerticalBar: "∤", npar: "∦", nparallel: "∦", nparsl: "⫽⃥", npart: "∂̸", npolint: "⨔", npr: "⊀", nprcue: "⋠", npre: "⪯̸", nprec: "⊀", npreceq: "⪯̸", nrArr: "⇏", nrarr: "↛", nrarrc: "⤳̸", nrarrw: "↝̸", nRightarrow: "⇏", nrightarrow: "↛", nrtri: "⋫", nrtrie: "⋭", nsc: "⊁", nsccue: "⋡", nsce: "⪰̸", Nscr: "𝒩", nscr: "𝓃", nshortmid: "∤", nshortparallel: "∦", nsim: "≁", nsime: "≄", nsimeq: "≄", nsmid: "∤", nspar: "∦", nsqsube: "⋢", nsqsupe: "⋣", nsub: "⊄", nsubE: "⫅̸", nsube: "⊈", nsubset: "⊂⃒", nsubseteq: "⊈", nsubseteqq: "⫅̸", nsucc: "⊁", nsucceq: "⪰̸", nsup: "⊅", nsupE: "⫆̸", nsupe: "⊉", nsupset: "⊃⃒", nsupseteq: "⊉", nsupseteqq: "⫆̸", ntgl: "≹", Ntilde: "Ñ", ntilde: "ñ", ntlg: "≸", ntriangleleft: "⋪", ntrianglelefteq: "⋬", ntriangleright: "⋫", ntrianglerighteq: "⋭", Nu: "Ν", nu: "ν", num: "#", numero: "№", numsp: " ", nvap: "≍⃒", nVDash: "⊯", nVdash: "⊮", nvDash: "⊭", nvdash: "⊬", nvge: "≥⃒", nvgt: ">⃒", nvHarr: "⤄", nvinfin: "⧞", nvlArr: "⤂", nvle: "≤⃒", nvlt: "<⃒", nvltrie: "⊴⃒", nvrArr: "⤃", nvrtrie: "⊵⃒", nvsim: "∼⃒", nwarhk: "⤣", nwArr: "⇖", nwarr: "↖", nwarrow: "↖", nwnear: "⤧", Oacute: "Ó", oacute: "ó", oast: "⊛", ocir: "⊚", Ocirc: "Ô", ocirc: "ô", Ocy: "О", ocy: "о", odash: "⊝", Odblac: "Ő", odblac: "ő", odiv: "⨸", odot: "⊙", odsold: "⦼", OElig: "Œ", oelig: "œ", ofcir: "⦿", Ofr: "𝔒", ofr: "𝔬", ogon: "˛", Ograve: "Ò", ograve: "ò", ogt: "⧁", ohbar: "⦵", ohm: "Ω", oint: "∮", olarr: "↺", olcir: "⦾", olcross: "⦻", oline: "‾", olt: "⧀", Omacr: "Ō", omacr: "ō", Omega: "Ω", omega: "ω", Omicron: "Ο", omicron: "ο", omid: "⦶", ominus: "⊖", Oopf: "𝕆", oopf: "𝕠", opar: "⦷", OpenCurlyDoubleQuote: "“", OpenCurlyQuote: "‘", operp: "⦹", oplus: "⊕", Or: "⩔", or: "∨", orarr: "↻", ord: "⩝", order: "ℴ", orderof: "ℴ", ordf: "ª", ordm: "º", origof: "⊶", oror: "⩖", orslope: "⩗", orv: "⩛", oS: "Ⓢ", Oscr: "𝒪", oscr: "ℴ", Oslash: "Ø", oslash: "ø", osol: "⊘", Otilde: "Õ", otilde: "õ", Otimes: "⨷", otimes: "⊗", otimesas: "⨶", Ouml: "Ö", ouml: "ö", ovbar: "⌽", OverBar: "‾", OverBrace: "⏞", OverBracket: "⎴", OverParenthesis: "⏜", par: "∥", para: "¶", parallel: "∥", parsim: "⫳", parsl: "⫽", part: "∂", PartialD: "∂", Pcy: "П", pcy: "п", percnt: "%", period: ".", permil: "‰", perp: "⊥", pertenk: "‱", Pfr: "𝔓", pfr: "𝔭", Phi: "Φ", phi: "φ", phiv: "ϕ", phmmat: "ℳ", phone: "☎", Pi: "Π", pi: "π", pitchfork: "⋔", piv: "ϖ", planck: "ℏ", planckh: "ℎ", plankv: "ℏ", plus: "+", plusacir: "⨣", plusb: "⊞", pluscir: "⨢", plusdo: "∔", plusdu: "⨥", pluse: "⩲", PlusMinus: "±", plusmn: "±", plussim: "⨦", plustwo: "⨧", pm: "±", Poincareplane: "ℌ", pointint: "⨕", Popf: "ℙ", popf: "𝕡", pound: "£", Pr: "⪻", pr: "≺", prap: "⪷", prcue: "≼", prE: "⪳", pre: "⪯", prec: "≺", precapprox: "⪷", preccurlyeq: "≼", Precedes: "≺", PrecedesEqual: "⪯", PrecedesSlantEqual: "≼", PrecedesTilde: "≾", preceq: "⪯", precnapprox: "⪹", precneqq: "⪵", precnsim: "⋨", precsim: "≾", Prime: "″", prime: "′", primes: "ℙ", prnap: "⪹", prnE: "⪵", prnsim: "⋨", prod: "∏", Product: "∏", profalar: "⌮", profline: "⌒", profsurf: "⌓", prop: "∝", Proportion: "∷", Proportional: "∝", propto: "∝", prsim: "≾", prurel: "⊰", Pscr: "𝒫", pscr: "𝓅", Psi: "Ψ", psi: "ψ", puncsp: " ", Qfr: "𝔔", qfr: "𝔮", qint: "⨌", Qopf: "ℚ", qopf: "𝕢", qprime: "⁗", Qscr: "𝒬", qscr: "𝓆", quaternions: "ℍ", quatint: "⨖", quest: "?", questeq: "≟", QUOT: '"', quot: '"', rAarr: "⇛", race: "∽̱", Racute: "Ŕ", racute: "ŕ", radic: "√", raemptyv: "⦳", Rang: "⟫", rang: "⟩", rangd: "⦒", range: "⦥", rangle: "⟩", raquo: "»", Rarr: "↠", rArr: "⇒", rarr: "→", rarrap: "⥵", rarrb: "⇥", rarrbfs: "⤠", rarrc: "⤳", rarrfs: "⤞", rarrhk: "↪", rarrlp: "↬", rarrpl: "⥅", rarrsim: "⥴", Rarrtl: "⤖", rarrtl: "↣", rarrw: "↝", rAtail: "⤜", ratail: "⤚", ratio: "∶", rationals: "ℚ", RBarr: "⤐", rBarr: "⤏", rbarr: "⤍", rbbrk: "❳", rbrace: "}", rbrack: "]", rbrke: "⦌", rbrksld: "⦎", rbrkslu: "⦐", Rcaron: "Ř", rcaron: "ř", Rcedil: "Ŗ", rcedil: "ŗ", rceil: "⌉", rcub: "}", Rcy: "Р", rcy: "р", rdca: "⤷", rdldhar: "⥩", rdquo: "”", rdquor: "”", rdsh: "↳", Re: "ℜ", real: "ℜ", realine: "ℛ", realpart: "ℜ", reals: "ℝ", rect: "▭", REG: "®", reg: "®", ReverseElement: "∋", ReverseEquilibrium: "⇋", ReverseUpEquilibrium: "⥯", rfisht: "⥽", rfloor: "⌋", Rfr: "ℜ", rfr: "𝔯", rHar: "⥤", rhard: "⇁", rharu: "⇀", rharul: "⥬", Rho: "Ρ", rho: "ρ", rhov: "ϱ", RightAngleBracket: "⟩", RightArrow: "→", Rightarrow: "⇒", rightarrow: "→", RightArrowBar: "⇥", RightArrowLeftArrow: "⇄", rightarrowtail: "↣", RightCeiling: "⌉", RightDoubleBracket: "⟧", RightDownTeeVector: "⥝", RightDownVector: "⇂", RightDownVectorBar: "⥕", RightFloor: "⌋", rightharpoondown: "⇁", rightharpoonup: "⇀", rightleftarrows: "⇄", rightleftharpoons: "⇌", rightrightarrows: "⇉", rightsquigarrow: "↝", RightTee: "⊢", RightTeeArrow: "↦", RightTeeVector: "⥛", rightthreetimes: "⋌", RightTriangle: "⊳", RightTriangleBar: "⧐", RightTriangleEqual: "⊵", RightUpDownVector: "⥏", RightUpTeeVector: "⥜", RightUpVector: "↾", RightUpVectorBar: "⥔", RightVector: "⇀", RightVectorBar: "⥓", ring: "˚", risingdotseq: "≓", rlarr: "⇄", rlhar: "⇌", rlm: "‏", rmoust: "⎱", rmoustache: "⎱", rnmid: "⫮", roang: "⟭", roarr: "⇾", robrk: "⟧", ropar: "⦆", Ropf: "ℝ", ropf: "𝕣", roplus: "⨮", rotimes: "⨵", RoundImplies: "⥰", rpar: ")", rpargt: "⦔", rppolint: "⨒", rrarr: "⇉", Rrightarrow: "⇛", rsaquo: "›", Rscr: "ℛ", rscr: "𝓇", Rsh: "↱", rsh: "↱", rsqb: "]", rsquo: "’", rsquor: "’", rthree: "⋌", rtimes: "⋊", rtri: "▹", rtrie: "⊵", rtrif: "▸", rtriltri: "⧎", RuleDelayed: "⧴", ruluhar: "⥨", rx: "℞", Sacute: "Ś", sacute: "ś", sbquo: "‚", Sc: "⪼", sc: "≻", scap: "⪸", Scaron: "Š", scaron: "š", sccue: "≽", scE: "⪴", sce: "⪰", Scedil: "Ş", scedil: "ş", Scirc: "Ŝ", scirc: "ŝ", scnap: "⪺", scnE: "⪶", scnsim: "⋩", scpolint: "⨓", scsim: "≿", Scy: "С", scy: "с", sdot: "⋅", sdotb: "⊡", sdote: "⩦", searhk: "⤥", seArr: "⇘", searr: "↘", searrow: "↘", sect: "§", semi: ";", seswar: "⤩", setminus: "∖", setmn: "∖", sext: "✶", Sfr: "𝔖", sfr: "𝔰", sfrown: "⌢", sharp: "♯", SHCHcy: "Щ", shchcy: "щ", SHcy: "Ш", shcy: "ш", ShortDownArrow: "↓", ShortLeftArrow: "←", shortmid: "∣", shortparallel: "∥", ShortRightArrow: "→", ShortUpArrow: "↑", shy: "­", Sigma: "Σ", sigma: "σ", sigmaf: "ς", sigmav: "ς", sim: "∼", simdot: "⩪", sime: "≃", simeq: "≃", simg: "⪞", simgE: "⪠", siml: "⪝", simlE: "⪟", simne: "≆", simplus: "⨤", simrarr: "⥲", slarr: "←", SmallCircle: "∘", smallsetminus: "∖", smashp: "⨳", smeparsl: "⧤", smid: "∣", smile: "⌣", smt: "⪪", smte: "⪬", smtes: "⪬︀", SOFTcy: "Ь", softcy: "ь", sol: "/", solb: "⧄", solbar: "⌿", Sopf: "𝕊", sopf: "𝕤", spades: "♠", spadesuit: "♠", spar: "∥", sqcap: "⊓", sqcaps: "⊓︀", sqcup: "⊔", sqcups: "⊔︀", Sqrt: "√", sqsub: "⊏", sqsube: "⊑", sqsubset: "⊏", sqsubseteq: "⊑", sqsup: "⊐", sqsupe: "⊒", sqsupset: "⊐", sqsupseteq: "⊒", squ: "□", Square: "□", square: "□", SquareIntersection: "⊓", SquareSubset: "⊏", SquareSubsetEqual: "⊑", SquareSuperset: "⊐", SquareSupersetEqual: "⊒", SquareUnion: "⊔", squarf: "▪", squf: "▪", srarr: "→", Sscr: "𝒮", sscr: "𝓈", ssetmn: "∖", ssmile: "⌣", sstarf: "⋆", Star: "⋆", star: "☆", starf: "★", straightepsilon: "ϵ", straightphi: "ϕ", strns: "¯", Sub: "⋐", sub: "⊂", subdot: "⪽", subE: "⫅", sube: "⊆", subedot: "⫃", submult: "⫁", subnE: "⫋", subne: "⊊", subplus: "⪿", subrarr: "⥹", Subset: "⋐", subset: "⊂", subseteq: "⊆", subseteqq: "⫅", SubsetEqual: "⊆", subsetneq: "⊊", subsetneqq: "⫋", subsim: "⫇", subsub: "⫕", subsup: "⫓", succ: "≻", succapprox: "⪸", succcurlyeq: "≽", Succeeds: "≻", SucceedsEqual: "⪰", SucceedsSlantEqual: "≽", SucceedsTilde: "≿", succeq: "⪰", succnapprox: "⪺", succneqq: "⪶", succnsim: "⋩", succsim: "≿", SuchThat: "∋", Sum: "∑", sum: "∑", sung: "♪", Sup: "⋑", sup: "⊃", sup1: "¹", sup2: "²", sup3: "³", supdot: "⪾", supdsub: "⫘", supE: "⫆", supe: "⊇", supedot: "⫄", Superset: "⊃", SupersetEqual: "⊇", suphsol: "⟉", suphsub: "⫗", suplarr: "⥻", supmult: "⫂", supnE: "⫌", supne: "⊋", supplus: "⫀", Supset: "⋑", supset: "⊃", supseteq: "⊇", supseteqq: "⫆", supsetneq: "⊋", supsetneqq: "⫌", supsim: "⫈", supsub: "⫔", supsup: "⫖", swarhk: "⤦", swArr: "⇙", swarr: "↙", swarrow: "↙", swnwar: "⤪", szlig: "ß", Tab: "	", target: "⌖", Tau: "Τ", tau: "τ", tbrk: "⎴", Tcaron: "Ť", tcaron: "ť", Tcedil: "Ţ", tcedil: "ţ", Tcy: "Т", tcy: "т", tdot: "⃛", telrec: "⌕", Tfr: "𝔗", tfr: "𝔱", there4: "∴", Therefore: "∴", therefore: "∴", Theta: "Θ", theta: "θ", thetasym: "ϑ", thetav: "ϑ", thickapprox: "≈", thicksim: "∼", ThickSpace: "  ", thinsp: " ", ThinSpace: " ", thkap: "≈", thksim: "∼", THORN: "Þ", thorn: "þ", Tilde: "∼", tilde: "˜", TildeEqual: "≃", TildeFullEqual: "≅", TildeTilde: "≈", times: "×", timesb: "⊠", timesbar: "⨱", timesd: "⨰", tint: "∭", toea: "⤨", top: "⊤", topbot: "⌶", topcir: "⫱", Topf: "𝕋", topf: "𝕥", topfork: "⫚", tosa: "⤩", tprime: "‴", TRADE: "™", trade: "™", triangle: "▵", triangledown: "▿", triangleleft: "◃", trianglelefteq: "⊴", triangleq: "≜", triangleright: "▹", trianglerighteq: "⊵", tridot: "◬", trie: "≜", triminus: "⨺", TripleDot: "⃛", triplus: "⨹", trisb: "⧍", tritime: "⨻", trpezium: "⏢", Tscr: "𝒯", tscr: "𝓉", TScy: "Ц", tscy: "ц", TSHcy: "Ћ", tshcy: "ћ", Tstrok: "Ŧ", tstrok: "ŧ", twixt: "≬", twoheadleftarrow: "↞", twoheadrightarrow: "↠", Uacute: "Ú", uacute: "ú", Uarr: "↟", uArr: "⇑", uarr: "↑", Uarrocir: "⥉", Ubrcy: "Ў", ubrcy: "ў", Ubreve: "Ŭ", ubreve: "ŭ", Ucirc: "Û", ucirc: "û", Ucy: "У", ucy: "у", udarr: "⇅", Udblac: "Ű", udblac: "ű", udhar: "⥮", ufisht: "⥾", Ufr: "𝔘", ufr: "𝔲", Ugrave: "Ù", ugrave: "ù", uHar: "⥣", uharl: "↿", uharr: "↾", uhblk: "▀", ulcorn: "⌜", ulcorner: "⌜", ulcrop: "⌏", ultri: "◸", Umacr: "Ū", umacr: "ū", uml: "¨", UnderBar: "_", UnderBrace: "⏟", UnderBracket: "⎵", UnderParenthesis: "⏝", Union: "⋃", UnionPlus: "⊎", Uogon: "Ų", uogon: "ų", Uopf: "𝕌", uopf: "𝕦", UpArrow: "↑", Uparrow: "⇑", uparrow: "↑", UpArrowBar: "⤒", UpArrowDownArrow: "⇅", UpDownArrow: "↕", Updownarrow: "⇕", updownarrow: "↕", UpEquilibrium: "⥮", upharpoonleft: "↿", upharpoonright: "↾", uplus: "⊎", UpperLeftArrow: "↖", UpperRightArrow: "↗", Upsi: "ϒ", upsi: "υ", upsih: "ϒ", Upsilon: "Υ", upsilon: "υ", UpTee: "⊥", UpTeeArrow: "↥", upuparrows: "⇈", urcorn: "⌝", urcorner: "⌝", urcrop: "⌎", Uring: "Ů", uring: "ů", urtri: "◹", Uscr: "𝒰", uscr: "𝓊", utdot: "⋰", Utilde: "Ũ", utilde: "ũ", utri: "▵", utrif: "▴", uuarr: "⇈", Uuml: "Ü", uuml: "ü", uwangle: "⦧", vangrt: "⦜", varepsilon: "ϵ", varkappa: "ϰ", varnothing: "∅", varphi: "ϕ", varpi: "ϖ", varpropto: "∝", vArr: "⇕", varr: "↕", varrho: "ϱ", varsigma: "ς", varsubsetneq: "⊊︀", varsubsetneqq: "⫋︀", varsupsetneq: "⊋︀", varsupsetneqq: "⫌︀", vartheta: "ϑ", vartriangleleft: "⊲", vartriangleright: "⊳", Vbar: "⫫", vBar: "⫨", vBarv: "⫩", Vcy: "В", vcy: "в", VDash: "⊫", Vdash: "⊩", vDash: "⊨", vdash: "⊢", Vdashl: "⫦", Vee: "⋁", vee: "∨", veebar: "⊻", veeeq: "≚", vellip: "⋮", Verbar: "‖", verbar: "|", Vert: "‖", vert: "|", VerticalBar: "∣", VerticalLine: "|", VerticalSeparator: "❘", VerticalTilde: "≀", VeryThinSpace: " ", Vfr: "𝔙", vfr: "𝔳", vltri: "⊲", vnsub: "⊂⃒", vnsup: "⊃⃒", Vopf: "𝕍", vopf: "𝕧", vprop: "∝", vrtri: "⊳", Vscr: "𝒱", vscr: "𝓋", vsubnE: "⫋︀", vsubne: "⊊︀", vsupnE: "⫌︀", vsupne: "⊋︀", Vvdash: "⊪", vzigzag: "⦚", Wcirc: "Ŵ", wcirc: "ŵ", wedbar: "⩟", Wedge: "⋀", wedge: "∧", wedgeq: "≙", weierp: "℘", Wfr: "𝔚", wfr: "𝔴", Wopf: "𝕎", wopf: "𝕨", wp: "℘", wr: "≀", wreath: "≀", Wscr: "𝒲", wscr: "𝓌", xcap: "⋂", xcirc: "◯", xcup: "⋃", xdtri: "▽", Xfr: "𝔛", xfr: "𝔵", xhArr: "⟺", xharr: "⟷", Xi: "Ξ", xi: "ξ", xlArr: "⟸", xlarr: "⟵", xmap: "⟼", xnis: "⋻", xodot: "⨀", Xopf: "𝕏", xopf: "𝕩", xoplus: "⨁", xotime: "⨂", xrArr: "⟹", xrarr: "⟶", Xscr: "𝒳", xscr: "𝓍", xsqcup: "⨆", xuplus: "⨄", xutri: "△", xvee: "⋁", xwedge: "⋀", Yacute: "Ý", yacute: "ý", YAcy: "Я", yacy: "я", Ycirc: "Ŷ", ycirc: "ŷ", Ycy: "Ы", ycy: "ы", yen: "¥", Yfr: "𝔜", yfr: "𝔶", YIcy: "Ї", yicy: "ї", Yopf: "𝕐", yopf: "𝕪", Yscr: "𝒴", yscr: "𝓎", YUcy: "Ю", yucy: "ю", Yuml: "Ÿ", yuml: "ÿ", Zacute: "Ź", zacute: "ź", Zcaron: "Ž", zcaron: "ž", Zcy: "З", zcy: "з", Zdot: "Ż", zdot: "ż", zeetrf: "ℨ", ZeroWidthSpace: "​", Zeta: "Ζ", zeta: "ζ", Zfr: "ℨ", zfr: "𝔷", ZHcy: "Ж", zhcy: "ж", zigrarr: "⇝", Zopf: "ℤ", zopf: "𝕫", Zscr: "𝒵", zscr: "𝓏", zwj: "‍", zwnj: "‌" }, L.NGSP_UNICODE = "", L.NAMED_ENTITIES.ngsp = L.NGSP_UNICODE;
        ...
        function He(Je, Qe) {
          let yt = [], _t = new class extends ve {
            visit(ct, kt) {
              let $t = Ve(ct);
              if ($t.start <= Qe && Qe < $t.end) yt.push(ct);
              else return !0;
            }
          }();
        ...
        function re(Pe, ie) {
          if (ie != null) {
            if (!Array.isArray(ie)) throw new Error(`Expected '${Pe}' to be an array of strings.`);
            for (let de = 0; de < ie.length; de += 1) if (typeof ie[de] != "string") throw new Error(`Expected '${Pe}' to be an array of strings.`);
          }
        }
        L.assertArrayOfStrings = re;
        var ge = [/^\s*$/, /[<>]/, /^[{}]$/, /&(#|[a-z])/i, /^\/\//];
        function Ee(Pe, ie) {
          if (ie != null && !(Array.isArray(ie) && ie.length == 2)) throw new Error(`Expected '${Pe}' to be an array, [start, end].`);
          if (ie != null) {
            let de = ie[0], Ue = ie[1];
            ge.forEach((Ge) => {
              if (Ge.test(de) || Ge.test(Ue)) throw new Error(`['${de}', '${Ue}'] contains unusable interpolation symbol.`);
            });
          }
        }
...
`);
          ...
          tokenize() {
            for (; this._cursor.peek() !== re.$EOF; ) {
              ...
              try {
                if (this._attemptCharCode(re.$LT)) if (this._attemptCharCode(re.$BANG)) this._attemptStr("[CDATA[") ? this._consumeCdata(z) : this._attemptStr("--") ? this._consumeComment(z) : this._attemptStrCaseInsensitive("doctype") ? this._consumeDocType(z) : this._consumeBogusComment(z);
                else if (this._attemptCharCode(re.$SLASH)) this._consumeTagClose(z);
                else {
          ...
          _tokenizeExpansionForm() {
            ...
            if ($t(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), !0;
          ...
          _endToken(z) {
            let le = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this._cursor.clone();
            if (this._currentTokenStart === null) throw new Ue("Programming error - attempted to end a token when there was no start to the token", this._currentTokenType, this._cursor.getSpan(le));
            if (this._currentTokenType === null) throw new Ue("Programming error - attempted to end a token which has no token type", null, this._cursor.getSpan(this._currentTokenStart));
          ...
          handleError(z) {
            if (z instanceof rr && (z = this._createError(z.msg, this._cursor.getSpan(z.cursor))), z instanceof He) this.errors.push(z.error);
            else throw z;
          }
          _attemptCharCode(z) {
          ...
          _requireCharCode(z) {
            let le = this._cursor.clone();
            if (!this._attemptCharCode(z)) throw this._createError(ve(this._cursor.peek()), this._cursor.getSpan(le));
          }
          _attemptStr(z) {
            let le = z.length;
            if (this._cursor.charsLeft() < le) return !1;
            let We = this._cursor.clone();
            for (let Me = 0; Me < le; Me++) if (!this._attemptCharCode(z.charCodeAt(Me))) return this._cursor = We, !1;
            return !0;
          }
          _attemptStrCaseInsensitive(z) {
            for (let le = 0; le < z.length; le++) if (!this._attemptCharCodeCaseInsensitive(z.charCodeAt(le))) return !1;
            return !0;
          }
          _requireStr(z) {
            let le = this._cursor.clone();
            if (!this._attemptStr(z)) throw this._createError(ve(this._cursor.peek()), this._cursor.getSpan(le));
          }
          _requireStrCaseInsensitive(z) {
            let le = this._cursor.clone();
            if (!this._attemptStrCaseInsensitive(z)) throw this._createError(ve(this._cursor.peek()), this._cursor.getSpan(le));
          }
          _attemptCharCodeUntilFn(z) {
            for (; !z(this._cursor.peek()); ) this._cursor.advance();
          }
          _requireCharCodeUntilFn(z, le) {
            let We = this._cursor.clone();
            if (this._attemptCharCodeUntilFn(z), this._cursor.clone().diff(We) < le) throw this._createError(ve(this._cursor.peek()), this._cursor.getSpan(We));
          }
          _attemptUntilChar(z) {
            for (; this._cursor.peek() !== z; ) this._cursor.advance();
          }
          _readChar(z) {
            if (z && this._cursor.peek() === re.$AMPERSAND) return this._decodeEntity();
            {
          ...
          _decodeEntity() {
            ...
            if (this._cursor.advance(), this._attemptCharCode(re.$HASH)) {
              ...
              if (this._attemptCharCodeUntilFn(ct), this._cursor.peek() != re.$SEMICOLON) throw this._createError(ve(this._cursor.peek()), this._cursor.getSpan());
              ...
              let le = this._cursor.clone();
              if (this._attemptCharCodeUntilFn(kt), this._cursor.peek() != re.$SEMICOLON) return this._cursor = le, "&";
              let We = this._cursor.getChars(le);
              this._cursor.advance();
              let Me = Pe.NAMED_ENTITIES[We];
              if (!Me) throw this._createError(Ve(We), this._cursor.getSpan(z));
              return Me;
            }
          }
          ...
          _consumePrefixAndName() {
            ...
            for (; this._cursor.peek() !== re.$COLON && !_t(this._cursor.peek()); ) this._cursor.advance();
            let We;
          ...
          _consumeTagOpen(z) {
            ...
            try {
              if (!re.isAsciiLetter(this._cursor.peek())) throw this._createError(ve(this._cursor.peek()), this._cursor.getSpan(z));
              for (Me = this._consumeTagOpenStart(z), We = Me.parts[0], le = Me.parts[1], this._attemptCharCodeUntilFn(Qe); this._cursor.peek() !== re.$SLASH && this._cursor.peek() !== re.$GT; ) {
                ...
                } else er.push({ prefix: Er, name: _r });
                this._attemptCharCodeUntilFn(Qe);
              }
            ...
            if (this._canSelfClose && this.tokens[this.tokens.length - 1].type === ie.TAG_OPEN_END_VOID) return;
          ...
          _consumeAttributeName() {
            ...
            if (z === re.$SQ || z === re.$DQ) throw this._createError(ve(z), this._cursor.getSpan());
          ...
          _consumeAttributeValue() {
            ...
            if (this._cursor.peek() === re.$SQ || this._cursor.peek() === re.$DQ) {
              ...
              let We = [];
              for (; this._cursor.peek() !== le; ) We.push(this._readChar(!0));
          ...
          _consumeTagClose(z) {
            if (this._beginToken(ie.TAG_CLOSE, z), this._attemptCharCodeUntilFn(Qe), this._allowHtmComponentClosingTags && this._attemptCharCode(re.$SLASH)) this._attemptCharCodeUntilFn(Qe), this._requireCharCode(re.$GT), this._endToken([]);
            else {
          ...
          isExpansionFormStart() {
            if (this._cursor.peek() !== re.$LBRACE) return !1;
        ...
        var Vt = class {
          constructor(z, le) {
            if (z instanceof Vt) this.file = z.file, this.input = z.input, this.end = z.end, this.state = Object.assign({}, z.state);
            else {
              if (!le) throw new Error("Programming error: the range argument must be provided with a file argument.");
          ...
          getSpan(z, le) {
            if (z = z || this, le) for (z = z.clone(); this.diff(z) > 0 && le.indexOf(z.peek()) !== -1; ) z.advance();
          ...
          advanceState(z) {
            if (z.offset >= this.end) throw this.state = z, new rr('Unexpected character "EOF"', this);
          ...
          getChars(z) {
            let le = z.clone(), We = "";
            for (; le.internalState.offset < this.internalState.offset; ) We += String.fromCodePoint(le.peek()), le.advance();
            return We;
          }
          processEscapeSequence() {
            let z = () => this.internalState.peek;
            if (z() === re.$BACKSLASH) if (this.internalState = Object.assign({}, this.state), this.advanceState(this.internalState), z() === re.$n) this.state.peek = re.$LF;
            else if (z() === re.$r) this.state.peek = re.$CR;
            else if (z() === re.$v) this.state.peek = re.$VTAB;
            else if (z() === re.$t) this.state.peek = re.$TAB;
            else if (z() === re.$b) this.state.peek = re.$BSPACE;
            else if (z() === re.$f) this.state.peek = re.$FF;
            else if (z() === re.$u) if (this.advanceState(this.internalState), z() === re.$LBRACE) {
              this.advanceState(this.internalState);
              let le = this.clone(), We = 0;
              for (; z() !== re.$RBRACE; ) this.advanceState(this.internalState), We++;
              ...
              for (; re.isOctalDigit(z()) && We < 3; ) Me = this.clone(), le += String.fromCodePoint(z()), this.advanceState(this.internalState), We++;
              this.state.peek = parseInt(le, 8), this.internalState = Me.internalState;
            } else re.isNewLine(this.internalState.peek) ? (this.advanceState(this.internalState), this.state = this.internalState) : this.state.peek = this.internalState.peek;
          }
          decodeHexDigits(z, le) {
            let We = this.input.substr(z.internalState.offset, le), Me = parseInt(We, 16);
            if (isNaN(Me)) throw z.state = z.internalState, new rr("Invalid hexadecimal escape sequence", z);
            return Me;
          }
        }, rr = class {
          constructor(z, le) {
        ...
        var Ue = class {
          ...
          parse(ce, ve, Ve) {
            let He = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1, Je = arguments.length > 4 ? arguments[4] : void 0, Qe = (Vt) => function(Ut) {
              for (var rr = arguments.length, z = new Array(rr > 1 ? rr - 1 : 0), le = 1; le < rr; le++) z[le - 1] = arguments[le];
        ...
        var Ge = class {
          ...
          _parseExpansionCase() {
            ...
            if (this._peek.type !== Ee.TokenType.EXPANSION_CASE_EXP_START) return this._errors.push(ie.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null;
            ...
            if (Je.errors.length > 0) return this._errors = this._errors.concat(Je.errors), null;
          ...
          _collectExpansionExpTokens(ce) {
            ...
            for (; ; ) {
              if ((this._peek.type === Ee.TokenType.EXPANSION_FORM_START || this._peek.type === Ee.TokenType.EXPANSION_CASE_EXP_START) && Ve.push(this._peek.type), this._peek.type === Ee.TokenType.EXPANSION_CASE_EXP_END) if (gt(Ve, Ee.TokenType.EXPANSION_CASE_EXP_START)) {
                if (Ve.pop(), Ve.length == 0) return ve;
              } else return this._errors.push(ie.create(null, ce.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
              if (this._peek.type === Ee.TokenType.EXPANSION_FORM_END) if (gt(Ve, Ee.TokenType.EXPANSION_FORM_START)) Ve.pop();
              else return this._errors.push(ie.create(null, ce.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
              if (this._peek.type === Ee.TokenType.EOF) return this._errors.push(ie.create(null, ce.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
...
`) {
          ...
          _consumeStartTag(ce) {
            ...
            for (; this._peek.type === Ee.TokenType.ATTR_NAME; ) He.push(this._consumeAttr(this._advance()));
            ...
            } else this._peek.type === Ee.TokenType.TAG_OPEN_END && (this._advance(), Qe = !1);
          ...
          _consumeEndTag(ce) {
            ...
            if (this._getParentElement() && (this._getParentElement().endSourceSpan = ce.sourceSpan), ve && this.getTagDefinition(ve).isVoid) this._errors.push(ie.create(ve, ce.sourceSpan, `Void elements do not have end tags "${ce.parts[1]}"`));
          ...
          _popElement(ce) {
            for (let ve = this._elementStack.length - 1; ve >= 0; ve--) {
              ...
              if (!ce || (Pe.getNsPrefix(Ve.name) ? Ve.name == ce : Ve.name.toLowerCase() == ce.toLowerCase())) return this._elementStack.splice(ve, this._elementStack.length - ve), !0;
              if (!this.getTagDefinition(Ve.name).closedByParent) return !1;
            }
            return !1;
          }
          _consumeAttr(ce) {
          ...
          _getParentElementSkippingContainers() {
            let ce = null;
            for (let ve = this._elementStack.length - 1; ve >= 0; ve--) {
              if (!Pe.isNgContainer(this._elementStack[ve].name)) return { parent: this._elementStack[ve], container: ce };
          ...
          _insertBeforeContainer(ce, ve, Ve) {
            if (!ve) this._addToParent(Ve), this._elementStack.push(Ve);
            else {
              if (ce) {
                let He = ce.children.indexOf(ve);
                ce.children[He] = Ve;
              } else this._rootNodes.push(Ve);
      ...
      function ns(L, re, ge) {
        ...
        if (ge.parser === "vue") if (Je.some((st) => st.type === "docType" && st.value === "html" || st.type === "element" && st.name.toLowerCase() === "html")) {
          ...
          let st = (Ot) => {
            if (!Ot || Ot.type !== "element" || Ot.name !== "template") return !1;
          ...
          if (Je.some(st)) {
            ...
            for (let z = 0; z < Je.length; z++) {
              ...
              if (We === null) Qe = Ut().errors, Je[z] = rr(le) || le;
              else if (st(le)) {
        ...
        let yt = (st) => {
          ...
          switch (st.type) {
            case "element":
              yt(st);
              for (let Ot of st.attrs) yt(Ot), Ot.valueSpan ? (Ot.value = Ot.valueSpan.toString(), /["']/.test(Ot.value[0]) && (Ot.value = Ot.value.slice(1, -1))) : Ot.value = null;
              break;
            case "comment":
          ...
          if (st.type === "element" && (Pe && (!st.namespace || st.namespace === st.tagDefinition.implicitNamespacePrefix || zu(st)) && (st.name = ct(st.name, (Ot) => Ot in Ki)), ie)) {
            ...
            for (let Vt of st.attrs) Vt.namespace || (Vt.name = ct(Vt.name, (Ut) => st.name in cu && (Ut in cu["*"] || Ut in Ot)));
          }
        }, $t = (st) => {
  ...
  (function(Ae) {
    ...
    var Ae = (ee, V) => () => (V || ee((V = { exports: {} }).exports, V), V.exports), Yt = Ae((ee, V) => {
      ...
      V.exports = function(Y) {
        if (W(Y)) throw Z("Can't call method on " + Y);
        return Y;
      };
    }), dn = Ae((ee, V) => {
      var W = Zr(), Z = qn();
      ...
      V.exports = function(Fe, je) {
        var he, qe;
        if (je === "string" && Z(he = Fe.toString) && !Y(qe = W(he, Fe)) || Z(he = Fe.valueOf) && !Y(qe = W(he, Fe)) || je !== "string" && Z(he = Fe.toString) && !Y(qe = W(he, Fe))) return qe;
      ...
      V.exports = function(et, Ze) {
        if (!Z(et) || Y(et)) return et;
        var nt = ne(et, qe), rt;
        if (nt) {
          if (Ze === void 0 && (Ze = "default"), rt = W(nt, et, Ze), !Z(rt) || Y(rt)) return rt;
      ...
      ee.f = V ? qe : function(et, Ze) {
        if (et = ne(et), Ze = Fe(Ze), he) try {
          return qe(et, Ze);
        } catch {
        }
        if (je(et, Ze)) return Y(!W(Z.f, et, Ze), et[Ze]);
      };
    }), ci = Ae((ee, V) => {
      var W = br(), Z = hr();
      V.exports = W && Z(function() {
      ...
      ee.f = V ? Z ? function(nt, rt, $) {
        ...
        if (Y(nt), rt = ne(rt), Y($), W) try {
          return je(nt, rt, $);
        } catch {
        }
        if ("get" in $ || "set" in $) throw Fe("Accessors not supported");
      ...
      V.exports = function(Fe, je, he, qe) {
        ...
        if (W(he) && Y(he, Ze, qe), qe.global) et ? Fe[je] = he : ne(je, he);
        else {
          try {
      ...
      var W = dn(), Z = yi(), Y = tn(), ne = function(Fe) {
        return function(je, he, qe) {
          ...
          if (Fe && he != he) {
            for (; Ze > nt; ) if (rt = et[nt++], rt != rt) return !0;
          } else for (; Ze > nt; nt++) if ((Fe || nt in et) && et[nt] === he) return Fe || nt || 0;
          return !Fe && -1;
        };
      };
      ...
      V.exports = function(he, qe) {
        ...
        for (rt in et) !Z(Fe, rt) && Z(et, rt) && je(nt, rt);
        for (; qe.length > Ze; ) Z(et, rt = qe[Ze++]) && (~ne(nt, rt) || je(nt, rt));
        return nt;
      };
    }), Ai = Ae((ee, V) => {
      ...
      V.exports = function(Y) {
        if (Y > Z) throw W("Maximum allowed index exceeded");
        return Y;
      };
    }), Eu = Ae((ee, V) => {
      var W = Br(), Z = Dr();
      V.exports = function(Y) {
        if (W(Y) === "Function") return Z(Y);
      };
    }), Cu = Ae((ee, V) => {
      ...
      var W = yu(), Z = tn(), Y = Bi(), ne = Cu(), Fe = function(je, he, qe, et, Ze, nt, rt, $) {
        for (var Ft = Ze, At = 0, Lt = rt ? ne(rt, $) : !1, qt, Zt; At < et; ) At in qe && (qt = Lt ? Lt(qe[At], At, he) : qe[At], nt > 0 && W(qt) ? (Zt = Z(qt), Ft = Fe(je, he, qt, Zt, Ft, nt - 1) - 1) : (Y(Ft + 1), je[Ft] = qt), Ft++), At++;
        return Ft;
      };
      V.exports = Fe;
    }), Au = Ae((ee, V) => {
      ...
      V.exports = function(Ft, At, Lt) {
        ...
        if (ue) fr = Ft.iterator;
        else if (yr) fr = Ft;
        else {
          if (Rr = et(Ft), !Rr) throw nt(ne(Ft) + " is not iterable");
          if (Fe(Rr)) {
            for (mr = 0, rn = je(Ft); rn > mr; mr++) if (wr = on(Ft[mr]), wr && he($, wr)) return wr;
            return new rt(!1);
          }
          fr = qe(Ft, Rr);
        }
        for (Fr = ue ? Ft.next : fr.next; !(Tn = Z(Fr, fr)).done; ) {
          ...
          if (typeof wr == "object" && wr && he($, wr)) return wr;
        }
        return new rt(!1);
      };
    }), Ii = Ae((ee, V) => {
      ...
      function ne(u, l) {
        ...
        if (Object.getOwnPropertySymbols) {
          ...
          for (s = 0; s < e.length; s++) a = e[s], !(l.indexOf(a) >= 0) && Object.prototype.propertyIsEnumerable.call(u, a) && (t[a] = u[a]);
        }
        return t;
      }
      function Fe(u, l) {
        ...
        for (e = 0; e < a.length; e++) s = a[e], !(l.indexOf(s) >= 0) && (t[s] = u[s]);
        return t;
      }
      Ni(), ji(), $i(), Ne(), Se();
      var je = Object.create, he = Object.defineProperty, qe = Object.getOwnPropertyDescriptor, et = Object.getOwnPropertyNames, Ze = Object.getPrototypeOf, nt = Object.prototype.hasOwnProperty, rt = (u, l) => function() {
        ...
        for (var t in l) he(u, t, { get: l[t], enumerable: !0 });
      }, At = (u, l, t, a) => {
        if (l && typeof l == "object" || typeof l == "function") for (let s of et(l)) !nt.call(u, s) && s !== t && he(u, s, { get: () => l[s], enumerable: !(a = qe(l, s)) || a.enumerable });
        return u;
      }, Lt = (u, l, t) => (t = u != null ? je(Ze(u)) : {}, At(!u || !u.__esModule ? he(t, "default", { value: u, enumerable: !0 }) : t, u)), qt = (u) => At(he({}, "__esModule", { value: !0 }), u), Zt, ue = rt({ "<define:process>"() {
        Zt = { env: {}, argv: [] };
      } }), yr = $({ "package.json"(u, l) {
        ...
        l.prototype = { diff: function(s, e) {
          ...
          if (D[0].newPos + 1 >= y && C + 1 >= m) return c([{ value: this.join(e), count: e.length }]);
          function w() {
            for (var A = -1 * g; A <= g; A += 2) {
              ...
              if (!J || d && x.newPos < P.newPos ? (N = a(P), o.pushComponent(N.components, void 0, !0)) : (N = x, N.newPos++, o.pushComponent(N.components, !0, void 0)), _ = o.extractCommon(N, e, s, A), N.newPos + 1 >= y && _ + 1 >= m) return c(t(o, N.components, e, s, o.useLongestToken));
              D[A] = N;
            }
            g++;
          }
          ...
          for (var o = e.length, c = r.length, y = s.newPos, m = y - n, g = 0; y + 1 < o && m + 1 < c && this.equals(e[y + 1], r[m + 1]); ) y++, m++, g++;
          ...
          for (var e = [], r = 0; r < s.length; r++) s[r] && e.push(s[r]);
          return e;
        ...
        function t(s, e, r, n, o) {
          for (var c = 0, y = e.length, m = 0, g = 0; c < y; c++) {
            ...
            if (p.removed) {
              ...
              } else p.value = s.join(r.slice(m, m + p.count));
        ...
        function d(F, i) {
          let h = [];
          for (let E = 0; E < i.length; E++) E !== 0 && h.push(F), h.push(i[E]);
          return t(h);
        }
        function T(F, i, h) {
          let E = F;
          if (i > 0) {
            for (let b = 0; b < Math.floor(i / h); ++b) E = a(E);
      ...
      var wu, Mi = rt({ "node_modules/string-width/index.js"() {
        ...
        function o(i, h, E, b) {
          ...
          for (; S.length > 0; ) {
            ...
            if (E && S.push(B, n), !h || h(B) !== !1) if (e(B) || B.type === "fill") {
              let I = r(B);
              for (let q = I.length, G = q - 1; G >= 0; --G) S.push(I[G]);
            } else if (B.type === "if-break") B.flatContents && S.push(B.flatContents), B.breakContents && S.push(B.breakContents);
            else if (B.type === "group" && B.expandedStates) if (b) for (let I = B.expandedStates.length, q = I - 1; q >= 0; --q) S.push(B.expandedStates[q]);
            else S.push(B.contents);
            else B.contents && S.push(B.contents);
          }
        }
        function c(i, h) {
          ...
          function S(B) {
            if (Array.isArray(B)) return h(B.map(b));
        ...
        function y(i, h, E) {
          ...
          function B(I) {
            let q = h(I);
            if (q !== void 0 && (S = !0, b = q), S) return !1;
          }
          return o(i, B), b;
        }
        function m(i) {
        ...
        function A(i) {
          ...
          if (e(i) || i.type === "fill") {
            let h = r(i);
            for (; h.length > 1 && k(...h.slice(-2)); ) h.length -= 2;
            if (h.length > 0) {
              let E = A(t(h));
              h[h.length - 1] = E;
            }
...
`)).parts;
        ...
        function k(x) {
          ...
          let P = 0;
          for (; x.length > 0 && typeof a(x) == "string" && /^[\t ]*$/.test(a(x)); ) P += x.pop().length;
        ...
        function A(x, P, _, J, d) {
          ...
          for (; _ >= 0; ) {
            ...
            if (typeof h == "string") F.push(h), _ -= s(h);
            else if (o(h) || h.type === "fill") {
              let E = c(h);
              for (let b = E.length - 1; b >= 0; b--) f.push({ mode: i, doc: E[b] });
            } else switch (h.type) {
              case "indent":
              case "align":
              case "indent-if-break":
...
` ? S.replace(/\n/g, J) : S;
              ...
              let B = c(S);
              for (let I = B.length - 1; I >= 0; I--) T.push({ ind: E, mode: b, doc: B[I] });
            } else switch (S.type) {
              case "cursor":
              ...
              case "group":
                switch (b) {
                  ...
                  case m: {
                    ...
                    if (!S.break && A(B, T, I, q)) T.push(B);
                    else if (S.expandedStates) {
                      let G = a(S.expandedStates);
                      if (S.break) {
                        T.push({ ind: E, mode: m, doc: G });
                        break;
                      } else for (let M = 1; M < S.expandedStates.length + 1; M++) if (M >= S.expandedStates.length) {
                        T.push({ ind: E, mode: m, doc: G });
                        break;
                      } else {
                    ...
                    } else T.push({ ind: E, mode: m, doc: S.contents });
                    break;
                  }
                }
        ...
        function s(r) {
          ...
          if (t(r)) {
            let n = [];
            for (let o of a(r)) if (t(o)) n.push(...s(o).parts);
            else {
              let c = s(o);
              c !== "" && n.push(c);
            }
        ...
        function e(r) {
          ...
          function c(m, g, p) {
            ...
            if (m.type === "if-break") return "ifBreak(" + c(m.breakContents) + (m.flatContents ? ", " + c(m.flatContents) : "") + (m.groupId ? (m.flatContents ? "" : ', ""') + `, { groupId: ${y(m.groupId)} }` : "") + ")";
      ...
      var Gi = rt({ "node_modules/escape-string-regexp/index.js"() {
        ...
        var t = typeof Zt == "object" && Zt.env && Zt.env.NODE_DEBUG && /\bsemver\b/i.test(Zt.env.NODE_DEBUG) ? function() {
          for (var a = arguments.length, s = new Array(a), e = 0; e < a; e++) s[e] = arguments[e];
        ...
        var t = ku(), { MAX_LENGTH: a, MAX_SAFE_INTEGER: s } = Pu(), { re: e, t: r } = Iu(), n = Ji(), { compareIdentifiers: o } = ju(), c = class {
          constructor(y, m) {
            if (m = n(m), y instanceof c) {
              if (y.loose === !!m.loose && y.includePrerelease === !!m.includePrerelease) return y;
              y = y.version;
            } else if (typeof y != "string") throw new TypeError(`Invalid Version: ${y}`);
            if (y.length > a) throw new TypeError(`version is longer than ${a} characters`);
            ...
            if (this.raw = y, this.major = +g[1], this.minor = +g[2], this.patch = +g[3], this.major > s || this.major < 0) throw new TypeError("Invalid major version");
          ...
          comparePre(y) {
            if (y instanceof c || (y = new c(y, this.options)), this.prerelease.length && !y.prerelease.length) return -1;
        ...
        function D(A, N) {
          for (var x = "", P = 0, _ = A.length; P < _; P++) x += A[P], P < _ - 1 && (x += N[P]);
          return x;
        }
        function C(A) {
        ...
        function w(A) {
          ...
          function P(J) {
            ...
            if (C(J)) {
              ...
              if (h || (h = p(f, F, A), i.set(f, h)), d.length === 0) return h[0];
        ...
        if (u.outdent = k, u.default = k, typeof l < "u") try {
    ...
    `, cliCategory: r }, tabWidth: { type: "int", category: o, default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 } }, useTabs: { since: "1.0.0", category: o, type: "boolean", default: !1, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { since: "2.1.0", category: o, type: "choice", default: [{ since: "2.1.0", value: "auto" }], description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
        ...
        function t(a, s) {
          ...
          if (a.charAt(s) === "/" && a.charAt(s + 1) === "*") {
            for (let e = s + 2; e < a.length; ++e) if (a.charAt(e) === "*" && a.charAt(e + 1) === "/") return e + 2;
          }
          return s;
        }
        l.exports = t;
...
` || n === "\r" || n === "\u2028" || n === "\u2029") return s + 1;
        ...
        function r(n, o) {
          let c = null, y = o;
          for (; y !== c; ) c = y, y = e(n, y), y = t(n, y), y = s(n, y), y = a(n, y);
          return y;
        }
        l.exports = r;
          ...
          return (R, pe, be) => {
            ...
            for (; X >= 0 && X < Ie; ) {
              ...
              if (U instanceof RegExp) {
                if (!U.test(se)) return X;
              } else if (!U.includes(se)) return X;
              fe ? X-- : X++;
            }
            return X === -1 || X === Ie ? X : !1;
          };
        ...
        function A(U, R, pe) {
          for (let be = R; be < pe; ++be) if (U.charAt(be) === `
`) return !0;
          return !1;
        }
        function N(U, R, pe) {
        ...
        function x(U, R) {
          let pe = null, be = R;
          for (; be !== pe; ) pe = be, be = c(U, be), be = m(U, be), be = o(U, be);
        ...
        function T(U, R) {
          ...
          for (let fe = pe; fe < U.length; ++fe) U[fe] === "	" ? be = be + R - be % R : be++;
          return be;
        }
        function f(U, R) {
...
`);
        ...
        function S(U, R) {
          ...
          for (let Ie = 1; Ie < fe; Ie++) if (!be.get(Ie)) return Ie;
          return fe + 1;
        }
        function B(U, R) {
      ...
      function Gu(u, l) {
        ...
        for (var a = t(u.split("/")), s = t(l.split("/")), e = Math.min(a.length, s.length), r = e, n = 0; n < e; n++) if (a[n] !== s[n]) {
          r = n;
          break;
        }
        for (var o = [], n = r; n < a.length; n++) o.push("..");
      ...
      function ou(u, l) {
        ...
        for (var t = [], a = 0; a < u.length; a++) l(u[a], a, u) && t.push(u[a]);
        return t;
      }
      var lu, Nn, _n, pn, pu, Wu, Hi = rt({ "node-modules-polyfills:path"() {
        ...
        if (t && t.default) {
          l.exports = t.default;
          for (let a in t) l.exports[a] = t[a];
        } else t && (l.exports = t);
      ...
      function cu(u, l) {
        var t = {};
        for (var a in u) Object.prototype.hasOwnProperty.call(u, a) && l.indexOf(a) < 0 && (t[a] = u[a]);
        if (u != null && typeof Object.getOwnPropertySymbols == "function") for (var s = 0, a = Object.getOwnPropertySymbols(u); s < a.length; s++) l.indexOf(a[s]) < 0 && Object.prototype.propertyIsEnumerable.call(u, a[s]) && (t[a[s]] = u[a[s]]);
        return t;
      }
      function zu(u, l, t, a) {
        var s = arguments.length, e = s < 3 ? l : a === null ? a = Object.getOwnPropertyDescriptor(l, t) : a, r;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") e = Reflect.decorate(u, l, t, a);
        else for (var n = u.length - 1; n >= 0; n--) (r = u[n]) && (e = (s < 3 ? r(e) : s > 3 ? r(l, t, e) : r(l, t)) || e);
      ...
      function ts(u, l) {
        ...
        function o(c) {
          ...
          for (; t; ) try {
            if (a = 1, s && (e = c[0] & 2 ? s.return : c[0] ? s.throw || ((e = s.return) && e.call(s), 0) : s.next) && !(e = e.call(s, c[1])).done) return e;
      ...
      function An(u, l) {
        ...
        try {
          for (; (l === void 0 || l-- > 0) && !(s = a.next()).done; ) e.push(s.value);
        } catch (n) {
          r = { error: n };
        } finally {
          try {
      ...
      function L() {
        for (var u = [], l = 0; l < arguments.length; l++) u = u.concat(An(arguments[l]));
        return u;
      }
      function re() {
        for (var u = 0, l = 0, t = arguments.length; l < t; l++) u += arguments[l].length;
        for (var a = Array(u), s = 0, l = 0; l < t; l++) for (var e = arguments[l], r = 0, n = e.length; r < n; r++, s++) a[s] = e[r];
        return a;
      }
      function ge(u) {
      ...
      var ve, Ve, He = rt({ "node_modules/tslib/tslib.es6.js"() {
        ...
        ue(), Object.defineProperty(u, "__esModule", { value: !0 }), u.apiDescriptor = { key: (l) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(l) ? l : JSON.stringify(l), value(l) {
          ...
          if (Array.isArray(l)) return `[${l.map((a) => u.apiDescriptor.value(a)).join(", ")}]`;
          let t = Object.keys(l);
        ...
        l.exports = function(s, e) {
          ...
          if (n === 0) return o;
          if (o === 0) return n;
          for (; n > 0 && s.charCodeAt(~-n) === e.charCodeAt(~-o); ) n--, o--;
          if (n === 0) return o;
          for (var c = 0; c < n && s.charCodeAt(c) === e.charCodeAt(c); ) c++;
          if (n -= c, o -= c, n === 0) return o;
          for (var y, m, g, p, D = 0, C = 0; D < n; ) a[c + D] = s.charCodeAt(c + D), t[D] = ++D;
          for (; C < o; ) for (y = e.charCodeAt(c + C), g = C++, m = C, D = 0; D < n; D++) p = y === a[c + D] ? g : g + 1, g = t[D], m = t[D] = g > m ? p > m ? m + 1 : p : p > g ? g + 1 : p;
          return m;
        };
        ...
        function t(e, r) {
          ...
          for (let c of l) c in r && (o[c] = s(r[c], n, a.prototype[c].length));
          return o;
        }
        u.createSchema = t;
        var a = class {
        ...
        function s(e, r, n) {
          return typeof e == "function" ? function() {
            for (var o = arguments.length, c = new Array(o), y = 0; y < o; y++) c[y] = arguments[y];
        ...
        function l(p, D) {
          ...
          for (let w of p) {
            let k = w[D];
            if (C[k]) throw new Error(`Duplicate ${D} ${JSON.stringify(k)}`);
            C[k] = w;
          }
          return C;
        }
        ...
        function t(p, D) {
          ...
          for (let w of p) {
            let k = w[D];
            if (C.has(k)) throw new Error(`Duplicate ${D} ${JSON.stringify(k)}`);
            C.set(k, w);
          }
          return C;
        }
        ...
        function s(p, D) {
          let C = [], w = [];
          for (let k of p) D(k) ? C.push(k) : w.push(k);
          return [C, w];
        }
        u.partition = s;
        function e(p) {
        ...
        var a = class {
          ...
          _applyNormalization(s, e) {
            ...
            for (let c of n) {
              ...
              for (let { from: w, to: k } of C.redirect) D({ value: w, redirectTo: k });
            }
            for (let c of o) {
          ...
          return class extends t.ChoiceSchema {
            ...
            preprocess(C, w) {
              if (typeof C == "string" && C.length > 0 && !this._flags.includes(C)) {
                ...
                if (k) return w.logger.warn([`Unknown flag ${p.yellow(w.descriptor.value(C))},`, `did you mean ${p.blue(w.descriptor.value(k))}?`].join(" ")), k;
              }
              return C;
            }
            expected() {
        ...
        function o(g, p) {
          ...
          for (let A of g) k.push(c(A, { isCLI: D, optionInfos: g, colorsModule: C, levenshteinDistance: w })), A.alias && D && k.push(t.AliasSchema.create({ name: A.alias, sourceName: A.name }));
          return k;
        }
        function c(g, p) {
          let { isCLI: D, optionInfos: C, colorsModule: w, levenshteinDistance: k } = p, { name: A } = g;
          if (A === "plugin-search-dir" || A === "pluginSearchDirs") return t.AnySchema.create({ name: A, preprocess(_) {
        ...
        function e(o, c, y) {
          ...
          else w === A ? w ? _[C] = [w, 0] : _[C] = !0 : _[C] = [w, A - w];
 ...
 `, D(p.gutter, T.replace(/\d/g, " ")), " ", h, D(p.marker, "^").repeat(E)].join(""), F && y.message && (i += " " + D(p.message, y.message));
            ...
            } else return ` ${D(p.gutter, T)}${_.length > 0 ? ` ${_}` : ""}`;
          }).join(`
`);
...
${P}`), m ? g.reset(P) : P;
        ...
        function n(o, c, y) {
          ...
          if (!t) {
            ...
            if (Zt.emitWarning) Zt.emitWarning(g, "DeprecationWarning");
            else {
              let p = new Error(g);
        ...
        function o(m) {
          let g = {};
          for (let p of m.plugins) if (p.parsers) for (let D of r(p.parsers)) Object.defineProperty(g, D, n(p.parsers, D));
          return g;
        }
        function c(m) {
          let g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : o(m);
          if (typeof m.parser == "function") return { parse: m.parser, astFormat: "estree", locStart: s, locEnd: e };
          if (typeof m.parser == "string") {
            if (Object.prototype.hasOwnProperty.call(g, m.parser)) return g[m.parser];
...
` + w.codeFrame, w;
        ...
        function o(m) {
          ...
          if (!p.parser) {
            ...
            else if (p.parser = y(p.filepath, p.plugins), !p.parser) throw new a(`No parser could be inferred for file: ${p.filepath}`);
          }
          ...
          for (let [x, P] of Object.entries(N)) (p[x] === null || p[x] === void 0) && (p[x] = P);
        ...
        function c(m) {
          ...
          if (!p) throw new Error(`Couldn't find plugin for AST format "${g}"`);
          return p;
        }
        function y(m, g) {
        ...
        ue();
        function t(a, s, e) {
          if (Array.isArray(a)) return a.map((c) => t(c, s, e)).filter(Boolean);
          if (!a || typeof a != "object") return a;
          let r = s.printer.massageAstNode, n;
          r && r.ignoredProperties ? n = r.ignoredProperties : n = /* @__PURE__ */ new Set();
          let o = {};
          for (let [c, y] of Object.entries(a)) !n.has(c) && typeof y != "function" && (o[c] = t(y, s, a));
          if (r) {
            let c = r(a, o, e);
            if (c === null) return;
            if (c) return c;
        ...
        function A(I, q, G) {
          ...
          } else if (k.has(I)) return k.get(I);
        ...
        function N(I, q, G, M) {
          ...
          for (; fe < Ie; ) {
            ...
            if (we <= De && U <= _e) return N(se, q, G, se);
            if (_e <= De) {
              pe = se, fe = X + 1;
              continue;
            }
        ...
        function P(I, q, G, M) {
          ...
          for (let [X, se] of Ie.entries()) {
            ...
            let Xe;
            if (R ? Xe = [se] : (we.enclosingNode = it, we.precedingNode = _e, we.followingNode = ae, Xe = [we, Q, me, Ce, Re]), J(Q, me, Ie, X)) we.placement = "ownLine", pe(...Xe) || (ae ? D(ae, we) : _e ? w(_e, we) : C(it || Ce, we));
            else if (d(Q, me, Ie, X)) we.placement = "endOfLine", be(...Xe) || (_e ? w(_e, we) : ae ? D(ae, we) : C(it || Ce, we));
            else if (we.placement = "remaining", !fe(...Xe)) if (_e && ae) {
              let Ye = te.length;
              Ye > 0 && te[Ye - 1].followingNode !== ae && T(te, Q, me), te.push(se);
            } else _e ? w(_e, we) : ae ? D(ae, we) : C(it || Ce, we);
          }
          if (T(te, G, M), !R) for (let X of I) delete X.precedingNode, delete X.enclosingNode, delete X.followingNode;
        }
        var _ = (I) => !/[\S\n\u2028\u2029]/.test(I);
        function J(I, q, G, M) {
          let { comment: te, precedingNode: j } = G[M], { locStart: De, locEnd: U } = q, R = De(te);
          if (j) for (let pe = M - 1; pe >= 0; pe--) {
            let { comment: be, precedingNode: fe } = G[pe];
            if (fe !== j || !_(I.slice(U(be), R))) break;
            R = De(be);
          }
        ...
        function d(I, q, G, M) {
          ...
          if (j) for (let pe = M + 1; pe < G.length; pe++) {
            let { comment: be, followingNode: fe } = G[pe];
            if (fe !== j || !_(I.slice(R, De(be)))) break;
            R = U(be);
          }
          return y(I, R);
        }
        function T(I, q, G) {
          ...
          for (pe = M; pe > 0; --pe) {
            ...
            if (U.test(X)) R = G.locStart(be);
            else break;
          }
          for (let [be, { comment: fe }] of I.entries()) be < pe ? w(te, fe) : D(j, fe);
          for (let be of [te, j]) be.comments && be.comments.length > 1 && be.comments.sort((fe, Ie) => G.locStart(fe) - G.locStart(Ie));
          I.length = 0;
        }
        function f(I, q) {
          let G = I.getValue();
        ...
        function F(I, q, G) {
          ...
          for (let te = 1; te < I.length; ++te) if (M < G.locStart(I[te])) return te - 1;
          return 0;
        }
        function i(I, q) {
        ...
        function B(I) {
          if (I) for (let q of I) {
            if (!q.printed) throw new Error('Comment "' + q.value.trim() + '" was not printed. Please report this error!');
            delete q.printed;
          }
        }
        ...
        var e = class {
          ...
          call(r) {
            ...
            for (var y = arguments.length, m = new Array(y > 1 ? y - 1 : 0), g = 1; g < y; g++) m[g - 1] = arguments[g];
          ...
          map(r) {
            let n = [];
            for (var o = arguments.length, c = new Array(o > 1 ? o - 1 : 0), y = 1; y < o; y++) c[y - 1] = arguments[y];
          ...
          match() {
            ...
            for (var c = arguments.length, y = new Array(c), m = 0; m < c; m++) y[m] = arguments[m];
            for (let g of y) {
              if (o === void 0) return !1;
              let p = null;
              if (typeof n == "number" && (p = n, n = this.stack[r--], o = this.stack[r--]), g && !g(o, n, p)) return !1;
          ...
          findAncestor(r) {
            ...
            for (; c; ) {
              let y = null;
              if (typeof o == "number" && (y = o, o = this.stack[n--], c = this.stack[n--]), o !== null && r(c, o, y)) return c;
        ...
        function e(n, o, c, y) {
          if (c.printer.embed && c.embeddedLanguageFormatting === "auto") return c.printer.embed(n, o, (m, g, p) => r(m, g, c, y, p), c);
        }
        function r(n, o, c, y) {
        ...
        function c(m, g) {
          ...
          for (let x of D) C(x) >= k && w(x) <= A && (x.printed = !0, N.add(x));
          return { doc: p.slice(k, A), printedComments: N };
        }
        function y(m, g, p, D) {
          let C = m.getValue(), { printer: w } = g, k, A;
          if (w.hasPrettierIgnore && w.hasPrettierIgnore(m)) ({ doc: k, printedComments: A } = c(C, g));
          else {
            if (C) try {
        ...
        function n(D, C, w) {
          ...
          let P = k(D.node);
          for (let J of r(C.parentNodes)) if (k(J) >= P) x = J;
          else break;
          let _ = A(C.node);
        ...
        function o(D, C, w, k) {
          ...
          if (!(C > J || C < _ || N === "rangeEnd" && C === _ || N === "rangeStart" && C === J)) {
            ...
            if (!k || k(D, A[0])) return { node: D, parentNodes: A };
          }
        }
        function c(D, C) {
        ...
        function p(D, C, w) {
          ...
          if (!_) for (k += P; A > k && !/\S/.test(D[A - 1]); --A) ;
        ...
        function N(f, F) {
          ...
          if (F.cursorOffset >= 0) {
            let I, q, G, M, te;
            if (F.cursorNode && B.cursorNodeText ? (I = F.locStart(F.cursorNode), q = E.slice(I, F.locEnd(F.cursorNode)), G = F.cursorOffset - I, M = B.cursorNodeStart, te = B.cursorNodeText) : (I = 0, q = E, G = F.cursorOffset, M = 0, te = B.formatted), q === te) return { formatted: B.formatted, cursorOffset: M + G, comments: b };
            let j = [...q];
            j.splice(G, 0, k);
            let De = [...te], U = t(j, De), R = M;
            for (let pe of U) if (pe.removed) {
              if (pe.value.includes(k)) break;
            } else R += pe.count;
...
`);
        ...
        function T(f, F) {
          ...
          if (E.rangeStart >= E.rangeEnd && h !== "" || E.requirePragma && !d(h, E)) return { formatted: f, cursorOffset: F.cursorOffset, comments: [] };
          let b;
        ...
        ue(), function() {
          ...
          function c(D) {
            var C, w, k;
            if (D.length === 0 || (k = D.charCodeAt(0), !t.isIdentifierStartES5(k))) return !1;
            for (C = 1, w = D.length; C < w; ++C) if (k = D.charCodeAt(C), !t.isIdentifierPartES5(k)) return !1;
            return !0;
          }
          function y(D, C) {
        ...
        function t(s, e) {
          ...
          for (let n = r.length - 1; n >= 0; n--) {
            let o = r[n];
            if (n === 0) return s.type === "Identifier" && s.name === o;
            if (s.type !== "MemberExpression" || s.optional || s.computed || s.property.type !== "Identifier" || s.property.name !== o) return !1;
            s = s.object;
          }
        }
        function a(s, e) {
        ...
        function N(O, $e) {
          ...
          if (Array.isArray(O)) return O.some((zt) => N(zt, $e));
          let vt = $e(O);
        ...
        function G(O, $e) {
          ...
          let vt = $e.getNode();
          if (!vt.expression || !q(vt.expression)) return !1;
        ...
        function se(O, $e) {
          ...
          if (O.arguments.length === 1) {
            if (I(O) && $e && se($e)) return S(O.arguments[0]);
            if (fe(O)) return I(O.arguments[0]);
          } else if ((O.arguments.length === 2 || O.arguments.length === 3) && (O.arguments[0].type === "TemplateLiteral" || E(O.arguments[0])) && X(O.callee)) return O.arguments[2] && !i(O.arguments[2]) ? !1 : (O.arguments.length === 2 ? S(O.arguments[1]) : B(O.arguments[1]) && Ke(O.arguments[1]).length <= 1) || I(O.arguments[1]);
          return !1;
        }
        ...
        function it(O) {
          ...
          return vt.length === 0 ? !1 : vt.every((zt) => {
            if (Bt(zt)) return !1;
            if (zt.type === "Identifier" || zt.type === "ThisExpression") return !0;
            if (_e(zt)) {
              let Ht = zt;
              for (; _e(Ht); ) if (Ht.property.type !== "Identifier" && Ht.property.type !== "Literal" && Ht.property.type !== "StringLiteral" && Ht.property.type !== "NumericLiteral" || (Ht = Ht.object, Bt(Ht))) return !1;
...
`));
        ...
        function It(O) {
          ...
          let $e = 0;
          for (let vt of O) if (S(vt)) {
            if ($e += 1, $e > 1) return !0;
          } else if (we(vt)) {
            for (let zt of vt.arguments) if (S(zt)) return !0;
          }
          return !1;
        }
        function Et(O) {
...
`)) && O.expressions.every(vt);
          if (O.type === "ObjectExpression") return O.properties.every((cr) => !cr.computed && (cr.shorthand || cr.value && vt(cr.value)));
          if (O.type === "ArrayExpression") return O.elements.every((cr) => cr === null || vt(cr));
          if (Sr(O)) return (O.type === "ImportExpression" || bt(O.callee, $e)) && ar(O).every(vt);
          if (_e(O)) return bt(O.object, $e) && bt(O.property, $e);
          let Ht = { "!": !0, "-": !0, "+": !0, "~": !0 };
          if (O.type === "UnaryExpression" && Ht[O.operator]) return bt(O.argument, $e);
          let jr = { "++": !0, "--": !0 };
        ...
        var ft = { Leading: 2, Trailing: 4, Dangling: 8, Block: 16, Line: 32, PrettierIgnore: 64, First: 128, Last: 256 }, Pt = (O, $e) => {
          if (typeof O == "function" && ($e = O, O = 0), O || $e) return (vt, zt, Ht) => !(O & ft.Leading && !vt.leading || O & ft.Trailing && !vt.trailing || O & ft.Dangling && (vt.leading || vt.trailing) || O & ft.Block && !g(vt) || O & ft.Line && !d(vt) || O & ft.First && zt !== 0 || O & ft.Last && zt !== Ht.length - 1 || O & ft.PrettierIgnore && !Tt(vt) || $e && !$e(vt));
        };
        function Bt(O, $e, vt) {
          if (!r(O == null ? void 0 : O.comments)) return !1;
          let zt = Pt($e, vt);
...
`) && q.push({ hasLineBreak: !1, cells: [] });
            ...
            for (let { cells: j } of te.filter((De) => !De.hasLineBreak)) for (let [De, U] of j.entries()) M[De] = Math.max(M[De], a(U));
...
`), _ = P.length, J = D[w], d = _ > 2 && P[0].trim() === "" && P[1].trim() === "", T = _ > 2 && P[_ - 1].trim() === "" && P[_ - 2].trim() === "", f = P.every((i) => /^\s*(?:#[^\n\r]*)?$/.test(i));
        ...
        function o(c) {
          ...
          for (let [p, D] of g.entries()) D !== "" && (g[p - 1] === "" && m ? y.push([s, D]) : y.push(D), m = !0);
        ...
        function y(m, g, p, D, C) {
          ...
          if (P.length === 0 && x.trim().length === 0) return "``";
        ...
        function y(d, T, f, F) {
          ...
          let h = c(d);
          if (h) {
            if (h === "markdown") return e(d, T, f);
            if (h === "css") return r(d, T, f);
            if (h === "graphql") return n(d, T, f);
            if (h === "html" || h === "angular") return o(d, T, f, F, { parser: h });
          }
        }
        function m(d) {
        ...
        function e(r, n, o) {
          ...
          if ((r.type === "Property" || r.type === "ObjectProperty" || r.type === "MethodDefinition" || r.type === "ClassProperty" || r.type === "ClassMethod" || r.type === "PropertyDefinition" || r.type === "TSDeclareMethod" || r.type === "TSPropertySignature" || r.type === "ObjectTypeProperty") && typeof r.key == "object" && r.key && (r.key.type === "Literal" || r.key.type === "NumericLiteral" || r.key.type === "StringLiteral" || r.key.type === "Identifier") && delete n.key, r.type === "JSXElement" && r.openingElement.name.name === "style" && r.openingElement.attributes.some((m) => m.name.name === "jsx")) for (let { type: m, expression: g } of n.children) m === "JSXExpressionContainer" && g.type === "TemplateLiteral" && s(g);
          ...
          if (r.type === "Decorator" && c.type === "CallExpression" && c.callee.name === "Component" && c.arguments.length === 1) {
            ...
            for (let [g, p] of n.expression.arguments[0].properties.entries()) switch (m[g].key.name) {
              case "styles":
      ...
      function Cs() {
        if (typeof Qu > "u") {
          ...
          if (l[0] = 1, l[1] = 2, t[0] === 258) Qu = "BE";
          else if (t[0] === 513) Qu = "LE";
...
`;
        ...
        function w(N) {
          ...
          let P = "";
          for (; P !== N; ) P = N, N = N.replace(c, `${x}$1 $2${x}`);
...
`) + w;
        ...
        function M(Le) {
          ...
          if ((ye == null ? void 0 : ye.type) !== "IfStatement" || !ze) return !1;
          if (e(tt, v, i) === ")") return o(K, v), !0;
          if (K === ye.consequent && ze === ye.alternate) {
            if (K.type === "BlockStatement") o(K, v);
            else {
        ...
        function be(Le) {
          ...
          if (pe.has(ye == null ? void 0 : ye.type)) {
            if (m(ye.decorators) && !(ze && ze.type === "Decorator")) return o(t(ye.decorators), v), !0;
            if (ye.body && ze === ye.body) return I(ye.body, v), !0;
            if (ze) {
              if (ye.superClass && ze === ye.superClass && K && (K === ye.id || K === ye.typeParameters)) return o(K, v), !0;
              for (let tt of ["implements", "extends", "mixins"]) if (ye[tt] && ze === ye[tt][0]) return K && (K === ye.id || K === ye.typeParameters || K === ye.superClass) ? o(K, v) : c(ye, v, tt), !0;
            }
          }
          return !1;
        }
        ...
        function we(Le) {
          ...
          if ((K == null ? void 0 : K.type) !== "ArrowFunctionExpression") return !1;
          let ze = y(ye, v, i);
        ...
        function it(Le) {
          let { comment: v, precedingNode: K, enclosingNode: ye, followingNode: ze, text: tt } = Le;
          if ((K == null ? void 0 : K.type) === "FunctionTypeParam" && (ye == null ? void 0 : ye.type) === "FunctionTypeAnnotation" && (ze == null ? void 0 : ze.type) !== "FunctionTypeParam" || ((K == null ? void 0 : K.type) === "Identifier" || (K == null ? void 0 : K.type) === "AssignmentPattern") && ye && Be(ye) && e(tt, v, i) === ")") return o(K, v), !0;
          if ((ye == null ? void 0 : ye.type) === "FunctionDeclaration" && (ze == null ? void 0 : ze.type) === "BlockStatement") {
            let ht = (() => {
              let Ke = g(ye);
              if (Ke.length > 0) return s(tt, i(t(Ke)));
              let pr = s(tt, i(ye.id));
              return pr !== !1 && s(tt, pr + 1);
            })();
            if (F(v) > ht) return I(ze, v), !0;
          }
          return !1;
        }
        function ae(Le) {
        ...
        function Ct(Le) {
          let { comment: v, precedingNode: K, enclosingNode: ye, text: ze } = Le;
          if ((ye == null ? void 0 : ye.type) === "ImportSpecifier" || (ye == null ? void 0 : ye.type) === "ExportSpecifier") return n(ye, v), !0;
        ...
        function H(Le) {
          let { comment: v, enclosingNode: K, followingNode: ye } = Le;
          if (p(v) && (K == null ? void 0 : K.type) === "TSMappedType" && (ye == null ? void 0 : ye.type) === "TSTypeParameter" && ye.constraint) return K.prettierIgnore = !0, v.unignore = !0, !0;
        }
        function ke(Le) {
          let { comment: v, precedingNode: K, enclosingNode: ye, followingNode: ze } = Le;
        ...
        function pt(Le, v) {
          if ((v.parser === "typescript" || v.parser === "flow" || v.parser === "acorn" || v.parser === "espree" || v.parser === "meriyah" || v.parser === "__babel_estree") && Le.type === "MethodDefinition" && Le.value && Le.value.type === "FunctionExpression" && g(Le.value).length === 0 && !Le.value.returnType && !m(Le.value.typeParameters) && Le.value.body) return [...Le.decorators || [], Le.key, Le.value.body];
        }
        function ut(Le) {
        ...
        function k(d, T) {
          ...
          if (T.__isInHtmlInterpolation && !T.bracketSpacing && P(i) && _(d)) return !0;
          if (A(i)) return !1;
          ...
          switch (f.type) {
              ...
              if (F === "expression") {
                ...
                for (; B; ) switch (B.type) {
                  case "MemberExpression":
                    ...
                    break;
                  case "CallExpression":
                    if (S || b) return T.parser !== "typescript";
                    b = !0, B = B.callee;
                    break;
                  case "Identifier":
                    return !1;
            ...
            case "ArrowFunctionExpression": {
              if (F === "body" && i.type !== "SequenceExpression" && y(i, (b) => b.type === "ObjectExpression")) return !0;
              break;
            }
          }
          switch (i.type) {
            ...
            case "BinaryExpression": {
              ...
              if (i.operator === "|>" && i.extra && i.extra.parenthesized) {
                ...
                if (b.type === "BinaryExpression" && b.operator === "|>") return !0;
              }
            }
            ...
            case "LogicalExpression":
              switch (f.type) {
                ...
                case "BinaryExpression": {
                  ...
                  if (!b && S !== "TSTypeAssertion") return !0;
            ...
            case "TSConstructorType":
              if (F === "extendsType" && f.type === "TSConditionalType") {
                ...
                if (b.type === "TSTypePredicate" && b.typeAnnotation && (b = b.typeAnnotation.typeAnnotation), b.type === "TSInferType" && b.typeParameter.constraint) return !0;
              }
            ...
            case "OptionalCallExpression": {
              let b = d.getParentNode(1);
              if (F === "object" && f.type === "MemberExpression" || F === "callee" && (f.type === "CallExpression" || f.type === "NewExpression") || f.type === "TSNonNullExpression" && b.type === "MemberExpression" && b.object === f) return !0;
            }
            case "CallExpression":
            case "MemberExpression":
            case "TaggedTemplateExpression":
        ...
        function _(d) {
          ...
          switch (f.type) {
            case "NGPipeExpression":
              if (typeof F == "number" && f.arguments[F] === T && f.arguments.length - 1 === F) return d.callParent(_);
              break;
            case "ObjectProperty":
              if (F === "value") {
            ...
            case "BinaryExpression":
            case "LogicalExpression":
              if (F === "right") return d.callParent(_);
              break;
            case "ConditionalExpression":
              if (F === "alternate") return d.callParent(_);
              break;
            case "UnaryExpression":
              if (f.prefix) return d.callParent(_);
              break;
          }
          return !1;
        }
        ...
        function n(c, y, m) {
          ...
          if (y.__onHtmlBindingRoot && c.getName() === null && y.__onHtmlBindingRoot(g, y), g.type === "File") {
            if (y.__isVueForBindingLeft) return c.call((p) => {
              let D = t([",", a], p.map(m, "params")), { params: C } = p.getValue();
              return C.length === 1 ? D : ["(", r([e, s(D)]), e, ")"];
            }, "program", "body", 0);
            if (y.__isVueBindings) return c.call((p) => t([",", a], p.map(m, "params")), "program", "body", 0);
          }
        }
        function o(c) {
          switch (c.type) {
        ...
        function T(i, h, E) {
          ...
          if (I) return G;
          if (q) return n(G);
          if (x(S) && S.callee === b || S.type === "UnaryExpression" || P(S) && !S.computed) return n([o([r, ...G]), r]);
        ...
        function h(Q, me, Ce) {
          let Re = Q.getValue();
          if (Re.type === "JSXElement" && we(Re)) return [Ce("openingElement"), Ce("closingElement")];
          ...
          if (Re.children.length === 1 && Re.children[0].type === "JSXExpressionContainer" && (Re.children[0].expression.type === "TemplateLiteral" || Re.children[0].expression.type === "TaggedTemplateExpression")) return [Xe, ...Q.map(Ce, "children"), Ye];
          ...
          for (; oe.length > 0 && i(w(oe)); ) oe.pop();
          for (; oe.length > 1 && i(oe[0]) && i(oe[1]); ) oe.shift(), oe.shift();
          let pt = [];
          ...
          return Q.each((Ct, Rt, It) => {
            ...
            if (Et.type === "JSXText") {
              ...
              if (_e(Et)) {
                ...
                let H;
                if (w(xe) === "" && (xe.pop(), H = xe.pop()), xe.length === 0) return;
                for (let [ke, oe] of xe.entries()) ke % 2 === 1 ? Ye.push(e) : Ye.push(oe);
                if (H !== void 0) if (/\n/.test(H)) {
                  let ke = It[Rt + 1];
        ...
        function B(Q, me, Ce) {
          ...
          if (!Re || { ArrayExpression: !0, JSXAttribute: !0, JSXElement: !0, JSXExpressionContainer: !0, JSXFragment: !0, ExpressionStatement: !0, CallExpression: !0, OptionalCallExpression: !0, ConditionalExpression: !0, JsExpressionRoot: !0 }[Re.type]) return me;
        ...
        function G(Q, me, Ce) {
          ...
          if (Re.selfClosing && Re.attributes.length === 0 && !Xe) return ["<", Ce("name"), Ce("typeParameters"), " />"];
...
`) && !Xe && !J(Re.attributes[0])) return o(["<", Ce("name"), Ce("typeParameters"), " ", ...Q.map(Ce, "attributes"), Re.selfClosing ? " />" : ">"]);
...
`)), Ct = me.singleAttributePerLine && Re.attributes.length > 1 ? r : e;
        ...
        function be(Q, me, Ce) {
          let Re = Q.getValue();
          if (Re.type.startsWith("JSX")) switch (Re.type) {
            case "JSXAttribute":
              return I(Q, me, Ce);
            case "JSXIdentifier":
...
\r	`, Ie = new RegExp("([" + fe + "]+)"), X = new RegExp("[^" + fe + "]"), se = (Q) => Q.replace(new RegExp("(?:^" + Ie.source + "|" + Ie.source + "$)"), "");
        ...
        function P(T, f, F) {
          ...
          if (i.elements.length === 0) p(i, D.Dangling) ? h.push(r([E, t(T, f), s, b])) : h.push(E, b);
          else {
        ...
        function E(M, te, j) {
          ...
          if (R.length === 0) return ["(", t(M, te, !0), ")"];
          if (I(R)) return ["(", j(["arguments", 0]), ", ", j(["arguments", 1]), ")"];
          ...
          if (pe || M.getParentNode().type !== "Decorator" && o(R)) return se();
          let we = B(R), _e = S(R, te);
          if (we || _e) {
            if (we ? Ie.slice(1).some(F) : Ie.slice(0, -1).some(F)) return se();
            let ae = [];
            try {
              M.try(() => {
                p(M, (Q, me) => {
        ...
        function b(S, B, I) {
          ...
          let U = [], R = [M[0]], pe = 1;
          for (; pe < M.length && (M[pe].node.type === "TSNonNullExpression" || n(M[pe].node) || o(M[pe].node) && M[pe].node.computed && g(M[pe].node.property)); ++pe) R.push(M[pe]);
          if (!n(M[0].node)) for (; pe + 1 < M.length && m(M[pe].node) && m(M[pe + 1].node); ++pe) R.push(M[pe]);
          U.push(R), R = [];
          let be = !1;
          for (; pe < M.length; ++pe) {
            if (be && m(M[pe].node)) {
          ...
          if (U.length <= Q && !Ce) return y(S) ? ae : x(ae);
        ...
        function k(N, x, P) {
          ...
          if (i && (_.callee.trailingComments[0].printed = !0), !T && !d && o(_.callee) && !N.call((E) => s(E, x), "callee")) return p(N, x, P);
        ...
        function h(X, se, we, _e, it) {
          ...
          if (!Q) return "only-left";
          let me = !S(Q);
          if (X.match(S, B, (Re) => !me || Re.type !== "ExpressionStatement" && Re.type !== "VariableDeclaration")) return me ? Q.type === "ArrowFunctionExpression" && Q.body.type === "ArrowFunctionExpression" ? "chain-tail-arrow-chain" : "chain-tail" : "chain";
          if (!me && S(Q.right) || g(se.originalText, Q)) return "break-after-operator";
          if (Q.type === "CallExpression" && Q.callee.name === "require" || se.parser === "json5" || se.parser === "json") return "never-break-after-operator";
          if (b(ae) || I(ae) || M(ae) || te(ae) && m(_e)) return "break-lhs";
          let Ce = be(ae, _e, se);
        ...
        function E(X, se, we, _e) {
          ...
          if (_e) return !1;
          let ae = it, Q = [];
          for (; ; ) if (ae.type === "UnaryExpression") ae = ae.argument, Q.push("argument");
          else if (ae.type === "TSNonNullExpression") ae = ae.expression, Q.push("expression");
          else break;
        ...
        function I(X) {
          ...
          if (t(se)) {
            ...
            if (se.length > 1 && se.some((_e) => _e[we] || _e.default)) return !0;
          }
          return !1;
        }
        function q(X) {
        ...
        function M(X) {
          if (X.type !== "VariableDeclarator") return !1;
          let { typeAnnotation: se } = X.id;
          if (!se || !se.typeAnnotation) return !1;
        ...
        function U(X, se, we) {
          ...
          if (it.type === "TSNonNullExpression") return X.call(ae, "expression");
          if (k(it)) {
            if (T(X, se, we).label === "member-chain") return !1;
            let Q = N(it);
        ...
        function pe(X, se) {
          ...
          if (P(X)) return !1;
          let _e = we * R;
          if (X.type === "ThisExpression" || X.type === "Identifier" && X.name.length <= _e || _(X) && !P(X.argument)) return !0;
...
`) : C(X);
        ...
        function fe(X, se) {
          ...
          if (t(we)) {
            ...
            if (we.length === 1) {
              let it = we[0];
              if (it.type === "TSUnionType" || it.type === "UnionTypeAnnotation" || it.type === "TSIntersectionType" || it.type === "IntersectionTypeAnnotation" || it.type === "TSTypeLiteral" || it.type === "ObjectTypeAnnotation") return !0;
            }
        ...
        function f(E, b, S, B, I) {
          ...
          if (G.length === 0) return [M, "(", a(E, S, !0, (pe) => t(S.originalText, pe, J) === ")"), ")"];
        ...
        function J(S) {
          ...
          if (S.type === "UnionTypeAnnotation" || S.type === "TSUnionType") {
            ...
            if (S.types.length - 1 === B && I) return !0;
          }
          return !1;
        }
        function d(S, B, I) {
        ...
        function f(S, B, I) {
          ...
          for (let j = 0; j < G.length; ++j) j === 0 ? M.push(G[j]) : C(q.types[j - 1]) && C(q.types[j]) ? M.push([" & ", te ? c(G[j]) : G[j]]) : !C(q.types[j - 1]) && !C(q.types[j]) ? M.push(c([" &", n, G[j]])) : (j > 1 && (te = !0), M.push(" & ", j > 1 ? c(G[j]) : G[j]));
          return e(M);
        }
        function F(S, B, I) {
        ...
        function _(T, f, F, i) {
          let h = T.getValue();
          if (!h[i]) return "";
          if (!Array.isArray(h[i])) return F(i);
          let E = T.getNode(2), b = E && y(E), S = T.match((I) => !(I[i].length === 1 && w(I[i][0])), void 0, (I, q) => q === "typeAnnotation", (I) => I.type === "Identifier", x);
          if (h[i].length === 0 || !S && (b || h[i].length === 1 && (h[i][0].type === "NullableTypeAnnotation" || N(h[i][0])))) return ["<", a(", ", T.map(F, i)), J(T, f), ">"];
        ...
        function pe(Q, me, Ce, Re) {
          ...
          if (Xe.async && Ye.push("async "), X(Q, me)) Ye.push(Ce(["params", 0]));
          else {
        ...
        function fe(Q, me, Ce, Re) {
          ...
          }(), Ye.length > 1) return be(Q, Re, Ye, Rt, Ct, Xe);
          let It = Ye;
          if (It.push(" =>"), !N(me.originalText, Xe.body) && (Xe.body.type === "ArrayExpression" || Xe.body.type === "ObjectExpression" || Xe.body.type === "BlockStatement" || P(Xe.body) || _(Xe.body, me.originalText) || Xe.body.type === "ArrowFunctionExpression" || Xe.body.type === "DoExpression")) return c([...It, " ", Ct]);
          if (Xe.body.type === "SequenceExpression") return c([...It, c([" (", y([o, Ct]), o, ")"])]);
        ...
        function X(Q, me) {
          if (me.arrowParens === "always") return !1;
        ...
        function se(Q, me, Ce) {
          ...
          if (Re.returnType && x(Ce.originalText, Re.returnType)) return [" /*: ", Xe, " */"];
          let Ye = [Xe];
        ...
        function ae(Q, me) {
          ...
          if (B(me)) {
            let Ce = me, Re;
            for (; Re = I(Ce); ) if (Ce = Re, N(Q.originalText, Ce)) return !0;
          }
          return !1;
        }
        ...
        function D(k, A, N) {
          ...
          if (!t(P) || w(k.getParentNode())) return;
        ...
        function w(k) {
          if (k.type !== "ExportDefaultDeclaration" && k.type !== "ExportNamedDeclaration" && k.type !== "DeclareExportDeclaration") return !1;
        ...
        function f(b, S, B) {
          ...
          if (t(I.specifiers)) {
            ...
            b.each(() => {
              ...
              if (te === "ExportNamespaceSpecifier" || te === "ExportDefaultSpecifier" || te === "ImportNamespaceSpecifier" || te === "ImportDefaultSpecifier") G.push(B());
              else if (te === "ExportSpecifier" || te === "ImportSpecifier") M.push(B());
              else throw new Error(`Unknown specifier type ${JSON.stringify(te)}`);
        ...
        function E(b) {
          if (b.type !== "ImportSpecifier" && b.type !== "ExportSpecifier") return !1;
          let { local: S, [b.type === "ImportSpecifier" ? "imported" : "exported"]: B } = b;
          if (S.type !== B.type || !A(S, B)) return !1;
          if (C(S)) return S.value === B.value && w(S) === w(B);
          switch (S.type) {
            case "Identifier":
        ...
        function T(f, F, i) {
          ...
          if (pe.length === 0) {
            if (!D(E, w.Dangling)) return [j, De, P(f, F, i)];
            Ie = e([j, t(f, F), s, De, x(f), P(f, F, i)]);
          } else Ie = [G && g(E.properties) ? d(q) : "", j, r([F.bracketSpacing ? a : s, ...pe]), n(fe && (te !== "," || p(F)) ? te : ""), F.bracketSpacing ? a : s, De, x(f), P(f, F, i)];
        ...
        function M(j, De, U) {
          ...
          switch (R.type) {
            ...
            case "EnumSymbolBody": {
              ...
              if (R.members.length === 0 && !R.hasUnknownMembers) be.push(o(["{", a(j, De), n, "}"]));
              else {
            ...
            case "TypeParameterInstantiation": {
              ...
              if (De.parser === "flow") {
                ...
                if (se !== -1 && we !== -1) {
                  ...
                  if (_e.startsWith("::") && !_e.includes("/*") && !_e.includes("*/")) return ["/*:: ", fe, " */"];
                }
              }
              return fe;
            }
        ...
        function g(x, P, _, J) {
          ...
          return x.each((i, h, E) => {
            let b = i.getValue();
            if (b.type === "EmptyStatement") return;
            let S = _();
        ...
        function p(x) {
          for (let P = x.length - 1; P >= 0; P--) {
            let _ = x[P];
            if (_.type !== "EmptyStatement") return _;
          }
        }
        function D(x, P) {
        ...
        function N(x, P) {
          ...
          if (!x.computed && _ === "Identifier" && (J === "static" || J === "get" || J === "set" || J === "accessor") && !x.value && !x.typeAnnotation) return !0;
          if (!P || P.static || P.accessibility) return !1;
          if (!P.computed) {
          ...
          switch (P.type) {
            ...
            case "ClassPrivateMethod": {
              if ((P.value ? P.value.async : P.async) || P.kind === "get" || P.kind === "set") return !1;
        ...
        function be(fe, Ie, X) {
          let se = fe.getValue();
          if (!se.type.startsWith("TS")) return;
          if (k(se)) return se.type.slice(2, -7).toLowerCase();
          let we = Ie.semi ? ";" : "", _e = [];
          switch (se.type) {
            case "TSThisType":
              return "this";
...
`);
        ...
        function r(y, m) {
          ...
          switch (g.type) {
            ...
            case "DecimalLiteral":
              return a(g.value) + "m";
            case "Literal": {
              if (g.regex) return c(g.regex);
              if (g.bigint) return o(g.raw);
              if (g.decimal) return a(g.decimal) + "m";
              let { value: p } = g;
        ...
        function K(tt, ht, Ke, pr) {
          ...
          if (Dt === "ClassMethod" || Dt === "ClassPrivateMethod" || Dt === "ClassProperty" || Dt === "ClassAccessorProperty" || Dt === "AccessorProperty" || Dt === "TSAbstractAccessorProperty" || Dt === "PropertyDefinition" || Dt === "TSAbstractPropertyDefinition" || Dt === "ClassPrivateProperty" || Dt === "MethodDefinition" || Dt === "TSAbstractMethodDefinition" || Dt === "TSDeclareMethod") return dt;
          let Tt = [dt], jt = v(tt, ht, Ke), tr = ar.type === "ClassExpression" && jt;
          if (jt && (Tt = [...jt, dt], !tr)) return o(Tt);
          if (!C(tt, ht)) return pr && pr.needsSemi && Tt.unshift(";"), Tt.length === 1 && Tt[0] === dt ? dt : Tt;
          ...
          switch (dt.type) {
            ...
            case "ExpressionStatement": {
              if (ht.parser === "__vue_event_binding" || ht.parser === "__vue_ts_event_binding") {
                ...
                if (jt.type === "Program" && jt.body.length === 1 && jt.body[0] === dt) return [Ke("expression"), S(dt.expression) ? ";" : ""];
              }
              let Tt = t(tt, ht, !0, (jt) => {
                let { marker: tr } = jt;
                return tr === F;
            ...
            case "AwaitExpression": {
              if (Dt.push("await"), dt.argument) {
                ...
                if (T(Tt) && Tt.callee === dt || f(Tt) && Tt.object === dt) {
                  ...
                  if (!jt || jt.type !== "AwaitExpression") return o(Dt);
                }
              }
              return Dt;
            }
        ...
        function c(y, m) {
          ...
          if (g === "UnaryExpression" && y.operator === "+") return m.argument;
          if (g === "ArrayExpression") {
            for (let [p, D] of y.elements.entries()) D === null && m.elements.splice(p, 0, { type: "NullLiteral" });
            return;
          }
        ...
        function e(n, o, c) {
          if (t(n) && n.lang === "yaml" && delete o.value, n.type === "css-comment" && c.type === "css-root" && c.nodes.length > 0 && ((c.nodes[0] === n || t(c.nodes[0]) && c.nodes[1] === n) && (delete o.text, /^\*\s*@(?:format|prettier)\s*$/.test(n.text)) || c.type === "css-root" && a(c.nodes) === n)) return null;
          ...
          if (n.type === "value-comma_group" && n.groups.some((y) => y.type === "value-atword" && y.value.endsWith("[") || y.type === "value-word" && y.value.startsWith("]"))) return { type: "value-atword", value: n.groups.map((y) => y.value).join(""), group: { open: null, close: null, groups: [], type: "value-paren_group" } };
        }
...
` : "") + t.insertPragma(o);
        ...
        function a(ae, Q) {
          ...
          for (; Re = ae.getParentNode(++Ce); ) if (me.includes(Re.type)) return Ce;
          return -1;
        }
        function s(ae, Q) {
          let me = a(ae, Q);
        ...
        function te(ae) {
          var Q;
          let me = ae.getValue();
          if (me.groups.length === 0) return !1;
          let Ce = ae.getParentNode(1);
          if (!M(me) && !(Ce && M(Ce))) return !1;
        ...
        function _e(ae, Q) {
          var me, Ce;
          if (((me = ae.open) === null || me === void 0 ? void 0 : me.value) !== "(" || ((Ce = ae.close) === null || Ce === void 0 ? void 0 : Ce.value) !== ")" || ae.groups.some((Re) => Re.type !== "value-comma_group")) return !1;
          if (Q.type === "value-comma_group") {
            let Re = Q.groups.indexOf(ae) - 1, Xe = Q.groups[Re];
            if ((Xe == null ? void 0 : Xe.type) === "value-word" && Xe.value === "with") return !0;
          }
          return !1;
        }
        function it(ae) {
        ...
        ue(), l.exports = function(t, a) {
          let s = 0;
          for (let e = 0; e < t.line - 1; ++e) s = a.indexOf(`
`, s) + 1;
          return s + t.column;
        };
...
` || x === "\r") && (k && A.push([w, N]), D = "initial", k = !1);
          ...
          for (let [N, x] of A) p = p.slice(0, N) + p.slice(N, x).replace(/["'*]/g, " ") + p.slice(x);
          return p;
        }
        function m(p) {
        ...
        function ze(ft, Pt, Bt) {
          ...
          switch (Te.type) {
            ...
            case "css-atrule": {
              ...
              if (Le(Pt)) {
                if (Te.mixin) return [Bt("selector"), Te.important ? " !important" : "", Wt ? "" : ";"];
                if (Te.function) return [Te.name, Bt("params"), Wt ? "" : ";"];
                if (Te.variable) return ["@", Te.name, ": ", Te.value ? Bt("value") : "", Te.raws.between.trim() ? Te.raws.between.trim() + " " : "", Te.nodes ? ["{", C([Te.nodes.length > 0 ? g : "", tt(ft, Pt, Bt)]), g, "}"] : "", Wt ? "" : ";"];
              }
            ...
            case "selector-unknown": {
              ...
              if (Xt && Xt.isSCSSNesterProperty) return jt(Dt(f(Te.value), Pt));
            ...
            case "value-comma_group": {
              ...
              for (let Gr = 0; Gr < Te.groups.length; ++Gr) {
                ...
                if (h(ft, "forward") && Nt.type === "value-word" && Nt.value && Cr !== void 0 && Cr.type === "value-word" && Cr.value === "as" && Mt.type === "value-operator" && Mt.value === "*" || !Mt || Nt.type === "value-word" && Nt.value.endsWith("-") && ke(Mt)) continue;
            ...
            case "value-paren_group": {
              ...
              if (Xt && fe(Xt) && (Te.groups.length === 1 || Te.groups.length > 0 && Te.groups[0].type === "value-comma_group" && Te.groups[0].groups.length > 0 && Te.groups[0].groups[0].type === "value-word" && Te.groups[0].groups[0].value.startsWith("data:"))) return [Te.open ? Bt("open") : "", c(",", ft.map(Bt, "groups")), Te.close ? Bt("close") : ""];
              if (!Te.open) {
                let jr = ft.map(Bt, "groups"), cr = [];
                for (let Tr = 0; Tr < jr.length; Tr++) Tr !== 0 && cr.push([",", y]), cr.push(jr[Tr]);
                return p(C(D(cr)));
              }
        ...
        function h(H, ke, oe) {
          let Be = H.getValue();
          if (!Be) return "";
          if (x(H)) return ke.originalText.slice(C(Be), w(Be));
          ...
          switch (Be.type) {
            ...
            case "AttrNode": {
              ...
              if (ut && Be.value.chars === "" && C(Be.value) === w(Be.value)) return Be.name;
            ...
            case "TextNode": {
              ...
              if ((K || ye) && v && d(H, ["Block", "ElementNode", "Template"])) return "";
        ...
        function Q(H) {
          for (let ke = 0; ke < 2; ke++) {
            ...
            if (oe && oe.type === "AttrNode") return oe.name.toLowerCase();
          }
        }
        function me(H) {
...
`).length - 1;
        ...
        function Ct(H) {
          ...
          for (; oe && J(oe, ["SubExpression"]); ) ke++, oe = H.getParentNode(ke);
...
` : " " });
            ...
            for (let [E, b] of h.entries()) if (!((E === 0 || E === h.length - 1) && b === "")) {
              if (E % 2 === 0) {
...
` + N.value, position: { start: A.position.start, end: N.position.end } }));
        ...
        function C(k, A) {
          return s(k, (N, x, P) => {
            if (N.type === "code") {
              ...
              if (N.isIndented = _, _) for (let J = 0; J < P.length; J++) {
                let d = P[J];
        ...
        function w(k, A) {
          return s(k, (P, _, J) => {
            if (P.type === "list" && P.children.length > 0) {
              for (let d = 0; d < J.length; d++) {
                let T = J[d];
                if (T.type === "list" && !T.isAligned) return P.isAligned = !1, P;
              }
              P.isAligned = x(P);
            }
            return P;
          ...
          function x(P) {
            if (!P.ordered) return !0;
            let [_, J] = P.children;
            if (a(_, A.originalText).leadingSpaces.length > 1) return !0;
            let d = N(_);
            if (d === -1) return !1;
            if (P.children.length === 1) return d % A.tabWidth === 0;
            let T = N(J);
        ...
        function De(xe, H, ke) {
          let oe = xe.getValue();
          if (Xe(xe)) return S(H.originalText.slice(oe.position.start.offset, oe.position.end.offset), H).map((Be) => Be.type === "word" ? Be.value : Be.value === "" ? "" : X(xe, Be.value, H));
          switch (oe.type) {
            case "front-matter":
            ...
            case "emphasis": {
              let Be;
              if (G(oe.children[0])) Be = H.originalText[oe.position.start.offset];
              else {
            ...
            case "list": {
              ...
              return _e(xe, H, ke, { processor: (ut, Le) => {
                ...
                if (K.children.length === 2 && K.children[1].type === "html" && K.children[0].position.start.column !== K.children[1].position.start.column) return [v, U(ut, H, ke, v)];
        ...
        function U(xe, H, ke, oe) {
          ...
          return [pt, _e(xe, H, ke, { processor: (ut, Le) => {
            if (Le === 0 && ut.getValue().type !== "list") return k(" ".repeat(pt.length), ke());
        ...
        function be(xe, H, ke) {
          let oe = -1;
          for (let Be of H.children) if (Be.type === xe.type && ke(Be) ? oe++ : oe = -1, Be === xe) return oe;
        }
        function fe(xe, H) {
          let ke = Array.isArray(H) ? H : [H], oe = -1, Be;
          for (; Be = xe.getParentNode(++oe); ) if (ke.includes(Be.type)) return oe;
          return -1;
        }
        function Ie(xe, H) {
          let ke = fe(xe, H);
...
`) return p;
        ...
        function se(xe, H, ke) {
          ...
          if (H.proseWrap !== "never") return [o, ut];
          let Le = v(!0);
          return [o, N(C(Le, ut))];
          function v(ze) {
        ...
        function we(xe, H, ke) {
          ...
          for (let [ut, Le] of pt.entries()) switch (Q(Le)) {
            case "start":
          ...
          return _e(xe, H, ke, { processor: (ut, Le) => {
            if (oe.length > 0) {
              let v = oe[0];
              if (Le === v.start.index) return [it(pt[v.start.index]), H.originalText.slice(v.start.offset, v.end.offset), it(pt[v.end.index])];
              if (v.start.index < Le && Le < v.end.index) return !1;
              if (Le === v.end.index) return oe.shift(), !1;
            }
            return ke();
          } });
        }
        ...
        function it(xe) {
          if (xe.type === "html") return xe.value;
          if (xe.type === "paragraph" && Array.isArray(xe.children) && xe.children.length === 1 && xe.children[0].type === "esComment") return ["{/* ", xe.children[0].value, " */}"];
        }
        function ae(xe) {
          let H = xe;
          for (; n(H.children); ) H = a(H.children);
          return H;
        }
        function Q(xe) {
          let H;
          if (xe.type === "html") H = xe.value.match(/^<!--\s*prettier-ignore(?:-(start|end))?\s*-->$/);
          else {
            let ke;
        ...
        function Ct(xe, H) {
          ...
          if (!xe) return "";
          if (ke) return " " + Ct(xe, H, !1);
          if (xe = xe.replace(/\\(["')])/g, "$1"), xe.includes('"') && xe.includes("'") && !xe.includes(")")) return `(${xe})`;
...
`, "\f", "\r", " "]), C = (v) => v.replace(/^[\t\n\f\r ]+/, ""), w = (v) => v.replace(/[\t\n\f\r ]+$/, ""), k = (v) => C(w(v)), A = (v) => v.replace(/^[\t\f\r ]*\n/g, ""), N = (v) => A(w(v)), x = (v) => v.split(/[\t\n\f\r ]+/), P = (v) => v.match(/^[\t\n\f\r ]*/)[0], _ = (v) => {
        ...
        function S(v, K) {
          let ye = ze();
          if (ye && !v.prev && v.parent && v.parent.tagDefinition && v.parent.tagDefinition.ignoreFirstLf) return v.type === "interpolation";
          return ye;
          function ze() {
        ...
        function Ie(v) {
          ...
          if (K === "module" || K === "text/javascript" || K === "text/babel" || K === "application/javascript" || ye === "jsx") return "babel";
          if (K === "application/x-typescript" || ye === "ts" || ye === "tsx") return "typescript";
          if (K === "text/markdown") return "markdown";
          if (K === "text/html") return "html";
          if (K && (K.endsWith("json") || K.endsWith("importmap")) || K === "speculationrules") return "json";
          if (K === "text/x-handlebars-template") return "glimmer";
        }
        function X(v, K) {
          let { lang: ye } = v.attrMap;
          if (!ye || ye === "postcss" || ye === "css") return "css";
          if (ye === "scss") return "scss";
          if (ye === "less") return "less";
          if (ye === "stylus") return t("stylus", K);
        }
        function se(v, K) {
          if (v.name === "script" && !v.attrMap.src) return !v.attrMap.lang && !v.attrMap.type ? "babel" : Ie(v);
          if (v.name === "style") return X(v, K);
          if (K && oe(v, K)) return Ie(v) || !("src" in v.attrMap) && t(v.attrMap.lang, K);
        }
        function we(v) {
        ...
        function Ye(v, K) {
          ...
          let ye = !1;
          if (v.type === "element" && v.namespace === "svg") if (Xe(v, (ze) => ze.fullName === "svg:foreignObject")) ye = !0;
...
`);
        ...
        function Et(v, K) {
          let ye = 0;
          for (let ze = 0; ze < v.length; ze++) v[ze] === K && ye++;
          return ye;
        }
        function bt(v) {
        ...
        function t(i) {
          return i.replace(l, function() {
            for (var h = arguments.length, E = new Array(h), b = 0; b < h; b++) E[b] = arguments[b];
        ...
        u.ValueTransformer = c, u.SyncAsync = { assertSync: (i) => {
          if (_(i)) throw new Error("Illegal state: value cannot be a promise");
          return i;
        ...
        function x(i) {
          ...
          if (i instanceof Array) return "[" + i.map(x).join(", ") + "]";
          if (i == null) return "" + i;
...
`);
        ...
        function r(E) {
          ...
          let b = E.reference;
          if (b instanceof l.StaticSymbol) return b.name;
        ...
        var w = class {
          constructor(E) {
            ...
            if (this.encapsulation = b, this.template = S, this.templateUrl = B, this.htmlAst = I, this.styles = _(q), this.styleUrls = _(G), this.externalStylesheets = _(M), this.animations = te ? d(te) : [], this.ngContentSelectors = j || [], De && De.length != 2) throw new Error("'interpolation' should have a start and an end symbol.");
        ...
        var l = Bo(), t = _o(), a = class {
          ...
          moveBy(y) {
            ...
            for (; p > 0 && y < 0; ) if (p--, y++, m.charCodeAt(p) == l.$LF) {
              D--;
...
`) {
        ...
        function k(i) {
          ...
          i.walk((E) => {
            if (E.children) for (let b = 0; b < E.children.length; b++) {
              let S = E.children[b];
              if (!h(S)) continue;
        ...
        function A(i, h, E) {
          i.walk((b) => {
            if (b.children) for (let S = 0; S < b.children.length; S++) {
              let B = b.children[S];
        ...
        function P(i, h) {
          ...
          let E = /{{(.+?)}}/s;
          i.walk((b) => {
            if (r(b)) for (let S of b.children) {
        ...
        function _(i) {
          i.walk((h) => {
            ...
            let E = g(h), b = c(h);
            if (!E) for (let S = 0; S < h.children.length; S++) {
              let B = h.children[S];
        ...
        function f(i, h) {
          i.walk((E) => {
            ...
            if (b) {
              ...
              for (let S of b) S.isLeadingSpaceSensitive = y(S, h), S.isTrailingSpaceSensitive = m(S, h);
              for (let S = 0; S < b.length; S++) {
                let B = b[S];
...
` + s.replace(/^\s*\n/, "");
        ...
        function J(j, De) {
          if (t(!j.isSelfClosing), T(j, De)) return "";
          switch (j.type) {
            case "ieConditionalComment":
              return "<!";
            case "element":
              if (j.hasHtmComponentClosingTag) return "<//";
            default:
              return `</${j.rawName}`;
          }
        }
        ...
        function S(j, De, U) {
          let R = j.getValue();
          if (!a(R.attrs)) return R.isSelfClosing ? " " : "";
        ...
        function M(j) {
          switch (j.type) {
            ...
            case "docType":
              return "<!DOCTYPE";
            case "element":
              if (j.condition) return `<!--[if ${j.condition}]><!--><${j.rawName}`;
            default:
              return `<${j.rawName}`;
          }
        }
...
` || J === "\f" || J === "\r";
            ...
            function P() {
              for (r(o), w = "", k = "in descriptor"; ; ) {
                if (A = t.charAt(N), k === "in descriptor") if (e(A)) w && (C.push(w), w = "", k = "after descriptor");
                else if (A === ",") {
                  N += 1, w && C.push(w), _();
                  return;
                } else if (A === "(") w = w + A, k = "in parens";
                else if (A === "") {
                  w && C.push(w), _();
                  return;
                } else w = w + A;
                else if (k === "in parens") if (A === ")") w = w + A, k = "in descriptor";
                else if (A === "") {
                  C.push(w), _();
                  return;
                } else w = w + A;
                else if (k === "after descriptor" && !e(A)) if (A === "") {
                  _();
                  return;
                } else k = "in descriptor", N -= 1;
                N += 1;
              }
            }
            function _() {
              var J = !1, d, T, f, F, i = {}, h, E, b, S, B;
              for (F = 0; F < C.length; F++) h = C[F], E = h[h.length - 1], b = h.substring(0, h.length - 1), S = parseInt(b, 10), B = parseFloat(b), g.test(b) && E === "w" ? ((d || T) && (J = !0), S === 0 ? J = !0 : d = S) : p.test(b) && E === "x" ? ((d || T || f) && (J = !0), B < 0 ? J = !0 : T = B) : g.test(b) && E === "h" ? ((f || T) && (J = !0), S === 0 ? J = !0 : f = S) : J = !0;
        ...
        function r(o) {
          ...
          if (y + m + g > 1) throw new Error("Mixed descriptor in srcset is not supported");
        ...
        function s(n) {
          ...
          if (!C.some((w, k) => !w && (k === 0 || C.slice(k + 1).some(Boolean)))) return { left: C.filter(Boolean).join(","), operator: m[2], right: g.for };
        }
        function e(n, o) {
        ...
        function S(I, q, G) {
          ...
          if (I.fullName === "srcset" && (I.parent.fullName === "img" || I.parent.fullName === "source")) return R(k(te()));
          if (I.fullName === "class" && !G.parentParser) {
            let fe = te();
            if (!fe.includes("{{")) return A(fe);
          }
          if (I.fullName === "style" && !G.parentParser) {
            let fe = te();
            if (!fe.includes("{{")) return R(be(fe, { parser: "css", __isHTMLStyleAttribute: !0 }));
          }
          if (G.parser === "vue") {
            if (I.fullName === "v-for") return N(te(), be);
            if (i(I) || h(I, G)) return x(te(), be);
            ...
            if (M(Ie)) return pe(be(te(), { parser: "__vue_expression" }));
            if (M(X)) return pe(be(te(), { parser: "__js_expression" }));
          }
          if (G.parser === "angular") {
            ...
            if (M(X)) return pe(fe(te(), { parser: "__ng_action" }));
            if (M(se)) return pe(fe(te(), { parser: "__ng_binding" }));
            if (M(we)) {
              let ae = te().trim();
              return R(n(E(I, ae)), !ae.includes("@@"));
            }
            if (M(Ie)) return pe(fe(te(), { parser: "__ng_directive" }));
            let _e = /{{(.+?)}}/s, it = te();
            if (_e.test(it)) {
              let ae = [];
              for (let [Q, me] of it.split(_e).entries()) if (Q % 2 === 0) ae.push(y(me));
              else try {
        ...
        function B(I, q, G, M) {
          ...
          switch (te.type) {
            case "element": {
              if (_(te) || te.type === "interpolation") return;
            ...
            case "attribute": {
              if (!te.value) break;
              if (/^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/.test(M.originalText.slice(te.valueSpan.start.offset, te.valueSpan.end.offset))) return [te.rawName, "=", te.value];
              if (M.parser === "lwc" && /^{.*}$/s.test(M.originalText.slice(te.valueSpan.start.offset, te.valueSpan.end.offset))) return [te.rawName, "=", te.value];
              let j = S(te, (De, U) => G(De, Object.assign({ __isInHtmlAttribute: !0, __embeddedInHtml: !0 }, U), { stripTrailingHardline: !0 }), M);
              if (j) return [te.rawName, '="', a(c(j, (De) => typeof De == "string" ? De.replace(/"/g, "&quot;") : De)), '"'];
              break;
            }
            case "front-matter":
              return m(te, G);
        ...
        function T(f, F, i) {
          ...
          return f.map((b, S) => {
            ...
            if (p(B)) {
              if (B.prev && p(B.prev)) {
                let De = d(B.prev, B);
                if (De) return g(B.prev) ? [n, n, J(b, F, i)] : [De, J(b, F, i)];
              }
              return J(b, F, i);
            }
        ...
        function d(T, f, F) {
          let i = T.getValue();
          if (g(i, f)) return [k(i, f), s(A(T, f, F)), ...y(m(i, f)), ...x(i, f), N(i, f)];
...
${e}`;
        ...
        ue();
        function t(a, s, e, r) {
          if (a.getValue().type === "root" && r.filepath && /(?:[/\\]|^)\.(?:prettier|stylelint|lintstaged)rc$/.test(r.filepath)) return e(r.originalText, Object.assign(Object.assign({}, r), {}, { parser: "json" }));
        }
        l.exports = t;
...
`).map((i, h, E) => h === 0 && h === E.length - 1 ? i : h !== 0 && h !== E.length - 1 ? i.trim() : h === 0 ? i.trimEnd() : i.trimStart());
        ...
        function _(d, T) {
          ...
          let b = h.split(`
`).map((B) => B.slice(E));
          if (i.proseWrap === "preserve" || d.type === "blockLiteral") return S(b.map((B) => B.length === 0 ? [] : [B]));
          ...
          function S(B) {
            ...
            let I = 0;
            for (let q = B.length - 1; q >= 0 && B[q].length === 0; q--) I++;
        ...
        function w(x, P, _, J, d) {
          ...
          if (F && i) return ": ";
          let h = J("key"), E = A(x) ? " " : "";
          if (i) return x.type === "flowMappingItem" && P.type === "flowMapping" ? h : x.type === "mappingItem" && k(T.content, d) && !y(T.content) && (!P.tag || P.tag.value !== "tag:yaml.org,2002:set") ? [h, E, ":"] : ["? ", C(2, h)];
          let b = J("value");
          if (F) return [": ", C(2, b)];
          if (o(f) || !D(T.content)) return ["? ", C(2, h), s, r("", _.map(J, "value", "leadingComments").map((M) => [M, s])), ": ", C(2, b)];
          if (N(T.content) && !o(T.content) && !c(T.content) && !y(T.content) && !m(T) && !o(f.content) && !c(f.content) && !m(f) && k(f.content, d)) return [h, E, ": ", b];
        ...
        function k(x, P) {
          ...
          if (P.proseWrap === "preserve") return x.position.start.line === x.position.end.line;
          if (/\\$/m.test(P.originalText.slice(x.position.start.offset, x.position.end.offset))) return !1;
          switch (P.proseWrap) {
            case "never":
...
`);
        ...
        function k(A, N, x) {
          ...
          for (let [F, i] of T.entries()) F === 0 && f.push(e), f.push(s(y(r(n, i)))), F !== T.length - 1 ? f.push(i.length === 0 ? e : c(o)) : P.chomping === "keep" && J && f.push(a(i.length === 0 ? e : o));
        ...
        function G(R, pe, be, fe, Ie) {
          switch (R.type) {
            ...
            case "quoteSingle": {
              ...
              if (we.includes(se)) return [X, De(R.type, R.type === "quoteDouble" ? we.replace(/\\"/g, se).replace(/'/g, X.repeat(2)) : we, fe), X];
              if (we.includes(X)) return [se, De(R.type, R.type === "quoteSingle" ? we.replace(/''/g, X) : we, fe), se];
        ...
        function U(R, pe) {
          if (T(pe)) switch (delete pe.position, pe.type) {
            case "comment":
              if (D(pe.value)) return null;
              break;
            case "quoteDouble":
            case "quoteSingle":
              pe.type = "quote";
...
function ml(Jr) {
  for (var Xr = [], Ae = 1; Ae < arguments.length; Ae++) Xr[Ae - 1] = arguments[Ae];
