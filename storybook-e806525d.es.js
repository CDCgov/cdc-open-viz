import { c as T, g as Ye } from "./storybook-c5d32002.es.js";
import { r as be, R as x } from "./storybook-e61d95ab.es.js";
var Z = {}, J = {};
(function(e) {
...
function Q(e, t) {
  ...
  if (Ne(e))
    ...
    var n = t ? G(e.children) : [], a = new ke(e.name, N({}, e.attribs), n);
    ...
    var n = t ? G(e.children) : [], l = new we(n);
    n.forEach(function(s) {
      return s.parent = l;
    }), r = l;
  } else if (Ie(e)) {
    var n = t ? G(e.children) : [], c = new Oe(n);
    n.forEach(function(s) {
      return s.parent = c;
...
var oe = "html", le = "head", P = "body", Je = /<([a-zA-Z]+[0-9]?)/, se = /<head[^]*>/i, ce = /<body[^]*>/i, I = function() {
  throw new Error(
...
function et(e) {
  ...
  switch (t) {
    ...
    case le:
    case P:
      return n = I(e), l = n.querySelectorAll(t), ce.test(e) && se.test(e) ? l[0].parentNode.childNodes : l;
    default:
      return Y ? Y(e) : (a = I(e, P).querySelector(P), a.childNodes);
  }
}
var tt = et, ee = {}, De = {};
...
var F = Z, rt = De, fe = rt.CASE_SENSITIVE_TAG_NAMES, nt = F.Comment, it = F.Element, at = F.ProcessingInstruction, ot = F.Text, Me = {}, X;
...
function Fe(e, t, r) {
  ...
  for (var n = [], a, l = 0, c = e.length; l < c; l++) {
    ...
    switch (o.nodeType) {
      case 1:
        a = ct(o.nodeName), i = new it(a, Le(o.attributes)), i.children = Fe(
...
var je = 0, S = 1, H = 2, z = 3, te = 4, He = 5, ze = 6;
function Ct(e) {
  return m.hasOwnProperty(e) ? m[e] : null;
}
function v(e, t, r, n, a, l, c) {
  this.acceptsBooleans = t === H || t === z || t === te, this.attributeName = n, this.attributeNamespace = a, this.mustUseProperty = r, this.propertyName = e, this.type = t, this.sanitizeURL = l, this.removeEmptyString = c;
}
var m = {}, St = [
  "children",
...
var ie = j, Ot = ie.CAMELCASE, kt = ie.SAME, de = ie.possibleStandardNames, At = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", _t = At + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", Nt = RegExp.prototype.test.bind(
  // eslint-disable-next-line no-misleading-character-class
  new RegExp("^(data|aria)-[" + _t + "]*$")
), Pt = Object.keys(de).reduce(function(e, t) {
  var r = de[t];
  return r === kt ? e[t] = t : r === Ot ? e[t.toLowerCase()] = t : e[t] = r, e;
}, {});
y.BOOLEAN = z;
y.BOOLEANISH_STRING = H;
y.NUMERIC = He;
...
y.possibleStandardNames = Pt;
var Be = {}, ae = { exports: {} }, he = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g, Rt = /\n/g, It = /^\s*/, Dt = /^(\*?[-#/*\\\w]+(\[[0-9a-z_-]+\])?)\s*/, Mt = /^:\s*/, Lt = /^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};])+)/, Ft = /^[;\s]*/, jt = /^\s+|\s+$/g, Ht = `
`, me = "/", ve = "*", w = "", zt = "comment", Bt = "declaration", Vt = function(e, t) {
  if (typeof e != "string")
    throw new TypeError("First argument must be a string");
  if (!e)
    return [];
  ...
  function h() {
    ...
    if (!(me != e.charAt(0) || ve != e.charAt(1))) {
      for (var u = 2; w != e.charAt(u) && (ve != e.charAt(u) || me != e.charAt(u + 1)); )
        ++u;
      if (u += 2, w === e.charAt(u - 1))
  ...
  function A() {
    ...
    if (u) {
      ...
      var E = i(Lt), qe = d({
        type: Bt,
        property: ge(u[0].replace(he, w)),
        value: E ? ge(E[0].replace(he, w)) : w
      });
      return i(Ft), qe;
    }
  }
...
var Ge = {
...
}, _ = y, Ee = Ge, lr = ["checked", "value"], sr = ["input", "select", "textarea"], cr = {
  reset: !0,
  submit: !0
}, $e = function(t, r) {
  t = t || {};
  ...
  for (n in t) {
    if (l = t[n], _.isCustomAttribute(n)) {
      i[n] = l;
      continue;
    }
    if (a = n.toLowerCase(), c = Te(a), c) {
      switch (o = _.getPropertyInfo(c), lr.indexOf(c) !== -1 && sr.indexOf(r) !== -1 && !s && (c = Te("default" + a)), i[c] = l, o && o.type) {
        case _.BOOLEAN:
          i[c] = !0;
          break;
        case _.OVERLOADED_BOOLEAN:
          l === "" && (i[c] = !0);
          break;
      }
      continue;
...
function Te(e) {
  return _.possibleStandardNames[e];
}
var ur = be, fr = $e, D = Ge, pr = D.setStyleProp, dr = D.canTextBeChildOfNode;
function Xe(e, t) {
  t = t || {};
  for (var r = t.library || ur, n = r.cloneElement, a = r.createElement, l = r.isValidElement, c = [], o, i, s = typeof t.replace == "function", p, h, A, U = t.trim, d = 0, u = e.length; d < u; d++) {
    ...
    if (o.type === "text") {
      if (i = !o.data.trim().length, i && o.parent && !dr(o.parent) || U && i)
        continue;
      c.push(o.data);
      continue;
    }
    switch (h = o.attribs, hr(o) ? pr(h.style, h) : h && (h = fr(h, o.name)), A = null, o.type) {
      case "script":
      case "style":
        ...
        break;
      case "tag":
        o.name === "textarea" && o.children[0] ? h.defaultValue = o.children[0].data : o.children && o.children.length && (A = Xe(o.children, t));
        break;
      default:
        continue;
    }
    u > 1 && (h.key = d), c.push(a(o.name, h, A));
  }
  return c.length === 1 ? c[0] : c;
}
function hr(e) {
  return D.PRESERVE_CUSTOM_ATTRIBUTES && e.type === "tag" && D.isCustomComponent(e.name, e.attribs);
}
var mr = Xe, V = Z, k = mt, vr = $e, We = mr;
...
b.Comment = V.Comment;
b.Element = V.Element;
b.ProcessingInstruction = V.ProcessingInstruction;
b.Text = V.Text;
var yr = b;
b.default = b;
const O = /* @__PURE__ */ Ye(yr);
O.domToReact;
O.htmlToDOM;
O.attributesToProps;
O.Comment;
...
class br extends x.Component {
  ...
  render() {
    return this.state.hasError ? this.props.component ? /* @__PURE__ */ x.createElement("h1", null, "Something went wrong with component ", this.props.component, ".") : /* @__PURE__ */ x.createElement("h1", null, "Something went wrong.") : this.props.children;
  }
}
function xr({ viewport: e = "lg" }) {
  return /* @__PURE__ */ x.createElement("section", { className: "loading", "aria-live": "assertive" }, /* @__PURE__ */ x.createElement("span", { className: "sr-only", style: { display: "none" } }, "Content is loading."), /* @__PURE__ */ x.createElement("div", { className: `la-ball-beat la-dark ${e}` }, /* @__PURE__ */ x.createElement("div", null), /* @__PURE__ */ x.createElement("div", null), /* @__PURE__ */ x.createElement("div", null)));
}
export {
  br as E,
  O as H,
