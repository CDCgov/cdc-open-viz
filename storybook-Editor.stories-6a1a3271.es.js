import { j as M, a as an, F as Re } from "./storybook-jsx-runtime-36872362.es.js";
import { r as A, R as ir } from "./storybook-index-45401197.es.js";
import { f as La, i as da, a as Ao, b as br, g as Ar } from "./storybook-getViewport-7dc50c16.es.js";
import { M as Dr, d as Rr, a as ka, G as Nr, O as Tr } from "./storybook-CdcDashboard-26d84891.es.js";
import { a as dt, E as Et } from "./storybook-CdcChartComponent-9f3340f1.es.js";
import { P as Qn } from "./storybook-index-43433e35.es.js";
import { G as lr, f as sr } from "./storybook-InputToggle-c9edfa1b.es.js";
import { a as Pr, C as Ir } from "./storybook-CdcMarkupInclude-49ce5edf.es.js";
import { D as Lr } from "./storybook-DataTransform-12e90958.es.js";
import { c as cr } from "./storybook-_commonjsHelpers-c5d32002.es.js";
import { a as ma, c as Oa, d as kr, e as Or, f as Br, g as Er, h as Hr, i as Fr, j as Ba, k as Wr, l as xr } from "./storybook-Icon-5df8fab3.es.js";
import { D as Gr } from "./storybook-DataDesigner-246dc688.es.js";
import { T as Ne } from "./storybook-Tooltip-b155742f.es.js";
import { S as Vr, C as Kr } from "./storybook-CdcMap-7db2b0aa.es.js";
import { C as qr } from "./storybook-CdcChart-04272cca.es.js";
import { C as zr } from "./storybook-CdcDataBite-adc584d9.es.js";
import { C as _r } from "./storybook-CdcWaffleChart-186907b0.es.js";
import { E as ct } from "./storybook-viewports-678eca6e.es.js";
import { _ as ha } from "./storybook-lodash-a4231e1c.es.js";
import { w as Xr, u as Yr } from "./storybook-index-73510294.es.js";
...
import "./storybook-DashboardFilters-dc074c87.es.js";
import "./storybook-Footnotes-3a1f1a4d.es.js";
...
import "./storybook-BlurStrokeText-7561b486.es.js";
import "./storybook-Card-060dcfc3.es.js";
import "./storybook-supported-geos-c96b4fa3.es.js";
import "./storybook-index-398c73a4.es.js";
var Ea = {}, Ca = {}, pa = 34, kt = 10, fa = 13;
function yr(o) {
  return new Function("d", "return {" + o.map(function(C, s) {
    return JSON.stringify(C) + ": d[" + s + '] || ""';
  }).join(",") + "}");
}
function jr(o, C) {
  var s = yr(o);
...
function Ha(o) {
  var C = /* @__PURE__ */ Object.create(null), s = [];
...
function Me(o, C) {
  var s = o + "", d = s.length;
  return d < C ? new Array(C - d + 1).join(0) + s : s;
}
function Ur(o) {
  return o < 0 ? "-" + Me(-o, 6) : o > 9999 ? "+" + Me(o, 6) : Me(o, 4);
}
function Jr(o) {
  var C = o.getUTCHours(), s = o.getUTCMinutes(), d = o.getUTCSeconds(), b = o.getUTCMilliseconds();
  return isNaN(o) ? "Invalid Date" : Ur(o.getUTCFullYear()) + "-" + Me(o.getUTCMonth() + 1, 2) + "-" + Me(o.getUTCDate(), 2) + (b ? "T" + Me(C, 2) + ":" + Me(s, 2) + ":" + Me(d, 2) + "." + Me(b, 3) + "Z" : d ? "T" + Me(C, 2) + ":" + Me(s, 2) + ":" + Me(d, 2) + "Z" : s || C ? "T" + Me(C, 2) + ":" + Me(s, 2) + "Z" : "");
}
function $r(o) {
  var C = new RegExp('["' + o + `
\r]`), s = o.charCodeAt(0);
  function d(w, ln) {
    var Tn, Cn, gn = b(w, function(zn, Sn) {
      if (Tn)
        return Tn(zn, Sn - 1);
      Cn = zn, Tn = ln ? jr(zn, ln) : yr(zn);
    });
    return gn.columns = Cn || [], gn;
  }
  function b(w, ln) {
    var Tn = [], Cn = w.length, gn = 0, zn = 0, Sn, Wn = Cn <= 0, Dn = !1;
    w.charCodeAt(Cn - 1) === kt && --Cn, w.charCodeAt(Cn - 1) === fa && --Cn;
    function Jn() {
      if (Wn)
        return Ca;
      if (Dn)
        return Dn = !1, Ea;
      var Rn, ae = gn, qn;
      if (w.charCodeAt(ae) === pa) {
        for (; gn++ < Cn && w.charCodeAt(gn) !== pa || w.charCodeAt(++gn) === pa; )
          ;
        return (Rn = gn) >= Cn ? Wn = !0 : (qn = w.charCodeAt(gn++)) === kt ? Dn = !0 : qn === fa && (Dn = !0, w.charCodeAt(gn) === kt && ++gn), w.slice(ae + 1, Rn - 1).replace(/""/g, '"');
      }
      for (; gn < Cn; ) {
        if ((qn = w.charCodeAt(Rn = gn++)) === kt)
          Dn = !0;
        else if (qn === fa)
          Dn = !0, w.charCodeAt(gn) === kt && ++gn;
        else if (qn !== s)
          continue;
        return w.slice(ae, Rn);
      }
      return Wn = !0, w.slice(ae, Cn);
    }
    for (; (Sn = Jn()) !== Ca; ) {
      for (var xn = []; Sn !== Ea && Sn !== Ca; )
        xn.push(Sn), Sn = Jn();
      ln && (xn = ln(xn, zn++)) == null || Tn.push(xn);
    }
    return Tn;
  }
  function P(w, ln) {
    return w.map(function(Tn) {
      return ln.map(function(Cn) {
        return fn(Tn[Cn]);
      }).join(o);
    });
  }
  function y(w, ln) {
    return ln == null && (ln = Ha(w)), [ln.map(fn).join(o)].concat(P(w, ln)).join(`
`);
  }
  function E(w, ln) {
    return ln == null && (ln = Ha(w)), P(w, ln).join(`
`);
  }
  function nn(w) {
    return w.map(h).join(`
`);
  ...
  function h(w) {
    return w.map(fn).join(o);
  }
  function fn(w) {
    return w == null ? "" : w instanceof Date ? Jr(w) : C.test(w += "") ? '"' + w.replace(/"/g, '""') + '"' : w;
  }
  return {
    parse: d,
    parseRows: b,
...
function Ct(o, C, s, d) {
  ...
  return new (s || (s = Promise))(function(P, y) {
    ...
    function h(fn) {
      fn.done ? P(fn.value) : b(fn.value).then(E, nn);
    }
    h((d = d.apply(o, C || [])).next());
  });
}
function pt(o, C) {
  ...
  function nn(h) {
    ...
    for (; y && (y = 0, h[0] && (s = 0)), s; )
      try {
        if (d = 1, b && (P = h[0] & 2 ? b.return : h[0] ? b.throw || ((P = b.return) && P.call(b), 0) : b.next) && !(P = P.call(b, h[1])).done)
          return P;
...
function nu(o, C) {
  ...
  try {
    for (; (C === void 0 || C-- > 0) && !(b = d.next()).done; )
      P.push(b.value);
  } catch (E) {
    y = { error: E };
  } finally {
...
function Ht(o, C) {
  ...
  if (typeof s.path != "string") {
    ...
    Object.defineProperty(s, "path", {
      value: typeof C == "string" ? C : typeof d == "string" && d.length > 0 ? d : o.name,
      writable: !1,
      configurable: !1,
      enumerable: !0
    });
...
function ou(o) {
  var C = o.name, s = C && C.lastIndexOf(".") !== -1;
  if (s && !o.type) {
    var d = C.split(".").pop().toLowerCase(), b = tu.get(d);
...
function ru(o) {
  return Ct(this, void 0, void 0, function() {
    return pt(this, function(C) {
      return Io(o) && uu(o) ? [2, cu(o.dataTransfer, o.type)] : iu(o) ? [2, lu(o)] : Array.isArray(o) && o.every(function(s) {
...
function uu(o) {
  return Io(o.dataTransfer);
}
function iu(o) {
  return Io(o) && Io(o.target);
}
function Io(o) {
  return typeof o == "object" && o !== null;
}
function lu(o) {
  return va(o.target.files).map(function(C) {
    return Ht(C);
  });
}
function su(o) {
  return Ct(this, void 0, void 0, function() {
    ...
    return pt(this, function(s) {
      switch (s.label) {
        ...
        case 1:
          return C = s.sent(), [2, C.map(function(d) {
            return Ht(d);
          })];
      }
    });
...
function cu(o, C) {
  return Ct(this, void 0, void 0, function() {
    ...
    return pt(this, function(b) {
      switch (b.label) {
        case 0:
          return o === null ? [2, []] : o.items ? (s = va(o.items).filter(function(P) {
            return P.kind === "file";
          }), C !== "drop" ? [2, s] : [4, Promise.all(s.map(yu))]) : [3, 2];
        case 1:
          return d = b.sent(), [2, Fa(dr(d))];
        case 2:
          return [2, Fa(va(o.files).map(function(P) {
            return Ht(P);
          }))];
      }
    });
...
function yu(o) {
  if (typeof o.webkitGetAsEntry != "function")
    return Wa(o);
  var C = o.webkitGetAsEntry();
  return C && C.isDirectory ? Cr(C) : Wa(o);
}
function dr(o) {
  return o.reduce(function(C, s) {
    return eu(C, Array.isArray(s) ? dr(s) : [s]);
  }, []);
}
function Wa(o) {
  var C = o.getAsFile();
        ...
        return Ct(y, void 0, void 0, function() {
          ...
          return pt(this, function(w) {
            switch (w.label) {
              ...
              case 2:
                return nn = w.sent(), s(nn), [3, 4];
              case 3:
                return h = w.sent(), d(h), [3, 4];
              case 4:
                return [3, 6];
              case 5:
                fn = Promise.all(E.map(du)), b.push(fn), P(), w.label = 6;
              case 6:
                return [
                  2
                  /*return*/
...
var pu = function(o, C) {
  if (o && C) {
    var s = Array.isArray(C) ? C : C.split(","), d = o.name || "", b = (o.type || "").toLowerCase(), P = b.replace(/\/.*$/, "");
    return s.some(function(y) {
      var E = y.trim().toLowerCase();
      return E.charAt(0) === "." ? d.toLowerCase().endsWith(E) : E.endsWith("/*") ? P === E.replace(/\/.*$/, "") : b === E;
    });
  }
  return !0;
};
...
function Ga(o) {
  for (var C = 1; C < arguments.length; C++) {
    ...
    C % 2 ? xa(Object(s), !0).forEach(function(d) {
      pr(o, d, s[d]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(s)) : xa(Object(s)).forEach(function(d) {
...
function pr(o, C, s) {
  return C in o ? Object.defineProperty(o, C, { value: s, enumerable: !0, configurable: !0, writable: !0 }) : o[C] = s, o;
}
function Va(o, C) {
  return hu(o) || mu(o, C) || gu(o, C) || fu();
}
function fu() {
...
function Ka(o, C) {
  ...
  for (var s = 0, d = new Array(C); s < C; s++)
    d[s] = o[s];
  return d;
}
function mu(o, C) {
  ...
  if (s != null) {
    var d = [], b = !0, P = !1, y, E;
    try {
      for (s = s.call(o); !(b = (y = s.next()).done) && (d.push(y.value), !(C && d.length === C)); b = !0)
        ;
    } catch (nn) {
      P = !0, E = nn;
    } finally {
...
var vu = "file-invalid-type", Su = "file-too-large", wu = "file-too-small", Mu = "too-many-files", bu = function(C) {
  C = Array.isArray(C) && C.length === 1 ? C[0] : C;
  var s = Array.isArray(C) ? "one of ".concat(C.join(", ")) : C;
  return {
    code: vu,
...
function fr(o, C) {
  var s = o.type === "application/x-moz-file" || pu(o, C);
  return [s, s ? null : bu(C)];
}
function gr(o, C, s) {
  if (Ot(o.size))
    if (Ot(C) && Ot(s)) {
...
function Du(o) {
  var C = o.files, s = o.accept, d = o.minSize, b = o.maxSize, P = o.multiple, y = o.maxFiles;
  return !P && C.length > 1 || P && y >= 1 && C.length > y ? !1 : C.every(function(E) {
    var nn = fr(E, s), h = Va(nn, 1), fn = h[0], w = gr(E, d, b), ln = Va(w, 1), Tn = ln[0];
    return fn && Tn;
  });
}
function Lo(o) {
...
function Do(o) {
  return o.dataTransfer ? Array.prototype.some.call(o.dataTransfer.types, function(C) {
...
function Ee() {
  ...
  return function(d) {
    ...
    return C.some(function(E) {
      return !Lo(d) && E && E.apply(void 0, [d].concat(P)), Lo(d);
    });
  };
}
function Xa() {
...
function Pu(o) {
  return o = typeof o == "string" ? o.split(",") : o, [{
    ...
    accept: Array.isArray(o) ? o.filter(function(C) {
...
var Iu = ["children"], Lu = ["open"], ku = ["refKey", "role", "onKeyDown", "onFocus", "onBlur", "onClick", "onDragEnter", "onDragOver", "onDragLeave", "onDrop"], Ou = ["refKey", "onChange", "onClick"];
function Bu(o) {
  return Fu(o) || Hu(o) || mr(o) || Eu();
}
function Eu() {
...
function ee(o) {
  for (var C = 1; C < arguments.length; C++) {
    var s = arguments[C] != null ? arguments[C] : {};
    C % 2 ? Ya(Object(s), !0).forEach(function(d) {
      wa(o, d, s[d]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(s)) : Ya(Object(s)).forEach(function(d) {
      Object.defineProperty(o, d, Object.getOwnPropertyDescriptor(s, d));
    });
  }
  return o;
...
function ko(o, C) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (b = 0; b < P.length; b++)
      d = P[b], !(C.indexOf(d) >= 0) && Object.prototype.propertyIsEnumerable.call(o, d) && (s[d] = o[d]);
  }
  return s;
}
function Vu(o, C) {
  ...
  for (P = 0; P < d.length; P++)
    b = d[P], !(C.indexOf(b) >= 0) && (s[b] = o[b]);
  return s;
}
var Ra = /* @__PURE__ */ A.forwardRef(function(o, C) {
  var s = o.children, d = ko(o, Iu), b = ba(d), P = b.open, y = ko(b, Lu);
  return A.useImperativeHandle(C, function() {
    return {
      open: P
    };
  }, [P]), /* @__PURE__ */ ir.createElement(A.Fragment, null, s(ee(ee({}, y), {}, {
    open: P
  })));
});
...
function ba() {
  var o = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, C = ee(ee({}, hr), o), s = C.accept, d = C.disabled, b = C.getFilesFromEvent, P = C.maxSize, y = C.minSize, E = C.multiple, nn = C.maxFiles, h = C.onDragEnter, fn = C.onDragLeave, w = C.onDragOver, ln = C.onDrop, Tn = C.onDropAccepted, Cn = C.onDropRejected, gn = C.onFileDialogCancel, zn = C.onFileDialogOpen, Sn = C.useFsAccessApi, Wn = C.preventDropOnDocument, Dn = C.noClick, Jn = C.noKeyboard, xn = C.noDrag, Rn = C.noDragEventsBubbling, ae = C.validator, qn = A.useMemo(function() {
    return typeof zn == "function" ? zn : ja;
  }, [zn]), Ce = A.useMemo(function() {
    return typeof gn == "function" ? gn : ja;
  }, [gn]), ne = A.useRef(null), tn = A.useRef(null), pn = A.useReducer(Ku, Ma), _n = ga(pn, 2), Yn = _n[0], $n = _n[1], Le = Yn.isFocused, Te = Yn.isFileDialogActive, be = Yn.draggedFiles, ke = function() {
    Te && setTimeout(function() {
      if (tn.current) {
        var Ln = tn.current.files;
        Ln.length || ($n({
          type: "closeDialog"
        }), Ce());
      }
  ...
  A.useEffect(function() {
    return Sn && Xa() ? function() {
    } : (window.addEventListener("focus", ke, !1), function() {
      window.removeEventListener("focus", ke, !1);
    });
  }, [tn, Te, Ce, Sn]);
  var pe = A.useRef([]), me = function(Ln) {
    ne.current && ne.current.contains(Ln.target) || (Ln.preventDefault(), pe.current = []);
  };
  A.useEffect(function() {
    return Wn && (document.addEventListener("dragover", _a, !1), document.addEventListener("drop", me, !1)), function() {
      Wn && (document.removeEventListener("dragover", _a), document.removeEventListener("drop", me));
    };
  }, [ne, Wn]);
  var re = A.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Oe(Q), pe.current = [].concat(Bu(pe.current), [Q.target]), Do(Q) && Promise.resolve(b(Q)).then(function(Ln) {
      Lo(Q) && !Rn || ($n({
        draggedFiles: Ln,
        isDragActive: !0,
  ...
  }, [b, h, Rn]), He = A.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Oe(Q);
    var Ln = Do(Q);
    if (Ln && Q.dataTransfer)
      try {
        Q.dataTransfer.dropEffect = "copy";
      } catch {
      }
    return Ln && w && w(Q), !1;
  }, [w, Rn]), Fe = A.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Oe(Q);
    var Ln = pe.current.filter(function(ie) {
      return ne.current && ne.current.contains(ie);
    }), te = Ln.indexOf(Q.target);
    te !== -1 && Ln.splice(te, 1), pe.current = Ln, !(Ln.length > 0) && ($n({
      isDragActive: !1,
      type: "setDraggedFiles",
      draggedFiles: []
    }), Do(Q) && fn && fn(Q));
  }, [ne, fn, Rn]), H = A.useCallback(function(Q, Ln) {
    var te = [], ie = [];
    Q.forEach(function(ge) {
      var We = fr(ge, s), Ie = ga(We, 2), Ue = Ie[0], Je = Ie[1], $e = gr(ge, y, P), Ge = ga($e, 2), Ze = Ge[0], Ve = Ge[1], Ke = ae ? ae(ge) : null;
      if (Ue && Ze && !Ke)
        te.push(ge);
      else {
        var xe = [Je, Ve];
        Ke && (xe = xe.concat(Ke)), ie.push({
          file: ge,
          errors: xe.filter(function(ut) {
            return ut;
          })
        });
      }
    }), (!E && te.length > 1 || E && nn >= 1 && te.length > nn) && (te.forEach(function(ge) {
      ie.push({
        file: ge,
        errors: [Au]
      });
      ...
      fileRejections: ie,
      type: "setFiles"
    }), ln && ln(te, ie, Ln), ie.length > 0 && Cn && Cn(ie, Ln), te.length > 0 && Tn && Tn(te, Ln);
  }, [$n, E, s, y, P, nn, ln, Tn, Cn, ae]), z = A.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Oe(Q), pe.current = [], Do(Q) && Promise.resolve(b(Q)).then(function(Ln) {
      Lo(Q) && !Rn || H(Ln, Q);
    }), $n({
      type: "reset"
    });
  }, [b, H, Rn]), un = A.useCallback(function() {
    if (Sn && Xa()) {
      $n({
        type: "openDialog"
      }), qn();
      ...
      window.showOpenFilePicker(Q).then(function(Ln) {
        return b(Ln);
      }).then(function(Ln) {
        return H(Ln, null);
      }).catch(function(Ln) {
    ...
    tn.current && ($n({
      type: "openDialog"
    }), qn(), tn.current.value = null, tn.current.click());
  }, [$n, qn, Ce, Sn, H, s, E]), on = A.useCallback(function(Q) {
    !ne.current || !ne.current.isEqualNode(Q.target) || (Q.keyCode === 32 || Q.keyCode === 13) && (Q.preventDefault(), un());
  }, [ne, tn, un]), Fn = A.useCallback(function() {
    $n({
      type: "focus"
    });
  }, []), jn = A.useCallback(function() {
    $n({
      type: "blur"
    });
  }, []), we = A.useCallback(function() {
    Dn || (Tu() ? setTimeout(un, 0) : un());
  }, [tn, Dn, un]), Pe = function(Ln) {
    return d ? null : Ln;
  }, Ae = function(Ln) {
    return Jn ? null : Pe(Ln);
  }, De = function(Ln) {
    return xn ? null : Pe(Ln);
  }, Oe = function(Ln) {
    Rn && Ln.stopPropagation();
  }, Ye = A.useMemo(function() {
    return function() {
      var Q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, Ln = Q.refKey, te = Ln === void 0 ? "ref" : Ln, ie = Q.role, ge = Q.onKeyDown, We = Q.onFocus, Ie = Q.onBlur, Ue = Q.onClick, Je = Q.onDragEnter, $e = Q.onDragOver, Ge = Q.onDragLeave, Ze = Q.onDrop, Ve = ko(Q, ku);
      return ee(ee(wa({
        onKeyDown: Ae(Ee(ge, on)),
        onFocus: Ae(Ee(We, Fn)),
        onBlur: Ae(Ee(Ie, jn)),
        onClick: Pe(Ee(Ue, we)),
        onDragEnter: De(Ee(Je, re)),
        onDragOver: De(Ee($e, He)),
        onDragLeave: De(Ee(Ge, Fe)),
        onDrop: De(Ee(Ze, z)),
  ...
  }, [ne, on, Fn, jn, we, re, He, Fe, z, Jn, xn, d]), fe = A.useCallback(function(Q) {
    Q.stopPropagation();
  }, []), ye = A.useMemo(function() {
    return function() {
      var Q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, Ln = Q.refKey, te = Ln === void 0 ? "ref" : Ln, ie = Q.onChange, ge = Q.onClick, We = ko(Q, Ou), Ie = wa({
        accept: s,
        multiple: E,
        type: "file",
        style: {
  ...
  }, [tn, s, E, z, d]), he = be.length, ve = he > 0 && Du({
    files: be,
    accept: s,
    minSize: y,
    maxSize: P,
...
function Ku(o, C) {
  switch (C.type) {
    ...
    case "setDraggedFiles":
      var s = C.isDragActive, d = C.draggedFiles;
      return ee(ee({}, o), {}, {
        draggedFiles: d,
        isDragActive: s
      });
...
const Bt = ({ children: o, className: C = "" }) => /* @__PURE__ */ M("div", { className: `tab-content ${C}`, children: o }), qu = (o) => {
  const { globalActive: C } = A.useContext(dt), s = A.useContext(Et);
  return /* @__PURE__ */ M(vr, { ...o, setActiveTab: (b) => {
    s({ type: "EDITOR_SET_GLOBALACTIVE", payload: b });
  }, activeTab: C });
}, zu = ({ children: o, className: C = void 0, startingTab: s }) => {
  const [d, b] = A.useState(s);
  return /* @__PURE__ */ M(vr, { className: C, setActiveTab: b, activeTab: d, children: o });
}, vr = ({ children: o, className: C, activeTab: s, setActiveTab: d }) => {
  const b = (E, nn) => {
    E || d(nn);
  };
  let P = "tabs";
  C && (P = `tabs ${C}`);
  const y = o.map(({ props: E }, nn) => {
    let h = "nav-item", fn = E.disableRule || !1;
    return fn && (h += " disabled"), nn === s && (h += " active"), /* @__PURE__ */ an("li", { onClick: () => b(fn, nn), className: h, children: [
      E.icon,
      E.title
    ] }, E.title);
  });
  return /* @__PURE__ */ an(Re, { children: [
    /* @__PURE__ */ M("nav", { className: P, children: /* @__PURE__ */ M("ul", { className: "nav nav-fill", children: y }) }),
    o[s]
  ] });
};
var Aa = { exports: {} }, Ro = { exports: {} }, Ua;
function _u() {
  return Ua || (Ua = 1, function(o, C) {
    (function(s, d) {
      d(C, A);
    })(cr, function(s, d) {
      function b(n, r, i, l, m, f, v) {
        try {
          var R = n[f](v), T = R.value;
        } catch (I) {
          return void i(I);
        }
        R.done ? r(T) : Promise.resolve(T).then(l, m);
      }
      function P(n) {
        return function() {
      ...
      function E(n, r) {
        if (n == null)
          return {};
        var i, l, m = {}, f = Object.keys(n);
        for (l = 0; l < f.length; l++)
          i = f[l], r.indexOf(i) >= 0 || (m[i] = n[i]);
        return m;
      }
      function nn(n) {
        var r = function(i, l) {
      ...
      var h = { init: "init" }, fn = function(n) {
        var r = n.value;
        return r === void 0 ? "" : r;
      }, w = function() {
        return d.createElement(d.Fragment, null, " ");
      }, ln = { Cell: fn, width: 150, minWidth: 0, maxWidth: Number.MAX_SAFE_INTEGER };
      function Tn() {
        for (var n = arguments.length, r = new Array(n), i = 0; i < n; i++)
          r[i] = arguments[i];
        return r.reduce(function(l, m) {
          var f = m.style, v = m.className;
          return l = y({}, l, {}, E(m, ["style", "className"])), f && (l.style = l.style ? y({}, l.style || {}, {}, f || {}) : f), v && (l.className = l.className ? l.className + " " + v : v), l.className === "" && delete l.className, l;
        }, {});
      }
      var Cn = function(n, r) {
        return r === void 0 && (r = {}), function(i) {
          return i === void 0 && (i = {}), [].concat(n, [i]).reduce(function(l, m) {
            return function f(v, R, T) {
              return typeof R == "function" ? f({}, R(v, T)) : Array.isArray(R) ? Tn.apply(void 0, [v].concat(R)) : Tn(v, R);
            }(l, m, y({}, r, { userProps: i }));
          }, {});
        };
      }, gn = function(n, r, i, l) {
      ...
      function Rn(n, r, i) {
        return i === void 0 && (i = {}), function(l, m) {
          m === void 0 && (m = {});
          var f = typeof l == "string" ? r[l] : l;
          if (f === void 0)
            throw console.info(r), new Error("Renderer Error ☝️");
          return ae(f, y({}, n, { column: r }, i, {}, m));
        };
      }
      function ae(n, r) {
        return function(l) {
          return typeof l == "function" && (m = Object.getPrototypeOf(l)).prototype && m.prototype.isReactComponent;
          var m;
      ...
      function qn(n, r, i) {
        return i === void 0 && (i = 0), n.map(function(l) {
          return ne(l = y({}, l, { parent: r, depth: i })), l.columns && (l.columns = qn(l.columns, l, i + 1)), l;
        });
      }
      function Ce(n) {
        return Le(n, "columns");
        ...
        if (typeof i == "string") {
          ...
          i = function(f) {
            return function(v, R, T) {
              if (!R)
                return v;
              var I, V = typeof R == "function" ? R : JSON.stringify(R), W = _n.get(V) || function() {
                var x = function(k) {
                  ...
                  }).join(".").replace(re, ".").replace(He, "").split(".");
                }(R);
                return _n.set(V, x), x;
              }();
              try {
      ...
      function tn(n, r) {
        if (!r)
          throw new Error();
        return Object.assign(n, y({ Header: w, Footer: w }, ln, {}, r, {}, n)), Object.assign(n, { originalWidth: n.width }), n;
      }
      function pn(n, r, i) {
        i === void 0 && (i = function() {
          return {};
        });
        for (var l = [], m = n, f = 0, v = function() {
          return f++;
        }, R = function() {
          var T = { headers: [] }, I = [], V = m.some(function(W) {
            return W.parent;
          });
          m.forEach(function(W) {
            var x, k = [].concat(I).reverse()[0];
            V && (W.parent ? x = y({}, W.parent, { originalId: W.parent.id, id: W.parent.id + "_" + v(), headers: [W] }, i(W)) : x = tn(y({ originalId: W.id + "_placeholder", id: W.id + "_placeholder_" + v(), placeholderOf: W, headers: [W] }, i(W)), r), k && k.originalId === x.originalId ? k.headers.push(W) : I.push(x)), T.headers.push(W);
          }), l.push(T), m = I;
        }; m.length; )
          R();
        return l.reverse();
      ...
      function Te(n, r) {
        var i = r.manualExpandedKey, l = r.expanded, m = r.expandSubRows, f = m === void 0 || m, v = [];
        return n.forEach(function(R) {
          return function T(I, V) {
            V === void 0 && (V = !0), I.isExpanded = I.original && I.original[i] || l[I.id], I.canExpand = I.subRows && !!I.subRows.length, V && v.push(I), I.subRows && I.subRows.length && I.isExpanded && I.subRows.forEach(function(W) {
              return T(W, f);
            });
          }(R);
        }), v;
      ...
      var me = null, re = /\[/g, He = /\]/g, Fe = function(n) {
      ...
      function Pe() {
        return { useOptions: [], stateReducers: [], useControlledState: [], columns: [], columnsDeps: [], allColumns: [], allColumnsDeps: [], accessValue: [], materializedColumns: [], materializedColumnsDeps: [], useInstanceAfterData: [], visibleColumns: [], visibleColumnsDeps: [], headerGroups: [], headerGroupsDeps: [], useInstanceBeforeDimensions: [], useInstance: [], prepareRow: [], getTableProps: [Fe], getTableBodyProps: [H], getHeaderGroupProps: [on], getFooterGroupProps: [Fn], getHeaderProps: [z], getFooterProps: [un], getRowProps: [jn], getCellProps: [we], useFinalInstance: [] };
      }
      ...
      var Ae = function(n) {
        n.getToggleHiddenProps = [De], n.getToggleHideAllColumnsProps = [Oe], n.stateReducers.push(Ye), n.useInstanceBeforeDimensions.push(fe), n.headerGroupsDeps.push(function(r, i) {
          var l = i.instance;
      ...
      function Ye(n, r, i, l) {
        ...
        if (r.type === h.toggleHideColumn) {
          var m = (r.value !== void 0 ? r.value : !n.hiddenColumns.includes(r.columnId)) ? [].concat(n.hiddenColumns, [r.columnId]) : n.hiddenColumns.filter(function(f) {
            return f !== r.columnId;
          });
          return y({}, n, { hiddenColumns: m });
        }
        return r.type === h.setHiddenColumns ? y({}, n, { hiddenColumns: Wn(r.value, n.hiddenColumns) }) : r.type === h.toggleHideAllColumns ? y({}, n, { hiddenColumns: (r.value !== void 0 ? r.value : !n.hiddenColumns.length) ? l.allColumns.map(function(f) {
          return f.id;
        }) : [] }) : void 0;
      }
      function fe(n) {
        ...
        var l = 0;
        r.forEach(function(m) {
          return l += function f(v, R) {
            v.isVisible = R && !i.includes(v.id);
            var T = 0;
            return v.headers && v.headers.length ? v.headers.forEach(function(I) {
              return T += f(I, v.isVisible);
            }) : T = v.isVisible ? 1 : 0, v.totalVisibleHeaderCount = T, T;
          }(m, !0);
        });
      }
      function ye(n) {
        var r = n.columns, i = n.flatHeaders, l = n.dispatch, m = n.allColumns, f = n.getHooks, v = n.state.hiddenColumns, R = n.autoResetHiddenColumns, T = R === void 0 || R, I = Dn(n), V = m.length === v.length, W = d.useCallback(function(U, sn) {
          return l({ type: h.toggleHideColumn, columnId: U, value: sn });
        }, [l]), x = d.useCallback(function(U) {
          return l({ type: h.setHiddenColumns, value: U });
        }, [l]), k = d.useCallback(function(U) {
          return l({ type: h.toggleHideAllColumns, value: U });
        }, [l]), F = Cn(f().getToggleHideAllColumnsProps, { instance: I() });
        i.forEach(function(U) {
          U.toggleHidden = function(sn) {
            l({ type: h.toggleHideColumn, columnId: U.id, value: sn });
          }, U.getToggleHiddenProps = Cn(f().getToggleHiddenProps, { instance: I(), column: U });
        });
        var X = Dn(T);
        xn(function() {
          X() && l({ type: h.resetHiddenColumns });
        }, [l, r]), Object.assign(n, { allColumnsHidden: V, toggleHideColumn: W, setHiddenColumns: x, toggleHideAllColumns: k, getToggleHideAllColumnsProps: F });
      }
      var he = {}, ve = {}, je = function(n, r, i) {
        return n;
      }, Q = function(n, r) {
        return n.subRows || [];
      }, Ln = function(n, r, i) {
      ...
      function ie(n) {
        var r = n.initialState, i = r === void 0 ? he : r, l = n.defaultColumn, m = l === void 0 ? ve : l, f = n.getSubRows, v = f === void 0 ? Q : f, R = n.getRowId, T = R === void 0 ? Ln : R, I = n.stateReducer, V = I === void 0 ? je : I, W = n.useControlledState, x = W === void 0 ? te : W;
        return y({}, E(n, ["initialState", "defaultColumn", "getSubRows", "getRowId", "stateReducer", "useControlledState"]), { initialState: i, defaultColumn: m, getSubRows: v, getRowId: T, stateReducer: V, useControlledState: x });
      }
      function ge(n, r) {
        r === void 0 && (r = 0);
        var i = 0, l = 0, m = 0, f = 0;
        return n.forEach(function(v) {
          var R = v.headers;
          if (v.totalLeft = r, R && R.length) {
            var T = ge(R, r), I = T[0], V = T[1], W = T[2], x = T[3];
            v.totalMinWidth = I, v.totalWidth = V, v.totalMaxWidth = W, v.totalFlexWidth = x;
          } else
          ...
          v.isVisible && (r += v.totalWidth, i += v.totalMinWidth, l += v.totalWidth, m += v.totalMaxWidth, f += v.totalFlexWidth);
        }), [i, l, m, f];
      }
      function We(n) {
        var r = n.data, i = n.rows, l = n.flatRows, m = n.rowsById, f = n.column, v = n.getRowId, R = n.getSubRows, T = n.accessValueHooks, I = n.getInstance;
        r.forEach(function(V, W) {
          return function x(k, F, X, U, sn) {
            X === void 0 && (X = 0);
            var kn = k, cn = v(k, F, U), K = m[cn];
            if (K)
              K.subRows && K.originalSubRows.forEach(function(en, bn) {
                return x(en, bn, X + 1, K);
              });
            else if ((K = { id: cn, original: kn, index: F, depth: X, cells: [{}] }).cells.map = pe, K.cells.filter = pe, K.cells.forEach = pe, K.cells[0].getCellProps = pe, K.values = {}, sn.push(K), l.push(K), m[cn] = K, K.originalSubRows = R(k, F), K.originalSubRows) {
              var Pn = [];
              K.originalSubRows.forEach(function(en, bn) {
                return x(en, bn, X + 1, K, Pn);
              }), K.subRows = Pn;
            }
            f.accessor && (K.values[f.id] = f.accessor(k, F, K, sn, r)), K.values[f.id] = gn(T, K.values[f.id], { row: K, column: f, instance: I() });
          }(V, W, 0, void 0, i);
        });
      }
      h.resetExpanded = "resetExpanded", h.toggleRowExpanded = "toggleRowExpanded", h.toggleAllRowsExpanded = "toggleAllRowsExpanded";
      var Ie = function(n) {
        n.getToggleAllRowsExpandedProps = [Ue], n.getToggleRowExpandedProps = [Je], n.stateReducers.push($e), n.useInstance.push(Ge), n.prepareRow.push(Ze);
      };
      ...
      function $e(n, r, i, l) {
        ...
        if (r.type === h.toggleAllRowsExpanded) {
          var m = r.value, f = l.rowsById, v = Object.keys(f).length === Object.keys(n.expanded).length;
          if (m !== void 0 ? m : !v) {
            var R = {};
            return Object.keys(f).forEach(function(F) {
              R[F] = !0;
            }), y({}, n, { expanded: R });
          }
          return y({}, n, { expanded: {} });
        ...
        if (r.type === h.toggleRowExpanded) {
          ...
          if (W && !x) {
            var k = n.expanded;
            return k[I], y({}, n, { expanded: E(k, [I].map(nn)) });
          }
          return n;
        }
      }
      function Ge(n) {
        var r = n.data, i = n.rows, l = n.rowsById, m = n.manualExpandedKey, f = m === void 0 ? "expanded" : m, v = n.paginateExpandedRows, R = v === void 0 || v, T = n.expandSubRows, I = T === void 0 || T, V = n.autoResetExpanded, W = V === void 0 || V, x = n.getHooks, k = n.plugins, F = n.state.expanded, X = n.dispatch;
        Sn(k, ["useSortBy", "useGroupBy", "usePivotColumns", "useGlobalFilter"], "useExpanded");
        var U = Dn(W), sn = !!(Object.keys(l).length && Object.keys(F).length);
        sn && Object.keys(l).some(function(Gn) {
          return !F[Gn];
        }) && (sn = !1), xn(function() {
          U() && X({ type: h.resetExpanded });
        }, [X, r]);
        var kn = d.useCallback(function(Gn, mn) {
          X({ type: h.toggleRowExpanded, id: Gn, value: mn });
        }, [X]), cn = d.useCallback(function(Gn) {
          return X({ type: h.toggleAllRowsExpanded, value: Gn });
        }, [X]), K = d.useMemo(function() {
          return R ? Te(i, { manualExpandedKey: f, expanded: F, expandSubRows: I }) : i;
        }, [R, i, f, F, I]), Pn = d.useMemo(function() {
          return function(Gn) {
            var mn = 0;
        ...
        }, [F]), en = Dn(n), bn = Cn(x().getToggleAllRowsExpandedProps, { instance: en() });
        Object.assign(n, { preExpandedRows: i, expandedRows: K, rows: K, expandedDepth: Pn, isAllRowsExpanded: sn, toggleRowExpanded: kn, toggleAllRowsExpanded: cn, getToggleAllRowsExpandedProps: bn });
      }
      function Ze(n, r) {
        var i = r.instance.getHooks, l = r.instance;
        n.toggleRowExpanded = function(m) {
          return l.toggleRowExpanded(n.id, m);
        }, n.getToggleRowExpandedProps = Cn(i().getToggleRowExpandedProps, { instance: l, row: n });
      }
      var Ve = function(n, r, i) {
      ...
      var ut = function(n, r, i) {
        return n.filter(function(l) {
          return r.some(function(m) {
            return l.values[m].includes(i);
          });
        });
      };
      ut.autoRemove = function(n) {
        return !n || !n.length;
      };
      var ft = function(n, r, i) {
        return n.filter(function(l) {
          return r.some(function(m) {
            var f = l.values[m];
            return f && f.length && i.every(function(v) {
              return f.includes(v);
            });
          });
        });
      ...
      var Ft = function(n, r, i) {
        return n.filter(function(l) {
          return r.some(function(m) {
            var f = l.values[m];
            return f && f.length && i.some(function(v) {
              return f.includes(v);
            });
          });
        });
      ...
      var Qe = Object.freeze({ __proto__: null, text: Ve, exactText: Ke, exactTextCase: xe, includes: ut, includesAll: ft, includesSome: Ft, includesValue: gt, exact: Wt, equals: xt, between: Gt });
      h.resetFilters = "resetFilters", h.setFilter = "setFilter", h.setAllFilters = "setAllFilters";
      var Vt = function(n) {
        n.stateReducers.push(Bo), n.useInstance.push(Kt);
      };
      function Bo(n, r, i, l) {
        if (r.type === h.init)
          return y({ filters: [] }, n);
        ...
        if (r.type === h.setFilter) {
          var m = r.columnId, f = r.filterValue, v = l.allColumns, R = l.filterTypes, T = v.find(function(X) {
            return X.id === m;
          });
          if (!T)
            throw new Error("React-Table: Could not find a column with id: " + m);
          var I = be(T.filter, R || {}, Qe), V = n.filters.find(function(X) {
            return X.id === m;
          }), W = Wn(f, V && V.value);
          return ke(I.autoRemove, W, T) ? y({}, n, { filters: n.filters.filter(function(X) {
            return X.id !== m;
          }) }) : y({}, n, V ? { filters: n.filters.map(function(X) {
            return X.id === m ? { id: m, value: W } : X;
          }) } : { filters: [].concat(n.filters, [{ id: m, value: W }]) });
        }
        if (r.type === h.setAllFilters) {
          var x = r.filters, k = l.allColumns, F = l.filterTypes;
          return y({}, n, { filters: Wn(x, n.filters).filter(function(X) {
            var U = k.find(function(sn) {
              return sn.id === X.id;
            });
            return !ke(be(U.filter, F || {}, Qe).autoRemove, X.value, U);
          }) });
        }
      }
      function Kt(n) {
        var r = n.data, i = n.rows, l = n.flatRows, m = n.rowsById, f = n.allColumns, v = n.filterTypes, R = n.manualFilters, T = n.defaultCanFilter, I = T !== void 0 && T, V = n.disableFilters, W = n.state.filters, x = n.dispatch, k = n.autoResetFilters, F = k === void 0 || k, X = d.useCallback(function(en, bn) {
          x({ type: h.setFilter, columnId: en, filterValue: bn });
        }, [x]), U = d.useCallback(function(en) {
          x({ type: h.setAllFilters, filters: en });
        }, [x]);
        f.forEach(function(en) {
          var bn = en.id, Gn = en.accessor, mn = en.defaultCanFilter, wn = en.disableFilters;
          en.canFilter = Gn ? Yn(wn !== !0 && void 0, V !== !0 && void 0, !0) : Yn(mn, I, !1), en.setFilter = function(Nn) {
            return X(en.id, Nn);
          };
        ...
        var sn = d.useMemo(function() {
          ...
          return [function Gn(mn, wn) {
            ...
            return (Kn = W.reduce(function(Nn, Vn) {
              var e = Vn.id, t = Vn.value, u = f.find(function(p) {
                return p.id === e;
              });
              if (!u)
                return Nn;
              wn === 0 && (u.preFilteredRows = Nn);
              var a = be(u.filter, v || {}, Qe);
              ...
              en.push(Nn), bn[Nn.id] = Nn, Nn.subRows && (Nn.subRows = Nn.subRows && Nn.subRows.length > 0 ? Gn(Nn.subRows, wn + 1) : Nn.subRows);
            }), Kn;
          }(i), en, bn];
        }, [R, W, i, l, m, f, v]), kn = sn[0], cn = sn[1], K = sn[2];
        d.useMemo(function() {
          f.filter(function(en) {
            ...
            en.preFilteredRows = kn, en.filteredRows = kn;
          });
        }, [kn, W, f]);
        var Pn = Dn(F);
        xn(function() {
          Pn() && x({ type: h.resetFilters });
        }, [x, R ? null : r]), Object.assign(n, { preFilteredRows: i, preFilteredFlatRows: l, preFilteredRowsById: m, filteredRows: kn, filteredFlatRows: cn, filteredRowsById: K, rows: kn, flatRows: cn, rowsById: K, setFilter: X, setAllFilters: U });
      }
      Vt.pluginName = "useFilters", h.resetGlobalFilter = "resetGlobalFilter", h.setGlobalFilter = "setGlobalFilter";
      var mt = function(n) {
        n.stateReducers.push(qt), n.useInstance.push(zt);
      };
      function qt(n, r, i, l) {
        if (r.type === h.resetGlobalFilter)
          return y({}, n, { globalFilter: l.initialState.globalFilter || void 0 });
        if (r.type === h.setGlobalFilter) {
          var m = r.filterValue, f = l.userFilterTypes, v = be(l.globalFilter, f || {}, Qe), R = Wn(m, n.globalFilter);
          return ke(v.autoRemove, R) ? (n.globalFilter, E(n, ["globalFilter"])) : y({}, n, { globalFilter: R });
        }
      }
      function zt(n) {
        var r = n.data, i = n.rows, l = n.flatRows, m = n.rowsById, f = n.allColumns, v = n.filterTypes, R = n.globalFilter, T = n.manualGlobalFilter, I = n.state.globalFilter, V = n.dispatch, W = n.autoResetGlobalFilter, x = W === void 0 || W, k = n.disableGlobalFilter, F = d.useCallback(function(K) {
          V({ type: h.setGlobalFilter, filterValue: K });
        }, [V]), X = d.useMemo(function() {
          if (T || I === void 0)
            return [i, l, m];
          var K = [], Pn = {}, en = be(R, v || {}, Qe);
          if (!en)
          ...
          return [function Gn(mn) {
            return (mn = en(mn, bn.map(function(wn) {
              ...
              K.push(wn), Pn[wn.id] = wn, wn.subRows = wn.subRows && wn.subRows.length ? Gn(wn.subRows) : wn.subRows;
            }), mn;
          }(i), K, Pn];
        }, [T, I, R, v, f, i, l, m, k]), U = X[0], sn = X[1], kn = X[2], cn = Dn(x);
        xn(function() {
          cn() && V({ type: h.resetGlobalFilter });
        }, [V, T ? null : r]), Object.assign(n, { preGlobalFilteredRows: i, preGlobalFilteredFlatRows: l, preGlobalFilteredRowsById: m, globalFilteredRows: U, globalFilteredFlatRows: sn, globalFilteredRowsById: kn, rows: U, flatRows: sn, rowsById: kn, setGlobalFilter: F, disableGlobalFilter: k });
      }
      function ht(n, r) {
      ...
      mt.pluginName = "useGlobalFilter";
      var vt = Object.freeze({ __proto__: null, sum: ht, min: function(n) {
        var r = n[0] || 0;
        ...
        return ht(0, n) / n.length;
      }, median: function(n) {
        if (!n.length)
          return null;
        var r = Math.floor(n.length / 2), i = [].concat(n).sort(function(l, m) {
          return l - m;
        });
      ...
      var St = function(n) {
        n.getGroupByToggleProps = [Yt], n.stateReducers.push(nt), n.visibleColumnsDeps.push(function(r, i) {
          var l = i.instance;
          return [].concat(r, [l.state.groupBy]);
        }), n.visibleColumns.push(jt), n.useInstance.push(Ho), n.prepareRow.push(Ut);
      };
      ...
      function nt(n, r, i, l) {
        ...
        if (r.type === h.toggleGroupBy) {
          var m = r.columnId, f = r.value, v = f !== void 0 ? f : !n.groupBy.includes(m);
          return y({}, n, v ? { groupBy: [].concat(n.groupBy, [m]) } : { groupBy: n.groupBy.filter(function(R) {
            return R !== m;
          }) });
        }
      }
      function jt(n, r) {
        ...
        return (n = [].concat(l, m)).forEach(function(f) {
          f.isGrouped = i.includes(f.id), f.groupedIndex = i.indexOf(f.id);
        }), n;
      }
      var Eo = {};
      function Ho(n) {
        var r = n.data, i = n.rows, l = n.flatRows, m = n.rowsById, f = n.allColumns, v = n.flatHeaders, R = n.groupByFn, T = R === void 0 ? Jt : R, I = n.manualGroupBy, V = n.aggregations, W = V === void 0 ? Eo : V, x = n.plugins, k = n.state.groupBy, F = n.dispatch, X = n.autoResetGroupBy, U = X === void 0 || X, sn = n.disableGroupBy, kn = n.defaultCanGroupBy, cn = n.getHooks;
        Sn(x, ["useColumnOrder", "useFilters"], "useGroupBy");
        var K = Dn(n);
        f.forEach(function(u) {
          var a = u.accessor, p = u.defaultGroupBy, g = u.disableGroupBy;
          u.canGroupBy = a ? Yn(u.canGroupBy, g !== !0 && void 0, sn !== !0 && void 0, !0) : Yn(u.canGroupBy, p, kn, !1), u.canGroupBy && (u.toggleGroupBy = function() {
            return n.toggleGroupBy(u.id);
          }), u.Aggregated = u.Aggregated || u.Cell;
        });
        var Pn = d.useCallback(function(u, a) {
          F({ type: h.toggleGroupBy, columnId: u, value: a });
        }, [F]), en = d.useCallback(function(u) {
          F({ type: h.setGroupBy, value: u });
        }, [F]);
        v.forEach(function(u) {
          u.getGroupByToggleProps = Cn(cn().getGroupByToggleProps, { instance: K(), header: u });
        });
        var bn = d.useMemo(function() {
          if (I || !k.length)
            return [i, l, m, _t, Xt, l, m];
          var u = k.filter(function(L) {
            return f.find(function(q) {
              return q.id === L;
            });
          }), a = [], p = {}, g = [], c = {}, S = [], D = {}, N = function L(q, B, G) {
            if (B === void 0 && (B = 0), B === u.length)
              return q.map(function(Z) {
                return y({}, Z, { depth: B });
              });
            var _ = u[B], O = T(q, _);
            return Object.entries(O).map(function(Z, dn) {
              var vn = Z[0], j = Z[1], In = _ + ":" + vn, Hn = L(j, B + 1, In = G ? G + ">" + In : In), J = B ? Le(j, "leafRows") : j, Y = function(yn, On, Bn) {
                var Xn = {};
                return f.forEach(function(rn) {
                  if (u.includes(rn.id))
                    Xn[rn.id] = On[0] ? On[0].values[rn.id] : null;
                  else {
                    var le = typeof rn.aggregate == "function" ? rn.aggregate : W[rn.aggregate] || vt[rn.aggregate];
                    if (le) {
                      var En = On.map(function(An) {
                        return An.values[rn.id];
                      }), Mn = yn.map(function(An) {
                        var Un = An.values[rn.id];
                        if (!Bn && rn.aggregateValue) {
                          var ce = typeof rn.aggregateValue == "function" ? rn.aggregateValue : W[rn.aggregateValue] || vt[rn.aggregateValue];
                          if (!ce)
              ...
              }(J, j, B), $ = { id: In, isGrouped: !0, groupByID: _, groupByVal: vn, values: Y, subRows: Hn, leafRows: J, depth: B, index: dn };
              return Hn.forEach(function(yn) {
                a.push(yn), p[yn.id] = yn, yn.isGrouped ? (g.push(yn), c[yn.id] = yn) : (S.push(yn), D[yn.id] = yn);
              }), $;
            });
          }(i);
          return N.forEach(function(L) {
            a.push(L), p[L.id] = L, L.isGrouped ? (g.push(L), c[L.id] = L) : (S.push(L), D[L.id] = L);
          }), [N, a, p, g, c, S, D];
        }, [I, k, i, l, m, f, W, T]), Gn = bn[0], mn = bn[1], wn = bn[2], Kn = bn[3], Nn = bn[4], Vn = bn[5], e = bn[6], t = Dn(U);
        xn(function() {
          t() && F({ type: h.resetGroupBy });
        }, [F, I ? null : r]), Object.assign(n, { preGroupedRows: i, preGroupedFlatRow: l, preGroupedRowsById: m, groupedRows: Gn, groupedFlatRows: mn, groupedRowsById: wn, onlyGroupedFlatRows: Kn, onlyGroupedRowsById: Nn, nonGroupedFlatRows: Vn, nonGroupedRowsById: e, rows: Gn, flatRows: mn, rowsById: wn, toggleGroupBy: Pn, setGroupBy: en });
      }
      function Ut(n) {
      ...
      function Jt(n, r) {
        return n.reduce(function(i, l, m) {
          var f = "" + l.values[r];
      ...
      var Fo = Object.freeze({ __proto__: null, alphanumeric: function(n, r, i) {
        var l = et(n, r, i), m = l[0], f = l[1];
        for (m = Zt(m), f = Zt(f), m = m.split($t).filter(Boolean), f = f.split($t).filter(Boolean); m.length && f.length; ) {
          var v = m.shift(), R = f.shift(), T = parseInt(v, 10), I = parseInt(R, 10), V = [T, I].sort();
          if (isNaN(V[0])) {
            if (v > R)
              return 1;
            if (R > v)
        ...
        var l = et(n, r, i), m = l[0], f = l[1];
        return it(m = m.getTime(), f = f.getTime());
        ...
        for (m = m.split("").filter(Boolean), f = f.split("").filter(Boolean); m.length && f.length; ) {
          var v = m.shift(), R = f.shift(), T = v.toLowerCase(), I = R.toLowerCase();
          if (T > I)
            return 1;
          if (I > T)
            return -1;
        ...
        var l = et(n, r, i), m = l[0], f = l[1], v = /[^0-9.]/gi;
        return it(m = Number(String(m).replace(v, "")), f = Number(String(f).replace(v, "")));
      } });
      h.resetSortBy = "resetSortBy", h.setSortBy = "setSortBy", h.toggleSortBy = "toggleSortBy", h.clearSortBy = "clearSortBy", ln.sortType = "alphanumeric", ln.sortDescFirst = !1;
      var Qt = function(n) {
        n.getSortByToggleProps = [Wo], n.stateReducers.push(xo), n.useInstance.push(Go);
      };
      Qt.pluginName = "useSortBy";
      var Wo = function(n, r) {
        var i = r.instance, l = r.column, m = i.isMultiSortEvent, f = m === void 0 ? function(v) {
          return v.shiftKey;
        } : m;
        return [n, { onClick: l.canSort ? function(v) {
          v.persist(), l.toggleSortBy(void 0, !i.disableMultiSort && f(v));
      ...
      function xo(n, r, i, l) {
        ...
        if (r.type === h.toggleSortBy) {
          var m, f = r.columnId, v = r.desc, R = r.multi, T = l.allColumns, I = l.disableMultiSort, V = l.disableSortRemove, W = l.disableMultiRemove, x = l.maxMultiSortColCount, k = x === void 0 ? Number.MAX_SAFE_INTEGER : x, F = n.sortBy, X = T.find(function(K) {
            return K.id === f;
          }).sortDescFirst, U = F.find(function(K) {
            return K.id === f;
          }), sn = F.findIndex(function(K) {
            return K.id === f;
          }), kn = v != null, cn = [];
          return (m = !I && R ? U ? "toggle" : "add" : sn !== F.length - 1 || F.length !== 1 ? "replace" : U ? "toggle" : "replace") != "toggle" || V || kn || R && W || !(U && U.desc && !X || !U.desc && X) || (m = "remove"), m === "replace" ? cn = [{ id: f, desc: kn ? v : X }] : m === "add" ? (cn = [].concat(F, [{ id: f, desc: kn ? v : X }])).splice(0, cn.length - k) : m === "toggle" ? cn = F.map(function(K) {
            return K.id === f ? y({}, K, { desc: kn ? v : !U.desc }) : K;
          }) : m === "remove" && (cn = F.filter(function(K) {
            return K.id !== f;
          })), y({}, n, { sortBy: cn });
        }
      }
      function Go(n) {
        var r = n.data, i = n.rows, l = n.flatRows, m = n.allColumns, f = n.orderByFn, v = f === void 0 ? no : f, R = n.sortTypes, T = n.manualSortBy, I = n.defaultCanSort, V = n.disableSortBy, W = n.flatHeaders, x = n.state.sortBy, k = n.dispatch, F = n.plugins, X = n.getHooks, U = n.autoResetSortBy, sn = U === void 0 || U;
        Sn(F, ["useFilters", "useGlobalFilter", "useGroupBy", "usePivotColumns"], "useSortBy");
        var kn = d.useCallback(function(mn) {
          k({ type: h.setSortBy, sortBy: mn });
        }, [k]), cn = d.useCallback(function(mn, wn, Kn) {
          k({ type: h.toggleSortBy, columnId: mn, desc: wn, multi: Kn });
        }, [k]), K = Dn(n);
        W.forEach(function(mn) {
          var wn = mn.accessor, Kn = mn.canSort, Nn = mn.disableSortBy, Vn = mn.id, e = wn ? Yn(Nn !== !0 && void 0, V !== !0 && void 0, !0) : Yn(I, Kn, !1);
          mn.canSort = e, mn.canSort && (mn.toggleSortBy = function(u, a) {
            return cn(mn.id, u, a);
          }, mn.clearSortBy = function() {
            k({ type: h.clearSortBy, columnId: mn.id });
          }), mn.getSortByToggleProps = Cn(X().getSortByToggleProps, { instance: K(), column: mn });
        ...
        }, [T, x, i, l, m, v, R]), en = Pn[0], bn = Pn[1], Gn = Dn(sn);
        xn(function() {
          Gn() && k({ type: h.resetSortBy });
        }, [T ? null : r]), Object.assign(n, { preSortedRows: i, preSortedFlatRows: l, sortedRows: en, sortedFlatRows: bn, rows: en, flatRows: bn, setSortBy: kn, toggleSortBy: cn });
      }
      function no(n, r, i) {
        return [].concat(n).sort(function(l, m) {
          for (var f = 0; f < r.length; f += 1) {
            var v = r[f], R = i[f] === !1 || i[f] === "desc", T = v(l, m);
            if (T !== 0)
              return R ? -T : T;
          }
          return i[0] ? l.index - m.index : m.index - l.index;
        });
      }
      h.resetPage = "resetPage", h.gotoPage = "gotoPage", h.setPageSize = "setPageSize";
      var wt = function(n) {
        n.stateReducers.push(Vo), n.useInstance.push(Ko);
      };
      function Vo(n, r, i, l) {
        if (r.type === h.init)
        ...
        if (r.type === h.gotoPage) {
          var m = l.pageCount, f = l.page, v = Wn(r.pageIndex, n.pageIndex), R = !1;
          return v > n.pageIndex ? R = m === -1 ? f.length >= n.pageSize : v < m : v < n.pageIndex && (R = v > -1), R ? y({}, n, { pageIndex: v }) : n;
        }
      ...
      function Ko(n) {
        var r = n.rows, i = n.autoResetPage, l = i === void 0 || i, m = n.manualExpandedKey, f = m === void 0 ? "expanded" : m, v = n.plugins, R = n.pageCount, T = n.paginateExpandedRows, I = T === void 0 || T, V = n.expandSubRows, W = V === void 0 || V, x = n.state, k = x.pageSize, F = x.pageIndex, X = x.expanded, U = x.globalFilter, sn = x.filters, kn = x.groupBy, cn = x.sortBy, K = n.dispatch, Pn = n.data, en = n.manualPagination;
        Sn(v, ["useGlobalFilter", "useFilters", "useGroupBy", "useSortBy", "useExpanded"], "usePagination");
        var bn = Dn(l);
        xn(function() {
          bn() && K({ type: h.resetPage });
        }, [K, en ? null : Pn, U, sn, kn, cn]);
        var Gn = en ? R : Math.ceil(r.length / k), mn = d.useMemo(function() {
          return Gn > 0 ? [].concat(new Array(Gn)).fill(null).map(function(a, p) {
            return p;
          }) : [];
        }, [Gn]), wn = d.useMemo(function() {
          var a;
          if (en)
            a = r;
          else {
          ...
          return I ? a : Te(a, { manualExpandedKey: f, expanded: X, expandSubRows: W });
        }, [W, X, f, en, F, k, I, r]), Kn = F > 0, Nn = Gn === -1 ? wn.length >= k : F < Gn - 1, Vn = d.useCallback(function(a) {
        ...
        }, [Vn]), u = d.useCallback(function(a) {
          K({ type: h.setPageSize, pageSize: a });
        }, [K]);
        Object.assign(n, { pageOptions: mn, pageCount: Gn, page: wn, canPreviousPage: Kn, canNextPage: Nn, gotoPage: Vn, previousPage: e, nextPage: t, setPageSize: u });
      }
      wt.pluginName = "usePagination", h.resetPivot = "resetPivot", h.togglePivot = "togglePivot";
      var Mt = function(n) {
        n.getPivotToggleProps = [qo], n.stateReducers.push(zo), n.useInstanceAfterData.push(_o), n.allColumns.push(Xo), n.accessValue.push(Yo), n.materializedColumns.push(to), n.materializedColumnsDeps.push(oo), n.visibleColumns.push(jo), n.visibleColumnsDeps.push(Uo), n.useInstance.push(Jo), n.prepareRow.push($o);
      };
      Mt.pluginName = "usePivotColumns";
      var eo = [], qo = function(n, r) {
        var i = r.header;
      ...
      function zo(n, r, i, l) {
        if (r.type === h.init)
          return y({ pivotColumns: eo }, n);
        if (r.type === h.resetPivot)
          return y({}, n, { pivotColumns: l.initialState.pivotColumns || eo });
        if (r.type === h.togglePivot) {
          var m = r.columnId, f = r.value, v = f !== void 0 ? f : !n.pivotColumns.includes(m);
          return y({}, n, v ? { pivotColumns: [].concat(n.pivotColumns, [m]) } : { pivotColumns: n.pivotColumns.filter(function(R) {
            return R !== m;
          }) });
        }
      }
      ...
      function to(n, r) {
        var i = r.instance, l = i.allColumns, m = i.state;
        if (!m.pivotColumns.length || !m.groupBy || !m.groupBy.length)
          return n;
        var f = m.pivotColumns.map(function(T) {
          return l.find(function(I) {
            return I.id === T;
          });
        }).filter(Boolean), v = l.filter(function(T) {
          return !T.isPivotSource && !m.groupBy.includes(T.id) && !m.pivotColumns.includes(T.id);
        }), R = Ce(function T(I, V, W) {
          I === void 0 && (I = 0), W === void 0 && (W = []);
          var x = f[I];
          return x ? Array.from(x.uniqueValues).sort().map(function(k) {
            var F = y({}, x, { Header: x.PivotHeader || typeof x.header == "string" ? x.Header + ": " + k : k, isPivotGroup: !0, parent: V, depth: I, id: V ? V.id + "." + x.id + "." + k : x.id + "." + k, pivotValue: k });
            return F.columns = T(I + 1, F, [].concat(W, [function(X) {
              return X.values[x.id] === k;
            }])), F;
          }) : v.map(function(k) {
            return y({}, k, { canPivot: !1, isPivoted: !0, parent: V, depth: I, id: "" + (V ? V.id + "." + k.id : k.id), accessor: function(F, X, U) {
      ...
      function oo(n, r) {
        var i = r.instance.state, l = i.pivotColumns, m = i.groupBy;
        return [].concat(n, [l, m]);
      }
      function jo(n, r) {
      ...
      function Jo(n) {
        var r = n.columns, i = n.allColumns, l = n.flatHeaders, m = n.getHooks, f = n.plugins, v = n.dispatch, R = n.autoResetPivot, T = R === void 0 || R, I = n.manaulPivot, V = n.disablePivot, W = n.defaultCanPivot;
        Sn(f, ["useGroupBy"], "usePivotColumns");
        var x = Dn(n);
        i.forEach(function(F) {
          var X = F.accessor, U = F.defaultPivot, sn = F.disablePivot;
          F.canPivot = X ? Yn(F.canPivot, sn !== !0 && void 0, V !== !0 && void 0, !0) : Yn(F.canPivot, U, W, !1), F.canPivot && (F.togglePivot = function() {
            return n.togglePivot(F.id);
          }), F.Aggregated = F.Aggregated || F.Cell;
        }), l.forEach(function(F) {
          F.getPivotToggleProps = Cn(m().getPivotToggleProps, { instance: x(), header: F });
        });
        var k = Dn(T);
        xn(function() {
          k() && v({ type: h.resetPivot });
        }, [v, I ? null : r]), Object.assign(n, { togglePivot: function(F, X) {
          v({ type: h.togglePivot, columnId: F, value: X });
        } });
      }
      function $o(n) {
        n.allCells.forEach(function(r) {
      ...
      var ao = function(n) {
        n.getToggleRowSelectedProps = [bt], n.getToggleAllRowsSelectedProps = [tt], n.getToggleAllPageRowsSelectedProps = [ro], n.stateReducers.push(Zo), n.useInstance.push(uo), n.prepareRow.push(Qo);
      };
      ao.pluginName = "useRowSelect";
      var bt = function(n, r) {
        var i = r.instance, l = r.row, m = i.manualRowSelectedKey, f = m === void 0 ? "isSelected" : m;
        return [n, { onChange: function(v) {
          l.toggleRowSelected(v.target.checked);
      ...
      function Zo(n, r, i, l) {
        ...
        if (r.type === h.toggleAllRowsSelected) {
          var m = r.value, f = l.isAllRowsSelected, v = l.rowsById, R = l.nonGroupedRowsById, T = R === void 0 ? v : R, I = m !== void 0 ? m : !f, V = Object.assign({}, n.selectedRowIds);
          return I ? Object.keys(T).forEach(function(Vn) {
            V[Vn] = !0;
        ...
        if (r.type === h.toggleRowSelected) {
          var W = r.id, x = r.value, k = l.rowsById, F = l.selectSubRows, X = F === void 0 || F, U = l.getSubRows, sn = n.selectedRowIds[W], kn = x !== void 0 ? x : !sn;
          if (sn === kn)
            return n;
          var cn = y({}, n.selectedRowIds);
          return function Vn(e) {
            var t = k[e];
            if (t && (t.isGrouped || (kn ? cn[e] = !0 : delete cn[e]), X && U(t)))
              return U(t).forEach(function(u) {
                return Vn(u.id);
              });
          }(W), y({}, n, { selectedRowIds: cn });
        }
        if (r.type === h.toggleAllPageRowsSelected) {
          var K = r.value, Pn = l.page, en = l.rowsById, bn = l.selectSubRows, Gn = bn === void 0 || bn, mn = l.isAllPageRowsSelected, wn = l.getSubRows, Kn = K !== void 0 ? K : !mn, Nn = y({}, n.selectedRowIds);
          return Pn.forEach(function(Vn) {
            return function e(t) {
              var u = en[t];
              if (u.isGrouped || (Kn ? Nn[t] = !0 : delete Nn[t]), Gn && wn(u))
                return wn(u).forEach(function(a) {
                  return e(a.id);
                });
            }(Vn.id);
          }), y({}, n, { selectedRowIds: Nn });
        }
        return n;
      }
      function uo(n) {
        var r = n.data, i = n.rows, l = n.getHooks, m = n.plugins, f = n.rowsById, v = n.nonGroupedRowsById, R = v === void 0 ? f : v, T = n.autoResetSelectedRows, I = T === void 0 || T, V = n.state.selectedRowIds, W = n.selectSubRows, x = W === void 0 || W, k = n.dispatch, F = n.page, X = n.getSubRows;
        Sn(m, ["useFilters", "useGroupBy", "useSortBy", "useExpanded", "usePagination"], "useRowSelect");
        ...
        }, [i, x, V, X]), sn = !!(Object.keys(R).length && Object.keys(V).length), kn = sn;
        sn && Object.keys(R).some(function(wn) {
          return !V[wn];
        }) && (sn = !1), sn || F && F.length && F.some(function(wn) {
          var Kn = wn.id;
          return !V[Kn];
        }) && (kn = !1);
        var cn = Dn(I);
        xn(function() {
          cn() && k({ type: h.resetSelectedRows });
        }, [k, r]);
        var K = d.useCallback(function(wn) {
          return k({ type: h.toggleAllRowsSelected, value: wn });
        }, [k]), Pn = d.useCallback(function(wn) {
          return k({ type: h.toggleAllPageRowsSelected, value: wn });
        }, [k]), en = d.useCallback(function(wn, Kn) {
          return k({ type: h.toggleRowSelected, id: wn, value: Kn });
        }, [k]), bn = Dn(n), Gn = Cn(l().getToggleAllRowsSelectedProps, { instance: bn() }), mn = Cn(l().getToggleAllPageRowsSelectedProps, { instance: bn() });
        Object.assign(n, { selectedFlatRows: U, isAllRowsSelected: sn, isAllPageRowsSelected: kn, toggleRowSelected: en, toggleAllRowsSelected: K, getToggleAllRowsSelectedProps: Gn, getToggleAllPageRowsSelectedProps: mn, toggleAllPageRowsSelected: Pn });
      }
      function Qo(n, r) {
        var i = r.instance;
      ...
      var At = function(n) {
        n.stateReducers.push(na), n.useInstance.push(so), n.prepareRow.push(ea);
      };
      function na(n, r, i, l) {
        var m = l.initialRowStateAccessor, f = m === void 0 ? io : m, v = l.initialCellStateAccessor, R = v === void 0 ? lo : v, T = l.rowsById;
        if (r.type === h.init)
          return y({ rowState: {} }, n);
        ...
        if (r.type === h.setRowState) {
          ...
          return y({}, n, { rowState: y({}, n.rowState, (I = {}, I[V] = Wn(W, x), I)) });
        }
        if (r.type === h.setCellState) {
          var k, F, X, U, sn, kn = r.rowId, cn = r.columnId, K = r.value, Pn = n.rowState[kn] !== void 0 ? n.rowState[kn] : f(T[kn]), en = (Pn == null || (k = Pn.cellState) == null ? void 0 : k[cn]) !== void 0 ? Pn.cellState[cn] : R((F = T[kn]) == null || (X = F.cells) == null ? void 0 : X.find(function(bn) {
            return bn.column.id === cn;
          }));
          return y({}, n, { rowState: y({}, n.rowState, (sn = {}, sn[kn] = y({}, Pn, { cellState: y({}, Pn.cellState || {}, (U = {}, U[cn] = Wn(K, en), U)) }), sn)) });
        }
      }
      function so(n) {
        var r = n.autoResetRowState, i = r === void 0 || r, l = n.data, m = n.dispatch, f = d.useCallback(function(T, I) {
          return m({ type: h.setRowState, rowId: T, value: I });
        }, [m]), v = d.useCallback(function(T, I, V) {
          return m({ type: h.setCellState, rowId: T, columnId: I, value: V });
        }, [m]), R = Dn(i);
        xn(function() {
          R() && m({ type: h.resetRowState });
        }, [l]), Object.assign(n, { setRowState: f, setCellState: v });
      }
      function ea(n, r) {
        var i = r.instance, l = i.initialRowStateAccessor, m = l === void 0 ? io : l, f = i.initialCellStateAccessor, v = f === void 0 ? lo : f, R = i.state.rowState;
        n && (n.state = R[n.id] !== void 0 ? R[n.id] : m(n), n.setState = function(T) {
          return i.setRowState(n.id, T);
        }, n.cells.forEach(function(T) {
          n.state.cellState || (n.state.cellState = {}), T.state = n.state.cellState[T.column.id] !== void 0 ? n.state.cellState[T.column.id] : v(T), T.setState = function(I) {
            return i.setCellState(n.id, T.column.id, I);
          };
        }));
      }
      At.pluginName = "useRowState", h.resetColumnOrder = "resetColumnOrder", h.setColumnOrder = "setColumnOrder";
      var co = function(n) {
        n.stateReducers.push(yo), n.visibleColumnsDeps.push(function(r, i) {
          var l = i.instance;
          return [].concat(r, [l.state.columnOrder]);
        }), n.visibleColumns.push(Co), n.useInstance.push(ta);
      };
      function yo(n, r, i, l) {
        return r.type === h.init ? y({ columnOrder: [] }, n) : r.type === h.resetColumnOrder ? y({}, n, { columnOrder: l.initialState.columnOrder || [] }) : r.type === h.setColumnOrder ? y({}, n, { columnOrder: Wn(r.columnOrder, n.columnOrder) }) : void 0;
      }
      function Co(n, r) {
        var i = r.instance.state.columnOrder;
        if (!i || !i.length)
          return n;
        for (var l = [].concat(i), m = [].concat(n), f = [], v = function() {
          var R = l.shift(), T = m.findIndex(function(I) {
            return I.id === R;
          });
          T > -1 && f.push(m.splice(T, 1)[0]);
        }; m.length && l.length; )
          v();
        return [].concat(f, m);
      }
      ...
      co.pluginName = "useColumnOrder", ln.canResize = !0, h.columnStartResizing = "columnStartResizing", h.columnResizing = "columnResizing", h.columnDoneResizing = "columnDoneResizing", h.resetResize = "resetResize";
      var po = function(n) {
        ...
        var i = r.instance, l = r.header, m = i.dispatch, f = function(v, R) {
          var T = !1;
          ...
          var I, V, W = function(cn) {
            var K = [];
            return function Pn(en) {
              en.columns && en.columns.length && en.columns.map(Pn), K.push(en);
            }(cn), K;
          }(R).map(function(cn) {
            return [cn.id, cn.totalWidth];
          }), x = T ? Math.round(v.touches[0].clientX) : v.clientX, k = function() {
            ...
            V = cn, I || (I = window.requestAnimationFrame(F));
          ...
          } } }, sn = T ? U.touch : U.mouse, kn = !!function() {
          ...
          document.addEventListener(sn.moveEvent, sn.moveHandler, kn), document.addEventListener(sn.upEvent, sn.upHandler, kn), m({ type: h.columnStartResizing, columnId: R.id, columnWidth: R.totalWidth, headerIdWidths: W, clientX: x });
        };
        return [n, { onMouseDown: function(v) {
          return v.persist() || f(v, l);
      ...
      function aa(n, r) {
        ...
        if (r.type === h.columnStartResizing) {
          var i = r.clientX, l = r.columnId, m = r.columnWidth, f = r.headerIdWidths;
          return y({}, n, { columnResizing: y({}, n.columnResizing, { startX: i, headerIdWidths: f, columnWidth: m, isResizingColumn: l }) });
        }
        if (r.type === h.columnResizing) {
          var v = r.clientX, R = n.columnResizing, T = R.startX, I = R.columnWidth, V = R.headerIdWidths, W = (v - T) / I, x = {};
          return (V === void 0 ? [] : V).forEach(function(k) {
            var F = k[0], X = k[1];
            x[F] = Math.max(X + X * W, 0);
      ...
      po.pluginName = "useResizeColumns";
      var ra = function(n) {
        var r = n.flatHeaders, i = n.disableResizing, l = n.getHooks, m = n.state.columnResizing, f = Dn(n);
        r.forEach(function(v) {
          var R = Yn(v.disableResizing !== !0 && void 0, i !== !0 && void 0, !0);
          v.canResize = R, v.width = m.columnWidths[v.id] || v.originalWidth || v.width, v.isResizing = m.isResizingColumn === v.id, R && (v.getResizerProps = Cn(l().getResizerProps, { instance: f(), header: v }));
        });
      };
      function ua(n) {
        var r = n.plugins, i = n.dispatch, l = n.autoResetResize, m = l === void 0 || l, f = n.columns;
        Sn(r, ["useAbsoluteLayout"], "useResizeColumns");
        var v = Dn(m);
        xn(function() {
          v() && i({ type: h.resetResize });
        }, [f]);
      ...
      var Dt = { position: "absolute", top: 0 }, fo = function(n) {
        n.getTableBodyProps.push(lt), n.getRowProps.push(lt), n.getHeaderGroupProps.push(lt), n.getFooterGroupProps.push(lt), n.getHeaderProps.push(function(r, i) {
          var l = i.column;
          return [r, { style: y({}, Dt, { left: l.totalLeft + "px", width: l.totalWidth + "px" }) }];
        }), n.getCellProps.push(function(r, i) {
          var l = i.cell;
          return [r, { style: y({}, Dt, { left: l.column.totalLeft + "px", width: l.column.totalWidth + "px" }) }];
      ...
      }, Rt = { display: "inline-block", boxSizing: "border-box" }, Nt = function(n, r) {
        return [n, { style: { display: "flex", width: r.instance.totalColumnsWidth + "px" } }];
      }, go = function(n) {
        n.getRowProps.push(Nt), n.getHeaderGroupProps.push(Nt), n.getFooterGroupProps.push(Nt), n.getHeaderProps.push(function(r, i) {
          var l = i.column;
          return [r, { style: y({}, Rt, { width: l.totalWidth + "px" }) }];
        }), n.getCellProps.push(function(r, i) {
          var l = i.cell;
          return [r, { style: y({}, Rt, { width: l.column.totalWidth + "px" }) }];
        }), n.getFooterProps.push(function(r, i) {
          var l = i.column;
          return [r, { style: y({}, Rt, { width: l.totalWidth + "px" }) }];
        });
      ...
      function Tt(n) {
        n.getTableProps.push(ia), n.getRowProps.push(Pt), n.getHeaderGroupProps.push(Pt), n.getFooterGroupProps.push(Pt), n.getHeaderProps.push(la), n.getCellProps.push(sa), n.getFooterProps.push(ca);
      }
      go.pluginName = "useBlockLayout", Tt.pluginName = "useFlexLayout";
      var ia = function(n, r) {
      ...
      function mo(n) {
        n.stateReducers.push(wo), n.getTableProps.push(ho), n.getHeaderProps.push(vo), n.getRowProps.push(So);
      }
      h.columnStartResizing = "columnStartResizing", h.columnResizing = "columnResizing", h.columnDoneResizing = "columnDoneResizing", h.resetResize = "resetResize", mo.pluginName = "useGridLayout";
      var ho = function(n, r) {
        var i = r.instance;
        return [n, { style: { display: "grid", gridTemplateColumns: i.visibleColumns.map(function(l) {
          var m;
          return i.state.gridLayout.columnWidths[l.id] ? i.state.gridLayout.columnWidths[l.id] + "px" : (m = i.state.columnResizing) != null && m.isResizingColumn ? i.state.gridLayout.startWidths[l.id] + "px" : typeof l.width == "number" ? l.width + "px" : l.width;
        }).join(" ") } }];
      }, vo = function(n, r) {
        var i = r.column;
      ...
      function wo(n, r, i, l) {
        ...
        if (r.type === h.columnStartResizing) {
          var m = r.columnId, f = r.headerIdWidths, v = It(m);
          if (v !== void 0) {
            var R = l.visibleColumns.reduce(function(K, Pn) {
              var en;
              return y({}, K, ((en = {})[Pn.id] = It(Pn.id), en));
            }, {}), T = l.visibleColumns.reduce(function(K, Pn) {
              var en;
              return y({}, K, ((en = {})[Pn.id] = Pn.minWidth, en));
            }, {}), I = l.visibleColumns.reduce(function(K, Pn) {
              var en;
              return y({}, K, ((en = {})[Pn.id] = Pn.maxWidth, en));
            }, {}), V = f.map(function(K) {
              var Pn = K[0];
              return [Pn, It(Pn)];
            });
            return y({}, n, { gridLayout: y({}, n.gridLayout, { startWidths: R, minWidths: T, maxWidths: I, headerIdGridWidths: V, columnWidth: v }) });
          }
          return n;
        }
        if (r.type === h.columnResizing) {
          var W = r.clientX, x = n.columnResizing.startX, k = n.gridLayout, F = k.columnWidth, X = k.minWidths, U = k.maxWidths, sn = k.headerIdGridWidths, kn = (W - x) / F, cn = {};
          return (sn === void 0 ? [] : sn).forEach(function(K) {
            var Pn = K[0], en = K[1];
            cn[Pn] = Math.min(Math.max(X[Pn], en + en * kn), U[Pn]);
          }), y({}, n, { gridLayout: y({}, n.gridLayout, { columnWidths: y({}, n.gridLayout.columnWidths, {}, cn) }) });
        }
      ...
      s._UNSTABLE_usePivotColumns = Mt, s.actions = h, s.defaultColumn = ln, s.defaultGroupByFn = Jt, s.defaultOrderByFn = no, s.defaultRenderer = fn, s.emptyRenderer = w, s.ensurePluginOrder = Sn, s.flexRender = ae, s.functionalUpdate = Wn, s.loopHooks = zn, s.makePropGetter = Cn, s.makeRenderer = Rn, s.reduceHooks = gn, s.safeUseLayoutEffect = Jn, s.useAbsoluteLayout = fo, s.useAsyncDebounce = function(n, r) {
        r === void 0 && (r = 0);
        var i = d.useRef({}), l = Dn(n), m = Dn(r);
        return d.useCallback(function() {
          var f = P(regeneratorRuntime.mark(function v() {
              ...
              for (; ; )
                switch (W.prev = W.next) {
                  case 0:
                    ...
                    })), m()), W.abrupt("return", i.current.promise);
                  case 5:
                  case "end":
                    return W.stop();
                }
      ...
      }, s.useBlockLayout = go, s.useColumnOrder = co, s.useExpanded = Ie, s.useFilters = Vt, s.useFlexLayout = Tt, s.useGetLatest = Dn, s.useGlobalFilter = mt, s.useGridLayout = mo, s.useGroupBy = St, s.useMountedLayoutEffect = xn, s.usePagination = wt, s.useResizeColumns = po, s.useRowSelect = ao, s.useRowState = At, s.useSortBy = Qt, s.useTable = function(n) {
        for (var r = arguments.length, i = new Array(r > 1 ? r - 1 : 0), l = 1; l < r; l++)
          i[l - 1] = arguments[l];
        n = ie(n), i = [Ae].concat(i);
        var m = d.useRef({}), f = Dn(m.current);
        Object.assign(f(), y({}, n, { plugins: i, hooks: Pe() })), i.filter(Boolean).forEach(function(c) {
          c(f().hooks);
        });
        var v = Dn(f().hooks);
        f().getHooks = v, delete f().hooks, Object.assign(f(), gn(v().useOptions, ie(n)));
        var R = f(), T = R.data, I = R.columns, V = R.initialState, W = R.defaultColumn, x = R.getSubRows, k = R.getRowId, F = R.stateReducer, X = R.useControlledState, U = Dn(F), sn = d.useCallback(function(c, S) {
          if (!S.type)
        ...
        }, [v, U, f]), kn = d.useReducer(sn, void 0, function() {
          return sn(V, { type: h.init });
        }), cn = kn[0], K = kn[1], Pn = gn([].concat(v().useControlledState, [X]), cn, { instance: f() });
        Object.assign(f(), { state: Pn, dispatch: K });
        var en = d.useMemo(function() {
          return qn(gn(v().columns, I, { instance: f() }));
        }, [v, f, I].concat(gn(v().columnsDeps, [], { instance: f() })));
        f().columns = en;
        var bn = d.useMemo(function() {
          return gn(v().allColumns, Ce(en), { instance: f() }).map(ne);
        }, [en, v, f].concat(gn(v().allColumnsDeps, [], { instance: f() })));
        f().allColumns = bn;
        var Gn = d.useMemo(function() {
          for (var c = [], S = [], D = {}, N = [].concat(bn); N.length; ) {
            var L = N.shift();
            We({ data: T, rows: c, flatRows: S, rowsById: D, column: L, getRowId: k, getSubRows: x, accessValueHooks: v().accessValue, getInstance: f });
          }
          return [c, S, D];
        }, [bn, T, k, x, v, f]), mn = Gn[0], wn = Gn[1], Kn = Gn[2];
        Object.assign(f(), { rows: mn, initialRows: [].concat(mn), flatRows: wn, rowsById: Kn }), zn(v().useInstanceAfterData, f());
        var Nn = d.useMemo(function() {
          return gn(v().visibleColumns, bn, { instance: f() }).map(function(c) {
            return tn(c, W);
          });
        }, [v, bn, f, W].concat(gn(v().visibleColumnsDeps, [], { instance: f() })));
        ...
        }, [bn, Nn]), f().allColumns = bn;
        var Vn = d.useMemo(function() {
          return gn(v().headerGroups, pn(Nn, W), f());
        }, [v, Nn, W, f].concat(gn(v().headerGroupsDeps, [], { instance: f() })));
        f().headerGroups = Vn;
        var e = d.useMemo(function() {
          return Vn.length ? Vn[0].headers : [];
        }, [Vn]);
        f().headers = e, f().flatHeaders = Vn.reduce(function(c, S) {
          return [].concat(c, S.headers);
        }, []), zn(v().useInstanceBeforeDimensions, f());
        var t = Nn.filter(function(c) {
          return c.isVisible;
        }).map(function(c) {
          return c.id;
        }).sort().join("_");
        ...
        var u = ge(e), a = u[0], p = u[1], g = u[2];
        return f().totalColumnsMinWidth = a, f().totalColumnsWidth = p, f().totalColumnsMaxWidth = g, zn(v().useInstance, f()), [].concat(f().flatHeaders, f().allColumns).forEach(function(c) {
          c.render = Rn(f(), c), c.getHeaderProps = Cn(v().getHeaderProps, { instance: f(), column: c }), c.getFooterProps = Cn(v().getFooterProps, { instance: f(), column: c });
          ...
          return Vn.filter(function(c, S) {
            ...
            }), !!c.headers.length && (c.getHeaderGroupProps = Cn(v().getHeaderGroupProps, { instance: f(), headerGroup: c, index: S }), c.getFooterGroupProps = Cn(v().getFooterGroupProps, { instance: f(), headerGroup: c, index: S }), !0);
          });
        }, [Vn, f, v]), f().footerGroups = [].concat(f().headerGroups).reverse(), f().prepareRow = d.useCallback(function(c) {
          c.getRowProps = Cn(v().getRowProps, { instance: f(), row: c }), c.allCells = bn.map(function(S) {
            var D = c.values[S.id], N = { column: S, row: c, value: D };
            return N.getCellProps = Cn(v().getCellProps, { instance: f(), cell: N }), N.render = Rn(f(), S, { row: c, cell: N, value: D }), N;
          }), c.cells = Nn.map(function(S) {
            return c.allCells.find(function(D) {
              return D.column.id === S.id;
            });
          }), zn(v().prepareRow, c, { instance: f() });
        }, [v, f, bn, Nn]), f().getTableProps = Cn(v().getTableProps, { instance: f() }), f().getTableBodyProps = Cn(v().getTableBodyProps, { instance: f() }), zn(v().useFinalInstance, f()), f();
  ...
  return Ja || (Ja = 1, function(o, C) {
    (function(s, d) {
      ...
      function b(e, t, u, a, p, g, c) {
        try {
          var S = e[g](c), D = S.value;
        } catch (N) {
          u(N);
          return;
        }
        S.done ? t(D) : Promise.resolve(D).then(a, p);
      }
      function P(e) {
        return function() {
      ...
      function gn() {
        ...
        return t.reduce(function(a, p) {
          var g = p.style, c = p.className, S = E(p, ["style", "className"]);
          return a = y({}, a, {}, S), g && (a.style = a.style ? y({}, a.style || {}, {}, g || {}) : g), c && (a.className = a.className ? a.className + " " + c : c), a.className === "" && delete a.className, a;
        }, {});
      }
      function zn(e, t, u) {
        return typeof t == "function" ? zn({}, t(e, u)) : Array.isArray(t) ? gn.apply(void 0, [e].concat(t)) : gn(e, t);
      }
      var Sn = function(t, u) {
...
`);
                              ...
                              return regeneratorRuntime.wrap(function(O) {
                                for (; ; )
                                  switch (O.prev = O.next) {
                                    case 0:
                                      return delete u.current.timeout, O.prev = 1, O.t0 = u.current, O.next = 5, a().apply(void 0, D);
                                    case 5:
      ...
      function ne(e, t, u) {
        return u === void 0 && (u = {}), function(a, p) {
          ...
          if (typeof g > "u")
            throw console.info(t), new Error(fn);
          return tn(g, y({}, e, {
            column: t
          }, u, {}, p));
        };
      ...
      function tn(e, t) {
        return pn(e) ? d.createElement(e, t) : e;
      }
      function pn(e) {
      ...
      function $n(e, t, u) {
        return u === void 0 && (u = 0), e.map(function(a) {
          return a = y({}, a, {
            parent: t,
            depth: u
          }), Te(a), a.columns && (a.columns = $n(a.columns, a, u + 1)), a;
        });
      }
      function Le(e) {
        return Fe(e, "columns");
        ...
        for (var a = [], p = e, g = 0, c = function() {
          ...
          p.forEach(function(B) {
            ...
            if (q) {
              ...
              G && G.originalId === _.originalId ? G.headers.push(B) : L.push(_);
            }
            N.headers.push(B);
          }), a.push(N), p = L;
        }; p.length; )
      ...
      function me(e, t, u) {
        if (!t)
          return e;
        var a = typeof t == "function" ? t : JSON.stringify(t), p = pe.get(a) || function() {
          var c = Ae(t);
          return pe.set(a, c), c;
        }(), g;
        try {
          g = p.reduce(function(c, S) {
            return c[S];
          }, e);
        } catch {
        }
      ...
      function H(e, t) {
        var u = t.manualExpandedKey, a = t.expanded, p = t.expandSubRows, g = p === void 0 ? !0 : p, c = [], S = function D(N, L) {
      ...
      function Ae(e) {
        ...
        }).join(".").replace(we, ".").replace(Pe, "").split(".");
      }
      function De(e, t) {
      ...
      function Ln() {
        return {
          ...
          prepareRow: [],
          getTableProps: [Oe],
          getTableBodyProps: [Ye],
          getHeaderGroupProps: [he],
      ...
      var te = function(t) {
        t.getToggleHiddenProps = [ie], t.getToggleHideAllColumnsProps = [ge], t.stateReducers.push(We), t.useInstanceBeforeDimensions.push(Ie), t.headerGroupsDeps.push(function(u, a) {
          var p = a.instance;
      ...
      function We(e, t, u, a) {
        ...
        if (t.type === w.toggleHideColumn) {
          var p = typeof t.value < "u" ? t.value : !e.hiddenColumns.includes(t.columnId), g = p ? [].concat(e.hiddenColumns, [t.columnId]) : e.hiddenColumns.filter(function(S) {
            return S !== t.columnId;
          });
          return y({}, e, {
            hiddenColumns: g
      ...
      function Ie(e) {
        ...
        var p = function c(S, D) {
          ...
          var N = 0;
          return S.headers && S.headers.length ? S.headers.forEach(function(L) {
            return N += c(L, S.isVisible);
      ...
      function Ue(e) {
        var t = e.columns, u = e.flatHeaders, a = e.dispatch, p = e.allColumns, g = e.getHooks, c = e.state.hiddenColumns, S = e.autoResetHiddenColumns, D = S === void 0 ? !0 : S, N = Rn(e), L = p.length === c.length, q = d.useCallback(function(Z, dn) {
          return a({
        ...
        }, [a]), G = d.useCallback(function(Z) {
          return a({
            type: w.toggleHideAllColumns,
            value: Z
          });
        }, [a]), _ = Sn(g().getToggleHideAllColumnsProps, {
          instance: N()
        });
        u.forEach(function(Z) {
          Z.toggleHidden = function(dn) {
            a({
              type: w.toggleHideColumn,
              columnId: Z.id,
              value: dn
            });
          }, Z.getToggleHiddenProps = Sn(g().getToggleHiddenProps, {
            instance: N(),
            column: Z
          });
        });
      ...
      function xe(e) {
        var t = e.initialState, u = t === void 0 ? Je : t, a = e.defaultColumn, p = a === void 0 ? $e : a, g = e.getSubRows, c = g === void 0 ? Ze : g, S = e.getRowId, D = S === void 0 ? Ve : S, N = e.stateReducer, L = N === void 0 ? Ge : N, q = e.useControlledState, B = q === void 0 ? Ke : q, G = E(e, ["initialState", "defaultColumn", "getSubRows", "getRowId", "stateReducer", "useControlledState"]);
        return y({}, G, {
          initialState: u,
          defaultColumn: p,
          getSubRows: c,
      ...
      var ut = function(t) {
        for (var u = arguments.length, a = new Array(u > 1 ? u - 1 : 0), p = 1; p < u; p++)
          a[p - 1] = arguments[p];
        t = xe(t), a = [te].concat(a);
        var g = d.useRef({}), c = Rn(g.current);
        Object.assign(c(), y({}, t, {
          plugins: a,
          hooks: Ln()
        })), a.filter(Boolean).forEach(function(hn) {
          hn(c().hooks);
        });
        var S = Rn(c().hooks);
        c().getHooks = S, delete c().hooks, Object.assign(c(), Wn(S().useOptions, xe(t)));
        var D = c(), N = D.data, L = D.columns, q = D.initialState, B = D.defaultColumn, G = D.getSubRows, _ = D.getRowId, O = D.stateReducer, Z = D.useControlledState, dn = Rn(O), vn = d.useCallback(function(hn, Zn) {
          if (!Zn.type)
            throw console.info({
              action: Zn
            }), new Error("Unknown Action 👆");
          return [].concat(S().stateReducers, Array.isArray(dn()) ? dn() : [dn()]).reduce(function(ue, Se) {
            return Se(ue, Zn, hn, c()) || ue;
          }, hn);
        }, [S, dn, c]), j = d.useReducer(vn, void 0, function() {
          return vn(q, {
            type: w.init
          });
        }), In = j[0], Hn = j[1], J = Wn([].concat(S().useControlledState, [Z]), In, {
          instance: c()
        });
        Object.assign(c(), {
          state: J,
        ...
        var Y = d.useMemo(function() {
          return $n(Wn(S().columns, L, {
            instance: c()
          }));
        }, [S, c, L].concat(Wn(S().columnsDeps, [], {
          instance: c()
        })));
        c().columns = Y;
        var $ = d.useMemo(function() {
          return Wn(S().allColumns, Le(Y), {
            instance: c()
          }).map(Te);
        ...
        var yn = d.useMemo(function() {
          for (var hn = [], Zn = [], ue = {}, Se = [].concat($); Se.length; ) {
            var se = Se.shift();
            Ft({
              data: N,
              rows: hn,
          ...
          return [hn, Zn, ue];
        }, [$, N, _, G, S, c]), On = yn[0], Bn = yn[1], Xn = yn[2];
        Object.assign(c(), {
          rows: On,
          initialRows: [].concat(On),
          flatRows: Bn,
          rowsById: Xn
          // materializedColumns,
        ...
        {
          var le = $.filter(function(hn, Zn) {
            return $.findIndex(function(ue) {
              return ue.id === hn.id;
            }) !== Zn;
          });
          if (le.length)
            throw console.info($), new Error('Duplicate columns were found with ids: "' + le.map(function(hn) {
              return hn.id;
            }).join(", ") + '" in the columns array above');
        }
        var En = d.useMemo(function() {
          return Wn(S().headerGroups, ke(rn, B), c());
        }, [S, rn, B, c].concat(Wn(S().headerGroupsDeps, [], {
          instance: c()
        })));
        c().headerGroups = En;
        var Mn = d.useMemo(function() {
          return En.length ? En[0].headers : [];
        }, [En]);
        c().headers = Mn, c().flatHeaders = En.reduce(function(hn, Zn) {
          return [].concat(hn, Zn.headers);
        }, []), Dn(S().useInstanceBeforeDimensions, c());
        var An = rn.filter(function(hn) {
          return hn.isVisible;
        }).map(function(hn) {
          return hn.id;
        }).sort().join("_");
        ...
        var Un = ft(Mn), ce = Un[0], ot = Un[1], Lt = Un[2];
        return c().totalColumnsMinWidth = ce, c().totalColumnsWidth = ot, c().totalColumnsMaxWidth = Lt, Dn(S().useInstance, c()), [].concat(c().flatHeaders, c().allColumns).forEach(function(hn) {
          hn.render = ne(c(), hn), hn.getHeaderProps = Sn(S().getHeaderProps, {
            instance: c(),
            column: hn
          }), hn.getFooterProps = Sn(S().getFooterProps, {
            instance: c(),
            column: hn
          });
        }), c().headerGroups = d.useMemo(function() {
          return En.filter(function(hn, Zn) {
            return hn.headers = hn.headers.filter(function(ue) {
              var Se = function se(qe) {
                return qe.filter(function(de) {
                  return de.headers ? se(de.headers) : de.isVisible;
                }).length;
              };
              return ue.headers ? Se(ue.headers) : ue.isVisible;
            }), hn.headers.length ? (hn.getHeaderGroupProps = Sn(S().getHeaderGroupProps, {
              instance: c(),
              headerGroup: hn,
              index: Zn
            }), hn.getFooterGroupProps = Sn(S().getFooterGroupProps, {
              instance: c(),
              headerGroup: hn,
              index: Zn
            }), !0) : !1;
          });
        }, [En, c, S]), c().footerGroups = [].concat(c().headerGroups).reverse(), c().prepareRow = d.useCallback(function(hn) {
          hn.getRowProps = Sn(S().getRowProps, {
            instance: c(),
            row: hn
          }), hn.allCells = $.map(function(Zn) {
            var ue = hn.values[Zn.id], Se = {
              column: Zn,
              row: hn,
              value: ue
            };
            return Se.getCellProps = Sn(S().getCellProps, {
              instance: c(),
              cell: Se
            }), Se.render = ne(c(), Zn, {
              row: hn,
          ...
          }), hn.cells = rn.map(function(Zn) {
            return hn.allCells.find(function(ue) {
              return ue.column.id === Zn.id;
            });
          }), Dn(S().prepareRow, hn, {
            instance: c()
          });
        }, [S, c, $, rn]), c().getTableProps = Sn(S().getTableProps, {
          instance: c()
        }), c().getTableBodyProps = Sn(S().getTableBodyProps, {
          instance: c()
      ...
      function ft(e, t) {
        ...
        return e.forEach(function(c) {
          ...
          if (c.totalLeft = t, S && S.length) {
            var D = ft(S, t), N = D[0], L = D[1], q = D[2], B = D[3];
            c.totalMinWidth = N, c.totalWidth = L, c.totalMaxWidth = q, c.totalFlexWidth = B;
          } else
      ...
      function Ft(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, g = e.column, c = e.getRowId, S = e.getSubRows, D = e.accessValueHooks, N = e.getInstance, L = function q(B, G, _, O, Z) {
          _ === void 0 && (_ = 0);
          var dn = B, vn = c(B, G, O), j = p[vn];
          if (j)
          ...
          }, j.cells.map = on, j.cells.filter = on, j.cells.forEach = on, j.cells[0].getCellProps = on, j.values = {}, Z.push(j), a.push(j), p[vn] = j, j.originalSubRows = S(B, G), j.originalSubRows) {
            var In = [];
            j.originalSubRows.forEach(function(Hn, J) {
              return q(Hn, J, _ + 1, j, In);
            }), j.subRows = In;
          }
          g.accessor && (j.values[g.id] = g.accessor(B, G, j, Z, t)), j.values[g.id] = Wn(D, j.values[g.id], {
            row: j,
            column: g,
            instance: N()
          }, !0);
        ...
        t.forEach(function(q, B) {
          return L(q, B, 0, void 0, u);
        });
      }
      w.resetExpanded = "resetExpanded", w.toggleRowExpanded = "toggleRowExpanded", w.toggleAllRowsExpanded = "toggleAllRowsExpanded";
      var gt = function(t) {
        t.getToggleAllRowsExpandedProps = [Wt], t.getToggleRowExpandedProps = [xt], t.stateReducers.push(Gt), t.useInstance.push(Qe), t.prepareRow.push(Vt);
      };
      ...
      function Gt(e, t, u, a) {
        ...
        if (t.type === w.toggleAllRowsExpanded) {
          var p = t.value, g = a.rowsById, c = Object.keys(g).length === Object.keys(e.expanded).length, S = typeof p < "u" ? p : !c;
          if (S) {
            var D = {};
        ...
        if (t.type === w.toggleRowExpanded) {
          var N = t.id, L = t.value, q = e.expanded[N], B = typeof L < "u" ? L : !q;
          if (!q && B) {
            var G;
            return y({}, e, {
      ...
      function Qe(e) {
        var t = e.data, u = e.rows, a = e.rowsById, p = e.manualExpandedKey, g = p === void 0 ? "expanded" : p, c = e.paginateExpandedRows, S = c === void 0 ? !0 : c, D = e.expandSubRows, N = D === void 0 ? !0 : D, L = e.autoResetExpanded, q = L === void 0 ? !0 : L, B = e.getHooks, G = e.plugins, _ = e.state.expanded, O = e.dispatch;
        Jn(G, ["useSortBy", "useGroupBy", "usePivotColumns", "useGlobalFilter"], "useExpanded");
        var Z = Rn(q), dn = !!(Object.keys(a).length && Object.keys(_).length);
        dn && Object.keys(a).some(function($) {
          return !_[$];
        }) && (dn = !1), qn(function() {
          Z() && O({
        ...
        var vn = d.useCallback(function($, yn) {
          O({
        ...
        }, [O]), In = d.useMemo(function() {
          return S ? H(u, {
            manualExpandedKey: g,
            expanded: _,
            expandSubRows: N
          }) : u;
        }, [S, u, g, _, N]), Hn = d.useMemo(function() {
          return Bo(_);
        }, [_]), J = Rn(e), Y = Sn(B().getToggleAllRowsExpandedProps, {
          instance: J()
        });
        Object.assign(e, {
          preExpandedRows: u,
      ...
      function Vt(e, t) {
        ...
        }, e.getToggleRowExpandedProps = Sn(u().getToggleRowExpandedProps, {
          instance: a,
          row: e
        });
      }
      ...
      var jt = function(t) {
        t.stateReducers.push(Eo), t.useInstance.push(Ho);
      };
      ...
      function Eo(e, t, u, a) {
        ...
        if (t.type === w.setFilter) {
          var p = t.columnId, g = t.filterValue, c = a.allColumns, S = a.filterTypes, D = c.find(function(O) {
            return O.id === p;
          });
          if (!D)
            throw new Error("React-Table: Could not find a column with id: " + p);
          var N = z(D.filter, S || {}, nt), L = e.filters.find(function(O) {
            return O.id === p;
          }), q = xn(g, L && L.value);
          return un(N.autoRemove, q, D) ? y({}, e, {
        ...
        if (t.type === w.setAllFilters) {
          ...
          return y({}, e, {
            ...
            filters: xn(B, e.filters).filter(function(O) {
              var Z = G.find(function(vn) {
                return vn.id === O.id;
              }), dn = z(Z.filter, _ || {}, nt);
              return !un(dn.autoRemove, O.value, Z);
            })
          });
        }
      }
      function Ho(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, g = e.allColumns, c = e.filterTypes, S = e.manualFilters, D = e.defaultCanFilter, N = D === void 0 ? !1 : D, L = e.disableFilters, q = e.state.filters, B = e.dispatch, G = e.autoResetFilters, _ = G === void 0 ? !0 : G, O = d.useCallback(function(J, Y) {
          B({
            type: w.setFilter,
            columnId: J,
            filterValue: Y
        ...
        g.forEach(function(J) {
          var Y = J.id, $ = J.accessor, yn = J.defaultCanFilter, On = J.disableFilters;
          J.canFilter = $ ? re(On === !0 ? !1 : void 0, L === !0 ? !1 : void 0, !0) : re(yn, N, !1), J.setFilter = function(Xn) {
            return O(J.id, Xn);
          };
          var Bn = q.find(function(Xn) {
            return Xn.id === Y;
          });
          J.filterValue = Bn && Bn.value;
        });
        var dn = d.useMemo(function() {
          if (S || !q.length)
            return [u, a, p];
          var J = [], Y = {}, $ = function yn(On, Bn) {
            Bn === void 0 && (Bn = 0);
            var Xn = On;
            return Xn = q.reduce(function(rn, le) {
              var En = le.id, Mn = le.value, An = g.find(function(ce) {
                return ce.id === En;
              });
              if (!An)
                return rn;
              Bn === 0 && (An.preFilteredRows = rn);
              var Un = z(An.filter, c || {}, nt);
              return Un ? (An.filteredRows = Un(rn, [En], Mn), An.filteredRows) : (console.warn("Could not find a valid 'column.filter' for column with the ID: " + An.id + "."), rn);
            }, On), Xn.forEach(function(rn) {
              J.push(rn), Y[rn.id] = rn, rn.subRows && (rn.subRows = rn.subRows && rn.subRows.length > 0 ? yn(rn.subRows, Bn + 1) : rn.subRows);
            }), Xn;
          };
          return [$(u), J, Y];
        }, [S, q, u, a, p, g, c]), vn = dn[0], j = dn[1], In = dn[2];
        d.useMemo(function() {
      ...
      var Ut = function(t) {
        t.stateReducers.push(Jt), t.useInstance.push($t);
      };
      Ut.pluginName = "useGlobalFilter";
      function Jt(e, t, u, a) {
        ...
        if (t.type === w.setGlobalFilter) {
          var p = t.filterValue, g = a.userFilterTypes, c = z(a.globalFilter, g || {}, nt), S = xn(p, e.globalFilter);
          if (un(c.autoRemove, S)) {
            e.globalFilter;
            var D = E(e, ["globalFilter"]);
            return D;
          }
          return y({}, e, {
            globalFilter: S
      ...
      function $t(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, g = e.allColumns, c = e.filterTypes, S = e.globalFilter, D = e.manualGlobalFilter, N = e.state.globalFilter, L = e.dispatch, q = e.autoResetGlobalFilter, B = q === void 0 ? !0 : q, G = e.disableGlobalFilter, _ = d.useCallback(function(In) {
          L({
          ...
          if (D || typeof N > "u")
            return [u, a, p];
          var In = [], Hn = {}, J = z(S, c || {}, nt);
          if (!J)
            return console.warn("Could not find a valid 'globalFilter' option."), u;
          g.forEach(function(yn) {
            var On = yn.disableGlobalFilter;
            yn.canFilter = re(On === !0 ? !1 : void 0, G === !0 ? !1 : void 0, !0);
          });
          var Y = g.filter(function(yn) {
            return yn.canFilter === !0;
          }), $ = function yn(On) {
            return On = J(On, Y.map(function(Bn) {
              return Bn.id;
            }), N), On.forEach(function(Bn) {
              In.push(Bn), Hn[Bn.id] = Bn, Bn.subRows = Bn.subRows && Bn.subRows.length ? yn(Bn.subRows) : Bn.subRows;
            }), On;
          };
          return [$(u), In, Hn];
        }, [D, N, S, c, g, u, a, p, G]), Z = O[0], dn = O[1], vn = O[2], j = Rn(B);
        qn(function() {
          j() && L({
      ...
      var Mt = function(t) {
        t.getGroupByToggleProps = [eo], t.stateReducers.push(qo), t.visibleColumnsDeps.push(function(u, a) {
          var p = a.instance;
          return [].concat(u, [p.state.groupBy]);
        }), t.visibleColumns.push(zo), t.useInstance.push(Xo), t.prepareRow.push(Yo);
      };
      ...
      function qo(e, t, u, a) {
        ...
        if (t.type === w.toggleGroupBy) {
          var g = t.columnId, c = t.value, S = typeof c < "u" ? c : !e.groupBy.includes(g);
          return S ? y({}, e, {
      ...
      var _o = {};
      function Xo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, g = e.allColumns, c = e.flatHeaders, S = e.groupByFn, D = S === void 0 ? to : S, N = e.manualGroupBy, L = e.aggregations, q = L === void 0 ? _o : L, B = e.plugins, G = e.state.groupBy, _ = e.dispatch, O = e.autoResetGroupBy, Z = O === void 0 ? !0 : O, dn = e.disableGroupBy, vn = e.defaultCanGroupBy, j = e.getHooks;
        Jn(B, ["useColumnOrder", "useFilters"], "useGroupBy");
        var In = Rn(e);
        g.forEach(function(Mn) {
          var An = Mn.accessor, Un = Mn.defaultGroupBy, ce = Mn.disableGroupBy;
          Mn.canGroupBy = An ? re(Mn.canGroupBy, ce === !0 ? !1 : void 0, dn === !0 ? !1 : void 0, !0) : re(Mn.canGroupBy, Un, vn, !1), Mn.canGroupBy && (Mn.toggleGroupBy = function() {
            return e.toggleGroupBy(Mn.id);
          }), Mn.Aggregated = Mn.Aggregated || Mn.Cell;
        });
        var Hn = d.useCallback(function(Mn, An) {
          _({
            type: w.toggleGroupBy,
            columnId: Mn,
            value: An
          });
        }, [_]), J = d.useCallback(function(Mn) {
          _({
            type: w.setGroupBy,
            value: Mn
          });
        ...
        c.forEach(function(Mn) {
          Mn.getGroupByToggleProps = Sn(j().getGroupByToggleProps, {
            instance: In(),
            header: Mn
          });
        });
        var Y = d.useMemo(function() {
          if (N || !G.length)
            return [u, a, p, Vo, Ko, a, p];
          var Mn = G.filter(function(se) {
            return g.find(function(qe) {
              return qe.id === se;
            });
          }), An = function(qe, de, Mo) {
            var ze = {};
            return g.forEach(function(oe) {
              if (Mn.includes(oe.id)) {
                ze[oe.id] = de[0] ? de[0].values[oe.id] : null;
                return;
              }
              var bo = typeof oe.aggregate == "function" ? oe.aggregate : q[oe.aggregate] || wt[oe.aggregate];
              if (bo) {
                var st = de.map(function(at) {
                  return at.values[oe.id];
                }), ya = qe.map(function(at) {
                  var _e = at.values[oe.id];
                  if (!Mo && oe.aggregateValue) {
                    var Xe = typeof oe.aggregateValue == "function" ? oe.aggregateValue : q[oe.aggregateValue] || wt[oe.aggregateValue];
                    if (!Xe)
                      throw console.info({
                        column: oe
          ...
          }, Un = [], ce = {}, ot = [], Lt = {}, hn = [], Zn = {}, ue = function se(qe, de, Mo) {
            if (de === void 0 && (de = 0), de === Mn.length)
              return qe.map(function(st) {
                return y({}, st, {
                  depth: de
                });
              });
            var ze = Mn[de], oe = D(qe, ze), bo = Object.entries(oe).map(function(st, ya) {
              var at = st[0], _e = st[1], Xe = ze + ":" + at;
              Xe = Mo ? Mo + ">" + Xe : Xe;
              var Pa = se(_e, de + 1, Xe), Ia = de ? Fe(_e, "leafRows") : _e, wr = An(Ia, _e, de), Mr = {
                id: Xe,
                isGrouped: !0,
                groupByID: ze,
                groupByVal: at,
              ...
              return Pa.forEach(function(Be) {
                Un.push(Be), ce[Be.id] = Be, Be.isGrouped ? (ot.push(Be), Lt[Be.id] = Be) : (hn.push(Be), Zn[Be.id] = Be);
              }), Mr;
            });
            return bo;
          }, Se = ue(u);
          return Se.forEach(function(se) {
            Un.push(se), ce[se.id] = se, se.isGrouped ? (ot.push(se), Lt[se.id] = se) : (hn.push(se), Zn[se.id] = se);
          }), [Se, Un, ce, ot, Lt, hn, Zn];
        }, [N, G, u, a, p, g, q, D]), $ = Y[0], yn = Y[1], On = Y[2], Bn = Y[3], Xn = Y[4], rn = Y[5], le = Y[6], En = Rn(Z);
        qn(function() {
          En() && _({
            type: w.resetGroupBy
          });
      ...
      var oo = /([0-9]+)/gm, jo = function(t, u, a) {
        var p = tt(t, u, a), g = p[0], c = p[1];
        for (g = ro(g), c = ro(c), g = g.split(oo).filter(Boolean), c = c.split(oo).filter(Boolean); g.length && c.length; ) {
          var S = g.shift(), D = c.shift(), N = parseInt(S, 10), L = parseInt(D, 10), q = [N, L].sort();
          if (isNaN(q[0])) {
            if (S > D)
              return 1;
            if (D > S)
      ...
      function Uo(e, t, u) {
        var a = tt(e, t, u), p = a[0], g = a[1];
        return p = p.getTime(), g = g.getTime(), bt(p, g);
      }
      function Jo(e, t, u) {
        var a = tt(e, t, u), p = a[0], g = a[1];
        return bt(p, g);
      ...
      function $o(e, t, u) {
        ...
        for (p = p.split("").filter(Boolean), g = g.split("").filter(Boolean); p.length && g.length; ) {
          var c = p.shift(), S = g.shift(), D = c.toLowerCase(), N = S.toLowerCase();
          if (D > N)
            return 1;
          if (N > D)
            return -1;
      ...
      function ao(e, t, u) {
        var a = tt(e, t, u), p = a[0], g = a[1], c = /[^0-9.]/gi;
        return p = Number(String(p).replace(c, "")), g = Number(String(g).replace(c, "")), bt(p, g);
      }
      function bt(e, t) {
      ...
      var uo = function(t) {
        t.getSortByToggleProps = [Qo], t.stateReducers.push(io), t.useInstance.push(lo);
      };
      uo.pluginName = "useSortBy";
      var Qo = function(t, u) {
        var a = u.instance, p = u.column, g = a.isMultiSortEvent, c = g === void 0 ? function(S) {
          return S.shiftKey;
        } : g;
        return [t, {
      ...
      function io(e, t, u, a) {
        ...
        if (t.type === w.toggleSortBy) {
          var S = t.columnId, D = t.desc, N = t.multi, L = a.allColumns, q = a.disableMultiSort, B = a.disableSortRemove, G = a.disableMultiRemove, _ = a.maxMultiSortColCount, O = _ === void 0 ? Number.MAX_SAFE_INTEGER : _, Z = e.sortBy, dn = L.find(function($) {
            return $.id === S;
          }), vn = dn.sortDescFirst, j = Z.find(function($) {
            return $.id === S;
          }), In = Z.findIndex(function($) {
            return $.id === S;
          }), Hn = typeof D < "u" && D !== null, J = [], Y;
          return !q && N ? j ? Y = "toggle" : Y = "add" : In !== Z.length - 1 || Z.length !== 1 ? Y = "replace" : j ? Y = "toggle" : Y = "replace", Y === "toggle" && // Must be toggling
      ...
      function lo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.allColumns, g = e.orderByFn, c = g === void 0 ? At : g, S = e.sortTypes, D = e.manualSortBy, N = e.defaultCanSort, L = e.disableSortBy, q = e.flatHeaders, B = e.state.sortBy, G = e.dispatch, _ = e.plugins, O = e.getHooks, Z = e.autoResetSortBy, dn = Z === void 0 ? !0 : Z;
        ...
        }, [G]), j = d.useCallback(function(yn, On, Bn) {
          G({
            type: w.toggleSortBy,
            columnId: yn,
            desc: On,
        ...
        q.forEach(function(yn) {
          var On = yn.accessor, Bn = yn.canSort, Xn = yn.disableSortBy, rn = yn.id, le = On ? re(Xn === !0 ? !1 : void 0, L === !0 ? !1 : void 0, !0) : re(N, Bn, !1);
          ...
          }), yn.getSortByToggleProps = Sn(O().getSortByToggleProps, {
            instance: In(),
            column: yn
          });
          var En = B.find(function(Mn) {
            return Mn.id === rn;
          });
          yn.isSorted = !!En, yn.sortedIndex = B.findIndex(function(Mn) {
            return Mn.id === rn;
          }), yn.isSortedDesc = yn.isSorted ? En.desc : void 0;
        });
        var Hn = d.useMemo(function() {
          if (D || !B.length)
            return [u, a];
          var yn = [], On = B.filter(function(Xn) {
            ...
            var le = c(
              ...
              On.map(function(En) {
                ...
                if (!Mn)
                  throw new Error("React-Table: Could not find a column with id: " + En.id + " while sorting");
                var An = Mn.sortType, Un = He(An) || (S || {})[An] || Zo[An];
                if (!Un)
                  throw new Error("React-Table: Could not find a valid sortType of '" + An + "' for column '" + En.id + "'.");
                return function(ce, ot) {
                  return Un(ce, ot, En.id, En.desc);
                };
              }),
              // Map the directions
              On.map(function(En) {
                ...
                return Mn && Mn.sortInverted ? En.desc : !En.desc;
              })
            );
            return le.forEach(function(En) {
              yn.push(En), !(!En.subRows || En.subRows.length === 0) && (En.subRows = Xn(En.subRows));
            }), le;
          };
          return [Bn(u), yn];
        }, [D, B, u, a, p, c, S]), J = Hn[0], Y = Hn[1], $ = Rn(dn);
        qn(function() {
          $() && G({
            type: w.resetSortBy
          });
      ...
      function At(e, t, u) {
        return [].concat(e).sort(function(a, p) {
          for (var g = 0; g < t.length; g += 1) {
            var c = t[g], S = u[g] === !1 || u[g] === "desc", D = c(a, p);
            if (D !== 0)
              return S ? -D : D;
          }
      ...
      var so = function(t) {
        t.stateReducers.push(ea), t.useInstance.push(co);
      };
      so.pluginName = na;
      function ea(e, t, u, a) {
        if (t.type === w.init)
        ...
        if (t.type === w.gotoPage) {
          var p = a.pageCount, g = a.page, c = xn(t.pageIndex, e.pageIndex), S = !1;
          return c > e.pageIndex ? S = p === -1 ? g.length >= e.pageSize : c < p : c < e.pageIndex && (S = c > -1), S ? y({}, e, {
            pageIndex: c
          }) : e;
        }
      ...
      function co(e) {
        var t = e.rows, u = e.autoResetPage, a = u === void 0 ? !0 : u, p = e.manualExpandedKey, g = p === void 0 ? "expanded" : p, c = e.plugins, S = e.pageCount, D = e.paginateExpandedRows, N = D === void 0 ? !0 : D, L = e.expandSubRows, q = L === void 0 ? !0 : L, B = e.state, G = B.pageSize, _ = B.pageIndex, O = B.expanded, Z = B.globalFilter, dn = B.filters, vn = B.groupBy, j = B.sortBy, In = e.dispatch, Hn = e.data, J = e.manualPagination;
        ...
        }, [In, J ? null : Hn, Z, dn, vn, j]);
        var $ = J ? S : Math.ceil(t.length / G), yn = d.useMemo(function() {
          return $ > 0 ? [].concat(new Array($)).fill(null).map(function(An, Un) {
            return Un;
          }) : [];
        }, [$]), On = d.useMemo(function() {
          var An;
          if (J)
            An = t;
          else {
        ...
        }, [q, O, g, J, _, G, N, t]), Bn = _ > 0, Xn = $ === -1 ? On.length >= G : _ < $ - 1, rn = d.useCallback(function(An) {
          In({
            type: w.gotoPage,
            pageIndex: An
          });
        }, [In]), le = d.useCallback(function() {
          return rn(function(An) {
            return An - 1;
          });
        }, [rn]), En = d.useCallback(function() {
          return rn(function(An) {
            return An + 1;
          });
        }, [rn]), Mn = d.useCallback(function(An) {
          In({
            type: w.setPageSize,
            pageSize: An
          });
      ...
      var yo = function(t) {
        t.getPivotToggleProps = [ta], t.stateReducers.push(po), t.useInstanceAfterData.push(oa), t.allColumns.push(aa), t.accessValue.push(ra), t.materializedColumns.push(ua), t.materializedColumnsDeps.push(Dt), t.visibleColumns.push(fo), t.visibleColumnsDeps.push(lt), t.useInstance.push(Rt), t.prepareRow.push(Nt);
      };
      yo.pluginName = "usePivotColumns";
      var Co = [], ta = function(t, u) {
        var a = u.header;
        return [t, {
      ...
      function ua(e, t) {
        ...
        var g = p.pivotColumns.map(function(N) {
          ...
          if (!G)
            return c.map(function(O) {
              return y({}, O, {
                ...
                depth: L,
                id: "" + (q ? q.id + "." + O.id : O.id),
                accessor: function(dn, vn, j) {
                  if (B.every(function(In) {
                    return In(j);
                  }))
          ...
          return _.map(function(O) {
            ...
            return Z.columns = N(L + 1, Z, [].concat(B, [function(dn) {
      ...
      function Rt(e) {
        var t = e.columns, u = e.allColumns, a = e.flatHeaders, p = e.getHooks, g = e.plugins, c = e.dispatch, S = e.autoResetPivot, D = S === void 0 ? !0 : S, N = e.manaulPivot, L = e.disablePivot, q = e.defaultCanPivot;
        Jn(g, ["useGroupBy"], "usePivotColumns");
        var B = Rn(e);
        u.forEach(function(O) {
          var Z = O.accessor, dn = O.defaultPivot, vn = O.disablePivot;
          O.canPivot = Z ? re(O.canPivot, vn === !0 ? !1 : void 0, L === !0 ? !1 : void 0, !0) : re(O.canPivot, dn, q, !1), O.canPivot && (O.togglePivot = function() {
        ...
        a.forEach(function(O) {
          O.getPivotToggleProps = Sn(p().getPivotToggleProps, {
            instance: B(),
            header: O
          });
        });
      ...
      var Tt = function(t) {
        t.getToggleRowSelectedProps = [ia], t.getToggleAllRowsSelectedProps = [Pt], t.getToggleAllPageRowsSelectedProps = [la], t.stateReducers.push(sa), t.useInstance.push(ca), t.prepareRow.push(mo);
      };
      Tt.pluginName = go;
      var ia = function(t, u) {
        var a = u.instance, p = u.row, g = a.manualRowSelectedKey, c = g === void 0 ? "isSelected" : g, S = !1;
      ...
      function sa(e, t, u, a) {
        ...
        if (t.type === w.toggleAllRowsSelected) {
          var p = t.value, g = a.isAllRowsSelected, c = a.rowsById, S = a.nonGroupedRowsById, D = S === void 0 ? c : S, N = typeof p < "u" ? p : !g, L = Object.assign({}, e.selectedRowIds);
          return N ? Object.keys(D).forEach(function(En) {
            L[En] = !0;
        ...
        if (t.type === w.toggleRowSelected) {
          var q = t.id, B = t.value, G = a.rowsById, _ = a.selectSubRows, O = _ === void 0 ? !0 : _, Z = a.getSubRows, dn = e.selectedRowIds[q], vn = typeof B < "u" ? B : !dn;
          if (dn === vn)
            return e;
          var j = y({}, e.selectedRowIds), In = function En(Mn) {
            var An = G[Mn];
            if (An && (An.isGrouped || (vn ? j[Mn] = !0 : delete j[Mn]), O && Z(An)))
        ...
        if (t.type === w.toggleAllPageRowsSelected) {
          var Hn = t.value, J = a.page, Y = a.rowsById, $ = a.selectSubRows, yn = $ === void 0 ? !0 : $, On = a.isAllPageRowsSelected, Bn = a.getSubRows, Xn = typeof Hn < "u" ? Hn : !On, rn = y({}, e.selectedRowIds), le = function En(Mn) {
            var An = Y[Mn];
            if (An.isGrouped || (Xn ? rn[Mn] = !0 : delete rn[Mn]), yn && Bn(An))
              return Bn(An).forEach(function(Un) {
                return En(Un.id);
              });
          };
          return J.forEach(function(En) {
            return le(En.id);
          }), y({}, e, {
            selectedRowIds: rn
          });
      ...
      function ca(e) {
        var t = e.data, u = e.rows, a = e.getHooks, p = e.plugins, g = e.rowsById, c = e.nonGroupedRowsById, S = c === void 0 ? g : c, D = e.autoResetSelectedRows, N = D === void 0 ? !0 : D, L = e.state.selectedRowIds, q = e.selectSubRows, B = q === void 0 ? !0 : q, G = e.dispatch, _ = e.page, O = e.getSubRows;
        Jn(p, ["useFilters", "useGroupBy", "useSortBy", "useExpanded", "usePagination"], "useRowSelect");
        var Z = d.useMemo(function() {
          var On = [];
          return u.forEach(function(Bn) {
            var Xn = B ? ho(Bn, L, O) : !!L[Bn.id];
            Bn.isSelected = !!Xn, Bn.isSomeSelected = Xn === null, Xn && On.push(Bn);
          }), On;
        }, [u, B, L, O]), dn = !!(Object.keys(S).length && Object.keys(L).length), vn = dn;
        dn && Object.keys(S).some(function(On) {
          return !L[On];
        }) && (dn = !1), dn || _ && _.length && _.some(function(On) {
          var Bn = On.id;
          return !L[Bn];
        }) && (vn = !1);
        var j = Rn(N);
        ...
        var In = d.useCallback(function(On) {
          return G({
            type: w.toggleAllRowsSelected,
            value: On
          });
        }, [G]), Hn = d.useCallback(function(On) {
          return G({
            type: w.toggleAllPageRowsSelected,
            value: On
          });
        }, [G]), J = d.useCallback(function(On, Bn) {
          return G({
            type: w.toggleRowSelected,
            id: On,
            value: Bn
          });
        }, [G]), Y = Rn(e), $ = Sn(a().getToggleAllRowsSelectedProps, {
          instance: Y()
        }), yn = Sn(a().getToggleAllPageRowsSelectedProps, {
          instance: Y()
        });
        Object.assign(e, {
          selectedFlatRows: Z,
      ...
      function mo(e, t) {
        ...
        }, e.getToggleRowSelectedProps = Sn(u.getHooks().getToggleRowSelectedProps, {
          instance: u,
          row: e
        });
      }
      ...
      var wo = function(t) {
        t.stateReducers.push(It), t.useInstance.push(n), t.prepareRow.push(r);
      };
      wo.pluginName = "useRowState";
      function It(e, t, u, a) {
        var p = a.initialRowStateAccessor, g = p === void 0 ? vo : p, c = a.initialCellStateAccessor, S = c === void 0 ? So : c, D = a.rowsById;
        if (t.type === w.init)
          return y({
            rowState: {}
          }, e);
        ...
        if (t.type === w.setRowState) {
          var N, L = t.rowId, q = t.value, B = typeof e.rowState[L] < "u" ? e.rowState[L] : g(D[L]);
          return y({}, e, {
            rowState: y({}, e.rowState, (N = {}, N[L] = xn(q, B), N))
          });
        }
        if (t.type === w.setCellState) {
          var G, _, O, Z, dn, vn = t.rowId, j = t.columnId, In = t.value, Hn = typeof e.rowState[vn] < "u" ? e.rowState[vn] : g(D[vn]), J = typeof (Hn == null || (G = Hn.cellState) == null ? void 0 : G[j]) < "u" ? Hn.cellState[j] : S((_ = D[vn]) == null || (O = _.cells) == null ? void 0 : O.find(function(Y) {
            return Y.column.id === j;
          }));
          return y({}, e, {
            rowState: y({}, e.rowState, (dn = {}, dn[vn] = y({}, Hn, {
              cellState: y({}, Hn.cellState || {}, (Z = {}, Z[j] = xn(In, J), Z))
            }), dn))
          });
        }
      }
      function n(e) {
        var t = e.autoResetRowState, u = t === void 0 ? !0 : t, a = e.data, p = e.dispatch, g = d.useCallback(function(D, N) {
          return p({
            type: w.setRowState,
            rowId: D,
            value: N
          });
        }, [p]), c = d.useCallback(function(D, N, L) {
          return p({
            type: w.setCellState,
            rowId: D,
            columnId: N,
      ...
      function r(e, t) {
        var u = t.instance, a = u.initialRowStateAccessor, p = a === void 0 ? vo : a, g = u.initialCellStateAccessor, c = g === void 0 ? So : g, S = u.state.rowState;
      ...
      var v = function(t) {
        ...
        var a = u.instance, p = u.header, g = a.dispatch, c = function(D, N) {
          ...
          }), G = L ? Math.round(D.touches[0].clientX) : D.clientX, _, O, Z = function() {
          ...
          }, In = L ? j.touch : j.mouse, Hn = jn() ? {
            passive: !1
          } : !1;
          document.addEventListener(In.moveEvent, In.moveHandler, Hn), document.addEventListener(In.upEvent, In.upHandler, Hn), g({
      ...
      function T(e, t) {
        ...
        if (t.type === w.columnResizing) {
          var c = t.clientX, S = e.columnResizing, D = S.startX, N = S.columnWidth, L = S.headerIdWidths, q = L === void 0 ? [] : L, B = c - D, G = B / N, _ = {};
          return q.forEach(function(O) {
            var Z = O[0], dn = O[1];
            _[Z] = Math.max(dn + dn * G, 0);
          }), y({}, e, {
            columnResizing: y({}, e.columnResizing, {
      ...
      var I = function(t) {
        var u = t.flatHeaders, a = t.disableResizing, p = t.getHooks, g = t.state.columnResizing, c = Rn(t);
        u.forEach(function(S) {
          var D = re(S.disableResizing === !0 ? !1 : void 0, a === !0 ? !1 : void 0, !0);
          S.canResize = D, S.width = g.columnWidths[S.id] || S.originalWidth || S.width, S.isResizing = g.isResizingColumn === S.id, D && (S.getResizerProps = Sn(p().getResizerProps, {
            instance: c(),
            header: S
          }));
        });
      ...
      function kn(e) {
        e.getTableProps.push(cn), e.getRowProps.push(K), e.getHeaderGroupProps.push(K), e.getFooterGroupProps.push(K), e.getHeaderProps.push(Pn), e.getCellProps.push(en), e.getFooterProps.push(bn);
      }
      ...
      function Nn(e, t, u, a) {
        ...
        if (t.type === w.columnStartResizing) {
          var p = t.columnId, g = t.headerIdWidths, c = Vn(p);
          if (c !== void 0) {
            var S = a.visibleColumns.reduce(function(J, Y) {
              var $;
              return y({}, J, ($ = {}, $[Y.id] = Vn(Y.id), $));
        ...
        if (t.type === w.columnResizing) {
          var q = t.clientX, B = e.columnResizing.startX, G = e.gridLayout, _ = G.columnWidth, O = G.minWidths, Z = G.maxWidths, dn = G.headerIdGridWidths, vn = dn === void 0 ? [] : dn, j = q - B, In = j / _, Hn = {};
          return vn.forEach(function(J) {
            var Y = J[0], $ = J[1];
            Hn[Y] = Math.min(Math.max(O[Y], $ + $ * In), Z[Y]);
          }), y({}, e, {
            gridLayout: y({}, e.gridLayout, {
      ...
      s._UNSTABLE_usePivotColumns = yo, s.actions = w, s.defaultColumn = Cn, s.defaultGroupByFn = to, s.defaultOrderByFn = At, s.defaultRenderer = ln, s.emptyRenderer = Tn, s.ensurePluginOrder = Jn, s.flexRender = tn, s.functionalUpdate = xn, s.loopHooks = Dn, s.makePropGetter = Sn, s.makeRenderer = ne, s.reduceHooks = Wn, s.safeUseLayoutEffect = ae, s.useAbsoluteLayout = k, s.useAsyncDebounce = Ce, s.useBlockLayout = sn, s.useColumnOrder = i, s.useExpanded = gt, s.useFilters = jt, s.useFlexLayout = kn, s.useGetLatest = Rn, s.useGlobalFilter = Ut, s.useGridLayout = Gn, s.useGroupBy = Mt, s.useMountedLayoutEffect = qn, s.usePagination = so, s.useResizeColumns = v, s.useRowSelect = Tt, s.useRowState = wo, s.useSortBy = uo, s.useTable = ut, Object.defineProperty(s, "__esModule", { value: !0 });
    });
  }(No, No.exports)), No.exports;
}
process.env.NODE_ENV === "production" ? Aa.exports = _u() : Aa.exports = Xu();
var yt = Aa.exports;
function Yu(o, C, s) {
  var d = this, b = A.useRef(null), P = A.useRef(0), y = A.useRef(null), E = A.useRef([]), nn = A.useRef(), h = A.useRef(), fn = A.useRef(o), w = A.useRef(!0);
  fn.current = o;
  var ln = !C && C !== 0 && typeof window < "u";
  if (typeof o != "function")
    throw new TypeError("Expected a function");
  C = +C || 0, s = s || {};
  var Tn = !!s.leading, Cn = "trailing" in s ? !!s.trailing : !0, gn = "maxWait" in s, zn = gn ? Math.max(+s.maxWait || 0, C) : null, Sn = A.useCallback(function(tn) {
    var pn = E.current, _n = nn.current;
    return E.current = nn.current = null, P.current = tn, h.current = fn.current.apply(_n, pn);
  }, []), Wn = A.useCallback(function(tn, pn) {
    ln && cancelAnimationFrame(y.current), y.current = ln ? requestAnimationFrame(tn) : setTimeout(tn, pn);
  }, [ln]), Dn = A.useCallback(function(tn) {
    if (!w.current)
      return !1;
    var pn = tn - b.current, _n = tn - P.current;
    return !b.current || pn >= C || pn < 0 || gn && _n >= zn;
  }, [zn, gn, C]), Jn = A.useCallback(function(tn) {
    return y.current = null, Cn && E.current ? Sn(tn) : (E.current = nn.current = null, h.current);
  }, [Sn, Cn]), xn = A.useCallback(function() {
    var tn = Date.now();
    if (Dn(tn))
      return Jn(tn);
    if (w.current) {
      var pn = tn - b.current, _n = tn - P.current, Yn = C - pn, $n = gn ? Math.min(Yn, zn - _n) : Yn;
      Wn(xn, $n);
    }
  }, [zn, gn, Dn, Wn, Jn, C]), Rn = A.useCallback(function() {
    y.current && (ln ? cancelAnimationFrame(y.current) : clearTimeout(y.current)), P.current = 0, E.current = b.current = nn.current = y.current = null;
  }, [ln]), ae = A.useCallback(function() {
    return y.current ? Jn(Date.now()) : h.current;
  }, [Jn]);
  A.useEffect(function() {
  ...
  var qn = A.useCallback(function() {
    for (var tn = [], pn = 0; pn < arguments.length; pn++)
      tn[pn] = arguments[pn];
    var _n = Date.now(), Yn = Dn(_n);
    if (E.current = tn, nn.current = d, b.current = _n, Yn) {
      if (!y.current && w.current)
        return P.current = b.current, Wn(xn, C), Tn ? Sn(b.current) : h.current;
      if (gn)
        return Wn(xn, C), Sn(b.current);
    }
    return y.current || Wn(xn, C), h.current;
  }, [Sn, Tn, gn, Dn, Wn, xn, C]), Ce = A.useCallback(function() {
    return !!y.current;
  }, []), ne = A.useMemo(function() {
    return {
      callback: qn,
      cancel: Rn,
      flush: ae,
...
function Uu(o) {
  var C = A.useState($a(o)), s = C[0], d = C[1], b = A.useCallback(function(P) {
    return d($a(P));
  }, []);
  return [s, b];
}
function Ju(o, C, s) {
  var d = s && s.equalityFn || ju, b = Uu(o), P = b[0], y = b[1], E = Yu(A.useCallback(function(h) {
    return y(h);
  }, [y]), C, s), nn = A.useRef(o);
  return A.useEffect(function() {
    d(nn.current, o) || (E.callback(o), nn.current = o);
  }, [o, E, d]), [P, { cancel: E.cancel, pending: E.pending, flush: E.flush }];
}
function $u(o) {
  return lr({ tag: "svg", attr: { viewBox: "0 0 24 24" }, child: [{ tag: "path", attr: { fill: "none", d: "M0 0h24v24H0z" } }, { tag: "path", attr: { d: "M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" } }] })(o);
}
function Zu(o) {
  return lr({ tag: "svg", attr: { viewBox: "0 0 24 24" }, child: [{ tag: "polyline", attr: { fill: "none", strokeWidth: "2", points: "9 6 15 12 9 18", transform: "matrix(-1 0 0 1 24 0)" } }] })(o);
}
function Qu(o) {
  if (Array.isArray(o) || (o.general.geoType === "us-county" || o.general.geoType === "single-state" || o.general.geoType === "us" && (o != null && o.data)) && (o == null || o.data.forEach((C) => {
    C[o.columns.geo.name] && (!isNaN(parseInt(C[o.columns.geo.name])) && C[o.columns.geo.name].length === 4 && (C[o.columns.geo.name] = 0 + C[o.columns.geo.name]), C[o.columns.geo.name] = C[o.columns.geo.name].toString());
  })), Array.isArray(o) && o.length > 0) {
    let C = Object.keys(o[0]), s = ["fips", "FIPS", "fips codes", "FIPS CODES", "Fips Codes", "fips Codes", "Fips codes", "FIPS Codes"];
    const d = C.filter((b) => s.includes(b));
    if (!d.length)
      return;
    o == null || o.forEach((b) => {
...
const Da = 10, rt = {
  ...
  fileTooLarge: `File is too large. Maximum file size is ${Da}MB.`
}, ni = A.memo(({ globalFilter: o, setGlobalFilter: C, disabled: s = !1 }) => {
  const [d, b] = A.useState(o), [P] = Ju(d, 200);
  return A.useEffect(() => {
    typeof P == "string" && P !== o && C(P ?? "");
  }, [P]), /* @__PURE__ */ M(
    "input",
    {
      className: "filter",
...
}), Za = A.memo(({ globalFilter: o, data: C, setGlobalFilter: s }) => /* @__PURE__ */ an("header", { className: "data-table-header", children: [
  /* @__PURE__ */ M("h2", { children: "Data Preview" }),
  /* @__PURE__ */ M(ni, { globalFilter: o || "", setGlobalFilter: s, disabled: C === null })
] })), ei = A.memo(({ previousPage: o, nextPage: C, canPreviousPage: s, canNextPage: d, pageNumber: b, totalPages: P }) => /* @__PURE__ */ an("footer", { className: "data-table-pagination mt-2", children: [
  /* @__PURE__ */ an("ul", { children: [
    /* @__PURE__ */ M("li", { children: /* @__PURE__ */ an(
      "button",
      {
        onClick: () => o(),
  ...
  const { config: o } = A.useContext(dt), C = A.useMemo(() => o.type === "dashboard" ? Object.values(o.datasets).find((tn) => tn.preview && Array.isArray(tn.data)) : o.data, [o.type, o.data, o.datasets]), [s, d] = A.useState(C), b = (tn) => {
    const pn = Object.keys(tn[0]).includes("tableData"), _n = fn(pn ? tn[0].tableData : tn);
    return Qu(_n), _n;
  }, P = (tn) => d(b(tn)), y = A.useContext(Et), E = async (tn, pn) => {
    if (pn.preview)
      if (pn.dataUrl) {
        const _n = await La(pn.dataUrl);
        Array.isArray(_n) && P(_n);
      } else
        Array.isArray(pn.data) && P(pn.data);
  }, nn = async (tn) => {
    for (const pn of Object.keys(tn))
      await E(pn, tn[pn]);
  };
  A.useEffect(() => {
    (async () => {
      if (o.data)
        ...
        const pn = await La(o.dataUrl);
        Array.isArray(pn) && P(pn);
      }
    })();
  }, [o, o.data, C]);
  const h = A.useMemo(() => {
    if (!s)
      return [];
    const tn = s.columns ?? [];
    return tn.length > 0 && tn.includes("") && y({ type: "EDITOR_SET_ERRORS", payload: [rt.emptyCols] }), tn.map((pn) => ({
      id: `column-${pn}`,
      accessor: (Yn) => Yn[pn],
      Header: pn
    }));
    ...
    yt.useResizeColumns,
    yt.usePagination
  ), qn = () => /* @__PURE__ */ an("section", { className: "no-data", children: [
    /* @__PURE__ */ M("section", { className: "no-data-message", children: /* @__PURE__ */ an("section", { children: [
      /* @__PURE__ */ M("h3", { children: "No Data" }),
      /* @__PURE__ */ M("p", { children: "Import data to preview" })
    ] }) }),
    /* @__PURE__ */ M("div", { className: "table-container mt-2", children: /* @__PURE__ */ an("table", { className: "editor data-table", role: "table", children: [
      /* @__PURE__ */ M("thead", { children: /* @__PURE__ */ an("tr", { children: [
        /* @__PURE__ */ M("th", { scope: "col", colSpan: 1, role: "columnheader" }),
        /* @__PURE__ */ M("th", { scope: "col", colSpan: 1, role: "columnheader" }),
        /* @__PURE__ */ M("th", { scope: "col", colSpan: 1, role: "columnheader" })
      ] }) }),
      /* @__PURE__ */ M("tbody", { children: /* @__PURE__ */ M(Re, { children: [...Array(10)].map((tn, pn) => /* @__PURE__ */ an("tr", { children: [
        /* @__PURE__ */ M("td", {}),
        /* @__PURE__ */ M("td", {}),
        /* @__PURE__ */ M("td", {})
      ] }, pn)) }) })
  ...
  if (!s)
    return [/* @__PURE__ */ M(Za, {}, "header"), /* @__PURE__ */ M(qn, {}, "table")];
  const Ce = {
    previousPage: ae,
    nextPage: Rn,
    canPreviousPage: Dn,
  ...
  return [
    /* @__PURE__ */ M(Za, { data: s, setGlobalFilter: Sn, globalFilter: gn }, "header"),
    /* @__PURE__ */ M(() => /* @__PURE__ */ an("div", { className: "table-responsive", children: [
      /* @__PURE__ */ an("table", { className: "mt-2 w-100 table table-striped data-table table-sm ", "aria-hidden": "true", ...w, children: [
        /* @__PURE__ */ M("thead", { children: Tn.map((tn) => /* @__PURE__ */ M("tr", { ...tn.getHeaderGroupProps(), children: tn.headers.map((pn) => /* @__PURE__ */ an(
          "th",
          {
            scope: "col",
...
`, ri = `Location,symbolCol,textCol,orderCol\r
...
Home,*,Some Home Footnote,1`, ui = `Race,Age-adjusted rate
...
`, ii = `FIPS Codes,County,Public Health Jurisdiction,Percent Vaccinated,Vaccination Coverage Group
...
`, li = `City,Longitude,Latitude,Value
...
}, Sr = ({ text: o, fileName: C, data: s }) => {
  const { editingDataset: d, loadData: b } = A.useContext(Oo);
  return /* @__PURE__ */ M(
    "button",
    {
      className: "link link-upload",
      onClick: (E) => b(new Blob([s], { type: "text/csv" }), C, d),
      onKeyDown: (E) => E.keyCode === 13 && b(new Blob([s], { type: "text/csv" }), C, d),
      children: o
    }
  );
}, hi = () => Na.maps.map((o) => /* @__PURE__ */ M(Sr, { text: o.text, fileName: o.fileName, data: o.data }, o.fileName)), vi = () => Na.charts.map((o) => /* @__PURE__ */ M(Sr, { text: o.text, fileName: o.fileName, data: o.data }, o.fileName)), Si = () => {
  const { config: o } = A.useContext(Oo);
  return /* @__PURE__ */ an(Re, { children: [
    /* @__PURE__ */ M("h3", { className: "heading-3", children: "Load Sample Data:" }),
    /* @__PURE__ */ an("ul", { className: "sample-data-list", children: [
      o.type !== "map" && /* @__PURE__ */ M(vi, {}),
      o.type !== "chart" && /* @__PURE__ */ M(hi, {})
    ] })
  ] });
}, Ta = () => null;
Ta.data = Na;
Ta.Buttons = Si;
const Qa = (o) => /* @__PURE__ */ A.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M224 136V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.2 0-24-10.8-24-24zm65.18 216.01H224v80c0 8.84-7.16 16-16 16h-32c-8.84 0-16-7.16-16-16v-80H94.82c-14.28 0-21.41-17.29-11.27-27.36l96.42-95.7c6.65-6.61 17.39-6.61 24.04 0l96.42 95.7c10.15 10.07 3.03 27.36-11.25 27.36zM377 105L279.1 7c-4.5-4.5-10.6-7-17-7H256v128h128v-6.1c0-6.3-2.5-12.4-7-16.9z" }));
function wi() {
  const { config: o, errors: C, tempConfig: s, sharepath: d } = A.useContext(dt), b = (H) => {
    gn({ type: "EDITOR_SET_CONFIG", payload: H });
  }, P = (H) => {
    gn({ type: "EDITOR_SET_ERRORS", payload: H });
  }, y = new Lr(), [E, nn] = A.useState(
    o.dataFileSourceType === "url" ? o.dataFileName : o.dataUrl || ""
  ), [h, fn] = A.useState(!!o.dataUrl), [w, ln] = A.useState(o.type === "dashboard" || !o.data), [Tn, Cn] = A.useState(void 0), gn = A.useContext(Et), zn = {
    ".csv": "text/csv",
    ".json": "application/json"
  }, Sn = (H) => H === void 0 ? "" : H > Math.pow(1024, 3) ? Math.round(H / Math.pow(1024, 3) * 100) / 100 + "GB" : H > Math.pow(1024, 2) ? Math.round(H / Math.pow(1024, 2) * 100) / 100 + "MB" : H > 1024 ? Math.round(H / 1024 * 100) / 100 + "KB" : H + "B", Wn = (H, z, un) => (z.map(function(on, Fn, jn) {
    if (!jn.find((we) => we.dataKey === on.dataKey))
      return !1;
  }), !(H.columns.indexOf(un) < 0)), Dn = (H) => da(E) ? ".csv" : Ao(E) ? ".json" : Object.keys(zn).find((z) => H.pathname.endsWith(z)), Jn = async () => {
    let H;
    try {
      H = da(E) || Ao(E) ? E : new URL(E, window.location.origin);
    } catch {
      throw rt.urlInvalid;
    }
    let z = null;
    const un = Dn(H);
    try {
      await Pr.get(H.toString(), {
        responseType: "blob"
      }).then((on) => {
        z = on.data, un === ".csv" && ["text/csv", "text/plain"].includes(z.type) || da(E) ? z = z.slice(0, z.size, "text/csv") : (z.type === "application/json" || un === ".json" && z.type === "text/plain" || Ao(E)) && (z = z.slice(0, z.size, "application/json"));
      });
    } catch (on) {
      console.error(on);
      const Fn = on.toString();
      throw Object.values(rt).includes(on) ? Fn : rt.failedFetch;
    }
    return o.type === "dashboard" && nn(""), z;
  }, xn = ([H]) => Rn(H, Tn, Tn), Rn = async (H = null, z, un) => {
    let on = H, Fn = (on == null ? void 0 : on.path) ?? z ?? E;
    ...
    const Ae = (() => {
      const fe = (H == null ? void 0 : H.name) || E || z;
      if (jn === "file") {
        const ye = fe.match(/(?:\.([^.]+))?$/g), he = ye.length === 0 ? ".csv" : ye[0];
        return zn[he];
      }
      if (jn === "url")
        return on.type;
    })(), De = new FileReader(), Oe = (fe) => {
      switch (Ae) {
        case "text/csv":
          return Qr(fe);
        case "text/plain":
        case "application/json":
          try {
            return Ao(E) ? JSON.parse(fe).response.docs : JSON.parse(fe);
          } catch {
            P([rt.formatting]);
            return;
          }
    ...
    De.onload = function() {
      const fe = (ye, he = !1) => {
        if (o.type === "dashboard") {
          let ve = { ...o.datasets };
          Object.keys(ve).forEach((Ln) => ve[Ln].preview = !1);
          const je = Ae.split("/")[1].toUpperCase();
          ve[un || Fn] = {
            data: ye,
            // new data
            dataFileSize: we,
      ...
      try {
        const ye = Oe(this.result.toString()), he = y.autoStandardize(ye);
        o.data && o.series ? Wn(he, o.series, o == null ? void 0 : o.xAxis.dataKey) ? fe(he, !0) : Le(
          {
            data: he,
            dataFileName: Fn,
            dataFileSourceType: jn
        ...
        ) : fe(he), Tn && Cn(void 0), ln(!1);
      } catch (ye) {
        P(ye);
      }
    };
    const Ye = Ae === "text/csv" ? "utf-8" : "";
    De.readAsText(on, Ye);
  };
  A.useEffect(() => {
    let H = { ...s || o };
    ...
    gn({ type: "EDITOR_SAVE", payload: H });
  }, []);
  const ae = (H, z, un) => {
    if (o.type === "dashboard") {
      let on = { ...o.datasets[H].dataDescription, [z]: un }, Fn = y.developerStandardize(o.datasets[H].data, on), jn = { ...o.datasets };
      jn[H] = { ...jn[H], dataDescription: on, formattedData: Fn }, b({ ...o, datasets: jn });
    } else {
      let on = { ...o.dataDescription, [z]: un }, Fn = y.developerStandardize(o.data, on);
      b({ ...o, formattedData: Fn, dataDescription: on });
    }
  }, qn = (H, z) => {
    if (z) {
      let un = { ...o.datasets };
      H === !1 ? delete un[z].dataUrl : un[z].dataUrl = un[z].dataFileName, b({ ...o, datasets: un });
    } else if (o.type !== "dashboard") {
      let un = { ...o };
      H === !1 ? delete un.dataUrl : un.dataUrl = un.dataFileName, b(un);
    }
    fn(H);
  }, { getRootProps: Ce, getInputProps: ne, isDragActive: tn } = ba({ onDrop: xn }), {
    getRootProps: pn,
    getInputProps: _n,
    isDragActive: Yn
  } = ba({ onDrop: xn }), $n = () => /* @__PURE__ */ an(Re, { children: [
    /* @__PURE__ */ an("form", { className: "input-group d-flex", onSubmit: (H) => H.preventDefault(), children: [
      /* @__PURE__ */ M(
        "input",
        {
          id: "external-data",
      ...
      /* @__PURE__ */ M(
        "button",
        {
          ...
          type: "submit",
          id: "load-data",
          onClick: () => Rn(null, E, Tn),
          children: "Load"
        }
      )
    ] }),
    /* @__PURE__ */ an("label", { htmlFor: "keep-url", className: "mt-1 d-flex keep-url", children: [
      /* @__PURE__ */ M(
        "input",
        {
          type: "checkbox",
  ...
  ] }), Le = (H = {}, z = "Are you sure you want to do this?") => {
    H.newViz = !0, window.confirm(z) === !0 && (gn({ type: "EDITOR_SAVE", payload: H }), ln(!0));
  }, Te = () => (
    //todo convert to modal
    /* @__PURE__ */ an(Re, { children: [
      /* @__PURE__ */ an(
        "button",
        {
      ...
      o.dataFileSourceType === "file" && /* @__PURE__ */ an("div", { className: "link link-replace", ...pn(), children: [
        /* @__PURE__ */ M("input", { ..._n() }),
    ...
    let on = { ...o.datasets };
    un === !0 ? Object.keys(on).forEach((Fn) => {
      const jn = Fn === H;
      on[Fn][z] = jn;
    }) : on[H][z] = un, b({ ...o, datasets: on });
  }, ke = (H) => {
    let z = { ...o.datasets }, un = { ...o.visualizations };
    Object.keys(un).forEach((on) => {
      un[on].dataKey === H && delete un[on].dataKey;
    }), delete z[H], b({ ...o, datasets: z, visualizations: un });
  }, pe = (H, z) => {
    if (H === z)
      return;
    let un = { ...o.datasets }, on = { ...o.visualizations }, Fn = 2, jn = z;
    for (; un[z]; )
      z = jn + "-" + Fn, Fn++;
    un[z] = un[H], delete un[H], Object.keys(on).forEach((we) => {
      on[we].dataKey === H && (on[we].dataKey = z);
    }), b({ ...o, datasets: un, visualizations: on });
  };
  let me, re = !1;
  o.type === "dashboard" ? re = Object.keys(o.datasets).length > 0 : (me = o, re = !!o.formattedData || o.data && o.dataDescription && y.autoStandardize(o.data)), o.visualizationType === "Sankey" && o.data && (re = !0), (o.visualizationType === "Box Plot" && o.data || o.visualizationType === "Scatter Plot") && (re = !0);
  const He = /* @__PURE__ */ an(Re, { children: [
    o.filters && o.filters.map(
      (H, z) => H.type !== "url" ? /* @__PURE__ */ M(Re, {}) : /* @__PURE__ */ an("fieldset", { className: "edit-block url-filters-block", children: [
        /* @__PURE__ */ M(
          "button",
          {
            onClick: (un) => {
        ...
        /* @__PURE__ */ an("label", { children: [
          /* @__PURE__ */ an("span", { className: "edit-label column-heading", children: [
            "Label",
            /* @__PURE__ */ an(Ne, { style: { textTransform: "none" }, children: [
              /* @__PURE__ */ M(Ne.Target, { children: /* @__PURE__ */ M(ma, { display: "question" }) }),
              /* @__PURE__ */ M(Ne.Content, { children: /* @__PURE__ */ M("p", { style: { padding: "0.5rem" }, children: "The label that will appear above the dropdown filter." }) })
            ] })
          ] }),
          " ",
          /* @__PURE__ */ M(
        ...
        /* @__PURE__ */ an("label", { children: [
          /* @__PURE__ */ an("span", { className: "edit-label column-heading", children: [
            ...
            /* @__PURE__ */ an(Ne, { style: { textTransform: "none" }, children: [
              /* @__PURE__ */ M(Ne.Target, { children: /* @__PURE__ */ M(ma, { display: "question" }) }),
              /* @__PURE__ */ M(Ne.Content, { children: /* @__PURE__ */ M("p", { style: { padding: "0.5rem" }, children: "Name of the query string parameter that will be appended to the URL above with the values provided below." }) })
            ] })
          ] }),
          " ",
          /* @__PURE__ */ M(
        ...
        /* @__PURE__ */ M("ul", { className: "value-list", children: H.orderedValues && H.orderedValues.map((un, on) => /* @__PURE__ */ an("li", { children: [
          un,
          /* @__PURE__ */ M(
            "input",
            {
              ...
              onChange: (Fn) => {
                let jn = [...o.filters];
                jn[z].labels = jn[z].labels || {}, jn[z].labels[un] = Fn.target.value, b({ ...o, filters: jn });
              }
            }
          ),
          /* @__PURE__ */ M(
  ...
  ] }), Fe = !["Box Plot", "Scatter Plot", "Sankey"].includes(o == null ? void 0 : o.visualizationType);
  return /* @__PURE__ */ an(Re, { children: [
    /* @__PURE__ */ an("div", { className: "left-col", children: [
      o.type === "dashboard" && Object.keys(o.datasets).length > 0 && /* @__PURE__ */ an(Re, { children: [
        /* @__PURE__ */ M("div", { className: "heading-3", children: "Data Sources" }),
        /* @__PURE__ */ an("table", { children: [
          /* @__PURE__ */ M("thead", { children: /* @__PURE__ */ an("tr", { children: [
          ...
          /* @__PURE__ */ M("tbody", { children: Object.keys(o.datasets).map(
            (H) => o.datasets[H].dataFileName && /* @__PURE__ */ an("tr", { children: [
              /* @__PURE__ */ M("td", { children: /* @__PURE__ */ M(
                "input",
                {
                  ...
                  type: "text",
                  defaultValue: H,
                  onBlur: (z) => pe(H, z.target.value)
                }
              ) }),
              /* @__PURE__ */ M("td", { className: "p-1", children: Sn(o.datasets[H].dataFileSize) }),
              /* @__PURE__ */ M("td", { className: "p-1", children: o.datasets[H].dataFileFormat }),
              /* @__PURE__ */ M("td", { children: /* @__PURE__ */ M(
                "button",
                {
                  className: "btn btn-link p-1",
                  onClick: () => be(H, "preview", !0),
                  children: "Preview"
                }
              ) }),
              /* @__PURE__ */ M("td", { children: /* @__PURE__ */ M(
                "button",
                {
                  className: "btn btn-link p-1",
                  onClick: () => {
                    Tn === H ? (Cn(void 0), nn(""), fn(!1)) : (Cn(H), nn(
                      o.datasets[H].dataUrl || o.datasets[H].dataFileName
                    ), fn(!!o.datasets[H].dataUrl));
                  },
                  children: "Edit"
                }
              ) }),
              /* @__PURE__ */ M("td", { children: /* @__PURE__ */ M("button", { className: "btn btn-danger", onClick: () => ke(H), children: "X" }) })
            ] }, `tr-${H}`)
          ) })
        ] })
      ] }),
      (me == null ? void 0 : me.data) && /* @__PURE__ */ an(Re, { children: [
        o.type !== "dashboard" && /* @__PURE__ */ an(Re, { children: [
          /* @__PURE__ */ M("div", { className: "heading-3", children: "Data Source" }),
          /* @__PURE__ */ an("div", { className: "file-loaded-area", children: [
            (o.dataFileSourceType === "file" || !o.dataFileSourceType) && /* @__PURE__ */ an("div", { className: "data-source-options", children: [
              /* @__PURE__ */ an(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ M("input", { ..._n() }),
                    Yn ? /* @__PURE__ */ M("p", { children: "Drop file here" }) : /* @__PURE__ */ an("p", { children: [
                      /* @__PURE__ */ M(Qa, {}),
                      " ",
                      /* @__PURE__ */ M("span", { children: o.dataFileName ?? "Replace data file" })
                    ] })
                  ]
                }
              ),
              /* @__PURE__ */ M("div", { children: Te() })
            ] }),
            o.dataFileSourceType === "url" && /* @__PURE__ */ an(Re, { children: [
              /* @__PURE__ */ an("div", { className: "url-source-options", children: [
                /* @__PURE__ */ M("div", { children: $n() }),
                /* @__PURE__ */ M("div", { children: Te() })
              ] }),
              o.dataUrl && (o.type === "chart" || o.type === "map") && He
            ] })
          ] })
        ] }),
        Fe && /* @__PURE__ */ M(
          Gr,
          {
            ...
            configureData: me,
            updateDescriptionProp: (H, z) => ae(me.dataFileName, H, z),
            config: o,
            setConfig: b
          }
        )
      ] }),
      (Tn || w) && // dataFileSourceType needs to be checked here since earlier versions did not track this state
      /* @__PURE__ */ an("div", { className: "load-data-area", children: [
        /* @__PURE__ */ M("div", { className: "heading-3", children: Tn ? `Editing ${Tn}` : "Add Dataset" }),
        /* @__PURE__ */ an(zu, { startingTab: Tn && o.datasets[Tn].dataFileSourceType === "url" ? 1 : 0, children: [
          /* @__PURE__ */ an(Bt, { title: "Upload File", icon: /* @__PURE__ */ M(Qa, { className: "inline-icon" }), children: [
            d && /* @__PURE__ */ an("p", { className: "alert--info", children: [
            ...
            /* @__PURE__ */ an(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ M("input", { ...ne() }),
                  tn ? /* @__PURE__ */ M("p", { children: "Drop file here" }) : /* @__PURE__ */ an("p", { children: [
            ...
            /* @__PURE__ */ an("p", { className: "footnote", children: [
          ...
          /* @__PURE__ */ M(Bt, { title: "Load from URL", icon: /* @__PURE__ */ M(oi, { className: "inline-icon" }), children: $n() })
        ] }),
        C && (Array.isArray(C) ? C.map((H, z) => /* @__PURE__ */ an("div", { className: "error-box slim mt-2", children: [
          ...
          /* @__PURE__ */ M(
            Oa,
            {
              ...
              onClick: () => P(C.filter((un, on) => on !== z))
            }
          )
        ] }, `error-${H}`)) : C.message),
        /* @__PURE__ */ M(Oo.Provider, { value: { loadData: Rn, editingDataset: Tn, config: o }, children: /* @__PURE__ */ M(Ta.Buttons, {}) })
      ] }),
      o.type === "dashboard" && !w && /* @__PURE__ */ M("div", { className: "mt-2", children: /* @__PURE__ */ M("button", { className: "btn btn-primary", onClick: () => ln(!0), children: "+ Add More Files" }) }),
      re && /* @__PURE__ */ M("div", { className: "mt-2", children: /* @__PURE__ */ M(
        "button",
        {
          className: "btn btn-primary",
          onClick: () => gn({ type: "EDITOR_SET_GLOBALACTIVE", payload: 2 }),
      ...
      /* @__PURE__ */ M(
        "a",
        {
          ...
          children: /* @__PURE__ */ an("div", { children: [
...
const Mi = (o) => /* @__PURE__ */ A.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 1024 1024", fill: "currentColor", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M489.3,377.8H80.1v-288c0-8.4-6.8-15.2-15.2-15.2H34.7c-8.4,0-15.2,6.8-15.2,15.2v318.3c0,16.7,13.6,30.3,30.3,30.3h439.5 c8.4,0,15.2-6.8,15.2-15.2v-30.3C504.5,384.6,497.7,377.8,489.3,377.8z" }), /* @__PURE__ */ A.createElement("path", { d: "M459,105H347.2c-20.3,0-30.4,24.5-16.1,38.8l30.7,30.7L292.3,244l-69.5-69.5c-11.8-11.8-31-11.8-42.9,0l-65.1,65.1 c-5.9,5.9-5.9,15.5,0,21.4l21.4,21.4c5.9,5.9,15.5,5.9,21.4,0l43.6-43.6l69.5,69.5c11.8,11.8,31,11.8,42.9,0l90.9-90.9l30.7,30.7 c14.3,14.3,38.8,4.2,38.8-16.1V120.1C474.2,111.7,467.4,105,459,105z" }), /* @__PURE__ */ A.createElement("path", { d: "M991.2,280.5h-188l125.2,125.2c4.8,4.8,12.7,5.2,17.6,0.5c30.7-28.9,51.8-67.8,57.9-111.6 C1005,287.2,998.8,280.5,991.2,280.5L991.2,280.5z" }), /* @__PURE__ */ A.createElement("path", { d: "M978.7,229.2c-6.5-94.6-82.2-170.3-176.8-176.8c-7.2-0.5-13.3,5.6-13.3,12.8v177.3h177.3 C973.1,242.5,979.2,236.4,978.7,229.2L978.7,229.2z" }), /* @__PURE__ */ A.createElement("path", { d: "M750.5,280.5v-188c0-7.6-6.6-13.8-14.1-12.7C642,93.1,569.8,175.6,573.2,274.5C576.6,376,664,459.3,765.6,458 c39.9-0.5,76.8-13.4,107.2-34.9c6.3-4.4,6.7-13.7,1.2-19.1L750.5,280.5z" }), /* @__PURE__ */ A.createElement("path", { d: "M130.7,558l1.1,7.2l5.5,11.6l-2.8,12.1l-6.1-7.7l-3.9-8.8l-8.8-1.7L102,569h-3.9l2.2,7.7l7.7,11v11l2.2,12.1l9.9,1.1 l3.9,5.5l-12.1-1.7l-3.9,2.8l1.7,11.6l-2.2,12.7l0.5,14.9l-3.9,9.9l-4.4,14.3l3.3,9.9l2.2,12.7l1.7,9.4l-2.2,12.7l1.7,8.8l3.9,8.8 l3.3,11l2.8,7.2L128,772l5.5-0.6l7.7,1.1l-8.3,2.2l2.2,3.9l-7.2,1.1l6.6,7.2l6.6,7.2l-2.2,6.1l8.8,12.7l9.4,7.7l1.1,9.4l7.7,3.9 l10.5,3.3l8.3,7.2l7.2,4.4l7.7,6.1l4.4,3.3l5,11l28.1-0.6l55.2,19.3h45.8l-1.1-4.4h22.1l8.8,5l5,5l12.7,8.8l4.4,16l12.7,6.6l7.7,3.3 l10.5-12.7l13.8,1.7l5.5,4.4l14.9,24.3l5,6.1l3.9,13.8l29.2,11.6l-1.1-9.9l-1.1-13.8l9.4-11l-1.7-3.3l9.4-7.7l5,2.8l8.3-9.4l5-6.6 h7.2l16-3.3l11.6,5h8.8l3.3-3.9l3.9,2.8l0.6,5l11.6,3.9l11-1.7l9.4,0.6l-7.7-6.1l-0.6-3.3l5-2.8l-0.5-2.8H598l-8.8,1.1l5.5-5 l2.8-3.3l2.8,2.8l16-2.2l2.2,2.8h11l6.1-1.7l8.8-0.5l8.3,3.3l5-0.6l5,7.2l9.9,0.5l5.5-4.4h5.5l11,9.4l6.1,6.6l1.7,8.8l-1.1,11 l3.9,11.6l10.5,13.2l6.1,12.7l2.2,5l11-2.2l2.8-12.1v-18.2l-5.5-14.9l-1.7-3.9l-1.1-11l-9.4-11l-1.7-13.2l0.5-11l4.4-12.1l8.3-6.6 l-0.6-5l9.9-1.7l14.3-16l6.6-5.5l7.2,1.1l6.6-12.7l9.4-5c0,0,7.2,1.1,7.7-1.7c0.5-2.8,7.7-16,7.7-16l-7.7-4.4l4.4-3.9l1.1-2.8 l-4.4-11l-4.4-5l5.5-6.1l-4.4-5.5l-1.1-11l-0.6-9.4l3.3-2.8l2.2,13.8l1.7,6.6l3.9,6.1l-1.1,9.9l6.1-12.1l3.9-9.4l0.6-5.5l-5.5-6.6 l-0.6-2.8l1.7-1.7l8.8,5.5l2.8-6.6l6.1-6.1l1.1-6.6l-1.1-7.7l0.5-3.9l1.1-5.5l4.4,6.1h2.2l6.6-1.1l6.6-0.6l8.8-2.8l-1.7-3.3 l-8.8,0.6l-8.3,2.2l-3.9,2.2l-0.6-3.9l2.8-3.3l7.2-1.7l8.8-1.7l6.1-1.7l5-3.3l11.6,2.8c0,0,5,2.8,5.5,1.1c0.6-1.7,2.2-6.1,2.2-6.1 l-3.9-4.4l-1.7-6.6l1.1-11l1.1-8.8l5-6.6l1.1-2.8l3.3,1.7l10.5-11.6h3.9l8.8-1.1l2.8-5.5h7.7l6.6-5.5l-2.5-3l-3-7.4l-3.3-2.5 l1.4-18.5l-1.7-16.8l-9.9-3l-8.6,3l-4.7-0.6l-19,44.4l-8.8,0.6l-3.9,3.3l-46.9-0.3l-11.6,10.8l-7.2,4.4l-3.3,9.4l-1.7,5l-8.3,5.5 H774l-6.1-2.8l-7.7,1.1l-9.9,3.3l0.6,5l-0.6,8.8l-5,4.4l-9.9,2.2l-15.4,7.7l-11.6,3.9l-11,0.6l-6.6-5l3.3-6.1l1.7-1.7l2.2-6.1 l4.1-2.5l5.2-9.1l-5.5-7.2l-1.1-11.6l-7.2-2.2l-9.4,6.6l3.3-7.7l5.5-7.7l-2.2-7.2l-1.7-8.3l-8.8-3.3l-7.7-6.6l-9.4,3.9l0.6,7.2 l-5.5,6.6l-4.4-2.2l-8.3,9.4v11l1.1,11l5,7.7l-0.6,16.6l-10.5,9.9l-7.7,0.6l-3.9-11.6l-3.9-8.3l1.7-11l-1.7-11l3.9-7.2l2.2-7.2 l3.9-12.1l-8.8,9.9l5-17.1l7.7-6.6l9.4-0.6l7.2-3.3H667h9.4l6.1-1.7l7.2,1.1l3.3,5.5l13.8,5l2.8-7.7l-9.4,1.1l-6.1-0.6l-8.8-6.6 l-5.5-3.3l-6.3-4.7l-6.3,1.9l-6.1-4.4l-14.3,0.6l-7.7,5l-6.1-3.9l-7.2-4.4l-10.5-0.6l10.5-14.9l-12.1,5.5l-9.9,7.7l-9.9,5.5 l-8.8,1.1l-1.1-5.5l-18.2,3.9l15.3-13.4l10.8-7.9l13.4-10.5l-5.5-0.8l-18.2,0.6l-8.3-1.7l-7.4-1.2L558,564l-8.3,0.6l-15.7-3.9 l-4.1-5l-2.2-7.7l-3.9-3.6l0.3,4.1l-3.9,6.1l-387.3,0.3L130.7,558L130.7,558z" })), bi = (o) => /* @__PURE__ */ A.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 99.1 79.7", fill: "currentColor", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M91,18.7H62c-0.6,0-1,0.4-1,1v6c0,0.6,0.4,1,1,1h29c0.6,0,1-0.4,1-1v-6C92,19.1,91.6,18.7,91,18.7z M89.4,24.7H63.6 c-0.3,0-0.6-0.2-0.6-0.6v-2.9c0-0.3,0.2-0.6,0.6-0.6h25.9c0.3,0,0.6,0.2,0.6,0.6v2.9C90,24.4,89.8,24.7,89.4,24.7z" }), /* @__PURE__ */ A.createElement("path", { d: "M75,30.7H63c-0.6,0-1,0.4-1,1v6c0,0.6,0.4,1,1,1h12c0.6,0,1-0.4,1-1v-6C76,31.1,75.6,30.7,75,30.7z M73.7,36.7h-9.3 c-0.2,0-0.3-0.2-0.3-0.3V33c0-0.2,0.2-0.3,0.3-0.3h9.3c0.2,0,0.3,0.2,0.3,0.3v3.3C74,36.5,73.8,36.7,73.7,36.7z" }), /* @__PURE__ */ A.createElement("path", { d: "M81,43.7H63c-0.6,0-1,0.4-1,1v6c0,0.6,0.4,1,1,1h18c0.6,0,1-0.4,1-1v-6C82,44.1,81.6,43.7,81,43.7z M79.6,49.7H64.4 c-0.2,0-0.4-0.2-0.4-0.4v-3.1c0-0.2,0.2-0.4,0.4-0.4h15.1c0.2,0,0.4,0.2,0.4,0.4v3.1C80,49.5,79.8,49.7,79.6,49.7z" }), /* @__PURE__ */ A.createElement("path", { d: "M47,12.7h6c0.6,0,1,0.4,1,1v52c0,0.6-0.4,1-1,1h-6c-0.6,0-1-0.4-1-1v-52C46,13.1,46.4,12.7,47,12.7z" }), /* @__PURE__ */ A.createElement("path", { d: "M39,19.7v6c0,0.6-0.4,1-1,1H17c-0.6,0-1-0.4-1-1v-6c0-0.6,0.4-1,1-1h21C38.6,18.7,39,19.1,39,19.7z" }), /* @__PURE__ */ A.createElement("path", { d: "M39,31.7v6c0,0.6-0.4,1-1,1H8c-0.6,0-1-0.4-1-1v-6c0-0.6,0.4-1,1-1h30C38.6,30.7,39,31.1,39,31.7z" }), /* @__PURE__ */ A.createElement("path", { d: "M39,44.7v6c0,0.6-0.4,1-1,1H20c-0.6,0-1-0.4-1-1v-6c0-0.6,0.4-1,1-1h18C38.6,43.7,39,44.1,39,44.7z" }), /* @__PURE__ */ A.createElement("path", { d: "M39,57.7v6c0,0.6-0.4,1-1,1H25c-0.6,0-1-0.4-1-1v-6c0-0.6,0.4-1,1-1h13C38.6,56.7,39,57.1,39,57.7z" }), /* @__PURE__ */ A.createElement("path", { d: "M79,56.7H63c-0.6,0-1,0.4-1,1v6c0,0.6,0.4,1,1,1h16c0.6,0,1-0.4,1-1v-6C80,57.1,79.6,56.7,79,56.7z M77.6,62.7H64.4 c-0.2,0-0.4-0.2-0.4-0.4v-3.2c0-0.2,0.2-0.4,0.4-0.4h13.2c0.2,0,0.4,0.2,0.4,0.4v3.2C78,62.5,77.8,62.7,77.6,62.7z" })), Ai = (o) => /* @__PURE__ */ A.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 96.3 82.6", fill: "currentColor", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M83.9,61.4h-64V12.1c0-1.1-0.9-2-2-2h-5.5c-1.1,0-2,0.9-2,2v56.7c0,1.1,0.9,2,2,2h71.5c1.1,0,2-0.9,2-2v-5.5 C85.9,62.3,85,61.4,83.9,61.4z" }), /* @__PURE__ */ A.createElement("path", { d: "M67.1,47.3H26.8c-1.1,0-2,0.9-2,2v6.1c0,1.1,0.9,2,2,2h40.3c1.1,0,2-0.9,2-2v-6.1C69.1,48.2,68.2,47.3,67.1,47.3L67.1,47.3z  M52,54.6H38.2c-0.7,0-1.3-0.4-1.3-1V51c0-0.5,0.6-1,1.3-1H52c0.7,0,1.3,0.4,1.3,1v2.6C53.3,54.1,52.8,54.6,52,54.6z" }), /* @__PURE__ */ A.createElement("path", { d: "M83.9,31.7H26.8c-1.1,0-2,0.9-2,2v6.1c0,1.1,0.9,2,2,2h57.2c1.1,0,2-0.9,2-2v-6.1C85.9,32.6,85,31.7,83.9,31.7z M68.8,39 H45.2c-0.7,0-1.3-0.4-1.3-1v-2.6c0-0.5,0.6-1,1.3-1h23.7c0.7,0,1.3,0.4,1.3,1V38C70.2,38.5,69.6,39,68.8,39z" }), /* @__PURE__ */ A.createElement("path", { d: "M77,16.1H26.8c-1.1,0-2,0.9-2,2v6.1c0,1.1,0.9,2,2,2H77c1.1,0,2-0.9,2-2v-6.1C79,17,78.1,16.1,77,16.1z M58.9,23.4H36.6 c-0.7,0-1.3-0.4-1.3-1v-2.6c0-0.5,0.6-1,1.3-1h22.3c0.7,0,1.3,0.4,1.3,1v2.6C60.2,23,59.6,23.4,58.9,23.4z" })), Di = (o) => /* @__PURE__ */ A.createElement("svg", { id: "a", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 96.31 82.55", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M88.49,65.65H15.29V9.04c0-1.1-.9-2-2-2H7.82c-1.1,0-2,.9-2,2V73.13c0,1.1,.9,2,2,2H88.49c1.1,0,2-.9,2-2v-5.48c0-1.1-.9-2-2-2Z" }), /* @__PURE__ */ A.createElement("g", null, /* @__PURE__ */ A.createElement("path", { d: "M30.22,49.19c-1.79,0-3.24,1.45-3.24,3.24s1.45,3.24,3.24,3.24,3.24-1.45,3.24-3.24-1.45-3.24-3.24-3.24Z" }), /* @__PURE__ */ A.createElement("path", { d: "M33.06,35.59c-1.79,0-3.24,1.45-3.24,3.24s1.45,3.24,3.24,3.24,3.24-1.45,3.24-3.24-1.45-3.24-3.24-3.24Z" }), /* @__PURE__ */ A.createElement("path", { d: "M48.12,37.83c-1.79,0-3.24,1.45-3.24,3.24s1.45,3.24,3.24,3.24,3.24-1.45,3.24-3.24-1.45-3.24-3.24-3.24Z" }), /* @__PURE__ */ A.createElement("circle", { cx: 49.64, cy: 22.73, r: 3.24 }), /* @__PURE__ */ A.createElement("path", { d: "M64.53,19.49c-1.79,0-3.24,1.45-3.24,3.24s1.45,3.24,3.24,3.24,3.24-1.45,3.24-3.24-1.45-3.24-3.24-3.24Z" }), /* @__PURE__ */ A.createElement("path", { d: "M57.95,31.11c-1.79,0-3.24,1.45-3.24,3.24s1.45,3.24,3.24,3.24,3.24-1.45,3.24-3.24-1.45-3.24-3.24-3.24Z" }), /* @__PURE__ */ A.createElement("path", { d: "M74.53,11.54c-1.79,0-3.24,1.45-3.24,3.24s1.45,3.24,3.24,3.24,3.24-1.45,3.24-3.24-1.45-3.24-3.24-3.24Z" }))), Ri = (o) => /* @__PURE__ */ A.createElement("svg", { id: "a", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 96.31 82.55", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M54.68,29.14h-4.1V8.43h2.68c.5,0,.9-.15,1.19-.46,.46-.48,.44-1.11,.42-1.62,0-.11,0-.22,0-.34s0-.24,0-.34c.02-.5,.05-1.13-.42-1.62-.29-.3-.69-.46-1.19-.46h-10.2c-.5,0-.9,.15-1.19,.46-.47,.48-.44,1.11-.42,1.62,0,.11,0,.23,0,.34s0,.23,0,.34c-.02,.5-.05,1.13,.42,1.62,.29,.3,.69,.46,1.19,.46h2.68V29.14h-4.1c-1.33,0-2.42,1.09-2.42,2.42v31.31c0,1.33,1.09,2.42,2.42,2.42h4.1v7.97h-2.68c-.5,0-.9,.15-1.19,.46-.46,.48-.44,1.11-.42,1.62,0,.11,0,.22,0,.34s0,.24,0,.34c-.02,.5-.05,1.13,.42,1.62,.29,.3,.69,.46,1.19,.46h10.2c.5,0,.9-.15,1.19-.46,.47-.48,.44-1.11,.42-1.62,0-.11,0-.23,0-.34s0-.23,0-.34c.02-.5,.05-1.13-.42-1.62-.29-.3-.69-.46-1.19-.46h-2.68v-7.97h4.1c1.33,0,2.42-1.09,2.42-2.42V31.56c0-1.33-1.09-2.42-2.42-2.42Zm-2.42,20.5v10.81h-8.2v-10.81h8.2Zm-8.2-4.84v-10.81h8.2v10.81h-8.2Z" })), Ni = (o) => /* @__PURE__ */ A.createElement("svg", { id: "a", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 96.31 82.55", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M88.49,65.65H15.29V9.04c0-1.1-.9-2-2-2H7.82c-1.1,0-2,.9-2,2V73.13c0,1.1,.9,2,2,2H88.49c1.1,0,2-.9,2-2v-5.48c0-1.1-.9-2-2-2Z" }), /* @__PURE__ */ A.createElement("path", { d: "M87.91,60.65c-.02-.12-2.46-12.63-5.53-24.97-5.97-23.99-8.8-26-10.99-26-2.54,0-4.17,3.55-7.92,12.31-.67,1.56-1.4,3.27-2.18,5.02-1.66-4.14-3.14-5.9-4.84-5.9-2.39,0-4.05,3.42-7.07,9.64-5.56,11.44-13.97,28.72-29.12,28.72-.8,0-1.46,.65-1.46,1.45s.65,1.45,1.46,1.45H86.48c.43,0,.85-.19,1.12-.53,.28-.34,.39-.78,.31-1.2Zm-46.88-1.25c8.93-4.92,15.3-15.3,19.83-24.54,2.62,8.88,4.97,20.28,5.83,24.58l-25.66-.04Z" })), Ti = (o) => /* @__PURE__ */ A.createElement("svg", { id: "a", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 96.31 82.55", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M18.29,39.57c0-1.03,.23-1.79,.68-2.28,.45-.49,1.06-.74,1.83-.74s1.42,.25,1.87,.74c.45,.49,.68,1.25,.68,2.29s-.23,1.79-.68,2.28c-.45,.5-1.06,.74-1.83,.74s-1.42-.25-1.87-.74c-.45-.49-.68-1.25-.68-2.29Zm1.71-.02c0,.75,.09,1.25,.26,1.5,.13,.19,.31,.28,.54,.28s.42-.09,.55-.28c.17-.25,.25-.75,.25-1.5s-.08-1.24-.25-1.49c-.13-.19-.31-.29-.55-.29s-.41,.09-.54,.28c-.17,.26-.26,.76-.26,1.5Zm2.47,9.08h-1.62l6.1-12.09h1.58l-6.05,12.09Zm3.55-3.01c0-1.03,.23-1.79,.68-2.28,.45-.49,1.07-.74,1.85-.74s1.4,.25,1.86,.74c.45,.5,.68,1.26,.68,2.28s-.23,1.79-.68,2.29c-.45,.49-1.06,.74-1.83,.74s-1.42-.25-1.87-.74c-.45-.49-.68-1.26-.68-2.29Zm1.71,0c0,.75,.09,1.24,.26,1.49,.13,.19,.31,.29,.54,.29s.41-.09,.54-.28c.17-.25,.26-.75,.26-1.5s-.08-1.24-.25-1.5c-.13-.19-.31-.28-.55-.28s-.41,.09-.54,.28c-.17,.26-.26,.76-.26,1.5Z" }), /* @__PURE__ */ A.createElement("path", { d: "M92.33,52.83v-20.42c0-1.61-1.31-2.93-2.93-2.93H6.65c-1.61,0-2.93,1.31-2.93,2.93v20.42c0,1.61,1.31,2.93,2.93,2.93H89.4c1.61,0,2.93-1.31,2.93-2.93Zm-52.34-2.93H9.58v-14.56h30.41v14.56Zm5.86-14.56h40.63v14.56H45.85v-14.56Z" })), nr = (o) => /* @__PURE__ */ A.createElement("svg", { id: "a", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 96.31 82.55", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M89.56,65.41H16.36V8.8c0-1.1-.9-2-2-2h-5.48c-1.1,0-2,.9-2,2V72.89c0,1.1,.9,2,2,2H89.56c1.1,0,2-.9,2-2v-5.48c0-1.1-.9-2-2-2Z" }), /* @__PURE__ */ A.createElement("path", { d: "M54.66,55.34c-17.76,0-33.46-17.8-34.12-18.56l-.98-1.13v-4.55l3.25,3.72c.15,.18,15.47,17.53,31.86,17.53h0c7.31,0,12.37-1.68,17.27-3.3,4.31-1.42,8.77-2.9,14.44-3.05l1.5-.04v3l-1.42,.04c-5.24,.14-9.29,1.48-13.59,2.9-5.13,1.69-10.43,3.45-18.22,3.45h0Z" }), /* @__PURE__ */ A.createElement("path", { d: "M87.84,59.04c-4.73-1.24-7.41-1.66-13.05-1.93-2.82-.14-5.22,.16-8,.5-2.73,.33-5.81,.71-10.06,.79-13.13,.27-23.77-4.63-37.17-17.31v-1.57c13.19,12.48,24.31,18.13,37.15,17.88,4.2-.08,7.26-.46,9.96-.79,2.83-.34,5.27-.64,8.17-.5,5.73,.28,8.2,.62,13,1.88v1.05Z" }), /* @__PURE__ */ A.createElement("path", { d: "M57.02,49.28c-19.55,0-30.91-14.65-37.69-23.41v-1.54c6.67,8.61,18.64,23.95,37.69,23.95,5.87,0,14.11-3.23,18.39-6.23,2.43-1.7,3.84-2.77,4.87-3.55,2.24-1.7,2.7-2.05,7.71-4.44l-.03,1.12c-4.92,2.34-4.91,2.47-7.08,4.12-1.04,.79-2.45,1.86-4.9,3.57-4.4,3.08-12.9,6.41-18.96,6.41Z" })), Pi = (o) => /* @__PURE__ */ A.createElement("svg", { id: "Layer_1", "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 99.1 79.69", ...o }, /* @__PURE__ */ A.createElement("defs", null, /* @__PURE__ */ A.createElement("style", null, ".cls-1{fill:#231f20;}")), /* @__PURE__ */ A.createElement("rect", { className: "cls-1", x: 46.87, y: 5.79, width: 8.32, height: 67.79, rx: 1 }), /* @__PURE__ */ A.createElement("rect", { className: "cls-1", x: 23.98, y: 17.65, width: 8.32, height: 23.31, rx: 1, transform: "translate(57.44 1.16) rotate(90)" }), /* @__PURE__ */ A.createElement("rect", { className: "cls-1", x: 19.53, y: 25.99, width: 8.32, height: 32.21, rx: 1, transform: "translate(65.79 18.41) rotate(90)" }), /* @__PURE__ */ A.createElement("rect", { className: "cls-1", x: 27.33, y: 60.4, width: 8.32, height: 14.6, rx: 1, transform: "translate(99.19 36.2) rotate(90)" }), /* @__PURE__ */ A.createElement("path", { className: "cls-1", d: "M81,52.74v4.32H64.55V52.74H81m1-2H63.55a1,1,0,0,0-1,1v6.32a1,1,0,0,0,1,1H82a1,1,0,0,0,1-1V51.74a1,1,0,0,0-1-1Z" }), /* @__PURE__ */ A.createElement("path", { className: "cls-1", d: "M90,14.41v4.33H64.55V14.41H90m1-2H63.55a1,1,0,0,0-1,1v6.33a1,1,0,0,0,1,1H91a1,1,0,0,0,1-1V13.41a1,1,0,0,0-1-1Z" })), Ii = (o) => /* @__PURE__ */ A.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 96.31 82.55", ...o }, /* @__PURE__ */ A.createElement("g", { id: "a" }, /* @__PURE__ */ A.createElement("path", { d: "M88.56,66.3H15.36V9.68c0-1.1-.9-2-2-2H7.89c-1.1,0-2,.9-2,2V73.77c0,1.1,.9,2,2,2H88.56c1.1,0,2-.9,2-2v-5.48c0-1.1-.9-2-2-2Z" }), /* @__PURE__ */ A.createElement("path", { d: "M18.36,54.67v6.94c0,1.1,.9,2,2,2h5.48c1.1,0,2-.9,2-2l-.13-6.94c0-1.1-.9-2-2-2h-5.34c-1.1,0-2,.9-2,2Z" }), /* @__PURE__ */ A.createElement("path", { d: "M30.43,45.3v16.31c0,1.1,.9,2,2,2h5.48c1.1,0,2-.9,2-2l-.13-16.31c0-1.1-.9-2-2-2h-5.34c-1.1,0-2,.9-2,2Z" }), /* @__PURE__ */ A.createElement("path", { d: "M42.51,32.3v29.31c0,1.1,.9,2,2,2h5.48c1.1,0,2-.9,2-2l-.13-29.31c0-1.1-.9-2-2-2h-5.34c-1.1,0-2,.9-2,2Z" }), /* @__PURE__ */ A.createElement("path", { d: "M54.58,32.3v29.31c0,1.1,.9,2,2,2h5.48c1.1,0,2-.9,2-2l-.13-29.31c0-1.1-.9-2-2-2h-5.34c-1.1,0-2,.9-2,2Z" }), /* @__PURE__ */ A.createElement("path", { d: "M66.66,42.22v19.33c0,1.1,.9,2,2,2h5.48c1.1,0,2-.9,2-2l-.13-19.33c0-1.1-.9-2-2-2h-5.34c-1.1,0-2,.9-2,2Z" }), /* @__PURE__ */ A.createElement("path", { d: "M78.73,58.89v2.72c0,1.1,.9,2,2,2h5.48c1.1,0,2-.9,2-2l-.13-2.72c0-1.1-.9-2-2-2h-5.34c-1.1,0-2,.9-2,2Z" }), /* @__PURE__ */ A.createElement("g", null, /* @__PURE__ */ A.createElement("path", { d: "M20.25,38.69c-.65,0-1.3-.32-1.68-.91-.6-.93-.34-2.16,.59-2.77,.01,0,1.17-.76,2.86-1.92,.91-.62,2.16-.39,2.78,.52,.62,.91,.39,2.16-.52,2.78-1.75,1.2-2.95,1.98-2.95,1.98-.34,.22-.71,.32-1.09,.32Z" }), /* @__PURE__ */ A.createElement("path", { d: "M28.5,32.92c-.61,0-1.21-.28-1.6-.8-.66-.88-.48-2.14,.4-2.8,1.91-1.43,3.51-2.72,4.76-3.83l.21-.19c.82-.74,2.09-.67,2.82,.16,.74,.82,.66,2.09-.16,2.82l-.22,.2c-1.34,1.19-3.03,2.55-5.02,4.04-.36,.27-.78,.4-1.2,.4Zm50.28-1.66c-.34,0-.68-.09-1-.27-1.64-.95-3.38-2.08-5.66-3.67-.91-.63-1.13-1.88-.49-2.79,.63-.9,1.88-1.13,2.79-.49,2.17,1.52,3.83,2.6,5.37,3.48,.96,.55,1.28,1.78,.73,2.73-.37,.64-1.04,1-1.73,1Zm-40.24-6.8c-.58,0-1.15-.25-1.55-.73-.7-.85-.58-2.11,.28-2.81,1.98-1.63,3.82-2.93,5.61-3.98,.95-.56,2.18-.24,2.74,.72s.24,2.18-.72,2.74c-1.61,.94-3.27,2.12-5.09,3.62-.37,.31-.82,.45-1.27,.45Zm29.37-.59c-.4,0-.8-.12-1.15-.37-1.61-1.13-3.5-2.44-5.34-3.52-.95-.56-1.27-1.78-.72-2.74,.56-.95,1.78-1.27,2.74-.72,1.98,1.16,3.95,2.52,5.63,3.7,.9,.64,1.12,1.88,.48,2.79-.39,.55-1.01,.85-1.64,.85Zm-18-5.77c-.89,0-1.7-.6-1.93-1.49-.28-1.07,.36-2.16,1.43-2.44,1.72-.45,3.46-.68,5.17-.68,.71,0,1.46,.08,2.24,.24,1.08,.23,1.77,1.29,1.55,2.37s-1.29,1.77-2.37,1.55c-.5-.11-.98-.16-1.42-.16-1.37,0-2.77,.18-4.16,.55-.17,.04-.34,.07-.51,.07Z" }), /* @__PURE__ */ A.createElement("path", { d: "M88.21,34.46c-1.26,0-2.6-.2-4-.6-1.06-.3-1.68-1.41-1.37-2.47,.3-1.06,1.41-1.68,2.47-1.37,1.04,.3,2.02,.45,2.9,.45,1.1,0,2,.9,2,2s-.9,2-2,2Z" }))), /* @__PURE__ */ A.createElement("g", { id: "b" })), Li = (o) => /* @__PURE__ */ A.createElement("svg", { id: "Layer_1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", x: "0px", y: "0px", viewBox: "0 0 96.3 82.6", style: {
  ...
  const { config: o, tempConfig: C } = A.useContext(dt), s = A.useContext(Et), d = ["General", , "Charts", "Maps"], b = (nn) => {
    ...
    switch (nn.category) {
      case "Charts": {
        const fn = nn.subType, w = nn.visualizationSubType ? nn.visualizationSubType : "regular";
        h = {
          ...nn,
          visualizationType: fn,
          visualizationSubType: w,
          newViz: !0,
          datasets: {}
        };
        break;
      ...
      case "General": {
        const fn = nn.subType;
        h = { ...nn, newViz: !0, datasets: {}, visualizationType: fn };
        break;
      }
      case "Maps": {
        const fn = nn.subType;
    ...
    const { label: h, icon: fn, id: w } = nn, ln = w === (o == null ? void 0 : o.activeVizButtonID) || 0, Tn = () => {
      y(nn);
    };
    return C && s({ type: "EDITOR_SAVE", payload: C }), /* @__PURE__ */ an("button", { className: ln ? "active" : "", onClick: Tn, "aria-label": h, children: [
      fn,
      /* @__PURE__ */ M("span", { className: "mt-1", children: h })
    ] });
  };
  return /* @__PURE__ */ an("div", { className: "choose-vis", children: [
    /* @__PURE__ */ M(
      "a",
      {
        ...
        children: /* @__PURE__ */ M("div", { children: /* @__PURE__ */ an("p", { children: [
    ...
    d.map((nn) => /* @__PURE__ */ an(ir.Fragment, { children: [
      /* @__PURE__ */ M("div", { className: "heading-2", children: nn }),
      /* @__PURE__ */ M("ul", { className: `visualization-grid category_${nn.toLowerCase()}`, children: Oi.filter((h) => h.category === nn).map((h, fn) => /* @__PURE__ */ M("li", { children: /* @__PURE__ */ an(Ne, { position: "right", children: [
        /* @__PURE__ */ M(Ne.Target, { children: /* @__PURE__ */ M(E, { ...h }) }),
        /* @__PURE__ */ M(Ne.Content, { children: h.content })
      ] }) }, fn)) })
    ] })),
    /* @__PURE__ */ M("hr", {}),
    /* @__PURE__ */ an("div", { className: "form-group", children: [
      /* @__PURE__ */ an("label", { htmlFor: "uploadConfig", children: [
        "Upload Custom Configuration",
        " ",
        /* @__PURE__ */ an(Ne, { style: { textTransform: "none" }, children: [
          /* @__PURE__ */ M(Ne.Target, { children: /* @__PURE__ */ M(ma, { display: "warningCircle", style: { marginLeft: "0.5rem" } }) }),
          /* @__PURE__ */ M(Ne.Content, { children: /* @__PURE__ */ M("p", { children: "Make sure you have properly validated the configuration before uploading." }) })
        ] })
      ] }),
      /* @__PURE__ */ M(
        "input",
...
function Bi({ containerEl: o }) {
  const { config: C, setTempConfig: s, hostname: d, isDebug: b } = A.useContext(dt);
  let { type: P } = C;
  switch (P) {
    case "map":
      return /* @__PURE__ */ M(ct, { component: "CdcMap", children: /* @__PURE__ */ M(
        Kr,
        {
          isEditor: !0,
          isDebug: b,
    ...
    case "waffle-chart":
      if (C.visualizationType === "Waffle" || C.visualizationType === "Gauge")
        return /* @__PURE__ */ M(ct, { component: "CdcWaffleChart", children: /* @__PURE__ */ M(_r, { isEditor: !0, isDebug: b, config: C, setConfig: s }) });
      break;
    case "chart":
      return /* @__PURE__ */ M(ct, { component: "CdcChart", children: /* @__PURE__ */ M(qr, { isEditor: !0, isDebug: b, config: C }) });
    case "dashboard":
      return /* @__PURE__ */ M(ct, { component: "CdcDashboard", children: /* @__PURE__ */ M(Dr, { isEditor: !0, isDebug: b }) });
    case "data-bite":
      return /* @__PURE__ */ M(ct, { component: "CdcDashboard", children: /* @__PURE__ */ M(zr, { isEditor: !0, isDebug: b, config: C, setConfig: s }) });
    case "markup-include":
      return /* @__PURE__ */ M(ct, { component: "CdcDashboard", children: /* @__PURE__ */ M(Ir, { isEditor: !0, isDebug: b, config: C, setConfig: s }) });
    default:
...
const Ei = (o) => {
  if (o !== null) {
    let C = sr(o);
    const s = JSON.stringify(C), d = new CustomEvent("updateVizConfig", { detail: s, bubbles: !0 });
  ...
  if (o.type === "dashboard") {
    ...
    if (o.data || o.dataUrl) {
      ...
      d.datasets = {}, d.datasets[b] = {
        ...ha.pick(o, ["data", "dataUrl", "dataFileSourceType"]),
        dataFileName: b
      }, Object.keys(d.visualizations).forEach((y) => {
        const E = { dataKey: b, ...ha.pick(d, "dataDescription", "formattedData") };
        d.visualizations[y] = { ...d.visualizations[y], ...E };
      }), d = { ...d, ...{ data: [], dataUrl: "", dataFileName: "", dataFileSourceType: "", dataDescription: [], formattedData: [] } };
    }
    if ((C = o.dashboard) != null && C.filters) {
      s = !0, d = { ...o };
      const b = { ...d.dashboard };
...
const Fi = (o, C) => {
  switch (C.type) {
    case "EDITOR_SAVE":
      return { ...o, config: C.payload, tempConfig: null };
    case "EDITOR_SET_CONFIG":
      return { ...o, config: C.payload };
    case "EDITOR_TEMP_SAVE":
      return { ...o, tempConfig: C.payload };
    case "EDITOR_SET_ERRORS":
      return { ...o, errors: C.payload };
    case "EDITOR_SET_VIEWPORT":
      return { ...o, currentViewport: C.payload };
    case "EDITOR_SET_GLOBALACTIVE":
      return { ...o, globalActive: C.payload };
    default:
      return o;
  }
}, Wi = Rr(Fi), xi = ({ config: o, hostname: C, containerEl: s, sharepath: d, isDebug: b }) => {
  const P = A.useMemo(() => {
    let ln = 0;
    return (o != null && o.data || o != null && o.dataUrl || o != null && o.originalFormattedData || o != null && o.datasets) && (o != null && o.type) && (ln = 2), { config: Hi(o || { newViz: !0, errors: [], currentViewport: "lg" }), errors: [], currentViewport: "lg", globalActive: ln, sharepath: d, isDebug: b, hostname: C };
  }, [o]);
  A.useEffect(() => {
    var ln;
    ka && ((ln = ka) == null || ln.init());
  }, []);
  const [y, E] = A.useReducer(Wi, P), nn = (ln) => {
    Ei(ha.cloneDeep(ln)), E({ type: "EDITOR_TEMP_SAVE", payload: ln });
  }, h = new br((ln) => {
    const Tn = ln[0], { width: Cn } = Tn.contentRect, gn = Ar(Cn);
    y.currentViewport !== gn && E({ type: "EDITOR_SET_VIEWPORT", payload: gn });
  }), fn = A.useCallback((ln) => {
    ln !== null && h.observe(ln);
  }, []);
  A.useEffect(() => {
    let ln = sr(y.config);
    const Tn = JSON.stringify(ln), Cn = new CustomEvent("updateVizConfig", { detail: Tn });
  ...
  return /* @__PURE__ */ an(Nr, { children: [
    /* @__PURE__ */ M(dt.Provider, { value: { ...y, setTempConfig: nn }, children: /* @__PURE__ */ M(Et.Provider, { value: E, children: /* @__PURE__ */ M("div", { className: `cdc-open-viz-module cdc-editor ${y.currentViewport}`, ref: fn, children: /* @__PURE__ */ an(qu, { className: "top-level", children: [
      /* @__PURE__ */ M(Bt, { title: "1. Choose Visualization Type", className: "choose-type", children: /* @__PURE__ */ M(ki, {}) }),
      /* @__PURE__ */ M(Bt, { title: "2. Import Data", className: "data-designer", disableRule: !y.config.type, children: /* @__PURE__ */ M(wi, {}) }),
      /* @__PURE__ */ M(Bt, { title: "3. Configure", className: "configure", disableRule: w, children: /* @__PURE__ */ M(Bi, { containerEl: s }) })
    ] }) }) }) }),
    /* @__PURE__ */ M(Tr, {})
  ] });
}, Gi = (o) => new Promise((C) => setTimeout(C, o)), V0 = {
  ...
  play: async ({
    ...
    const C = Xr(o), s = Yr.setup();
    await Gi(1e3);
    const d = C.getByText("United States (State- or County-Level)");
    await s.click(d);
    const b = C.getByText("United States: County Sample Data");
    await s.click(b);
  }
};
var er, tr, or;
To.parameters = {
  ...To.parameters,
  docs: {
    ...(er = To.parameters) == null ? void 0 : er.docs,
    source: {
      originalSource: `{
  args: {
    config: {}
      ...
      ...(or = (tr = To.parameters) == null ? void 0 : tr.docs) == null ? void 0 : or.source
    }
  }
};
var ar, rr, ur;
Po.parameters = {
  ...Po.parameters,
  docs: {
    ...(ar = Po.parameters) == null ? void 0 : ar.docs,
    source: {
      originalSource: `{
  args: {},
  parameters: {},
  play: async ({
    ...
    await user.click(sampleData);
      ...
      ...(ur = (rr = Po.parameters) == null ? void 0 : rr.docs) == null ? void 0 : ur.source
    }
  }
};
const K0 = ["DefaultEditor", "PreviewTable"];
export {
  To as DefaultEditor,
  Po as PreviewTable,
