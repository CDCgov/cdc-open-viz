import { g as Cs, j as Wu, k as Hu, m as Kt, o as As, i as Ts, p as qu, G as Kn } from "./storybook-linear-5c281d48.es.js";
import { c as jt } from "./storybook-index-80cf478c.es.js";
import { P as F } from "./storybook-index-43433e35.es.js";
import { r as S, R } from "./storybook-index-f2fed736.es.js";
import { c as zt, T as Lt } from "./storybook-Tooltip-7cf39805.es.js";
import { a as _l, g as Yu } from "./storybook-_commonjsHelpers-c5d32002.es.js";
import { j as b, a as B, F as mt } from "./storybook-jsx-runtime-ea6e0d87.es.js";
...
import { S as mn, T as Is } from "./storybook-Inputs-f2c63984.es.js";
import { h as qo, i as Ju } from "./storybook-Filters-caf19344.es.js";
...
import { M as ed } from "./storybook-MultiSelect-cda00383.es.js";
  ...
  arcTo: function(e, t, n, r, o) {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(d * a - l * c) > Xt) || !o)
        ...
        var f = n - i, p = r - s, h = a * a + l * l, g = f * f + p * p, m = Math.sqrt(h), _ = Math.sqrt(u), O = o * Math.tan((Yo - Math.acos((h + u - g) / (2 * m * _))) / 2), y = O / _, v = O / m;
        Math.abs(y - 1) > Xt && (this._ += "L" + (e + y * c) + "," + (t + y * d)), this._ += "A" + o + "," + o + ",0,0," + +(d * f > c * p) + "," + (this._x1 = e + v * a) + "," + (this._y1 = t + v * l);
      }
  },
...
function bd({ debounce: e, scroll: t, polyfill: n, offsetSize: r } = { debounce: 0, scroll: !1, offsetSize: !1 }) {
  ...
  const [i, s] = S.useState({ left: 0, top: 0, width: 0, height: 0, bottom: 0, right: 0, x: 0, y: 0 }), a = S.useRef({ element: null, scrollContainers: null, resizeObserver: null, lastBounds: i, orientationHandler: null }), l = e ? typeof e == "number" ? e : e.scroll : null, c = e ? typeof e == "number" ? e : e.resize : null, d = S.useRef(!1);
  S.useEffect(() => (d.current = !0, () => void (d.current = !1)));
  const [u, f, p] = S.useMemo(() => {
    const _ = () => {
      if (!a.current.element)
        return;
      const { left: O, top: y, width: v, height: D, bottom: x, right: C, x: N, y: G } = a.current.element.getBoundingClientRect(), T = { left: O, top: y, width: v, height: D, bottom: x, right: C, x: N, y: G };
  ...
  const m = (_) => {
    !_ || _ === a.current.element || (h(), a.current.element = _, a.current.scrollContainers = Pl(_), g());
  };
  return wd(p, !!t), Ed(f), S.useEffect(() => {
    h(), g();
  }, [t, p, f]), S.useEffect(() => h, []), [m, i, u];
}
function Ed(e) {
  S.useEffect(() => {
    const t = e;
...
function Rl(e, t, n, r) {
  ...
  function i(c, d, u, f, p, h) {
    if (c !== u || d !== f) {
      ...
      h.push({ i: g - 4, x: Kt(c, u) }, { i: g - 2, x: Kt(d, f) });
    } else
...
function mf(e, t) {
  ...
  for (var i = o.length, s = new Array(i), a = new Array(i), l = new Array(i), c = 0; c < i; ++c) {
    var d = r[c], u = o[c], f = u.length, p = gf(e.call(d, d && d.__data__, c, r)), h = p.length, g = a[c] = new Array(h), m = s[c] = new Array(h), _ = l[c] = new Array(f);
    n(d, u, g, m, _, p, t);
    for (var O = 0, y = 0, v, D; O < h; ++O)
      if (v = g[O]) {
        for (O >= y && (y = O + 1); !(D = m[y]) && ++y < h; )
          ;
        v._next = D || null;
      }
  }
...
function hh(e) {
  ...
  for (var r = this._groups, o = r.length, i = [], s = [], a = 0; a < o; ++a)
    for (var l = r[a], c = l.length, d, u = 0; u < c; ++u)
      if (d = l[u]) {
        for (var f = e.call(d, d.__data__, u, l), p, h = St(d, n), g = 0, m = f.length; g < m; ++g)
          (p = f[g]) && io(p, t, n, g, f, h);
        i.push(f), s.push(d);
      }
...
function sc() {
  ...
  const r = n, o = r.currentScript, {
    ...
    DOMParser: f,
    trustedTypes: p
  } = e, h = l.prototype, g = Bn(h, "cloneNode"), m = Bn(h, "remove"), _ = Bn(h, "nextSibling"), O = Bn(h, "childNodes"), y = Bn(h, "parentNode");
  ...
  let P = ea();
  t.isSupported = typeof nc == "function" && typeof y == "function" && x && x.createHTMLDocument !== void 0;
  const {
    MUSTACHE_EXPR: k,
    ERB_EXPR: V,
    TMPLIT_EXPR: Z,
  ...
  })), we = null, Le = null, Ye = !0, Ne = !0, Ue = !1, Ce = !0, I = !1, pe = !0, j = !1, ee = !1, de = !1, ke = !1, Oe = !1, We = !1, Pt = !0, Ot = !1;
  ...
  let ue = null, Ae = null;
  const je = n.createElement("form"), ft = function(w) {
    return w instanceof RegExp || w instanceof Function;
  }, pt = function() {
    let w = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (!(Ae && Ae === w)) {
      if ((!w || typeof w != "object") && (w = {}), w = Zt(w), L = // eslint-disable-next-line unicorn/prefer-includes
      be.indexOf(w.PARSER_MEDIA_TYPE) === -1 ? he : w.PARSER_MEDIA_TYPE, ue = L === "application/xhtml+xml" ? _o : Br, K = _t(w, "ALLOWED_TAGS") ? ae({}, w.ALLOWED_TAGS, ue) : Se, oe = _t(w, "ALLOWED_ATTR") ? ae({}, w.ALLOWED_ATTR, ue) : Ie, X = _t(w, "ALLOWED_NAMESPACES") ? ae({}, w.ALLOWED_NAMESPACES, _o) : se, rt = _t(w, "ADD_URI_SAFE_ATTR") ? ae(Zt(Ke), w.ADD_URI_SAFE_ATTR, ue) : Ke, $e = _t(w, "ADD_DATA_URI_TAGS") ? ae(Zt(It), w.ADD_DATA_URI_TAGS, ue) : It, nt = _t(w, "FORBID_CONTENTS") ? ae({}, w.FORBID_CONTENTS, ue) : xt, we = _t(w, "FORBID_TAGS") ? ae({}, w.FORBID_TAGS, ue) : {}, Le = _t(w, "FORBID_ATTR") ? ae({}, w.FORBID_ATTR, ue) : {}, xe = _t(w, "USE_PROFILES") ? w.USE_PROFILES : !1, Ye = w.ALLOW_ARIA_ATTR !== !1, Ne = w.ALLOW_DATA_ATTR !== !1, Ue = w.ALLOW_UNKNOWN_PROTOCOLS || !1, Ce = w.ALLOW_SELF_CLOSE_IN_ATTR !== !1, I = w.SAFE_FOR_TEMPLATES || !1, pe = w.SAFE_FOR_XML !== !1, j = w.WHOLE_DOCUMENT || !1, ke = w.RETURN_DOM || !1, Oe = w.RETURN_DOM_FRAGMENT || !1, We = w.RETURN_TRUSTED_TYPE || !1, de = w.FORCE_BODY || !1, Pt = w.SANITIZE_DOM !== !1, Ot = w.SANITIZE_NAMED_PROPS || !1, Et = w.KEEP_CONTENT !== !1, at = w.IN_PLACE || !1, H = w.ALLOWED_URI_REGEXP || oc, ot = w.NAMESPACE || He, le = w.MATHML_TEXT_INTEGRATION_POINTS || le, ie = w.HTML_INTEGRATION_POINTS || ie, re = w.CUSTOM_ELEMENT_HANDLING || {}, w.CUSTOM_ELEMENT_HANDLING && ft(w.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (re.tagNameCheck = w.CUSTOM_ELEMENT_HANDLING.tagNameCheck), w.CUSTOM_ELEMENT_HANDLING && ft(w.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (re.attributeNameCheck = w.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), w.CUSTOM_ELEMENT_HANDLING && typeof w.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (re.allowCustomizedBuiltInElements = w.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), I && (Ne = !1), Oe && (ke = !0), xe && (K = ae({}, Xs), oe = [], xe.html === !0 && (ae(K, Ks), ae(oe, Zs)), xe.svg === !0 && (ae(K, Do), ae(oe, xo), ae(oe, Tr)), xe.svgFilters === !0 && (ae(K, So), ae(oe, xo), ae(oe, Tr)), xe.mathMl === !0 && (ae(K, Oo), ae(oe, Js), ae(oe, Tr))), w.ADD_TAGS && (K === Se && (K = Zt(K)), ae(K, w.ADD_TAGS, ue)), w.ADD_ATTR && (oe === Ie && (oe = Zt(oe)), ae(oe, w.ADD_ATTR, ue)), w.ADD_URI_SAFE_ATTR && ae(rt, w.ADD_URI_SAFE_ATTR, ue), w.FORBID_CONTENTS && (nt === xt && (nt = Zt(nt)), ae(nt, w.FORBID_CONTENTS, ue)), Et && (K["#text"] = !0), j && ae(K, ["html", "head", "body"]), K.table && (ae(K, ["tbody"]), delete we.tbody), w.TRUSTED_TYPES_POLICY) {
        ...
        v = w.TRUSTED_TYPES_POLICY, D = v.createHTML("");
      } else
        v === void 0 && (v = vm(p, o)), v !== null && typeof D == "string" && (D = v.createHTML(""));
      et && et(w), Ae = w;
    }
  }, Rt = ae({}, [...Do, ...So, ...sm]), dn = ae({}, [...Oo, ...am]), wr = function(w) {
    let A = y(w);
    (!A || !A.tagName) && (A = {
      namespaceURI: ot,
      tagName: "template"
    });
    const U = Br(w.tagName), M = Br(A.tagName);
    return X[w.namespaceURI] ? w.namespaceURI === Te ? A.namespaceURI === He ? U === "svg" : A.namespaceURI === Fe ? U === "svg" && (M === "annotation-xml" || le[M]) : !!Rt[U] : w.namespaceURI === Fe ? A.namespaceURI === He ? U === "math" : A.namespaceURI === Te ? U === "math" && ie[M] : !!dn[U] : w.namespaceURI === He ? A.namespaceURI === Te && !ie[M] || A.namespaceURI === Fe && !le[M] ? !1 : !dn[U] && (fe[U] || !Rt[U]) : !!(L === "application/xhtml+xml" && X[w.namespaceURI]) : !1;
  }, Xe = function(w) {
    Ln(t.removed, {
      element: w
    });
    ...
    L === "application/xhtml+xml" && ot === He && (w = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + w + "</body></html>");
    const M = v ? v.createHTML(w) : w;
    if (ot === He)
      try {
    ...
    if (!A || !A.documentElement) {
      ...
      try {
        A.documentElement.innerHTML = te ? D : M;
      } catch {
      }
    }
    const ne = A.body || A.documentElement;
    return w && U && ne.insertBefore(n.createTextNode(U), ne.childNodes[0] || null), ot === He ? G.call(A, j ? "html" : "body")[0] : j ? A.documentElement : ne;
  }, Vt = function(w) {
    return C.call(
      w.ownerDocument || w,
      w,
    ...
    return w instanceof u && (typeof w.nodeName != "string" || typeof w.textContent != "string" || typeof w.removeChild != "function" || !(w.attributes instanceof d) || typeof w.removeAttribute != "function" || typeof w.setAttribute != "function" || typeof w.namespaceURI != "string" || typeof w.insertBefore != "function" || typeof w.hasChildNodes != "function");
  }, Dr = function(w) {
    return typeof a == "function" && w instanceof a;
  };
  function wt(q, w, A) {
    Ar(q, (U) => {
      U.call(t, w, A, Ae);
  ...
  const Sr = function(w) {
    let A = null;
    if (wt(P.beforeSanitizeElements, w, null), fn(w))
      return Xe(w), !0;
    const U = ue(w.nodeName);
    if (wt(P.uponSanitizeElement, w, {
      tagName: U,
      allowedTags: K
    }), w.hasChildNodes() && !Dr(w.firstElementChild) && Ze(/<[/\w!]/g, w.innerHTML) && Ze(/<[/\w!]/g, w.textContent) || w.nodeType === Vn.progressingInstruction || pe && w.nodeType === Vn.comment && Ze(/<[/\w]/g, w.data))
      return Xe(w), !0;
    if (!K[U] || we[U]) {
      if (!we[U] && In(U) && (re.tagNameCheck instanceof RegExp && Ze(re.tagNameCheck, U) || re.tagNameCheck instanceof Function && re.tagNameCheck(U)))
        return !1;
      if (Et && !nt[U]) {
        const M = y(w) || w.parentNode, ne = O(w) || w.childNodes;
        if (ne && M) {
          const Ee = ne.length;
          for (let _e = Ee - 1; _e >= 0; --_e) {
            const qe = g(ne[_e], !0);
            qe.__removalCount = (w.__removalCount || 0) + 1, M.insertBefore(qe, _(w));
          }
        }
      }
      return Xe(w), !0;
    }
    return w instanceof l && !wr(w) || (U === "noscript" || U === "noembed" || U === "noframes") && Ze(/<\/no(script|embed|frames)/i, w.innerHTML) ? (Xe(w), !0) : (I && w.nodeType === Vn.text && (A = w.textContent, Ar([k, V, Z], (M) => {
      A = kn(A, M, " ");
    }), w.textContent !== A && (Ln(t.removed, {
      element: w.cloneNode()
    }), w.textContent = A)), wt(P.afterSanitizeElements, w, null), !1);
  }, pn = function(w, A, U) {
      ...
      if (!(Ye && Ze($, A))) {
        if (!oe[A] || Le[A]) {
          if (
            ...
            !(In(w) && (re.tagNameCheck instanceof RegExp && Ze(re.tagNameCheck, w) || re.tagNameCheck instanceof Function && re.tagNameCheck(w)) && (re.attributeNameCheck instanceof RegExp && Ze(re.attributeNameCheck, A) || re.attributeNameCheck instanceof Function && re.attributeNameCheck(A)) || // Alternative, second condition checks if it's an `is`-attribute, AND
          ...
          if (!Ze(H, kn(U, J, ""))) {
            if (!((A === "src" || A === "xlink:href" || A === "href") && w !== "script" && nm(U, "data:") === 0 && $e[w])) {
              if (!(Ue && !Ze(W, kn(U, J, "")))) {
                if (U)
                  return !1;
              }
    ...
    return w !== "annotation-xml" && Ys(w, z);
  }, hn = function(w) {
    wt(P.beforeSanitizeAttributes, w, null);
    const {
      attributes: A
    } = w;
    if (!A || fn(w))
    ...
    for (; M--; ) {
      ...
      if (U.attrName = Ut, U.attrValue = Pe, U.keepAttr = !0, U.forceKeepAttr = void 0, wt(P.uponSanitizeAttribute, w, U), Pe = U.attrValue, Ot && (Ut === "id" || Ut === "name") && (Mt(Ee, w), Pe = bt + Pe), pe && Ze(/((--!?|])>)|<\/(style|title)/i, Pe)) {
        Mt(Ee, w);
        continue;
      }
      if (U.forceKeepAttr || (Mt(Ee, w), !U.keepAttr))
        continue;
      if (!Ce && Ze(/\/>/i, Pe)) {
        Mt(Ee, w);
        continue;
      ...
      const Wt = ue(w.nodeName);
      if (pn(Wt, Ut, Pe)) {
        if (v && typeof p == "object" && typeof p.getAttributeType == "function" && !_e)
          switch (p.getAttributeType(Wt, Ut)) {
            ...
            case "TrustedScriptURL": {
              Pe = v.createScriptURL(Pe);
              break;
            }
          }
        try {
          _e ? w.setAttributeNS(_e, Ee, Pe) : w.setAttribute(Ee, Pe), fn(w) ? Xe(w) : qs(t.removed);
        } catch {
        }
      }
    }
    wt(P.afterSanitizeAttributes, w, null);
  }, Or = function q(w) {
    let A = null;
    const U = Vt(w);
    for (wt(P.beforeSanitizeShadowDOM, w, null); A = U.nextNode(); )
      wt(P.uponSanitizeShadowNode, A, null), Sr(A), hn(A), A.content instanceof i && q(A.content);
    wt(P.afterSanitizeShadowDOM, w, null);
  };
  return t.sanitize = function(q) {
    let w = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, A = null, U = null, M = null, ne = null;
    ...
    if (!t.isSupported)
      return q;
    if (ee || pt(w), t.removed = [], typeof q == "string" && (at = !1), at) {
      if (q.nodeName) {
      ...
      if (!ke && !I && !j && // eslint-disable-next-line unicorn/prefer-includes
      q.indexOf("<") === -1)
        return v && We ? v.createHTML(q) : q;
      if (A = _r(q), !A)
        return ke ? null : We ? D : "";
    }
    ...
    let _e = j ? A.outerHTML : A.innerHTML;
    return j && K["!doctype"] && A.ownerDocument && A.ownerDocument.doctype && A.ownerDocument.doctype.name && Ze(ic, A.ownerDocument.doctype.name) && (_e = "<!DOCTYPE " + A.ownerDocument.doctype.name + `>
` + _e), I && Ar([k, V, Z], (qe) => {
      _e = kn(_e, qe, " ");
    }), v && We ? v.createHTML(_e) : _e;
  }, t.setConfig = function() {
    let q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    pt(q), ee = !0;
  }, t.clearConfig = function() {
    Ae = null, ee = !1;
  }, t.isValidAttribute = function(q, w, A) {
    Ae || pt({});
    const U = ue(q), M = ue(w);
    return pn(U, M, A);
  }, t.addHook = function(q, w) {
    typeof w == "function" && Ln(P[q], w);
...
var V0 = sc(), ym = /* @__PURE__ */ S.createContext({});
const so = ym;
function di() {
...
function bm(e) {
  var t, n, r, o, i = e.className, s = e.x, a = e.y, l = e.dx, c = e.dy, d = e.type, u = d === void 0 ? "elbow" : d, f = e.stroke, p = f === void 0 ? "#222" : f, h = e.pathProps, g = S.useContext(so), m = s ?? ((t = g.x) != null ? t : 0), _ = a ?? ((n = g.y) != null ? n : 0), O = l ?? ((r = g.dx) != null ? r : 0), y = c ?? ((o = g.dy) != null ? o : 0), v = m, D = _, x = m + O, C = _ + y;
  if (u === "elbow")
    if (Math.abs(O) <= Math.abs(y)) {
      v = x;
      var N = y > 0 ? 1 : -1;
      D = _ + N * Math.abs(v - m);
    } else {
...
function Em(e) {
  var t = e.anchorLineStroke, n = t === void 0 ? "#222" : t, r = e.children, o = e.className, i = e.containerStyle, s = e.horizontalAnchor, a = e.resizeObserverPolyfill, l = e.showAnchorLine, c = l === void 0 ? !0 : l, d = e.verticalAnchor, u = e.x, f = e.y, p = bd({
    polyfill: a
  }), h = p[0], g = p[1], m = g.width, _ = g.height, O = S.useContext(so), y = O.x, v = y === void 0 ? 0 : y, D = O.y, x = D === void 0 ? 0 : D, C = O.dx, N = C === void 0 ? 0 : C, G = O.dy, T = G === void 0 ? 0 : G, P = s || (Math.abs(N) < Math.abs(T) ? "middle" : N > 0 ? "start" : "end"), k = d || (Math.abs(N) > Math.abs(T) ? "middle" : T > 0 ? "start" : "end"), V = S.useMemo(function() {
    var Z = u ?? v + N, Q = f ?? x + T;
    return P === "middle" && (Z -= m / 2), P === "end" && (Z -= m), k === "middle" && (Q -= _ / 2), k === "end" && (Q -= _), {
      x: Z,
      y: Q
    };
  }, [u, v, N, f, x, T, P, k, m, _]);
...
function Dm(e) {
  var t = e.className, n = e.x, r = e.y, o = e.stroke, i = o === void 0 ? "#222" : o, s = e.radius, a = s === void 0 ? 16 : s, l = _m(e, wm), c = S.useContext(so);
...
function lc(e) {
  var t = e.x, n = e.y, r = e.dx, o = e.dy, i = e.children, s = S.useMemo(function() {
    return {
      x: t,
      y: n,
      dx: r,
...
var oa = Bm, Ht = S, gn = Sm, ia = Om, km = Hi(Fi), sa = Hi(Gi), jm = Hi(Wi);
function Hi(e) {
  return e && e.__esModule ? e : { default: e };
}
function Nt() {
...
function Bm(e) {
  var t = e === void 0 ? {} : e, n = t.resetOnStart, r = n === void 0 ? !1 : n, o = t.snapToPointer, i = o === void 0 ? !0 : o, s = t.onDragEnd, a = t.onDragMove, l = t.onDragStart, c = t.x, d = t.y, u = t.dx, f = t.dy, p = t.isDragging, h = t.restrict, g = h === void 0 ? {} : h, m = t.restrictToPath, _ = (0, Ht.useRef)({
    x: c,
    y: d,
    dx: u,
    dy: f
    ...
    dy: f ?? 0,
    isDragging: !1
  }), y = O[0], v = O[1], D = (0, Ht.useState)(new gn.Point({
    x: 0,
    y: 0
  })), x = D[0], C = D[1];
  (0, Ht.useEffect)(function() {
    ...
    p !== void 0 && y.isDragging !== p && v(function(k) {
      return Nt({}, k, {
        isDragging: p
      });
    });
  }, [y.isDragging, p, v]);
  var N = (0, jm.default)(m), G = (0, Ht.useCallback)(function(k) {
    k.persist(), v(function(V) {
      var Z = V.x, Q = Z === void 0 ? 0 : Z, $ = V.y, W = $ === void 0 ? 0 : $, J = V.dx, z = V.dy, H = new gn.Point({
        x: (Q || 0) + J,
        y: (W || 0) + z
      }), K = (0, ia.localPoint)(k) || new gn.Point({
        x: 0,
        y: 0
      }), Se = i ? K : H, oe = (0, sa.default)(Se, N, g);
  ...
  }, [l, r, g, N, v, i]), T = (0, Ht.useCallback)(function(k) {
    k.persist(), v(function(V) {
      if (!V.isDragging)
        return V;
      var Z = V.x, Q = Z === void 0 ? 0 : Z, $ = V.y, W = $ === void 0 ? 0 : $, J = (0, ia.localPoint)(k) || new gn.Point({
        x: 0,
        y: 0
      }), z = i ? J : (0, gn.sumPoints)(J, x), H = (0, sa.default)(z, N, g);
      return Nt({}, V, {
        dx: H.x - Q,
        dy: H.y - W
      });
  ...
  }, [v, a, i, x, N, g]), P = (0, Ht.useCallback)(function(k) {
    k.persist(), v(function(V) {
      return Nt({}, V, {
        isDragging: !1
      });
...
function Vm(e) {
  var t = e.canEditLabel, n = t === void 0 ? !0 : t, r = e.canEditSubject, o = r === void 0 ? !0 : r, i = e.children, s = e.dx, a = s === void 0 ? 0 : s, l = e.dy, c = l === void 0 ? 0 : l, d = e.height, u = e.labelDragHandleProps, f = e.onDragEnd, p = e.onDragMove, h = e.onDragStart, g = e.subjectDragHandleProps, m = e.width, _ = e.x, O = _ === void 0 ? 0 : _, y = e.y, v = y === void 0 ? 0 : y, D = S.useRef(), x = S.useRef(), C = S.useCallback(function(k) {
    var V = k.event;
    if (h) {
      var Z, Q, $, W, J, z, H, K;
      h({
        event: V,
        x: O + ((Z = (Q = D.current) == null ? void 0 : Q.dx) != null ? Z : 0),
        y: v + (($ = (W = D.current) == null ? void 0 : W.dy) != null ? $ : 0),
        dx: a + ((J = (z = x.current) == null ? void 0 : z.dx) != null ? J : 0),
        dy: c + ((H = (K = x.current) == null ? void 0 : K.dy) != null ? H : 0)
      });
    }
  }, [a, c, h, O, v]), N = S.useCallback(function(k) {
    var V = k.event;
    if (p) {
      var Z, Q, $, W, J, z, H, K;
      p({
  ...
  }, [a, c, p, O, v]), G = S.useCallback(function(k) {
    var V = k.event;
    if (f) {
      var Z, Q, $, W, J, z, H, K;
      f({
  ...
  return D.current = T, x.current = P, /* @__PURE__ */ R.createElement(R.Fragment, null, /* @__PURE__ */ R.createElement(lc, {
    x: O + T.dx,
    y: v + T.dy,
    dx: a + P.dx,
    dy: c + P.dy
  ...
  }, aa, g)), P.isDragging && /* @__PURE__ */ R.createElement("rect", {
    width: m,
    height: d,
...
const Um = 0.02, Wm = 20, Hm = 8, qm = (e, t, n) => {
  ...
  let [h] = r;
  const g = h <= Xm, m = Number(h) - o - it * 2 - Ym * 2, _ = `${i}-${Date.now()}`, { legendSeparators: O, separatorSize: y, legendSeparatorsToSubtract: v, getTickSeparatorsAdjustment: D } = qm(f, m, p), x = t == null ? void 0 : t.length, C = (e || []).reduce(($, W) => $.length > String(W).length ? $ : W, ""), N = 20;
  let G = 50;
  const T = Bh(C, "normal 14px sans-serif"), P = Number(l) || 0, k = P * (Math.PI / 180), V = G + Number(T) * Math.sin(k), Z = t.map(($, W) => {
    const J = W / (t.length - 1) * 100;
    return /* @__PURE__ */ b("stop", { offset: `${J}%`, style: { stopColor: $, stopOpacity: 1 } }, W);
  }), Q = e.map(($, W) => {
    const J = (m - v) / x, z = W * J + J + it + D(W), H = P ? "end" : "middle", K = P ? "middle" : "start", Se = W === e.length - 1;
    return /* @__PURE__ */ B(Kn, { top: it, children: [
      !Se && !p && /* @__PURE__ */ b("line", { x1: z, x2: z, y1: 30, y2: N, stroke: "black" }),
      /* @__PURE__ */ b(
        Xu,
        {
          angle: -l,
  ...
  if (!(a === "map" && c === "side" || !c) && !(a === "chart" && (c === "left" || c === "right" || !c)) && d === "gradient")
    return /* @__PURE__ */ B("svg", { className: "w-100 overflow-visible", height: V, children: [
      /* @__PURE__ */ b("rect", { x: 0, y: 0, width: m + it * 2, height: N + it * 2, fill: Km }),
      /* @__PURE__ */ b("linearGradient", { id: `gradient-smooth-${_}`, x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: Z }),
      u === "smooth" && /* @__PURE__ */ b(
        "rect",
        {
          x: it,
      ...
      u === "linear blocks" && /* @__PURE__ */ B(mt, { children: [
        t.map(($, W) => {
          const J = (m - v) / x, z = W * J + it + D(W);
          return /* @__PURE__ */ b(Kn, { children: /* @__PURE__ */ b(
            "rect",
            {
              x: z,
              y: it,
        ...
        O.map(($, W) => {
          const J = (m - v) / x, z = $ * J + it + D($ - 1);
          return /* @__PURE__ */ B(Kn, { children: [
            /* @__PURE__ */ b(
              "rect",
              {
                x: z,
...
function pc(e, t, n) {
  ...
  function u(g) {
    if (typeof g != "function")
      throw new Error(process.env.NODE_ENV === "production" ? st(4) : "Expected the listener to be a function. Instead, received: '" + Jt(g) + "'");
    if (l)
  ...
  function f(g) {
    if (!ag(g))
      throw new Error(process.env.NODE_ENV === "production" ? st(7) : "Actions must be plain objects. Instead, the actual type was: '" + Jt(g) + "'. You may need to add middleware to your store setup to handle dispatching other values, such as 'redux-thunk' to handle dispatching functions. See https://redux.js.org/tutorials/fundamentals/part-4-store#middleware and https://redux.js.org/tutorials/fundamentals/part-6-async-logic#using-the-redux-thunk-middleware for examples.");
    if (typeof g.type > "u")
    ...
    for (var m = s = a, _ = 0; _ < m.length; _++) {
      var O = m[_];
      O();
    }
    return g;
  ...
  function p(g) {
    if (typeof g != "function")
      throw new Error(process.env.NODE_ENV === "production" ? st(10) : "Expected the nextReducer to be a function. Instead, received: '" + Jt(g));
    o = g, f({
      type: pa.REPLACE
    });
  }
    ...
    return g = {
      ...
      subscribe: function(O) {
        if (typeof O != "object" || O === null)
          throw new Error(process.env.NODE_ENV === "production" ? st(11) : "Expected the observer to be an object. Instead, received: '" + Jt(O) + "'");
        function y() {
          O.next && O.next(d());
        }
        y();
...
function pg() {
  ...
  function a(u, f) {
    var p = f(), h = r({ inst: { value: p, getSnapshot: f } }), g = h[0].inst, m = h[1];
    return i(
      function() {
        g.value = p, g.getSnapshot = f, l(g) && m({ inst: g });
      },
      [u, p, f]
    ), o(
      function() {
        return l(g) && m({ inst: g }), u(function() {
          l(g) && m({ inst: g });
        });
      },
      [u]
...
function hg() {
  return va || (va = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function t(p, h) {
      ...
      var _ = m[0].inst, O = m[1];
      return l(
        function() {
          _.value = g, _.getSnapshot = h, n(_) && O({ inst: _ });
        },
        [p, g, h]
      ), a(
        function() {
          return n(_) && O({ inst: _ }), p(function() {
            n(_) && O({ inst: _ });
          });
        },
        [p]
    ...
    var o = S, i = typeof Object.is == "function" ? Object.is : e, s = o.useState, a = o.useEffect, l = o.useLayoutEffect, c = o.useDebugValue, d = !1, u = !1, f = typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u" ? r : t;
  ...
  return To.useSyncExternalStoreWithSelector = function(c, d, u, f, p) {
    ...
    h = a(
      function() {
        function _(x) {
          if (!O) {
            if (O = !0, y = x, x = f(x), p !== void 0 && g.hasValue) {
              var C = g.value;
              if (p(C, x))
                return v = C;
            }
          ...
          if (C = v, r(y, x))
            return C;
          var N = f(x);
          return p !== void 0 && p(C, N) ? (y = x, C) : (y = x, v = N);
        }
        var O = !1, y, v, D = u === void 0 ? null : u;
        return [
          function() {
            return _(d());
          },
...
function gg() {
  return ba || (ba = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
    var t = S, n = qi, r = typeof Object.is == "function" ? Object.is : e, o = n.useSyncExternalStore, i = t.useRef, s = t.useEffect, a = t.useMemo, l = t.useDebugValue;
...
function _g() {
  if (_a)
    return me;
  _a = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, i = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, a = e ? Symbol.for("react.context") : 60110, l = e ? Symbol.for("react.async_mode") : 60111, c = e ? Symbol.for("react.concurrent_mode") : 60111, d = e ? Symbol.for("react.forward_ref") : 60112, u = e ? Symbol.for("react.suspense") : 60113, f = e ? Symbol.for("react.suspense_list") : 60120, p = e ? Symbol.for("react.memo") : 60115, h = e ? Symbol.for("react.lazy") : 60116, g = e ? Symbol.for("react.block") : 60121, m = e ? Symbol.for("react.fundamental") : 60117, _ = e ? Symbol.for("react.responder") : 60118, O = e ? Symbol.for("react.scope") : 60119;
  function y(D) {
  ...
  return me.AsyncMode = l, me.ConcurrentMode = c, me.ContextConsumer = a, me.ContextProvider = s, me.Element = t, me.ForwardRef = d, me.Fragment = r, me.Lazy = h, me.Memo = p, me.Portal = n, me.Profiler = i, me.StrictMode = o, me.Suspense = u, me.isAsyncMode = function(D) {
    return v(D) || y(D) === l;
  }, me.isConcurrentMode = v, me.isContextConsumer = function(D) {
    return y(D) === a;
    ...
    return typeof D == "string" || typeof D == "function" || D === r || D === c || D === i || D === o || D === u || D === f || typeof D == "object" && D !== null && (D.$$typeof === h || D.$$typeof === p || D.$$typeof === s || D.$$typeof === a || D.$$typeof === d || D.$$typeof === m || D.$$typeof === _ || D.$$typeof === O || D.$$typeof === g);
  }, me.typeOf = y, me;
}
var ge = {};
/** @license React v16.13.1
...
function Dg() {
  return Da || (Da = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(I) {
      ...
      I === r || I === c || I === i || I === o || I === u || I === f || typeof I == "object" && I !== null && (I.$$typeof === h || I.$$typeof === p || I.$$typeof === s || I.$$typeof === a || I.$$typeof === d || I.$$typeof === m || I.$$typeof === _ || I.$$typeof === O || I.$$typeof === g);
    }
    function v(I) {
    ...
    var D = l, x = c, C = a, N = s, G = t, T = d, P = r, k = h, V = p, Z = n, Q = i, $ = o, W = u, J = !1;
    function z(I) {
      return J || (J = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), H(I) || v(I) === l;
    }
    function H(I) {
      return v(I) === c;
    }
    ...
    ge.AsyncMode = D, ge.ConcurrentMode = x, ge.ContextConsumer = C, ge.ContextProvider = N, ge.Element = G, ge.ForwardRef = T, ge.Fragment = P, ge.Lazy = k, ge.Memo = V, ge.Portal = Z, ge.Profiler = Q, ge.StrictMode = $, ge.Suspense = W, ge.isAsyncMode = z, ge.isConcurrentMode = H, ge.isContextConsumer = K, ge.isContextProvider = Se, ge.isElement = oe, ge.isForwardRef = Ie, ge.isFragment = re, ge.isLazy = we, ge.isMemo = Le, ge.isPortal = Ye, ge.isProfiler = Ne, ge.isStrictMode = Ue, ge.isSuspense = Ce, ge.isValidElementType = y, ge.typeOf = v;
  }()), ge;
}
...
function Rg() {
  ...
  return ve.ContextConsumer = s, ve.ContextProvider = i, ve.Element = e, ve.ForwardRef = l, ve.Fragment = n, ve.Lazy = f, ve.Memo = u, ve.Portal = t, ve.Profiler = o, ve.StrictMode = r, ve.Suspense = c, ve.SuspenseList = d, ve.isAsyncMode = function() {
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === o || m === r || m === c || m === d || m === p || typeof m == "object" && m !== null && (m.$$typeof === f || m.$$typeof === u || m.$$typeof === i || m.$$typeof === s || m.$$typeof === l || m.$$typeof === h || m.getModuleId !== void 0);
  }, ve.typeOf = g, ve;
}
var ye = {};
/**
...
function Mg() {
  return Aa || (Aa = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), a = Symbol.for("react.server_context"), l = Symbol.for("react.forward_ref"), c = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), u = Symbol.for("react.memo"), f = Symbol.for("react.lazy"), p = Symbol.for("react.offscreen"), h = !1, g = !1, m = !1, _ = !1, O = !1, y;
    y = Symbol.for("react.module.reference");
    function v(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || O || j === r || j === c || j === d || _ || j === p || h || g || m || typeof j == "object" && j !== null && (j.$$typeof === f || j.$$typeof === u || j.$$typeof === i || j.$$typeof === s || j.$$typeof === l || // This needs to include all possible module reference object
    ...
    var x = s, C = i, N = e, G = l, T = n, P = f, k = u, V = t, Z = o, Q = r, $ = c, W = d, J = !1, z = !1;
    function H(j) {
...
function jg(e, t, n, r, {
  ...
  let a = !1, l, c, d, u, f;
  function p(O, y) {
    return l = O, c = y, d = e(l, c), u = t(r, c), f = n(d, u, c), a = !0, f;
  }
  function h() {
  ...
  function m() {
    const O = e(l, c), y = !s(O, d);
    return d = O, y && (f = n(d, u, c)), f;
  }
  function _(O, y) {
    const v = !i(y, c), D = !o(O, l, y, c);
    return l = O, c = y, v && D ? h() : v ? g() : D ? m() : f;
  }
  return function(y, v) {
    return a ? _(y, v) : p(y, v);
  };
}
function Bg(e, t) {
  let {
...
const qg = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", Yr = qg ? S.useLayoutEffect : S.useEffect;
function Ra(e, t) {
...
function ev(e, t, n, r, o, i, s, a, l, c, d) {
  ...
  const p = () => {
    ...
    _ || (f = null), m === i.current ? s.current || c() : (i.current = m, l.current = m, s.current = !0, d());
  };
...
function Sc(e, t, n, {
  ...
  return (m) => {
    if (process.env.NODE_ENV !== "production" && !Ta.isValidElementType(m))
      throw new Error(`You must pass a component to the function returned by connect. Instead received ${Zg(m)}`);
    const _ = m.displayName || m.name || "Component", O = `Connect(${_})`, y = {
    ...
    function v(C) {
      const [N, G, T] = S.useMemo(() => {
        const {
          reactReduxForwardedRef: I
        } = C, pe = vc(C, Yg);
        return [C.context, I, pe];
      }, [C]), P = S.useMemo(() => N && N.Consumer && // @ts-ignore
      Ta.isContextConsumer(/* @__PURE__ */ S.createElement(N.Consumer, null)) ? N : d, [N, d]), k = S.useContext(P), V = !!C.store && !!C.store.getState && !!C.store.dispatch, Z = !!k && !!k.store;
      ...
      const Q = V ? C.store : k.store, $ = Z ? k.getServerState : Q.getState, W = S.useMemo(() => Bg(Q.dispatch, y), [Q]), [J, z] = S.useMemo(() => {
        if (!h)
          return Xg;
        const I = _c(Q, V ? void 0 : k.subscription), pe = I.notifyNestedSubs.bind(I);
        return [I, pe];
      }, [Q, V, k]), H = S.useMemo(() => V ? k : En({}, k, {
        subscription: J
      }), [V, k, J]), K = S.useRef(), Se = S.useRef(T), oe = S.useRef(), Ie = S.useRef(!1);
      S.useRef(!1);
      const re = S.useRef(!1), we = S.useRef();
      Yr(() => (re.current = !0, () => {
        re.current = !1;
      }), []);
      const Le = S.useMemo(() => () => oe.current && T === Se.current ? oe.current : W(Q.getState(), T), [Q, T]), Ye = S.useMemo(() => (pe) => J ? ev(
        h,
        Q,
        J,
        // @ts-ignore
...
`), I;
      ...
      const Ue = S.useMemo(() => (
        // @ts-ignore
        /* @__PURE__ */ S.createElement(m, En({}, Ne, {
          ref: G
        }))
      ), [G, m, Ne]);
      return S.useMemo(() => h ? /* @__PURE__ */ S.createElement(P.Provider, {
        value: H
      }, Ue) : Ue, [P, Ue, H]);
    }
    const x = S.memo(v);
    if (x.WrappedComponent = m, x.displayName = v.displayName = O, l) {
      const N = S.forwardRef(function(T, P) {
        return /* @__PURE__ */ S.createElement(x, En({}, T, {
          reactReduxForwardedRef: P
        }));
      });
      return N.displayName = O, N.WrappedComponent = m, Na(N, m);
    }
    return Na(x, m);
  };
}
function nv({
  ...
  }, [e, r, o, i]), a = S.useMemo(() => e.getState(), [e]);
  Yr(() => {
    const {
      subscription: c
    } = s;
...
function Oc(e, t) {
  ...
  })[0], r = S.useRef(!0), o = S.useRef(n), i = r.current || !!(t && o.current.inputs && rv(t, o.current.inputs)), s = i ? o.current : {
    inputs: t,
    result: e()
  };
...
var co = Be((e, t) => t.filter((n) => n.descriptor.id !== e.descriptor.id)), Tv = ({
  ...
  d === -1 && (process.env.NODE_ENV !== "production" ? E(!1, "Could not find displaced item in set") : E(!1));
  const u = d - 1;
  if (u < 0)
    return null;
  const f = c[u];
...
var zv = ({
  ...
  const c = s.at;
  if (c || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot move in direction without previous impact location") : E(!1)), c.type === "REORDER") {
    const u = Uv({
      isMovingForward: e,
      isInHomeList: t,
...
const iy = (e, t, n) => {
  ...
  const r = e.frame;
  Pn(t, e) && (process.env.NODE_ENV !== "production" ? E(!1, "Should not add placeholder space to home list") : E(!1)), e.subject.withPlaceholder && (process.env.NODE_ENV !== "production" ? E(!1, "Cannot add placeholder size to a subject when it already has one") : E(!1));
...
var gy = ({
  ...
  const a = n.axis, l = gr(n.axis, t.displaceBy), c = l.value, d = e[a.start], u = e[a.end], p = co(t, r).find((g) => {
    const m = g.descriptor.id, _ = g.page.borderBox.center[a.line], O = Gt(m, s), y = Wc({
      displaced: o,
      id: m
    });
    return O ? y ? u <= _ : d < _ - c : y ? u <= _ + c : d < _;
  }) || null, h = my({
    draggable: t,
    closest: p,
    inHomeList: Pn(t, n)
...
var yy = ({
  ...
  const s = r.axis, a = gr(r.axis, e.displaceBy), l = a.value, c = t[s.start], d = t[s.end], f = co(e, o).find((h) => {
    const g = h.descriptor.id, m = h.page.borderBox, O = m[s.size] / vy, y = Gt(g, i), v = Wc({
      displaced: n.displaced,
      id: g
    });
    return y ? v ? d > m[s.start] + O && d < m[s.end] - O : c > m[s.start] - l + O && c < m[s.end] - l - O : v ? d > m[s.start] + l + O && d < m[s.end] + l - O : c > m[s.start] + O && c < m[s.end] - O;
  });
  return f ? {
    displacedBy: a,
    displaced: n.displaced,
...
var qc = ({
  ...
  c || (process.env.NODE_ENV !== "production" ? E(!1, "Must be over a destination in SNAP movement mode") : E(!1));
  const d = a[c], u = qc({
    impact: r,
    viewport: o,
    destination: d,
...
var Sy = ({
  ...
  const n = t.modified.map((_) => {
    const O = e.dimensions.droppables[_.droppableId];
    return es(O, _.scroll);
  }), r = {
...
var Cy = (e = qa, t) => {
  ...
  if (t.type === "INITIAL_PUBLISH") {
    ...
    }, u = ao(i.droppables).every((g) => !g.isFixedOnPage), {
      impact: f,
      afterCritical: p
    } = Xc({
      draggable: a,
  ...
  if (t.type === "PUBLISH_WHILE_DRAGGING")
    return e.phase === "COLLECTING" || e.phase === "DROP_PENDING" || (process.env.NODE_ENV !== "production" ? E(!1, `Unexpected ${t.type} received in phase ${e.phase}`) : E(!1)), Ny({
      state: e,
      published: t.payload
    });
  if (t.type === "MOVE") {
    if (e.phase === "DROP_PENDING")
      return e;
    Qt(e) || (process.env.NODE_ENV !== "production" ? E(!1, `${t.type} not permitted in phase ${e.phase}`) : E(!1));
    const {
      client: n
    } = t.payload;
  ...
  if (t.type === "UPDATE_DROPPABLE_IS_ENABLED") {
    if (e.phase === "DROP_PENDING")
      return e;
    Qt(e) || (process.env.NODE_ENV !== "production" ? E(!1, `Attempting to move in an unsupported phase ${e.phase}`) : E(!1));
    const {
      id: n,
      isEnabled: r
    } = t.payload, o = e.dimensions.droppables[n];
  ...
  if (t.type === "MOVE_BY_WINDOW_SCROLL") {
    if (e.phase === "DROP_PENDING" || e.phase === "DROP_ANIMATING")
      return e;
    Qt(e) || (process.env.NODE_ENV !== "production" ? E(!1, `Cannot move by window in phase ${e.phase}`) : E(!1)), e.isWindowScrollAllowed || (process.env.NODE_ENV !== "production" ? E(!1, "Window scrolling is currently not supported for fixed lists") : E(!1));
...
var qy = (e) => ({
  ...
  })), t().phase !== "IDLE" && (process.env.NODE_ENV !== "production" ? E(!1, "Unexpected phase to start a drag") : E(!1)), n(as()), n(Ay({
    draggableId: i,
    movementMode: a
  }));
  const d = {
...
const eb = ({
  ...
  if (!(!Ft(o.current.client.offset, m) || !!g.combine)) {
    t(ls({
      completed: _
    }));
    return;
...
function rb({
  ...
  function s() {
    i() && (process.env.NODE_ENV !== "production" ? E(!1, "Cannot start scroll listener when already active") : E(!1)), o = gt(window, [r]);
  }
  function a() {
    i() || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot stop scroll listener when not active") : E(!1)), n.cancel(), o(), o = $t;
  }
  return {
    start: s,
    stop: a,
...
var fb = (e, t) => {
  ...
  const o = (u, f) => {
    ...
    const g = !db(u, r.lastCritical);
    g && (r.lastCritical = u);
    const m = !cb(r.lastLocation, p);
    m && (r.lastLocation = p);
    const _ = !ub(r.lastCombine, h);
    if (_ && (r.lastCombine = h), !g && !m && !_)
      return;
    const O = {
      ...Ir(u, r.mode),
      combine: h,
    ...
    n.add(() => {
      $n("onDragUpdate", () => jo(e().onDragUpdate, O, t, Vr.onDragUpdate));
    });
  }, l = () => {
    r || (process.env.NODE_ENV !== "production" ? E(!1, "Can only flush responders while dragging") : E(!1)), n.flush();
  }, c = (u) => {
    r || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot fire onDragEnd when there is no matching onDragStart") : E(!1)), r = null, $n("onDragEnd", () => jo(e().onDragEnd, u, t, Vr.onDragEnd));
  };
  return {
    beforeCapture: o,
    beforeStart: i,
...
const hb = (e) => (t) => (n) => {
  ...
  const r = e.getState();
  r.phase !== "DROP_ANIMATING" && (process.env.NODE_ENV !== "production" ? E(!1, "Cannot finish a drop animating when no drop is occurring") : E(!1)), e.dispatch(ls({
  ...
  const o = () => {
    r || (t.collectionStarting(), r = requestAnimationFrame(() => {
      ...
      const {
        ...
        removals: c,
        modified: d
      } = n, u = Object.keys(l).map((h) => e.draggable.getById(h).getDimension(Ve)).sort((h, g) => h.descriptor.index - g.descriptor.index), f = Object.keys(d).map((h) => {
...
var Ab = (e, t) => {
  ...
  const r = xb({
    ...
    e.droppable.exists(f) || (process.env.NODE_ENV !== "production" ? E(!1, `Cannot update is enabled flag of Droppable ${f} as it is not registered`) : E(!1)), n && t.updateDroppableIsEnabled({
      id: f,
      isEnabled: p
    });
  }, i = (f, p) => {
    n && (e.droppable.exists(f) || (process.env.NODE_ENV !== "production" ? E(!1, `Cannot update isCombineEnabled flag of Droppable ${f} as it is not registered`) : E(!1)), t.updateDroppableIsCombineEnabled({
      id: f,
      isCombineEnabled: p
    }));
  }, s = (f, p) => {
    n && (e.droppable.exists(f) || (process.env.NODE_ENV !== "production" ? E(!1, `Cannot update the scroll on Droppable ${f} as it is not registered`) : E(!1)), t.updateDroppableScroll({
      id: f,
      newScroll: p
    }));
  }, a = (f, p) => {
  ...
  return {
    ...
    startPublishing: (f) => {
      ...
      const p = e.draggable.getById(f.draggableId), h = e.droppable.getById(p.descriptor.droppableId), g = {
...
const Pb = Be((e) => ao(e).filter((t) => !(!t.isEnabled || !t.frame))), Ib = (e, t) => Pb(t).find((r) => (r.frame || (process.env.NODE_ENV !== "production" ? E(!1, "Invalid result") : E(!1)), zc(r.frame.pageMarginBox)(e))) || null;
var Rb = ({
  center: e,
  destination: t,
  droppables: n
...
var Gb = ({
  ...
  return {
    start: (c) => {
      vr(), i && (process.env.NODE_ENV !== "production" ? E(!1, "Cannot start auto scrolling when already started") : E(!1));
      const d = Date.now();
      let u = !1;
      const f = () => {
        u = !0;
  ...
  return (a) => {
    ...
    if (!l)
      return;
    const c = ct(a.impact);
    c || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot perform a jump scroll when there is no destination") : E(!1));
...
const Zb = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u" ? S.useLayoutEffect : S.useEffect;
var ut = Zb;
const Vo = () => {
...
function Jb(e, t) {
  const n = ce(() => Xb(e), [e]), r = S.useRef(null), o = S.useRef(null), i = Y(Be((u) => {
    const f = o.current;
    f || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot set dynamic style element if it is not set") : E(!1)), f.textContent = u;
  }), []), s = Y((u) => {
    const f = r.current;
    f || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot set dynamic style element if it is not set") : E(!1)), f.textContent = u;
  }, []);
  ut(() => {
    ...
    return r.current = u, o.current = f, u.setAttribute(`${Sn}-always`, e), f.setAttribute(`${Sn}-dynamic`, e), Vo().appendChild(u), Vo().appendChild(f), s(n.always), i(n.resting), () => {
      const p = (h) => {
        const g = h.current;
        g || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot unmount ref as it is not set") : E(!1)), Vo().removeChild(g), h.current = null;
      };
      p(r), p(o);
    };
...
function Qb(e) {
  const t = S.useRef({}), n = S.useRef(null), r = S.useRef(null), o = S.useRef(!1), i = Y(function(f, p) {
    const h = {
      id: f,
      focus: p
    };
...
function eE() {
  ...
  function i(u) {
    const f = o(u);
    return f || (process.env.NODE_ENV !== "production" ? E(!1, `Cannot find draggable entry with id [${u}]`) : E(!1)), f;
  }
  const s = {
    register: (u) => {
  ...
  function l(u) {
    const f = a(u);
    return f || (process.env.NODE_ENV !== "production" ? E(!1, `Cannot find droppable entry with id [${u}]`) : E(!1)), f;
  }
  const c = {
    register: (u) => {
...
function iE(e) {
  const t = ce(() => oE(e), [e]), n = S.useRef(null);
  return S.useEffect(function() {
...
function PE({
  ...
  return [{
    ...
    fn: (o) => {
      ...
      c.type !== "PENDING" && (process.env.NODE_ENV !== "production" ? E(!1, "Cannot be IDLE") : E(!1));
      const d = c.point;
      if (!TE(d, l))
        return;
      o.preventDefault();
...
function IE(e) {
  const t = S.useRef(ol), n = S.useRef($t), r = ce(() => ({
    eventName: "mousedown",
    fn: function(u) {
...
function kE(e) {
  const t = S.useRef(RE), n = ce(() => ({
    ...
    fn: function(i) {
      ...
      t.current();
      function d() {
        l || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot stop capturing a keyboard drag when not capturing") : E(!1)), l = !1, t.current(), r();
      }
...
function FE(e) {
  const t = S.useRef(Fo), n = S.useRef($t), r = Y(function() {
    return t.current;
  }, []), o = Y(function(p) {
    t.current = p;
  }, []), i = ce(() => ({
    ...
    const p = {
      ...
      completed: a,
      getPhase: r
    }, g = gt(window, $E(h), p), m = gt(window, VE(h), p);
    n.current = function() {
      g(), m();
    };
  }, [l, r, a]), d = Y(function() {
...
function ew({
  ...
  const g = h.bind(null, "DRAGGING");
  function m(D) {
    function x() {
      e.release(), u = "COMPLETED";
    }
    u !== "PRE_DRAG" && (x(), process.env.NODE_ENV !== "production" ? E(!1, `Cannot lift in phase ${u}`) : E(!1)), n.dispatch(Ty(D.liftActionArgs)), u = "DRAGGING";
    function C(N, G = {
      shouldBlockNextClick: !1
    }) {
      if (D.cleanup(), G.shouldBlockNextClick) {
        const T = gt(window, [{
          eventName: "click",
          fn: QE,
          options: {
...
function nw({
  ...
  const i = [...o ? tw : [], ...r || []], s = S.useState(() => vE())[0], a = Y(function(m, _) {
    fr(m) && !fr(_) && s.tryAbandon();
  }, [s]);
  ut(function() {
    let m = t.getState();
    return t.subscribe(() => {
  ...
  }), [e, s, n, t]), d = Y((g) => ZE(e, g), [e]), u = Y((g) => {
    const m = n.draggable.findById(g);
...
function iw(e) {
  ...
  }, p), [p]), g = tE(), m = ce(() => Ab(g, h), [g, h]), _ = ce(() => Hb({
    scrollWindow: Tb,
  ...
  }), [m.scrollDroppable, p, c]), O = Qb(t), y = ce(() => Ob({
    announce: d,
    autoScroller: _,
    dimensionMarshal: m,
    focusMarshal: O,
  ...
  process.env.NODE_ENV !== "production" && s.current && s.current !== y && process.env.NODE_ENV !== "production" && De("unexpected store change"), s.current = y;
  const v = Y(() => {
    const T = Gn(s);
  ...
  }), S.useEffect(() => v, [v]), R.createElement(fo.Provider, {
    value: G
  }, R.createElement(nv, {
    context: hs,
    store: y
...
function yw(e) {
  const t = ms("draggable"), {
    ...
    const h = o();
    return h || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot get dimension when no ref is set") : E(!1)), vw(n, h, p);
  }, [n, o]), d = ce(() => ({
    uniqueId: t,
    descriptor: n,
    options: l,
    getDimension: c
  }), [n, c, l, t]), u = S.useRef(d), f = S.useRef(!0);
...
function Eu(e) {
  e && br(e) || (process.env.NODE_ENV !== "production" ? E(!1, `
...
function bw(e, t, n) {
  Er(() => {
    ...
    o || (process.env.NODE_ENV !== "production" ? E(!1, "Draggable requires a draggableId") : E(!1)), typeof o != "string" && (process.env.NODE_ENV !== "production" ? E(!1, `Draggable requires a [string] draggableId.
      Provided: [type: ${typeof o}] (value: ${o})`) : E(!1)), Number.isInteger(e.index) || (process.env.NODE_ENV !== "production" ? E(!1, `${r(o)} requires an integer index prop`) : E(!1)), e.mapped.type !== "DRAGGING" && (Eu(n()), e.isEnabled && (fu(t, o) || (process.env.NODE_ENV !== "production" ? E(!1, `${r(o)} Unable to find drag handle`) : E(!1))));
  });
}
function Ew(e) {
  gs(() => {
...
const _w = (e) => {
  const t = S.useRef(null), n = Y((x = null) => {
    t.current = x;
  }, []), r = Y(() => t.current, []), {
    contextId: o,
  ...
  const O = ce(() => f ? {
    ...
    m.type === "DRAGGING" && m.dropping && x.propertyName === "transform" && (R.version.startsWith("16") || R.version.startsWith("17") ? _() : Ri.flushSync(_));
  }, [_, m]), v = ce(() => {
    const x = gw(m), C = m.type === "DRAGGING" && m.dropping ? y : void 0;
    return {
      innerRef: n,
      draggableProps: {
  ...
  return R.createElement(R.Fragment, null, d(v, m.snapshot, D));
};
  ...
  const e = Be((s, a) => ({
    ...
    if (!d) {
      ...
      if (l.displaced.invisible[s])
        return null;
      const m = Tn(c.displacedBy.point), _ = e(m.x, m.y);
      return n(_, p, !0);
    }
    if (u)
      return r(p);
    const h = l.displacedBy.point, g = e(h.x, h.y);
...
const Es = (e) => (t) => e === t, Mw = Es("scroll"), Lw = Es("auto"), kw = Es("visible"), sl = (e, t) => t(e.overflowX) || t(e.overflowY), jw = (e, t) => t(e.overflowX) && t(e.overflowY), Ou = (e) => {
  ...
  if (t || (process.env.NODE_ENV, E(!1)), !Ou(e))
    return !1;
...
function Hw(e) {
  const t = S.useRef(null), n = Qr(fo), r = ms("droppable"), {
    registry: o,
    marshal: i
  } = n, s = vs(e), a = ce(() => ({
    id: e.droppableId,
    type: e.type,
    mode: e.mode
  }), [e.droppableId, e.mode, e.type]), l = S.useRef(a), c = ce(() => Be((v, D) => {
    ...
    const v = t.current;
    return !v || !v.env.closestScrollable ? Ve : xi(v.env.closestScrollable);
  }, []), u = Y(() => {
    const v = d();
    c(v.x, v.y);
  }, [d, c]), f = ce(() => or(u), [u]), p = Y(() => {
    const v = t.current, D = Mr(v);
    if (v && D || (process.env.NODE_ENV !== "production" ? E(!1, "Could not find scroll options while scrolling") : E(!1)), v.scrollOptions.shouldPublishImmediately) {
      u();
      return;
    }
    f();
    ...
    C || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot collect without a droppable ref") : E(!1));
    const N = $w(C), G = {
      ref: C,
      descriptor: a,
      env: N,
  ...
  }, [n.contextId, a, p, s]), g = Y(() => {
    const v = t.current, D = Mr(v);
    return v && D || (process.env.NODE_ENV !== "production" ? E(!1, "Can only recollect Droppable client for Droppables that have a scroll container") : E(!1)), xi(D);
  }, []), m = Y(() => {
    const v = t.current;
    v || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot stop drag when no active drag") : E(!1));
    const D = Mr(v);
    t.current = null, D && (f.cancel(), D.removeAttribute(el.contextId), D.removeEventListener("scroll", p, al(v.scrollOptions)));
  }, [p, f]), _ = Y((v) => {
    const D = t.current;
    D || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot scroll when there is no drag") : E(!1));
    const x = Mr(D);
    x || (process.env.NODE_ENV !== "production" ? E(!1, "Cannot scroll a droppable with no closest scrollable") : E(!1)), x.scrollTop += v.y, x.scrollLeft += v.x;
  }, []), O = ce(() => ({
  ...
  ut(() => (l.current = y.descriptor, o.droppable.register(y), () => {
    t.current && (process.env.NODE_ENV !== "production" && De("Unsupported: changing the droppableId or type of a Droppable during a drag"), m()), o.droppable.unregister(y);
  }), [O, a, m, y, i, o.droppable]), ut(() => {
...
const ll = {
  ...
  const t = S.useRef(null), n = Y(() => {
    ...
    onClose: i,
    contextId: s
  } = e, [a, l] = S.useState(e.animate === "open");
  S.useEffect(() => a ? r !== "open" ? (n(), l(!1), Go) : t.current ? Go : (t.current = setTimeout(() => {
    t.current = null, l(!1);
  }), n) : Go, [r, a, n]);
  const c = Y((u) => {
...
const Zw = [function({
  ...
  zo(t.isDropDisabled) || (process.env.NODE_ENV !== "production" ? E(!1, "isDropDisabled must be a boolean") : E(!1)), zo(t.isCombineEnabled) || (process.env.NODE_ENV !== "production" ? E(!1, "isCombineEnabled must be a boolean") : E(!1)), zo(t.ignoreContainerClipping) || (process.env.NODE_ENV !== "production" ? E(!1, "ignoreContainerClipping must be a boolean") : E(!1));
}, function({
  getDroppableRef: t
}) {
  Eu(t());
...
const n_ = (e) => {
  ...
  } = e, O = Y(() => o.current, []), y = Y((k = null) => {
    o.current = k;
  }, []), v = Y(() => i.current, []), D = Y((k = null) => {
    i.current = k;
  }, []);
  e_({
    props: e,
  ...
  const C = ce(() => R.createElement(t_, {
    ...
    contextId: n,
    onTransitionEnd: x
  })), [n, x, e.placeholder, e.shouldAnimatePlaceholder, D]), N = ce(() => ({
    innerRef: y,
    placeholder: C,
    droppableProps: {
  ...
  }), [n, a, C, y]), G = g ? g.dragging.draggableId : null, T = ce(() => ({
    droppableId: a,
    type: l,
    isUsingCloneFor: G
  }), [a, G, l]);
...
const cl = {
  ...
  return (i, s) => {
    ...
    if (i.phase === "IDLE" && i.completed && !i.shouldFlush) {
      ...
      if (!Wo(c, f.critical))
        return t;
      const p = ct(f.impact) === l, h = !!(f.impact.at && f.impact.at.type === "COMBINE"), g = f.critical.droppable.id === l;
      return p ? h ? e : t : g ? e : t;
    }
    return t;
  };
}, s_ = {
...
var l_ = a_;
const c_ = (e) => /* @__PURE__ */ S.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512", ...e }, /* @__PURE__ */ S.createElement("path", { d: "M0 117.66v346.32c0 11.32 11.43 19.06 21.94 14.86L160 416V32L20.12 87.95A32.006 32.006 0 000 117.66zM192 416l192 64V96L192 32v384zM554.06 33.16L416 96v384l139.88-55.95A31.996 31.996 0 00576 394.34V48.02c0-11.32-11.43-19.06-21.94-14.86z" })), tn = (e, t, n, r, o) => {
  if (!r)
...
Couldn't access "${n}" in ${JSON.stringify(e)}`);
  ...
  if (a && t.length === 2 && typeof t[1] == "number") {
    const g = f[u], m = t[1];
    return $r(g) ? f[u] = Cu(g, m) : tn(c, d, u, l, "Trying to remove an indexed item from an object that is not an array"), f;
  }
  const p = t.slice(1);
  if (u in e) {
    if (h = f[u], !$r(h) && !dl(h)) {
  ...
  var h;
  if (s) {
    const g = typeof p[0] == "number" ? [] : {};
    if (o)
      return f[u] = g, f[u] = Yn(f[u], p, n, r), f;
    if (i && Array.isArray(f)) {
      f.push(g);
      const m = f.length - 1;
      return f[m] = Yn(f[m], p, n, r), f;
    }
  }
  return tn(c, d, u, l), f;
}, d_ = (e, t, n, r) => {
  ...
  if (l !== void 0 || a !== void 0) {
    ...
    let p = 1 / 0;
    return p = typeof l == "number" ? l : typeof a == "number" ? a : f.findIndex(([h, g]) => h === (l ?? a)), a && p++, f.splice(p, 0, [t, n]), Object.fromEntries(f);
  }
  const u = t in e;
...
const Tu = ({ className: e, name: t, value: n, setValue: r, handleKeyPress: o, styles: i, textAreaRef: s }) => {
  ...
  const a = n.slice(-1) === `
` ? n + "." : n;
  return B("div", { style: { display: "grid" }, children: [b("textarea", { id: `${t}_textarea`, ref: s, style: Object.assign({ height: "auto", gridArea: "1 / 1 / 2 / 2", overflowY: "auto", whiteSpace: "pre-wrap" }, i), rows: 1, className: e, name: `${t}_textarea`, value: n, onChange: (l) => r(l.target.value), autoFocus: !0, onFocus: (l) => {
    n.length < 40 && l.target.select();
  }, onKeyDown: o }), b("span", { className: e, style: Object.assign({ visibility: "hidden", height: "auto", gridArea: "1 / 1 / 2 / 2", color: "red", opacity: 0.9, whiteSpace: "pre-wrap", overflowY: "auto", border: "1px solid transparent" }, i), children: a })] });
...
}, b_ = (e) => !("styles" in e), E_ = { container: "backgroundColor", collection: "backgroundColor", collectionInner: "backgroundColor", collectionElement: "backgroundColor", dropZone: "borderColor", inputHighlight: "backgroundColor" }, ku = S.createContext(null), w_ = ({ children: e, onEditEvent: t, onCollapse: n }) => {
  const [r, o] = S.useState(null), [i, s] = S.useState(null), [a, l] = S.useState(null), [c, d] = S.useState({ path: null, pathString: null }), u = S.useRef(null), f = S.useRef("next"), p = S.useRef(null);
  return b(ku.Provider, { value: { collapseState: r, setCollapseState: (h) => {
    o(h), n && h !== null && (Array.isArray(h) ? h.forEach((g) => n(g)) : n(h)), h !== null && setTimeout(() => o(null), 2e3);
  ...
  }, currentlyEditingElement: i, setCurrentlyEditingElement: (h, g) => {
    const m = typeof h == "string" || h === null ? h : un(h, g === "key" ? "key_" : void 0);
    i !== null && m !== null && u.current !== null && u.current(), s(m), t && t(h, g === "key"), u.current = typeof g == "function" ? g : null;
  ...
  const d = l ?? e.value, [u, f] = S.useState(!1), p = t ? '"' : "", h = d.length > n, g = () => {
    o ? i(!0) : f(!u);
  };
  return B("div", { id: `${r}_display`, onDoubleClick: g, onClick: (m) => {
    (m.getModifierState("Control") || m.getModifierState("Meta")) && g();
  }, className: "jer-value-string", style: s, children: [p, h ? B(mt, u ? { children: [b(c, { children: B("span", { children: [d, p] }) }), B("span", { className: "jer-string-expansion jer-show-less", onClick: () => f(!1), children: [" ", a("SHOW_LESS", e)] })] } : { children: [B(c, { children: [b("span", { children: d.slice(0, n - 2).trimEnd() }), " "] }), b("span", { className: "jer-string-expansion jer-ellipsis", onClick: () => f(!0), children: "..." }), p] }) : b(c, { children: `${d}${p}` })] });
}, D_ = ({ styles: e, pathString: t, value: n, setValue: r, handleEdit: o, handleKeyboard: i, keyboardCommon: s }) => {
  const a = S.useRef(null);
  return b(Tu, { className: "jer-input-text", textAreaRef: a, name: t, value: n, setValue: r, handleKeyPress: (l) => {
...
`);
  ...
  return t && r ? B("div", { className: "jer-select jer-select-enums", children: [b("select", { name: `${s}-value-select`, className: "jer-select-inner", onChange: (p) => l(p.target.value), value: a, autoFocus: !0, onKeyDown: (p) => {
    u(p, Object.assign({ stringConfirm: d }, f));
  }, children: r.values.map((p) => b("option", { value: p, children: p }, p)) }), b("span", { className: "focus" })] }) : t ? b(D_, Object.assign({ styles: i("input", c), pathString: s }, o, { setValue: o.setValue })) : b(__, Object.assign({ pathString: s, styles: i("string", c) }, o));
  ...
  return n ? b("input", { className: "jer-input-number", type: "text", name: un(r), value: e, onChange: (d) => t(d.target.value.replace(/[^0-9.-]/g, "")), autoFocus: !0, onFocus: (d) => setTimeout(() => d.target.select(), 10), onKeyDown: (d) => a(d, Object.assign({ numberConfirm: i, numberUp: () => t(Number(e) + 1), numberDown: () => t(Number(e) - 1) }, l)), style: Object.assign({ width: String(e).length / 1.5 + 2 + "em" }, c("input", s)) }) : b("span", { onDoubleClick: () => o(!0), className: "jer-value-number", style: c("number", s), children: e });
}, x_ = ({ value: e, setValue: t, isEditing: n, path: r, setIsEditing: o, handleEdit: i, nodeData: s, handleKeyboard: a, keyboardCommon: l }) => {
  const { getStyles: c } = Tt();
  return typeof e != "boolean" ? null : n ? b("input", { className: "jer-input-boolean", type: "checkbox", name: un(r), checked: e, onChange: () => t(!e), onKeyDown: (d) => {
    d.key === " " && d.preventDefault(), a(d, Object.assign({ booleanConfirm: i, booleanToggle: () => t(!e) }, l));
  }, autoFocus: !0 }) : b("span", { onDoubleClick: () => o(!0), className: "jer-value-boolean", style: c("boolean", s), children: String(e) });
}, N_ = (e, t) => {
  const n = S.useRef(void 0), r = S.useRef(t);
  S.useEffect(() => {
    r.current = t;
  }, [t]);
  const o = (i) => {
  ...
  return N_(t, (l) => i(l, Object.assign({ confirm: r }, s))), b("div", { onDoubleClick: () => n(!0), className: "jer-value-null", style: a("null", o), children: String(e) });
}, A_ = ({ value: e }) => {
  let t = "Error!";
  switch (typeof e) {
    case "string":
  ...
  return b("span", { className: "jer-value-invalid", children: t });
}, T_ = ({ size: e, style: t, className: n }) => B("svg", { viewBox: "0 0 24 24", fill: "currentColor", width: e, height: e, className: n, style: t, children: [b("path", { d: "M13 7h-2v4H7v2h4v4h2v-4h4v-2h-4z" }), b("path", { d: "M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z" })] }), P_ = ({ size: e, style: t, className: n }) => B("svg", { viewBox: "0 0 24 24", fill: "currentColor", width: e, height: e, className: n, style: t, transform: "translate(0, 0.5)", children: [b("path", { d: "M7 17.013l4.413-.015 9.632-9.54c.378-.378.586-.88.586-1.414s-.208-1.036-.586-1.414l-1.586-1.586c-.756-.756-2.075-.752-2.825-.003L7 12.583v4.43zM18.045 4.458l1.589 1.583-1.597 1.582-1.586-1.585 1.594-1.58zM9 13.417l6.03-5.973 1.586 1.586-6.029 5.971L9 15.006v-1.589z" }), b("path", { d: "M5 21h14c1.103 0 2-.897 2-2v-8.668l-2 2V19H8.158c-.026 0-.053.01-.079.01-.033 0-.066-.009-.1-.01H5V5h6.847l2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2z" })] }), I_ = ({ size: e, style: t, className: n }) => b("svg", { viewBox: "0 0 24 24", fill: "currentColor", width: e, height: e, className: n, style: t, children: b("path", { d: "M6 19a2 2 0 002 2h8a2 2 0 002-2V7H6v12m2.46-7.12l1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12M15.5 4l-1-1h-5l-1 1H5v2h14V4h-3.5z" }) }), R_ = ({ size: e, style: t, className: n }) => B("svg", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, viewBox: "0 0 24 24", width: e, height: e, className: n, style: t, children: [b("path", { d: "M9 2 H15 A1 1 0 0 1 16 3 V5 A1 1 0 0 1 15 6 H9 A1 1 0 0 1 8 5 V3 A1 1 0 0 1 9 2 z" }), b("path", { d: "M8 4H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2v-2M16 4h2a2 2 0 012 2v4M21 14H11" }), b("path", { d: "M15 10l-4 4 4 4" })] }), M_ = ({ size: e, style: t, className: n }) => B("svg", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, viewBox: "0 0 24 24", width: e, height: e, className: n, style: t, children: [b("path", { d: "M22 11.08V12a10 10 0 11-5.93-9.14" }), b("path", { d: "M22 4L12 14.01l-3-3" })] }), L_ = ({ size: e, style: t, className: n }) => b("svg", { baseProfile: "tiny", viewBox: "0 0 24 24", fill: "currentColor", width: e, height: e, className: n, style: t, children: b("path", { d: "M12 4c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm-5 8c0-.832.224-1.604.584-2.295l6.711 6.711A4.943 4.943 0 0112 17c-2.757 0-5-2.243-5-5zm9.416 2.295L9.705 7.584A4.943 4.943 0 0112 7c2.757 0 5 2.243 5 5 0 .832-.224 1.604-.584 2.295z" }) }), k_ = ({ size: e, style: t, className: n }) => b("svg", { viewBox: "0 0 512 512", fill: "currentColor", width: e, height: e, className: n, style: t, children: b("path", { d: "M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" }) }), rn = ({ name: e, nodeData: t }) => {
  var n, r, o, i, s, a, l;
  const { getStyles: c, icons: d } = Tt(), u = { size: "1.4em", className: "jer-icon" };
  switch (e) {
    case "add":
      return (n = d == null ? void 0 : d.add) !== null && n !== void 0 ? n : b(T_, Object.assign({}, u, { style: c("iconAdd", t) }));
    case "edit":
      return (r = d == null ? void 0 : d.edit) !== null && r !== void 0 ? r : b(P_, Object.assign({}, u, { style: c("iconEdit", t) }));
    case "delete":
      return (o = d == null ? void 0 : d.delete) !== null && o !== void 0 ? o : b(I_, Object.assign({}, u, { style: c("iconDelete", t), size: "1.45em" }));
    case "copy":
      return (i = d == null ? void 0 : d.copy) !== null && i !== void 0 ? i : b(R_, Object.assign({}, u, { style: c("iconCopy", t), size: "1.2em" }));
    case "ok":
      return (s = d == null ? void 0 : d.ok) !== null && s !== void 0 ? s : b(M_, Object.assign({}, u, { style: Object.assign({ fontSize: "90%" }, c("iconOk", t)) }));
    case "cancel":
      return (a = d == null ? void 0 : d.cancel) !== null && a !== void 0 ? a : b(L_, Object.assign({}, u, { style: Object.assign({ fontSize: "130%" }, c("iconCancel", t)) }));
    case "chevron":
      return (l = d == null ? void 0 : d.chevron) !== null && l !== void 0 ? l : b(k_, { size: "1em", style: c("iconCollection", t) });
    default:
      return b(mt, {});
  }
  ...
  const { getStyles: p } = Tt(), h = a("KEY_NEW", s), [g, m] = S.useState(h), [_, O] = S.useState(!1), { key: y, path: v, value: D } = s, x = Array.isArray(_), C = (N) => {
    var G;
    if (!N)
      return void O(!1);
    const T = Object.keys(xn(s.fullData, v)), P = u ? (G = u(s)) === null || G === void 0 ? void 0 : G.filter((k) => !T.includes(k)) : null;
    P && m(""), O(P == null || P);
  };
  return B("div", { className: "jer-edit-buttons", style: { opacity: _ ? 1 : void 0 }, onClick: (N) => N.stopPropagation(), children: [r && b("div", { onClick: (N) => {
    var G;
    N.stopPropagation();
    let T, P, k = "value", V = "", Z = null;
    if (r) {
      const Q = _s(N);
      if (Q && l.clipboardModifier.includes(Q) ? (T = j_(v), V = T, k = "path") : (T = D, V = o ? f(D) : String(T)), !navigator.clipboard)
        return void (typeof r == "function" && r({ success: !1, value: T, stringValue: V, path: v, key: y, type: k, errorMessage: "Can't access clipboard API" }));
      (G = navigator.clipboard) === null || G === void 0 || G.writeText(V).then(() => P = !0).catch(($) => {
        P = !1, Z = $.message;
      }).finally(() => {
        typeof r == "function" && r({ success: P, errorMessage: Z, value: T, stringValue: V, path: v, key: y, type: k });
      });
    }
  }, className: "jer-copy-pulse", children: b(rn, { name: "copy", nodeData: s }) }), e && b("div", { onClick: e, children: b(rn, { name: "edit", nodeData: s }) }), t && b("div", { onClick: t, children: b(rn, { name: "delete", nodeData: s }) }), n && b("div", { onClick: () => {
    o === "object" ? C(!0) : n("");
  }, children: b(rn, { name: "add", nodeData: s }) }), i == null ? void 0 : i.map(({ Element: N, onClick: G }, T) => b("div", { onClick: (P) => G && G(s, P), children: b(N, { nodeData: s }) }, T)), _ && n && o === "object" && B(mt, { children: [x ? B("div", { className: "jer-select jer-select-keys", children: [B("select", { name: "new-key-select", className: "jer-select-inner", onChange: (N) => {
    n(N.target.value), C(!1);
  }, defaultValue: "", autoFocus: !0, onKeyDown: (N) => {
    c(N, { cancel: () => C(!1) });
  }, children: [b("option", { value: "", disabled: !0, children: _.length > 0 ? a("KEY_SELECT", s) : a("NO_KEY_OPTIONS", s) }), _.map((N) => b("option", { value: N, children: N }, N))] }), b("span", { className: "focus" })] }) : b("input", { className: "jer-input-new-key", type: "text", name: "new-object-key", value: g, onChange: (N) => m(N.target.value), autoFocus: !0, onFocus: (N) => N.target.select(), onKeyDown: (N) => {
    c(N, { stringConfirm: () => {
      n && (C(!1), n(g), m(h));
    }, cancel: () => {
      C(!1), m(h);
    } });
  }, style: p("input", s) }), b(Ss, { onOk: () => {
    x && !g || (C(!1), n(g));
  }, onCancel: () => {
    C(!1);
  }, nodeData: s, editConfirmRef: d, hideOk: x })] })] });
}, Ss = ({ onOk: e, onCancel: t, nodeData: n, editConfirmRef: r, hideOk: o = !1 }) => B("div", { className: "jer-confirm-buttons", children: [!o && b("div", { onClick: e, ref: r, children: b(rn, { name: "ok", nodeData: n }) }), b("div", { onClick: t, children: b(rn, { name: "cancel", nodeData: n }) })] }), j_ = (e) => e.reduce((t, n) => typeof n == "number" ? `${t}[${n}]` : t === "" ? n : `${t}.${n}`, ""), B_ = ["string", "number", "boolean", "null", "object", "array"], Bu = (e = [], t) => {
  ...
  const { data: n, nodeData: r, parentData: o, onEdit: i, onError: s, showErrorMessages: a, restrictEditFilter: l, restrictDeleteFilter: c, restrictAddFilter: d, restrictDragFilter: u, translate: f, errorMessageTimeout: p } = e, { currentlyEditingElement: h, setCurrentlyEditingElement: g } = ln(), [m, _] = S.useState(null), O = Object.assign(Object.assign({}, r), { collapsed: t }), { path: y, key: v, size: D } = O, x = un(y), C = !l(O), N = !c(O), G = !d(O), T = !u(O) && N && h === null, P = ($) => {
    a && (_($), setTimeout(() => _(null), p)), console.warn("Error", $);
  }, k = S.useCallback(($, W) => {
    P($.message), s && s({ currentData: O.fullData, errorValue: W, currentValue: n, name: v, path: y, error: $ });
  }, [s, a]), V = h === x, Z = h === `key_${x}`, Q = typeof y.slice(-1)[0] == "number";
  return { pathString: x, nodeData: O, path: y, name: v, size: D, canEdit: C, canDelete: N, canAdd: G, canDrag: T, error: m, showError: P, onError: k, setError: _, handleEditKey: ($) => {
    if (g(null), v === $ || !o)
      return;
    const W = y.slice(0, -1);
    if (Object.keys(o).includes($))
      return void k({ code: "KEY_EXISTS", message: f("ERROR_KEY_EXISTS", O) }, $);
    const J = Object.fromEntries(Object.entries(o).map(([z, H]) => z === v ? [$, H] : [z, H]));
    i(J, W).then((z) => {
      z && k({ code: "UPDATE_ERROR", message: z }, $);
    });
  ...
  const { getStyles: a } = Tt(), { dragSource: l, setDragSource: c } = ln(), [d, u] = S.useState(!1), f = un(n), p = S.useMemo(() => e ? { onDragStart: (_) => {
    _.stopPropagation(), c({ path: n, pathString: f });
  }, onDragEnd: (_) => {
    _.stopPropagation(), c({ path: null, pathString: null });
  } } : {}, [e, f]), h = S.useMemo(() => (_) => t ? { onDragOver: (O) => {
    O.stopPropagation(), O.preventDefault();
  }, onDrop: (O) => {
    O.stopPropagation(), m(_), c({ path: null, pathString: null }), u(!1);
  }, onDragEnter: (O) => {
    var y;
    O.stopPropagation(), f.startsWith((y = l.pathString) !== null && y !== void 0 ? y : "") || u(_);
  }, onDragExit: (O) => {
    O.stopPropagation(), u(!1);
  } } : {}, [l, t, f]), g = S.useMemo(() => t && l.pathString !== null ? b("div", Object.assign({ className: "jer-drop-target-bottom", style: { height: "50%", position: "absolute", width: "100%", top: "50%", zIndex: n.length } }, h("below"))) : null, [l, t, n.length]), m = (_) => {
    var O, y;
    const v = (O = l.path) === null || O === void 0 ? void 0 : O.slice(-1)[0], D = (y = l.path) === null || y === void 0 ? void 0 : y.slice(0, -1).join("."), x = n.slice(0, -1).join(""), { parentData: C } = r;
    typeof v == "string" && C && !Array.isArray(C) && Object.keys(C).includes(v) && v in C && D !== x ? i({ code: "KEY_EXISTS", message: s("ERROR_KEY_EXISTS", r) }, v) : o(l.path, n, _).then((N) => {
      N && i({ code: "UPDATE_ERROR", message: N }, r.value);
    });
  };
  return { dragSourceProps: p, getDropTargetProps: h, BottomDropTarget: g, DropTargetPadding: ({ position: _, nodeData: O }) => d === _ ? b("div", { className: "jer-drag-n-drop-padding", style: a("dropZone", O) }) : null, handleDrop: m };
}, V_ = (e, t, n, r) => {
  var o, i, s;
  if (!t.current)
    return 0;
...
`).map((d) => Math.ceil(d.length / l)).reduce((d, u) => d + u, 0) * a;
  ...
  return e ? b("input", { className: "jer-input-text jer-key-edit", type: "text", name: n, defaultValue: o, autoFocus: !0, onFocus: (p) => p.target.select(), onKeyDown: (p) => i(p, { stringConfirm: () => s(p.target.value), cancel: a, tabForward: () => {
  ...
  } }), style: { width: String(o).length / 1.5 + 0.5 + "em" } }) : B("span", { className: "jer-key-text", style: Object.assign(Object.assign({}, d), { minWidth: `${Math.min(String(o).length + 1, 5)}ch`, flexShrink: o.length > 10 ? 1 : 0 }), onDoubleClick: () => t && f(r, "key"), onClick: l, children: [o === "" ? b("span", { className: r.length > 0 ? "jer-empty-string" : void 0 }) : `${o}`, b("span", { className: "jer-key-colon", children: ":" })] });
}, Fu = (e) => {
  const { data: t, parentData: n, onEdit: r, onDelete: o, onChange: i, onMove: s, enableClipboard: a, canDragOnto: l, restrictTypeSelection: c, searchFilter: d, searchText: u, showLabel: f, stringTruncate: p, showStringQuotes: h, indent: g, translate: m, customNodeDefinitions: _, handleKeyboard: O, keyboardControls: y, sort: v, editConfirmRef: D, jsonStringify: x } = e, { getStyles: C } = Tt(), { setCurrentlyEditingElement: N, setCollapseState: G, previouslyEditedElement: T, setPreviouslyEditedElement: P, tabDirection: k, setTabDirection: V, previousValue: Z, setPreviousValue: Q } = ln(), [$, W] = S.useState(typeof t == "function" ? Ai : t), { pathString: J, nodeData: z, path: H, name: K, canEdit: Se, canDelete: oe, canDrag: Ie, error: re, onError: we, handleEditKey: Le, derivedValues: Ye } = Vu({ props: e }), { dragSourceProps: Ne, getDropTargetProps: Ue, BottomDropTarget: Ce, DropTargetPadding: I } = $u({ canDrag: Ie, canDragOnto: l, path: H, nodeData: z, onMove: s, onError: we, translate: m }), pe = Bu(_, z), [j, ee] = S.useState(Ti(t, pe)), de = S.useCallback((L) => {
    if (!i)
      return void W(L);
  ...
  const { CustomNode: ke, customNodeProps: Oe, hideKey: We, showEditTools: Pt = !0, showOnEdit: Ot, showOnView: bt, passOriginalNode: Et } = pe, at = [...B_, ..._.filter(({ showInTypesSelector: L = !1, name: be }) => L && !!be).map(({ name: L }) => L)], xe = S.useMemo(() => {
    if (typeof c == "boolean")
      return c ? [] : at;
    if (Array.isArray(c))
      return c;
  ...
  }, { isEditingKey: Fe, canEditKey: Te } = Ye, He = !$e && re, ot = $e && xe.length > 1, te = (j !== "invalid" || ke) && !re && Pt, X = f && !We, se = ke && ($e && Ot || !$e && bt), le = { value: $, parentData: n, setValue: de, isEditing: $e, canEdit: Se, setIsEditing: Se ? () => N(H) : () => {
  }, handleEdit: rt, handleCancel: Ke, path: H, stringTruncate: p, showStringQuotes: h, nodeData: z, enumType: nt, translate: m, handleKeyboard: O, keyboardCommon: { cancel: Ke, tabForward: () => {
    V("next"), P(J);
    const L = nn(z.fullData, H, "next", v);
    L && (rt(), N(L));
  }, tabBack: () => {
    V("prev"), P(J);
    const L = nn(z.fullData, H, "prev", v);
    L && (rt(), N(L));
  } } }, ie = { canEditKey: Te, isEditingKey: Fe, pathString: J, path: H, name: K, handleKeyboard: O, handleEditKey: Le, handleCancel: Ke, styles: C("property", z), getNextOrPrevious: (L) => nn(z.fullData, H, L, v) }, fe = se ? b(ke, Object.assign({}, e, { value: $, customNodeProps: Oe, setValue: de, handleEdit: rt, handleCancel: Ke, handleKeyPress: (L) => O(L, { stringConfirm: rt, cancel: Ke }), isEditing: $e, setIsEditing: () => N(H), getStyles: C, originalNode: Et ? ml(t, le) : void 0, originalNodeKey: Et ? b(eo, Object.assign({}, ie)) : void 0, canEdit: Se, keyboardCommon: le.keyboardCommon, onError: we })) : ml(t, le);
  return B("div", Object.assign({ className: "jer-component jer-value-component", style: { marginLeft: g / 2 + "em", position: "relative" }, draggable: Ie }, Ne, Ue("above"), { children: [Ce, b(I, { position: "above", nodeData: z }), B("div", { className: "jer-value-main-row", style: { flexWrap: K.length > 10 ? "wrap" : "nowrap" }, children: [X && b(eo, Object.assign({}, ie)), B("div", { className: "jer-value-and-buttons", children: [b("div", { className: "jer-input-component", children: fe }), $e ? b(Ss, { onOk: rt, onCancel: Ke, nodeData: z, editConfirmRef: D }) : te && b(ju, { startEdit: Se ? () => {
    Q(Z), N(H, Ke);
  } : void 0, handleDelete: oe ? () => {
    o($, H).then((L) => {
      L && we({ code: "DELETE_ERROR", message: L }, $);
    });
  } : void 0, enableClipboard: a, translate: m, customButtons: e.customButtons, nodeData: z, handleKeyboard: O, keyboardControls: y, editConfirmRef: D, jsonStringify: x }), ot && B("div", { className: "jer-select jer-select-types", children: [b("select", { name: `${K}-type-select`, className: "jer-select-inner", onChange: (L) => ((be) => {
    ...
    const Ae = $_($, be, m("DEFAULT_NEW_KEY", z), pe != null && pe.CustomNode ? m("DEFAULT_STRING", z) : void 0);
    r(Ae, H).then((je) => {
      je ? (we({ code: "UPDATE_ERROR", message: je }, Ae), N(null)) : xt(null);
    });
  })(L.target.value), value: nt ? nt.enum : j, children: xe.map((L) => L instanceof Object && "enum" in L ? b("option", { value: L.enum, children: L.enum }, L.enum) : b("option", { value: L, children: L }, L)) }), b("span", { className: "focus" })] }), He && b("span", { className: "jer-error-slug", style: C("error", z), children: re })] })] }), b(I, { position: "below", nodeData: z })] }));
  ...
  switch (n) {
    case "string":
      return b(S_, Object.assign({}, t, { value: r }));
    case "number":
      return b(O_, Object.assign({}, t, { value: r }));
    case "boolean":
      return b(x_, Object.assign({}, t, { value: r }));
    case "null":
      return b(C_, Object.assign({}, t));
    default:
      return b(A_, Object.assign({}, t));
  }
}, $_ = (e, t, n, r) => {
  switch (t) {
    case "string":
  ...
  const { getStyles: t } = Tt(), { collapseState: n, setCollapseState: r, getMatchingCollapseState: o, currentlyEditingElement: i, setCurrentlyEditingElement: s, areChildrenBeingEdited: a, previousValue: l, setPreviousValue: c } = ln(), { mainContainerRef: d, data: u, nodeData: f, parentData: p, showCollectionCount: h, onEdit: g, onAdd: m, onDelete: _, canDragOnto: O, collapseFilter: y, collapseAnimationTime: v, onMove: D, enableClipboard: x, searchFilter: C, searchText: N, indent: G, sort: T, showArrayIndices: P, defaultValue: k, newKeyOptions: V, translate: Z, customNodeDefinitions: Q, jsonParse: $, jsonStringify: W, TextEditor: J, keyboardControls: z, handleKeyboard: H, insertAtTop: K, onCollapse: Se, editConfirmRef: oe, collapseClickZones: Ie } = e, [re, we] = S.useState(W(u)), Le = y(f), { contentRef: Ye, isAnimating: Ne, maxHeight: Ue, collapsed: Ce, animateCollapse: I, cssTransitionValue: pe } = ((M, ne, Ee, _e, qe) => {
    const [Ut, Pe] = S.useState(Ee ? 0 : void 0), [Wt, xr] = S.useState(Ee), ho = S.useRef(!1), mo = S.useRef(null), Os = S.useRef(0), xs = S.useRef(0), zu = ne / 1e3 + "s", Uu = S.useCallback((go) => {
      var vo, yo;
      if (Wt !== go) {
  ...
  })(u, v, Le, d, W), { pathString: j, nodeData: ee, path: de, name: ke, size: Oe, canEdit: We, canDelete: Pt, canAdd: Ot, canDrag: bt, error: Et, setError: at, onError: xe, handleEditKey: nt, derivedValues: xt } = Vu({ props: e, collapsed: Ce }), { dragSourceProps: $e, getDropTargetProps: It, BottomDropTarget: rt, DropTargetPadding: Ke } = $u({ canDrag: bt, canDragOnto: O, path: de, nodeData: ee, onMove: D, onError: xe, translate: Z }), Fe = S.useRef(!Le), { isEditing: Te, isEditingKey: He, isArray: ot, canEditKey: te } = xt;
  S.useEffect(() => {
    we(W(u));
  }, [u, W]), S.useEffect(() => {
    const M = y(ee) && !Te;
  ...
  const X = S.useRef(null), se = S.useCallback((M, ne) => {
    if (typeof k != "function")
      return k;
    const Ee = k(M, ne);
    return Ee !== void 0 ? Ee : null;
  }, [k]), le = S.useCallback((M) => V ? typeof V != "function" ? V : V(M) : null, [V]), { CustomNode: ie, customNodeProps: fe, CustomWrapper: L, wrapperProps: be = {}, hideKey: he, showEditTools: ue = !0, showOnEdit: Ae, showOnView: je, showCollectionWrapper: ft = !0 } = S.useMemo(() => Bu(Q, ee), [ee, Q]), pt = a(j);
  ...
  const Rt = Array.isArray(u) ? "array" : "object", dn = Rt === "array" ? { open: "[", close: "]" } : { open: "{", close: "}" }, wr = (M) => {
    ...
    i && i.includes(j) || (Fe.current = !0, r(null), Se && Se({ path: de, collapsed: !Ce, includeChildren: !1 }), I(!Ce));
  }, Mt = () => {
    try {
      const M = $(re);
    ...
    s(null), l === null ? (at(null), we(W(u)), c(null)) : g(l, de);
  ...
  Rt === "object" && T(pn, (M) => M);
  const In = Fe.current ? Te ? B("div", { className: "jer-collection-text-edit", children: [J ? b(J, { value: re, onChange: we, onKeyDown: (M) => H(M, { objectConfirm: Mt, cancel: Vt }) }) : b(Tu, { textAreaRef: X, className: "jer-collection-text-area", name: j, value: re, setValue: we, handleKeyPress: wr, styles: t("input", ee) }), b("div", { className: "jer-collection-input-button-row", children: b(Ss, { onOk: Mt, onCancel: Vt, nodeData: ee, editConfirmRef: oe }) })] }) : pn.map(([M, ne], Ee) => {
    ...
    return b("div", { className: "jer-collection-element", style: t("collectionElement", _e), children: Nn(ne) ? b(Gu, Object.assign({}, e, { data: ne, parentData: u, nodeData: _e, showCollectionCount: h, canDragOnto: We }), M) : b(Fu, Object.assign({}, e, { data: ne, parentData: u, nodeData: _e, canDragOnto: We, showLabel: Rt === "object" || P }), M) }, M);
  }) : null, hn = !!ft && Ce && !pt;
  hn || (Fe.current = !0);
  const Or = Object.assign(Object.assign({}, e), { data: u, value: u, parentData: p, nodeData: ee, setValue: (M) => vn(void 0, void 0, void 0, function* () {
    return yield g(M, de);
  }), handleEdit: Mt, handleCancel: Vt, handleKeyPress: wr, isEditing: Te, setIsEditing: () => s(de), getStyles: t, canDragOnto: We, canEdit: We, keyboardCommon: {}, onError: xe }), q = Sr ? b(ie, Object.assign({ customNodeProps: fe }, Or, { children: In })) : In, w = Dr && b(ju, { startEdit: We ? () => {
    ...
    if (Rt === "array") {
      ...
      m(ne, [...de, M], Ee).then((_e) => {
        _e && xe({ code: "ADD_ERROR", message: _e }, ne);
      });
    }
  } : void 0, handleDelete: Pt ? _r : void 0, enableClipboard: x, type: Rt, nodeData: ee, translate: Z, customButtons: e.customButtons, keyboardControls: z, handleKeyboard: H, getNewKeyOptions: le, editConfirmRef: oe, jsonStringify: W }), A = { canEditKey: te, isEditingKey: He, pathString: j, path: de, name: ke, handleKeyboard: H, handleEditKey: nt, handleCancel: Vt, keyValueArray: pn, styles: t("property", ee), getNextOrPrevious: (M) => nn(ee.fullData, de, M, T), handleClick: Ie.includes("property") ? Xe : (M) => M.stopPropagation() }, U = B("div", Object.assign({ className: "jer-component jer-collection-component", style: Object.assign(Object.assign({ marginLeft: (de.length === 0 ? 0 : G / 2) + "em" }, t("collection", ee)), { position: "relative" }), draggable: bt }, $e, It("above"), { children: [b("div", { className: "jer-clickzone", style: { width: G / 2 + 1 + "em", zIndex: 10 + 2 * ee.level }, onClick: Ie.includes("left") ? Xe : void 0 }), !Te && rt, b(Ke, { position: "above", nodeData: ee }), ft ? B("div", { className: "jer-collection-header-row", style: { position: "relative" }, onClick: Ie.includes("header") ? Xe : void 0, children: [B("div", { className: "jer-collection-name", children: [b("div", { className: "jer-collapse-icon jer-accordion-icon" + (Ce ? " jer-rotate-90" : ""), style: { zIndex: 11 + 2 * ee.level, transition: pe }, onClick: Xe, children: b(rn, { name: "chevron", rotate: Ce, nodeData: ee }) }), wt && b(eo, Object.assign({}, A)), !Te && b("span", { className: "jer-brackets jer-bracket-open", style: t("bracket", ee), children: dn.open })] }), !Te && fn && b("div", { className: "jer-collection-item-count" + (fn ? " jer-visible" : " jer-hidden"), style: Object.assign(Object.assign({}, t("itemCount", ee)), { transition: pe }), children: Oe === 1 ? Z("ITEM_SINGLE", Object.assign(Object.assign({}, ee), { size: 1 }), 1) : Z("ITEMS_MULTIPLE", ee, Oe) }), b("div", { className: "jer-brackets" + (hn ? " jer-visible" : " jer-hidden"), style: Object.assign(Object.assign({}, t("bracket", ee)), { transition: pe }), children: dn.close }), w] }) : he ? b(mt, {}) : B("div", { className: "jer-collection-header-row", style: { position: "relative" }, children: [b(eo, Object.assign({}, A)), w] }), B("div", { className: "jer-collection-inner", style: Object.assign(Object.assign({ overflowY: hn || Ne ? "clip" : "visible", maxHeight: pt ? void 0 : Ue }, t("collectionInner", ee)), { transition: pe }), ref: Ye, children: [q, b("div", { className: Te ? "jer-collection-error-row" : "jer-collection-error-row-edit", children: Et && b("span", { className: "jer-error-slug", style: t("error", ee), children: Et }) }), !Te && ft && b("div", { className: "jer-brackets jer-bracket-outside", style: Object.assign(Object.assign({}, t("bracket", ee)), { marginLeft: (G < 3 ? -1 : G < 6 ? -0.5 : 0) + "em" }), children: dn.close })] }), b(Ke, { position: "below", nodeData: ee })] }));
  return L ? b(L, Object.assign({ customNodeProps: be }, Or, { children: U })) : U;
...
const z_ = ({ data: e, setData: t, rootName: n = "root", onUpdate: r = () => {
}, onEdit: o = r, onDelete: i = r, onAdd: s = r, onChange: a, onError: l, showErrorMessages: c = !0, enableClipboard: d = !0, indent: u = 2, collapse: f = !1, collapseAnimationTime: p = 300, showCollectionCount: h = !0, restrictEdit: g = !1, restrictDelete: m = !1, restrictAdd: _ = !1, restrictTypeSelection: O = !1, restrictDrag: y = !0, viewOnly: v, searchFilter: D, searchText: x, searchDebounceTime: C = 350, keySort: N = !1, showArrayIndices: G = !0, showStringQuotes: T = !0, defaultValue: P = null, newKeyOptions: k, minWidth: V = 250, maxWidth: Z = "min(600px, 90vw)", rootFontSize: Q, stringTruncate: $ = 250, translations: W = {}, className: J, id: z, customText: H = {}, customNodeDefinitions: K = [], customButtons: Se = [], jsonParse: oe = JSON.parse, jsonStringify: Ie = (I, pe) => JSON.stringify(I, pe, 2), TextEditor: re, errorMessageTimeout: we = 2500, keyboardControls: Le = {}, externalTriggers: Ye, insertAtTop: Ne = !1, onCollapse: Ue, collapseClickZones: Ce = ["header", "left"] }) => {
  const { getStyles: I } = Tt(), { setCurrentlyEditingElement: pe } = ln(), j = S.useMemo(() => Wn(f), [f]), ee = S.useMemo(() => G_(W, H), [W, H]), [de, ke] = S.useState(x), [Oe, We] = (({ setData: te, data: X }) => {
    const [se, le] = S.useState(te ? void 0 : X), ie = S.useCallback((fe) => {
      te ? te(fe) : le(fe);
    }, [te]);
    return S.useEffect(() => {
      te || le(X);
    }, [X]), [te ? X : se, ie];
  })({ setData: t, data: e }), Pt = S.useRef(null);
  S.useEffect(() => {
    pe(null);
  ...
  const Ot = { key: n, path: [], level: 0, index: 0, value: Oe, size: typeof Oe == "object" && Oe !== null ? Object.keys(Oe).length : 1, parentData: null, fullData: Oe }, bt = (te, X) => vn(void 0, void 0, void 0, function* () {
    ...
    We(fe);
  }), Et = S.useMemo(() => Wn(g, v), [g, v]), at = S.useMemo(() => Wn(m, v), [m, v]), xe = S.useMemo(() => Wn(_, v), [_, v]), nt = S.useMemo(() => Wn(y, v), [y, v]), xt = S.useMemo(() => W_(D), [D]), $e = S.useMemo(() => ((te) => {
    ...
    return X;
  })(Le), [Le]), It = S.useCallback((te, X) => ((se, le, ie) => {
  ...
  }), showCollectionCount: h, collapseFilter: j, collapseAnimationTime: p, restrictEditFilter: Et, restrictDeleteFilter: at, restrictAddFilter: xe, restrictTypeSelection: O, restrictDragFilter: nt, canDragOnto: !1, searchFilter: xt, searchText: de, enableClipboard: d, keySort: N, sort: Te, showArrayIndices: G, showStringQuotes: T, indent: u, defaultValue: P, newKeyOptions: k, stringTruncate: $, translate: ee, customNodeDefinitions: K, customButtons: Se, parentData: null, jsonParse: Ke, jsonStringify: rt, TextEditor: re, errorMessageTimeout: we, handleKeyboard: It, keyboardControls: $e, insertAtTop: { object: Ne === !0 || Ne === "object", array: Ne === !0 || Ne === "array" }, onCollapse: Ue, editConfirmRef: Fe, collapseClickZones: Ce }, ot = Object.assign(Object.assign({}, I("container", Ot)), { minWidth: V, maxWidth: Z });
  return ot.fontSize = Q ?? ot.fontSize, b("div", { id: z, ref: Pt, className: `jer-editor-container ${J ?? ""}`, style: ot, children: Nn(Oe) ? b(Gu, Object.assign({ data: Oe }, He)) : b(Fu, Object.assign({ data: Oe, showLabel: !0 }, He)) });
}, U_ = (e) => {
  var t;
  ...
  return S.useEffect(() => {
    ...
    r(o);
  }, []), n ? b(v_, { theme: (t = e.theme) !== null && t !== void 0 ? t : Ds, icons: e.icons, docRoot: n, children: b(w_, { onEditEvent: e.onEditEvent, onCollapse: e.onCollapse, children: b(z_, Object.assign({}, e)) }) }) : null;
}, Un = (e, t, n, r, o = {}) => {
  if (t.length === 0)
  ...
  if ((t = e.dashboard) != null && t.sharedFilters) {
    const n = (r, o) => {
      const i = Re.uniq(Object.values(o).reduce((s, a) => (a.type === "dashboardFilters" && (s = s.concat(a.sharedFilterIndexes)), s), []));
      for (let s = 0; s < r.length; s++) {
        ...
        if (i.includes(s))
          ...
          const [l, c] = q_(s, e.dashboard.sharedFilters, e.visualizations);
...
const z0 = ({ loadConfig: e, config: t, convertStateToConfig: n, onExpandCollapse: r = () => {
  ...
  const [o, i] = S.useState(!1), [s, a] = S.useState({}), l = (f) => {
    i(f), r();
  ...
  const u = {
    chart: ["Charts", "https://www.cdc.gov/cove/index.html", /* @__PURE__ */ b(Ps, {})],
    dashboard: ["Dashboard", "https://www.cdc.gov/cove/index.html", /* @__PURE__ */ b(Ps, {})],
    map: ["Maps", "https://www.cdc.gov/cove/index.html", /* @__PURE__ */ b(c_, {})],
    "markup-include": ["Markup Include", "https://www.cdc.gov/cove/index.html", /* @__PURE__ */ b(Zu, {})]
  };
  return t.type ? /* @__PURE__ */ B(mt, { children: [
    /* @__PURE__ */ B(
      "a",
      {
        href: u[t.type][1],
        ...
        children: [
          ...
          /* @__PURE__ */ B("div", { children: [
            /* @__PURE__ */ B("span", { className: "heading-3", children: [
              "Get Help with ",
              u[t.type][0]
            ] }),
            /* @__PURE__ */ b("p", { children: "Examples and documentation" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ B("div", { className: "advanced", children: [
      /* @__PURE__ */ B("span", { className: "advanced-toggle-link", onClick: () => l(!o), children: [
        /* @__PURE__ */ b("span", { children: o ? "— " : "+ " }),
        "Advanced Options"
      ] }),
      o && /* @__PURE__ */ B(R.Fragment, { children: [
        /* @__PURE__ */ b("section", { className: "error-box py-2 px-3 my-2", children: /* @__PURE__ */ B("div", { children: [
          /* @__PURE__ */ b("strong", { className: "pt-1", children: "Warning" }),
          /* @__PURE__ */ b("p", { children: "This can cause serious errors in your visualization." })
        ] }) }),
        /* @__PURE__ */ B("p", { className: "pb-2", children: [
          "This tool displays the actual ",
          /* @__PURE__ */ b("acronym", { title: "JavaScript Object Notation", children: "JSON" }),
  ...
  return l ? /* @__PURE__ */ B("fieldset", { className: "edit-block mb-1", children: [
    /* @__PURE__ */ B("div", { className: "d-flex justify-content-between", children: [
      /* @__PURE__ */ b("button", { className: "btn btn-light", onClick: () => c(t, !1), children: /* @__PURE__ */ b(Xn, { display: "caretUp" }) }),
      /* @__PURE__ */ b(
        "button",
        {
    ...
    i
  ] }, t) : /* @__PURE__ */ B("div", { className: "mb-1", children: [
    /* @__PURE__ */ b("button", { className: "btn btn-light", onClick: () => c(t, !0), children: /* @__PURE__ */ b(Xn, { display: "caretDown" }) }),
...
], Ii = ({ orderedValues: e, handleFilterOrder: t }) => /* @__PURE__ */ b(uw, { onDragEnd: ({ source: n, destination: r }) => t(n == null ? void 0 : n.index, r == null ? void 0 : r.index), children: /* @__PURE__ */ b(l_, { droppableId: "filter_order", children: (n) => /* @__PURE__ */ B("ul", { ...n.droppableProps, className: "sort-list", ref: n.innerRef, style: { marginTop: "1em" }, children: [
  e == null ? void 0 : e.map((r, o) => /* @__PURE__ */ b(Rw, { draggableId: `draggableFilter-${r}`, index: o, children: (i, s) => /* @__PURE__ */ b("li", { children: /* @__PURE__ */ b(
    "div",
    {
  ...
  e.filters.forEach((y, v) => {
    o !== v && (c.push(y.columnName), l != null && l.columnName && c.push(l.columnName));
  });
  const d = (y, v) => {
    s("filters", o, y, v);
  }, u = (y) => {
    const v = {
      ...
      order: y
    }, D = qo(v).values, x = Re.cloneDeep(e.filters);
    x[o] = { ...a, values: D, order: y }, y === "cust" ? x[o].orderedValues = D : delete x[o].orderedValues, s(null, null, "filters", x);
  }, f = (y) => {
    s("filters", o, "subGrouping", y);
  }, p = (y) => {
    var C;
    const D = ((C = a.orderedValues) != null && C.length ? a.orderedValues : a.values).reduce((N, G) => {
      const T = Re.uniq(
        i.map((P) => P[a.columnName] === G ? P[y] : "").filter((P) => P !== "")
      ).sort();
      return N[G] = {
        values: T
    ...
    const v = Object.keys(l.valuesLookup).reduce((x, C) => {
      const N = l.valuesLookup[C], { values: G } = qo({ values: N.values, order: y });
      return x[C] = {
        values: G
      }, y === "cust" ? x[C].orderedValues = G : delete x[C].orderedValues, x;
    }, {}), D = { ...l, order: y, valuesLookup: v };
    f(D);
  }, g = (y, v, D, x) => {
    const C = Re.cloneDeep(D), [N] = C.splice(y, 1);
    C.splice(v, 0, N);
    const G = Re.cloneDeep(l);
    G.valuesLookup[x].values = C, G.valuesLookup[x].orderedValues = C, f({ ...G, order: "cust" });
  }, m = t.filter((y) => !c.includes(y)), _ = S.useMemo(() => {
    var v;
    const y = e.filters[o];
    return !!(y.setByQueryParameter && ((v = y.subGrouping) != null && v.setByQueryParameter));
  }, [e, o]), O = (y) => {
    const v = e.filters, { checked: D } = y.target, x = D ? a.columnName : "", C = D ? l.columnName : "";
    v[o] = {
      ...e.filters[o],
      setByQueryParameter: x,
      subGrouping: { ...l, setByQueryParameter: C }
    }, s(null, null, "filters", v);
  };
  return /* @__PURE__ */ B("div", { className: "nesteddropdown-editor", children: [
    /* @__PURE__ */ B("label", { children: [
      /* @__PURE__ */ b("span", { className: "edit-label column-heading mt-2", children: "Label" }),
      /* @__PURE__ */ b(
        "input",
        {
          type: "text",
          value: a.label,
          onChange: (y) => {
            d("label", y.target.value);
          }
        }
      )
    ] }),
    /* @__PURE__ */ B("label", { children: [
      /* @__PURE__ */ B("div", { className: "edit-label column-heading mt-2", children: [
        "Filter Grouping",
        /* @__PURE__ */ b("span", {})
      ] }),
      /* @__PURE__ */ B("select", { value: a.columnName, onChange: (y) => r(y.target.value), children: [
        /* @__PURE__ */ b("option", { value: "", children: "- Select Option -" }),
        m.map((y, v) => /* @__PURE__ */ b("option", { value: y, children: y }, v))
      ] })
    ] }),
    /* @__PURE__ */ B("label", { children: [
      /* @__PURE__ */ B("div", { className: "edit-label column-heading mt-2", children: [
      ...
      /* @__PURE__ */ B(
        "select",
        {
          ...
          children: [
            ...
            m.map((y, v) => {
              if (y !== a.columnName)
                return /* @__PURE__ */ b("option", { value: y, children: y }, v);
            })
          ]
        }
      )
    ...
    /* @__PURE__ */ B("label", { children: [
      ...
      /* @__PURE__ */ b("span", { children: " Create query parameters" }),
      _ && /* @__PURE__ */ B(mt, { children: [
        /* @__PURE__ */ b("span", { className: "edit-label column-heading mt-2", children: "Grouping: Default Value Set By Query String Parameter" }),
        /* @__PURE__ */ b(
          "input",
          {
            type: "text",
            ...
            onChange: (y) => {
              d("setByQueryParameter", y.target.value);
            }
          }
        ),
        /* @__PURE__ */ b("span", { className: "edit-label column-heading mt-2", children: "SubGrouping: Default Value Set By Query String Parameter" }),
        /* @__PURE__ */ b(
          "input",
          {
            type: "text",
            ...
            onChange: (y) => {
              ...
              f({ ...l, setByQueryParameter: v });
            }
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ B("label", { className: "mt-2", children: [
      /* @__PURE__ */ B("div", { className: "edit-label column-heading float-right", children: [
        a.columnName,
        " "
      ] }),
      /* @__PURE__ */ b("span", { className: "edit-filterOrder column-heading ", children: "Group Order" }),
      /* @__PURE__ */ b("select", { value: a.order, onChange: (y) => u(y.target.value), children: Pi.map((y, v) => /* @__PURE__ */ b("option", { value: y.value, children: y.label }, `filter-${y.label}-${v}`)) }),
      a.order === "cust" && /* @__PURE__ */ b(Ii, { orderedValues: a.orderedValues, handleFilterOrder: n })
    ] }),
    (l == null ? void 0 : l.columnName) && /* @__PURE__ */ B("label", { className: "mt-2", children: [
      /* @__PURE__ */ b("span", { className: "edit-filterOrder column-heading", children: "SubGrouping Order" }),
      /* @__PURE__ */ B("div", { className: "edit-label column-heading float-right", children: [
        l.columnName,
        " "
      ] }),
      /* @__PURE__ */ b(
        "select",
        {
          ...
          children: Pi.map((y, v) => /* @__PURE__ */ b("option", { value: y.value, children: y.label }, `filter-${v}`))
        }
      ),
      (l == null ? void 0 : l.order) === "cust" && a.values.map((y, v) => {
        const D = l.valuesLookup[y].orderedValues;
        return /* @__PURE__ */ B("div", { children: [
          /* @__PURE__ */ b("span", { className: "font-weight-bold", children: y }),
          /* @__PURE__ */ b(
            Ii,
            {
              orderedValues: D,
        ...
        ] }, `group-subgroup-values-${y}-${v}`);
      })
    ] })
  ] });
}, U0 = ({ config: e, updateField: t, rawData: n }) => {
  const r = S.useState({}), o = S.useMemo(() => Re.uniq(Re.flatten(n == null ? void 0 : n.map((p) => Object.keys(p)))), [n]), i = (p) => {
    let h = Re.cloneDeep(e.filters);
    h.splice(p, 1), t(null, null, "filters", h);
  }, s = (p, h, g) => {
    t("filters", h, p, g);
  }, a = (p, h) => {
    const g = Re.cloneDeep(e.filters), m = { ...g[p], orderedValues: g[p].values };
    m.defaultValue = h, m.active = h, g[p] = m, t(null, null, "filters", g);
  }, l = (p, h) => {
    const g = Re.cloneDeep(e.filters), m = { ...g[p], orderedValues: g[p].values };
    m.filterStyle = h, h === "multi-select" ? m.active = Array.isArray(m.active) ? m.active : [m.active] : Array.isArray(m.active) && (m.active = m.active[0]), h === "nested-dropdown" && (m.showDropdown = !0), g[p] = m, t(null, null, "filters", g);
  }, c = (p, h) => {
    const g = Re.uniq(n.map((O) => O[h])), m = { ...Re.cloneDeep(e.filters[p]), columnName: h, values: g };
    qo(m), m.active = m.values[0];
    const _ = e.filters.map((O, y) => y === p ? m : O);
    t(null, null, "filters", _);
  }, d = () => {
    const p = e.filters ? [...e.filters] : [], h = {
      values: [],
      filterStyle: "dropdown",
      id: Date.now(),
      showDropdown: !0
    };
    p.push(h), t(null, null, "filters", p);
  }, u = (p, h, g) => {
    const m = e.filters[g], _ = [...m.orderedValues || m.values], [O] = _.splice(p, 1);
    _.splice(h, 0, O);
    const y = Re.cloneDeep(e.filters), v = { ...y[g] };
    v.values = _, v.orderedValues = _, v.active = v.defaultValue ? v.defaultValue : _[0], v.order = "cust", y[g] = v, t(null, null, "filters", y);
  }, f = (p) => e.filters.filter((h, g) => g !== p).map(({ label: h, columnName: g, id: m }) => ({ label: h || g, value: m }));
  return /* @__PURE__ */ B(mt, { children: [
    e.filters && /* @__PURE__ */ B(mt, { children: [
      /* @__PURE__ */ b(
        mn,
        {
          ...
          tooltip: /* @__PURE__ */ B(Lt, { style: { textTransform: "none" }, children: [
            /* @__PURE__ */ b(Lt.Target, { children: /* @__PURE__ */ b(Xn, { display: "question", style: { marginLeft: "0.5rem" } }) }),
            /* @__PURE__ */ b(Lt.Content, { children: /* @__PURE__ */ b("p", { children: 'The Apply Button option changes the visualization when the user clicks "apply". The Filter Change option immediately changes the visualization when the selection is changed.' }) })
          ] })
        }
      ),
      /* @__PURE__ */ b(
      ...
      /* @__PURE__ */ b("br", {}),
      /* @__PURE__ */ b("ul", { className: "filters-list", children: e.filters.map((p, h) => {
        var g, m;
        return p.type === "url" ? /* @__PURE__ */ b(mt, {}) : /* @__PURE__ */ B(
          X_,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ b(
                mn,
                {
                  ...
                  options: p.resetLabel ? [p.resetLabel, ...(g = e.filters) == null ? void 0 : g[h].values] : (m = e.filters) == null ? void 0 : m[h].values,
                  updateField: (_, O, y, v) => {
                    a(h, v);
                  },
              ...
              p.filterStyle !== "nested-dropdown" ? /* @__PURE__ */ B(mt, { children: [
                /* @__PURE__ */ b(
                  mn,
                  {
                    value: p.columnName,
                    ...
                    label: "Filter",
                    updateField: (_, O, y, v) => c(h, v),
                    options: o,
                    initial: "- Select Option -"
                  }
                ),
                /* @__PURE__ */ B("label", { children: [
                  /* @__PURE__ */ b("span", { className: "edit-showDropdown column-heading", children: "Show Filter Input" }),
                  /* @__PURE__ */ b(
                    "input",
                    {
                      type: "checkbox",
                      checked: p.showDropdown === void 0 ? !0 : p.showDropdown,
                      onChange: (_) => {
                        s("showDropdown", h, _.target.checked);
                      }
                    }
                  )
                ] }),
                /* @__PURE__ */ B("label", { children: [
                  /* @__PURE__ */ b("span", { className: "edit-label column-heading", children: "Label" }),
                  /* @__PURE__ */ b(
                    "input",
                    {
                      type: "text",
                      value: p.label,
                      onChange: (_) => {
                        s("label", h, _.target.value);
                      }
                    }
                  )
                ] }),
                p.filterStyle === "multi-select" && /* @__PURE__ */ b(
                  Is,
                  {
                    label: "Select Limit",
                    value: p.selectLimit,
                    ...
                    tooltip: /* @__PURE__ */ B(Lt, { style: { textTransform: "none" }, children: [
                      /* @__PURE__ */ b(Lt.Target, { children: /* @__PURE__ */ b(Xn, { display: "question", style: { marginLeft: "0.5rem" } }) }),
                      /* @__PURE__ */ b(Lt.Content, { children: /* @__PURE__ */ b("p", { children: "The maximum number of items that can be selected." }) })
                    ] })
                  }
                ),
                /* @__PURE__ */ B("label", { children: [
                  /* @__PURE__ */ b("span", { className: "edit-label column-heading", children: "Default Value Set By Query String Parameter" }),
                  /* @__PURE__ */ b(
                    "input",
                    {
                      type: "text",
                      value: p.setByQueryParameter,
                      onChange: (_) => {
                        s("setByQueryParameter", h, _.target.value);
                      }
                    }
                  )
                ] }),
                /* @__PURE__ */ b(
                  mn,
                  {
                    ...
                    label: "Filter Order",
                    updateField: (_, O, y, v) => {
                      s("order", h, v), p.orderColumn && v !== "column" && s("orderColumn", h, "");
                    },
                    options: Pi
                  }
                ),
                p.order === "cust" && /* @__PURE__ */ b(
                  Ii,
                  {
                    orderedValues: p.orderedValues || p.values,
                    handleFilterOrder: (_, O) => u(_, O, h)
                  }
                ),
                p.order === "column" && /* @__PURE__ */ b(
                  mn,
                  {
                    value: p.orderColumn,
                    fieldName: "orderColumn",
                    label: "Order Column",
                    updateField: (_, O, y, v) => s("orderColumn", h, v),
                    options: o
                  }
                )
              ] }) : /* @__PURE__ */ b(
                Z_,
                {
                  ...
                  filterIndex: h,
                  rawData: n,
                  handleGroupingCustomOrder: (_, O) => u(_, O, h),
                  handleNameChange: (_) => c(h, _),
                  updateField: t,
                  updateFilterStyle: l
                }
              ),
              /* @__PURE__ */ B("label", { children: [
                /* @__PURE__ */ B("span", { className: "edit-label column-heading", children: [
                  "Filter Parents",
                  " ",
                  /* @__PURE__ */ B(Lt, { style: { textTransform: "none" }, children: [
                    /* @__PURE__ */ b(Lt.Target, { children: /* @__PURE__ */ b(Xn, { display: "question", style: { marginLeft: "0.5rem" } }) }),
                    /* @__PURE__ */ b(Lt.Content, { children: /* @__PURE__ */ b("p", { children: "A selected parent's value will be used to filter the available options of this child filter." }) })
                  ] })
                ] }),
                /* @__PURE__ */ b(
                  ed,
    ...
    !e.filters && /* @__PURE__ */ b("p", { style: { textAlign: "center" }, children: "There are currently no filters." }),
    /* @__PURE__ */ b("button", { type: "button", onClick: d, className: "btn btn-primary full-width", children: "Add Filter" })
  ] });
}, W0 = ({
  label: e,
  sliderType: t = "flat",
  ...
  const [h, g] = S.useState(l);
  let m = () => {
    let y = "";
    return o && (y += o + "-"), i && (y += i + "-"), s && (y += s), y;
  };
  const _ = () => ({
    flat: " slider--flat",
    block: " slider--block",
  ...
  return /* @__PURE__ */ B("div", { className: "input-group", children: [
    e && /* @__PURE__ */ b("label", { children: e }),
    /* @__PURE__ */ B(
      "div",
      {
        ...
        onClick: O,
        children: [
          /* @__PURE__ */ b("div", { className: "cove-input__slider-button" }),
          /* @__PURE__ */ b(
            "div",
            {
          ...
          /* @__PURE__ */ b("input", { className: "cove-input--hidden", type: "checkbox", name: m(), checked: h || !1, readOnly: !0 })
        ]
      }
    )
  ] });
}, H0 = S.createContext({ displayName: "ConfigContext", setTempConfig: () => {
} }), q0 = S.createContext(() => {
});
export {
  g0 as $,
