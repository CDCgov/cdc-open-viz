...
<<<<<<< HEAD
                        {runtime.yAxis.gridLines ? <Line display={(config.useLogScale && showTicks).toString()} from={{ x: tick.from.x + xMax, y: tick.from.y }} to={tick.from} stroke='rgba(0,0,0,0.3)' /> : ''}
=======
...
>>>>>>> 1f899d0ceb23f42358fbcfc2c53c23904152ae5e
