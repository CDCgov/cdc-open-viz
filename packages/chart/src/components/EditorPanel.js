            ...
            <Accordion allowZeroExpanded={true}>
              <AccordionItem> {/* General */}
                ...
                <AccordionItemPanel>
                  ...
                  {config.visualizationType === 'Bar' &&  <Select value={config.barStyle || 'flat'} fieldName="barStyle" label="bar style" updateField={updateField} options={[ 'flat','rounded','lollipop']}/>}
