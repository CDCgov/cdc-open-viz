                        ...
                        >
                            {(barGroups) => {
                                ...
                                return barGroups.map((barGroup, index) => (
                                    <Group className={`bar-group-${barGroup.index}-${barGroup.x0}--${index}`} key={`bar-group-${barGroup.index}-${barGroup.x0}--${index}`} top={config.runtime.horizontal ? (yMax / barGroups.length) * barGroup.index : 0} left={config.runtime.horizontal ? 0 : (xMax / barGroups.length) * barGroup.index}>
