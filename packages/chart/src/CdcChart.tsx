...
export default function CdcChart({
  ...
  if (!loading) {
    ...
    body = (
      <LayoutTemplate
        ...
        handleAriaLabels={handleChartAriaLabels}
      ...
      >
        ...
        <div className={getChartWrapperClasses().join(' ')}>
          <LegendWrapper>
            ...
            >
              <Layout.IntroText text={config.introText} config={config} />
  ...
  return <ConfigContext.Provider value={contextValues}>{body}</ConfigContext.Provider>
}
