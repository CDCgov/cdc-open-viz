...
| `visualizations.*.filterSectionTitle` | `string` | No | `''` | Heading shown above this dashboard filter widget's intro text and controls. | Renders with the shared small title treatment. |
