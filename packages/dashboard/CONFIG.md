...
| `dashboard.sharedFilters[].resetLabel` | `string` | No | None | Reset option label and nested-dropdown empty-state placeholder. | Often shown as `All`, `Reset`, or a File Name search prompt such as `Type to search for a disease`. |
