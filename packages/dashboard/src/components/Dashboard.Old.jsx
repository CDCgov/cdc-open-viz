  ...
  if (viewMode.isEditor && !preview) {
    ...
    Object.keys(config.visualizations).forEach(visualizationKey => {
      ...
      if (filteredData && filteredData[visualizationKey]) {
        ...
        updateConfigField('visualizations', visualizationKey, 'data', filteredData[visualizationKey])
        if (visualizationConfig.formattedData) {
          // visualizationConfig.originalFormattedData = visualizationConfig.formattedData
          // visualizationConfig.formattedData = visualizationConfig.data
          updateConfigField('visualizations', visualizationKey, 'originalFormattedData', visualizationConfig.formattedData)
          updateConfigField('visualizations', visualizationKey, 'formattedData', visualizationConfig.data)
        }
      } else {
        // visualizationConfig.data = data[dataKey]
        updateConfigField('visualizations', visualizationKey, 'data', data[dataKey])
        if (visualizationConfig.formattedData) {
          // visualizationConfig.originalFormattedData = visualizationConfig.formattedData
          updateConfigField('visualizations', visualizationKey, 'originalFormattedData', visualizationConfig.formattedData)
          ...
          updateConfigField('visualizations', visualizationKey, 'formattedData', transform.developerStandardize(visualizationConfig.data, visualizationConfig.dataDescription) || visualizationConfig.data)
        }
      }
