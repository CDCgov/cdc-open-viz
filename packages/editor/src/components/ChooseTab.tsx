...
import ComboChartIcon from '@cdc/core/assets/icon-combo-chart.svg?react'
import EpiChartIcon from '@cdc/core/assets/icon-epi-chart.svg?react'
import TableIcon from '@cdc/core/assets/icon-table.svg?react'
