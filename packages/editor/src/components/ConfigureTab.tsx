...
import CdcChart from '@cdc/chart/src/CdcChartComponent' // TODO: Lazy load this
    ...
    case 'chart':
      return (
        <ErrorBoundary component='CdcChart'>
          <CdcChart isEditor={true} isDebug={isDebug} config={config} data={config.data} setConfig={setTempConfig} />
        </ErrorBoundary>
      )
    case 'dashboard':
      return (
