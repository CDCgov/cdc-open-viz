...
# globalSlice
The **globalSlice** of the [COVE store](./?path=/docs/store-cove-store--docs) contains global state that is used throughout the application. This includes general data like viewport information, operating system, modal states, and more.
