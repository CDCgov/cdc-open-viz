...
# visConfigSlice
The **visConfigSlice** of the COVE store contains the state for visualization configurations. This includes the current visualization type, configuration settings, and the data.
