  ...
  ({
    ...
    const TooltipLabel = () => {
      ...
      return (
        <div className='cove-input__checkbox-group__label' {...labelProps}>
          <Label tooltip={tooltip} onClick={onClickHandler}>
            {label}
          </Label>
        </div>
      )
    ...
    return (
      <div className={generateWrapperClasses()} flow={labelPosition}>
        ...
        >
          <div className={`cove-input__checkbox-box${activeColor ? ' cove-input__checkbox-box--custom-color' : ''}`} style={value && activeColor ? { backgroundColor: activeColor } : null}>
