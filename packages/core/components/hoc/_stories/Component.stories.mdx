...
<Meta
  ...
  argTypes={{
    ...
    'config.title': {
      description: "[External] Set a custom title for the component header section"
    },
    'config.description': {
      description: "[External] Supply a description or subtext for the component's content"
    },
    'config.visual': {
      description: "[External] An object containing visual definitions for the component"
    },
    ...
    'config.visual.shadow': {
      description: "[External] Enable/disable the display of the drop-shadow on the Component",
    },
    'config.visual.accent': {
      description: "[External] Set the position of the accent border display on the Component <br/><br/> `'top'` `'right'` `'bottom'` `'left'`",
    }
  }}
/>
