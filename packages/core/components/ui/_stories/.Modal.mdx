...
export const ButtonTemplate = ({ header, content, footer, ...args }) => {
...
<Canvas>
  <Story
    ...
    args={{
      ...
      content: 'This is a popup modal with general information. This serves as an example of how interaction with the modal is intended to work.',
      fontTheme: 'light',
      headerBgColor: '#824c88'
    }}
  >
    {ButtonTemplate.bind({})}
  </Story>
  ...
  <Story name="BgCloseDisabled">
    {() => {
      ...
      return (
        <Button onClick={
          () => openOverlay(
            <Modal fontTheme={'light'} headerBgColor={'#824c88'}>
              <Modal.Header>
                Example Modal
              </Modal.Header>
              <Modal.Content>
...
<Canvas withSource='open'>
  <Story name='Example #2'>
    <Modal fontTheme={'light'} headerBgColor={'#363955'} showDividerBottom={false}>
      <Modal.Header>General Information Modal</Modal.Header>
      <Modal.Content>
        <p>This is a modal with some general information. Anything can go here, to provide details or explain information further. The modal can contain as much information as needed, in order to provide the proper context for the content.</p>
      </Modal.Content>
      <Modal.Footer>
        <sub>
          <em>Last updated 01/02/34</em>
        </sub>
      </Modal.Footer>
    </Modal>
  </Story>
  ...
  <Story name='Example #3'>
    <Modal fontTheme={'light'} headerBgColor={'#d73636'} showClose={false}>
      ...
      <Modal.Footer>
        ...
        <div style={{ textAlign: 'center' }}>
          <Button className='warn' onClick={e => e.preventDefault()}>
            No, Cancel
          </Button>
          <Button className='success' onClick={e => e.preventDefault()}>
            Yes, Continue
          </Button>
        </div>
      </Modal.Footer>
