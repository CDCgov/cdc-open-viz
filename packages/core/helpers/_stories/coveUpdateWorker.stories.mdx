...
# coveUpdateWorker
The coveUpdateWorker is a config worker used to update COVE config data automatically. It allows for key values to be updated with new values, transferred to new key entries, and/or removed from the config entirely.
