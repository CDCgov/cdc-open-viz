...
const EXEMPT_FROM_COVE_PROSE = new Set([
  // Editor highlighting markup is generated by internal UI logic and is not user-authored prose.
  'packages/core/components/EditorPanel/components/MarkupHighlightedTextField.tsx',
...
describe('cove-prose contract coverage', () => {
  it('requires .cove-prose near parse() and dangerouslySetInnerHTML render sites', () => {
    ...
    for (const filePath of sourceFiles) {
      ...
      if (EXEMPT_FROM_COVE_PROSE.has(relPath)) continue
