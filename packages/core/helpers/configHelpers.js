export const setConfigKeyValue = (configKeyArray, setKeyValue) => {
  ...
  return configKeyArray.reduceRight((acc, configKey, index, array) => {
    return index + 1 === array.length ? { [configKey]: setKeyValue } : { [configKey]: acc }
  }, {})
}

export const getConfigKeyValue = (configKeyArray, object) => {
  /**
