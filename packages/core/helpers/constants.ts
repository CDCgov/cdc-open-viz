...
export const TREND_ARROW_TYPE_NO_CHANGE = 'no-change'

export const TREND_ARROW_TYPES = [TREND_ARROW_TYPE_UP, TREND_ARROW_TYPE_DOWN, TREND_ARROW_TYPE_NO_CHANGE]

export const TREND_ARROW_TYPE_LABELS = {
  [TREND_ARROW_TYPE_UP]: 'Up',
  [TREND_ARROW_TYPE_DOWN]: 'Down',
  [TREND_ARROW_TYPE_NO_CHANGE]: 'No Change'
}
