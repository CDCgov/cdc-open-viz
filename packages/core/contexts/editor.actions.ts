...
import { type AnyVisualization } from '@cdc/dashboard/src/types/AnyVisualization'
import { type DataSet } from '@cdc/core/types/DataSet'

type EDITOR_SAVE = Action<'EDITOR_SAVE', AnyVisualization>
type EDITOR_SET_CONFIG = Action<'EDITOR_SET_CONFIG', AnyVisualization>
type EDITOR_TEMP_SAVE = Action<'EDITOR_TEMP_SAVE', AnyVisualization>
