...
export default ( { backgroundColor } ) => {
	...
	return (
		<section style={ styleObj } className="container mt-5">
			...
			<p>
				This is an example component showing foundational React concepts
				like state, props and JSX. View the source code for more helpful
				information.
			</p>
			<p>
				Before using this starter kit it&apos;s very important that you
				read the{ ' ' }
				<a href="https://github.com/CDCgov/react-starter-kit/blob/master/README.md">
					documentation
				</a>{ ' ' }
				which contains helpful tips and guidelines to adhere to when
				creating your codebase that keep things easy to understand and
				maintainable for the entire team.
			</p>
			<h4 className="mt-4 mb-2">Example 1 - Local State</h4>
			<p>
				This example is simple. There&apos;s a piece of state held in
				the <code>Example.js</code> component that is a number. Clicking
				the first button increments by one. Clicking the reset button
				simply sets the state to 0.
			</p>
			<p className="h5 mt-3">
				<strong>
			...
			<p className="pb-3">
				Here&apos;s an example on how to hook up a text field that also
				uses React&apos;s{ ' ' }
				<a href="https://reactjs.org/docs/context.html">Context API</a>.
				The text based piece of state that is the title is stored in the
				parent component, <code>App.js</code> but you can access it and
				change it here. Refer to the README for more information.
			</p>
			<form>
