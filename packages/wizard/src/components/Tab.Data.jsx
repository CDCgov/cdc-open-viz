          ...
          {(!config.data || !config.dataFileSourceType) && (   // dataFileSourceType needs to be checked here since earlier versions did not track this state
            <>
              ...
              <ul className="cove-wizard__data-samples">
                <li>
                  <span onClick={() => loadData(new Blob([ validMapData ], { type: 'text/csv' }), 'valid-data-map.csv')}>United States Sample Data #1</span>
                </li>
                <li>
                  <span onClick={() => loadData(new Blob([ validChartData ], { type: 'text/csv' }), 'valid-data-chart.csv')}>Chart Sample Data</span>
                </li>
                <li>
                  <span onClick={() => loadData(new Blob([ validCountyMapData ], { type: 'text/csv' }), 'valid-county-data.csv')}>United States Counties Sample Data</span>
                </li>
              </ul>
            ...
            <>
              ...
              <div className="mb-2">
                ...
                <div className="cove-grid cove-grid--gap--2 mb-4">
                  <div className="cove-grid__col--12 cove-grid__col--xl-6">
                    <button
              ...
              <div style={{ textAlign: 'right' }}>
                <Button className="mt-2" onClick={() => globalActions.setWizardActiveTab(1)}
