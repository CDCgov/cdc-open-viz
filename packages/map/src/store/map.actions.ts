import { type MapConfig, type MapPosition } from '../types/MapConfig'
...
type SET_POSITION = Action<'SET_POSITION', MapPosition>
...
type SET_RUNTIME_BUBBLE_LEGEND = Action<'SET_RUNTIME_BUBBLE_LEGEND', RuntimeLegend | RuntimeLegend[] | []>
