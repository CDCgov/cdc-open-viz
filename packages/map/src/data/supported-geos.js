...
export const supportedCities = {
  ...
  'ARCTIC SLOPE NATIVE ASSOICATION LIMITED': [-156.79225, 71.2907],
  'CHEROKEE NATION': [-94.971725, 35.91169],
  'CHEYENNE RIVER SIOUX TRIBE': [-101.2397, 45.00084],
  'FOND DU LAC RESERVATION': [-92.46117, 46.71961],
  "GREAT PLAINS TRIBAL CHAIRMEN'S HEALTH BOARD": [-103.22444, 44.083054],
  'HOPI TRIBE': [-110.61761, 35.876884],
  'INTER-TRIBAL COUNCIL OF MICHIGAN, INC.': [-103.22444, 44.083054],
  'KAW NATION OF OKLAHOMA': [-97.0534, 36.8823],
  'NAVAJO NATION': [-109.067413, 35.67897],
  'SOUTH PUGET INTERTRIBAL PLANNING AGENCY': [-123.09899, 47.210484],
  'SOUTHEAST ALASKA REGIONAL HEALTH CONSORTIUM': [-135.3369, 57.05479],
  'YUKON-KUSKOKWIM HEALTH CORPORATION': [-161.78215, 60.804882]
}
