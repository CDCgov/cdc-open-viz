...
| `general.usTerritoriesLabel` | `string` | No | `U.S. territories` | Customizes the heading above U.S. territories on U.S. state maps. | Use this field for translated or alternate copy. An omitted value falls back to `U.S. territories`. |
| `general.freelyAssociatedStatesLabel` | `string` | No | `Freely associated states` | Customizes the heading above freely associated states on U.S. state maps. | Use this field for translated or alternate copy. An omitted value falls back to `Freely associated states`. |
