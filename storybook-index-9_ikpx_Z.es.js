import { g as $t } from "./storybook-_commonjsHelpers-BkfeUUK-.es.js";
function Ft(j, l) {
...
function xt() {
  ...
  function H(t, o, p) {
    ...
    if (o != null) for (y in o.ref !== void 0 && (E = o.ref), o.key !== void 0 && (w = "" + o.key), o) O.call(o, y) && !N.hasOwnProperty(y) && (h[y] = o[y]);
    var R = arguments.length - 2;
    if (R === 1) h.children = p;
    else if (1 < R) {
      for (var g = Array(R), k = 0; k < R; k++) g[k] = arguments[k + 2];
      h.children = g;
    }
  ...
  function X(t, o, p, y, h) {
    ...
    if (E) return E = t, h = h(E), t = y === "" ? "." + ie(E, 0) : y, M(h) ? (p = "", t != null && (p = t.replace(ye, "$&/") + "/"), X(h, o, p, "", function(k) {
      return k;
    })) : h != null && (ue(h) && (h = ve(h, p + (!h.key || E && E.key === h.key ? "" : ("" + h.key).replace(ye, "$&/") + "/") + t)), o.push(h)), 1;
    if (E = 0, y = y === "" ? "." : y + ":", M(t)) for (var R = 0; R < t.length; R++) {
      w = t[R];
      var g = y + ie(w, R);
      E += X(w, o, p, g, h);
    }
    else if (g = oe(t), typeof g == "function") for (t = g.call(t), R = 0; !(w = t.next()).done; ) w = w.value, g = y + ie(w, R++), E += X(w, o, p, g, h);
  ...
  return d.Children = { map: I, forEach: function(t, o, p) {
    ...
    if (o != null) {
      ...
      for (g in o) O.call(o, g) && !N.hasOwnProperty(g) && (y[g] = o[g] === void 0 && R !== void 0 ? R[g] : o[g]);
    }
    var g = arguments.length - 2;
    if (g === 1) y.children = p;
    else if (1 < g) {
      R = Array(g);
      for (var k = 0; k < g; k++) R[k] = arguments[k + 2];
      y.children = R;
    }
    ...
    process.env.NODE_ENV !== "production" && function() {
      ...
      function _e(e, r, n, a, u) {
        ...
        if (i) {
          ...
          } else v != null && (Z(v) && (v.key && (!f || f.key !== v.key) && ge(v.key), v = Lr(
            v,
