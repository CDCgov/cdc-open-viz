...
import { I as Hs } from "./storybook-Icon-9a8d8f01.es.js";
...
const ag = ({ rawData: e, fileName: A, headerColor: t, skipId: r }) => {
  ...
  let a = [];
  e.visualizationType !== "Pie" ? (a = A ? [(c = e.xAxis) == null ? void 0 : c.dataKey] : [], e.runtime.series ? e.runtime.series.forEach((g) => {
    a.push(g.dataKey);
