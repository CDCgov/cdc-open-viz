...
import { j as S, a as he, F as Ar } from "./storybook-jsx-runtime-36872362.es.js";
...
import { N as gu } from "./storybook-NestedDropdown-00da5d7e.es.js";
...
Oe.iterable && (ge.prototype[Symbol.iterator] = ge.prototype.entries);
function _n(e) {
  if (!e._noBody) {
    if (e.bodyUsed)
...
function pt(e, t) {
  ...
  if (e instanceof pt) {
    ...
    this.url = String(e);
  if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new ge(t.headers)), this.method = wu(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || function() {
...
function Si(e, t) {
  return new Promise(function(n, r) {
    ...
    if (i.open(o.method, u(o.url), !0), o.credentials === "include" ? i.withCredentials = !0 : o.credentials === "omit" && (i.withCredentials = !1), "responseType" in i && (Oe.blob ? i.responseType = "blob" : Oe.arrayBuffer && (i.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof ge || Ae.Headers && t.headers instanceof Ae.Headers)) {
      var c = [];
...
Si.polyfill = !0;
Ae.fetch || (Ae.fetch = Si, Ae.Headers = ge, Ae.Request = pt, Ae.Response = Je);
function Ni(e, t) {
  if (e == null)
    return {};
      ...
      var y = u(function() {
        var g = !1, F, x, P = function(L) {
          ...
          if (r(z, L))
            return ce;
          var ne = p(L);
          return E !== void 0 && E(ce, ne) ? ce : (F = L, x = ne, ne);
        }, B = d === void 0 ? null : d, I = function() {
          return P(a());
        }, V = B === null ? void 0 : function() {
          return P(B());
        };
        return [I, V];
...
function Yu() {
  return xo || (xo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var g = c, F = l, x = u, P = s, B = t, I = f, V = r, L = E, M = p, U = n, z = i, ce = o, ne = a, Y = !1;
    function me(O) {
      return Y || (Y = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), re(O) || b(O) === c;
    }
    function re(O) {
      return b(O) === l;
    }
    ...
    Z.AsyncMode = g, Z.ConcurrentMode = F, Z.ContextConsumer = x, Z.ContextProvider = P, Z.Element = B, Z.ForwardRef = I, Z.Fragment = V, Z.Lazy = L, Z.Memo = M, Z.Portal = U, Z.Profiler = z, Z.StrictMode = ce, Z.Suspense = ne, Z.isAsyncMode = me, Z.isConcurrentMode = re, Z.isContextConsumer = Ce, Z.isContextProvider = de, Z.isElement = fe, Z.isForwardRef = k, Z.isFragment = R, Z.isLazy = J, Z.isMemo = pe, Z.isPortal = X, Z.isProfiler = H, Z.isStrictMode = Ee, Z.isSuspense = xe, Z.isValidElementType = v, Z.typeOf = b;
  }()), Z;
}
...
function ia() {
  return Vo || (Vo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var F = s, x = i, P = e, B = c, I = n, V = d, L = a, M = t, U = o, z = r, ce = l, ne = f, Y = !1, me = !1;
    function re(_) {
    ...
    te.ContextConsumer = F, te.ContextProvider = x, te.Element = P, te.ForwardRef = B, te.Fragment = I, te.Lazy = V, te.Memo = L, te.Portal = M, te.Profiler = U, te.StrictMode = z, te.Suspense = ce, te.SuspenseList = ne, te.isAsyncMode = re, te.isConcurrentMode = Ce, te.isContextConsumer = de, te.isContextProvider = fe, te.isElement = k, te.isForwardRef = R, te.isFragment = J, te.isLazy = pe, te.isMemo = X, te.isPortal = H, te.isProfiler = Ee, te.isStrictMode = xe, te.isSuspense = O, te.isSuspenseList = le, te.isValidElementType = b, te.typeOf = g;
  }()), te;
}
  ...
  return (D) => {
    ...
    function b(x) {
      const [P, B, I] = C.useMemo(() => {
        ...
        return [x.context, O, le];
      }, [x]), V = C.useMemo(() => P && P.Consumer && // @ts-ignore
      Lo.isContextConsumer(/* @__PURE__ */ C.createElement(P.Consumer, null)) ? P : f, [P, f]), L = C.useContext(V), M = !!x.store && !!x.store.getState && !!x.store.dispatch, U = !!L && !!L.store;
      ...
      const z = M ? x.store : L.store, ce = U ? L.getServerState : z.getState, ne = C.useMemo(() => ca(z.dispatch, v), [z]), [Y, me] = C.useMemo(() => {
        if (!E)
          return va;
        const O = Vi(z, M ? void 0 : L.subscription), le = O.notifyNestedSubs.bind(O);
        return [O, le];
      }, [z, M, L]), re = C.useMemo(() => M ? L : Et({}, L, {
        subscription: Y
      }), [M, L, Y]), Ce = C.useRef(), de = C.useRef(I), fe = C.useRef(), k = C.useRef(!1);
      C.useRef(!1);
      const R = C.useRef(!1), J = C.useRef();
      mn(() => (R.current = !0, () => {
        R.current = !1;
      }), []);
      const pe = C.useMemo(() => () => fe.current && I === de.current ? fe.current : ne(z.getState(), I), [z, I]), X = C.useMemo(() => (le) => Y ? wa(
        E,
        z,
        Y,
        // @ts-ignore
...
`), O;
      ...
      mn(() => {
        J.current = void 0, fe.current = void 0, Ce.current = H;
      });
      const Ee = C.useMemo(() => (
        // @ts-ignore
        /* @__PURE__ */ C.createElement(D, Et({}, H, {
          ref: B
        }))
      ), [B, D, H]);
      return C.useMemo(() => E ? /* @__PURE__ */ C.createElement(V.Provider, {
        value: re
      }, Ee) : Ee, [V, Ee, re]);
    }
    const F = C.memo(b);
    if (F.WrappedComponent = D, F.displayName = b.displayName = A, c) {
      const P = C.forwardRef(function(I, V) {
...
var K = $i, T = Ba, xa = process.env.NODE_ENV === "production", Mn = "Invariant failed";
function Go(e, t) {
  if (!e) {
    if (xa)
      throw new Error(Mn);
...
const $t = Ta, Va = process.env.NODE_ENV === "production", La = /[ \t]{2,}/g, ja = /^[ \t]*/gm, zo = (e) => e.replace(La, " ").replace(ja, "").trim(), $a = (e) => zo(`
  %c@hello-pangea/dnd
...
function h(e, t) {
  if (!e)
    throw Wa ? new Mt(Ho) : new Mt(`${Ho}: ${t || ""}`);
}
...
const ve = {
  ...
  x: n,
  y: t
}, kt = (e, t) => Math.sqrt((t.x - e.x) ** 2 + (t.y - e.y) ** 2), Yo = (e, t) => Math.min(...t.map((n) => kt(e, n))), zi = (e) => (t) => ({
  x: e(t.x),
  y: e(t.y)
});
var Ja = (e, t) => {
...
const Yt = (e, t) => ({
  ...
  bottom: 0,
  left: 0
}, Qa = (e, t) => t ? Yt(e, t.scroll.diff.displacement) : e, Za = (e, t, n) => n && n.increasedBy ? {
  ...e,
...
const Hi = ye((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), qi = ye((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), wn = ye((e) => Object.values(e)), tc = ye((e) => Object.values(e));
var mt = ye((e, t) => tc(t).filter((r) => e === r.descriptor.droppableId).sort((r, o) => r.descriptor.index - o.descriptor.index));
function Rr(e) {
...
var Nn = ye((e, t) => t.filter((n) => n.descriptor.id !== e.descriptor.id)), nc = ({
  isMovingForward: e,
  draggable: t,
  destination: n,
  insideDestination: r,
...
var wc = ({
  ...
  const i = Zi(t, Fe(t.scroll.current, o)), s = n.frame ? Pr(n, Fe(n.frame.scroll.current, o)) : n, u = e.displaced, c = Wt({
...
var Oc = ({
  ...
  if (!i)
    return null;
  const s = n.axis, u = Ue(i[s.start], i[s.end]), c = wn(r).filter((f) => f !== n).filter((f) => f.isEnabled).filter((f) => !!f.subject.active).filter((f) => Ki(o.frame)(Ne(f))).filter((f) => {
    const a = Ne(f);
...
const Ic = (e, t, n) => {
  ...
  const o = Kt(e.axis, t.displaceBy).point, i = Ic(e, o, n), s = {
    placeholderSize: o,
    increasedBy: i,
...
var us = ({
  ...
  const i = e.displaced, s = qc(i.all, n), u = Wt({
    afterDragging: s,
    destination: r,
    displacedBy: e.displacedBy,
    viewport: t.frame,
...
const rd = ye((e) => wn(e).filter((t) => !(!t.isEnabled || !t.frame))), od = (e, t) => rd(t).find((r) => (r.frame || (process.env.NODE_ENV !== "production" ? h(!1, "Invalid result") : h(!1)), rs(r.frame.pageMarginBox)(e))) || null;
var id = ({
  center: e,
  destination: t,
  droppables: n
...
function Fd(e, t) {
  const n = K(() => Cd(e), [e]), r = C.useRef(null), o = C.useRef(null), i = T(ye((a) => {
    const d = o.current;
  ...
  const u = T(() => i(n.dragging), [i, n.dragging]), c = T((a) => {
    if (a === "DROP") {
      i(n.dropAnimating);
      return;
    }
...
function Ss(e, t) {
  ...
  return o ? Qt(o) ? o : (process.env.NODE_ENV !== "production" && ie("drag handle needs to be a HTMLElement"), null) : (process.env.NODE_ENV !== "production" && ie(`Unable to find drag handle with id "${t}" as no handle with a matching id was found`), null);
}
function wd(e) {
  const t = C.useRef({}), n = C.useRef(null), r = C.useRef(null), o = C.useRef(!1), i = T(function(d, p) {
    const E = {
      id: d,
      focus: p
    };
...
function Id(e) {
  const t = K(() => xd(e), [e]), n = C.useRef(null);
  return C.useEffect(function() {
    const i = document.createElement("div");
    return n.current = i, i.id = t, i.setAttribute("aria-live", "assertive"), i.setAttribute("aria-atomic", "true"), Et(i.style, Bd), Ht().appendChild(i), function() {
      setTimeout(function() {
        const c = Ht();
...
function Pd(e, t = Ns) {
  return K(() => `${e}${t.separator}${_d++}`, [t.separator, e]);
}
function Rd(e, t = Ns) {
  const n = N.useId();
...
var Md = (e, t) => {
  const n = li(e), r = li(t);
  $d(n, r) || process.env.NODE_ENV !== "production" && ie(`
    React version: [${r.raw}]
...
function of(e) {
  const t = C.useRef(fi), n = C.useRef(tt), r = K(() => ({
    eventName: "mousedown",
    fn: function(a) {
...
function Df(e) {
  const t = C.useRef(Yn), n = C.useRef(tt), r = T(function() {
    return t.current;
  }, []), o = T(function(p) {
    t.current = p;
  }, []), i = K(() => ({
...
function Af(e, t) {
  ...
  return o ? Qt(o) ? o : (process.env.NODE_ENV !== "production" && ie("drag handle must be a HTMLElement"), null) : null;
}
function Ff(e, t) {
  const n = Af(e, t);
...
function wf(e, t) {
  ...
  return o ? Qt(o) ? o : (process.env.NODE_ENV !== "production" && ie("Draggable element is not a HTMLElement"), null) : null;
}
function Sf(e) {
  e.preventDefault();
}
...
function Bf({
  ...
  const i = [...o ? Of : [], ...r || []], s = C.useState(() => Wd())[0], u = T(function(D, y) {
...
function _f(e) {
  ...
  Gd();
  const u = Jr(e), c = T(() => xf(u.current), [u]), l = T(() => If(u.current), [u]), f = Id(t), a = Vd({
    contextId: t,
    text: i
  }), d = Fd(t, o), p = T((I) => {
    Bt(s).dispatch(I);
  ...
  }, p), [p]), m = Nd(), D = K(() => td(m, E), [m, E]), y = K(() => Ed({
    scrollWindow: nd,
  ...
  }), [D.scrollDroppable, p, l]), A = wd(t), v = K(() => Xl({
    announce: f,
    autoScroller: y,
    dimensionMarshal: D,
    focusMarshal: A,
  ...
  n(F);
  const x = T((I) => ys(Bt(s).getState(), I), []), P = T(() => ct(Bt(s).getState()), []), B = K(() => ({
    marshal: D,
    focus: A,
    contextId: t,
    canLift: x,
...
function XD(e) {
  const t = Vf(), n = e.dragHandleUsageInstructions || fn.dragHandleUsageInstructions;
...
const Yf = (e) => {
  const t = C.useRef(null), n = T((F = null) => {
    t.current = F;
  }, []), r = T(() => t.current, []), {
    contextId: o,
...
const Zr = (e) => (t) => e === t, ip = Zr("scroll"), sp = Zr("auto"), up = Zr("visible"), Di = (e, t) => t(e.overflowX) || t(e.overflowY), ap = (e, t) => t(e.overflowX) && t(e.overflowY), $s = (e) => {
  ...
  return ap(r, up) || process.env.NODE_ENV !== "production" && ie(`
...
function gp(e) {
  const t = C.useRef(null), n = yn(Bn), r = Yr("droppable"), {
    ...
    type: e.type,
    mode: e.mode
  }), [e.droppableId, e.mode, e.type]), c = C.useRef(u), l = K(() => ye((b, g) => {
    ...
    }), V = P.closestScrollable;
    return V && (V.setAttribute(ai.contextId, n.contextId), V.addEventListener("scroll", p, mi(B.scrollOptions)), process.env.NODE_ENV !== "production" && lp(V)), I;
  }, [n.contextId, u, p, s]), m = T(() => {
    const b = t.current, g = un(b);
...
const Np = (e) => {
  ...
  } = e, A = T(() => o.current, []), v = T((L = null) => {
    o.current = L;
  }, []), b = T(() => i.current, []), g = T((L = null) => {
    i.current = L;
  }, []);
  wp({
    props: e,
  ...
  const x = K(() => N.createElement(Sp, {
    ...
    contextId: n,
    onTransitionEnd: F
  })), [n, F, e.placeholder, e.shouldAnimatePlaceholder, g]), P = K(() => ({
    innerRef: v,
    placeholder: x,
    droppableProps: {
  ...
  }), [n, u, x, v]), B = m ? m.dragging.draggableId : null, I = K(() => ({
    droppableId: u,
    type: c,
    isUsingCloneFor: B
  }), [u, B, c]);
...
Couldn't access "${n}" in ${JSON.stringify(e)}`);
}, bi = (e) => typeof e == "object" && e !== null && !Array.isArray(e), pn = (e) => Array.isArray(e), Us = (e, t) => e.filter((n, r) => r !== t), Rp = (e, t, n, r = {}) => {
  ...
  return pn(e) && o && a.length === 1 ? Us(e, a[0]) : It(e, a, n, f);
}, It = (e, t, n, r) => {
  ...
  if (u && t.length === 2 && typeof t[1] == "number") {
    const m = d[a], D = t[1];
    return pn(m) ? d[a] = Us(m, D) : dt(l, f, a, c, "Trying to remove an indexed item from an object that is not an array"), d;
  }
  const p = t.slice(1);
  if (a in e) {
    if (E = d[a], !pn(E) && !bi(E)) {
...
`:
  ...
  value() {
    switch (q) {
      case "{":
      case "[":
        return ue("punctuator", w());
      case "n":
        return w(), st("ull"), ue("null", null);
      case "t":
        return w(), st("rue"), ue("boolean", !0);
      case "f":
        return w(), st("alse"), ue("boolean", !1);
      case "-":
      case "+":
        w() === "-" && (Xe = -1), W = "sign";
        return;
      ...
      case "9":
        ...
        return;
      case "I":
        return w(), st("nfinity"), ue("numeric", 1 / 0);
      case "N":
        return w(), st("aN"), ue("numeric", NaN);
      case '"':
      case "'":
        _t = w() === '"', G = "", W = "string";
        return;
  ...
  sign() {
    switch (q) {
      ...
      case "9":
        ...
        return;
      case "I":
        return w(), st("nfinity"), ue("numeric", Xe * (1 / 0));
      case "N":
        return w(), st("aN"), ue("numeric", NaN);
    }
    throw ae(w());
...
function zp() {
  let e = "", t = Ze();
  if (!De.isHexDigit(t) || (e += w(), t = Ze(), !De.isHexDigit(t)))
    throw ae(w());
...
` + D + "}";
  ...
  function p(m) {
    ...
    if (!De.isIdStartChar(D))
      return a(m);
    for (let y = D.length; y < m.length; y++)
      if (!De.isIdContinueChar(String.fromCodePoint(m.codePointAt(y))))
        return a(m);
    return m;
  }
  function E(m) {
...
const Ys = ({ className: e, name: t, value: n, setValue: r, handleKeyPress: o, styles: i }) => {
  const s = n.slice(-1) === `
` ? n + "." : n;
  return he("div", { style: { display: "grid" }, children: [S("textarea", { id: `${t}_textarea`, style: Object.assign({ height: "auto", gridArea: "1 / 1 / 2 / 2", overflowY: "auto", whiteSpace: "pre-wrap" }, i), rows: 1, className: e, name: `${t}_textarea`, value: n, onChange: (u) => r(u.target.value), autoFocus: !0, onFocus: (u) => {
  ...
  var t, n, r, o;
  const i = {}, s = (Array.isArray(e) ? e : [e]).map((l) => e === "default" ? {} : typeof l == "string" ? cn(Ks[l], i) : nD(l) ? cn({ fragments: {}, styles: l }, i) : cn(l, i)), u = cn(Zp, {});
  ...
  return C.useEffect(() => {
    l || d(c);
  }, [l]), he("div", { className: "jer-edit-buttons", style: l ? { opacity: 1 } : void 0, children: [r && S("div", { onClick: (D) => {
    let y, A = "value", v = "";
    ...
    o === "object" ? f(!0) : n("");
  }, children: S(ft, { name: "add", nodeData: i }) }), l && n && o === "object" && he(Ar, { children: [S("input", { className: "jer-input-new-key", type: "text", name: "new-object-key", value: a, onChange: (D) => d(D.target.value), autoFocus: !0, onFocus: (D) => D.target.select(), onKeyDown: (D) => {
...
}, to = ({ onOk: e, onCancel: t, nodeData: n }) => he("div", { className: "jer-confirm-buttons", children: [S("div", { onClick: e, children: S(ft, { name: "ok", nodeData: n }) }), S("div", { onClick: t, children: S(ft, { name: "cancel", nodeData: n }) })] }), bD = (e) => e.reduce((t, n) => typeof n == "number" ? `${t}[${n}]` : t === "" ? n : `${t}.${n}`, ""), yD = ["string", "number", "boolean", "null", "object", "array"], Qs = (e = [], t) => {
  ...
  const { data: t, parentData: n, nodeData: r, onEdit: o, onDelete: i, onChange: s, onError: u, showErrorMessages: c, enableClipboard: l, restrictEditFilter: f, restrictDeleteFilter: a, restrictTypeSelection: d, searchFilter: p, searchText: E, showLabel: m, stringTruncate: D, showStringQuotes: y, indent: A, translate: v, customNodeDefinitions: b } = e, { getStyles: g } = et(), { currentlyEditingElement: F, setCurrentlyEditingElement: x, setCollapseState: P } = no(), [B, I] = C.useState(typeof t == "function" ? "**INVALID_FUNCTION**" : t), [V, L] = C.useState(null), { key: M, path: U } = r, z = Qs(b, r), [ce, ne] = C.useState(ln(t, z)), Y = en(U), me = C.useCallback((j) => {
    if (!s)
      return void I(j);
    const se = s({ currentData: r.fullData, newValue: j, currentValue: B, name: M, path: U });
    I(se);
  }, [s]);
  C.useEffect(() => {
    I(typeof t == "function" ? "**INVALID_FUNCTION**" : t), ne(ln(t, z));
  }, [t, V]);
  const re = C.useMemo(() => !f(r), [r]), Ce = C.useMemo(() => !a(r), [r]), de = C.useMemo(() => (j, se) => {
    var Se;
    Se = j.message, c && (L(Se), setTimeout(() => L(null), 2500)), console.warn("Error", Se), u && u({ currentData: r.fullData, errorValue: se, currentValue: B, name: M, path: U, error: j });
  }, [u, c]), { CustomNode: fe, customNodeProps: k, hideKey: R, showEditTools: J = !0, showOnEdit: pe, showOnView: X } = z, H = [...yD, ...b.filter(({ showInTypesSelector: j = !1, name: se }) => j && !!se).map(({ name: j }) => j)], Ee = C.useMemo(() => {
    if (typeof d == "boolean")
      return d ? [] : H;
    if (Array.isArray(d))
      return d;
    const j = d(r);
    return typeof j == "boolean" ? j ? [] : H : j;
  }, [r, d]);
  if (!Zs("value", r, p, E))
    return null;
  const xe = () => {
    ...
    o(j, U).then((se) => {
      se && de({ code: "UPDATE_ERROR", message: se }, j);
    });
  }, O = () => {
    x(null), I(t), ne(ln(t, z));
  }, le = F === Y, _ = F === `key_${Y}`, Pe = typeof U.slice(-1)[0] != "number" && re && Ce, Re = !le && V, Ie = le && Ee.length > 0, we = ce !== "invalid" && !V && J, ke = m && _, Te = m && !_ && !R, qe = { value: B, parentData: n, setValue: me, isEditing: le, setIsEditing: re ? () => x(Y) : () => {
  }, handleEdit: xe, handleCancel: O, path: U, stringTruncate: D, showStringQuotes: y, nodeData: r, translate: v }, Ye = fe && (le && pe || !le && X) ? S(fe, Object.assign({}, e, { value: B, customNodeProps: k, setValue: me, handleEdit: xe, handleCancel: O, handleKeyPress: (j) => {
    j.key === "Enter" ? xe() : j.key === "Escape" && O();
  }, isEditing: le, setIsEditing: () => x(Y), getStyles: g })) : CD(ln(t), qe);
  return S("div", { className: "jer-component jer-value-component", style: { marginLeft: A / 2 + "em" }, children: he("div", { className: "jer-value-main-row", style: { flexWrap: M.length > 10 ? "wrap" : "nowrap" }, children: [Te && he("span", { className: "jer-key-text", style: Object.assign(Object.assign({}, g("property", r)), { minWidth: `${Math.min(String(M).length + 1, 5)}ch`, flexShrink: M.length > 10 ? 1 : 0 }), onDoubleClick: () => Pe && x(`key_${Y}`), children: [M === "" ? S("span", { className: "jer-empty-string" }) : M, ":"] }), ke && S("input", { className: "jer-input-text jer-key-edit", type: "text", name: Y, defaultValue: M, autoFocus: !0, onFocus: (j) => j.target.select(), onKeyDown: (j) => {
    j.key === "Enter" ? ((se) => {
      if (x(null), M === se || !n)
        return;
      const Se = U.slice(0, -1);
      if (Object.keys(n).includes(se))
        return void de({ code: "KEY_EXISTS", message: v("ERROR_KEY_EXISTS", r) }, se);
      const Ve = Object.fromEntries(Object.entries(n).map(([ht, tn]) => ht === M ? [se, tn] : [ht, tn]));
      o(Ve, Se);
    })(j.target.value) : j.key === "Escape" && O();
  }, style: { width: String(M).length / 1.5 + 0.5 + "em" } }), he("div", { className: "jer-value-and-buttons", children: [S("div", { className: "jer-input-component", children: Ye }), le ? S(to, { onOk: xe, onCancel: O, nodeData: r }) : we && S(Xs, { startEdit: re ? () => x(Y) : void 0, handleDelete: Ce ? () => {
    i(B, U).then((j) => {
      j && de({ code: "DELETE_ERROR", message: j }, B);
    });
  } : void 0, enableClipboard: l, translate: v, nodeData: r }), Ie && he("div", { className: "jer-select", children: [S("select", { name: `${M}-type-select`, className: "jer-type-select", onChange: (j) => ((se) => {
    const Se = b.find((Ve) => Ve.name === se);
    if (Se)
      o(Se.defaultValue, U), ne(se);
    else {
      const Ve = AD(B, se, v("DEFAULT_NEW_KEY", r), z != null && z.CustomNode ? v("DEFAULT_STRING", r) : void 0);
      me(Ve), o(Ve, U), P({ path: U, collapsed: !1 }), ne(se);
    }
  })(j.target.value), value: ce, children: Ee.map((j) => S("option", { value: j, children: j }, j)) }), S("span", { className: "focus" })] }), Re && S("span", { className: "jer-error-slug", style: g("error", r), children: V })] })] }) });
}, ln = (e, t) => t != null && t.CustomNode && (t != null && t.name) && t.showInTypesSelector ? t.name : typeof e == "string" ? "string" : typeof e == "number" ? "number" : typeof e == "boolean" ? "boolean" : e === null ? "null" : "invalid", CD = (e, t) => {
  const n = t.value;
  switch (e) {
    case "string":
  ...
  const { getStyles: s } = et(), { collapseState: u, setCollapseState: c, doesPathMatch: l, currentlyEditingElement: f, setCurrentlyEditingElement: a, areChildrenBeingEdited: d } = no(), { onEdit: p, onAdd: E, onDelete: m, onError: D, showErrorMessages: y, restrictEditFilter: A, restrictDeleteFilter: v, restrictAddFilter: b, collapseFilter: g, enableClipboard: F, searchFilter: x, searchText: P, indent: B, keySort: I, showArrayIndices: V, defaultValue: L, translate: M, customNodeDefinitions: U, useJSON5Editor: z } = i, ce = C.useMemo(() => z ? z instanceof Object ? ($) => tr.stringify($, z) : ($) => tr.stringify($, { space: 2 }) : ($) => JSON.stringify($, null, 2), [z]), [ne, Y] = C.useState(ce(t)), [me, re] = C.useState(null), Ce = g(n), [de, fe] = C.useState(Ce), k = Object.assign(Object.assign({}, n), { collapsed: de }), { path: R, key: J, size: pe } = k, X = en(R), H = C.useRef(!Ce), [Ee, xe] = C.useState(!1);
  C.useEffect(() => {
    Y(ce(t));
  }, [t]), C.useEffect(() => {
    const $ = g(k);
    ...
    u !== null && l(R) && (H.current = !0, fe(u.collapsed));
  }, [u]);
  const O = C.useMemo(() => !A(k), [k]), le = C.useMemo(() => !v(k), [k]), _ = C.useMemo(() => !b(k), [k]), Pe = C.useMemo(() => ($) => typeof L != "function" ? L : L($), [L]), { CustomNode: Re, customNodeProps: Ie, CustomWrapper: we, wrapperProps: ke = {}, hideKey: Te, showEditTools: qe = !0, showOnEdit: Ye, showOnView: j, showCollectionWrapper: se = !0 } = C.useMemo(() => Qs(U, k), []), Se = C.useMemo(() => ($, oe) => {
    var Le;
    Le = $.message, y && (re(Le), setTimeout(() => re(null), 2500)), console.warn("Error", Le), D && D({ currentData: k.fullData, errorValue: oe, currentValue: t, name: J, path: R, error: $ });
  }, [D, y]);
  if (!Zs("collection", k, x, P) && k.level > 0)
    return null;
  const Ve = Array.isArray(t) ? "array" : "object", ht = Ve === "array" ? { open: "[", close: "]" } : { open: "{", close: "}" }, tn = getComputedStyle(document.documentElement).getPropertyValue("--jer-expand-transition-time"), ro = ($) => {
    $.key === "Enter" && ($.metaKey || $.shiftKey || $.ctrlKey) ? In() : $.key === "Escape" && nn();
  }, In = () => {
    try {
      const $ = tr.parse(ne);
      if (a(null), re(null), JSON.stringify($) === JSON.stringify(t))
        return;
      p($, R).then((oe) => {
        oe && Se({ code: "UPDATE_ERROR", message: oe }, $);
      });
    } catch {
      Se({ code: "INVALID_JSON", message: M("ERROR_INVALID_JSON", k) }, ne);
    }
  }, ru = R.length > 0 ? () => {
    m(t, R).then(($) => {
      $ && Se({ code: "DELETE_ERROR", message: $ }, vn(t, R));
    });
  } : void 0, nn = () => {
    a(null), re(null), Y(ce(t));
  }, Ke = f === X, ou = f === `key_${X}`, oo = typeof R.slice(-1)[0] == "number", iu = r !== null && O && _ && le && !oo, io = o === "when-closed" ? de : o, su = !Ke && qe, uu = (V || !oo) && !Te && J !== void 0, au = Re && (Ke && Ye || !Ke && j), cu = I && Ve === "object", so = Object.entries(t).map(([$, oe]) => [Ve === "array" ? Number($) : $, oe]);
  cu && so.sort(typeof I == "function" ? ($, oe) => I($[0], oe[0]) : void 0);
  const lu = JSON.stringify(t, null, 2).replace(/\\n/g, `
`).split(`
`).length, uo = H.current ? Ke ? S("div", { className: "jer-collection-text-edit", children: he("div", { children: [S(Ys, { className: "jer-collection-text-area", name: X, value: ne, setValue: Y, isEditing: Ke, handleKeyPress: ro, styles: s("input", k) }), S("div", { className: "jer-collection-input-button-row", children: S(to, { onOk: In, onCancel: nn, nodeData: k }) })] }) }) : so.map(([$, oe], Le) => {
    const St = { key: $, value: oe, path: [...R, $], level: R.length + 1, index: Le, size: Fn(oe) ? Object.keys(oe).length : 1, parentData: t, fullData: k.fullData };
    return S("div", { className: "jer-collection-element", style: s("collectionElement", St), children: Fn(oe) ? S(nu, Object.assign({ data: oe, parentData: t, nodeData: St, showCollectionCount: o }, i), $) : S(tu, Object.assign({ data: oe, parentData: t, nodeData: St }, i, { showLabel: Ve === "object" || V }), $) }, $);
  }) : null, rn = !!se && de;
  rn || (H.current = !0);
  const ao = Object.assign(Object.assign({}, i), { data: t, value: t, parentData: r, nodeData: k, setValue: ($) => Dn(void 0, void 0, void 0, function* () {
    return yield p($, R);
  }), handleEdit: In, handleCancel: nn, handleKeyPress: ro, isEditing: Ke, setIsEditing: () => a(X), getStyles: s }), du = au ? S(Re, Object.assign({ customNodeProps: Ie }, ao, { children: uo })) : uo, co = ou ? S("input", { className: "jer-input-text jer-key-edit", type: "text", name: X, defaultValue: J, autoFocus: !0, onFocus: ($) => $.target.select(), onKeyDown: ($) => {
    $.key === "Enter" ? ((oe) => {
      if (a(null), J === oe || !r)
        return;
      const Le = R.slice(0, -1);
      if (Object.keys(r).includes(oe))
        return void Se({ code: "KEY_EXISTS", message: M("ERROR_KEY_EXISTS", k) }, oe);
      const St = Object.fromEntries(Object.entries(r).map(([po, Do]) => po === J ? [oe, Do] : [po, Do]));
      p(St, Le);
    })($.target.value) : $.key === "Escape" && nn();
  }, style: { width: String(J).length / 1.5 + 0.5 + "em" } }) : uu && S("span", { className: "jer-key-text", style: s("property", k), onDoubleClick: () => iu && a(`key_${X}`), children: J === "" ? S("span", { className: R.length > 0 ? "jer-empty-string" : void 0 }) : `${J}:` }), lo = su && S(Xs, { startEdit: O ? () => {
    H.current = !0, a(X), fe(!1);
  } : void 0, handleAdd: _ ? ($) => {
    fe(!1);
    const oe = Pe(k);
    Ve === "array" ? E(oe, [...R, t.length]).then((Le) => {
      Le && Se({ code: "ADD_ERROR", message: Le }, oe);
    }) : $ in t ? Se({ code: "KEY_EXISTS", message: M("ERROR_KEY_EXISTS", k) }, $) : E(oe, [...R, $]).then((Le) => {
      Le && Se({ code: "ADD_ERROR", message: Le }, oe);
    });
  } : void 0, handleDelete: le ? ru : void 0, enableClipboard: F, type: Ve, nodeData: k, translate: M }), fo = he("div", { className: "jer-component jer-collection-component", style: Object.assign({ marginLeft: (R.length === 0 ? 0 : B / 2) + "em" }, s("collection", k)), children: [se ? he("div", { className: "jer-collection-header-row", style: { position: "relative" }, children: [he("div", { className: "jer-collection-name", children: [S("div", { className: "jer-collapse-icon", onClick: ($) => ((oe) => {
    if (oe.getModifierState("Alt"))
      return H.current = !0, void c({ collapsed: !de, path: R });
    f && f.includes(X) || (xe(!0), H.current = !0, fe(!de), setTimeout(() => xe(!1), 500));
  })($), children: S(ft, { name: "chevron", rotate: de, nodeData: k }) }), co, !Ke && S("span", { className: "jer-brackets jer-bracket-open", style: s("bracket", k), children: ht.open })] }), !Ke && io && S("div", { className: "jer-collection-item-count" + (io ? " jer-visible" : " jer-hidden"), style: s("itemCount", k), children: pe === 1 ? M("ITEM_SINGLE", Object.assign(Object.assign({}, k), { size: 1 }), 1) : M("ITEMS_MULTIPLE", k, pe) }), S("div", { className: "jer-brackets" + (rn ? " jer-visible" : " jer-hidden"), style: s("bracket", k), children: ht.close }), lo] }) : Te ? S(Ar, {}) : he("div", { className: "jer-collection-header-row", style: { position: "relative" }, children: [co, lo] }), he("div", { className: "jer-collection-inner", style: Object.assign({ maxHeight: rn ? 0 : d(X) ? void 0 : 3 * lu + "em", overflowY: rn || Ee ? "hidden" : "visible", transition: `max-height ${tn}` }, s("collectionInner", k)), children: [du, S("div", { className: Ke ? "jer-collection-error-row" : "jer-collection-error-row-edit", children: me && S("span", { className: "jer-error-slug", style: s("error", k), children: me }) }), !Ke && se && S("div", { className: "jer-brackets jer-bracket-outside", style: s("bracket", k), children: ht.close })] })] });
...
}, onEdit: r = n, onDelete: o = n, onAdd: i = n, onChange: s, onError: u, showErrorMessages: c = !0, enableClipboard: l = !0, theme: f = "default", icons: a, indent: d = 3, collapse: p = !1, showCollectionCount: E = !0, restrictEdit: m = !1, restrictDelete: D = !1, restrictAdd: y = !1, restrictTypeSelection: A = !1, searchFilter: v, searchText: b, searchDebounceTime: g = 350, keySort: F = !1, showArrayIndices: x = !0, showStringQuotes: P = !0, defaultValue: B = null, minWidth: I = 250, maxWidth: V = "min(600px, 90vw)", rootFontSize: L, stringTruncate: M = 250, translations: U = {}, className: z, id: ce, customText: ne = {}, customNodeDefinitions: Y = [], useJSON5Editor: me = !1 }) => {
  const { getStyles: re, setTheme: Ce, setIcons: de } = et(), { setCollapseState: fe } = no(), k = C.useCallback(dn(p), [p]), R = C.useCallback(wD(U, ne), [U, ne]), [J, pe] = C.useState(b), [X, H] = C.useState(e);
  C.useEffect(() => {
    f && Ce(f), a && de(a);
  }, [f, a]), C.useEffect(() => {
    fe(null), H(e);
  }, [e]), C.useEffect(() => {
    const Ie = setTimeout(() => pe(b), g);
    return () => clearTimeout(Ie);
  }, [b, g]);
  const Ee = { key: t, path: [], level: 0, index: 0, value: X, size: Object.keys(X).length, parentData: null, fullData: X }, xe = dn(m), O = dn(D), le = dn(y), _ = OD(v), Pe = { name: t, nodeData: Ee, onEdit: (Ie, we) => Dn(void 0, void 0, void 0, function* () {
    const { currentData: ke, newData: Te, currentValue: qe, newValue: Ye } = nr(X, we, Ie, "update");
    if (qe === Ye)
      return;
    H(Te);
    const j = yield r({ currentData: ke, newData: Te, currentValue: qe, newValue: Ye, name: we.slice(-1)[0], path: we });
    return j !== void 0 ? (H(ke), j === !1 ? R("ERROR_UPDATE", Ee) : j) : void 0;
  }), onDelete: (Ie, we) => Dn(void 0, void 0, void 0, function* () {
    const { currentData: ke, newData: Te, currentValue: qe, newValue: Ye } = nr(X, we, Ie, "delete");
    H(Te);
    const j = yield o({ currentData: ke, newData: Te, currentValue: qe, newValue: Ye, name: we.slice(-1)[0], path: we });
    if (j !== void 0)
      return H(ke), j === !1 ? R("ERROR_UPDATE", Ee) : j;
  }), onAdd: (Ie, we) => Dn(void 0, void 0, void 0, function* () {
    const { currentData: ke, newData: Te, currentValue: qe, newValue: Ye } = nr(X, we, Ie, "add");
    H(Te);
    const j = yield i({ currentData: ke, newData: Te, currentValue: qe, newValue: Ye, name: we.slice(-1)[0], path: we });
    if (j !== void 0)
      return H(ke), j === !1 ? R("ERROR_UPDATE", Ee) : j;
  }), onChange: s, onError: u, showErrorMessages: c, showCollectionCount: E, collapseFilter: k, restrictEditFilter: xe, restrictDeleteFilter: O, restrictAddFilter: le, restrictTypeSelection: A, searchFilter: _, searchText: J, enableClipboard: l, keySort: F, showArrayIndices: x, showStringQuotes: P, indent: d, defaultValue: B, stringTruncate: M, translate: R, customNodeDefinitions: Y, parentData: null, useJSON5Editor: me }, Re = Object.assign(Object.assign({}, re("container", Ee)), { minWidth: I, maxWidth: V });
  return Re.fontSize = L ?? Re.fontSize, S("div", { id: ce, className: "jer-editor-container " + z, style: Re, children: Fn(X) ? S(nu, Object.assign({ data: X }, Pe)) : S(tu, Object.assign({ data: X, showLabel: !0 }, Pe)) });
...
}, dn = (e) => typeof e == "boolean" ? () => e : typeof e == "number" ? ({ level: t }) => t >= e : e, OD = (e) => {
  if (e !== void 0)
...
const ir = (e, t) => {
  ...
  if (F.Section = ({ children: B }) => (t == null ? void 0 : t.filters) && /* @__PURE__ */ N.createElement("section", { className: x.join(" ") }, /* @__PURE__ */ N.createElement("p", { className: "filters-section__intro-text" }, i != null && i.some((I) => I.active) ? b.introText : "", " ", t.filterBehavior === "Apply Button" && b.applyText), /* @__PURE__ */ N.createElement("div", { className: "filters-section__wrapper" }, B)), F.ApplyBehavior = () => {
    ...
    const { filter: I, index: V } = B;
    return /* @__PURE__ */ N.createElement("section", { className: "single-filters__tab-bar" }, I.values.map((L, M) => {
      const U = ["button__tab-bar", I.active === L ? "button__tab-bar--active" : ""];
    ...
    const { index: I, label: V, active: L, filters: M } = B;
    return /* @__PURE__ */ N.createElement(
      "select",
      {
        id: `filter-${I}`,
        ...
        value: L,
        onChange: (U) => {
          D(I, U.target.value), y(`Filter ${V} value has been changed to ${U.target.value}, please reference the data table to see updated values.`);
        }
      },
      M
    );
    ...
    if (i || n) {
      let B = s === "map" ? n : i;
      return delete B.fromHash, TD(B, t.data).map((I, V) => {
        var de, fe, k;
        if (I.showDropdown === !1)
          return;
        const L = [], M = [], U = [], { active: z, queuedActive: ce, label: ne, filterStyle: Y } = I;
        g(I), (de = I.values) == null || de.forEach((R, J) => {
          const pe = ["pill", z === R ? "pill--active" : null, c && c], X = ["tab", z === R && "tab--active", c && c];
          M.push(
            /* @__PURE__ */ N.createElement("div", { className: "pill__wrapper", key: `pill-${J}` }, /* @__PURE__ */ N.createElement(
              "button",
              {
                id: `${R}-${V}-${J}-${E}`,
                className: pe.join(" "),
                onKeyDown: (H) => {
                  H.keyCode === 13 && (D(V, R), p(H.target));
                },
                onClick: (H) => {
                  D(V, R), p(H.target);
                },
            ...
            /* @__PURE__ */ N.createElement("option", { key: J, value: R, "aria-label": R }, I.labels && I.labels[R] ? I.labels[R] : R)
          ), U.push(
        ...
        const me = (R, J) => {
          const pe = Lt.cloneDeep(R);
          return J !== "cust" && pe.sort(), J === "desc" && pe.reverse(), pe;
        }, re = i[V];
        Y === "nested-dropdown" && (re.values = me(re.values, re.order), (fe = re.subGroupingFilter) == null || fe.values.map((R) => {
          var J;
          return me(R, (J = re.subGroupingFilter) == null ? void 0 : J.order);
        }));
        const Ce = ["single-filters", f ? "single-filters--dropdown" : `single-filters--${Y}`];
        return /* @__PURE__ */ N.createElement("div", { className: Ce.join(" "), key: V }, /* @__PURE__ */ N.createElement(N.Fragment, null, ne && /* @__PURE__ */ N.createElement("label", { htmlFor: `filter-${V}` }, ne), Y === "tab" && !f && /* @__PURE__ */ N.createElement(F.Tabs, { tabs: U }), Y === "pill" && !f && /* @__PURE__ */ N.createElement(F.Pills, { pills: M }), Y === "tab bar" && !f && /* @__PURE__ */ N.createElement(F.TabBar, { filter: I, index: V }), (Y === "dropdown" || f) && Y !== "nested-dropdown" && /* @__PURE__ */ N.createElement(F.Dropdown, { filter: I, index: V, label: ne, active: ce || z, filters: L }), Y === "multi-select" && /* @__PURE__ */ N.createElement(
          hu,
          {
            options: I.values.map((R) => ({ value: R, label: R })),
            fieldName: V,
            updateField: (R, J, pe, X) => D(pe, X),
            selected: I.active,
            limit: I.selectLimit || 5
          }
        ), Y === "nested-dropdown" && /* @__PURE__ */ N.createElement(gu, { currentFilter: re, filterIndex: V, listLlabel: ne, handleSelectedItems: (R) => D(V, R), valueOrder: re.values, subGroupingValueOrder: (k = re.subGroupingFilter) == null ? void 0 : k.values })));
      });
    }
