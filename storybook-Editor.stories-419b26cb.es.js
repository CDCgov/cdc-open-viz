...
import { i as ca, b as Mo, a as fr, g as pr } from "./storybook-isSolr-cb863e7a.es.js";
import { C as ct, E as Lt, y as gr, o as mr, M as vr, k as hr, m as Sr, B as wr, d as Mr, a as Na, G as br, O as Ar } from "./storybook-CdcDashboard-8f0599d2.es.js";
...
import { a as Pa, b as Ea, c as Tr, d as Pr, e as Er, f as Ir, g as kr, h as Lr, i as Ia, j as Or, k as Br } from "./storybook-Icon-48ed169f.es.js";
...
import { _ as No } from "./storybook-lodash-c15d8e1c.es.js";
import "./storybook-Filters-d0b59c22.es.js";
...
import "./storybook-DataTableEditor-f2f7b65f.es.js";
import "./storybook-useDebounce-78f40efd.es.js";
import "./storybook-MultiSelect-be5791cb.es.js";
import "./storybook-InputSelect-20478396.es.js";
import "./storybook-index-4ed993c7.es.js";
import "./storybook-DataTable-b1fffc08.es.js";
...
import "./storybook-footnoteSymbols-166b967a.es.js";
...
function Ot(o, f) {
  ...
  if (typeof c.path != "string") {
    ...
    Object.defineProperty(c, "path", {
      value: typeof f == "string" ? f : typeof y == "string" && y.length > 0 ? y : o.name,
      writable: !1,
      configurable: !1,
      enumerable: !0
    });
...
function Gr(o) {
  ...
  if (c && !o.type) {
    var y = f.split(".").pop().toLowerCase(), b = xr.get(y);
...
var $r = function(o, f) {
  if (o && f) {
    var c = Array.isArray(f) ? f : f.split(","), y = o.name || "", b = (o.type || "").toLowerCase(), P = b.replace(/\/.*$/, "");
...
function Ba(o) {
  for (var f = 1; f < arguments.length; f++) {
    ...
    f % 2 ? Oa(Object(c), !0).forEach(function(y) {
      or(o, y, c[y]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(c)) : Oa(Object(c)).forEach(function(y) {
...
function nu(o, f) {
  ...
  if (c != null) {
    var y = [], b = !0, P = !1, C, O;
    try {
      for (c = c.call(o); !(b = (C = c.next()).done) && (y.push(C.value), !(f && y.length === f)); b = !0)
        ;
    } catch (Rn) {
      P = !0, O = Rn;
    } finally {
...
function lu(o) {
  var f = o.files, c = o.accept, y = o.minSize, b = o.maxSize, P = o.multiple, C = o.maxFiles;
  return !P && f.length > 1 || P && C >= 1 && f.length > C ? !1 : f.every(function(O) {
    var Rn = ar(O, c), M = Fa(Rn, 1), En = M[0], w = rr(O, y, b), un = Fa(w, 1), Nn = un[0];
    return En && Nn;
  });
}
function Po(o) {
...
function Le() {
  ...
  return function(y) {
    ...
    return f.some(function(O) {
      return !Po(y) && O && O.apply(void 0, [y].concat(P)), Po(y);
    });
  };
}
function Va() {
...
function ee(o) {
  for (var f = 1; f < arguments.length; f++) {
    var c = arguments[f] != null ? arguments[f] : {};
    f % 2 ? Ka(Object(c), !0).forEach(function(y) {
      ma(o, y, c[y]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(c)) : Ka(Object(c)).forEach(function(y) {
      Object.defineProperty(o, y, Object.getOwnPropertyDescriptor(c, y));
    });
  }
  return o;
...
function Eo(o, f) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (b = 0; b < P.length; b++)
      y = P[b], !(f.indexOf(y) >= 0) && Object.prototype.propertyIsEnumerable.call(o, y) && (c[y] = o[y]);
  }
  return c;
}
function Au(o, f) {
  if (o == null)
    return {};
  var c = {}, y = Object.keys(o), b, P;
  for (P = 0; P < y.length; P++)
    b = y[P], !(f.indexOf(b) >= 0) && (c[b] = o[b]);
  return c;
}
var Ma = /* @__PURE__ */ D.forwardRef(function(o, f) {
  var c = o.children, y = Eo(o, du), b = ha(y), P = b.open, C = Eo(b, fu);
  return D.useImperativeHandle(f, function() {
    return {
      open: P
    };
  }, [P]), /* @__PURE__ */ l.createElement(D.Fragment, null, c(ee(ee({}, C), {}, {
    open: P
  })));
});
...
function ha() {
  ...
  var re = D.useCallback(function(Q) {
    ...
    Q.forEach(function(ge) {
      var Fe = ar(ge, c), Te = ya(Fe, 2), Ye = Te[0], je = Te[1], Ue = rr(ge, C, P), We = ya(Ue, 2), Je = We[0], xe = We[1], Ge = ae ? ae(ge) : null;
      if (Ye && Je && !Ge)
        te.push(ge);
      else {
        var He = [je, xe];
  ...
  }, [ne, O, c, C, P, Rn, un, Nn, Cn, ae]), z = D.useCallback(function(Q) {
  ...
  }, [fn, en, Gn, jn, we, re, Oe, Be, z, Jn, Wn, y]), pe = D.useCallback(function(Q) {
    Q.stopPropagation();
  ...
  }, [an, c, O, z, y]), ve = be.length, he = ve > 0 && lu({
    files: be,
    accept: c,
    minSize: C,
    maxSize: P,
...
function Tu(o) {
  var f = o.getUTCHours(), c = o.getUTCMinutes(), y = o.getUTCSeconds(), b = o.getUTCMilliseconds();
  return isNaN(o) ? "Invalid Date" : Nu(o.getUTCFullYear()) + "-" + Me(o.getUTCMonth() + 1, 2) + "-" + Me(o.getUTCDate(), 2) + (b ? "T" + Me(f, 2) + ":" + Me(c, 2) + ":" + Me(y, 2) + "." + Me(b, 3) + "Z" : y ? "T" + Me(f, 2) + ":" + Me(c, 2) + ":" + Me(y, 2) + "Z" : c || f ? "T" + Me(f, 2) + ":" + Me(c, 2) + "Z" : "");
}
function Pu(o) {
  var f = new RegExp('["' + o + `
\r]`), c = o.charCodeAt(0);
    ...
    function Jn() {
      ...
      if (w.charCodeAt(ae) === da) {
        for (; dn++ < Cn && w.charCodeAt(dn) !== da || w.charCodeAt(++dn) === da; )
          ;
        return (An = dn) >= Cn ? Hn = !0 : (zn = w.charCodeAt(dn++)) === It ? bn = !0 : zn === fa && (bn = !0, w.charCodeAt(dn) === It && ++dn), w.slice(ae + 1, An - 1).replace(/""/g, '"');
      }
      for (; dn < Cn; ) {
...
const kt = ({ children: o, className: f = "" }) => /* @__PURE__ */ l.createElement("div", { className: `tab-content ${f}` }, o), ku = (o) => {
  const { globalActive: f } = D.useContext(ct), c = D.useContext(Lt), y = (b) => {
    c({ type: "EDITOR_SET_GLOBALACTIVE", payload: b });
  };
  return /* @__PURE__ */ l.createElement(sr, { ...o, setActiveTab: y, activeTab: f });
}, Lu = ({ children: o, className: f = void 0, startingTab: c }) => {
  const [y, b] = D.useState(c);
  return /* @__PURE__ */ l.createElement(sr, { className: f, setActiveTab: b, activeTab: y }, o);
}, sr = ({ children: o, className: f, activeTab: c, setActiveTab: y }) => {
  const b = (O, Rn) => {
    O || y(Rn);
  };
  let P = "tabs";
  f && (P = `tabs ${f}`);
  const C = o.map(({ props: O }, Rn) => {
  ...
  return /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("nav", { className: P }, /* @__PURE__ */ l.createElement("ul", { className: "nav nav-fill" }, C)), o[c]);
};
  ...
  return Xa || (Xa = 1, function(o, f) {
    (function(c, y) {
      ...
      function ae(n, r) {
        ...
        }(i) ? y.createElement(n, r) : n;
        var i;
      }
      function zn(n, r, i) {
        return i === void 0 && (i = 0), n.map(function(s) {
          return fn(s = C({}, s, { parent: r, depth: i })), s.columns && (s.columns = zn(s.columns, s, i + 1)), s;
        });
      }
      function de(n) {
        return Pe(n, "columns");
      ...
      function an(n, r) {
        if (!r)
          throw new Error();
        return Object.assign(n, C({ Header: w, Footer: w }, un, {}, r, {}, n)), Object.assign(n, { originalWidth: n.width }), n;
      }
      function _n(n, r, i) {
        i === void 0 && (i = function() {
          return {};
        ...
        for (var s = [], v = n, g = 0, h = function() {
          ...
          v.forEach(function(W) {
            ...
            V && (W.parent ? x = C({}, W.parent, { originalId: W.parent.id, id: W.parent.id + "_" + h(), headers: [W] }, i(W)) : x = an(C({ originalId: W.id + "_placeholder", id: W.id + "_placeholder_" + h(), placeholderOf: W, headers: [W] }, i(W)), r), k && k.originalId === x.originalId ? k.headers.push(W) : E.push(x)), T.headers.push(W);
          }), s.push(T), v = E;
        }; v.length; )
          R();
        return s.reverse();
      ...
      function _e(n, r, i, s) {
        ...
        return r.type === M.setHiddenColumns ? C({}, n, { hiddenColumns: Hn(r.value, n.hiddenColumns) }) : r.type === M.toggleHideAllColumns ? C({}, n, { hiddenColumns: (r.value !== void 0 ? r.value : !n.hiddenColumns.length) ? s.allColumns.map(function(g) {
          return g.id;
        }) : [] }) : void 0;
      }
      function pe(n) {
      ...
      function ye(n) {
        var r = n.columns, i = n.flatHeaders, s = n.dispatch, v = n.allColumns, g = n.getHooks, h = n.state.hiddenColumns, R = n.autoResetHiddenColumns, T = R === void 0 || R, E = bn(n), V = v.length === h.length, W = y.useCallback(function(U, ln) {
      ...
      function Fe(n) {
        ...
        r.forEach(function(V, W) {
          return function x(k, H, X, U, ln) {
            X === void 0 && (X = 0);
            var kn = k, sn = h(k, H, U), K = v[sn];
            if (K)
              K.subRows && K.originalSubRows.forEach(function(nn, wn) {
                return x(nn, wn, X + 1, K);
              });
            else if ((K = { id: sn, original: kn, index: H, depth: X, cells: [{}] }).cells.map = fe, K.cells.filter = fe, K.cells.forEach = fe, K.cells[0].getCellProps = fe, K.values = {}, ln.push(K), s.push(K), v[sn] = K, K.originalSubRows = R(k, H), K.originalSubRows) {
              var Tn = [];
              K.originalSubRows.forEach(function(nn, wn) {
                return x(nn, wn, X + 1, K, Tn);
              }), K.subRows = Tn;
            }
            g.accessor && (K.values[g.id] = g.accessor(k, H, K, ln, r)), K.values[g.id] = dn(T, K.values[g.id], { row: K, column: g, instance: E() });
          }(V, W, 0, void 0, i);
        });
      }
      ...
      function Ue(n, r, i, s) {
        ...
        if (r.type === M.toggleRowExpanded) {
          ...
          if (W && !x) {
            var k = n.expanded;
            return k[E], C({}, n, { expanded: O(k, [E].map(Rn)) });
          }
          return n;
        }
      }
      function We(n) {
        ...
        var kn = y.useCallback(function(xn, pn) {
        ...
        Object.assign(n, { preExpandedRows: i, expandedRows: K, rows: K, expandedDepth: Tn, isAllRowsExpanded: ln, toggleRowExpanded: kn, toggleAllRowsExpanded: sn, getToggleAllRowsExpandedProps: wn });
      }
      function Je(n, r) {
      ...
      function ko(n, r, i, s) {
        ...
        if (r.type === M.setFilter) {
          ...
          return Ee(E.autoRemove, W, T) ? C({}, n, { filters: n.filters.filter(function(X) {
            return X.id !== v;
      ...
      function Gt(n) {
        var r = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.filterTypes, R = n.manualFilters, T = n.defaultCanFilter, E = T !== void 0 && T, V = n.disableFilters, W = n.state.filters, x = n.dispatch, k = n.autoResetFilters, H = k === void 0 || k, X = y.useCallback(function(nn, wn) {
        ...
        }, [R, W, i, s, v, g, h]), kn = ln[0], sn = ln[1], K = ln[2];
        y.useMemo(function() {
        ...
        }, [x, R ? null : r]), Object.assign(n, { preFilteredRows: i, preFilteredFlatRows: s, preFilteredRowsById: v, filteredRows: kn, filteredFlatRows: sn, filteredRowsById: K, rows: kn, flatRows: sn, rowsById: K, setFilter: X, setAllFilters: U });
      }
      xt.pluginName = "useFilters", M.resetGlobalFilter = "resetGlobalFilter", M.setGlobalFilter = "setGlobalFilter";
      var pt = function(n) {
      ...
      function Vt(n, r, i, s) {
        ...
        if (r.type === M.setGlobalFilter) {
          ...
          return Ee(h.autoRemove, R) ? (n.globalFilter, O(n, ["globalFilter"])) : C({}, n, { globalFilter: R });
        }
      }
      function Kt(n) {
        var r = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.filterTypes, R = n.globalFilter, T = n.manualGlobalFilter, E = n.state.globalFilter, V = n.dispatch, W = n.autoResetGlobalFilter, x = W === void 0 || W, k = n.disableGlobalFilter, H = y.useCallback(function(K) {
          ...
          g.forEach(function(xn) {
            ...
            xn.canFilter = Yn(pn !== !0 && void 0, k !== !0 && void 0, !0);
          });
        ...
        }, [T, E, R, h, g, i, s, v, k]), U = X[0], ln = X[1], kn = X[2], sn = bn(x);
        Wn(function() {
          sn() && V({ type: M.resetGlobalFilter });
        }, [V, T ? null : r]), Object.assign(n, { preGlobalFilteredRows: i, preGlobalFilteredFlatRows: s, preGlobalFilteredRowsById: v, globalFilteredRows: U, globalFilteredFlatRows: ln, globalFilteredRowsById: kn, rows: U, flatRows: ln, rowsById: kn, setGlobalFilter: H, disableGlobalFilter: k });
      }
      function gt(n, r) {
      ...
      var Lo = {};
      function Oo(n) {
        var r = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.flatHeaders, R = n.groupByFn, T = R === void 0 ? jt : R, E = n.manualGroupBy, V = n.aggregations, W = V === void 0 ? Lo : V, x = n.plugins, k = n.state.groupBy, H = n.dispatch, X = n.autoResetGroupBy, U = X === void 0 || X, ln = n.disableGroupBy, kn = n.defaultCanGroupBy, sn = n.getHooks;
        ...
        var Tn = y.useCallback(function(u, a) {
        ...
        var wn = y.useMemo(function() {
          ...
          var u = k.filter(function(I) {
            ...
            return Object.entries(L).map(function(Z, yn) {
              var mn = Z[0], j = Z[1], Pn = _ + ":" + mn, Fn = I(j, B + 1, Pn = G ? G + ">" + Pn : Pn), J = B ? Pe(j, "leafRows") : j, Y = function(cn, Ln, On) {
                var Xn = {};
        ...
        }, [E, k, i, s, v, g, W, T]), xn = wn[0], pn = wn[1], hn = wn[2], qn = wn[3], Dn = wn[4], Kn = wn[5], e = wn[6], t = bn(U);
        Wn(function() {
      ...
      function Ho(n, r, i, s) {
        ...
        if (r.type === M.toggleSortBy) {
          ...
          return (v = !E && R ? U ? "toggle" : "add" : ln !== H.length - 1 || H.length !== 1 ? "replace" : U ? "toggle" : "replace") != "toggle" || V || kn || R && W || !(U && U.desc && !X || !U.desc && X) || (v = "remove"), v === "replace" ? sn = [{ id: g, desc: kn ? h : X }] : v === "add" ? (sn = [].concat(H, [{ id: g, desc: kn ? h : X }])).splice(0, sn.length - k) : v === "toggle" ? sn = H.map(function(K) {
            return K.id === g ? C({}, K, { desc: kn ? h : !U.desc }) : K;
      ...
      function Wo(n) {
        var r = n.data, i = n.rows, s = n.flatRows, v = n.allColumns, g = n.orderByFn, h = g === void 0 ? Zt : g, R = n.sortTypes, T = n.manualSortBy, E = n.defaultCanSort, V = n.disableSortBy, W = n.flatHeaders, x = n.state.sortBy, k = n.dispatch, H = n.plugins, X = n.getHooks, U = n.autoResetSortBy, ln = U === void 0 || U;
        vn(H, ["useFilters", "useGlobalFilter", "useGroupBy", "usePivotColumns"], "useSortBy");
        var kn = y.useCallback(function(pn) {
          k({ type: M.setSortBy, sortBy: pn });
        }, [k]), sn = y.useCallback(function(pn, hn, qn) {
        ...
        Wn(function() {
          xn() && k({ type: M.resetSortBy });
        }, [T ? null : r]), Object.assign(n, { preSortedRows: i, preSortedFlatRows: s, sortedRows: nn, sortedFlatRows: wn, rows: nn, flatRows: wn, setSortBy: kn, toggleSortBy: sn });
      }
      function Zt(n, r, i) {
      ...
      function Go(n) {
        var r = n.rows, i = n.autoResetPage, s = i === void 0 || i, v = n.manualExpandedKey, g = v === void 0 ? "expanded" : v, h = n.plugins, R = n.pageCount, T = n.paginateExpandedRows, E = T === void 0 || T, V = n.expandSubRows, W = V === void 0 || V, x = n.state, k = x.pageSize, H = x.pageIndex, X = x.expanded, U = x.globalFilter, ln = x.filters, kn = x.groupBy, sn = x.sortBy, K = n.dispatch, Tn = n.data, nn = n.manualPagination;
        vn(h, ["useGlobalFilter", "useFilters", "useGroupBy", "useSortBy", "useExpanded"], "usePagination");
        var wn = bn(s);
        Wn(function() {
          wn() && K({ type: M.resetPage });
        }, [K, nn ? null : Tn, U, ln, kn, sn]);
        var xn = nn ? R : Math.ceil(r.length / k), pn = y.useMemo(function() {
        ...
        }, [W, X, g, nn, H, k, E, r]), qn = H > 0, Dn = xn === -1 ? hn.length >= k : H < xn - 1, Kn = y.useCallback(function(a) {
      ...
      function Ko(n, r, i, s) {
        if (r.type === M.init)
          return C({ pivotColumns: Qt }, n);
        if (r.type === M.resetPivot)
          return C({}, n, { pivotColumns: s.initialState.pivotColumns || Qt });
      ...
      function no(n, r) {
        ...
        var g = v.pivotColumns.map(function(T) {
          ...
          return x ? Array.from(x.uniqueValues).sort().map(function(k) {
            var H = C({}, x, { Header: x.PivotHeader || typeof x.header == "string" ? x.Header + ": " + k : k, isPivotGroup: !0, parent: V, depth: E, id: V ? V.id + "." + x.id + "." + k : x.id + "." + k, pivotValue: k });
            return H.columns = T(E + 1, H, [].concat(W, [function(X) {
              return X.values[x.id] === k;
            }])), H;
          }) : h.map(function(k) {
            return C({}, k, { canPivot: !1, isPivoted: !0, parent: V, depth: E, id: "" + (V ? V.id + "." + k.id : k.id), accessor: function(H, X, U) {
      ...
      function Jo(n, r, i, s) {
        ...
        if (r.type === M.toggleRowSelected) {
          var W = r.id, x = r.value, k = s.rowsById, H = s.selectSubRows, X = H === void 0 || H, U = s.getSubRows, ln = n.selectedRowIds[W], kn = x !== void 0 ? x : !ln;
          if (ln === kn)
            return n;
        ...
        if (r.type === M.toggleAllPageRowsSelected) {
          var K = r.value, Tn = s.page, nn = s.rowsById, wn = s.selectSubRows, xn = wn === void 0 || wn, pn = s.isAllPageRowsSelected, hn = s.getSubRows, qn = K !== void 0 ? K : !pn, Dn = C({}, n.selectedRowIds);
      ...
      function ao(n) {
        ...
        }, [i, x, V, X]), ln = !!(Object.keys(R).length && Object.keys(V).length), kn = ln;
        ...
        }, [k]), Tn = y.useCallback(function(hn) {
          return k({ type: M.toggleAllPageRowsSelected, value: hn });
        }, [k]), nn = y.useCallback(function(hn, qn) {
          return k({ type: M.toggleRowSelected, id: hn, value: qn });
        }, [k]), wn = bn(n), xn = Cn(s().getToggleAllRowsSelectedProps, { instance: wn() }), pn = Cn(s().getToggleAllPageRowsSelectedProps, { instance: wn() });
        Object.assign(n, { selectedFlatRows: U, isAllRowsSelected: ln, isAllPageRowsSelected: kn, toggleRowSelected: nn, toggleAllRowsSelected: K, getToggleAllRowsSelectedProps: xn, getToggleAllPageRowsSelectedProps: pn, toggleAllPageRowsSelected: Tn });
      }
      function $o(n, r) {
        var i = r.instance;
      ...
      function Zo(n, r, i, s) {
        ...
        if (r.type === M.setCellState) {
          var k, H, X, U, ln, kn = r.rowId, sn = r.columnId, K = r.value, Tn = n.rowState[kn] !== void 0 ? n.rowState[kn] : g(T[kn]), nn = (Tn == null || (k = Tn.cellState) == null ? void 0 : k[sn]) !== void 0 ? Tn.cellState[sn] : R((H = T[kn]) == null || (X = H.cells) == null ? void 0 : X.find(function(wn) {
            return wn.column.id === sn;
          }));
          return C({}, n, { rowState: C({}, n.rowState, (ln = {}, ln[kn] = C({}, Tn, { cellState: C({}, Tn.cellState || {}, (U = {}, U[sn] = Hn(K, nn), U)) }), ln)) });
        }
      }
      function io(n) {
        var r = n.autoResetRowState, i = r === void 0 || r, s = n.data, v = n.dispatch, g = y.useCallback(function(T, E) {
      ...
      function so(n, r, i, s) {
        return r.type === M.init ? C({ columnOrder: [] }, n) : r.type === M.resetColumnOrder ? C({}, n, { columnOrder: s.initialState.columnOrder || [] }) : r.type === M.setColumnOrder ? C({}, n, { columnOrder: Hn(r.columnOrder, n.columnOrder) }) : void 0;
      }
      function co(n, r) {
      ...
      var yo = function(n) {
        ...
        var i = r.instance, s = r.header, v = i.dispatch, g = function(h, R) {
          ...
          document.addEventListener(ln.moveEvent, ln.moveHandler, kn), document.addEventListener(ln.upEvent, ln.upHandler, kn), v({ type: M.columnStartResizing, columnId: R.id, columnWidth: R.totalWidth, headerIdWidths: W, clientX: x });
        };
      ...
      function ta(n, r) {
        ...
        return r.type === M.columnDoneResizing ? C({}, n, { columnResizing: C({}, n.columnResizing, { startX: null, isResizingColumn: null }) }) : void 0;
      }
      ...
      var bt = { position: "absolute", top: 0 }, Co = function(n) {
        n.getTableBodyProps.push(ut), n.getRowProps.push(ut), n.getHeaderGroupProps.push(ut), n.getFooterGroupProps.push(ut), n.getHeaderProps.push(function(r, i) {
          var s = i.column;
          return [r, { style: C({}, bt, { left: s.totalLeft + "px", width: s.totalWidth + "px" }) }];
        }), n.getCellProps.push(function(r, i) {
          var s = i.cell;
          return [r, { style: C({}, bt, { left: s.column.totalLeft + "px", width: s.column.totalWidth + "px" }) }];
      ...
      var ut = function(n, r) {
        ...
        n.getRowProps.push(Dt), n.getHeaderGroupProps.push(Dt), n.getFooterGroupProps.push(Dt), n.getHeaderProps.push(function(r, i) {
          var s = i.column;
          return [r, { style: C({}, At, { width: s.totalWidth + "px" }) }];
        }), n.getCellProps.push(function(r, i) {
          var s = i.cell;
          return [r, { style: C({}, At, { width: s.column.totalWidth + "px" }) }];
        }), n.getFooterProps.push(function(r, i) {
          var s = i.column;
          return [r, { style: C({}, At, { width: s.totalWidth + "px" }) }];
        });
      ...
      function ho(n, r, i, s) {
        ...
        if (r.type === M.columnStartResizing) {
          ...
          if (h !== void 0) {
            var R = s.visibleColumns.reduce(function(K, Tn) {
              var nn;
              return C({}, K, ((nn = {})[Tn.id] = Tt(Tn.id), nn));
        ...
        if (r.type === M.columnResizing) {
          var W = r.clientX, x = n.columnResizing.startX, k = n.gridLayout, H = k.columnWidth, X = k.minWidths, U = k.maxWidths, ln = k.headerIdGridWidths, kn = (W - x) / H, sn = {};
          return (ln === void 0 ? [] : ln).forEach(function(K) {
            var Tn = K[0], nn = K[1];
            sn[Tn] = Math.min(Math.max(X[Tn], nn + nn * kn), U[Tn]);
          }), C({}, n, { gridLayout: C({}, n.gridLayout, { columnWidths: C({}, n.gridLayout.columnWidths, {}, sn) }) });
        }
        return r.type === M.columnDoneResizing ? C({}, n, { gridLayout: C({}, n.gridLayout, { startWidths: {}, minWidths: {}, maxWidths: {} }) }) : void 0;
      }
      function Tt(n) {
      ...
      c._UNSTABLE_usePivotColumns = St, c.actions = M, c.defaultColumn = un, c.defaultGroupByFn = jt, c.defaultOrderByFn = Zt, c.defaultRenderer = En, c.emptyRenderer = w, c.ensurePluginOrder = vn, c.flexRender = ae, c.functionalUpdate = Hn, c.loopHooks = Vn, c.makePropGetter = Cn, c.makeRenderer = An, c.reduceHooks = dn, c.safeUseLayoutEffect = Jn, c.useAbsoluteLayout = Co, c.useAsyncDebounce = function(n, r) {
        r === void 0 && (r = 0);
        var i = y.useRef({}), s = bn(n), v = bn(r);
      ...
      }, c.useBlockLayout = fo, c.useColumnOrder = lo, c.useExpanded = Te, c.useFilters = xt, c.useFlexLayout = Rt, c.useGetLatest = bn, c.useGlobalFilter = pt, c.useGridLayout = po, c.useGroupBy = vt, c.useMountedLayoutEffect = Wn, c.usePagination = ht, c.useResizeColumns = yo, c.useRowSelect = to, c.useRowState = Mt, c.useSortBy = $t, c.useTable = function(n) {
        for (var r = arguments.length, i = new Array(r > 1 ? r - 1 : 0), s = 1; s < r; s++)
          i[s - 1] = arguments[s];
        n = ie(n), i = [Ae].concat(i);
        var v = y.useRef({}), g = bn(v.current);
        Object.assign(g(), C({}, n, { plugins: i, hooks: Ne() })), i.filter(Boolean).forEach(function(d) {
          d(g().hooks);
        });
        var h = bn(g().hooks);
        g().getHooks = h, delete g().hooks, Object.assign(g(), dn(h().useOptions, ie(n)));
        var R = g(), T = R.data, E = R.columns, V = R.initialState, W = R.defaultColumn, x = R.getSubRows, k = R.getRowId, H = R.stateReducer, X = R.useControlledState, U = bn(H), ln = y.useCallback(function(d, S) {
          if (!S.type)
        ...
        }, [h, U, g]), kn = y.useReducer(ln, void 0, function() {
          return ln(V, { type: M.init });
        }), sn = kn[0], K = kn[1], Tn = dn([].concat(h().useControlledState, [X]), sn, { instance: g() });
        ...
        var xn = y.useMemo(function() {
          for (var d = [], S = [], A = {}, N = [].concat(wn); N.length; ) {
            var I = N.shift();
            Fe({ data: T, rows: d, flatRows: S, rowsById: A, column: I, getRowId: k, getSubRows: x, accessValueHooks: h().accessValue, getInstance: g });
          }
          return [d, S, A];
        }, [wn, T, k, x, h, g]), pn = xn[0], hn = xn[1], qn = xn[2];
    ...
    (function(c, y) {
      ...
      function dn() {
        ...
        return t.reduce(function(a, p) {
          ...
          return a = C({}, a, {}, S), m && (a.style = a.style ? C({}, a.style || {}, {}, m || {}) : m), d && (a.className = a.className ? a.className + " " + d : d), a.className === "" && delete a.className, a;
        }, {});
      }
      function Vn(e, t, u) {
        return typeof t == "function" ? Vn({}, t(e, u)) : Array.isArray(t) ? dn.apply(void 0, [e].concat(t)) : dn(e, t);
      }
      var vn = function(t, u) {
...
`);
      ...
      var ae = typeof document < "u" ? y.useLayoutEffect : y.useEffect;
      function zn(e, t) {
        var u = y.useRef(!1);
        ae(function() {
      ...
      function an(e, t) {
        return _n(e) ? y.createElement(e, t) : e;
      }
      function _n(e) {
      ...
      function Ye(e) {
        var t = e.columns, u = e.flatHeaders, a = e.dispatch, p = e.allColumns, m = e.getHooks, d = e.state.hiddenColumns, S = e.autoResetHiddenColumns, A = S === void 0 ? !0 : S, N = An(e), I = p.length === d.length, q = y.useCallback(function(Z, yn) {
          return a({
            type: w.toggleHideColumn,
            columnId: Z,
            value: yn
          });
        }, [a]), B = y.useCallback(function(Z) {
          return a({
            type: w.setHiddenColumns,
            value: Z
          });
        }, [a]), G = y.useCallback(function(Z) {
          return a({
      ...
      var at = function(t) {
        ...
        var A = d(), N = A.data, I = A.columns, q = A.initialState, B = A.defaultColumn, G = A.getSubRows, _ = A.getRowId, L = A.stateReducer, Z = A.useControlledState, yn = An(L), mn = y.useCallback(function(gn, $n) {
          if (!$n.type)
            throw console.info({
              action: $n
            }), new Error("Unknown Action 👆");
          return [].concat(S().stateReducers, Array.isArray(yn()) ? yn() : [yn()]).reduce(function(ue, Se) {
            return Se(ue, $n, gn, d()) || ue;
          }, gn);
        ...
        var cn = y.useMemo(function() {
          ...
          return [gn, $n, ue];
        }, [$, N, _, G, S, d]), Ln = cn[0], On = cn[1], Xn = cn[2];
        Object.assign(d(), {
          rows: Ln,
        ...
        var Bn = y.useMemo(function() {
          return Hn(S().headerGroups, Ee(tn, B), d());
        }, [S, tn, B, d].concat(Hn(S().headerGroupsDeps, [], {
          instance: d()
        })));
        d().headerGroups = Bn;
        ...
        }, [S, d, $, tn]), d().getTableProps = vn(S().getTableProps, {
          instance: d()
      ...
      function Bt(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, m = e.column, d = e.getRowId, S = e.getSubRows, A = e.accessValueHooks, N = e.getInstance, I = function q(B, G, _, L, Z) {
          _ === void 0 && (_ = 0);
          var yn = B, mn = d(B, G, L), j = p[mn];
          if (j)
          ...
          }, j.cells.map = en, j.cells.filter = en, j.cells.forEach = en, j.cells[0].getCellProps = en, j.values = {}, Z.push(j), a.push(j), p[mn] = j, j.originalSubRows = S(B, G), j.originalSubRows) {
            var Pn = [];
      ...
      function Wt(e, t, u, a) {
        ...
        if (t.type === w.toggleRowExpanded) {
          ...
          if (!q && B) {
            var G;
            return C({}, e, {
              expanded: C({}, e.expanded, (G = {}, G[N] = !0, G))
            });
          } else if (q && !B) {
            var _ = e.expanded;
            _[N];
      ...
      function $e(e) {
        var t = e.data, u = e.rows, a = e.rowsById, p = e.manualExpandedKey, m = p === void 0 ? "expanded" : p, d = e.paginateExpandedRows, S = d === void 0 ? !0 : d, A = e.expandSubRows, N = A === void 0 ? !0 : A, I = e.autoResetExpanded, q = I === void 0 ? !0 : I, B = e.getHooks, G = e.plugins, _ = e.state.expanded, L = e.dispatch;
        ...
        }, [L]), j = y.useCallback(function($) {
          return L({
            type: w.toggleAllRowsExpanded,
            value: $
          });
        }, [L]), Pn = y.useMemo(function() {
          return S ? F(u, {
            manualExpandedKey: m,
            expanded: _,
            expandSubRows: N
      ...
      function Lo(e, t, u, a) {
        ...
        if (t.type === w.setFilter) {
          var p = t.columnId, m = t.filterValue, d = a.allColumns, S = a.filterTypes, A = d.find(function(L) {
            return L.id === p;
          });
          if (!A)
          ...
          return rn(N.autoRemove, q, A) ? C({}, e, {
      ...
      function Oo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, m = e.allColumns, d = e.filterTypes, S = e.manualFilters, A = e.defaultCanFilter, N = A === void 0 ? !1 : A, I = e.disableFilters, q = e.state.filters, B = e.dispatch, G = e.autoResetFilters, _ = G === void 0 ? !0 : G, L = y.useCallback(function(J, Y) {
          B({
            type: w.setFilter,
            columnId: J,
            filterValue: Y
      ...
      function Ut(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, m = e.allColumns, d = e.filterTypes, S = e.globalFilter, A = e.manualGlobalFilter, N = e.state.globalFilter, I = e.dispatch, q = e.autoResetGlobalFilter, B = q === void 0 ? !0 : q, G = e.disableGlobalFilter, _ = y.useCallback(function(Pn) {
          I({
          ...
          m.forEach(function(cn) {
            ...
            cn.canFilter = re(Ln === !0 ? !1 : void 0, G === !0 ? !1 : void 0, !0);
          });
          ...
          return [$(u), Pn, Fn];
        }, [A, N, S, d, m, u, a, p, G]), Z = L[0], yn = L[1], mn = L[2], j = An(B);
        zn(function() {
          j() && I({
      ...
      var qo = {};
      function zo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, m = e.allColumns, d = e.flatHeaders, S = e.groupByFn, A = S === void 0 ? no : S, N = e.manualGroupBy, I = e.aggregations, q = I === void 0 ? qo : I, B = e.plugins, G = e.state.groupBy, _ = e.dispatch, L = e.autoResetGroupBy, Z = L === void 0 ? !0 : L, yn = e.disableGroupBy, mn = e.defaultCanGroupBy, j = e.getHooks;
        ...
        }, [N, G, u, a, p, m, q, A]), $ = Y[0], cn = Y[1], Ln = Y[2], On = Y[3], Xn = Y[4], tn = Y[5], le = Y[6], Bn = An(Z);
        zn(function() {
          Bn() && _({
            type: w.resetGroupBy
          });
      ...
      var eo = /([0-9]+)/gm, Xo = function(t, u, a) {
        ...
        for (m = oo(m), d = oo(d), m = m.split(eo).filter(Boolean), d = d.split(eo).filter(Boolean); m.length && d.length; ) {
      ...
      function ro(e, t, u, a) {
        ...
        if (t.type === w.toggleSortBy) {
          var S = t.columnId, A = t.desc, N = t.multi, I = a.allColumns, q = a.disableMultiSort, B = a.disableSortRemove, G = a.disableMultiRemove, _ = a.maxMultiSortColCount, L = _ === void 0 ? Number.MAX_SAFE_INTEGER : _, Z = e.sortBy, yn = I.find(function($) {
            return $.id === S;
      ...
      function uo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.allColumns, m = e.orderByFn, d = m === void 0 ? Mt : m, S = e.sortTypes, A = e.manualSortBy, N = e.defaultCanSort, I = e.disableSortBy, q = e.flatHeaders, B = e.state.sortBy, G = e.dispatch, _ = e.plugins, L = e.getHooks, Z = e.autoResetSortBy, yn = Z === void 0 ? !0 : Z;
        ...
        }, [G]), j = y.useCallback(function(cn, Ln, On) {
          G({
            type: w.toggleSortBy,
            columnId: cn,
            desc: Ln,
      ...
      function Qo(e, t, u, a) {
        ...
        if (t.type === w.gotoPage) {
          ...
          return d > e.pageIndex ? S = p === -1 ? m.length >= e.pageSize : d < p : d < e.pageIndex && (S = d > -1), S ? C({}, e, {
            pageIndex: d
          }) : e;
        }
      ...
      function lo(e) {
        var t = e.rows, u = e.autoResetPage, a = u === void 0 ? !0 : u, p = e.manualExpandedKey, m = p === void 0 ? "expanded" : p, d = e.plugins, S = e.pageCount, A = e.paginateExpandedRows, N = A === void 0 ? !0 : A, I = e.expandSubRows, q = I === void 0 ? !0 : I, B = e.state, G = B.pageSize, _ = B.pageIndex, L = B.expanded, Z = B.globalFilter, yn = B.filters, mn = B.groupBy, j = B.sortBy, Pn = e.dispatch, Fn = e.data, J = e.manualPagination;
        ...
        var $ = J ? S : Math.ceil(t.length / G), cn = y.useMemo(function() {
          return $ > 0 ? [].concat(new Array($)).fill(null).map(function(Mn, Un) {
            return Un;
          }) : [];
        }, [$]), Ln = y.useMemo(function() {
          var Mn;
          if (J)
            Mn = t;
          else {
        ...
        }, [q, L, m, J, _, G, N, t]), On = _ > 0, Xn = $ === -1 ? Ln.length >= G : _ < $ - 1, tn = y.useCallback(function(Mn) {
          Pn({
            type: w.gotoPage,
            pageIndex: Mn
          });
        }, [Pn]), le = y.useCallback(function() {
          return tn(function(Mn) {
            return Mn - 1;
          });
        }, [tn]), Bn = y.useCallback(function() {
          return tn(function(Mn) {
            return Mn + 1;
          });
        }, [tn]), Sn = y.useCallback(function(Mn) {
          Pn({
            type: w.setPageSize,
            pageSize: Mn
          });
        ...
        var m = p.pivotColumns.map(function(N) {
          ...
          return _.map(function(L) {
            var Z = C({}, G, {
              ...
              parent: q,
              depth: I,
              id: q ? q.id + "." + G.id + "." + L : G.id + "." + L,
              pivotValue: L
            });
            return Z.columns = N(I + 1, Z, [].concat(B, [function(yn) {
              return yn.values[G.id] === L;
            }])), Z;
          });
        }, A = Pe(S());
        return [].concat(e, A);
      ...
      function ia(e, t, u, a) {
        ...
        if (t.type === w.toggleRowSelected) {
          var q = t.id, B = t.value, G = a.rowsById, _ = a.selectSubRows, L = _ === void 0 ? !0 : _, Z = a.getSubRows, yn = e.selectedRowIds[q], mn = typeof B < "u" ? B : !yn;
          if (yn === mn)
            return e;
          var j = C({}, e.selectedRowIds), Pn = function Bn(Sn) {
            var Mn = G[Sn];
        ...
        if (t.type === w.toggleAllPageRowsSelected) {
          var Fn = t.value, J = a.page, Y = a.rowsById, $ = a.selectSubRows, cn = $ === void 0 ? !0 : $, Ln = a.isAllPageRowsSelected, On = a.getSubRows, Xn = typeof Fn < "u" ? Fn : !Ln, tn = C({}, e.selectedRowIds), le = function Bn(Sn) {
            var Mn = Y[Sn];
      ...
      function la(e) {
        var t = e.data, u = e.rows, a = e.getHooks, p = e.plugins, m = e.rowsById, d = e.nonGroupedRowsById, S = d === void 0 ? m : d, A = e.autoResetSelectedRows, N = A === void 0 ? !0 : A, I = e.state.selectedRowIds, q = e.selectSubRows, B = q === void 0 ? !0 : q, G = e.dispatch, _ = e.page, L = e.getSubRows;
        ...
        var Pn = y.useCallback(function(Ln) {
          return G({
            type: w.toggleAllRowsSelected,
            value: Ln
          });
        }, [G]), Fn = y.useCallback(function(Ln) {
          return G({
            type: w.toggleAllPageRowsSelected,
            value: Ln
          });
        }, [G]), J = y.useCallback(function(Ln, On) {
          return G({
      ...
      function Tt(e, t, u, a) {
        var p = a.initialRowStateAccessor, m = p === void 0 ? mo : p, d = a.initialCellStateAccessor, S = d === void 0 ? vo : d, A = a.rowsById;
        if (t.type === w.init)
          return C({
            rowState: {}
          }, e);
        ...
        if (t.type === w.setRowState) {
          ...
          return C({}, e, {
            rowState: C({}, e.rowState, (N = {}, N[I] = Wn(q, B), N))
          });
        }
        if (t.type === w.setCellState) {
          var G, _, L, Z, yn, mn = t.rowId, j = t.columnId, Pn = t.value, Fn = typeof e.rowState[mn] < "u" ? e.rowState[mn] : m(A[mn]), J = typeof (Fn == null || (G = Fn.cellState) == null ? void 0 : G[j]) < "u" ? Fn.cellState[j] : S((_ = A[mn]) == null || (L = _.cells) == null ? void 0 : L.find(function(Y) {
            return Y.column.id === j;
          }));
          return C({}, e, {
            rowState: C({}, e.rowState, (yn = {}, yn[mn] = C({}, Fn, {
      ...
      function n(e) {
        var t = e.autoResetRowState, u = t === void 0 ? !0 : t, a = e.data, p = e.dispatch, m = y.useCallback(function(A, N) {
          return p({
            type: w.setRowState,
            rowId: A,
            value: N
      ...
      function r(e, t) {
        var u = t.instance, a = u.initialRowStateAccessor, p = a === void 0 ? mo : a, m = u.initialCellStateAccessor, d = m === void 0 ? vo : m, S = u.state.rowState;
      ...
      var h = function(t) {
        ...
        var a = u.instance, p = u.header, m = a.dispatch, d = function(A, N) {
          ...
          }), G = I ? Math.round(A.touches[0].clientX) : A.clientX, _, L, Z = function() {
      ...
      function T(e, t) {
        ...
        if (t.type === w.columnResizing) {
          ...
          return q.forEach(function(L) {
            ...
            columnResizing: C({}, e.columnResizing, {
              columnWidths: C({}, e.columnResizing.columnWidths, {}, _)
            })
          });
        }
      ...
      function Dn(e, t, u, a) {
        ...
        if (t.type === w.columnResizing) {
          var q = t.clientX, B = e.columnResizing.startX, G = e.gridLayout, _ = G.columnWidth, L = G.minWidths, Z = G.maxWidths, yn = G.headerIdGridWidths, mn = yn === void 0 ? [] : yn, j = q - B, Pn = j / _, Fn = {};
          return mn.forEach(function(J) {
            var Y = J[0], $ = J[1];
            Fn[Y] = Math.min(Math.max(L[Y], $ + $ * Pn), Z[Y]);
          }), C({}, e, {
            gridLayout: C({}, e.gridLayout, {
              columnWidths: C({}, e.gridLayout.columnWidths, {}, Fn)
            })
          });
        }
        if (t.type === w.columnDoneResizing)
      ...
      c._UNSTABLE_usePivotColumns = so, c.actions = w, c.defaultColumn = Cn, c.defaultGroupByFn = no, c.defaultOrderByFn = Mt, c.defaultRenderer = un, c.emptyRenderer = Nn, c.ensurePluginOrder = Jn, c.flexRender = an, c.functionalUpdate = Wn, c.loopHooks = bn, c.makePropGetter = vn, c.makeRenderer = fn, c.reduceHooks = Hn, c.safeUseLayoutEffect = ae, c.useAbsoluteLayout = k, c.useAsyncDebounce = de, c.useBlockLayout = ln, c.useColumnOrder = i, c.useExpanded = ft, c.useFilters = Xt, c.useFlexLayout = kn, c.useGetLatest = An, c.useGlobalFilter = Yt, c.useGridLayout = xn, c.useGroupBy = St, c.useMountedLayoutEffect = zn, c.usePagination = io, c.useResizeColumns = h, c.useRowSelect = Rt, c.useRowState = ho, c.useSortBy = ao, c.useTable = at, Object.defineProperty(c, "__esModule", { value: !0 });
    });
...
var st = Sa.exports;
function Fu(o, f, c) {
  var y = this, b = D.useRef(null), P = D.useRef(0), C = D.useRef(null), O = D.useRef([]), Rn = D.useRef(), M = D.useRef(), En = D.useRef(o), w = D.useRef(!0);
  En.current = o;
  var un = !f && f !== 0 && typeof window < "u";
  if (typeof o != "function")
    throw new TypeError("Expected a function");
  f = +f || 0, c = c || {};
  var Nn = !!c.leading, Cn = "trailing" in c ? !!c.trailing : !0, dn = "maxWait" in c, Vn = dn ? Math.max(+c.maxWait || 0, f) : null, vn = D.useCallback(function(an) {
    var _n = O.current, Qn = Rn.current;
    return O.current = Rn.current = null, P.current = an, M.current = En.current.apply(Qn, _n);
  }, []), Hn = D.useCallback(function(an, _n) {
    un && cancelAnimationFrame(C.current), C.current = un ? requestAnimationFrame(an) : setTimeout(an, _n);
  }, [un]), bn = D.useCallback(function(an) {
    if (!w.current)
      return !1;
    var _n = an - b.current, Qn = an - P.current;
    return !b.current || _n >= f || _n < 0 || dn && Qn >= Vn;
  }, [Vn, dn, f]), Jn = D.useCallback(function(an) {
    return C.current = null, Cn && O.current ? vn(an) : (O.current = Rn.current = null, M.current);
  }, [vn, Cn]), Wn = D.useCallback(function() {
    var an = Date.now();
    if (bn(an))
      return Jn(an);
    if (w.current) {
      var _n = an - b.current, Qn = an - P.current, Yn = f - _n, ne = dn ? Math.min(Yn, Vn - Qn) : Yn;
      Hn(Wn, ne);
    }
  ...
  var zn = D.useCallback(function() {
    ...
    if (O.current = an, Rn.current = y, b.current = Qn, Yn) {
  ...
  }, [vn, Nn, dn, bn, Hn, Wn, f]), de = D.useCallback(function() {
    return !!C.current;
...
function Wu(o) {
  var f = D.useState(ja(o)), c = f[0], y = f[1], b = D.useCallback(function(P) {
    return y(ja(P));
  }, []);
  return [c, b];
}
function xu(o, f, c) {
  var y = c && c.equalityFn || Hu, b = Wu(o), P = b[0], C = b[1], O = Fu(D.useCallback(function(M) {
    return C(M);
  }, [C]), f, c), Rn = D.useRef(o);
  return D.useEffect(function() {
    y(Rn.current, o) || (O.callback(o), Rn.current = o);
  }, [o, O, y]), [P, { cancel: O.cancel, pending: O.pending, flush: O.flush }];
}
function Gu(o) {
...
const wa = 10, ot = {
  ...
  const [y, b] = D.useState(o), [P] = xu(y, 200);
  D.useEffect(() => {
...
}), Ua = D.memo(({ globalFilter: o, data: f, setGlobalFilter: c }) => /* @__PURE__ */ l.createElement("header", { className: "data-table-header" }, /* @__PURE__ */ l.createElement("h2", null, "Data Preview"), /* @__PURE__ */ l.createElement(Vu, { globalFilter: o || "", setGlobalFilter: c, disabled: f === null }))), Ku = D.memo(({ previousPage: o, nextPage: f, canPreviousPage: c, canNextPage: y, pageNumber: b, totalPages: P }) => /* @__PURE__ */ l.createElement("footer", { className: "data-table-pagination" }, /* @__PURE__ */ l.createElement("ul", null, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement("button", { onClick: () => o(), className: "btn btn-prev", disabled: !c, title: "Previous Page" })), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement("button", { onClick: () => f(), className: "btn btn-next", disabled: !y, title: "Next Page" }))), /* @__PURE__ */ l.createElement("span", null, "Page ", b, " of ", P))), qu = () => {
  const { config: o } = D.useContext(ct), f = D.useMemo(() => o.type === "dashboard" ? Object.values(o.datasets).find((fn) => fn.preview && Array.isArray(fn.data)) : o.data, [o.type, o.data, o.datasets]), [c, y] = D.useState(f), b = (fn) => {
    const an = Object.keys(fn[0]).includes("tableData"), _n = M(an ? fn[0].tableData : fn);
    return Gu(_n), _n;
  }, P = (fn) => y(b(fn)), C = D.useContext(Lt), O = async () => {
    if (o.type === "dashboard")
  ...
  const Rn = D.useMemo(() => {
    if (!c)
      return [];
    const fn = c.columns ?? [];
    return fn.length > 0 && fn.includes("") && C({ type: "EDITOR_SET_ERRORS", payload: [ot.emptyCols] }), fn.map((an) => ({
      id: `column-${an}`,
      accessor: (Qn) => Qn[an],
      Header: an,
      width: 250
...
`, ei = `[
  ...
  const { editingDataset: y, loadData: b } = D.useContext(Io), P = (O) => b(new Blob([c], { type: "text/csv" }), f, y), C = (O) => O.keyCode === 13 && b(new Blob([c], { type: "text/csv" }), f, y);
...
}, ai = () => ba.maps.map((o) => /* @__PURE__ */ l.createElement(cr, { key: o.fileName, text: o.text, fileName: o.fileName, data: o.data })), ri = () => ba.charts.map((o) => /* @__PURE__ */ l.createElement(cr, { key: o.fileName, text: o.text, fileName: o.fileName, data: o.data })), ui = () => {
  const { config: o } = D.useContext(Io);
  return /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("h3", { className: "heading-3" }, "Load Sample Data:"), /* @__PURE__ */ l.createElement("ul", { className: "sample-data-list" }, o.type !== "map" && /* @__PURE__ */ l.createElement(ri, null), o.type !== "chart" && /* @__PURE__ */ l.createElement(ai, null)));
}, Aa = () => null;
Aa.data = ba;
Aa.Buttons = ui;
...
function ii() {
  const { config: o, errors: f, tempConfig: c, sharepath: y } = D.useContext(ct), b = (F) => {
    dn({ type: "EDITOR_SET_CONFIG", payload: F });
  }, P = (F) => {
    dn({ type: "EDITOR_SET_ERRORS", payload: F });
  }, C = new Nr(), [O, Rn] = D.useState(o.dataFileSourceType === "url" ? o.dataFileName : o.dataUrl || ""), [M, En] = D.useState(!!o.dataUrl), [w, un] = D.useState(o.type === "dashboard" || !o.data), [Nn, Cn] = D.useState(void 0), dn = D.useContext(Lt), Vn = {
    ".csv": "text/csv",
    ".json": "application/json"
  }, vn = (F) => F === void 0 ? "" : F > Math.pow(1024, 3) ? Math.round(F / Math.pow(1024, 3) * 100) / 100 + " GB" : F > Math.pow(1024, 2) ? Math.round(F / Math.pow(1024, 2) * 100) / 100 + " MB" : F > 1024 ? Math.round(F / 1024 * 100) / 100 + " KB" : F + " B", Hn = (F, z, rn) => (z.map(function(en, Gn, jn) {
    if (!jn.find((we) => we.dataKey === en.dataKey))
      return !1;
  }), !(F.columns.indexOf(rn) < 0)), bn = (F) => ca(O) ? ".csv" : Mo(O) ? ".json" : Object.keys(Vn).find((z) => F.pathname.endsWith(z)), Jn = async () => {
    let F;
    try {
      F = ca(O) || Mo(O) ? O : new URL(O, window.location.origin);
    } catch {
      throw ot.urlInvalid;
    }
    let z = null;
    ...
    try {
      await Rr.get(F.toString(), {
        ...
        z = en.data, rn === ".csv" && ["text/csv", "text/plain"].includes(z.type) || ca(O) ? z = z.slice(0, z.size, "text/csv") : (z.type === "application/json" || rn === ".json" && z.type === "text/plain" || Mo(O)) && (z = z.slice(0, z.size, "application/json"));
      });
    } catch (en) {
      console.error(en);
      const Gn = en.toString();
      throw Object.values(ot).includes(en) ? Gn : ot.failedFetch;
    }
    return o.type === "dashboard" && Rn(""), z;
  }, Wn = ([F]) => An(F, Nn, Nn), An = async (F = null, z, rn) => {
    let en = F;
    const Gn = (en == null ? void 0 : en.path) ?? z ?? O, jn = F ? "file" : "url";
    if (jn === "url")
      try {
        en = await Jn();
      } catch (pe) {
      ...
      const pe = (ye, ve = !1) => {
        if (o.type === "dashboard") {
          ...
          let he = {
            ...
            dataFileSourceType: jn,
            // new file source type
            formattedData: C.developerStandardize(ye, o.dataDescription)
          };
          M && (he.dataUrl = Gn), b(he);
        }
      };
      try {
        const ye = Ie(this.result.toString()), ve = C.autoStandardize(ye);
  ...
  D.useEffect(() => {
    ...
    if (o.formattedData === void 0 && o.dataDescription) {
      const z = C.developerStandardize(o.data, o.dataDescription);
      z && (F.formattedData = z);
    }
  ...
  const ae = (F, z, rn) => {
    if (o.type === "dashboard") {
      let en = { ...o.datasets[F].dataDescription, [z]: rn }, Gn = C.developerStandardize(o.datasets[F].data, en), jn = { ...o.datasets };
      jn[F] = { ...jn[F], dataDescription: en, formattedData: Gn }, b({ ...o, datasets: jn });
    } else {
      let en = { ...o.dataDescription, [z]: rn }, Gn = C.developerStandardize(o.data, en);
      b({ ...o, formattedData: Gn, dataDescription: en });
    }
  }, zn = (F, z) => {
    if (z) {
      let rn = { ...o.datasets };
    ...
    En(F);
  }, { getRootProps: de, getInputProps: fn, isDragActive: an } = ha({ onDrop: Wn }), { getRootProps: _n, getInputProps: Qn, isDragActive: Yn } = ha({ onDrop: Wn }), ne = () => /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("form", { className: "input-group d-flex", onSubmit: (F) => F.preventDefault() }, /* @__PURE__ */ l.createElement("input", { id: "external-data", type: "text", className: "form-control flex-grow-1 border-right-0", placeholder: "e.g., https://data.cdc.gov/resources/file.json", "aria-label": "Load data from external URL", "aria-describedby": "load-data", value: O, onChange: (F) => Rn(F.target.value) }), /* @__PURE__ */ l.createElement("button", { className: "input-group-text btn btn-primary px-4", type: "submit", id: "load-data", onClick: () => An(null, O, Nn) }, "Load")), /* @__PURE__ */ l.createElement("label", { htmlFor: "keep-url", className: "mt-1 d-flex keep-url" }, /* @__PURE__ */ l.createElement("input", { type: "checkbox", id: "keep-url", checked: M, onChange: () => zn(!M, Nn) }), " Always load from URL (normally will only pull once)")), Pe = (F = {}, z = "Are you sure you want to do this?") => {
    ...
    let en = { ...o.datasets };
    rn === !0 ? Object.keys(en).forEach((Gn) => {
      const jn = Gn === F;
      en[Gn][z] = jn;
    }) : en[F][z] = rn, b({ ...o, datasets: en });
  }, Ee = (F) => {
    let z = { ...o.datasets }, rn = { ...o.visualizations };
    Object.keys(rn).forEach((en) => {
      rn[en].dataKey === F && delete rn[en].dataKey;
    }), delete z[F], b({ ...o, datasets: z, visualizations: rn });
  }, fe = (F, z) => {
    if (F === z)
      return;
    let rn = { ...o.datasets }, en = { ...o.visualizations }, Gn = 2, jn = z;
    for (; rn[z]; )
      z = jn + "-" + Gn, Gn++;
    rn[z] = rn[F], delete rn[F], Object.keys(en).forEach((we) => {
      en[we].dataKey === F && (en[we].dataKey = z);
  ...
  const Oe = /* @__PURE__ */ l.createElement(l.Fragment, null, o.filters && o.filters.map(
    (F, z) => F.type !== "url" ? /* @__PURE__ */ l.createElement(l.Fragment, null) : /* @__PURE__ */ l.createElement("fieldset", { key: F.key, className: "edit-block url-filters-block" }, /* @__PURE__ */ l.createElement(
    ...
    )), /* @__PURE__ */ l.createElement("label", null, /* @__PURE__ */ l.createElement("span", { className: "edit-label column-heading" }, "Values"), " "), /* @__PURE__ */ l.createElement("ul", { className: "value-list" }, F.orderedValues && F.orderedValues.map((rn, en) => /* @__PURE__ */ l.createElement("li", null, rn, /* @__PURE__ */ l.createElement(
      "input",
      {
        type: "text",
      ...
      "button",
      {
        onClick: () => {
          let Gn = [...o.filters];
          Gn[z].labels && delete Gn[z].labels[Gn[z].orderedValues[en]], Gn[z].orderedValues.splice(en, 1), b({ ...o, filters: Gn });
        }
      },
      "X"
    )))), /* @__PURE__ */ l.createElement(
...
function mi() {
  ...
  const y = ({ icon: b, label: P, type: C, subType: O = void 0, orientation: Rn = void 0, stacked: M = !1, generalType: En = "data" }) => {
    ...
    C === "chart" && (w = O === o.visualizationType, un = Rn === o.orientation && M === !0), (C === "dashboard" || C === "data-bite" || C === "markup-include") && (w = !0), C === "chart" && M ? Nn = o.type === C && w && o.visualizationSubType === "stacked" ? "active" : "" : C === "chart" && !M && o.visualizationSubType !== "stacked" && (Nn = o.type === C && w ? "active" : ""), C !== "chart" && (Nn = o.type === C && w && !un ? "active" : "");
    let Cn = () => {
      if (C === o.type)
  ...
  return /* @__PURE__ */ l.createElement("div", { className: "choose-vis" }, /* @__PURE__ */ l.createElement("a", { href: "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/index.html", target: "_blank", rel: "noopener noreferrer", className: "guidance-link", style: { marginTop: 0, marginBottom: "2rem" } }, /* @__PURE__ */ l.createElement("div", null, /* @__PURE__ */ l.createElement("p", null, "For more information on the types of data visualizations in the WCMS, including examples and best practices, ", /* @__PURE__ */ l.createElement("u", null, "see the WCMS Features Gallery"), "."))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "General"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, " ", /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, { position: "right" }, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Dashboard", type: "dashboard", icon: /* @__PURE__ */ l.createElement(li, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Present multiple data visualizations with shared filter controls."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Data Bite", type: "data-bite", icon: /* @__PURE__ */ l.createElement(Tr, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Highlight a single aggregated value (e.g., sum or median)."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Waffle Chart", type: "waffle-chart", subType: "Waffle", icon: /* @__PURE__ */ l.createElement(Pr, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Highlight a piece of data in relationship to a data set."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Gauge Chart", type: "waffle-chart", subType: "Gauge", icon: /* @__PURE__ */ l.createElement(fi, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Specify the calculation of a single data point (such as a percentage value) and present it on a horizontal scale.")))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "Charts"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, { position: "right" }, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Bar", type: "chart", subType: "Bar", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Er, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Use bars to show comparisons between data categories."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Line", type: "chart", subType: "Line", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Ir, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Present one or more data trends over time."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Pie", type: "chart", subType: "Pie", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(kr, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Present the numerical proportions of a data series."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Paired Bar", type: "chart", subType: "Paired Bar", orientation: "horizontal", icon: /* @__PURE__ */ l.createElement(si, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Use paired bars to show comparisons between two different data categories."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Deviation Bar", type: "chart", subType: "Deviation Bar", orientation: "horizontal", stacked: !1, icon: /* @__PURE__ */ l.createElement(gi, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Use deviation bars to display how individual values differ from a target."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Horizontal Bar (Stacked)", type: "chart", subType: "Bar", orientation: "horizontal", stacked: !0, icon: /* @__PURE__ */ l.createElement(ci, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Use bars to show comparisons between data categories.")))), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Box Plot", type: "chart", subType: "Box Plot", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Ci, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Display a box plot"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Scatter Plot", type: "chart", subType: "Scatter Plot", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(yi, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Display a scatter plot"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Area Chart", type: "chart", subType: "Area Chart", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(di, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Display an area chart"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Forecast Chart", type: "chart", subType: "Forecasting", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(pi, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Display a forecasting chart"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Sankey Diagram", type: "chart", subType: "Sankey", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Lr, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Display a sankey diagram")))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "Maps"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, { position: "right" }, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "United States (State- or County-Level)", type: "map", subType: "us", icon: /* @__PURE__ */ l.createElement(Ia, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, { position: "right" }, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "United States (HHS Regions)", type: "map", subType: "us-region", icon: /* @__PURE__ */ l.createElement(Dr, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "World", type: "map", subType: "world", icon: /* @__PURE__ */ l.createElement(Or, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Present a choropleth map of the world."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "U.S. State", type: "map", subType: "single-state", icon: /* @__PURE__ */ l.createElement(Br, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "Present a choropleth map of an individual U.S. state."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(on, null, /* @__PURE__ */ l.createElement(on.Target, null, /* @__PURE__ */ l.createElement(y, { label: "U.S. Geocode", type: "map", subType: "us-county", generalType: "us-geocode", icon: /* @__PURE__ */ l.createElement(Ia, null) })), /* @__PURE__ */ l.createElement(on.Content, null, "United States GeoCode")))));
}
function vi({ containerEl: o }) {
  const { config: f, setTempConfig: c, hostname: y, isDebug: b } = D.useContext(ct);
  let { type: P } = f;
  switch (P) {
    case "map":
      return /* @__PURE__ */ l.createElement(lt, { component: "CdcMap" }, /* @__PURE__ */ l.createElement(wr, { isEditor: !0, isDebug: b, config: f, hostname: y, setConfig: c, containerEl: o }));
    case "waffle-chart":
...
const hi = (o) => {
  ...
  o.rows && o.rows.forEach((c) => {
    if (c.footnotesId) {
      const { dataKey: y, staticFootnotes: b } = o.visualizations[c.footnotesId];
      !y && !(b != null && b.length) ? delete o.visualizations[c.footnotesId] : f.push(c.footnotesId);
    }
  ...
  o.datasets && Object.keys(o.datasets).forEach((f) => {
    ...
    o.visualizations[f] = No.omit(o.visualizations[f], ["runtime", "formattedData", "data"]);
  }), o.rows && o.rows.forEach((f) => {
    f.dataKey && (f = No.omit(f, ["data", "formattedData"]));
  });
}, yr = (o) => {
  let f = { ...o };
  ...
  if (o.type === "dashboard") {
    ...
    if (o.data || o.dataUrl) {
      ...
      y.datasets = {}, y.datasets[b] = {
        ...
        const O = { dataKey: b, ...No.pick(y, "dataDescription", "formattedData") };
...
const bi = (o, f) => {
...
}, Ai = Mr(bi), Di = ({ config: o, hostname: f, containerEl: c, sharepath: y, isDebug: b }) => {
  const P = D.useMemo(() => {
    let un = 0;
    return (o != null && o.data || o != null && o.dataUrl) && (o != null && o.type) && (un = 2), { config: Mi(o || { newViz: !0, errors: [], currentViewport: "lg" }), errors: [], currentViewport: "lg", globalActive: un, sharepath: y, isDebug: b, hostname: f };
  }, [o]);
  D.useEffect(() => {
    var un;
  ...
  const [C, O] = D.useReducer(Ai, P), Rn = (un) => {
    ...
    const Nn = un[0];
    let { width: Cn } = Nn.contentRect, dn = pr(Cn);
  ...
  return /* @__PURE__ */ l.createElement(br, null, /* @__PURE__ */ l.createElement(ct.Provider, { value: { ...C, setTempConfig: Rn } }, /* @__PURE__ */ l.createElement(Lt.Provider, { value: O }, /* @__PURE__ */ l.createElement("div", { className: `cdc-open-viz-module cdc-editor ${C.currentViewport}`, ref: En }, /* @__PURE__ */ l.createElement(ku, { className: "top-level" }, /* @__PURE__ */ l.createElement(kt, { title: "1. Choose Visualization Type", className: "choose-type" }, /* @__PURE__ */ l.createElement(mi, null)), /* @__PURE__ */ l.createElement(kt, { title: "2. Import Data", className: "data-designer", disableRule: !C.config.type }, /* @__PURE__ */ l.createElement(ii, null)), /* @__PURE__ */ l.createElement(kt, { title: "3. Configure", className: "configure", disableRule: w }, /* @__PURE__ */ l.createElement(vi, { containerEl: c })))))), /* @__PURE__ */ l.createElement(Ar, null));
}, c0 = {
