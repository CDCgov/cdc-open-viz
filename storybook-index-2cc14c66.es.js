...
var Dt = [], tr = null, rm = b.lazy(async () => {
  let { SyntaxHighlighter: e } = await import("./storybook-syntaxhighlighter-V7JZZA35-57cd26b1.es.js");
  return Dt.length > 0 && (Dt.forEach((t) => {
    e.registerLanguage(...t);
  }), Dt = []), tr === null && (tr = e), { default: (t) => a.createElement(e, { ...t }) };
}), nm = b.lazy(async () => {
  let [{ SyntaxHighlighter: e }, { formatter: t }] = await Promise.all([import("./storybook-syntaxhighlighter-V7JZZA35-57cd26b1.es.js"), import("./storybook-formatter-SWP5E3XI-11fbe0d9.es.js")]);
...
}), { displayName: "Button" }), je = Object.assign(_.form({ boxSizing: "border-box", width: "100%" }), { Field: Gu, Input: Om, Select: Tm, Textarea: Rm, Button: Dm }), Lm = b.lazy(() => import("./storybook-WithTooltip-V3YHNWJZ-46b59f25.es.js").then((e) => ({ default: e.WithTooltip }))), $m = (e) => a.createElement(b.Suspense, { fallback: a.createElement("div", null) }, a.createElement(Lm, { ...e })), Mm = b.lazy(() => import("./storybook-WithTooltip-V3YHNWJZ-46b59f25.es.js").then((e) => ({ default: e.WithTooltipPure }))), Ku = (e) => a.createElement(b.Suspense, { fallback: a.createElement("div", null) }, a.createElement(Mm, { ...e }));
