...
import { b as Eo, c as Cd } from "./storybook-60d140a8.es.js";
...
function Bo(a, p) {
  return new Promise(function(o, b) {
    ...
    T.onload = function() {
      ...
      R.url.startsWith("file://") && (T.status < 200 || T.status > 599) ? z.status = 200 : z.status = T.status, z.url = "responseURL" in T ? T.responseURL : z.headers.get("X-Request-URL");
