...
import { i as aa, g as ta } from "./storybook-7366772a.es.js";
import { f as na } from "./storybook-5637bace.es.js";
import { E as Ve, L as la } from "./storybook-a0c99f4a.es.js";
import { A as le } from "./storybook-603f8697.es.js";
import { B as oa } from "./storybook-8d78bf52.es.js";
import { I as he } from "./storybook-d6b8e24c.es.js";
import { T as U } from "./storybook-46a89ba7.es.js";
import { I as x } from "./storybook-c75f9caa.es.js";
import { S as ra, I as F, B as ye, C as sa, c as ia } from "./storybook-fde5cb17.es.js";
import { P as oe } from "./storybook-b8c9afe4.es.js";
import "./storybook-4ed993c7.es.js";
import { c as ca, p as ma, u as ua } from "./storybook-25f566e3.es.js";
import { G as we } from "./storybook-b0e07e40.es.js";
...
const fa = u.memo((t) => {
  const { config: a, updateConfig: d, loading: w, data: _, setParentConfig: C, isDashboard: g } = u.useContext(qe), [E, p] = u.useState(!0), [A, $] = u.useState(!1), R = (l) => l ? { backgroundColor: "#ffd2d2", color: "#d8000c" } : {}, o = (l, s, i, v) => {
    if (l === null && s === null) {
      let ee = { ...a, [i]: v };
  ...
  }, Q = ["Waffle", "Gauge"], H = /* @__PURE__ */ e.createElement(le, null, /* @__PURE__ */ e.createElement(le.Section, { title: "General" }, /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-section" }, /* @__PURE__ */ e.createElement("div", { style: { width: "100%", display: "block" }, className: "cove-input-group" }, /* @__PURE__ */ e.createElement(F, { value: a.visualizationType, fieldName: "visualizationType", label: "Chart Type", updateField: o, options: Q, className: "cove-input" }), a.visualizationType === "Gauge" && /* @__PURE__ */ e.createElement(F, { value: a.visualizationSubType, fieldName: "visualizationSubType", label: "Chart Subtype", updateField: o, options: ["Linear"], className: "cove-input" }))), /* @__PURE__ */ e.createElement(x, { value: a.title, fieldName: "title", label: "Title", placeholder: "Chart Title", updateField: o }), /* @__PURE__ */ e.createElement(
    x,
    {
      type: "textarea",
      value: a.content,
  ...
  ))))), /* @__PURE__ */ e.createElement(oa, { onClick: r, fluid: !0 }, "Add Filter")), /* @__PURE__ */ e.createElement(le.Section, { title: "Visual" }, a.visualizationType !== "Gauge" && /* @__PURE__ */ e.createElement(F, { value: a.shape, fieldName: "shape", label: "Shape", updateField: o, options: ["circle", "square", "person"], className: "cove-input" }), a.visualizationType !== "Gauge" && /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-row cove-accordion__small-inputs", style: { marginTop: "1rem", marginBottom: "1rem" } }, /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-col" }, /* @__PURE__ */ e.createElement(x, { type: "number", value: a.nodeWidth, fieldName: "nodeWidth", label: "Width", updateField: o })), /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-col" }, /* @__PURE__ */ e.createElement(x, { type: "number", value: a.nodeSpacer, fieldName: "nodeSpacer", label: "Spacer", updateField: o }))), /* @__PURE__ */ e.createElement("div", { className: "cove-input-group" }, a.visualizationType !== "Gauge" && /* @__PURE__ */ e.createElement(F, { value: a.orientation, fieldName: "orientation", label: "Layout", updateField: o, className: "cove-input", options: ["horizontal", "vertical"] })), /* @__PURE__ */ e.createElement("div", { className: "cove-input-group" }, /* @__PURE__ */ e.createElement("label", null, /* @__PURE__ */ e.createElement("span", { className: "edit-label column-heading cove-input__label" }, "Data Point Font Size")), /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-row cove-accordion__small-inputs align-center" }, /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-col" }, /* @__PURE__ */ e.createElement(x, { type: "number", value: a.fontSize, fieldName: "fontSize", updateField: o })), /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-col", style: { display: "flex", alignItems: "center" } }, /* @__PURE__ */ e.createElement("label", { className: "accordion__panel-label--muted" }, " default (50px)")))), /* @__PURE__ */ e.createElement(F, { value: a.overallFontSize, fieldName: "overallFontSize", label: "Overall Font Size", updateField: o, options: ["small", "medium", "large"], className: "cove-input" }), /* @__PURE__ */ e.createElement("label", null, /* @__PURE__ */ e.createElement("span", { className: "edit-label cove-input__label" }, "Theme"), /* @__PURE__ */ e.createElement("ul", { className: "color-palette" }, pa.map((l) => /* @__PURE__ */ e.createElement(
    "li",
    {
      title: l,
      key: l,
  ...
  )))), /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-section reverse-labels" }, /* @__PURE__ */ e.createElement(G, { inline: !0, size: "small", value: a.visual.border, section: "visual", fieldName: "border", label: "Display Border", updateField: o }), /* @__PURE__ */ e.createElement(G, { inline: !0, size: "small", value: a.visual.borderColorTheme, section: "visual", fieldName: "borderColorTheme", label: "Use theme border color", updateField: o }), /* @__PURE__ */ e.createElement(G, { size: "small", value: a.visual.accent, section: "visual", fieldName: "accent", label: "Use Accent Style", updateField: o }), /* @__PURE__ */ e.createElement(G, { size: "small", value: a.visual.background, section: "visual", fieldName: "background", label: "Use Theme Background Color", updateField: o }), /* @__PURE__ */ e.createElement(G, { size: "small", value: a.visual.hideBackgroundColor, section: "visual", fieldName: "hideBackgroundColor", label: "Hide Background Color", updateField: o }))));
...
const va = ({ config: t, isEditor: a, link: d = "" }) => {
  const { title: w, theme: _, shape: C, nodeWidth: g, nodeSpacer: E, prefix: p, suffix: A, subtext: $, content: R, orientation: o, filters: N, dataColumn: O, dataFunction: k, dataConditionalColumn: b, dataConditionalOperator: r, dataConditionalComparate: c, customDenom: D, dataDenom: Y, dataDenomColumn: q, dataDenomFunction: Q, roundToPlace: H } = t, l = (I, S = !1) => {
  ...
  }, [O, k, t.data, N, b, r, c, D, q, Q, H, Y]), [L, W, K] = v(), ee = u.useCallback(() => {
  ...
  if (E === !1) {
    let r = ["cove", "cdc-open-viz-module", "type-waffle-chart", A, p.theme, "font-" + p.overallFontSize];
    w && r.push("is-editor");
    ...
    b = /* @__PURE__ */ e.createElement("div", { className: r.join(" ") }, w && /* @__PURE__ */ e.createElement(fa, null, D), !w && D);
  }
  return /* @__PURE__ */ e.createElement(Ve, { component: "WaffleChart" }, /* @__PURE__ */ e.createElement(qe.Provider, { value: { config: p, updateConfig: o, loading: E, data: p.data, setParentConfig: _, isDashboard: d, outerContainerRef: k } }, b));
}, ve = "Max", ge = "Count", Ee = "Mean (Average)", Ce = "Median", Ne = "Min", be = "Mode", _e = "Sum", De = [ge, ve, Ee, Ce, Ne, be, _e], ga = "<", Ea = ">", Ca = "<=", Na = ">=", ba = "=", _a = "≠", ya = [ga, Ea, Ca, Na, ba, _a], Ya = {
...
re.parameters = {
  ...re.parameters,
  docs: {
    ...(Se = re.parameters) == null ? void 0 : Se.docs,
    source: {
      originalSource: `{
  args: {
    configUrl: 'https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/examples/Waffle-Chart-Example-Count.json'
  ...
  render: args => <>
      ...
      ...(xe = (Te = re.parameters) == null ? void 0 : Te.docs) == null ? void 0 : xe.source
    }
  }
};
var Ae, Oe, ze;
...
const Ba = ["Example_Waffle_Chart_Count", "Waffle_Chart_Average_Max", "Waffle_Chart_Demographics", "Linear_Gauge", "Linear_Gauge_With_Message", "Person", "Gauge"];
export {
  re as Example_Waffle_Chart_Count,
  de as Gauge,
  ce as Linear_Gauge,
