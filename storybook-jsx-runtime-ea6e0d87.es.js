import { r as we } from "./storybook-index-f2fed736.es.js";
var Z = { exports: {} }, F = {};
/**
 * @license React
...
function cr() {
  if (Se)
    return F;
  Se = 1;
  var M = we, w = Symbol.for("react.element"), U = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, A = M.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function P(h, c, T) {
...
function vr() {
  return Ce || (Ce = 1, process.env.NODE_ENV !== "production" && function() {
    var M = we, w = Symbol.for("react.element"), U = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), A = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), P = Symbol.for("react.provider"), h = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), E = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), ee = Symbol.iterator, Pe = "@@iterator";
    function je(e) {
    ...
    function We(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === I || Ie || e === A || e === T || e === p || Ae || e === W || ke || Fe || De || typeof e == "object" && e !== null && (e.$$typeof === E || e.$$typeof === b || e.$$typeof === P || e.$$typeof === h || e.$$typeof === c || // This needs to include all possible module reference object
    ...
    var R = Object.assign, j = 0, ne, ae, ie, oe, ue, se, fe;
    function le() {
    }
...
` + a[s].replace(" at new ", " at ");
    ...
    var x = Object.prototype.hasOwnProperty, ve = {}, de = O.ReactDebugCurrentFrame;
    function V(e) {
      if (e) {
    ...
    function Ne(e, r, t, n, o) {
      {
        ...
        for (var i in e)
          if (u(e, i)) {
            ...
            a && !(a instanceof Error) && (V(o), l("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, i, typeof a), V(null)), a instanceof Error && !(a.message in ve) && (ve[a.message] = !0, V(o), l("Failed %s type: %s", t, a.message), V(null));
          }
      }
    }
    ...
    function er(e, r, t, n, o) {
      {
        ...
        t !== void 0 && (ge(t), a = "" + t), ze(r) && (ge(r.key), a = "" + r.key), Ge(r) && (v = r.ref, Xe(r, o));
        for (u in r)
...
var Q = Z.exports;
const pr = Q.Fragment, gr = Q.jsx, yr = Q.jsxs;
export {
  pr as F,
  yr as a,
  gr as j
