function q0(t = "", e = null) {
  var r;
  if (typeof t == "string" && ((r = e == null ? void 0 : e.legend) == null ? void 0 : r.type) === "category")
    return t;
  let n = /[^\d.-]/g;
  return Number.isNaN(parseFloat(t)) === !1 && String(t).match(n) === null ? parseFloat(t) : t;
}
const { min: ze, max: Ge } = Math, V = (t, e = 0, n = 1) => ze(Ge(e, t), n), Ot = (t) => {
  t._clipped = !1, t._unclipped = t.slice(0);
  for (let e = 0; e <= 3; e++)
    e < 3 ? ((t[e] < 0 || t[e] > 255) && (t._clipped = !0), t[e] = V(t[e], 0, 255)) : e === 3 && (t[e] = V(t[e], 0, 1));
  return t;
}, re = {};
for (let t of [
  "Boolean",
...
const M = (t, e = null) => t.length >= 3 ? Array.prototype.slice.call(t) : x(t[0]) == "object" && e ? e.split("").filter((n) => t[0][n] !== void 0).map((n) => t[0][n]) : t[0].slice(0), rt = (t) => {
  if (t.length < 2)
    return null;
  const e = t.length - 1;
  return x(t[e]) == "string" ? t[e].toLowerCase() : null;
}, { PI: wt, min: oe, max: ce } = Math, S = (t) => Math.round(t * 100) / 100, Ct = (t) => Math.round(t * 100) / 100, K = wt * 2, _t = wt / 3, Be = wt / 180, Se = 180 / wt;
function se(t) {
...
class i {
  constructor(...e) {
    const n = this;
    if (x(e[0]) === "object" && e[0].constructor && e[0].constructor === this.constructor)
      return e[0];
    let r = rt(e), o = !1;
    if (!r) {
...
k.autodetect.push({
  p: 5,
  test: (t, ...e) => {
    if (!e.length && x(t) === "string" && et[t.toLowerCase()])
      return "named";
  }
});
...
const Yt = (...t) => {
  ...
  const { kE: r, kK: o, kKE: c, Xn: s, Yn: f, Zn: a } = I, l = (t + 16) / 116, b = 2e-3 * e + l, d = l - 5e-3 * n, h = b * b * b, p = d * d * d, _ = h > r ? h : (116 * b - 16) / o, R = t > c ? Math.pow((t + 16) / 116, 3) : t / o, w = p > r ? p : (116 * d - 16) / o, g = _ * s, O = R * f, Y = w * a;
  return [g, O, Y];
}, Mt = (t) => {
  const e = Math.sign(t);
  return t = Math.abs(t), (t <= 31308e-7 ? t * 12.92 : 1.055 * Math.pow(t, 1 / 2.4) - 0.055) * e;
}, le = (t, e, n) => {
  const { MtxAdaptMa: r, MtxAdaptMaI: o, MtxXYZ2RGB: c, RefWhiteRGB: s, Xn: f, Yn: a, Zn: l } = I, b = f * r.m00 + a * r.m10 + l * r.m20, d = f * r.m01 + a * r.m11 + l * r.m21, h = f * r.m02 + a * r.m12 + l * r.m22, p = s.X * r.m00 + s.Y * r.m10 + s.Z * r.m20, _ = s.X * r.m01 + s.Y * r.m11 + s.Z * r.m21, R = s.X * r.m02 + s.Y * r.m12 + s.Z * r.m22, w = (t * r.m00 + e * r.m10 + n * r.m20) * (p / b), g = (t * r.m01 + e * r.m11 + n * r.m21) * (_ / d), O = (t * r.m02 + e * r.m12 + n * r.m22) * (R / h), Y = w * o.m00 + g * o.m10 + O * o.m20, C = w * o.m01 + g * o.m11 + O * o.m21, z = w * o.m02 + g * o.m12 + O * o.m22, A = Mt(
    Y * c.m00 + C * c.m10 + z * c.m20
  ), u = Mt(
    Y * c.m01 + C * c.m11 + z * c.m21
  ), m = Mt(
    Y * c.m02 + C * c.m12 + z * c.m22
  );
...
function Ke(t, e, n) {
  const { Xn: r, Yn: o, Zn: c, kE: s, kK: f } = I, a = t / r, l = e / o, b = n / c, d = a > s ? Math.pow(a, 1 / 3) : (f * a + 16) / 116, h = l > s ? Math.pow(l, 1 / 3) : (f * l + 16) / 116, p = b > s ? Math.pow(b, 1 / 3) : (f * b + 16) / 116;
...
const ie = (t, e, n) => {
  ...
  const { MtxRGB2XYZ: r, MtxAdaptMa: o, MtxAdaptMaI: c, Xn: s, Yn: f, Zn: a, As: l, Bs: b, Cs: d } = I;
  let h = t * r.m00 + e * r.m10 + n * r.m20, p = t * r.m01 + e * r.m11 + n * r.m21, _ = t * r.m02 + e * r.m12 + n * r.m22;
  const R = s * o.m00 + f * o.m10 + a * o.m20, w = s * o.m01 + f * o.m11 + a * o.m21, g = s * o.m02 + f * o.m12 + a * o.m22;
  let O = h * o.m00 + p * o.m10 + _ * o.m20, Y = h * o.m01 + p * o.m11 + _ * o.m21, C = h * o.m02 + p * o.m12 + _ * o.m22;
  return O *= R / l, Y *= w / b, C *= g / d, h = O * c.m00 + Y * c.m10 + C * c.m20, p = O * c.m01 + Y * c.m11 + C * c.m21, _ = O * c.m02 + Y * c.m12 + C * c.m22, [h, p, _];
};
i.prototype.lab = function() {
  return zt(this._rgb);
};
const We = (...t) => new i(...t, "lab");
Object.assign(N, { lab: We, getLabWhitePoint: at, setLabWhitePoint: W });
k.format.lab = Yt;
k.autodetect.push({
  p: 2,
  test: (...t) => {
    if (t = M(t, "lab"), x(t) === "array" && t.length === 3)
      return "lab";
  }
});
...
const { pow: He } = Math, Fe = 1e-7, De = 20;
i.prototype.luminance = function(t, e = "rgb") {
  if (t !== void 0 && x(t) === "number") {
    ...
    let n = this.luminance(), r = De;
    const o = (s, f) => {
      const a = s.interpolate(f, 0.5, e), l = a.luminance();
      return Math.abs(t - l) < Fe || !r-- ? a : l > t ? o(s, a) : o(a, f);
    }, c = (n > t ? o(new i([0, 0, 0]), this) : o(this, new i([255, 255, 255]))).rgb();
    return new i([...c, this._rgb[3]]);
  }
  return Ue(...this._rgb.slice(0, 3));
};
const Ue = (t, e, n) => (t = xt(t), e = xt(e), n = xt(n), 0.2126 * t + 0.7152 * e + 0.0722 * n), xt = (t) => (t /= 255, t <= 0.03928 ? t / 12.92 : He((t + 0.055) / 1.055, 2.4)), G = {}, nt = (t, e, n = 0.5, ...r) => {
  let o = r[0] || "lrgb";
  if (!G[o] && !r.length && (o = Object.keys(G)[0]), !G[o])
    throw new Error(`interpolation mode ${o} is not defined`);
  return x(t) !== "object" && (t = new i(t)), x(e) !== "object" && (e = new i(e)), G[o](t, e, n).alpha(
...
const rn = (...t) => new i(...t, "lch"), on = (...t) => new i(...t, "hcl");
Object.assign(N, { lch: rn, hcl: on });
k.format.lch = Gt;
k.format.hcl = Qe;
["lch", "hcl"].forEach(
  (t) => k.autodetect.push({
    p: 2,
    test: (...e) => {
      if (e = M(e, t), x(e) === "array" && e.length === 3)
        return t;
    }
  })
);
...
G.rgb = cn;
const { sqrt: At, pow: J } = Math, sn = (t, e, n) => {
  const [r, o, c] = t._rgb, [s, f, a] = e._rgb;
  return new i(
    At(J(r, 2) * (1 - n) + J(s, 2) * n),
    At(J(o, 2) * (1 - n) + J(f, 2) * n),
    At(J(c, 2) * (1 - n) + J(a, 2) * n),
    "rgb"
  );
};
G.lrgb = sn;
...
const ot = (t, e, n, r) => {
  ...
  let h, p, _, R;
  return !isNaN(s) && !isNaN(f) ? (f > s && f - s > 180 ? R = f - (s + 360) : f < s && s - f > 180 ? R = f + 360 - s : R = f - s, p = s + n * R) : isNaN(s) ? isNaN(f) ? p = Number.NaN : (p = f, (b == 1 || b == 0) && r != "hsv" && (h = l)) : (p = s, (d == 1 || d == 0) && r != "hsv" && (h = a)), h === void 0 && (h = a + n * (l - a)), _ = b + n * (d - b), r === "oklch" ? new i([_, h, p], r) : new i([p, h, _], r);
...
Object.assign(N, { num: un });
k.format.num = an;
k.autodetect.push({
  p: 5,
  test: (...t) => {
    if (t.length === 1 && x(t[0]) === "number" && t[0] >= 0 && t[0] <= 16777215)
      return "num";
  }
});
const bn = (t, e, n) => {
...
const { floor: hn } = Math, dn = (...t) => {
  ...
  if (n === 0)
    ...
    const a = hn(e), l = e - a, b = r * (1 - n), d = b + f * (1 - l), h = b + f * l, p = b + f;
    switch (a) {
      case 0:
        [o, c, s] = [p, h, b];
        break;
...
k.autodetect.push({
  p: 1,
  test: (...t) => {
    if (t = M(t, "hcg"), x(t) === "array" && t.length === 3)
      return "hcg";
  }
});
const gn = (t, e, n) => ot(t, e, n, "hcg");
G.hcg = gn;
const { cos: Q } = Math, wn = (...t) => {
  t = M(t, "hsi");
  let [e, n, r] = t, o, c, s;
  ...
  e /= 255, n /= 255, r /= 255;
  let o;
  const c = yn(e, n, r), s = (e + n + r) / 3, f = s > 0 ? 1 - c / s : 0;
...
k.autodetect.push({
  p: 2,
  test: (...t) => {
    if (t = M(t, "hsi"), x(t) === "array" && t.length === 3)
      return "hsi";
  }
});
...
const vt = (...t) => {
  ...
  let [e, n, r] = t;
  e /= 255, n /= 255, r /= 255;
  const o = oe(e, n, r), c = ce(e, n, r), s = (c + o) / 2;
  let f, a;
...
k.autodetect.push({
  p: 2,
  test: (...t) => {
    if (t = M(t, "hsl"), x(t) === "array" && t.length === 3)
      return "hsl";
  }
});
const Ln = (t, e, n) => ot(t, e, n, "hsl");
G.hsl = Ln;
const { floor: Nn } = Math, En = (...t) => {
  t = M(t, "hsv");
  let [e, n, r] = t, o, c, s;
  if (r *= 255, n === 0)
    o = c = s = r;
    ...
    e === 360 && (e = 0), e > 360 && (e -= 360), e < 0 && (e += 360), e /= 60;
    const f = Nn(e), a = e - f, l = r * (1 - n), b = r * (1 - n * a), d = r * (1 - n * (1 - a));
    switch (f) {
      case 0:
        [o, c, s] = [r, d, l];
        break;
  ...
  return [o, c, s, t.length > 3 ? t[3] : 1];
}, { min: Rn, max: jn } = Math, Cn = (...t) => {
  t = M(t, "rgb");
  let [e, n, r] = t;
  const o = Rn(e, n, r), c = jn(e, n, r), s = c - o;
  let f, a, l;
...
const vn = (...t) => new i(...t, "hsv");
N.hsv = vn;
k.format.hsv = En;
k.autodetect.push({
  p: 2,
  test: (...t) => {
    if (t = M(t, "hsv"), x(t) === "array" && t.length === 3)
      return "hsv";
  }
});
...
Object.assign(N, { oklab: zn });
k.format.oklab = St;
k.autodetect.push({
  p: 2,
  test: (...t) => {
    if (t = M(t, "oklab"), x(t) === "array" && t.length === 3)
      return "oklab";
  }
});
const Gn = (t, e, n) => {
...
G.oklch = Bn;
const { pow: Lt, sqrt: Nt, PI: Et, cos: Tt, sin: Kt, atan2: Sn } = Math, Xn = (t, e = "lrgb", n = null) => {
  const r = t.length;
    ...
    for (let _ = 0; _ < s.length; _++)
      if (!isNaN(p[_]))
        if (f[_] += n[h + 1], e.charAt(_) === "h") {
          const R = p[_] / 180 * Et;
          a += Tt(R) * n[h + 1], l += Kt(R) * n[h + 1];
        } else
          s[_] += p[_] * n[h + 1];
  });
  for (let d = 0; d < s.length; d++)
    if (e.charAt(d) === "h") {
      let h = Sn(l / f[d], a / f[d]) / Et * 180;
      for (; h < 0; )
        h += 360;
      for (; h >= 360; )
        h -= 360;
  ...
  return r[0] = Nt(r[0]), r[1] = Nt(r[1]), r[2] = Nt(r[2]), r[3] > 0.9999999 && (r[3] = 1), new i(Ot(r));
}, { pow: Zn } = Math;
function mt(t) {
  let e = "rgb", n = N("#ccc"), r = 0, o = [0, 1], c = [], s = [0, 0], f = !1, a = [], l = !1, b = 0, d = 1, h = !1, p = {}, _ = !0, R = 1;
  const w = function(u) {
    if (u = u || ["#fff", "#000"], u && x(u) === "string" && N.brewer && N.brewer[u.toLowerCase()] && (u = N.brewer[u.toLowerCase()]), x(u) === "array") {
  ...
  const C = function(u, m) {
    ...
    if (m == null && (m = !1), isNaN(u) || u === null)
      return n;
    m ? y = u : f && f.length > 2 ? y = g(u) / (f.length - 2) : d !== b ? y = (u - b) / (d - b) : y = 1, y = Y(y), m || (y = O(y)), R !== 1 && (y = Zn(y, R)), y = s[0] + y * (1 - s[0] - s[1]), y = V(y, 0, 1);
  ...
  return A.classes = function(u) {
    if (u != null) {
      if (x(u) === "array")
        ...
        const m = N.analyze(o);
        u === 0 ? f = [m.min, m.max] : f = N.limits(m, "e", u);
      }
      return A;
    }
    return f;
    ...
    if (u.length === m && b !== d)
      ...
      for (let $ = 0; $ < m; $++)
        c.push($ / (m - 1));
      if (u.length > 2) {
        const $ = u.map((E, L) => L / (u.length - 1)), y = u.map((E) => (E - b) / (d - b));
        y.every((E, L) => $[L] === E) || (Y = (E) => {
          if (E <= 0 || E >= 1)
            return E;
          let L = 0;
    ...
    return u == null && (u = !0), h = u, z(), h ? O = function(m) {
      const $ = C(0, !0).lab()[0], y = C(1, !0).lab()[0], E = $ > y;
      let L = C(m, !0).lab()[0];
      const j = $ + (y - $) * m;
      let U = L - j, ft = 0, lt = 1, it = 20;
      for (; Math.abs(U) > 0.01 && it-- > 0; )
        (function() {
          return E && (U *= -1), U < 0 ? (ft = m, m += (lt - m) * 0.5) : (lt = m, m += (ft - m) * 0.5), L = C(m, !0).lab()[0], U = L - j;
        })();
      return m;
    } : O = (m) => m, A;
    ...
    if (arguments.length === 0)
      ...
      let y = [];
      if (f && f.length > 2)
        for (let E = 1, L = f.length, j = 1 <= L; j ? E < L : E > L; j ? E++ : E--)
          y.push((f[E - 1] + f[E]) * 0.5);
      else
        y = o;
      $ = y.map((E) => A(E));
    }
    return N[m] && ($ = $.map((y) => y[m]())), $;
  }, A.cache = function(u) {
    return u != null ? (_ = u, A) : _;
  }, A.gamma = function(u) {
    return u != null ? (R = u, A) : R;
  }, A.nodata = function(u) {
    return u != null ? (n = N(u), A) : n;
  }, A;
}
function In(t, e, n) {
  let r = [], o = t < e, c = n ? o ? e + 1 : e - 1 : e;
...
k.autodetect.push({
  p: 3,
  test: (...t) => {
    if (t = M(t, "rgba"), x(t) === "array" && (t.length === 3 || t.length === 4 && x(t[3]) == "number" && t[3] >= 0 && t[3] <= 1))
      return "rgb";
  }
});
const Z = (t, e, n) => {
  ...
  const r = N(n).rgb(), o = N(e).rgb();
  return N.rgb(t(r, o));
}, D = (t) => (e, n) => {
  const r = [];
  return r[0] = t(e[0], n[0]), r[1] = t(e[1], n[1]), r[2] = t(e[2], n[2]), r;
}, Fn = (t) => t, Dn = (t, e) => t * e / 255, Un = (t, e) => t > e ? e : t, Vn = (t, e) => t > e ? t : e, Jn = (t, e) => 255 * (1 - (1 - t / 255) * (1 - e / 255)), Qn = (t, e) => e < 128 ? 2 * t * e / 255 : 255 * (1 - 2 * (1 - t / 255) * (1 - e / 255)), t0 = (t, e) => 255 * (1 - (1 - e / 255) / (t / 255)), e0 = (t, e) => t === 255 ? 255 : (t = 255 * (e / 255) / (1 - t / 255), t > 255 ? 255 : t);
Z.normal = F(D(Fn));
Z.multiply = F(D(Dn));
Z.screen = F(D(Jn));
Z.overlay = F(D(Qn));
...
function c0(t = 300, e = -1.5, n = 1, r = 1, o = [0, 1]) {
  ...
  const f = function(a) {
    const l = K * ((t + 120) / 360 + e * a), b = n0(o[0] + s * a, r), h = (c !== 0 ? n[0] + a * c : n) * b * (1 - b) / 2, p = o0(l), _ = r0(l), R = b + h * (-0.14861 * p + 1.78277 * _), w = b + h * (-0.29227 * p - 0.90649 * _), g = b + h * (1.97294 * p);
    return N(Ot([R * 255, w * 255, g * 255, 1]));
  };
  ...
  }, f.scale = () => N.scale(f), f.hue(n), f;
}
const s0 = "0123456789abcdef", { floor: f0, random: a0 } = Math, l0 = () => {
  let t = "#";
  for (let e = 0; e < 6; e++)
    t += s0.charAt(f0(a0() * 16));
  return new i(t, "hex");
...
function ge(t, e = "equal", n = 7) {
  ...
  if (e.substr(0, 1) === "c" && (s.push(r), s.push(o)), e.substr(0, 1) === "e") {
    ...
    s.push(r);
    for (let l = 1; l < n; l++)
      s.push(i0(10, f + l / n * (a - f)));
    s.push(o);
  } else if (e.substr(0, 1) === "q") {
    s.push(r);
    for (let f = 1; f < n; f++) {
      const a = (c.length - 1) * f / n, l = u0(a);
      if (l === a)
        s.push(c[l]);
      else {
        const b = a - l;
    ...
    for (p.push(o); d; ) {
      ...
      for (let g = 0; g < a; g++) {
        const O = c[g];
        let Y = Number.MAX_VALUE, C;
        for (let z = 0; z < n; z++) {
          const A = b0(p[z] - O);
          A < Y && (Y = A, C = z), b[C]++, l[g] = C;
        }
      }
      const w = new Array(n);
      for (let g = 0; g < n; g++)
        w[g] = null;
      for (let g = 0; g < a; g++)
        f = l[g], w[f] === null ? w[f] = c[g] : w[f] += c[g];
      for (let g = 0; g < n; g++)
        w[g] *= 1 / b[g];
      d = !1;
      for (let g = 0; g < n; g++)
    ...
    let R = [];
    for (let w = 0; w < n; w++)
      R.push(_[w][0]), R.push(_[w][_[w].length - 1]);
    R = R.sort((w, g) => w - g), s.push(R[0]);
 ...
 */
const Ht = 0.027, d0 = 5e-4, p0 = 0.1, Ft = 1.14, bt = 0.022, Dt = 1.414, m0 = (t, e) => {
  t = new i(t), e = new i(e), t.alpha() < 1 && (t = nt(e, t, t.alpha(), "rgb"));
  const n = Ut(...t.rgb()), r = Ut(...e.rgb()), o = n >= bt ? n : n + Math.pow(bt - n, Dt), c = r >= bt ? r : r + Math.pow(bt - r, Dt), s = Math.pow(c, 0.56) - Math.pow(o, 0.57), f = Math.pow(c, 0.65) - Math.pow(o, 0.62), a = Math.abs(c - o) < d0 ? 0 : o < c ? s * Ft : f * Ft;
...
const { sqrt: T, pow: v, min: g0, max: w0, atan2: Vt, abs: Jt, cos: ht, sin: Qt, exp: y0, PI: te } = Math;
function k0(t, e, n = 1, r = 1, o = 1) {
  ...
  t = new i(t), e = new i(e);
  const [f, a, l] = Array.from(t.lab()), [b, d, h] = Array.from(e.lab()), p = (f + b) / 2, _ = T(v(a, 2) + v(l, 2)), R = T(v(d, 2) + v(h, 2)), w = (_ + R) / 2, g = 0.5 * (1 - T(v(w, 7) / (v(w, 7) + v(25, 7)))), O = a * (1 + g), Y = d * (1 + g), C = T(v(O, 2) + v(l, 2)), z = T(v(Y, 2) + v(h, 2)), A = (C + z) / 2, u = c(Vt(l, O)), m = c(Vt(h, Y)), $ = u >= 0 ? u : u + 360, y = m >= 0 ? m : m + 360, E = Jt($ - y) > 180 ? ($ + y + 360) / 2 : ($ + y) / 2, L = 1 - 0.17 * ht(s(E - 30)) + 0.24 * ht(s(2 * E)) + 0.32 * ht(s(3 * E + 6)) - 0.2 * ht(s(4 * E - 63));
  let j = y - $;
  j = Jt(j) <= 180 ? j : y <= $ ? j + 360 : j - 360, j = 2 * T(C * z) * Qt(s(j) / 2);
  const U = b - f, ft = z - C, lt = 1 + 0.015 * v(p - 50, 2) / T(20 + v(p - 50, 2)), it = 1 + 0.045 * A, It = 1 + 0.015 * A * L, Pe = 30 * y0(-v((E - 275) / 25, 2)), Oe = -(2 * T(v(A, 7) / (v(A, 7) + v(25, 7)))) * Qt(2 * s(Pe)), Ye = T(
    v(U / (n * lt), 2) + v(ft / (r * it), 2) + v(j / (o * It), 2) + Oe * (ft / (r * it)) * (j / (o * It))
  );
...
const M0 = (...t) => {
  ...
  cool() {
    return mt([N.hsl(180, 1, 0.9), N.hsl(250, 0.7, 0.4)]);
  },
  hot() {
    return mt(["#000", "#f00", "#ff0", "#fff"]).mode(
      "rgb"
    );
  }
}, Pt = {
...
}, we = Object.keys(Pt), ee = new Map(we.map((t) => [t.toLowerCase(), t])), x0 = typeof Proxy == "function" ? new Proxy(Pt, {
  get(t, e) {
  ...
  const o = 1 - ne(e, ne(n, r)), c = o < 1 ? 1 / (1 - o) : 0, s = (1 - e - o) * c, f = (1 - n - o) * c, a = (1 - r - o) * c;
  return [s, f, a, o];
};
i.prototype.cmyk = function() {
  return L0(this._rgb);
};
const N0 = (...t) => new i(...t, "cmyk");
Object.assign(N, { cmyk: N0 });
k.format.cmyk = A0;
k.autodetect.push({
  p: 2,
  test: (...t) => {
    if (t = M(t, "cmyk"), x(t) === "array" && t.length === 4)
      return "cmyk";
  }
});
const E0 = (...t) => {
  ...
  const e = M(t, "lab");
  return e[0] = S(e[0] * 100) + "%", e[1] = Ct(e[1]), e[2] = Ct(e[2]), e.length > 3 && e[3] < 1 ? e[3] = "/ " + (e.length > 3 ? e[3] : 1) : e.length = 3, `oklab(${e.join(" ")})`;
}, ye = (...t) => {
  const [e, n, r, ...o] = M(t, "rgb"), [c, s, f] = Xt(e, n, r), [a, l, b] = be(c, s, f);
  return [a, l, b, ...o.length > 0 && o[0] < 1 ? [o[0]] : []];
}, v0 = (...t) => {
  const e = M(t, "lch");
  return e[0] = S(e[0] * 100) + "%", e[1] = Ct(e[1]), e[2] = isNaN(e[2]) ? "none" : S(e[2]) + "deg", e.length > 3 && e[3] < 1 ? e[3] = "/ " + (e.length > 3 ? e[3] : 1) : e.length = 3, `oklch(${e.join(" ")})`;
}, { round: Rt } = Math, P0 = (...t) => {
  const e = M(t, "rgba");
  let n = rt(t) || "rgb";
  if (n.substr(0, 3) === "hsl")
  ...
  return n.substr(0, 5) === "oklab" ? C0(Xt(e)) : n.substr(0, 5) === "oklch" ? v0(ye(e)) : (e[0] = Rt(e[0]), e[1] = Rt(e[1]), e[2] = Rt(e[2]), (n === "rgba" || e.length > 3 && e[3] < 1) && (e[3] = "/ " + (e.length > 3 ? e[3] : 1), n = "rgba"), `${n.substr(0, 3)}(${e.slice(0, n === "rgb" ? 3 : 4).join(" ")})`);
}, ke = (...t) => {
  t = M(t, "lch");
  const [e, n, r, ...o] = t, [c, s, f] = ue(e, n, r), [a, l, b] = St(c, s, f);
  return [a, l, b, ...o.length > 0 && o[0] < 1 ? [o[0]] : []];
}, H = /((?:-?\d+)|(?:-?\d+(?:\.\d+)?)%|none)/.source, q = /((?:-?(?:\d+(?:\.\d*)?|\.\d+)%?)|none)/.source, gt = /((?:-?(?:\d+(?:\.\d*)?|\.\d+)%)|none)/.source, X = /\s*/.source, ct = /\s+/.source, qt = /\s*,\s*/.source, yt = /((?:-?(?:\d+(?:\.\d*)?|\.\d+)(?:deg)?)|none)/.source, st = /\s*(?:\/\s*((?:[01]|[01]?\.\d+)|\d+(?:\.\d+)?%))?/.source, _e = new RegExp(
  "^rgba?\\(" + X + [H, H, H].join(ct) + st + "\\)$"
), Me = new RegExp(
  "^rgb\\(" + X + [H, H, H].join(qt) + X + "\\)$"
), $e = new RegExp(
  "^rgba\\(" + X + [H, H, H, q].join(qt) + X + "\\)$"
), xe = new RegExp(
  "^hsla?\\(" + X + [yt, gt, gt].join(ct) + st + "\\)$"
), Ae = new RegExp(
  "^hsl?\\(" + X + [yt, gt, gt].join(qt) + X + "\\)$"
), Le = /^hsla\(\s*(-?\d+(?:\.\d+)?),\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*,\s*([01]|[01]?\.\d+)\)$/, Ne = new RegExp(
  "^lab\\(" + X + [q, q, q].join(ct) + st + "\\)$"
), Ee = new RegExp(
  "^lch\\(" + X + [q, q, yt].join(ct) + st + "\\)$"
), Re = new RegExp(
  "^oklab\\(" + X + [q, q, q].join(ct) + st + "\\)$"
), je = new RegExp(
  "^oklch\\(" + X + [q, q, yt].join(ct) + st + "\\)$"
), { round: Ce } = Math, tt = (t) => t.map((e, n) => n <= 2 ? V(Ce(e), 0, 255) : e), P = (t, e = 0, n = 100, r = !1) => (typeof t == "string" && t.endsWith("%") && (t = parseFloat(t.substring(0, t.length - 1)) / 100, r ? t = e + (t + 1) * 0.5 * (n - e) : t = e + t * (n - e)), +t), B = (t, e) => t === "none" ? e : t, Zt = (t) => {
  ...
  if ((e = t.match(xe)) || (e = t.match(Ae))) {
    const n = e.slice(1, 4);
    n[0] = +B(n[0].replace("deg", ""), 0), n[1] = +P(B(n[1], 0), 0, 100) * 0.01, n[2] = +P(B(n[2], 0), 0, 100) * 0.01;
    const r = tt(vt(n)), o = e[4] !== void 0 ? +P(e[4], 0, 1) : 1;
    return r[3] = o, r;
  }
  if (e = t.match(Le)) {
    const n = e.slice(1, 4);
  ...
  if (e = t.match(Re)) {
    const n = e.slice(1, 4);
    n[0] = P(B(n[0], 0), 0, 1), n[1] = P(B(n[1], 0), -0.4, 0.4, !0), n[2] = P(B(n[2], 0), -0.4, 0.4, !0);
    const r = tt(St(n)), o = e[4] !== void 0 ? +P(e[4], 0, 1) : 1;
    return r[3] = o, r;
  }
  if (e = t.match(je)) {
    const n = e.slice(1, 4);
    n[0] = P(B(n[0], 0), 0, 1), n[1] = P(B(n[1], 0), 0, 0.4, !1), n[2] = +B(n[2].replace("deg", ""), 0);
    const r = tt(ke(n)), o = e[4] !== void 0 ? +P(e[4], 0, 1) : 1;
    return r[3] = o, r;
  }
};
Zt.test = (t) => (
  // modern
  _e.test(t) || xe.test(t) || Ne.test(t) || Ee.test(t) || Re.test(t) || je.test(t) || // legacy
...
k.autodetect.push({
  p: 5,
  test: (t, ...e) => {
    if (!e.length && x(t) === "string" && Zt.test(t))
      return "css";
  }
});
k.format.gl = (...t) => {
...
k.autodetect.push({
  p: 4,
  test: (t, ...e) => {
    if (!e.length && x(t) === "string" && [3, 4, 5, 6, 7, 8, 9].indexOf(t.length) >= 0)
      return "hex";
  }
});
const { log: dt } = Math, ve = (t) => {
  const e = t / 100;
  let n, r, o;
  return e < 66 ? (n = 255, r = e < 6 ? 0 : -155.25485562709179 - 0.44596950469579133 * (r = e - 2) + 104.49216199393888 * dt(r), o = e < 20 ? 0 : -254.76935184120902 + 0.8274096064007395 * (o = e - 10) + 115.67994401066147 * dt(o)) : (n = 351.97690566805693 + 0.114206453784165 * (n = e - 55) - 40.25366309332127 * dt(n), r = 325.4494125711974 + 0.07943456536662342 * (r = e - 50) - 28.0852963507957 * dt(r), o = 255), [n, r, o, 1];
}, { round: G0 } = Math, B0 = (...t) => {
...
Object.assign(N, { temp: jt, kelvin: jt, temperature: jt });
k.format.temp = k.format.kelvin = k.format.temperature = ve;
i.prototype.oklch = function() {
  return ye(this._rgb);
};
const S0 = (...t) => new i(...t, "oklch");
Object.assign(N, { oklch: S0 });
k.format.oklch = ke;
k.autodetect.push({
  p: 2,
  test: (...t) => {
    if (t = M(t, "oklch"), x(t) === "array" && t.length === 3)
      return "oklch";
  }
});
Object.assign(N, {
