...
import { A as $e, a as re, b as le, c as oe, d as ie, e as Ze } from "./storybook-index-66852bf6.es.js";
import { a as fe, S as Je } from "./storybook-Icon-48ed169f.es.js";
...
import { L as ne, a as Ke } from "./storybook-coveUpdateWorker-d145772b.es.js";
import { T as et, H as ge } from "./storybook-index-e5bf02db.es.js";
import { a as tt, g as at } from "./storybook-isSolr-6a0136d5.es.js";
import { D as nt } from "./storybook-DataTransform-b554456e.es.js";
import { n as rt } from "./storybook-numberFromString-24623c03.es.js";
import { f as lt } from "./storybook-fetchRemoteData-6254352f.es.js";
import { u as ot, p as Ee } from "./storybook-useDataVizClasses-707a8d8e.es.js";
...
function ct(t, l, m) {
  var h = this, u = p.useRef(null), T = p.useRef(0), y = p.useRef(null), N = p.useRef([]), F = p.useRef(), i = p.useRef(), a = p.useRef(t), _ = p.useRef(!0);
  a.current = t;
  var R = !l && l !== 0 && typeof window < "u";
  if (typeof t != "function")
    throw new TypeError("Expected a function");
  l = +l || 0, m = m || {};
  var j = !!m.leading, V = "trailing" in m ? !!m.trailing : !0, P = "maxWait" in m, U = P ? Math.max(+m.maxWait || 0, l) : null;
  ...
  var S = p.useMemo(function() {
    var A = function(D) {
      var I = N.current, B = F.current;
      return N.current = F.current = null, T.current = D, i.current = a.current.apply(B, I);
    }, X = function(D, I) {
      R && cancelAnimationFrame(y.current), y.current = R ? requestAnimationFrame(D) : setTimeout(D, I);
    }, G = function(D) {
      if (!_.current)
        return !1;
      var I = D - u.current, B = D - T.current;
      return !u.current || I >= l || I < 0 || P && B >= U;
    }, W = function(D) {
      return y.current = null, V && N.current ? A(D) : (N.current = F.current = null, i.current);
    }, k = function() {
      var D = Date.now();
      if (G(D))
        return W(D);
      if (_.current) {
        var I = D - u.current, B = D - T.current, r = l - I, o = P ? Math.min(r, U - B) : r;
        X(k, o);
      }
    }, J = function() {
      for (var D = [], I = 0; I < arguments.length; I++)
        D[I] = arguments[I];
      var B = Date.now(), r = G(B);
      if (N.current = D, F.current = h, u.current = B, r) {
        if (!y.current && _.current)
          return T.current = u.current, X(k, l), j ? A(u.current) : i.current;
        if (P)
          return X(k, l), A(u.current);
      }
      return y.current || X(k, l), i.current;
    };
    return J.cancel = function() {
      y.current && (R ? cancelAnimationFrame(y.current) : clearTimeout(y.current)), T.current = 0, N.current = u.current = F.current = y.current = null;
    }, J.isPending = function() {
      return !!y.current;
    }, J.flush = function() {
      return y.current ? W(Date.now()) : i.current;
    }, J;
  }, [j, P, l, U, V, R]);
  return S;
}
...
function mt(t) {
  var l = p.useState(he(t)), m = l[0], h = l[1], u = p.useCallback(function(T) {
    return h(he(T));
  }, []);
  return [m, u];
}
function ut(t, l, m) {
  var h = m && m.equalityFn || st, u = mt(t), T = u[0], y = u[1], N = ct(p.useCallback(function(i) {
    return y(i);
  }, [y]), l, m), F = p.useRef(t);
  return h(F.current, t) || (N(t), F.current = t), [T, N];
}
const $ = p.memo(({ label: t, section: l = null, subsection: m = null, fieldName: h, updateField: u, value: T, tooltip: y, type: N = "input", i: F = null, min: i = null, max: a = null, ..._ }) => {
  const [R, j] = p.useState(T), [V] = ut(R, 500);
  p.useEffect(() => {
    typeof V == "string" && T !== V && u(l, m, h, V, F);
  }, [V, l, m, h, F, T, u]);
  let P = m ? `${l}-${m}-${h}` : `${l}-${m}-${h}`;
  const U = (A) => {
    N !== "number" || i === null || !A.target.value || parseFloat(i) <= parseFloat(A.target.value) & parseFloat(a) >= parseFloat(A.target.value) ? j(A.target.value) : j(i.toString());
  };
  let S = /* @__PURE__ */ e.createElement("input", { type: "text", name: P, onChange: U, ..._, value: R });
  return N === "textarea" && (S = /* @__PURE__ */ e.createElement("textarea", { name: P, onChange: U, ..._, value: R })), N === "number" && (S = /* @__PURE__ */ e.createElement("input", { type: "number", name: P, onChange: U, ..._, value: R })), /* @__PURE__ */ e.createElement(e.Fragment, null, t && t.length > 0 && /* @__PURE__ */ e.createElement("label", null, /* @__PURE__ */ e.createElement("span", { className: "edit-label column-heading" }, t, y), S), (!t || t.length === 0) && S);
}), ee = p.memo(({ label: t, value: l, fieldName: m, section: h = null, subsection: u = null, tooltip: T, updateField: y, ...N }) => /* @__PURE__ */ e.createElement("label", { className: "checkbox" }, /* @__PURE__ */ e.createElement(
  "input",
  {
    type: "checkbox",
    name: m,
...
), /* @__PURE__ */ e.createElement("span", { className: "edit-label column-heading" }, t), /* @__PURE__ */ e.createElement("span", { className: "cove-icon" }, T))), ae = p.memo(({ label: t, value: l, options: m, fieldName: h, section: u = null, subsection: T = null, required: y = !1, updateField: N, initial: F, ...i }) => {
  let a = "";
  if (Array.isArray(m))
    a = m.map((_) => /* @__PURE__ */ e.createElement("option", { value: _, key: _ }, _));
  else {
    a = [];
  ...
  var k, J, D, I, B;
  const { config: t, updateConfig: l, loading: m, data: h, setParentConfig: u, isDashboard: T, isEditor: y } = p.useContext(Re), [N, F] = p.useState(!0), i = Ye(t, l, !0);
  p.useEffect(() => {
    if (u) {
      const r = _();
      delete r.newViz, u(r);
  ...
  return m ? null : /* @__PURE__ */ e.createElement(Qe, { component: "EditorPanel" }, /* @__PURE__ */ e.createElement(ne.Sidebar, { isEditor: !0, config: t, title: "Configure Data Bites", onBackClick: a, displayPanel: N }, /* @__PURE__ */ e.createElement("section", { className: "form-container" }, /* @__PURE__ */ e.createElement("form", null, /* @__PURE__ */ e.createElement($e, { allowZeroExpanded: !0 }, /* @__PURE__ */ e.createElement(re, null, " ", /* @__PURE__ */ e.createElement(le, null, /* @__PURE__ */ e.createElement(oe, null, "General")), /* @__PURE__ */ e.createElement(ie, null, /* @__PURE__ */ e.createElement(ae, { value: t.biteStyle, fieldName: "biteStyle", label: "Data Bite Style", updateField: i, options: ht, initial: "Select" }), /* @__PURE__ */ e.createElement($, { value: t.title, fieldName: "title", label: "Title", placeholder: "Data Bite Title", updateField: i }), /* @__PURE__ */ e.createElement(
    $,
    {
      type: "textarea",
      value: t.biteBody,
    ...
    /* @__PURE__ */ e.createElement("option", { value: "" }, "- Select Option -"),
    U(o).map((d, E) => /* @__PURE__ */ e.createElement("option", { value: d, key: E }, d))
  ))))), (!t.filters || t.filters.length === 0) && /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement("fieldset", { className: "edit-block" }, /* @__PURE__ */ e.createElement("p", { style: { textAlign: "center" } }, "There are currently no filters."))), /* @__PURE__ */ e.createElement("button", { type: "button", onClick: V, className: "btn full-width" }, "Add Filter"))), /* @__PURE__ */ e.createElement(re, null, " ", /* @__PURE__ */ e.createElement(le, null, /* @__PURE__ */ e.createElement(oe, null, "Visual")), /* @__PURE__ */ e.createElement(ie, null, /* @__PURE__ */ e.createElement($, { type: "number", value: t.biteFontSize, fieldName: "biteFontSize", label: "Bite Font Size", updateField: i, min: "17", max: "65" }), /* @__PURE__ */ e.createElement(ae, { value: t.fontSize, fieldName: "fontSize", label: "Overall Font Size", updateField: i, options: ["small", "medium", "large"] }), /* @__PURE__ */ e.createElement("div", { className: "checkbox-group" }, /* @__PURE__ */ e.createElement(ee, { value: (k = t.visual) == null ? void 0 : k.border, section: "visual", fieldName: "border", label: "Display Border", updateField: i }), /* @__PURE__ */ e.createElement(ee, { value: (J = t.visual) == null ? void 0 : J.borderColorTheme, section: "visual", fieldName: "borderColorTheme", label: "Use Border Color Theme", updateField: i }), /* @__PURE__ */ e.createElement(ee, { value: (D = t.visual) == null ? void 0 : D.accent, section: "visual", fieldName: "accent", label: "Use Accent Style", updateField: i }), /* @__PURE__ */ e.createElement(ee, { value: (I = t.visual) == null ? void 0 : I.background, section: "visual", fieldName: "background", label: "Use Theme Background Color", updateField: i }), /* @__PURE__ */ e.createElement(ee, { value: (B = t.visual) == null ? void 0 : B.hideBackgroundColor, section: "visual", fieldName: "hideBackgroundColor", label: "Hide Background Color", updateField: i })), /* @__PURE__ */ e.createElement("label", null, /* @__PURE__ */ e.createElement("span", { className: "edit-label" }, "Theme"), /* @__PURE__ */ e.createElement("ul", { className: "color-palette" }, dt.map((r) => /* @__PURE__ */ e.createElement(
    "li",
    {
      title: r,
      key: r,
  ...
  )))))), ["title", "body", "graphic"].includes(t.biteStyle) && /* @__PURE__ */ e.createElement(re, null, " ", /* @__PURE__ */ e.createElement(le, null, /* @__PURE__ */ e.createElement(oe, null, "Image", ["dynamic"].includes(t.imageData.display) && "s")), /* @__PURE__ */ e.createElement(ie, null, /* @__PURE__ */ e.createElement(ae, { value: t.imageData.display || "", section: "imageData", fieldName: "display", label: "Image Display Type", updateField: i, options: ["none", "static", "dynamic"] }), /* @__PURE__ */ e.createElement(ae, { value: t.bitePosition || "", fieldName: "bitePosition", label: "Image/Graphic Position", updateField: i, initial: "Select", options: bt }), ["static"].includes(t.imageData.display) && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement($, { value: t.imageData.url, section: "imageData", fieldName: "url", label: "Image URL", updateField: i }), /* @__PURE__ */ e.createElement($, { value: t.imageData.alt, section: "imageData", fieldName: "alt", label: "Alt Text", updateField: i })), ["dynamic"].includes(t.imageData.display) && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement($, { value: t.imageData.url || "", section: "imageData", fieldName: "url", label: "Image URL (default)", updateField: i }), /* @__PURE__ */ e.createElement($, { value: t.imageData.alt, section: "imageData", fieldName: "alt", label: "Alt Text (default)", updateField: i }), /* @__PURE__ */ e.createElement("hr", { className: "accordion__divider" }), (!t.imageData.options || t.imageData.options.length === 0) && /* @__PURE__ */ e.createElement("p", { style: { textAlign: "center" } }, "There are currently no dynamic images."), t.imageData.options && t.imageData.options.length > 0 && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement("ul", null, t.imageData.options.map((r, o) => {
    var d, E, x, Z;
...
}, ye = ({ text: t, theme: l = "theme-blue", dataFormat: m, biteFontSize: h }) => {
  const u = {
    outerRing: {
      fill: ve[l].primary
    },
...
const gt = (t) => {
  const { configUrl: l, config: m, isDashboard: h = !1, isEditor: u = !1, setConfig: T, link: y } = t, N = {
    config: m ?? ce,
    loading: !0,
    currentViewport: "lg",
    coveLoadedHasRan: !1,
    container: null
  }, [F, i] = p.useReducer(pt, N), { config: a, loading: _, currentViewport: R, coveLoadedHasRan: j, container: V } = F, { title: P, dataColumn: U, dataFunction: S, imageData: A, biteBody: X, biteFontSize: G, dataFormat: W, biteStyle: k, filters: J, subtext: D } = a, { innerContainerClasses: I, contentClasses: B } = ot(a), r = new nt(), o = new tt((s) => {
    for (let f of s) {
      let z = at(f.contentRect.width * 2);
      i({ type: "SET_CURRENT_VIEWPORT", payload: z });
    }
  }), d = (s) => {
    ...
    const f = (n) => {
      ...
      let c = n, v = Number(a.dataFormat.roundToPlace);
      if (v < 0) {
        console.error(' ROUND field is below "0", "applyPrecision()" function ');
        return;
      }
      return typeof v == "number" && v > -1 && (c = Number(c).toFixed(v)), String(c);
    }, z = (n) => (a.dataFormat.ignoreZeros && (C = C.filter((c) => c && c)), C.length), M = (n) => {
      if (n == null) {
      ...
      let c = 0;
      return n.length > 1 ? c = n.map((v) => Number(v)).reduce((v, L) => v + L) : c = Number(n[0]), f(c);
    }, O = (n) => {
      ...
      let c = 0;
      return n.length > 1 ? c = n.map((v) => Number(v)).reduce((v, L) => v + L) / n.length : c = Number(n[0]), f(c);
    }, w = (n = []) => {
      let c = {}, v = -1 / 0;
      for (let q = 0; q < n.length; q++)
        c[n[q]] ? c[n[q]] += 1 : c[n[q]] = 1, c[n[q]] > v && (v = c[n[q]]);
      let L = [];
      for (let q in c)
        c[q] === v && L.push(q);
      return L;
      ...
      if (!n.length)
        return;
      const c = Math.floor(n.length / 2), v = [...n].sort((q, He) => q - He), L = n.length % 2 !== 0 ? v[c] : (v[c - 1] + v[c]) / 2;
      return f(L);
    }, Y = (n) => {
      if (n == null)
        return;
      ...
      const c = "en-US";
      let v = parseFloat(n).toLocaleString(c, {
        useGrouping: !0,
    ...
    switch (K.length ? K.forEach((n) => {
      ...
      case Ve:
        ...
        break;
      case pe:
        let n = Math.min(...C), c = Math.max(...C);
        n = f(n), c = f(c), a.dataFormat.commas && (n = Y(n), c = Y(c)), g = a.dataFormat.prefix + n + a.dataFormat.suffix + " - " + a.dataFormat.prefix + c + a.dataFormat.suffix;
        break;
      default:
  ...
  p.useEffect(() => {
    ...
    a && !j && V && (Ee("cove_loaded", { config: a }), i({ type: "SET_COVE_LOADED_HAS_RAN", payload: !0 }));
  }, [a, V]), m && a && JSON.stringify(m.data) !== JSON.stringify(a.data) && E();
  ...
  const te = p.useCallback(() => {
    ...
    if (A.display === "dynamic" && A.options && ((M = A.options) == null ? void 0 : M.length) > 0) {
      let O = Number(x(!1)), w = !1;
      A.options.forEach((H, Y) => {
        var n, c;
        let g = H.arguments, { source: K, alt: C } = H;
        w === !1 && g.length > 0 && g[0].operator.length > 0 && g[0].threshold.length > 0 && s[g[0].operator](O, g[0].threshold) && (g[1] !== void 0 ? ((n = g[1].operator) == null ? void 0 : n.length) > 0 && ((c = g[1].threshold) == null ? void 0 : c.length) > 0 && s[g[1].operator](O, g[1].threshold) && (f = K, C !== "" && C !== void 0 && (z = C), w = !0) : (f = K, C !== "" && C !== void 0 && (z = C), w = !0));
      });
    }
  ...
  gradient: "Gradient"
}, qe = "Left", je = "Right", Ge = "Top", We = "Bottom", bt = [qe, je, Ge, We], vt = "<", yt = ">", Nt = "<=", _t = ">=", Dt = "=", At = "≠", Ne = [vt, yt, Nt, _t, Dt, At], jt = {
...
const Gt = ["Data_Bite_Circle_Average", "Data_Bite_Text_Max_Pic", "Data_Bite_Circle_Sum", "Data_Bite_Text_Average_Pic"];
export {
