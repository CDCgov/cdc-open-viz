import { R as e, r as a } from "./storybook-index-BmAYD2Ot.es.js";
import { P as l } from "./storybook-index-Cdio1Uc1.es.js";
const L = ({ color: c = "#fff", opacity: s = 100, size: u = 100, className: i }) => /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement("div", { className: `cove-loadspin${i ? " " + i : ""}`, style: { width: u, height: u } }, /* @__PURE__ */ e.createElement("div", { className: "cove-loadspin__roller", style: { opacity: s / 100, transform: `scale(${u / 80})` } }, [...Array(8)].map((m, f) => /* @__PURE__ */ e.createElement("div", { key: f, style: { backgroundColor: c } }))))), w = ({ style: c, role: s, hoverStyle: u = {}, fluid: i = !1, loading: n = !1, loadingText: m = "Loading...", flexCenter: f, active: v = !1, onClick: N, children: d, ...y }) => {
