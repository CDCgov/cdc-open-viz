import { r as R, R as w } from "./storybook-index-45401197.es.js";
import { g as _e } from "./storybook-_commonjsHelpers-c5d32002.es.js";
import { m as Fe } from "./storybook-memoize-b2d53f3a.es.js";
import "./storybook-lodash-c15d8e1c.es.js";
import { e as Ce } from "./storybook-index-66852bf6.es.js";
import { P as O } from "./storybook-index-43433e35.es.js";
import "./storybook-index-4ed993c7.es.js";
var Z = Math.PI, J = 2 * Z, I = 1e-6, Ae = J - I;
function Q() {
...
Q.prototype = Me.prototype = {
  ...
  arcTo: function(e, t, a, n, r) {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(h * u - i * s) > I) || !r)
        ...
        var d = a - o, F = n - l, c = u * u + i * i, g = d * d + F * F, C = Math.sqrt(c), m = Math.sqrt(p), v = r * Math.tan((Z - Math.acos((c + p - g) / (2 * C * m))) / 2), y = v / m, k = v / C;
        Math.abs(y - 1) > I && (this._ += "L" + (e + y * s) + "," + (t + y * h)), this._ += "A" + r + "," + r + ",0,0," + +(h * d > s * F) + "," + (this._x1 = e + k * u) + "," + (this._y1 = t + k * i);
      }
  },
  arc: function(e, t, a, n, r, o) {
    ...
    this._x1 === null ? this._ += "M" + i + "," + s : (Math.abs(this._x1 - i) > I || Math.abs(this._y1 - s) > I) && (this._ += "L" + i + "," + s), a && (p < 0 && (p = p % J + J), p > Ae ? this._ += "A" + a + "," + a + ",0,1," + h + "," + (e - l) + "," + (t - u) + "A" + a + "," + a + ",0,1," + h + "," + (this._x1 = i) + "," + (this._y1 = s) : p > I && (this._ += "A" + a + "," + a + ",0," + +(p >= Z) + "," + h + "," + (this._x1 = e + a * Math.cos(r)) + "," + (this._y1 = t + a * Math.sin(r))));
  },
...
var bt = Math.abs, Et = Math.atan2, _t = Math.cos, Ft = Math.max, Ct = Math.min, At = Math.sin, Mt = Math.sqrt, xt = 1e-12, ae = Math.PI, re = ae / 2, Ot = 2 * ae;
function kt(e) {
...
function de(e, t, a) {
  var n = e;
  return Be(e, t).reduce(function(r, o) {
    return r.replace(o.functionIdentifier + "(" + o.matches.body + ")", Ne(o.matches.body, o.functionIdentifier, a, n, t));
  }, e);
}
function Be(e, t) {
...
f.addToken = function(e) {
  for (var t = 0; t < e.length; t++) {
    ...
    n === -1 ? (N.push(e[t]), e[t].precedence = V[e[t].type], _.length <= e[t].token.length && (_[e[t].token.length] = []), _[e[t].token.length].push(e[t].token)) : (N[n] = e[t], e[t].precedence = V[e[t].type]);
  }
};
function ye(e, t) {
...
f.lex = function(e, t) {
  ...
  for (s = 0; s < p.length; s++) {
    ...
    var F = d.token, c = d.type, g = d.value, C = d.precedence, m = d.show, v = a[a.length - 1], y;
    for (y = n.length; y-- && n[y] === 0; )
      if ([0, 2, 3, 4, 5, 9, 11, 12, 13].indexOf(c) !== -1) {
        if (o[c] !== !0)
          throw new f.Exception(F + " is not allowed after " + i);
        a.push(z), o = $, u = W, n.pop();
      }
    if (o[c] !== !0)
      throw new f.Exception(F + " is not allowed after " + i);
    if (u[c] === !0 && (c = 2, g = f.math.mul, m = "&times;", C = 3, s = s - 1), h = {
      value: g,
      type: c,
      pre: C,
      show: m,
      ...
      o = x, u = M, b(n, 2), a.push(h), p[s + 1].type !== 4 && (a.push(H), n.push(2));
    else if (c === 1)
      v.type === 1 ? (v.value += g, b(n, 1)) : a.push(h), o = $, u = Se;
    else if (c === 2)
      o = x, u = M, b(n, 2), a.push(h);
    else if (c === 3)
      a.push(h), o = $, u = W;
    else if (c === 4)
      b(n, 1), l++, o = x, u = M, a.push(h);
    else if (c === 5) {
      if (!l)
        throw new f.Exception("Closing parenthesis are more than opening one, wait What!!!");
      l--, o = $, u = W, a.push(h), b(n, 1);
    } else if (c === 6) {
      if (v.hasDec)
      ...
      v.type !== 1 && (v = {
        ...
        type: 1,
        pre: 0
      }, a.push(v)), o = Ie, b(n, 1), u = M, v.value += g, v.hasDec = !0;
    } else
      c === 7 && (o = $, u = W, b(n, 1), a.push(h));
    c === 8 ? (o = x, u = M, b(n, d.numberOfArguments + 2), a.push(h), p[s + 1].type !== 4 && (a.push(H), n.push(d.numberOfArguments + 2))) : c === 9 ? (v.type === 9 ? v.value === f.math.add ? (v.value = g, v.show = m, b(n, 1)) : v.value === f.math.sub && m === "-" && (v.value = f.math.add, v.show = "+", b(n, 1)) : v.type !== 5 && v.type !== 7 && v.type !== 1 && v.type !== 3 && v.type !== 13 ? F === "-" && (o = x, u = M, b(n, 2).push(2), a.push(Te), a.push(H)) : (a.push(h), b(n, 2)), o = x, u = M) : c === 10 ? (o = x, u = M, b(n, 2), a.push(h)) : c === 11 ? (o = x, u = M, a.push(h)) : c === 12 ? (o = x, u = M, b(n, 6), a.push(h), p[s + 1].type !== 4 && (a.push(H), n.push(6))) : c === 13 && (o = $, u = W, a.push(h)), b(n, -1), i = F;
  }
  for (y = n.length; y--; )
    a.push(z);
  if (o[5] !== !0)
...
var We = ee, L = We;
L.prototype.postfixEval = function(e) {
...
var He = L, ge = He;
ge.prototype.formulaEval = function() {
...
var Le = ge, je = xe, ze = Pe, Ge = Le, Ue = 100, Xe = /(\+|\-|\*|\\|[^a-z]|)(\s*)(\()/g, X, Ke = Ye;
function Ye(e, t) {
...
function et(e) {
  var t = e.verticalAnchor, a = t === void 0 ? "end" : t, n = e.scaleToFit, r = n === void 0 ? !1 : n, o = e.angle, l = e.width, u = e.lineHeight, i = u === void 0 ? "1em" : u, s = e.capHeight, h = s === void 0 ? "0.71em" : s, p = e.children, d = e.style, F = Ve(e, Qe), c = F.x, g = c === void 0 ? 0 : c, C = F.y, m = C === void 0 ? 0 : C, v = !se(g) || !se(m), y = R.useMemo(function() {
    var A = p == null ? [] : p.toString().split(/(?:(?!\u00A0+)\s+)/);
    return {
      wordsWithWidth: A.map(function(P) {
        return {
          word: P,
          wordWidth: le(P, d) || 0
        };
  ...
  }, [p, d]), k = y.wordsWithWidth, G = y.spaceWidth, S = R.useMemo(function() {
    return v ? [] : l || r ? k.reduce(function(A, P) {
      var q = P.word, T = P.wordWidth, B = A[A.length - 1];
      if (B && (l == null || r || (B.width || 0) + T + G < l))
        B.words.push(q), B.width = B.width || 0, B.width += T + G;
      else {
        var U = {
          words: [q],
          width: T
    ...
    var A = v ? "" : K(a === "start" ? "calc(" + h + ")" : a === "middle" ? "calc(" + (S.length - 1) / 2 + " * -" + i + " + (" + h + " / 2))" : "calc(" + (S.length - 1) + " * -" + i + ")");
    return A;
  }, [v, a, h, S.length, i]), Ee = R.useMemo(function() {
    var A = [];
    if (v)
      return "";
    if (Y(g) && Y(m) && Y(l) && r && S.length > 0) {
      var P = S[0].width || 1, q = r === "shrink-only" ? Math.min(l / P, 1) : l / P, T = q, B = g - q * g, U = m - T * m;
      A.push("matrix(" + q + ", 0, 0, " + T + ", " + B + ", " + U + ")");
    }
    return o && A.push("rotate(" + o + ", " + g + ", " + m + ")"), A.length > 0 ? A.join(" ") : "";
  }, [v, g, m, l, r, S, o]);
  return {
    wordsByLines: S,
    startDy: be,
...
function Bt(e) {
  ...
  var p = at(e, tt), d = p.x, F = d === void 0 ? 0 : d, c = p.fontSize, g = et(e), C = g.wordsByLines, m = g.startDy, v = g.transform;
  return /* @__PURE__ */ w.createElement("svg", {
    ...
    fontSize: c,
    style: nt
  }, C.length > 0 ? /* @__PURE__ */ w.createElement("text", te({
    ref: i,
    transform: v
  }, p, {
    textAnchor: l
...
const rt = {
  ...
  "Sequential Green": ["#C7E9C0", "#A1D99B", "#74C476", "#41AB5D", "#238B45", "#005A32"]
}, Nt = it, Dt = ne(ot), St = ne(rt), It = ne(ut);
var me = {
  color: void 0,
  size: void 0,
  className: void 0,
  style: void 0,
  attr: void 0
}, he = w.createContext && w.createContext(me), D = globalThis && globalThis.__assign || function() {
...
}, lt = globalThis && globalThis.__rest || function(e, t) {
  var a = {};
  for (var n in e)
...
function we(e) {
  return e && e.map(function(t, a) {
    return w.createElement(t.tag, D({
      key: a
    }, t.attr), we(t.child));
  });
}
...
function st(e) {
  var t = function(a) {
    ...
    return a.className && (i = a.className), e.className && (i = (i ? i + " " : "") + e.className), w.createElement("svg", D({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, a.attr, n, l, {
...
const ht = 4.5, qt = (e, t) => {
  ...
  return /* @__PURE__ */ w.createElement("div", { className: "input-group" }, e && /* @__PURE__ */ w.createElement("label", null, e), /* @__PURE__ */ w.createElement("div", { className: "cove-input__slider" + (a === "small" ? "--small" : a === "large" ? "--large" : "") + m() + (c ? " active" : ""), onClick: v }, /* @__PURE__ */ w.createElement("div", { className: "cove-input__slider-button" }), /* @__PURE__ */ w.createElement("div", { className: "cove-input__slider-track", style: c && n ? { backgroundColor: n } : null }), /* @__PURE__ */ w.createElement("input", { className: "cove-input--hidden", type: "checkbox", name: C(), checked: c || !1, readOnly: !0 })));
};
ft.propTypes = {
