...
import { e as mo, l as Du } from "./storybook-Icon-b09f76c0.es.js";
...
import { M as hu } from "./storybook-MultiSelect-4068d9a0.es.js";
...
if (Ne.arrayBuffer)
  var Eu = [
    ...
    "[object Float32Array]",
    "[object Float64Array]"
  ], bu = ArrayBuffer.isView || function(e) {
    return e && Eu.indexOf(Object.prototype.toString.call(e)) > -1;
  };
function At(e) {
...
function Si() {
  return this.bodyUsed = !1, this._initBody = function(e) {
    ...
    if (e)
      return e;
    if (this._bodyBlob)
      return vu(this._bodyBlob);
    if (this._bodyArrayBuffer)
      return Promise.resolve(Cu(this._bodyArrayBuffer));
    if (this._bodyFormData)
...
var Au = ["CONNECT", "DELETE", "GET", "HEAD", "OPTIONS", "PATCH", "POST", "PUT", "TRACE"];
function Fu(e) {
  var t = e.toUpperCase();
  return Au.indexOf(t) > -1 ? t : e;
}
function pt(e, t) {
  ...
  if (e instanceof pt) {
    ...
    this.url = String(e);
  if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new ge(t.headers)), this.method = Fu(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || function() {
  ...
  return new Promise(function(n, r) {
    ...
    i.onload = function() {
      var l = {
        ...
        headers: wu(i.getAllResponseHeaders() || "")
      };
...
wi.polyfill = !0;
Ce.fetch || (Ce.fetch = wi, Ce.Headers = ge, Ce.Request = pt, Ce.Response = Je);
function Ni(e, t) {
  if (e == null)
    return {};
...
function at(e) {
  var t = typeof e;
  return process.env.NODE_ENV !== "production" && (t = _u(e)), t;
}
function Oi(e, t, n) {
  var r;
...
process.env.NODE_ENV === "production" ? ur.exports = Lu() : ur.exports = ju();
...
process.env.NODE_ENV === "production" ? $u() : Mu();
function ku(e) {
  e();
}
let xi = ku;
const Gu = (e) => xi = e, Wu = () => xi, No = Symbol.for("react-redux-context"), Oo = typeof globalThis < "u" ? globalThis : (
...
process.env.NODE_ENV === "production" ? ar.exports = Hu() : ar.exports = qu();
var Yu = ar.exports, Nr = Yu, Ku = {
  childContextTypes: !0,
  contextType: !0,
  contextTypes: !0,
  defaultProps: !0,
...
Or[Nr.Memo] = _i;
function Io(e) {
  return Nr.isMemo(e) ? _i : Or[e.$$typeof] || Ku;
}
var Qu = Object.defineProperty, Zu = Object.getOwnPropertyNames, _o = Object.getOwnPropertySymbols, ea = Object.getOwnPropertyDescriptor, ta = Object.getPrototypeOf, Po = Object.prototype;
function Pi(e, t, n) {
  if (typeof t != "string") {
    if (Po) {
      var r = ta(t);
...
process.env.NODE_ENV === "production" ? cr.exports = ra() : cr.exports = oa();
var Lo = cr.exports;
function Br(e) {
...
const sa = ["initMapStateToProps", "initMapDispatchToProps", "initMergeProps"];
function ua(e, t, n, r, {
  areStatesEqual: o,
  areOwnPropsEqual: i,
...
function aa(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && ia(s, u, c), ua(s, u, c, e, i);
}
function ca(e, t) {
  const n = {};
  for (const r in e) {
...
function Ri(e, t, n) {
  la(e) || Br(`${n}() in ${t} must return a plain object. Instead received ${e}.`);
}
function lr(e) {
  return function(n) {
    const r = e(n);
...
function ma(e) {
  return e ? typeof e == "function" ? Da(e) : xr(e, "mergeProps") : () => pa;
}
function ha() {
  const e = Wu();
  let t = null, n = null;
...
function Vi(e, t) {
  ...
  function f() {
    o++, n || (n = t ? t.addNestedSub(c) : e.subscribe(c), r = ha());
  }
  function a() {
...
const ga = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", mn = ga ? C.useLayoutEffect : C.useEffect;
function Mo(e, t) {
...
function Fa(e, t, n, r, o, i, s, u, c, l, f) {
  if (!e)
    return () => {
    };
  let a = !1, d = null;
...
function ji(e, t, n, {
  ...
  const f = l, a = fa(e), d = da(t), p = ma(n), E = !!e;
  return (D) => {
    if (process.env.NODE_ENV !== "production" && !Lo.isValidElementType(D))
      throw new Error(`You must pass a component to the function returned by connect. Instead received ${va(D)}`);
    ...
    function b(I) {
      ...
      const q = j ? I.store : $.store, ee = G ? $.getServerState : q.getState, K = C.useMemo(() => aa(q.dispatch, v), [q]), [te, me] = C.useMemo(() => {
        if (!E)
          return ya;
        const O = Vi(q, j ? void 0 : $.subscription), de = O.notifyNestedSubs.bind(O);
        return [O, de];
      ...
      const _e = C.useMemo(() => () => le.current && _ === ce.current ? le.current : K(q.getState(), _), [q, _]), ne = C.useMemo(() => (de) => te ? Fa(
        E,
        q,
        te,
        // @ts-ignore
...
ba(wr.useSyncExternalStore);
Gu(Cr.unstable_batchedUpdates);
function Na(e, t) {
...
function $i(e, t) {
  ...
  })[0], r = C.useRef(!0), o = C.useRef(n), i = r.current || !!(t && o.current.inputs && Na(t, o.current.inputs)), s = i ? o.current : {
    inputs: t,
    result: e()
  };
...
var H = $i, R = Oa, Ba = process.env.NODE_ENV === "production", Mn = "Invariant failed";
function Go(e, t) {
  if (!e) {
    if (Ba)
      throw new Error(Mn);
...
var ze = function(t) {
  ...
  var r = t.borderBox, o = t.border, i = t.margin, s = t.padding, u = xa(r, n);
  return _r({
    borderBox: u,
    border: o,
    margin: i,
...
const jt = Ra, Ta = process.env.NODE_ENV === "production", Va = /[ \t]{2,}/g, La = /^[ \t]*/gm, zo = (e) => e.replace(Va, " ").replace(La, "").trim(), ja = (e) => zo(`
  %c@hello-pangea/dnd

  %c${zo(e)}

  %c👷‍ This is a development only message. It will be removed in production builds.
`), $a = (e) => [ja(e), "color: #00C584; font-size: 1.2em; font-weight: bold;", "line-height: 1.5", "color: #723874;"], Ma = "__@hello-pangea/dnd-disable-dev-warnings";
function Gi(e, t) {
  Ta || typeof window < "u" && window[Ma] || console[e](...$a(t));
}
const ie = Gi.bind(null, "warn"), dr = Gi.bind(null, "error");
function tt() {
}
function ka(e, t) {
  return {
...
const Ga = process.env.NODE_ENV === "production", Ho = "Invariant failed";
...
`, qa = (e) => {
  ...
  dragHandleUsageInstructions: Ua,
  onDragStart: za,
  onDragUpdate: Ha,
  onDragEnd: qa
};
...
const qt = (e, t) => ({
  ...
  bottom: 0,
  left: 0
}, Xa = (e, t) => t ? qt(e, t.scroll.diff.displacement) : e, Qa = (e, t, n) => n && n.increasedBy ? {
  ...e,
  [t.end]: e[t.end] + n.increasedBy[t.line]
} : e, Za = (e, t) => t && t.shouldClipSubject ? Ka(t.pageMarginBox, e) : ze(e);
var bt = ({
  page: e,
  withPlaceholder: t,
  axis: n,
  ...
  const o = Xa(e.marginBox, r), i = Qa(o, n, t), s = Za(i, r);
  return {
    page: e,
    withPlaceholder: t,
    active: s
...
const Hi = ye((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), qi = ye((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), Sn = ye((e) => Object.values(e)), ec = ye((e) => Object.values(e));
var mt = ye((e, t) => ec(t).filter((r) => e === r.descriptor.droppableId).sort((r, o) => r.descriptor.index - o.descriptor.index));
function Rr(e) {
...
var Nn = ye((e, t) => t.filter((n) => n.descriptor.id !== e.descriptor.id)), tc = ({
  isMovingForward: e,
  draggable: t,
  destination: n,
  insideDestination: r,
...
var rc = nc, Ue = (e, t) => (n) => e <= n && n <= t, Ki = (e) => {
...
const sc = (e, t) => {
  ...
  return qt(e, n);
}, uc = (e, t, n) => t.subject.active ? n(t.subject.active)(e) : !1, ac = (e, t, n) => n(t)(e), Vr = ({
  target: e,
  destination: t,
  viewport: n,
  ...
  const i = r ? sc(e, t) : e;
  return uc(i, t, o) && ac(i, n, o);
}, cc = (e) => Vr({
  ...e,
  isVisibleThroughFrameFn: Ki
}), Xi = (e) => Vr({
  ...e,
  isVisibleThroughFrameFn: oc
}), lc = (e) => Vr({
  ...e,
  isVisibleThroughFrameFn: ic(e.destination.axis)
}), dc = (e, t, n) => {
  if (typeof n == "boolean")
    return n;
  if (!t)
...
function Gt({
  ...
  return e.reduce(function(u, c) {
    const l = fc(c, n), f = c.descriptor.id;
    if (u.all.push(f), !cc({
      target: l,
      destination: t,
      viewport: r,
...
var Dc = ({
  ...
  const o = r.draggableId, i = n[o].page.borderBox.center, s = gc({
...
const Qi = (e, t) => t.margin[e.start] + t.borderBox[e.size] / 2, bc = (e, t) => t.margin[e.end] + t.borderBox[e.size] / 2, Lr = (e, t, n) => t[e.crossAxisStart] + n.margin[e.crossAxisStart] + n.borderBox[e.crossAxisSize] / 2, Xo = ({
  axis: e,
  moveRelativeTo: t,
  isMoving: n
  ...
  moveRelativeTo: t,
  isMoving: n
}) => Dt(e.line, t.marginBox[e.start] - bc(e, n), Lr(e, t.marginBox, n)), yc = ({
  axis: e,
  moveInto: t,
  isMoving: n
...
var Fc = ({
  ...
  const i = Zi(t, Ae(t.scroll.current, o)), s = n.frame ? Pr(n, Ae(n.frame.scroll.current, o)) : n, u = e.displaced, c = Gt({
...
}, Sc = (e, t) => Ae(e.scroll.diff.displacement, t), jr = ({
  ...
  if (!n.isEnabled)
    return null;
  const l = mt(n.descriptor.id, r), f = St(t, n), a = tc({
    isMovingForward: e,
    draggable: t,
    destination: n,
    insideDestination: l,
...
var Nc = ({
  ...
  if (!i)
    return null;
  const s = n.axis, u = Ue(i[s.start], i[s.end]), c = Sn(r).filter((f) => f !== n).filter((f) => f.isEnabled).filter((f) => !!f.subject.active).filter((f) => Ki(o.frame)(we(f))).filter((f) => {
    const a = we(f);
...
const xc = (e, t, n) => {
  ...
  const o = Yt(e.axis, t.displaceBy).point, i = xc(e, o, n), s = {
    placeholderSize: o,
    increasedBy: i,
  ...
  const u = i ? Ae(r.scroll.max, i) : r.scroll.max, c = ts(r, u), l = bt({
    page: e.subject.page,
    withPlaceholder: s,
    axis: e.axis,
    frame: c
...
var _c = ({
  ...
  if (!c)
    return null;
  const l = mt(c.descriptor.id, o), f = Bc({
    pageBorderBoxCenter: t,
    viewport: s,
    destination: c,
    insideDestination: l,
...
var Tc = ({
  ...
  const n = Rc(e.impact, e.dimensions.droppables), r = !!n, o = e.dimensions.droppables[e.critical.droppable.id], i = n || o, s = i.axis.direction, u = s === "vertical" && (t === "MOVE_UP" || t === "MOVE_DOWN") || s === "horizontal" && (t === "MOVE_LEFT" || t === "MOVE_RIGHT");
  if (u && !r)
    return null;
...
function jc({
  ...
  return r.length ? r.length === 1 ? r[0].descriptor.id : Lc({
    pageBorderBox: e,
    draggable: t,
    candidates: r
  }) : null;
...
var Wc = ({
  ...
  const s = r.axis, u = Yt(r.axis, e.displaceBy), c = u.value, l = t[s.start], f = t[s.end], d = Nn(e, o).find((E) => {
    const m = E.descriptor.id, D = E.page.borderBox, A = D[s.size] / Gc, v = rt(m, i), b = is({
  ...
  const u = os(t.page.borderBox, e), c = jc({
    pageBorderBox: u,
    draggable: t,
    droppables: r
  });
  if (!c)
    return rc;
  const l = r[c], f = mt(l.descriptor.id, n), a = $c(l, u);
  return Wc({
...
var us = ({
  ...
  const i = e.displaced, s = Hc(i.all, n), u = Gt({
    afterDragging: s,
    destination: r,
    displacedBy: e.displacedBy,
    viewport: t.frame,
...
var Kc = ({
  ...
  return e.map((o) => {
    const i = o.descriptor.droppableId, s = t[i], c = Jc(s).scroll.diff.value, l = Ae(r, c);
    return Kc({
      draggable: o,
      offset: l,
...
var Zc = (e = ti, t) => {
  ...
  if (t.type === "PUBLISH_WHILE_DRAGGING")
    return e.phase === "COLLECTING" || e.phase === "DROP_PENDING" || (process.env.NODE_ENV !== "production" ? h(!1, `Unexpected ${t.type} received in phase ${e.phase}`) : h(!1)), Qc({
      state: e,
      published: t.payload
    });
  if (t.type === "MOVE") {
...
var El = (e) => ({
  ...
  })), t().phase !== "IDLE" && (process.env.NODE_ENV !== "production" ? h(!1, "Unexpected phase to start a drag") : h(!1)), n(Mr()), n(el({
    draggableId: i,
    movementMode: u
  }));
  const f = {
...
var Cl = ({
  ...
  if (r >= ri)
    return ms;
  const o = r / ri, i = mr + yl * o, s = n === "CANCEL" ? i * vl : i;
...
const Bl = (e) => e.type === "DROP_COMPLETE" || e.type === "DROP_ANIMATE" || e.type === "FLUSH", xl = (e) => {
  const t = Ol({
    onWindowScroll: (n) => {
      e.dispatch(al({
        newScroll: n
  ...
  return (n) => (r) => {
    !t.isActive() && r.type === "INITIAL_PUBLISH" && t.start(), t.isActive() && Bl(r) && t.stop(), n(r);
  };
};
var Il = xl, _l = (e) => {
  let t = !1, n = !1;
...
const Rl = (e, t) => e == null && t == null ? !0 : e == null || t == null ? !1 : e.droppableId === t.droppableId && e.index === t.index, Tl = (e, t) => e == null && t == null ? !0 : e == null || t == null ? !1 : e.draggableId === t.draggableId && e.droppableId === t.droppableId, Vl = (e, t) => {
  if (e === t)
    return !0;
...
var Ll = (e, t) => {
  ...
  const o = (a, d) => {
    ...
    const m = !Vl(a, r.lastCritical);
    m && (r.lastCritical = a);
    const D = !Rl(r.lastLocation, p);
    D && (r.lastLocation = p);
    const y = !Tl(r.lastCombine, E);
...
const zl = (e) => e.type === "DROP_COMPLETE" || e.type === "DROP_ANIMATE" || e.type === "FLUSH";
var Hl = (e) => (t) => (n) => (r) => {
  if (zl(r)) {
    e.stop(), n(r);
    return;
...
var Yl = ql;
const Kl = process.env.NODE_ENV !== "production" && typeof window < "u" && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({
...
var Jl = ({
  ...
  announce: o,
  autoScroller: i
}) => Oi(Zc, Kl(Vu(bl(n), Wl(e), El(e), wl, Ml, Gl, Yl, Hl(i), Il, Ul(t), jl(r, o))));
const zn = () => ({
  additions: {},
  removals: {},
  modified: {}
...
var gs = ({
  ...
  Kt();
  const r = Ql(), o = r.scroll.current, i = e.droppable, s = n.droppable.getAllByType(i.type).map((f) => f.callbacks.getDimensionAndWatchScroll(o, t)), u = n.draggable.getAllByType(e.draggable.type).map((f) => f.getDimension(o)), c = {
    draggables: qi(u),
    droppables: Hi(s)
  };
  return Jt(), {
...
}, ys = (e, t) => e.phase === "IDLE" ? !0 : e.phase !== "DROP_ANIMATING" || e.completed.result.draggableId === t ? !1 : e.completed.result.reason === "DROP", td = (e) => {
  window.scrollBy(e.x, e.y);
};
const nd = ye((e) => Sn(e).filter((t) => !(!t.isEnabled || !t.frame))), rd = (e, t) => nd(t).find((r) => (r.frame || (process.env.NODE_ENV !== "production" ? h(!1, "Invalid result") : h(!1)), rs(r.frame.pageMarginBox)(e))) || null;
var od = ({
  center: e,
  destination: t,
  droppables: n
...
var id = (e, t, n = () => Ut) => {
  ...
  const i = sd(e, t, o);
  return i === 0 ? 0 : r ? Math.max(ud(i, n, o), Wr) : i;
}, si = ({
  container: e,
  distanceToEdges: t,
  dragStartTime: n,
...
const ld = zi((e) => e === 0 ? 0 : e > 0 ? 1 : -1), Ur = (() => {
...
}, bd = (e) => (t) => `[${t}="${e}"]`, Ot = (e, t) => e.map((n) => {
  const r = n.styles[t];
  return r ? `${n.selector} { ${r} }` : "";
}).join(" "), yd = "pointer-events: none;";
var vd = (e) => {
  const t = bd(e), n = (() => {
    const u = `
      cursor: -webkit-grab;
...
const Cd = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u" ? C.useLayoutEffect : C.useEffect;
var Me = Cd;
const Hn = () => {
...
function Ad(e, t) {
  const n = H(() => vd(e), [e]), r = C.useRef(null), o = C.useRef(null), i = R(ye((a) => {
    const d = o.current;
...
var Ss = (e) => e && e.ownerDocument && e.ownerDocument.defaultView ? e.ownerDocument.defaultView : window;
function Xt(e) {
  return e instanceof Ss(e).HTMLElement;
}
function ws(e, t) {
...
function xd(e) {
  const t = H(() => Bd(e), [e]), n = C.useRef(null);
  return C.useEffect(function() {
    const i = document.createElement("div");
    return n.current = i, i.id = t, i.setAttribute("aria-live", "assertive"), i.setAttribute("aria-atomic", "true"), Et(i.style, Od), zt().appendChild(i), function() {
      setTimeout(function() {
        const c = zt();
...
function _d(e, t = Ns) {
  return H(() => `${e}${t.separator}${Id++}`, [t.separator, e]);
}
function Pd(e, t = Ns) {
  const n = N.useId();
  return H(() => `${e}${t.separator}${n}`, [t.separator, e, n]);
}
var Yr = "useId" in N ? Pd : _d;
function Rd({
  contextId: e,
  uniqueId: t
}) {
...
var Bn = N.createContext(null), Vd = {
...
}, jd = (e, t) => t.major > e.major ? !0 : t.major < e.major ? !1 : t.minor > e.minor ? !0 : t.minor < e.minor ? !1 : t.patch >= e.patch;
var $d = (e, t) => {
  const n = li(e), r = li(t);
  jd(n, r) || process.env.NODE_ENV !== "production" && ie(`
    React version: [${r.raw}]
...
function kd() {
  Qt(() => {
    $d(Vd.react, N.version), Md(document);
  }, []);
}
function Jr(e) {
  const t = C.useRef(e);
...
const Wd = 9, Ud = 13, Xr = 27, Os = 32, zd = 33, Hd = 34, qd = 35, Yd = 36, Kd = 37, Jd = 38, Xd = 39, Qd = 40, Zd = {
  [Ud]: !0,
  [Wd]: !0
};
var Bs = (e) => {
  Zd[e.keyCode] && e.preventDefault();
};
const ef = (() => {
...
function pf(e) {
  const t = C.useRef(Yn), n = C.useRef(tt), r = R(function() {
    ...
    const p = {
      ...
      completed: u,
      getPhase: r
    }, m = We(window, ff(E), p), D = We(window, df(E), p);
    n.current = function() {
      m(), D();
    };
  }, [c, r, u]), f = R(function() {
...
var gf = (e) => ze(e.getBoundingClientRect()).center;
function Ef(e) {
  return e instanceof Ss(e).Element;
}
const bf = (() => {
  const e = "matches";
...
function _s(e, t) {
  return e == null ? null : e[bf](t) ? e : _s(e.parentElement, t);
}
function yf(e, t) {
...
function Ps({
  ...
  return o ? !(!o.options.isEnabled || !ys(t.getState(), r)) : (process.env.NODE_ENV !== "production" && ie(`Unable to find draggable with id: ${r}`), !1);
}
function wf({
  lockAPI: e,
  contextId: t,
  ...
  if (!Ps({
    ...
    return null;
  const c = r.draggable.getById(o), l = Ff(t, c.descriptor.id);
  if (!l)
    return process.env.NODE_ENV !== "production" && ie(`Unable to find draggable element with id: ${o}`), null;
  if (s && !c.options.canDragInteractiveElements && hf(l, s))
    return null;
  ...
  function D(g) {
    ...
    a !== "PRE_DRAG" && (S(), process.env.NODE_ENV !== "production" ? h(!1, `Cannot lift in phase ${a}`) : h(!1)), n.dispatch(tl(g.liftActionArgs)), a = "DRAGGING";
    function I(B, x = {
...
function Of({
  ...
  const i = [...o ? Nf : [], ...r || []], s = C.useState(() => Gd())[0], u = R(function(D, y) {
...
function If(e) {
  ...
  kd();
  const u = Jr(e), c = R(() => Bf(u.current), [u]), l = R(() => xf(u.current), [u]), f = xd(t), a = Td({
    contextId: t,
    text: i
  }), d = Ad(t, o), p = R((_) => {
    Bt(s).dispatch(_);
  }, []), E = H(() => Co({
    publishWhileDragging: rl,
    updateDroppableScroll: il,
    updateDroppableIsEnabled: sl,
    updateDroppableIsCombineEnabled: ul,
    collectionStarting: ol
  }, p), [p]), m = wd(), D = H(() => ed(m, E), [m, E]), y = H(() => gd({
    scrollWindow: td,
  ...
  }), [D.scrollDroppable, p, l]), A = Fd(t), v = H(() => Jl({
    announce: f,
    autoScroller: y,
    dimensionMarshal: D,
    focusMarshal: A,
  ...
  n(S);
  const I = R((_) => ys(Bt(s).getState(), _), []), B = R(() => ct(Bt(s).getState()), []), x = H(() => ({
    marshal: D,
    focus: A,
    contextId: t,
    canLift: I,
...
var Tf = "useId" in N ? Rf : Pf;
function KD(e) {
  const t = Tf(), n = e.dragHandleUsageInstructions || dn.dragHandleUsageInstructions;
  return N.createElement(Wa, null, (r) => N.createElement(If, {
    nonce: e.nonce,
    contextId: t,
    setCallbacks: r,
...
const pi = {
  dragging: 5e3,
  dropAnimating: 4500
}, Vf = (e, t) => t ? Tt.drop(t.duration) : e ? Tt.snap : Tt.fluid, Lf = (e, t) => {
  if (e)
...
function $f(e) {
  const n = e.dimension.client, {
    ...
    combineWith: o,
    dropping: i
  } = e, s = !!o, u = jf(e), c = !!i, l = c ? Dr.drop(r, s) : Dr.moveTo(r);
  return {
    position: "fixed",
    top: n.marginBox.top,
...
function kf(e) {
  return e.type === "DRAGGING" ? $f(e) : Mf(e);
}
function Gf(e, t, n = ve) {
...
function Wf(e) {
  const t = Yr("draggable"), {
    ...
    const E = o();
    return E || (process.env.NODE_ENV !== "production" ? h(!1, "Cannot get dimension when no ref is set") : h(!1)), Gf(n, E, p);
  }, [n, o]), f = H(() => ({
    uniqueId: t,
    descriptor: n,
    options: c,
...
function Uf(e, t, n) {
  Qt(() => {
    ...
    o || (process.env.NODE_ENV !== "production" ? h(!1, "Draggable requires a draggableId") : h(!1)), typeof o != "string" && (process.env.NODE_ENV !== "production" ? h(!1, `Draggable requires a [string] draggableId.
      Provided: [type: ${typeof o}] (value: ${o})`) : h(!1)), Number.isInteger(e.index) || (process.env.NODE_ENV !== "production" ? h(!1, `${r(o)} requires an integer index prop`) : h(!1)), e.mapped.type !== "DRAGGING" && (Rs(n()), e.isEnabled && (ws(t, o) || (process.env.NODE_ENV !== "production" ? h(!1, `${r(o)} Unable to find drag handle`) : h(!1))));
  });
}
function zf(e) {
  Kr(() => {
...
const qf = (e) => {
  ...
  const A = H(() => d ? {
    ...
    const S = kf(D), I = D.type === "DRAGGING" && D.dropping ? v : void 0;
    return {
      innerRef: n,
      draggableProps: {
...
const Kf = (e) => e.combine ? e.combine.draggableId : null, Jf = (e) => e.at && e.at.type === "COMBINE" ? e.at.combine.draggableId : null;
function Xf() {
  const e = ye((o, i) => ({
    x: o,
    y: i
  ...
  return (o, i) => {
    if (Ht(o)) {
      if (o.critical.draggable.id !== i.draggableId)
        return null;
      const s = o.current.client.offset, u = o.dimensions.draggables[i.draggableId], c = $e(o.impact), l = Jf(o.impact), f = o.forceShouldAnimate;
    ...
    if (o.phase === "DROP_ANIMATING") {
      ...
      if (s.result.draggableId !== i.draggableId)
        return null;
      const u = i.isClone, c = o.dimensions.draggables[i.draggableId], l = s.result, f = l.mode, a = Vs(l), d = Kf(l), E = {
...
var rp = np;
function js(e) {
  return yn(Qr).isUsingCloneFor === e.draggableId && !e.isClone ? null : N.createElement(rp, e);
}
function JD(e) {
...
const Zr = (e) => (t) => e === t, op = Zr("scroll"), ip = Zr("auto"), sp = Zr("visible"), Di = (e, t) => t(e.overflowX) || t(e.overflowY), up = (e, t) => t(e.overflowX) && t(e.overflowY), $s = (e) => {
  const t = window.getComputedStyle(e), n = {
    overflowX: t.overflowX,
    overflowY: t.overflowY
  };
  return Di(n, op) || Di(n, ip);
}, ap = () => {
  if (process.env.NODE_ENV === "production")
    return !1;
  ...
  return up(r, sp) || process.env.NODE_ENV !== "production" && ie(`
  ...
  `), !1;
}, Ms = (e) => e == null ? null : e === document.body ? ap() ? e : null : e === document.documentElement ? null : $s(e) ? e : Ms(e.parentElement);
var ks = Ms, cp = (e) => {
  !e || !ks(e.parentElement) || process.env.NODE_ENV !== "production" && ie(`
...
var pp = ({
  ...
  const c = n.closestScrollable, l = fp(e, c), f = gn(l, r), a = (() => {
    if (!c)
      return null;
    const p = ki(c), E = {
...
var mi = (e) => e.shouldPublishImmediately ? Dp : mp;
...
function hp(e) {
  const t = C.useRef(null), n = yn(Bn), r = Yr("droppable"), {
    ...
    return M && (M.setAttribute(ai.contextId, n.contextId), M.addEventListener("scroll", p, mi(x.scrollOptions)), process.env.NODE_ENV !== "production" && cp(M)), _;
...
function Fp(e) {
  Qt(() => {
    Xn(e, vp), e.props.mode === "standard" && Xn(e, Cp), e.props.mode === "virtual" && Xn(e, Ap);
  });
}
...
const gi = {
  ...
  return t;
}, Qn = (e, t) => e === t.droppable.type, Ei = (e, t) => t.draggables[e.draggable.id], Bp = () => {
  const e = {
    placeholder: null,
...
var XD = Ip;
const _p = (e) => /* @__PURE__ */ C.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512", ...e }, /* @__PURE__ */ C.createElement("path", { d: "M0 117.66v346.32c0 11.32 11.43 19.06 21.94 14.86L160 416V32L20.12 87.95A32.006 32.006 0 000 117.66zM192 416l192 64V96L192 32v384zM554.06 33.16L416 96v384l139.88-55.95A31.996 31.996 0 00576 394.34V48.02c0-11.32-11.43-19.06-21.94-14.86z" })), dt = (e, t, n, r, o) => {
  if (!r)
    throw new Error(o ?? `Invalid property path: ${t}
Couldn't access "${n}" in ${JSON.stringify(e)}`);
}, bi = (e) => typeof e == "object" && e !== null && !Array.isArray(e), fn = (e) => Array.isArray(e), Us = (e, t) => e.filter((n, r) => r !== t), Pp = (e, t, n, r = {}) => {
  ...
  if (t.length === 1) {
    ...
    return i && typeof a == "number" ? (Tp(i, a, n, r), i) : (dt(l, f, a, c), e);
  }
  const d = o || i || [];
  ...
  const r = Array.isArray(t) ? t : Vp(t);
  if (r.length === 0)
    return e;
  const o = r[0];
...
}, Vp = (e) => e.split(/(\.|\[\d+\])/).filter((t) => t !== "." && t !== "").map((t) => {
  const n = /\[(\d+)\]/.exec(t);
...
` ? n + "." : n;
  ...
  return Object.entries(r).forEach(([i, s]) => {
    const u = (Array.isArray(s) ? s : [s]).reduce((c, l) => {
      ...
      if (typeof l == "string") {
        ...
        return typeof a == "string" ? Object.assign(Object.assign({}, c), { [nD[i]]: a }) : Object.assign(Object.assign({}, c), a);
      }
      return Object.assign(Object.assign({}, c), l);
    }, {});
    o[i] = u;
  }), o;
}, tD = (e) => !("styles" in e), nD = { container: "backgroundColor", collection: "backgroundColor", collectionInner: "backgroundColor", collectionElement: "backgroundColor", property: "color", bracket: "color", itemCount: "color", string: "color", number: "color", boolean: "color", null: "color", input: "color", inputHighlight: "backgroundColor", error: "color", iconCollection: "color", iconEdit: "color", iconDelete: "color", iconAdd: "color", iconCopy: "color", iconOk: "color", iconCancel: "color" }, rD = (e, t = 200) => typeof e == "string" ? e.length < t ? e : `${e.slice(0, t - 2).trim()}...` : e, Zt = (e) => e.map((t) => t === "" ? String.fromCharCode(0) : t).join("."), oD = ({ value: e, setValue: t, isEditing: n, path: r, setIsEditing: o, handleEdit: i, handleCancel: s, stringTruncate: u, showStringQuotes: c, nodeData: l }) => {
  const { getStyles: f } = et(), a = Zt(r), d = c ? '"' : "";
  return n ? w(Ys, { className: "jer-input-text", name: a, value: e, setValue: t, isEditing: n, handleKeyPress: (p) => {
  ...
  }, className: "jer-value-string", style: f("string", l), children: [d, rD(e, u), d] });
}, iD = ({ value: e, setValue: t, isEditing: n, path: r, setIsEditing: o, handleEdit: i, handleCancel: s, nodeData: u }) => {
...
}, uD = ({ value: e, isEditing: t, setIsEditing: n, handleEdit: r, handleCancel: o, nodeData: i }) => {
...
}, aD = ({ value: e, translate: t, isEditing: n, handleEdit: r, handleCancel: o, nodeData: i }) => {
...
}, cD = ({ value: e, isEditing: t, handleEdit: n, handleCancel: r }) => {
  ...
  switch (e) {
    ...
    case "edit":
      return (o = a == null ? void 0 : a.edit) !== null && o !== void 0 ? o : w(fD, Object.assign({}, d, { style: f("iconEdit", t) }));
    case "delete":
      return (i = a == null ? void 0 : a.delete) !== null && i !== void 0 ? i : w(pD, Object.assign({}, d, { style: f("iconDelete", t), size: "1.45em" }));
    case "copy":
      return (s = a == null ? void 0 : a.copy) !== null && s !== void 0 ? s : w(DD, Object.assign({}, d, { style: f("iconCopy", t), size: "1.2em" }));
    case "ok":
      return (u = a == null ? void 0 : a.ok) !== null && u !== void 0 ? u : w(mD, Object.assign({}, d, { style: Object.assign({ fontSize: "90%" }, f("iconOk", t)) }));
    case "cancel":
      return (c = a == null ? void 0 : a.cancel) !== null && c !== void 0 ? c : w(hD, Object.assign({}, d, { style: Object.assign({ fontSize: "130%" }, f("iconCancel", t)) }));
    case "chevron":
      return (l = a == null ? void 0 : a.chevron) !== null && l !== void 0 ? l : w(gD, { className: "jer-accordion-icon" + (n ? " jer-rotate-90" : ""), size: "1em", style: f("iconCollection", t) });
    default:
      return w(Ar, {});
  }
  ...
  return C.useEffect(() => {
    ...
    let y, A = "value", v = "";
    r && ((D.ctrlKey || D.metaKey) === !0 ? (y = ED(E), v = y, A = "path") : (y = m, v = o ? JSON.stringify(m, null, 2) : String(y)), navigator.clipboard.writeText(v)), typeof r == "function" && r({ value: y, stringValue: v, path: E, key: p, type: A });
...
}, to = ({ onOk: e, onCancel: t, nodeData: n }) => he("div", { className: "jer-confirm-buttons", children: [w("div", { onClick: e, children: w(ft, { name: "ok", nodeData: n }) }), w("div", { onClick: t, children: w(ft, { name: "cancel", nodeData: n }) })] }), ED = (e) => e.reduce((t, n) => typeof n == "number" ? `${t}[${n}]` : t === "" ? n : `${t}.${n}`, ""), bD = ["string", "number", "boolean", "null", "object", "array"], Qs = (e = [], t) => {
...
}, areChildrenBeingEdited: () => !1 }), yD = ({ children: e }) => {
  const [t, n] = C.useState(null), [r, o] = C.useState(null);
  return w(eu.Provider, { value: { collapseState: t, setCollapseState: n, doesPathMatch: (i) => {
    if (t === null)
      return !1;
  ...
  }, [u, c]), { CustomNode: le, customNodeProps: T, hideKey: Y, showEditTools: De = !0, showOnEdit: _e, showOnView: ne } = q, re = [...bD, ...b.filter(({ showInTypesSelector: V = !1, name: se }) => V && !!se).map(({ name: V }) => V)], Ee = C.useMemo(() => {
    if (typeof d == "boolean")
      return d ? [] : re;
    if (Array.isArray(d))
      return d;
  ...
  }, isEditing: de, setIsEditing: () => I(te), getStyles: g })) : vD(cn(t), qe);
  return w("div", { className: "jer-component jer-value-component", style: { marginLeft: A / 2 + "em" }, children: he("div", { className: "jer-value-main-row", style: { flexWrap: j.length > 10 ? "wrap" : "nowrap" }, children: [Te && he("span", { className: "jer-key-text", style: Object.assign(Object.assign({}, g("property", r)), { minWidth: `${Math.min(String(j).length + 1, 5)}ch`, flexShrink: j.length > 10 ? 1 : 0 }), onDoubleClick: () => Pe && I(`key_${te}`), children: [j === "" ? w("span", { className: "jer-empty-string" }) : j, ":"] }), ke && w("input", { className: "jer-input-text jer-key-edit", type: "text", name: te, defaultValue: j, autoFocus: !0, onFocus: (V) => V.target.select(), onKeyDown: (V) => {
  ...
  }, style: { width: String(j).length / 1.5 + 0.5 + "em" } }), he("div", { className: "jer-value-and-buttons", children: [w("div", { className: "jer-input-component", children: Ye }), de ? w(to, { onOk: Be, onCancel: O, nodeData: r }) : Fe && w(Xs, { startEdit: U ? () => I(te) : void 0, handleDelete: fe ? () => {
    i(x, G).then((V) => {
    ...
    if (Se)
      ...
      const Ve = CD(x, se, v("DEFAULT_NEW_KEY", r), q != null && q.CustomNode ? v("DEFAULT_STRING", r) : void 0);
...
}, cn = (e, t) => t != null && t.CustomNode && (t != null && t.name) && t.showInTypesSelector ? t.name : typeof e == "string" ? "string" : typeof e == "number" ? "number" : typeof e == "boolean" ? "boolean" : e === null ? "null" : "invalid", vD = (e, t) => {
  const n = t.value;
  switch (e) {
    case "string":
      return w(oD, Object.assign({}, t, { value: n }));
    case "number":
      return w(iD, Object.assign({}, t, { value: n }));
    case "boolean":
      return w(sD, Object.assign({}, t, { value: n }));
    case "null":
      return w(uD, Object.assign({}, t));
    case "object":
      return w(aD, Object.assign({}, t, { value: n }));
    case "array":
      return w(cD, Object.assign({}, t));
    default:
  ...
  const O = C.useMemo(() => !A(T), [T]), de = C.useMemo(() => !v(T), [T]), P = C.useMemo(() => !b(T), [T]), Pe = C.useMemo(() => (L) => typeof $ != "function" ? $ : $(L), [$]), { CustomNode: Re, customNodeProps: xe, CustomWrapper: Fe, wrapperProps: ke = {}, hideKey: Te, showEditTools: qe = !0, showOnEdit: Ye, showOnView: V, showCollectionWrapper: se = !0 } = C.useMemo(() => Qs(G, T), []), Se = C.useMemo(() => (L, oe) => {
    var Le;
  ...
  if (!Zs("collection", T, I, B) && T.level > 0)
    return null;
  ...
  }, Ke = f === ne, ou = f === `key_${ne}`, oo = typeof Y.slice(-1)[0] == "number", iu = r !== null && O && P && de && !oo, io = o === "when-closed" ? ce : o, su = !Ke && qe, uu = (M || !oo) && !Te && De !== void 0, au = Re && (Ke && Ye || !Ke && V), cu = _ && Ve === "object", so = Object.entries(t).map(([L, oe]) => [Ve === "array" ? Number(L) : L, oe]);
  cu && so.sort(typeof _ == "function" ? (L, oe) => _(L[0], oe[0]) : void 0);
  const lu = JSON.stringify(t, null, 2).replace(/\\n/g, `
`).split(`
`).length, uo = re.current ? Ke ? w("div", { className: "jer-collection-text-edit", children: he("div", { children: [w(Ys, { className: "jer-collection-text-area", name: ne, value: K, setValue: te, isEditing: Ke, handleKeyPress: ro, styles: s("input", T) }), w("div", { className: "jer-collection-input-button-row", children: w(to, { onOk: In, onCancel: tn, nodeData: T }) })] }) }) : so.map(([L, oe], Le) => {
    ...
    return w("div", { className: "jer-collection-element", style: s("collectionElement", wt), children: Fn(oe) ? w(nu, Object.assign({ data: oe, parentData: t, nodeData: wt, showCollectionCount: o }, i), L) : w(tu, Object.assign({ data: oe, parentData: t, nodeData: wt }, i, { showLabel: Ve === "object" || M }), L) }, L);
  }) : null, nn = !!se && ce;
  nn || (re.current = !0);
  const ao = Object.assign(Object.assign({}, i), { data: t, value: t, parentData: r, nodeData: T, setValue: (L) => pn(void 0, void 0, void 0, function* () {
    return yield p(L, Y);
  }), handleEdit: In, handleCancel: tn, handleKeyPress: ro, isEditing: Ke, setIsEditing: () => a(ne), getStyles: s }), du = au ? w(Re, Object.assign({ customNodeProps: xe }, ao, { children: uo })) : uo, co = ou ? w("input", { className: "jer-input-text jer-key-edit", type: "text", name: ne, defaultValue: De, autoFocus: !0, onFocus: (L) => L.target.select(), onKeyDown: (L) => {
    L.key === "Enter" ? ((oe) => {
      if (a(null), De === oe || !r)
        return;
  ...
  }, style: { width: String(De).length / 1.5 + 0.5 + "em" } }) : uu && w("span", { className: "jer-key-text", style: s("property", T), onDoubleClick: () => iu && a(`key_${ne}`), children: De === "" ? w("span", { className: Y.length > 0 ? "jer-empty-string" : void 0 }) : `${De}:` }), lo = su && w(Xs, { startEdit: O ? () => {
  ...
  const { getStyles: U, setTheme: fe, setIcons: ce } = et(), { setCollapseState: le } = no(), T = C.useCallback(ln(p), [p]), Y = C.useCallback(FD(G, K), [G, K]), [De, _e] = C.useState(b), [ne, re] = C.useState(e);
  C.useEffect(() => {
    f && fe(f), a && ce(a);
  }, [f, a]), C.useEffect(() => {
    le(null), re(e);
  ...
  const Ee = { key: t, path: [], level: 0, index: 0, value: ne, size: Object.keys(ne).length, parentData: null, fullData: ne }, Be = ln(m), O = ln(D), de = ln(y), P = ND(v), Pe = { name: t, nodeData: Ee, onEdit: (xe, Fe) => pn(void 0, void 0, void 0, function* () {
  ...
  return Re.fontSize = $ ?? Re.fontSize, w("div", { id: ee, className: "jer-editor-container " + q, style: Re, children: Fn(ne) ? w(nu, Object.assign({ data: ne }, Pe)) : w(tu, Object.assign({ data: ne, showLabel: !0 }, Pe)) });
}, wD = (e) => w(Zp, { children: w(yD, { children: w(SD, Object.assign({}, e)) }) }), nr = (e, t, n, r) => {
  if (t.length === 0)
    return { currentData: e, newData: n, currentValue: e, newValue: n };
  const o = r !== "add" ? vn(e, t) : void 0;
  return { currentData: e, newData: Pp(Kp(e), t, n, { remove: r === "delete" }), currentValue: o, newValue: r !== "delete" ? n : void 0 };
}, ln = (e) => typeof e == "boolean" ? () => e : typeof e == "number" ? ({ level: t }) => t >= e : e, ND = (e) => {
  if (e !== void 0)
  ...
  return t.type === "dashboard" ? (BD(t), xD(t), OD(t)) : (delete t.runtime, delete t.formattedData, t.dataUrl && delete t.data), t;
};
const QD = ({ loadConfig: e, config: t, convertStateToConfig: n, onExpandCollapse: r = () => {
  ...
  const f = {
    ...
    map: ["Maps", "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/data-map.html", /* @__PURE__ */ N.createElement(_p, null)],
  ...
  return t.type ? /* @__PURE__ */ N.createElement(N.Fragment, null, /* @__PURE__ */ N.createElement("a", { href: f[t.type][1], target: "_blank", rel: "noopener noreferrer", className: "guidance-link" }, f[t.type][2], /* @__PURE__ */ N.createElement("div", null, /* @__PURE__ */ N.createElement("span", { className: "heading-3" }, "Get Help with ", f[t.type][0]), /* @__PURE__ */ N.createElement("p", null, "Examples and documentation"))), /* @__PURE__ */ N.createElement("div", { className: "advanced" }, /* @__PURE__ */ N.createElement("span", { className: "advanced-toggle-link", onClick: () => c(!o) }, /* @__PURE__ */ N.createElement("span", null, o ? "— " : "+ "), "Advanced Options"), o && /* @__PURE__ */ N.createElement(N.Fragment, null, /* @__PURE__ */ N.createElement("section", { className: "error-box py-2 px-3 my-2" }, /* @__PURE__ */ N.createElement("div", null, /* @__PURE__ */ N.createElement("strong", { className: "pt-1" }, "Warning"), /* @__PURE__ */ N.createElement("p", null, "This can cause serious errors in your visualization."))), /* @__PURE__ */ N.createElement("p", { className: "pb-2" }, "This tool displays the actual ", /* @__PURE__ */ N.createElement("acronym", { title: "JavaScript Object Notation" }, "JSON"), " configuration that is generated by this editor and allows you to edit properties directly and apply them."), /* @__PURE__ */ N.createElement(
    ...
    "Copy to Clipboard"
  ), /* @__PURE__ */ N.createElement(wD, { className: "advanced-json-editor", data: JSON.parse(s), onUpdate: l, rootName: "" }), /* @__PURE__ */ N.createElement(
    "button",
    {
...
const ir = (e, t) => {
  ...
  return {
    ...
    handleReset: (y) => {
      ...
      const b = rr();
      A.forEach((g, S) => {
        (!g.values || g.values.length === 0) && (g.values = c(f, g.columnName)), A[S].active = Ai(g).values[0], g.setByQueryParameter && b[g.setByQueryParameter] !== g.active && (b[g.setByQueryParameter] = g.active, v = !0);
  ...
  if (g.Section = ({ children: B }) => (t == null ? void 0 : t.filters) && /* @__PURE__ */ N.createElement("section", { className: S.join(" ") }, /* @__PURE__ */ N.createElement("p", { className: "filters-section__intro-text" }, o != null && o.some((x) => x.active) ? v.introText : "", " ", t.filterBehavior === "Apply Button" && v.applyText), /* @__PURE__ */ N.createElement("div", { className: "filters-section__wrapper" }, B)), g.ApplyBehavior = () => {
    ...
    return /* @__PURE__ */ N.createElement("div", { className: "filters-section__buttons" }, /* @__PURE__ */ N.createElement(mu, { onClick: () => E(o), disabled: !y, className: B.join(" ") }, v.buttonText), /* @__PURE__ */ N.createElement("a", { href: "#!", role: "button", onClick: A }, v.resetText));
  }, g.TabBar = (B) => {
