...
import { A as ke, a as re, b as le, c as oe, d as ie, e as Ie, D as Re } from "./storybook-DataTransform-0947aeee.es.js";
...
import { L as ne, u as Ve, p as de, c as ze } from "./storybook-coveUpdateWorker-91c2d978.es.js";
...
function He(t, l, m) {
  var b = this, u = g.useRef(null), _ = g.useRef(0), v = g.useRef(null), N = g.useRef([]), O = g.useRef(), i = g.useRef(), a = g.useRef(t), A = g.useRef(!0);
  a.current = t;
  ...
  var S = g.useMemo(function() {
    var T = function(C) {
      ...
      if (W(C))
        return j(C);
      if (A.current) {
        var R = C - u.current, B = C - _.current, r = l - R, o = P ? Math.min(r, L - B) : r;
        X(I, o);
      }
    }, J = function() {
      ...
      if (N.current = C, O.current = b, u.current = B, r) {
        if (!v.current && A.current)
          return _.current = u.current, X(I, l), G ? T(u.current) : i.current;
        if (P)
          return X(I, l), T(u.current);
      }
...
function Je(t, l, m) {
  var b = m && m.equalityFn || $e, u = Ze(t), _ = u[0], v = u[1], N = He(g.useCallback(function(i) {
    return v(i);
  }, [v]), l, m), O = g.useRef(t);
...
const $ = g.memo(
  ...
  return m ? null : /* @__PURE__ */ e.createElement(Pe, { component: "EditorPanel" }, /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement("section", { className: "form-container" }, /* @__PURE__ */ e.createElement("form", null, /* @__PURE__ */ e.createElement(ke, { allowZeroExpanded: !0 }, /* @__PURE__ */ e.createElement(re, null, " ", /* @__PURE__ */ e.createElement(le, null, /* @__PURE__ */ e.createElement(oe, null, "General")), /* @__PURE__ */ e.createElement(ie, null, /* @__PURE__ */ e.createElement(
      ...
      ee,
      {
        value: (C = t.visual) == null ? void 0 : C.accent,
        section: "visual",
        fieldName: "accent",
    ...
    )), /* @__PURE__ */ e.createElement("label", null, /* @__PURE__ */ e.createElement("span", { className: "edit-label" }, "Theme"), /* @__PURE__ */ e.createElement("ul", { className: "color-palette" }, Qe.map((r) => /* @__PURE__ */ e.createElement(
      "li",
      {
        title: r,
        key: r,
...
const Xe = ({ label: t, value: l }) => /* @__PURE__ */ e.createElement("div", { className: "cove-component__content kpi-container" }, /* @__PURE__ */ e.createElement("div", { className: "kpi-content" }, /* @__PURE__ */ e.createElement("div", { className: "label-container" }, /* @__PURE__ */ e.createElement("span", { className: "label" }, /* @__PURE__ */ e.createElement("strong", null, t))), /* @__PURE__ */ e.createElement("div", { className: "value-container" }, /* @__PURE__ */ e.createElement("span", { className: "value" }, /* @__PURE__ */ e.createElement("strong", null, l))))), Ye = (t, l) => {
  switch (l.type) {
    case "SET_CONFIG":
...
const vt = (t) => {
  const {
    ...
    coveLoadedHasRan: !1,
    container: null
  }, [O, i] = g.useReducer(Ye, N), { config: a, loading: A, currentViewport: w, coveLoadedHasRan: G, container: z } = O, {
    title: P,
    dataColumn: L,
    dataFunction: S,
    imageData: T,
  ...
  return /* @__PURE__ */ e.createElement(he.Provider, { value: { config: a, updateConfig: d, loading: A, data: a.data, setParentConfig: _, isDashboard: b } }, I !== "gradient" && /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(ne.Responsive, { isEditor: u }, !a.newViz && a.runtime && a.runtime.editorErrorMessage && /* @__PURE__ */ e.createElement(Error, null), (!a.dataColumn || !a.dataFunction) && /* @__PURE__ */ e.createElement(Confirm, null), /* @__PURE__ */ e.createElement(Xe, { label: a.title, value: x() }))
  ));
}, ye = "Max", ve = "Count", Ne = "Mean (Average)", Ae = "Median", Ce = "Min", Te = "Mode", me = "Range", De = "Sum", Ke = [
  ve,
  ye,
  Ne,
  Ae,
