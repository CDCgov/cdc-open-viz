import { C as c } from "./storybook-CdcChartComponent-f9821d3b.es.js";
...
const l = [], r = "chart", t = !1, S = {
  noData: "No Data Available"
}, i = "", s = !0, m = !1, Y = "theme-blue", u = !1, x = "medium", d = "hover", A = "Same as Line", I = "false", p = !1, h = "circle", f = "two-tone", g = "regular", M = "", F = "standard", b = "top", y = !0, w = {
...
], ie = "https://wwwdev.cdc.gov/wcms/4.0/cdc-wp/data-presentation/data/indexed-data-files/59-scatter-plot-tight-correlation-multiple-series-sexFilter.csv", se = "url", me = "4.24.9", Ye = 104, ue = [
  {
    values: [
      "Male",
      "Female"
  ...
  title: i,
  showTitle: s,
  showDownloadMediaButton: m,
  theme: Y,
  animate: u,
  fontSize: x,
  lineDatapointStyle: d,
  lineDatapointColor: A,
  barHasBorder: I,
  isLollipopChart: p,
  lollipopShape: h,
...
const oo = ["ScatterPlot_Download_Image"];
export {
  e as ScatterPlot_Download_Image,
