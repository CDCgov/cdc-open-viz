...
import { i as so, b as wt, a as fa, g as pa } from "./storybook-isSolr-cb863e7a.es.js";
import { C as ce, E as ke, y as ga, o as ma, M as va, $ as ha, m as Sa, B as wa, d as Ma, a as No, G as ba, O as Aa } from "./storybook-CdcDashboard-a9953414.es.js";
...
import { D as Na } from "./storybook-DataTransform-e292f51b.es.js";
import { c as na } from "./storybook-_commonjsHelpers-c5d32002.es.js";
import { f as To } from "./storybook-fetchRemoteData-8fd8b50f.es.js";
import { a as Po, b as Eo, c as Ta, d as Pa, e as Ea, f as Ia, g as La, h as ka, i as Io, j as Oa, k as Ba } from "./storybook-Icon-ed0ee925.es.js";
import { D as Fa } from "./storybook-DataDesigner-a81779cb.es.js";
import { T as tn } from "./storybook-Tooltip-edc0f7ab.es.js";
import { E as le } from "./storybook-Loading-f180d060.es.js";
import { _ as Rt } from "./storybook-lodash-c15d8e1c.es.js";
import "./storybook-Filters-b7b1162e.es.js";
...
import "./storybook-DataTableEditor-01907213.es.js";
import "./storybook-useDebounce-78f40efd.es.js";
import "./storybook-MultiSelect-97f9e57b.es.js";
import "./storybook-InputSelect-20478396.es.js";
import "./storybook-index-4ed993c7.es.js";
import "./storybook-DataTable-def0ac69.es.js";
...
import "./storybook-footnoteSymbols-afb8d386.es.js";
import "./storybook-Footnotes-6f80714a.es.js";
import "./storybook-coveUpdateWorker-aacf98e7.es.js";
import "./storybook-jsx-runtime-36872362.es.js";
import "./storybook-string-7df1b381.es.js";
import "./storybook-Card-6750b07b.es.js";
function ye(t, f, c, y) {
  function b(P) {
    return P instanceof c ? P : new c(function(C) {
      C(P);
    });
  }
  return new (c || (c = Promise))(function(P, C) {
    function O(En) {
      try {
        M(y.next(En));
      } catch (w) {
    ...
    function M(En) {
      En.done ? P(En.value) : b(En.value).then(O, Rn);
    }
    M((y = y.apply(t, f || [])).next());
  });
}
function Ce(t, f) {
  ...
  function Rn(M) {
    ...
    for (; C && (C = 0, M[0] && (c = 0)), c; )
      try {
        if (y = 1, b && (P = M[0] & 2 ? b.return : M[0] ? b.throw || ((P = b.return) && P.call(b), 0) : b.next) && !(P = P.call(b, M[1])).done)
          return P;
...
function Ha(t, f) {
  ...
  if (!c)
    return t;
  var y = c.call(t), b, P = [], C;
  try {
    for (; (f === void 0 || f-- > 0) && !(b = y.next()).done; )
      P.push(b.value);
  } catch (O) {
    C = { error: O };
  } finally {
...
function Oe(t, f) {
  ...
  if (typeof c.path != "string") {
    ...
    Object.defineProperty(c, "path", {
      value: typeof f == "string" ? f : typeof y == "string" && y.length > 0 ? y : t.name,
      writable: !1,
      configurable: !1,
      enumerable: !0
    });
...
function Ga(t) {
  ...
  if (c && !t.type) {
    var y = f.split(".").pop().toLowerCase(), b = xa.get(y);
...
function Ka(t) {
  return ye(this, void 0, void 0, function() {
    return Ce(this, function(f) {
      return Nt(t) && qa(t) ? [2, Ya(t.dataTransfer, t.type)] : za(t) ? [2, _a(t)] : Array.isArray(t) && t.every(function(c) {
...
function _a(t) {
  return po(t.target.files).map(function(f) {
    return Oe(f);
  });
}
function Xa(t) {
  return ye(this, void 0, void 0, function() {
    ...
    return Ce(this, function(c) {
      switch (c.label) {
        ...
        case 1:
          return f = c.sent(), [2, f.map(function(y) {
            return Oe(y);
          })];
      }
    });
...
function Ya(t, f) {
  return ye(this, void 0, void 0, function() {
    ...
    return Ce(this, function(b) {
      switch (b.label) {
        case 0:
          return t === null ? [2, []] : t.items ? (c = po(t.items).filter(function(P) {
            return P.kind === "file";
          }), f !== "drop" ? [2, c] : [4, Promise.all(c.map(ja))]) : [3, 2];
        case 1:
          return y = b.sent(), [2, Lo(ra(y))];
        case 2:
          return [2, Lo(po(t.files).map(function(P) {
            return Oe(P);
          }))];
      }
    });
...
function ja(t) {
  ...
  return f && f.isDirectory ? ea(f) : ko(t);
}
function ra(t) {
  return t.reduce(function(f, c) {
    return Wa(f, Array.isArray(c) ? ra(c) : [c]);
  }, []);
}
function ko(t) {
  var f = t.getAsFile();
...
function Ua(t) {
  return ye(this, void 0, void 0, function() {
    return Ce(this, function(f) {
      return [2, t.isDirectory ? ea(t) : Ja(t)];
    });
  });
}
function ea(t) {
  ...
  return new Promise(function(c, y) {
    ...
    function P() {
      ...
      f.readEntries(function(O) {
        return ye(C, void 0, void 0, function() {
          var Rn, M, En;
          return Ce(this, function(w) {
            switch (w.label) {
              ...
              case 2:
                return Rn = w.sent(), c(Rn), [3, 4];
              case 3:
                return M = w.sent(), y(M), [3, 4];
              case 4:
                return [3, 6];
              case 5:
                En = Promise.all(O.map(Ua)), b.push(En), P(), w.label = 6;
              case 6:
                return [
                  2
                  /*return*/
...
var $a = function(t, f) {
  if (t && f) {
    var c = Array.isArray(f) ? f : f.split(","), y = t.name || "", b = (t.type || "").toLowerCase(), P = b.replace(/\/.*$/, "");
    return c.some(function(C) {
      var O = C.trim().toLowerCase();
      return O.charAt(0) === "." ? y.toLowerCase().endsWith(O) : O.endsWith("/*") ? P === O.replace(/\/.*$/, "") : b === O;
    });
  }
  return !0;
};
...
function Bo(t) {
  for (var f = 1; f < arguments.length; f++) {
    ...
    f % 2 ? Oo(Object(c), !0).forEach(function(y) {
      ta(t, y, c[y]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(c)) : Oo(Object(c)).forEach(function(y) {
...
function Ho(t, f) {
  ...
  for (var c = 0, y = new Array(f); c < f; c++)
    y[c] = t[c];
  return y;
}
function nu(t, f) {
  ...
  if (c != null) {
    var y = [], b = !0, P = !1, C, O;
    try {
      for (c = c.call(t); !(b = (C = c.next()).done) && (y.push(C.value), !(f && y.length === f)); b = !0)
        ;
    } catch (Rn) {
      P = !0, O = Rn;
    } finally {
...
function lu(t) {
  var f = t.files, c = t.accept, y = t.minSize, b = t.maxSize, P = t.multiple, C = t.maxFiles;
  return !P && f.length > 1 || P && C >= 1 && f.length > C ? !1 : f.every(function(O) {
    var Rn = oa(O, c), M = Fo(Rn, 1), En = M[0], w = aa(O, y, b), un = Fo(w, 1), Nn = un[0];
    return En && Nn;
  });
}
function Tt(t) {
...
function kr() {
  for (var t = arguments.length, f = new Array(t), c = 0; c < t; c++)
    f[c] = arguments[c];
  return function(y) {
    for (var b = arguments.length, P = new Array(b > 1 ? b - 1 : 0), C = 1; C < b; C++)
      P[C - 1] = arguments[C];
    return f.some(function(O) {
      return !Tt(y) && O && O.apply(void 0, [y].concat(P)), Tt(y);
    });
  };
}
function Vo() {
...
function rr(t) {
  for (var f = 1; f < arguments.length; f++) {
    var c = arguments[f] != null ? arguments[f] : {};
    f % 2 ? Ko(Object(c), !0).forEach(function(y) {
      mo(t, y, c[y]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(c)) : Ko(Object(c)).forEach(function(y) {
      Object.defineProperty(t, y, Object.getOwnPropertyDescriptor(c, y));
    });
  }
  return t;
...
function Pt(t, f) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (b = 0; b < P.length; b++)
      y = P[b], !(f.indexOf(y) >= 0) && Object.prototype.propertyIsEnumerable.call(t, y) && (c[y] = t[y]);
  }
  return c;
}
function Au(t, f) {
  if (t == null)
    return {};
  var c = {}, y = Object.keys(t), b, P;
  for (P = 0; P < y.length; P++)
    b = y[P], !(f.indexOf(b) >= 0) && (c[b] = t[b]);
  return c;
}
var Mo = /* @__PURE__ */ D.forwardRef(function(t, f) {
  var c = t.children, y = Pt(t, du), b = ho(y), P = b.open, C = Pt(b, fu);
  return D.useImperativeHandle(f, function() {
    return {
      open: P
    };
  }, [P]), /* @__PURE__ */ l.createElement(D.Fragment, null, c(rr(rr({}, C), {}, {
    open: P
  })));
});
...
function ho() {
  var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, f = rr(rr({}, ia), t), c = f.accept, y = f.disabled, b = f.getFilesFromEvent, P = f.maxSize, C = f.minSize, O = f.multiple, Rn = f.maxFiles, M = f.onDragEnter, En = f.onDragLeave, w = f.onDragOver, un = f.onDrop, Nn = f.onDropAccepted, Cn = f.onDropRejected, dn = f.onFileDialogCancel, Vn = f.onFileDialogOpen, vn = f.useFsAccessApi, Hn = f.preventDropOnDocument, bn = f.noClick, Jn = f.noKeyboard, Wn = f.noDrag, An = f.noDragEventsBubbling, or = f.validator, zn = D.useMemo(function() {
    return typeof Vn == "function" ? Vn : qo;
  }, [Vn]), dr = D.useMemo(function() {
    return typeof dn == "function" ? dn : qo;
  }, [dn]), fn = D.useRef(null), on = D.useRef(null), _n = D.useReducer(Du, vo), Qn = co(_n, 2), Yn = Qn[0], nr = Qn[1], Pr = Yn.isFocused, Rr = Yn.isFileDialogActive, br = Yn.draggedFiles, Er = function() {
    Rr && setTimeout(function() {
      if (on.current) {
        var In = on.current.files;
        In.length || (nr({
          type: "closeDialog"
        }), dr());
      }
  ...
  var ar = D.useCallback(function(Q) {
  ...
  }, [b, M, An]), Or = D.useCallback(function(Q) {
    ...
    return In && w && w(Q), !1;
  }, [w, An]), Br = D.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Ir(Q);
    var In = fr.current.filter(function(ir) {
      return fn.current && fn.current.contains(ir);
    }), er = In.indexOf(Q.target);
    er !== -1 && In.splice(er, 1), fr.current = In, !(In.length > 0) && (nr({
      isDragActive: !1,
      type: "setDraggedFiles",
      draggedFiles: []
    }), Mt(Q) && En && En(Q));
  }, [fn, En, An]), F = D.useCallback(function(Q, In) {
    var er = [], ir = [];
    Q.forEach(function(gr) {
      var Fr = oa(gr, c), Tr = co(Fr, 2), Yr = Tr[0], jr = Tr[1], Ur = aa(gr, C, P), Wr = co(Ur, 2), Jr = Wr[0], xr = Wr[1], Gr = or ? or(gr) : null;
      if (Yr && Jr && !Gr)
        er.push(gr);
      else {
        var Hr = [jr, xr];
    ...
    }), (!O && er.length > 1 || O && Rn >= 1 && er.length > Rn) && (er.forEach(function(gr) {
      ir.push({
        file: gr,
        errors: [iu]
      });
      ...
      fileRejections: ir,
      type: "setFiles"
    }), un && un(er, ir, In), ir.length > 0 && Cn && Cn(ir, In), er.length > 0 && Nn && Nn(er, In);
  }, [nr, O, c, C, P, Rn, un, Nn, Cn, or]), z = D.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Ir(Q), fr.current = [], Mt(Q) && Promise.resolve(b(Q)).then(function(In) {
      Tt(Q) && !An || F(In, Q);
    }), nr({
      type: "reset"
    });
  }, [b, F, An]), an = D.useCallback(function() {
    if (vn && Vo()) {
      nr({
        type: "openDialog"
      }), zn();
    ...
    on.current && (nr({
      type: "openDialog"
    }), zn(), on.current.value = null, on.current.click());
  }, [nr, zn, dr, vn, F, c, O]), rn = D.useCallback(function(Q) {
    !fn.current || !fn.current.isEqualNode(Q.target) || (Q.keyCode === 32 || Q.keyCode === 13) && (Q.preventDefault(), an());
  }, [fn, on, an]), Gn = D.useCallback(function() {
    nr({
      type: "focus"
    });
    ...
    bn || (yu() ? setTimeout(an, 0) : an());
  }, [on, bn, an]), Nr = function(In) {
    return y ? null : In;
  }, Ar = function(In) {
    ...
    return function() {
      var Q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, In = Q.refKey, er = In === void 0 ? "ref" : In, ir = Q.role, gr = Q.onKeyDown, Fr = Q.onFocus, Tr = Q.onBlur, Yr = Q.onClick, jr = Q.onDragEnter, Ur = Q.onDragOver, Wr = Q.onDragLeave, Jr = Q.onDrop, xr = Pt(Q, pu);
      return rr(rr(mo({
        onKeyDown: Ar(kr(gr, rn)),
        onFocus: Ar(kr(Fr, Gn)),
        onBlur: Ar(kr(Tr, jn)),
        onClick: Nr(kr(Yr, wr)),
  ...
  }, [fn, rn, Gn, jn, wr, ar, Or, Br, z, Jn, Wn, y]), pr = D.useCallback(function(Q) {
    Q.stopPropagation();
  }, []), yr = D.useMemo(function() {
    return function() {
      var Q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, In = Q.refKey, er = In === void 0 ? "ref" : In, ir = Q.onChange, gr = Q.onClick, Fr = Pt(Q, gu), Tr = mo({
        accept: c,
        multiple: O,
        type: "file",
        style: {
  ...
  }, [on, c, O, z, y]), vr = br.length, hr = vr > 0 && lu({
    files: br,
    accept: c,
    minSize: C,
    maxSize: P,
...
function Du(t, f) {
  switch (f.type) {
    ...
    case "setDraggedFiles":
      var c = f.isDragActive, y = f.draggedFiles;
      return rr(rr({}, t), {}, {
        draggedFiles: y,
        isDragActive: c
      });
...
function Mr(t, f) {
  var c = t + "", y = c.length;
  return y < f ? new Array(f - y + 1).join(0) + c : c;
}
function Nu(t) {
  return t < 0 ? "-" + Mr(-t, 6) : t > 9999 ? "+" + Mr(t, 6) : Mr(t, 4);
}
function Tu(t) {
  var f = t.getUTCHours(), c = t.getUTCMinutes(), y = t.getUTCSeconds(), b = t.getUTCMilliseconds();
  return isNaN(t) ? "Invalid Date" : Nu(t.getUTCFullYear()) + "-" + Mr(t.getUTCMonth() + 1, 2) + "-" + Mr(t.getUTCDate(), 2) + (b ? "T" + Mr(f, 2) + ":" + Mr(c, 2) + ":" + Mr(y, 2) + "." + Mr(b, 3) + "Z" : y ? "T" + Mr(f, 2) + ":" + Mr(c, 2) + ":" + Mr(y, 2) + "Z" : c || f ? "T" + Mr(f, 2) + ":" + Mr(c, 2) + "Z" : "");
}
function Pu(t) {
  var f = new RegExp('["' + t + `
\r]`), c = t.charCodeAt(0);
  function y(w, un) {
    var Nn, Cn, dn = b(w, function(Vn, vn) {
      if (Nn)
        return Nn(Vn, vn - 1);
      Cn = Vn, Nn = un ? Ru(Vn, un) : la(Vn);
    });
    return dn.columns = Cn || [], dn;
  }
  function b(w, un) {
    var Nn = [], Cn = w.length, dn = 0, Vn = 0, vn, Hn = Cn <= 0, bn = !1;
    w.charCodeAt(Cn - 1) === Ie && --Cn, w.charCodeAt(Cn - 1) === fo && --Cn;
    function Jn() {
      if (Hn)
        return yo;
      if (bn)
        return bn = !1, zo;
      var An, or = dn, zn;
      if (w.charCodeAt(or) === Co) {
        for (; dn++ < Cn && w.charCodeAt(dn) !== Co || w.charCodeAt(++dn) === Co; )
          ;
        return (An = dn) >= Cn ? Hn = !0 : (zn = w.charCodeAt(dn++)) === Ie ? bn = !0 : zn === fo && (bn = !0, w.charCodeAt(dn) === Ie && ++dn), w.slice(or + 1, An - 1).replace(/""/g, '"');
      }
      for (; dn < Cn; ) {
        if ((zn = w.charCodeAt(An = dn++)) === Ie)
          bn = !0;
        else if (zn === fo)
          bn = !0, w.charCodeAt(dn) === Ie && ++dn;
        else if (zn !== c)
          continue;
        return w.slice(or, An);
      }
      return Hn = !0, w.slice(or, Cn);
    }
    for (; (vn = Jn()) !== yo; ) {
      for (var Wn = []; vn !== zo && vn !== yo; )
        Wn.push(vn), vn = Jn();
      un && (Wn = un(Wn, Vn++)) == null || Nn.push(Wn);
    }
    return Nn;
  }
  function P(w, un) {
  ...
  function C(w, un) {
    return un == null && (un = _o(w)), [un.map(En).join(t)].concat(P(w, un)).join(`
`);
  }
  function O(w, un) {
    return un == null && (un = _o(w)), P(w, un).join(`
`);
  }
  function Rn(w) {
    return w.map(M).join(`
...
const Le = ({ children: t, className: f = "" }) => /* @__PURE__ */ l.createElement("div", { className: `tab-content ${f}` }, t), Lu = (t) => {
  const { globalActive: f } = D.useContext(ce), c = D.useContext(ke), y = (b) => {
    c({ type: "EDITOR_SET_GLOBALACTIVE", payload: b });
  };
  return /* @__PURE__ */ l.createElement(sa, { ...t, setActiveTab: y, activeTab: f });
}, ku = ({ children: t, className: f = void 0, startingTab: c }) => {
  const [y, b] = D.useState(c);
  return /* @__PURE__ */ l.createElement(sa, { className: f, setActiveTab: b, activeTab: y }, t);
}, sa = ({ children: t, className: f, activeTab: c, setActiveTab: y }) => {
  const b = (O, Rn) => {
    O || y(Rn);
  };
  let P = "tabs";
  f && (P = `tabs ${f}`);
  const C = t.map(({ props: O }, Rn) => {
    let M = "nav-item", En = O.disableRule || !1;
    return En && (M += " disabled"), Rn === c && (M += " active"), /* @__PURE__ */ l.createElement("li", { onClick: () => b(En, Rn), key: O.title, className: M }, O.icon, O.title);
  });
  return /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("nav", { className: P }, /* @__PURE__ */ l.createElement("ul", { className: "nav nav-fill" }, C)), t[c]);
};
var So = { exports: {} }, bt = { exports: {} }, Xo;
function Ou() {
    ...
    (function(c, y) {
      ...
      function Nn() {
        ...
        return a.reduce(function(s, v) {
          ...
          return s = C({}, s, {}, O(v, ["style", "className"])), g && (s.style = s.style ? C({}, s.style || {}, {}, g || {}) : g), h && (s.className = s.className ? s.className + " " + h : h), s.className === "" && delete s.className, s;
        }, {});
      }
      var Cn = function(n, a) {
        return a === void 0 && (a = {}), function(i) {
          return i === void 0 && (i = {}), [].concat(n, [i]).reduce(function(s, v) {
            return function g(h, R, T) {
              return typeof R == "function" ? g({}, R(h, T)) : Array.isArray(R) ? Nn.apply(void 0, [h].concat(R)) : Nn(h, R);
            }(s, v, C({}, a, { userProps: i }));
          }, {});
        };
      }, dn = function(n, a, i, s) {
      ...
      function zn(n, a, i) {
        return i === void 0 && (i = 0), n.map(function(s) {
          return fn(s = C({}, s, { parent: a, depth: i })), s.columns && (s.columns = zn(s.columns, s, i + 1)), s;
        });
      }
      function dr(n) {
        return Pr(n, "columns");
      ...
      function on(n, a) {
        if (!a)
          throw new Error();
        return Object.assign(n, C({ Header: w, Footer: w }, un, {}, a, {}, n)), Object.assign(n, { originalWidth: n.width }), n;
      }
      function _n(n, a, i) {
        i === void 0 && (i = function() {
          return {};
        ...
        for (var s = [], v = n, g = 0, h = function() {
          ...
          v.forEach(function(W) {
            var x, L = [].concat(E).reverse()[0];
            V && (W.parent ? x = C({}, W.parent, { originalId: W.parent.id, id: W.parent.id + "_" + h(), headers: [W] }, i(W)) : x = on(C({ originalId: W.id + "_placeholder", id: W.id + "_placeholder_" + h(), placeholderOf: W, headers: [W] }, i(W)), a), L && L.originalId === x.originalId ? L.headers.push(W) : E.push(x)), T.headers.push(W);
          }), s.push(T), v = E;
        }; v.length; )
          R();
        return s.reverse();
      ...
      function _r(n, a, i, s) {
        ...
        if (a.type === M.resetHiddenColumns)
          return C({}, n, { hiddenColumns: s.initialState.hiddenColumns || [] });
        if (a.type === M.toggleHideColumn) {
          ...
          return C({}, n, { hiddenColumns: v });
        }
        return a.type === M.setHiddenColumns ? C({}, n, { hiddenColumns: Hn(a.value, n.hiddenColumns) }) : a.type === M.toggleHideAllColumns ? C({}, n, { hiddenColumns: (a.value !== void 0 ? a.value : !n.hiddenColumns.length) ? s.allColumns.map(function(g) {
          return g.id;
        }) : [] }) : void 0;
      }
      function pr(n) {
      ...
      function yr(n) {
        var a = n.columns, i = n.flatHeaders, s = n.dispatch, v = n.allColumns, g = n.getHooks, h = n.state.hiddenColumns, R = n.autoResetHiddenColumns, T = R === void 0 || R, E = bn(n), V = v.length === h.length, W = y.useCallback(function(U, ln) {
          return s({ type: M.toggleHideColumn, columnId: U, value: ln });
        }, [s]), x = y.useCallback(function(U) {
          return s({ type: M.setHiddenColumns, value: U });
        }, [s]), L = y.useCallback(function(U) {
          return s({ type: M.toggleHideAllColumns, value: U });
        }, [s]), H = Cn(g().getToggleHideAllColumnsProps, { instance: E() });
        i.forEach(function(U) {
          U.toggleHidden = function(ln) {
            s({ type: M.toggleHideColumn, columnId: U.id, value: ln });
          }, U.getToggleHiddenProps = Cn(g().getToggleHiddenProps, { instance: E(), column: U });
        });
        var X = bn(T);
        Wn(function() {
          X() && s({ type: M.resetHiddenColumns });
        }, [s, a]), Object.assign(n, { allColumnsHidden: V, toggleHideColumn: W, setHiddenColumns: x, toggleHideAllColumns: L, getToggleHideAllColumnsProps: H });
      }
      ...
      function ir(n) {
        ...
        return C({}, O(n, ["initialState", "defaultColumn", "getSubRows", "getRowId", "stateReducer", "useControlledState"]), { initialState: i, defaultColumn: v, getSubRows: h, getRowId: T, stateReducer: V, useControlledState: x });
      }
      function gr(n, a) {
        a === void 0 && (a = 0);
        var i = 0, s = 0, v = 0, g = 0;
      ...
      function Fr(n) {
        ...
        a.forEach(function(V, W) {
          return function x(L, H, X, U, ln) {
            X === void 0 && (X = 0);
            var Ln = L, sn = h(L, H, U), K = v[sn];
            if (K)
              K.subRows && K.originalSubRows.forEach(function(nn, wn) {
                return x(nn, wn, X + 1, K);
              });
            else if ((K = { id: sn, original: Ln, index: H, depth: X, cells: [{}] }).cells.map = fr, K.cells.filter = fr, K.cells.forEach = fr, K.cells[0].getCellProps = fr, K.values = {}, ln.push(K), s.push(K), v[sn] = K, K.originalSubRows = R(L, H), K.originalSubRows) {
              var Tn = [];
              K.originalSubRows.forEach(function(nn, wn) {
                return x(nn, wn, X + 1, K, Tn);
              }), K.subRows = Tn;
            }
            g.accessor && (K.values[g.id] = g.accessor(L, H, K, ln, a)), K.values[g.id] = dn(T, K.values[g.id], { row: K, column: g, instance: E() });
          }(V, W, 0, void 0, i);
        });
      }
      ...
      function Ur(n, a, i, s) {
        if (a.type === M.init)
          return C({ expanded: {} }, n);
        if (a.type === M.resetExpanded)
          return C({}, n, { expanded: s.initialState.expanded || {} });
        if (a.type === M.toggleAllRowsExpanded) {
        ...
        if (a.type === M.toggleRowExpanded) {
          var T, E = a.id, V = a.value, W = n.expanded[E], x = V !== void 0 ? V : !W;
          if (!W && x)
            return C({}, n, { expanded: C({}, n.expanded, (T = {}, T[E] = !0, T)) });
          if (W && !x) {
            var L = n.expanded;
            return L[E], C({}, n, { expanded: O(L, [E].map(Rn)) });
          }
          return n;
        }
      }
      function Wr(n) {
        var a = n.data, i = n.rows, s = n.rowsById, v = n.manualExpandedKey, g = v === void 0 ? "expanded" : v, h = n.paginateExpandedRows, R = h === void 0 || h, T = n.expandSubRows, E = T === void 0 || T, V = n.autoResetExpanded, W = V === void 0 || V, x = n.getHooks, L = n.plugins, H = n.state.expanded, X = n.dispatch;
        vn(L, ["useSortBy", "useGroupBy", "usePivotColumns", "useGlobalFilter"], "useExpanded");
        var U = bn(W), ln = !!(Object.keys(s).length && Object.keys(H).length);
        ln && Object.keys(s).some(function(xn) {
          return !H[xn];
        }) && (ln = !1), Wn(function() {
          U() && X({ type: M.resetExpanded });
        }, [X, a]);
        var Ln = y.useCallback(function(xn, pn) {
          X({ type: M.toggleRowExpanded, id: xn, value: pn });
        }, [X]), sn = y.useCallback(function(xn) {
          return X({ type: M.toggleAllRowsExpanded, value: xn });
        }, [X]), K = y.useMemo(function() {
          return R ? Rr(i, { manualExpandedKey: g, expanded: H, expandSubRows: E }) : i;
        }, [R, i, g, H, E]), Tn = y.useMemo(function() {
          return function(xn) {
            var pn = 0;
        ...
        }, [H]), nn = bn(n), wn = Cn(x().getToggleAllRowsExpandedProps, { instance: nn() });
        Object.assign(n, { preExpandedRows: i, expandedRows: K, rows: K, expandedDepth: Tn, isAllRowsExpanded: ln, toggleRowExpanded: Ln, toggleAllRowsExpanded: sn, getToggleAllRowsExpandedProps: wn });
      }
      function Jr(n, a) {
      ...
      var xe = function(n) {
        n.stateReducers.push(It), n.useInstance.push(Ge);
      };
      function It(n, a, i, s) {
        if (a.type === M.init)
          return C({ filters: [] }, n);
        if (a.type === M.resetFilters)
          return C({}, n, { filters: s.initialState.filters || [] });
        if (a.type === M.setFilter) {
          ...
          return Er(E.autoRemove, W, T) ? C({}, n, { filters: n.filters.filter(function(X) {
            return X.id !== v;
          }) }) : C({}, n, V ? { filters: n.filters.map(function(X) {
            return X.id === v ? { id: v, value: W } : X;
          }) } : { filters: [].concat(n.filters, [{ id: v, value: W }]) });
        }
        if (a.type === M.setAllFilters) {
          var x = a.filters, L = s.allColumns, H = s.filterTypes;
          return C({}, n, { filters: Hn(x, n.filters).filter(function(X) {
            var U = L.find(function(ln) {
              return ln.id === X.id;
            });
      ...
      function Ge(n) {
        var a = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.filterTypes, R = n.manualFilters, T = n.defaultCanFilter, E = T !== void 0 && T, V = n.disableFilters, W = n.state.filters, x = n.dispatch, L = n.autoResetFilters, H = L === void 0 || L, X = y.useCallback(function(nn, wn) {
          x({ type: M.setFilter, columnId: nn, filterValue: wn });
        }, [x]), U = y.useCallback(function(nn) {
          x({ type: M.setAllFilters, filters: nn });
        }, [x]);
        g.forEach(function(nn) {
          var wn = nn.id, xn = nn.accessor, pn = nn.defaultCanFilter, hn = nn.disableFilters;
          nn.canFilter = xn ? Yn(hn !== !0 && void 0, V !== !0 && void 0, !0) : Yn(pn, E, !1), nn.setFilter = function(Dn) {
            return X(nn.id, Dn);
          };
        ...
        var ln = y.useMemo(function() {
          if (R || !W.length)
            return [i, s, v];
          var nn = [], wn = {};
          return [function xn(pn, hn) {
            hn === void 0 && (hn = 0);
            var qn = pn;
            return (qn = W.reduce(function(Dn, Kn) {
              var r = Kn.id, e = Kn.value, u = g.find(function(p) {
                return p.id === r;
              });
              if (!u)
                return Dn;
              ...
              return o ? (u.filteredRows = o(Dn, [r], e), u.filteredRows) : (console.warn("Could not find a valid 'column.filter' for column with the ID: " + u.id + "."), Dn);
            }, pn)).forEach(function(Dn) {
              nn.push(Dn), wn[Dn.id] = Dn, Dn.subRows && (Dn.subRows = Dn.subRows && Dn.subRows.length > 0 ? xn(Dn.subRows, hn + 1) : Dn.subRows);
            }), qn;
          }(i), nn, wn];
        }, [R, W, i, s, v, g, h]), Ln = ln[0], sn = ln[1], K = ln[2];
        y.useMemo(function() {
          g.filter(function(nn) {
            ...
            nn.preFilteredRows = Ln, nn.filteredRows = Ln;
          });
        }, [Ln, W, g]);
        var Tn = bn(H);
        Wn(function() {
          Tn() && x({ type: M.resetFilters });
        }, [x, R ? null : a]), Object.assign(n, { preFilteredRows: i, preFilteredFlatRows: s, preFilteredRowsById: v, filteredRows: Ln, filteredFlatRows: sn, filteredRowsById: K, rows: Ln, flatRows: sn, rowsById: K, setFilter: X, setAllFilters: U });
      }
      xe.pluginName = "useFilters", M.resetGlobalFilter = "resetGlobalFilter", M.setGlobalFilter = "setGlobalFilter";
      var pe = function(n) {
        n.stateReducers.push(Ve), n.useInstance.push(Ke);
      };
      function Ve(n, a, i, s) {
        if (a.type === M.resetGlobalFilter)
          return C({}, n, { globalFilter: s.initialState.globalFilter || void 0 });
        if (a.type === M.setGlobalFilter) {
          var v = a.filterValue, g = s.userFilterTypes, h = br(s.globalFilter, g || {}, $r), R = Hn(v, n.globalFilter);
          return Er(h.autoRemove, R) ? (n.globalFilter, O(n, ["globalFilter"])) : C({}, n, { globalFilter: R });
        }
      }
      function Ke(n) {
        var a = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.filterTypes, R = n.globalFilter, T = n.manualGlobalFilter, E = n.state.globalFilter, V = n.dispatch, W = n.autoResetGlobalFilter, x = W === void 0 || W, L = n.disableGlobalFilter, H = y.useCallback(function(K) {
          V({ type: M.setGlobalFilter, filterValue: K });
        }, [V]), X = y.useMemo(function() {
          if (T || E === void 0)
            return [i, s, v];
          var K = [], Tn = {}, nn = br(R, h || {}, $r);
          if (!nn)
            return console.warn("Could not find a valid 'globalFilter' option."), i;
          g.forEach(function(xn) {
            var pn = xn.disableGlobalFilter;
            xn.canFilter = Yn(pn !== !0 && void 0, L !== !0 && void 0, !0);
          });
          var wn = g.filter(function(xn) {
            return xn.canFilter === !0;
          });
          return [function xn(pn) {
            return (pn = nn(pn, wn.map(function(hn) {
              return hn.id;
            }), E)).forEach(function(hn) {
              K.push(hn), Tn[hn.id] = hn, hn.subRows = hn.subRows && hn.subRows.length ? xn(hn.subRows) : hn.subRows;
            }), pn;
          }(i), K, Tn];
        }, [T, E, R, h, g, i, s, v, L]), U = X[0], ln = X[1], Ln = X[2], sn = bn(x);
        Wn(function() {
          sn() && V({ type: M.resetGlobalFilter });
        }, [V, T ? null : a]), Object.assign(n, { preGlobalFilteredRows: i, preGlobalFilteredFlatRows: s, preGlobalFilteredRowsById: v, globalFilteredRows: U, globalFilteredFlatRows: ln, globalFilteredRowsById: Ln, rows: U, flatRows: ln, rowsById: Ln, setGlobalFilter: H, disableGlobalFilter: L });
      }
      function ge(n, a) {
      ...
      var ve = function(n) {
        ...
        }), n.visibleColumns.push(Xe), n.useInstance.push(kt), n.prepareRow.push(Ye);
      };
      ...
      function Zr(n, a, i, s) {
        if (a.type === M.init)
          return C({ groupBy: [] }, n);
        if (a.type === M.resetGroupBy)
          return C({}, n, { groupBy: s.initialState.groupBy || [] });
        if (a.type === M.setGroupBy)
          return C({}, n, { groupBy: a.value });
        if (a.type === M.toggleGroupBy) {
          var v = a.columnId, g = a.value, h = g !== void 0 ? g : !n.groupBy.includes(v);
          return C({}, n, h ? { groupBy: [].concat(n.groupBy, [v]) } : { groupBy: n.groupBy.filter(function(R) {
            return R !== v;
          }) });
        }
      }
      ...
      var Lt = {};
      function kt(n) {
        var a = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.flatHeaders, R = n.groupByFn, T = R === void 0 ? je : R, E = n.manualGroupBy, V = n.aggregations, W = V === void 0 ? Lt : V, x = n.plugins, L = n.state.groupBy, H = n.dispatch, X = n.autoResetGroupBy, U = X === void 0 || X, ln = n.disableGroupBy, Ln = n.defaultCanGroupBy, sn = n.getHooks;
        vn(x, ["useColumnOrder", "useFilters"], "useGroupBy");
        var K = bn(n);
        g.forEach(function(u) {
          var o = u.accessor, p = u.defaultGroupBy, m = u.disableGroupBy;
          u.canGroupBy = o ? Yn(u.canGroupBy, m !== !0 && void 0, ln !== !0 && void 0, !0) : Yn(u.canGroupBy, p, Ln, !1), u.canGroupBy && (u.toggleGroupBy = function() {
            return n.toggleGroupBy(u.id);
          }), u.Aggregated = u.Aggregated || u.Cell;
        });
        var Tn = y.useCallback(function(u, o) {
          H({ type: M.toggleGroupBy, columnId: u, value: o });
        }, [H]), nn = y.useCallback(function(u) {
        ...
        var wn = y.useMemo(function() {
          ...
          }), o = [], p = {}, m = [], d = {}, S = [], A = {}, N = function I(q, B, G) {
            if (B === void 0 && (B = 0), B === u.length)
              return q.map(function(Z) {
                return C({}, Z, { depth: B });
              });
            var _ = u[B], k = T(q, _);
            return Object.entries(k).map(function(Z, yn) {
              var mn = Z[0], j = Z[1], Pn = _ + ":" + mn, Fn = I(j, B + 1, Pn = G ? G + ">" + Pn : Pn), J = B ? Pr(j, "leafRows") : j, Y = function(cn, kn, On) {
                var Xn = {};
                return g.forEach(function(en) {
                  if (u.includes(en.id))
                    Xn[en.id] = kn[0] ? kn[0].values[en.id] : null;
                  else {
                    var lr = typeof en.aggregate == "function" ? en.aggregate : W[en.aggregate] || me[en.aggregate];
                    if (lr) {
                      var Bn = kn.map(function(Mn) {
                        return Mn.values[en.id];
                      }), Sn = cn.map(function(Mn) {
                        var Un = Mn.values[en.id];
                        if (!On && en.aggregateValue) {
                          var cr = typeof en.aggregateValue == "function" ? en.aggregateValue : W[en.aggregateValue] || me[en.aggregateValue];
                          if (!cr)
                            throw console.info({ column: en }), new Error("React Table: Invalid column.aggregateValue option for column listed above");
                          Un = cr(Un, Mn, en);
                        }
                        return Un;
                      });
                      ...
                      if (en.aggregate)
                        throw console.info({ column: en }), new Error("React Table: Invalid column.aggregate option for column listed above");
                      Xn[en.id] = null;
                    }
                  }
                }), Xn;
              }(J, j, B), $ = { id: Pn, isGrouped: !0, groupByID: _, groupByVal: mn, values: Y, subRows: Fn, leafRows: J, depth: B, index: yn };
              return Fn.forEach(function(cn) {
                o.push(cn), p[cn.id] = cn, cn.isGrouped ? (m.push(cn), d[cn.id] = cn) : (S.push(cn), A[cn.id] = cn);
              }), $;
            });
          }(i);
          return N.forEach(function(I) {
            o.push(I), p[I.id] = I, I.isGrouped ? (m.push(I), d[I.id] = I) : (S.push(I), A[I.id] = I);
          }), [N, o, p, m, d, S, A];
        }, [E, L, i, s, v, g, W, T]), xn = wn[0], pn = wn[1], hn = wn[2], qn = wn[3], Dn = wn[4], Kn = wn[5], r = wn[6], e = bn(U);
        Wn(function() {
          e() && H({ type: M.resetGroupBy });
        }, [H, E ? null : a]), Object.assign(n, { preGroupedRows: i, preGroupedFlatRow: s, preGroupedRowsById: v, groupedRows: xn, groupedFlatRows: pn, groupedRowsById: hn, onlyGroupedFlatRows: qn, onlyGroupedRowsById: Dn, nonGroupedFlatRows: Kn, nonGroupedRowsById: r, rows: xn, flatRows: pn, rowsById: hn, toggleGroupBy: Tn, setGroupBy: nn });
      }
      function Ye(n) {
      ...
      function Ft(n, a, i, s) {
        if (a.type === M.init)
          return C({ sortBy: [] }, n);
        if (a.type === M.resetSortBy)
          return C({}, n, { sortBy: s.initialState.sortBy || [] });
        if (a.type === M.clearSortBy)
          return C({}, n, { sortBy: n.sortBy.filter(function(K) {
            return K.id !== a.columnId;
          }) });
        if (a.type === M.setSortBy)
          return C({}, n, { sortBy: a.sortBy });
        if (a.type === M.toggleSortBy) {
          var v, g = a.columnId, h = a.desc, R = a.multi, T = s.allColumns, E = s.disableMultiSort, V = s.disableSortRemove, W = s.disableMultiRemove, x = s.maxMultiSortColCount, L = x === void 0 ? Number.MAX_SAFE_INTEGER : x, H = n.sortBy, X = T.find(function(K) {
            return K.id === g;
          ...
          return (v = !E && R ? U ? "toggle" : "add" : ln !== H.length - 1 || H.length !== 1 ? "replace" : U ? "toggle" : "replace") != "toggle" || V || Ln || R && W || !(U && U.desc && !X || !U.desc && X) || (v = "remove"), v === "replace" ? sn = [{ id: g, desc: Ln ? h : X }] : v === "add" ? (sn = [].concat(H, [{ id: g, desc: Ln ? h : X }])).splice(0, sn.length - L) : v === "toggle" ? sn = H.map(function(K) {
            return K.id === g ? C({}, K, { desc: Ln ? h : !U.desc }) : K;
      ...
      function Ht(n) {
        var a = n.data, i = n.rows, s = n.flatRows, v = n.allColumns, g = n.orderByFn, h = g === void 0 ? Ze : g, R = n.sortTypes, T = n.manualSortBy, E = n.defaultCanSort, V = n.disableSortBy, W = n.flatHeaders, x = n.state.sortBy, L = n.dispatch, H = n.plugins, X = n.getHooks, U = n.autoResetSortBy, ln = U === void 0 || U;
        vn(H, ["useFilters", "useGlobalFilter", "useGroupBy", "usePivotColumns"], "useSortBy");
        var Ln = y.useCallback(function(pn) {
          L({ type: M.setSortBy, sortBy: pn });
        }, [L]), sn = y.useCallback(function(pn, hn, qn) {
          L({ type: M.toggleSortBy, columnId: pn, desc: hn, multi: qn });
        }, [L]), K = bn(n);
        W.forEach(function(pn) {
          var hn = pn.accessor, qn = pn.canSort, Dn = pn.disableSortBy, Kn = pn.id, r = hn ? Yn(Dn !== !0 && void 0, V !== !0 && void 0, !0) : Yn(E, qn, !1);
          pn.canSort = r, pn.canSort && (pn.toggleSortBy = function(u, o) {
            return sn(pn.id, u, o);
          }, pn.clearSortBy = function() {
            L({ type: M.clearSortBy, columnId: pn.id });
          }), pn.getSortByToggleProps = Cn(X().getSortByToggleProps, { instance: K(), column: pn });
          var e = x.find(function(u) {
            return u.id === Kn;
          });
          pn.isSorted = !!e, pn.sortedIndex = x.findIndex(function(u) {
            return u.id === Kn;
          }), pn.isSortedDesc = pn.isSorted ? e.desc : void 0;
        });
        var Tn = y.useMemo(function() {
          if (T || !x.length)
            return [i, s];
          var pn = [], hn = x.filter(function(qn) {
            return v.find(function(Dn) {
              return Dn.id === qn.id;
            });
          });
          return [function qn(Dn) {
            var Kn = h(Dn, hn.map(function(r) {
              var e = v.find(function(p) {
                return p.id === r.id;
              });
              if (!e)
                throw new Error("React-Table: Could not find a column with id: " + r.id + " while sorting");
              var u = e.sortType, o = nr(u) || (R || {})[u] || Ot[u];
              if (!o)
            ...
            return Kn.forEach(function(r) {
              pn.push(r), r.subRows && r.subRows.length !== 0 && (r.subRows = qn(r.subRows));
            }), Kn;
          }(i), pn];
        }, [T, x, i, s, v, h, R]), nn = Tn[0], wn = Tn[1], xn = bn(ln);
        Wn(function() {
          xn() && L({ type: M.resetSortBy });
        }, [T ? null : a]), Object.assign(n, { preSortedRows: i, preSortedFlatRows: s, sortedRows: nn, sortedFlatRows: wn, rows: nn, flatRows: wn, setSortBy: Ln, toggleSortBy: sn });
      }
      function Ze(n, a, i) {
      ...
      function Wt(n, a, i, s) {
        ...
        if (a.type === M.resetPage)
          return C({}, n, { pageIndex: s.initialState.pageIndex || 0 });
        if (a.type === M.gotoPage) {
          var v = s.pageCount, g = s.page, h = Hn(a.pageIndex, n.pageIndex), R = !1;
          return h > n.pageIndex ? R = v === -1 ? g.length >= n.pageSize : h < v : h < n.pageIndex && (R = h > -1), R ? C({}, n, { pageIndex: h }) : n;
        }
        if (a.type === M.setPageSize) {
          var T = a.pageSize, E = n.pageSize * n.pageIndex;
          return C({}, n, { pageIndex: Math.floor(E / T), pageSize: T });
        }
      }
      function xt(n) {
        var a = n.rows, i = n.autoResetPage, s = i === void 0 || i, v = n.manualExpandedKey, g = v === void 0 ? "expanded" : v, h = n.plugins, R = n.pageCount, T = n.paginateExpandedRows, E = T === void 0 || T, V = n.expandSubRows, W = V === void 0 || V, x = n.state, L = x.pageSize, H = x.pageIndex, X = x.expanded, U = x.globalFilter, ln = x.filters, Ln = x.groupBy, sn = x.sortBy, K = n.dispatch, Tn = n.data, nn = n.manualPagination;
        vn(h, ["useGlobalFilter", "useFilters", "useGroupBy", "useSortBy", "useExpanded"], "usePagination");
        var wn = bn(s);
        Wn(function() {
          wn() && K({ type: M.resetPage });
        }, [K, nn ? null : Tn, U, ln, Ln, sn]);
        var xn = nn ? R : Math.ceil(a.length / L), pn = y.useMemo(function() {
          return xn > 0 ? [].concat(new Array(xn)).fill(null).map(function(o, p) {
            return p;
          }) : [];
        }, [xn]), hn = y.useMemo(function() {
          var o;
          if (nn)
            o = a;
          else {
        ...
        }, [W, X, g, nn, H, L, E, a]), qn = H > 0, Dn = xn === -1 ? hn.length >= L : H < xn - 1, Kn = y.useCallback(function(o) {
          K({ type: M.gotoPage, pageIndex: o });
        }, [K]), r = y.useCallback(function() {
          return Kn(function(o) {
            return o - 1;
          });
        }, [Kn]), e = y.useCallback(function() {
          return Kn(function(o) {
            return o + 1;
          });
        }, [Kn]), u = y.useCallback(function(o) {
          K({ type: M.setPageSize, pageSize: o });
        }, [K]);
        Object.assign(n, { pageOptions: pn, pageCount: xn, page: hn, canPreviousPage: qn, canNextPage: Dn, gotoPage: Kn, previousPage: r, nextPage: e, setPageSize: u });
      }
      he.pluginName = "usePagination", M.resetPivot = "resetPivot", M.togglePivot = "togglePivot";
      var Se = function(n) {
      ...
      function Vt(n, a, i, s) {
        if (a.type === M.init)
          return C({ pivotColumns: Qe }, n);
        if (a.type === M.resetPivot)
          return C({}, n, { pivotColumns: s.initialState.pivotColumns || Qe });
        if (a.type === M.togglePivot) {
          var v = a.columnId, g = a.value, h = g !== void 0 ? g : !n.pivotColumns.includes(v);
          return C({}, n, h ? { pivotColumns: [].concat(n.pivotColumns, [v]) } : { pivotColumns: n.pivotColumns.filter(function(R) {
            return R !== v;
          }) });
        }
      }
      ...
      function nt(n, a) {
        ...
        var g = v.pivotColumns.map(function(T) {
          ...
          return x ? Array.from(x.uniqueValues).sort().map(function(L) {
            var H = C({}, x, { Header: x.PivotHeader || typeof x.header == "string" ? x.Header + ": " + L : L, isPivotGroup: !0, parent: V, depth: E, id: V ? V.id + "." + x.id + "." + L : x.id + "." + L, pivotValue: L });
            return H.columns = T(E + 1, H, [].concat(W, [function(X) {
              return X.values[x.id] === L;
            }])), H;
          }) : h.map(function(L) {
            return C({}, L, { canPivot: !1, isPivoted: !0, parent: V, depth: E, id: "" + (V ? V.id + "." + L.id : L.id), accessor: function(H, X, U) {
      ...
      function Yt(n) {
        ...
        i.forEach(function(H) {
          ...
          H.canPivot = X ? Yn(H.canPivot, ln !== !0 && void 0, V !== !0 && void 0, !0) : Yn(H.canPivot, U, W, !1), H.canPivot && (H.togglePivot = function() {
      ...
      function Ut(n, a, i, s) {
        ...
        if (a.type === M.resetSelectedRows)
          return C({}, n, { selectedRowIds: s.initialState.selectedRowIds || {} });
        if (a.type === M.toggleAllRowsSelected) {
        ...
        if (a.type === M.toggleRowSelected) {
          var W = a.id, x = a.value, L = s.rowsById, H = s.selectSubRows, X = H === void 0 || H, U = s.getSubRows, ln = n.selectedRowIds[W], Ln = x !== void 0 ? x : !ln;
          if (ln === Ln)
            return n;
          ...
          }(W), C({}, n, { selectedRowIds: sn });
        }
        if (a.type === M.toggleAllPageRowsSelected) {
          var K = a.value, Tn = s.page, nn = s.rowsById, wn = s.selectSubRows, xn = wn === void 0 || wn, pn = s.isAllPageRowsSelected, hn = s.getSubRows, qn = K !== void 0 ? K : !pn, Dn = C({}, n.selectedRowIds);
          return Tn.forEach(function(Kn) {
            return function r(e) {
              var u = nn[e];
              if (u.isGrouped || (qn ? Dn[e] = !0 : delete Dn[e]), xn && hn(u))
                return hn(u).forEach(function(o) {
                  return r(o.id);
                });
            }(Kn.id);
      ...
      function ot(n) {
        var a = n.data, i = n.rows, s = n.getHooks, v = n.plugins, g = n.rowsById, h = n.nonGroupedRowsById, R = h === void 0 ? g : h, T = n.autoResetSelectedRows, E = T === void 0 || T, V = n.state.selectedRowIds, W = n.selectSubRows, x = W === void 0 || W, L = n.dispatch, H = n.page, X = n.getSubRows;
        ...
        ln && Object.keys(R).some(function(hn) {
          return !V[hn];
        }) && (ln = !1), ln || H && H.length && H.some(function(hn) {
          var qn = hn.id;
          return !V[qn];
        }) && (Ln = !1);
        var sn = bn(E);
        Wn(function() {
          sn() && L({ type: M.resetSelectedRows });
        }, [L, a]);
        var K = y.useCallback(function(hn) {
          return L({ type: M.toggleAllRowsSelected, value: hn });
        }, [L]), Tn = y.useCallback(function(hn) {
          return L({ type: M.toggleAllPageRowsSelected, value: hn });
        }, [L]), nn = y.useCallback(function(hn, qn) {
          return L({ type: M.toggleRowSelected, id: hn, value: qn });
        }, [L]), wn = bn(n), xn = Cn(s().getToggleAllRowsSelectedProps, { instance: wn() }), pn = Cn(s().getToggleAllPageRowsSelectedProps, { instance: wn() });
        Object.assign(n, { selectedFlatRows: U, isAllRowsSelected: ln, isAllPageRowsSelected: Ln, toggleRowSelected: nn, toggleAllRowsSelected: K, getToggleAllRowsSelectedProps: xn, getToggleAllPageRowsSelectedProps: pn, toggleAllPageRowsSelected: Tn });
      }
      function Jt(n, a) {
        var i = a.instance;
      ...
      function $t(n, a, i, s) {
        ...
        if (a.type === M.init)
          return C({ rowState: {} }, n);
        if (a.type === M.resetRowState)
          return C({}, n, { rowState: s.initialState.rowState || {} });
        if (a.type === M.setRowState) {
          var E, V = a.rowId, W = a.value, x = n.rowState[V] !== void 0 ? n.rowState[V] : g(T[V]);
          return C({}, n, { rowState: C({}, n.rowState, (E = {}, E[V] = Hn(W, x), E)) });
        }
        if (a.type === M.setCellState) {
          var L, H, X, U, ln, Ln = a.rowId, sn = a.columnId, K = a.value, Tn = n.rowState[Ln] !== void 0 ? n.rowState[Ln] : g(T[Ln]), nn = (Tn == null || (L = Tn.cellState) == null ? void 0 : L[sn]) !== void 0 ? Tn.cellState[sn] : R((H = T[Ln]) == null || (X = H.cells) == null ? void 0 : X.find(function(wn) {
            return wn.column.id === sn;
          }));
          return C({}, n, { rowState: C({}, n.rowState, (ln = {}, ln[Ln] = C({}, Tn, { cellState: C({}, Tn.cellState || {}, (U = {}, U[sn] = Hn(K, nn), U)) }), ln)) });
        }
      }
      function it(n) {
        var a = n.autoResetRowState, i = a === void 0 || a, s = n.data, v = n.dispatch, g = y.useCallback(function(T, E) {
          return v({ type: M.setRowState, rowId: T, value: E });
        }, [v]), h = y.useCallback(function(T, E, V) {
      ...
      Me.pluginName = "useRowState", M.resetColumnOrder = "resetColumnOrder", M.setColumnOrder = "setColumnOrder";
      var lt = function(n) {
      ...
      function st(n, a, i, s) {
        return a.type === M.init ? C({ columnOrder: [] }, n) : a.type === M.resetColumnOrder ? C({}, n, { columnOrder: s.initialState.columnOrder || [] }) : a.type === M.setColumnOrder ? C({}, n, { columnOrder: Hn(a.columnOrder, n.columnOrder) }) : void 0;
      }
      function ct(n, a) {
      ...
      function Qt(n) {
        ...
        n.setColumnOrder = y.useCallback(function(i) {
          return a({ type: M.setColumnOrder, columnOrder: i });
        }, [a]);
      }
      lt.pluginName = "useColumnOrder", un.canResize = !0, M.columnStartResizing = "columnStartResizing", M.columnResizing = "columnResizing", M.columnDoneResizing = "columnDoneResizing", M.resetResize = "resetResize";
      var yt = function(n) {
        ...
        var i = a.instance, s = a.header, v = i.dispatch, g = function(h, R) {
          ...
          var E, V, W = function(sn) {
          ...
          }), x = T ? Math.round(h.touches[0].clientX) : h.clientX, L = function() {
            ...
            V = sn, E || (E = window.requestAnimationFrame(H));
          ...
          document.addEventListener(ln.moveEvent, ln.moveHandler, Ln), document.addEventListener(ln.upEvent, ln.upHandler, Ln), v({ type: M.columnStartResizing, columnId: R.id, columnWidth: R.totalWidth, headerIdWidths: W, clientX: x });
        };
      ...
      function ro(n, a) {
        ...
        if (a.type === M.resetResize)
          return C({}, n, { columnResizing: { columnWidths: {} } });
        if (a.type === M.columnStartResizing) {
          var i = a.clientX, s = a.columnId, v = a.columnWidth, g = a.headerIdWidths;
          return C({}, n, { columnResizing: C({}, n.columnResizing, { startX: i, headerIdWidths: g, columnWidth: v, isResizingColumn: s }) });
        }
        if (a.type === M.columnResizing) {
          ...
          }), C({}, n, { columnResizing: C({}, n.columnResizing, { columnWidths: C({}, n.columnResizing.columnWidths, {}, x) }) });
        }
        return a.type === M.columnDoneResizing ? C({}, n, { columnResizing: C({}, n.columnResizing, { startX: null, isResizingColumn: null }) }) : void 0;
      }
      yt.pluginName = "useResizeColumns";
      var eo = function(n) {
        var a = n.flatHeaders, i = n.disableResizing, s = n.getHooks, v = n.state.columnResizing, g = bn(n);
        a.forEach(function(h) {
          var R = Yn(h.disableResizing !== !0 && void 0, i !== !0 && void 0, !0);
          h.canResize = R, h.width = v.columnWidths[h.id] || h.originalWidth || h.width, h.isResizing = v.isResizingColumn === h.id, R && (h.getResizerProps = Cn(s().getResizerProps, { instance: g(), header: h }));
        });
      };
      function to(n) {
        var a = n.plugins, i = n.dispatch, s = n.autoResetResize, v = s === void 0 || s, g = n.columns;
        vn(a, ["useAbsoluteLayout"], "useResizeColumns");
        var h = bn(v);
        Wn(function() {
      ...
      var be = { position: "absolute", top: 0 }, Ct = function(n) {
        n.getTableBodyProps.push(ue), n.getRowProps.push(ue), n.getHeaderGroupProps.push(ue), n.getFooterGroupProps.push(ue), n.getHeaderProps.push(function(a, i) {
          var s = i.column;
          return [a, { style: C({}, be, { left: s.totalLeft + "px", width: s.totalWidth + "px" }) }];
        }), n.getCellProps.push(function(a, i) {
          var s = i.cell;
          return [a, { style: C({}, be, { left: s.column.totalLeft + "px", width: s.column.totalWidth + "px" }) }];
      ...
      var ue = function(n, a) {
        ...
        n.getRowProps.push(De), n.getHeaderGroupProps.push(De), n.getFooterGroupProps.push(De), n.getHeaderProps.push(function(a, i) {
          var s = i.column;
          return [a, { style: C({}, Ae, { width: s.totalWidth + "px" }) }];
        }), n.getCellProps.push(function(a, i) {
          var s = i.cell;
          return [a, { style: C({}, Ae, { width: s.column.totalWidth + "px" }) }];
        }), n.getFooterProps.push(function(a, i) {
          var s = i.column;
          return [a, { style: C({}, Ae, { width: s.totalWidth + "px" }) }];
        });
      ...
      M.columnStartResizing = "columnStartResizing", M.columnResizing = "columnResizing", M.columnDoneResizing = "columnDoneResizing", M.resetResize = "resetResize", ft.pluginName = "useGridLayout";
      var pt = function(n, a) {
        var i = a.instance;
        ...
        if (a.type === M.columnStartResizing) {
          ...
          if (h !== void 0) {
            var R = s.visibleColumns.reduce(function(K, Tn) {
              var nn;
              return C({}, K, ((nn = {})[Tn.id] = Te(Tn.id), nn));
            ...
            return C({}, n, { gridLayout: C({}, n.gridLayout, { startWidths: R, minWidths: T, maxWidths: E, headerIdGridWidths: V, columnWidth: h }) });
          }
          return n;
        }
        if (a.type === M.columnResizing) {
          var W = a.clientX, x = n.columnResizing.startX, L = n.gridLayout, H = L.columnWidth, X = L.minWidths, U = L.maxWidths, ln = L.headerIdGridWidths, Ln = (W - x) / H, sn = {};
          return (ln === void 0 ? [] : ln).forEach(function(K) {
            var Tn = K[0], nn = K[1];
            sn[Tn] = Math.min(Math.max(X[Tn], nn + nn * Ln), U[Tn]);
          }), C({}, n, { gridLayout: C({}, n.gridLayout, { columnWidths: C({}, n.gridLayout.columnWidths, {}, sn) }) });
        }
        return a.type === M.columnDoneResizing ? C({}, n, { gridLayout: C({}, n.gridLayout, { startWidths: {}, minWidths: {}, maxWidths: {} }) }) : void 0;
      }
      function Te(n) {
      ...
      c._UNSTABLE_usePivotColumns = Se, c.actions = M, c.defaultColumn = un, c.defaultGroupByFn = je, c.defaultOrderByFn = Ze, c.defaultRenderer = En, c.emptyRenderer = w, c.ensurePluginOrder = vn, c.flexRender = or, c.functionalUpdate = Hn, c.loopHooks = Vn, c.makePropGetter = Cn, c.makeRenderer = An, c.reduceHooks = dn, c.safeUseLayoutEffect = Jn, c.useAbsoluteLayout = Ct, c.useAsyncDebounce = function(n, a) {
        a === void 0 && (a = 0);
        var i = y.useRef({}), s = bn(n), v = bn(a);
                ...
                switch (W.prev = W.next) {
                  case 0:
                    for (R = V.length, T = new Array(R), E = 0; E < R; E++)
                      T[E] = V[E];
                    return i.current.promise || (i.current.promise = new Promise(function(x, L) {
                      i.current.resolve = x, i.current.reject = L;
                      ...
                      return regeneratorRuntime.wrap(function(L) {
                        for (; ; )
                          switch (L.prev = L.next) {
                            case 0:
                              return delete i.current.timeout, L.prev = 1, L.t0 = i.current, L.next = 5, s().apply(void 0, T);
                            case 5:
      ...
      }, c.useBlockLayout = dt, c.useColumnOrder = lt, c.useExpanded = Tr, c.useFilters = xe, c.useFlexLayout = Re, c.useGetLatest = bn, c.useGlobalFilter = pe, c.useGridLayout = ft, c.useGroupBy = ve, c.useMountedLayoutEffect = Wn, c.usePagination = he, c.useResizeColumns = yt, c.useRowSelect = et, c.useRowState = Me, c.useSortBy = $e, c.useTable = function(n) {
        for (var a = arguments.length, i = new Array(a > 1 ? a - 1 : 0), s = 1; s < a; s++)
          i[s - 1] = arguments[s];
        n = ir(n), i = [Ar].concat(i);
        var v = y.useRef({}), g = bn(v.current);
        Object.assign(g(), C({}, n, { plugins: i, hooks: Nr() })), i.filter(Boolean).forEach(function(d) {
          d(g().hooks);
        });
        var h = bn(g().hooks);
        g().getHooks = h, delete g().hooks, Object.assign(g(), dn(h().useOptions, ir(n)));
        var R = g(), T = R.data, E = R.columns, V = R.initialState, W = R.defaultColumn, x = R.getSubRows, L = R.getRowId, H = R.stateReducer, X = R.useControlledState, U = bn(H), ln = y.useCallback(function(d, S) {
          if (!S.type)
        ...
        }, [h, U, g]), Ln = y.useReducer(ln, void 0, function() {
          return ln(V, { type: M.init });
        }), sn = Ln[0], K = Ln[1], Tn = dn([].concat(h().useControlledState, [X]), sn, { instance: g() });
        ...
        g().columns = nn;
        var wn = y.useMemo(function() {
          return dn(h().allColumns, dr(nn), { instance: g() }).map(fn);
        }, [nn, h, g].concat(dn(h().allColumnsDeps, [], { instance: g() })));
        g().allColumns = wn;
        var xn = y.useMemo(function() {
          for (var d = [], S = [], A = {}, N = [].concat(wn); N.length; ) {
            var I = N.shift();
            Fr({ data: T, rows: d, flatRows: S, rowsById: A, column: I, getRowId: L, getSubRows: x, accessValueHooks: h().accessValue, getInstance: g });
          }
          return [d, S, A];
        }, [wn, T, L, x, h, g]), pn = xn[0], hn = xn[1], qn = xn[2];
        Object.assign(g(), { rows: pn, initialRows: [].concat(pn), flatRows: hn, rowsById: qn }), Vn(h().useInstanceAfterData, g());
        var Dn = y.useMemo(function() {
          return dn(h().visibleColumns, wn, { instance: g() }).map(function(d) {
            return on(d, W);
          });
        ...
        g().headers = r, g().flatHeaders = Kn.reduce(function(d, S) {
          return [].concat(d, S.headers);
        }, []), Vn(h().useInstanceBeforeDimensions, g());
        var e = Dn.filter(function(d) {
          return d.isVisible;
        }).map(function(d) {
          return d.id;
        }).sort().join("_");
        Dn = y.useMemo(function() {
          return Dn.filter(function(d) {
            return d.isVisible;
          });
        }, [Dn, e]), g().visibleColumns = Dn;
        var u = gr(r), o = u[0], p = u[1], m = u[2];
        return g().totalColumnsMinWidth = o, g().totalColumnsWidth = p, g().totalColumnsMaxWidth = m, Vn(h().useInstance, g()), [].concat(g().flatHeaders, g().allColumns).forEach(function(d) {
          d.render = An(g(), d), d.getHeaderProps = Cn(h().getHeaderProps, { instance: g(), column: d }), d.getFooterProps = Cn(h().getFooterProps, { instance: g(), column: d });
        }), g().headerGroups = y.useMemo(function() {
          return Kn.filter(function(d, S) {
            return d.headers = d.headers.filter(function(A) {
              return A.headers ? function N(I) {
                return I.filter(function(q) {
                  return q.headers ? N(q.headers) : q.isVisible;
                }).length;
              }(A.headers) : A.isVisible;
            }), !!d.headers.length && (d.getHeaderGroupProps = Cn(h().getHeaderGroupProps, { instance: g(), headerGroup: d, index: S }), d.getFooterGroupProps = Cn(h().getFooterGroupProps, { instance: g(), headerGroup: d, index: S }), !0);
          });
        }, [Kn, g, h]), g().footerGroups = [].concat(g().headerGroups).reverse(), g().prepareRow = y.useCallback(function(d) {
          d.getRowProps = Cn(h().getRowProps, { instance: g(), row: d }), d.allCells = wn.map(function(S) {
            var A = d.values[S.id], N = { column: S, row: d, value: A };
            return N.getCellProps = Cn(h().getCellProps, { instance: g(), cell: N }), N.render = An(g(), S, { row: d, cell: N, value: A }), N;
          }), d.cells = Dn.map(function(S) {
            return d.allCells.find(function(A) {
              return A.column.id === S.id;
            });
          }), Vn(h().prepareRow, d, { instance: g() });
        }, [h, g, wn, Dn]), g().getTableProps = Cn(h().getTableProps, { instance: g() }), g().getTableBodyProps = Cn(h().getTableBodyProps, { instance: g() }), Vn(h().useFinalInstance, g()), g();
...
function Bu() {
  return Yo || (Yo = 1, function(t, f) {
    (function(c, y) {
      ...
      y = y && Object.prototype.hasOwnProperty.call(y, "default") ? y.default : y;
      function b(r, e, u, o, p, m, d) {
        try {
          var S = r[m](d), A = S.value;
        } catch (N) {
          u(N);
          return;
        }
      ...
      function dn() {
        ...
        return e.reduce(function(o, p) {
          var m = p.style, d = p.className, S = O(p, ["style", "className"]);
          return o = C({}, o, {}, S), m && (o.style = o.style ? C({}, o.style || {}, {}, m || {}) : m), d && (o.className = o.className ? o.className + " " + d : d), o.className === "" && delete o.className, o;
        }, {});
      }
      function Vn(r, e, u) {
        return typeof e == "function" ? Vn({}, e(r, u)) : Array.isArray(e) ? dn.apply(void 0, [r].concat(e)) : dn(r, e);
      }
      var vn = function(e, u) {
        ...
        return o === void 0 && (o = {}), e.reduce(function(m, d) {
          var S = d(m, o);
          if (!p && typeof S > "u")
...
`);
                              ...
                              return regeneratorRuntime.wrap(function(k) {
                                for (; ; )
                                  switch (k.prev = k.next) {
                                    case 0:
                                      return delete u.current.timeout, k.prev = 1, k.t0 = u.current, k.next = 5, o().apply(void 0, A);
                                    case 5:
      ...
      function fn(r, e, u) {
        return u === void 0 && (u = {}), function(o, p) {
          ...
          if (typeof m > "u")
            throw console.info(e), new Error(En);
          return on(m, C({}, r, {
            column: e
          }, u, {}, p));
        };
      ...
      function on(r, e) {
        return _n(r) ? y.createElement(r, e) : r;
      }
      function _n(r) {
        return Qn(r) || typeof r == "function" || Yn(r);
      }
      function Qn(r) {
      ...
      function nr(r, e, u) {
        return u === void 0 && (u = 0), r.map(function(o) {
          return o = C({}, o, {
            parent: e,
            depth: u
          }), Rr(o), o.columns && (o.columns = nr(o.columns, o, u + 1)), o;
        });
      }
      function Pr(r) {
        return Br(r, "columns");
      ...
      function F(r, e) {
        var u = e.manualExpandedKey, o = e.expanded, p = e.expandSubRows, m = p === void 0 ? !0 : p, d = [], S = function A(N, I) {
          I === void 0 && (I = !0), N.isExpanded = N.original && N.original[u] || o[N.id], N.canExpand = N.subRows && !!N.subRows.length, I && d.push(N), N.subRows && N.subRows.length && N.isExpanded && N.subRows.forEach(function(q) {
            return A(q, m);
          });
        };
      ...
      function Fr(r, e, u, o) {
        ...
        if (e.type === w.resetHiddenColumns)
          return C({}, r, {
            hiddenColumns: o.initialState.hiddenColumns || []
          });
        if (e.type === w.toggleHideColumn) {
        ...
        if (e.type === w.setHiddenColumns)
          return C({}, r, {
            hiddenColumns: Wn(e.value, r.hiddenColumns)
          });
        if (e.type === w.toggleHideAllColumns) {
          var d = typeof e.value < "u" ? e.value : !r.hiddenColumns.length;
          return C({}, r, {
            hiddenColumns: d ? o.allColumns.map(function(S) {
              return S.id;
            }) : []
          });
        }
      ...
      function Yr(r) {
        var e = r.columns, u = r.flatHeaders, o = r.dispatch, p = r.allColumns, m = r.getHooks, d = r.state.hiddenColumns, S = r.autoResetHiddenColumns, A = S === void 0 ? !0 : S, N = An(r), I = p.length === d.length, q = y.useCallback(function(Z, yn) {
          return o({
            type: w.toggleHideColumn,
            columnId: Z,
            value: yn
          });
        }, [o]), B = y.useCallback(function(Z) {
          return o({
            type: w.setHiddenColumns,
            value: Z
          });
        }, [o]), G = y.useCallback(function(Z) {
          return o({
            type: w.toggleHideAllColumns,
            value: Z
          });
        }, [o]), _ = vn(m().getToggleHideAllColumnsProps, {
          instance: N()
        });
      ...
      function Hr(r) {
        var e = r.initialState, u = e === void 0 ? jr : e, o = r.defaultColumn, p = o === void 0 ? Ur : o, m = r.getSubRows, d = m === void 0 ? Jr : m, S = r.getRowId, A = S === void 0 ? xr : S, N = r.stateReducer, I = N === void 0 ? Wr : N, q = r.useControlledState, B = q === void 0 ? Gr : q, G = O(r, ["initialState", "defaultColumn", "getSubRows", "getRowId", "stateReducer", "useControlledState"]);
        return C({}, G, {
          initialState: u,
          defaultColumn: p,
          getSubRows: d,
      ...
      var oe = function(e) {
        ...
        var m = y.useRef({}), d = An(m.current);
        Object.assign(d(), C({}, e, {
          plugins: o,
          hooks: In()
        })), o.filter(Boolean).forEach(function(gn) {
          gn(d().hooks);
        });
        var S = An(d().hooks);
        d().getHooks = S, delete d().hooks, Object.assign(d(), Hn(S().useOptions, Hr(e)));
        var A = d(), N = A.data, I = A.columns, q = A.initialState, B = A.defaultColumn, G = A.getSubRows, _ = A.getRowId, k = A.stateReducer, Z = A.useControlledState, yn = An(k), mn = y.useCallback(function(gn, $n) {
          if (!$n.type)
            throw console.info({
              action: $n
            }), new Error("Unknown Action 👆");
          return [].concat(S().stateReducers, Array.isArray(yn()) ? yn() : [yn()]).reduce(function(ur, Sr) {
            return Sr(ur, $n, gn, d()) || ur;
          }, gn);
        }, [S, yn, d]), j = y.useReducer(mn, void 0, function() {
          return mn(q, {
            type: w.init
          });
        ...
        var Y = y.useMemo(function() {
          return nr(Hn(S().columns, I, {
            instance: d()
          }));
        }, [S, d, I].concat(Hn(S().columnsDeps, [], {
          instance: d()
        })));
        d().columns = Y;
        ...
        }, [Y, S, d].concat(Hn(S().allColumnsDeps, [], {
          instance: d()
        })));
        d().allColumns = $;
        var cn = y.useMemo(function() {
          for (var gn = [], $n = [], ur = {}, Sr = [].concat($); Sr.length; ) {
            var sr = Sr.shift();
            Be({
              data: N,
              rows: gn,
          ...
          return [gn, $n, ur];
        }, [$, N, _, G, S, d]), kn = cn[0], On = cn[1], Xn = cn[2];
        Object.assign(d(), {
          rows: kn,
          ...
          rowsById: Xn
          // materializedColumns,
        }), bn(S().useInstanceAfterData, d());
        var en = y.useMemo(function() {
          return Hn(S().visibleColumns, $, {
            instance: d()
          }).map(function(gn) {
            return br(gn, B);
          });
        }, [S, $, d, B].concat(Hn(S().visibleColumnsDeps, [], {
          instance: d()
        })));
        $ = y.useMemo(function() {
          var gn = [].concat(en);
        ...
        {
          var lr = $.filter(function(gn, $n) {
            return $.findIndex(function(ur) {
              return ur.id === gn.id;
            }) !== $n;
          });
          if (lr.length)
            throw console.info($), new Error('Duplicate columns were found with ids: "' + lr.map(function(gn) {
              return gn.id;
            }).join(", ") + '" in the columns array above');
        }
        var Bn = y.useMemo(function() {
          return Hn(S().headerGroups, Er(en, B), d());
        }, [S, en, B, d].concat(Hn(S().headerGroupsDeps, [], {
          instance: d()
        })));
        d().headerGroups = Bn;
        ...
        d().headers = Sn, d().flatHeaders = Bn.reduce(function(gn, $n) {
          return [].concat(gn, $n.headers);
        }, []), bn(S().useInstanceBeforeDimensions, d());
        var Mn = en.filter(function(gn) {
          return gn.isVisible;
        }).map(function(gn) {
          return gn.id;
        }).sort().join("_");
        ...
        var Un = de(Sn), cr = Un[0], re = Un[1], Pe = Un[2];
        return d().totalColumnsMinWidth = cr, d().totalColumnsWidth = re, d().totalColumnsMaxWidth = Pe, bn(S().useInstance, d()), [].concat(d().flatHeaders, d().allColumns).forEach(function(gn) {
          gn.render = fn(d(), gn), gn.getHeaderProps = vn(S().getHeaderProps, {
            instance: d(),
            column: gn
        ...
        }), d().headerGroups = y.useMemo(function() {
          return Bn.filter(function(gn, $n) {
            return gn.headers = gn.headers.filter(function(ur) {
        ...
        }, [Bn, d, S]), d().footerGroups = [].concat(d().headerGroups).reverse(), d().prepareRow = y.useCallback(function(gn) {
          gn.getRowProps = vn(S().getRowProps, {
            instance: d(),
            row: gn
          }), gn.allCells = $.map(function($n) {
            var ur = gn.values[$n.id], Sr = {
              column: $n,
              row: gn,
              value: ur
            };
            return Sr.getCellProps = vn(S().getCellProps, {
              instance: d(),
              cell: Sr
            }), Sr.render = fn(d(), $n, {
              row: gn,
          ...
          }), gn.cells = en.map(function($n) {
            return gn.allCells.find(function(ur) {
              return ur.column.id === $n.id;
            });
          }), bn(S().prepareRow, gn, {
            instance: d()
          });
        }, [S, d, $, en]), d().getTableProps = vn(S().getTableProps, {
          instance: d()
        }), d().getTableBodyProps = vn(S().getTableBodyProps, {
          instance: d()
        }), bn(S().useFinalInstance, d()), d();
      };
      function de(r, e) {
        e === void 0 && (e = 0);
        var u = 0, o = 0, p = 0, m = 0;
        return r.forEach(function(d) {
          var S = d.headers;
          if (d.totalLeft = e, S && S.length) {
            var A = de(S, e), N = A[0], I = A[1], q = A[2], B = A[3];
            d.totalMinWidth = N, d.totalWidth = I, d.totalMaxWidth = q, d.totalFlexWidth = B;
          } else
          ...
          d.isVisible && (e += d.totalWidth, u += d.totalMinWidth, o += d.totalWidth, p += d.totalMaxWidth, m += d.totalFlexWidth);
        }), [u, o, p, m];
      }
      function Be(r) {
        var e = r.data, u = r.rows, o = r.flatRows, p = r.rowsById, m = r.column, d = r.getRowId, S = r.getSubRows, A = r.accessValueHooks, N = r.getInstance, I = function q(B, G, _, k, Z) {
          _ === void 0 && (_ = 0);
          var yn = B, mn = d(B, G, k), j = p[mn];
          if (j)
          ...
          }, j.cells.map = rn, j.cells.filter = rn, j.cells.forEach = rn, j.cells[0].getCellProps = rn, j.values = {}, Z.push(j), o.push(j), p[mn] = j, j.originalSubRows = S(B, G), j.originalSubRows) {
            var Pn = [];
      ...
      function We(r, e, u, o) {
        ...
        if (e.type === w.resetExpanded)
          return C({}, r, {
            expanded: o.initialState.expanded || {}
          });
        if (e.type === w.toggleAllRowsExpanded) {
          var p = e.value, m = o.rowsById, d = Object.keys(m).length === Object.keys(r.expanded).length, S = typeof p < "u" ? p : !d;
          if (S) {
            var A = {};
        ...
        if (e.type === w.toggleRowExpanded) {
          var N = e.id, I = e.value, q = r.expanded[N], B = typeof I < "u" ? I : !q;
          if (!q && B) {
            var G;
            return C({}, r, {
              expanded: C({}, r.expanded, (G = {}, G[N] = !0, G))
            });
          } else if (q && !B) {
            var _ = r.expanded;
            _[N];
      ...
      function $r(r) {
        var e = r.data, u = r.rows, o = r.rowsById, p = r.manualExpandedKey, m = p === void 0 ? "expanded" : p, d = r.paginateExpandedRows, S = d === void 0 ? !0 : d, A = r.expandSubRows, N = A === void 0 ? !0 : A, I = r.autoResetExpanded, q = I === void 0 ? !0 : I, B = r.getHooks, G = r.plugins, _ = r.state.expanded, k = r.dispatch;
        Jn(G, ["useSortBy", "useGroupBy", "usePivotColumns", "useGlobalFilter"], "useExpanded");
        var Z = An(q), yn = !!(Object.keys(o).length && Object.keys(_).length);
        ...
        var mn = y.useCallback(function($, cn) {
          k({
            type: w.toggleRowExpanded,
            id: $,
            value: cn
          });
        }, [k]), j = y.useCallback(function($) {
          return k({
            type: w.toggleAllRowsExpanded,
            value: $
          });
        }, [k]), Pn = y.useMemo(function() {
          return S ? F(u, {
            manualExpandedKey: m,
            expanded: _,
            expandSubRows: N
          ...
          return It(_);
        }, [_]), J = An(r), Y = vn(B().getToggleAllRowsExpandedProps, {
          instance: J()
        });
        Object.assign(r, {
          preExpandedRows: u,
      ...
      function xe(r, e) {
        ...
        }, r.getToggleRowExpandedProps = vn(u().getToggleRowExpandedProps, {
          instance: o,
          row: r
        });
      }
      ...
      var Ge = function(e, u, o) {
        return e = e.filter(function(p) {
          return u.some(function(m) {
            var d = p.values[m];
            return String(d).toLowerCase().includes(String(o).toLowerCase());
          });
        }), e;
      };
      ...
      var pe = function(e, u, o) {
        return e.filter(function(p) {
          return u.some(function(m) {
            var d = p.values[m];
            return d !== void 0 ? String(d).toLowerCase() === String(o).toLowerCase() : !0;
          });
        });
      };
      ...
      var Ve = function(e, u, o) {
        return e.filter(function(p) {
          return u.some(function(m) {
            var d = p.values[m];
            return d !== void 0 ? String(d) === String(o) : !0;
          });
        });
      };
      ...
      var ge = function(e, u, o) {
        return e.filter(function(p) {
          return u.some(function(m) {
            var d = p.values[m];
            return d && d.length && o.every(function(S) {
              return d.includes(S);
            });
          });
        });
      ...
      var me = function(e, u, o) {
        return e.filter(function(p) {
          return u.some(function(m) {
            var d = p.values[m];
            return d && d.length && o.some(function(S) {
              return d.includes(S);
            });
          });
        });
      ...
      var Xe = function(e) {
        e.stateReducers.push(Lt), e.useInstance.push(kt);
      };
      ...
      function Lt(r, e, u, o) {
        ...
        if (e.type === w.resetFilters)
          return C({}, r, {
            filters: o.initialState.filters || []
          });
        if (e.type === w.setFilter) {
          var p = e.columnId, m = e.filterValue, d = o.allColumns, S = o.filterTypes, A = d.find(function(k) {
            return k.id === p;
          });
          if (!A)
            throw new Error("React-Table: Could not find a column with id: " + p);
          var N = z(A.filter, S || {}, Zr), I = r.filters.find(function(k) {
            return k.id === p;
          }), q = Wn(m, I && I.value);
          return an(N.autoRemove, q, A) ? C({}, r, {
            filters: r.filters.filter(function(k) {
              return k.id !== p;
            })
          }) : I ? C({}, r, {
            filters: r.filters.map(function(k) {
              return k.id === p ? {
                id: p,
                value: q
              } : k;
        ...
        if (e.type === w.setAllFilters) {
          var B = e.filters, G = o.allColumns, _ = o.filterTypes;
          return C({}, r, {
            // Filter out undefined values
            filters: Wn(B, r.filters).filter(function(k) {
              var Z = G.find(function(mn) {
                return mn.id === k.id;
              }), yn = z(Z.filter, _ || {}, Zr);
              return !an(yn.autoRemove, k.value, Z);
            })
          });
        }
      }
      function kt(r) {
        var e = r.data, u = r.rows, o = r.flatRows, p = r.rowsById, m = r.allColumns, d = r.filterTypes, S = r.manualFilters, A = r.defaultCanFilter, N = A === void 0 ? !1 : A, I = r.disableFilters, q = r.state.filters, B = r.dispatch, G = r.autoResetFilters, _ = G === void 0 ? !0 : G, k = y.useCallback(function(J, Y) {
          B({
            type: w.setFilter,
            columnId: J,
            filterValue: Y
          });
        }, [B]), Z = y.useCallback(function(J) {
          B({
        ...
        var yn = y.useMemo(function() {
          if (S || !q.length)
            return [u, o, p];
          var J = [], Y = {}, $ = function cn(kn, On) {
            On === void 0 && (On = 0);
            var Xn = kn;
            return Xn = q.reduce(function(en, lr) {
              var Bn = lr.id, Sn = lr.value, Mn = m.find(function(cr) {
                return cr.id === Bn;
              });
              if (!Mn)
                return en;
              On === 0 && (Mn.preFilteredRows = en);
              var Un = z(Mn.filter, d || {}, Zr);
              return Un ? (Mn.filteredRows = Un(en, [Bn], Sn), Mn.filteredRows) : (console.warn("Could not find a valid 'column.filter' for column with the ID: " + Mn.id + "."), en);
            }, kn), Xn.forEach(function(en) {
              J.push(en), Y[en.id] = en, en.subRows && (en.subRows = en.subRows && en.subRows.length > 0 ? cn(en.subRows, On + 1) : en.subRows);
            }), Xn;
          };
          return [$(u), J, Y];
        }, [S, q, u, o, p, m, d]), mn = yn[0], j = yn[1], Pn = yn[2];
        y.useMemo(function() {
      ...
      function je(r, e, u, o) {
        if (e.type === w.resetGlobalFilter)
          return C({}, r, {
            globalFilter: o.initialState.globalFilter || void 0
          });
        if (e.type === w.setGlobalFilter) {
          var p = e.filterValue, m = o.userFilterTypes, d = z(o.globalFilter, m || {}, Zr), S = Wn(p, r.globalFilter);
          if (an(d.autoRemove, S)) {
            r.globalFilter;
            var A = O(r, ["globalFilter"]);
            return A;
          }
          return C({}, r, {
            globalFilter: S
      ...
      function Ue(r) {
        var e = r.data, u = r.rows, o = r.flatRows, p = r.rowsById, m = r.allColumns, d = r.filterTypes, S = r.globalFilter, A = r.manualGlobalFilter, N = r.state.globalFilter, I = r.dispatch, q = r.autoResetGlobalFilter, B = q === void 0 ? !0 : q, G = r.disableGlobalFilter, _ = y.useCallback(function(Pn) {
          I({
            type: w.setGlobalFilter,
            filterValue: Pn
          });
        }, [I]), k = y.useMemo(function() {
          if (A || typeof N > "u")
            return [u, o, p];
          var Pn = [], Fn = {}, J = z(S, d || {}, Zr);
          if (!J)
          ...
          var Y = m.filter(function(cn) {
            ...
            return kn = J(kn, Y.map(function(On) {
              ...
              Pn.push(On), Fn[On.id] = On, On.subRows = On.subRows && On.subRows.length ? cn(On.subRows) : On.subRows;
            }), kn;
          };
          return [$(u), Pn, Fn];
        }, [A, N, S, d, m, u, o, p, G]), Z = k[0], yn = k[1], mn = k[2], j = An(B);
        zn(function() {
          j() && I({
      ...
      function Gt(r, e, u, o) {
        ...
        if (e.type === w.resetGroupBy)
          return C({}, r, {
            groupBy: o.initialState.groupBy || []
          });
        if (e.type === w.setGroupBy) {
          var p = e.value;
          return C({}, r, {
            groupBy: p
          });
        }
        if (e.type === w.toggleGroupBy) {
          var m = e.columnId, d = e.value, S = typeof d < "u" ? d : !r.groupBy.includes(m);
          return S ? C({}, r, {
      ...
      var Kt = {};
      function qt(r) {
        var e = r.data, u = r.rows, o = r.flatRows, p = r.rowsById, m = r.allColumns, d = r.flatHeaders, S = r.groupByFn, A = S === void 0 ? nt : S, N = r.manualGroupBy, I = r.aggregations, q = I === void 0 ? Kt : I, B = r.plugins, G = r.state.groupBy, _ = r.dispatch, k = r.autoResetGroupBy, Z = k === void 0 ? !0 : k, yn = r.disableGroupBy, mn = r.defaultCanGroupBy, j = r.getHooks;
        Jn(B, ["useColumnOrder", "useFilters"], "useGroupBy");
        var Pn = An(r);
        m.forEach(function(Sn) {
          var Mn = Sn.accessor, Un = Sn.defaultGroupBy, cr = Sn.disableGroupBy;
          Sn.canGroupBy = Mn ? ar(Sn.canGroupBy, cr === !0 ? !1 : void 0, yn === !0 ? !1 : void 0, !0) : ar(Sn.canGroupBy, Un, mn, !1), Sn.canGroupBy && (Sn.toggleGroupBy = function() {
            return r.toggleGroupBy(Sn.id);
          }), Sn.Aggregated = Sn.Aggregated || Sn.Cell;
        });
        var Fn = y.useCallback(function(Sn, Mn) {
          _({
        ...
        var Y = y.useMemo(function() {
          ...
          var Sn = G.filter(function(sr) {
            return m.find(function(Vr) {
              return Vr.id === sr;
            });
          }), Mn = function(Vr, Cr, ht) {
            var Kr = {};
            return m.forEach(function(tr) {
              if (Sn.includes(tr.id)) {
          ...
          }, Un = [], cr = {}, re = [], Pe = {}, gn = [], $n = {}, ur = function sr(Vr, Cr, ht) {
            if (Cr === void 0 && (Cr = 0), Cr === Sn.length)
              return Vr.map(function(ie) {
                return C({}, ie, {
                  depth: Cr
                });
              });
            var Kr = Sn[Cr], tr = A(Vr, Kr), St = Object.entries(tr).map(function(ie, lo) {
              var ee = ie[0], qr = ie[1], zr = Kr + ":" + ee;
              zr = ht ? ht + ">" + zr : zr;
              var Do = sr(qr, Cr + 1, zr), Ro = Cr ? Br(qr, "leafRows") : qr, Ca = Mn(Ro, qr, Cr), da = {
                id: zr,
                isGrouped: !0,
                groupByID: Kr,
                groupByVal: ee,
              ...
              return Do.forEach(function(Lr) {
                Un.push(Lr), cr[Lr.id] = Lr, Lr.isGrouped ? (re.push(Lr), Pe[Lr.id] = Lr) : (gn.push(Lr), $n[Lr.id] = Lr);
              }), da;
            });
            return St;
          }, Sr = ur(u);
          return Sr.forEach(function(sr) {
            Un.push(sr), cr[sr.id] = sr, sr.isGrouped ? (re.push(sr), Pe[sr.id] = sr) : (gn.push(sr), $n[sr.id] = sr);
          }), [Sr, Un, cr, re, Pe, gn, $n];
        }, [N, G, u, o, p, m, q, A]), $ = Y[0], cn = Y[1], kn = Y[2], On = Y[3], Xn = Y[4], en = Y[5], lr = Y[6], Bn = An(Z);
        zn(function() {
          Bn() && _({
            type: w.resetGroupBy
          });
      ...
      var rt = /([0-9]+)/gm, _t = function(e, u, o) {
        var p = ne(e, u, o), m = p[0], d = p[1];
        for (m = tt(m), d = tt(d), m = m.split(rt).filter(Boolean), d = d.split(rt).filter(Boolean); m.length && d.length; ) {
          var S = m.shift(), A = d.shift(), N = parseInt(S, 10), I = parseInt(A, 10), q = [N, I].sort();
          if (isNaN(q[0])) {
            if (S > A)
              return 1;
            if (A > S)
      ...
      function jt(r, e, u) {
        ...
        for (p = p.split("").filter(Boolean), m = m.split("").filter(Boolean); p.length && m.length; ) {
          var d = p.shift(), S = m.shift(), A = d.toLowerCase(), N = S.toLowerCase();
          if (A > N)
            return 1;
          if (N > A)
            return -1;
      ...
      function et(r, e, u) {
        var o = ne(r, e, u), p = o[0], m = o[1], d = /[^0-9.]/gi;
        return p = Number(String(p).replace(d, "")), m = Number(String(m).replace(d, "")), we(p, m);
      }
      function we(r, e) {
      ...
      var Jt = function(e, u) {
        var o = u.instance, p = u.column, m = o.isMultiSortEvent, d = m === void 0 ? function(S) {
          return S.shiftKey;
        } : m;
        return [e, {
          onClick: p.canSort ? function(S) {
            S.persist(), p.toggleSortBy(void 0, !o.disableMultiSort && d(S));
          } : void 0,
          style: {
      ...
      function at(r, e, u, o) {
        ...
        if (e.type === w.resetSortBy)
          return C({}, r, {
            sortBy: o.initialState.sortBy || []
          });
        if (e.type === w.clearSortBy) {
        ...
        if (e.type === w.setSortBy) {
          var d = e.sortBy;
          return C({}, r, {
            sortBy: d
          });
        }
        if (e.type === w.toggleSortBy) {
          var S = e.columnId, A = e.desc, N = e.multi, I = o.allColumns, q = o.disableMultiSort, B = o.disableSortRemove, G = o.disableMultiRemove, _ = o.maxMultiSortColCount, k = _ === void 0 ? Number.MAX_SAFE_INTEGER : _, Z = r.sortBy, yn = I.find(function($) {
            return $.id === S;
      ...
      function ut(r) {
        var e = r.data, u = r.rows, o = r.flatRows, p = r.allColumns, m = r.orderByFn, d = m === void 0 ? Me : m, S = r.sortTypes, A = r.manualSortBy, N = r.defaultCanSort, I = r.disableSortBy, q = r.flatHeaders, B = r.state.sortBy, G = r.dispatch, _ = r.plugins, k = r.getHooks, Z = r.autoResetSortBy, yn = Z === void 0 ? !0 : Z;
        ...
        q.forEach(function(cn) {
          var kn = cn.accessor, On = cn.canSort, Xn = cn.disableSortBy, en = cn.id, lr = kn ? ar(Xn === !0 ? !1 : void 0, I === !0 ? !1 : void 0, !0) : ar(N, On, !1);
          cn.canSort = lr, cn.canSort && (cn.toggleSortBy = function(Sn, Mn) {
          ...
          }), cn.getSortByToggleProps = vn(k().getSortByToggleProps, {
            instance: Pn(),
            column: cn
          });
        ...
        var Fn = y.useMemo(function() {
          ...
          return [On(u), cn];
        }, [A, B, u, o, p, d, S]), J = Fn[0], Y = Fn[1], $ = An(yn);
        zn(function() {
          $() && G({
            type: w.resetSortBy
          });
      ...
      function Me(r, e, u) {
        return [].concat(r).sort(function(o, p) {
          for (var m = 0; m < e.length; m += 1) {
            var d = e[m], S = u[m] === !1 || u[m] === "desc", A = d(o, p);
            if (A !== 0)
              return S ? -A : A;
          }
      ...
      function Zt(r, e, u, o) {
        ...
        if (e.type === w.resetPage)
          return C({}, r, {
            pageIndex: o.initialState.pageIndex || 0
          });
        if (e.type === w.gotoPage) {
          var p = o.pageCount, m = o.page, d = Wn(e.pageIndex, r.pageIndex), S = !1;
          return d > r.pageIndex ? S = p === -1 ? m.length >= r.pageSize : d < p : d < r.pageIndex && (S = d > -1), S ? C({}, r, {
            pageIndex: d
          }) : r;
        }
        if (e.type === w.setPageSize) {
      ...
      function lt(r) {
        var e = r.rows, u = r.autoResetPage, o = u === void 0 ? !0 : u, p = r.manualExpandedKey, m = p === void 0 ? "expanded" : p, d = r.plugins, S = r.pageCount, A = r.paginateExpandedRows, N = A === void 0 ? !0 : A, I = r.expandSubRows, q = I === void 0 ? !0 : I, B = r.state, G = B.pageSize, _ = B.pageIndex, k = B.expanded, Z = B.globalFilter, yn = B.filters, mn = B.groupBy, j = B.sortBy, Pn = r.dispatch, Fn = r.data, J = r.manualPagination;
        ...
        }, [q, k, m, J, _, G, N, e]), On = _ > 0, Xn = $ === -1 ? kn.length >= G : _ < $ - 1, en = y.useCallback(function(Mn) {
          Pn({
            type: w.gotoPage,
            pageIndex: Mn
          });
        }, [Pn]), lr = y.useCallback(function() {
          return en(function(Mn) {
            return Mn - 1;
          });
        }, [en]), Bn = y.useCallback(function() {
          return en(function(Mn) {
            return Mn + 1;
          });
        }, [en]), Sn = y.useCallback(function(Mn) {
          Pn({
            type: w.setPageSize,
            pageSize: Mn
          });
      ...
      function yt(r, e, u, o) {
        ...
        if (e.type === w.resetPivot)
          return C({}, r, {
            pivotColumns: o.initialState.pivotColumns || ct
          });
        if (e.type === w.togglePivot) {
          var p = e.columnId, m = e.value, d = typeof m < "u" ? m : !r.pivotColumns.includes(p);
          return d ? C({}, r, {
      ...
      function to(r, e) {
        ...
        var m = p.pivotColumns.map(function(N) {
        ...
        }).filter(Boolean), d = o.filter(function(N) {
          ...
          return _.map(function(k) {
            var Z = C({}, G, {
              ...
              parent: q,
              depth: I,
              id: q ? q.id + "." + G.id + "." + k : G.id + "." + k,
              pivotValue: k
            });
            return Z.columns = N(I + 1, Z, [].concat(B, [function(yn) {
              return yn.values[G.id] === k;
            }])), Z;
          });
        }, A = Pr(S());
        return [].concat(r, A);
      ...
      function Ae(r) {
        var e = r.columns, u = r.allColumns, o = r.flatHeaders, p = r.getHooks, m = r.plugins, d = r.dispatch, S = r.autoResetPivot, A = S === void 0 ? !0 : S, N = r.manaulPivot, I = r.disablePivot, q = r.defaultCanPivot;
        Jn(m, ["useGroupBy"], "usePivotColumns");
        var B = An(r);
        u.forEach(function(k) {
          var Z = k.accessor, yn = k.defaultPivot, mn = k.disablePivot;
          k.canPivot = Z ? ar(k.canPivot, mn === !0 ? !1 : void 0, I === !0 ? !1 : void 0, !0) : ar(k.canPivot, yn, q, !1), k.canPivot && (k.togglePivot = function() {
            return r.togglePivot(k.id);
        ...
        o.forEach(function(k) {
          k.getPivotToggleProps = vn(p().getPivotToggleProps, {
            instance: B(),
            header: k
          });
        });
      ...
      var Re = function(e) {
        e.getToggleRowSelectedProps = [oo], e.getToggleAllRowsSelectedProps = [Ne], e.getToggleAllPageRowsSelectedProps = [ao], e.stateReducers.push(uo), e.useInstance.push(io), e.prepareRow.push(ft);
      };
      Re.pluginName = dt;
      var oo = function(e, u) {
        var o = u.instance, p = u.row, m = o.manualRowSelectedKey, d = m === void 0 ? "isSelected" : m, S = !1;
        return p.original && p.original[d] ? S = !0 : S = p.isSelected, [e, {
          onChange: function(N) {
      ...
      function uo(r, e, u, o) {
        ...
        if (e.type === w.resetSelectedRows)
          return C({}, r, {
            selectedRowIds: o.initialState.selectedRowIds || {}
          });
        if (e.type === w.toggleAllRowsSelected) {
          var p = e.value, m = o.isAllRowsSelected, d = o.rowsById, S = o.nonGroupedRowsById, A = S === void 0 ? d : S, N = typeof p < "u" ? p : !m, I = Object.assign({}, r.selectedRowIds);
        ...
        if (e.type === w.toggleRowSelected) {
          var q = e.id, B = e.value, G = o.rowsById, _ = o.selectSubRows, k = _ === void 0 ? !0 : _, Z = o.getSubRows, yn = r.selectedRowIds[q], mn = typeof B < "u" ? B : !yn;
          if (yn === mn)
            return r;
          var j = C({}, r.selectedRowIds), Pn = function Bn(Sn) {
            var Mn = G[Sn];
            if (Mn && (Mn.isGrouped || (mn ? j[Sn] = !0 : delete j[Sn]), k && Z(Mn)))
        ...
        if (e.type === w.toggleAllPageRowsSelected) {
          var Fn = e.value, J = o.page, Y = o.rowsById, $ = o.selectSubRows, cn = $ === void 0 ? !0 : $, kn = o.isAllPageRowsSelected, On = o.getSubRows, Xn = typeof Fn < "u" ? Fn : !kn, en = C({}, r.selectedRowIds), lr = function Bn(Sn) {
            var Mn = Y[Sn];
            if (Mn.isGrouped || (Xn ? en[Sn] = !0 : delete en[Sn]), cn && On(Mn))
      ...
      function io(r) {
        var e = r.data, u = r.rows, o = r.getHooks, p = r.plugins, m = r.rowsById, d = r.nonGroupedRowsById, S = d === void 0 ? m : d, A = r.autoResetSelectedRows, N = A === void 0 ? !0 : A, I = r.state.selectedRowIds, q = r.selectSubRows, B = q === void 0 ? !0 : q, G = r.dispatch, _ = r.page, k = r.getSubRows;
        ...
        var Z = y.useMemo(function() {
          ...
          return u.forEach(function(On) {
            var Xn = B ? pt(On, I, k) : !!I[On.id];
            On.isSelected = !!Xn, On.isSomeSelected = Xn === null, Xn && kn.push(On);
          }), kn;
        }, [u, B, I, k]), yn = !!(Object.keys(S).length && Object.keys(I).length), mn = yn;
        yn && Object.keys(S).some(function(kn) {
          return !I[kn];
        ...
        var Pn = y.useCallback(function(kn) {
          return G({
        ...
        }, [G]), Y = An(r), $ = vn(o().getToggleAllRowsSelectedProps, {
          instance: Y()
        }), cn = vn(o().getToggleAllPageRowsSelectedProps, {
          instance: Y()
        });
        Object.assign(r, {
          selectedFlatRows: Z,
      ...
      function ft(r, e) {
        ...
        }, r.getToggleRowSelectedProps = vn(u.getHooks().getToggleRowSelectedProps, {
          instance: u,
          row: r
        });
      }
      ...
      function Te(r, e, u, o) {
        var p = o.initialRowStateAccessor, m = p === void 0 ? gt : p, d = o.initialCellStateAccessor, S = d === void 0 ? mt : d, A = o.rowsById;
        if (e.type === w.init)
          return C({
            rowState: {}
          }, r);
        if (e.type === w.resetRowState)
          return C({}, r, {
            rowState: o.initialState.rowState || {}
          });
        if (e.type === w.setRowState) {
          var N, I = e.rowId, q = e.value, B = typeof r.rowState[I] < "u" ? r.rowState[I] : m(A[I]);
          return C({}, r, {
            rowState: C({}, r.rowState, (N = {}, N[I] = Wn(q, B), N))
          });
        }
        if (e.type === w.setCellState) {
          var G, _, k, Z, yn, mn = e.rowId, j = e.columnId, Pn = e.value, Fn = typeof r.rowState[mn] < "u" ? r.rowState[mn] : m(A[mn]), J = typeof (Fn == null || (G = Fn.cellState) == null ? void 0 : G[j]) < "u" ? Fn.cellState[j] : S((_ = A[mn]) == null || (k = _.cells) == null ? void 0 : k.find(function(Y) {
            return Y.column.id === j;
          }));
          return C({}, r, {
            rowState: C({}, r.rowState, (yn = {}, yn[mn] = C({}, Fn, {
              cellState: C({}, Fn.cellState || {}, (Z = {}, Z[j] = Wn(Pn, J), Z))
            }), yn))
          });
        }
      }
      function n(r) {
        var e = r.autoResetRowState, u = e === void 0 ? !0 : e, o = r.data, p = r.dispatch, m = y.useCallback(function(A, N) {
          return p({
            type: w.setRowState,
            rowId: A,
            value: N
          });
        }, [p]), d = y.useCallback(function(A, N, I) {
          return p({
            type: w.setCellState,
            rowId: A,
            columnId: N,
      ...
      function a(r, e) {
        var u = e.instance, o = u.initialRowStateAccessor, p = o === void 0 ? gt : o, m = u.initialCellStateAccessor, d = m === void 0 ? mt : m, S = u.state.rowState;
        r && (r.state = typeof S[r.id] < "u" ? S[r.id] : p(r), r.setState = function(A) {
          return u.setRowState(r.id, A);
        }, r.cells.forEach(function(A) {
          r.state.cellState || (r.state.cellState = {}), A.state = typeof r.state.cellState[A.column.id] < "u" ? r.state.cellState[A.column.id] : d(A), A.setState = function(N) {
      ...
      function s(r, e, u, o) {
        ...
        if (e.type === w.resetColumnOrder)
          return C({}, r, {
            columnOrder: o.initialState.columnOrder || []
          });
        if (e.type === w.setColumnOrder)
          return C({}, r, {
      ...
      function v(r, e) {
        ...
        if (!u || !u.length)
          return r;
        for (var o = [].concat(u), p = [].concat(r), m = [], d = function() {
      ...
      var h = function(e) {
        ...
        var o = u.instance, p = u.header, m = o.dispatch, d = function(A, N) {
          var I = !1;
          ...
          var q = W(N), B = q.map(function(J) {
          ...
          }), G = I ? Math.round(A.touches[0].clientX) : A.clientX, _, k, Z = function() {
            ...
            k = Y, _ || (_ = window.requestAnimationFrame(yn));
          }, j = {
            mouse: {
              moveEvent: "mousemove",
      ...
      function T(r, e) {
        ...
        if (e.type === w.resetResize)
          return C({}, r, {
            columnResizing: {
              columnWidths: {}
            }
          });
        if (e.type === w.columnStartResizing) {
        ...
        if (e.type === w.columnResizing) {
          var d = e.clientX, S = r.columnResizing, A = S.startX, N = S.columnWidth, I = S.headerIdWidths, q = I === void 0 ? [] : I, B = d - A, G = B / N, _ = {};
        ...
        if (e.type === w.columnDoneResizing)
          return C({}, r, {
            columnResizing: C({}, r.columnResizing, {
              startX: null,
      ...
      var E = function(e) {
        var u = e.flatHeaders, o = e.disableResizing, p = e.getHooks, m = e.state.columnResizing, d = An(e);
      ...
      function Ln(r) {
        r.getTableProps.push(sn), r.getRowProps.push(K), r.getHeaderGroupProps.push(K), r.getFooterGroupProps.push(K), r.getHeaderProps.push(Tn), r.getCellProps.push(nn), r.getFooterProps.push(wn);
      }
      ...
      function xn(r) {
        r.stateReducers.push(Dn), r.getTableProps.push(pn), r.getHeaderProps.push(hn), r.getRowProps.push(qn);
      }
      xn.pluginName = "useGridLayout";
      var pn = function(e, u) {
        var o = u.instance, p = o.visibleColumns.map(function(m) {
          var d;
          return o.state.gridLayout.columnWidths[m.id] ? o.state.gridLayout.columnWidths[m.id] + "px" : (d = o.state.columnResizing) != null && d.isResizingColumn ? o.state.gridLayout.startWidths[m.id] + "px" : typeof m.width == "number" ? m.width + "px" : m.width;
        });
        return [e, {
          style: {
            display: "grid",
      ...
      function Dn(r, e, u, o) {
        ...
        if (e.type === w.columnStartResizing) {
          var p = e.columnId, m = e.headerIdWidths, d = Kn(p);
          if (d !== void 0) {
            var S = o.visibleColumns.reduce(function(J, Y) {
              var $;
              return C({}, J, ($ = {}, $[Y.id] = Kn(Y.id), $));
        ...
        if (e.type === w.columnResizing) {
          var q = e.clientX, B = r.columnResizing.startX, G = r.gridLayout, _ = G.columnWidth, k = G.minWidths, Z = G.maxWidths, yn = G.headerIdGridWidths, mn = yn === void 0 ? [] : yn, j = q - B, Pn = j / _, Fn = {};
          return mn.forEach(function(J) {
            var Y = J[0], $ = J[1];
            Fn[Y] = Math.min(Math.max(k[Y], $ + $ * Pn), Z[Y]);
          }), C({}, r, {
            gridLayout: C({}, r.gridLayout, {
              columnWidths: C({}, r.gridLayout.columnWidths, {}, Fn)
            })
          });
        }
        if (e.type === w.columnDoneResizing)
      ...
      c._UNSTABLE_usePivotColumns = st, c.actions = w, c.defaultColumn = Cn, c.defaultGroupByFn = nt, c.defaultOrderByFn = Me, c.defaultRenderer = un, c.emptyRenderer = Nn, c.ensurePluginOrder = Jn, c.flexRender = on, c.functionalUpdate = Wn, c.loopHooks = bn, c.makePropGetter = vn, c.makeRenderer = fn, c.reduceHooks = Hn, c.safeUseLayoutEffect = or, c.useAbsoluteLayout = L, c.useAsyncDebounce = dr, c.useBlockLayout = ln, c.useColumnOrder = i, c.useExpanded = fe, c.useFilters = Xe, c.useFlexLayout = Ln, c.useGetLatest = An, c.useGlobalFilter = Ye, c.useGridLayout = xn, c.useGroupBy = Se, c.useMountedLayoutEffect = zn, c.usePagination = it, c.useResizeColumns = h, c.useRowSelect = Re, c.useRowState = vt, c.useSortBy = ot, c.useTable = oe, Object.defineProperty(c, "__esModule", { value: !0 });
    });
  }(At, At.exports)), At.exports;
}
process.env.NODE_ENV === "production" ? So.exports = Ou() : So.exports = Bu();
var se = So.exports;
function Fu(t, f, c) {
  var y = this, b = D.useRef(null), P = D.useRef(0), C = D.useRef(null), O = D.useRef([]), Rn = D.useRef(), M = D.useRef(), En = D.useRef(t), w = D.useRef(!0);
  En.current = t;
  var un = !f && f !== 0 && typeof window < "u";
  if (typeof t != "function")
    throw new TypeError("Expected a function");
  f = +f || 0, c = c || {};
  var Nn = !!c.leading, Cn = "trailing" in c ? !!c.trailing : !0, dn = "maxWait" in c, Vn = dn ? Math.max(+c.maxWait || 0, f) : null, vn = D.useCallback(function(on) {
    var _n = O.current, Qn = Rn.current;
    return O.current = Rn.current = null, P.current = on, M.current = En.current.apply(Qn, _n);
  }, []), Hn = D.useCallback(function(on, _n) {
    un && cancelAnimationFrame(C.current), C.current = un ? requestAnimationFrame(on) : setTimeout(on, _n);
  }, [un]), bn = D.useCallback(function(on) {
    if (!w.current)
      return !1;
    var _n = on - b.current, Qn = on - P.current;
    return !b.current || _n >= f || _n < 0 || dn && Qn >= Vn;
  }, [Vn, dn, f]), Jn = D.useCallback(function(on) {
    return C.current = null, Cn && O.current ? vn(on) : (O.current = Rn.current = null, M.current);
  }, [vn, Cn]), Wn = D.useCallback(function() {
    var on = Date.now();
    if (bn(on))
      return Jn(on);
    if (w.current) {
      var _n = on - b.current, Qn = on - P.current, Yn = f - _n, nr = dn ? Math.min(Yn, Vn - Qn) : Yn;
      Hn(Wn, nr);
    }
  }, [Vn, dn, bn, Hn, Jn, f]), An = D.useCallback(function() {
    C.current && (un ? cancelAnimationFrame(C.current) : clearTimeout(C.current)), P.current = 0, O.current = b.current = Rn.current = C.current = null;
  }, [un]), or = D.useCallback(function() {
    return C.current ? Jn(Date.now()) : M.current;
  }, [Jn]);
  D.useEffect(function() {
  ...
  var zn = D.useCallback(function() {
    for (var on = [], _n = 0; _n < arguments.length; _n++)
      on[_n] = arguments[_n];
    var Qn = Date.now(), Yn = bn(Qn);
    if (O.current = on, Rn.current = y, b.current = Qn, Yn) {
      if (!C.current && w.current)
        return P.current = b.current, Hn(Wn, f), Nn ? vn(b.current) : M.current;
      if (dn)
        return Hn(Wn, f), vn(b.current);
    }
    return C.current || Hn(Wn, f), M.current;
  }, [vn, Nn, dn, bn, Hn, Wn, f]), dr = D.useCallback(function() {
    return !!C.current;
...
function Wu(t) {
  var f = D.useState(jo(t)), c = f[0], y = f[1], b = D.useCallback(function(P) {
    return y(jo(P));
  }, []);
  return [c, b];
}
function xu(t, f, c) {
  var y = c && c.equalityFn || Hu, b = Wu(t), P = b[0], C = b[1], O = Fu(D.useCallback(function(M) {
    return C(M);
  }, [C]), f, c), Rn = D.useRef(t);
  return D.useEffect(function() {
    y(Rn.current, t) || (O.callback(t), Rn.current = t);
  }, [t, O, y]), [P, { cancel: O.cancel, pending: O.pending, flush: O.flush }];
}
function Gu(t) {
  if (Array.isArray(t) || (t.general.geoType === "us-county" || t.general.geoType === "single-state" || t.general.geoType === "us" && (t != null && t.data)) && (t == null || t.data.forEach((f) => {
    ...
    const y = f.filter((b) => c.includes(b));
    if (!y.length)
      return;
    t == null || t.forEach((b) => {
      b[y] && (!isNaN(parseInt(b[y])) && b[y].length === 4 && (b[y] = 0 + b[y]), b[y] = b[y].toString());
    });
  }
  return t;
}
const wo = 10, te = {
  ...
  fileTooLarge: `File is too large. Maximum file size is ${wo}MB.`
}, Vu = D.memo(({ globalFilter: t, setGlobalFilter: f, disabled: c = !1 }) => {
  const [y, b] = D.useState(t), [P] = xu(y, 200);
  D.useEffect(() => {
  ...
  return /* @__PURE__ */ l.createElement("input", { className: "filter", value: y, onChange: C, type: "search", placeholder: "Filter...", disabled: c });
}), Uo = D.memo(({ globalFilter: t, data: f, setGlobalFilter: c }) => /* @__PURE__ */ l.createElement("header", { className: "data-table-header" }, /* @__PURE__ */ l.createElement("h2", null, "Data Preview"), /* @__PURE__ */ l.createElement(Vu, { globalFilter: t || "", setGlobalFilter: c, disabled: f === null }))), Ku = D.memo(({ previousPage: t, nextPage: f, canPreviousPage: c, canNextPage: y, pageNumber: b, totalPages: P }) => /* @__PURE__ */ l.createElement("footer", { className: "data-table-pagination" }, /* @__PURE__ */ l.createElement("ul", null, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement("button", { onClick: () => t(), className: "btn btn-prev", disabled: !c, title: "Previous Page" })), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement("button", { onClick: () => f(), className: "btn btn-next", disabled: !y, title: "Next Page" }))), /* @__PURE__ */ l.createElement("span", null, "Page ", b, " of ", P))), qu = () => {
  const { config: t } = D.useContext(ce), f = D.useMemo(() => t.type === "dashboard" ? Object.values(t.datasets).find((fn) => fn.preview && Array.isArray(fn.data)) : t.data, [t.type, t.data, t.datasets]), [c, y] = D.useState(f), b = (fn) => {
    const on = Object.keys(fn[0]).includes("tableData"), _n = M(on ? fn[0].tableData : fn);
    return Gu(_n), _n;
  }, P = (fn) => y(b(fn)), C = D.useContext(ke), O = async () => {
    if (t.type === "dashboard")
      Object.keys(t.datasets).forEach(async (fn) => {
        if (t.datasets[fn].preview)
          if (t.datasets[fn].dataUrl) {
            const on = await To(t.datasets[fn].dataUrl);
            Array.isArray(on) && P(on);
          } else
            Array.isArray(t.datasets[fn].data) && P(t.datasets[fn].data);
      });
    else if (t.dataUrl) {
      const fn = await To(t.dataUrl);
  ...
  const Rn = D.useMemo(() => {
    if (!c)
      return [];
    const fn = c.columns ?? [];
    return fn.length > 0 && fn.includes("") && C({ type: "EDITOR_SET_ERRORS", payload: [te.emptyCols] }), fn.map((on) => ({
      id: `column-${on}`,
      accessor: (Qn) => Qn[on],
      Header: on,
      width: 250
    ...
    fn.forEach((Qn) => {
      Object.keys(Qn).forEach((Yn) => {
        on.includes(Yn) === !1 && on.push(Yn);
      });
    });
    const _n = [...fn];
    if (Array.isArray(_n))
      return _n.columns = on, _n;
  }, {
    getTableProps: En,
    getTableBodyProps: w,
    headerGroups: un,
    ...
    nextPage: Wn,
    previousPage: An
  } = se.useTable({ columns: Rn, data: c, initialState: { pageSize: 25 } }, se.useBlockLayout, se.useGlobalFilter, se.useSortBy, se.useResizeColumns, se.usePagination), or = () => /* @__PURE__ */ l.createElement("section", { className: "no-data" }, /* @__PURE__ */ l.createElement("section", { className: "no-data-message" }, /* @__PURE__ */ l.createElement("section", null, /* @__PURE__ */ l.createElement("h3", null, "No Data"), /* @__PURE__ */ l.createElement("p", null, "Import data to preview"))), /* @__PURE__ */ l.createElement("div", { className: "table-container" }, /* @__PURE__ */ l.createElement("table", { className: "editor data-table", role: "table" }, /* @__PURE__ */ l.createElement("thead", null, /* @__PURE__ */ l.createElement("tr", null, /* @__PURE__ */ l.createElement("th", { scope: "col", colSpan: 1, role: "columnheader" }), /* @__PURE__ */ l.createElement("th", { scope: "col", colSpan: 1, role: "columnheader" }), /* @__PURE__ */ l.createElement("th", { scope: "col", colSpan: 1, role: "columnheader" }))), /* @__PURE__ */ l.createElement("tbody", null, /* @__PURE__ */ l.createElement(l.Fragment, null, [...Array(10)].map((fn, on) => /* @__PURE__ */ l.createElement("tr", { key: on }, /* @__PURE__ */ l.createElement("td", null), /* @__PURE__ */ l.createElement("td", null), /* @__PURE__ */ l.createElement("td", null))))))));
  if (!c)
    return [/* @__PURE__ */ l.createElement(Uo, { key: "header" }), /* @__PURE__ */ l.createElement(or, { key: "table" })];
  const zn = { previousPage: An, nextPage: Wn, canPreviousPage: Hn, canNextPage: bn, pageNumber: Nn + 1, totalPages: Jn.length }, dr = () => /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("section", { className: "data-table-container" }, /* @__PURE__ */ l.createElement("div", { className: "table-container" }, /* @__PURE__ */ l.createElement("table", { className: "data-table", ...En(), "aria-hidden": "true" }, /* @__PURE__ */ l.createElement("thead", null, un.map((fn) => /* @__PURE__ */ l.createElement("tr", { ...fn.getHeaderGroupProps() }, fn.headers.map((on) => /* @__PURE__ */ l.createElement("th", { scope: "col", ...on.getHeaderProps(on.getSortByToggleProps()), className: on.isSorted ? on.isSortedDesc ? "sort sort-desc" : "sort sort-asc" : "", title: on.Header }, on.render("Header"), /* @__PURE__ */ l.createElement("div", { ...on.getResizerProps(), className: "resizer" })))))), /* @__PURE__ */ l.createElement("tbody", { ...w() }, vn.map((fn) => (dn(fn), /* @__PURE__ */ l.createElement("tr", { ...fn.getRowProps() }, fn.cells.map((on) => /* @__PURE__ */ l.createElement("td", { ...on.getCellProps(), title: on.value }, on.render("Cell")))))))))), /* @__PURE__ */ l.createElement(Ku, { ...zn }));
  return [/* @__PURE__ */ l.createElement(Uo, { key: "header", data: c, setGlobalFilter: Vn, globalFilter: Cn }), /* @__PURE__ */ l.createElement(dr, { key: "table" })];
}, zu = (t) => /* @__PURE__ */ D.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", ...t }, /* @__PURE__ */ D.createElement("path", { d: "M314.222 197.78c51.091 51.091 54.377 132.287 9.75 187.16-6.242 7.73-2.784 3.865-84.94 86.02-54.696 54.696-143.266 54.745-197.99 0-54.711-54.69-54.734-143.255 0-197.99 32.773-32.773 51.835-51.899 63.409-63.457 7.463-7.452 20.331-2.354 20.486 8.192a173.31 173.31 0 0 0 4.746 37.828c.966 4.029-.272 8.269-3.202 11.198L80.632 312.57c-32.755 32.775-32.887 85.892 0 118.8 32.775 32.755 85.892 32.887 118.8 0l75.19-75.2c32.718-32.725 32.777-86.013 0-118.79a83.722 83.722 0 0 0-22.814-16.229c-4.623-2.233-7.182-7.25-6.561-12.346 1.356-11.122 6.296-21.885 14.815-30.405l4.375-4.375c3.625-3.626 9.177-4.594 13.76-2.294 12.999 6.524 25.187 15.211 36.025 26.049zM470.958 41.04c-54.724-54.745-143.294-54.696-197.99 0-82.156 82.156-78.698 78.29-84.94 86.02-44.627 54.873-41.341 136.069 9.75 187.16 10.838 10.838 23.026 19.525 36.025 26.049 4.582 2.3 10.134 1.331 13.76-2.294l4.375-4.375c8.52-8.519 13.459-19.283 14.815-30.405.621-5.096-1.938-10.113-6.561-12.346a83.706 83.706 0 0 1-22.814-16.229c-32.777-32.777-32.718-86.065 0-118.79l75.19-75.2c32.908-32.887 86.025-32.755 118.8 0 32.887 32.908 32.755 86.025 0 118.8l-45.848 45.84c-2.93 2.929-4.168 7.169-3.202 11.198a173.31 173.31 0 0 1 4.746 37.828c.155 10.546 13.023 15.644 20.486 8.192 11.574-11.558 30.636-30.684 63.409-63.457 54.733-54.735 54.71-143.3-.001-197.991z" })), Et = D.createContext();
...
}, ca = ({ text: t, fileName: f, data: c }) => {
  const { editingDataset: y, loadData: b } = D.useContext(Et), P = (O) => b(new Blob([c], { type: "text/csv" }), f, y), C = (O) => O.keyCode === 13 && b(new Blob([c], { type: "text/csv" }), f, y);
...
}, oi = () => bo.maps.map((t) => /* @__PURE__ */ l.createElement(ca, { key: t.fileName, text: t.text, fileName: t.fileName, data: t.data })), ai = () => bo.charts.map((t) => /* @__PURE__ */ l.createElement(ca, { key: t.fileName, text: t.text, fileName: t.fileName, data: t.data })), ui = () => {
  const { config: t } = D.useContext(Et);
  return /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("h3", { className: "heading-3" }, "Load Sample Data:"), /* @__PURE__ */ l.createElement("ul", { className: "sample-data-list" }, t.type !== "map" && /* @__PURE__ */ l.createElement(ai, null), t.type !== "chart" && /* @__PURE__ */ l.createElement(oi, null)));
}, Ao = () => null;
Ao.data = bo;
Ao.Buttons = ui;
...
function ii() {
  const { config: t, errors: f, tempConfig: c, sharepath: y } = D.useContext(ce), b = (F) => {
    dn({ type: "EDITOR_SET_CONFIG", payload: F });
  }, P = (F) => {
    dn({ type: "EDITOR_SET_ERRORS", payload: F });
  }, C = new Na(), [O, Rn] = D.useState(t.dataFileSourceType === "url" ? t.dataFileName : t.dataUrl || ""), [M, En] = D.useState(!!t.dataUrl), [w, un] = D.useState(t.type === "dashboard" || !t.data), [Nn, Cn] = D.useState(void 0), dn = D.useContext(ke), Vn = {
    ".csv": "text/csv",
    ".json": "application/json"
  }, vn = (F) => F === void 0 ? "" : F > Math.pow(1024, 3) ? Math.round(F / Math.pow(1024, 3) * 100) / 100 + " GB" : F > Math.pow(1024, 2) ? Math.round(F / Math.pow(1024, 2) * 100) / 100 + " MB" : F > 1024 ? Math.round(F / 1024 * 100) / 100 + " KB" : F + " B", Hn = (F, z, an) => (z.map(function(rn, Gn, jn) {
    if (!jn.find((wr) => wr.dataKey === rn.dataKey))
      return !1;
  }), !(F.columns.indexOf(an) < 0)), bn = (F) => so(O) ? ".csv" : wt(O) ? ".json" : Object.keys(Vn).find((z) => F.pathname.endsWith(z)), Jn = async () => {
    let F;
    try {
      F = so(O) || wt(O) ? O : new URL(O, window.location.origin);
    } catch {
      throw te.urlInvalid;
    }
    let z = null;
    ...
    try {
      await Ra.get(F.toString(), {
        ...
        z = rn.data, an === ".csv" && ["text/csv", "text/plain"].includes(z.type) || so(O) ? z = z.slice(0, z.size, "text/csv") : (z.type === "application/json" || an === ".json" && z.type === "text/plain" || wt(O)) && (z = z.slice(0, z.size, "application/json"));
      });
    } catch (rn) {
      console.error(rn);
      const Gn = rn.toString();
      throw Object.values(te).includes(rn) ? Gn : te.failedFetch;
    }
    return t.type === "dashboard" && Rn(""), z;
  }, Wn = ([F]) => An(F, Nn, Nn), An = async (F = null, z, an) => {
    let rn = F;
    const Gn = (rn == null ? void 0 : rn.path) ?? z ?? O, jn = F ? "file" : "url";
    if (jn === "url")
      try {
        rn = await Jn();
      } catch (pr) {
    ...
    const Ar = (() => {
      const pr = (F == null ? void 0 : F.name) || O || z;
      if (jn === "file") {
      ...
      switch (Ar) {
        ...
        case "application/json":
          try {
            return wt(O) ? JSON.parse(pr).response.docs : JSON.parse(pr);
          } catch {
            P([te.formatting]);
            return;
          }
      ...
      const pr = (yr, vr = !1) => {
        if (t.type === "dashboard") {
          ...
          let hr = {
            ...
            dataFileSourceType: jn,
            // new file source type
            formattedData: C.developerStandardize(yr, t.dataDescription)
          };
          M && (hr.dataUrl = Gn), b(hr);
        }
      };
      try {
        const yr = Ir(this.result.toString()), vr = C.autoStandardize(yr);
  ...
  D.useEffect(() => {
    ...
    if (t.formattedData === void 0 && t.dataDescription) {
      const z = C.developerStandardize(t.data, t.dataDescription);
      z && (F.formattedData = z);
    }
    dn({ type: "EDITOR_SAVE", payload: F });
  }, []);
  const or = (F, z, an) => {
    if (t.type === "dashboard") {
      let rn = { ...t.datasets[F].dataDescription, [z]: an }, Gn = C.developerStandardize(t.datasets[F].data, rn), jn = { ...t.datasets };
      jn[F] = { ...jn[F], dataDescription: rn, formattedData: Gn }, b({ ...t, datasets: jn });
    } else {
      let rn = { ...t.dataDescription, [z]: an }, Gn = C.developerStandardize(t.data, rn);
      b({ ...t, formattedData: Gn, dataDescription: rn });
    }
  }, zn = (F, z) => {
    if (z) {
      let an = { ...t.datasets };
    ...
    En(F);
  }, { getRootProps: dr, getInputProps: fn, isDragActive: on } = ho({ onDrop: Wn }), { getRootProps: _n, getInputProps: Qn, isDragActive: Yn } = ho({ onDrop: Wn }), nr = () => /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("form", { className: "input-group d-flex", onSubmit: (F) => F.preventDefault() }, /* @__PURE__ */ l.createElement("input", { id: "external-data", type: "text", className: "form-control flex-grow-1 border-right-0", placeholder: "e.g., https://data.cdc.gov/resources/file.json", "aria-label": "Load data from external URL", "aria-describedby": "load-data", value: O, onChange: (F) => Rn(F.target.value) }), /* @__PURE__ */ l.createElement("button", { className: "input-group-text btn btn-primary px-4", type: "submit", id: "load-data", onClick: () => An(null, O, Nn) }, "Load")), /* @__PURE__ */ l.createElement("label", { htmlFor: "keep-url", className: "mt-1 d-flex keep-url" }, /* @__PURE__ */ l.createElement("input", { type: "checkbox", id: "keep-url", checked: M, onChange: () => zn(!M, Nn) }), " Always load from URL (normally will only pull once)")), Pr = (F = {}, z = "Are you sure you want to do this?") => {
    F.newViz = !0, window.confirm(z) === !0 && (dn({ type: "EDITOR_SAVE", payload: F }), un(!0));
  }, Rr = () => (
    ...
    let rn = { ...t.datasets };
    an === !0 ? Object.keys(rn).forEach((Gn) => {
      const jn = Gn === F;
      rn[Gn][z] = jn;
    }) : rn[F][z] = an, b({ ...t, datasets: rn });
  }, Er = (F) => {
    let z = { ...t.datasets }, an = { ...t.visualizations };
    Object.keys(an).forEach((rn) => {
      an[rn].dataKey === F && delete an[rn].dataKey;
    }), delete z[F], b({ ...t, datasets: z, visualizations: an });
  }, fr = (F, z) => {
    if (F === z)
      return;
    let an = { ...t.datasets }, rn = { ...t.visualizations }, Gn = 2, jn = z;
    for (; an[z]; )
      z = jn + "-" + Gn, Gn++;
    an[z] = an[F], delete an[F], Object.keys(rn).forEach((wr) => {
      rn[wr].dataKey === F && (rn[wr].dataKey = z);
    }), b({ ...t, datasets: an, visualizations: rn });
  };
  let mr, ar = !1;
  t.type === "dashboard" ? ar = Object.keys(t.datasets).length > 0 : (mr = t, ar = !!t.formattedData || t.data && t.dataDescription && C.autoStandardize(t.data)), (t.visualizationType === "Box Plot" && t.data || t.visualizationType === "Scatter Plot") && (ar = !0);
  const Or = /* @__PURE__ */ l.createElement(l.Fragment, null, t.filters && t.filters.map(
    (F, z) => F.type !== "url" ? /* @__PURE__ */ l.createElement(l.Fragment, null) : /* @__PURE__ */ l.createElement("fieldset", { key: F.key, className: "edit-block url-filters-block" }, /* @__PURE__ */ l.createElement(
      "button",
      {
        onClick: (an) => {
          let rn = [...t.filters];
          rn.splice(z, 1), b({ ...t, filters: rn, runtimeDataUrl: void 0 });
        }
      },
      "Remove"
    ), /* @__PURE__ */ l.createElement("label", null, /* @__PURE__ */ l.createElement("span", { className: "edit-label column-heading" }, "Label", /* @__PURE__ */ l.createElement(tn, { style: { textTransform: "none" } }, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(Po, { display: "question" })), /* @__PURE__ */ l.createElement(tn.Content, null, /* @__PURE__ */ l.createElement("p", { style: { padding: "0.5rem" } }, "The label that will appear above the dropdown filter.")))), " ", /* @__PURE__ */ l.createElement(
      "input",
      {
        type: "text",
        ...
        onChange: (an) => {
          let rn = [...t.filters];
          rn[z].label = an.target.value, b({ ...t, filters: rn });
        }
      }
    )), /* @__PURE__ */ l.createElement("label", null, /* @__PURE__ */ l.createElement("span", { className: "edit-label column-heading" }, "Query string parameter", /* @__PURE__ */ l.createElement(tn, { style: { textTransform: "none" } }, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(Po, { display: "question" })), /* @__PURE__ */ l.createElement(tn.Content, null, /* @__PURE__ */ l.createElement("p", { style: { padding: "0.5rem" } }, "Name of the query string parameter that will be appended to the URL above with the values provided below.")))), " ", /* @__PURE__ */ l.createElement(
      "input",
      {
        type: "text",
        ...
        onChange: (an) => {
          let rn = [...t.filters];
          rn[z].queryParameter = an.target.value, b({ ...t, filters: rn });
        }
      }
    )), /* @__PURE__ */ l.createElement("label", null, /* @__PURE__ */ l.createElement("span", { className: "edit-label column-heading" }, "Values"), " "), /* @__PURE__ */ l.createElement("ul", { className: "value-list" }, F.orderedValues && F.orderedValues.map((an, rn) => /* @__PURE__ */ l.createElement("li", null, an, /* @__PURE__ */ l.createElement(
      "input",
      {
        type: "text",
        ...
        onChange: (Gn) => {
          let jn = [...t.filters];
          jn[z].labels = jn[z].labels || {}, jn[z].labels[an] = Gn.target.value, b({ ...t, filters: jn });
        }
      }
      ...
      "button",
      {
        onClick: () => {
          let Gn = [...t.filters];
          Gn[z].labels && delete Gn[z].labels[Gn[z].orderedValues[rn]], Gn[z].orderedValues.splice(rn, 1), b({ ...t, filters: Gn });
        }
      },
      "X"
    )))), /* @__PURE__ */ l.createElement(
      "form",
      {
        onSubmit: (an) => {
          if (an.preventDefault(), !t.filters[z].orderedValues || t.filters[z].orderedValues.indexOf(an.target[0].value) === -1) {
            let rn = [...t.filters];
            rn[z].orderedValues = rn[z].orderedValues || [], rn[z].orderedValues.push(an.target[0].value), rn[z].values = rn[z].orderedValues, rn[z].active || (rn[z].active = an.target[0].value), an.target[0].value = "", b({ ...t, filters: rn });
          }
        }
      },
    ...
    "Add New URL Filter"
  )), Br = t.visualizationType !== "Box Plot" && t.visualizationType !== "Scatter Plot";
    ...
    let Cn = () => {
      if (C === t.type)
        ...
        C === "map" ? Vn.general = {
          ...
          geoType: O,
          type: En
        } : Vn.visualizationType = O, C === "chart" && (Vn.visualizationSubType = M ? "stacked" : "regular", Vn.orientation = Rn), c({ type: "EDITOR_SET_CONFIG", payload: Vn }), c({ type: "EDITOR_SET_GLOBALACTIVE", payload: 1 });
      }
    };
    return /* @__PURE__ */ l.createElement("button", { className: Nn, onClick: () => Cn(), "aria-label": P }, b, /* @__PURE__ */ l.createElement("span", { className: "mt-1" }, P));
  };
  return /* @__PURE__ */ l.createElement("div", { className: "choose-vis" }, /* @__PURE__ */ l.createElement("a", { href: "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/index.html", target: "_blank", rel: "noopener noreferrer", className: "guidance-link", style: { marginTop: 0, marginBottom: "2rem" } }, /* @__PURE__ */ l.createElement("div", null, /* @__PURE__ */ l.createElement("p", null, "For more information on the types of data visualizations in the WCMS, including examples and best practices, ", /* @__PURE__ */ l.createElement("u", null, "see the WCMS Features Gallery"), "."))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "General"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, " ", /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, { position: "right" }, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Dashboard", type: "dashboard", icon: /* @__PURE__ */ l.createElement(li, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Present multiple data visualizations with shared filter controls."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Data Bite", type: "data-bite", icon: /* @__PURE__ */ l.createElement(Ta, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Highlight a single aggregated value (e.g., sum or median)."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Waffle Chart", type: "waffle-chart", subType: "Waffle", icon: /* @__PURE__ */ l.createElement(Pa, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Highlight a piece of data in relationship to a data set."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Gauge Chart", type: "waffle-chart", subType: "Gauge", icon: /* @__PURE__ */ l.createElement(fi, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Specify the calculation of a single data point (such as a percentage value) and present it on a horizontal scale.")))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "Charts"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, { position: "right" }, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Bar", type: "chart", subType: "Bar", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Ea, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Use bars to show comparisons between data categories."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Line", type: "chart", subType: "Line", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Ia, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Present one or more data trends over time."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Pie", type: "chart", subType: "Pie", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(La, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Present the numerical proportions of a data series."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Paired Bar", type: "chart", subType: "Paired Bar", orientation: "horizontal", icon: /* @__PURE__ */ l.createElement(si, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Use paired bars to show comparisons between two different data categories."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Deviation Bar", type: "chart", subType: "Deviation Bar", orientation: "horizontal", stacked: !1, icon: /* @__PURE__ */ l.createElement(gi, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Use deviation bars to display how individual values differ from a target."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Horizontal Bar (Stacked)", type: "chart", subType: "Bar", orientation: "horizontal", stacked: !0, icon: /* @__PURE__ */ l.createElement(ci, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Use bars to show comparisons between data categories.")))), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Box Plot", type: "chart", subType: "Box Plot", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Ci, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Display a box plot"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Scatter Plot", type: "chart", subType: "Scatter Plot", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(yi, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Display a scatter plot"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Area Chart", type: "chart", subType: "Area Chart", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(di, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Display an area chart"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Forecast Chart", type: "chart", subType: "Forecasting", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(pi, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Display a forecasting chart"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "Sankey Diagram", type: "chart", subType: "Sankey", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(ka, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Display a sankey diagram")))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "Maps"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, { position: "right" }, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "United States (State- or County-Level)", type: "map", subType: "us", icon: /* @__PURE__ */ l.createElement(Io, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, { position: "right" }, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "United States (HHS Regions)", type: "map", subType: "us-region", icon: /* @__PURE__ */ l.createElement(Da, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "World", type: "map", subType: "world", icon: /* @__PURE__ */ l.createElement(Oa, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Present a choropleth map of the world."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "U.S. State", type: "map", subType: "single-state", icon: /* @__PURE__ */ l.createElement(Ba, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "Present a choropleth map of an individual U.S. state."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(tn, null, /* @__PURE__ */ l.createElement(tn.Target, null, /* @__PURE__ */ l.createElement(y, { label: "U.S. Geocode", type: "map", subType: "us-county", generalType: "us-geocode", icon: /* @__PURE__ */ l.createElement(Io, null) })), /* @__PURE__ */ l.createElement(tn.Content, null, "United States GeoCode")))));
}
function vi({ containerEl: t }) {
  const { config: f, setTempConfig: c, hostname: y, isDebug: b } = D.useContext(ce);
  let { type: P } = f;
  switch (P) {
    case "map":
      return /* @__PURE__ */ l.createElement(le, { component: "CdcMap" }, /* @__PURE__ */ l.createElement(wa, { isEditor: !0, isDebug: b, config: f, hostname: y, setConfig: c, containerEl: t }));
    case "waffle-chart":
...
const hi = (t) => {
  const f = [];
  t.rows && t.rows.forEach((c) => {
    if (c.footnotesId) {
      const { dataKey: y, staticFootnotes: b } = t.visualizations[c.footnotesId];
      !y && !(b != null && b.length) ? delete t.visualizations[c.footnotesId] : f.push(c.footnotesId);
    }
  }), t.visualizations && Object.keys(t.visualizations).forEach((c) => {
    t.visualizations[c].type === "footnotes" && !f.includes(c) && delete t.visualizations[c];
  });
}, Si = (t) => {
  t.datasets && Object.keys(t.datasets).forEach((f) => {
    delete t.datasets[f].formattedData, t.datasets[f].dataUrl && delete t.datasets[f].data;
  }), t.visualizations && Object.keys(t.visualizations).forEach((f) => {
    t.visualizations[f] = Rt.omit(t.visualizations[f], ["runtime", "formattedData", "data"]);
  }), t.rows && t.rows.forEach((f) => {
    f.dataKey && (f = Rt.omit(f, ["data", "formattedData"]));
  });
}, ya = (t) => {
  let f = { ...t };
  return f.type === "dashboard" ? (Si(f), hi(f)) : (delete f.runtime, delete f.formattedData, f.dataUrl && delete f.data), f;
}, wi = (t) => {
  if (t !== null) {
    let f = ya(t);
    const c = JSON.stringify(f), y = new CustomEvent("updateVizConfig", { detail: c, bubbles: !0 });
  ...
  if (t.type === "dashboard") {
    ...
    if (t.data || t.dataUrl) {
      ...
      y.datasets = {}, y.datasets[b] = {
        ...Rt.pick(t, ["data", "dataUrl", "dataFileSourceType"]),
        dataFileName: b
      }, Object.keys(y.visualizations).forEach((C) => {
        const O = { dataKey: b, ...Rt.pick(y, "dataDescription", "formattedData") };
        y.visualizations[C] = { ...y.visualizations[C], ...O };
    ...
    if ((f = t.dashboard) != null && f.filters) {
      ...
      const P = b.filters.map((C) => ({ ...C, key: C.label, showDropdown: !0, usedBy: Object.keys(y.visualizations) }));
      b.sharedFilters = [...b.sharedFilters, ...P], y.dashboard = { ...b, filters: void 0 };
    }
    if (c)
      return y;
  }
...
const bi = (t, f) => {
...
}, Ai = Ma(bi), Di = ({ config: t, hostname: f, containerEl: c, sharepath: y, isDebug: b }) => {
  const P = D.useMemo(() => {
    let un = 0;
    return (t != null && t.data || t != null && t.dataUrl) && (t != null && t.type) && (un = 2), { config: Mi(t || { newViz: !0, errors: [], currentViewport: "lg" }), errors: [], currentViewport: "lg", globalActive: un, sharepath: y, isDebug: b, hostname: f };
  }, [t]);
  D.useEffect(() => {
    var un;
    No && ((un = No) == null || un.init());
  }, []);
  const [C, O] = D.useReducer(Ai, P), Rn = (un) => {
    wi(JSON.parse(JSON.stringify(un))), O({ type: "EDITOR_TEMP_SAVE", payload: un });
  }, M = new fa((un) => {
    const Nn = un[0];
    let { width: Cn } = Nn.contentRect, dn = pa(Cn);
  ...
  return /* @__PURE__ */ l.createElement(ba, null, /* @__PURE__ */ l.createElement(ce.Provider, { value: { ...C, setTempConfig: Rn } }, /* @__PURE__ */ l.createElement(ke.Provider, { value: O }, /* @__PURE__ */ l.createElement("div", { className: `cdc-open-viz-module cdc-editor ${C.currentViewport}`, ref: En }, /* @__PURE__ */ l.createElement(Lu, { className: "top-level" }, /* @__PURE__ */ l.createElement(Le, { title: "1. Choose Visualization Type", className: "choose-type" }, /* @__PURE__ */ l.createElement(mi, null)), /* @__PURE__ */ l.createElement(Le, { title: "2. Import Data", className: "data-designer", disableRule: !C.config.type }, /* @__PURE__ */ l.createElement(ii, null)), /* @__PURE__ */ l.createElement(Le, { title: "3. Configure", className: "configure", disableRule: w }, /* @__PURE__ */ l.createElement(vi, { containerEl: c })))))), /* @__PURE__ */ l.createElement(Aa, null));
}, c0 = {
