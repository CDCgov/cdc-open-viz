...
import { I as fe, S as Ze } from "./storybook-d6b8e24c.es.js";
...
import { i as Ye, g as Ke } from "./storybook-7366772a.es.js";
import { n as et, D as tt } from "./storybook-28c41e3d.es.js";
import { f as at } from "./storybook-5637bace.es.js";
...
const ft = (t) => {
  const { configUrl: l, config: d, isDashboard: b = !1, isEditor: f = !1, setConfig: T, link: E } = t, D = {
    ...
    coveLoadedHasRan: !1,
    container: null
  }, [m, A] = g.useReducer(dt, D), { config: o, loading: N, currentViewport: I, coveLoadedHasRan: Z, container: q } = m, { title: B, dataColumn: U, dataFunction: P, imageData: S, biteBody: L, biteFontSize: j, dataFormat: W, biteStyle: M, filters: X, subtext: _ } = o, { innerContainerClasses: w, contentClasses: z } = nt(o), J = new tt(), ee = new Ye((i) => {
    for (let p of i) {
...
}, Ve = "Left", qe = "Right", je = "Top", Ge = "Bottom", Et = [Ve, qe, je, Ge], ht = "<", vt = ">", bt = "<=", yt = ">=", Nt = "=", _t = "≠", ye = [ht, vt, bt, yt, Nt, _t], Bt = {
...
const Mt = ["Data_Bite_Circle_Average", "Data_Bite_Text_Max_Pic", "Data_Bite_Circle_Sum", "Data_Bite_Text_Average_Pic"];
export {
