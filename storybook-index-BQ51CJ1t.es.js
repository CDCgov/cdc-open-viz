import { r as be, R as U } from "./storybook-index-9_ikpx_Z.es.js";
import { c as T, g as Ye } from "./storybook-_commonjsHelpers-BkfeUUK-.es.js";
var Z = {}, J = {};
(function(e) {
...
`, me = "/", ve = "*", O = "", zt = "comment", Bt = "declaration", Vt = function(e, t) {
  ...
  function o(d) {
    ...
    if (u.reason = d, u.filename = t.source, u.line = r, u.column = n, u.source = e, !t.silent) throw u;
  }
  function i(d) {
    var u = d.exec(e);
    if (u) {
  ...
  function k() {
    var d = l(), u = i(Dt);
    if (u) {
      if (h(), !i(Mt)) return o("property missing ':'");
      var E = i(Lt), qe = d({
        type: Bt,
