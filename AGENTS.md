...
| `docs/MODERNIZATION_SYSTEM.md`       | Working on modernization recipes, applicability, editor entry actions, selectable review, dashboard aggregation, runtime previews, or deciding between modernization and config migration.                                    |
