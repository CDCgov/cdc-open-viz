...
| `docs/DASHBOARD_CONDITIONS.md`     | Working on Modular Dashboards or dashboard-condition visibility logic. Covers condition config, target scoping, precomputed condition data, unresolved-vs-empty behavior, and v1 exclusions. |
