import { C as i } from "./storybook-2343a0bb.es.js";
...
const s = "chart", r = !1, l = {
...
}, n = "", c = !0, d = !1, p = "theme-blue", m = !1, h = "medium", u = "hover", D = "false", f = !1, g = "circle", b = "two-tone", x = "regular", y = "", L = "standard", C = "top", w = !1, v = {
...
], ra = "valid-area-chart.json", la = "file", na = {
  horizontal: !1,
  series: !1
}, ca = 4.23, da = 0, pa = {
  type: s,
  ...
  showChartBrush: ea,
  customColors: oa,
  visualizationType: ia,
  data: sa,
  dataFileName: ra,
  dataFileSourceType: la,
  dataDescription: na,
  validated: ca,
  dynamicMarginTop: da
}, Ua = {
