...
import { b as Tt, i as Ao, a as Ma, g as Aa } from "./storybook-6a0136d5.es.js";
import { C as kt, E as Ot, Z as ba, i as Da, M as Ra, j as Na, J as Ea, e as Ta, d as Ia, a as Tr, G as Pa, O as La } from "./storybook-ef5aab34.es.js";
import { P as Qn } from "./storybook-b8c9afe4.es.js";
import "./storybook-9c2b8003.es.js";
import { a as ka } from "./storybook-01170075.es.js";
import { D as Oa } from "./storybook-441ad5c2.es.js";
import { c as la } from "./storybook-c5d32002.es.js";
import { a as Ir, d as Pr, e as Ba, f as Fa, S as Ha, g as Wa, h as xa, i as Lr, j as Ga, k as Va } from "./storybook-2ad7d390.es.js";
import { f as kr } from "./storybook-b6bb4d22.es.js";
import { D as Ka } from "./storybook-0d7692d1.es.js";
import { T as on } from "./storybook-a16f6c8c.es.js";
import { S as qa } from "./storybook-ecf3351a.es.js";
import { E as lt } from "./storybook-a0c99f4a.es.js";
import { _ as gr } from "./storybook-80f88100.es.js";
...
function we(o, p) {
  var c = o + "", d = c.length;
  return d < p ? new Array(p - d + 1).join(0) + c : c;
}
function Xa(o) {
  return o < 0 ? "-" + we(-o, 6) : o > 9999 ? "+" + we(o, 6) : we(o, 4);
}
function ja(o) {
  var p = o.getUTCHours(), c = o.getUTCMinutes(), d = o.getUTCSeconds(), b = o.getUTCMilliseconds();
  return isNaN(o) ? "Invalid Date" : Xa(o.getUTCFullYear()) + "-" + we(o.getUTCMonth() + 1, 2) + "-" + we(o.getUTCDate(), 2) + (b ? "T" + we(p, 2) + ":" + we(c, 2) + ":" + we(d, 2) + "." + we(b, 3) + "Z" : d ? "T" + we(p, 2) + ":" + we(c, 2) + ":" + we(d, 2) + "Z" : c || p ? "T" + we(p, 2) + ":" + we(c, 2) + "Z" : "");
}
function Ya(o) {
  var p = new RegExp('["' + o + `
\r]`), c = o.charCodeAt(0);
  function d(M, an) {
    var gn, yn, mn = b(M, function(Kn, Cn) {
      if (gn)
        return gn(Kn, Cn - 1);
      yn = Kn, gn = an ? za(Kn, an) : sa(Kn);
    });
    return mn.columns = yn || [], mn;
  }
  function b(M, an) {
    var gn = [], yn = M.length, mn = 0, Kn = 0, Cn, Fn = yn <= 0, Mn = !1;
    M.charCodeAt(yn - 1) === It && --yn, M.charCodeAt(yn - 1) === pr && --yn;
    function Un() {
      if (Fn)
        return Cr;
      if (Mn)
        return Mn = !1, Or;
      var Dn, Vn = mn, An;
      if (M.charCodeAt(Vn) === dr) {
        for (; mn++ < yn && M.charCodeAt(mn) !== dr || M.charCodeAt(++mn) === dr; )
          ;
        return (Dn = mn) >= yn ? Fn = !0 : (An = M.charCodeAt(mn++)) === It ? Mn = !0 : An === pr && (Mn = !0, M.charCodeAt(mn) === It && ++mn), M.slice(Vn + 1, Dn - 1).replace(/""/g, '"');
      }
      for (; mn < yn; ) {
        if ((An = M.charCodeAt(Dn = mn++)) === It)
          Mn = !0;
        else if (An === pr)
          Mn = !0, M.charCodeAt(mn) === It && ++mn;
        else if (An !== c)
          continue;
  ...
  function y(M, an) {
    return an == null && (an = Br(M)), [an.map(Tn).join(o)].concat(T(M, an)).join(`
`);
  }
  function O(M, an) {
    return an == null && (an = Br(M)), T(M, an).join(`
`);
  }
  function Nn(M) {
    return M.map(w).join(`
`);
  ...
  function Tn(M) {
    return M == null ? "" : M instanceof Date ? ja(M) : p.test(M += "") ? '"' + M.replace(/"/g, '""') + '"' : M;
  }
  return {
    parse: d,
    parseRows: b,
...
function Ja(o, p) {
  ...
  try {
    for (; (p === void 0 || p-- > 0) && !(b = d.next()).done; )
      T.push(b.value);
  } catch (O) {
    y = { error: O };
  } finally {
...
function Bt(o, p) {
  ...
  if (typeof c.path != "string") {
    ...
    Object.defineProperty(c, "path", {
      value: typeof p == "string" ? p : typeof d == "string" && d.length > 0 ? d : o.name,
      writable: !1,
      configurable: !1,
      enumerable: !0
    });
...
function Qa(o) {
  ...
  if (c && !o.type) {
    var d = p.split(".").pop().toLowerCase(), b = Za.get(d);
...
function eu(o) {
  return ct(this, void 0, void 0, function() {
    return yt(this, function(p) {
      return Io(o) && tu(o) ? [2, uu(o.dataTransfer, o.type)] : ou(o) ? [2, ru(o)] : Array.isArray(o) && o.every(function(c) {
...
function ru(o) {
  return mr(o.target.files).map(function(p) {
    return Bt(p);
  });
}
function au(o) {
  return ct(this, void 0, void 0, function() {
    ...
    return yt(this, function(c) {
      switch (c.label) {
        ...
        case 1:
          return p = c.sent(), [2, p.map(function(d) {
            return Bt(d);
          })];
      }
    });
...
function uu(o, p) {
  return ct(this, void 0, void 0, function() {
    ...
    return yt(this, function(b) {
      switch (b.label) {
        case 0:
          return o === null ? [2, []] : o.items ? (c = mr(o.items).filter(function(T) {
            return T.kind === "file";
          }), p !== "drop" ? [2, c] : [4, Promise.all(c.map(iu))]) : [3, 2];
        case 1:
          return d = b.sent(), [2, Fr(ca(d))];
        case 2:
          return [2, Fr(mr(o.files).map(function(T) {
            return Bt(T);
          }))];
      }
    });
...
function iu(o) {
  ...
  return p && p.isDirectory ? ya(p) : Hr(o);
}
function ca(o) {
  return o.reduce(function(p, c) {
    return $a(p, Array.isArray(c) ? ca(c) : [c]);
  }, []);
}
function Hr(o) {
  var p = o.getAsFile();
...
function lu(o) {
  return ct(this, void 0, void 0, function() {
    return yt(this, function(p) {
      return [2, o.isDirectory ? ya(o) : su(o)];
    });
  });
}
function ya(o) {
          ...
          return yt(this, function(M) {
            switch (M.label) {
              ...
              case 4:
                return [3, 6];
              case 5:
                Tn = Promise.all(O.map(lu)), b.push(Tn), T(), M.label = 6;
              case 6:
                return [
                  2
                  /*return*/
...
var cu = function(o, p) {
  if (o && p) {
    var c = Array.isArray(p) ? p : p.split(","), d = o.name || "", b = (o.type || "").toLowerCase(), T = b.replace(/\/.*$/, "");
...
function xr(o) {
  for (var p = 1; p < arguments.length; p++) {
    ...
    p % 2 ? Wr(Object(c), !0).forEach(function(d) {
      Ca(o, d, c[d]);
...
function Vr(o, p) {
  ...
  for (var c = 0, d = new Array(p); c < p; c++)
    d[c] = o[c];
  return d;
}
function du(o, p) {
  ...
  if (c != null) {
    var d = [], b = !0, T = !1, y, O;
    try {
      for (c = c.call(o); !(b = (y = c.next()).done) && (d.push(y.value), !(p && d.length === p)); b = !0)
        ;
    } catch (Nn) {
      T = !0, O = Nn;
    } finally {
...
var fu = "file-invalid-type", gu = "file-too-large", mu = "file-too-small", hu = "too-many-files", vu = function(p) {
...
function da(o, p) {
  var c = o.type === "application/x-moz-file" || cu(o, p);
  return [c, c ? null : vu(p)];
}
function pa(o, p, c) {
  if (Pt(o.size))
    if (Pt(p) && Pt(c)) {
...
function wu(o) {
  var p = o.files, c = o.accept, d = o.minSize, b = o.maxSize, T = o.multiple, y = o.maxFiles;
  return !T && p.length > 1 || T && y >= 1 && p.length > y ? !1 : p.every(function(O) {
    var Nn = da(O, c), w = Gr(Nn, 1), Tn = w[0], M = pa(O, d, b), an = Gr(M, 1), gn = an[0];
    return Tn && gn;
  });
}
function Po(o) {
...
function Le() {
  ...
  return function(d) {
    ...
    return p.some(function(O) {
      return !Po(d) && O && O.apply(void 0, [d].concat(T)), Po(d);
    });
  };
}
function Xr() {
...
var Ru = ["children"], Nu = ["open"], Eu = ["refKey", "role", "onKeyDown", "onFocus", "onBlur", "onClick", "onDragEnter", "onDragOver", "onDragLeave", "onDrop"], Tu = ["refKey", "onChange", "onClick"];
function Iu(o) {
  return ku(o) || Lu(o) || fa(o) || Pu();
}
function Pu() {
...
function te(o) {
  for (var p = 1; p < arguments.length; p++) {
    var c = arguments[p] != null ? arguments[p] : {};
    p % 2 ? jr(Object(c), !0).forEach(function(d) {
      vr(o, d, c[d]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(c)) : jr(Object(c)).forEach(function(d) {
      Object.defineProperty(o, d, Object.getOwnPropertyDescriptor(c, d));
    });
  }
  return o;
...
function Lo(o, p) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (b = 0; b < T.length; b++)
      d = T[b], !(p.indexOf(d) >= 0) && Object.prototype.propertyIsEnumerable.call(o, d) && (c[d] = o[d]);
  }
  return c;
}
function Hu(o, p) {
  ...
  for (T = 0; T < d.length; T++)
    b = d[T], !(p.indexOf(b) >= 0) && (c[b] = o[b]);
  return c;
}
var br = /* @__PURE__ */ A.forwardRef(function(o, p) {
  var c = o.children, d = Lo(o, Ru), b = wr(d), T = b.open, y = Lo(b, Nu);
  return A.useImperativeHandle(p, function() {
    return {
      open: T
    };
...
function wr() {
  var o = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, p = te(te({}, ga), o), c = p.accept, d = p.disabled, b = p.getFilesFromEvent, T = p.maxSize, y = p.minSize, O = p.multiple, Nn = p.maxFiles, w = p.onDragEnter, Tn = p.onDragLeave, M = p.onDragOver, an = p.onDrop, gn = p.onDropAccepted, yn = p.onDropRejected, mn = p.onFileDialogCancel, Kn = p.onFileDialogOpen, Cn = p.useFsAccessApi, Fn = p.preventDropOnDocument, Mn = p.noClick, Un = p.noKeyboard, Gn = p.noDrag, Dn = p.noDragEventsBubbling, Vn = p.validator, An = A.useMemo(function() {
    return typeof Kn == "function" ? Kn : Yr;
  }, [Kn]), le = A.useMemo(function() {
    return typeof mn == "function" ? mn : Yr;
  }, [mn]), $n = A.useRef(null), Wn = A.useRef(null), oe = A.useReducer(Wu, Sr), se = fr(oe, 2), ne = se[0], ee = se[1], Ee = ne.isFocused, De = ne.isFileDialogActive, ve = ne.draggedFiles, Te = function() {
    De && setTimeout(function() {
      if (Wn.current) {
        var In = Wn.current.files;
        In.length || (ee({
          type: "closeDialog"
        }), le());
      }
  ...
  A.useEffect(function() {
    return Fn && (document.addEventListener("dragover", zr, !1), document.addEventListener("drop", Ie, !1)), function() {
      Fn && (document.removeEventListener("dragover", zr), document.removeEventListener("drop", Ie));
    };
  }, [$n, Fn]);
  var ce = A.useCallback(function(Z) {
    Z.preventDefault(), Z.persist(), ke(Z), ge.current = [].concat(Iu(ge.current), [Z.target]), bo(Z) && Promise.resolve(b(Z)).then(function(In) {
      Po(Z) && !Dn || (ee({
        draggedFiles: In,
        isDragActive: !0,
    ...
    Z.forEach(function(me) {
      var Be = da(me, c), Ne = fr(Be, 2), Ye = Ne[0], _e = Ne[1], Ue = pa(me, y, T), Ge = fr(Ue, 2), Je = Ge[0], Ve = Ge[1], Ke = Vn ? Vn(me) : null;
      if (Ye && Je && !Ke)
        re.push(me);
      else {
        var Fe = [_e, Ve];
    ...
    Z.preventDefault(), Z.persist(), ke(Z), ge.current = [], bo(Z) && Promise.resolve(b(Z)).then(function(In) {
      Po(Z) && !Dn || Re(In, Z);
    }), ee({
      type: "reset"
    });
  }, [b, Re, Dn]), H = A.useCallback(function() {
    if (Cn && Xr()) {
      ee({
        type: "openDialog"
      }), An();
    ...
    Wn.current && (ee({
      type: "openDialog"
    }), An(), Wn.current.value = null, Wn.current.click());
  }, [ee, An, le, Cn, Re, c, O]), V = A.useCallback(function(Z) {
    !$n.current || !$n.current.isEqualNode(Z.target) || (Z.keyCode === 32 || Z.keyCode === 13) && (Z.preventDefault(), H());
  }, [$n, Wn, H]), nn = A.useCallback(function() {
    ee({
      type: "focus"
    });
    ...
    Mn || (bu() ? setTimeout(H, 0) : H());
  }, [Wn, Mn, H]), jn = function(In) {
    return d ? null : In;
  }, ue = function(In) {
    ...
    return function() {
      var Z = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, In = Z.refKey, re = In === void 0 ? "ref" : In, ye = Z.role, me = Z.onKeyDown, Be = Z.onFocus, Ne = Z.onBlur, Ye = Z.onClick, _e = Z.onDragEnter, Ue = Z.onDragOver, Ge = Z.onDragLeave, Je = Z.onDrop, Ve = Lo(Z, Eu);
      return te(te(vr({
  ...
  }, [$n, V, nn, rn, kn, ce, Me, Ae, Se, Un, Gn, d]), He = A.useCallback(function(Z) {
    Z.stopPropagation();
  }, []), We = A.useMemo(function() {
    return function() {
      var Z = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, In = Z.refKey, re = In === void 0 ? "ref" : In, ye = Z.onChange, me = Z.onClick, Be = Lo(Z, Tu), Ne = vr({
        accept: c,
        multiple: O,
        type: "file",
        style: {
  ...
  }, [Wn, c, O, Se, d]), xe = ve.length, Jn = xe > 0 && wu({
    files: ve,
    accept: c,
    minSize: y,
    maxSize: T,
...
function Wu(o, p) {
  switch (p.type) {
    ...
    case "setDraggedFiles":
      var c = p.isDragActive, d = p.draggedFiles;
      return te(te({}, o), {}, {
        draggedFiles: d,
        isDragActive: c
      });
...
const Lt = ({ children: o, className: p = "" }) => /* @__PURE__ */ i.createElement("div", { className: `tab-content ${p}` }, o), xu = (o) => {
  const { globalActive: p } = A.useContext(kt), c = A.useContext(Ot), d = (b) => {
    c({ type: "EDITOR_SET_GLOBALACTIVE", payload: b });
  };
  return /* @__PURE__ */ i.createElement(ma, { ...o, setActiveTab: d, activeTab: p });
}, Gu = ({ children: o, className: p = void 0, startingTab: c }) => {
  const [d, b] = A.useState(c);
  return /* @__PURE__ */ i.createElement(ma, { className: p, setActiveTab: b, activeTab: d }, o);
}, ma = ({ children: o, className: p, activeTab: c, setActiveTab: d }) => {
  const b = (O, Nn) => {
    O || d(Nn);
  };
  let T = "tabs";
...
var Mr = { exports: {} }, Do = { exports: {} }, _r;
function Vu() {
  return _r || (_r = 1, function(o, p) {
    (function(c, d) {
      d(p, A);
    })(la, function(c, d) {
        ...
        if (typeof l == "string") {
          ...
          l = function(g) {
            return function(v, R, E) {
              if (!R)
                return v;
              var I, K = typeof R == "function" ? R : JSON.stringify(R), W = se.get(K) || function() {
                var x = function(L) {
      ...
      function oe(n, a, l) {
        ...
        for (var s = [], h = n, g = 0, v = function() {
          ...
          var E = { headers: [] }, I = [], K = h.some(function(W) {
            return W.parent;
          });
          h.forEach(function(W) {
            var x, L = [].concat(I).reverse()[0];
            K && (W.parent ? x = y({}, W.parent, { originalId: W.parent.id, id: W.parent.id + "_" + v(), headers: [W] }, l(W)) : x = Wn(y({ originalId: W.id + "_placeholder", id: W.id + "_placeholder_" + v(), placeholderOf: W, headers: [W] }, l(W)), a), L && L.originalId === x.originalId ? L.headers.push(W) : I.push(x)), E.headers.push(W);
          }), s.push(E), h = I;
        }; h.length; )
          R();
        return s.reverse();
      ...
      function De(n, a) {
        ...
        return n.forEach(function(R) {
          return function E(I, K) {
            K === void 0 && (K = !0), I.isExpanded = I.original && I.original[l] || s[I.id], I.canExpand = I.subRows && !!I.subRows.length, K && v.push(I), I.subRows && I.subRows.length && I.isExpanded && I.subRows.forEach(function(W) {
              return E(W, g);
            });
          }(R);
        }), v;
      ...
      var ue = function(n) {
        n.getToggleHiddenProps = [be], n.getToggleHideAllColumnsProps = [ke], n.stateReducers.push(Oe), n.useInstanceBeforeDimensions.push(He), n.headerGroupsDeps.push(function(a, l) {
          var s = l.instance;
      ...
      function We(n) {
        var a = n.columns, l = n.flatHeaders, s = n.dispatch, h = n.allColumns, g = n.getHooks, v = n.state.hiddenColumns, R = n.autoResetHiddenColumns, E = R === void 0 || R, I = Mn(n), K = h.length === v.length, W = d.useCallback(function(U, un) {
        ...
        }, [s, a]), Object.assign(n, { allColumnsHidden: K, toggleHideColumn: W, setHiddenColumns: x, toggleHideAllColumns: L, getToggleHideAllColumnsProps: F });
      }
      ...
      function ye(n) {
        var a = n.initialState, l = a === void 0 ? xe : a, s = n.defaultColumn, h = s === void 0 ? Jn : s, g = n.getSubRows, v = g === void 0 ? Z : g, R = n.getRowId, E = R === void 0 ? In : R, I = n.stateReducer, K = I === void 0 ? Xn : I, W = n.useControlledState, x = W === void 0 ? re : W;
      ...
      function me(n, a) {
        ...
        return n.forEach(function(v) {
          ...
          if (v.totalLeft = a, R && R.length) {
            var E = me(R, a), I = E[0], K = E[1], W = E[2], x = E[3];
            v.totalMinWidth = I, v.totalWidth = K, v.totalMaxWidth = W, v.totalFlexWidth = x;
          } else
      ...
      function Ue(n, a, l, s) {
        ...
        if (a.type === w.toggleRowExpanded) {
          var E, I = a.id, K = a.value, W = n.expanded[I], x = K !== void 0 ? K : !W;
          if (!W && x)
      ...
      function Ge(n) {
        var a = n.data, l = n.rows, s = n.rowsById, h = n.manualExpandedKey, g = h === void 0 ? "expanded" : h, v = n.paginateExpandedRows, R = v === void 0 || v, E = n.expandSubRows, I = E === void 0 || E, K = n.autoResetExpanded, W = K === void 0 || K, x = n.getHooks, L = n.plugins, F = n.state.expanded, j = n.dispatch;
        Cn(L, ["useSortBy", "useGroupBy", "usePivotColumns", "useGlobalFilter"], "useExpanded");
        var U = Mn(W), un = !!(Object.keys(s).length && Object.keys(F).length);
      ...
      var $e = Object.freeze({ __proto__: null, text: Ve, exactText: Ke, exactTextCase: Fe, includes: rt, includesAll: Ct, includesSome: Ft, includesValue: dt, exact: Ht, equals: Wt, between: xt });
      ...
      function Oo(n, a, l, s) {
        ...
        if (a.type === w.setFilter) {
          ...
          return Te(I.autoRemove, W, E) ? y({}, n, { filters: n.filters.filter(function(j) {
            return j.id !== h;
          }) }) : y({}, n, K ? { filters: n.filters.map(function(j) {
            return j.id === h ? { id: h, value: W } : j;
          }) } : { filters: [].concat(n.filters, [{ id: h, value: W }]) });
        }
      ...
      function Vt(n) {
        var a = n.data, l = n.rows, s = n.flatRows, h = n.rowsById, g = n.allColumns, v = n.filterTypes, R = n.manualFilters, E = n.defaultCanFilter, I = E !== void 0 && E, K = n.disableFilters, W = n.state.filters, x = n.dispatch, L = n.autoResetFilters, F = L === void 0 || L, j = d.useCallback(function(en, Sn) {
        ...
        var un = d.useMemo(function() {
          ...
          return [function xn(dn, hn) {
            hn === void 0 && (hn = 0);
            var zn = dn;
            return (zn = W.reduce(function(bn, qn) {
              var e = qn.id, t = qn.value, u = g.find(function(f) {
                return f.id === e;
              });
              if (!u)
                return bn;
        ...
        }, [R, W, l, s, h, g, v]), Pn = un[0], ln = un[1], q = un[2];
        d.useMemo(function() {
          g.filter(function(en) {
            return !W.find(function(Sn) {
              return Sn.id === en.id;
            });
          }).forEach(function(en) {
      ...
      function qt(n) {
        var a = n.data, l = n.rows, s = n.flatRows, h = n.rowsById, g = n.allColumns, v = n.filterTypes, R = n.globalFilter, E = n.manualGlobalFilter, I = n.state.globalFilter, K = n.dispatch, W = n.autoResetGlobalFilter, x = W === void 0 || W, L = n.disableGlobalFilter, F = d.useCallback(function(q) {
      ...
      var mt = function(n) {
        ...
        }), n.visibleColumns.push(Yt), n.useInstance.push(Fo), n.prepareRow.push(_t);
      };
      ...
      var Bo = {};
      function Fo(n) {
        var a = n.data, l = n.rows, s = n.flatRows, h = n.rowsById, g = n.allColumns, v = n.flatHeaders, R = n.groupByFn, E = R === void 0 ? Ut : R, I = n.manualGroupBy, K = n.aggregations, W = K === void 0 ? Bo : K, x = n.plugins, L = n.state.groupBy, F = n.dispatch, j = n.autoResetGroupBy, U = j === void 0 || j, un = n.disableGroupBy, Pn = n.defaultCanGroupBy, ln = n.getHooks;
        Cn(x, ["useColumnOrder", "useFilters"], "useGroupBy");
        var q = Mn(n);
        g.forEach(function(u) {
          var r = u.accessor, f = u.defaultGroupBy, m = u.disableGroupBy;
          u.canGroupBy = r ? ne(u.canGroupBy, m !== !0 && void 0, un !== !0 && void 0, !0) : ne(u.canGroupBy, f, Pn, !1), u.canGroupBy && (u.toggleGroupBy = function() {
        ...
        var Sn = d.useMemo(function() {
          ...
          var u = L.filter(function(P) {
          ...
          }), r = [], f = {}, m = [], C = {}, S = [], D = {}, N = function P(z, B, G) {
            ...
            return Object.entries(k).map(function(Q, cn) {
              var fn = Q[0], _ = Q[1], En = X + ":" + fn, Hn = P(_, B + 1, En = G ? G + ">" + En : En), J = B ? Ee(_, "leafRows") : _, Y = function(sn, Ln, On) {
                var Yn = {};
                return g.forEach(function(tn) {
                  if (u.includes(tn.id))
                    Yn[tn.id] = Ln[0] ? Ln[0].values[tn.id] : null;
                  else {
                    var Ce = typeof tn.aggregate == "function" ? tn.aggregate : W[tn.aggregate] || gt[tn.aggregate];
                    if (Ce) {
                      var Bn = Ln.map(function(wn) {
                        ...
                        if (!On && tn.aggregateValue) {
                          var pe = typeof tn.aggregateValue == "function" ? tn.aggregateValue : W[tn.aggregateValue] || gt[tn.aggregateValue];
                          if (!pe)
              ...
              }(J, _, B), $ = { id: En, isGrouped: !0, groupByID: X, groupByVal: fn, values: Y, subRows: Hn, leafRows: J, depth: B, index: cn };
              return Hn.forEach(function(sn) {
                r.push(sn), f[sn.id] = sn, sn.isGrouped ? (m.push(sn), C[sn.id] = sn) : (S.push(sn), D[sn.id] = sn);
              }), $;
            });
          }(l);
          return N.forEach(function(P) {
            r.push(P), f[P.id] = P, P.isGrouped ? (m.push(P), C[P.id] = P) : (S.push(P), D[P.id] = P);
          }), [N, r, f, m, C, S, D];
        }, [I, L, l, s, h, g, W, E]), xn = Sn[0], dn = Sn[1], hn = Sn[2], zn = Sn[3], bn = Sn[4], qn = Sn[5], e = Sn[6], t = Mn(U);
        Gn(function() {
      ...
      var Ho = Object.freeze({ __proto__: null, alphanumeric: function(n, a, l) {
      ...
      function xo(n, a, l, s) {
        ...
        if (a.type === w.toggleSortBy) {
          var h, g = a.columnId, v = a.desc, R = a.multi, E = s.allColumns, I = s.disableMultiSort, K = s.disableSortRemove, W = s.disableMultiRemove, x = s.maxMultiSortColCount, L = x === void 0 ? Number.MAX_SAFE_INTEGER : x, F = n.sortBy, j = E.find(function(q) {
            return q.id === g;
          ...
          return (h = !I && R ? U ? "toggle" : "add" : un !== F.length - 1 || F.length !== 1 ? "replace" : U ? "toggle" : "replace") != "toggle" || K || Pn || R && W || !(U && U.desc && !j || !U.desc && j) || (h = "remove"), h === "replace" ? ln = [{ id: g, desc: Pn ? v : j }] : h === "add" ? (ln = [].concat(F, [{ id: g, desc: Pn ? v : j }])).splice(0, ln.length - L) : h === "toggle" ? ln = F.map(function(q) {
      ...
      function Go(n) {
        var a = n.data, l = n.rows, s = n.flatRows, h = n.allColumns, g = n.orderByFn, v = g === void 0 ? Qt : g, R = n.sortTypes, E = n.manualSortBy, I = n.defaultCanSort, K = n.disableSortBy, W = n.flatHeaders, x = n.state.sortBy, L = n.dispatch, F = n.plugins, j = n.getHooks, U = n.autoResetSortBy, un = U === void 0 || U;
      ...
      function Ko(n) {
        var a = n.rows, l = n.autoResetPage, s = l === void 0 || l, h = n.manualExpandedKey, g = h === void 0 ? "expanded" : h, v = n.plugins, R = n.pageCount, E = n.paginateExpandedRows, I = E === void 0 || E, K = n.expandSubRows, W = K === void 0 || K, x = n.state, L = x.pageSize, F = x.pageIndex, j = x.expanded, U = x.globalFilter, un = x.filters, Pn = x.groupBy, ln = x.sortBy, q = n.dispatch, Rn = n.data, en = n.manualPagination;
        ...
        var xn = en ? R : Math.ceil(a.length / L), dn = d.useMemo(function() {
          return xn > 0 ? [].concat(new Array(xn)).fill(null).map(function(r, f) {
            return f;
          }) : [];
          ...
          return I ? r : De(r, { manualExpandedKey: g, expanded: j, expandSubRows: W });
        }, [W, j, g, en, F, L, I, a]), zn = F > 0, bn = xn === -1 ? hn.length >= L : F < xn - 1, qn = d.useCallback(function(r) {
      ...
      var vt = function(n) {
        n.getPivotToggleProps = [qo], n.stateReducers.push(zo), n.useInstanceAfterData.push(Xo), n.allColumns.push(jo), n.accessValue.push(Yo), n.materializedColumns.push(eo), n.materializedColumnsDeps.push(to), n.visibleColumns.push(_o), n.visibleColumnsDeps.push(Uo), n.useInstance.push(Jo), n.prepareRow.push($o);
      };
      vt.pluginName = "usePivotColumns";
      var no = [], qo = function(n, a) {
        var l = a.header;
      ...
      function eo(n, a) {
        ...
        var g = h.pivotColumns.map(function(E) {
          ...
          return x ? Array.from(x.uniqueValues).sort().map(function(L) {
            ...
            return F.columns = E(I + 1, F, [].concat(W, [function(j) {
      ...
      function Jo(n) {
        var a = n.columns, l = n.allColumns, s = n.flatHeaders, h = n.getHooks, g = n.plugins, v = n.dispatch, R = n.autoResetPivot, E = R === void 0 || R, I = n.manaulPivot, K = n.disablePivot, W = n.defaultCanPivot;
        Cn(g, ["useGroupBy"], "usePivotColumns");
        var x = Mn(n);
        l.forEach(function(F) {
          var j = F.accessor, U = F.defaultPivot, un = F.disablePivot;
          F.canPivot = j ? ne(F.canPivot, un !== !0 && void 0, K !== !0 && void 0, !0) : ne(F.canPivot, U, W, !1), F.canPivot && (F.togglePivot = function() {
      ...
      var oo = function(n) {
        n.getToggleRowSelectedProps = [St], n.getToggleAllRowsSelectedProps = [nt], n.getToggleAllPageRowsSelectedProps = [ro], n.stateReducers.push(Zo), n.useInstance.push(ao), n.prepareRow.push(Qo);
      };
      ...
      function Zo(n, a, l, s) {
        ...
        if (a.type === w.toggleRowSelected) {
          var W = a.id, x = a.value, L = s.rowsById, F = s.selectSubRows, j = F === void 0 || F, U = s.getSubRows, un = n.selectedRowIds[W], Pn = x !== void 0 ? x : !un;
          if (un === Pn)
            return n;
      ...
      function ao(n) {
        var a = n.data, l = n.rows, s = n.getHooks, h = n.plugins, g = n.rowsById, v = n.nonGroupedRowsById, R = v === void 0 ? g : v, E = n.autoResetSelectedRows, I = E === void 0 || E, K = n.state.selectedRowIds, W = n.selectSubRows, x = W === void 0 || W, L = n.dispatch, F = n.page, j = n.getSubRows;
      ...
      var wt = function(n) {
        n.stateReducers.push(nr), n.useInstance.push(lo), n.prepareRow.push(er);
      };
      function nr(n, a, l, s) {
        ...
        if (a.type === w.setRowState) {
          var I, K = a.rowId, W = a.value, x = n.rowState[K] !== void 0 ? n.rowState[K] : g(E[K]);
          return y({}, n, { rowState: y({}, n.rowState, (I = {}, I[K] = Fn(W, x), I)) });
        }
      ...
      var so = function(n) {
        ...
        }), n.visibleColumns.push(yo), n.useInstance.push(tr);
      };
      function co(n, a, l, s) {
      ...
      var Co = function(n) {
        n.getResizerProps = [or], n.getHeaderProps.push({ style: { position: "relative" } }), n.stateReducers.push(rr), n.useInstance.push(ur), n.useInstanceBeforeDimensions.push(ar);
      }, or = function(n, a) {
        var l = a.instance, s = a.header, h = l.dispatch, g = function(v, R) {
          ...
          document.addEventListener(un.moveEvent, un.moveHandler, Pn), document.addEventListener(un.upEvent, un.upHandler, Pn), h({ type: w.columnStartResizing, columnId: R.id, columnWidth: R.totalWidth, headerIdWidths: W, clientX: x });
        };
      ...
      function rr(n, a) {
        ...
        if (a.type === w.columnResizing) {
          var v = a.clientX, R = n.columnResizing, E = R.startX, I = R.columnWidth, K = R.headerIdWidths, W = (v - E) / I, x = {};
          return (K === void 0 ? [] : K).forEach(function(L) {
            var F = L[0], j = L[1];
            x[F] = Math.max(j + j * W, 0);
      ...
      var Mt = { position: "absolute", top: 0 }, po = function(n) {
      ...
      function Dt(n) {
        n.getTableProps.push(ir), n.getRowProps.push(Rt), n.getHeaderGroupProps.push(Rt), n.getFooterGroupProps.push(Rt), n.getHeaderProps.push(lr), n.getCellProps.push(sr), n.getFooterProps.push(cr);
      }
      ...
      function So(n, a, l, s) {
        ...
        if (a.type === w.columnResizing) {
          var W = a.clientX, x = n.columnResizing.startX, L = n.gridLayout, F = L.columnWidth, j = L.minWidths, U = L.maxWidths, un = L.headerIdGridWidths, Pn = (W - x) / F, ln = {};
      ...
      c._UNSTABLE_usePivotColumns = vt, c.actions = w, c.defaultColumn = an, c.defaultGroupByFn = Ut, c.defaultOrderByFn = Qt, c.defaultRenderer = Tn, c.emptyRenderer = M, c.ensurePluginOrder = Cn, c.flexRender = Vn, c.functionalUpdate = Fn, c.loopHooks = Kn, c.makePropGetter = yn, c.makeRenderer = Dn, c.reduceHooks = mn, c.safeUseLayoutEffect = Un, c.useAbsoluteLayout = po, c.useAsyncDebounce = function(n, a) {
              ...
              for (; ; )
                switch (W.prev = W.next) {
                  case 0:
                    ...
                    })), h()), W.abrupt("return", l.current.promise);
                  case 5:
                  case "end":
                    return W.stop();
                }
      ...
      }, c.useBlockLayout = fo, c.useColumnOrder = so, c.useExpanded = Ne, c.useFilters = Gt, c.useFlexLayout = Dt, c.useGetLatest = Mn, c.useGlobalFilter = pt, c.useGridLayout = go, c.useGroupBy = mt, c.useMountedLayoutEffect = Gn, c.usePagination = ht, c.useResizeColumns = Co, c.useRowSelect = oo, c.useRowState = wt, c.useSortBy = Zt, c.useTable = function(n) {
        ...
        var R = g(), E = R.data, I = R.columns, K = R.initialState, W = R.defaultColumn, x = R.getSubRows, L = R.getRowId, F = R.stateReducer, j = R.useControlledState, U = Mn(F), un = d.useCallback(function(C, S) {
          if (!S.type)
        ...
        }, [v, Sn, g, W].concat(mn(v().visibleColumnsDeps, [], { instance: g() })));
        ...
        var qn = d.useMemo(function() {
          return mn(v().headerGroups, oe(bn, W), g());
        }, [v, bn, W, g].concat(mn(v().headerGroupsDeps, [], { instance: g() })));
        g().headerGroups = qn;
        ...
        var u = me(e), r = u[0], f = u[1], m = u[2];
        return g().totalColumnsMinWidth = r, g().totalColumnsWidth = f, g().totalColumnsMaxWidth = m, Kn(v().useInstance, g()), [].concat(g().flatHeaders, g().allColumns).forEach(function(C) {
...
var Ro = { exports: {} }, Ur;
function Ku() {
  return Ur || (Ur = 1, function(o, p) {
    (function(c, d) {
      d(p, A);
    })(la, function(c, d) {
      d = d && Object.prototype.hasOwnProperty.call(d, "default") ? d.default : d;
      function b(e, t, u, r, f, m, C) {
        try {
        ...
        S.done ? t(D) : Promise.resolve(D).then(r, f);
      }
      function T(e) {
        return function() {
      ...
      function O(e, t) {
        if (e == null)
          return {};
        var u = {}, r = Object.keys(e), f, m;
        for (m = 0; m < r.length; m++)
          f = r[m], !(t.indexOf(f) >= 0) && (u[f] = e[f]);
        return u;
      }
      function Nn(e, t) {
      ...
      var Cn = function(t, u) {
        return u === void 0 && (u = {}), function(r) {
          return r === void 0 && (r = {}), [].concat(t, [r]).reduce(function(f, m) {
            return Kn(f, m, y({}, u, {
              userProps: r
            }));
          }, {});
        ...
        return r === void 0 && (r = {}), t.forEach(function(f) {
          var m = f(u, r);
          if (typeof m < "u")
...
`);
      ...
      function $n(e, t, u) {
        return u === void 0 && (u = {}), function(r, f) {
          f === void 0 && (f = {});
      ...
      function Te(e, t, u) {
        ...
        for (var r = [], f = e, m = 0, C = function() {
          return m++;
        }, S = function() {
          var N = {
            headers: []
          }, P = [], z = f.some(function(B) {
            return B.parent;
          });
      ...
      function Ie(e, t, u) {
        if (!t)
          return e;
        var r = typeof t == "function" ? t : JSON.stringify(t), f = ge.get(r) || function() {
          var C = ue(t);
          return ge.set(r, C), C;
        }(), m;
        try {
      ...
      function Re(e, t) {
        var u = t.manualExpandedKey, r = t.expanded, f = t.expandSubRows, m = f === void 0 ? !0 : f, C = [], S = function D(N, P) {
      ...
      function Ye(e) {
        var t = e.columns, u = e.flatHeaders, r = e.dispatch, f = e.allColumns, m = e.getHooks, C = e.state.hiddenColumns, S = e.autoResetHiddenColumns, D = S === void 0 ? !0 : S, N = Dn(e), P = f.length === C.length, z = d.useCallback(function(Q, cn) {
          return r({
      ...
      function Fe(e) {
        var t = e.initialState, u = t === void 0 ? _e : t, r = e.defaultColumn, f = r === void 0 ? Ue : r, m = e.getSubRows, C = m === void 0 ? Je : m, S = e.getRowId, D = S === void 0 ? Ve : S, N = e.stateReducer, P = N === void 0 ? Ge : N, z = e.useControlledState, B = z === void 0 ? Ke : z, G = O(e, ["initialState", "defaultColumn", "getSubRows", "getRowId", "stateReducer", "useControlledState"]);
        return y({}, G, {
          initialState: u,
          defaultColumn: f,
          getSubRows: C,
      ...
      var rt = function(t) {
        for (var u = arguments.length, r = new Array(u > 1 ? u - 1 : 0), f = 1; f < u; f++)
          r[f - 1] = arguments[f];
        ...
        Object.assign(C(), y({}, t, {
          plugins: r,
          hooks: In()
        })), r.filter(Boolean).forEach(function(pn) {
          pn(C().hooks);
        });
        var S = Dn(C().hooks);
        C().getHooks = S, delete C().hooks, Object.assign(C(), Fn(S().useOptions, Fe(t)));
        var D = C(), N = D.data, P = D.columns, z = D.initialState, B = D.defaultColumn, G = D.getSubRows, X = D.getRowId, k = D.stateReducer, Q = D.useControlledState, cn = Dn(k), fn = d.useCallback(function(pn, Zn) {
          if (!Zn.type)
            throw console.info({
              action: Zn
            }), new Error("Unknown Action 👆");
          return [].concat(S().stateReducers, Array.isArray(cn()) ? cn() : [cn()]).reduce(function(ie, he) {
            return he(ie, Zn, pn, C()) || ie;
          }, pn);
        }, [S, cn, C]), _ = d.useReducer(fn, void 0, function() {
          return fn(z, {
            type: M.init
          });
        }), En = _[0], Hn = _[1], J = Fn([].concat(S().useControlledState, [Q]), En, {
          instance: C()
        });
        Object.assign(C(), {
          state: J,
        ...
        C().allColumns = $;
        var sn = d.useMemo(function() {
          for (var pn = [], Zn = [], ie = {}, he = [].concat($); he.length; ) {
            var de = he.shift();
            Ft({
              data: N,
              rows: pn,
        ...
        {
          var Ce = $.filter(function(pn, Zn) {
            return $.findIndex(function(ie) {
              return ie.id === pn.id;
            }) !== Zn;
          });
          if (Ce.length)
            throw console.info($), new Error('Duplicate columns were found with ids: "' + Ce.map(function(pn) {
              return pn.id;
        ...
        C().headers = vn, C().flatHeaders = Bn.reduce(function(pn, Zn) {
          return [].concat(pn, Zn.headers);
        }, []), Mn(S().useInstanceBeforeDimensions, C());
        var wn = tn.filter(function(pn) {
          return pn.isVisible;
        }).map(function(pn) {
          return pn.id;
        }).sort().join("_");
        ...
        var _n = Ct(vn), pe = _n[0], et = _n[1], Et = _n[2];
        return C().totalColumnsMinWidth = pe, C().totalColumnsWidth = et, C().totalColumnsMaxWidth = Et, Mn(S().useInstance, C()), [].concat(C().flatHeaders, C().allColumns).forEach(function(pn) {
          pn.render = $n(C(), pn), pn.getHeaderProps = Cn(S().getHeaderProps, {
            instance: C(),
            column: pn
          }), pn.getFooterProps = Cn(S().getFooterProps, {
            instance: C(),
            column: pn
          });
        }), C().headerGroups = d.useMemo(function() {
          return Bn.filter(function(pn, Zn) {
            return pn.headers = pn.headers.filter(function(ie) {
              var he = function de(qe) {
                return qe.filter(function(fe) {
                  return fe.headers ? de(fe.headers) : fe.isVisible;
                }).length;
              };
              return ie.headers ? he(ie.headers) : ie.isVisible;
            }), pn.headers.length ? (pn.getHeaderGroupProps = Cn(S().getHeaderGroupProps, {
              instance: C(),
              headerGroup: pn,
              index: Zn
            }), pn.getFooterGroupProps = Cn(S().getFooterGroupProps, {
              instance: C(),
              headerGroup: pn,
              index: Zn
            }), !0) : !1;
          });
        }, [Bn, C, S]), C().footerGroups = [].concat(C().headerGroups).reverse(), C().prepareRow = d.useCallback(function(pn) {
          pn.getRowProps = Cn(S().getRowProps, {
            instance: C(),
            row: pn
          }), pn.allCells = $.map(function(Zn) {
            var ie = pn.values[Zn.id], he = {
              column: Zn,
              row: pn,
              value: ie
            };
      ...
      function Ct(e, t) {
        ...
        return e.forEach(function(C) {
          ...
          C.isVisible && (t += C.totalWidth, u += C.totalMinWidth, r += C.totalWidth, f += C.totalMaxWidth, m += C.totalFlexWidth);
        }), [u, r, f, m];
      }
      function Ft(e) {
        var t = e.data, u = e.rows, r = e.flatRows, f = e.rowsById, m = e.column, C = e.getRowId, S = e.getSubRows, D = e.accessValueHooks, N = e.getInstance, P = function z(B, G, X, k, Q) {
          X === void 0 && (X = 0);
          var cn = B, fn = C(B, G, k), _ = f[fn];
          if (_)
            _.subRows && _.originalSubRows.forEach(function(Hn, J) {
              return z(Hn, J, X + 1, _);
            });
          else if (_ = {
            id: fn,
          ...
          }, _.cells.map = V, _.cells.filter = V, _.cells.forEach = V, _.cells[0].getCellProps = V, _.values = {}, Q.push(_), r.push(_), f[fn] = _, _.originalSubRows = S(B, G), _.originalSubRows) {
            var En = [];
            _.originalSubRows.forEach(function(Hn, J) {
              return z(Hn, J, X + 1, _, En);
            }), _.subRows = En;
          }
      ...
      function xt(e, t, u, r) {
        ...
        if (t.type === M.toggleAllRowsExpanded) {
          var f = t.value, m = r.rowsById, C = Object.keys(m).length === Object.keys(e.expanded).length, S = typeof f < "u" ? f : !C;
          if (S) {
            var D = {};
      ...
      function $e(e) {
        var t = e.data, u = e.rows, r = e.rowsById, f = e.manualExpandedKey, m = f === void 0 ? "expanded" : f, C = e.paginateExpandedRows, S = C === void 0 ? !0 : C, D = e.expandSubRows, N = D === void 0 ? !0 : D, P = e.autoResetExpanded, z = P === void 0 ? !0 : P, B = e.getHooks, G = e.plugins, X = e.state.expanded, k = e.dispatch;
        ...
        var fn = d.useCallback(function($, sn) {
          k({
        ...
        }, [S, u, m, X, N]), Hn = d.useMemo(function() {
          return Oo(X);
      ...
      function Gt(e, t) {
        ...
        e.toggleRowExpanded = function(f) {
          return r.toggleRowExpanded(e.id, f);
      ...
      var Yt = function(t) {
        t.stateReducers.push(Bo), t.useInstance.push(Fo);
      };
      ...
      function Bo(e, t, u, r) {
        ...
        if (t.type === M.setFilter) {
          var f = t.columnId, m = t.filterValue, C = r.allColumns, S = r.filterTypes, D = C.find(function(k) {
            return k.id === f;
          });
          if (!D)
        ...
        if (t.type === M.setAllFilters) {
          ...
          return y({}, e, {
            ...
            filters: Gn(B, e.filters).filter(function(k) {
              ...
              return !H(cn.autoRemove, k.value, Q);
            })
          });
        }
      }
      function Fo(e) {
        var t = e.data, u = e.rows, r = e.flatRows, f = e.rowsById, m = e.allColumns, C = e.filterTypes, S = e.manualFilters, D = e.defaultCanFilter, N = D === void 0 ? !1 : D, P = e.disableFilters, z = e.state.filters, B = e.dispatch, G = e.autoResetFilters, X = G === void 0 ? !0 : G, k = d.useCallback(function(J, Y) {
          B({
            type: M.setFilter,
            columnId: J,
            filterValue: Y
        ...
        var cn = d.useMemo(function() {
          ...
          var J = [], Y = {}, $ = function sn(Ln, On) {
            ...
            return Yn = z.reduce(function(tn, Ce) {
              var Bn = Ce.id, vn = Ce.value, wn = m.find(function(pe) {
                return pe.id === Bn;
              });
              if (!wn)
                return tn;
          ...
          return [$(u), J, Y];
        }, [S, z, u, r, f, m, C]), fn = cn[0], _ = cn[1], En = cn[2];
        d.useMemo(function() {
          ...
          J.forEach(function(Y) {
            Y.preFilteredRows = fn, Y.filteredRows = fn;
          });
        }, [fn, z, m]);
        var Hn = Dn(X);
        An(function() {
      ...
      function Ut(e, t, u, r) {
        ...
        if (t.type === M.setGlobalFilter) {
          var f = t.filterValue, m = r.userFilterTypes, C = Se(r.globalFilter, m || {}, Ze), S = Gn(f, e.globalFilter);
          if (H(C.autoRemove, S)) {
            e.globalFilter;
      ...
      function Jt(e) {
        var t = e.data, u = e.rows, r = e.flatRows, f = e.rowsById, m = e.allColumns, C = e.filterTypes, S = e.globalFilter, D = e.manualGlobalFilter, N = e.state.globalFilter, P = e.dispatch, z = e.autoResetGlobalFilter, B = z === void 0 ? !0 : z, G = e.disableGlobalFilter, X = d.useCallback(function(En) {
          P({
          ...
          var Y = m.filter(function(sn) {
            ...
            return Ln = J(Ln, Y.map(function(On) {
              ...
              En.push(On), Hn[On.id] = On, On.subRows = On.subRows && On.subRows.length ? sn(On.subRows) : On.subRows;
            }), Ln;
          };
          return [$(u), En, Hn];
        }, [D, N, S, C, m, u, r, f, G]), Q = k[0], cn = k[1], fn = k[2], _ = Dn(B);
        An(function() {
          _() && P({
      ...
      function Wo(e) {
        if (!e.length)
          return null;
        var t = Math.floor(e.length / 2), u = [].concat(e).sort(function(r, f) {
          return r - f;
        });
      ...
      var vt = function(t) {
        t.getGroupByToggleProps = [no], t.stateReducers.push(qo), t.visibleColumnsDeps.push(function(u, r) {
          var f = r.instance;
          return [].concat(u, [f.state.groupBy]);
        }), t.visibleColumns.push(zo), t.useInstance.push(jo), t.prepareRow.push(Yo);
      };
      vt.pluginName = "useGroupBy";
      var no = function(t, u) {
        var r = u.header;
        return [t, {
          onClick: r.canGroupBy ? function(f) {
            f.persist(), r.toggleGroupBy();
          } : void 0,
          style: {
      ...
      function zo(e, t) {
        ...
        return e = [].concat(r, f), e.forEach(function(m) {
          m.isGrouped = u.includes(m.id), m.groupedIndex = u.indexOf(m.id);
        }), e;
      }
      var Xo = {};
      function jo(e) {
        var t = e.data, u = e.rows, r = e.flatRows, f = e.rowsById, m = e.allColumns, C = e.flatHeaders, S = e.groupByFn, D = S === void 0 ? eo : S, N = e.manualGroupBy, P = e.aggregations, z = P === void 0 ? Xo : P, B = e.plugins, G = e.state.groupBy, X = e.dispatch, k = e.autoResetGroupBy, Q = k === void 0 ? !0 : k, cn = e.disableGroupBy, fn = e.defaultCanGroupBy, _ = e.getHooks;
        Un(B, ["useColumnOrder", "useFilters"], "useGroupBy");
        var En = Dn(e);
        m.forEach(function(vn) {
          var wn = vn.accessor, _n = vn.defaultGroupBy, pe = vn.disableGroupBy;
          vn.canGroupBy = wn ? ce(vn.canGroupBy, pe === !0 ? !1 : void 0, cn === !0 ? !1 : void 0, !0) : ce(vn.canGroupBy, _n, fn, !1), vn.canGroupBy && (vn.toggleGroupBy = function() {
            return e.toggleGroupBy(vn.id);
          }), vn.Aggregated = vn.Aggregated || vn.Cell;
        });
        var Hn = d.useCallback(function(vn, wn) {
          X({
        ...
        var Y = d.useMemo(function() {
          ...
          }, _n = [], pe = {}, et = [], Et = {}, pn = [], Zn = {}, ie = function de(qe, fe, wo) {
            if (fe === void 0 && (fe = 0), fe === vn.length)
              return qe.map(function(it) {
                return y({}, it, {
                  depth: fe
                });
              });
            var ze = vn[fe], ae = D(qe, ze), Mo = Object.entries(ae).map(function(it, yr) {
              var tt = it[0], Xe = it[1], je = ze + ":" + tt;
              je = wo ? wo + ">" + je : je;
              var Nr = de(Xe, fe + 1, je), Er = fe ? Ae(Xe, "leafRows") : Xe, Sa = wn(Er, Xe, fe), wa = {
                id: je,
                isGrouped: !0,
                groupByID: ze,
                groupByVal: tt,
              ...
              return Nr.forEach(function(Pe) {
                _n.push(Pe), pe[Pe.id] = Pe, Pe.isGrouped ? (et.push(Pe), Et[Pe.id] = Pe) : (pn.push(Pe), Zn[Pe.id] = Pe);
              }), wa;
            });
            return Mo;
          }, he = ie(u);
          return he.forEach(function(de) {
            _n.push(de), pe[de.id] = de, de.isGrouped ? (et.push(de), Et[de.id] = de) : (pn.push(de), Zn[de.id] = de);
          }), [he, _n, pe, et, Et, pn, Zn];
        }, [N, G, u, r, f, m, z, D]), $ = Y[0], sn = Y[1], Ln = Y[2], On = Y[3], Yn = Y[4], tn = Y[5], Ce = Y[6], Bn = Dn(Q);
        An(function() {
          Bn() && X({
            type: M.resetGroupBy
          });
      ...
      function eo(e, t) {
        return e.reduce(function(u, r, f) {
          var m = "" + r.values[t];
          return u[m] = Array.isArray(u[m]) ? u[m] : [], u[m].push(r), u;
        }, {});
      }
      var to = /([0-9]+)/gm, _o = function(t, u, r) {
        var f = nt(t, u, r), m = f[0], C = f[1];
      ...
      function oo(e, t, u) {
        var r = nt(e, t, u), f = r[0], m = r[1], C = /[^0-9.]/gi;
      ...
      var Qo = function(t, u) {
        var r = u.instance, f = u.column, m = r.isMultiSortEvent, C = m === void 0 ? function(S) {
          return S.shiftKey;
        } : m;
        return [t, {
          onClick: f.canSort ? function(S) {
            S.persist(), f.toggleSortBy(void 0, !r.disableMultiSort && C(S));
          } : void 0,
          style: {
      ...
      function uo(e, t, u, r) {
        ...
        if (t.type === M.toggleSortBy) {
          var S = t.columnId, D = t.desc, N = t.multi, P = r.allColumns, z = r.disableMultiSort, B = r.disableSortRemove, G = r.disableMultiRemove, X = r.maxMultiSortColCount, k = X === void 0 ? Number.MAX_SAFE_INTEGER : X, Q = e.sortBy, cn = P.find(function($) {
            return $.id === S;
          }), fn = cn.sortDescFirst, _ = Q.find(function($) {
            return $.id === S;
          ...
          _.desc && !fn || !_.desc && fn) && (Y = "remove"), Y === "replace" ? J = [{
            id: S,
            desc: Hn ? D : fn
          }] : Y === "add" ? (J = [].concat(Q, [{
            id: S,
      ...
      function io(e) {
        var t = e.data, u = e.rows, r = e.flatRows, f = e.allColumns, m = e.orderByFn, C = m === void 0 ? wt : m, S = e.sortTypes, D = e.manualSortBy, N = e.defaultCanSort, P = e.disableSortBy, z = e.flatHeaders, B = e.state.sortBy, G = e.dispatch, X = e.plugins, k = e.getHooks, Q = e.autoResetSortBy, cn = Q === void 0 ? !0 : Q;
        ...
        var Hn = d.useMemo(function() {
          ...
          return [On(u), sn];
        }, [D, B, u, r, f, C, S]), J = Hn[0], Y = Hn[1], $ = Dn(cn);
        An(function() {
          $() && G({
            type: M.resetSortBy
          });
      ...
      function wt(e, t, u) {
        return [].concat(e).sort(function(r, f) {
          for (var m = 0; m < t.length; m += 1) {
            var C = t[m], S = u[m] === !1 || u[m] === "desc", D = C(r, f);
            if (D !== 0)
              return S ? -D : D;
          }
          return u[0] ? r.index - f.index : f.index - r.index;
        });
      }
      var nr = "usePagination";
      M.resetPage = "resetPage", M.gotoPage = "gotoPage", M.setPageSize = "setPageSize";
      var lo = function(t) {
        t.stateReducers.push(er), t.useInstance.push(so);
      };
      lo.pluginName = nr;
      function er(e, t, u, r) {
        if (t.type === M.init)
        ...
        if (t.type === M.gotoPage) {
          var f = r.pageCount, m = r.page, C = Gn(t.pageIndex, e.pageIndex), S = !1;
          return C > e.pageIndex ? S = f === -1 ? m.length >= e.pageSize : C < f : C < e.pageIndex && (S = C > -1), S ? y({}, e, {
            pageIndex: C
          }) : e;
        }
      ...
      function so(e) {
        var t = e.rows, u = e.autoResetPage, r = u === void 0 ? !0 : u, f = e.manualExpandedKey, m = f === void 0 ? "expanded" : f, C = e.plugins, S = e.pageCount, D = e.paginateExpandedRows, N = D === void 0 ? !0 : D, P = e.expandSubRows, z = P === void 0 ? !0 : P, B = e.state, G = B.pageSize, X = B.pageIndex, k = B.expanded, Q = B.globalFilter, cn = B.filters, fn = B.groupBy, _ = B.sortBy, En = e.dispatch, Hn = e.data, J = e.manualPagination;
      ...
      var co = function(t) {
        t.getPivotToggleProps = [tr], t.stateReducers.push(Co), t.useInstanceAfterData.push(or), t.allColumns.push(rr), t.accessValue.push(ar), t.materializedColumns.push(ur), t.materializedColumnsDeps.push(Mt), t.visibleColumns.push(po), t.visibleColumnsDeps.push(ut), t.useInstance.push(At), t.prepareRow.push(bt);
      };
      co.pluginName = "usePivotColumns";
      var yo = [], tr = function(t, u) {
        var r = u.header;
        return [t, {
          onClick: r.canPivot ? function(f) {
            f.persist(), r.togglePivot();
          } : void 0,
          style: {
      ...
      function ur(e, t) {
        var u = t.instance, r = u.allColumns, f = u.state;
      ...
      function Mt(e, t) {
        var u = t.instance.state, r = u.pivotColumns, f = u.groupBy;
        return [].concat(e, [r, f]);
      }
      function po(e, t) {
      ...
      function At(e) {
        var t = e.columns, u = e.allColumns, r = e.flatHeaders, f = e.getHooks, m = e.plugins, C = e.dispatch, S = e.autoResetPivot, D = S === void 0 ? !0 : S, N = e.manaulPivot, P = e.disablePivot, z = e.defaultCanPivot;
        Un(m, ["useGroupBy"], "usePivotColumns");
        var B = Dn(e);
        u.forEach(function(k) {
          var Q = k.accessor, cn = k.defaultPivot, fn = k.disablePivot;
          k.canPivot = Q ? ce(k.canPivot, fn === !0 ? !1 : void 0, P === !0 ? !1 : void 0, !0) : ce(k.canPivot, cn, z, !1), k.canPivot && (k.togglePivot = function() {
        ...
        r.forEach(function(k) {
          k.getPivotToggleProps = Cn(f().getPivotToggleProps, {
            instance: B(),
            header: k
          });
        });
      ...
      var Dt = function(t) {
        t.getToggleRowSelectedProps = [ir], t.getToggleAllRowsSelectedProps = [Rt], t.getToggleAllPageRowsSelectedProps = [lr], t.stateReducers.push(sr), t.useInstance.push(cr), t.prepareRow.push(go);
      };
      Dt.pluginName = fo;
      var ir = function(t, u) {
        var r = u.instance, f = u.row, m = r.manualRowSelectedKey, C = m === void 0 ? "isSelected" : m, S = !1;
        ...
        return [t, {
          ...
          indeterminate: !!(!r.isAllPageRowsSelected && r.page.some(function(f) {
            var m = f.id;
      ...
      function sr(e, t, u, r) {
        ...
        if (t.type === M.toggleAllRowsSelected) {
          var f = t.value, m = r.isAllRowsSelected, C = r.rowsById, S = r.nonGroupedRowsById, D = S === void 0 ? C : S, N = typeof f < "u" ? f : !m, P = Object.assign({}, e.selectedRowIds);
        ...
        if (t.type === M.toggleRowSelected) {
          var z = t.id, B = t.value, G = r.rowsById, X = r.selectSubRows, k = X === void 0 ? !0 : X, Q = r.getSubRows, cn = e.selectedRowIds[z], fn = typeof B < "u" ? B : !cn;
          if (cn === fn)
            return e;
          var _ = y({}, e.selectedRowIds), En = function Bn(vn) {
            var wn = G[vn];
            if (wn && (wn.isGrouped || (fn ? _[vn] = !0 : delete _[vn]), k && Q(wn)))
        ...
        if (t.type === M.toggleAllPageRowsSelected) {
          var Hn = t.value, J = r.page, Y = r.rowsById, $ = r.selectSubRows, sn = $ === void 0 ? !0 : $, Ln = r.isAllPageRowsSelected, On = r.getSubRows, Yn = typeof Hn < "u" ? Hn : !Ln, tn = y({}, e.selectedRowIds), Ce = function Bn(vn) {
            var wn = Y[vn];
      ...
      function cr(e) {
        var t = e.data, u = e.rows, r = e.getHooks, f = e.plugins, m = e.rowsById, C = e.nonGroupedRowsById, S = C === void 0 ? m : C, D = e.autoResetSelectedRows, N = D === void 0 ? !0 : D, P = e.state.selectedRowIds, z = e.selectSubRows, B = z === void 0 ? !0 : z, G = e.dispatch, X = e.page, k = e.getSubRows;
        ...
        }, [u, B, P, k]), cn = !!(Object.keys(S).length && Object.keys(P).length), fn = cn;
        ...
        }, [G]), Hn = d.useCallback(function(Ln) {
          return G({
      ...
      function Nt(e, t, u, r) {
        var f = r.initialRowStateAccessor, m = f === void 0 ? ho : f, C = r.initialCellStateAccessor, S = C === void 0 ? vo : C, D = r.rowsById;
        if (t.type === M.init)
          return y({
            rowState: {}
          }, e);
        ...
        if (t.type === M.setCellState) {
          var G, X, k, Q, cn, fn = t.rowId, _ = t.columnId, En = t.value, Hn = typeof e.rowState[fn] < "u" ? e.rowState[fn] : m(D[fn]), J = typeof (Hn == null || (G = Hn.cellState) == null ? void 0 : G[_]) < "u" ? Hn.cellState[_] : S((X = D[fn]) == null || (k = X.cells) == null ? void 0 : k.find(function(Y) {
            return Y.column.id === _;
          }));
          return y({}, e, {
            rowState: y({}, e.rowState, (cn = {}, cn[fn] = y({}, Hn, {
              cellState: y({}, Hn.cellState || {}, (Q = {}, Q[_] = Gn(En, J), Q))
            }), cn))
          });
        }
      }
      function n(e) {
        var t = e.autoResetRowState, u = t === void 0 ? !0 : t, r = e.data, f = e.dispatch, m = d.useCallback(function(D, N) {
          return f({
            type: M.setRowState,
            rowId: D,
            value: N
          });
        }, [f]), C = d.useCallback(function(D, N, P) {
          return f({
            type: M.setCellState,
            rowId: D,
            columnId: N,
      ...
      function a(e, t) {
        var u = t.instance, r = u.initialRowStateAccessor, f = r === void 0 ? ho : r, m = u.initialCellStateAccessor, C = m === void 0 ? vo : m, S = u.state.rowState;
      ...
      function h(e, t) {
        ...
        if (!u || !u.length)
          return e;
        for (var r = [].concat(u), f = [].concat(e), m = [], C = function() {
          var D = r.shift(), N = f.findIndex(function(P) {
            return P.id === D;
          });
      ...
      var v = function(t) {
        ...
        var r = u.instance, f = u.header, m = r.dispatch, C = function(D, N) {
          var P = !1;
          ...
          var z = W(N), B = z.map(function(J) {
            ...
            touch: {
              moveEvent: "touchmove",
              moveHandler: function(Y) {
                return Y.cancelable && (Y.preventDefault(), Y.stopPropagation()), fn(Y.touches[0].clientX), !1;
              },
              upEvent: "touchend",
              upHandler: function(Y) {
          ...
          }, En = P ? _.touch : _.mouse, Hn = rn() ? {
            passive: !1
          } : !1;
          document.addEventListener(En.moveEvent, En.moveHandler, Hn), document.addEventListener(En.upEvent, En.upHandler, Hn), m({
      ...
      function E(e, t) {
        ...
        if (t.type === M.columnStartResizing) {
          var u = t.clientX, r = t.columnId, f = t.columnWidth, m = t.headerIdWidths;
          return y({}, e, {
      ...
      var I = function(t) {
        var u = t.flatHeaders, r = t.disableResizing, f = t.getHooks, m = t.state.columnResizing, C = Dn(t);
        u.forEach(function(S) {
          var D = ce(S.disableResizing === !0 ? !1 : void 0, r === !0 ? !1 : void 0, !0);
          S.canResize = D, S.width = m.columnWidths[S.id] || S.originalWidth || S.width, S.isResizing = m.isResizingColumn === S.id, D && (S.getResizerProps = Cn(f().getResizerProps, {
            instance: C(),
            header: S
          }));
        });
      ...
      function K(e) {
        var t = e.plugins, u = e.dispatch, r = e.autoResetResize, f = r === void 0 ? !0 : r, m = e.columns;
      ...
      function W(e) {
        var t = [], u = function r(f) {
          f.columns && f.columns.length && f.columns.map(r), t.push(f);
        };
        return u(e), t;
      }
      var x = {
      ...
      var dn = function(t, u) {
        var r = u.instance, f = r.visibleColumns.map(function(m) {
          var C;
      ...
      function bn(e, t, u, r) {
        ...
        if (t.type === M.columnStartResizing) {
          var f = t.columnId, m = t.headerIdWidths, C = qn(f);
          if (C !== void 0) {
        ...
        if (t.type === M.columnResizing) {
          var z = t.clientX, B = e.columnResizing.startX, G = e.gridLayout, X = G.columnWidth, k = G.minWidths, Q = G.maxWidths, cn = G.headerIdGridWidths, fn = cn === void 0 ? [] : cn, _ = z - B, En = _ / X, Hn = {};
          return fn.forEach(function(J) {
            var Y = J[0], $ = J[1];
            Hn[Y] = Math.min(Math.max(k[Y], $ + $ * En), Q[Y]);
          }), y({}, e, {
            gridLayout: y({}, e.gridLayout, {
      ...
      c._UNSTABLE_usePivotColumns = co, c.actions = M, c.defaultColumn = yn, c.defaultGroupByFn = eo, c.defaultOrderByFn = wt, c.defaultRenderer = an, c.emptyRenderer = gn, c.ensurePluginOrder = Un, c.flexRender = Wn, c.functionalUpdate = Gn, c.loopHooks = Mn, c.makePropGetter = Cn, c.makeRenderer = $n, c.reduceHooks = Fn, c.safeUseLayoutEffect = Vn, c.useAbsoluteLayout = L, c.useAsyncDebounce = le, c.useBlockLayout = un, c.useColumnOrder = l, c.useExpanded = dt, c.useFilters = Yt, c.useFlexLayout = Pn, c.useGetLatest = Dn, c.useGlobalFilter = _t, c.useGridLayout = xn, c.useGroupBy = vt, c.useMountedLayoutEffect = An, c.usePagination = lo, c.useResizeColumns = v, c.useRowSelect = Dt, c.useRowState = So, c.useSortBy = ao, c.useTable = rt, Object.defineProperty(c, "__esModule", { value: !0 });
    });
  }(Ro, Ro.exports)), Ro.exports;
}
process.env.NODE_ENV === "production" ? Mr.exports = Vu() : Mr.exports = Ku();
var st = Mr.exports;
function qu(o, p, c) {
  var d = this, b = A.useRef(null), T = A.useRef(0), y = A.useRef(null), O = A.useRef([]), Nn = A.useRef(), w = A.useRef(), Tn = A.useRef(o), M = A.useRef(!0);
  Tn.current = o;
  var an = !p && p !== 0 && typeof window < "u";
  if (typeof o != "function")
    throw new TypeError("Expected a function");
  p = +p || 0, c = c || {};
  var gn = !!c.leading, yn = "trailing" in c ? !!c.trailing : !0, mn = "maxWait" in c, Kn = mn ? Math.max(+c.maxWait || 0, p) : null, Cn = A.useCallback(function(Wn) {
    var oe = O.current, se = Nn.current;
    return O.current = Nn.current = null, T.current = Wn, w.current = Tn.current.apply(se, oe);
  }, []), Fn = A.useCallback(function(Wn, oe) {
    an && cancelAnimationFrame(y.current), y.current = an ? requestAnimationFrame(Wn) : setTimeout(Wn, oe);
  }, [an]), Mn = A.useCallback(function(Wn) {
    if (!M.current)
      return !1;
    var oe = Wn - b.current, se = Wn - T.current;
    return !b.current || oe >= p || oe < 0 || mn && se >= Kn;
  }, [Kn, mn, p]), Un = A.useCallback(function(Wn) {
    return y.current = null, yn && O.current ? Cn(Wn) : (O.current = Nn.current = null, w.current);
  }, [Cn, yn]), Gn = A.useCallback(function() {
    var Wn = Date.now();
    if (Mn(Wn))
      return Un(Wn);
    if (M.current) {
      var oe = Wn - b.current, se = Wn - T.current, ne = p - oe, ee = mn ? Math.min(ne, Kn - se) : ne;
      Fn(Gn, ee);
    }
  }, [Kn, mn, Mn, Fn, Un, p]), Dn = A.useCallback(function() {
  ...
  var An = A.useCallback(function() {
    for (var Wn = [], oe = 0; oe < arguments.length; oe++)
      Wn[oe] = arguments[oe];
    var se = Date.now(), ne = Mn(se);
    if (O.current = Wn, Nn.current = d, b.current = se, ne) {
      if (!y.current && M.current)
        return T.current = b.current, Fn(Gn, p), gn ? Cn(b.current) : w.current;
      if (mn)
        return Fn(Gn, p), Cn(b.current);
    }
    return y.current || Fn(Gn, p), w.current;
  }, [Cn, gn, mn, Mn, Fn, Gn, p]), le = A.useCallback(function() {
    return !!y.current;
...
function Xu(o) {
  var p = A.useState(Jr(o)), c = p[0], d = p[1], b = A.useCallback(function(T) {
    return d(Jr(T));
  }, []);
  return [c, b];
}
function ju(o, p, c) {
  var d = c && c.equalityFn || zu, b = Xu(o), T = b[0], y = b[1], O = qu(A.useCallback(function(w) {
    return y(w);
  }, [y]), p, c), Nn = A.useRef(o);
...
function Yu(o) {
  if (Array.isArray(o) || (o.general.geoType === "us-county" || o.general.geoType === "single-state" || o.general.geoType === "us" && (o != null && o.data)) && (o == null || o.data.forEach((p) => {
    ...
    const d = p.filter((b) => c.includes(b));
    if (!d.length)
      return;
    o == null || o.forEach((b) => {
...
const Ar = 10, ot = {
  ...
  fileTooLarge: `File is too large. Maximum file size is ${Ar}MB.`
}, _u = A.memo(({ globalFilter: o, setGlobalFilter: p, disabled: c = !1 }) => {
  const [d, b] = A.useState(o), [T] = ju(d, 200);
  A.useEffect(() => {
    typeof T == "string" && T !== o && p(T ?? "");
  }, [T]);
  const y = (O) => {
    b(O.target.value);
  };
  return /* @__PURE__ */ i.createElement("input", { className: "filter", value: d, onChange: y, type: "search", placeholder: "Filter...", disabled: c });
}), $r = A.memo(({ globalFilter: o, data: p, setGlobalFilter: c }) => /* @__PURE__ */ i.createElement("header", { className: "data-table-header" }, /* @__PURE__ */ i.createElement("h2", null, "Data Preview"), /* @__PURE__ */ i.createElement(_u, { globalFilter: o || "", setGlobalFilter: c, disabled: p === null }))), Uu = A.memo(({ previousPage: o, nextPage: p, canPreviousPage: c, canNextPage: d, pageNumber: b, totalPages: T }) => /* @__PURE__ */ i.createElement("footer", { className: "data-table-pagination" }, /* @__PURE__ */ i.createElement("ul", null, /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement("button", { onClick: () => o(), className: "btn btn-prev", disabled: !c, title: "Previous Page" })), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement("button", { onClick: () => p(), className: "btn btn-next", disabled: !d, title: "Next Page" }))), /* @__PURE__ */ i.createElement("span", null, "Page ", b, " of ", T))), Ju = ({ data: o }) => {
  const [p, c] = A.useState(o ?? []), d = A.useContext(Ot), b = A.useMemo(() => {
    const Vn = p.columns ?? [];
  ...
  }, [p]), T = A.useCallback((Vn) => {
    let An = [];
    Vn.forEach(($n) => {
      Object.keys($n).forEach((Wn) => {
        An.includes(Wn) === !1 && An.push(Wn);
      });
    });
    const le = [...Vn];
    if (Array.isArray(le))
...
`, n0 = `FIPS Codes,County,Public Health Jurisdiction,Percent Vaccinated,Vaccination Coverage Group
...
`, e0 = `City,Longitude,Latitude,Value
...
]`, u0 = `date,quarter,upper_90,lower_90,random_col
...
`, i0 = `Author(s) and Year,Confidence,Timing,N,Estimate,Lower,Upper,Result
...
}, ha = ({ text: o, fileName: p, data: c }) => {
  const { editingDataset: d, loadData: b } = A.useContext(ko), T = (O) => b(new Blob([c], { type: "text/csv" }), p, d), y = (O) => O.keyCode === 13 && b(new Blob([c], { type: "text/csv" }), p, d);
...
}, c0 = () => Dr.maps.map((o) => /* @__PURE__ */ i.createElement(ha, { key: o.fileName, text: o.text, fileName: o.fileName, data: o.data })), y0 = () => Dr.charts.map((o) => /* @__PURE__ */ i.createElement(ha, { key: o.fileName, text: o.text, fileName: o.fileName, data: o.data })), C0 = () => {
  const { config: o } = A.useContext(ko);
  return /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("h3", { className: "heading-3" }, "Load Sample Data:"), /* @__PURE__ */ i.createElement("ul", { className: "sample-data-list" }, o.type !== "map" && /* @__PURE__ */ i.createElement(y0, null), o.type !== "chart" && /* @__PURE__ */ i.createElement(c0, null)));
}, Rr = () => null;
Rr.data = Dr;
Rr.Buttons = C0;
const Zr = (o) => /* @__PURE__ */ A.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", ...o }, /* @__PURE__ */ A.createElement("path", { d: "M224 136V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.2 0-24-10.8-24-24zm65.18 216.01H224v80c0 8.84-7.16 16-16 16h-32c-8.84 0-16-7.16-16-16v-80H94.82c-14.28 0-21.41-17.29-11.27-27.36l96.42-95.7c6.65-6.61 17.39-6.61 24.04 0l96.42 95.7c10.15 10.07 3.03 27.36-11.25 27.36zM377 105L279.1 7c-4.5-4.5-10.6-7-17-7H256v128h128v-6.1c0-6.3-2.5-12.4-7-16.9z" }));
function d0() {
  const { config: o, errors: p, tempConfig: c, sharepath: d } = A.useContext(kt), b = (H) => {
    Cn({ type: "EDITOR_SET_CONFIG", payload: H });
  }, T = (H) => {
    Cn({ type: "EDITOR_SET_ERRORS", payload: H });
  }, y = new Oa(), [O, Nn] = A.useState(o.dataFileSourceType === "url" ? o.dataFileName : o.dataUrl || ""), [w, Tn] = A.useState(!!o.dataUrl), [M, an] = A.useState(o.type === "dashboard" || !o.data), [gn, yn] = A.useState(void 0), [mn, Kn] = A.useState(), Cn = A.useContext(Ot), Fn = {
    ".csv": "text/csv",
    ".json": "application/json"
  }, Mn = (H) => H === void 0 ? "" : H > Math.pow(1024, 3) ? Math.round(H / Math.pow(1024, 3) * 100) / 100 + " GB" : H > Math.pow(1024, 2) ? Math.round(H / Math.pow(1024, 2) * 100) / 100 + " MB" : H > 1024 ? Math.round(H / 1024 * 100) / 100 + " KB" : H + " B", Un = (H, V, nn) => (V.map(function(rn, kn, jn) {
    if (!jn.find((ue) => ue.dataKey === rn.dataKey))
      return !1;
  }), !(H.columns.indexOf(nn) < 0)), Gn = async () => {
    let H;
    try {
      H = Ao(O) || Tt(O) ? O : new URL(O, window.location.origin);
    } catch {
      throw ot.urlInvalid;
    }
    let V = null;
    const nn = Ao(O) ? ".csv" : Tt(O) ? ".json" : Object == null ? void 0 : Object.keys(Fn).find((rn) => H.pathname.endsWith(rn));
    try {
      await ka.get(H.toString(), {
        responseType: "blob"
      }).then((rn) => {
        V = rn.data, nn === ".csv" && V.type === "text/plain" || Ao(O) ? V = V.slice(0, V.size, "text/csv") : (nn === ".json" && V.type === "text/plain" || Tt(O)) && (V = V.slice(0, V.size, "application/json"));
      });
    } catch (rn) {
      console.error(rn);
    ...
    return V;
  }, Dn = ([H]) => Vn(H, gn, gn), Vn = async (H = null, V, nn) => {
    let rn = H, kn = (rn == null ? void 0 : rn.path) ?? V ?? null, jn = "file";
    if (rn === null) {
      jn = "url";
      try {
        rn = await Gn(), kn = O;
    ...
    let be = (H == null ? void 0 : H.name) || O || V, Oe = ((Jn) => {
      let Xn;
      if (Jn === "file" && (Xn = be.match(/(?:\.([^.]+))?$/g), Xn.length === 0 ? Xn = ".csv" : Xn = Xn[0]), Jn === "url") {
        let Z = new URL(be, window.location.origin);
        Xn = Ao(O) ? ".csv" : Tt(O) ? ".json" : Object.keys(Fn).find((In) => Z.pathname.endsWith(In));
      }
      return Xn;
    })(jn), He = Fn[Oe], We = new FileReader(), xe = He === "text/csv" ? "utf-8" : "";
    We.onload = function() {
      let Jn = this.result;
      switch (He) {
        case "text/csv":
        ...
        case "application/json":
          try {
            Jn = Tt(O) ? JSON.parse(Jn).response.docs : JSON.parse(Jn);
          } catch {
            T([ot.formatting]);
            return;
          }
  ...
  const An = (H, V, nn, rn) => {
    ...
    if (V) {
      let nn = { ...o.datasets };
      H === !1 ? delete nn[V].dataUrl : nn[V].dataUrl = nn[V].dataFileName, b({ ...o, datasets: nn });
    } else if (o.type !== "dashboard") {
      let nn = { ...o };
      H === !1 ? delete nn.dataUrl : nn.dataUrl = nn.dataFileName, b(nn);
    }
    Tn(H);
  }, { getRootProps: $n, getInputProps: Wn, isDragActive: oe } = wr({ onDrop: Dn }), { getRootProps: se, getInputProps: ne, isDragActive: ee } = wr({ onDrop: Dn }), Ee = (H, V) => /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("form", { className: "input-group d-flex", onSubmit: (nn) => nn.preventDefault() }, /* @__PURE__ */ i.createElement("input", { id: "external-data", type: "text", className: "form-control flex-grow-1 border-right-0", placeholder: "e.g., https://data.cdc.gov/resources/file.json", "aria-label": "Load data from external URL", "aria-describedby": "load-data", value: O, onChange: (nn) => Nn(nn.target.value) }), /* @__PURE__ */ i.createElement("button", { className: "input-group-text btn btn-primary px-4", type: "submit", id: "load-data", onClick: () => Vn(null, O, V) }, "Load")), /* @__PURE__ */ i.createElement("label", { htmlFor: "keep-url", className: "mt-1 d-flex keep-url" }, /* @__PURE__ */ i.createElement("input", { type: "checkbox", id: "keep-url", checked: w, onChange: () => le(!w, V) }), " Always load from URL (normally will only pull once)")), De = (H = {}, V = "Are you sure you want to do this?") => {
    H.newViz = !0, window.confirm(V) === !0 && (Cn({ type: "EDITOR_SAVE", payload: H }), an(!0));
  }, ve = () => (
    //todo convert to modal
    /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("button", { className: "btn danger", onClick: () => De({ type: o.type, visualizationType: o.visualizationType }, "Resetting will remove your data and settings. Do you want to continue?") }, "Clear", /* @__PURE__ */ i.createElement(Pr, null)), o.dataFileSourceType === "file" && /* @__PURE__ */ i.createElement("div", { className: "link link-replace", ...se() }, /* @__PURE__ */ i.createElement("input", { ...ne() }), /* @__PURE__ */ i.createElement("p", null, /* @__PURE__ */ i.createElement("span", null, "or replace file"))))
  ), Te = (H, V, nn) => {
    let rn = { ...o.datasets };
    nn === !0 ? Object.keys(rn).forEach((kn) => {
      kn !== H ? rn[kn][V] = !1 : rn[kn][V] = !0;
    }) : rn[H][V] = nn, b({ ...o, datasets: rn });
  }, ge = (H) => {
    let V = { ...o.datasets }, nn = { ...o.visualizations };
    Object.keys(nn).forEach((rn) => {
      nn[rn].dataKey === H && delete nn[rn].dataKey;
    }), delete V[H], b({ ...o, datasets: V, visualizations: nn });
  }, Ie = (H, V) => {
    if (H === V)
      return;
    ...
    for (; nn[V]; )
      V = jn + "-" + kn, kn++;
    nn[V] = nn[H], delete nn[H], Object.keys(rn).forEach((ue) => {
      rn[ue].dataKey === H && (rn[ue].dataKey = V);
    }), b({ ...o, datasets: nn, visualizations: rn });
  };
  let ce, Me, Ae = !1;
  o.type === "dashboard" ? (Ae = Object.keys(o.datasets).length > 0, Object.keys(o.datasets).forEach((H) => {
    o.datasets[H].preview && Array.isArray(o.datasets[H].data) && (ce = o.datasets[H].data);
  ...
  const Re = /* @__PURE__ */ i.createElement(i.Fragment, null, o.filters && o.filters.map(
    (H, V) => H.type !== "url" ? /* @__PURE__ */ i.createElement(i.Fragment, null) : /* @__PURE__ */ i.createElement("fieldset", { key: H.key, className: "edit-block url-filters-block" }, /* @__PURE__ */ i.createElement(
      "button",
      {
        onClick: (nn) => {
          let rn = [...o.filters];
    ...
    )), /* @__PURE__ */ i.createElement("label", null, /* @__PURE__ */ i.createElement("span", { className: "edit-label column-heading" }, "Values"), " "), /* @__PURE__ */ i.createElement("ul", { className: "value-list" }, H.orderedValues && H.orderedValues.map((nn, rn) => /* @__PURE__ */ i.createElement("li", null, nn, /* @__PURE__ */ i.createElement(
      "input",
      {
        type: "text",
        placeholder: "Enter value display name here",
        value: H.labels ? H.labels[nn] : void 0,
...
function b0() {
  ...
  return /* @__PURE__ */ i.createElement("div", { className: "choose-vis" }, /* @__PURE__ */ i.createElement("a", { href: "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/index.html", target: "_blank", rel: "noopener noreferrer", className: "guidance-link", style: { marginTop: 0, marginBottom: "2rem" } }, /* @__PURE__ */ i.createElement("div", null, /* @__PURE__ */ i.createElement("p", null, "For more information on the types of data visualizations in the WCMS, including examples and best practices, ", /* @__PURE__ */ i.createElement("u", null, "see the WCMS Features Gallery"), "."))), /* @__PURE__ */ i.createElement("div", { className: "heading-2" }, "General"), /* @__PURE__ */ i.createElement("ul", { className: "grid cove-temp" }, " ", /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, { position: "right" }, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Dashboard", type: "dashboard", icon: /* @__PURE__ */ i.createElement(p0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Present multiple data visualizations with shared filter controls."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Data Bite", type: "data-bite", icon: /* @__PURE__ */ i.createElement(Ba, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Highlight a single aggregated value (e.g., sum or median)."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Waffle Chart", type: "waffle-chart", subType: "Waffle", icon: /* @__PURE__ */ i.createElement(Fa, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Highlight a piece of data in relationship to a data set."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Gauge Chart", type: "waffle-chart", subType: "Gauge", icon: /* @__PURE__ */ i.createElement(S0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Specify the calculation of a single data point (such as a percentage value) and present it on a horizontal scale.")))), /* @__PURE__ */ i.createElement("div", { className: "heading-2" }, "Charts"), /* @__PURE__ */ i.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, { position: "right" }, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Bar", type: "chart", subType: "Bar", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(Ha, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Use bars to show comparisons between data categories."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Line", type: "chart", subType: "Line", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(Wa, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Present one or more data trends over time."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Pie", type: "chart", subType: "Pie", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(xa, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Present the numerical proportions of a data series."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Paired Bar", type: "chart", subType: "Paired Bar", orientation: "horizontal", icon: /* @__PURE__ */ i.createElement(f0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Use paired bars to show comparisons between two different data categories."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Deviation Bar", type: "chart", subType: "Deviation Bar", orientation: "horizontal", stacked: !1, icon: /* @__PURE__ */ i.createElement(A0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Use deviation bars to display how individual values differ from a target."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Horizontal Bar (Stacked)", type: "chart", subType: "Bar", orientation: "horizontal", stacked: !0, icon: /* @__PURE__ */ i.createElement(g0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Use bars to show comparisons between data categories.")))), /* @__PURE__ */ i.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Box Plot", type: "chart", subType: "Box Plot", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(h0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Display a box plot"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Scatter Plot", type: "chart", subType: "Scatter Plot", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(m0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Display a scatter plot"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Area Chart", type: "chart", subType: "Area Chart", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(v0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Display an area chart"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Forecast Chart", type: "chart", subType: "Forecasting", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(M0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Display a forecasting chart"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "Forest Plot", type: "chart", subType: "Forest Plot", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(w0, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Display a forest plot")))), /* @__PURE__ */ i.createElement("div", { className: "heading-2" }, "Maps"), /* @__PURE__ */ i.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, { position: "right" }, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "United States (State- or County-Level)", type: "map", subType: "us", icon: /* @__PURE__ */ i.createElement(Lr, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, { position: "right" }, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "United States (HHS Regions)", type: "map", subType: "us-region", icon: /* @__PURE__ */ i.createElement(qa, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "World", type: "map", subType: "world", icon: /* @__PURE__ */ i.createElement(Ga, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Present a choropleth map of the world."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "U.S. State", type: "map", subType: "single-state", icon: /* @__PURE__ */ i.createElement(Va, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "Present a choropleth map of an individual U.S. state."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(on, null, /* @__PURE__ */ i.createElement(on.Target, null, /* @__PURE__ */ i.createElement(d, { label: "U.S. Geocode", type: "map", subType: "us-county", generalType: "us-geocode", icon: /* @__PURE__ */ i.createElement(Lr, null) })), /* @__PURE__ */ i.createElement(on.Content, null, "United States GeoCode")))));
}
function D0({ containerEl: o }) {
  const { config: p, setTempConfig: c, hostname: d, isDebug: b } = A.useContext(kt);
  let { type: T } = p;
  switch (T) {
    case "map":
      return /* @__PURE__ */ i.createElement(lt, { component: "CdcMap" }, /* @__PURE__ */ i.createElement(Ta, { isEditor: !0, isDebug: b, config: p, hostname: d, setConfig: c, containerEl: o }));
    case "waffle-chart":
      if (p.visualizationType === "Waffle" || p.visualizationType === "Gauge")
        return /* @__PURE__ */ i.createElement(lt, { component: "CdcWaffleChart" }, /* @__PURE__ */ i.createElement(Ea, { isEditor: !0, isDebug: b, config: p, setConfig: c }));
      break;
    case "chart":
      return /* @__PURE__ */ i.createElement(lt, { component: "CdcChart" }, /* @__PURE__ */ i.createElement(Na, { isEditor: !0, isDebug: b, config: p, setConfig: c }));
    case "dashboard":
      return /* @__PURE__ */ i.createElement(lt, { component: "CdcDashboard" }, /* @__PURE__ */ i.createElement(Ra, { isEditor: !0, isDebug: b, config: p }));
    case "data-bite":
      return /* @__PURE__ */ i.createElement(lt, { component: "CdcDashboard" }, /* @__PURE__ */ i.createElement(Da, { isEditor: !0, isDebug: b, config: p, setConfig: c }));
    case "markup-include":
      return /* @__PURE__ */ i.createElement(lt, { component: "CdcDashboard" }, /* @__PURE__ */ i.createElement(ba, { isEditor: !0, isDebug: b, config: p, setConfig: c }));
    default:
...
const va = (o) => {
  ...
  return p.type === "dashboard" ? (p.datasets && Object.keys(p.datasets).forEach((c) => {
    ...
    p.visualizations[c] = gr.omit(p.visualizations[c], ["runtime", "formattedData", "data"]);
  })) : (delete p.runtime, delete p.formattedData, p.dataUrl && delete p.data), p;
}, R0 = (o) => {
  if (o !== null) {
    let p = va(o);
    const c = JSON.stringify(p), d = new CustomEvent("updateVizConfig", { detail: c, bubbles: !0 });
  ...
  if (o.type === "dashboard") {
    ...
    if (o.data || o.dataUrl) {
      ...
      d.datasets = {}, d.datasets[b] = {
        ...gr.pick(o, ["data", "dataUrl", "dataFileSourceType"]),
        dataFileName: b
      }, Object.keys(d.visualizations).forEach((y) => {
        const O = { dataKey: b, ...gr.pick(d, "dataDescription", "formattedData") };
...
const E0 = (o, p) => {
...
}, T0 = Ia(E0), I0 = ({ config: o, hostname: p, containerEl: c, sharepath: d, isDebug: b }) => {
  const T = A.useMemo(() => {
    let an = 0;
    return (o != null && o.data || o != null && o.dataUrl) && (o != null && o.type) && (an = 2), { config: N0(o || { newViz: !0, errors: [], currentViewport: "lg" }), errors: [], currentViewport: "lg", globalActive: an, sharepath: d, isDebug: b, hostname: p };
  }, [o]);
  A.useEffect(() => {
    var an;
    Tr && ((an = Tr) == null || an.init());
  }, []);
  const [y, O] = A.useReducer(T0, T), Nn = (an) => {
    R0(JSON.parse(JSON.stringify(an))), O({ type: "EDITOR_TEMP_SAVE", payload: an });
  }, w = new Ma((an) => {
    const gn = an[0];
    let { width: yn } = gn.contentRect, mn = Aa(yn);
  ...
  return /* @__PURE__ */ i.createElement(Pa, null, /* @__PURE__ */ i.createElement(kt.Provider, { value: { ...y, setTempConfig: Nn } }, /* @__PURE__ */ i.createElement(Ot.Provider, { value: O }, /* @__PURE__ */ i.createElement("div", { className: `cdc-open-viz-module cdc-editor ${y.currentViewport}`, ref: Tn }, /* @__PURE__ */ i.createElement(xu, { className: "top-level" }, /* @__PURE__ */ i.createElement(Lt, { title: "1. Choose Visualization Type", className: "choose-type" }, /* @__PURE__ */ i.createElement(b0, null)), /* @__PURE__ */ i.createElement(Lt, { title: "2. Import Data", className: "data-designer", disableRule: !y.config.type }, /* @__PURE__ */ i.createElement(d0, null)), /* @__PURE__ */ i.createElement(Lt, { title: "3. Configure", className: "configure", disableRule: M }, /* @__PURE__ */ i.createElement(D0, { containerEl: c })))))), /* @__PURE__ */ i.createElement(La, null));
}, P0 = {
  theme: "theme-blue"
}, L0 = [
  [
...
No.parameters = {
  ...No.parameters,
  docs: {
    ...(Qr = No.parameters) == null ? void 0 : Qr.docs,
    source: {
      originalSource: `{
  args: {
    config: BlankConfig
      ...
      ...(ea = (na = No.parameters) == null ? void 0 : na.docs) == null ? void 0 : ea.source
    }
  }
};
var ta, oa, ra;
Eo.parameters = {
  ...Eo.parameters,
  docs: {
    ...(ta = Eo.parameters) == null ? void 0 : ta.docs,
    source: {
      originalSource: `{
  args: {
    config: StandAloneTableConfig
      ...
      ...(ra = (oa = Eo.parameters) == null ? void 0 : oa.docs) == null ? void 0 : ra.source
    }
  }
};
var aa, ua, ia;
To.parameters = {
  ...To.parameters,
  docs: {
    ...(aa = To.parameters) == null ? void 0 : aa.docs,
    source: {
      originalSource: `{
  args: {
    config: PivotFilterConfig
      ...
      ...(ia = (ua = To.parameters) == null ? void 0 : ua.docs) == null ? void 0 : ia.source
    }
  }
};
const Hi = ["DefaultEditor", "StandAloneTable", "PivotFilter"];
export {
  No as DefaultEditor,
  To as PivotFilter,
