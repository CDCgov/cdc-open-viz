import { r as D, R as l } from "./storybook-index-9_ikpx_Z.es.js";
import { i as ca, b as bo, a as fr, g as pr } from "./storybook-isSolr-Dnxk31O3.es.js";
import { C as ct, E as Ot, y as gr, o as mr, M as vr, d as hr, m as Sr, I as wr, a as Mr, b as Na, G as br, O as Ar } from "./storybook-CdcDashboard-DfLnMh9C.es.js";
import { P as Qn } from "./storybook-index-Dm4aM_I4.es.js";
import { S as Dr } from "./storybook-usa-region-graphic-BXCQ_KLV.es.js";
import { a as Rr } from "./storybook-axios-DgtQ8_ZG.es.js";
import { D as Nr } from "./storybook-DataTransform-CIGrt-HV.es.js";
import { c as nr } from "./storybook-_commonjsHelpers-BkfeUUK-.es.js";
import { f as Ta } from "./storybook-fetchRemoteData-CYJw3rkn.es.js";
import { a as Pa, b as Ea, c as Tr, d as Pr, e as Er, f as Ir, g as Lr, h as kr, i as Ia, j as Or, k as Br } from "./storybook-Icon-avKQaL8M.es.js";
import { D as Fr } from "./storybook-DataDesigner-CBLZCJO_.es.js";
import { T as an } from "./storybook-Tooltip-DCJgUFyx.es.js";
import { E as lt } from "./storybook-Loading-BWOxMRmm.es.js";
import { _ as kt } from "./storybook-lodash-ClpRvLhc.es.js";
function yt(o, f, c, C) {
  function b(P) {
    return P instanceof c ? P : new c(function(y) {
      y(P);
    });
  }
  return new (c || (c = Promise))(function(P, y) {
    function O(En) {
      try {
        M(C.next(En));
      } catch (w) {
...
function Ct(o, f) {
  ...
  function Rn(M) {
    ...
    for (; y && (y = 0, M[0] && (c = 0)), c; ) try {
      if (C = 1, b && (P = M[0] & 2 ? b.return : M[0] ? b.throw || ((P = b.return) && P.call(b), 0) : b.next) && !(P = P.call(b, M[1])).done) return P;
...
function Hr(o, f) {
  ...
  if (!c) return o;
  var C = c.call(o), b, P = [], y;
  try {
    for (; (f === void 0 || f-- > 0) && !(b = C.next()).done; ) P.push(b.value);
  } catch (O) {
    y = { error: O };
  } finally {
    try {
...
function Kr(o) {
  return yt(this, void 0, void 0, function() {
    return Ct(this, function(f) {
      return To(o) && qr(o) ? [2, Yr(o.dataTransfer, o.type)] : zr(o) ? [2, _r(o)] : Array.isArray(o) && o.every(function(c) {
...
function Yr(o, f) {
  return yt(this, void 0, void 0, function() {
    ...
    return Ct(this, function(b) {
      switch (b.label) {
        case 0:
          return o === null ? [2, []] : o.items ? (c = pa(o.items).filter(function(P) {
            return P.kind === "file";
          }), f !== "drop" ? [2, c] : [4, Promise.all(c.map(jr))]) : [3, 2];
        case 1:
          return C = b.sent(), [2, La(er(C))];
        case 2:
...
function jr(o) {
  ...
  return f && f.isDirectory ? tr(f) : ka(o);
}
function er(o) {
  return o.reduce(function(f, c) {
    return Wr(f, Array.isArray(c) ? er(c) : [c]);
  }, []);
}
function ka(o) {
  var f = o.getAsFile();
...
var $r = function(o, f) {
  if (o && f) {
    ...
    return c.some(function(y) {
      ...
      return O.charAt(0) === "." ? C.toLowerCase().endsWith(O) : O.endsWith("/*") ? P === O.replace(/\/.*$/, "") : b === O;
    });
  }
  return !0;
};
...
function Qr(o, f) {
  if (o) {
    if (typeof o == "string") return Ha(o, f);
    ...
    if (c === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c)) return Ha(o, f);
  }
}
function Ha(o, f) {
...
function nu(o, f) {
  ...
  if (c != null) {
    var C = [], b = !0, P = !1, y, O;
    try {
      for (c = c.call(o); !(b = (y = c.next()).done) && (C.push(y.value), !(f && C.length === f)); b = !0)
        ;
    } catch (Rn) {
      P = !0, O = Rn;
    } finally {
...
function rr(o, f, c) {
  if (Et(o.size))
    if (Et(f) && Et(c)) {
      if (o.size > c) return [!1, Wa(c)];
      if (o.size < f) return [!1, xa(f)];
    } else {
      if (Et(f) && o.size < f) return [!1, xa(f)];
      if (Et(c) && o.size > c) return [!1, Wa(c)];
    }
  return [!0, null];
}
function Et(o) {
...
function lu(o) {
  var f = o.files, c = o.accept, C = o.minSize, b = o.maxSize, P = o.multiple, y = o.maxFiles;
  return !P && f.length > 1 || P && y >= 1 && f.length > y ? !1 : f.every(function(O) {
    var Rn = ar(O, c), M = Fa(Rn, 1), En = M[0], w = rr(O, C, b), rn = Fa(w, 1), Nn = rn[0];
    return En && Nn;
  });
}
function Po(o) {
...
function ke() {
  ...
  return function(C) {
    ...
    return f.some(function(O) {
      return !Po(C) && O && O.apply(void 0, [C].concat(P)), Po(C);
    });
  };
}
function Va() {
...
function Su(o) {
  if (Array.isArray(o)) return ga(o);
}
function ya(o, f) {
...
function ur(o, f) {
  if (o) {
    if (typeof o == "string") return ga(o, f);
    var c = Object.prototype.toString.call(o).slice(8, -1);
    if (c === "Object" && o.constructor && (c = o.constructor.name), c === "Map" || c === "Set") return Array.from(o);
    if (c === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c)) return ga(o, f);
  }
}
function ga(o, f) {
  (f == null || f > o.length) && (f = o.length);
...
var Ma = /* @__PURE__ */ D.forwardRef(function(o, f) {
  var c = o.children, C = Eo(o, du), b = ha(C), P = b.open, y = Eo(b, fu);
  return D.useImperativeHandle(f, function() {
    return {
      open: P
    };
  }, [P]), /* @__PURE__ */ l.createElement(D.Fragment, null, c(ee(ee({}, y), {}, {
    open: P
  })));
});
...
function ha() {
  var o = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, f = ee(ee({}, ir), o), c = f.accept, C = f.disabled, b = f.getFilesFromEvent, P = f.maxSize, y = f.minSize, O = f.multiple, Rn = f.maxFiles, M = f.onDragEnter, En = f.onDragLeave, w = f.onDragOver, rn = f.onDrop, Nn = f.onDropAccepted, Cn = f.onDropRejected, fn = f.onFileDialogCancel, Vn = f.onFileDialogOpen, vn = f.useFsAccessApi, Hn = f.preventDropOnDocument, bn = f.noClick, Jn = f.noKeyboard, Wn = f.noDrag, An = f.noDragEventsBubbling, ae = f.validator, zn = D.useMemo(function() {
    return typeof Vn == "function" ? Vn : qa;
  }, [Vn]), de = D.useMemo(function() {
    return typeof fn == "function" ? fn : qa;
  }, [fn]), ne = D.useRef(null), en = D.useRef(null), dn = D.useReducer(Du, va), _n = ya(dn, 2), Yn = _n[0], $n = _n[1], Pe = Yn.isFocused, Re = Yn.isFileDialogActive, be = Yn.draggedFiles, Ee = function() {
  ...
  var re = D.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Ie(Q), fe.current = [].concat(mu(fe.current), [Q.target]), Ao(Q) && Promise.resolve(b(Q)).then(function(In) {
      Po(Q) && !An || ($n({
        draggedFiles: In,
        isDragActive: !0,
  ...
  }, [ne, En, An]), F = D.useCallback(function(Q, In) {
    var te = [], ie = [];
    Q.forEach(function(ge) {
      var Fe = ar(ge, c), Te = ya(Fe, 2), Ye = Te[0], je = Te[1], Ue = rr(ge, y, P), We = ya(Ue, 2), Je = We[0], xe = We[1], Ge = ae ? ae(ge) : null;
      if (Ye && Je && !Ge)
        te.push(ge);
      else {
        var He = [je, xe];
    ...
    }), (!O && te.length > 1 || O && Rn >= 1 && te.length > Rn) && (te.forEach(function(ge) {
      ie.push({
        file: ge,
        errors: [iu]
      });
      ...
      fileRejections: ie,
      type: "setFiles"
    }), rn && rn(te, ie, In), ie.length > 0 && Cn && Cn(ie, In), te.length > 0 && Nn && Nn(te, In);
  }, [$n, O, c, y, P, Rn, rn, Nn, Cn, ae]), z = D.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Ie(Q), fe.current = [], Ao(Q) && Promise.resolve(b(Q)).then(function(In) {
      Po(Q) && !An || F(In, Q);
    }), $n({
      type: "reset"
    });
  }, [b, F, An]), un = D.useCallback(function() {
    if (vn && Va()) {
      $n({
        type: "openDialog"
      }), zn();
    ...
    bn || (yu() ? setTimeout(un, 0) : un());
  }, [en, bn, un]), Ne = function(In) {
    return C ? null : In;
  }, Ae = function(In) {
    ...
    return function() {
      var Q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, In = Q.refKey, te = In === void 0 ? "ref" : In, ie = Q.role, ge = Q.onKeyDown, Fe = Q.onFocus, Te = Q.onBlur, Ye = Q.onClick, je = Q.onDragEnter, Ue = Q.onDragOver, We = Q.onDragLeave, Je = Q.onDrop, xe = Eo(Q, pu);
      return ee(ee(ma({
        onKeyDown: Ae(ke(ge, tn)),
        onFocus: Ae(ke(Fe, Gn)),
        onBlur: Ae(ke(Te, jn)),
        onClick: Ne(ke(Ye, we)),
  ...
  }, [ne, tn, Gn, jn, we, re, Oe, Be, z, Jn, Wn, C]), pe = D.useCallback(function(Q) {
    Q.stopPropagation();
  }, []), ye = D.useMemo(function() {
    return function() {
      var Q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, In = Q.refKey, te = In === void 0 ? "ref" : In, ie = Q.onChange, ge = Q.onClick, Fe = Eo(Q, gu), Te = ma({
        accept: c,
        multiple: O,
        type: "file",
        style: {
  ...
  }, [en, c, O, z, C]), ve = be.length, he = ve > 0 && lu({
    files: be,
    accept: c,
    minSize: y,
    maxSize: P,
...
\r]`), c = o.charCodeAt(0);
  function C(w, rn) {
    var Nn, Cn, fn = b(w, function(Vn, vn) {
      if (Nn) return Nn(Vn, vn - 1);
      Cn = Vn, Nn = rn ? Ru(Vn, rn) : lr(Vn);
    });
    return fn.columns = Cn || [], fn;
  }
  function b(w, rn) {
    var Nn = [], Cn = w.length, fn = 0, Vn = 0, vn, Hn = Cn <= 0, bn = !1;
    w.charCodeAt(Cn - 1) === It && --Cn, w.charCodeAt(Cn - 1) === fa && --Cn;
    function Jn() {
      if (Hn) return Ca;
      if (bn) return bn = !1, za;
      var An, ae = fn, zn;
      if (w.charCodeAt(ae) === da) {
        for (; fn++ < Cn && w.charCodeAt(fn) !== da || w.charCodeAt(++fn) === da; ) ;
        return (An = fn) >= Cn ? Hn = !0 : (zn = w.charCodeAt(fn++)) === It ? bn = !0 : zn === fa && (bn = !0, w.charCodeAt(fn) === It && ++fn), w.slice(ae + 1, An - 1).replace(/""/g, '"');
      }
      for (; fn < Cn; ) {
        if ((zn = w.charCodeAt(An = fn++)) === It) bn = !0;
        else if (zn === fa)
          bn = !0, w.charCodeAt(fn) === It && ++fn;
        else if (zn !== c) continue;
        return w.slice(ae, An);
      }
      return Hn = !0, w.slice(ae, Cn);
    }
    for (; (vn = Jn()) !== Ca; ) {
      for (var Wn = []; vn !== za && vn !== Ca; ) Wn.push(vn), vn = Jn();
      rn && (Wn = rn(Wn, Vn++)) == null || Nn.push(Wn);
    }
    return Nn;
  }
  function P(w, rn) {
    return w.map(function(Nn) {
      return rn.map(function(Cn) {
        return En(Nn[Cn]);
      }).join(o);
    });
  }
  function y(w, rn) {
    return rn == null && (rn = _a(w)), [rn.map(En).join(o)].concat(P(w, rn)).join(`
`);
  }
  function O(w, rn) {
    return rn == null && (rn = _a(w)), P(w, rn).join(`
`);
  }
  function Rn(w) {
    return w.map(M).join(`
...
const Lt = ({ children: o, className: f = "" }) => /* @__PURE__ */ l.createElement("div", { className: `tab-content ${f}` }, o), Lu = (o) => {
  const { globalActive: f } = D.useContext(ct), c = D.useContext(Ot), C = (b) => {
    c({ type: "EDITOR_SET_GLOBALACTIVE", payload: b });
  };
  return /* @__PURE__ */ React.createElement(sr, { ...o, setActiveTab: C, activeTab: f });
}, ku = ({ children: o, className: f = void 0, startingTab: c }) => {
  const [C, b] = D.useState(c);
  return /* @__PURE__ */ React.createElement(sr, { className: f, setActiveTab: b, activeTab: C }, o);
}, sr = ({ children: o, className: f, activeTab: c, setActiveTab: C }) => {
  const b = (O, Rn) => {
    O || C(Rn);
  };
  let P = "tabs";
  f && (P = `tabs ${f}`);
  const y = o.map(({ props: O }, Rn) => {
    let M = "nav-item", En = O.disableRule || !1;
    return En && (M += " disabled"), Rn === c && (M += " active"), /* @__PURE__ */ React.createElement("li", { onClick: () => b(En, Rn), key: O.title, className: M }, O.icon, O.title);
  });
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("nav", { className: P }, /* @__PURE__ */ React.createElement("ul", { className: "nav nav-fill" }, y)), o[c]);
};
var Sa = { exports: {} }, Do = { exports: {} }, Xa;
function Ou() {
  return Xa || (Xa = 1, function(o, f) {
    (function(c, C) {
      ...
      function O(n, r) {
        ...
        for (s = 0; s < g.length; s++) i = g[s], r.indexOf(i) >= 0 || (v[i] = n[i]);
        return v;
      }
      function Rn(n) {
        var r = function(i, s) {
      ...
      function Nn() {
        ...
        return r.reduce(function(s, v) {
          ...
          return s = y({}, s, {}, O(v, ["style", "className"])), g && (s.style = s.style ? y({}, s.style || {}, {}, g || {}) : g), h && (s.className = s.className ? s.className + " " + h : h), s.className === "" && delete s.className, s;
        }, {});
      }
      var Cn = function(n, r) {
      ...
      function An(n, r, i) {
        return i === void 0 && (i = {}), function(s, v) {
          ...
          if (g === void 0) throw console.info(r), new Error("Renderer Error ☝️");
      ...
      function zn(n, r, i) {
        return i === void 0 && (i = 0), n.map(function(s) {
          return ne(s = y({}, s, { parent: r, depth: i })), s.columns && (s.columns = zn(s.columns, s, i + 1)), s;
        });
      }
      function de(n) {
        return Pe(n, "columns");
      ...
      function ne(n) {
              ...
              var E, V = typeof R == "function" ? R : JSON.stringify(R), W = _n.get(V) || function() {
                var x = function(L) {
                  return function H(X, U) {
                    if (U === void 0 && (U = []), Array.isArray(X)) for (var ln = 0; ln < X.length; ln += 1) H(X[ln], U);
                    else U.push(X);
                    return U;
                  }(L).map(function(H) {
        ...
        if (!r && typeof s == "string" && s && (r = s), !r && n.columns) throw console.error(n), new Error('A column ID (or unique "Header" value) is required!');
        if (!r) throw console.error(n), new Error("A column ID (or string accessor) is required!");
        return Object.assign(n, { id: r, accessor: i }), n;
      }
      function en(n, r) {
        if (!r) throw new Error();
        return Object.assign(n, y({ Header: w, Footer: w }, rn, {}, r, {}, n)), Object.assign(n, { originalWidth: n.width }), n;
      }
      function dn(n, r, i) {
        i === void 0 && (i = function() {
          return {};
        ...
        for (var s = [], v = n, g = 0, h = function() {
          ...
          v.forEach(function(W) {
            ...
            V && (W.parent ? x = y({}, W.parent, { originalId: W.parent.id, id: W.parent.id + "_" + h(), headers: [W] }, i(W)) : x = en(y({ originalId: W.id + "_placeholder", id: W.id + "_placeholder_" + h(), placeholderOf: W, headers: [W] }, i(W)), r), L && L.originalId === x.originalId ? L.headers.push(W) : E.push(x)), T.headers.push(W);
          }), s.push(T), v = E;
        }; v.length; ) R();
        return s.reverse();
      }
      ...
      function Yn() {
        for (var n = arguments.length, r = new Array(n), i = 0; i < n; i++) r[i] = arguments[i];
        for (var s = 0; s < r.length; s += 1) if (r[s] !== void 0) return r[s];
      }
      function $n(n) {
      ...
      function _e(n, r, i, s) {
        if (r.type === M.init) return y({ hiddenColumns: [] }, n);
        if (r.type === M.resetHiddenColumns) return y({}, n, { hiddenColumns: s.initialState.hiddenColumns || [] });
        ...
        return r.type === M.setHiddenColumns ? y({}, n, { hiddenColumns: Hn(r.value, n.hiddenColumns) }) : r.type === M.toggleHideAllColumns ? y({}, n, { hiddenColumns: (r.value !== void 0 ? r.value : !n.hiddenColumns.length) ? s.allColumns.map(function(g) {
          return g.id;
        }) : [] }) : void 0;
      }
      function pe(n) {
      ...
      function ye(n) {
        var r = n.columns, i = n.flatHeaders, s = n.dispatch, v = n.allColumns, g = n.getHooks, h = n.state.hiddenColumns, R = n.autoResetHiddenColumns, T = R === void 0 || R, E = bn(n), V = v.length === h.length, W = C.useCallback(function(U, ln) {
        ...
        }, [s, r]), Object.assign(n, { allColumnsHidden: V, toggleHideColumn: W, setHiddenColumns: x, toggleHideAllColumns: L, getToggleHideAllColumnsProps: H });
      }
      ...
      function ie(n) {
        ...
        return y({}, O(n, ["initialState", "defaultColumn", "getSubRows", "getRowId", "stateReducer", "useControlledState"]), { initialState: i, defaultColumn: v, getSubRows: h, getRowId: T, stateReducer: V, useControlledState: x });
      }
      function ge(n, r) {
        r === void 0 && (r = 0);
        var i = 0, s = 0, v = 0, g = 0;
        return n.forEach(function(h) {
          ...
          } else h.totalMinWidth = h.minWidth, h.totalWidth = Math.min(Math.max(h.minWidth, h.width), h.maxWidth), h.totalMaxWidth = h.maxWidth, h.totalFlexWidth = h.canResize ? h.totalWidth : 0;
      ...
      function Fe(n) {
        ...
        r.forEach(function(V, W) {
          return function x(L, H, X, U, ln) {
            ...
            if (K) K.subRows && K.originalSubRows.forEach(function(nn, wn) {
              return x(nn, wn, X + 1, K);
            });
            else if ((K = { id: sn, original: Ln, index: H, depth: X, cells: [{}] }).cells.map = fe, K.cells.filter = fe, K.cells.forEach = fe, K.cells[0].getCellProps = fe, K.values = {}, ln.push(K), s.push(K), v[sn] = K, K.originalSubRows = R(L, H), K.originalSubRows) {
              var Tn = [];
              K.originalSubRows.forEach(function(nn, wn) {
                return x(nn, wn, X + 1, K, Tn);
              }), K.subRows = Tn;
            }
            g.accessor && (K.values[g.id] = g.accessor(L, H, K, ln, r)), K.values[g.id] = fn(T, K.values[g.id], { row: K, column: g, instance: E() });
          }(V, W, 0, void 0, i);
        });
      }
      ...
      function Ue(n, r, i, s) {
        if (r.type === M.init) return y({ expanded: {} }, n);
        if (r.type === M.resetExpanded) return y({}, n, { expanded: s.initialState.expanded || {} });
        ...
        if (r.type === M.toggleRowExpanded) {
          ...
          if (!W && x) return y({}, n, { expanded: y({}, n.expanded, (T = {}, T[E] = !0, T)) });
          if (W && !x) {
            var L = n.expanded;
            return L[E], y({}, n, { expanded: O(L, [E].map(Rn)) });
          }
          return n;
        }
      }
      function We(n) {
        var r = n.data, i = n.rows, s = n.rowsById, v = n.manualExpandedKey, g = v === void 0 ? "expanded" : v, h = n.paginateExpandedRows, R = h === void 0 || h, T = n.expandSubRows, E = T === void 0 || T, V = n.autoResetExpanded, W = V === void 0 || V, x = n.getHooks, L = n.plugins, H = n.state.expanded, X = n.dispatch;
        ...
        var Ln = C.useCallback(function(xn, pn) {
      ...
      var $e = Object.freeze({ __proto__: null, text: xe, exactText: Ge, exactTextCase: He, includes: at, includesAll: dt, includesSome: Ft, includesValue: ft, exact: Ht, equals: Wt, between: xt });
      M.resetFilters = "resetFilters", M.setFilter = "setFilter", M.setAllFilters = "setAllFilters";
      var Gt = function(n) {
        n.stateReducers.push(Lo), n.useInstance.push(Vt);
      };
      function Lo(n, r, i, s) {
        if (r.type === M.init) return y({ filters: [] }, n);
        if (r.type === M.resetFilters) return y({}, n, { filters: s.initialState.filters || [] });
        if (r.type === M.setFilter) {
          var v = r.columnId, g = r.filterValue, h = s.allColumns, R = s.filterTypes, T = h.find(function(X) {
            return X.id === v;
          });
          if (!T) throw new Error("React-Table: Could not find a column with id: " + v);
        ...
        if (r.type === M.setAllFilters) {
          var x = r.filters, L = s.allColumns, H = s.filterTypes;
      ...
      function Vt(n) {
        var r = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.filterTypes, R = n.manualFilters, T = n.defaultCanFilter, E = T !== void 0 && T, V = n.disableFilters, W = n.state.filters, x = n.dispatch, L = n.autoResetFilters, H = L === void 0 || L, X = C.useCallback(function(nn, wn) {
          x({ type: M.setFilter, columnId: nn, filterValue: wn });
        }, [x]), U = C.useCallback(function(nn) {
        ...
        }, [x, R ? null : r]), Object.assign(n, { preFilteredRows: i, preFilteredFlatRows: s, preFilteredRowsById: v, filteredRows: Ln, filteredFlatRows: sn, filteredRowsById: K, rows: Ln, flatRows: sn, rowsById: K, setFilter: X, setAllFilters: U });
      }
      ...
      function Kt(n, r, i, s) {
        if (r.type === M.resetGlobalFilter) return y({}, n, { globalFilter: s.initialState.globalFilter || void 0 });
      ...
      function qt(n) {
        var r = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.filterTypes, R = n.globalFilter, T = n.manualGlobalFilter, E = n.state.globalFilter, V = n.dispatch, W = n.autoResetGlobalFilter, x = W === void 0 || W, L = n.disableGlobalFilter, H = C.useCallback(function(K) {
          V({ type: M.setGlobalFilter, filterValue: K });
        }, [V]), X = C.useMemo(function() {
          if (T || E === void 0) return [i, s, v];
          var K = [], Tn = {}, nn = be(R, h || {}, $e);
          if (!nn) return console.warn("Could not find a valid 'globalFilter' option."), i;
        ...
        }, [V, T ? null : r]), Object.assign(n, { preGlobalFilteredRows: i, preGlobalFilteredFlatRows: s, preGlobalFilteredRowsById: v, globalFilteredRows: U, globalFilteredFlatRows: ln, globalFilteredRowsById: Ln, rows: U, flatRows: ln, rowsById: Ln, setGlobalFilter: H, disableGlobalFilter: L });
      }
      function gt(n, r) {
      ...
      var vt = function(n) {
        n.getGroupByToggleProps = [Xt], n.stateReducers.push(Ze), n.visibleColumnsDeps.push(function(r, i) {
          var s = i.instance;
          return [].concat(r, [s.state.groupBy]);
        }), n.visibleColumns.push(Yt), n.useInstance.push(Oo), n.prepareRow.push(jt);
      };
      ...
      function Ze(n, r, i, s) {
        if (r.type === M.init) return y({ groupBy: [] }, n);
        if (r.type === M.resetGroupBy) return y({}, n, { groupBy: s.initialState.groupBy || [] });
        if (r.type === M.setGroupBy) return y({}, n, { groupBy: r.value });
      ...
      var ko = {};
      function Oo(n) {
        var r = n.data, i = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.flatHeaders, R = n.groupByFn, T = R === void 0 ? Ut : R, E = n.manualGroupBy, V = n.aggregations, W = V === void 0 ? ko : V, x = n.plugins, L = n.state.groupBy, H = n.dispatch, X = n.autoResetGroupBy, U = X === void 0 || X, ln = n.disableGroupBy, Ln = n.defaultCanGroupBy, sn = n.getHooks;
        vn(x, ["useColumnOrder", "useFilters"], "useGroupBy");
        var K = bn(n);
        g.forEach(function(u) {
          var a = u.accessor, p = u.defaultGroupBy, m = u.disableGroupBy;
          u.canGroupBy = a ? Yn(u.canGroupBy, m !== !0 && void 0, ln !== !0 && void 0, !0) : Yn(u.canGroupBy, p, Ln, !1), u.canGroupBy && (u.toggleGroupBy = function() {
        ...
        var wn = C.useMemo(function() {
          if (E || !L.length) return [i, s, v, zt, _t, s, v];
          var u = L.filter(function(I) {
            return g.find(function(q) {
              return q.id === I;
            });
          }), a = [], p = {}, m = [], d = {}, S = [], A = {}, N = function I(q, B, G) {
            if (B === void 0 && (B = 0), B === u.length) return q.map(function(Z) {
              return y({}, Z, { depth: B });
            });
            var _ = u[B], k = T(q, _);
            return Object.entries(k).map(function(Z, yn) {
              var mn = Z[0], j = Z[1], Pn = _ + ":" + mn, Fn = I(j, B + 1, Pn = G ? G + ">" + Pn : Pn), J = B ? Pe(j, "leafRows") : j, Y = function(cn, kn, On) {
                var Xn = {};
                return g.forEach(function(on) {
                  if (u.includes(on.id)) Xn[on.id] = kn[0] ? kn[0].values[on.id] : null;
                  else {
                    var le = typeof on.aggregate == "function" ? on.aggregate : W[on.aggregate] || mt[on.aggregate];
                    if (le) {
                      var Bn = kn.map(function(Mn) {
                        return Mn.values[on.id];
                      }), Sn = cn.map(function(Mn) {
                        var Un = Mn.values[on.id];
                        if (!On && on.aggregateValue) {
                          var ce = typeof on.aggregateValue == "function" ? on.aggregateValue : W[on.aggregateValue] || mt[on.aggregateValue];
                          if (!ce) throw console.info({ column: on }), new Error("React Table: Invalid column.aggregateValue option for column listed above");
                          Un = ce(Un, Mn, on);
                        }
                        return Un;
                      });
                      ...
                      if (on.aggregate) throw console.info({ column: on }), new Error("React Table: Invalid column.aggregate option for column listed above");
                      Xn[on.id] = null;
                    }
                  }
                }), Xn;
              ...
              return Fn.forEach(function(cn) {
                a.push(cn), p[cn.id] = cn, cn.isGrouped ? (m.push(cn), d[cn.id] = cn) : (S.push(cn), A[cn.id] = cn);
              }), $;
            });
          }(i);
          return N.forEach(function(I) {
            a.push(I), p[I.id] = I, I.isGrouped ? (m.push(I), d[I.id] = I) : (S.push(I), A[I.id] = I);
          }), [N, a, p, m, d, S, A];
        }, [E, L, i, s, v, g, W, T]), xn = wn[0], pn = wn[1], hn = wn[2], qn = wn[3], Dn = wn[4], Kn = wn[5], e = wn[6], t = bn(U);
        Wn(function() {
          t() && H({ type: M.resetGroupBy });
        }, [H, E ? null : r]), Object.assign(n, { preGroupedRows: i, preGroupedFlatRow: s, preGroupedRowsById: v, groupedRows: xn, groupedFlatRows: pn, groupedRowsById: hn, onlyGroupedFlatRows: qn, onlyGroupedRowsById: Dn, nonGroupedFlatRows: Kn, nonGroupedRowsById: e, rows: xn, flatRows: pn, rowsById: hn, toggleGroupBy: Tn, setGroupBy: nn });
      }
      function jt(n) {
      ...
      var Bo = Object.freeze({ __proto__: null, alphanumeric: function(n, r, i) {
        ...
        for (v = $t(v), g = $t(g), v = v.split(Jt).filter(Boolean), g = g.split(Jt).filter(Boolean); v.length && g.length; ) {
          ...
          if (isNaN(V[0])) {
            ...
            if (isNaN(V[1])) return isNaN(T) ? -1 : 1;
            if (T > E) return 1;
            if (E > T) return -1;
          }
        }
      ...
      M.resetSortBy = "resetSortBy", M.setSortBy = "setSortBy", M.toggleSortBy = "toggleSortBy", M.clearSortBy = "clearSortBy", rn.sortType = "alphanumeric", rn.sortDescFirst = !1;
      var Zt = function(n) {
      ...
      function Ho(n, r, i, s) {
        if (r.type === M.init) return y({ sortBy: [] }, n);
        if (r.type === M.resetSortBy) return y({}, n, { sortBy: s.initialState.sortBy || [] });
        if (r.type === M.clearSortBy) return y({}, n, { sortBy: n.sortBy.filter(function(K) {
          return K.id !== r.columnId;
        }) });
        if (r.type === M.setSortBy) return y({}, n, { sortBy: r.sortBy });
        if (r.type === M.toggleSortBy) {
          var v, g = r.columnId, h = r.desc, R = r.multi, T = s.allColumns, E = s.disableMultiSort, V = s.disableSortRemove, W = s.disableMultiRemove, x = s.maxMultiSortColCount, L = x === void 0 ? Number.MAX_SAFE_INTEGER : x, H = n.sortBy, X = T.find(function(K) {
            return K.id === g;
          ...
          return (v = !E && R ? U ? "toggle" : "add" : ln !== H.length - 1 || H.length !== 1 ? "replace" : U ? "toggle" : "replace") != "toggle" || V || Ln || R && W || !(U && U.desc && !X || !U.desc && X) || (v = "remove"), v === "replace" ? sn = [{ id: g, desc: Ln ? h : X }] : v === "add" ? (sn = [].concat(H, [{ id: g, desc: Ln ? h : X }])).splice(0, sn.length - L) : v === "toggle" ? sn = H.map(function(K) {
            return K.id === g ? y({}, K, { desc: Ln ? h : !U.desc }) : K;
      ...
      function Wo(n) {
        var r = n.data, i = n.rows, s = n.flatRows, v = n.allColumns, g = n.orderByFn, h = g === void 0 ? Qt : g, R = n.sortTypes, T = n.manualSortBy, E = n.defaultCanSort, V = n.disableSortBy, W = n.flatHeaders, x = n.state.sortBy, L = n.dispatch, H = n.plugins, X = n.getHooks, U = n.autoResetSortBy, ln = U === void 0 || U;
        vn(H, ["useFilters", "useGlobalFilter", "useGroupBy", "usePivotColumns"], "useSortBy");
        var Ln = C.useCallback(function(pn) {
          L({ type: M.setSortBy, sortBy: pn });
        }, [L]), sn = C.useCallback(function(pn, hn, qn) {
        ...
        W.forEach(function(pn) {
          ...
          pn.isSorted = !!t, pn.sortedIndex = x.findIndex(function(u) {
            return u.id === Kn;
          }), pn.isSortedDesc = pn.isSorted ? t.desc : void 0;
        });
        var Tn = C.useMemo(function() {
          if (T || !x.length) return [i, s];
          ...
          return [function qn(Dn) {
            var Kn = h(Dn, hn.map(function(e) {
              ...
              var u = t.sortType, a = $n(u) || (R || {})[u] || Bo[u];
              if (!a) throw new Error("React-Table: Could not find a valid sortType of '" + u + "' for column '" + e.id + "'.");
              return function(p, m) {
        ...
        }, [T ? null : r]), Object.assign(n, { preSortedRows: i, preSortedFlatRows: s, sortedRows: nn, sortedFlatRows: wn, rows: nn, flatRows: wn, setSortBy: Ln, toggleSortBy: sn });
      }
      function Qt(n, r, i) {
      ...
      function xo(n, r, i, s) {
        if (r.type === M.init) return y({ pageSize: 10, pageIndex: 0 }, n);
        if (r.type === M.resetPage) return y({}, n, { pageIndex: s.initialState.pageIndex || 0 });
      ...
      function Go(n) {
        ...
        var xn = nn ? R : Math.ceil(r.length / L), pn = C.useMemo(function() {
          return xn > 0 ? [].concat(new Array(xn)).fill(null).map(function(a, p) {
            return p;
          }) : [];
        }, [xn]), hn = C.useMemo(function() {
          var a;
          if (nn) a = r;
          else {
            var p = L * H, m = p + L;
        ...
        }, [W, X, g, nn, H, L, E, r]), qn = H > 0, Dn = xn === -1 ? hn.length >= L : H < xn - 1, Kn = C.useCallback(function(a) {
          K({ type: M.gotoPage, pageIndex: a });
        }, [K]), e = C.useCallback(function() {
          return Kn(function(a) {
            return a - 1;
          });
        }, [Kn]), t = C.useCallback(function() {
          return Kn(function(a) {
            return a + 1;
          });
        }, [Kn]), u = C.useCallback(function(a) {
          K({ type: M.setPageSize, pageSize: a });
        }, [K]);
        Object.assign(n, { pageOptions: pn, pageCount: xn, page: hn, canPreviousPage: qn, canNextPage: Dn, gotoPage: Kn, previousPage: e, nextPage: t, setPageSize: u });
      }
      ht.pluginName = "usePagination", M.resetPivot = "resetPivot", M.togglePivot = "togglePivot";
      var St = function(n) {
        n.getPivotToggleProps = [Vo], n.stateReducers.push(Ko), n.useInstanceAfterData.push(qo), n.allColumns.push(zo), n.accessValue.push(_o), n.materializedColumns.push(eo), n.materializedColumnsDeps.push(to), n.visibleColumns.push(Xo), n.visibleColumnsDeps.push(Yo), n.useInstance.push(jo), n.prepareRow.push(Uo);
      };
      St.pluginName = "usePivotColumns";
      var no = [], Vo = function(n, r) {
        var i = r.header;
      ...
      function Ko(n, r, i, s) {
        if (r.type === M.init) return y({ pivotColumns: no }, n);
        if (r.type === M.resetPivot) return y({}, n, { pivotColumns: s.initialState.pivotColumns || no });
      ...
      function eo(n, r) {
        ...
        if (!v.pivotColumns.length || !v.groupBy || !v.groupBy.length) return n;
        var g = v.pivotColumns.map(function(T) {
          ...
          return x ? Array.from(x.uniqueValues).sort().map(function(L) {
            var H = y({}, x, { Header: x.PivotHeader || typeof x.header == "string" ? x.Header + ": " + L : L, isPivotGroup: !0, parent: V, depth: E, id: V ? V.id + "." + x.id + "." + L : x.id + "." + L, pivotValue: L });
            return H.columns = T(E + 1, H, [].concat(W, [function(X) {
              return X.values[x.id] === L;
            }])), H;
          }) : h.map(function(L) {
            return y({}, L, { canPivot: !1, isPivoted: !0, parent: V, depth: E, id: "" + (V ? V.id + "." + L.id : L.id), accessor: function(H, X, U) {
      ...
      var oo = function(n) {
        n.getToggleRowSelectedProps = [wt], n.getToggleAllRowsSelectedProps = [nt], n.getToggleAllPageRowsSelectedProps = [ao], n.stateReducers.push(Jo), n.useInstance.push(ro), n.prepareRow.push($o);
      };
      ...
      function Jo(n, r, i, s) {
        if (r.type === M.init) return y({ selectedRowIds: {} }, n);
        if (r.type === M.resetSelectedRows) return y({}, n, { selectedRowIds: s.initialState.selectedRowIds || {} });
        ...
        if (r.type === M.toggleRowSelected) {
          var W = r.id, x = r.value, L = s.rowsById, H = s.selectSubRows, X = H === void 0 || H, U = s.getSubRows, ln = n.selectedRowIds[W], Ln = x !== void 0 ? x : !ln;
          if (ln === Ln) return n;
          var sn = y({}, n.selectedRowIds);
          return function Kn(e) {
            var t = L[e];
            if (t && (t.isGrouped || (Ln ? sn[e] = !0 : delete sn[e]), X && U(t))) return U(t).forEach(function(u) {
              return Kn(u.id);
            });
          }(W), y({}, n, { selectedRowIds: sn });
        }
        if (r.type === M.toggleAllPageRowsSelected) {
          var K = r.value, Tn = s.page, nn = s.rowsById, wn = s.selectSubRows, xn = wn === void 0 || wn, pn = s.isAllPageRowsSelected, hn = s.getSubRows, qn = K !== void 0 ? K : !pn, Dn = y({}, n.selectedRowIds);
          return Tn.forEach(function(Kn) {
            return function e(t) {
              var u = nn[t];
              if (u.isGrouped || (qn ? Dn[t] = !0 : delete Dn[t]), xn && hn(u)) return hn(u).forEach(function(a) {
                return e(a.id);
              });
            }(Kn.id);
      ...
      function ro(n) {
        var r = n.data, i = n.rows, s = n.getHooks, v = n.plugins, g = n.rowsById, h = n.nonGroupedRowsById, R = h === void 0 ? g : h, T = n.autoResetSelectedRows, E = T === void 0 || T, V = n.state.selectedRowIds, W = n.selectSubRows, x = W === void 0 || W, L = n.dispatch, H = n.page, X = n.getSubRows;
        ...
        var U = C.useMemo(function() {
          ...
          return i.forEach(function(qn) {
            var Dn = x ? function Kn(e, t, u) {
              if (t[e.id]) return !0;
              var a = u(e);
              if (a && a.length) {
                var p = !0, m = !1;
                return a.forEach(function(d) {
                  m && !p || (Kn(d, t, u) ? m = !0 : p = !1);
                }), !!p || !!m && null;
              }
              return !1;
            }(qn, V, X) : !!V[qn.id];
      ...
      var Mt = function(n) {
        n.stateReducers.push(Zo), n.useInstance.push(lo), n.prepareRow.push(Qo);
      };
      function Zo(n, r, i, s) {
        var v = s.initialRowStateAccessor, g = v === void 0 ? uo : v, h = s.initialCellStateAccessor, R = h === void 0 ? io : h, T = s.rowsById;
        if (r.type === M.init) return y({ rowState: {} }, n);
        if (r.type === M.resetRowState) return y({}, n, { rowState: s.initialState.rowState || {} });
        if (r.type === M.setRowState) {
          var E, V = r.rowId, W = r.value, x = n.rowState[V] !== void 0 ? n.rowState[V] : g(T[V]);
          return y({}, n, { rowState: y({}, n.rowState, (E = {}, E[V] = Hn(W, x), E)) });
        }
        if (r.type === M.setCellState) {
          var L, H, X, U, ln, Ln = r.rowId, sn = r.columnId, K = r.value, Tn = n.rowState[Ln] !== void 0 ? n.rowState[Ln] : g(T[Ln]), nn = (Tn == null || (L = Tn.cellState) == null ? void 0 : L[sn]) !== void 0 ? Tn.cellState[sn] : R((H = T[Ln]) == null || (X = H.cells) == null ? void 0 : X.find(function(wn) {
            return wn.column.id === sn;
          }));
          return y({}, n, { rowState: y({}, n.rowState, (ln = {}, ln[Ln] = y({}, Tn, { cellState: y({}, Tn.cellState || {}, (U = {}, U[sn] = Hn(K, nn), U)) }), ln)) });
        }
      }
      function lo(n) {
      ...
      function Qo(n, r) {
        var i = r.instance, s = i.initialRowStateAccessor, v = s === void 0 ? uo : s, g = i.initialCellStateAccessor, h = g === void 0 ? io : g, R = i.state.rowState;
      ...
      var so = function(n) {
        n.stateReducers.push(co), n.visibleColumnsDeps.push(function(r, i) {
          var s = i.instance;
          return [].concat(r, [s.state.columnOrder]);
        }), n.visibleColumns.push(yo), n.useInstance.push(na);
      };
      function co(n, r, i, s) {
        return r.type === M.init ? y({ columnOrder: [] }, n) : r.type === M.resetColumnOrder ? y({}, n, { columnOrder: s.initialState.columnOrder || [] }) : r.type === M.setColumnOrder ? y({}, n, { columnOrder: Hn(r.columnOrder, n.columnOrder) }) : void 0;
      }
      function yo(n, r) {
      ...
      so.pluginName = "useColumnOrder", rn.canResize = !0, M.columnStartResizing = "columnStartResizing", M.columnResizing = "columnResizing", M.columnDoneResizing = "columnDoneResizing", M.resetResize = "resetResize";
      var Co = function(n) {
        ...
        var i = r.instance, s = r.header, v = i.dispatch, g = function(h, R) {
          ...
          if (h.type === "touchstart") {
            if (h.touches && h.touches.length > 1) return;
            T = !0;
          }
      ...
      function ta(n, r) {
        if (r.type === M.init) return y({ columnResizing: { columnWidths: {} } }, n);
        if (r.type === M.resetResize) return y({}, n, { columnResizing: { columnWidths: {} } });
        if (r.type === M.columnStartResizing) {
          var i = r.clientX, s = r.columnId, v = r.columnWidth, g = r.headerIdWidths;
          return y({}, n, { columnResizing: y({}, n.columnResizing, { startX: i, headerIdWidths: g, columnWidth: v, isResizingColumn: s }) });
        }
      ...
      var oa = function(n) {
        var r = n.flatHeaders, i = n.disableResizing, s = n.getHooks, v = n.state.columnResizing, g = bn(n);
      ...
      var bt = { position: "absolute", top: 0 }, fo = function(n) {
        n.getTableBodyProps.push(ut), n.getRowProps.push(ut), n.getHeaderGroupProps.push(ut), n.getFooterGroupProps.push(ut), n.getHeaderProps.push(function(r, i) {
          var s = i.column;
          return [r, { style: y({}, bt, { left: s.totalLeft + "px", width: s.totalWidth + "px" }) }];
        }), n.getCellProps.push(function(r, i) {
          var s = i.cell;
          return [r, { style: y({}, bt, { left: s.column.totalLeft + "px", width: s.column.totalWidth + "px" }) }];
      ...
      var ut = function(n, r) {
        ...
        n.getRowProps.push(Dt), n.getHeaderGroupProps.push(Dt), n.getFooterGroupProps.push(Dt), n.getHeaderProps.push(function(r, i) {
          var s = i.column;
          return [r, { style: y({}, At, { width: s.totalWidth + "px" }) }];
        }), n.getCellProps.push(function(r, i) {
          var s = i.cell;
          return [r, { style: y({}, At, { width: s.column.totalWidth + "px" }) }];
        }), n.getFooterProps.push(function(r, i) {
          var s = i.column;
          return [r, { style: y({}, At, { width: s.totalWidth + "px" }) }];
        });
      ...
      M.columnStartResizing = "columnStartResizing", M.columnResizing = "columnResizing", M.columnDoneResizing = "columnDoneResizing", M.resetResize = "resetResize", go.pluginName = "useGridLayout";
      var mo = function(n, r) {
        var i = r.instance;
      ...
      function So(n, r, i, s) {
        if (r.type === M.init) return y({ gridLayout: { columnWidths: {} } }, n);
        if (r.type === M.resetResize) return y({}, n, { gridLayout: { columnWidths: {} } });
        if (r.type === M.columnStartResizing) {
          var v = r.columnId, g = r.headerIdWidths, h = Tt(v);
          if (h !== void 0) {
            var R = s.visibleColumns.reduce(function(K, Tn) {
              var nn;
              return y({}, K, ((nn = {})[Tn.id] = Tt(Tn.id), nn));
            }, {}), T = s.visibleColumns.reduce(function(K, Tn) {
              var nn;
              return y({}, K, ((nn = {})[Tn.id] = Tn.minWidth, nn));
            }, {}), E = s.visibleColumns.reduce(function(K, Tn) {
              var nn;
              return y({}, K, ((nn = {})[Tn.id] = Tn.maxWidth, nn));
            }, {}), V = g.map(function(K) {
              var Tn = K[0];
              return [Tn, Tt(Tn)];
            });
        ...
        if (r.type === M.columnResizing) {
          var W = r.clientX, x = n.columnResizing.startX, L = n.gridLayout, H = L.columnWidth, X = L.minWidths, U = L.maxWidths, ln = L.headerIdGridWidths, Ln = (W - x) / H, sn = {};
      ...
      c._UNSTABLE_usePivotColumns = St, c.actions = M, c.defaultColumn = rn, c.defaultGroupByFn = Ut, c.defaultOrderByFn = Qt, c.defaultRenderer = En, c.emptyRenderer = w, c.ensurePluginOrder = vn, c.flexRender = ae, c.functionalUpdate = Hn, c.loopHooks = Vn, c.makePropGetter = Cn, c.makeRenderer = An, c.reduceHooks = fn, c.safeUseLayoutEffect = Jn, c.useAbsoluteLayout = fo, c.useAsyncDebounce = function(n, r) {
        r === void 0 && (r = 0);
        var i = C.useRef({}), s = bn(n), v = bn(r);
          ...
          var g = P(regeneratorRuntime.mark(function h() {
            ...
            return regeneratorRuntime.wrap(function(W) {
              for (; ; ) switch (W.prev = W.next) {
                case 0:
                  for (R = V.length, T = new Array(R), E = 0; E < R; E++) T[E] = V[E];
      ...
      }, c.useBlockLayout = po, c.useColumnOrder = so, c.useExpanded = Te, c.useFilters = Gt, c.useFlexLayout = Rt, c.useGetLatest = bn, c.useGlobalFilter = pt, c.useGridLayout = go, c.useGroupBy = vt, c.useMountedLayoutEffect = Wn, c.usePagination = ht, c.useResizeColumns = Co, c.useRowSelect = oo, c.useRowState = Mt, c.useSortBy = Zt, c.useTable = function(n) {
        for (var r = arguments.length, i = new Array(r > 1 ? r - 1 : 0), s = 1; s < r; s++) i[s - 1] = arguments[s];
        n = ie(n), i = [Ae].concat(i);
        var v = C.useRef({}), g = bn(v.current);
        Object.assign(g(), y({}, n, { plugins: i, hooks: Ne() })), i.filter(Boolean).forEach(function(d) {
          d(g().hooks);
        });
        var h = bn(g().hooks);
        g().getHooks = h, delete g().hooks, Object.assign(g(), fn(h().useOptions, ie(n)));
        var R = g(), T = R.data, E = R.columns, V = R.initialState, W = R.defaultColumn, x = R.getSubRows, L = R.getRowId, H = R.stateReducer, X = R.useControlledState, U = bn(H), ln = C.useCallback(function(d, S) {
          if (!S.type) throw console.info({ action: S }), new Error("Unknown Action 👆");
          return [].concat(h().stateReducers, Array.isArray(U()) ? U() : [U()]).reduce(function(A, N) {
            return N(A, S, d, g()) || A;
          }, d);
        }, [h, U, g]), Ln = C.useReducer(ln, void 0, function() {
          return ln(V, { type: M.init });
        }), sn = Ln[0], K = Ln[1], Tn = fn([].concat(h().useControlledState, [X]), sn, { instance: g() });
        Object.assign(g(), { state: Tn, dispatch: K });
        var nn = C.useMemo(function() {
          return zn(fn(h().columns, E, { instance: g() }));
        }, [h, g, E].concat(fn(h().columnsDeps, [], { instance: g() })));
        g().columns = nn;
        var wn = C.useMemo(function() {
          return fn(h().allColumns, de(nn), { instance: g() }).map(ne);
        }, [nn, h, g].concat(fn(h().allColumnsDeps, [], { instance: g() })));
        g().allColumns = wn;
        var xn = C.useMemo(function() {
          for (var d = [], S = [], A = {}, N = [].concat(wn); N.length; ) {
            var I = N.shift();
            Fe({ data: T, rows: d, flatRows: S, rowsById: A, column: I, getRowId: L, getSubRows: x, accessValueHooks: h().accessValue, getInstance: g });
          }
          return [d, S, A];
        ...
        var Dn = C.useMemo(function() {
          return fn(h().visibleColumns, wn, { instance: g() }).map(function(d) {
            return en(d, W);
          });
        }, [h, wn, g, W].concat(fn(h().visibleColumnsDeps, [], { instance: g() })));
        wn = C.useMemo(function() {
          var d = [].concat(Dn);
        ...
        var Kn = C.useMemo(function() {
          return fn(h().headerGroups, dn(Dn, W), g());
        }, [h, Dn, W, g].concat(fn(h().headerGroupsDeps, [], { instance: g() })));
        g().headerGroups = Kn;
        var e = C.useMemo(function() {
          return Kn.length ? Kn[0].headers : [];
        }, [Kn]);
        g().headers = e, g().flatHeaders = Kn.reduce(function(d, S) {
        ...
        return g().totalColumnsMinWidth = a, g().totalColumnsWidth = p, g().totalColumnsMaxWidth = m, Vn(h().useInstance, g()), [].concat(g().flatHeaders, g().allColumns).forEach(function(d) {
        ...
        }, [Kn, g, h]), g().footerGroups = [].concat(g().headerGroups).reverse(), g().prepareRow = C.useCallback(function(d) {
...
function Bu() {
  return Ya || (Ya = 1, function(o, f) {
    (function(c, C) {
      ...
      C = C && Object.prototype.hasOwnProperty.call(C, "default") ? C.default : C;
      function b(e, t, u, a, p, m, d) {
        try {
          var S = e[m](d), A = S.value;
        } catch (N) {
          u(N);
          return;
        }
      ...
      function fn() {
        ...
        return t.reduce(function(a, p) {
          ...
          return a = y({}, a, {}, S), m && (a.style = a.style ? y({}, a.style || {}, {}, m || {}) : m), d && (a.className = a.className ? a.className + " " + d : d), a.className === "" && delete a.className, a;
        }, {});
      }
      function Vn(e, t, u) {
        return typeof t == "function" ? Vn({}, t(e, u)) : Array.isArray(t) ? fn.apply(void 0, [e].concat(t)) : fn(e, t);
      }
      var vn = function(t, u) {
...
`);
                              ...
                              return regeneratorRuntime.wrap(function(k) {
                                for (; ; )
                                  switch (k.prev = k.next) {
                                    case 0:
                                      return delete u.current.timeout, k.prev = 1, k.t0 = u.current, k.next = 5, a().apply(void 0, A);
                                    case 5:
      ...
      function F(e, t) {
        var u = t.manualExpandedKey, a = t.expanded, p = t.expandSubRows, m = p === void 0 ? !0 : p, d = [], S = function A(N, I) {
          I === void 0 && (I = !0), N.isExpanded = N.original && N.original[u] || a[N.id], N.canExpand = N.subRows && !!N.subRows.length, I && d.push(N), N.subRows && N.subRows.length && N.isExpanded && N.subRows.forEach(function(q) {
            return A(q, m);
          });
        };
      ...
      function Fe(e, t, u, a) {
        ...
        if (t.type === w.toggleHideAllColumns) {
          ...
          return y({}, e, {
            hiddenColumns: d ? a.allColumns.map(function(S) {
              return S.id;
            }) : []
          });
        }
      ...
      function Ye(e) {
        var t = e.columns, u = e.flatHeaders, a = e.dispatch, p = e.allColumns, m = e.getHooks, d = e.state.hiddenColumns, S = e.autoResetHiddenColumns, A = S === void 0 ? !0 : S, N = An(e), I = p.length === d.length, q = C.useCallback(function(Z, yn) {
          return a({
      ...
      function He(e) {
        var t = e.initialState, u = t === void 0 ? je : t, a = e.defaultColumn, p = a === void 0 ? Ue : a, m = e.getSubRows, d = m === void 0 ? Je : m, S = e.getRowId, A = S === void 0 ? xe : S, N = e.stateReducer, I = N === void 0 ? We : N, q = e.useControlledState, B = q === void 0 ? Ge : q, G = O(e, ["initialState", "defaultColumn", "getSubRows", "getRowId", "stateReducer", "useControlledState"]);
        return y({}, G, {
          initialState: u,
          defaultColumn: p,
          getSubRows: d,
      ...
      var at = function(t) {
        ...
        var S = An(d().hooks);
        d().getHooks = S, delete d().hooks, Object.assign(d(), Hn(S().useOptions, He(t)));
        var A = d(), N = A.data, I = A.columns, q = A.initialState, B = A.defaultColumn, G = A.getSubRows, _ = A.getRowId, k = A.stateReducer, Z = A.useControlledState, yn = An(k), mn = C.useCallback(function(gn, Zn) {
          if (!Zn.type)
            throw console.info({
              action: Zn
            }), new Error("Unknown Action 👆");
          return [].concat(S().stateReducers, Array.isArray(yn()) ? yn() : [yn()]).reduce(function(ue, Se) {
            return Se(ue, Zn, gn, d()) || ue;
          }, gn);
        }, [S, yn, d]), j = C.useReducer(mn, void 0, function() {
          return mn(q, {
            type: w.init
          });
        ...
        var cn = C.useMemo(function() {
          for (var gn = [], Zn = [], ue = {}, Se = [].concat($); Se.length; ) {
            var se = Se.shift();
            Ft({
              data: N,
              rows: gn,
        ...
        var Bn = C.useMemo(function() {
          return Hn(S().headerGroups, Ee(on, B), d());
        }, [S, on, B, d].concat(Hn(S().headerGroupsDeps, [], {
          instance: d()
        })));
        d().headerGroups = Bn;
        ...
        d().headers = Sn, d().flatHeaders = Bn.reduce(function(gn, Zn) {
          return [].concat(gn, Zn.headers);
        }, []), bn(S().useInstanceBeforeDimensions, d());
        var Mn = on.filter(function(gn) {
          return gn.isVisible;
        }).map(function(gn) {
          return gn.id;
        }).sort().join("_");
        ...
        return d().totalColumnsMinWidth = ce, d().totalColumnsWidth = et, d().totalColumnsMaxWidth = Pt, bn(S().useInstance, d()), [].concat(d().flatHeaders, d().allColumns).forEach(function(gn) {
          gn.render = ne(d(), gn), gn.getHeaderProps = vn(S().getHeaderProps, {
            instance: d(),
            column: gn
          ...
          return Bn.filter(function(gn, Zn) {
        ...
        }, [Bn, d, S]), d().footerGroups = [].concat(d().headerGroups).reverse(), d().prepareRow = C.useCallback(function(gn) {
          gn.getRowProps = vn(S().getRowProps, {
            instance: d(),
            row: gn
          }), gn.allCells = $.map(function(Zn) {
            var ue = gn.values[Zn.id], Se = {
              column: Zn,
              row: gn,
              value: ue
            };
        ...
        }, [S, d, $, on]), d().getTableProps = vn(S().getTableProps, {
          instance: d()
      ...
      function dt(e, t) {
        ...
        return e.forEach(function(d) {
          ...
          d.isVisible && (t += d.totalWidth, u += d.totalMinWidth, a += d.totalWidth, p += d.totalMaxWidth, m += d.totalFlexWidth);
        }), [u, a, p, m];
      }
      function Ft(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, m = e.column, d = e.getRowId, S = e.getSubRows, A = e.accessValueHooks, N = e.getInstance, I = function q(B, G, _, k, Z) {
          _ === void 0 && (_ = 0);
          ...
          }, j.cells.map = tn, j.cells.filter = tn, j.cells.forEach = tn, j.cells[0].getCellProps = tn, j.values = {}, Z.push(j), a.push(j), p[mn] = j, j.originalSubRows = S(B, G), j.originalSubRows) {
            var Pn = [];
      ...
      var ft = function(t) {
        t.getToggleAllRowsExpandedProps = [Ht], t.getToggleRowExpandedProps = [Wt], t.stateReducers.push(xt), t.useInstance.push($e), t.prepareRow.push(Gt);
      };
      ...
      function xt(e, t, u, a) {
        ...
        if (t.type === w.toggleAllRowsExpanded) {
          var p = t.value, m = a.rowsById, d = Object.keys(m).length === Object.keys(e.expanded).length, S = typeof p < "u" ? p : !d;
          if (S) {
            var A = {};
      ...
      function $e(e) {
        var t = e.data, u = e.rows, a = e.rowsById, p = e.manualExpandedKey, m = p === void 0 ? "expanded" : p, d = e.paginateExpandedRows, S = d === void 0 ? !0 : d, A = e.expandSubRows, N = A === void 0 ? !0 : A, I = e.autoResetExpanded, q = I === void 0 ? !0 : I, B = e.getHooks, G = e.plugins, _ = e.state.expanded, k = e.dispatch;
        ...
        var mn = C.useCallback(function($, cn) {
          k({
      ...
      var gt = function(t, u, a) {
        return t.filter(function(p) {
          return u.some(function(m) {
            var d = p.values[m];
            return d && d.length && a.every(function(S) {
              return d.includes(S);
            });
          });
        });
      ...
      var mt = function(t, u, a) {
        return t.filter(function(p) {
          return u.some(function(m) {
            var d = p.values[m];
            return d && d.length && a.some(function(S) {
              return d.includes(S);
            });
          });
        });
      ...
      function ko(e, t, u, a) {
        ...
        if (t.type === w.setFilter) {
          var p = t.columnId, m = t.filterValue, d = a.allColumns, S = a.filterTypes, A = d.find(function(k) {
            return k.id === p;
          });
          if (!A)
            throw new Error("React-Table: Could not find a column with id: " + p);
          var N = z(A.filter, S || {}, Ze), I = e.filters.find(function(k) {
            return k.id === p;
          }), q = Wn(m, I && I.value);
          return un(N.autoRemove, q, A) ? y({}, e, {
        ...
        if (t.type === w.setAllFilters) {
          ...
          return y({}, e, {
            ...
            filters: Wn(B, e.filters).filter(function(k) {
              var Z = G.find(function(mn) {
                return mn.id === k.id;
              }), yn = z(Z.filter, _ || {}, Ze);
              return !un(yn.autoRemove, k.value, Z);
            })
          });
        }
      }
      function Oo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, m = e.allColumns, d = e.filterTypes, S = e.manualFilters, A = e.defaultCanFilter, N = A === void 0 ? !1 : A, I = e.disableFilters, q = e.state.filters, B = e.dispatch, G = e.autoResetFilters, _ = G === void 0 ? !0 : G, k = C.useCallback(function(J, Y) {
          B({
            type: w.setFilter,
            columnId: J,
            filterValue: Y
        ...
        m.forEach(function(J) {
          ...
          J.canFilter = $ ? re(kn === !0 ? !1 : void 0, I === !0 ? !1 : void 0, !0) : re(cn, N, !1), J.setFilter = function(Xn) {
            return k(J.id, Xn);
          };
        ...
        var yn = C.useMemo(function() {
          ...
          var J = [], Y = {}, $ = function cn(kn, On) {
            On === void 0 && (On = 0);
            var Xn = kn;
            return Xn = q.reduce(function(on, le) {
              var Bn = le.id, Sn = le.value, Mn = m.find(function(ce) {
                return ce.id === Bn;
              });
              if (!Mn)
                return on;
              On === 0 && (Mn.preFilteredRows = on);
              var Un = z(Mn.filter, d || {}, Ze);
              return Un ? (Mn.filteredRows = Un(on, [Bn], Sn), Mn.filteredRows) : (console.warn("Could not find a valid 'column.filter' for column with the ID: " + Mn.id + "."), on);
            }, kn), Xn.forEach(function(on) {
              J.push(on), Y[on.id] = on, on.subRows && (on.subRows = on.subRows && on.subRows.length > 0 ? cn(on.subRows, On + 1) : on.subRows);
            }), Xn;
          };
          return [$(u), J, Y];
        }, [S, q, u, a, p, m, d]), mn = yn[0], j = yn[1], Pn = yn[2];
        C.useMemo(function() {
      ...
      function Ut(e, t, u, a) {
        ...
        if (t.type === w.setGlobalFilter) {
          var p = t.filterValue, m = a.userFilterTypes, d = z(a.globalFilter, m || {}, Ze), S = Wn(p, e.globalFilter);
          if (un(d.autoRemove, S)) {
            e.globalFilter;
      ...
      function Jt(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, m = e.allColumns, d = e.filterTypes, S = e.globalFilter, A = e.manualGlobalFilter, N = e.state.globalFilter, I = e.dispatch, q = e.autoResetGlobalFilter, B = q === void 0 ? !0 : q, G = e.disableGlobalFilter, _ = C.useCallback(function(Pn) {
          I({
            type: w.setGlobalFilter,
            filterValue: Pn
          });
        }, [I]), k = C.useMemo(function() {
          if (A || typeof N > "u")
            return [u, a, p];
          var Pn = [], Fn = {}, J = z(S, d || {}, Ze);
          if (!J)
            return console.warn("Could not find a valid 'globalFilter' option."), u;
          m.forEach(function(cn) {
            var kn = cn.disableGlobalFilter;
            cn.canFilter = re(kn === !0 ? !1 : void 0, G === !0 ? !1 : void 0, !0);
          });
          ...
          return [$(u), Pn, Fn];
        }, [A, N, S, d, m, u, a, p, G]), Z = k[0], yn = k[1], mn = k[2], j = An(B);
        zn(function() {
          j() && I({
      ...
      var St = function(t) {
        t.getGroupByToggleProps = [no], t.stateReducers.push(Vo), t.visibleColumnsDeps.push(function(u, a) {
          var p = a.instance;
      ...
      function Vo(e, t, u, a) {
        ...
        if (t.type === w.toggleGroupBy) {
          var m = t.columnId, d = t.value, S = typeof d < "u" ? d : !e.groupBy.includes(m);
          return S ? y({}, e, {
      ...
      var qo = {};
      function zo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.rowsById, m = e.allColumns, d = e.flatHeaders, S = e.groupByFn, A = S === void 0 ? eo : S, N = e.manualGroupBy, I = e.aggregations, q = I === void 0 ? qo : I, B = e.plugins, G = e.state.groupBy, _ = e.dispatch, k = e.autoResetGroupBy, Z = k === void 0 ? !0 : k, yn = e.disableGroupBy, mn = e.defaultCanGroupBy, j = e.getHooks;
        ...
        var Fn = C.useCallback(function(Sn, Mn) {
          _({
            type: w.toggleGroupBy,
            columnId: Sn,
            value: Mn
          });
        }, [_]), J = C.useCallback(function(Sn) {
          _({
            type: w.setGroupBy,
            value: Sn
          });
        ...
        var Y = C.useMemo(function() {
          ...
          var Sn = G.filter(function(se) {
            return m.find(function(Ve) {
              return Ve.id === se;
            });
          }), Mn = function(Ve, Ce, wo) {
            var Ke = {};
            return m.forEach(function(oe) {
              ...
              var Mo = typeof oe.aggregate == "function" ? oe.aggregate : q[oe.aggregate] || ht[oe.aggregate];
              if (Mo) {
                var it = Ce.map(function(tt) {
                  return tt.values[oe.id];
                }), sa = Ve.map(function(tt) {
                  var qe = tt.values[oe.id];
                  if (!wo && oe.aggregateValue) {
          ...
          }, Un = [], ce = {}, et = [], Pt = {}, gn = [], Zn = {}, ue = function se(Ve, Ce, wo) {
            ...
            var Ke = Sn[Ce], oe = A(Ve, Ke), Mo = Object.entries(oe).map(function(it, sa) {
              ...
              return Da.forEach(function(Le) {
                Un.push(Le), ce[Le.id] = Le, Le.isGrouped ? (et.push(Le), Pt[Le.id] = Le) : (gn.push(Le), Zn[Le.id] = Le);
              }), dr;
            });
            return Mo;
          }, Se = ue(u);
          return Se.forEach(function(se) {
            Un.push(se), ce[se.id] = se, se.isGrouped ? (et.push(se), Pt[se.id] = se) : (gn.push(se), Zn[se.id] = se);
          }), [Se, Un, ce, et, Pt, gn, Zn];
        }, [N, G, u, a, p, m, q, A]), $ = Y[0], cn = Y[1], kn = Y[2], On = Y[3], Xn = Y[4], on = Y[5], le = Y[6], Bn = An(Z);
        zn(function() {
          Bn() && _({
            type: w.resetGroupBy
          });
      ...
      var to = /([0-9]+)/gm, Xo = function(t, u, a) {
        var p = nt(t, u, a), m = p[0], d = p[1];
      ...
      function oo(e, t, u) {
        var a = nt(e, t, u), p = a[0], m = a[1], d = /[^0-9.]/gi;
        return p = Number(String(p).replace(d, "")), m = Number(String(m).replace(d, "")), wt(p, m);
      }
      function wt(e, t) {
      ...
      var ro = function(t) {
        t.getSortByToggleProps = [$o], t.stateReducers.push(uo), t.useInstance.push(io);
      };
      ro.pluginName = "useSortBy";
      var $o = function(t, u) {
        var a = u.instance, p = u.column, m = a.isMultiSortEvent, d = m === void 0 ? function(S) {
          return S.shiftKey;
        } : m;
        return [t, {
          onClick: p.canSort ? function(S) {
            S.persist(), p.toggleSortBy(void 0, !a.disableMultiSort && d(S));
          } : void 0,
          style: {
      ...
      function uo(e, t, u, a) {
        ...
        if (t.type === w.toggleSortBy) {
          var S = t.columnId, A = t.desc, N = t.multi, I = a.allColumns, q = a.disableMultiSort, B = a.disableSortRemove, G = a.disableMultiRemove, _ = a.maxMultiSortColCount, k = _ === void 0 ? Number.MAX_SAFE_INTEGER : _, Z = e.sortBy, yn = I.find(function($) {
            return $.id === S;
      ...
      function io(e) {
        var t = e.data, u = e.rows, a = e.flatRows, p = e.allColumns, m = e.orderByFn, d = m === void 0 ? Mt : m, S = e.sortTypes, A = e.manualSortBy, N = e.defaultCanSort, I = e.disableSortBy, q = e.flatHeaders, B = e.state.sortBy, G = e.dispatch, _ = e.plugins, k = e.getHooks, Z = e.autoResetSortBy, yn = Z === void 0 ? !0 : Z;
        ...
        }, [G]), j = C.useCallback(function(cn, kn, On) {
          G({
            type: w.toggleSortBy,
            columnId: cn,
            desc: kn,
        ...
        q.forEach(function(cn) {
          var kn = cn.accessor, On = cn.canSort, Xn = cn.disableSortBy, on = cn.id, le = kn ? re(Xn === !0 ? !1 : void 0, I === !0 ? !1 : void 0, !0) : re(N, On, !1);
        ...
        var Fn = C.useMemo(function() {
          ...
          return [On(u), cn];
        }, [A, B, u, a, p, d, S]), J = Fn[0], Y = Fn[1], $ = An(yn);
        zn(function() {
          $() && G({
            type: w.resetSortBy
          });
      ...
      function Mt(e, t, u) {
        return [].concat(e).sort(function(a, p) {
          for (var m = 0; m < t.length; m += 1) {
            var d = t[m], S = u[m] === !1 || u[m] === "desc", A = d(a, p);
            if (A !== 0)
              return S ? -A : A;
          }
      ...
      var lo = function(t) {
        t.stateReducers.push(Qo), t.useInstance.push(so);
      };
      lo.pluginName = Zo;
      function Qo(e, t, u, a) {
        if (t.type === w.init)
        ...
        if (t.type === w.gotoPage) {
          var p = a.pageCount, m = a.page, d = Wn(t.pageIndex, e.pageIndex), S = !1;
          return d > e.pageIndex ? S = p === -1 ? m.length >= e.pageSize : d < p : d < e.pageIndex && (S = d > -1), S ? y({}, e, {
            pageIndex: d
          }) : e;
        }
      ...
      function so(e) {
        var t = e.rows, u = e.autoResetPage, a = u === void 0 ? !0 : u, p = e.manualExpandedKey, m = p === void 0 ? "expanded" : p, d = e.plugins, S = e.pageCount, A = e.paginateExpandedRows, N = A === void 0 ? !0 : A, I = e.expandSubRows, q = I === void 0 ? !0 : I, B = e.state, G = B.pageSize, _ = B.pageIndex, k = B.expanded, Z = B.globalFilter, yn = B.filters, mn = B.groupBy, j = B.sortBy, Pn = e.dispatch, Fn = e.data, J = e.manualPagination;
        ...
        var $ = J ? S : Math.ceil(t.length / G), cn = C.useMemo(function() {
        ...
        }, [q, k, m, J, _, G, N, t]), On = _ > 0, Xn = $ === -1 ? kn.length >= G : _ < $ - 1, on = C.useCallback(function(Mn) {
          Pn({
            type: w.gotoPage,
            pageIndex: Mn
          });
        }, [Pn]), le = C.useCallback(function() {
          return on(function(Mn) {
            return Mn - 1;
          });
        }, [on]), Bn = C.useCallback(function() {
          return on(function(Mn) {
            return Mn + 1;
          });
        }, [on]), Sn = C.useCallback(function(Mn) {
          Pn({
            type: w.setPageSize,
            pageSize: Mn
          });
      ...
      var co = function(t) {
        t.getPivotToggleProps = [na], t.stateReducers.push(Co), t.useInstanceAfterData.push(ea), t.allColumns.push(ta), t.accessValue.push(oa), t.materializedColumns.push(aa), t.materializedColumnsDeps.push(bt), t.visibleColumns.push(fo), t.visibleColumnsDeps.push(ut), t.useInstance.push(At), t.prepareRow.push(Dt);
      };
      co.pluginName = "usePivotColumns";
      var yo = [], na = function(t, u) {
        var a = u.header;
        return [t, {
      ...
      function Co(e, t, u, a) {
        ...
        if (t.type === w.togglePivot) {
          var p = t.columnId, m = t.value, d = typeof m < "u" ? m : !e.pivotColumns.includes(p);
          return d ? y({}, e, {
      ...
      function aa(e, t) {
        ...
        }).filter(Boolean), d = a.filter(function(N) {
      ...
      function At(e) {
        var t = e.columns, u = e.allColumns, a = e.flatHeaders, p = e.getHooks, m = e.plugins, d = e.dispatch, S = e.autoResetPivot, A = S === void 0 ? !0 : S, N = e.manaulPivot, I = e.disablePivot, q = e.defaultCanPivot;
        Jn(m, ["useGroupBy"], "usePivotColumns");
        var B = An(e);
        u.forEach(function(k) {
          var Z = k.accessor, yn = k.defaultPivot, mn = k.disablePivot;
          k.canPivot = Z ? re(k.canPivot, mn === !0 ? !1 : void 0, I === !0 ? !1 : void 0, !0) : re(k.canPivot, yn, q, !1), k.canPivot && (k.togglePivot = function() {
      ...
      var Rt = function(t) {
        t.getToggleRowSelectedProps = [ra], t.getToggleAllRowsSelectedProps = [Nt], t.getToggleAllPageRowsSelectedProps = [ua], t.stateReducers.push(ia), t.useInstance.push(la), t.prepareRow.push(go);
      };
      Rt.pluginName = po;
      var ra = function(t, u) {
        var a = u.instance, p = u.row, m = a.manualRowSelectedKey, d = m === void 0 ? "isSelected" : m, S = !1;
        return p.original && p.original[d] ? S = !0 : S = p.isSelected, [t, {
          onChange: function(N) {
      ...
      function ia(e, t, u, a) {
        ...
        if (t.type === w.toggleAllRowsSelected) {
          var p = t.value, m = a.isAllRowsSelected, d = a.rowsById, S = a.nonGroupedRowsById, A = S === void 0 ? d : S, N = typeof p < "u" ? p : !m, I = Object.assign({}, e.selectedRowIds);
        ...
        if (t.type === w.toggleRowSelected) {
          var q = t.id, B = t.value, G = a.rowsById, _ = a.selectSubRows, k = _ === void 0 ? !0 : _, Z = a.getSubRows, yn = e.selectedRowIds[q], mn = typeof B < "u" ? B : !yn;
          if (yn === mn)
            return e;
        ...
        if (t.type === w.toggleAllPageRowsSelected) {
          var Fn = t.value, J = a.page, Y = a.rowsById, $ = a.selectSubRows, cn = $ === void 0 ? !0 : $, kn = a.isAllPageRowsSelected, On = a.getSubRows, Xn = typeof Fn < "u" ? Fn : !kn, on = y({}, e.selectedRowIds), le = function Bn(Sn) {
            var Mn = Y[Sn];
            if (Mn.isGrouped || (Xn ? on[Sn] = !0 : delete on[Sn]), cn && On(Mn))
      ...
      function la(e) {
        var t = e.data, u = e.rows, a = e.getHooks, p = e.plugins, m = e.rowsById, d = e.nonGroupedRowsById, S = d === void 0 ? m : d, A = e.autoResetSelectedRows, N = A === void 0 ? !0 : A, I = e.state.selectedRowIds, q = e.selectSubRows, B = q === void 0 ? !0 : q, G = e.dispatch, _ = e.page, k = e.getSubRows;
        ...
        }, [G]), Y = An(e), $ = vn(a().getToggleAllRowsSelectedProps, {
          instance: Y()
      ...
      function Tt(e, t, u, a) {
        var p = a.initialRowStateAccessor, m = p === void 0 ? vo : p, d = a.initialCellStateAccessor, S = d === void 0 ? ho : d, A = a.rowsById;
        if (t.type === w.init)
          return y({
            rowState: {}
          }, e);
        ...
        if (t.type === w.setCellState) {
          var G, _, k, Z, yn, mn = t.rowId, j = t.columnId, Pn = t.value, Fn = typeof e.rowState[mn] < "u" ? e.rowState[mn] : m(A[mn]), J = typeof (Fn == null || (G = Fn.cellState) == null ? void 0 : G[j]) < "u" ? Fn.cellState[j] : S((_ = A[mn]) == null || (k = _.cells) == null ? void 0 : k.find(function(Y) {
            return Y.column.id === j;
          }));
          return y({}, e, {
            rowState: y({}, e.rowState, (yn = {}, yn[mn] = y({}, Fn, {
              cellState: y({}, Fn.cellState || {}, (Z = {}, Z[j] = Wn(Pn, J), Z))
            }), yn))
          });
        }
      }
      function n(e) {
        ...
        }, [p]), d = C.useCallback(function(A, N, I) {
          return p({
            type: w.setCellState,
            rowId: A,
            columnId: N,
      ...
      function r(e, t) {
        var u = t.instance, a = u.initialRowStateAccessor, p = a === void 0 ? vo : a, m = u.initialCellStateAccessor, d = m === void 0 ? ho : m, S = u.state.rowState;
        e && (e.state = typeof S[e.id] < "u" ? S[e.id] : p(e), e.setState = function(A) {
          return u.setRowState(e.id, A);
        }, e.cells.forEach(function(A) {
          e.state.cellState || (e.state.cellState = {}), A.state = typeof e.state.cellState[A.column.id] < "u" ? e.state.cellState[A.column.id] : d(A), A.setState = function(N) {
      ...
      function v(e, t) {
        ...
        if (!u || !u.length)
          return e;
        for (var a = [].concat(u), p = [].concat(e), m = [], d = function() {
      ...
      var h = function(t) {
        ...
        var a = u.instance, p = u.header, m = a.dispatch, d = function(A, N) {
          var I = !1;
      ...
      function T(e, t) {
        ...
        if (t.type === w.columnResizing) {
          var d = t.clientX, S = e.columnResizing, A = S.startX, N = S.columnWidth, I = S.headerIdWidths, q = I === void 0 ? [] : I, B = d - A, G = B / N, _ = {};
      ...
      var E = function(t) {
        var u = t.flatHeaders, a = t.disableResizing, p = t.getHooks, m = t.state.columnResizing, d = An(t);
      ...
      function Ln(e) {
        e.getTableProps.push(sn), e.getRowProps.push(K), e.getHeaderGroupProps.push(K), e.getFooterGroupProps.push(K), e.getHeaderProps.push(Tn), e.getCellProps.push(nn), e.getFooterProps.push(wn);
      }
      ...
      function Dn(e, t, u, a) {
        ...
        if (t.type === w.columnStartResizing) {
          var p = t.columnId, m = t.headerIdWidths, d = Kn(p);
          if (d !== void 0) {
        ...
        if (t.type === w.columnResizing) {
          var q = t.clientX, B = e.columnResizing.startX, G = e.gridLayout, _ = G.columnWidth, k = G.minWidths, Z = G.maxWidths, yn = G.headerIdGridWidths, mn = yn === void 0 ? [] : yn, j = q - B, Pn = j / _, Fn = {};
          return mn.forEach(function(J) {
            var Y = J[0], $ = J[1];
            Fn[Y] = Math.min(Math.max(k[Y], $ + $ * Pn), Z[Y]);
          }), y({}, e, {
            gridLayout: y({}, e.gridLayout, {
              columnWidths: y({}, e.gridLayout.columnWidths, {}, Fn)
            })
          });
        }
        if (t.type === w.columnDoneResizing)
      ...
      c._UNSTABLE_usePivotColumns = co, c.actions = w, c.defaultColumn = Cn, c.defaultGroupByFn = eo, c.defaultOrderByFn = Mt, c.defaultRenderer = rn, c.emptyRenderer = Nn, c.ensurePluginOrder = Jn, c.flexRender = en, c.functionalUpdate = Wn, c.loopHooks = bn, c.makePropGetter = vn, c.makeRenderer = ne, c.reduceHooks = Hn, c.safeUseLayoutEffect = ae, c.useAbsoluteLayout = L, c.useAsyncDebounce = de, c.useBlockLayout = ln, c.useColumnOrder = i, c.useExpanded = ft, c.useFilters = Yt, c.useFlexLayout = Ln, c.useGetLatest = An, c.useGlobalFilter = jt, c.useGridLayout = xn, c.useGroupBy = St, c.useMountedLayoutEffect = zn, c.usePagination = lo, c.useResizeColumns = h, c.useRowSelect = Rt, c.useRowState = So, c.useSortBy = ro, c.useTable = at, Object.defineProperty(c, "__esModule", { value: !0 });
    });
...
var st = Sa.exports;
function Fu(o, f, c) {
  var C = this, b = D.useRef(null), P = D.useRef(0), y = D.useRef(null), O = D.useRef([]), Rn = D.useRef(), M = D.useRef(), En = D.useRef(o), w = D.useRef(!0);
  En.current = o;
  var rn = !f && f !== 0 && typeof window < "u";
  if (typeof o != "function")
    throw new TypeError("Expected a function");
  f = +f || 0, c = c || {};
  var Nn = !!c.leading, Cn = "trailing" in c ? !!c.trailing : !0, fn = "maxWait" in c, Vn = fn ? Math.max(+c.maxWait || 0, f) : null, vn = D.useCallback(function(en) {
    var dn = O.current, _n = Rn.current;
    return O.current = Rn.current = null, P.current = en, M.current = En.current.apply(_n, dn);
  }, []), Hn = D.useCallback(function(en, dn) {
    rn && cancelAnimationFrame(y.current), y.current = rn ? requestAnimationFrame(en) : setTimeout(en, dn);
  }, [rn]), bn = D.useCallback(function(en) {
    if (!w.current)
      return !1;
    var dn = en - b.current, _n = en - P.current;
    return !b.current || dn >= f || dn < 0 || fn && _n >= Vn;
  }, [Vn, fn, f]), Jn = D.useCallback(function(en) {
    return y.current = null, Cn && O.current ? vn(en) : (O.current = Rn.current = null, M.current);
  }, [vn, Cn]), Wn = D.useCallback(function() {
    var en = Date.now();
    if (bn(en))
      return Jn(en);
    if (w.current) {
      var dn = en - b.current, _n = en - P.current, Yn = f - dn, $n = fn ? Math.min(Yn, Vn - _n) : Yn;
      Hn(Wn, $n);
    }
  }, [Vn, fn, bn, Hn, Jn, f]), An = D.useCallback(function() {
    y.current && (rn ? cancelAnimationFrame(y.current) : clearTimeout(y.current)), P.current = 0, O.current = b.current = Rn.current = y.current = null;
  }, [rn]), ae = D.useCallback(function() {
  ...
  var zn = D.useCallback(function() {
    for (var en = [], dn = 0; dn < arguments.length; dn++)
      en[dn] = arguments[dn];
    var _n = Date.now(), Yn = bn(_n);
    if (O.current = en, Rn.current = C, b.current = _n, Yn) {
      if (!y.current && w.current)
        return P.current = b.current, Hn(Wn, f), Nn ? vn(b.current) : M.current;
      if (fn)
        return Hn(Wn, f), vn(b.current);
    }
    return y.current || Hn(Wn, f), M.current;
  }, [vn, Nn, fn, bn, Hn, Wn, f]), de = D.useCallback(function() {
    return !!y.current;
...
function xu(o, f, c) {
  var C = Hu, b = Wu(o), P = b[0], y = b[1], O = Fu(D.useCallback(function(M) {
    return y(M);
  }, [y]), f, c), Rn = D.useRef(o);
  return D.useEffect(function() {
    C(Rn.current, o) || (O.callback(o), Rn.current = o);
  }, [o, O, C]), [P, { cancel: O.cancel, pending: O.pending, flush: O.flush }];
}
function Gu(o) {
...
const wa = 10, ot = {
  ...
  return /* @__PURE__ */ l.createElement("input", { className: "filter", value: C, onChange: y, type: "search", placeholder: "Filter...", disabled: c });
  ...
  const { config: o } = D.useContext(ct), f = D.useMemo(() => o.type === "dashboard" ? Object.values(o.datasets).find((en) => en.preview && Array.isArray(en.data)) : o.data, [o.type, o.data, o.datasets]), [c, C] = D.useState(f), b = (en) => {
    const dn = Object.keys(en[0]).includes("tableData"), _n = En(dn ? en[0].tableData : en);
    return Gu(_n), _n;
  }, P = (en) => C(b(en)), y = D.useContext(Ot), O = async (en, dn) => {
    if (dn.preview)
      if (dn.dataUrl) {
        const _n = await Ta(dn.dataUrl);
        Array.isArray(_n) && P(_n);
      } else Array.isArray(dn.data) && P(dn.data);
  }, Rn = async (en) => {
  ...
  const M = D.useMemo(() => {
    if (!c) return [];
    const en = c.columns ?? [];
    return en.length > 0 && en.includes("") && y({ type: "EDITOR_SET_ERRORS", payload: [ot.emptyCols] }), en.map((dn) => ({
      id: `column-${dn}`,
      accessor: (Yn) => Yn[dn],
      Header: dn,
      width: 250
    ...
    en.forEach((Yn) => {
      Object.keys(Yn).forEach(($n) => {
        dn.includes($n) === !1 && dn.push($n);
      });
    });
    const _n = [...en];
    if (Array.isArray(_n))
      return _n.columns = dn, _n;
  }, {
    getTableProps: w,
    getTableBodyProps: rn,
    headerGroups: Nn,
    ...
    nextPage: An,
    previousPage: ae
  } = st.useTable({ columns: M, data: c, initialState: { pageSize: 25 } }, st.useBlockLayout, st.useGlobalFilter, st.useSortBy, st.useResizeColumns, st.usePagination), zn = () => /* @__PURE__ */ l.createElement("section", { className: "no-data" }, /* @__PURE__ */ l.createElement("section", { className: "no-data-message" }, /* @__PURE__ */ l.createElement("section", null, /* @__PURE__ */ l.createElement("h3", null, "No Data"), /* @__PURE__ */ l.createElement("p", null, "Import data to preview"))), /* @__PURE__ */ l.createElement("div", { className: "table-container" }, /* @__PURE__ */ l.createElement("table", { className: "editor data-table", role: "table" }, /* @__PURE__ */ l.createElement("thead", null, /* @__PURE__ */ l.createElement("tr", null, /* @__PURE__ */ l.createElement("th", { scope: "col", colSpan: 1, role: "columnheader" }), /* @__PURE__ */ l.createElement("th", { scope: "col", colSpan: 1, role: "columnheader" }), /* @__PURE__ */ l.createElement("th", { scope: "col", colSpan: 1, role: "columnheader" }))), /* @__PURE__ */ l.createElement("tbody", null, /* @__PURE__ */ l.createElement(l.Fragment, null, [...Array(10)].map((en, dn) => /* @__PURE__ */ l.createElement("tr", { key: dn }, /* @__PURE__ */ l.createElement("td", null), /* @__PURE__ */ l.createElement("td", null), /* @__PURE__ */ l.createElement("td", null))))))));
  if (!c) return [/* @__PURE__ */ l.createElement(Ua, { key: "header" }), /* @__PURE__ */ l.createElement(zn, { key: "table" })];
  const de = { previousPage: ae, nextPage: An, canPreviousPage: bn, canNextPage: Jn, pageNumber: Cn + 1, totalPages: Wn.length }, ne = () => /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("section", { className: "data-table-container" }, /* @__PURE__ */ l.createElement("div", { className: "table-container" }, /* @__PURE__ */ l.createElement("table", { className: "data-table", ...w(), "aria-hidden": "true" }, /* @__PURE__ */ l.createElement("thead", null, Nn.map((en) => /* @__PURE__ */ l.createElement("tr", { ...en.getHeaderGroupProps() }, en.headers.map((dn) => /* @__PURE__ */ l.createElement("th", { scope: "col", ...dn.getHeaderProps(dn.getSortByToggleProps()), className: dn.isSorted ? dn.isSortedDesc ? "sort sort-desc" : "sort sort-asc" : "", title: dn.Header }, dn.render("Header"), /* @__PURE__ */ l.createElement("div", { ...dn.getResizerProps(), className: "resizer" })))))), /* @__PURE__ */ l.createElement("tbody", { ...rn() }, Hn.map((en) => (Vn(en), /* @__PURE__ */ l.createElement("tr", { ...en.getRowProps() }, en.cells.map((dn) => /* @__PURE__ */ l.createElement("td", { ...dn.getCellProps(), title: dn.value }, dn.render("Cell")))))))))), /* @__PURE__ */ l.createElement(Ku, { ...de }));
  return [/* @__PURE__ */ l.createElement(Ua, { key: "header", data: c, setGlobalFilter: vn, globalFilter: fn }), /* @__PURE__ */ l.createElement(ne, { key: "table" })];
...
}, cr = ({ text: o, fileName: f, data: c }) => {
  const { editingDataset: C, loadData: b } = D.useContext(Io), P = (O) => b(new Blob([c], { type: "text/csv" }), f, C), y = (O) => O.keyCode === 13 && b(new Blob([c], { type: "text/csv" }), f, C);
...
}, ri = () => ba.maps.map((o) => /* @__PURE__ */ l.createElement(cr, { key: o.fileName, text: o.text, fileName: o.fileName, data: o.data })), ui = () => ba.charts.map((o) => /* @__PURE__ */ l.createElement(cr, { key: o.fileName, text: o.text, fileName: o.fileName, data: o.data })), ii = () => {
...
function li() {
  const { config: o, errors: f, tempConfig: c, sharepath: C } = D.useContext(ct), b = (F) => {
  ...
  }, y = new Nr(), [O, Rn] = D.useState(o.dataFileSourceType === "url" ? o.dataFileName : o.dataUrl || ""), [M, En] = D.useState(!!o.dataUrl), [w, rn] = D.useState(o.type === "dashboard" || !o.data), [Nn, Cn] = D.useState(void 0), fn = D.useContext(Ot), Vn = {
    ".csv": "text/csv",
    ".json": "application/json"
  }, vn = (F) => F === void 0 ? "" : F > Math.pow(1024, 3) ? Math.round(F / Math.pow(1024, 3) * 100) / 100 + " GB" : F > Math.pow(1024, 2) ? Math.round(F / Math.pow(1024, 2) * 100) / 100 + " MB" : F > 1024 ? Math.round(F / 1024 * 100) / 100 + " KB" : F + " B", Hn = (F, z, un) => (z.map(function(tn, Gn, jn) {
    if (!jn.find((we) => we.dataKey === tn.dataKey)) return !1;
  }), !(F.columns.indexOf(un) < 0)), bn = (F) => ca(O) ? ".csv" : bo(O) ? ".json" : Object.keys(Vn).find((z) => F.pathname.endsWith(z)), Jn = async () => {
    let F;
    try {
      F = ca(O) || bo(O) ? O : new URL(O, window.location.origin);
    } catch {
      throw ot.urlInvalid;
    }
    let z = null;
    ...
    try {
      await Rr.get(F.toString(), {
        ...
        z = tn.data, un === ".csv" && ["text/csv", "text/plain"].includes(z.type) || ca(O) ? z = z.slice(0, z.size, "text/csv") : (z.type === "application/json" || un === ".json" && z.type === "text/plain" || bo(O)) && (z = z.slice(0, z.size, "application/json"));
      });
    } catch (tn) {
      console.error(tn);
      const Gn = tn.toString();
      throw Object.values(ot).includes(tn) ? Gn : ot.failedFetch;
    }
    return o.type === "dashboard" && Rn(""), z;
  }, Wn = ([F]) => An(F, Nn, Nn), An = async (F = null, z, un) => {
    let tn = F;
    const Gn = (tn == null ? void 0 : tn.path) ?? z ?? O, jn = F ? "file" : "url";
    if (jn === "url")
      try {
        tn = await Jn();
      } catch (pe) {
    ...
    const Ae = (() => {
      const pe = (F == null ? void 0 : F.name) || O || z;
      if (jn === "file") {
      ...
      switch (Ae) {
        ...
        case "application/json":
          try {
            return bo(O) ? JSON.parse(pe).response.docs : JSON.parse(pe);
          } catch {
            P([ot.formatting]);
            return;
          }
  ...
  const ae = (F, z, un) => {
    if (o.type === "dashboard") {
      let tn = { ...o.datasets[F].dataDescription, [z]: un }, Gn = y.developerStandardize(o.datasets[F].data, tn), jn = { ...o.datasets };
      jn[F] = { ...jn[F], dataDescription: tn, formattedData: Gn }, b({ ...o, datasets: jn });
    } else {
      let tn = { ...o.dataDescription, [z]: un }, Gn = y.developerStandardize(o.data, tn);
      b({ ...o, formattedData: Gn, dataDescription: tn });
    }
  }, zn = (F, z) => {
    if (z) {
      let un = { ...o.datasets };
    ...
    En(F);
  }, { getRootProps: de, getInputProps: ne, isDragActive: en } = ha({ onDrop: Wn }), { getRootProps: dn, getInputProps: _n, isDragActive: Yn } = ha({ onDrop: Wn }), $n = () => /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("form", { className: "input-group d-flex", onSubmit: (F) => F.preventDefault() }, /* @__PURE__ */ l.createElement("input", { id: "external-data", type: "text", className: "form-control flex-grow-1 border-right-0", placeholder: "e.g., https://data.cdc.gov/resources/file.json", "aria-label": "Load data from external URL", "aria-describedby": "load-data", value: O, onChange: (F) => Rn(F.target.value) }), /* @__PURE__ */ l.createElement("button", { className: "input-group-text btn btn-primary px-4", type: "submit", id: "load-data", onClick: () => An(null, O, Nn) }, "Load")), /* @__PURE__ */ l.createElement("label", { htmlFor: "keep-url", className: "mt-1 d-flex keep-url" }, /* @__PURE__ */ l.createElement("input", { type: "checkbox", id: "keep-url", checked: M, onChange: () => zn(!M, Nn) }), " Always load from URL (normally will only pull once)")), Pe = (F = {}, z = "Are you sure you want to do this?") => {
    F.newViz = !0, window.confirm(z) === !0 && (fn({ type: "EDITOR_SAVE", payload: F }), rn(!0));
  }, Re = () => (
    //todo convert to modal
    /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("button", { className: "btn danger", onClick: () => Pe({ type: o.type, visualizationType: o.visualizationType }, "Resetting will remove your data and settings. Do you want to continue?") }, "Clear", /* @__PURE__ */ l.createElement(Ea, null)), o.dataFileSourceType === "file" && /* @__PURE__ */ l.createElement("div", { className: "link link-replace", ...dn() }, /* @__PURE__ */ l.createElement("input", { ..._n() }), /* @__PURE__ */ l.createElement("p", null, /* @__PURE__ */ l.createElement("span", null, "or replace file"))))
  ), be = (F, z, un) => {
    let tn = { ...o.datasets };
    Object.keys(tn).forEach((Gn) => {
      const jn = Gn === F;
      tn[Gn][z] = jn;
    }), b({ ...o, datasets: tn });
  }, Ee = (F) => {
    ...
    if (F === z) return;
    let un = { ...o.datasets }, tn = { ...o.visualizations }, Gn = 2, jn = z;
    for (; un[z]; )
      z = jn + "-" + Gn, Gn++;
    un[z] = un[F], delete un[F], Object.keys(tn).forEach((we) => {
      tn[we].dataKey === F && (tn[we].dataKey = z);
    }), b({ ...o, datasets: un, visualizations: tn });
  };
  let me, re = !1;
  ...
  const Oe = /* @__PURE__ */ l.createElement(l.Fragment, null, o.filters && o.filters.map(
    (F, z) => F.type !== "url" ? /* @__PURE__ */ l.createElement(l.Fragment, null) : /* @__PURE__ */ l.createElement("fieldset", { key: F.key, className: "edit-block url-filters-block" }, /* @__PURE__ */ l.createElement(
      ...
      "input",
      {
        ...
        onChange: (un) => {
          let tn = [...o.filters];
          tn[z].queryParameter = un.target.value, b({ ...o, filters: tn });
        }
      }
      ...
      "button",
      {
        onClick: () => {
          let Gn = [...o.filters];
          Gn[z].labels && delete Gn[z].labels[Gn[z].orderedValues[tn]], Gn[z].orderedValues.splice(tn, 1), b({ ...o, filters: Gn });
        }
      },
      "X"
    )))), /* @__PURE__ */ l.createElement(
      "form",
      {
        onSubmit: (un) => {
          if (un.preventDefault(), !o.filters[z].orderedValues || o.filters[z].orderedValues.indexOf(un.target[0].value) === -1) {
            let tn = [...o.filters];
            tn[z].orderedValues = tn[z].orderedValues || [], tn[z].orderedValues.push(un.target[0].value), tn[z].values = tn[z].orderedValues, tn[z].active || (tn[z].active = un.target[0].value), un.target[0].value = "", b({ ...o, filters: tn });
          }
        }
      },
  ...
  return /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("div", { className: "left-col" }, o.type === "dashboard" && Object.keys(o.datasets).length > 0 && /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("div", { className: "heading-3" }, "Data Sources"), /* @__PURE__ */ l.createElement("table", null, /* @__PURE__ */ l.createElement("thead", null, /* @__PURE__ */ l.createElement("tr", null, /* @__PURE__ */ l.createElement("th", null, "Name"), /* @__PURE__ */ l.createElement("th", null, "Size"), /* @__PURE__ */ l.createElement("th", null, "Type"), /* @__PURE__ */ l.createElement("th", { colSpan: 4 }, "Actions"))), /* @__PURE__ */ l.createElement("tbody", null, Object.keys(o.datasets).map(
    (F) => o.datasets[F].dataFileName && /* @__PURE__ */ l.createElement("tr", { key: `tr-${F}` }, /* @__PURE__ */ l.createElement("td", null, /* @__PURE__ */ l.createElement("input", { className: "dataset-name-input", type: "text", defaultValue: F, onBlur: (z) => fe(F, z.target.value) })), /* @__PURE__ */ l.createElement("td", null, vn(o.datasets[F].dataFileSize)), /* @__PURE__ */ l.createElement("td", null, o.datasets[F].dataFileFormat), /* @__PURE__ */ l.createElement("td", null, /* @__PURE__ */ l.createElement("button", { className: "btn btn-primary", onClick: () => be(F, "preview") }, "Preview Data")), /* @__PURE__ */ l.createElement("td", null, /* @__PURE__ */ l.createElement(
      "button",
      {
        className: "btn btn-primary",
        onClick: () => {
          Nn === F ? (Cn(void 0), Rn(""), En(!1)) : (Cn(F), Rn(o.datasets[F].dataUrl || o.datasets[F].dataFileName), En(!!o.datasets[F].dataUrl));
        }
      },
      "Edit Data"
    )), /* @__PURE__ */ l.createElement("td", null, /* @__PURE__ */ l.createElement("button", { className: "btn btn-primary", onClick: () => Ee(F) }, "X")))
  )))), (me == null ? void 0 : me.data) && /* @__PURE__ */ l.createElement(l.Fragment, null, o.type !== "dashboard" && /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("div", { className: "heading-3" }, "Data Source"), /* @__PURE__ */ l.createElement("div", { className: "file-loaded-area" }, (o.dataFileSourceType === "file" || !o.dataFileSourceType) && /* @__PURE__ */ l.createElement("div", { className: "data-source-options" }, /* @__PURE__ */ l.createElement("div", { className: Yn ? "drag-active cdcdataviz-file-selector loaded-file" : "cdcdataviz-file-selector loaded-file", ...dn() }, /* @__PURE__ */ l.createElement("input", { ..._n() }), Yn ? /* @__PURE__ */ l.createElement("p", null, "Drop file here") : /* @__PURE__ */ l.createElement("p", null, /* @__PURE__ */ l.createElement(Ja, null), " ", /* @__PURE__ */ l.createElement("span", null, o.dataFileName ?? "Replace data file"))), /* @__PURE__ */ l.createElement("div", null, Re())), o.dataFileSourceType === "url" && /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("div", { className: "url-source-options" }, /* @__PURE__ */ l.createElement("div", null, $n()), /* @__PURE__ */ l.createElement("div", null, Re())), o.dataUrl && (o.type === "chart" || o.type === "map") && Oe))), Be && /* @__PURE__ */ l.createElement(Fr, { visualizationKey: null, configureData: me, updateDescriptionProp: (F, z) => ae(me.dataFileName, F, z), config: o, setConfig: b })), (Nn || w) && // dataFileSourceType needs to be checked here since earlier versions did not track this state
  /* @__PURE__ */ l.createElement("div", { className: "load-data-area" }, /* @__PURE__ */ l.createElement("div", { className: "heading-3" }, Nn ? `Editing ${Nn}` : "Add Dataset"), /* @__PURE__ */ l.createElement(ku, { startingTab: Nn && o.datasets[Nn].dataFileSourceType === "url" ? 1 : 0 }, /* @__PURE__ */ l.createElement(Lt, { title: "Upload File", icon: /* @__PURE__ */ l.createElement(Ja, { className: "inline-icon" }) }, C && /* @__PURE__ */ l.createElement("p", { className: "alert--info" }, "The share path set for this website is: ", C), /* @__PURE__ */ l.createElement("div", { className: en ? "drag-active cdcdataviz-file-selector" : "cdcdataviz-file-selector", ...de() }, /* @__PURE__ */ l.createElement("input", { ...ne() }), en ? /* @__PURE__ */ l.createElement("p", null, "Drop file here") : /* @__PURE__ */ l.createElement("p", null, "Drag file to this area, or ", /* @__PURE__ */ l.createElement("span", null, "select a file"), ".")), /* @__PURE__ */ l.createElement("p", { className: "footnote" }, "Supported file types: ", Object.keys(Vn).join(", "), ". Maximum file size ", wa, "MB.")), /* @__PURE__ */ l.createElement(Lt, { title: "Load from URL", icon: /* @__PURE__ */ l.createElement(zu, { className: "inline-icon" }) }, $n())), f && (Array.isArray(f) ? f.map((F, z) => /* @__PURE__ */ l.createElement("div", { className: "error-box slim mt-2", key: `error-${F}` }, /* @__PURE__ */ l.createElement("span", null, F), " ", /* @__PURE__ */ l.createElement(Ea, { className: "inline-icon dismiss-error", onClick: () => P(f.filter((un, tn) => tn !== z)) }))) : f.message), /* @__PURE__ */ l.createElement(Io.Provider, { value: { loadData: An, editingDataset: Nn, config: o } }, /* @__PURE__ */ l.createElement(Aa.Buttons, null))), o.type === "dashboard" && !w && /* @__PURE__ */ l.createElement("p", null, /* @__PURE__ */ l.createElement("button", { className: "btn btn-primary", onClick: () => rn(!0) }, "+ Add More Files")), re && /* @__PURE__ */ l.createElement("p", null, /* @__PURE__ */ l.createElement("button", { className: "btn btn-primary", onClick: () => fn({ type: "EDITOR_SET_GLOBALACTIVE", payload: 2 }) }, "Configure your visualization")), /* @__PURE__ */ l.createElement("a", { href: "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/data-map.html", target: "_blank", rel: "noopener noreferrer", className: "guidance-link" }, /* @__PURE__ */ l.createElement("div", null, /* @__PURE__ */ l.createElement("h3", null, "Get Help"), /* @__PURE__ */ l.createElement("p", null, "Documentation and examples on formatting data and configuring visualizations.")))), /* @__PURE__ */ l.createElement("div", { className: "right-col" }, /* @__PURE__ */ l.createElement(qu, null)));
}
...
function vi() {
  const { config: o, tempConfig: f } = D.useContext(ct), c = D.useContext(Ot);
  D.useEffect(() => {
    f && c({ type: "EDITOR_SAVE", payload: f });
  }, []);
  const C = ({ icon: b, label: P, type: y, subType: O = void 0, orientation: Rn = void 0, stacked: M = !1, generalType: En = "data" }) => {
    let w = !1, rn = !1, Nn;
    if (y === "map" && o.general) {
      let fn = o.general.geoType;
      w = O === fn;
    }
    y === "chart" && (w = O === o.visualizationType, rn = Rn === o.orientation && M === !0), (y === "dashboard" || y === "data-bite" || y === "markup-include") && (w = !0), y === "chart" && M ? Nn = o.type === y && w && o.visualizationSubType === "stacked" ? "active" : "" : y === "chart" && !M && o.visualizationSubType !== "stacked" && (Nn = o.type === y && w ? "active" : ""), y !== "chart" && (Nn = o.type === y && w && !rn ? "active" : "");
    let Cn = () => {
      if (y === o.type)
        ...
        y === "map" ? Vn.general = {
          ...
          geoType: O,
          type: En
        } : Vn.visualizationType = O, y === "chart" && (Vn.visualizationSubType = M ? "stacked" : "regular", Vn.orientation = Rn), c({ type: "EDITOR_SET_CONFIG", payload: Vn }), c({ type: "EDITOR_SET_GLOBALACTIVE", payload: 1 });
      }
    };
  ...
  return /* @__PURE__ */ l.createElement("div", { className: "choose-vis" }, /* @__PURE__ */ l.createElement("a", { href: "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/index.html", target: "_blank", rel: "noopener noreferrer", className: "guidance-link", style: { marginTop: 0, marginBottom: "2rem" } }, /* @__PURE__ */ l.createElement("div", null, /* @__PURE__ */ l.createElement("p", null, "For more information on the types of data visualizations in the WCMS, including examples and best practices, ", /* @__PURE__ */ l.createElement("u", null, "see the WCMS Features Gallery"), "."))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "General"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, " ", /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, { position: "right" }, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Dashboard", type: "dashboard", icon: /* @__PURE__ */ l.createElement(si, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Present multiple data visualizations with shared filter controls."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Data Bite", type: "data-bite", icon: /* @__PURE__ */ l.createElement(Tr, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Highlight a single aggregated value (e.g., sum or median)."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Waffle Chart", type: "waffle-chart", subType: "Waffle", icon: /* @__PURE__ */ l.createElement(Pr, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Highlight a piece of data in relationship to a data set."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Gauge Chart", type: "waffle-chart", subType: "Gauge", icon: /* @__PURE__ */ l.createElement(pi, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Specify the calculation of a single data point (such as a percentage value) and present it on a horizontal scale.")))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "Charts"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, { position: "right" }, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Bar", type: "chart", subType: "Bar", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Er, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Use bars to show comparisons between data categories."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Line", type: "chart", subType: "Line", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Ir, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Present one or more data trends over time."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Pie", type: "chart", subType: "Pie", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Lr, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Present the numerical proportions of a data series."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Paired Bar", type: "chart", subType: "Paired Bar", orientation: "horizontal", icon: /* @__PURE__ */ l.createElement(ci, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Use paired bars to show comparisons between two different data categories."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Deviation Bar", type: "chart", subType: "Deviation Bar", orientation: "horizontal", stacked: !1, icon: /* @__PURE__ */ l.createElement(mi, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Use deviation bars to display how individual values differ from a target."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Horizontal Bar (Stacked)", type: "chart", subType: "Bar", orientation: "horizontal", stacked: !0, icon: /* @__PURE__ */ l.createElement(yi, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Use bars to show comparisons between data categories.")))), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Box Plot", type: "chart", subType: "Box Plot", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(di, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Display a box plot"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Scatter Plot", type: "chart", subType: "Scatter Plot", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(Ci, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Display a scatter plot"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Area Chart", type: "chart", subType: "Area Chart", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(fi, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Display an area chart"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Forecast Chart", type: "chart", subType: "Forecasting", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(gi, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Display a forecasting chart"))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "Sankey Diagram", type: "chart", subType: "Sankey", orientation: "vertical", icon: /* @__PURE__ */ l.createElement(kr, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Display a sankey diagram")))), /* @__PURE__ */ l.createElement("div", { className: "heading-2" }, "Maps"), /* @__PURE__ */ l.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, { position: "right" }, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "United States (State- or County-Level)", type: "map", subType: "us", icon: /* @__PURE__ */ l.createElement(Ia, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, { position: "right" }, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "United States (HHS Regions)", type: "map", subType: "us-region", icon: /* @__PURE__ */ l.createElement(Dr, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "World", type: "map", subType: "world", icon: /* @__PURE__ */ l.createElement(Or, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Present a choropleth map of the world."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "U.S. State", type: "map", subType: "single-state", icon: /* @__PURE__ */ l.createElement(Br, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "Present a choropleth map of an individual U.S. state."))), /* @__PURE__ */ l.createElement("li", null, /* @__PURE__ */ l.createElement(an, null, /* @__PURE__ */ l.createElement(an.Target, null, /* @__PURE__ */ l.createElement(C, { label: "U.S. Geocode", type: "map", subType: "us-county", generalType: "us-geocode", icon: /* @__PURE__ */ l.createElement(Ia, null) })), /* @__PURE__ */ l.createElement(an.Content, null, "United States GeoCode")))));
}
...
const Si = (o) => {
  const f = [];
  o.rows && o.rows.forEach((c) => {
    if (c.footnotesId) {
      const { dataKey: C, staticFootnotes: b } = o.visualizations[c.footnotesId];
      !C && !(b != null && b.length) ? delete o.visualizations[c.footnotesId] : f.push(c.footnotesId);
    }
  }), o.visualizations && Object.keys(o.visualizations).forEach((c) => {
    o.visualizations[c].type === "footnotes" && !f.includes(c) && delete o.visualizations[c];
  });
}, wi = (o) => {
  o.datasets && Object.keys(o.datasets).forEach((f) => {
    delete o.datasets[f].formattedData, o.datasets[f].dataUrl && delete o.datasets[f].data;
  }), o.visualizations && Object.keys(o.visualizations).forEach((f) => {
    o.visualizations[f] = kt.omit(o.visualizations[f], ["runtime", "formattedData", "data"]);
  }), o.rows && o.rows.forEach((f) => {
    f.dataKey && (f = kt.omit(f, ["data", "formattedData"]));
  });
}, yr = (o) => {
  let f = { ...o };
  return f.type === "dashboard" ? (wi(f), Si(f)) : (delete f.runtime, delete f.formattedData, f.dataUrl && delete f.data), f;
}, Mi = (o) => {
  if (o !== null) {
    let f = yr(o);
  ...
  if (o.type === "dashboard") {
    ...
    if (o.data || o.dataUrl) {
      ...
      C.datasets = {}, C.datasets[b] = {
        ...
        const O = { dataKey: b, ...kt.pick(C, "dataDescription", "formattedData") };
        C.visualizations[y] = { ...C.visualizations[y], ...O };
...
}, Di = Mr(Ai), Ri = ({ config: o, hostname: f, containerEl: c, sharepath: C, isDebug: b }) => {
  const P = D.useMemo(() => {
    let rn = 0;
    return (o != null && o.data || o != null && o.dataUrl) && (o != null && o.type) && (rn = 2), { config: bi(o || { newViz: !0, errors: [], currentViewport: "lg" }), errors: [], currentViewport: "lg", globalActive: rn, sharepath: C, isDebug: b, hostname: f };
  }, [o]);
  D.useEffect(() => {
    var rn;
    Na && ((rn = Na) == null || rn.init());
  }, []);
  const [y, O] = D.useReducer(Di, P), Rn = (rn) => {
    Mi(kt.cloneDeep(rn)), O({ type: "EDITOR_TEMP_SAVE", payload: rn });
  }, M = new fr((rn) => {
    const Nn = rn[0], { width: Cn } = Nn.contentRect, fn = pr(Cn);
    y.currentViewport !== fn && O({ type: "EDITOR_SET_VIEWPORT", payload: fn });
  }), En = D.useCallback((rn) => {
    rn !== null && M.observe(rn);
  }, []);
  D.useEffect(() => {
    let rn = yr(y.config);
    const Nn = JSON.stringify(rn), Cn = new CustomEvent("updateVizConfig", { detail: Nn });
  ...
  return /* @__PURE__ */ l.createElement(br, null, /* @__PURE__ */ l.createElement(ct.Provider, { value: { ...y, setTempConfig: Rn } }, /* @__PURE__ */ l.createElement(Ot.Provider, { value: O }, /* @__PURE__ */ l.createElement("div", { className: `cdc-open-viz-module cdc-editor ${y.currentViewport}`, ref: En }, /* @__PURE__ */ l.createElement(Lu, { className: "top-level" }, /* @__PURE__ */ l.createElement(Lt, { title: "1. Choose Visualization Type", className: "choose-type" }, /* @__PURE__ */ l.createElement(vi, null)), /* @__PURE__ */ l.createElement(Lt, { title: "2. Import Data", className: "data-designer", disableRule: !y.config.type }, /* @__PURE__ */ l.createElement(li, null)), /* @__PURE__ */ l.createElement(Lt, { title: "3. Configure", className: "configure", disableRule: w }, /* @__PURE__ */ l.createElement(hi, { containerEl: c })))))), /* @__PURE__ */ l.createElement(Ar, null));
}, Vi = {
...
No.parameters = {
  ...No.parameters,
  docs: {
    ...($a = No.parameters) == null ? void 0 : $a.docs,
    source: {
      originalSource: `{
  args: {
    config: {}
      ...
      ...(Qa = (Za = No.parameters) == null ? void 0 : Za.docs) == null ? void 0 : Qa.source
    }
  }
};
const Ki = ["DefaultEditor"];
export {
  No as DefaultEditor,
