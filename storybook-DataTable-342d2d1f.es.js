import { R as h, r as SA } from "./storybook-index-45401197.es.js";
import { L as Tt, E as kr } from "./storybook-Loading-f180d060.es.js";
import { P as Fa } from "./storybook-papaparse.min-b07ddc33.es.js";
import { u as Br, a as BB, t as ar, b as aB, c as Ke, d as ha, e as Le, f as be, g as da, h as xe } from "./storybook-year-bedc547d.es.js";
import { n as _r } from "./storybook-numberFromString-24623c03.es.js";
import { a as pa } from "./storybook-Icon-58d1c99f.es.js";
...
const tg = ({ rawData: e, fileName: A, headerColor: t, skipId: r }) => {
  ...
  const E = A.table.customTableConfig ? fg(B, A.table.excludeColumns) : a, I = Object.keys(E).filter((M) => M != "columns"), N = m ? I.sort((M, _) => {
    ...
    return (A.type === "chart" || A.type === "dashboard") && (G = E[M][H.column], X = E[_][H.column]), !G && !X && A.type === "chart" && A.xAxis && A.xAxis.type === "date-time" && (G = gt(A.runtime.xAxis.dateParseFormat)(E[M][A.xAxis.dataKey]), X = gt(A.runtime.xAxis.dateParseFormat)(E[_][A.xAxis.dataKey])), G && X ? ut(G, X, H, A) : 0;
  }) : I, j = {
