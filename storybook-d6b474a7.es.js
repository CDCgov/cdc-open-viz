import { c as bi, b as Un, a as yi, d as Ei } from "./storybook-c757ed74.es.js";
import { r as w, R as I } from "./storybook-e61d95ab.es.js";
import { B as Di } from "./storybook-8d78bf52.es.js";
import { P as Z } from "./storybook-b8c9afe4.es.js";
import { r as pn, R as Si, m as Ci } from "./storybook-ac19c974.es.js";
...
const wi = {
  ...
  "Sequential Green": ["#C7E9C0", "#A1D99B", "#74C476", "#41AB5D", "#238B45", "#005A32"]
}, pp = Oi, fp = fn(xi), gp = fn(wi), mp = fn(Ni), Ii = (e) => {
  ...
  if (v.Section = (_) => /* @__PURE__ */ I.createElement("section", { className: C.join(" ") }, /* @__PURE__ */ I.createElement("p", { className: "filters-section__intro-text" }, y.introText, " ", t.filterBehavior === "Apply Button" && y.applyText), /* @__PURE__ */ I.createElement("div", { className: "filters-section__wrapper" }, _.children)), v.ApplyBehavior = (_) => {
    ...
    return /* @__PURE__ */ I.createElement("div", { className: "filters-section__buttons" }, /* @__PURE__ */ I.createElement(Di, { onClick: () => h(o), disabled: !S, className: x.join(" ") }, y.buttonText), /* @__PURE__ */ I.createElement("a", { href: "#!", role: "button", onClick: D }, y.resetText));
  }, v.TabBar = (_) => {
...
var Hl = (e) => {
  ...
  return yi(ja, Ul(Ei(fl(r), Fl(t), pl(t), El, Bl, $l, Wl, Gl(a), xl, Ll(n), Rl(o, i))));
};
const Gt = () => ({
  additions: {},
  removals: {},
