...
import { c as ea, A as ta, V as na, F as ra, a as aa, b as ia } from "./storybook-InputToggle-26a8dec6.es.js";
import { f as $e, b as oa, g as sa } from "./storybook-getViewport-7dc50c16.es.js";
import { T as ar, H as ir } from "./storybook-index-88ba5a71.es.js";
import { E as or, L as Nt } from "./storybook-viewports-678eca6e.es.js";
import { D as Ce, A as la, a as Jt, b as en, c as tn, d as nn } from "./storybook-DataTransform-12e90958.es.js";
import { b as ua, D as ca, C as sr, a as lr } from "./storybook-CdcChartComponent-b107ddb3.es.js";
import { C as ur } from "./storybook-CdcDataBite-adc584d9.es.js";
import { e as da, C as cr, A as fa } from "./storybook-CdcMap-41f7d7f3.es.js";
import { C as dr } from "./storybook-CdcWaffleChart-186907b0.es.js";
import { C as fr } from "./storybook-CdcMarkupInclude-791799a2.es.js";
import { A as Be, a as ha, b as at, c as it, d as ot, e as st } from "./storybook-Accordion-e48d2b15.es.js";
import { I as pa, a as Ae } from "./storybook-editor-8c1f9105.es.js";
import { B as ga } from "./storybook-Button-9d1b8d73.es.js";
...
import { L as De, u as ma, c as hr } from "./storybook-coveUpdateWorker-f0e4685a.es.js";
import { u as At } from "./storybook-updateFieldFactory-c006040a.es.js";
import { D as va } from "./storybook-DataDesigner-246dc688.es.js";
import { P as Fe } from "./storybook-index-43433e35.es.js";
import { C as He, T as te, S as yt } from "./storybook-Inputs-b140d38c.es.js";
import { _ as N } from "./storybook-lodash-a4231e1c.es.js";
import { u as pr, g as gr, f as rn, a as ya, F as ba, b as Ft, c as mr, r as Da, d as Sa, h as vr, e as Me, i as wa } from "./storybook-Filters-8098ad82.es.js";
import { D as bt, f as Ta, M as an } from "./storybook-DataTable-58beb6cf.es.js";
import { F as se } from "./storybook-FilterStyles-fd509eb9.es.js";
import { D as Ca } from "./storybook-DashboardFilters-dc074c87.es.js";
import { M as lt } from "./storybook-MultiSelect-09077870.es.js";
import { L as Oa } from "./storybook-Loader-2db99cd1.es.js";
import "./storybook-NestedDropdown-43ca2e78.es.js";
import { F as Ea } from "./storybook-Footnotes-3a1f1a4d.es.js";
var yr = y.createContext({
...
function Ga(e, t, n, r) {
  ...
  return Wa(i), typeof i > "u" && (i = t === 0 ? {} : r.getDropResult()), i;
}
function Wa(e) {
  F(typeof e > "u" || br(e), "Drop result must either be an object or undefined.");
}
function Qa(e) {
...
var ei = /* @__PURE__ */ function() {
  function e(t, n) {
    var r = this;
    Ya(this, e), Le(this, "store", void 0), Le(this, "monitor", void 0), Le(this, "backend", void 0), Le(this, "isSetUp", !1), Le(this, "handleRefCountChange", function() {
...
function ri(e, t) {
  var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : ti;
...
function ii() {
  ...
  switch (t.type) {
    ...
    case et:
      return ni(e.clientOffset, n.clientOffset) ? e : dn(dn({}, e), {}, {
        clientOffset: n.clientOffset
      });
    case nt:
    case tt:
...
function fi() {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : di, t = arguments.length > 1 ? arguments[1] : void 0, n = t.payload;
  switch (t.type) {
    case Je:
      return oe(oe({}, e), {}, {
        itemType: n.itemType,
    ...
    case rt:
      return e.targetIds.indexOf(n.targetId) === -1 ? e : oe(oe({}, e), {}, {
        targetIds: Ia(e.targetIds, n.targetId)
      });
    case tt:
      return oe(oe({}, e), {}, {
...
function gi() {
  ...
  var t = e.payload, n = t.targetIds, r = n === void 0 ? [] : n, a = t.prevTargetIds, i = a === void 0 ? [] : a, s = ka(r, i), l = s.length > 0 || !ri(r, i);
  if (!l)
    return Ze;
...
function yi() {
  ...
  return {
    dirtyHandlerIds: gi(e.dirtyHandlerIds, {
      type: t.type,
      payload: gn(gn({}, t.payload), {}, {
        prevTargetIds: _a(e, "dragOperation.targetIds", [])
      })
    }),
    dragOffset: ii(e.dragOffset, t),
    refCount: hi(e.refCount, t),
    dragOperation: fi(e.dragOperation, t),
...
function Di(e) {
  ...
  return !t || !n || !r ? null : Dr(bi(t, r), n);
}
function Si(e) {
  var t = e.clientOffset, n = e.initialClientOffset;
  return !t || !n ? null : Dr(t, n);
}
function wi(e, t) {
  if (!(e instanceof t))
    throw new TypeError("Cannot call a class as a function");
...
var Ci = /* @__PURE__ */ function() {
  function e(t, n) {
    wi(this, e), vn(this, "store", void 0), vn(this, "registry", void 0), this.store = t, this.registry = n;
  }
  return Ti(e, [{
    ...
    value: function(n) {
      ...
      var s = this.store.getState().stateId, l = function() {
        ...
        try {
          var d = m === s || m === s + 1 && !pi(h.dirtyHandlerIds, i);
          d || n();
        } finally {
          s = m;
        }
    ...
    value: function() {
      return Si(this.store.getState().dragOffset);
    }
  }]), e;
}(), Oi = 0;
function Ei() {
...
const yn = typeof global < "u" ? global : self, Sr = yn.MutationObserver || yn.WebKitMutationObserver;
function wr(e) {
  return function() {
...
function ki(e) {
  let t = 1;
  const n = new Sr(e), r = document.createTextNode("");
  return n.observe(r, {
    characterData: !0
  }), function() {
    t = -t, r.data = t;
...
class Ai {
  ...
  constructor() {
    ...
    }, this.requestFlush = Ni(this.flush), this.requestErrorThrow = wr(() => {
...
class Li {
  create(t) {
    const n = this.freeTasks, r = n.length ? n.pop() : new Fi(
      this.onError,
      (a) => n[n.length] = a
    );
    return r.task = t, r;
...
const Tr = new Ai(), Pi = new Li(Tr.registerPendingError);
function Ri(e) {
  Tr.enqueueTask(Pi.create(e));
}
function xi(e, t) {
  if (!(e instanceof t))
    throw new TypeError("Cannot call a class as a function");
...
function wn(e, t) {
  var n = e.entries(), r = !1;
  do {
    var a = n.next(), i = a.done, s = $i(a.value, 2), l = s[1];
    if (l === t)
      return !0;
    r = !!i;
  } while (!r);
...
var ji = /* @__PURE__ */ function() {
  function e(t) {
    xi(this, e), Ee(this, "types", /* @__PURE__ */ new Map()), Ee(this, "dragSources", /* @__PURE__ */ new Map()), Ee(this, "dropTargets", /* @__PURE__ */ new Map()), Ee(this, "pinnedSourceId", null), Ee(this, "pinnedSource", null), Ee(this, "store", void 0), this.store = t;
  }
  return Mi(e, [{
    key: "addSource",
    value: function(n, r) {
    ...
    value: function(n, r) {
      ...
      return this.store.dispatch(si(a)), a;
    }
  }, {
    key: "containsHandler",
    value: function(n) {
    ...
    value: function(n) {
      var r = this;
      F(this.getSource(n), "Expected an existing source."), this.store.dispatch(li(n)), Ri(function() {
    ...
    key: "removeTarget",
    value: function(n) {
      F(this.getTarget(n), "Expected an existing target."), this.store.dispatch(ui(n)), this.dropTargets.delete(n), this.types.delete(n);
    }
  }, {
    key: "pinSource",
    value: function(n) {
...
function qi(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0, n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1, a = Gi(r), i = new Ci(a, new ji(a)), s = new ei(a, i), l = e(s, t, n);
...
var Cn = 0, Ge = Symbol.for("__REACT_DND_CONTEXT_INSTANCE__"), to = y.memo(function(t) {
  var n = t.children, r = Ji(t, Wi), a = no(r), i = Qi(a, 2), s = i[0], l = i[1];
...
function no(e) {
  ...
  var n = ro(e.backend, e.context, e.options, e.debugMode), r = !e.context;
  return [n, r];
}
function ro(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Cr(), n = arguments.length > 2 ? arguments[2] : void 0, r = arguments.length > 3 ? arguments[3] : void 0, a = t;
  return a[Ge] || (a[Ge] = {
    dragDropManager: qi(e, t, n, r)
  }), a[Ge];
}
function Cr() {
...
var ut = !1, ct = !1, oo = /* @__PURE__ */ function() {
  function e(t) {
    ao(this, e), En(this, "internalMonitor", void 0), En(this, "sourceId", null), this.internalMonitor = t.getMonitor();
  }
  return io(e, [{
...
var dt = !1, uo = /* @__PURE__ */ function() {
  function e(t) {
    so(this, e), In(this, "internalMonitor", void 0), In(this, "targetId", null), this.internalMonitor = t.getMonitor();
  }
  return lo(e, [{
    key: "receiveHandlerId",
    value: function(n) {
...
var Co = /* @__PURE__ */ function() {
  function e(t, n, r) {
    wo(this, e), ft(this, "spec", void 0), ft(this, "monitor", void 0), ft(this, "connector", void 0), this.spec = t, this.monitor = n, this.connector = r;
  }
  return To(e, [{
    key: "beginDrag",
    value: function() {
...
function ke() {
  var e = y.useContext(yr), t = e.dragDropManager;
...
function Fo(e, t, n) {
  var r = ke(), a = Oo(e, t, n), i = Eo(e);
  we(function() {
    if (i != null) {
      var l = So(i, a, r), u = _o(l, 2), h = u[0], m = u[1];
      return t.receiveHandlerId(h), n.receiveHandlerId(h), m;
    }
  }, [r, t, n, a, i]);
}
function Lo(e) {
  return Mo(e) || xo(e) || Ro(e) || Po();
}
function Po() {
...
function qo(e, t, n) {
  var r = y.useState(function() {
    return t(e);
  }), a = Vo(r, 2), i = a[0], s = a[1], l = y.useCallback(function() {
    var u = t(e);
    da(i, u) || (s(u), n && n());
  }, [i, e, n]);
  return we(l), [i, l];
...
function Xo(e, t, n) {
  var r = qo(e, t, n), a = Go(r, 2), i = a[0], s = a[1];
  return we(function() {
...
function es(e, t) {
  ...
  var r = $o(), a = Bo(n.options, n.previewOptions);
  return Fo(n, r, a), [_r(n.collect, r, a), Yo(a), Jo(a)];
}
function ts(e) {
  var t = e.accept;
  return y.useMemo(function() {
...
var as = /* @__PURE__ */ function() {
  function e(t, n) {
    ns(this, e), Mn(this, "spec", void 0), Mn(this, "monitor", void 0), this.spec = t, this.monitor = n;
  }
  return rs(e, [{
    key: "canDrop",
    value: function() {
...
function ds(e, t, n) {
  var r = ke(), a = is(e, t), i = ts(e);
  we(function() {
    var l = Do(i, a, r), u = os(l, 2), h = u[0], m = u[1];
    return t.receiveHandlerId(h), n.receiveHandlerId(h), m;
...
function gs(e, t) {
  var n = Er(e, t), r = fs(), a = hs(n.options);
  return ds(n, r, a), [_r(n.collect, r, a), ps(a)];
}
function Ir(e) {
...
var Ds = /* @__PURE__ */ function() {
  function e(t) {
    ys(this, e), Vn(this, "entered", []), Vn(this, "isNodeInDocument", void 0), this.isNodeInDocument = t;
  }
  return bs(e, [{
    key: "enter",
    value: function(n) {
      ...
      return this.entered = vs(this.entered.filter(i), [n]), a === 0 && this.entered.length > 0;
    }
  }, {
    key: "leave",
    value: function(n) {
      var r = this.entered.length;
      return this.entered = ms(this.entered.filter(this.isNodeInDocument), n), r > 0 && this.entered.length === 0;
    }
  }, {
    key: "reset",
    value: function() {
...
var zn = /* @__PURE__ */ function() {
  function e(t, n) {
    ws(this, e), Pe(this, "xs", void 0), Pe(this, "ys", void 0), Pe(this, "c1s", void 0), Pe(this, "c2s", void 0), Pe(this, "c3s", void 0);
...
function Nr(e) {
  var t = e.nodeType === Cs ? e : e.parentElement;
  if (!t)
    return null;
...
function Os(e) {
  var t;
  return e.nodeName === "IMG" && (Ss() || !((t = document.documentElement) !== null && t !== void 0 && t.contains(e)));
}
function Es(e, t, n, r) {
  var a = e ? t.width : n, i = e ? t.height : r;
  return kr() && e && (i /= window.devicePixelRatio, a /= window.devicePixelRatio), {
    dragPreviewWidth: a,
    dragPreviewHeight: i
  };
}
function _s(e, t, n, r, a) {
  var i = Os(t), s = i ? e : t, l = Nr(s), u = {
    x: n.x - l.x,
    y: n.y - l.y
  }, h = e.offsetWidth, m = e.offsetHeight, d = r.anchorX, T = r.anchorY, b = Es(i, t, h, m), O = b.dragPreviewWidth, I = b.dragPreviewHeight, g = function() {
    ...
    return kr() && i && (C += (window.devicePixelRatio - 1) * I), C;
  }, c = function() {
    var _ = new zn([0, 0.5, 1], [
      // Dock to the left
      u.x,
...
var Ar = "__NATIVE_FILE__", Fr = "__NATIVE_URL__", Lr = "__NATIVE_TEXT__", Pr = "__NATIVE_HTML__";
...
var Ns = /* @__PURE__ */ function() {
  function e(t) {
    Is(this, e), qn(this, "item", void 0), qn(this, "config", void 0), this.config = t, this.item = {}, this.initializeExposedProperties();
  }
  return ks(e, [{
...
var Ps = /* @__PURE__ */ function() {
  function e(t, n) {
    Fs(this, e), gt(this, "ownerDocument", null), gt(this, "globalContext", void 0), gt(this, "optionsArgs", void 0), this.globalContext = t, this.optionsArgs = n;
  }
  return Ls(e, [{
    key: "window",
    get: function() {
...
var Ms = /* @__PURE__ */ function() {
  function e(t, n, r) {
    ...
    }), this.options = new Ps(n, r), this.actions = t.getActions(), this.monitor = t.getMonitor(), this.registry = t.getRegistry(), this.enterLeaveCounter = new Ds(this.isNodeInDocument);
  }
  return xs(e, [{
    key: "profile",
    value: function() {
    ...
    value: function(n, r) {
      this.clearCurrentDragSourceNode(), this.currentNativeSource = As(n, r), this.currentNativeHandle = this.registry.addSource(n, this.currentNativeSource), this.actions.beginDrag([this.currentNativeHandle]);
    }
  }, {
...
const Rr = y.createContext({}), me = () => y.useContext(Rr), Bs = ({ children: e }) => {
  var s, l, u;
  ...
  return /* @__PURE__ */ o(Rr.Provider, { value: i, children: e });
}, Vs = "Dashboard Description", Ke = {
  data: {},
  loading: !1,
  filteredData: {},
  preview: !1,
  ...
  config: {},
  ...Ke
}, ne = y.createContext(Us), ae = y.createContext(() => {
});
const zs = ({ disableBgClose: e, children: t, override: n = null }) => {
  let { overlay: r } = me();
  ...
  const { overlay: e } = me();
  return /* @__PURE__ */ o(zs, { disableBgClose: e.disableBgClose, children: e.object });
}, xr = y.createContext({}), ze = {
  title: "Filtered Text",
  type: "filtered-text",
  theme: "theme-blue",
  fontSize: "small",
  ...
  const { config: t, updateConfig: n, loading: r, stateData: a, setParentConfig: i, isDashboard: s } = y.useContext(xr), [l, u] = y.useState(!0), [h, m] = y.useState(!1), d = At(t, n, !0), T = (w) => {
    let _ = [...t.filters];
  ...
  const c = () => {
    ...
    /* @__PURE__ */ p(Be.Section, { title: "Data", children: [
      ...
      /* @__PURE__ */ o(ga, { onClick: O, fluid: !0, children: "Add Filter" })
    ] }),
    /* @__PURE__ */ p(Be.Section, { title: "Visual", children: [
      ...
      /* @__PURE__ */ p("label", { children: [
        ...
        /* @__PURE__ */ o("ul", { className: "color-palette", children: js.map((w) => /* @__PURE__ */ o(
          "li",
          {
            title: w,
            onClick: () => {
...
const Mr = ({ config: e, configUrl: t, isDashboard: n = !1, isEditor: r = !1, setConfig: a }) => {
  const i = new Ce(), [s, l] = y.useState(ze), [u, h] = y.useState(!0), [m, d] = y.useState(s.data || []), [T, b] = y.useState();
  let { title: O, filters: I } = s;
  const g = s.fontSize === "small" ? "16px" : s.fontSize === "medium" ? "22px" : "27px", { contentClasses: c, innerContainerClasses: v } = ma(s), f = async () => {
  ...
  return /* @__PURE__ */ o(or, { component: "CdcFilteredText", children: /* @__PURE__ */ o(xr.Provider, { value: _, children: /* @__PURE__ */ o(De.VisualizationWrapper, { config: s, isEditor: r, showEditorPanel: s == null ? void 0 : s.showEditorPanel, children: w }) }) });
}, ye = {
...
const $r = () => null, Br = (e) => e, Vr = () => null, ge = ({ fontTheme: e = "dark", headerBgColor: t = "#fff", showDividerTop: n = !0, showDividerBottom: r = !0, showClose: a = !0, children: i, override: s = null }) => {
  let { overlay: l } = me();
  const u = y.Children.toArray(i), h = u.find((b) => (b == null ? void 0 : b.type) === $r), m = u.find((b) => (b == null ? void 0 : b.type) === Br), d = u.find((b) => (b == null ? void 0 : b.type) === Vr), T = (b) => b ? null : "none";
...
const Ur = ({ vizKey: e, rowIndex: t }) => {
          ...
          "button",
          {
            ...
            onClick: () => {
              a == null || a.actions.openOverlay(
                /* @__PURE__ */ o(Ur, { rowIndex: t.rowIdx, vizKey: t.uid })
              );
            },
            children: ye.gear
          }
...
}, Qs = ({ data: e, rowIdx: t, colIdx: n }) => {
  var m;
  const { config: r } = y.useContext(ne), [{ isOver: a, canDrop: i }, s] = gs(
    () => ({
      accept: "vis-widget",
      drop: () => ({
        rowIdx: t,
...
}, Zs = (e) => /* @__PURE__ */ y.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", ...e }, /* @__PURE__ */ y.createElement("path", { d: "M2,16 L22,16 L22,14 L2,14 L2,16 Z M2,11 L22,11 L22,9 L2,9 L2,11 Z M2,4 L2,6 L22,6 L22,4 L2,4 Z" })), Ks = (e) => /* @__PURE__ */ y.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", ...e }, /* @__PURE__ */ y.createElement("path", { d: "M22 14L22 16 13 16 13 14 22 14zM11 16L2 16 2 14 11 14 11 16zM22 4L22 6 13 6 13 4 22 4zM11 6L2 6 2 4 11 4 11 6zM22 9L22 11 13 11 13 9 22 9zM11 11L2 11 2 9 11 9 11 11z" })), Xs = (e) => /* @__PURE__ */ y.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", ...e }, /* @__PURE__ */ y.createElement("path", { d: "M22,14 L22,16 L17,16 L17,14 L22,14 Z M7,14 L7,16 L2,16 L2,14 L7,14 Z M15,14 L15,16 L9,16 L9,14 L15,14 Z M22,9 L22,11 L17,11 L17,9 L22,9 Z M7,9 L7,11 L2,11 L2,9 L7,9 Z M15,9 L15,11 L9,11 L9,9 L15,9 Z M22,4 L22,6 L17,6 L17,4 L22,4 Z M7,4 L7,6 L2,6 L2,4 L7,4 Z M15,4 L15,6 L9,6 L9,4 L15,4 Z" })), Ys = (e) => /* @__PURE__ */ y.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", ...e }, /* @__PURE__ */ y.createElement("path", { d: "M22,14 L22,16 L10,16 L10,14 L22,14 Z M8,14 L8,16 L2,16 L2,14 L8,14 Z M22,9 L22,11 L10,11 L10,9 L22,9 Z M8,9 L8,11 L2,11 L2,9 L8,9 Z M22,4 L22,6 L10,6 L10,4 L22,4 Z M8,4 L8,6 L2,6 L2,4 L8,4 Z" })), Js = (e) => /* @__PURE__ */ y.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", ...e }, /* @__PURE__ */ y.createElement("path", { d: "M22,14 L22,16 L16,16 L16,14 L22,14 Z M14,14 L14,16 L2,16 L2,14 L14,14 Z M22,9 L22,11 L16,11 L16,9 L22,9 Z M14,9 L14,11 L2,11 L2,9 L14,9 Z M22,4 L22,6 L16,6 L16,4 L22,4 Z M14,4 L14,6 L2,6 L2,4 L14,4 Z" })), el = (e) => /* @__PURE__ */ y.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", height: 24, width: 24, viewBox: "0 0 576 512", ...e }, /* @__PURE__ */ y.createElement("path", { d: "M192 64C86 64 0 150 0 256S86 448 192 448H384c106 0 192-86 192-192s-86-192-192-192H192zm192 96a96 96 0 1 1 0 192 96 96 0 1 1 0-192z" })), tl = ({ rowIdx: e }) => {
  ...
  return /* @__PURE__ */ o(P, { children: /* @__PURE__ */ p("div", { className: "builder-row", "data-row-id": t, children: [
    ...
    /* @__PURE__ */ o(
      "button",
      {
        ...
        onClick: () => {
          r == null || r.actions.openOverlay(/* @__PURE__ */ o(Ur, { rowIndex: t }));
        },
        children: ye.gearMulti
      }
    ),
    /* @__PURE__ */ o("div", { className: "column-container", children: e.columns.filter((s) => s.width).map((s, l) => /* @__PURE__ */ o(Qs, { data: s, rowIdx: t, colIdx: l }, `row-${n}-col-${l}`)) }),
  ...
  return /* @__PURE__ */ p("div", { className: "builder-grid", children: [
    (t || []).map((i, s) => /* @__PURE__ */ o(nl, { row: i, idx: s, uuid: i.uuid }, s)),
    /* @__PURE__ */ o("button", { className: "btn btn-primary col", onClick: a, children: "Add Row" })
  ] });
};
const al = (e) => /* @__PURE__ */ o(ge, { children: /* @__PURE__ */ p(ge.Content, { children: [
...
] }) }), il = ({ name: e, handleClick: t, tabs: n, index: r, active: a }) => {
  const [i, s] = y.useState(!1), l = y.useContext(ae), { overlay: u } = me(), h = y.createRef(), m = (g) => {
    ...
    u == null || u.actions.openOverlay(al(g));
  }, b = (g, c) => {
    const v = g + c;
  ...
  const { config: e } = y.useContext(ne), t = y.useContext(ae), n = y.useMemo(
    ...
    s.preventDefault(), t({ type: "SWITCH_CONFIG", payload: i }), pr("cove-tab", i);
  };
...
}, zr = ({ isEditor: e = !1 }) => e ? /* @__PURE__ */ o(ol, {}) : /* @__PURE__ */ o(sl, {}), ue = (e) => {
  var O, I;
    ...
    /* @__PURE__ */ o(
      ta,
      {
        loadConfig: (i) => {
          ...
          r({ type: "APPLY_CONFIG", payload: [cl(s)] });
        },
        config: n,
...
function fl(e) {
  let t = 1;
  return e.forEach((n) => {
    n.tier = Hr(e, n), n.tier > t && (t = n.tier);
  }), t;
}
function Xn(e = [], t, n) {
...
const Ie = (e, t) => {
  ...
  return t.dashboard.sharedFilters && (t.dashboard.sharedFilters.forEach((s, l) => {
    const u = !!a.find((T) => T === s.setBy), h = t.dashboard.sharedFilters[l], m = (T) => {
      if (h.values = T, T.length > 0) {
        const b = h.pivot ? h.values : h.values[0], O = gr(h);
        O ? h.active = O : h.active = h.active || b;
      }
    }, d = hl(s.columnName, n || e.data);
...
}, jr = typeof window < "u" && window.__REDUX_DEVTOOLS_EXTENSION__, pl = jr ? window.__REDUX_DEVTOOLS_EXTENSION__.connect() : null, mt = jr ? pl : null, qr = (e) => (t, n) => {
  const r = e(t, n);
  ...
  switch (t.type) {
    ...
    case "ADD_NEW_DASHBOARD": {
      const n = e.config.multiDashboards, r = "New Dashboard " + (n.length + 1), a = [...n, { ...gl(), label: r }];
      return Re(e, a);
    }
    case "UPDATE_CONFIG": {
...
const Gr = ({ children: e, visualizationKey: t, visualizationConfig: n, type: r, component: a, updateConfig: i, viewport: s }) => {
  ...
  return /* @__PURE__ */ p(ha, { allowZeroExpanded: !0, children: [
    /* @__PURE__ */ p(at, { children: [
      /* @__PURE__ */ o(it, { children: /* @__PURE__ */ o(ot, { children: "Filters" }) }),
      /* @__PURE__ */ o(st, { children: /* @__PURE__ */ o(na, { config: e, updateField: n, rawData: e.originalFormattedData }) })
    ] }),
    /* @__PURE__ */ p(at, { children: [
      /* @__PURE__ */ o(it, { children: /* @__PURE__ */ o(ot, { children: "Columns" }) }),
      /* @__PURE__ */ o(st, { children: /* @__PURE__ */ o(ua, { config: e, updateField: n, deleteColumn: r }) })
    ] }),
    /* @__PURE__ */ p(at, { children: [
      /* @__PURE__ */ o(it, { children: /* @__PURE__ */ o(ot, { children: "Data Table" }) }),
      /* @__PURE__ */ o(st, { children: /* @__PURE__ */ o(ca, { config: e, columns: a, updateField: n, isDashboard: !0 }) })
    ] })
  ] });
}, Vt = ({
  visualizationKey: e,
  ...
  return y.useEffect(() => {
    ...
    Gr,
    {
      ...
      type: "Table",
      viewport: r,
      children: /* @__PURE__ */ o(Dl, { config: t, updateConfig: n }, e)
    }
  ) : /* @__PURE__ */ p(P, { children: [
    /* @__PURE__ */ o(
      ba,
...
const Sl = ({ active: e, row: t, visualizations: n, setToggled: r }) => {
  const a = (i, s = null) => {
  ...
  if (r.filterBehavior !== Wr.Apply || r.autoLoad)
    if ((i == null ? void 0 : i.filterStyle) === se.nestedDropdown)
      a[e].active = t[0], a[e].subGrouping.active = t[1];
    else {
      a[e].active = t, Yn(a, e);
      const s = Ft();
      i.setByQueryParameter && s[i.setByQueryParameter] !== i.active && (s[i.setByQueryParameter] = i.active, mr(s));
    }
  else {
    const s = Array.isArray(t) ? t.join(",") : t;
    i.setByQueryParameter && pr(i.setByQueryParameter, s), a[e].queuedActive = t;
  }
  return [a, Yn(a, e)];
}, _t = (e, t) => {
  var r;
...
}, Xe = (e) => Object.values(e).some((t) => t.filterBehavior === "Apply Button" && t.type === "dashboardFilters"), Tl = ({
  filter: e,
  config: t,
  isDashboard: n = !1,
  updateFilterProp: r
...
}, Cl = ({ filter: e, filterIndex: t, config: n, updateFilterProp: r }) => {
  ...
  if (n.includes(a) || r.type === "urlfilter")
    return r;
  const i = N.cloneDeep(r), s = El(_l(r), t);
  ...
  const { config: n, loadAPIFilters: r, data: a } = y.useContext(ne), { overlay: i } = me(), {
    ...
    if (f[c][g] = v, g === "columnName") {
      ...
      g === "filterStyle" ? (f[c] = {
        ...
        setByQueryParameter: "",
        valuesLookup: {}
      }), r(f, {})) : (vr(f[c]), u({ type: "SET_SHARED_FILTERS", payload: f }));
  }, O = (g) => {
  ...
  return /* @__PURE__ */ p(la, { allowZeroExpanded: !0, children: [
...
}, kl = (e) => e.replace(/"/g, ""), Nl = (e) => String(e).match(/^[-]?[0-9\.]+$/), kt = (e, t) => {
  const n = e.includes("?");
  return t.filter(({ value: r }) => r !== "").map(({ key: r, value: a }, i) => {
    const s = i === 0 && !n ? "?" : "&", l = r.match(/\$.*/);
    return Nl(a) || l ? s + r + "=" + a : s + r + `="${kl(a)}"`;
  }).join("");
}, Al = (e, t, n = []) => e.reduce((r, a, i) => {
...
}, Zr = (e) => e == null ? void 0 : e.some(({ value: t }) => t === ""), Fl = (e, t) => {
...
const xl = (e, t) => {
  ...
  const i = y.useContext(ne), { config: s, reloadURLData: l, loadAPIFilters: u, setAPIFilterDropdowns: h, setAPILoading: m } = i, d = y.useContext(ae), T = (D) => {
    ...
    if (!w.sharedFilters.some((E, L) => _.includes(L) ? !E.active && !E.queuedActive : !1)) {
      if (Xe(i.config.visualizations)) {
        ...
        w.sharedFilters.forEach((j) => {
          j.queuedActive && wa(j), j.setByQueryParameter && E[j.setByQueryParameter] !== j.active && (E[j.setByQueryParameter] = Array.isArray(j.active) ? j.active.join(",") : j.active, L = !0);
        }), L && mr(E);
      }
    ...
    if (d({ type: "SET_SHARED_FILTERS", payload: C }), Xe(s.visualizations)) {
      const L = t.autoLoad, j = _.dashboard.sharedFilters.some((de) => !de.active), W = C.filter((de) => de.apiFilter).map((de) => de.apiFilter.apiEndpoint), z = Al(
        W,
        e,
        E
      );
  ...
  return v && !a ? /* @__PURE__ */ o(P, {}) : /* @__PURE__ */ p(De.VisualizationWrapper, { config: t, isEditor: a, currentViewport: r, children: [
    a && /* @__PURE__ */ o(
      De.Sidebar,
      {
        ...
        onBackClick: g,
        children: /* @__PURE__ */ o(Il, { updateConfig: n, vizConfig: t })
      }
    ),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ o(
          Ca,
          {
            ...
            filters: xl(s.dashboard.sharedFilters, i.data) || [],
            apiFilterDropdowns: e,
            handleOnChange: b,
            showSubmit: t.filterBehavior === Wr.Apply && !t.autoLoad,
            applyFilters: T,
  ...
  if (l)
    ...
    i.data = r[u] || [], i.formattedData && (i.formattedData = Ml.developerStandardize(i.data, i.dataDescription) || i.data);
  }
  return i;
}, $l = ({ config: e, updateField: t }) => {
  var h, m, d, T, b, O;
  const n = () => {
  ...
  if (r)
    return /* @__PURE__ */ o(
      Gr,
      {
        ...
        type: "Footnotes",
        viewport: n,
        children: /* @__PURE__ */ o($l, { config: t, updateField: i }, e)
      }
    );
  const s = y.useMemo(() => {
  ...
  return /* @__PURE__ */ o(Ea, { footnotes: [...s, ...l] });
}, Bl = ({
  allExpanded: e,
  fontSize: t,
  groupName: n,
  ...
  const [i, s] = y.useState(e), l = ["xs", "xxs"].includes(r) ? "13px" : `${ia}px`;
  return y.useEffect(() => {
    s(e);
    ...
    /* @__PURE__ */ p(
      "div",
      {
        style: { fontSize: l },
        role: "button",
        className: `multi-visualiation-heading${i ? "" : " collapsed"} h4 py-0`,
        onClick: () => {
          s(!i);
        },
        tabIndex: 0,
...
}, jl = (e, t) => Object.keys(e).reduce((n, r) => {
  const a = e[r].dataKey;
  return t[a] && (n[r].formattedData = t[a]), n;
}, N.cloneDeep(e)), ql = (e, t, n, r) => {
  var i, s;
...
}, Gl = ({ setAllExpanded: e }) => /* @__PURE__ */ o("div", { className: "d-block ", children: /* @__PURE__ */ p("div", { className: "d-flex flex-row-reverse mb-2", children: [
  ...
  const a = (i, s, l, u = 50) => {
    ...
    const d = i.filter((g) => g.apiFilter), T = new Map(d.map((g) => [g.apiFilter.apiEndpoint, g.apiFilter])), b = Ll(i, s), O = Object.values(b).reduce(
      (g, [c]) => ({ ...g, [c]: null }),
      {}
    );
    n((g) => ({ ...g, ...O }));
    ...
    return Promise.all(
      Object.keys(b).map(
        (g) => new Promise((c) => {
          fetch(g).then((v) => v.json()).then((v) => {
            ...
            const [f, S] = b[g], D = T.get(f), w = Fl(v, D);
            I[f] = w;
            const _ = Jn(
              S,
              w,
      ...
      const c = g.some(({ error: f }) => f), v = i.reduce((f, S, D) => m.includes(D) && !S.active ? Zr(Qr(S, i)) ? f : [...f, D] : f, []);
...
function Zl({ initialState: e, isEditor: t = !1, isDebug: n = !1 }) {
  ...
  const [r, a] = y.useReducer(vl, e), [i, s] = y.useReducer(bl, []), l = y.useContext(lr), [u, h] = y.useState({}), [m, d] = y.useState("lg"), [T] = y.useState(`cove-${Math.random().toString(16).slice(-4)}`), [b, O] = y.useState(!0), [I, g] = y.useState(!1), c = r.tabSelected === "Dashboard Preview", v = y.useMemo(() => {
    const k = nr(r.config).map((A) => r.data[A]);
    return k.length ? k.some((A) => A === void 0) : !0;
  }, [r.data]), f = Bt(r.config.rows), S = new Ce(), D = y.useMemo(() => Object.values(r.config.visualizations).filter((k) => k.type === "dashboardFilters").reduce((k, A) => A.autoLoad ? [...k, ...A.sharedFilterIndexes] : k, []), [r.config.visualizations]), w = Wl(
    a,
    s,
    h,
    D
    ...
    for (let Z = 0; Z < B.length; Z++) {
      ...
      if (fe.dataUrl && H) {
        ...
        H.forEach((U) => {
          var K;
          if (U.type === "urlfilter" && ql(U, G, A.visualizations, A.rows)) {
            if (U.filterBy === "File Name" && (q = Hl(q, U, G)), U.queryParameter && (J[U.queryParameter] ? J[U.queryParameter] = J[U.queryParameter] + U.active : J[U.queryParameter] = U.active), U.setByQueryParameter) {
              const Oe = Object.fromEntries(new URLSearchParams(window.location.search))[U.setByQueryParameter], Jr = ((K = U.apiFilter) == null ? void 0 : K.valueSelector) || U.setByQueryParameter;
              Oe && (J[Jr] = Oe);
            }
  ...
  y.useEffect(() => {
    var B;
    const { config: k } = r, A = Ql(k, t && !c), H = It(k.dashboard.sharedFilters, r.data);
  ...
  if (t && !c) {
    ...
    Se(r.config).forEach((A) => {
      var Q;
      const H = (Q = f[A]) == null ? void 0 : Q.row, B = Yr(
        A,
        H,
        r.config,
        r.data,
    ...
    }), k || (W = /* @__PURE__ */ p(to, { backend: $s, children: [
    ...
    W = /* @__PURE__ */ p(P, { children: [
      t && /* @__PURE__ */ o(ue, {}),
      I && /* @__PURE__ */ o(Oa, { fullScreen: !0 }),
      /* @__PURE__ */ o(zr, { isEditor: t && !c }),
        ...
        B && B.map((R, V) => {
          if (R.multiVizColumn && (c || !t)) {
            ...
            return q.forEach((Z) => {
              ...
              !v && R.expandCollapseAllButtons === !0 && /* @__PURE__ */ o(Gl, { setAllExpanded: O }),
              Object.keys(X).map((Z) => {
                const G = X[Z];
                return /* @__PURE__ */ o(
                  er,
  ...
  return /* @__PURE__ */ o(Bs, { children: /* @__PURE__ */ o(
    ne.Provider,
    {
      value: {
        ...r,
...
const rr = {
...
}, ku = ({ configUrl: e, isEditor: t, isDebug: n, config: r }) => {
  ...
  const m = (b) => {
    ...
    if (b.datasets)
      return m(O);
    {
      const I = O.dataFileName || "backwards-compatibility", g = await Kl(b), c = {};
      if (c[I] = {
        data: g,
  ...
  return a ? /* @__PURE__ */ o(Zl, { isEditor: t, isDebug: n, initialState: a }) : /* @__PURE__ */ o(Nt, {});
};
export {
  Bs as G,
  ku as M,
