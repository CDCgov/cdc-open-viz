import { a as A, i as O } from "./storybook-memoize-b2d53f3a.es.js";
import { i as C } from "./storybook-isSymbol-227578c5.es.js";
var L = A, M = function() {
  return L.Date.now();
}, j = M, B = /\s/;
function R(e) {
...
var U = P, X = U, E = O, q = C, _ = 0 / 0, w = /^[-+]0x[0-9a-f]+$/i, z = /^0b[01]+$/i, G = /^0o[0-7]+$/i, J = parseInt;
function K(e) {
  if (typeof e == "number")
    return e;
  if (q(e))
