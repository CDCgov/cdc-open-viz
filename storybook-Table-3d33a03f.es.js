...
const f = ({ children: t, style: a, isBold: r = !1, ariaLabel: s }) => /* @__PURE__ */ e.createElement("td", { "aria-label": s, tabIndex: 0, role: "gridcell", style: a }, r ? /* @__PURE__ */ e.createElement("strong", null, t) : t), g = (t) => {
  const { childRow: a, rowKey: r, wrapColumns: s, cellMinWidth: p = 0, isTotal: W, fontSize: i, viewport: u, preliminaryData: y } = t, d = s ? "unset" : "nowrap", m = p + "px", E = { small: 16, medium: 18, large: 20 }, $ = ["sm", "xs", "xxs"].includes(u) ? "11px" : `${E[i]}px`;
