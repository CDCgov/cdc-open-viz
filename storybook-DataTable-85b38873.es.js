import { R as F, r as SA } from "./storybook-index-45401197.es.js";
...
import { a as Es } from "./storybook-Icon-ee109bed.es.js";
...
var wl = 1, Yt = 2, Zt = 3, xn = 4, Dn = 5, fl = 7, Tn = 8, zt = 9, jt = 10, Sn = 11, Mn = 12, On = 13, Nn = 14, qt = 15, Cl = function(e) {
      ...
      if (nA.SUPPORT_RANGE_BOUNDS) {
        ...
        if (i.length > 1) {
          ...
          c.forEach(function(u) {
            a.push(new Ie(u, xA.fromDOMRectList(e, Vn(r, l + s, u.length).getClientRects()))), l += u.length;
          });
        } else
          a.push(new Ie(B, xA.fromDOMRectList(e, i)));
      } else {
    ...
    function A(t, r) {
      ...
      try {
        if (r.contentWindow && r.contentWindow.document && r.contentWindow.document.documentElement) {
          ...
          var a = r.contentWindow.document.documentElement ? ve(t, getComputedStyle(r.contentWindow.document.documentElement).backgroundColor) : bA.TRANSPARENT, s = r.contentWindow.document.body ? ve(t, getComputedStyle(r.contentWindow.document.body).backgroundColor) : bA.TRANSPARENT;
...
}, re = 1, DA = 2, TA = 4, Ee = 8, LA = function(e, A, t, r, n, a) {
  if (e < -9999 || e > 9999)
  ...
  for (var i = 0; s > 0 && i <= 4; i++) {
    var c = s % 10;
    c === 0 && eA(a, re) && B !== "" ? B = A[c] + B : c > 1 || c === 1 && i === 0 || c === 1 && i === 1 && eA(a, DA) || c === 1 && i === 1 && eA(a, TA) && e > 100 || c === 1 && i > 1 && eA(a, Ee) ? B = A[c] + (i > 0 ? t[i - 1] : "") + B : c === 1 && i > 0 && (B = t[i - 1] + B), s = Math.floor(s / 10);
  }
  return (e < 0 ? r : "") + B;
  ...
  switch (A) {
    ...
    case 31:
      return LA(e, "영일이삼사오육칠팔구", "십백천만", Ar, a, re | DA | TA);
    case 33:
      return LA(e, "零一二三四五六七八九", "十百千萬", Ar, a, 0);
    case 32:
      return LA(e, "零壹貳參四五六七八九", "拾百千", Ar, a, re | DA | TA);
    case 18:
...
var zu = function(e, A) {
    ...
    return sA(this, function(Z) {
      switch (Z.label) {
        case 0:
          ...
          }, B = new xA(s.scrollX, s.scrollY, s.windowWidth, s.windowHeight), i = new Yu(a, B), c = ($ = A.foreignObjectRendering) !== null && $ !== void 0 ? $ : !1, l = {
        ...
        case 2:
          return y = Z.sent(), [3, 5];
        case 3:
          return i.logger.debug("Document cloned, element located at " + U + "," + h + " with size " + w + "x" + E + " using computed rendering"), i.logger.debug("Starting DOM parsing"), C = es(i, u), K === C.styles.backgroundColor && (C.styles.backgroundColor = bA.TRANSPARENT), i.logger.debug("Starting renderer for element at " + I.x + "," + I.y + " with size " + I.width + "x" + I.height), L = new Ru(i, I), [4, L.render(C)];
        case 4:
          y = Z.sent(), Z.label = 5;
        case 5:
  ...
  var r = A.ownerDocument, n = r.documentElement ? ve(e, getComputedStyle(r.documentElement).backgroundColor) : bA.TRANSPARENT, a = r.body ? ve(e, getComputedStyle(r.body).backgroundColor) : bA.TRANSPARENT, s = typeof t == "string" ? ve(e, t) : t === null ? bA.TRANSPARENT : 4294967295;
...
const rg = ({ rawData: e, fileName: A, headerColor: t, skipId: r }) => {
...
})), ra = ({ skipId: e, skipMessage: A }) => /* @__PURE__ */ F.createElement("a", { id: "skip-nav", className: "cdcdataviz-sr-only-focusable", href: `#${e}` }, A), na = ({ expanded: e, setExpanded: A, tableTitle: t }) => /* @__PURE__ */ F.createElement(
  "div",
  {
  ...
  t
), lg = (e) => /* @__PURE__ */ SA.createElement("svg", { viewBox: "0 0 512 512", xmlns: "http://www.w3.org/2000/svg", ...e }, /* @__PURE__ */ SA.createElement("path", { d: "M432 320h-32c-8.837 0-16 7.163-16 16v112H64V128h144c8.837 0 16-7.163 16-16V80c0-8.837-7.163-16-16-16H48C21.49 64 0 85.49 0 112v352c0 26.51 21.49 48 48 48h352c26.51 0 48-21.49 48-48V336c0-8.837-7.163-16-16-16zM488 0H360c-21.37 0-32.05 25.91-17 41l35.73 35.73L135 320.37a24 24 0 000 34L157.67 377a24 24 0 0034 0l243.61-243.68L471 169c15 15 41 4.5 41-17V24c0-13.255-10.745-24-24-24z", fillRule: "nonzero" }));
function ug(e) {
...
const gg = ({ markup: e, row: A, columns: t, navigationHandler: r, mapZoomHandler: n }) => t.navigate && A[t.navigate.name] ? /* @__PURE__ */ F.createElement(
  ...
  var $, AA, CA, iA, uA;
  const { config: A, dataConfig: t, tableTitle: r, vizTitle: n, rawData: a, runtimeData: s, headerColor: B, expandDataTable: i, columns: c, viewport: l, formatLegendLocation: o, tabbingId: u, wrapColumns: Q } = e, [g, w] = SA.useState(i), [E, U] = SA.useState({ column: A.type === "map" ? "geo" : "date", asc: !1, colIndex: null }), [h, K] = SA.useState(""), I = !(A.type === "chart" && !(($ = A.table) != null && $.showVertical)), C = `btn__${Math.random().toString(16).substr(2, 8)}`, L = {
