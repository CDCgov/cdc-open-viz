...
function G(r, n) {
  return n && (typeof n == "object" || typeof n == "function") ? n : h(r);
}
function N(r) {
  var n = V();
  return function() {
...
var re = function r(n) {
  ...
  x(this, r), f(this, "expanded", void 0), f(this, "allowMultipleExpanded", void 0), f(this, "allowZeroExpanded", void 0), f(this, "toggleExpanded", function(u) {
    ...
    var s = e.isItemExpanded(u), p = e.expanded.length === 1;
    return !!(s && !e.allowZeroExpanded && p);
  }), f(this, "isItemExpanded", function(u) {
    return e.expanded.indexOf(u) !== -1;
  }), f(this, "getPanelAttributes", function(u, s) {
    var p = s ?? e.isItemExpanded(u);
    return {
  ...
  }), f(this, "getButtonAttributes", function(u, s) {
    var p = s ?? e.isItemExpanded(u), v = e.isItemDisabled(u);
    return {
      id: e.getButtonId(u),
      "aria-disabled": v,
      "aria-expanded": p,
...
}, R = /* @__PURE__ */ c.createContext(null), H = /* @__PURE__ */ function(r) {
  j(e, r);
  var n = N(e);
  function e() {
    var t;
    ...
    for (var o = arguments.length, a = new Array(o), l = 0; l < o; l++)
      a[l] = arguments[l];
    return t = n.call.apply(n, [this].concat(a)), f(h(t), "state", new re({
  ...
  return C(e, [{
    ...
    value: function() {
      ...
      return /* @__PURE__ */ c.createElement(R.Provider, {
        value: {
...
var B = /* @__PURE__ */ function(r) {
  ...
  function e() {
    ...
    for (var o = arguments.length, a = new Array(o), l = 0; l < o; l++)
      a[l] = arguments[l];
    return t = n.call.apply(n, [this].concat(a)), f(h(t), "renderChildren", function(i) {
  ...
  return C(e, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ c.createElement(R.Consumer, null, this.renderChildren);
    }
  }]), e;
  ...
  return /* @__PURE__ */ c.createElement(H, {
    ...
    allowZeroExpanded: a,
    onChange: l
  }, /* @__PURE__ */ c.createElement("div", m({
...
var z = /* @__PURE__ */ c.createContext(null), le = function(n) {
  var e = n.children, t = n.uuid, o = n.accordionContext, a = n.dangerouslySetExpanded, l = function() {
    o.toggleExpanded(t);
  }, i = function(u) {
    var s = a ?? u.isItemExpanded(t), p = u.isItemDisabled(t), v = u.getPanelAttributes(t, a), E = u.getHeadingAttributes(t), P = u.getButtonAttributes(t, a);
    return /* @__PURE__ */ c.createElement(z.Provider, {
      value: {
        uuid: t,
        expanded: s,
        disabled: p,
  ...
  return /* @__PURE__ */ c.createElement(B, null, i);
}, ue = function(n) {
  return /* @__PURE__ */ c.createElement(B, null, function(e) {
    return /* @__PURE__ */ c.createElement(le, m({}, n, {
      accordionContext: e
    }));
  });
}, O = function(n) {
  ...
  return /* @__PURE__ */ c.createElement(z.Consumer, null, t);
}, de = function(n) {
  var e = n.uuid, t = n.dangerouslySetExpanded, o = n.className, a = o === void 0 ? "accordion__item" : o, l = n.activeClassName, i = A(n, ["uuid", "dangerouslySetExpanded", "className", "activeClassName"]), d = c.useState(oe()), u = Y(d, 1), s = u[0], p = e ?? s, v = function(P) {
    var L = P.expanded, W = L && l ? l : a;
    return /* @__PURE__ */ c.createElement("div", m({
      "data-accordion-component": "AccordionItem",
      className: W
    }, i));
  };
  return b(p.toString()), i.id && b(i.id), /* @__PURE__ */ c.createElement(ue, {
    uuid: p,
    dangerouslySetExpanded: t
  }, /* @__PURE__ */ c.createElement(O, null, v));
};
...
var g = {
  ...
  return a.id && b(a.id), /* @__PURE__ */ c.createElement("div", m({
    className: o
  }, a, {
    role: "button",
    tabIndex: 0,
  ...
  return /* @__PURE__ */ c.createElement(O, null, function(e) {
    var t = e.toggleExpanded, o = e.buttonAttributes;
    return /* @__PURE__ */ c.createElement(he, m({
      toggleExpanded: t
    }, n, o));
  });
}, me = {
...
`, F = /* @__PURE__ */ function(r) {
  ...
  function e() {
    ...
    for (var o = arguments.length, a = new Array(o), l = 0; l < o; l++)
      a[l] = arguments[l];
    return t = n.call.apply(n, [this].concat(a)), f(h(t), "ref", void 0), f(h(t), "setRef", function(i) {
      t.ref = i;
    }), t;
  }
  return C(e, [{
...
var ve = function(n) {
  return /* @__PURE__ */ c.createElement(O, null, function(e) {
    ...
    return n.id && b(n.id), /* @__PURE__ */ c.createElement(F, m({}, n, t));
  });
};
...
var xe = function(n) {
  var e = n.className, t = e === void 0 ? "accordion__panel" : e, o = n.id, a = A(n, ["className", "id"]), l = function(d) {
    ...
    return o && b(o), /* @__PURE__ */ c.createElement("div", m({
      "data-accordion-component": "AccordionItemPanel",
      className: t
    }, a, u));
  };
  return /* @__PURE__ */ c.createElement(O, null, l);
};
class Ae {
  constructor() {
    this.constants = {
            ...
            return e.ignoredKeys && e.ignoredKeys.length > 0 && (a = a.concat(e.ignoredKeys)), n.forEach((l) => {
              a.forEach((i) => {
                ...
                Object.keys(l).forEach((s) => {
                  s !== e.xKey && s !== e.seriesKey && a.indexOf(s) === -1 && (u += "|" + s + "=" + l[s], d.push(s));
                }), t[u] || (t[u] = { [e.xKey]: l[e.xKey], "**Numeric Value Property**": i }, d.forEach((s) => {
                  t[u][s] = l[s];
    ...
    return t && console.log("## Data to clean=", n), e === void 0 ? (console.log("COVE: cleanData excludeKey undefined"), n) : (n.forEach(function(a, l) {
      ...
      Object.keys(a).forEach(function(d) {
        ...
        if (d === e)
          ...
          let s = "";
          typeof u == "string" ? s = u ? ((E) => E.replace(/[,\$]/g, ""))(u) : "" : s = u || "";
          const v = (E) => /\d+\.?\d*/.test(E);
          !isNaN(parseFloat(s)) || v(s) ? i[d] = s : i[d] = "";
        }
