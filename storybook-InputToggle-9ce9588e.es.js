...
import { e as xt } from "./storybook-DataTransform-12e90958.es.js";
...
import { d as js, m as Yc, a as qn } from "./storybook-Icon-d8cd8abc.es.js";
import { j as x, a as Te, F as $i } from "./storybook-jsx-runtime-36872362.es.js";
import { S as Bn, T as Gs } from "./storybook-Inputs-0111192f.es.js";
import { T as wt } from "./storybook-Tooltip-8bb9dfa2.es.js";
import { d as Qo, h as Zo, j as Xc } from "./storybook-Filters-f5cf5018.es.js";
import { r as Vi, R as Kc } from "./storybook-index-633d712d.es.js";
import { _ as mn } from "./storybook-extends-70f3d2a3.es.js";
import { M as Jc } from "./storybook-MultiSelect-fb96d51f.es.js";
  ...
  arcTo: function(e, t, n, r, o) {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(f * a - u * l) > Xt) || !o)
        ...
        var d = n - i, p = r - s, g = a * a + u * u, h = d * d + p * p, m = Math.sqrt(g), b = Math.sqrt(c), A = o * Math.tan((ei - Math.acos((g + c - h) / (2 * m * b))) / 2), D = A / b, E = A / m;
        Math.abs(D - 1) > Xt && (this._ += "L" + (e + D * l) + "," + (t + D * f)), this._ += "A" + o + "," + o + ",0,0," + +(f * d > l * p) + "," + (this._x1 = e + E * a) + "," + (this._y1 = t + E * u);
      }
  },
...
var Ru = Math.sqrt(1 / 3), dd = Ru * 2;
const fd = {
  draw: function(e, t) {
    var n = Math.sqrt(t / dd), r = n * Ru;
...
function gd(e) {
  ...
  const [s, a] = w.useState({
    ...
    resizeObserver: null,
    lastBounds: s
  }), l = t ? typeof t == "number" ? t : t.scroll : null, f = t ? typeof t == "number" ? t : t.resize : null, c = w.useRef(!1);
  w.useEffect(() => (c.current = !0, () => void (c.current = !1)));
  const [d, p, g] = w.useMemo(() => {
    const A = () => {
    ...
    return [A, f ? Ws(A, f) : A, l ? Ws(A, l) : A];
  }, [a, o, l, f]);
  function h() {
  ...
  const b = (A) => {
    !A || A === u.current.element || (h(), u.current.element = A, u.current.scrollContainers = Iu(A), m());
  };
  return Ed(g, !!n), Dd(p), w.useEffect(() => {
    h(), m();
  }, [n, g, p]), w.useEffect(() => h, []), [b, s, d];
}
function Dd(e) {
  w.useEffect(() => {
    const t = e;
...
function Iu(e) {
  ...
  return [n, r, o].some((i) => i === "auto" || i === "scroll") && t.push(e), [...t, ...Iu(e.parentElement)];
}
...
function oi(e, t) {
  if (!e || !t)
    return null;
  var n = Pd(t), r = xd(e) ? e.ownerSVGElement : e, o = Td(r) ? r.getScreenCTM() : null;
  if (Od(r) && o) {
...
function kd(e) {
  ...
  return t.isIdentity ? ii : Pu(t.a, t.b, t.c, t.d, t.e, t.f);
}
function $d(e) {
  return e == null || (Ar || (Ar = document.createElementNS("http://www.w3.org/2000/svg", "g")), Ar.setAttribute("transform", e), !(e = Ar.transform.baseVal.consolidate())) ? ii : (e = e.matrix, Pu(e.a, e.b, e.c, e.d, e.e, e.f));
}
function Mu(e, t, n, r) {
  function o(l) {
...
}, TC = (e, t) => !xt.valid(e) || !xt.valid(t) ? !1 : xt.contrast(e, t) >= Gd, BC = (e, t) => !xt.valid(e) || !xt.valid(t) ? !1 : xt.contrast(e, t), RC = (e) => {
...
function hf(e, t) {
  ...
  for (var i = o.length, s = new Array(i), a = new Array(i), u = new Array(i), l = 0; l < i; ++l) {
    var f = r[l], c = o[l], d = c.length, p = gf(e.call(f, f && f.__data__, l, r)), g = p.length, h = a[l] = new Array(g), m = s[l] = new Array(g), b = u[l] = new Array(d);
    n(f, c, h, m, b, p, t);
    for (var A = 0, D = 0, E, y; A < g; ++A)
      if (E = h[A]) {
        for (A >= D && (D = A + 1); !(y = m[D]) && ++D < g; )
          ;
        E._next = y || null;
      }
  }
...
function Pf(e, t) {
  ...
  return this.each((t == null ? n.local ? Of : xf : typeof t == "function" ? n.local ? If : Rf : n.local ? Bf : Tf)(n, t));
}
function Uu(e) {
...
var gn = 0, Gn = 0, Rn = 0, Qu = 1e3, Ur, zn, Wr = 0, rn = 0, ao = 0, Zn = typeof performance == "object" && performance.now ? performance : Date, Zu = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function Hi() {
...
function li(e) {
  if (!gn) {
    ...
    var t = e - rn;
    t > 24 ? (e < 1 / 0 && (Gn = setTimeout(Xs, e - Zn.now() - ao)), Rn && (Rn = clearInterval(Rn))) : (Rn || (Wr = Zn.now(), Rn = setInterval(Np, Qu)), gn = 1, Zu(Xs));
  }
}
function Ks(e, t, n) {
  var r = new Hr();
...
function Lp(e, t) {
  ...
  return this.each((t == null ? Pp : Mp)(n, e, t));
}
function Yi(e, t, n) {
  var r = e._id;
...
function Lm(e) {
  var t, n;
  e instanceof Tt ? (t = e._id, e = e._name) : (t = ol(), (n = Pm).time = Hi(), e = e == null ? null : e + "");
  for (var r = this._groups, o = r.length, i = 0; i < o; ++i)
    for (var s = r[i], a = s.length, u, l = 0; l < a; ++l)
      (u = s[l]) && uo(u, e, t, l, s, n || Mm(u, t));
  return new Tt(r, this._parents, e, t);
}
cr.prototype.interrupt = Ip;
...
function jm(e) {
  ...
  return a.type(fd), (typeof i == "number" || i) && a.size(i), t ? /* @__PURE__ */ F.createElement(F.Fragment, null, t({
    path: a
  })) : /* @__PURE__ */ F.createElement(dr, {
    top: r,
    left: o
  }, /* @__PURE__ */ F.createElement("path", fi({
...
function Um(e) {
  ...
  return a.type(md), (typeof i == "number" || i) && a.size(i), t ? /* @__PURE__ */ F.createElement(F.Fragment, null, t({
    path: a
  })) : /* @__PURE__ */ F.createElement(dr, {
    top: r,
    left: o
  }, /* @__PURE__ */ F.createElement("path", pi({
...
function qm(e) {
  ...
  return a.type(pd), (typeof i == "number" || i) && a.size(i), t ? /* @__PURE__ */ F.createElement(F.Fragment, null, t({
    path: a
  })) : /* @__PURE__ */ F.createElement(dr, {
    top: r,
    left: o
  }, /* @__PURE__ */ F.createElement("path", mi({
...
function Km(e) {
  ...
  return a.type(Bu), (typeof i == "number" || i) && a.size(i), t ? /* @__PURE__ */ F.createElement(F.Fragment, null, t({
    path: a
  })) : /* @__PURE__ */ F.createElement(dr, {
    top: r,
    left: o
  }, /* @__PURE__ */ F.createElement("path", hi({
...
const wr = st(Array.prototype.forEach), ea = st(Array.prototype.pop), In = st(Array.prototype.push), kr = st(String.prototype.toLowerCase), Ao = st(String.prototype.toString), ta = st(String.prototype.match), Pn = st(String.prototype.replace), eh = st(String.prototype.indexOf), th = st(String.prototype.trim), ft = st(Object.prototype.hasOwnProperty), qe = st(RegExp.prototype.test), Mn = nh(TypeError);
function st(e) {
  return function(t) {
...
function ll() {
  ...
  const r = n, o = r.currentScript, {
    ...
    DOMParser: d,
    trustedTypes: p
  } = e, g = u.prototype, h = _r(g, "cloneNode"), m = _r(g, "nextSibling"), b = _r(g, "childNodes"), A = _r(g, "parentNode");
  ...
  let O = {};
  t.isSupported = typeof il == "function" && typeof A == "function" && y && y.createHTMLDocument !== void 0;
  const {
    MUSTACHE_EXPR: L,
    ERB_EXPR: P,
    TMPLIT_EXPR: T,
  ...
  })), te = null, be = null, je = !0, le = !0, de = !1, Ae = !0, we = !1, R = !0, ae = !1, $ = !1, Le = !1, Fe = !1, Oe = !1, _e = !1, We = !0, Ge = !1;
  ...
  let Rt = Ne, cn = !1, wn = null;
  const yr = re({}, [ln, bt, Ne], Ao);
  let zt = null;
  const Do = ["application/xhtml+xml", "text/html"], Eo = "text/html";
  let xe = null, Ct = null;
  const yo = n.createElement("form"), _n = function(C) {
    return C instanceof RegExp || C instanceof Function;
  }, It = function() {
    let C = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (!(Ct && Ct === C)) {
      if ((!C || typeof C != "object") && (C = {}), C = Kt(C), zt = // eslint-disable-next-line unicorn/prefer-includes
      Do.indexOf(C.PARSER_MEDIA_TYPE) === -1 ? Eo : C.PARSER_MEDIA_TYPE, xe = zt === "application/xhtml+xml" ? Ao : kr, Y = ft(C, "ALLOWED_TAGS") ? re({}, C.ALLOWED_TAGS, xe) : ce, Z = ft(C, "ALLOWED_ATTR") ? re({}, C.ALLOWED_ATTR, xe) : ge, wn = ft(C, "ALLOWED_NAMESPACES") ? re({}, C.ALLOWED_NAMESPACES, Ao) : yr, an = ft(C, "ADD_URI_SAFE_ATTR") ? re(
        Kt(un),
        ...
        xe
        // eslint-disable-line indent
      ) : un, vt = ft(C, "ADD_DATA_URI_TAGS") ? re(
        Kt(Gt),
        // eslint-disable-line indent
        C.ADD_DATA_URI_TAGS,
        // eslint-disable-line indent
        xe
        // eslint-disable-line indent
      ) : Gt, Ce = ft(C, "FORBID_CONTENTS") ? re({}, C.FORBID_CONTENTS, xe) : ze, te = ft(C, "FORBID_TAGS") ? re({}, C.FORBID_TAGS, xe) : {}, be = ft(C, "FORBID_ATTR") ? re({}, C.FORBID_ATTR, xe) : {}, ue = ft(C, "USE_PROFILES") ? C.USE_PROFILES : !1, je = C.ALLOW_ARIA_ATTR !== !1, le = C.ALLOW_DATA_ATTR !== !1, de = C.ALLOW_UNKNOWN_PROTOCOLS || !1, Ae = C.ALLOW_SELF_CLOSE_IN_ATTR !== !1, we = C.SAFE_FOR_TEMPLATES || !1, R = C.SAFE_FOR_XML !== !1, ae = C.WHOLE_DOCUMENT || !1, Fe = C.RETURN_DOM || !1, Oe = C.RETURN_DOM_FRAGMENT || !1, _e = C.RETURN_TRUSTED_TYPE || !1, Le = C.FORCE_BODY || !1, We = C.SANITIZE_DOM !== !1, Ge = C.SANITIZE_NAMED_PROPS || !1, Ze = C.KEEP_CONTENT !== !1, z = C.IN_PLACE || !1, se = C.ALLOWED_URI_REGEXP || al, Rt = C.NAMESPACE || Ne, V = C.CUSTOM_ELEMENT_HANDLING || {}, C.CUSTOM_ELEMENT_HANDLING && _n(C.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (V.tagNameCheck = C.CUSTOM_ELEMENT_HANDLING.tagNameCheck), C.CUSTOM_ELEMENT_HANDLING && _n(C.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (V.attributeNameCheck = C.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), C.CUSTOM_ELEMENT_HANDLING && typeof C.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (V.allowCustomizedBuiltInElements = C.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), we && (le = !1), Oe && (Fe = !0), ue && (Y = re({}, ra), Z = [], ue.html === !0 && (re(Y, na), re(Z, oa)), ue.svg === !0 && (re(Y, wo), re(Z, Fo), re(Z, Sr)), ue.svgFilters === !0 && (re(Y, _o), re(Z, Fo), re(Z, Sr)), ue.mathMl === !0 && (re(Y, So), re(Z, ia), re(Z, Sr))), C.ADD_TAGS && (Y === ce && (Y = Kt(Y)), re(Y, C.ADD_TAGS, xe)), C.ADD_ATTR && (Z === ge && (Z = Kt(Z)), re(Z, C.ADD_ATTR, xe)), C.ADD_URI_SAFE_ATTR && re(an, C.ADD_URI_SAFE_ATTR, xe), C.FORBID_CONTENTS && (Ce === ze && (Ce = Kt(Ce)), re(Ce, C.FORBID_CONTENTS, xe)), Ze && (Y["#text"] = !0), ae && re(Y, ["html", "head", "body"]), Y.table && (re(Y, ["tbody"]), delete te.tbody), C.TRUSTED_TYPES_POLICY) {
        ...
        D = C.TRUSTED_TYPES_POLICY, E = D.createHTML("");
      } else
        D === void 0 && (D = hh(p, o)), D !== null && typeof E == "string" && (E = D.createHTML(""));
      Qe && Qe(C), Ct = C;
    }
  }, Sn = re({}, ["mi", "mo", "mn", "ms", "mtext"]), vr = re({}, ["foreignobject", "annotation-xml"]), br = re({}, ["title", "style", "font", "a", "script"]), Fn = re({}, [...wo, ..._o, ...oh]), Nn = re({}, [...So, ...ih]), q = function(C) {
    let B = A(C);
    (!B || !B.tagName) && (B = {
      namespaceURI: Rt,
      tagName: "template"
    });
    const G = kr(C.tagName), De = kr(B.tagName);
    return wn[C.namespaceURI] ? C.namespaceURI === bt ? B.namespaceURI === Ne ? G === "svg" : B.namespaceURI === ln ? G === "svg" && (De === "annotation-xml" || Sn[De]) : !!Fn[G] : C.namespaceURI === ln ? B.namespaceURI === Ne ? G === "math" : B.namespaceURI === bt ? G === "math" && vr[De] : !!Nn[G] : C.namespaceURI === Ne ? B.namespaceURI === bt && !vr[De] || B.namespaceURI === ln && !Sn[De] ? !1 : !Nn[G] && (br[G] || !Fn[G]) : !!(zt === "application/xhtml+xml" && wn[C.namespaceURI]) : !1;
  }, ne = function(C) {
    In(t.removed, {
      element: C
    });
    ...
    if (B.removeAttribute(C), C === "is" && !Z[C])
      if (Fe || Oe)
        try {
          ne(B);
        } catch {
    ...
    zt === "application/xhtml+xml" && Rt === Ne && (C = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + C + "</body></html>");
    const De = D ? D.createHTML(C) : C;
    if (Rt === Ne)
      try {
    ...
    if (!B || !B.documentElement) {
      B = y.createDocument(Rt, "template", null);
      try {
        B.documentElement.innerHTML = cn ? E : De;
      } catch {
      }
    }
    const Ue = B.body || B.documentElement;
    return C && G && Ue.insertBefore(n.createTextNode(G), Ue.childNodes[0] || null), Rt === Ne ? I.call(B, ae ? "html" : "body")[0] : ae ? B.documentElement : Ue;
  }, xn = function(C) {
    return _.call(
      C.ownerDocument || C,
      C,
    ...
    return C instanceof c && (typeof C.nodeName != "string" || typeof C.textContent != "string" || typeof C.removeChild != "function" || !(C.attributes instanceof f) || typeof C.removeAttribute != "function" || typeof C.setAttribute != "function" || typeof C.namespaceURI != "string" || typeof C.insertBefore != "function" || typeof C.hasChildNodes != "function");
  }, Bs = function(C) {
    ...
    let B = null;
    if (At("beforeSanitizeElements", C, null), On(C))
      return ne(C), !0;
    const G = xe(C.nodeName);
    if (At("uponSanitizeElement", C, {
      tagName: G,
      allowedTags: Y
    }), C.hasChildNodes() && !Bs(C.firstElementChild) && qe(/<[/\w]/g, C.innerHTML) && qe(/<[/\w]/g, C.textContent) || C.nodeType === Ln.progressingInstruction || R && C.nodeType === Ln.comment && qe(/<[/\w]/g, C.data))
      return ne(C), !0;
    if (!Y[G] || te[G]) {
      if (!te[G] && Ps(G) && (V.tagNameCheck instanceof RegExp && qe(V.tagNameCheck, G) || V.tagNameCheck instanceof Function && V.tagNameCheck(G)))
        return !1;
      if (Ze && !Ce[G]) {
        const De = A(C) || C.parentNode, Ue = b(C) || C.childNodes;
        if (Ue && De) {
          const ke = Ue.length;
          for (let et = ke - 1; et >= 0; --et) {
            const gt = h(Ue[et], !0);
            gt.__removalCount = (C.__removalCount || 0) + 1, De.insertBefore(gt, m(C));
          }
        }
      }
      return ne(C), !0;
    }
    return C instanceof u && !q(C) || (G === "noscript" || G === "noembed" || G === "noframes") && qe(/<\/no(script|embed|frames)/i, C.innerHTML) ? (ne(C), !0) : (we && C.nodeType === Ln.text && (B = C.textContent, wr([L, P, T], (De) => {
      B = Pn(B, De, " ");
    }), C.textContent !== B && (In(t.removed, {
      element: C.cloneNode()
    }), C.textContent = B)), At("afterSanitizeElements", C, null), !1);
  }, Is = function(C, B, G) {
      ...
      if (!(je && qe(H, B))) {
        if (!Z[B] || be[B]) {
          if (
            ...
            !(Ps(C) && (V.tagNameCheck instanceof RegExp && qe(V.tagNameCheck, C) || V.tagNameCheck instanceof Function && V.tagNameCheck(C)) && (V.attributeNameCheck instanceof RegExp && qe(V.attributeNameCheck, B) || V.attributeNameCheck instanceof Function && V.attributeNameCheck(B)) || // Alternative, second condition checks if it's an `is`-attribute, AND
          ...
          if (!qe(se, Pn(G, Q, ""))) {
            if (!((B === "src" || B === "xlink:href" || B === "href") && C !== "script" && eh(G, "data:") === 0 && vt[C])) {
              if (!(de && !qe(J, Pn(G, Q, "")))) {
                if (G)
                  return !1;
              }
    ...
    return C !== "annotation-xml" && ta(C, X);
  }, Ms = function(C) {
    At("beforeSanitizeAttributes", C, null);
    const {
      attributes: B
    } = C;
    if (!B)
    ...
    for (; De--; ) {
      ...
      if (G.attrName = Tn, G.attrValue = He, G.keepAttr = !0, G.forceKeepAttr = void 0, At("uponSanitizeAttribute", C, G), He = G.attrValue, G.forceKeepAttr || (Re(ke, C), !G.keepAttr))
        continue;
      if (!Ae && qe(/\/>/i, He)) {
        Re(ke, C);
        continue;
      }
      if (R && qe(/((--!?|])>)|<\/(style|title)/i, He)) {
        Re(ke, C);
        continue;
      }
      we && wr([L, P, T], (ks) => {
      ...
      const Ls = xe(C.nodeName);
      if (Is(Ls, Tn, He)) {
        if (Ge && (Tn === "id" || Tn === "name") && (Re(ke, C), He = at + He), D && typeof p == "object" && typeof p.getAttributeType == "function" && !et)
        ...
        try {
          et ? C.setAttributeNS(et, ke, He) : C.setAttribute(ke, He), On(C) ? ne(C) : ea(t.removed);
        } catch {
        }
      }
    }
    At("afterSanitizeAttributes", C, null);
  }, Wc = function W(C) {
    let B = null;
    const G = xn(C);
    for (At("beforeSanitizeShadowDOM", C, null); B = G.nextNode(); )
      At("uponSanitizeShadowNode", B, null), !Rs(B) && (B.content instanceof i && W(B.content), Ms(B));
    At("afterSanitizeShadowDOM", C, null);
  };
  return t.sanitize = function(W) {
    let C = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, B = null, G = null, De = null, Ue = null;
    ...
    if (!t.isSupported)
      return W;
    if ($ || It(C), t.removed = [], typeof W == "string" && (z = !1), z) {
      if (W.nodeName) {
      ...
      B = Pt("<!---->"), G = B.ownerDocument.importNode(W, !0), G.nodeType === Ln.element && G.nodeName === "BODY" || G.nodeName === "HTML" ? B = G : B.appendChild(G);
    else {
    ...
    const ke = xn(z ? W : B);
    for (; De = ke.nextNode(); )
      Rs(De) || (De.content instanceof i && Wc(De.content), Ms(De));
    if (z)
      return W;
    if (Fe) {
      if (Oe)
...
` + et), we && wr([L, P, T], (gt) => {
    ...
    Ct = null, $ = !1;
  }, t.isValidAttribute = function(W, C, B) {
    Ct || It({});
    const G = xe(W), De = xe(C);
    return Is(G, De, B);
  }, t.addHook = function(W, C) {
    typeof C == "function" && (O[W] = O[W] || [], In(O[W], C));
...
var VC = ll(), gh = /* @__PURE__ */ w.createContext({});
const lo = gh;
function Ei() {
...
function Dh(e) {
  var t, n, r, o, i = e.className, s = e.x, a = e.y, u = e.dx, l = e.dy, f = e.type, c = f === void 0 ? "elbow" : f, d = e.stroke, p = d === void 0 ? "#222" : d, g = e.pathProps, h = w.useContext(lo), m = s ?? ((t = h.x) != null ? t : 0), b = a ?? ((n = h.y) != null ? n : 0), A = u ?? ((r = h.dx) != null ? r : 0), D = l ?? ((o = h.dy) != null ? o : 0), E = m, y = b, _ = m + A, N = b + D;
  if (c === "elbow")
  ...
  return /* @__PURE__ */ F.createElement("path", Ei({
    className: jt("visx-annotation-connector", i),
    strokeWidth: 1,
    stroke: p,
    fill: "transparent",
    pointerEvents: "none",
    d: "M" + m + "," + b + (c === "elbow" ? "L" + E + "," + y : "") + "L" + _ + "," + N
  }, g));
}
Dh.propTypes = {
  className: k.string,
...
function cl(e) {
  ...
  return /* @__PURE__ */ F.createElement(F.Fragment, null, t === "horizontal" && r === "start" && /* @__PURE__ */ F.createElement("line", pn({}, a, {
    x1: 0,
    x2: i,
    y1: 0,
    y2: 0
  })), t === "horizontal" && r === "end" && /* @__PURE__ */ F.createElement("line", pn({}, a, {
    x1: 0,
    x2: i,
    y1: s,
    y2: s
  })), t === "vertical" && o === "start" && /* @__PURE__ */ F.createElement("line", pn({}, a, {
    x1: 0,
    x2: 0,
    y1: 0,
    y2: s
  })), t === "vertical" && o === "end" && /* @__PURE__ */ F.createElement("line", pn({}, a, {
    x1: i,
    x2: i,
    y1: 0,
    y2: s
...
function Eh(e) {
  var t = e.anchorLineStroke, n = t === void 0 ? "#222" : t, r = e.children, o = e.className, i = e.containerStyle, s = e.horizontalAnchor, a = e.resizeObserverPolyfill, u = e.showAnchorLine, l = u === void 0 ? !0 : u, f = e.verticalAnchor, c = e.x, d = e.y, p = gd({
    polyfill: a
  }), g = p[0], h = p[1], m = h.width, b = h.height, A = w.useContext(lo), D = A.x, E = D === void 0 ? 0 : D, y = A.y, _ = y === void 0 ? 0 : y, N = A.dx, I = N === void 0 ? 0 : N, M = A.dy, O = M === void 0 ? 0 : M, L = s || (Math.abs(I) < Math.abs(O) ? "middle" : I > 0 ? "start" : "end"), P = f || (Math.abs(I) > Math.abs(O) ? "middle" : O > 0 ? "start" : "end"), T = w.useMemo(function() {
    var j = c ?? E + I, H = d ?? _ + O;
    return L === "middle" && (j -= m / 2), L === "end" && (j -= m), P === "middle" && (H -= b / 2), P === "end" && (H -= b), {
      x: j,
      y: H
    };
  }, [c, E, I, d, _, O, L, P, m, b]);
  return /* @__PURE__ */ F.createElement(Gr, {
    ...
    ref: g,
    style: i ? yi({}, aa, i) : aa
  }, r)), l && /* @__PURE__ */ F.createElement(cl, {
    anchorLineOrientation: Math.abs(I) > Math.abs(O) ? "vertical" : "horizontal",
    anchorLineStroke: n,
    verticalAnchor: P,
    horizontalAnchor: L,
    width: m,
...
function bh(e) {
  var t = e.className, n = e.x, r = e.y, o = e.stroke, i = o === void 0 ? "#222" : o, s = e.radius, a = s === void 0 ? 16 : s, u = vh(e, yh), l = w.useContext(lo);
  return /* @__PURE__ */ F.createElement("circle", vi({
...
function dl(e) {
  ...
  return /* @__PURE__ */ F.createElement(lo.Provider, {
    value: s
  }, i);
}
dl.propTypes = {
...
var ca = Mh, Ut = w, dn = Ch, da = Ah, Ih = es(Xi), fa = es(Ki), Ph = es(Zi);
function es(e) {
  return e && e.__esModule ? e : { default: e };
}
function Dt() {
...
function Mh(e) {
  var t = e === void 0 ? {} : e, n = t.resetOnStart, r = n === void 0 ? !1 : n, o = t.snapToPointer, i = o === void 0 ? !0 : o, s = t.onDragEnd, a = t.onDragMove, u = t.onDragStart, l = t.x, f = t.y, c = t.dx, d = t.dy, p = t.isDragging, g = t.restrict, h = g === void 0 ? {} : g, m = t.restrictToPath, b = (0, Ut.useRef)({
    x: l,
    y: f,
    dx: c,
    dy: d
    ...
    dy: d ?? 0,
    isDragging: !1
  }), D = A[0], E = A[1], y = (0, Ut.useState)(new dn.Point({
    x: 0,
    y: 0
  })), _ = y[0], N = y[1];
  (0, Ut.useEffect)(function() {
    ...
    p !== void 0 && D.isDragging !== p && E(function(P) {
      return Dt({}, P, {
        isDragging: p
      });
    });
  }, [D.isDragging, p, E]);
  var I = (0, Ph.default)(m), M = (0, Ut.useCallback)(function(P) {
    P.persist(), E(function(T) {
      var j = T.x, H = j === void 0 ? 0 : j, J = T.y, Q = J === void 0 ? 0 : J, X = T.dx, se = T.dy, Y = new dn.Point({
        x: (H || 0) + X,
        y: (Q || 0) + se
      }), ce = (0, da.localPoint)(P) || new dn.Point({
        x: 0,
        y: 0
      }), Z = i ? ce : Y, ge = (0, fa.default)(Z, I, h);
  ...
  }, [u, r, h, I, E, i]), O = (0, Ut.useCallback)(function(P) {
    P.persist(), E(function(T) {
      if (!T.isDragging)
        return T;
      var j = T.x, H = j === void 0 ? 0 : j, J = T.y, Q = J === void 0 ? 0 : J, X = (0, da.localPoint)(P) || new dn.Point({
        x: 0,
        y: 0
      }), se = i ? X : (0, dn.sumPoints)(X, _), Y = (0, fa.default)(se, I, h);
      return Dt({}, T, {
        dx: Y.x - H,
        dy: Y.y - Q
      });
  ...
  }, [E, a, i, _, I, h]), L = (0, Ut.useCallback)(function(P) {
    P.persist(), E(function(T) {
      return Dt({}, T, {
        isDragging: !1
      });
...
function Lh(e) {
  var t = e.canEditLabel, n = t === void 0 ? !0 : t, r = e.canEditSubject, o = r === void 0 ? !0 : r, i = e.children, s = e.dx, a = s === void 0 ? 0 : s, u = e.dy, l = u === void 0 ? 0 : u, f = e.height, c = e.labelDragHandleProps, d = e.onDragEnd, p = e.onDragMove, g = e.onDragStart, h = e.subjectDragHandleProps, m = e.width, b = e.x, A = b === void 0 ? 0 : b, D = e.y, E = D === void 0 ? 0 : D, y = w.useRef(), _ = w.useRef(), N = w.useCallback(function(P) {
    var T = P.event;
    if (g) {
      var j, H, J, Q, X, se, Y, ce;
      g({
        event: T,
        x: A + ((j = (H = y.current) == null ? void 0 : H.dx) != null ? j : 0),
        y: E + ((J = (Q = y.current) == null ? void 0 : Q.dy) != null ? J : 0),
        dx: a + ((X = (se = _.current) == null ? void 0 : se.dx) != null ? X : 0),
        dy: l + ((Y = (ce = _.current) == null ? void 0 : ce.dy) != null ? Y : 0)
      });
    }
  }, [a, l, g, A, E]), I = w.useCallback(function(P) {
    var T = P.event;
    if (p) {
      var j, H, J, Q, X, se, Y, ce;
      p({
  ...
  }, [a, l, p, A, E]), M = w.useCallback(function(P) {
    var T = P.event;
    if (d) {
      var j, H, J, Q, X, se, Y, ce;
      d({
  ...
  return y.current = O, _.current = L, /* @__PURE__ */ F.createElement(F.Fragment, null, /* @__PURE__ */ F.createElement(dl, {
    x: A + O.dx,
    y: E + O.dy,
    dx: a + L.dx,
    dy: l + L.dy
    ...
    onMouseUp: O.dragEnd,
    fill: "transparent"
  }), o && /* @__PURE__ */ F.createElement("circle", qr({
    cx: A,
    cy: E,
  ...
  }, pa, h)), L.isDragging && /* @__PURE__ */ F.createElement("rect", {
    width: m,
    height: f,
    onMouseMove: L.dragMove,
    onMouseUp: L.dragEnd,
    fill: "transparent"
  }), n && /* @__PURE__ */ F.createElement("circle", qr({
    cx: A + O.dx + a,
    cy: E + O.dy + l,
...
function pl(e) {
  ...
  return /* @__PURE__ */ F.createElement("defs", null, /* @__PURE__ */ F.createElement("marker", bi({
    id: t,
    markerWidth: r,
    markerHeight: i,
    markerUnits: a
...
function jC(e) {
  ...
  return /* @__PURE__ */ F.createElement(pl, Ci({
    id: t,
    markerWidth: a,
    markerHeight: a,
    refX: u,
...
const St = 1, Gh = 1, zh = 576, GC = ({
  ...
  let [g] = r;
  const h = g <= zh, m = Number(g) - o - St * 2 - Gh * 2, b = `${i}-${Date.now()}`, A = t == null ? void 0 : t.length, D = (e || []).reduce((P, T) => P.length > String(T).length ? P : T, ""), E = 20;
  let y = 50;
  const _ = km(D, "normal 14px sans-serif"), N = Number(u) || 0, I = N * (Math.PI / 180), M = y + Number(_) * Math.sin(I), O = t.map((P, T) => {
    const j = T / (t.length - 1) * 100;
    return /* @__PURE__ */ React.createElement("stop", { key: T, offset: `${j}%`, style: { stopColor: P, stopOpacity: 1 } });
  }), L = e.map((P, T) => {
    const j = m / A, H = T * j + j + St, J = N ? "end" : "middle", Q = N ? "middle" : "start", X = T === e.length - 1;
    return /* @__PURE__ */ React.createElement(Gr, { top: St }, !X && !p && /* @__PURE__ */ React.createElement("line", { x1: H, x2: H, y1: 30, y2: E, stroke: "black" }), /* @__PURE__ */ React.createElement(
      qc,
      {
        angle: -u,
        x: H,
  ...
  if (!(a === "map" && l === "side" || !l) && !(a === "chart" && (l === "left" || l === "right" || !l)) && f === "gradient")
    return /* @__PURE__ */ React.createElement("svg", { className: "w-100 overflow-visible", height: M }, /* @__PURE__ */ React.createElement("rect", { x: 0, y: 0, width: m + St * 2, height: E + St * 2, fill: "#d3d3d3" }), /* @__PURE__ */ React.createElement("linearGradient", { id: `gradient-smooth-${b}`, x1: "0%", y1: "0%", x2: "100%", y2: "0%" }, O), c === "smooth" && /* @__PURE__ */ React.createElement(
      "rect",
      {
        x: St,
        y: St,
    ...
    ), c === "linear blocks" && t.map((P, T) => {
      const j = m / A, H = T * j + St;
      return /* @__PURE__ */ React.createElement(Gr, null, /* @__PURE__ */ React.createElement(
        "rect",
        {
          key: T,
          x: H,
    ...
    }), /* @__PURE__ */ React.createElement("g", null, L));
};
var ml = {
  color: void 0,
  size: void 0,
  ...
  style: void 0,
  attr: void 0
}, ma = F.createContext && F.createContext(ml), Mt = globalThis && globalThis.__assign || function() {
...
function hl(e) {
  return e && e.map(function(t, n) {
    return F.createElement(t.tag, Mt({
      key: n
    }, t.attr), hl(t.child));
  });
}
...
function Wh(e) {
  var t = function(n) {
    ...
    return n.className && (u = n.className), e.className && (u = (u ? u + " " : "") + e.className), F.createElement("svg", Mt({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, n.attr, r, s, {
  ...
  return ma !== void 0 ? F.createElement(ma.Consumer, null, function(n) {
    return t(n);
  }) : t(ml);
}
function er(e) {
...
function gl(e, t, n) {
  ...
  function d(h) {
    ...
    for (var m = s = a, b = 0; b < m.length; b++) {
      var A = m[b];
      A();
    }
    return h;
    ...
    return h = {
      ...
      subscribe: function(A) {
        if (typeof A != "object" || A === null)
          throw new Error(process.env.NODE_ENV === "production" ? tt(11) : "Expected the observer to be an object. Instead, received: '" + Jt(A) + "'");
        function D() {
          A.next && A.next(f());
        }
        D();
...
function ng() {
  return Ca || (Ca = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function n(D) {
      {
        for (var E = arguments.length, y = new Array(E > 1 ? E - 1 : 0), _ = 1; _ < E; _++)
          y[_ - 1] = arguments[_];
        r("error", D, y);
      }
    }
    function r(D, E, y) {
      {
        ...
        N !== "" && (E += "%s", y = y.concat([N]));
        var I = y.map(function(M) {
          return String(M);
        });
        I.unshift("Warning: " + E), Function.prototype.apply.call(console[D], console, I);
      }
    }
    function o(D, E) {
    ...
    function d(D, E, y) {
      ...
      if (!c) {
        var N = E();
        i(_, N) || (n("The result of getSnapshot should be cached to avoid an infinite loop"), c = !0);
      }
      var I = s({
        inst: {
          value: _,
      ...
      return u(function() {
        M.value = _, M.getSnapshot = E, p(M) && O({
          inst: M
        });
      }, [D, _, E]), a(function() {
        p(M) && O({
    ...
    var h = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", m = !h, b = m ? g : d, A = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : b;
    Oo.useSyncExternalStore = A, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
  }()), Oo;
}
...
function rg() {
  ...
  return To.useSyncExternalStoreWithSelector = function(l, f, c, d, p) {
    ...
    g = a(function() {
      function b(_) {
        if (!A) {
          if (A = !0, D = _, _ = d(_), p !== void 0 && h.hasValue) {
            var N = h.value;
            if (p(N, _))
              return E = N;
          }
        ...
        if (N = E, r(D, _))
          return N;
        var I = d(_);
        return p !== void 0 && p(N, I) ? N : (D = _, E = I);
      }
      var A = !1, D, E, y = c === void 0 ? null : c;
      return [function() {
        return b(f());
      ...
      var b = a(function() {
        var y = !1, _, N, I = function(P) {
          ...
          if (r(H, P))
            return J;
          var Q = p(P);
          return g !== void 0 && g(J, Q) ? J : (_ = P, N = Q, Q);
...
function cg() {
  ...
  return fe.AsyncMode = u, fe.ConcurrentMode = l, fe.ContextConsumer = a, fe.ContextProvider = s, fe.Element = t, fe.ForwardRef = f, fe.Fragment = r, fe.Lazy = g, fe.Memo = p, fe.Portal = n, fe.Profiler = i, fe.StrictMode = o, fe.Suspense = c, fe.isAsyncMode = function(y) {
    return E(y) || D(y) === u;
  }, fe.isConcurrentMode = E, fe.isContextConsumer = function(y) {
    return D(y) === a;
    ...
    return typeof y == "string" || typeof y == "function" || y === r || y === l || y === i || y === o || y === c || y === d || typeof y == "object" && y !== null && (y.$$typeof === g || y.$$typeof === p || y.$$typeof === s || y.$$typeof === a || y.$$typeof === f || y.$$typeof === m || y.$$typeof === b || y.$$typeof === A || y.$$typeof === h);
  }, fe.typeOf = D, fe;
}
var pe = {};
/** @license React v16.13.1
...
function dg() {
  return Na || (Na = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function D(R) {
      ...
      R === r || R === l || R === i || R === o || R === c || R === d || typeof R == "object" && R !== null && (R.$$typeof === g || R.$$typeof === p || R.$$typeof === s || R.$$typeof === a || R.$$typeof === f || R.$$typeof === m || R.$$typeof === b || R.$$typeof === A || R.$$typeof === h);
    }
    function E(R) {
    ...
    var y = u, _ = l, N = a, I = s, M = t, O = f, L = r, P = g, T = p, j = n, H = i, J = o, Q = c, X = !1;
    function se(R) {
      return X || (X = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), Y(R) || E(R) === u;
    }
    function Y(R) {
      return E(R) === l;
    }
    ...
    pe.AsyncMode = y, pe.ConcurrentMode = _, pe.ContextConsumer = N, pe.ContextProvider = I, pe.Element = M, pe.ForwardRef = O, pe.Fragment = L, pe.Lazy = P, pe.Memo = T, pe.Portal = j, pe.Profiler = H, pe.StrictMode = J, pe.Suspense = Q, pe.isAsyncMode = se, pe.isConcurrentMode = Y, pe.isContextConsumer = ce, pe.isContextProvider = Z, pe.isElement = ge, pe.isForwardRef = V, pe.isFragment = te, pe.isLazy = be, pe.isMemo = je, pe.isPortal = le, pe.isProfiler = de, pe.isStrictMode = Ae, pe.isSuspense = we, pe.isValidElementType = D, pe.typeOf = E;
  }()), pe;
}
...
function Cg() {
  return Ia || (Ia = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), a = Symbol.for("react.server_context"), u = Symbol.for("react.forward_ref"), l = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), c = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), p = Symbol.for("react.offscreen"), g = !1, h = !1, m = !1, b = !1, A = !1, D;
    D = Symbol.for("react.module.reference");
    function E($) {
      return !!(typeof $ == "string" || typeof $ == "function" || $ === n || $ === o || A || $ === r || $ === l || $ === f || b || $ === p || g || h || m || typeof $ == "object" && $ !== null && ($.$$typeof === d || $.$$typeof === c || $.$$typeof === i || $.$$typeof === s || $.$$typeof === u || // This needs to include all possible module reference object
    ...
    var _ = s, N = i, I = e, M = u, O = n, L = d, P = c, T = t, j = o, H = r, J = l, Q = f, X = !1, se = !1;
    function Y($) {
    ...
    he.ContextConsumer = _, he.ContextProvider = N, he.Element = I, he.ForwardRef = M, he.Fragment = O, he.Lazy = L, he.Memo = P, he.Portal = T, he.Profiler = j, he.StrictMode = H, he.Suspense = J, he.SuspenseList = Q, he.isAsyncMode = Y, he.isConcurrentMode = ce, he.isContextConsumer = Z, he.isContextProvider = ge, he.isElement = V, he.isForwardRef = te, he.isFragment = be, he.isLazy = je, he.isMemo = le, he.isPortal = de, he.isProfiler = Ae, he.isStrictMode = we, he.isSuspense = R, he.isSuspenseList = ae, he.isValidElementType = E, he.typeOf = y;
  }()), he;
}
...
function Ag(e, t, n) {
  Ro(e, "mapStateToProps"), Ro(t, "mapDispatchToProps"), Ro(n, "mergeProps");
}
...
function _g(e, t, n, r, {
  ...
  let a = !1, u, l, f, c, d;
  function p(A, D) {
    return u = A, l = D, f = e(u, l), c = t(r, l), d = n(f, c, l), a = !0, d;
  }
  function g() {
  ...
  function m() {
    const A = e(u, l), D = !s(A, f);
    return f = A, D && (d = n(f, c, l)), d;
  }
  function b(A, D) {
    const E = !i(D, l), y = !o(A, u, D, l);
    return u = A, l = D, E && y ? g() : E ? h() : y ? m() : d;
  }
  return function(D, E) {
    return a ? b(D, E) : p(D, E);
  };
}
function Sg(e, t) {
  let {
...
function wl(e, t) {
  ...
  function f() {
    o++, n || (n = t ? t.addNestedSub(u) : e.subscribe(u), r = Ig());
  }
  function c() {
...
const Pg = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", Yr = Pg ? w.useLayoutEffect : w.useEffect;
function ka(e, t) {
...
function Gg(e, t, n, r, o, i, s, a, u, l, f) {
  ...
  const p = () => {
    ...
    b || (d = null), m === i.current ? s.current || l() : (i.current = m, u.current = m, s.current = !0, f());
  };
...
function Sl(e, t, n, {
  ...
  areStatePropsEqual: s = Io,
  areMergedPropsEqual: a = Io,
  ...
  const f = l, c = Og(e), d = xg(t), p = Rg(n), g = !!e;
  return (m) => {
    if (process.env.NODE_ENV !== "production" && !Pa.isValidElementType(m))
      throw new Error(`You must pass a component to the function returned by connect. Instead received ${$g(m)}`);
    const b = m.displayName || m.name || "Component", A = `Connect(${b})`, D = {
    ...
    function E(N) {
      const [I, M, O] = w.useMemo(() => {
        const {
          reactReduxForwardedRef: R
        } = N, ae = Ou(N, Mg);
        return [N.context, R, ae];
      }, [N]), L = w.useMemo(() => I && I.Consumer && // @ts-ignore
      Pa.isContextConsumer(/* @__PURE__ */ w.createElement(I.Consumer, null)) ? I : f, [I, f]), P = w.useContext(L), T = !!N.store && !!N.store.getState && !!N.store.dispatch, j = !!P && !!P.store;
      ...
      const H = T ? N.store : P.store, J = j ? P.getServerState : H.getState, Q = w.useMemo(() => Sg(H.dispatch, D), [H]), [X, se] = w.useMemo(() => {
        if (!g)
          return kg;
        const R = wl(H, T ? void 0 : P.subscription), ae = R.notifyNestedSubs.bind(R);
        return [R, ae];
      }, [H, T, P]), Y = w.useMemo(() => T ? P : mn({}, P, {
        subscription: X
      }), [T, P, X]), ce = w.useRef(), Z = w.useRef(O), ge = w.useRef(), V = w.useRef(!1);
      w.useRef(!1);
      const te = w.useRef(!1), be = w.useRef();
      Yr(() => (te.current = !0, () => {
        te.current = !1;
      }), []);
      const je = w.useMemo(() => () => ge.current && O === Z.current ? ge.current : Q(H.getState(), O), [H, O]), le = w.useMemo(() => (ae) => X ? Gg(
        g,
        H,
        X,
        // @ts-ignore
...
`), R;
      ...
      const Ae = w.useMemo(() => (
        // @ts-ignore
        /* @__PURE__ */ w.createElement(m, mn({}, de, {
          ref: M
        }))
      ), [M, m, de]);
    ...
    const _ = w.memo(E);
    if (_.WrappedComponent = m, _.displayName = E.displayName = A, u) {
      const I = w.forwardRef(function(O, L) {
        return /* @__PURE__ */ w.createElement(_, mn({}, O, {
          reactReduxForwardedRef: L
        }));
      });
      return I.displayName = A, I.WrappedComponent = m, Ba(I, m);
    }
    return Ba(_, m);
  };
}
...
function Fl(e, t) {
  ...
  })[0], r = w.useRef(!0), o = w.useRef(n), i = r.current || !!(t && o.current.inputs && Wg(t, o.current.inputs)), s = i ? o.current : {
    inputs: t,
    result: e()
  };
...
var ie = Fl, U = Hg, qg = process.env.NODE_ENV === "production", Po = "Invariant failed";
function Va(e, t) {
  if (!e) {
    if (qg)
      throw new Error(Po);
    var n = typeof t == "function" ? t() : t, r = n ? "".concat(Po, ": ").concat(n) : Po;
    throw new Error(r);
  }
}
var pt = function(t) {
...
const Me = {
  ...
  x: n,
  y: t
}, rr = (e, t) => Math.sqrt((t.x - e.x) ** 2 + (t.y - e.y) ** 2), Ha = (e, t) => Math.min(...t.map((n) => rr(e, n))), Rl = (e) => (t) => ({
  x: e(t.x),
  y: e(t.y)
});
var p0 = (e, t) => {
...
var Dn = ({
  ...
  e.frame || (process.env.NODE_ENV, v(!1));
...
const Il = Pe((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), Pl = Pe((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), co = Pe((e) => Object.values(e)), E0 = Pe((e) => Object.values(e));
var sn = Pe((e, t) => E0(t).filter((r) => e === r.descriptor.droppableId).sort((r, o) => r.descriptor.index - o.descriptor.index));
function ls(e) {
...
var po = Pe((e, t) => t.filter((n) => n.descriptor.id !== e.descriptor.id)), y0 = ({
  isMovingForward: e,
  draggable: t,
  destination: n,
  insideDestination: r,
  ...
  f === -1 && (process.env.NODE_ENV !== "production" ? v(!1, "Could not find displaced item in set") : v(!1));
  const c = f - 1;
  if (c < 0)
    return null;
  const d = l[c];
...
var B0 = ({
  ...
  const l = s.at;
  if (l || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot move in direction without previous impact location") : v(!1)), l.type === "REORDER") {
    const c = R0({
      isMovingForward: e,
      isInHomeList: t,
  ...
  const r = fo(t);
  r || (process.env.NODE_ENV, v(!1));
  const o = r.draggableId, i = n[o].page.borderBox.center, s = P0({
...
const Ye = (e) => {
  ...
  return t || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot get clipped area from droppable") : v(!1)), t;
};
var W0 = ({
  isMovingForward: e,
...
const Y0 = (e, t, n) => {
  ...
  const r = e.frame;
  An(t, e) && (process.env.NODE_ENV !== "production" ? v(!1, "Should not add placeholder space to home list") : v(!1)), e.subject.withPlaceholder && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot add placeholder size to a subject when it already has one") : v(!1));
  ...
  t || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot remove placeholder form subject when there was none") : v(!1));
  const n = e.frame;
  if (!n) {
    const s = Dn({
      page: e.subject.page,
  ...
  r || (process.env.NODE_ENV !== "production" ? v(!1, "Expected droppable with frame to have old max frame scroll when removing placeholder") : v(!1));
  const o = zl(n, r), i = Dn({
    page: e.subject.page,
    axis: e.axis,
    frame: o,
...
var iD = ({
  ...
  const a = n.axis, u = pr(n.axis, t.displaceBy), l = u.value, f = e[a.start], c = e[a.end], p = po(t, r).find((h) => {
    const m = h.descriptor.id, b = h.page.borderBox.center[a.line], A = $t(m, s), D = ql({
      displaced: o,
      id: m
    });
    return A ? D ? c <= b : f < b - l : D ? c <= b + l : f < b;
  }) || null, g = oD({
    draggable: t,
    closest: p,
    inHomeList: An(t, n)
...
var aD = ({
  ...
  const s = r.axis, a = pr(r.axis, e.displaceBy), u = a.value, l = t[s.start], f = t[s.end], d = po(e, o).find((g) => {
    const h = g.descriptor.id, m = g.page.borderBox, A = m[s.size] / sD, D = $t(h, i), E = ql({
      displaced: n.displaced,
      id: h
    });
    return D ? E ? f > m[s.start] + A && f < m[s.end] - A : l > m[s.start] - u + A && l < m[s.end] - u - A : E ? f > m[s.start] + u + A && f < m[s.end] + u - A : l > m[s.start] + A && l < m[s.end] - A;
  });
  return d ? {
    displacedBy: a,
    displaced: n.displaced,
...
var Xl = ({
  ...
  e.movementMode !== "SNAP" && (process.env.NODE_ENV, v(!1));
  const r = e.impact, o = n || e.viewport, i = t || e.dimensions, {
    draggables: s,
    droppables: a
  } = i, u = s[e.critical.draggable.id], l = rt(r);
  l || (process.env.NODE_ENV !== "production" ? v(!1, "Must be over a destination in SNAP movement mode") : v(!1));
  const f = a[l], c = Xl({
    impact: r,
    viewport: o,
    destination: f,
  ...
  s === -1 && (process.env.NODE_ENV !== "production" ? v(!1, "Expected draggable to be inside home list") : v(!1));
...
var pD = ({
  ...
  const t = e.frame;
  return t || (process.env.NODE_ENV !== "production" ? v(!1, "Expected Droppable to have a frame") : v(!1)), t;
}, hD = ({
  additions: e,
  updatedDroppables: t,
  viewport: n
  ...
  const n = t.modified.map((b) => {
    const A = e.dimensions.droppables[b.droppableId];
    return us(A, b.scroll);
  }), r = {
...
var DD = (e = Za, t) => {
  ...
  if (t.type === "INITIAL_PUBLISH") {
    e.phase !== "IDLE" && (process.env.NODE_ENV !== "production" ? v(!1, "INITIAL_PUBLISH must come after a IDLE phase") : v(!1));
    const {
      critical: n,
      clientSelection: r,
      viewport: o,
  ...
  if (t.type === "COLLECTION_STARTING")
    return e.phase === "COLLECTING" || e.phase === "DROP_PENDING" ? e : (e.phase !== "DRAGGING" && (process.env.NODE_ENV !== "production" ? v(!1, `Collection cannot start from phase ${e.phase}`) : v(!1)), {
      ...e,
      phase: "COLLECTING"
    });
  if (t.type === "PUBLISH_WHILE_DRAGGING")
    return e.phase === "COLLECTING" || e.phase === "DROP_PENDING" || (process.env.NODE_ENV !== "production" ? v(!1, `Unexpected ${t.type} received in phase ${e.phase}`) : v(!1)), gD({
      state: e,
      published: t.payload
    });
  if (t.type === "MOVE") {
    if (e.phase === "DROP_PENDING")
      return e;
    Qt(e) || (process.env.NODE_ENV !== "production" ? v(!1, `${t.type} not permitted in phase ${e.phase}`) : v(!1));
    const {
      client: n
    } = t.payload;
  ...
  if (t.type === "UPDATE_DROPPABLE_IS_ENABLED") {
    if (e.phase === "DROP_PENDING")
      return e;
    Qt(e) || (process.env.NODE_ENV !== "production" ? v(!1, `Attempting to move in an unsupported phase ${e.phase}`) : v(!1));
    const {
      id: n,
      isEnabled: r
    } = t.payload, o = e.dimensions.droppables[n];
    o || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot find Droppable[id: ${n}] to toggle its enabled state`) : v(!1)), o.isEnabled === r && (process.env.NODE_ENV !== "production" ? v(!1, `Trying to set droppable isEnabled to ${String(r)}
      but it is already ${String(o.isEnabled)}`) : v(!1));
    const i = {
      ...o,
      isEnabled: r
    };
  ...
  if (t.type === "UPDATE_DROPPABLE_IS_COMBINE_ENABLED") {
    ...
    o || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot find Droppable[id: ${n}] to toggle its isCombineEnabled state`) : v(!1)), o.isCombineEnabled === r && (process.env.NODE_ENV !== "production" ? v(!1, `Trying to set droppable isCombineEnabled to ${String(r)}
      but it is already ${String(o.isCombineEnabled)}`) : v(!1));
    const i = {
      ...o,
      isCombineEnabled: r
    };
  ...
  if (t.type === "MOVE_BY_WINDOW_SCROLL") {
    if (e.phase === "DROP_PENDING" || e.phase === "DROP_ANIMATING")
      return e;
    Qt(e) || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot move by window in phase ${e.phase}`) : v(!1)), e.isWindowScrollAllowed || (process.env.NODE_ENV !== "production" ? v(!1, "Window scrolling is currently not supported for fixed lists") : v(!1));
  ...
  if (t.type === "MOVE_UP" || t.type === "MOVE_DOWN" || t.type === "MOVE_LEFT" || t.type === "MOVE_RIGHT") {
    if (e.phase === "COLLECTING" || e.phase === "DROP_PENDING")
      return e;
    e.phase !== "DRAGGING" && (process.env.NODE_ENV !== "production" ? v(!1, `${t.type} received while not in DRAGGING phase`) : v(!1));
    const n = Z0({
      state: e,
      type: t.type
    });
  ...
  if (t.type === "DROP_PENDING") {
    ...
    return e.phase !== "COLLECTING" && (process.env.NODE_ENV !== "production" ? v(!1, "Can only move into the DROP_PENDING phase from the COLLECTING phase") : v(!1)), {
      ...e,
      phase: "DROP_PENDING",
      isWaiting: !0,
      reason: n
  ...
  if (t.type === "DROP_ANIMATE") {
    ...
    return e.phase === "DRAGGING" || e.phase === "DROP_PENDING" || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot animate drop from phase ${e.phase}`) : v(!1)), {
...
var MD = (e) => ({
  ...
  })), t().phase !== "IDLE" && (process.env.NODE_ENV !== "production" ? v(!1, "Unexpected phase to start a drag") : v(!1)), n(hs()), n(ED({
    draggableId: i,
    movementMode: a
  }));
  const f = {
...
const zD = ({
  ...
  if (o.phase === "IDLE")
    return;
  o.phase === "DROP_PENDING" && o.isWaiting && (process.env.NODE_ENV !== "production" ? v(!1, "A DROP action occurred while DROP_PENDING and still waiting") : v(!1)), o.phase === "DRAGGING" || o.phase === "DROP_PENDING" || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot drop in phase: ${o.phase}`) : v(!1));
...
function HD({
  ...
  function s() {
    i() && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot start scroll listener when already active") : v(!1)), o = lt(window, [r]);
  }
  function a() {
    i() || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot stop scroll listener when not active") : v(!1)), n.cancel(), o(), o = Lt;
  }
  return {
    start: s,
    stop: a,
...
var XD = YD, KD = (e) => {
  ...
  const e = [], t = (o) => {
    ...
    i === -1 && (process.env.NODE_ENV !== "production" ? v(!1, "Could not find timer") : v(!1));
...
var tE = (e, t) => {
  ...
  let r = null;
  const o = (c, d) => {
    r && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot fire onBeforeCapture as a drag start has already been published") : v(!1)), kn("onBeforeCapture", () => {
    ...
    r && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot fire onBeforeDragStart as a drag start has already been published") : v(!1)), kn("onBeforeDragStart", () => {
      const p = e().onBeforeDragStart;
      p && p(Nr(c, d));
    });
  }, s = (c, d) => {
    r && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot fire onBeforeDragStart as a drag start has already been published") : v(!1));
    const p = Nr(c, d);
    r = {
      mode: d,
      lastCritical: c,
    ...
    const p = ls(d), g = fo(d);
    r || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot fire onDragMove when onDragStart has not been called") : v(!1));
    const h = !eE(c, r.lastCritical);
    h && (r.lastCritical = c);
    const m = !QD(r.lastLocation, p);
    m && (r.lastLocation = p);
    const b = !ZD(r.lastCombine, g);
    if (b && (r.lastCombine = g), !h && !m && !b)
      return;
    const A = {
      ...Nr(c, r.mode),
      combine: g,
    ...
    n.add(() => {
      kn("onDragUpdate", () => $o(e().onDragUpdate, A, t, $r.onDragUpdate));
    });
  }, u = () => {
    r || (process.env.NODE_ENV !== "production" ? v(!1, "Can only flush responders while dragging") : v(!1)), n.flush();
  }, l = (c) => {
    r || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot fire onDragEnd when there is no matching onDragStart") : v(!1)), r = null, kn("onDragEnd", () => $o(e().onDragEnd, c, t, $r.onDragEnd));
  };
  return {
    beforeCapture: o,
    beforeStart: i,
...
const rE = (e) => (t) => (n) => {
  ...
  const r = e.getState();
  r.phase !== "DROP_ANIMATING" && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot finish a drop animating when no drop is occurring") : v(!1)), e.dispatch(gs({
...
var cE = (e) => (t) => (n) => (r) => {
  ...
  if (r.type === "INITIAL_PUBLISH") {
    n(r);
    const o = t.getState();
    o.phase !== "DRAGGING" && (process.env.NODE_ENV !== "production" ? v(!1, "Expected phase to be DRAGGING after INITIAL_PUBLISH") : v(!1)), e.start(o);
    return;
  }
...
var ic = ({
  ...
  return e || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot find document.documentElement") : v(!1)), e;
}, ac = () => {
  const e = sc();
  return ic({
...
var EE = (e, t) => {
  ...
  const r = hE({
    ...
    e.droppable.exists(d) || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot update is enabled flag of Droppable ${d} as it is not registered`) : v(!1)), n && t.updateDroppableIsEnabled({
      id: d,
      isEnabled: p
    });
  }, i = (d, p) => {
    n && (e.droppable.exists(d) || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot update isCombineEnabled flag of Droppable ${d} as it is not registered`) : v(!1)), t.updateDroppableIsCombineEnabled({
      id: d,
      isCombineEnabled: p
    }));
  }, s = (d, p) => {
    n && (e.droppable.exists(d) || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot update the scroll on Droppable ${d} as it is not registered`) : v(!1)), t.updateDroppableScroll({
      id: d,
      newScroll: p
    }));
  }, a = (d, p) => {
    ...
    n || (process.env.NODE_ENV !== "production" ? v(!1, "Should only be subscribed when a collection is occurring") : v(!1));
  ...
  return {
    ...
    startPublishing: (d) => {
      n && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot start capturing critical dimensions as there is already a collection") : v(!1));
...
const vE = Pe((e) => co(e).filter((t) => !(!t.isEnabled || !t.frame))), bE = (e, t) => vE(t).find((r) => (r.frame || (process.env.NODE_ENV !== "production" ? v(!1, "Invalid result") : v(!1)), Wl(r.frame.pageMarginBox)(e))) || null;
var CE = ({
  center: e,
  destination: t,
  droppables: n
...
const NE = Rl((e) => e === 0 ? 0 : e > 0 ? 1 : -1), ys = (() => {
...
var TE = ({
  ...
  let i = null;
  const s = (l) => {
    i || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot fluid scroll if not dragging") : v(!1));
    const {
  ...
  return {
    start: (l) => {
      mr(), i && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot start auto scrolling when already started") : v(!1));
      const f = Date.now();
      let c = !1;
      const d = () => {
        c = !0;
  ...
  return (a) => {
    ...
    if (!u)
      return;
    const l = rt(a.impact);
    l || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot perform a jump scroll when there is no destination") : v(!1));
...
const VE = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u" ? w.useLayoutEffect : w.useEffect;
var ot = VE;
const jo = () => {
  const e = document.querySelector("head");
  return e || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot find the head to append a style to") : v(!1)), e;
}, au = (e) => {
  const t = document.createElement("style");
  return e && t.setAttribute("nonce", e), t.type = "text/css", t;
};
function jE(e, t) {
  const n = ie(() => $E(e), [e]), r = w.useRef(null), o = w.useRef(null), i = U(Pe((c) => {
    const d = o.current;
    d || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot set dynamic style element if it is not set") : v(!1)), d.textContent = c;
  }), []), s = U((c) => {
    const d = r.current;
    d || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot set dynamic style element if it is not set") : v(!1)), d.textContent = c;
  }, []);
  ot(() => {
    !r.current && !o.current || (process.env.NODE_ENV !== "production" ? v(!1, "style elements already mounted") : v(!1));
    const c = au(t), d = au(t);
    return r.current = c, o.current = d, c.setAttribute(`${En}-always`, e), d.setAttribute(`${En}-dynamic`, e), jo().appendChild(c), jo().appendChild(d), s(n.always), i(n.resting), () => {
      const p = (g) => {
        const h = g.current;
        h || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot unmount ref as it is not set") : v(!1)), jo().removeChild(h), g.current = null;
      };
      p(r), p(o);
    };
...
function GE(e) {
  const t = w.useRef({}), n = w.useRef(null), r = w.useRef(null), o = w.useRef(!1), i = U(function(d, p) {
    const g = {
      id: d,
      focus: p
    };
...
function zE() {
  ...
  function i(c) {
    const d = o(c);
    return d || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot find draggable entry with id [${c}]`) : v(!1)), d;
  }
  const s = {
    register: (c) => {
  ...
  function u(c) {
    const d = a(c);
    return d || (process.env.NODE_ENV !== "production" ? v(!1, `Cannot find droppable entry with id [${c}]`) : v(!1)), d;
  }
  const l = {
    register: (c) => {
...
var Cs = F.createContext(null), ur = () => {
  const e = document.body;
  return e || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot find document.body") : v(!1)), e;
};
const WE = {
  position: "absolute",
  width: "1px",
...
function YE(e) {
  const t = ie(() => qE(e), [e]), n = w.useRef(null);
  return w.useEffect(function() {
...
var ho = F.createContext(null), ey = {
  react: "^16.8.5 || ^17.0.0 || ^18.0.0",
  "react-dom": "^16.8.5 || ^17.0.0 || ^18.0.0"
};
const ty = /(\d+)\.(\d+)\.(\d+)/, uu = (e) => {
  const t = ty.exec(e);
  t == null && (process.env.NODE_ENV !== "production" ? v(!1, `Unable to parse React version ${e}`) : v(!1));
...
function iy() {
  Dr(() => {
    ry(ey.react, F.version), oy(document);
  }, []);
}
function _s(e) {
  const t = w.useRef(e);
...
function sy() {
  ...
  function r(s) {
    e && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot claim lock as it is already claimed") : v(!1));
    const a = {
      abandon: s
    };
    return e = a, a;
  ...
  function o() {
    e || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot release lock when there is no lock") : v(!1)), e = null;
  }
  function i() {
    e && (e.abandon(), o());
  }
...
function vy({
  ...
  return [{
    ...
    fn: (o) => {
      ...
      l.type !== "PENDING" && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot be IDLE") : v(!1));
      const f = l.point;
      if (!yy(f, u))
        return;
      o.preventDefault();
    ...
    fn: (o) => {
      const i = n();
      if (i.type === "IDLE" && (process.env.NODE_ENV !== "production" ? v(!1, "Unexpected phase") : v(!1)), i.actions.shouldRespectForcePress()) {
        e();
        return;
      }
      o.preventDefault();
...
function by(e) {
  const t = w.useRef(cu), n = w.useRef(Lt), r = ie(() => ({
    eventName: "mousedown",
    fn: function(c) {
    ...
    t.current.type !== "IDLE" && (process.env.NODE_ENV !== "production" ? v(!1, "Expected to move from IDLE to PENDING drag") : v(!1)), t.current = {
      type: "PENDING",
      point: d,
      actions: c
    }, u();
...
function _y(e) {
  const t = w.useRef(Cy), n = ie(() => ({
    ...
    fn: function(i) {
      ...
      t.current();
      function f() {
        u || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot stop capturing a keyboard drag when not capturing") : v(!1)), u = !1, t.current(), r();
      }
...
function xy({
  ...
  return [{
    ...
    fn: (r) => {
      const o = n();
      o.type === "IDLE" && (process.env.NODE_ENV, v(!1));
      const i = r.touches[0];
      if (!i || !(i.force >= Fy))
        return;
...
function Oy(e) {
  const t = w.useRef(zo), n = w.useRef(Lt), r = U(function() {
    return t.current;
  }, []), o = U(function(p) {
    t.current = p;
  }, []), i = ie(() => ({
    ...
    const p = r();
    p.type !== "PENDING" && (process.env.NODE_ENV !== "production" ? v(!1, `Cannot start dragging from phase ${p.type}`) : v(!1));
    ...
    r().type !== "IDLE" && (process.env.NODE_ENV !== "production" ? v(!1, "Expected to move from IDLE to PENDING drag") : v(!1));
...
var Iy = (e) => pt(e.getBoundingClientRect()).center;
function Py(e) {
...
function zy({
  ...
  if (s && !u.options.canDragInteractiveElements && Ry(l, s))
    return null;
  ...
  function m(y) {
    ...
    c !== "PRE_DRAG" && (_(), process.env.NODE_ENV !== "production" ? v(!1, `Cannot lift in phase ${c}`) : v(!1)), n.dispatch(yD(y.liftActionArgs)), c = "DRAGGING";
    function N(I, M = {
      shouldBlockNextClick: !1
    }) {
      if (y.cleanup(), M.shouldBlockNextClick) {
        const O = lt(window, [{
          eventName: "click",
          fn: Gy,
          options: {
...
function Wy({
  ...
  const i = [...o ? Uy : [], ...r || []], s = w.useState(() => sy())[0], a = U(function(m, b) {
    lr(m) && !lr(b) && s.tryAbandon();
  }, [s]);
  ot(function() {
    let m = t.getState();
    return t.subscribe(() => {
...
const Hy = (e) => ({
  onBeforeCapture: (t) => {
    ...
    F.version.startsWith("16") || F.version.startsWith("17") ? n() : Vi.flushSync(n);
  },
...
function Vn(e) {
  return e.current || (process.env.NODE_ENV !== "production" ? v(!1, "Could not find store from lazy ref") : v(!1)), e.current;
}
function Yy(e) {
  const {
    contextId: t,
  ...
  }, p), [p]), h = UE(), m = ie(() => EE(h, g), [h, g]), b = ie(() => PE({
    scrollWindow: yE,
  ...
  }), [m.scrollDroppable, p, l]), A = GE(t), D = ie(() => mE({
    announce: f,
    autoScroller: b,
    dimensionMarshal: m,
    focusMarshal: A,
  ...
  n(_);
  const N = U((O) => uc(Vn(s).getState(), O), []), I = U(() => Qt(Vn(s).getState()), []), M = ie(() => ({
    marshal: m,
    focus: A,
    contextId: t,
    canLift: N,
  ...
  }), w.useEffect(() => E, [E]), F.createElement(ho.Provider, {
    value: M
  }, F.createElement(Ug, {
    context: Cs,
    store: D
...
var Qy = "useId" in F ? Jy : Ky;
function Zy(e) {
  const t = Qy(), n = e.dragHandleUsageInstructions || $r.dragHandleUsageInstructions;
  return F.createElement(a0, null, (r) => F.createElement(Yy, {
    nonce: e.nonce,
    contextId: t,
    setCallbacks: r,
...
function av(e) {
  const t = As("draggable"), {
    ...
    const g = o();
    return g || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot get dimension when no ref is set") : v(!1)), sv(n, g, p);
  }, [n, o]), f = ie(() => ({
    uniqueId: t,
    descriptor: n,
    options: u,
    getDimension: l
  }), [n, l, u, t]), c = w.useRef(f), d = w.useRef(!0);
...
var Fs = F.createContext(null);
function Cc(e) {
  e && gr(e) || (process.env.NODE_ENV !== "production" ? v(!1, `
...
function uv(e, t, n) {
  Dr(() => {
    ...
    o || (process.env.NODE_ENV !== "production" ? v(!1, "Draggable requires a draggableId") : v(!1)), typeof o != "string" && (process.env.NODE_ENV !== "production" ? v(!1, `Draggable requires a [string] draggableId.
      Provided: [type: ${typeof o}] (value: ${o})`) : v(!1)), Number.isInteger(e.index) || (process.env.NODE_ENV !== "production" ? v(!1, `${r(o)} requires an integer index prop`) : v(!1)), e.mapped.type !== "DRAGGING" && (Cc(n()), e.isEnabled && (mc(t, o) || (process.env.NODE_ENV !== "production" ? v(!1, `${r(o)} Unable to find drag handle`) : v(!1))));
  });
}
function lv(e) {
  ws(() => {
...
function Zr(e) {
  ...
  return t || (process.env.NODE_ENV !== "production" ? v(!1, "Could not find required context") : v(!1)), t;
}
function cv(e) {
  e.preventDefault();
}
const dv = (e) => {
  ...
  const A = ie(() => d ? {
    ...
    m.type === "DRAGGING" && m.dropping && _.propertyName === "transform" && (F.version.startsWith("16") || F.version.startsWith("17") ? b() : Vi.flushSync(b));
  }, [b, m]), E = ie(() => {
    const _ = iv(m), N = m.type === "DRAGGING" && m.dropping ? D : void 0;
    return {
      innerRef: n,
      draggableProps: {
  ...
  return F.createElement(F.Fragment, null, f(E, m.snapshot, y));
};
...
function hv() {
  ...
  })), n = Pe((o, i, s, a, u = null, l = null, f = null) => ({
    mapped: {
      type: "DRAGGING",
      dropping: null,
      draggingOver: u,
  ...
  const e = Pe((s, a) => ({
    ...
    if (!f) {
      ...
      if (u.displaced.invisible[s])
        return null;
      const m = Cn(l.displacedBy.point), b = e(m.x, m.y);
      return n(b, p, !0);
    }
    if (c)
      return r(p);
...
var bv = vv;
function Sc(e) {
  return Zr(Fs).isUsingCloneFor === e.draggableId && !e.isClone ? null : F.createElement(bv, e);
}
function Cv(e) {
  ...
  return F.createElement(Sc, mn({}, e, {
    isClone: !1,
    isEnabled: t,
...
const Ns = (e) => (t) => e === t, Av = Ns("scroll"), wv = Ns("auto"), _v = Ns("visible"), fu = (e, t) => t(e.overflowX) || t(e.overflowY), Sv = (e, t) => t(e.overflowX) && t(e.overflowY), Fc = (e) => {
  ...
  if (t || (process.env.NODE_ENV, v(!1)), !Fc(e))
    return !1;
...
var pu = (e) => e.shouldPublishImmediately ? Rv : Iv;
const Or = (e) => e && e.env.closestScrollable || null;
function Pv(e) {
  const t = w.useRef(null), n = Zr(ho), r = As("droppable"), {
    registry: o,
    marshal: i
  } = n, s = _s(e), a = ie(() => ({
    id: e.droppableId,
    type: e.type,
    mode: e.mode
  }), [e.droppableId, e.mode, e.type]), u = w.useRef(a), l = ie(() => Pe((E, y) => {
    t.current || (process.env.NODE_ENV !== "production" ? v(!1, "Can only update scroll when dragging") : v(!1));
    const _ = {
      x: E,
      y
    };
    ...
    const E = t.current;
    return !E || !E.env.closestScrollable ? Me : Ri(E.env.closestScrollable);
  }, []), c = U(() => {
    const E = f();
    l(E.x, E.y);
  }, [f, l]), d = ie(() => tr(c), [c]), p = U(() => {
    const E = t.current, y = Or(E);
    if (E && y || (process.env.NODE_ENV !== "production" ? v(!1, "Could not find scroll options while scrolling") : v(!1)), E.scrollOptions.shouldPublishImmediately) {
      c();
      return;
    }
    d();
  }, [d, c]), g = U((E, y) => {
    t.current && (process.env.NODE_ENV !== "production" ? v(!1, "Cannot collect a droppable while a drag is occurring") : v(!1));
    const _ = s.current, N = _.getDroppableRef();
    N || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot collect without a droppable ref") : v(!1));
    const I = xv(N), M = {
      ref: N,
      descriptor: a,
      env: I,
    ...
    const E = t.current, y = Or(E);
    return E && y || (process.env.NODE_ENV !== "production" ? v(!1, "Can only recollect Droppable client for Droppables that have a scroll container") : v(!1)), Ri(y);
  }, []), m = U(() => {
    const E = t.current;
    E || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot stop drag when no active drag") : v(!1));
    const y = Or(E);
    t.current = null, y && (d.cancel(), y.removeAttribute(su.contextId), y.removeEventListener("scroll", p, pu(E.scrollOptions)));
  }, [p, d]), b = U((E) => {
    const y = t.current;
    y || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot scroll when there is no drag") : v(!1));
    const _ = Or(y);
    _ || (process.env.NODE_ENV !== "production" ? v(!1, "Cannot scroll a droppable with no closest scrollable") : v(!1)), _.scrollTop += E.y, _.scrollLeft += E.x;
  }, []), A = ie(() => ({
...
const mu = {
  ...
  w.useEffect(() => a ? r !== "open" ? (n(), u(!1), Uo) : t.current ? Uo : (t.current = setTimeout(() => {
    t.current = null, u(!1);
  }), n) : Uo, [r, a, n]);
  const l = U((c) => {
...
const Vv = [function({
  ...
  t.droppableId || (process.env.NODE_ENV !== "production" ? v(!1, "A Droppable requires a droppableId prop") : v(!1)), typeof t.droppableId != "string" && (process.env.NODE_ENV !== "production" ? v(!1, `A Droppable requires a [string] droppableId. Provided: [${typeof t.droppableId}]`) : v(!1));
}, function({
  props: t
}) {
  Wo(t.isDropDisabled) || (process.env.NODE_ENV !== "production" ? v(!1, "isDropDisabled must be a boolean") : v(!1)), Wo(t.isCombineEnabled) || (process.env.NODE_ENV !== "production" ? v(!1, "isCombineEnabled must be a boolean") : v(!1)), Wo(t.ignoreContainerClipping) || (process.env.NODE_ENV !== "production" ? v(!1, "ignoreContainerClipping must be a boolean") : v(!1));
}, function({
  getDroppableRef: t
}) {
  Cc(t());
  ...
  t.renderClone || (process.env.NODE_ENV !== "production" ? v(!1, "Must provide a clone render function (renderClone) for virtual lists") : v(!1));
}, function({
  getPlaceholderRef: t
}) {
  t() && (process.env.NODE_ENV !== "production" ? v(!1, "Expected virtual list to not have a placeholder") : v(!1));
}];
function zv(e) {
  Dr(() => {
...
class Uv extends F.PureComponent {
  constructor(...t) {
    super(...t), this.state = {
...
const Wv = (e) => {
  const t = w.useContext(ho);
  t || (process.env.NODE_ENV !== "production" ? v(!1, "Could not find app context") : v(!1));
  const {
    contextId: n,
    isMovementAllowed: r
  ...
  } = e, A = U(() => o.current, []), D = U((P = null) => {
    o.current = P;
  }, []), E = U(() => i.current, []), y = U((P = null) => {
    i.current = P;
  }, []);
  zv({
    props: e,
  ...
  const N = ie(() => F.createElement(Uv, {
    ...
    contextId: n,
    onTransitionEnd: _
  })), [n, _, e.placeholder, e.shouldAnimatePlaceholder, y]), I = ie(() => ({
    innerRef: D,
    placeholder: N,
    droppableProps: {
  ...
  function L() {
    ...
    return Kc.createPortal(j, b());
  }
  return F.createElement(Fs.Provider, {
    value: O
  }, s(I, g), L());
};
var Hv = Wv;
function qv() {
  return document.body || (process.env.NODE_ENV !== "production" ? v(!1, "document.body is not ready") : v(!1)), document.body;
}
const hu = {
  mode: "standard",
  type: "DEFAULT",
...
var Jv = Kv;
const Qv = (e) => /* @__PURE__ */ w.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512", ...e }, /* @__PURE__ */ w.createElement("path", { d: "M0 117.66v346.32c0 11.32 11.43 19.06 21.94 14.86L160 416V32L20.12 87.95A32.006 32.006 0 000 117.66zM192 416l192 64V96L192 32v384zM554.06 33.16L416 96v384l139.88-55.95A31.996 31.996 0 00576 394.34V48.02c0-11.32-11.43-19.06-21.94-14.86z" })), en = (e, t, n, r, o) => {
  if (!r)
...
let Ii, Je, Nt, to, Vt, mt, Ie, xs, Jn;
var ab = function(t, n) {
  Ii = String(t), Je = "start", Nt = [], to = 0, Vt = 1, mt = 0, Ie = void 0, xs = void 0, Jn = void 0;
  do
    Ie = ub(), db[Je]();
  while (Ie.type !== "eof");
  return typeof n == "function" ? Pi({ "": Jn }, "", n) : Jn;
};
function Pi(e, t, n) {
  const r = e[t];
...
function Ot() {
  if (Ii[to])
    return String.fromCodePoint(Ii.codePointAt(to));
}
function S() {
  const e = Ot();
  return e === `
...
`:
  ...
  comment() {
    switch (oe) {
      case "*":
        S(), ee = "multiLineComment";
        return;
      case "/":
        S(), ee = "singleLineComment";
        return;
    }
    throw ve(S());
  },
...
`:
  ...
  value() {
    switch (oe) {
      ...
      case "n":
        return S(), Ht("ull"), ye("null", null);
      case "t":
        return S(), Ht("rue"), ye("boolean", !0);
      case "f":
        return S(), Ht("alse"), ye("boolean", !1);
      case "-":
      case "+":
        S() === "-" && (Ft = -1), ee = "sign";
        return;
      case ".":
        K = S(), ee = "decimalPointLeading";
        return;
      case "0":
        K = S(), ee = "zero";
        return;
      ...
      case "8":
      case "9":
        K = S(), ee = "decimalInteger";
        return;
      case "I":
        return S(), Ht("nfinity"), ye("numeric", 1 / 0);
      case "N":
        return S(), Ht("aN"), ye("numeric", NaN);
      case '"':
      case "'":
        Wn = S() === '"', K = "", ee = "string";
        return;
  ...
  sign() {
    switch (oe) {
      ...
      case "9":
        ...
        return;
      case "I":
        return S(), Ht("nfinity"), ye("numeric", Ft * (1 / 0));
      case "N":
        return S(), Ht("aN"), ye("numeric", NaN);
    }
    throw ve(S());
  ...
  decimalExponent() {
    switch (oe) {
      case "+":
      case "-":
        K += S(), ee = "decimalExponentSign";
        return;
    }
    if (Se.isDigit(oe)) {
      K += S(), ee = "decimalExponentInteger";
      return;
    }
    throw ve(S());
  },
...
`:
  ...
  beforePropertyName() {
    switch (oe) {
      case "$":
      case "_":
        K = S(), ee = "identifierName";
        return;
      case "\\":
        S(), ee = "identifierNameStartEscape";
        return;
      case "}":
        return ye("punctuator", S());
      case '"':
...
function cb() {
  let e = "", t = Ot();
  if (!Se.isHexDigit(t) || (e += S(), t = Ot(), !Se.isHexDigit(t)))
    throw ve(S());
...
const db = {
  ...
  beforePropertyName() {
    switch (Ie.type) {
      case "identifier":
      case "string":
        xs = Ie.value, Je = "afterPropertyName";
        return;
      case "punctuator":
        Tr();
        return;
...
function ve(e) {
  return no(e === void 0 ? `JSON5: invalid end of input at ${Vt}:${mt}` : `JSON5: invalid character '${Ic(e)}' at ${Vt}:${mt}`);
}
function qt() {
...
function fb(e) {
  console.warn(`JSON5: '${Ic(e)}' in strings is not valid ECMAScript; consider escaping`);
}
function Ic(e) {
  const t = {
    "'": "\\'",
...
var pb = function(t, n, r) {
  ...
  function f(h, m) {
    let b = m[h];
    switch (b != null && (typeof b.toJSON5 == "function" ? b = b.toJSON5(h) : typeof b.toJSON == "function" && (b = b.toJSON(h))), a && (b = a.call(m, h, b)), b instanceof Number ? b = Number(b) : b instanceof String ? b = String(b) : b instanceof Boolean && (b = b.valueOf()), b) {
      case null:
        return "null";
      case !0:
        return "true";
  ...
  function c(h) {
    ...
    for (let E = 0; E < h.length; E++) {
      ...
      if (y < " ") {
        let _ = y.charCodeAt(0).toString(16);
        A += "\\x" + ("00" + _).substring(_.length);
        continue;
      }
      A += y;
    }
    const D = l || Object.keys(m).reduce((E, y) => m[E] < m[y] ? E : y);
    return A = A.replace(new RegExp(D, "g"), b[D]), D + A + D;
  }
  function d(h) {
    if (o.indexOf(h) >= 0)
...
` + m + "}";
  ...
  function p(h) {
    ...
    if (!Se.isIdStartChar(m))
      return c(h);
    for (let b = m.length; b < h.length; b++)
      if (!Se.isIdContinueChar(String.fromCodePoint(h.codePointAt(b))))
        return c(h);
    return h;
  }
  function g(h) {
    ...
    for (let D = 0; D < h.length; D++) {
      const E = f(String(D), h);
      b.push(E !== void 0 ? E : "null");
    }
    let A;
    if (b.length === 0)
      A = "[]";
...
` ? n + "." : n;
  ...
  switch (e) {
    ...
    case "delete":
      return (i = c == null ? void 0 : c.delete) !== null && i !== void 0 ? i : x(Rb, Object.assign({}, d, { style: f("iconDelete", t), size: "1.45em" }));
    case "copy":
      return (s = c == null ? void 0 : c.copy) !== null && s !== void 0 ? s : x(Ib, Object.assign({}, d, { style: f("iconCopy", t), size: "1.2em" }));
    case "ok":
      return (a = c == null ? void 0 : c.ok) !== null && a !== void 0 ? a : x(Pb, Object.assign({}, d, { style: Object.assign({ fontSize: "90%" }, f("iconOk", t)) }));
    case "cancel":
  ...
  const { getStyles: a } = Bt(), u = s("KEY_NEW", i), [l, f] = w.useState(!1), [c, d] = w.useState(u), { key: p, path: g, value: h } = i;
  return w.useEffect(() => {
    l || d(u);
  }, [l]), Te("div", { className: "jer-edit-buttons", style: l ? { opacity: 1 } : void 0, children: [r && x("div", { onClick: (m) => {
    let b, A = "value", D = "";
    r && ((m.ctrlKey || m.metaKey) === !0 ? (b = kb(g), D = b, A = "path") : (b = h, D = o ? JSON.stringify(h, null, 2) : String(b)), navigator.clipboard.writeText(D)), typeof r == "function" && r({ value: b, stringValue: D, path: g, key: p, type: A });
  ...
  if (n.length === 0)
    return {};
  const r = n[0], { element: o, wrapperElement: i, customNodeProps: s, wrapperProps: a, hideKey: u = !1, showEditTools: l = !0, showOnEdit: f = !1, showOnView: c = !0, showCollectionWrapper: d = !0 } = r, p = Pc(r, ["element", "wrapperElement", "customNodeProps", "wrapperProps", "hideKey", "showEditTools", "showOnEdit", "showOnView", "showCollectionWrapper"]);
...
}, vu = ({ key: e, path: t }, n = "") => !!vn({ value: e }, n) || !!t.some((r) => vn({ value: r }, n)), Gc = w.createContext({ collapseState: null, setCollapseState: () => {
...
}, Ts = () => w.useContext(Gc), zc = (e) => {
  const { data: t, parentData: n, nodeData: r, onEdit: o, onDelete: i, onChange: s, onError: a, showErrorMessages: u, enableClipboard: l, restrictEditFilter: f, restrictDeleteFilter: c, restrictTypeSelection: d, searchFilter: p, searchText: g, showLabel: h, stringTruncate: m, showStringQuotes: b, indent: A, translate: D, customNodeDefinitions: E } = e, { getStyles: y } = Bt(), { currentlyEditingElement: _, setCurrentlyEditingElement: N, setCollapseState: I } = Ts(), [M, O] = w.useState(typeof t == "function" ? "**INVALID_FUNCTION**" : t), [L, P] = w.useState(null), { key: T, path: j } = r, H = Vc(E, r), [J, Q] = w.useState(Rr(t, H)), X = Er(j), se = w.useCallback((z) => {
    if (!s)
      return void O(z);
  ...
  w.useEffect(() => {
    O(typeof t == "function" ? "**INVALID_FUNCTION**" : t), Q(Rr(t, H));
  }, [t, L]);
  const Y = w.useMemo(() => !f(r), [r]), ce = w.useMemo(() => !c(r), [r]), Z = w.useMemo(() => (z, ue) => {
    var Ce;
    Ce = z.message, u && (P(Ce), setTimeout(() => P(null), 2500)), console.warn("Error", Ce), a && a({ currentData: r.fullData, errorValue: ue, currentValue: M, name: T, path: j, error: z });
  }, [a, u]), { CustomNode: ge, customNodeProps: V, hideKey: te, showEditTools: be = !0, showOnEdit: je, showOnView: le } = H, de = [...$b, ...E.filter(({ showInTypesSelector: z = !1, name: ue }) => z && !!ue).map(({ name: z }) => z)], Ae = w.useMemo(() => {
    if (typeof d == "boolean")
      return d ? [] : de;
    if (Array.isArray(d))
      return d;
  ...
  const we = () => {
    ...
    N(null), O(t), Q(Rr(t, H));
  }, ae = _ === X, $ = _ === `key_${X}`, Le = typeof j.slice(-1)[0] != "number" && Y && ce, Fe = !ae && L, Oe = ae && Ae.length > 0, _e = J !== "invalid" && !L && be, We = h && $, Ge = h && !$ && !te, at = { value: M, parentData: n, setValue: se, isEditing: ae, setIsEditing: Y ? () => N(X) : () => {
  }, handleEdit: we, handleCancel: R, path: j, stringTruncate: m, showStringQuotes: b, nodeData: r, translate: D }, Ze = ge && (ae && je || !ae && le) ? x(ge, Object.assign({}, e, { value: M, customNodeProps: V, setValue: se, handleEdit: we, handleCancel: R, handleKeyPress: (z) => {
    z.key === "Enter" ? we() : z.key === "Escape" && R();
  }, isEditing: ae, setIsEditing: () => N(X), getStyles: y })) : jb(Rr(t), at);
  return x("div", { className: "jer-component jer-value-component", style: { marginLeft: A / 2 + "em" }, children: Te("div", { className: "jer-value-main-row", style: { flexWrap: T.length > 10 ? "wrap" : "nowrap" }, children: [Ge && Te("span", { className: "jer-key-text", style: Object.assign(Object.assign({}, y("property", r)), { minWidth: `${Math.min(String(T).length + 1, 5)}ch`, flexShrink: T.length > 10 ? 1 : 0 }), onDoubleClick: () => Le && N(`key_${X}`), children: [T === "" ? x("span", { className: "jer-empty-string" }) : T, ":"] }), We && x("input", { className: "jer-input-text jer-key-edit", type: "text", name: X, defaultValue: T, autoFocus: !0, onFocus: (z) => z.target.select(), onKeyDown: (z) => {
    z.key === "Enter" ? ((ue) => {
      if (N(null), T === ue || !n)
        return;
      ...
      o(ze, Ce);
    })(z.target.value) : z.key === "Escape" && R();
  }, style: { width: String(T).length / 1.5 + 0.5 + "em" } }), Te("div", { className: "jer-value-and-buttons", children: [x("div", { className: "jer-input-component", children: Ze }), ae ? x(Os, { onOk: we, onCancel: R, nodeData: r }) : _e && x($c, { startEdit: Y ? () => N(X) : void 0, handleDelete: ce ? () => {
    i(M, j).then((z) => {
    ...
    const Ce = E.find((ze) => ze.name === ue);
    if (Ce)
      o(Ce.defaultValue, j), Q(ue);
    else {
      const ze = Gb(M, ue, D("DEFAULT_NEW_KEY", r), H != null && H.CustomNode ? D("DEFAULT_STRING", r) : void 0);
      se(ze), o(ze, j), I({ path: j, collapsed: !1 }), Q(ue);
    }
  })(z.target.value), value: J, children: Ae.map((z) => x("option", { value: z, children: z }, z)) }), x("span", { className: "focus" })] }), Fe && x("span", { className: "jer-error-slug", style: y("error", r), children: L })] })] }) });
}, Rr = (e, t) => t != null && t.CustomNode && (t != null && t.name) && t.showInTypesSelector ? t.name : typeof e == "string" ? "string" : typeof e == "number" ? "number" : typeof e == "boolean" ? "boolean" : e === null ? "null" : "invalid", jb = (e, t) => {
  const n = t.value;
  switch (e) {
    case "string":
  ...
  var { data: t, nodeData: n, parentData: r, showCollectionCount: o } = e, i = Pc(e, ["data", "nodeData", "parentData", "showCollectionCount"]);
  const { getStyles: s } = Bt(), { collapseState: a, setCollapseState: u, doesPathMatch: l, currentlyEditingElement: f, setCurrentlyEditingElement: c, areChildrenBeingEdited: d } = Ts(), { onEdit: p, onAdd: g, onDelete: h, onError: m, showErrorMessages: b, restrictEditFilter: A, restrictDeleteFilter: D, restrictAddFilter: E, collapseFilter: y, enableClipboard: _, searchFilter: N, searchText: I, indent: M, keySort: O, showArrayIndices: L, defaultValue: P, translate: T, customNodeDefinitions: j, useJSON5Editor: H } = i, J = w.useMemo(() => H ? H instanceof Object ? (q) => Ko.stringify(q, H) : (q) => Ko.stringify(q, { space: 2 }) : (q) => JSON.stringify(q, null, 2), [H]), [Q, X] = w.useState(J(t)), [se, Y] = w.useState(null), ce = y(n), [Z, ge] = w.useState(ce), V = Object.assign(Object.assign({}, n), { collapsed: Z }), { path: te, key: be, size: je } = V, le = Er(te), de = w.useRef(!ce), [Ae, we] = w.useState(!1);
  w.useEffect(() => {
    X(J(t));
  }, [t]), w.useEffect(() => {
    const q = y(V);
  ...
  const R = w.useMemo(() => !A(V), [V]), ae = w.useMemo(() => !D(V), [V]), $ = w.useMemo(() => !E(V), [V]), Le = w.useMemo(() => (q) => typeof P != "function" ? P : P(q), [P]), { CustomNode: Fe, customNodeProps: Oe, CustomWrapper: _e, wrapperProps: We = {}, hideKey: Ge, showEditTools: at = !0, showOnEdit: Ze, showOnView: z, showCollectionWrapper: ue = !0 } = w.useMemo(() => Vc(j, V), []), Ce = w.useMemo(() => (q, ne) => {
    var Re;
    Re = q.message, b && (Y(Re), setTimeout(() => Y(null), 2500)), console.warn("Error", Re), m && m({ currentData: V.fullData, errorValue: ne, currentValue: t, name: be, path: te, error: q });
  }, [m, b]);
  if (!jc("collection", V, N, I) && V.level > 0)
    return null;
  const ze = Array.isArray(t) ? "array" : "object", vt = ze === "array" ? { open: "[", close: "]" } : { open: "{", close: "}" }, Gt = getComputedStyle(document.documentElement).getPropertyValue("--jer-expand-transition-time"), an = (q) => {
    ...
    c(null), Y(null), X(J(t));
  }, Ne = f === le, Rt = f === `key_${le}`, cn = typeof te.slice(-1)[0] == "number", wn = r !== null && R && $ && ae && !cn, yr = o === "when-closed" ? Z : o, zt = !Ne && at, Do = (L || !cn) && !Ge && be !== void 0, Eo = Fe && (Ne && Ze || !Ne && z), xe = O && ze === "object", Ct = Object.entries(t).map(([q, ne]) => [ze === "array" ? Number(q) : q, ne]);
...
`).length, _n = de.current ? Ne ? x("div", { className: "jer-collection-text-edit", children: Te("div", { children: [x(Mc, { className: "jer-collection-text-area", name: le, value: Q, setValue: X, isEditing: Ne, handleKeyPress: an, styles: s("input", V) }), x("div", { className: "jer-collection-input-button-row", children: x(Os, { onOk: un, onCancel: bt, nodeData: V }) })] }) }) : Ct.map(([q, ne], Re) => {
    const Pt = { key: q, value: ne, path: [...te, q], level: te.length + 1, index: Re, size: ro(ne) ? Object.keys(ne).length : 1, parentData: t, fullData: V.fullData };
    return x("div", { className: "jer-collection-element", style: s("collectionElement", Pt), children: ro(ne) ? x(Uc, Object.assign({ data: ne, parentData: t, nodeData: Pt, showCollectionCount: o }, i), q) : x(zc, Object.assign({ data: ne, parentData: t, nodeData: Pt }, i, { showLabel: ze === "object" || L }), q) }, q);
  }) : null, It = !!ue && Z;
  It || (de.current = !0);
  const Sn = Object.assign(Object.assign({}, i), { data: t, value: t, parentData: r, nodeData: V, setValue: (q) => jr(void 0, void 0, void 0, function* () {
    return yield p(q, te);
  }), handleEdit: un, handleCancel: bt, handleKeyPress: an, isEditing: Ne, setIsEditing: () => c(le), getStyles: s }), vr = Eo ? x(Fe, Object.assign({ customNodeProps: Oe }, Sn, { children: _n })) : _n, br = Rt ? x("input", { className: "jer-input-text jer-key-edit", type: "text", name: le, defaultValue: be, autoFocus: !0, onFocus: (q) => q.target.select(), onKeyDown: (q) => {
    q.key === "Enter" ? ((ne) => {
      if (c(null), be === ne || !r)
        return;
      const Re = te.slice(0, -1);
      if (Object.keys(r).includes(ne))
        return void Ce({ code: "KEY_EXISTS", message: T("ERROR_KEY_EXISTS", V) }, ne);
      const Pt = Object.fromEntries(Object.entries(r).map(([xn, On]) => xn === be ? [ne, On] : [xn, On]));
      p(Pt, Re);
    })(q.target.value) : q.key === "Escape" && bt();
  }, style: { width: String(be).length / 1.5 + 0.5 + "em" } }) : Do && x("span", { className: "jer-key-text", style: s("property", V), onDoubleClick: () => wn && c(`key_${le}`), children: be === "" ? x("span", { className: te.length > 0 ? "jer-empty-string" : void 0 }) : `${be}:` }), Fn = zt && x($c, { startEdit: R ? () => {
    de.current = !0, c(le), ge(!1);
  } : void 0, handleAdd: $ ? (q) => {
    ge(!1);
    const ne = Le(V);
    ze === "array" ? g(ne, [...te, t.length]).then((Re) => {
      Re && Ce({ code: "ADD_ERROR", message: Re }, ne);
    }) : q in t ? Ce({ code: "KEY_EXISTS", message: T("ERROR_KEY_EXISTS", V) }, q) : g(ne, [...te, q]).then((Re) => {
      Re && Ce({ code: "ADD_ERROR", message: Re }, ne);
    });
  } : void 0, handleDelete: ae ? ln : void 0, enableClipboard: _, type: ze, nodeData: V, translate: T }), Nn = Te("div", { className: "jer-component jer-collection-component", style: Object.assign({ marginLeft: (te.length === 0 ? 0 : M / 2) + "em" }, s("collection", V)), children: [ue ? Te("div", { className: "jer-collection-header-row", style: { position: "relative" }, children: [Te("div", { className: "jer-collection-name", children: [x("div", { className: "jer-collapse-icon", onClick: (q) => ((ne) => {
...
}, onEdit: r = n, onDelete: o = n, onAdd: i = n, onChange: s, onError: a, showErrorMessages: u = !0, enableClipboard: l = !0, theme: f = "default", icons: c, indent: d = 3, collapse: p = !1, showCollectionCount: g = !0, restrictEdit: h = !1, restrictDelete: m = !1, restrictAdd: b = !1, restrictTypeSelection: A = !1, searchFilter: D, searchText: E, searchDebounceTime: y = 350, keySort: _ = !1, showArrayIndices: N = !0, showStringQuotes: I = !0, defaultValue: M = null, minWidth: O = 250, maxWidth: L = "min(600px, 90vw)", rootFontSize: P, stringTruncate: T = 250, translations: j = {}, className: H, id: J, customText: Q = {}, customNodeDefinitions: X = [], useJSON5Editor: se = !1 }) => {
  const { getStyles: Y, setTheme: ce, setIcons: Z } = Bt(), { setCollapseState: ge } = Ts(), V = w.useCallback(Ir(p), [p]), te = w.useCallback(Ub(j, Q), [j, Q]), [be, je] = w.useState(E), [le, de] = w.useState(e);
  w.useEffect(() => {
    f && ce(f), c && Z(c);
  }, [f, c]), w.useEffect(() => {
    ge(null), de(e);
  }, [e]), w.useEffect(() => {
    const Oe = setTimeout(() => je(E), y);
    return () => clearTimeout(Oe);
  }, [E, y]);
  const Ae = { key: t, path: [], level: 0, index: 0, value: le, size: Object.keys(le).length, parentData: null, fullData: le }, we = Ir(h), R = Ir(m), ae = Ir(b), $ = qb(D), Le = { name: t, nodeData: Ae, onEdit: (Oe, _e) => jr(void 0, void 0, void 0, function* () {
    ...
    if (z !== void 0)
      return de(We), z === !1 ? te("ERROR_UPDATE", Ae) : z;
  }), onChange: s, onError: a, showErrorMessages: u, showCollectionCount: g, collapseFilter: V, restrictEditFilter: we, restrictDeleteFilter: R, restrictAddFilter: ae, restrictTypeSelection: A, searchFilter: $, searchText: be, enableClipboard: l, keySort: _, showArrayIndices: N, showStringQuotes: I, indent: d, defaultValue: M, stringTruncate: T, translate: te, customNodeDefinitions: X, parentData: null, useJSON5Editor: se }, Fe = Object.assign(Object.assign({}, Y("container", Ae)), { minWidth: O, maxWidth: L });
  return Fe.fontSize = P ?? Fe.fontSize, x("div", { id: J, className: "jer-editor-container " + H, style: Fe, children: ro(le) ? x(Uc, Object.assign({ data: le }, Le)) : x(zc, Object.assign({ data: le, showLabel: !0 }, Le)) });
...
}, Ir = (e) => typeof e == "boolean" ? () => e : typeof e == "number" ? ({ level: t }) => t >= e : e, qb = (e) => {
  if (e !== void 0)
...
const UC = ({ loadConfig: e, config: t, convertStateToConfig: n, onExpandCollapse: r = () => {
  ...
  const [o, i] = w.useState(!1), [s, a] = w.useState({}), u = (d) => {
    i(d), r();
  ...
  const c = {
    chart: ["Charts", "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/bar-chart.html", /* @__PURE__ */ F.createElement(js, null)],
    dashboard: ["Dashboard", "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/bar-chart.html", /* @__PURE__ */ F.createElement(js, null)],
    map: ["Maps", "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/data-map.html", /* @__PURE__ */ F.createElement(Qv, null)],
    "markup-include": [
      "Markup Include",
      "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/Markup-Include.html",
      /* @__PURE__ */ F.createElement(Yc, null)
    ]
  };
  ...
  return u ? /* @__PURE__ */ React.createElement("fieldset", { className: "edit-block mb-1", key: t }, /* @__PURE__ */ React.createElement("div", { className: "d-flex justify-content-between" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-light", onClick: () => l(t, !1) }, /* @__PURE__ */ React.createElement(qn, { display: "caretUp" })), /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "Remove"
  )), i) : /* @__PURE__ */ React.createElement("div", { className: "mb-1" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-light", onClick: () => l(t, !0) }, /* @__PURE__ */ React.createElement(qn, { display: "caretDown" })), /* @__PURE__ */ React.createElement("span", null, " ", e ? `${e}` : "New " + n));
}, ki = ({ orderedValues: e, handleFilterOrder: t }) => /* @__PURE__ */ React.createElement(Zy, { onDragEnd: ({ source: n, destination: r }) => t(n == null ? void 0 : n.index, r == null ? void 0 : r.index) }, /* @__PURE__ */ React.createElement(Jv, { droppableId: "filter_order" }, (n) => /* @__PURE__ */ React.createElement("ul", { ...n.droppableProps, className: "sort-list", ref: n.innerRef, style: { marginTop: "1em" } }, e == null ? void 0 : e.map((r, o) => /* @__PURE__ */ React.createElement(Cv, { key: r, draggableId: `draggableFilter-${r}`, index: o }, (i, s) => /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(
  "div",
  {
  ...
  e.filters.forEach((D, E) => {
    o !== E && (l.push(D.columnName), u != null && u.columnName && l.push(u.columnName));
  });
  const f = (D, E) => {
    s("filters", o, D, E);
  }, c = (D) => {
    const E = {
      ...
      order: D
    }, y = Zo(E).values, _ = Ke.cloneDeep(e.filters);
    _[o] = { ...a, values: y, order: D }, D === "cust" ? _[o].orderedValues = y : delete _[o].orderedValues, s(null, null, "filters", _);
  }, d = (D) => {
    s("filters", o, "subGrouping", D);
  }, p = (D) => {
    var N;
    const y = ((N = a.orderedValues) != null && N.length ? a.orderedValues : a.values).reduce((I, M) => {
      const O = Ke.uniq(
    ...
    const E = Object.keys(u.valuesLookup).reduce((_, N) => {
      const I = u.valuesLookup[N], { values: M } = Zo({ values: I.values, order: D });
      return _[N] = {
        values: M
      }, D === "cust" ? _[N].orderedValues = M : delete _[N].orderedValues, _;
    }, {}), y = { ...u, order: D, valuesLookup: E };
    d(y);
  }, h = (D, E, y, _) => {
    const N = Ke.cloneDeep(y), [I] = N.splice(D, 1);
    N.splice(E, 0, I);
    const M = Ke.cloneDeep(u);
    M.valuesLookup[_].values = N, M.valuesLookup[_].orderedValues = N, d({ ...M, order: "cust" });
  }, m = t.filter((D) => !l.includes(D)), b = w.useMemo(() => {
    var E;
    const D = e.filters[o];
    return !!(D.setByQueryParameter && ((E = D.subGrouping) != null && E.setByQueryParameter));
  }, [e, o]), A = (D) => {
    const E = e.filters, { checked: y } = D.target, _ = y ? a.columnName : "", N = y ? u.columnName : "";
    E[o] = {
      ...e.filters[o],
      setByQueryParameter: _,
      subGrouping: { ...u, setByQueryParameter: N }
    }, s(null, null, "filters", E);
  };
  return /* @__PURE__ */ React.createElement("div", { className: "nesteddropdown-editor" }, /* @__PURE__ */ React.createElement("label", null, /* @__PURE__ */ React.createElement("span", { className: "edit-label column-heading mt-2" }, "Label"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      value: a.label,
  ...
  )), /* @__PURE__ */ React.createElement("label", null, /* @__PURE__ */ React.createElement("div", { className: "edit-label column-heading mt-2" }, "Filter Grouping", /* @__PURE__ */ React.createElement("span", null)), /* @__PURE__ */ React.createElement("select", { value: a.columnName, onChange: (D) => r(D.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "- Select Option -"), m.map((D, E) => /* @__PURE__ */ React.createElement("option", { value: D, key: E }, D)))), /* @__PURE__ */ React.createElement("label", null, /* @__PURE__ */ React.createElement("div", { className: "edit-label column-heading mt-2" }, "Filter SubGrouping", /* @__PURE__ */ React.createElement("span", null)), /* @__PURE__ */ React.createElement(
    "select",
    {
    ...
    m.map((D, E) => {
      if (D !== a.columnName)
        return /* @__PURE__ */ React.createElement("option", { value: D, key: E }, D);
    })
  ...
  ), /* @__PURE__ */ React.createElement("span", null, " Create query parameters"), b && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "edit-label column-heading mt-2" }, "Grouping: Default Value Set By Query String Parameter"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
  ...
  ), /* @__PURE__ */ React.createElement("span", { className: "edit-label column-heading mt-2" }, "SubGrouping: Default Value Set By Query String Parameter"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      ...
      onChange: (D) => {
        ...
        d({ ...u, setByQueryParameter: E });
      }
    }
  ))), /* @__PURE__ */ React.createElement("label", { className: "mt-2" }, /* @__PURE__ */ React.createElement("div", { className: "edit-label column-heading float-right" }, a.columnName, " "), /* @__PURE__ */ React.createElement("span", { className: "edit-filterOrder column-heading " }, "Group Order"), /* @__PURE__ */ React.createElement("select", { value: a.order, onChange: (D) => c(D.target.value) }, Qo.map((D, E) => /* @__PURE__ */ React.createElement("option", { value: D.value, key: `filter-${D.label}-${E}` }, D.label))), a.order === "cust" && /* @__PURE__ */ React.createElement(ki, { orderedValues: a.orderedValues, handleFilterOrder: n })), (u == null ? void 0 : u.columnName) && /* @__PURE__ */ React.createElement("label", { className: "mt-2" }, /* @__PURE__ */ React.createElement("span", { className: "edit-filterOrder column-heading" }, "SubGrouping Order"), /* @__PURE__ */ React.createElement("div", { className: "edit-label column-heading float-right" }, u.columnName, " "), /* @__PURE__ */ React.createElement(
    "select",
    {
      value: u.order ? u.order : "asc",
      onChange: (D) => g(D.target.value)
    },
    Qo.map((D, E) => /* @__PURE__ */ React.createElement("option", { value: D.value, key: `filter-${E}` }, D.label))
  ), (u == null ? void 0 : u.order) === "cust" && a.values.map((D, E) => {
    const y = u.valuesLookup[D].orderedValues;
    return /* @__PURE__ */ React.createElement("div", { key: `group-subgroup-values-${D}-${E}` }, /* @__PURE__ */ React.createElement("span", { className: "font-weight-bold" }, D), /* @__PURE__ */ React.createElement(
      ki,
      {
        key: `subgroup-values-${D}-${E}`,
        orderedValues: y,
        handleFilterOrder: (_, N) => {
          h(_, N, y, D);
        }
      }
    ));
  ...
  const r = w.useState({}), o = w.useMemo(() => Ke.uniq(Ke.flatten(n == null ? void 0 : n.map((d) => Object.keys(d)))), [n]), i = (d) => {
    ...
    const g = Ke.uniq(n.map((b) => b[p])), h = { ...Ke.cloneDeep(e.filters[d]), columnName: p, values: g };
    Zo(h), h.active = h.values[0];
    const m = e.filters.map((b, A) => A === d ? h : b);
    ...
    const h = e.filters[g], m = [...h.orderedValues || h.values], [b] = m.splice(d, 1);
    m.splice(p, 0, b);
    const A = Ke.cloneDeep(e.filters), D = { ...A[g] };
    D.values = m, D.orderedValues = m, D.active = m[0], D.order = "cust", A[g] = D, t(null, null, "filters", A);
  }, c = (d) => e.filters.filter((p, g) => g !== d).map(({ label: p, columnName: g, id: h }) => ({ label: p || g, value: h }));
  return /* @__PURE__ */ React.createElement(React.Fragment, null, e.filters && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    Bn,
    {
      ...
      tooltip: /* @__PURE__ */ React.createElement(wt, { style: { textTransform: "none" } }, /* @__PURE__ */ React.createElement(wt.Target, null, /* @__PURE__ */ React.createElement(qn, { display: "question", style: { marginLeft: "0.5rem" } })), /* @__PURE__ */ React.createElement(wt.Content, null, /* @__PURE__ */ React.createElement("p", null, 'The Apply Button option changes the visualization when the user clicks "apply". The Filter Change option immediately changes the visualization when the selection is changed.')))
    }
  ...
  ), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("ul", { className: "filters-list" }, e.filters.map((d, p) => d.type === "url" ? /* @__PURE__ */ React.createElement(React.Fragment, null) : /* @__PURE__ */ React.createElement(
    Kb,
    {
      key: d.columnName,
    ...
    /* @__PURE__ */ React.createElement(
      Bn,
      {
        ...
        label: "Filter Style",
        updateField: (g, h, m, b) => a(p, b),
        options: Xc
      }
    ),
    d.filterStyle !== "nested-dropdown" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      Bn,
      {
        value: d.columnName,
        fieldName: "columnName",
        label: "Filter",
        updateField: (g, h, m, b) => u(p, b),
        options: o,
    ...
    )), d.filterStyle === "multi-select" && /* @__PURE__ */ React.createElement(
      Gs,
      {
        label: "Select Limit",
        value: d.selectLimit,
    ...
    ), d.order === "cust" && /* @__PURE__ */ React.createElement(
      ki,
      {
        orderedValues: d.orderedValues || d.values,
        handleFilterOrder: (g, h) => f(g, h, p)
      }
    ), d.order === "column" && /* @__PURE__ */ React.createElement(
      Bn,
      {
        value: d.orderColumn,
        fieldName: "orderColumn",
        label: "Order Column",
        updateField: (g, h, m, b) => s("orderColumn", p, b),
        options: o
      }
    )) : /* @__PURE__ */ React.createElement(
      Jb,
  ...
  )))), !e.filters && /* @__PURE__ */ React.createElement("p", { style: { textAlign: "center" } }, "There are currently no filters."), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: l, className: "btn btn-primary full-width" }, "Add Filter"));
}, HC = ({
  label: e,
  sliderType: t = "flat",
  size: n = "medium",
  ...
  return /* @__PURE__ */ F.createElement("div", { className: "input-group" }, e && /* @__PURE__ */ F.createElement("label", null, e), /* @__PURE__ */ F.createElement(
    ...
    /* @__PURE__ */ F.createElement("input", { className: "cove-input--hidden", type: "checkbox", name: m(), checked: g || !1, readOnly: !0 })
  ));
};
export {
  CC as $,
