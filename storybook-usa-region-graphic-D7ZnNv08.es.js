import { g as M, j as r1, i as l1, k as I1 } from "./storybook-string-OihhptyG.es.js";
import { r as u } from "./storybook-index-BmAYD2Ot.es.js";
...
function Y1(t, c) {
  return t.trim().split(/^|\s+/).map(function(e) {
    var n = "", r = e.indexOf(".");
    if (r >= 0 && (n = e.slice(r + 1), e = e.slice(0, r)), e && !c.hasOwnProperty(e))
...
D.prototype = d1.prototype = {
  ...
  on: function(t, c) {
    ...
    if (arguments.length < 2) {
      for (; ++l < i; )
        if ((r = (t = n[l]).type) && (r = B1(e[r], t.name)))
          return r;
      return;
    }
    if (c != null && typeof c != "function")
      throw new Error("invalid callback: " + c);
    for (; ++l < i; )
      if (r = (t = n[l]).type)
        e[r] = a1(e[r], t.name, c);
      else if (c == null)
        for (r in e)
          e[r] = a1(e[r], t.name, null);
    return this;
  },
  copy: function() {
    var t = {}, c = this._;
  ...
  call: function(t, c) {
    if ((r = arguments.length - 2) > 0)
      for (var e = new Array(r), n = 0, r, l; n < r; ++n)
        e[n] = arguments[n + 2];
    if (!this._.hasOwnProperty(t))
      throw new Error("unknown type: " + t);
    for (l = this._[t], n = 0, r = l.length; n < r; ++n)
      l[n].value.apply(c, e);
  },
  apply: function(t, c, e) {
    if (!this._.hasOwnProperty(t))
      throw new Error("unknown type: " + t);
    for (var n = this._[t], r = 0, l = n.length; r < l; ++r)
      n[r].value.apply(c, e);
  }
};
function B1(t, c) {
...
function z1(t, c) {
  for (var e = b(t), n = -1, r = c.length; ++n < r; )
    e.add(c[n]);
}
function x1(t, c) {
  for (var e = b(t), n = -1, r = c.length; ++n < r; )
...
function q0(t, c) {
  var e = E1(t + "");
  if (arguments.length < 2) {
    for (var n = b(this.node()), r = -1, l = e.length; ++r < l; )
      if (!n.contains(e[r]))
        return !1;
    return !0;
  }
...
function At(t) {
  ...
  if (arguments.length < 1)
    return (c = this.tween(c)) && c._value;
  if (t == null)
    return this.tween(c, null);
  if (typeof t != "function")
    throw new Error();
