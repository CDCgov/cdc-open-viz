...
import { A as We, a as re, b as le, c as oe, d as ce, e as $e, f as Ze } from "./storybook-bb6534e3.es.js";
import { I as fe, S as Je } from "./storybook-03f28f41.es.js";
import { T as Q } from "./storybook-46a89ba7.es.js";
import { E as Qe, L as Xe } from "./storybook-a0c99f4a.es.js";
import { T as Ye, H as ge } from "./storybook-826feda6.es.js";
import { i as Ke, g as et } from "./storybook-7366772a.es.js";
import { n as tt, D as at } from "./storybook-28c41e3d.es.js";
import { f as nt } from "./storybook-5637bace.es.js";
import { u as rt, p as Ee, c as lt } from "./storybook-25f566e3.es.js";
...
const ft = (t) => {
  const { configUrl: l, config: d, isDashboard: b = !1, isEditor: f = !1, setConfig: T, link: E } = t, D = {
    ...
    coveLoadedHasRan: !1,
    container: null
  }, [m, A] = g.useReducer(dt, D), { config: o, loading: N, currentViewport: I, coveLoadedHasRan: Z, container: q } = m, { title: B, dataColumn: U, dataFunction: P, imageData: S, biteBody: L, biteFontSize: j, dataFormat: W, biteStyle: M, filters: X, subtext: _ } = o, { innerContainerClasses: w, contentClasses: z } = rt(o), J = new at(), ee = new Ke((i) => {
    for (let p of i) {
      let G = et(p.contentRect.width * 2);
    ...
    if (i.dataUrl) {
      i.dataUrl = `${i.dataUrl}?${Ze()}`;
      let x = await nt(i.dataUrl);
  ...
  let k = /* @__PURE__ */ e.createElement(Xe, null);
...
}, Ve = "Left", qe = "Right", je = "Top", Ge = "Bottom", Et = [Ve, qe, je, Ge], ht = "<", vt = ">", bt = "<=", yt = ">=", Nt = "=", _t = "≠", ye = [ht, vt, bt, yt, Nt, _t], Pt = {
...
const Bt = ["Data_Bite_Circle_Average", "Data_Bite_Text_Max_Pic", "Data_Bite_Circle_Sum", "Data_Bite_Text_Average_Pic"];
export {
