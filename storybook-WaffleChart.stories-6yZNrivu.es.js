import { r as p, R as e } from "./storybook-index-BmAYD2Ot.es.js";
import { T as ta, H as Z } from "./storybook-index-R_DM8DTt.es.js";
import { a as na, g as la } from "./storybook-isSolr-B1sVi3Vf.es.js";
import { f as oa } from "./storybook-fetchRemoteData-C6Zo10qQ.es.js";
import { E as je, L as ra } from "./storybook-Loading-DS8g8-4Q.es.js";
import { A as K } from "./storybook-Accordion-BJt7AwfQ.es.js";
import { B as sa } from "./storybook-Button-Djy4jtV0.es.js";
import { a as me } from "./storybook-Icon-B5TlldJZ.es.js";
import { T as R } from "./storybook-Tooltip-BxtpAmS8.es.js";
import { I as _, a as L } from "./storybook-editor-oEm-zD-g.es.js";
import { I as T } from "./storybook-InputSelect-CDWSnKkx.es.js";
import { u as ia } from "./storybook-updateFieldFactory-BcswjCX8.es.js";
import { L as ue, a as ca } from "./storybook-coveUpdateWorker-D1xxZDqt.es.js";
import { p as ma, u as ua } from "./storybook-useDataVizClasses-BwbaCKu-.es.js";
import { B as be, C as da, c as pa } from "./storybook-Circle-DG-wjuHC.es.js";
import { G as _e } from "./storybook-Group-DMkA2r_N.es.js";
...
const va = p.memo((t) => {
  const { config: a, updateConfig: h, loading: w, data: x, setParentConfig: k, isDashboard: N } = p.useContext(He), { showConfigConfirm: y } = t, [f, U] = p.useState(!0), O = (o) => o ? { backgroundColor: "#ffd2d2", color: "#d8000c" } : {}, l = ia(a, h, !0);
  p.useEffect(() => {
    if (k) {
      const o = j();
      k(o);
  ...
  }, r = ["Waffle", "Gauge"], i = /* @__PURE__ */ e.createElement(K, null, /* @__PURE__ */ e.createElement(K.Section, { title: "General" }, /* @__PURE__ */ e.createElement("div", { className: "cove-accordion__panel-section" }, /* @__PURE__ */ e.createElement("div", { style: { width: "100%", display: "block" }, className: "cove-input-group" }, /* @__PURE__ */ e.createElement(T, { value: a.visualizationType, fieldName: "visualizationType", label: "Chart Type", updateField: l, options: r, className: "cove-input" }), a.visualizationType === "Gauge" && /* @__PURE__ */ e.createElement(T, { value: a.visualizationSubType, fieldName: "visualizationSubType", label: "Chart Subtype", updateField: l, options: ["Linear"], className: "cove-input" }))), /* @__PURE__ */ e.createElement(_, { value: a.title, fieldName: "title", label: "Title", placeholder: "Chart Title", updateField: l }), /* @__PURE__ */ e.createElement(
    _,
    {
      type: "textarea",
      value: a.content,
...
}, Ea = ({ config: t, isEditor: a, link: h = "", showConfigConfirm: w, updateConfig: x }) => {
  const { title: k, theme: N, shape: y, nodeWidth: f, nodeSpacer: U, prefix: O, suffix: l, subtext: W, content: j, orientation: P, filters: G, dataColumn: z, dataFunction: D, dataConditionalColumn: g, dataConditionalOperator: r, dataConditionalComparate: i, customDenom: o, dataDenom: u, dataDenomColumn: d, dataDenomFunction: v, roundToPlace: $ } = t, $e = t.visual.colors[t.theme];
  ...
  const qe = p.useCallback(() => {
    ...
    return o && d && v ? X = ea[v] : X = u > 0 ? u : 100, [s(ce / X * 100), X, s(ce)];
  }, [z, D, t.data, G, g, r, i, o, d, v, $, u]), [H, se, Ne] = qe(), Qe = p.useCallback(() => {
  ...
  const [k, N] = p.useReducer(ga, { config: a ?? Q, loading: !0, preview: !1, viewport: "lg", coveLoadedHasRan: !1, container: null }), { loading: y, config: f, viewport: U, coveLoadedHasRan: O, container: l } = k, [W, j] = p.useState(!1), P = (r) => {
    Object.keys(Q).forEach((i) => {
      r[i] && typeof r[i] == "object" && !Array.isArray(r[i]) && (r[i] = { ...Q[i], ...r[i] });
    }), r.runtime = {}, r.runtime.uniqueId = Date.now(), r.runtime.editorErrorMessage = "", N({ type: "SET_CONFIG", payload: r });
  }, G = p.useCallback(async () => {
    let r = a || await (await fetch(t)).json(), i = r.data ?? {};
    r.dataUrl && (i = await oa(r.dataUrl)), r.data = i;
    const o = { ...await ca(r) };
    P({ ...Q, ...o }), N({ type: "SET_LOADING", payload: !1 });
  }, []), z = new na((r) => {
    for (let i of r) {
      let o = la(i.contentRect.width * 2);
      N({ type: "SET_VIEWPORT", payload: o });
    }
  }), D = p.useCallback((r) => {
    r !== null && z.observe(r), N({ type: "SET_CONTAINER", payload: r });
  }, []);
  p.useEffect(() => {
    G().catch((r) => console.log(r));
  }, []), p.useEffect(() => {
  ...
  if (y === !1) {
    let r = /* @__PURE__ */ e.createElement(ue.Responsive, { isEditor: w }, /* @__PURE__ */ e.createElement(Ea, { config: f, isEditor: w, showConfigConfirm: W, updateConfig: P }));
    g = /* @__PURE__ */ e.createElement(e.Fragment, null, w && /* @__PURE__ */ e.createElement(va, { showConfigConfirm: W }, r), !w && r);
  }
...
}, de = "Max", pe = "Count", fe = "Mean (Average)", he = "Median", ve = "Min", ge = "Mode", Ee = "Sum", we = [pe, de, fe, he, ve, ge, Ee], Ca = "<", Na = ">", ba = "<=", _a = ">=", wa = "=", ya = "≠", Da = [Ca, Na, ba, _a, wa, ya], Ba = {
...
oe.parameters = {
  ...oe.parameters,
  docs: {
    ...(Ie = oe.parameters) == null ? void 0 : Ie.docs,
    source: {
      originalSource: `{
  args: {
    config: {
  ...
  render: args => <>
      ...
      ...(Ge = (Ue = oe.parameters) == null ? void 0 : Ue.docs) == null ? void 0 : Ge.source
    }
  }
};
var Ve, Ye, Be;
re.parameters = {
  ...re.parameters,
  docs: {
    ...(Ve = re.parameters) == null ? void 0 : Ve.docs,
    source: {
      originalSource: `{
  args: {
    config: {
  ...
  render: args => <>
      ...
      ...(Be = (Ye = re.parameters) == null ? void 0 : Ye.docs) == null ? void 0 : Be.source
    }
  }
};
