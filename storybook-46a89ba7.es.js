import { r as T, R as Ft } from "./storybook-e61d95ab.es.js";
function Pt(t) {
  return t.split("-")[1];
}
function Yt(t) {
...
const be = (t) => t, xe = (t) => t, Se = ({ place: t = "top", trigger: e = "hover", float: n = !1, shadow: r = !0, border: o = !1, children: l, style: a, ...s }) => {
  ...
  return /* @__PURE__ */ Ft.createElement("span", { className: "cove-tooltip", style: a, ...s }, /* @__PURE__ */ Ft.createElement("a", { id: h, className: "cove-tooltip--target", "data-tooltip-float": n, "data-tooltip-place": t, "data-tooltip-events": m() }, f ? f.props.children : null), /* @__PURE__ */ Ft.createElement(
    Ie,
    {
      id: h,
      anchorId: h,
