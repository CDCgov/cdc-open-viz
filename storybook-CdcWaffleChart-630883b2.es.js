...
import { A as Z } from "./storybook-Accordion-2501c7d9.es.js";
...
import { I as _, a as L } from "./storybook-editor-57986c01.es.js";
import { I as D } from "./storybook-InputSelect-20478396.es.js";
import { u as Re } from "./storybook-updateFieldFactory-c006040a.es.js";
import { L as le, c as Pe, p as ke, u as Me } from "./storybook-coveUpdateWorker-91c2d978.es.js";
...
const Be = ({ config: l, isEditor: t, link: v = "", showConfigConfirm: y, updateConfig: A }) => {
  ...
  const ge = f.useCallback(() => {
    ...
    return o && d && E ? X = Te[E] : X = u > 0 ? u : 100, [
      i(te / X * 100),
      X,
      i(te)
    ];
    ...
    return O.map(
      (i, s) => i.shape === "square" ? /* @__PURE__ */ e.createElement(
        ...
        {
          style: {
            transform: `translateX(${i.x + g / 4}px) translateY(${i.y}px) scale(${g / 20})`
          },
          fill: i.color,
          fillOpacity: i.opacity,
          key: s,
  ...
  ), /* @__PURE__ */ e.createElement(pe, { x: 0, y: 0, width: _e(de), height: l.gauge.height, fill: Ne }))), /* @__PURE__ */ e.createElement("div", { className: "cove-waffle-chart__subtext subtext" }, Y(k)))), l.visualizationType !== "Gauge" && /* @__PURE__ */ e.createElement(
    "div",
    {
      className: `cove-waffle-chart${M === "vertical" ? " cove-waffle-chart--verical" : ""}${l.overallFontSize ? " font-" + l.overallFontSize : ""}`
    },
    /* @__PURE__ */ e.createElement("div", { className: "cove-waffle-chart__chart", style: { width: ee() } }, /* @__PURE__ */ e.createElement("svg", { width: ee(), height: ee() }, /* @__PURE__ */ e.createElement(fe, null, Ce()))),
    ($ || B) && /* @__PURE__ */ e.createElement("div", { className: "cove-waffle-chart__data" }, $ && /* @__PURE__ */ e.createElement("div", { className: "cove-waffle-chart__data--primary", style: ue }, z || null, $, n || null), /* @__PURE__ */ e.createElement("div", { className: "cove-waffle-chart__data--text" }, Y(B)), k && /* @__PURE__ */ e.createElement("div", { className: "cove-waffle-chart__subtext subtext" }, Y(k)))
  ))), v && v);
}, ft = ({
  configUrl: l,
  config: t,
