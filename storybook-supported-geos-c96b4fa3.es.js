const t = (a) => {
  if (a && a !== void 0)
    if (a.includes("–") || a.includes("-")) {
      let e = a.includes("–") ? a.split("–") : a.split("-"), o = a.includes("–") ? "–" : "-", r = e[0].split(" ").map((n) => n.charAt(0).toUpperCase() + n.substring(1).toLowerCase()).join(" "), i = e[1].split(" ").map((n) => n.charAt(0).toUpperCase() + n.substring(1).toLowerCase()).join(" ");
      return r + o + i;
    } else
      return a.split(" ").map((e) => e.charAt(0).toUpperCase() + e.substring(1).toLowerCase()).join(" ");
}, l = {
  10001: "Kent",
  10003: "New Castle",
  10005: "Sussex",
