...
import { f as Ae, b as xe, g as ze } from "./storybook-getViewport-7dc50c16.es.js";
import { E as Ee, L as Fe } from "./storybook-viewports-5c5d7af1.es.js";
import { A as j } from "./storybook-Accordion-aed5218d.es.js";
import { B as Oe } from "./storybook-Button-63da743c.es.js";
import { a as ae } from "./storybook-Icon-d8cd8abc.es.js";
import { T as R } from "./storybook-Tooltip-8bb9dfa2.es.js";
import { I as b, a as L } from "./storybook-editor-390d9f4b.es.js";
import { I as D } from "./storybook-InputSelect-76dbb8cb.es.js";
import { u as Re } from "./storybook-updateFieldFactory-c006040a.es.js";
import { L as le, c as Pe, p as ke, u as Me } from "./storybook-coveUpdateWorker-e42c85d9.es.js";
...
const Be = ({ config: l, isEditor: t, link: v = "", showConfigConfirm: y, updateConfig: A }) => {
  ...
  const [P, g] = f.useReducer(Ge, {
    ...
    r.dataUrl && (c = await Ae(r.dataUrl)), r.data = c;
    const o = { ...Pe(r) };
    M({ ...J, ...o }), g({ type: "SET_LOADING", payload: !1 });
  }, []), F = new xe((r) => {
    for (let c of r) {
      let o = ze(c.contentRect.width * 2);
