...
import { c as Kn, A as Xn, V as Yn, F as Jn, a as er, b as tr } from "./storybook-InputToggle-e5ab6790.es.js";
import { f as xe, b as ar, g as nr } from "./storybook-getViewport-7dc50c16.es.js";
import { T as en, H as tn } from "./storybook-index-3b47b3f7.es.js";
import { E as an, L as Ot } from "./storybook-viewports-5c5d7af1.es.js";
import { D as Se, A as rr, a as Kt, b as Xt, c as Yt, d as Jt } from "./storybook-DataTransform-12e90958.es.js";
import { b as or, D as ir, C as nn, a as rn } from "./storybook-CdcChartComponent-a86b82b6.es.js";
import { C as on } from "./storybook-CdcDataBite-37a15c95.es.js";
import { e as sr, C as sn, A as lr } from "./storybook-CdcMap-de1f9950.es.js";
import { C as ln } from "./storybook-CdcWaffleChart-31d12867.es.js";
import { C as cn } from "./storybook-CdcMarkupInclude-524a6bb4.es.js";
import { A as Me, a as cr, b as at, c as nt, d as rt, e as ot } from "./storybook-Accordion-aed5218d.es.js";
import { I as ur, a as Ie } from "./storybook-editor-390d9f4b.es.js";
import { B as dr } from "./storybook-Button-63da743c.es.js";
...
import { L as ye, u as fr, c as un } from "./storybook-coveUpdateWorker-e42c85d9.es.js";
import { u as _t } from "./storybook-updateFieldFactory-c006040a.es.js";
import { D as mr } from "./storybook-DataDesigner-8f06e949.es.js";
import { P as ke } from "./storybook-index-43433e35.es.js";
import { C as Ue, T as J, S as gt } from "./storybook-Inputs-6377cf32.es.js";
import { _ as I } from "./storybook-lodash-a4231e1c.es.js";
import { u as pr, g as dn, f as ea, a as gr, F as hr, b as It, c as fn, d as vr, h as mn, e as Pe, i as yr } from "./storybook-Filters-0b0ab6a2.es.js";
import { D as ht, f as br, M as ta } from "./storybook-DataTable-fa1d7944.es.js";
import { F as oe } from "./storybook-FilterStyles-fd509eb9.es.js";
import { D as Er } from "./storybook-DashboardFilters-7461a191.es.js";
import { M as it } from "./storybook-MultiSelect-fb96d51f.es.js";
import { L as Dr } from "./storybook-Loader-f4ec7b29.es.js";
import "./storybook-NestedDropdown-c8ea7d17.es.js";
import { F as Sr } from "./storybook-Footnotes-864326bc.es.js";
import { j as wr } from "./storybook-jsx-runtime-36872362.es.js";
var pn = v.createContext({
...
function Hr(e, t, a, n) {
  ...
  return jr(o), typeof o > "u" && (o = t === 0 ? {} : n.getDropResult()), o;
}
function jr(e) {
  N(typeof e > "u" || gn(e), "Drop result must either be an object or undefined.");
}
function qr(e) {
...
var Xr = /* @__PURE__ */ function() {
  function e(t, a) {
    var n = this;
    Zr(this, e), Ne(this, "store", void 0), Ne(this, "monitor", void 0), Ne(this, "backend", void 0), Ne(this, "isSetUp", !1), Ne(this, "handleRefCountChange", function() {
...
function eo(e, t) {
  var a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Yr;
...
function ao() {
  ...
  switch (t.type) {
    ...
    case Ye:
      return Jr(e.clientOffset, a.clientOffset) ? e : sa(sa({}, e), {}, {
        clientOffset: a.clientOffset
      });
    case et:
    case Je:
...
function co() {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : lo, t = arguments.length > 1 ? arguments[1] : void 0, a = t.payload;
  switch (t.type) {
    case Xe:
      return re(re({}, e), {}, {
        itemType: a.itemType,
    ...
    case tt:
      return e.targetIds.indexOf(a.targetId) === -1 ? e : re(re({}, e), {}, {
        targetIds: Rr(e.targetIds, a.targetId)
      });
    case Je:
      return re(re({}, e), {}, {
...
function mo() {
  ...
  var t = e.payload, a = t.targetIds, n = a === void 0 ? [] : a, r = t.prevTargetIds, o = r === void 0 ? [] : r, i = Cr(n, o), s = i.length > 0 || !eo(n, o);
  if (!s)
    return We;
...
function ho() {
  ...
  return {
    dirtyHandlerIds: mo(e.dirtyHandlerIds, {
      type: t.type,
      payload: da(da({}, t.payload), {}, {
        prevTargetIds: Tr(e, "dragOperation.targetIds", [])
      })
    }),
    dragOffset: ao(e.dragOffset, t),
    refCount: uo(e.refCount, t),
    dragOperation: co(e.dragOperation, t),
    stateId: po(e.stateId)
  };
}
function vo(e, t) {
  return {
...
function yo(e) {
  ...
  return !t || !a || !n ? null : hn(vo(t, n), a);
}
function bo(e) {
  var t = e.clientOffset, a = e.initialClientOffset;
  return !t || !a ? null : hn(t, a);
}
function Eo(e, t) {
  if (!(e instanceof t))
    throw new TypeError("Cannot call a class as a function");
...
var So = /* @__PURE__ */ function() {
  function e(t, a) {
    Eo(this, e), ma(this, "store", void 0), ma(this, "registry", void 0), this.store = t, this.registry = a;
  }
  return Do(e, [{
    ...
    value: function(a) {
      ...
      var i = this.store.getState().stateId, s = function() {
        ...
        try {
          var d = g === i || g === i + 1 && !fo(m.dirtyHandlerIds, o);
          d || a();
        } finally {
          i = g;
        }
    ...
    value: function() {
      return yo(this.store.getState().dragOffset);
    }
  }, {
...
const pa = typeof global < "u" ? global : self, vn = pa.MutationObserver || pa.WebKitMutationObserver;
function yn(e) {
  return function() {
...
function Oo(e) {
  let t = 1;
  const a = new vn(e), n = document.createTextNode("");
  return a.observe(n, {
    characterData: !0
  }), function() {
    t = -t, n.data = t;
...
class Io {
  ...
  constructor() {
    ...
    }, this.requestFlush = _o(this.flush), this.requestErrorThrow = yn(() => {
...
class No {
  create(t) {
    const a = this.freeTasks, n = a.length ? a.pop() : new ko(
      this.onError,
      (r) => a[a.length] = r
    );
    return n.task = t, n;
...
const bn = new Io(), Fo = new No(bn.registerPendingError);
function Ao(e) {
  bn.enqueueTask(Fo.create(e));
}
function Lo(e, t) {
  if (!(e instanceof t))
    throw new TypeError("Cannot call a class as a function");
...
function ya(e, t) {
  var a = e.entries(), n = !1;
  do {
    var r = a.next(), o = r.done, i = xo(r.value, 2), s = i[1];
    if (s === t)
      return !0;
    n = !!o;
  } while (!n);
...
var zo = /* @__PURE__ */ function() {
  function e(t) {
    Lo(this, e), Te(this, "types", /* @__PURE__ */ new Map()), Te(this, "dragSources", /* @__PURE__ */ new Map()), Te(this, "dropTargets", /* @__PURE__ */ new Map()), Te(this, "pinnedSourceId", null), Te(this, "pinnedSource", null), Te(this, "store", void 0), this.store = t;
  }
  return Po(e, [{
    key: "addSource",
    value: function(a, n) {
      ...
      return this.store.dispatch(no(r)), r;
    }
  }, {
    key: "addTarget",
    value: function(a, n) {
    ...
    value: function(a) {
      var n = this;
      N(this.getSource(a), "Expected an existing source."), this.store.dispatch(oo(a)), Ao(function() {
    ...
    key: "removeTarget",
    value: function(a) {
      N(this.getTarget(a), "Expected an existing target."), this.store.dispatch(io(a)), this.dropTargets.delete(a), this.types.delete(a);
    }
  }, {
    key: "pinSource",
    value: function(a) {
...
function Ho(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0, a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, n = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1, r = jo(n), o = new So(r, new zo(r)), i = new Xr(r, o), s = e(i, t, a);
...
var Ea = 0, je = Symbol.for("__REACT_DND_CONTEXT_INSTANCE__"), Jo = v.memo(function(t) {
  var a = t.children, n = Xo(t, qo), r = ei(n), o = Go(r, 2), i = o[0], s = o[1];
...
function ei(e) {
  ...
  var a = ti(e.backend, e.context, e.options, e.debugMode), n = !e.context;
  return [a, n];
}
function ti(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : En(), a = arguments.length > 2 ? arguments[2] : void 0, n = arguments.length > 3 ? arguments[3] : void 0, r = t;
  return r[je] || (r[je] = {
    dragDropManager: Ho(e, t, a, n)
  }), r[je];
}
function En() {
...
var st = !1, lt = !1, ri = /* @__PURE__ */ function() {
  function e(t) {
    ai(this, e), Sa(this, "internalMonitor", void 0), Sa(this, "sourceId", null), this.internalMonitor = t.getMonitor();
  }
  return ni(e, [{
...
var ct = !1, si = /* @__PURE__ */ function() {
  function e(t) {
    oi(this, e), Ta(this, "internalMonitor", void 0), Ta(this, "targetId", null), this.internalMonitor = t.getMonitor();
  }
  return ii(e, [{
    key: "receiveHandlerId",
    value: function(a) {
...
var Di = /* @__PURE__ */ function() {
  function e(t, a, n) {
    bi(this, e), ut(this, "spec", void 0), ut(this, "monitor", void 0), ut(this, "connector", void 0), this.spec = t, this.monitor = a, this.connector = n;
  }
  return Ei(e, [{
    key: "beginDrag",
    value: function() {
...
function Oe() {
  var e = v.useContext(pn), t = e.dragDropManager;
...
function Ii(e, t, a) {
  var n = Oe(), r = Si(e, t, a), o = wi(e);
  Ee(function() {
    if (o != null) {
      var s = yi(o, r, n), l = Ti(s, 2), m = l[0], g = l[1];
      return t.receiveHandlerId(m), a.receiveHandlerId(m), g;
    }
  }, [n, t, a, r, o]);
}
function ki(e) {
  return Li(e) || Ai(e) || Fi(e) || Ni();
}
function Ni() {
...
function zi(e, t, a) {
  var n = v.useState(function() {
    return t(e);
  }), r = Mi(n, 2), o = r[0], i = r[1], s = v.useCallback(function() {
    var l = t(e);
    sr(o, l) || (i(l), a && a());
  }, [o, e, a]);
  return Ee(s), [o, s];
...
function Qi(e, t, a) {
  var n = zi(e, t, a), r = Hi(n, 2), o = r[0], i = r[1];
  return Ee(function() {
...
function Xi(e, t) {
  ...
  var n = Pi(), r = xi(a.options, a.previewOptions);
  return Ii(a, n, r), [wn(a.collect, n, r), Zi(r), Ki(r)];
}
function Yi(e) {
  var t = e.accept;
  return v.useMemo(function() {
...
var ts = /* @__PURE__ */ function() {
  function e(t, a) {
    Ji(this, e), Aa(this, "spec", void 0), Aa(this, "monitor", void 0), this.spec = t, this.monitor = a;
  }
  return es(e, [{
    key: "canDrop",
    value: function() {
...
function ls(e, t, a) {
  var n = Oe(), r = as(e, t), o = Yi(e);
  Ee(function() {
    var s = vi(o, r, n), l = ns(s, 2), m = l[0], g = l[1];
    return t.receiveHandlerId(m), a.receiveHandlerId(m), g;
...
function fs(e, t) {
  var a = Sn(e, t), n = cs(), r = us(a.options);
  return ls(a, n, r), [wn(a.collect, n, r), ds(r)];
}
function Tn(e) {
...
var vs = /* @__PURE__ */ function() {
  function e(t) {
    gs(this, e), xa(this, "entered", []), xa(this, "isNodeInDocument", void 0), this.isNodeInDocument = t;
  }
  return hs(e, [{
    key: "enter",
    value: function(a) {
      ...
      return this.entered = ps(this.entered.filter(o), [a]), r === 0 && this.entered.length > 0;
    }
  }, {
    key: "leave",
    value: function(a) {
      var n = this.entered.length;
      return this.entered = ms(this.entered.filter(this.isNodeInDocument), a), n > 0 && this.entered.length === 0;
    }
  }, {
    key: "reset",
    value: function() {
...
var $a = /* @__PURE__ */ function() {
  function e(t, a) {
    bs(this, e), Fe(this, "xs", void 0), Fe(this, "ys", void 0), Fe(this, "c1s", void 0), Fe(this, "c2s", void 0), Fe(this, "c3s", void 0);
...
function Cn(e) {
  var t = e.nodeType === Ds ? e : e.parentElement;
  if (!t)
    return null;
...
function Ss(e) {
  var t;
  return e.nodeName === "IMG" && (ys() || !((t = document.documentElement) !== null && t !== void 0 && t.contains(e)));
}
function ws(e, t, a, n) {
  var r = e ? t.width : a, o = e ? t.height : n;
  return Rn() && e && (o /= window.devicePixelRatio, r /= window.devicePixelRatio), {
    dragPreviewWidth: r,
    dragPreviewHeight: o
  };
}
function Ts(e, t, a, n, r) {
  var o = Ss(t), i = o ? e : t, s = Cn(i), l = {
    x: a.x - s.x,
    y: a.y - s.y
  }, m = e.offsetWidth, g = e.offsetHeight, d = n.anchorX, S = n.anchorY, y = ws(o, t, m, g), T = y.dragPreviewWidth, O = y.dragPreviewHeight, p = function() {
    var C = new $a([0, 0.5, 1], [
      // Dock to the top
      l.y,
      // Align at the center
    ...
    return Rn() && o && (w += (window.devicePixelRatio - 1) * O), w;
  }, u = function() {
    var C = new $a([0, 0.5, 1], [
      // Dock to the left
      l.x,
...
var On = "__NATIVE_FILE__", _n = "__NATIVE_URL__", In = "__NATIVE_TEXT__", kn = "__NATIVE_HTML__";
...
var Os = /* @__PURE__ */ function() {
  function e(t) {
    Rs(this, e), Ua(this, "item", void 0), Ua(this, "config", void 0), this.config = t, this.item = {}, this.initializeExposedProperties();
  }
  return Cs(e, [{
...
var Ns = /* @__PURE__ */ function() {
  function e(t, a) {
    Is(this, e), mt(this, "ownerDocument", null), mt(this, "globalContext", void 0), mt(this, "optionsArgs", void 0), this.globalContext = t, this.optionsArgs = a;
  }
  return ks(e, [{
    key: "window",
    get: function() {
...
var Ls = /* @__PURE__ */ function() {
  function e(t, a, n) {
    ...
    }), this.options = new Ns(a, n), this.actions = t.getActions(), this.monitor = t.getMonitor(), this.registry = t.getRegistry(), this.enterLeaveCounter = new vs(this.isNodeInDocument);
  }
  return As(e, [{
    key: "profile",
    value: function() {
    ...
    value: function(a, n) {
      this.clearCurrentDragSourceNode(), this.currentNativeSource = _s(a, n), this.currentNativeHandle = this.registry.addSource(a, this.currentNativeSource), this.actions.beginDrag([this.currentNativeHandle]);
    }
  }, {
...
const Nn = v.createContext({}), pe = () => v.useContext(Nn), xs = ({ children: e }) => {
  var i, s, l;
  ...
  return /* @__PURE__ */ c.createElement(Nn.Provider, { value: o }, e);
}, Ms = "Dashboard Description", Qe = {
  data: {},
  loading: !1,
  filteredData: {},
  preview: !1,
  ...
  config: {},
  ...Qe
}, ee = v.createContext($s), ae = v.createContext(() => {
});
const Bs = ({ disableBgClose: e, children: t, override: a = null }) => {
  let { overlay: n } = pe();
  ...
  const { overlay: e } = pe();
  return /* @__PURE__ */ c.createElement(Bs, { disableBgClose: e.disableBgClose }, e.object);
}, Fn = v.createContext({}), Ve = {
  title: "Filtered Text",
  type: "filtered-text",
  theme: "theme-blue",
  fontSize: "small",
  ...
  const { config: t, updateConfig: a, loading: n, stateData: r, setParentConfig: o, isDashboard: i } = v.useContext(Fn), [s, l] = v.useState(!0), [m, g] = v.useState(!1), d = _t(t, a, !0), S = (D) => {
    let C = [...t.filters];
  ...
  ))))), /* @__PURE__ */ c.createElement(dr, { onClick: T, fluid: !0 }, "Add Filter")), /* @__PURE__ */ c.createElement(Me.Section, { title: "Visual" }, /* @__PURE__ */ c.createElement(
    ge,
    {
      value: t.fontSize,
      fieldName: "fontSize",
  ...
  ), /* @__PURE__ */ c.createElement("br", null), /* @__PURE__ */ c.createElement("label", null, /* @__PURE__ */ c.createElement("span", { className: "edit-label" }, "Theme"), /* @__PURE__ */ c.createElement("ul", { className: "color-palette" }, Us.map((D) => /* @__PURE__ */ c.createElement(
    "li",
    {
      title: D,
      key: D,
...
const An = ({ config: e, configUrl: t, isDashboard: a = !1, isEditor: n = !1, setConfig: r }) => {
  const o = new Se(), [i, s] = v.useState(Ve), [l, m] = v.useState(!0), [g, d] = v.useState(i.data || []), [S, y] = v.useState();
  let { title: T, filters: O } = i;
  const p = i.fontSize === "small" ? "16px" : i.fontSize === "medium" ? "22px" : "27px", { contentClasses: u, innerContainerClasses: h } = fr(i), f = async () => {
  ...
  if (l === !1) {
    ...
    D = /* @__PURE__ */ c.createElement(c.Fragment, null, n && /* @__PURE__ */ c.createElement(zs, null), w);
  }
  const C = {
    config: i,
    updateConfig: E,
  ...
  return /* @__PURE__ */ c.createElement(an, { component: "CdcFilteredText" }, /* @__PURE__ */ c.createElement(Fn.Provider, { value: C }, /* @__PURE__ */ c.createElement(ye.VisualizationWrapper, { config: i, isEditor: n, showEditorPanel: i == null ? void 0 : i.showEditorPanel }, D)));
}, he = {
...
const Ln = () => null, Pn = (e) => e, xn = () => null, me = ({ fontTheme: e = "dark", headerBgColor: t = "#fff", showDividerTop: a = !0, showDividerBottom: n = !0, showClose: r = !0, children: o, override: i = null }) => {
  let { overlay: s } = pe();
  const l = v.Children.toArray(o), m = l.find((y) => (y == null ? void 0 : y.type) === Ln), g = l.find((y) => (y == null ? void 0 : y.type) === Pn), d = l.find((y) => (y == null ? void 0 : y.type) === xn), S = (y) => y ? null : "none";
...
const Mn = ({ vizKey: e, rowIndex: t }) => {
    ...
    "button",
    {
      ...
      onClick: () => {
        r == null || r.actions.openOverlay(
          /* @__PURE__ */ React.createElement(Mn, { rowIndex: t.rowIdx, vizKey: t.uid })
        );
      }
    },
    he.gear
  ), /* @__PURE__ */ React.createElement("div", { className: "widget-menu-item", onClick: y }, /* @__PURE__ */ React.createElement(P, { display: "close", base: !0 }))), he[n], /* @__PURE__ */ React.createElement("span", null, js[n]), /* @__PURE__ */ React.createElement("span", null, e), (t == null ? void 0 : t.newViz) && n !== "dashboardFilters" && /* @__PURE__ */ React.createElement("span", { onClick: p, className: "config-needed" }, "Configuration needed"))));
}, qs = ({ data: e, rowIdx: t, colIdx: a }) => {
  var g;
  const { config: n } = v.useContext(ee), [{ isOver: r, canDrop: o }, i] = fs(
    () => ({
      accept: "vis-widget",
      drop: () => ({
        rowIdx: t,
  ...
  const { config: t } = v.useContext(ee), a = v.useContext(ae), n = I.cloneDeep(t.rows), r = t.rows[e], o = (d) => a({ type: "UPDATE_CONFIG", payload: [d] }), i = v.useMemo(() => r.toggle ? "toggle" : r.columns.reduce((d, S) => (S.width && (d += S.width), d), ""), [r]), s = (d, S = void 0) => {
    ...
    /* @__PURE__ */ c.createElement(
      ...
      /* @__PURE__ */ c.createElement(Gs, null)
    ),
    /* @__PURE__ */ c.createElement(
      "li",
      {
  ...
  return /* @__PURE__ */ c.createElement(c.Fragment, null, /* @__PURE__ */ c.createElement("div", { className: "builder-row", "data-row-id": t }, /* @__PURE__ */ c.createElement(Ys, { rowIdx: t }), /* @__PURE__ */ c.createElement(
    "button",
    {
      title: "Configure Data",
      className: "btn btn-configure-row",
      onClick: () => {
        n == null || n.actions.openOverlay(/* @__PURE__ */ c.createElement(Mn, { rowIndex: t }));
      }
    },
    he.gearMulti
  ), /* @__PURE__ */ c.createElement("div", { className: "column-container" }, e.columns.filter((i) => i.width).map((i, s) => /* @__PURE__ */ c.createElement(qs, { data: i, key: `row-${a}-col-${s}`, rowIdx: t, colIdx: s }))), /* @__PURE__ */ c.createElement("button", { className: "btn btn-primary footnotes", onClick: o }, e.footnotesId ? "Edit" : "Add", " Footnotes")));
}, el = () => {
  ...
  return /* @__PURE__ */ c.createElement("div", { className: "builder-grid" }, (t || []).map((o, i) => /* @__PURE__ */ c.createElement(Js, { row: o, idx: i, uuid: o.uuid, key: i })), /* @__PURE__ */ c.createElement("button", { className: "btn btn-primary col", onClick: r }, "Add Row"));
};
const tl = (e) => /* @__PURE__ */ React.createElement(me, null, /* @__PURE__ */ React.createElement(me.Content, null, /* @__PURE__ */ React.createElement("p", null, "Are you sure you want to delete this dashboard? "), /* @__PURE__ */ React.createElement("button", { className: "btn btn-danger", onClick: e }, "DELETE"))), al = ({ name: e, handleClick: t, tabs: a, index: n, active: r }) => {
  const [o, i] = v.useState(!1), s = v.useContext(ae), { overlay: l } = pe(), m = v.createRef(), g = (p) => {
    ...
    l == null || l.actions.openOverlay(tl(p));
  }, y = (p, u) => {
    const h = p + u;
  ...
  const { config: e } = v.useContext(ee), t = v.useContext(ae), a = v.useMemo(
    ...
    i.preventDefault(), t({ type: "SWITCH_CONFIG", payload: o }), pr("cove-tab", o);
  };
...
}, $n = ({ isEditor: e = !1 }) => e ? /* @__PURE__ */ React.createElement(nl, null) : /* @__PURE__ */ React.createElement(rl, null), se = (e) => {
  var T, O;
  ...
  )), !n && /* @__PURE__ */ React.createElement("div", { className: "toggle-bar__wrapper" }, /* @__PURE__ */ React.createElement($n, { isEditor: !0 }), /* @__PURE__ */ React.createElement("ul", { className: "toggle-bar" }, t.map((p) => /* @__PURE__ */ React.createElement(
    "li",
    {
      key: p,
...
const te = (e, t) => {
  ...
  const [e, t] = v.useState(!1), { config: a } = v.useContext(ee), n = v.useContext(ae), r = (o) => {
    ...
    n({ type: "APPLY_CONFIG", payload: [sl(i)] });
  };
...
function cl(e) {
  let t = 1;
  return e.forEach((a) => {
    a.tier = Bn(e, a), a.tier > t && (t = a.tier);
  }), t;
}
function Wa(e = [], t, a) {
...
const Ce = (e, t) => {
  ...
  return t.dashboard.sharedFilters && (t.dashboard.sharedFilters.forEach((i, s) => {
    const l = !!r.find((S) => S === i.setBy), m = t.dashboard.sharedFilters[s], g = (S) => {
      if (m.values = S, S.length > 0) {
        const y = m.pivot ? m.values : m.values[0], T = dn(m);
        T ? m.active = T : m.active = m.active || y;
      }
    }, d = ul(i.columnName, a || e.data);
...
}, Vn = typeof window < "u" && window.__REDUX_DEVTOOLS_EXTENSION__, dl = Vn ? window.__REDUX_DEVTOOLS_EXTENSION__.connect() : null, pt = Vn ? dl : null, Un = (e) => (t, a) => {
  const n = e(t, a);
  ...
  switch (t.type) {
    ...
    case "ADD_NEW_DASHBOARD": {
      const a = e.config.multiDashboards, n = "New Dashboard " + (a.length + 1), r = [...a, { ...fl(), label: n }];
      return Ae(e, r);
    }
    case "UPDATE_CONFIG": {
...
const zn = ({ children: e, visualizationKey: t, visualizationConfig: a, type: n, component: r, updateConfig: o, viewport: i }) => {
  ...
  return /* @__PURE__ */ React.createElement(cr, { allowZeroExpanded: !0 }, /* @__PURE__ */ React.createElement(at, null, /* @__PURE__ */ React.createElement(nt, null, /* @__PURE__ */ React.createElement(rt, null, "Filters")), /* @__PURE__ */ React.createElement(ot, null, /* @__PURE__ */ React.createElement(Yn, { config: e, updateField: a, rawData: e.originalFormattedData }))), /* @__PURE__ */ React.createElement(at, null, /* @__PURE__ */ React.createElement(nt, null, /* @__PURE__ */ React.createElement(rt, null, "Columns")), /* @__PURE__ */ React.createElement(ot, null, /* @__PURE__ */ React.createElement(or, { config: e, updateField: a, deleteColumn: n }))), /* @__PURE__ */ React.createElement(at, null, /* @__PURE__ */ React.createElement(nt, null, /* @__PURE__ */ React.createElement(rt, null, "Data Table")), /* @__PURE__ */ React.createElement(ot, null, /* @__PURE__ */ React.createElement(ir, { config: e, columns: r, updateField: a, isDashboard: !0 }))));
}, Mt = ({
  visualizationKey: e,
  config: t,
  updateConfig: a,
  ...
  return v.useEffect(() => {
    ...
    /* @__PURE__ */ React.createElement(vl, { key: e, config: t, updateConfig: a })
...
const yl = ({ active: e, row: t, visualizations: a, setToggled: n }) => {
  const r = (o, i = null) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "toggle-component" }, t.columns.map((o, i) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { role: "radio", className: l ? "selected" : "", key: i, onClick: () => r(i), onKeyUp: (m) => r(i, m), "aria-checked": l, tabIndex: 0, "aria-label": `Toggle ${s}` }, Hs(a[o.widget]), " ", /* @__PURE__ */ React.createElement("span", null, I.capitalize(s)));
  }));
}, Hn = {
  Apply: "Apply Button",
  ...
  return n.length && n.forEach((r) => {
    e[r].active = "", e[r].subGrouping && (e[r].subGrouping.active = "");
  }), n;
}, bl = (e, t, a, n) => {
  const r = I.cloneDeep(a), o = r[e];
  if (n.filterBehavior !== Hn.Apply || n.autoLoad)
    if ((o == null ? void 0 : o.filterStyle) === oe.nestedDropdown)
      r[e].active = t[0], r[e].subGrouping.active = t[1];
    else {
      r[e].active = t, Qa(r, e);
      const i = It();
      o.setByQueryParameter && i[o.setByQueryParameter] !== o.active && (i[o.setByQueryParameter] = o.active, fn(i));
    }
  else
    r[e].queuedActive = t;
  return [r, Qa(r, e)];
...
}, Ze = (e) => Object.values(e).some((t) => t.filterBehavior === "Apply Button" && t.type === "dashboardFilters"), El = ({
  filter: e,
  config: t,
  isDashboard: a = !1,
  updateFilterProp: n
...
}, Dl = ({ filter: e, filterIndex: t, config: a, updateFilterProp: n }) => {
  ...
  if (a.includes(r) || n.type === "urlfilter")
    return n;
  const o = I.cloneDeep(n), i = wl(Tl(n), t);
  ...
  const { config: a, loadAPIFilters: n, data: r } = v.useContext(ee), { overlay: o } = pe(), {
    ...
    if (f[u][p] = h, p === "columnName") {
      ...
      p === "filterStyle" ? (f[u] = {
        ...
        setByQueryParameter: "",
        valuesLookup: {}
      }), n(f, {})) : (mn(f[u]), l({ type: "SET_SHARED_FILTERS", payload: f }));
  }, T = (p) => {
  ...
  return /* @__PURE__ */ React.createElement(rr, { allowZeroExpanded: !0 }, /* @__PURE__ */ React.createElement(Kt, null, /* @__PURE__ */ React.createElement(Xt, null, /* @__PURE__ */ React.createElement(Yt, null, "General")), /* @__PURE__ */ React.createElement(Jt, null, /* @__PURE__ */ React.createElement(
    gt,
    {
...
}, Cl = (e) => e.replace(/"/g, ""), Ol = (e) => String(e).match(/^[-]?[0-9\.]+$/), Ct = (e, t) => {
  const a = e.includes("?");
  return t.filter(({ value: n }) => n !== "").map(({ key: n, value: r }, o) => {
    const i = o === 0 && !a ? "?" : "&", s = n.match(/\$.*/);
    return Ol(r) || s ? i + n + "=" + r : i + n + `="${Cl(r)}"`;
  }).join("");
}, _l = (e, t, a = []) => e.reduce((n, r, o) => {
...
}, qn = (e) => e == null ? void 0 : e.some(({ value: t }) => t === ""), Il = (e, t) => {
...
const Al = (e, t) => {
  ...
  const o = v.useContext(ee), { config: i, reloadURLData: s, loadAPIFilters: l, setAPIFilterDropdowns: m, setAPILoading: g } = o, d = v.useContext(ae), S = (b) => {
    ...
    if (!D.sharedFilters.some((R, F) => C.includes(F) ? !R.active && !R.queuedActive : !1)) {
      if (Ze(o.config.visualizations)) {
        ...
        D.sharedFilters.forEach((z) => {
          z.queuedActive && (yr(z), z.setByQueryParameter && R[z.setByQueryParameter] !== z.active && (R[z.setByQueryParameter] = Array.isArray(z.active) ? z.active.join(",") : z.active, F = !0));
        }), F && fn(R);
      }
    ...
    if (d({ type: "SET_SHARED_FILTERS", payload: w }), Ze(i.visualizations)) {
      const F = t.autoLoad, z = C.dashboard.sharedFilters.some((ce) => !ce.active), q = w.filter((ce) => ce.apiFilter).map((ce) => ce.apiFilter.apiEndpoint), V = _l(
        q,
        e,
        R
      );
  ...
  return h && !r ? /* @__PURE__ */ React.createElement(React.Fragment, null) : /* @__PURE__ */ React.createElement(ye.VisualizationWrapper, { config: t, isEditor: r, currentViewport: n }, r && /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Rl, { updateConfig: a, vizConfig: t })
    ...
    /* @__PURE__ */ React.createElement(
      Er,
      {
        ...
        filters: Al(i.dashboard.sharedFilters, o.data) || [],
        apiFilterDropdowns: e,
        handleOnChange: y,
        showSubmit: t.filterBehavior === Hn.Apply && !t.autoLoad,
        applyFilters: S,
  ...
  if (s)
    ...
    o.data = n[l] || [], o.formattedData && (o.formattedData = Ll.developerStandardize(o.data, o.dataDescription) || o.data);
  }
  return o;
}, Pl = ({ config: e, updateField: t }) => {
  var m, g, d, S, y, T;
  const a = () => {
  ...
  if (n)
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(Pl, { key: e, config: t, updateField: o })
    );
  const i = v.useMemo(() => {
  ...
  return /* @__PURE__ */ React.createElement(Sr, { footnotes: [...i, ...s] });
}, xl = ({
  allExpanded: e,
  fontSize: t,
  groupName: a,
  ...
  const [o, i] = v.useState(e), s = ["xs", "xxs"].includes(n) ? "13px" : `${tr}px`;
  return v.useEffect(() => {
    i(e);
    ...
    "div",
    {
      style: { fontSize: s },
      role: "button",
      className: `multi-visualiation-heading${o ? "" : " collapsed"} h4`,
      onClick: () => {
        i(!o);
      },
      tabIndex: 0,
...
}, Ul = (e, t) => Object.keys(e).reduce((a, n) => {
  const r = e[n].dataKey;
  return t[r] && (a[n].formattedData = t[r]), a;
}, I.cloneDeep(e)), zl = (e, t, a, n) => {
  var o, i;
...
}, Hl = ({ setAllExpanded: e }) => /* @__PURE__ */ React.createElement("div", { className: "d-block " }, /* @__PURE__ */ React.createElement("div", { className: "d-flex flex-row-reverse mb-2" }, /* @__PURE__ */ React.createElement("button", { className: "btn expand-collapse-buttons", onClick: () => e(!1) }, "- Collapse All"), /* @__PURE__ */ React.createElement("button", { className: "btn expand-collapse-buttons me-2", onClick: () => e(!0) }, "+ Expand All"))), jl = (e, t, a, n) => {
  const r = (o, i, s, l = 50) => {
    if (!o)
      return;
    ...
    const d = o.filter((p) => p.apiFilter), S = new Map(d.map((p) => [p.apiFilter.apiEndpoint, p.apiFilter])), y = kl(o, i), T = Object.values(y).reduce(
      (p, [u]) => ({ ...p, [u]: null }),
      {}
    );
    a((p) => ({ ...p, ...T }));
    ...
    return Promise.all(
      Object.keys(y).map(
        (p) => new Promise((u) => {
          fetch(p).then((h) => h.json()).then((h) => {
            ...
            const [f, E] = y[p], b = S.get(f), D = Il(h, b);
            O[f] = D;
            const C = Za(
              E,
              D,
      ...
      const u = p.some(({ error: f }) => f), h = o.reduce((f, E, b) => g.includes(b) && !E.active ? qn(jn(E, o)) ? f : [...f, b] : f, []);
...
function Gl({ initialState: e, isEditor: t = !1, isDebug: a = !1 }) {
  var ce, $t, Bt, Vt, Ut, zt, Ht, jt, qt, Gt, Wt, Qt, Zt;
  const [n, r] = v.useReducer(pl, e), [o, i] = v.useReducer(hl, []), s = v.useContext(rn), [l, m] = v.useState({}), [g, d] = v.useState("lg"), [S] = v.useState(`cove-${Math.random().toString(16).slice(-4)}`), [y, T] = v.useState(!0), [O, p] = v.useState(!1), u = n.tabSelected === "Dashboard Preview", h = v.useMemo(() => {
    const _ = Ya(n.config).map((k) => n.data[k]);
    return _.length ? _.some((k) => k === void 0) : !0;
  }, [n.data]), f = xt(n.config.rows), E = new Se(), b = v.useMemo(() => Object.values(n.config.visualizations).filter((_) => _.type === "dashboardFilters").reduce((_, k) => k.autoLoad ? [..._, ...k.sharedFilterIndexes] : _, []), [n.config.visualizations]), D = jl(
    r,
    i,
    m,
    b
    ...
    for (let W = 0; W < M.length; W++) {
      ...
      if (ue.dataUrl && U) {
        ...
        U.forEach((B) => {
          var Q;
          if (B.type === "urlfilter" && zl(B, j, k.visualizations, k.rows)) {
            if (B.filterBy === "File Name" && (H = Vl(H, B, j)), B.queryParameter && (X[B.queryParameter] ? X[B.queryParameter] = X[B.queryParameter] + B.active : X[B.queryParameter] = B.active), B.setByQueryParameter) {
              const we = Object.fromEntries(new URLSearchParams(window.location.search))[B.setByQueryParameter], Zn = ((Q = B.apiFilter) == null ? void 0 : Q.valueSelector) || B.setByQueryParameter;
              we && (X[Zn] = we);
            }
  ...
  v.useEffect(() => {
    var M;
    const { config: _ } = n, k = ql(_, t && !u), U = Rt(_.dashboard.sharedFilters, n.data);
  ...
  if (t && !u) {
    ...
    be(n.config).forEach((k) => {
      var G;
      const U = (G = f[k]) == null ? void 0 : G.row, M = Qn(
        k,
        U,
        n.config,
        n.data,
    ...
    }), _ || (q = /* @__PURE__ */ c.createElement(Jo, { backend: Ps }, /* @__PURE__ */ c.createElement("div", { className: "header-container" }, /* @__PURE__ */ c.createElement(se, null), /* @__PURE__ */ c.createElement(ll, null)), /* @__PURE__ */ c.createElement("div", { className: "layout-container" }, /* @__PURE__ */ c.createElement(el, null))));
  } else {
    const { config: _ } = n, { title: k, description: U } = _.dashboard || {}, M = _.rows && _.rows.filter((A) => A.columns.filter(($) => $.widget).length !== 0);
    q = /* @__PURE__ */ c.createElement(c.Fragment, null, t && /* @__PURE__ */ c.createElement(se, null), O && /* @__PURE__ */ c.createElement(Dr, { fullScreen: !0 }), /* @__PURE__ */ c.createElement($n, { isEditor: t && !u }), o.map((A, $) => /* @__PURE__ */ c.createElement(
      lr,
      {
        type: "danger",
      ...
      if (A.multiVizColumn && (u || !t)) {
        ...
        return H.forEach((W) => {
          ...
          Z[j] || (Z[j] = []), Z[j].push(W);
        }), /* @__PURE__ */ c.createElement(c.Fragment, null, !h && A.expandCollapseAllButtons === !0 && /* @__PURE__ */ c.createElement(Hl, { setAllExpanded: T }), Object.keys(Z).map((W) => {
          const j = Z[W];
          return /* @__PURE__ */ c.createElement(
            Ka,
            {
  ...
  return /* @__PURE__ */ c.createElement(xs, null, /* @__PURE__ */ c.createElement(
    ee.Provider,
    {
      value: {
        ...n,
    ...
    /* @__PURE__ */ c.createElement(ae.Provider, { value: r }, /* @__PURE__ */ c.createElement("div", { className: V.join(" "), ref: z, "data-download-id": S }, q), /* @__PURE__ */ c.createElement(Vs, null))
  ));
}
const Ja = {
  dashboard: {
...
}, Cc = ({ configUrl: e, isEditor: t, isDebug: a, config: n }) => {
  ...
  const g = (y) => {
    ...
    if (y.datasets)
      return g(T);
    {
      const O = T.dataFileName || "backwards-compatibility", p = await Wl(y), u = {};
      if (u[O] = {
        data: p,
  ...
  return r ? /* @__PURE__ */ React.createElement(Gl, { isEditor: t, isDebug: a, initialState: r }) : /* @__PURE__ */ React.createElement(Ot, null);
};
export {
  xs as G,
  Cc as M,
