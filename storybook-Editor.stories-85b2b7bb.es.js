...
import { C as Lt, E as Ot, J as Ar, j as Nr, M as Dr, a as Rr, t as Tr, i as Er, d as Pr, b as Ea, G as Ir, O as kr } from "./storybook-CdcDashboard-86b6dc63.es.js";
import { P as Qn } from "./storybook-index-43433e35.es.js";
import { S as Lr } from "./storybook-usa-region-graphic-ecaa401d.es.js";
import { a as Or } from "./storybook-axios-01170075.es.js";
import { D as Hr } from "./storybook-index-964548d8.es.js";
import { c as lr } from "./storybook-_commonjsHelpers-c5d32002.es.js";
import { a as Pa, d as Ia, e as Br, f as Fr, S as Wr, g as xr, h as Gr, i as Vr, j as ka, k as qr, l as Kr } from "./storybook-Icon-58d1c99f.es.js";
import { f as La } from "./storybook-fetchRemoteData-6254352f.es.js";
import { D as zr } from "./storybook-DataDesigner-31ee8381.es.js";
import { T as en } from "./storybook-Tooltip-edc0f7ab.es.js";
import { E as lt } from "./storybook-Loading-f180d060.es.js";
import { _ as ga } from "./storybook-queryStringUtils-a03213e7.es.js";
import "./storybook-index-e5bf02db.es.js";
import "./storybook-Button-d74e310e.es.js";
import "./storybook-DataTable-342d2d1f.es.js";
...
function Yr(o) {
  ...
  if (c && !o.type) {
    var y = p.split(".").pop().toLowerCase(), A = jr.get(y);
...
function Jr(o) {
  return ct(this, void 0, void 0, function() {
    return dt(this, function(p) {
      return Po(o) && $r(o) ? [2, eu(o.dataTransfer, o.type)] : Zr(o) ? [2, Qr(o)] : Array.isArray(o) && o.every(function(c) {
      ...
      switch (A.label) {
        case 0:
          return o === null ? [2, []] : o.items ? (c = ma(o.items).filter(function(E) {
            return E.kind === "file";
          }), p !== "drop" ? [2, c] : [4, Promise.all(c.map(tu))]) : [3, 2];
        case 1:
          return y = A.sent(), [2, Oa(sr(y))];
        case 2:
          return [2, Oa(ma(o.files).map(function(E) {
            return Ht(E);
          }))];
      }
    });
...
function tu(o) {
  ...
  return p && p.isDirectory ? cr(p) : Ha(o);
}
function sr(o) {
  return o.reduce(function(p, c) {
    return Xr(p, Array.isArray(c) ? sr(c) : [c]);
  }, []);
}
function Ha(o) {
  var p = o.getAsFile();
...
function ou(o) {
  return ct(this, void 0, void 0, function() {
    return dt(this, function(p) {
      return [2, o.isDirectory ? cr(o) : au(o)];
    });
  });
}
function cr(o) {
          ...
          return dt(this, function(b) {
            switch (b.label) {
              ...
              case 4:
                return [3, 6];
              case 5:
                En = Promise.all(O.map(ou)), A.push(En), E(), b.label = 6;
              case 6:
                return [
                  2
                  /*return*/
...
function Fa(o) {
  for (var p = 1; p < arguments.length; p++) {
    ...
    p % 2 ? Ba(Object(c), !0).forEach(function(y) {
      dr(o, y, c[y]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(c)) : Ba(Object(c)).forEach(function(y) {
...
var cu = "file-invalid-type", du = "file-too-large", yu = "file-too-small", Cu = "too-many-files", pu = function(p) {
...
function yr(o, p) {
  var c = o.type === "application/x-moz-file" || ru(o, p);
  return [c, c ? null : pu(p)];
}
function Cr(o, p, c) {
  if (Pt(o.size))
    if (Pt(p) && Pt(c)) {
...
function gu(o) {
  ...
  return !E && p.length > 1 || E && d >= 1 && p.length > d ? !1 : p.every(function(O) {
    var Rn = yr(O, c), w = Wa(Rn, 1), En = w[0], b = Cr(O, y, A), rn = Wa(b, 1), gn = rn[0];
    return En && gn;
  });
}
function Io(o) {
...
var wu = ["children"], bu = ["open"], Mu = ["refKey", "role", "onKeyDown", "onFocus", "onBlur", "onClick", "onDragEnter", "onDragOver", "onDragLeave", "onDrop"], Au = ["refKey", "onChange", "onClick"];
function Nu(o) {
  return Tu(o) || Ru(o) || pr(o) || Du();
}
function Du() {
...
function te(o) {
  for (var p = 1; p < arguments.length; p++) {
    var c = arguments[p] != null ? arguments[p] : {};
    p % 2 ? za(Object(c), !0).forEach(function(y) {
      ha(o, y, c[y]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(c)) : za(Object(c)).forEach(function(y) {
      Object.defineProperty(o, y, Object.getOwnPropertyDescriptor(c, y));
    });
  }
  return o;
...
var Aa = /* @__PURE__ */ M.forwardRef(function(o, p) {
  var c = o.children, y = ko(o, wu), A = wa(y), E = A.open, d = ko(A, bu);
...
function wa() {
  var o = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, p = te(te({}, fr), o), c = p.accept, y = p.disabled, A = p.getFilesFromEvent, E = p.maxSize, d = p.minSize, O = p.multiple, Rn = p.maxFiles, w = p.onDragEnter, En = p.onDragLeave, b = p.onDragOver, rn = p.onDrop, gn = p.onDropAccepted, dn = p.onDropRejected, mn = p.onFileDialogCancel, qn = p.onFileDialogOpen, yn = p.useFsAccessApi, Bn = p.preventDropOnDocument, Mn = p.noClick, Un = p.noKeyboard, Vn = p.noDrag, Nn = p.noDragEventsBubbling, Wn = p.validator, vn = M.useMemo(function() {
    return typeof qn == "function" ? qn : _a;
  }, [qn]), le = M.useMemo(function() {
    return typeof mn == "function" ? mn : _a;
  }, [mn]), $n = M.useRef(null), xn = M.useRef(null), oe = M.useReducer(Lu, Sa), se = ya(oe, 2), ne = se[0], ee = se[1], Te = ne.isFocused, Ne = ne.isFileDialogActive, he = ne.draggedFiles, Ee = function() {
  ...
  M.useEffect(function() {
    return Bn && (document.addEventListener("dragover", qa, !1), document.addEventListener("drop", Pe, !1)), function() {
      Bn && (document.removeEventListener("dragover", qa), document.removeEventListener("drop", Pe));
    };
  }, [$n, Bn]);
  var ce = M.useCallback(function(Z) {
    Z.preventDefault(), Z.persist(), Le(Z), ge.current = [].concat(Nu(ge.current), [Z.target]), Ao(Z) && Promise.resolve(A(Z)).then(function(Pn) {
      Io(Z) && !Nn || (ee({
        draggedFiles: Pn,
        isDragActive: !0,
  ...
  }, [A, w, Nn]), be = M.useCallback(function(Z) {
    ...
    return Pn && b && b(Z), !1;
  }, [b, Nn]), Me = M.useCallback(function(Z) {
    Z.preventDefault(), Z.persist(), Le(Z);
  ...
  }, [$n, En, Nn]), De = M.useCallback(function(Z, Pn) {
    var ae = [], de = [];
    Z.forEach(function(me) {
      var He = yr(me, c), Re = ya(He, 2), je = Re[0], Ye = Re[1], Ue = Cr(me, d, E), Ge = ya(Ue, 2), Je = Ge[0], Ve = Ge[1], qe = Wn ? Wn(me) : null;
      if (je && Je && !qe)
        ae.push(me);
      else {
        var Be = [Ye, Ve];
  ...
  }, [A, De, Nn]), F = M.useCallback(function() {
    if (yn && Ka()) {
      ee({
        type: "openDialog"
      }), vn();
  ...
  }, [ee, vn, le, yn, De, c, O]), V = M.useCallback(function(Z) {
    ...
    Nn && Pn.stopPropagation();
  }, Oe = M.useMemo(function() {
    return function() {
      var Z = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, Pn = Z.refKey, ae = Pn === void 0 ? "ref" : Pn, de = Z.role, me = Z.onKeyDown, He = Z.onFocus, Re = Z.onBlur, je = Z.onClick, Ye = Z.onDragEnter, Ue = Z.onDragOver, Ge = Z.onDragLeave, Je = Z.onDrop, Ve = ko(Z, Mu);
      return te(te(ha({
    ...
    return function() {
      var Z = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, Pn = Z.refKey, ae = Pn === void 0 ? "ref" : Pn, de = Z.onChange, me = Z.onClick, He = ko(Z, Au), Re = ha({
        accept: c,
        multiple: O,
        type: "file",
        style: {
  ...
  }, [xn, c, O, Se, y]), xe = he.length, Jn = xe > 0 && gu({
    files: he,
    accept: c,
    minSize: d,
    maxSize: E,
...
function Bu(o) {
  ...
  return isNaN(o) ? "Invalid Date" : Hu(o.getUTCFullYear()) + "-" + we(o.getUTCMonth() + 1, 2) + "-" + we(o.getUTCDate(), 2) + (A ? "T" + we(p, 2) + ":" + we(c, 2) + ":" + we(y, 2) + "." + we(A, 3) + "Z" : y ? "T" + we(p, 2) + ":" + we(c, 2) + ":" + we(y, 2) + "Z" : c || p ? "T" + we(p, 2) + ":" + we(c, 2) + "Z" : "");
}
function Fu(o) {
  var p = new RegExp('["' + o + `
\r]`), c = o.charCodeAt(0);
  function y(b, rn) {
    var gn, dn, mn = A(b, function(qn, yn) {
      if (gn)
        return gn(qn, yn - 1);
      dn = qn, gn = rn ? Ou(qn, rn) : gr(qn);
    });
    return mn.columns = dn || [], mn;
  }
  function A(b, rn) {
    var gn = [], dn = b.length, mn = 0, qn = 0, yn, Bn = dn <= 0, Mn = !1;
    b.charCodeAt(dn - 1) === It && --dn, b.charCodeAt(dn - 1) === fa && --dn;
    function Un() {
      if (Bn)
        return Ca;
      if (Mn)
        return Mn = !1, Xa;
      var Nn, Wn = mn, vn;
      if (b.charCodeAt(Wn) === pa) {
        for (; mn++ < dn && b.charCodeAt(mn) !== pa || b.charCodeAt(++mn) === pa; )
          ;
        return (Nn = mn) >= dn ? Bn = !0 : (vn = b.charCodeAt(mn++)) === It ? Mn = !0 : vn === fa && (Mn = !0, b.charCodeAt(mn) === It && ++mn), b.slice(Wn + 1, Nn - 1).replace(/""/g, '"');
      }
      for (; mn < dn; ) {
        if ((vn = b.charCodeAt(Nn = mn++)) === It)
          Mn = !0;
        else if (vn === fa)
          Mn = !0, b.charCodeAt(mn) === It && ++mn;
        else if (vn !== c)
          continue;
        return b.slice(Wn, Nn);
      }
      return Bn = !0, b.slice(Wn, dn);
    }
    for (; (yn = Un()) !== Ca; ) {
      for (var Vn = []; yn !== Xa && yn !== Ca; )
        Vn.push(yn), yn = Un();
  ...
  function d(b, rn) {
    return rn == null && (rn = ja(b)), [rn.map(En).join(o)].concat(E(b, rn)).join(`
`);
  }
  function O(b, rn) {
    return rn == null && (rn = ja(b)), E(b, rn).join(`
`);
  }
  function Rn(b) {
    return b.map(w).join(`
`);
  ...
  function En(b) {
    return b == null ? "" : b instanceof Date ? Bu(b) : p.test(b += "") ? '"' + b.replace(/"/g, '""') + '"' : b;
  }
  return {
    parse: y,
    parseRows: A,
  ...
  return Ya || (Ya = 1, function(o, p) {
    (function(c, y) {
      ...
      function A(n, r, l, s, v, g, h) {
        try {
          var D = n[g](h), T = D.value;
        } catch (P) {
          return void l(P);
        }
        D.done ? r(T) : Promise.resolve(T).then(s, v);
      }
      function E(n) {
        return function() {
      ...
      var dn = function(n, r) {
        return r === void 0 && (r = {}), function(l) {
          return l === void 0 && (l = {}), [].concat(n, [l]).reduce(function(s, v) {
            return function g(h, D, T) {
              return typeof D == "function" ? g({}, D(h, T)) : Array.isArray(D) ? gn.apply(void 0, [h].concat(D)) : gn(h, D);
            }(s, v, d({}, r, { userProps: l }));
          }, {});
        };
      }, mn = function(n, r, l, s) {
      ...
      function $n(n) {
        ...
        if (typeof l == "string") {
          ...
          var v = l.split(".");
          l = function(g) {
            return function(h, D, T) {
              if (!D)
                return h;
              var P, q = typeof D == "function" ? D : JSON.stringify(D), W = se.get(q) || function() {
                var x = function(k) {
      ...
      function We(n) {
        var r = n.columns, l = n.flatHeaders, s = n.dispatch, v = n.allColumns, g = n.getHooks, h = n.state.hiddenColumns, D = n.autoResetHiddenColumns, T = D === void 0 || D, P = Mn(n), q = v.length === h.length, W = y.useCallback(function(U, un) {
      ...
      function de(n) {
        var r = n.initialState, l = r === void 0 ? xe : r, s = n.defaultColumn, v = s === void 0 ? Jn : s, g = n.getSubRows, h = g === void 0 ? Z : g, D = n.getRowId, T = D === void 0 ? Pn : D, P = n.stateReducer, q = P === void 0 ? _n : P, W = n.useControlledState, x = W === void 0 ? ae : W;
      ...
      function me(n, r) {
        ...
        return n.forEach(function(h) {
          ...
          if (h.totalLeft = r, D && D.length) {
            var T = me(D, r), P = T[0], q = T[1], W = T[2], x = T[3];
      ...
      function He(n) {
        var r = n.data, l = n.rows, s = n.flatRows, v = n.rowsById, g = n.column, h = n.getRowId, D = n.getSubRows, T = n.accessValueHooks, P = n.getInstance;
        r.forEach(function(q, W) {
          return function x(k, B, X, U, un) {
            ...
            else if ((K = { id: ln, original: In, index: B, depth: X, cells: [{}] }).cells.map = ge, K.cells.filter = ge, K.cells.forEach = ge, K.cells[0].getCellProps = ge, K.values = {}, un.push(K), s.push(K), v[ln] = K, K.originalSubRows = D(k, B), K.originalSubRows) {
              var Dn = [];
              K.originalSubRows.forEach(function(tn, wn) {
                return x(tn, wn, X + 1, K, Dn);
              }), K.subRows = Dn;
            }
      ...
      function Ge(n) {
        var r = n.data, l = n.rows, s = n.rowsById, v = n.manualExpandedKey, g = v === void 0 ? "expanded" : v, h = n.paginateExpandedRows, D = h === void 0 || h, T = n.expandSubRows, P = T === void 0 || T, q = n.autoResetExpanded, W = q === void 0 || q, x = n.getHooks, k = n.plugins, B = n.state.expanded, X = n.dispatch;
        ...
        var In = y.useCallback(function(Gn, Cn) {
          ...
          return D ? Ne(l, { manualExpandedKey: g, expanded: B, expandSubRows: P }) : l;
        }, [D, l, g, B, P]), Dn = y.useMemo(function() {
          return function(Gn) {
            var Cn = 0;
        ...
        Object.assign(n, { preExpandedRows: l, expandedRows: K, rows: K, expandedDepth: Dn, isAllRowsExpanded: un, toggleRowExpanded: In, toggleAllRowsExpanded: ln, getToggleAllRowsExpandedProps: wn });
      }
      function Je(n, r) {
      ...
      function Oo(n, r, l, s) {
        ...
        if (r.type === w.setFilter) {
          var v = r.columnId, g = r.filterValue, h = s.allColumns, D = s.filterTypes, T = h.find(function(X) {
            return X.id === v;
          });
          if (!T)
            throw new Error("React-Table: Could not find a column with id: " + v);
          var P = he(T.filter, D || {}, $e), q = n.filters.find(function(X) {
            return X.id === v;
          }), W = Bn(g, q && q.value);
      ...
      function Vt(n) {
        var r = n.data, l = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.filterTypes, D = n.manualFilters, T = n.defaultCanFilter, P = T !== void 0 && T, q = n.disableFilters, W = n.state.filters, x = n.dispatch, k = n.autoResetFilters, B = k === void 0 || k, X = y.useCallback(function(tn, wn) {
        ...
        }, [D, W, l, s, v, g, h]), In = un[0], ln = un[1], K = un[2];
        y.useMemo(function() {
        ...
        var Dn = Mn(B);
        Vn(function() {
          Dn() && x({ type: w.resetFilters });
        }, [x, D ? null : r]), Object.assign(n, { preFilteredRows: l, preFilteredFlatRows: s, preFilteredRowsById: v, filteredRows: In, filteredFlatRows: ln, filteredRowsById: K, rows: In, flatRows: ln, rowsById: K, setFilter: X, setAllFilters: U });
      }
      ...
      function qt(n, r, l, s) {
        ...
        if (r.type === w.setGlobalFilter) {
          var v = r.filterValue, g = s.userFilterTypes, h = he(s.globalFilter, g || {}, $e), D = Bn(v, n.globalFilter);
          return Ee(h.autoRemove, D) ? (n.globalFilter, O(n, ["globalFilter"])) : d({}, n, { globalFilter: D });
        }
      }
      function Kt(n) {
        var r = n.data, l = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.filterTypes, D = n.globalFilter, T = n.manualGlobalFilter, P = n.state.globalFilter, q = n.dispatch, W = n.autoResetGlobalFilter, x = W === void 0 || W, k = n.disableGlobalFilter, B = y.useCallback(function(K) {
          q({ type: w.setGlobalFilter, filterValue: K });
        }, [q]), X = y.useMemo(function() {
          if (T || P === void 0)
            return [l, s, v];
          var K = [], Dn = {}, tn = he(D, h || {}, $e);
          if (!tn)
          ...
          return [function Gn(Cn) {
            return (Cn = tn(Cn, wn.map(function(hn) {
              ...
              K.push(hn), Dn[hn.id] = hn, hn.subRows = hn.subRows && hn.subRows.length ? Gn(hn.subRows) : hn.subRows;
            }), Cn;
          }(l), K, Dn];
        }, [T, P, D, h, g, l, s, v, k]), U = X[0], un = X[1], In = X[2], ln = Mn(x);
        Vn(function() {
      ...
      var Ho = {};
      function Bo(n) {
        var r = n.data, l = n.rows, s = n.flatRows, v = n.rowsById, g = n.allColumns, h = n.flatHeaders, D = n.groupByFn, T = D === void 0 ? Ut : D, P = n.manualGroupBy, q = n.aggregations, W = q === void 0 ? Ho : q, x = n.plugins, k = n.state.groupBy, B = n.dispatch, X = n.autoResetGroupBy, U = X === void 0 || X, un = n.disableGroupBy, In = n.defaultCanGroupBy, ln = n.getHooks;
        ...
        var Dn = y.useCallback(function(u, a) {
        ...
        var wn = y.useMemo(function() {
          ...
          var u = k.filter(function(I) {
          ...
          }), a = [], f = {}, m = [], C = {}, S = [], N = {}, R = function I(z, H, G) {
            ...
            return Object.entries(L).map(function(Q, cn) {
              ...
              return Fn.forEach(function(sn) {
                a.push(sn), f[sn.id] = sn, sn.isGrouped ? (m.push(sn), C[sn.id] = sn) : (S.push(sn), N[sn.id] = sn);
              }), $;
            });
          }(l);
          return R.forEach(function(I) {
            a.push(I), f[I.id] = I, I.isGrouped ? (m.push(I), C[I.id] = I) : (S.push(I), N[I.id] = I);
          }), [R, a, f, m, C, S, N];
        }, [P, k, l, s, v, g, W, T]), Gn = wn[0], Cn = wn[1], hn = wn[2], zn = wn[3], An = wn[4], Kn = wn[5], e = wn[6], t = Mn(U);
        Vn(function() {
          t() && B({ type: w.resetGroupBy });
        }, [B, P ? null : r]), Object.assign(n, { preGroupedRows: l, preGroupedFlatRow: s, preGroupedRowsById: v, groupedRows: Gn, groupedFlatRows: Cn, groupedRowsById: hn, onlyGroupedFlatRows: zn, onlyGroupedRowsById: An, nonGroupedFlatRows: Kn, nonGroupedRowsById: e, rows: Gn, flatRows: Cn, rowsById: hn, toggleGroupBy: Dn, setGroupBy: tn });
      }
      function Yt(n) {
      ...
      var Fo = Object.freeze({ __proto__: null, alphanumeric: function(n, r, l) {
        ...
        for (v = $t(v), g = $t(g), v = v.split(Jt).filter(Boolean), g = g.split(Jt).filter(Boolean); v.length && g.length; ) {
          var h = v.shift(), D = g.shift(), T = parseInt(h, 10), P = parseInt(D, 10), q = [T, P].sort();
          if (isNaN(q[0])) {
            if (h > D)
              return 1;
            if (D > h)
        ...
        for (v = v.split("").filter(Boolean), g = g.split("").filter(Boolean); v.length && g.length; ) {
          var h = v.shift(), D = g.shift(), T = h.toLowerCase(), P = D.toLowerCase();
          if (T > P)
            return 1;
          if (P > T)
            return -1;
      ...
      function xo(n, r, l, s) {
        ...
        if (r.type === w.toggleSortBy) {
          var v, g = r.columnId, h = r.desc, D = r.multi, T = s.allColumns, P = s.disableMultiSort, q = s.disableSortRemove, W = s.disableMultiRemove, x = s.maxMultiSortColCount, k = x === void 0 ? Number.MAX_SAFE_INTEGER : x, B = n.sortBy, X = T.find(function(K) {
            return K.id === g;
          ...
          return (v = !P && D ? U ? "toggle" : "add" : un !== B.length - 1 || B.length !== 1 ? "replace" : U ? "toggle" : "replace") != "toggle" || q || In || D && W || !(U && U.desc && !X || !U.desc && X) || (v = "remove"), v === "replace" ? ln = [{ id: g, desc: In ? h : X }] : v === "add" ? (ln = [].concat(B, [{ id: g, desc: In ? h : X }])).splice(0, ln.length - k) : v === "toggle" ? ln = B.map(function(K) {
      ...
      function Go(n) {
        var r = n.data, l = n.rows, s = n.flatRows, v = n.allColumns, g = n.orderByFn, h = g === void 0 ? Qt : g, D = n.sortTypes, T = n.manualSortBy, P = n.defaultCanSort, q = n.disableSortBy, W = n.flatHeaders, x = n.state.sortBy, k = n.dispatch, B = n.plugins, X = n.getHooks, U = n.autoResetSortBy, un = U === void 0 || U;
        ...
        var Dn = y.useMemo(function() {
          ...
          return [function zn(An) {
            var Kn = h(An, hn.map(function(e) {
              ...
              var u = t.sortType, a = ee(u) || (D || {})[u] || Fo[u];
              if (!a)
        ...
        }, [T, x, l, s, v, h, D]), tn = Dn[0], wn = Dn[1], Gn = Mn(un);
        Vn(function() {
      ...
      function Qt(n, r, l) {
        return [].concat(n).sort(function(s, v) {
          for (var g = 0; g < r.length; g += 1) {
            var h = r[g], D = l[g] === !1 || l[g] === "desc", T = h(s, v);
            if (T !== 0)
              return D ? -T : T;
          }
      ...
      function Vo(n, r, l, s) {
        ...
        if (r.type === w.gotoPage) {
          var v = s.pageCount, g = s.page, h = Bn(r.pageIndex, n.pageIndex), D = !1;
      ...
      function qo(n) {
        var r = n.rows, l = n.autoResetPage, s = l === void 0 || l, v = n.manualExpandedKey, g = v === void 0 ? "expanded" : v, h = n.plugins, D = n.pageCount, T = n.paginateExpandedRows, P = T === void 0 || T, q = n.expandSubRows, W = q === void 0 || q, x = n.state, k = x.pageSize, B = x.pageIndex, X = x.expanded, U = x.globalFilter, un = x.filters, In = x.groupBy, ln = x.sortBy, K = n.dispatch, Dn = n.data, tn = n.manualPagination;
        yn(h, ["useGlobalFilter", "useFilters", "useGroupBy", "useSortBy", "useExpanded"], "usePagination");
        var wn = Mn(s);
        Vn(function() {
          wn() && K({ type: w.resetPage });
        }, [K, tn ? null : Dn, U, un, In, ln]);
        var Gn = tn ? D : Math.ceil(r.length / k), Cn = y.useMemo(function() {
          ...
          return P ? a : Ne(a, { manualExpandedKey: g, expanded: X, expandSubRows: W });
      ...
      function Jo(n) {
        var r = n.columns, l = n.allColumns, s = n.flatHeaders, v = n.getHooks, g = n.plugins, h = n.dispatch, D = n.autoResetPivot, T = D === void 0 || D, P = n.manaulPivot, q = n.disablePivot, W = n.defaultCanPivot;
      ...
      function Zo(n, r, l, s) {
        ...
        if (r.type === w.toggleAllRowsSelected) {
          var v = r.value, g = s.isAllRowsSelected, h = s.rowsById, D = s.nonGroupedRowsById, T = D === void 0 ? h : D, P = v !== void 0 ? v : !g, q = Object.assign({}, n.selectedRowIds);
        ...
        if (r.type === w.toggleAllPageRowsSelected) {
          var K = r.value, Dn = s.page, tn = s.rowsById, wn = s.selectSubRows, Gn = wn === void 0 || wn, Cn = s.isAllPageRowsSelected, hn = s.getSubRows, zn = K !== void 0 ? K : !Cn, An = d({}, n.selectedRowIds);
          return Dn.forEach(function(Kn) {
            return function e(t) {
              var u = tn[t];
      ...
      function ro(n) {
        var r = n.data, l = n.rows, s = n.getHooks, v = n.plugins, g = n.rowsById, h = n.nonGroupedRowsById, D = h === void 0 ? g : h, T = n.autoResetSelectedRows, P = T === void 0 || T, q = n.state.selectedRowIds, W = n.selectSubRows, x = W === void 0 || W, k = n.dispatch, B = n.page, X = n.getSubRows;
        ...
        }, [l, x, q, X]), un = !!(Object.keys(D).length && Object.keys(q).length), In = un;
        un && Object.keys(D).some(function(hn) {
          return !q[hn];
        ...
        }, [k]), Dn = y.useCallback(function(hn) {
        ...
        Object.assign(n, { selectedFlatRows: U, isAllRowsSelected: un, isAllPageRowsSelected: In, toggleRowSelected: tn, toggleAllRowsSelected: K, getToggleAllRowsSelectedProps: Gn, getToggleAllPageRowsSelectedProps: Cn, toggleAllPageRowsSelected: Dn });
      }
      function Qo(n, r) {
        var l = r.instance;
      ...
      function na(n, r, l, s) {
        var v = s.initialRowStateAccessor, g = v === void 0 ? uo : v, h = s.initialCellStateAccessor, D = h === void 0 ? io : h, T = s.rowsById;
        if (r.type === w.init)
          return d({ rowState: {} }, n);
        ...
        if (r.type === w.setCellState) {
          var k, B, X, U, un, In = r.rowId, ln = r.columnId, K = r.value, Dn = n.rowState[In] !== void 0 ? n.rowState[In] : g(T[In]), tn = (Dn == null || (k = Dn.cellState) == null ? void 0 : k[ln]) !== void 0 ? Dn.cellState[ln] : D((B = T[In]) == null || (X = B.cells) == null ? void 0 : X.find(function(wn) {
            return wn.column.id === ln;
          }));
          return d({}, n, { rowState: d({}, n.rowState, (un = {}, un[In] = d({}, Dn, { cellState: d({}, Dn.cellState || {}, (U = {}, U[ln] = Bn(K, tn), U)) }), un)) });
        }
      }
      function lo(n) {
        ...
        Vn(function() {
          D() && v({ type: w.resetRowState });
        }, [s]), Object.assign(n, { setRowState: g, setCellState: h });
      }
      function ea(n, r) {
        var l = r.instance, s = l.initialRowStateAccessor, v = s === void 0 ? uo : s, g = l.initialCellStateAccessor, h = g === void 0 ? io : g, D = l.state.rowState;
        n && (n.state = D[n.id] !== void 0 ? D[n.id] : v(n), n.setState = function(T) {
      ...
      function yo(n, r) {
        ...
        for (var s = [].concat(l), v = [].concat(n), g = [], h = function() {
          var D = s.shift(), T = v.findIndex(function(P) {
            return P.id === D;
          });
      ...
      var Co = function(n) {
        ...
        var l = r.instance, s = r.header, v = l.dispatch, g = function(h, D) {
          var T = !1;
          ...
          var P, q, W = function(ln) {
            var K = [];
            return function Dn(tn) {
              tn.columns && tn.columns.length && tn.columns.map(Dn), K.push(tn);
            }(ln), K;
          }(D).map(function(ln) {
          ...
          document.addEventListener(un.moveEvent, un.moveHandler, In), document.addEventListener(un.upEvent, un.upHandler, In), v({ type: w.columnStartResizing, columnId: D.id, columnWidth: D.totalWidth, headerIdWidths: W, clientX: x });
        };
      ...
      function aa(n, r) {
        ...
        if (r.type === w.columnResizing) {
          var h = r.clientX, D = n.columnResizing, T = D.startX, P = D.columnWidth, q = D.headerIdWidths, W = (h - T) / P, x = {};
      ...
      var ra = function(n) {
        ...
        r.forEach(function(h) {
          var D = ne(h.disableResizing !== !0 && void 0, l !== !0 && void 0, !0);
          h.canResize = D, h.width = v.columnWidths[h.id] || h.originalWidth || h.width, h.isResizing = v.isResizingColumn === h.id, D && (h.getResizerProps = dn(s().getResizerProps, { instance: g(), header: h }));
        });
      };
      function ua(n) {
      ...
      function Nt(n) {
        n.getTableProps.push(ia), n.getRowProps.push(Dt), n.getHeaderGroupProps.push(Dt), n.getFooterGroupProps.push(Dt), n.getHeaderProps.push(la), n.getCellProps.push(sa), n.getFooterProps.push(ca);
      }
      ...
      function So(n, r, l, s) {
        ...
        if (r.type === w.columnStartResizing) {
          ...
          if (h !== void 0) {
            var D = s.visibleColumns.reduce(function(K, Dn) {
              var tn;
              return d({}, K, ((tn = {})[Dn.id] = Rt(Dn.id), tn));
            }, {}), T = s.visibleColumns.reduce(function(K, Dn) {
              var tn;
              return d({}, K, ((tn = {})[Dn.id] = Dn.minWidth, tn));
            }, {}), P = s.visibleColumns.reduce(function(K, Dn) {
              var tn;
              return d({}, K, ((tn = {})[Dn.id] = Dn.maxWidth, tn));
            }, {}), q = g.map(function(K) {
              var Dn = K[0];
              return [Dn, Rt(Dn)];
            });
            return d({}, n, { gridLayout: d({}, n.gridLayout, { startWidths: D, minWidths: T, maxWidths: P, headerIdGridWidths: q, columnWidth: h }) });
          }
          return n;
        }
        if (r.type === w.columnResizing) {
          ...
          return (un === void 0 ? [] : un).forEach(function(K) {
            var Dn = K[0], tn = K[1];
            ln[Dn] = Math.min(Math.max(X[Dn], tn + tn * In), U[Dn]);
      ...
      c._UNSTABLE_usePivotColumns = ht, c.actions = w, c.defaultColumn = rn, c.defaultGroupByFn = Ut, c.defaultOrderByFn = Qt, c.defaultRenderer = En, c.emptyRenderer = b, c.ensurePluginOrder = yn, c.flexRender = Wn, c.functionalUpdate = Bn, c.loopHooks = qn, c.makePropGetter = dn, c.makeRenderer = Nn, c.reduceHooks = mn, c.safeUseLayoutEffect = Un, c.useAbsoluteLayout = po, c.useAsyncDebounce = function(n, r) {
        r === void 0 && (r = 0);
        var l = y.useRef({}), s = Mn(n), v = Mn(r);
        return y.useCallback(function() {
          var g = E(regeneratorRuntime.mark(function h() {
            var D, T, P, q = arguments;
            return regeneratorRuntime.wrap(function(W) {
              for (; ; )
                switch (W.prev = W.next) {
                  case 0:
                    for (D = q.length, T = new Array(D), P = 0; P < D; P++)
                      T[P] = q[P];
      ...
      }, c.useBlockLayout = fo, c.useColumnOrder = so, c.useExpanded = Re, c.useFilters = Gt, c.useFlexLayout = Nt, c.useGetLatest = Mn, c.useGlobalFilter = pt, c.useGridLayout = go, c.useGroupBy = mt, c.useMountedLayoutEffect = Vn, c.usePagination = vt, c.useResizeColumns = Co, c.useRowSelect = oo, c.useRowState = wt, c.useSortBy = Zt, c.useTable = function(n) {
        ...
        var D = g(), T = D.data, P = D.columns, q = D.initialState, W = D.defaultColumn, x = D.getSubRows, k = D.getRowId, B = D.stateReducer, X = D.useControlledState, U = Mn(B), un = y.useCallback(function(C, S) {
          if (!S.type)
            throw console.info({ action: S }), new Error("Unknown Action 👆");
          return [].concat(h().stateReducers, Array.isArray(U()) ? U() : [U()]).reduce(function(N, R) {
            return R(N, S, C, g()) || N;
          }, C);
        }, [h, U, g]), In = y.useReducer(un, void 0, function() {
          return un(q, { type: w.init });
        }), ln = In[0], K = In[1], Dn = mn([].concat(h().useControlledState, [X]), ln, { instance: g() });
        Object.assign(g(), { state: Dn, dispatch: K });
        ...
        var Gn = y.useMemo(function() {
          for (var C = [], S = [], N = {}, R = [].concat(wn); R.length; ) {
            var I = R.shift();
            He({ data: T, rows: C, flatRows: S, rowsById: N, column: I, getRowId: k, getSubRows: x, accessValueHooks: h().accessValue, getInstance: g });
          }
          return [C, S, N];
        ...
        return g().totalColumnsMinWidth = a, g().totalColumnsWidth = f, g().totalColumnsMaxWidth = m, qn(h().useInstance, g()), [].concat(g().flatHeaders, g().allColumns).forEach(function(C) {
          C.render = Nn(g(), C), C.getHeaderProps = dn(h().getHeaderProps, { instance: g(), column: C }), C.getFooterProps = dn(h().getFooterProps, { instance: g(), column: C });
        }), g().headerGroups = y.useMemo(function() {
          return Kn.filter(function(C, S) {
            return C.headers = C.headers.filter(function(N) {
              return N.headers ? function R(I) {
          ...
          C.getRowProps = dn(h().getRowProps, { instance: g(), row: C }), C.allCells = wn.map(function(S) {
            var N = C.values[S.id], R = { column: S, row: C, value: N };
            return R.getCellProps = dn(h().getCellProps, { instance: g(), cell: R }), R.render = Nn(g(), S, { row: C, cell: R, value: N }), R;
          }), C.cells = An.map(function(S) {
            return C.allCells.find(function(N) {
              return N.column.id === S.id;
            });
  ...
  return Ua || (Ua = 1, function(o, p) {
    (function(c, y) {
      ...
      function A(e, t, u, a, f, m, C) {
        try {
          var S = e[m](C), N = S.value;
        } catch (R) {
          u(R);
          return;
        }
        S.done ? t(N) : Promise.resolve(N).then(a, f);
      }
      function E(e) {
        return function() {
...
`);
                              ...
                              return regeneratorRuntime.wrap(function(L) {
                                for (; ; )
                                  switch (L.prev = L.next) {
                                    case 0:
                                      return delete u.current.timeout, L.prev = 1, L.t0 = u.current, L.next = 5, a().apply(void 0, N);
                                    case 5:
      ...
      function De(e, t) {
        var u = t.manualExpandedKey, a = t.expanded, f = t.expandSubRows, m = f === void 0 ? !0 : f, C = [], S = function N(R, I) {
      ...
      function Re(e) {
        ...
        a.current;
        var f = function C(S, N) {
          S.isVisible = N && !u.includes(S.id);
          var R = 0;
      ...
      function je(e) {
        var t = e.columns, u = e.flatHeaders, a = e.dispatch, f = e.allColumns, m = e.getHooks, C = e.state.hiddenColumns, S = e.autoResetHiddenColumns, N = S === void 0 ? !0 : S, R = Nn(e), I = f.length === C.length, z = y.useCallback(function(Q, cn) {
          return a({
      ...
      function Be(e) {
        var t = e.initialState, u = t === void 0 ? Ye : t, a = e.defaultColumn, f = a === void 0 ? Ue : a, m = e.getSubRows, C = m === void 0 ? Je : m, S = e.getRowId, N = S === void 0 ? Ve : S, R = e.stateReducer, I = R === void 0 ? Ge : R, z = e.useControlledState, H = z === void 0 ? qe : z, G = O(e, ["initialState", "defaultColumn", "getSubRows", "getRowId", "stateReducer", "useControlledState"]);
        return d({}, G, {
          initialState: u,
          defaultColumn: f,
          getSubRows: C,
      ...
      var at = function(t) {
        ...
        var N = C(), R = N.data, I = N.columns, z = N.initialState, H = N.defaultColumn, G = N.getSubRows, _ = N.getRowId, L = N.stateReducer, Q = N.useControlledState, cn = Nn(L), fn = y.useCallback(function(pn, Zn) {
          if (!Zn.type)
            throw console.info({
              action: Zn
      ...
      function yt(e, t) {
        ...
        return e.forEach(function(C) {
          ...
          if (C.totalLeft = t, S && S.length) {
            var N = yt(S, t), R = N[0], I = N[1], z = N[2], H = N[3];
      ...
      function Bt(e) {
        var t = e.data, u = e.rows, a = e.flatRows, f = e.rowsById, m = e.column, C = e.getRowId, S = e.getSubRows, N = e.accessValueHooks, R = e.getInstance, I = function z(H, G, _, L, Q) {
          _ === void 0 && (_ = 0);
          ...
          m.accessor && (Y.values[m.id] = m.accessor(H, G, Y, Q, t)), Y.values[m.id] = Bn(N, Y.values[m.id], {
            row: Y,
            column: m,
            instance: R()
          }, !0);
      ...
      function $e(e) {
        var t = e.data, u = e.rows, a = e.rowsById, f = e.manualExpandedKey, m = f === void 0 ? "expanded" : f, C = e.paginateExpandedRows, S = C === void 0 ? !0 : C, N = e.expandSubRows, R = N === void 0 ? !0 : N, I = e.autoResetExpanded, z = I === void 0 ? !0 : I, H = e.getHooks, G = e.plugins, _ = e.state.expanded, L = e.dispatch;
        Un(G, ["useSortBy", "useGroupBy", "usePivotColumns", "useGlobalFilter"], "useExpanded");
        var Q = Nn(z), cn = !!(Object.keys(a).length && Object.keys(_).length);
        ...
        var fn = y.useCallback(function($, sn) {
          ...
          return Oo(_);
        }, [_]), J = Nn(e), j = yn(H().getToggleAllRowsExpandedProps, {
          instance: J()
        });
        Object.assign(e, {
          preExpandedRows: u,
      ...
      function Ho(e, t, u, a) {
        ...
        if (t.type === b.setFilter) {
          var f = t.columnId, m = t.filterValue, C = a.allColumns, S = a.filterTypes, N = C.find(function(L) {
            return L.id === f;
          });
          if (!N)
            throw new Error("React-Table: Could not find a column with id: " + f);
          var R = Se(N.filter, S || {}, Ze), I = e.filters.find(function(L) {
            return L.id === f;
          }), z = Vn(m, I && I.value);
          return F(R.autoRemove, z, N) ? d({}, e, {
      ...
      function Bo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, f = e.rowsById, m = e.allColumns, C = e.filterTypes, S = e.manualFilters, N = e.defaultCanFilter, R = N === void 0 ? !1 : N, I = e.disableFilters, z = e.state.filters, H = e.dispatch, G = e.autoResetFilters, _ = G === void 0 ? !0 : G, L = y.useCallback(function(J, j) {
          H({
            type: b.setFilter,
            columnId: J,
            filterValue: j
      ...
      function Jt(e) {
        var t = e.data, u = e.rows, a = e.flatRows, f = e.rowsById, m = e.allColumns, C = e.filterTypes, S = e.globalFilter, N = e.manualGlobalFilter, R = e.state.globalFilter, I = e.dispatch, z = e.autoResetGlobalFilter, H = z === void 0 ? !0 : z, G = e.disableGlobalFilter, _ = y.useCallback(function(Tn) {
          I({
          ...
          return [$(u), Tn, Fn];
        }, [N, R, S, C, m, u, a, f, G]), Q = L[0], cn = L[1], fn = L[2], Y = Nn(H);
        vn(function() {
          Y() && I({
            type: b.resetGlobalFilter
          });
        }, [I, N ? null : t]), Object.assign(e, {
      ...
      var _o = {};
      function Xo(e) {
        var t = e.data, u = e.rows, a = e.flatRows, f = e.rowsById, m = e.allColumns, C = e.flatHeaders, S = e.groupByFn, N = S === void 0 ? eo : S, R = e.manualGroupBy, I = e.aggregations, z = I === void 0 ? _o : I, H = e.plugins, G = e.state.groupBy, _ = e.dispatch, L = e.autoResetGroupBy, Q = L === void 0 ? !0 : L, cn = e.disableGroupBy, fn = e.defaultCanGroupBy, Y = e.getHooks;
        ...
        var j = y.useMemo(function() {
          ...
          var Sn = G.filter(function(Ce) {
            ...
            var ze = Sn[fe], re = N(Ke, ze), bo = Object.entries(re).map(function(it, da) {
        ...
        }, [R, G, u, a, f, m, z, N]), $ = j[0], sn = j[1], kn = j[2], On = j[3], jn = j[4], on = j[5], ye = j[6], Hn = Nn(Q);
        vn(function() {
          Hn() && _({
            type: b.resetGroupBy
          });
      ...
      var to = /([0-9]+)/gm, Yo = function(t, u, a) {
        ...
        for (m = ao(m), C = ao(C), m = m.split(to).filter(Boolean), C = C.split(to).filter(Boolean); m.length && C.length; ) {
          var S = m.shift(), N = C.shift(), R = parseInt(S, 10), I = parseInt(N, 10), z = [R, I].sort();
          if (isNaN(z[0])) {
            if (S > N)
              return 1;
            if (N > S)
      ...
      function $o(e, t, u) {
        ...
        for (f = f.split("").filter(Boolean), m = m.split("").filter(Boolean); f.length && m.length; ) {
          var C = f.shift(), S = m.shift(), N = C.toLowerCase(), R = S.toLowerCase();
          if (N > R)
            return 1;
          if (R > N)
            return -1;
      ...
      function uo(e, t, u, a) {
        ...
        if (t.type === b.toggleSortBy) {
          var S = t.columnId, N = t.desc, R = t.multi, I = a.allColumns, z = a.disableMultiSort, H = a.disableSortRemove, G = a.disableMultiRemove, _ = a.maxMultiSortColCount, L = _ === void 0 ? Number.MAX_SAFE_INTEGER : _, Q = e.sortBy, cn = I.find(function($) {
            return $.id === S;
          }), fn = cn.sortDescFirst, Y = Q.find(function($) {
            return $.id === S;
          }), Tn = Q.findIndex(function($) {
            return $.id === S;
          }), Fn = typeof N < "u" && N !== null, J = [], j;
      ...
      function io(e) {
        var t = e.data, u = e.rows, a = e.flatRows, f = e.allColumns, m = e.orderByFn, C = m === void 0 ? wt : m, S = e.sortTypes, N = e.manualSortBy, R = e.defaultCanSort, I = e.disableSortBy, z = e.flatHeaders, H = e.state.sortBy, G = e.dispatch, _ = e.plugins, L = e.getHooks, Q = e.autoResetSortBy, cn = Q === void 0 ? !0 : Q;
        ...
        var Fn = y.useMemo(function() {
          ...
          return [On(u), sn];
        }, [N, H, u, a, f, C, S]), J = Fn[0], j = Fn[1], $ = Nn(cn);
        vn(function() {
          $() && G({
            type: b.resetSortBy
          });
      ...
      function wt(e, t, u) {
        return [].concat(e).sort(function(a, f) {
          for (var m = 0; m < t.length; m += 1) {
            var C = t[m], S = u[m] === !1 || u[m] === "desc", N = C(a, f);
            if (N !== 0)
              return S ? -N : N;
          }
      ...
      function ea(e, t, u, a) {
        ...
        if (t.type === b.setPageSize) {
          var N = t.pageSize, R = e.pageSize * e.pageIndex, I = Math.floor(R / N);
          return d({}, e, {
            pageIndex: I,
            pageSize: N
          });
      ...
      function Mt(e) {
        var t = e.columns, u = e.allColumns, a = e.flatHeaders, f = e.getHooks, m = e.plugins, C = e.dispatch, S = e.autoResetPivot, N = S === void 0 ? !0 : S, R = e.manaulPivot, I = e.disablePivot, z = e.defaultCanPivot;
      ...
      var Nt = function(t) {
        t.getToggleRowSelectedProps = [ia], t.getToggleAllRowsSelectedProps = [Dt], t.getToggleAllPageRowsSelectedProps = [la], t.stateReducers.push(sa), t.useInstance.push(ca), t.prepareRow.push(go);
      };
      Nt.pluginName = fo;
      var ia = function(t, u) {
      ...
      function sa(e, t, u, a) {
        ...
        if (t.type === b.toggleAllRowsSelected) {
          var f = t.value, m = a.isAllRowsSelected, C = a.rowsById, S = a.nonGroupedRowsById, N = S === void 0 ? C : S, R = typeof f < "u" ? f : !m, I = Object.assign({}, e.selectedRowIds);
          return R ? Object.keys(N).forEach(function(Hn) {
            I[Hn] = !0;
          }) : Object.keys(N).forEach(function(Hn) {
            delete I[Hn];
          }), d({}, e, {
            selectedRowIds: I
          });
      ...
      function ca(e) {
        var t = e.data, u = e.rows, a = e.getHooks, f = e.plugins, m = e.rowsById, C = e.nonGroupedRowsById, S = C === void 0 ? m : C, N = e.autoResetSelectedRows, R = N === void 0 ? !0 : N, I = e.state.selectedRowIds, z = e.selectSubRows, H = z === void 0 ? !0 : z, G = e.dispatch, _ = e.page, L = e.getSubRows;
        ...
        }, [G]), j = Nn(e), $ = yn(a().getToggleAllRowsSelectedProps, {
          instance: j()
      ...
      function Rt(e, t, u, a) {
        var f = a.initialRowStateAccessor, m = f === void 0 ? vo : f, C = a.initialCellStateAccessor, S = C === void 0 ? ho : C, N = a.rowsById;
        if (t.type === b.init)
          return d({
            rowState: {}
          }, e);
        ...
        if (t.type === b.setRowState) {
          var R, I = t.rowId, z = t.value, H = typeof e.rowState[I] < "u" ? e.rowState[I] : m(N[I]);
          return d({}, e, {
            rowState: d({}, e.rowState, (R = {}, R[I] = Vn(z, H), R))
          });
        }
        if (t.type === b.setCellState) {
          var G, _, L, Q, cn, fn = t.rowId, Y = t.columnId, Tn = t.value, Fn = typeof e.rowState[fn] < "u" ? e.rowState[fn] : m(N[fn]), J = typeof (Fn == null || (G = Fn.cellState) == null ? void 0 : G[Y]) < "u" ? Fn.cellState[Y] : S((_ = N[fn]) == null || (L = _.cells) == null ? void 0 : L.find(function(j) {
      ...
      function n(e) {
        var t = e.autoResetRowState, u = t === void 0 ? !0 : t, a = e.data, f = e.dispatch, m = y.useCallback(function(N, R) {
          return f({
            type: b.setRowState,
            rowId: N,
            value: R
          });
        }, [f]), C = y.useCallback(function(N, R, I) {
          return f({
            type: b.setCellState,
            rowId: N,
            columnId: R,
      ...
      function r(e, t) {
        ...
        e && (e.state = typeof S[e.id] < "u" ? S[e.id] : f(e), e.setState = function(N) {
          return u.setRowState(e.id, N);
        }, e.cells.forEach(function(N) {
          e.state.cellState || (e.state.cellState = {}), N.state = typeof e.state.cellState[N.column.id] < "u" ? e.state.cellState[N.column.id] : C(N), N.setState = function(R) {
            return u.setCellState(e.id, N.column.id, R);
          };
        }));
      }
      ...
      function v(e, t) {
        ...
        for (var a = [].concat(u), f = [].concat(e), m = [], C = function() {
          var N = a.shift(), R = f.findIndex(function(I) {
            return I.id === N;
          });
      ...
      var h = function(t) {
        ...
        var a = u.instance, f = u.header, m = a.dispatch, C = function(N, R) {
          var I = !1;
          ...
          }), G = I ? Math.round(N.touches[0].clientX) : N.clientX, _, L, Q = function() {
      ...
      function T(e, t) {
        ...
        if (t.type === b.columnResizing) {
          var C = t.clientX, S = e.columnResizing, N = S.startX, R = S.columnWidth, I = S.headerIdWidths, z = I === void 0 ? [] : I, H = C - N, G = H / R, _ = {};
      ...
      var P = function(t) {
        var u = t.flatHeaders, a = t.disableResizing, f = t.getHooks, m = t.state.columnResizing, C = Nn(t);
        u.forEach(function(S) {
          var N = ce(S.disableResizing === !0 ? !1 : void 0, a === !0 ? !1 : void 0, !0);
          S.canResize = N, S.width = m.columnWidths[S.id] || S.originalWidth || S.width, S.isResizing = m.isResizingColumn === S.id, N && (S.getResizerProps = yn(f().getResizerProps, {
            instance: C(),
            header: S
          }));
        });
      ...
      function In(e) {
        e.getTableProps.push(ln), e.getRowProps.push(K), e.getHeaderGroupProps.push(K), e.getFooterGroupProps.push(K), e.getHeaderProps.push(Dn), e.getCellProps.push(tn), e.getFooterProps.push(wn);
      }
      ...
      function An(e, t, u, a) {
        ...
        if (t.type === b.columnStartResizing) {
          ...
          if (C !== void 0) {
            ...
            }, {}), N = a.visibleColumns.reduce(function(J, j) {
              var $;
...
function zu(o, p, c) {
  ...
  }, [qn, mn, Mn, Bn, Un, p]), Nn = M.useCallback(function() {
...
}, yi = () => Na.maps.map((o) => /* @__PURE__ */ i.createElement(vr, { key: o.fileName, text: o.text, fileName: o.fileName, data: o.data })), Ci = () => Na.charts.map((o) => /* @__PURE__ */ i.createElement(vr, { key: o.fileName, text: o.text, fileName: o.fileName, data: o.data })), pi = () => {
...
function fi() {
  const { config: o, errors: p, tempConfig: c, sharepath: y } = M.useContext(Lt), A = (F) => {
  ...
  }, d = new Hr(), [O, Rn] = M.useState(o.dataFileSourceType === "url" ? o.dataFileName : o.dataUrl || ""), [w, En] = M.useState(!!o.dataUrl), [b, rn] = M.useState(o.type === "dashboard" || !o.data), [gn, dn] = M.useState(void 0), [mn, qn] = M.useState(), yn = M.useContext(Ot), Bn = {
    ".csv": "text/csv",
    ".json": "application/json"
    ...
    return V;
  }, Nn = ([F]) => Wn(F, gn, gn), Wn = async (F = null, V, nn) => {
  ...
  const vn = (F, V, nn, an) => {
    ...
    En(F);
  }, { getRootProps: $n, getInputProps: xn, isDragActive: oe } = wa({ onDrop: Nn }), { getRootProps: se, getInputProps: ne, isDragActive: ee } = wa({ onDrop: Nn }), Te = (F, V) => /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("form", { className: "input-group d-flex", onSubmit: (nn) => nn.preventDefault() }, /* @__PURE__ */ i.createElement("input", { id: "external-data", type: "text", className: "form-control flex-grow-1 border-right-0", placeholder: "e.g., https://data.cdc.gov/resources/file.json", "aria-label": "Load data from external URL", "aria-describedby": "load-data", value: O, onChange: (nn) => Rn(nn.target.value) }), /* @__PURE__ */ i.createElement("button", { className: "input-group-text btn btn-primary px-4", type: "submit", id: "load-data", onClick: () => Wn(null, O, V) }, "Load")), /* @__PURE__ */ i.createElement("label", { htmlFor: "keep-url", className: "mt-1 d-flex keep-url" }, /* @__PURE__ */ i.createElement("input", { type: "checkbox", id: "keep-url", checked: w, onChange: () => le(!w, V) }), " Always load from URL (normally will only pull once)")), Ne = (F = {}, V = "Are you sure you want to do this?") => {
    F.newViz = !0, window.confirm(V) === !0 && (yn({ type: "EDITOR_SAVE", payload: F }), rn(!0));
  }, he = () => (
    //todo convert to modal
    /* @__PURE__ */ i.createElement(i.Fragment, null, /* @__PURE__ */ i.createElement("button", { className: "btn danger", onClick: () => Ne({ type: o.type, visualizationType: o.visualizationType }, "Resetting will remove your data and settings. Do you want to continue?") }, "Clear", /* @__PURE__ */ i.createElement(Ia, null)), o.dataFileSourceType === "file" && /* @__PURE__ */ i.createElement("div", { className: "link link-replace", ...se() }, /* @__PURE__ */ i.createElement("input", { ...ne() }), /* @__PURE__ */ i.createElement("p", null, /* @__PURE__ */ i.createElement("span", null, "or replace file"))))
  ), Ee = (F, V, nn) => {
    let an = { ...o.datasets };
  ...
  const De = /* @__PURE__ */ i.createElement(i.Fragment, null, o.filters && o.filters.map(
...
function Di() {
  ...
  return /* @__PURE__ */ i.createElement("div", { className: "choose-vis" }, /* @__PURE__ */ i.createElement("a", { href: "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/index.html", target: "_blank", rel: "noopener noreferrer", className: "guidance-link", style: { marginTop: 0, marginBottom: "2rem" } }, /* @__PURE__ */ i.createElement("div", null, /* @__PURE__ */ i.createElement("p", null, "For more information on the types of data visualizations in the WCMS, including examples and best practices, ", /* @__PURE__ */ i.createElement("u", null, "see the WCMS Features Gallery"), "."))), /* @__PURE__ */ i.createElement("div", { className: "heading-2" }, "General"), /* @__PURE__ */ i.createElement("ul", { className: "grid cove-temp" }, " ", /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, { position: "right" }, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Dashboard", type: "dashboard", icon: /* @__PURE__ */ i.createElement(gi, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Present multiple data visualizations with shared filter controls."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Data Bite", type: "data-bite", icon: /* @__PURE__ */ i.createElement(Br, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Highlight a single aggregated value (e.g., sum or median)."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Waffle Chart", type: "waffle-chart", subType: "Waffle", icon: /* @__PURE__ */ i.createElement(Fr, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Highlight a piece of data in relationship to a data set."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Gauge Chart", type: "waffle-chart", subType: "Gauge", icon: /* @__PURE__ */ i.createElement(bi, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Specify the calculation of a single data point (such as a percentage value) and present it on a horizontal scale.")))), /* @__PURE__ */ i.createElement("div", { className: "heading-2" }, "Charts"), /* @__PURE__ */ i.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, { position: "right" }, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Bar", type: "chart", subType: "Bar", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(Wr, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Use bars to show comparisons between data categories."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Line", type: "chart", subType: "Line", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(xr, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Present one or more data trends over time."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Pie", type: "chart", subType: "Pie", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(Gr, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Present the numerical proportions of a data series."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Paired Bar", type: "chart", subType: "Paired Bar", orientation: "horizontal", icon: /* @__PURE__ */ i.createElement(mi, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Use paired bars to show comparisons between two different data categories."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Deviation Bar", type: "chart", subType: "Deviation Bar", orientation: "horizontal", stacked: !1, icon: /* @__PURE__ */ i.createElement(Ni, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Use deviation bars to display how individual values differ from a target."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Horizontal Bar (Stacked)", type: "chart", subType: "Bar", orientation: "horizontal", stacked: !0, icon: /* @__PURE__ */ i.createElement(vi, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Use bars to show comparisons between data categories.")))), /* @__PURE__ */ i.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Box Plot", type: "chart", subType: "Box Plot", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(Si, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Display a box plot"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Scatter Plot", type: "chart", subType: "Scatter Plot", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(hi, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Display a scatter plot"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Area Chart", type: "chart", subType: "Area Chart", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(wi, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Display an area chart"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Forecast Chart", type: "chart", subType: "Forecasting", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(Ai, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Display a forecasting chart"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Forest Plot", type: "chart", subType: "Forest Plot", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(Mi, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Display a forest plot"))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "Sankey Diagram", type: "chart", subType: "Sankey", orientation: "vertical", icon: /* @__PURE__ */ i.createElement(Vr, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Display a sankey diagram")))), /* @__PURE__ */ i.createElement("div", { className: "heading-2" }, "Maps"), /* @__PURE__ */ i.createElement("ul", { className: "grid cove-temp" }, /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, { position: "right" }, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "United States (State- or County-Level)", type: "map", subType: "us", icon: /* @__PURE__ */ i.createElement(ka, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, { position: "right" }, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "United States (HHS Regions)", type: "map", subType: "us-region", icon: /* @__PURE__ */ i.createElement(Lr, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Present a U.S. choropleth map at state or county level."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "World", type: "map", subType: "world", icon: /* @__PURE__ */ i.createElement(qr, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Present a choropleth map of the world."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "U.S. State", type: "map", subType: "single-state", icon: /* @__PURE__ */ i.createElement(Kr, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "Present a choropleth map of an individual U.S. state."))), /* @__PURE__ */ i.createElement("li", null, /* @__PURE__ */ i.createElement(en, null, /* @__PURE__ */ i.createElement(en.Target, null, /* @__PURE__ */ i.createElement(y, { label: "U.S. Geocode", type: "map", subType: "us-county", generalType: "us-geocode", icon: /* @__PURE__ */ i.createElement(ka, null) })), /* @__PURE__ */ i.createElement(en.Content, null, "United States GeoCode")))));
}
function Ri({ containerEl: o }) {
  ...
  switch (E) {
    ...
    case "dashboard":
      return /* @__PURE__ */ i.createElement(lt, { component: "CdcDashboard" }, /* @__PURE__ */ i.createElement(Dr, { isEditor: !0, isDebug: A, config: p }));
    case "data-bite":
      return /* @__PURE__ */ i.createElement(lt, { component: "CdcDashboard" }, /* @__PURE__ */ i.createElement(Nr, { isEditor: !0, isDebug: A, config: p, setConfig: c }));
    case "markup-include":
...
const Pi = (o, p) => {
  ...
  return /* @__PURE__ */ i.createElement(Ir, null, /* @__PURE__ */ i.createElement(Lt.Provider, { value: { ...d, setTempConfig: Rn } }, /* @__PURE__ */ i.createElement(Ot.Provider, { value: O }, /* @__PURE__ */ i.createElement("div", { className: `cdc-open-viz-module cdc-editor ${d.currentViewport}`, ref: En }, /* @__PURE__ */ i.createElement(Gu, { className: "top-level" }, /* @__PURE__ */ i.createElement(kt, { title: "1. Choose Visualization Type", className: "choose-type" }, /* @__PURE__ */ i.createElement(Di, null)), /* @__PURE__ */ i.createElement(kt, { title: "2. Import Data", className: "data-designer", disableRule: !d.config.type }, /* @__PURE__ */ i.createElement(fi, null)), /* @__PURE__ */ i.createElement(kt, { title: "3. Configure", className: "configure", disableRule: b }, /* @__PURE__ */ i.createElement(Ri, { containerEl: c })))))), /* @__PURE__ */ i.createElement(kr, null));
}, Li = {
  theme: "theme-blue"
}, Oi = [
  [
...
const Wl = ["DefaultEditor", "StandAloneTable", "PivotFilter"];
export {
  Ro as DefaultEditor,
  Eo as PivotFilter,
  To as StandAloneTable,
  Wl as __namedExportsOrder,
  Fl as default
};
