...
var q = 0.7, X = 1 / q, P = "\\s*([+-]?\\d+)\\s*", z = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", y = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", ee = /^#([0-9a-f]{3,8})$/, re = new RegExp(`^rgb\\(${P},${P},${P}\\)$`), te = new RegExp(`^rgb\\(${y},${y},${y}\\)$`), ie = new RegExp(`^rgba\\(${P},${P},${P},${z}\\)$`), ae = new RegExp(`^rgba\\(${y},${y},${y},${z}\\)$`), fe = new RegExp(`^hsl\\(${z},${y},${y}\\)$`), oe = new RegExp(`^hsla\\(${z},${y},${y},${z}\\)$`), xn = {
  aliceblue: 15792383,
...
function I(n) {
  var e, r;
  return n = (n + "").trim().toLowerCase(), (e = ee.exec(n)) ? (r = e[1].length, e = parseInt(e[1], 16), r === 6 ? pn(e) : r === 3 ? new x(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : r === 8 ? L(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : r === 4 ? L(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = re.exec(n)) ? new x(e[1], e[2], e[3], 1) : (e = te.exec(n)) ? new x(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = ie.exec(n)) ? L(e[1], e[2], e[3], e[4]) : (e = ae.exec(n)) ? L(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = fe.exec(n)) ? wn(e[1], e[2] / 100, e[3] / 100, 1) : (e = oe.exec(n)) ? wn(e[1], e[2] / 100, e[3] / 100, e[4]) : xn.hasOwnProperty(n) ? pn(xn[n]) : n === "transparent" ? new x(NaN, NaN, NaN, 0) : null;
}
function pn(n) {
...
function rn(n, e, r, t) {
  return arguments.length === 1 ? ce(n) : new x(n, e, r, t ?? 1);
}
function x(n, e, r, t) {
...
function he(n, e, r, t) {
  return arguments.length === 1 ? En(n) : new p(n, e, r, t ?? 1);
}
function p(n, e, r, t) {
...
function nr(n, e) {
  var r = e - n;
  return r ? Hn(n, r > 180 || r < -180 ? r - 360 * Math.round(r / 360) : r) : Z(isNaN(n) ? e : n);
}
function xe(n) {
  return (n = +n) == 1 ? On : function(e, r) {
    return r - e ? de(e, r, n) : Z(isNaN(e) ? r : e);
  };
}
function On(n, e) {
  var r = e - n;
  return r ? Hn(n, r) : Z(isNaN(n) ? e : n);
}
const Nn = function n(e) {
  var r = xe(e);
  function t(i, a) {
    var f = r((i = rn(i)).r, (a = rn(a)).r), o = r(i.g, a.g), s = r(i.b, a.b), u = On(i.opacity, a.opacity);
    return function(l) {
...
var tn = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, nn = new RegExp(tn.source, "g");
function we(n) {
  return function() {
    return n;
  };
...
function Ne(n, e) {
  var r = tn.lastIndex = nn.lastIndex = 0, t, i, a, f = -1, o = [], s = [];
  for (n = n + "", e = e + ""; (t = tn.exec(n)) && (i = nn.exec(e)); )
    (a = i.index) > r && (a = e.slice(r, a), o[f] ? o[f] += a : o[++f] = a), (t = t[0]) === (i = i[0]) ? o[f] ? o[f] += i : o[++f] = i : (o[++f] = null, s.push({ i: f, x: U(t, i) })), r = nn.lastIndex;
  return r < e.length && (a = e.slice(r), o[f] ? o[f] += a : o[++f] = a), o.length < 2 ? s[0] ? Me(s[0].x) : we(e) : (e = s.length, function(u) {
    for (var l = 0, c; l < e; ++l)
      o[(c = s[l]).i] = c.x(u);
    return o.join("");
  });
...
function un(n, e) {
  var r = typeof e, t;
  return e == null || r === "boolean" ? Z(e) : (r === "number" ? U : r === "string" ? (t = I(e)) ? (e = t, Nn) : Ne : e instanceof I ? Nn : e instanceof Date ? be : me(e) ? ge : Array.isArray(e) ? pe : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? ye : U)(n, e);
}
function ve(n, e) {
  return n = +n, e = +e, function(r) {
...
function Ae(n, e, r) {
  ...
  return i < t ? (t = an(i, t), a = r(f, a)) : (t = an(t, i), a = r(a, f)), function(o) {
    return a(t(o));
  };
}
function Se(n, e, r) {
  ...
  for (n[t] < n[0] && (n = n.slice().reverse(), e = e.slice().reverse()); ++f < t; )
    i[f] = an(n[f], n[f + 1]), a[f] = r(e[f], e[f + 1]);
  return function(o) {
    var s = Un(n, o, 1, t) - 1;
    return a[s](i[s](o));
  };
...
function Pe() {
  ...
  function l() {
    ...
    return f !== j && (f = Re(n[0], n[d - 1])), o = d > 2 ? Se : Ae, s = u = null, c;
  }
  function c(d) {
  ...
  return c.invert = function(d) {
    ...
    return arguments.length ? (n = Array.from(d, ke), l()) : n.slice();
  }, c.range = function(d) {
    return arguments.length ? (e = Array.from(d), l()) : e.slice();
  }, c.rangeRound = function(d) {
    return e = Array.from(d), r = ve, l();
  }, c.clamp = function(d) {
...
function Ce(n, e) {
  ...
  if (!r)
    return n + "";
  var t = r[0], i = r[1], a = i - (qn = Math.max(-8, Math.min(8, Math.floor(i / 3))) * 3) + 1, f = t.length;
...
function Fe(n) {
  var e = n.grouping === void 0 || n.thousands === void 0 ? Rn : Oe(An.call(n.grouping, Number), n.thousands + ""), r = n.currency === void 0 ? "" : n.currency[0] + "", t = n.currency === void 0 ? "" : n.currency[1] + "", i = n.decimal === void 0 ? "." : n.decimal + "", a = n.numerals === void 0 ? Rn : qe(An.call(n.numerals, String)), f = n.percent === void 0 ? "%" : n.percent + "", o = n.minus === void 0 ? "−" : n.minus + "", s = n.nan === void 0 ? "NaN" : n.nan + "";
  function u(c) {
    c = Y(c);
    ...
    function hn(h) {
      ...
      if (g === "c")
        ...
        h = +h;
        var T = h < 0 || 1 / h < 0;
        if (h = isNaN(h) ? s : ln(Math.abs(h), v), cn && (h = Ie(h)), T && +h == 0 && b !== "+" && (T = !1), $ = (T ? b === "(" ? b : o : b === "-" || b === "(" ? "" : b) + $, m = (g === "s" ? Sn[8 + qn / 3] : "") + m + (T && b === "(" ? ")" : ""), Dn) {
...
function Te(n) {
  return G = Fe(n), zn = G.format, In = G.formatPrefix, G;
}
function De(n) {
...
function Ge(n, e, r, t) {
  ...
  switch (t = Y(t ?? ",f"), t.type) {
    case "s": {
      ...
      return t.precision == null && !isNaN(a = Le(i, f)) && (t.precision = a), In(t, f);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      t.precision == null && !isNaN(a = _e(i, Math.max(Math.abs(n), Math.abs(e)))) && (t.precision = a - (t.type === "e"));
      break;
    }
    case "f":
    case "%": {
      t.precision == null && !isNaN(a = De(i)) && (t.precision = a - (t.type === "%") * 2);
      break;
    }
  }
  return zn(t);
...
function Be(n) {
  ...
  return n.ticks = function(r) {
    ...
    var i = e();
    return Ge(i[0], i[i.length - 1], r ?? 10, t);
  }, n.nice = function(r) {
    r == null && (r = 10);
...
var Xe = Cn.exports;
const Ke = /* @__PURE__ */ _n(Xe);
var Ue = ["top", "left", "transform", "className", "children", "innerRef"];
function fn() {
...
function Ye(n) {
  var e = n.top, r = e === void 0 ? 0 : e, t = n.left, i = t === void 0 ? 0 : t, a = n.transform, f = n.className, o = n.children, s = n.innerRef, u = We(n, Ue);
  return /* @__PURE__ */ Ln.createElement("g", fn({
    ref: s,
    className: Ke("visx-group", f),
