...
import { C as ce, E as ke, _ as ga, B as ma, M as va, a as ha, A as Sa, g as wa, d as Ma, b as To, G as ba, O as Aa } from "./storybook-CdcDashboard-f6796f12.es.js";
import { P as Qn } from "./storybook-index-43433e35.es.js";
import "./storybook-transform-e0776740.es.js";
import { a as Da } from "./storybook-axios-01170075.es.js";
import { D as Ra } from "./storybook-DataTransform-1390427f.es.js";
...
import { I as fo, c as Eo, d as Na, e as Ta, f as Pa, g as Ea, h as Ia, i as La, j as Io, k as ka, l as Oa } from "./storybook-Icon-9a8d8f01.es.js";
import { D as Ba } from "./storybook-DataDesigner-a81779cb.es.js";
import { T as nn } from "./storybook-Tooltip-edc0f7ab.es.js";
import { S as Fa } from "./storybook-usa-region-graphic-fcafc1fc.es.js";
import { E as le } from "./storybook-Loading-f180d060.es.js";
import { b as ra } from "./storybook-Filters-46e2d309.es.js";
...
import "./storybook-footnoteSymbols-22cecfbd.es.js";
import "./storybook-NestedDropdown-d56e9caf.es.js";
...
function xa(t) {
  ...
  return isNaN(t) ? "Invalid Date" : Wa(t.getUTCFullYear()) + "-" + Mr(t.getUTCMonth() + 1, 2) + "-" + Mr(t.getUTCDate(), 2) + (b ? "T" + Mr(f, 2) + ":" + Mr(c, 2) + ":" + Mr(C, 2) + "." + Mr(b, 3) + "Z" : C ? "T" + Mr(f, 2) + ":" + Mr(c, 2) + ":" + Mr(C, 2) + "Z" : c || f ? "T" + Mr(f, 2) + ":" + Mr(c, 2) + "Z" : "");
}
function Ga(t) {
  var f = new RegExp('["' + t + `
\r]`), c = t.charCodeAt(0);
  function C(M, on) {
    var En, ln, pn = b(M, function(qn, dn) {
      if (En)
        return En(qn, dn - 1);
      ln = qn, En = on ? Ha(qn, on) : ea(qn);
    });
    return pn.columns = ln || [], pn;
  }
  function b(M, on) {
    var En = [], ln = M.length, pn = 0, qn = 0, dn, Hn = ln <= 0, Dn = !1;
    M.charCodeAt(ln - 1) === Ee && --ln, M.charCodeAt(ln - 1) === yo && --ln;
    function Jn() {
      if (Hn)
        return so;
      if (Dn)
      ...
      if (M.charCodeAt(or) === co) {
        for (; pn++ < ln && M.charCodeAt(pn) !== co || M.charCodeAt(++pn) === co; )
          ;
        return (Rn = pn) >= ln ? Hn = !0 : (zn = M.charCodeAt(pn++)) === Ee ? Dn = !0 : zn === yo && (Dn = !0, M.charCodeAt(pn) === Ee && ++pn), M.slice(or + 1, Rn - 1).replace(/""/g, '"');
      }
      for (; pn < ln; ) {
        if ((zn = M.charCodeAt(Rn = pn++)) === Ee)
          Dn = !0;
        else if (zn === yo)
          Dn = !0, M.charCodeAt(pn) === Ee && ++pn;
        else if (zn !== c)
          continue;
  ...
  function d(M, on) {
    return on == null && (on = ko(M)), [on.map(Sn).join(t)].concat(P(M, on)).join(`
`);
  }
  function L(M, on) {
    return on == null && (on = ko(M)), P(M, on).join(`
`);
  }
  function gn(M) {
    return M.map(w).join(`
`);
  ...
  function Sn(M) {
    return M == null ? "" : M instanceof Date ? xa(M) : f.test(M += "") ? '"' + M.replace(/"/g, '""') + '"' : M;
  }
  return {
    parse: C,
    parseRows: b,
...
function Xa(t) {
  ...
  if (c && !t.type) {
    var C = f.split(".").pop().toLowerCase(), b = _a.get(C);
      ...
      switch (b.label) {
        case 0:
          return t === null ? [2, []] : t.items ? (c = go(t.items).filter(function(P) {
            return P.kind === "file";
          }), f !== "drop" ? [2, c] : [4, Promise.all(c.map(nu))]) : [3, 2];
        case 1:
          return C = b.sent(), [2, Oo(ta(C))];
        case 2:
          return [2, Oo(go(t.files).map(function(P) {
            return Oe(P);
          }))];
      }
    });
...
function nu(t) {
  ...
  return f && f.isDirectory ? oa(f) : Bo(t);
}
function ta(t) {
  return t.reduce(function(f, c) {
    return za(f, Array.isArray(c) ? ta(c) : [c]);
  }, []);
}
function Bo(t) {
  var f = t.getAsFile();
          ...
          return Ce(this, function(M) {
            switch (M.label) {
              ...
              case 4:
                return [3, 6];
              case 5:
                Sn = Promise.all(L.map(ru)), b.push(Sn), P(), M.label = 6;
              case 6:
                return [
                  2
                  /*return*/
...
function Ho(t) {
  for (var f = 1; f < arguments.length; f++) {
    ...
    f % 2 ? Fo(Object(c), !0).forEach(function(C) {
      aa(t, C, c[C]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(c)) : Fo(Object(c)).forEach(function(C) {
...
var lu = "file-invalid-type", su = "file-too-large", cu = "file-too-small", yu = "too-many-files", Cu = function(f) {
...
function ua(t, f) {
  var c = t.type === "application/x-moz-file" || tu(t, f);
  return [c, c ? null : Cu(f)];
}
function ia(t, f, c) {
  if (Ie(t.size))
    if (Ie(f) && Ie(c)) {
...
function fu(t) {
  ...
  return !P && f.length > 1 || P && d >= 1 && f.length > d ? !1 : f.every(function(L) {
    var gn = ua(L, c), w = Wo(gn, 1), Sn = w[0], M = ia(L, C, b), on = Wo(M, 1), En = on[0];
    return Sn && En;
  });
}
function Nt(t) {
...
function rr(t) {
  for (var f = 1; f < arguments.length; f++) {
    var c = arguments[f] != null ? arguments[f] : {};
    f % 2 ? zo(Object(c), !0).forEach(function(C) {
      vo(t, C, c[C]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(c)) : zo(Object(c)).forEach(function(C) {
      Object.defineProperty(t, C, Object.getOwnPropertyDescriptor(c, C));
    });
  }
  return t;
...
var bo = /* @__PURE__ */ D.forwardRef(function(t, f) {
  var c = t.children, C = Tt(t, hu), b = So(C), P = b.open, d = Tt(b, Su);
...
function So() {
  ...
  D.useEffect(function() {
    return Hn && (document.addEventListener("dragover", Ko, !1), document.addEventListener("drop", mr, !1)), function() {
      Hn && (document.removeEventListener("dragover", Ko), document.removeEventListener("drop", mr));
    };
  }, [nr, Hn]);
  var ar = D.useCallback(function(Q) {
    Q.preventDefault(), Q.persist(), Ir(Q), fr.current = [].concat(bu(fr.current), [Q.target]), Mt(Q) && Promise.resolve(b(Q)).then(function(In) {
      Nt(Q) && !Rn || ($n({
        draggedFiles: In,
        isDragActive: !0,
    ...
    Q.forEach(function(gr) {
      var Fr = ua(gr, c), Tr = Co(Fr, 2), Yr = Tr[0], jr = Tr[1], Ur = ia(gr, d, P), Wr = Co(Ur, 2), Jr = Wr[0], xr = Wr[1], Gr = or ? or(gr) : null;
      if (Yr && Jr && !Gr)
        er.push(gr);
      else {
        var Hr = [jr, xr];
    ...
    return function() {
      var Q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, In = Q.refKey, er = In === void 0 ? "ref" : In, ir = Q.role, gr = Q.onKeyDown, Fr = Q.onFocus, Tr = Q.onBlur, Yr = Q.onClick, jr = Q.onDragEnter, Ur = Q.onDragOver, Wr = Q.onDragLeave, Jr = Q.onDrop, xr = Tt(Q, wu);
      return rr(rr(vo({
    ...
    return function() {
      var Q = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, In = Q.refKey, er = In === void 0 ? "ref" : In, ir = Q.onChange, gr = Q.onClick, Fr = Tt(Q, Mu), Tr = vo({
        accept: c,
        multiple: L,
        type: "file",
        style: {
  ...
  }, [en, c, L, z, C]), vr = br.length, hr = vr > 0 && fu({
    files: br,
    accept: c,
    minSize: d,
    maxSize: P,
...
function li() {
  ...
  }, d = new Ra(), [L, gn] = D.useState(t.dataFileSourceType === "url" ? t.dataFileName : t.dataUrl || ""), [w, Sn] = D.useState(!!t.dataUrl), [M, on] = D.useState(t.type === "dashboard" || !t.data), [En, ln] = D.useState(void 0), pn = D.useContext(ke), qn = {
    ".csv": "text/csv",
    ".json": "application/json"
  ...
  )))), (mr == null ? void 0 : mr.data) && /* @__PURE__ */ l.createElement(l.Fragment, null, t.type !== "dashboard" && /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("div", { className: "heading-3" }, "Data Source"), /* @__PURE__ */ l.createElement("div", { className: "file-loaded-area" }, (t.dataFileSourceType === "file" || !t.dataFileSourceType) && /* @__PURE__ */ l.createElement("div", { className: "data-source-options" }, /* @__PURE__ */ l.createElement("div", { className: Yn ? "drag-active cdcdataviz-file-selector loaded-file" : "cdcdataviz-file-selector loaded-file", ...fn() }, /* @__PURE__ */ l.createElement("input", { ..._n() }), Yn ? /* @__PURE__ */ l.createElement("p", null, "Drop file here") : /* @__PURE__ */ l.createElement("p", null, /* @__PURE__ */ l.createElement(Jo, null), " ", /* @__PURE__ */ l.createElement("span", null, t.dataFileName ?? "Replace data file"))), /* @__PURE__ */ l.createElement("div", null, Rr())), t.dataFileSourceType === "url" && /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement("div", { className: "url-source-options" }, /* @__PURE__ */ l.createElement("div", null, $n()), /* @__PURE__ */ l.createElement("div", null, Rr())), t.dataUrl && (t.type === "chart" || t.type === "map") && Or))), Br && /* @__PURE__ */ l.createElement(Ba, { visualizationKey: null, configureData: mr, updateDescriptionProp: (F, z) => or(mr.dataFileName, F, z), config: t, setConfig: b })), (En || M) && // dataFileSourceType needs to be checked here since earlier versions did not track this state
