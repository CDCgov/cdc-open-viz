import { _ as A, i as O, a as C } from "./storybook-975e540d.es.js";
var L = A, M = function() {
  return L.Date.now();
}, j = M, B = /\s/;
function R(e) {
...
var U = P, X = U, E = O, q = C, p = 0 / 0, w = /^[-+]0x[0-9a-f]+$/i, z = /^0b[01]+$/i, G = /^0o[0-7]+$/i, J = parseInt;
function K(e) {
  if (typeof e == "number")
    return e;
  if (q(e))
  ...
  e = X(e);
  var t = z.test(e);
  return t || G.test(e) ? J(e.slice(2), t ? 2 : 8) : w.test(e) ? p : +e;
}
var Q = K, V = O, x = j, $ = Q, Y = "Expected a function", Z = Math.max, ee = Math.min;
function ne(e, r, t) {
  var u, s, l, o, i, f, d = 0, I = !1, c = !1, b = !0;
  if (typeof e != "function")
    throw new TypeError(Y);
  r = $(r) || 0, V(t) && (I = !!t.leading, c = "maxWait" in t, l = c ? Z($(t.maxWait) || 0, r) : l, b = "trailing" in t ? !!t.trailing : b);
  function T(n) {
    var a = u, m = s;
    return u = s = void 0, d = n, o = e.apply(m, a), o;
  }
  function S(n) {
    return d = n, i = setTimeout(v, r), I ? T(n) : o;
  }
  function k(n) {
    var a = n - f, m = n - d, y = r - a;
    return c ? ee(y, l - m) : y;
  }
  function h(n) {
    var a = n - f, m = n - d;
