...
import { B as s } from "./storybook-515527e1.es.js";
...
const n = ["", "cove-button--success", "cove-button--warn", "cove-button--muted"], d = {
  ...
  render: (a) => /* @__PURE__ */ t.createElement(t.Fragment, null, /* @__PURE__ */ t.createElement(s, { ...a, className: n[0] }, "Button"), /* @__PURE__ */ t.createElement(s, { ...a, className: n[1] }, "Success"))
};
var o, r, c;
e.parameters = {
  ...e.parameters,
