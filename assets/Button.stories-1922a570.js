...
`,e(s,{sourceState:"hidden",children:e(a,{name:"Custom Hover Styles",children:f.bind({})})})]})}}const m=d.bind({});m.storyName="Example";m.args={children:"Button Text",fluid:!1,disabled:!1,flexCenter:!1};m.parameters={storySource:{source:`({ ...args
  ...
  </>`}};const c={title:"Components/Element/Button",component:t,tags:["stories-mdx"],includeStories:["example","loader","classes","fluid","customStyles","customHoverStyles"]};c.parameters=c.parameters||{};c.parameters.docs={...c.parameters.docs||{},page:H};const U=["Template","Classes","CustomClasses","CustomHover","example","loader","classes","fluid","customStyles","customHoverStyles"];export{b as Classes,S as CustomClasses,f as CustomHover,d as Template,U as __namedExportsOrder,v as classes,x as customHoverStyles,B as customStyles,c as default,m as example,h as fluid,C as loader};
//# sourceMappingURL=Button.stories-1922a570.js.map
