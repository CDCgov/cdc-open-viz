...
import { r as Cr, R as hu } from "./storybook-index-633d712d.es.js";
import { _ as Et } from "./storybook-extends-70f3d2a3.es.js";
import { g as gu } from "./storybook-_commonjsHelpers-c5d32002.es.js";
import { e as mo, l as Eu } from "./storybook-Icon-b09f76c0.es.js";
...
import { M as yu } from "./storybook-MultiSelect-4068d9a0.es.js";
...
function Fu(e) {
  var t = new FileReader(), n = Oi(t);
  return t.readAsArrayBuffer(e), n;
}
function Su(e) {
  var t = new FileReader(), n = Oi(t), r = /charset=([A-Za-z0-9_-]+)/.exec(e.type), o = r ? r[1] : "utf-8";
...
function Bi() {
  return this.bodyUsed = !1, this._initBody = function(e) {
    ...
    if (this._bodyArrayBuffer)
      return Promise.resolve(wu(this._bodyArrayBuffer));
    if (this._bodyFormData)
...
function pt(e, t) {
  ...
  if (e instanceof pt) {
    ...
    this.url = String(e);
  if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new ge(t.headers)), this.method = Ou(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || function() {
...
xi.polyfill = !0;
Ce.fetch || (Ce.fetch = xi, Ce.Headers = ge, Ce.Request = pt, Ce.Response = Je);
function Ii(e, t) {
  if (e == null)
    return {};
...
function Mu() {
  ...
  return function(r) {
    return function() {
      ...
      return i = Pi.apply(void 0, u)(o.dispatch), Eo(Eo({}, o), {}, {
        dispatch: i
      });
    };
  };
...
let Ri = zu;
const Hu = (e) => Ri = e, qu = () => Ri, No = Symbol.for("react-redux-context"), Oo = typeof globalThis < "u" ? globalThis : (
...
Or[Nr.Memo] = Vi;
function Io(e) {
  return Nr.isMemo(e) ? Vi : Or[e.$$typeof] || Zu;
}
...
function $i(e, t) {
  return function(r, {
    ...
    return i.dependsOnOwnProps = !0, i.mapToProps = function(u, c) {
      ...
      let l = i(u, c);
      return typeof l == "function" && (i.mapToProps = l, i.dependsOnOwnProps = jo(l), l = i(u, c)), process.env.NODE_ENV !== "production" && ji(l, o, t), l;
    }, i;
  };
}
function xr(e, t) {
...
function Ea(e) {
  return function(n, {
    ...
    return function(c, l, f) {
      const a = e(c, l, f);
      return i ? o(a, s) || (s = a) : (i = !0, s = a, process.env.NODE_ENV !== "production" && ji(s, r, "mergeProps")), s;
    };
  };
}
function ba(e) {
...
function Gi(e, t, n, {
  ...
  return (D) => {
    ...
    function b(I) {
      ...
      const q = j ? I.store : $.store, ee = G ? $.getServerState : q.getState, K = C.useMemo(() => fa(q.dispatch, v), [q]), [te, me] = C.useMemo(() => {
        if (!E)
          return Fa;
        const O = Mi(q, j ? void 0 : $.subscription), de = O.notifyNestedSubs.bind(O);
        return [O, de];
      ...
      const _e = C.useMemo(() => () => le.current && _ === ce.current ? le.current : K(q.getState(), _), [q, _]), ne = C.useMemo(() => (de) => te ? Oa(
        E,
        q,
        te,
        // @ts-ignore
...
var H = Wi, R = _a, Pa = process.env.NODE_ENV === "production", Mn = "Invariant failed";
function Go(e, t) {
  if (!e) {
    if (Pa)
      throw new Error(Mn);
...
const ie = Hi.bind(null, "warn"), dr = Hi.bind(null, "error");
function tt() {
}
function za(e, t) {
  return {
...
`, qi = (e, t) => {
  ...
  return n ? `
    ...
    in position ${o}
  `;
}, Yi = (e, t, n) => t.droppableId === n.droppableId ? `
      The item ${e}
  ...
  if (t)
    return qi(e.source, t);
  const n = e.combine;
  return n ? Yi(e.draggableId, e.source, n) : "You are over an area that cannot be dropped on";
}, qo = (e) => `
...
const ve = {
  ...
  x: n,
  y: t
}, kt = (e, t) => Math.sqrt((t.x - e.x) ** 2 + (t.y - e.y) ** 2), Yo = (e, t) => Math.min(...t.map((n) => kt(e, n))), Ki = (e) => (t) => ({
  x: e(t.x),
  y: e(t.y)
});
var Za = (e, t) => {
...
const Ji = ye((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), Xi = ye((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), Sn = ye((e) => Object.values(e)), oc = ye((e) => Object.values(e));
...
var uc = sc, Ue = (e, t) => (n) => e <= n && n <= t, Zi = (e) => {
...
const ns = (e, t) => t.margin[e.start] + t.borderBox[e.size] / 2, Ac = (e, t) => t.margin[e.end] + t.borderBox[e.size] / 2, Lr = (e, t, n) => t[e.crossAxisStart] + n.margin[e.crossAxisStart] + n.borderBox[e.crossAxisSize] / 2, Xo = ({
  axis: e,
  moveRelativeTo: t,
  isMoving: n
}) => Dt(e.line, t.marginBox[e.end] + ns(e, n), Lr(e, t.marginBox, n)), Qo = ({
  axis: e,
  moveRelativeTo: t,
  isMoving: n
  ...
  moveInto: t,
  isMoving: n
}) => Dt(e.line, t.contentBox[e.start] + ns(e, n), Lr(e, t.contentBox, n));
var Sc = ({
  impact: e,
  draggable: t,
  draggables: n,
...
var Oc = ({
  ...
  const i = rs(t, Ae(t.scroll.current, o)), s = n.frame ? Pr(n, Ae(n.frame.scroll.current, o)) : n, u = e.displaced, c = Wt({
...
}, Bc = (e, t) => Ae(e.scroll.diff.displacement, t), jr = ({
  ...
  if (!n.isEnabled)
    return null;
  const l = mt(n.descriptor.id, r), f = St(t, n), a = ic({
    isMovingForward: e,
    draggable: t,
    destination: n,
    insideDestination: l,
...
var Ic = ({
  ...
  if (!i)
    return null;
  const s = n.axis, u = Ue(i[s.start], i[s.end]), c = Sn(r).filter((f) => f !== n).filter((f) => f.isEnabled).filter((f) => !!f.subject.active).filter((f) => Zi(o.frame)(we(f))).filter((f) => {
    const a = we(f);
...
const Rc = (e, t, n) => {
  ...
  const u = i ? Ae(r.scroll.max, i) : r.scroll.max, c = is(r, u), l = bt({
    page: e.subject.page,
    withPlaceholder: s,
    axis: e.axis,
    frame: c
...
const as = (e, t) => ze(Yt(e, t));
var Wc = (e, t) => {
  const n = e.frame;
  return n ? as(t, n.scroll.diff.value) : t;
};
function cs({
  displaced: e,
  id: t
...
var zc = ({
  ...
  const u = n.axis, c = Kt(n.axis, t.displaceBy), l = c.value, f = e[u.start], a = e[u.end], p = Nn(t, r).find((m) => {
    const D = m.descriptor.id, y = m.page.borderBox.center[u.line], A = rt(D, s), v = cs({
      displaced: o,
      id: D
    });
...
var qc = ({
  ...
  const s = r.axis, u = Kt(r.axis, e.displaceBy), c = u.value, l = t[s.start], f = t[s.end], d = Nn(e, o).find((E) => {
    const m = E.descriptor.id, D = E.page.borderBox, A = D[s.size] / Hc, v = rt(m, i), b = cs({
  ...
  const u = as(t.page.borderBox, e), c = Gc({
    pageBorderBox: u,
    draggable: t,
    droppables: r
  });
...
var Kc = ({
  ...
  const p = u.draggables[e.critical.draggable.id], E = o || ls({
    pageOffset: a.offset,
    draggable: p,
...
var Zc = ({
  ...
  return e.map((o) => {
    const i = o.descriptor.droppableId, s = t[i], c = el(s).scroll.diff.value, l = Ae(r, c);
    return Zc({
      draggable: o,
      offset: l,
  ...
  const s = {
    ...
    draggables: i,
    viewport: e.viewport
  }), p = c && c.isCombineEnabled ? e.impact : a, E = ls({
...
const Gr = {
  ...
  minDropTime: 0.33,
  maxDropTime: 0.55
}, it = `${Es.outOfTheWay}s ${Gr.outOfTheWay}`, Tt = {
  fluid: `opacity ${it}`,
...
var wl = ({
  ...
  if (r >= ri)
    return bs;
  const o = r / ri, i = mr + Fl * o, s = n === "CANCEL" ? i * Sl : i;
  ...
  const {
    draggables: i,
    droppables: s
  } = n, u = $e(e), c = u ? s[u] : null, l = s[t.descriptor.droppableId], f = fs({
    impact: e,
    draggable: t,
    draggables: i,
    afterCritical: o,
...
const zl = (e) => {
  ...
  return (o) => (i) => {
    ...
    const s = {
      ...
      fn: function() {
        e.getState().phase === "DROP_ANIMATING" && e.dispatch(gs());
      }
    };
...
const Xl = (e) => (t) => (n) => {
  if (t(n), n.type !== "PUBLISH_WHILE_DRAGGING")
    return;
  const r = e.getState();
  r.phase === "DROP_PENDING" && (r.isWaiting || e.dispatch(hs({
    reason: r.reason
  })));
};
var Ql = Xl;
...
var ed = ({
  ...
  announce: o,
  autoScroller: i
}) => _i(rl, Zl(Mu(Al(n), ql(e), Cl(e), xl, Ul, Hl, Ql, Jl(i), Tl, Yl(t), Gl(r, o))));
const zn = () => ({
  additions: {},
  removals: {},
  modified: {}
...
var vs = ({
  ...
  const e = ys(), t = As(), n = e.y, r = e.x, o = Cs(), i = o.clientWidth, s = o.clientHeight, u = r + i, c = n + s;
  return {
    frame: ze({
      top: n,
      left: r,
...
}, Fs = (e, t) => e.phase === "IDLE" ? !0 : e.phase !== "DROP_ANIMATING" || e.completed.result.draggableId === t ? !1 : e.completed.result.reason === "DROP", id = (e) => {
  window.scrollBy(e.x, e.y);
};
const sd = ye((e) => Sn(e).filter((t) => !(!t.isEnabled || !t.frame))), ud = (e, t) => sd(t).find((r) => (r.frame || (process.env.NODE_ENV !== "production" ? h(!1, "Invalid result") : h(!1)), us(r.frame.pageMarginBox)(e))) || null;
var ad = ({
  center: e,
  destination: t,
  droppables: n
...
const Dd = Ki((e) => e === 0 ? 0 : e > 0 ? 1 : -1), Ur = (() => {
...
const wd = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u" ? C.useLayoutEffect : C.useEffect;
var Me = wd;
const Hn = () => {
...
function Nd(e, t) {
  const n = H(() => Sd(e), [e]), r = C.useRef(null), o = C.useRef(null), i = R(ye((a) => {
    const d = o.current;
...
var Bs = (e) => e && e.ownerDocument && e.ownerDocument.defaultView ? e.ownerDocument.defaultView : window;
function Qt(e) {
  return e instanceof Bs(e).HTMLElement;
}
function xs(e, t) {
  const n = `[${vt.contextId}="${e}"]`, r = Os(document, n);
  if (!r.length)
...
function Rd(e) {
  const t = H(() => Pd(e), [e]), n = C.useRef(null);
  return C.useEffect(function() {
...
function Vd(e, t = Is) {
  return H(() => `${e}${t.separator}${Td++}`, [t.separator, e]);
}
function Ld(e, t = Is) {
  const n = N.useId();
...
var Wd = (e, t) => {
  const n = li(e), r = li(t);
  Gd(n, r) || process.env.NODE_ENV !== "production" && ie(`
    React version: [${r.raw}]
...
const qd = 9, Yd = 13, Xr = 27, _s = 32, Kd = 33, Jd = 34, Xd = 35, Qd = 36, Zd = 37, ef = 38, tf = 39, nf = 40, rf = {
  [Yd]: !0,
  [qd]: !0
};
var Ps = (e) => {
...
function af(e) {
  const t = C.useRef(fi), n = C.useRef(tt), r = H(() => ({
    eventName: "mousedown",
    fn: function(a) {
      if (a.defaultPrevented || a.button !== Rs || a.ctrlKey || a.metaKey || a.shiftKey || a.altKey)
        return;
...
function Ts(e, t) {
  ...
  return r === "true" || r === "" ? !0 : t === e ? !1 : Ts(e, t.parentElement);
}
function yf(e, t) {
  const n = t.target;
  return Qt(n) ? Ts(e, n) : !1;
}
var vf = (e) => ze(e.getBoundingClientRect()).center;
function Cf(e) {
  return e instanceof Bs(e).Element;
}
const Af = (() => {
  const e = "matches";
...
function Vs(e, t) {
  return e == null ? null : e[Af](t) ? e : Vs(e.parentElement, t);
}
function Ff(e, t) {
  return e.closest ? e.closest(t) : Vs(e, t);
}
function Sf(e) {
...
function Of(e, t) {
  const n = `[${hr.contextId}="${e}"]`, o = Os(document, n).find((i) => i.getAttribute(hr.id) === t);
...
function Ls({
  ...
  return o ? !(!o.options.isEnabled || !Fs(t.getState(), r)) : (process.env.NODE_ENV !== "production" && ie(`Unable to find draggable with id: ${r}`), !1);
}
function xf({
  lockAPI: e,
  contextId: t,
  ...
  function D(g) {
    ...
    a !== "PRE_DRAG" && (S(), process.env.NODE_ENV !== "production" ? h(!1, `Cannot lift in phase ${a}`) : h(!1)), n.dispatch(il(g.liftActionArgs)), a = "DRAGGING";
    function I(B, x = {
...
function Tf(e) {
  ...
  }, p), [p]), m = xd(), D = H(() => od(m, E), [m, E]), y = H(() => vd({
    scrollWindow: id,
  ...
  }), [D.scrollDroppable, p, l]), A = Od(t), v = H(() => ed({
    announce: f,
    autoScroller: y,
    dimensionMarshal: D,
    focusMarshal: A,
  ...
  n(S);
  const I = R((_) => Fs(Bt(s).getState(), _), []), B = R(() => ct(Bt(s).getState()), []), x = H(() => ({
    marshal: D,
    focus: A,
    contextId: t,
    canLift: I,
...
function Hf(e, t, n = ve) {
  const r = window.getComputedStyle(t), o = t.getBoundingClientRect(), i = Ui(o, r), s = gn(i, n), u = {
    client: i,
...
function Yf(e, t, n) {
  Zt(() => {
    ...
    o || (process.env.NODE_ENV !== "production" ? h(!1, "Draggable requires a draggableId") : h(!1)), typeof o != "string" && (process.env.NODE_ENV !== "production" ? h(!1, `Draggable requires a [string] draggableId.
      Provided: [type: ${typeof o}] (value: ${o})`) : h(!1)), Number.isInteger(e.index) || (process.env.NODE_ENV !== "production" ? h(!1, `${r(o)} requires an integer index prop`) : h(!1)), e.mapped.type !== "DRAGGING" && (js(n()), e.isEnabled && (xs(t, o) || (process.env.NODE_ENV !== "production" ? h(!1, `${r(o)} Unable to find drag handle`) : h(!1))));
  });
}
function Kf(e) {
  Kr(() => {
...
const Xf = (e) => {
  ...
  const A = H(() => d ? {
    ...
    const S = zf(D), I = D.type === "DRAGGING" && D.dropping ? v : void 0;
    return {
      innerRef: n,
      draggableProps: {
  ...
  return (o, i) => {
    ...
    if (o.phase === "DROP_ANIMATING") {
      ...
      if (s.result.draggableId !== i.draggableId)
        return null;
      const u = i.isClone, c = o.dimensions.draggables[i.draggableId], l = s.result, f = l.mode, a = Ms(l), d = Zf(l), E = {
...
function XD(e) {
  ...
  return N.createElement(Gs, Et({}, e, {
    isClone: !1,
    isEnabled: t,
...
const Zr = (e) => (t) => e === t, ap = Zr("scroll"), cp = Zr("auto"), lp = Zr("visible"), Di = (e, t) => t(e.overflowX) || t(e.overflowY), dp = (e, t) => t(e.overflowX) && t(e.overflowY), Ws = (e) => {
  ...
  if (t || (process.env.NODE_ENV, h(!1)), !Ws(e))
    return !1;
  const n = window.getComputedStyle(t), r = {
    overflowX: n.overflowX,
    overflowY: n.overflowY
  };
  return dp(r, lp) || process.env.NODE_ENV !== "production" && ie(`
  ...
  `), !1;
}, Us = (e) => e == null ? null : e === document.body ? fp() ? e : null : e === document.documentElement ? null : Ws(e) ? e : Us(e.parentElement);
var zs = Us, pp = (e) => {
  !e || !zs(e.parentElement) || process.env.NODE_ENV !== "production" && ie(`
...
function yp(e) {
  const t = C.useRef(null), n = yn(Bn), r = Yr("droppable"), {
    ...
    return M && (M.setAttribute(ai.contextId, n.contextId), M.addEventListener("scroll", p, mi(x.scrollOptions)), process.env.NODE_ENV !== "production" && pp(M)), _;
...
function Op(e) {
  Zt(() => {
    Xn(e, Sp), e.props.mode === "standard" && Xn(e, wp), e.props.mode === "virtual" && Xn(e, Np);
  });
}
...
const gi = {
  ...
  return (i, s) => {
    const u = qs(s), c = u.droppableId, l = u.type, f = !u.isDropDisabled, a = u.renderClone;
    if (qt(i)) {
      const d = i.critical;
      if (!Qn(l, d))
        return t;
    ...
    if (i.phase === "DROP_ANIMATING") {
      ...
      return r(c, f, Ms(d.result) === c, $e(d.impact) === c, p, a);
    }
...
Couldn't access "${n}" in ${JSON.stringify(e)}`);
}, bi = (e) => typeof e == "object" && e !== null && !Array.isArray(e), pn = (e) => Array.isArray(e), Ys = (e, t) => e.filter((n, r) => r !== t), Lp = (e, t, n, r = {}) => {
  ...
  return pn(e) && o && a.length === 1 ? Ys(e, a[0]) : It(e, a, n, f);
}, It = (e, t, n, r) => {
  ...
  if (u && t.length === 2 && typeof t[1] == "number") {
    const m = d[a], D = t[1];
    return pn(m) ? d[a] = Ys(m, D) : dt(l, f, a, c, "Trying to remove an indexed item from an object that is not an array"), d;
  }
  const p = t.slice(1);
  if (a in e) {
    if (E = d[a], !pn(E) && !bi(E)) {
...
function ae(e) {
  return An(e === void 0 ? `JSON5: invalid end of input at ${ot}:${He}` : `JSON5: invalid character '${Js(e)}' at ${ot}:${He}`);
}
function ut() {
...
function Jp(e) {
  console.warn(`JSON5: '${Js(e)}' in strings is not valid ECMAScript; consider escaping`);
}
function Js(e) {
  const t = {
    "'": "\\'",
...
`, {});
const Qs = ({ className: e, name: t, value: n, setValue: r, handleKeyPress: o, styles: i }) => {
  const s = n.slice(-1) === `
` ? n + "." : n;
  ...
  return n ? w(Qs, { className: "jer-input-text", name: a, value: e, setValue: t, isEditing: n, handleKeyPress: (p) => {
  ...
  return n ? w("input", { className: "jer-input-number", type: "text", name: en(r), value: e, onChange: (l) => t(l.target.value.replace(/[^0-9.-]/g, "")), autoFocus: !0, onFocus: (l) => l.target.select(), onKeyDown: (l) => {
    switch (l.key) {
      case "Enter":
        i();
        break;
  ...
  return n ? w("input", { className: "jer-input-boolean", type: "checkbox", name: en(r), checked: e, onChange: () => t(!e) }) : w("span", { onDoubleClick: () => o(!0), className: "jer-value-boolean", style: c("boolean", u), children: String(e) });
...
}, to = ({ onOk: e, onCancel: t, nodeData: n }) => he("div", { className: "jer-confirm-buttons", children: [w("div", { onClick: e, children: w(ft, { name: "ok", nodeData: n }) }), w("div", { onClick: t, children: w(ft, { name: "cancel", nodeData: n }) })] }), CD = (e) => e.reduce((t, n) => typeof n == "number" ? `${t}[${n}]` : t === "" ? n : `${t}.${n}`, ""), AD = ["string", "number", "boolean", "null", "object", "array"], nu = (e = [], t) => {
  const n = e.filter(({ condition: E }) => E(t));
  if (n.length === 0)
    return {};
  const r = n[0], { element: o, wrapperElement: i, customNodeProps: s, wrapperProps: u, hideKey: c = !1, showEditTools: l = !0, showOnEdit: f = !1, showOnView: a = !0, showCollectionWrapper: d = !0 } = r, p = Xs(r, ["element", "wrapperElement", "customNodeProps", "wrapperProps", "hideKey", "showEditTools", "showOnEdit", "showOnView", "showCollectionWrapper"]);
...
}, Fn = (e) => e !== null && typeof e == "object", ru = (e, t, n, r = "") => {
  if (!n && !r)
    return !0;
  switch (e) {
    case "collection":
...
}, Ci = ({ key: e, path: t }, n = "") => !!Ct({ value: e }, n) || !!t.some((r) => Ct({ value: r }, n)), ou = C.createContext({ collapseState: null, setCollapseState: () => {
  ...
  return w(ou.Provider, { value: { collapseState: t, setCollapseState: n, doesPathMatch: (i) => {
    if (t === null)
      return !1;
  ...
  C.useEffect(() => {
    _(typeof t == "function" ? "**INVALID_FUNCTION**" : t), K(ln(t, q));
  }, [t, M]);
  ...
  }, [u, c]), { CustomNode: le, customNodeProps: T, hideKey: Y, showEditTools: De = !0, showOnEdit: _e, showOnView: ne } = q, re = [...AD, ...b.filter(({ showInTypesSelector: V = !1, name: se }) => V && !!se).map(({ name: V }) => V)], Ee = C.useMemo(() => {
    if (typeof d == "boolean")
      return d ? [] : re;
    if (Array.isArray(d))
      return d;
  ...
  }, isEditing: de, setIsEditing: () => I(te), getStyles: g })) : SD(ln(t), qe);
  return w("div", { className: "jer-component jer-value-component", style: { marginLeft: A / 2 + "em" }, children: he("div", { className: "jer-value-main-row", style: { flexWrap: j.length > 10 ? "wrap" : "nowrap" }, children: [Te && he("span", { className: "jer-key-text", style: Object.assign(Object.assign({}, g("property", r)), { minWidth: `${Math.min(String(j).length + 1, 5)}ch`, flexShrink: j.length > 10 ? 1 : 0 }), onDoubleClick: () => Pe && I(`key_${te}`), children: [j === "" ? w("span", { className: "jer-empty-string" }) : j, ":"] }), ke && w("input", { className: "jer-input-text jer-key-edit", type: "text", name: te, defaultValue: j, autoFocus: !0, onFocus: (V) => V.target.select(), onKeyDown: (V) => {
    V.key === "Enter" ? ((se) => {
      ...
      const Ve = Object.fromEntries(Object.entries(n).map(([ht, tn]) => ht === j ? [se, tn] : [ht, tn]));
      o(Ve, Se);
    })(V.target.value) : V.key === "Escape" && O();
  }, style: { width: String(j).length / 1.5 + 0.5 + "em" } }), he("div", { className: "jer-value-and-buttons", children: [w("div", { className: "jer-input-component", children: Ye }), de ? w(to, { onOk: Be, onCancel: O, nodeData: r }) : Fe && w(tu, { startEdit: U ? () => I(te) : void 0, handleDelete: fe ? () => {
    i(x, G).then((V) => {
    ...
    if (Se)
      ...
      const Ve = wD(x, se, v("DEFAULT_NEW_KEY", r), q != null && q.CustomNode ? v("DEFAULT_STRING", r) : void 0);
...
}, ln = (e, t) => t != null && t.CustomNode && (t != null && t.name) && t.showInTypesSelector ? t.name : typeof e == "string" ? "string" : typeof e == "number" ? "number" : typeof e == "boolean" ? "boolean" : e === null ? "null" : "invalid", SD = (e, t) => {
  const n = t.value;
  switch (e) {
    case "string":
    ...
    case "boolean":
      return w(lD, Object.assign({}, t, { value: n }));
    case "null":
      return w(dD, Object.assign({}, t));
    case "object":
      return w(fD, Object.assign({}, t, { value: n }));
    case "array":
  ...
  const O = C.useMemo(() => !A(T), [T]), de = C.useMemo(() => !v(T), [T]), P = C.useMemo(() => !b(T), [T]), Pe = C.useMemo(() => (L) => typeof $ != "function" ? $ : $(L), [$]), { CustomNode: Re, customNodeProps: xe, CustomWrapper: Fe, wrapperProps: ke = {}, hideKey: Te, showEditTools: qe = !0, showOnEdit: Ye, showOnView: V, showCollectionWrapper: se = !0 } = C.useMemo(() => nu(G, T), []), Se = C.useMemo(() => (L, oe) => {
    var Le;
  ...
  if (!ru("collection", T, I, B) && T.level > 0)
    return null;
  const Ve = Array.isArray(t) ? "array" : "object", ht = Ve === "array" ? { open: "[", close: "]" } : { open: "{", close: "}" }, tn = getComputedStyle(document.documentElement).getPropertyValue("--jer-expand-transition-time"), ro = (L) => {
    L.key === "Enter" && (L.metaKey || L.shiftKey || L.ctrlKey) ? In() : L.key === "Escape" && nn();
  }, In = () => {
    try {
      const L = tr.parse(K);
  ...
  }, Ke = f === ne, au = f === `key_${ne}`, oo = typeof Y.slice(-1)[0] == "number", cu = r !== null && O && P && de && !oo, io = o === "when-closed" ? ce : o, lu = !Ke && qe, du = (M || !oo) && !Te && De !== void 0, fu = Re && (Ke && Ye || !Ke && V), pu = _ && Ve === "object", so = Object.entries(t).map(([L, oe]) => [Ve === "array" ? Number(L) : L, oe]);
  pu && so.sort(typeof _ == "function" ? (L, oe) => _(L[0], oe[0]) : void 0);
  const Du = JSON.stringify(t, null, 2).replace(/\\n/g, `
`).split(`
`).length, uo = re.current ? Ke ? w("div", { className: "jer-collection-text-edit", children: he("div", { children: [w(Qs, { className: "jer-collection-text-area", name: ne, value: K, setValue: te, isEditing: Ke, handleKeyPress: ro, styles: s("input", T) }), w("div", { className: "jer-collection-input-button-row", children: w(to, { onOk: In, onCancel: nn, nodeData: T }) })] }) }) : so.map(([L, oe], Le) => {
    ...
    return w("div", { className: "jer-collection-element", style: s("collectionElement", wt), children: Fn(oe) ? w(su, Object.assign({ data: oe, parentData: t, nodeData: wt, showCollectionCount: o }, i), L) : w(iu, Object.assign({ data: oe, parentData: t, nodeData: wt }, i, { showLabel: Ve === "object" || M }), L) }, L);
  }) : null, rn = !!se && ce;
  rn || (re.current = !0);
  const ao = Object.assign(Object.assign({}, i), { data: t, value: t, parentData: r, nodeData: T, setValue: (L) => Dn(void 0, void 0, void 0, function* () {
    return yield p(L, Y);
  }), handleEdit: In, handleCancel: nn, handleKeyPress: ro, isEditing: Ke, setIsEditing: () => a(ne), getStyles: s }), mu = fu ? w(Re, Object.assign({ customNodeProps: xe }, ao, { children: uo })) : uo, co = au ? w("input", { className: "jer-input-text jer-key-edit", type: "text", name: ne, defaultValue: De, autoFocus: !0, onFocus: (L) => L.target.select(), onKeyDown: (L) => {
    L.key === "Enter" ? ((oe) => {
      if (a(null), De === oe || !r)
        return;
      ...
      p(wt, Le);
    })(L.target.value) : L.key === "Escape" && nn();
  }, style: { width: String(De).length / 1.5 + 0.5 + "em" } }) : du && w("span", { className: "jer-key-text", style: s("property", T), onDoubleClick: () => cu && a(`key_${ne}`), children: De === "" ? w("span", { className: Y.length > 0 ? "jer-empty-string" : void 0 }) : `${De}:` }), lo = lu && w(tu, { startEdit: O ? () => {
  ...
  const { getStyles: U, setTheme: fe, setIcons: ce } = et(), { setCollapseState: le } = no(), T = C.useCallback(dn(p), [p]), Y = C.useCallback(OD(G, K), [G, K]), [De, _e] = C.useState(b), [ne, re] = C.useState(e);
  C.useEffect(() => {
    f && fe(f), a && ce(a);
  }, [f, a]), C.useEffect(() => {
    le(null), re(e);
  ...
  const Ee = { key: t, path: [], level: 0, index: 0, value: ne, size: Object.keys(ne).length, parentData: null, fullData: ne }, Be = dn(m), O = dn(D), de = dn(y), P = ID(v), Pe = { name: t, nodeData: Ee, onEdit: (xe, Fe) => Dn(void 0, void 0, void 0, function* () {
  ...
  }), onDelete: (xe, Fe) => Dn(void 0, void 0, void 0, function* () {
  ...
  }), onAdd: (xe, Fe) => Dn(void 0, void 0, void 0, function* () {
  ...
  return Re.fontSize = $ ?? Re.fontSize, w("div", { id: ee, className: "jer-editor-container " + q, style: Re, children: Fn(ne) ? w(su, Object.assign({ data: ne }, Pe)) : w(iu, Object.assign({ data: ne, showLabel: !0 }, Pe)) });
}, xD = (e) => w(rD, { children: w(FD, { children: w(BD, Object.assign({}, e)) }) }), nr = (e, t, n, r) => {
  if (t.length === 0)
...
const ZD = ({ loadConfig: e, config: t, convertStateToConfig: n, onExpandCollapse: r = () => {
  ...
  return t.type ? /* @__PURE__ */ N.createElement(N.Fragment, null, /* @__PURE__ */ N.createElement("a", { href: a[t.type][1], target: "_blank", rel: "noopener noreferrer", className: "guidance-link" }, a[t.type][2], /* @__PURE__ */ N.createElement("div", null, /* @__PURE__ */ N.createElement("span", { className: "heading-3" }, "Get Help with ", a[t.type][0]), /* @__PURE__ */ N.createElement("p", null, "Examples and documentation"))), /* @__PURE__ */ N.createElement("div", { className: "advanced" }, /* @__PURE__ */ N.createElement("span", { className: "advanced-toggle-link", onClick: () => c(!o) }, /* @__PURE__ */ N.createElement("span", null, o ? "— " : "+ "), "Advanced Options"), o && /* @__PURE__ */ N.createElement(N.Fragment, null, /* @__PURE__ */ N.createElement("section", { className: "error-box py-2 px-3 my-2" }, /* @__PURE__ */ N.createElement("div", null, /* @__PURE__ */ N.createElement("strong", { className: "pt-1" }, "Warning"), /* @__PURE__ */ N.createElement("p", null, "This can cause serious errors in your visualization."))), /* @__PURE__ */ N.createElement("p", { className: "pb-2" }, "This tool displays the actual ", /* @__PURE__ */ N.createElement("acronym", { title: "JavaScript Object Notation" }, "JSON"), " configuration that is generated by this editor and allows you to edit properties directly and apply them."), /* @__PURE__ */ N.createElement(
    ...
    "Copy to Clipboard"
  ), /* @__PURE__ */ N.createElement(xD, { className: "advanced-json-editor", data: s, onUpdate: f, rootName: "", collapse: l }), /* @__PURE__ */ N.createElement(
    "button",
    {
...
const ir = (e, t) => {
  ...
  if (Array.isArray(t))
    t.forEach((r) => {
      const o = r[e];
      o !== void 0 && !n.includes(o) && n.push(o);
    });
  else {
    if (!t)
      return n;
    Object.values(t).forEach((r) => {
      r.forEach((o) => {
        const i = o[e];
        i !== void 0 && !n.includes(i) && n.push(i);
      });
    });
  }
  return n;
}, wi = (e, t) => e.map((n) => String(n)).includes(String(t)), TD = (e, t) => (Lt.keyBy(e, "id"), e == null ? void 0 : e.map((n) => {
  const r = Lt.cloneDeep(n), o = RD(n.columnName, t);
  if (r.values = o, o.length > 0) {
    r.filterStyle === "multi-select" ? r.values : r.values[0];
    const i = PD(r);
    if (i)
      r.active = i;
    else if (r.filterStyle === "multi-select") {
      const s = r.values, u = Array.isArray(r.active) ? r.active : [r.active];
      r.active = u.filter((c) => wi(s, c));
    } else {
      const s = r.values[0], u = Array.isArray(r.active) ? r.active[0] : r.active;
      r.active = wi(r.values, u) ? u : s;
    }
  }
  return r;
})), VD = ["dropdown", "pill", "tab", "tab bar", "multi-select"], LD = [
  {
  ...
  const { order: t } = e;
  if (t === "cust")
    return e.values = e.orderedValues, e.values;
  const n = (o, i) => o.toString().localeCompare(i.toString(), "en", { numeric: !0 }), r = (o, i) => i.toString().localeCompare(o.toString(), "en", { numeric: !0 });
  ...
  return {
    ...
    handleReset: (y) => {
      ...
      const b = rr();
      A.forEach((g, S) => {
        (!g.values || g.values.length === 0) && (g.values = c(f, g.columnName)), A[S].active = Ni(g).values[0], g.setByQueryParameter && b[g.setByQueryParameter] !== g.active && (b[g.setByQueryParameter] = g.active, v = !0);
  ...
  if (g.Section = ({ children: B }) => (t == null ? void 0 : t.filters) && /* @__PURE__ */ N.createElement("section", { className: S.join(" ") }, /* @__PURE__ */ N.createElement("p", { className: "filters-section__intro-text" }, o != null && o.some((x) => x.active) ? v.introText : "", " ", t.filterBehavior === "Apply Button" && v.applyText), /* @__PURE__ */ N.createElement("div", { className: "filters-section__wrapper" }, B)), g.ApplyBehavior = () => {
    ...
    return /* @__PURE__ */ N.createElement("div", { className: "filters-section__buttons" }, /* @__PURE__ */ N.createElement(bu, { onClick: () => E(o), disabled: !y, className: B.join(" ") }, v.buttonText), /* @__PURE__ */ N.createElement("a", { href: "#!", role: "button", onClick: A }, v.resetText));
  }, g.TabBar = (B) => {
    ...
    if (o || n) {
      let B = i === "map" ? n : o;
      return delete B.fromHash, TD(B, t.data).map((x, _) => {
        var me;
        if (x.showDropdown === !1)
          return;
