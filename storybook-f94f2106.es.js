import { c as re, g as At } from "./storybook-92157f1b.es.js";
import et from "react";
import { a as Ke, j as ke } from "./storybook-8087091f.es.js";
var tt = {}, rt = {};
(function(e) {
...
function it(e, t) {
  ...
  if (jt(e))
    ...
    var n = t ? We(e.children) : [], s = new Lt(e.name, Ce({}, e.attribs), n);
    ...
    var n = t ? We(e.children) : [], l = new Mt(n);
    n.forEach(function(h) {
      return h.parent = l;
    }), r = l;
  } else if (Ut(e)) {
    var n = t ? We(e.children) : [], f = new Nt(n);
    n.forEach(function(h) {
      return h.parent = f;
    }), e["x-mode"] && (f["x-mode"] = e["x-mode"]), r = f;
  } else if (Bt(e)) {
    var u = new Pt(e.name, e.data);
...
var pt = "html", vt = "head", Re = "body", fr = /<([a-zA-Z]+[0-9]?)/, mt = /<head[^]*>/i, gt = /<body[^]*>/i, Ie = function() {
  throw new Error(
...
if (typeof yt == "function") {
  var hr = new yt(), dr = "text/html";
  Je = function(e, t) {
    return t && (e = "<" + t + ">" + e + "</" + t + ">"), hr.parseFromString(e, dr);
  }, Ie = Je;
}
...
var $e = typeof document == "object" ? document.createElement("template") : {}, Ze;
$e.content && (Ze = function(e) {
...
function pr(e) {
  ...
  switch (t) {
    case pt:
      return n = Je(e), mt.test(e) || (s = n.querySelector(vt), s && s.parentNode.removeChild(s)), gt.test(e) || (s = n.querySelector(Re), s && s.parentNode.removeChild(s)), n.querySelectorAll(pt);
    case vt:
    case Re:
      return n = Ie(e), l = n.querySelectorAll(t), gt.test(e) && mt.test(e) ? l[0].parentNode.childNodes : l;
    default:
      return Ze ? Ze(e) : (s = Ie(e, Re).querySelector(Re), s.childNodes);
  }
}
var vr = pr, at = {}, Gt = {};
Gt.CASE_SENSITIVE_TAG_NAMES = [
  "animateMotion",
  "animateTransform",
  "clipPath",
  "feBlend",
...
var Fe = tt, mr = Gt, _t = mr.CASE_SENSITIVE_TAG_NAMES, gr = Fe.Comment, yr = Fe.Element, _r = Fe.ProcessingInstruction, br = Fe.Text, qt = {}, Xe;
for (var Ye = 0, Er = _t.length; Ye < Er; Ye++)
  Xe = _t[Ye], qt[Xe.toLowerCase()] = Xe;
function wr(e) {
  return qt[e];
}
function Vt(e) {
...
function Wt(e, t, r) {
  ...
  for (var n = [], s, l = 0, f = e.length; l < f; l++) {
    ...
    switch (u.nodeType) {
      case 1:
        s = Tr(u.nodeName), o = new yr(s, Vt(u.attributes)), o.children = Wt(
        ...
        break;
      case 3:
        o = new br(u.nodeValue);
        break;
      case 8:
        o = new gr(u.nodeValue);
        break;
      default:
        continue;
    }
...
at.formatAttributes = Vt;
at.formatDOM = Wt;
var Or = vr, kr = at, xr = kr.formatDOM, Cr = /<(![a-zA-Z\s]+)>/;
function Sr(e) {
  if (typeof e != "string")
  ...
  if (e === "")
    return [];
  var t = e.match(Cr), r;
  return t && t[1] && (r = t[1]), xr(Or(e), null, r);
}
var Rr = Sr, ee = {}, ze = {}, Ar = 0;
ze.SAME = Ar;
var Ir = 1;
ze.CAMELCASE = Ir;
...
var $t = 0, me = 1, je = 2, He = 3, ot = 4, Xt = 5, Yt = 6;
function Fr(e) {
  return V.hasOwnProperty(e) ? V[e] : null;
}
function Y(e, t, r, n, s, l, f) {
  this.acceptsBooleans = t === je || t === He || t === ot, this.attributeName = n, this.attributeNamespace = s, this.mustUseProperty = r, this.propertyName = e, this.type = t, this.sanitizeURL = l, this.removeEmptyString = f;
}
var V = {}, zr = [
  "children",
...
var ut = ze, Hr = ut.CAMELCASE, Br = ut.SAME, Et = ut.possibleStandardNames, Ur = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", Gr = Ur + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", qr = RegExp.prototype.test.bind(
  // eslint-disable-next-line no-misleading-character-class
  new RegExp("^(data|aria)-[" + Gr + "]*$")
), Vr = Object.keys(Et).reduce(function(e, t) {
  var r = Et[t];
  return r === Br ? e[t] = t : r === Hr ? e[t.toLowerCase()] = t : e[t] = r, e;
}, {});
ee.BOOLEAN = He;
ee.BOOLEANISH_STRING = je;
ee.NUMERIC = Xt;
ee.OVERLOADED_BOOLEAN = ot;
ee.POSITIVE_NUMERIC = Yt;
ee.RESERVED = $t;
ee.STRING = me;
ee.getPropertyInfo = Fr;
ee.isCustomAttribute = qr;
ee.possibleStandardNames = Vr;
var Kt = {}, ct = { exports: {} }, wt = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g, Wr = /\n/g, $r = /^\s*/, Xr = /^(\*?[-#/*\\\w]+(\[[0-9a-z_-]+\])?)\s*/, Yr = /^:\s*/, Kr = /^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};])+)/, Jr = /^[;\s]*/, Zr = /^\s+|\s+$/g, Qr = `
`, Tt = "/", Ot = "*", _e = "", en = "comment", tn = "declaration", rn = function(e, t) {
  if (typeof e != "string")
    throw new TypeError("First argument must be a string");
  if (!e)
    return [];
  ...
  function x() {
    var w = l();
    if (!(Tt != e.charAt(0) || Ot != e.charAt(1))) {
      for (var E = 2; _e != e.charAt(E) && (Ot != e.charAt(E) || Tt != e.charAt(E + 1)); )
        ++E;
  ...
  function ne() {
    ...
    if (E) {
      ...
      var U = o(Kr), Oe = w({
        type: tn,
        property: kt(E[0].replace(wt, _e)),
        value: U ? kt(U[0].replace(wt, _e)) : _e
      });
      return o(Jr), Oe;
    }
  }
...
function Jt(e, t) {
  ...
  if (!e || typeof e != "string")
    return r;
  for (var n, s = nn(e), l = typeof t == "function", f, u, o = 0, h = s.length; o < h; o++)
    n = s[o], f = n.property, u = n.value, l ? t(f, u, n) : u && (r || (r = {}), r[f] = u);
  return r;
}
ct.exports = Jt;
ct.exports.default = Jt;
var an = ct.exports, Be = {};
Be.__esModule = !0;
Be.camelCase = void 0;
var on = /^--[a-zA-Z0-9-]+$/, sn = /-([a-z])/g, ln = /^[^-]+$/, un = /^-(webkit|moz|ms|o|khtml)-/, cn = /^-(ms)-/, fn = function(e) {
  return !e || ln.test(e) || on.test(e);
}, hn = function(e, t) {
  return t.toUpperCase();
}, xt = function(e, t) {
  return "".concat(t, "-");
}, dn = function(e, t) {
  return t === void 0 && (t = {}), fn(e) ? e : (e = e.toLowerCase(), t.reactCompat ? e = e.replace(cn, xt) : e = e.replace(un, xt), e.replace(sn, hn));
};
Be.camelCase = dn;
(function(e) {
...
var bn = pn.version.split(".")[0] >= 16, Zt = /* @__PURE__ */ new Set([
  "tr",
  "tbody",
  "thead",
  "tfoot",
...
function En(e) {
  return !Zt.has(e.name);
}
var Qt = {
  PRESERVE_CUSTOM_ATTRIBUTES: bn,
  invertObject: mn,
  isCustomComponent: gn,
  setStyleProp: _n,
  canTextBeChildOfNode: En,
  elementsWithNoTextChildren: Zt
}, xe = ee, Ct = Qt, wn = ["checked", "value"], Tn = ["input", "select", "textarea"], On = {
  reset: !0,
  submit: !0
}, er = function(t, r) {
  t = t || {};
  var n, s, l, f, u, o = {}, h = t.type && On[t.type];
  for (n in t) {
    if (l = t[n], xe.isCustomAttribute(n)) {
      o[n] = l;
      continue;
    }
    if (s = n.toLowerCase(), f = St(s), f) {
      switch (u = xe.getPropertyInfo(f), wn.indexOf(f) !== -1 && Tn.indexOf(r) !== -1 && !h && (f = St("default" + s)), o[f] = l, u && u.type) {
        case xe.BOOLEAN:
          o[f] = !0;
          break;
    ...
    Ct.PRESERVE_CUSTOM_ATTRIBUTES && (o[n] = l);
  }
  return Ct.setStyleProp(t.style, o), o;
};
function St(e) {
  return xe.possibleStandardNames[e];
}
var kn = et, xn = er, De = Qt, Cn = De.setStyleProp, Sn = De.canTextBeChildOfNode;
function tr(e, t) {
  t = t || {};
  for (var r = t.library || kn, n = r.cloneElement, s = r.createElement, l = r.isValidElement, f = [], u, o, h = typeof t.replace == "function", _, x, ne, se = t.trim, w = 0, E = e.length; w < E; w++) {
    ...
    if (u.type === "text") {
      if (o = !u.data.trim().length, o && u.parent && !Sn(u.parent) || se && o)
        continue;
      f.push(u.data);
      continue;
    }
    switch (x = u.attribs, Rn(u) ? Cn(x.style, x) : x && (x = xn(x, u.name)), ne = null, u.type) {
      case "script":
      case "style":
        ...
        break;
      case "tag":
        u.name === "textarea" && u.children[0] ? x.defaultValue = u.children[0].data : u.children && u.children.length && (ne = tr(u.children, t));
        break;
      default:
        continue;
    }
...
var An = tr, Ue = tt, we = Rr, In = er, rr = An;
...
function oe(e, t) {
  if (typeof e != "string")
    throw new TypeError("First argument must be a string");
  return e === "" ? [] : (t = t || {}, rr(
    we(e, t.htmlparser2 || Dn),
    t
  ));
}
oe.domToReact = rr;
oe.htmlToDOM = we;
oe.attributesToProps = In;
...
}(), Qe = typeof window < "u" && typeof document < "u" && window.document === document, Pe = function() {
...
var Fn = 20, zn = ["top", "right", "bottom", "left", "width", "height", "size", "weight"], jn = typeof MutationObserver < "u", Hn = (
  /** @class */
  function() {
    function e() {
      this.connected_ = !1, this.mutationEventsAdded_ = !1, this.mutationsObserver_ = null, this.observers_ = [], this.onTransitionEnd_ = this.onTransitionEnd_.bind(this), this.refresh = Ln(this.refresh.bind(this), Fn);
    }
    return e.prototype.addObserver = function(t) {
      ...
      !Qe || this.connected_ || (document.addEventListener("transitionend", this.onTransitionEnd_), window.addEventListener("resize", this.refresh), jn ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, {
        attributes: !0,
        childList: !0,
        characterData: !0,
        subtree: !0
      ...
      var r = t.propertyName, n = r === void 0 ? "" : r, s = zn.some(function(l) {
        return !!~n.indexOf(l);
      });
      s && this.refresh();
...
function Gn(e) {
  ...
  if (!t && !r)
    return ar;
  var n = Te(e).getComputedStyle(e), s = Bn(n), l = s.left + s.right, f = s.top + s.bottom, u = Me(n.width), o = Me(n.height);
  if (n.boxSizing === "border-box" && (Math.round(u + l) !== t && (u -= Rt(n, "left", "right") + l), Math.round(o + f) !== r && (o -= Rt(n, "top", "bottom") + f)), !Vn(e)) {
...
var Xn = (
  ...
  function() {
    function e(t, r) {
      var n = $n(r);
      ir(this, { target: t, contentRect: n });
    }
    return e;
  }()
), Kn = (
    ...
    return e.prototype.observe = function(t) {
      ...
      if (this.hasActive()) {
        var t = this.callbackCtx_, r = this.activeObservations_.map(function(n) {
          return new Yn(n.target, n.broadcastRect());
        });
...
), or = typeof WeakMap < "u" ? /* @__PURE__ */ new WeakMap() : new nr(), sr = (
  /** @class */
  function() {
    function e(t) {
      ...
      if (!arguments.length)
        throw new TypeError("1 argument required, but only 0 present.");
      var r = Hn.getInstance(), n = new Kn(t, r, this);
      or.set(this, n);
    }
    return e;
  }()
...
var ri = function() {
  return typeof Pe.ResizeObserver < "u" ? Pe.ResizeObserver : sr;
}();
function ni(e) {
  let t = "lg";
  const r = {
    ...
    var n = typeof self < "u" ? self : typeof window < "u" ? window : n !== void 0 ? n : {}, s = !n.document && !!n.postMessage, l = n.IS_PAPA_WORKER || !1, f = {}, u = 0, o = { parse: function(a, i) {
      ...
      if (S(c) && (i.dynamicTypingFunction = c, c = {}), i.dynamicTyping = c, i.transform = !!S(i.transform) && i.transform, i.worker && o.WORKERS_SUPPORTED) {
        var d = function() {
          ...
          return O.onmessage = ur, O.id = u++, f[O.id] = O;
        }();
    ...
    function ur(a) {
      ...
      if (i.error)
        ...
        var v = { abort: function() {
          d = !0, ft(i.workerId, { data: [], errors: [], meta: { aborted: !0 } });
        }, pause: ht, resume: ht };
        if (S(c.userStep)) {
      ...
      i.finished && !d && ft(i.workerId, i.results);
    }
    function ft(a, i) {
      var c = f[a];
...
var Jn = lr.exports;
const Zn = /* @__PURE__ */ At(Jn);
async function ii(e, t = "") {
  try {
    e = new URL(e);
    const r = e.pathname;
    return /(?:\.([^.]+))?$/.exec(r)[1] === "csv" ? await fetch(e.href).then((l) => l.text()).then((l) => (l = l.replace(/(".*?")|,/g, (...u) => u[1] || "|"), l = l.replace(/["]+/g, ""), Zn.parse(l, {
...
class ai extends et.Component {
  ...
  render() {
    return this.state.hasError ? this.props.component ? /* @__PURE__ */ Ke("h1", { children: [
...
function oi({ viewport: e = "lg" }) {
  return /* @__PURE__ */ Ke("section", { className: "loading", "aria-live": "assertive", children: [
    /* @__PURE__ */ ke("span", { className: "sr-only", style: { display: "none" }, children: "Content is loading." }),
    /* @__PURE__ */ Ke("div", { className: `la-ball-beat la-dark ${e}`, children: [
      /* @__PURE__ */ ke("div", {}),
      /* @__PURE__ */ ke("div", {}),
      /* @__PURE__ */ ke("div", {})
    ] })
