import { D as y } from "./storybook-2b211e5b.es.js";
import { s as R, a as h, b as g, c as S } from "./storybook-31fa1f17.es.js";
...
import "./storybook-5db1e0e0.es.js";
import "./storybook-b8c9afe4.es.js";
import "./storybook-fe996ed4.es.js";
const V = {
  theme: "theme-blue",
  ...
  if (t && t !== void 0)
    if (t.includes("–") || t.includes("-")) {
      let c = t.includes("–") ? t.split("–") : t.split("-"), r = t.includes("–") ? "–" : "-", T = c[0].split(" ").map((i) => i.charAt(0).toUpperCase() + i.substring(1).toLowerCase()).join(" "), L = c[1].split(" ").map((i) => i.charAt(0).toUpperCase() + i.substring(1).toLowerCase()).join(" ");
      return T + r + L;
    } else
  ...
  if (!c)
    return t;
  const r = Object.keys(R), T = Object.keys(h), L = Object.keys(g), i = Object.keys(S);
  let a = t;
  r.includes(a) && (a = n(R[t][0])), T.includes(a) && (a = n(h[t][0])), L.includes(a) && (a = n(g[t][0])), i.includes(a) && (a = n(S[t]));
  const p = {
  ...
  return Object.keys(p).includes(a) === !0 && (a = p[a]), a.length === 2 ? a : n(a);
}, lt = {
  title: "Components/Organisms/DataTable",
  component: y
}, o = "dashboard_example_map.csv", w = {
  args: {
    config: e,
...
w.parameters = {
  ...w.parameters,
  docs: {
    ...(m = w.parameters) == null ? void 0 : m.docs,
    source: {
      originalSource: `{
  args: {
    config: Example_1,
    ...
    tabbingId: datasetKey
      ...
      ...(u = (A = w.parameters) == null ? void 0 : A.docs) == null ? void 0 : u.source
    }
  }
};
var E, v, U;
...
d.parameters = {
  ...
  args: {
    ...
    tabbingId: datasetKey
      ...
      ...(C = (f = d.parameters) == null ? void 0 : f.docs) == null ? void 0 : C.source
    }
  }
};
const dt = ["Primary", "CityState", "Grouped"];
export {
  l as CityState,
  d as Grouped,
  w as Primary,
