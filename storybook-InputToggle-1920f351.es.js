...
import { e as Zt } from "./storybook-DataTransform-8cd95c19.es.js";
import { j as Wt, k as _s, i as Ss, m as Sc, g as Ai, G as Go } from "./storybook-Group-eff0b1b9.es.js";
import { P as Y } from "./storybook-index-43433e35.es.js";
...
import { f as Fs, m as Nc } from "./storybook-Icon-73ec66ec.es.js";
import { j as x, a as Te, F as _i } from "./storybook-jsx-runtime-36872362.es.js";
import "./storybook-index-4ed993c7.es.js";
var Ve = typeof globalThis < "u" && globalThis || typeof self < "u" && self || // eslint-disable-next-line no-undef
  ...
  return new Promise(function(n, r) {
    ...
    i.onload = function() {
      var l = {
        ...
        headers: Vc(i.getAllResponseHeaders() || "")
      };
    ...
    function a(l) {
      try {
        return l === "" && Ve.location.href ? Ve.location.href : l;
      } catch {
        return l;
      }
    }
    if (i.open(o.method, a(o.url), !0), o.credentials === "include" ? i.withCredentials = !0 : o.credentials === "omit" && (i.withCredentials = !1), "responseType" in i && (Xe.blob ? i.responseType = "blob" : Xe.arrayBuffer && (i.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof Be || Ve.Headers && t.headers instanceof Ve.Headers)) {
      var u = [];
...
pu.polyfill = !0;
Ve.fetch || (Ve.fetch = pu, Ve.Headers = Be, Ve.Request = Qt, Ve.Response = Dt);
function Cb(e, t) {
  let n, r;
  if (t === void 0)
    for (const o of e)
  ...
  arcTo: function(e, t, n, r, o) {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(d * a - u * l) > zt) || !o)
        ...
        var f = n - i, p = r - s, g = a * a + u * u, m = f * f + p * p, h = Math.sqrt(g), A = Math.sqrt(c), C = o * Math.tan((Wo - Math.acos((g + c - m) / (2 * h * A))) / 2), b = C / A, v = C / h;
  ...
  const [f, p, g] = w.useMemo(() => {
    const C = () => {
      ...
      const {
        ...
        x: V,
        y: N
      } = u.current.element.getBoundingClientRect(), k = {
        left: b,
        top: v,
        width: E,
        height: _,
      ...
      u.current.element instanceof HTMLElement && o && (k.height = u.current.element.offsetHeight, k.width = u.current.element.offsetWidth), Object.freeze(k), c.current && !Zc(u.current.lastBounds, k) && a(u.current.lastBounds = k);
    };
    return [C, d ? Ts(C, d) : C, l ? Ts(C, l) : C];
  }, [a, o, l, d]);
  function m() {
    u.current.scrollContainers && (u.current.scrollContainers.forEach((C) => C.removeEventListener("scroll", g, !0)), u.current.scrollContainers = null), u.current.resizeObserver && (u.current.resizeObserver.disconnect(), u.current.resizeObserver = null);
  }
  function h() {
    u.current.element && (u.current.resizeObserver = new i(g), u.current.resizeObserver.observe(u.current.element), n && u.current.scrollContainers && u.current.scrollContainers.forEach((C) => C.addEventListener("scroll", g, {
      capture: !0,
      passive: !0
    })));
  }
  const A = (C) => {
    !C || C === u.current.element || (m(), u.current.element = C, u.current.scrollContainers = Du(C), h());
  };
  return Kc(g, !!n), Xc(p), w.useEffect(() => {
    m(), h();
  }, [n, g, p]), w.useEffect(() => m, []), [A, s, f];
}
function Xc(e) {
  w.useEffect(() => {
    const t = e;
...
const Jc = ["x", "y", "top", "bottom", "left", "right", "width", "height"], Zc = (e, t) => Jc.every((n) => e[n] === t[n]), Ni = (e) => {
  ...
  "Sequential Green": ["#C7E9C0", "#A1D99B", "#74C476", "#41AB5D", "#238B45", "#005A32"]
}, Mb = nd, Lb = Ni(ed), kb = Ni(Qc), Vb = Ni(td);
...
const md = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  localPoint: hd,
  touchPoint: Yo
}, Symbol.toStringTag, { value: "Module" })), gd = 4.5, Dd = 3.5, $b = (e, t) => {
  if (t) {
...
function Ud(e, t) {
  ...
  var n = t ? jd : $d, r = this._parents, o = this._groups;
  typeof e != "function" && (e = Vd(e));
  for (var i = o.length, s = new Array(i), a = new Array(i), u = new Array(i), l = 0; l < i; ++l) {
    var d = r[l], c = o[l], f = c.length, p = Wd(e.call(d, d && d.__data__, l, r)), g = p.length, m = a[l] = new Array(g), h = s[l] = new Array(g), A = u[l] = new Array(f);
    n(d, c, m, h, A, p, t);
    for (var C = 0, b = 0, v, E; C < g; ++C)
      if (v = m[C]) {
        for (C >= b && (b = C + 1); !(E = h[b]) && ++b < g; )
          ;
        v._next = E || null;
      }
  }
...
var pn = 0, kn = 0, Nn = 0, Bu = 1e3, Mr, Vn, Lr = 0, en = 0, Jr = 0, Yn = typeof performance == "object" && performance.now ? performance : Date, Iu = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function Bi() {
...
kr.prototype = Pu.prototype = {
  ...
  restart: function(e, t, n) {
    ...
    n = (n == null ? Bi() : +n) + (t == null ? 0 : +t), !this._next && Vn !== this && (Vn ? Vn._next = this : Mr = this, Vn = this), this._call = e, this._time = n, Zo();
  },
  stop: function() {
...
const Dr = it(Array.prototype.forEach), Vs = it(Array.prototype.pop), On = it(Array.prototype.push), Tr = it(String.prototype.toLowerCase), fo = it(String.prototype.toString), $s = it(String.prototype.match), Tn = it(String.prototype.replace), Dh = it(String.prototype.indexOf), Eh = it(String.prototype.trim), dt = it(Object.prototype.hasOwnProperty), qe = it(RegExp.prototype.test), Bn = yh(TypeError);
function it(e) {
  return function(t) {
...
function Uu() {
  ...
  const r = n, o = r.currentScript, {
    ...
    DOMParser: f,
    trustedTypes: p
  } = e, g = u.prototype, m = Er(g, "cloneNode"), h = Er(g, "nextSibling"), A = Er(g, "childNodes"), C = Er(g, "parentNode");
  ...
  let N = {};
  t.isSupported = typeof Vu == "function" && typeof C == "function" && E && E.createHTMLDocument !== void 0;
  const {
    MUSTACHE_EXPR: k,
    ERB_EXPR: R,
    TMPLIT_EXPR: I,
  ...
  const ce = re({}, [...js, ...po, ...ho, ...mo, ...Gs]);
  let J = null;
  const ge = re({}, [...Us, ...go, ...Ws, ...yr]);
  let L = Object.seal($u(null, {
    tagNameCheck: {
      writable: !0,
      configurable: !1,
      enumerable: !0,
  ...
  })), te = null, be = null, je = !0, le = !0, de = !1, Ae = !0, we = !1, T = !0, ae = !1, M = !1, Le = !1, Fe = !1, Oe = !1, _e = !1, ze = !0, Ge = !1;
  const st = "user-content-";
  let Ze = !0, j = !1, ue = {}, Ce = null;
  const Ue = re({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
  let yt = null;
  const kt = re({}, ["audio", "video", "img", "source", "image", "track"]);
  let rn = null;
  const on = re({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), sn = "http://www.w3.org/1998/Math/MathML", vt = "http://www.w3.org/2000/svg", xe = "http://www.w3.org/1999/xhtml";
  let Ot = xe, an = !1, bn = null;
  const pr = re({}, [sn, vt, xe], fo);
  let Vt = null;
  ...
  const uo = n.createElement("form"), Cn = function(y) {
    ...
    if (!(bt && bt === y)) {
      if ((!y || typeof y != "object") && (y = {}), y = Ht(y), Vt = // eslint-disable-next-line unicorn/prefer-includes
      so.indexOf(y.PARSER_MEDIA_TYPE) === -1 ? ao : y.PARSER_MEDIA_TYPE, Ne = Vt === "application/xhtml+xml" ? fo : Tr, H = dt(y, "ALLOWED_TAGS") ? re({}, y.ALLOWED_TAGS, Ne) : ce, J = dt(y, "ALLOWED_ATTR") ? re({}, y.ALLOWED_ATTR, Ne) : ge, bn = dt(y, "ALLOWED_NAMESPACES") ? re({}, y.ALLOWED_NAMESPACES, fo) : pr, rn = dt(y, "ADD_URI_SAFE_ATTR") ? re(
        Ht(on),
        ...
        Ne
        // eslint-disable-line indent
      ) : on, yt = dt(y, "ADD_DATA_URI_TAGS") ? re(
        Ht(kt),
        // eslint-disable-line indent
        y.ADD_DATA_URI_TAGS,
        // eslint-disable-line indent
        Ne
        // eslint-disable-line indent
      ) : kt, Ce = dt(y, "FORBID_CONTENTS") ? re({}, y.FORBID_CONTENTS, Ne) : Ue, te = dt(y, "FORBID_TAGS") ? re({}, y.FORBID_TAGS, Ne) : {}, be = dt(y, "FORBID_ATTR") ? re({}, y.FORBID_ATTR, Ne) : {}, ue = dt(y, "USE_PROFILES") ? y.USE_PROFILES : !1, je = y.ALLOW_ARIA_ATTR !== !1, le = y.ALLOW_DATA_ATTR !== !1, de = y.ALLOW_UNKNOWN_PROTOCOLS || !1, Ae = y.ALLOW_SELF_CLOSE_IN_ATTR !== !1, we = y.SAFE_FOR_TEMPLATES || !1, T = y.SAFE_FOR_XML !== !1, ae = y.WHOLE_DOCUMENT || !1, Fe = y.RETURN_DOM || !1, Oe = y.RETURN_DOM_FRAGMENT || !1, _e = y.RETURN_TRUSTED_TYPE || !1, Le = y.FORCE_BODY || !1, ze = y.SANITIZE_DOM !== !1, Ge = y.SANITIZE_NAMED_PROPS || !1, Ze = y.KEEP_CONTENT !== !1, j = y.IN_PLACE || !1, se = y.ALLOWED_URI_REGEXP || ju, Ot = y.NAMESPACE || xe, L = y.CUSTOM_ELEMENT_HANDLING || {}, y.CUSTOM_ELEMENT_HANDLING && Cn(y.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (L.tagNameCheck = y.CUSTOM_ELEMENT_HANDLING.tagNameCheck), y.CUSTOM_ELEMENT_HANDLING && Cn(y.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (L.attributeNameCheck = y.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), y.CUSTOM_ELEMENT_HANDLING && typeof y.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (L.allowCustomizedBuiltInElements = y.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), we && (le = !1), Oe && (Fe = !0), ue && (H = re({}, Gs), J = [], ue.html === !0 && (re(H, js), re(J, Us)), ue.svg === !0 && (re(H, po), re(J, go), re(J, yr)), ue.svgFilters === !0 && (re(H, ho), re(J, go), re(J, yr)), ue.mathMl === !0 && (re(H, mo), re(J, Ws), re(J, yr))), y.ADD_TAGS && (H === ce && (H = Ht(H)), re(H, y.ADD_TAGS, Ne)), y.ADD_ATTR && (J === ge && (J = Ht(J)), re(J, y.ADD_ATTR, Ne)), y.ADD_URI_SAFE_ATTR && re(rn, y.ADD_URI_SAFE_ATTR, Ne), y.FORBID_CONTENTS && (Ce === Ue && (Ce = Ht(Ce)), re(Ce, y.FORBID_CONTENTS, Ne)), Ze && (H["#text"] = !0), ae && re(H, ["html", "head", "body"]), H.table && (re(H, ["tbody"]), delete te.tbody), y.TRUSTED_TYPES_POLICY) {
  ...
  }, An = re({}, ["mi", "mo", "mn", "ms", "mtext"]), hr = re({}, ["foreignobject", "annotation-xml"]), mr = re({}, ["title", "style", "font", "a", "script"]), wn = re({}, [...po, ...ho, ...bh]), _n = re({}, [...mo, ...Ch]), W = function(y) {
    let O = C(y);
    (!O || !O.tagName) && (O = {
      namespaceURI: Ot,
      tagName: "template"
    });
    const $ = Tr(y.tagName), De = Tr(O.tagName);
    return bn[y.namespaceURI] ? y.namespaceURI === vt ? O.namespaceURI === xe ? $ === "svg" : O.namespaceURI === sn ? $ === "svg" && (De === "annotation-xml" || An[De]) : !!wn[$] : y.namespaceURI === sn ? O.namespaceURI === xe ? $ === "math" : O.namespaceURI === vt ? $ === "math" && hr[De] : !!_n[$] : y.namespaceURI === xe ? O.namespaceURI === vt && !hr[De] || O.namespaceURI === sn && !An[De] ? !1 : !_n[$] && (mr[$] || !wn[$]) : !!(Vt === "application/xhtml+xml" && bn[y.namespaceURI]) : !1;
  }, ne = function(y) {
    On(t.removed, {
      element: y
    });
    ...
    try {
      On(t.removed, {
        attribute: O.getAttributeNode(y),
        from: O
      });
    } catch {
      On(t.removed, {
    ...
    if (O.removeAttribute(y), y === "is" && !J[y])
      if (Fe || Oe)
        try {
          ne(O);
        } catch {
    ...
    Vt === "application/xhtml+xml" && Ot === xe && (y = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + y + "</body></html>");
    const De = b ? b.createHTML(y) : y;
    if (Ot === xe)
      try {
        O = new f().parseFromString(De, Vt);
      } catch {
      }
    if (!O || !O.documentElement) {
      O = E.createDocument(Ot, "template", null);
      try {
        O.documentElement.innerHTML = an ? v : De;
      } catch {
      }
    }
    const We = O.body || O.documentElement;
    return y && $ && We.insertBefore(n.createTextNode($), We.childNodes[0] || null), Ot === xe ? P.call(O, ae ? "html" : "body")[0] : ae ? O.documentElement : We;
  }, Sn = function(y) {
    return _.call(
      y.ownerDocument || y,
      y,
    ...
    if (Ct("uponSanitizeElement", y, {
      tagName: $,
      allowedTags: H
    }), y.hasChildNodes() && !Es(y.firstElementChild) && qe(/<[/\w]/g, y.innerHTML) && qe(/<[/\w]/g, y.textContent) || y.nodeType === In.progressingInstruction || T && y.nodeType === In.comment && qe(/<[/\w]/g, y.data))
      return ne(y), !0;
    if (!H[$] || te[$]) {
      if (!te[$] && bs($) && (L.tagNameCheck instanceof RegExp && qe(L.tagNameCheck, $) || L.tagNameCheck instanceof Function && L.tagNameCheck($)))
        return !1;
      if (Ze && !Ce[$]) {
        const De = C(y) || y.parentNode, We = A(y) || y.childNodes;
        if (We && De) {
          const ke = We.length;
    ...
    return y instanceof u && !W(y) || ($ === "noscript" || $ === "noembed" || $ === "noframes") && qe(/<\/no(script|embed|frames)/i, y.innerHTML) ? (ne(y), !0) : (we && y.nodeType === In.text && (O = y.textContent, Dr([k, R, I], (De) => {
      O = Tn(O, De, " ");
    }), y.textContent !== O && (On(t.removed, {
      element: y.cloneNode()
    }), y.textContent = O)), Ct("afterSanitizeElements", y, null), !1);
  }, vs = function(y, O, $) {
    if (ze && (O === "id" || O === "name") && ($ in n || $ in uo))
      return !1;
    if (!(le && !be[O] && qe(z, O))) {
      if (!(je && qe(q, O))) {
        if (!J[O] || be[O]) {
          if (
            ...
            !(bs(y) && (L.tagNameCheck instanceof RegExp && qe(L.tagNameCheck, y) || L.tagNameCheck instanceof Function && L.tagNameCheck(y)) && (L.attributeNameCheck instanceof RegExp && qe(L.attributeNameCheck, O) || L.attributeNameCheck instanceof Function && L.attributeNameCheck(O)) || // Alternative, second condition checks if it's an `is`-attribute, AND
            // the value passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
            O === "is" && L.allowCustomizedBuiltInElements && (L.tagNameCheck instanceof RegExp && qe(L.tagNameCheck, $) || L.tagNameCheck instanceof Function && L.tagNameCheck($)))
          )
            return !1;
        } else if (!rn[O]) {
          if (!qe(se, Tn($, ee, ""))) {
            if (!((O === "src" || O === "xlink:href" || O === "href") && y !== "script" && Dh($, "data:") === 0 && yt[y])) {
              if (!(de && !qe(Q, Tn($, ee, "")))) {
                if ($)
                  return !1;
              }
    ...
    for (; De--; ) {
      ...
      if ($.attrName = xn, $.attrValue = He, $.keepAttr = !0, $.forceKeepAttr = void 0, Ct("uponSanitizeAttribute", y, $), He = $.attrValue, $.forceKeepAttr || (Ie(ke, y), !$.keepAttr))
        continue;
      if (!Ae && qe(/\/>/i, He)) {
        Ie(ke, y);
        continue;
      }
      if (T && qe(/((--!?|])>)|<\/(style|title)/i, He)) {
        Ie(ke, y);
        continue;
      }
      we && Dr([k, R, I], (ws) => {
      ...
      if (vs(As, xn, He)) {
        ...
        try {
          Qe ? y.setAttributeNS(Qe, ke, He) : y.setAttribute(ke, He), Fn(y) ? ne(y) : Vs(t.removed);
        } catch {
        }
      }
    }
    ...
    let O = null;
    const $ = Sn(y);
    for (Ct("beforeSanitizeShadowDOM", y, null); O = $.nextNode(); )
      Ct("uponSanitizeShadowNode", O, null), !ys(O) && (O.content instanceof i && U(O.content), Cs(O));
    Ct("afterSanitizeShadowDOM", y, null);
  };
  return t.sanitize = function(U) {
    let y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, O = null, $ = null, De = null, We = null;
    if (an = !U, an && (U = "<!-->"), typeof U != "string" && !Es(U))
    ...
    if (!t.isSupported)
      return U;
    if (M || Tt(y), t.removed = [], typeof U == "string" && (j = !1), j) {
      if (U.nodeName) {
        const mt = Ne(U.nodeName);
        if (!H[mt] || te[mt])
          throw Bn("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (U instanceof a)
      O = Bt("<!---->"), $ = O.ownerDocument.importNode(U, !0), $.nodeType === In.element && $.nodeName === "BODY" || $.nodeName === "HTML" ? O = $ : O.appendChild($);
    else {
      if (!Fe && !we && !ae && // eslint-disable-next-line unicorn/prefer-includes
      U.indexOf("<") === -1)
        return b && _e ? b.createHTML(U) : U;
      if (O = Bt(U), !O)
        return Fe ? null : _e ? v : "";
    }
    O && Le && ne(O.firstChild);
    const ke = Sn(j ? U : O);
    for (; De = ke.nextNode(); )
    ...
    if (Fe) {
      if (Oe)
        for (We = B.call(O.ownerDocument); O.firstChild; )
          We.appendChild(O.firstChild);
      else
        We = O;
      return (J.shadowroot || J.shadowrootmode) && (We = V.call(r, We, !0)), We;
    }
    let Qe = ae ? O.outerHTML : O.innerHTML;
    return ae && H["!doctype"] && O.ownerDocument && O.ownerDocument.doctype && O.ownerDocument.doctype.name && qe(Gu, O.ownerDocument.doctype.name) && (Qe = "<!DOCTYPE " + O.ownerDocument.doctype.name + `>
` + Qe), we && Dr([k, R, I], (mt) => {
      Qe = Tn(Qe, mt, " ");
    ...
    bt = null, M = !1;
  }, t.isValidAttribute = function(U, y, O) {
    bt || Tt({});
    const $ = Ne(U), De = Ne(y);
    return vs($, De, O);
  }, t.addHook = function(U, y) {
    typeof y == "function" && (N[U] = N[U] || [], On(N[U], y));
...
function Ph(e) {
  var t, n, r, o, i = e.className, s = e.x, a = e.y, u = e.dx, l = e.dy, d = e.type, c = d === void 0 ? "elbow" : d, f = e.stroke, p = f === void 0 ? "#222" : f, g = e.pathProps, m = w.useContext(Qr), h = s ?? ((t = m.x) != null ? t : 0), A = a ?? ((n = m.y) != null ? n : 0), C = u ?? ((r = m.dx) != null ? r : 0), b = l ?? ((o = m.dy) != null ? o : 0), v = h, E = A, _ = h + C, B = A + b;
  if (c === "elbow")
  ...
  return /* @__PURE__ */ F.createElement("path", ri({
    ...
    fill: "transparent",
    pointerEvents: "none",
    d: "M" + h + "," + A + (c === "elbow" ? "L" + v + "," + E : "") + "L" + _ + "," + B
  }, g));
}
Ph.propTypes = {
  className: Y.string,
  type: Y.oneOf(["line", "elbow"]),
  stroke: Y.string
};
function cn() {
...
Wu.propTypes = {
  anchorLineOrientation: Y.oneOf(["horizontal", "vertical"]).isRequired,
  anchorLineStroke: Y.string.isRequired,
...
function Rh(e) {
  var t = e.anchorLineStroke, n = t === void 0 ? "#222" : t, r = e.children, o = e.className, i = e.containerStyle, s = e.horizontalAnchor, a = e.resizeObserverPolyfill, u = e.showAnchorLine, l = u === void 0 ? !0 : u, d = e.verticalAnchor, c = e.x, f = e.y, p = Yc({
    polyfill: a
  }), g = p[0], m = p[1], h = m.width, A = m.height, C = w.useContext(Qr), b = C.x, v = b === void 0 ? 0 : b, E = C.y, _ = E === void 0 ? 0 : E, B = C.dx, P = B === void 0 ? 0 : B, V = C.dy, N = V === void 0 ? 0 : V, k = s || (Math.abs(P) < Math.abs(N) ? "middle" : P > 0 ? "start" : "end"), R = d || (Math.abs(P) > Math.abs(N) ? "middle" : N > 0 ? "start" : "end"), I = w.useMemo(function() {
    var z = c ?? v + P, q = f ?? _ + N;
    return k === "middle" && (z -= h / 2), k === "end" && (z -= h), R === "middle" && (q -= A / 2), R === "end" && (q -= A), {
      x: z,
      y: q
    };
  }, [c, v, P, f, _, N, k, R, h, A]);
  return /* @__PURE__ */ F.createElement(Go, {
    ...
    anchorLineOrientation: Math.abs(P) > Math.abs(N) ? "vertical" : "horizontal",
    anchorLineStroke: n,
    verticalAnchor: R,
    horizontalAnchor: k,
    width: h,
...
const Vh = /* @__PURE__ */ cu(id), $h = /* @__PURE__ */ cu(md);
var Ri = {};
Ri.__esModule = !0;
Ri.default = jh;
var vr = w;
...
var Xs = Qh, $t = w, un = Vh, Ks = $h, Jh = $i(Ri), Js = $i(Mi), Zh = $i(Vi);
function $i(e) {
  return e && e.__esModule ? e : { default: e };
}
function gt() {
...
function Qh(e) {
  var t = e === void 0 ? {} : e, n = t.resetOnStart, r = n === void 0 ? !1 : n, o = t.snapToPointer, i = o === void 0 ? !0 : o, s = t.onDragEnd, a = t.onDragMove, u = t.onDragStart, l = t.x, d = t.y, c = t.dx, f = t.dy, p = t.isDragging, g = t.restrict, m = g === void 0 ? {} : g, h = t.restrictToPath, A = (0, $t.useRef)({
    x: l,
    y: d,
    dx: c,
    dy: f
    ...
    dy: f ?? 0,
    isDragging: !1
  }), b = C[0], v = C[1], E = (0, $t.useState)(new un.Point({
    x: 0,
    y: 0
  })), _ = E[0], B = E[1];
  (0, $t.useEffect)(function() {
    (A.current.x !== l || A.current.y !== d || A.current.dx !== c || A.current.dy !== f) && (A.current = {
      x: l,
      y: d,
      dx: c,
      dy: f
    ...
    p !== void 0 && b.isDragging !== p && v(function(R) {
      return gt({}, R, {
        isDragging: p
      });
    });
  }, [b.isDragging, p, v]);
  var P = (0, Zh.default)(h), V = (0, $t.useCallback)(function(R) {
    R.persist(), v(function(I) {
      var z = I.x, q = z === void 0 ? 0 : z, Q = I.y, ee = Q === void 0 ? 0 : Q, K = I.dx, se = I.dy, H = new un.Point({
        x: (q || 0) + K,
        y: (ee || 0) + se
      }), ce = (0, Ks.localPoint)(R) || new un.Point({
        x: 0,
        y: 0
      }), J = i ? ce : H, ge = (0, Js.default)(J, P, m);
      return B((0, un.subtractPoints)(H, ce)), {
        isDragging: !0,
        dx: r ? 0 : I.dx,
        dy: r ? 0 : I.dy,
        x: r ? ge.x : ge.x - I.dx,
  ...
  }, [u, r, m, P, v, i]), N = (0, $t.useCallback)(function(R) {
    R.persist(), v(function(I) {
      if (!I.isDragging)
        return I;
      var z = I.x, q = z === void 0 ? 0 : z, Q = I.y, ee = Q === void 0 ? 0 : Q, K = (0, Ks.localPoint)(R) || new un.Point({
        x: 0,
        y: 0
      }), se = i ? K : (0, un.sumPoints)(K, _), H = (0, Js.default)(se, P, m);
      return gt({}, I, {
        dx: H.x - q,
        dy: H.y - ee
      });
  ...
  }, [v, a, i, _, P, m]), k = (0, $t.useCallback)(function(R) {
    R.persist(), v(function(I) {
      return gt({}, I, {
        isDragging: !1
      });
...
function em(e) {
  var t = e.canEditLabel, n = t === void 0 ? !0 : t, r = e.canEditSubject, o = r === void 0 ? !0 : r, i = e.children, s = e.dx, a = s === void 0 ? 0 : s, u = e.dy, l = u === void 0 ? 0 : u, d = e.height, c = e.labelDragHandleProps, f = e.onDragEnd, p = e.onDragMove, g = e.onDragStart, m = e.subjectDragHandleProps, h = e.width, A = e.x, C = A === void 0 ? 0 : A, b = e.y, v = b === void 0 ? 0 : b, E = w.useRef(), _ = w.useRef(), B = w.useCallback(function(R) {
    var I = R.event;
    if (g) {
      var z, q, Q, ee, K, se, H, ce;
      g({
        event: I,
        x: C + ((z = (q = E.current) == null ? void 0 : q.dx) != null ? z : 0),
        y: v + ((Q = (ee = E.current) == null ? void 0 : ee.dy) != null ? Q : 0),
        dx: a + ((K = (se = _.current) == null ? void 0 : se.dx) != null ? K : 0),
        dy: l + ((H = (ce = _.current) == null ? void 0 : ce.dy) != null ? H : 0)
      });
    }
  }, [a, l, g, C, v]), P = w.useCallback(function(R) {
    var I = R.event;
    if (p) {
      var z, q, Q, ee, K, se, H, ce;
      p({
  ...
  }, [a, l, p, C, v]), V = w.useCallback(function(R) {
    var I = R.event;
    if (f) {
      var z, q, Q, ee, K, se, H, ce;
      f({
  ...
  return E.current = N, _.current = k, /* @__PURE__ */ F.createElement(F.Fragment, null, /* @__PURE__ */ F.createElement(zu, {
    x: C + N.dx,
    y: v + N.dy,
    dx: a + k.dx,
    dy: l + k.dy
  }, i), N.isDragging && /* @__PURE__ */ F.createElement("rect", {
    width: h,
    height: d,
    onMouseMove: N.dragMove,
    onMouseUp: N.dragEnd,
    fill: "transparent"
  }), o && /* @__PURE__ */ F.createElement("circle", Vr({
    cx: C,
    cy: v,
    transform: "translate(" + N.dx + "," + N.dy + ")",
    onMouseMove: N.dragMove,
    onMouseUp: N.dragEnd,
    onMouseDown: N.dragStart,
    onTouchStart: N.dragStart,
    onTouchMove: N.dragMove,
    onTouchEnd: N.dragEnd,
    cursor: N.isDragging ? "grabbing" : "grab"
  }, Zs, m)), k.isDragging && /* @__PURE__ */ F.createElement("rect", {
    width: h,
    height: d,
    onMouseMove: k.dragMove,
    onMouseUp: k.dragEnd,
    fill: "transparent"
  }), n && /* @__PURE__ */ F.createElement("circle", Vr({
    cx: C + N.dx + a,
    cy: v + N.dy + l,
    transform: "translate(" + k.dx + "," + k.dy + ")",
    onMouseMove: k.dragMove,
    onMouseUp: k.dragEnd,
    onMouseDown: k.dragStart,
    onTouchStart: k.dragStart,
    onTouchMove: k.dragMove,
    onTouchEnd: k.dragEnd,
    cursor: k.isDragging ? "grabbing" : "grab"
  }, Zs, c)));
}
em.propTypes = {
  width: Y.number.isRequired,
...
qu.propTypes = {
  ...
  size: Y.number,
  markerWidth: Y.oneOfType([Y.string, Y.number]),
  markerHeight: Y.oneOfType([Y.string, Y.number]),
  markerUnits: Y.string,
  refX: Y.oneOfType([Y.string, Y.number]),
  refY: Y.oneOfType([Y.string, Y.number]),
...
const wt = 1, im = 1, Kb = ({
  ...
  let [i] = r;
  const s = Number(i) - o - wt * 2 - im * 2, a = `${n.uid}-${Date.now()}`, u = t == null ? void 0 : t.length, l = e && e.length > 0 ? e.reduce((C, b) => C.length > b.length ? C : b) : "", d = 20;
  let c = 50;
  const f = ph(l, "normal 14px sans-serif"), p = Number(n.legend.tickRotation) || 0, g = p * (Math.PI / 180), m = c + Number(f) * Math.sin(g), h = t.map((C, b) => {
    const v = b / (t.length - 1) * 100;
    return /* @__PURE__ */ F.createElement("stop", { key: b, offset: `${v}%`, style: { stopColor: C, stopOpacity: 1 } });
  }), A = e.map((C, b) => {
    const v = s / u, E = b * v + v + wt, _ = p ? "end" : "middle", B = p ? "middle" : "start", P = b === e.length - 1;
    return /* @__PURE__ */ F.createElement(Go, { top: wt }, !P && /* @__PURE__ */ F.createElement("line", { x1: E, x2: E, y1: 30, y2: d, stroke: "black" }), /* @__PURE__ */ F.createElement(
      Fc,
      {
        angle: -n.legend.tickRotation,
        x: E,
        y: d,
        dy: 10,
        dx: -v / 2,
  ...
  if (!(n.type === "map" && n.legend.position === "side" || !n.legend.position) && !(n.type === "chart" && (n.legend.position === "left" || n.legend.position === "right" || !n.legend.position)) && n.legend.style === "gradient")
    return /* @__PURE__ */ F.createElement("svg", { style: { overflow: "visible", width: "100%", marginTop: 10 }, height: m }, /* @__PURE__ */ F.createElement("rect", { x: 0, y: 0, width: s + wt * 2, height: d + wt * 2, fill: "#d3d3d3" }), /* @__PURE__ */ F.createElement("linearGradient", { id: `gradient-smooth-${a}`, x1: "0%", y1: "0%", x2: "100%", y2: "0%" }, h), n.legend.subStyle === "smooth" && /* @__PURE__ */ F.createElement(
      "rect",
      {
        x: wt,
        y: wt,
        width: s,
        height: d,
        fill: `url(#gradient-smooth-${a})`
      }
    ), n.legend.subStyle === "linear blocks" && t.map((C, b) => {
      const v = s / u, E = b * v + wt;
    ...
    }), /* @__PURE__ */ F.createElement("g", null, A));
};
var Yu = {
  color: void 0,
  size: void 0,
...
function am(e) {
  var t = function(n) {
    var r = e.attr, o = e.size, i = e.title, s = sm(e, ["attr", "size", "title"]), a = o || n.size || "1em", u;
...
function qt(e) {
  var t = typeof e;
  return process.env.NODE_ENV !== "production" && (t = fm(e)), t;
}
function Ku(e, t, n) {
  var r;
  ...
  function f(m) {
    ...
    for (var h = s = a, A = 0; A < h.length; A++) {
      var C = h[A];
      C();
    }
    return m;
    ...
    return m = {
      ...
      subscribe: function(C) {
        if (typeof C != "object" || C === null)
          throw new Error(process.env.NODE_ENV === "production" ? et(11) : "Expected the observer to be an object. Instead, received: '" + qt(C) + "'");
        function b() {
          C.next && C.next(d());
        }
        b();
...
function Em() {
  return aa || (aa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function r(b, v, E) {
      {
        ...
        B !== "" && (v += "%s", E = E.concat([B]));
        var P = E.map(function(V) {
          return String(V);
        });
        P.unshift("Warning: " + v), Function.prototype.apply.call(console[b], console, P);
      }
    }
    function o(b, v) {
    ...
    function f(b, v, E) {
      ...
      if (!c) {
        var B = v();
        i(_, B) || (n("The result of getSnapshot should be cached to avoid an infinite loop"), c = !0);
      }
      var P = s({
        inst: {
          value: _,
      ...
      return u(function() {
        V.value = _, V.getSnapshot = v, p(V) && N({
          inst: V
        });
      }, [b, _, v]), a(function() {
        p(V) && N({
    ...
    var m = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", h = !m, A = h ? g : f, C = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : A;
    yo.useSyncExternalStore = C, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
  }()), yo;
}
process.env.NODE_ENV === "production" ? ui.exports = Dm() : ui.exports = Em();
...
function ym() {
  ...
  return vo.useSyncExternalStoreWithSelector = function(l, d, c, f, p) {
    ...
    g = a(function() {
      function A(_) {
        if (!C) {
          if (C = !0, b = _, _ = f(_), p !== void 0 && m.hasValue) {
            var B = m.value;
            if (p(B, _))
              return v = B;
          }
        ...
        if (B = v, r(b, _))
          return B;
        var P = f(_);
        return p !== void 0 && p(B, P) ? B : (b = _, v = P);
      }
      var C = !1, b, v, E = c === void 0 ? null : c;
      return [function() {
        return A(d());
      ...
      var A = a(function() {
        var E = !1, _, B, P = function(R) {
          ...
          if (r(q, R))
            return Q;
          var ee = p(R);
          return g !== void 0 && g(Q, ee) ? Q : (_ = R, B = ee, ee);
        }, V = f === void 0 ? null : f, N = function() {
          return P(c());
        }, k = V === null ? void 0 : function() {
          return P(V());
        };
        return [N, k];
      }, [c, f, p, g]), C = A[0], b = A[1], v = o(d, C, b);
      return s(function() {
...
process.env.NODE_ENV === "production" ? ym() : vm();
function bm(e) {
  e();
}
let Zu = bm;
const Cm = (e) => Zu = e, Am = () => Zu, ca = Symbol.for("react-redux-context"), da = typeof globalThis < "u" ? globalThis : (
...
function Sm() {
  ...
  return fe.AsyncMode = u, fe.ConcurrentMode = l, fe.ContextConsumer = a, fe.ContextProvider = s, fe.Element = t, fe.ForwardRef = d, fe.Fragment = r, fe.Lazy = g, fe.Memo = p, fe.Portal = n, fe.Profiler = i, fe.StrictMode = o, fe.Suspense = c, fe.isAsyncMode = function(E) {
    ...
    return typeof E == "string" || typeof E == "function" || E === r || E === l || E === i || E === o || E === c || E === f || typeof E == "object" && E !== null && (E.$$typeof === g || E.$$typeof === p || E.$$typeof === s || E.$$typeof === a || E.$$typeof === d || E.$$typeof === h || E.$$typeof === A || E.$$typeof === C || E.$$typeof === m);
  }, fe.typeOf = b, fe;
}
var pe = {};
/** @license React v16.13.1
...
function Fm() {
  return pa || (pa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function b(T) {
      ...
      T === r || T === l || T === i || T === o || T === c || T === f || typeof T == "object" && T !== null && (T.$$typeof === g || T.$$typeof === p || T.$$typeof === s || T.$$typeof === a || T.$$typeof === d || T.$$typeof === h || T.$$typeof === A || T.$$typeof === C || T.$$typeof === m);
    }
    function v(T) {
    ...
    var E = u, _ = l, B = a, P = s, V = t, N = d, k = r, R = g, I = p, z = n, q = i, Q = o, ee = c, K = !1;
    function se(T) {
      return K || (K = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), H(T) || v(T) === u;
    }
    function H(T) {
      return v(T) === l;
    }
    ...
    pe.AsyncMode = E, pe.ConcurrentMode = _, pe.ContextConsumer = B, pe.ContextProvider = P, pe.Element = V, pe.ForwardRef = N, pe.Fragment = k, pe.Lazy = R, pe.Memo = I, pe.Portal = z, pe.Profiler = q, pe.StrictMode = Q, pe.Suspense = ee, pe.isAsyncMode = se, pe.isConcurrentMode = H, pe.isContextConsumer = ce, pe.isContextProvider = J, pe.isElement = ge, pe.isForwardRef = L, pe.isFragment = te, pe.isLazy = be, pe.isMemo = je, pe.isPortal = le, pe.isProfiler = de, pe.isStrictMode = Ae, pe.isSuspense = we, pe.isValidElementType = b, pe.typeOf = v;
  }()), pe;
}
process.env.NODE_ENV === "production" ? li.exports = Sm() : li.exports = Fm();
var xm = li.exports, Gi = xm, Nm = {
  childContextTypes: !0,
  contextType: !0,
  contextTypes: !0,
  defaultProps: !0,
...
Ui[Gi.Memo] = el;
function ha(e) {
  return Gi.isMemo(e) ? el : Ui[e.$$typeof] || Nm;
}
var Bm = Object.defineProperty, Im = Object.getOwnPropertyNames, ma = Object.getOwnPropertySymbols, Pm = Object.getOwnPropertyDescriptor, Rm = Object.getPrototypeOf, ga = Object.prototype;
function tl(e, t, n) {
  if (typeof t != "string") {
    if (ga) {
      var r = Rm(t);
...
function km() {
  return ya || (ya = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), a = Symbol.for("react.server_context"), u = Symbol.for("react.forward_ref"), l = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), c = Symbol.for("react.memo"), f = Symbol.for("react.lazy"), p = Symbol.for("react.offscreen"), g = !1, m = !1, h = !1, A = !1, C = !1, b;
    b = Symbol.for("react.module.reference");
    function v(M) {
      return !!(typeof M == "string" || typeof M == "function" || M === n || M === o || C || M === r || M === l || M === d || A || M === p || g || m || h || typeof M == "object" && M !== null && (M.$$typeof === f || M.$$typeof === c || M.$$typeof === i || M.$$typeof === s || M.$$typeof === u || // This needs to include all possible module reference object
    ...
    var _ = s, B = i, P = e, V = u, N = n, k = f, R = c, I = t, z = o, q = r, Q = l, ee = d, K = !1, se = !1;
    function H(M) {
    ...
    me.ContextConsumer = _, me.ContextProvider = B, me.Element = P, me.ForwardRef = V, me.Fragment = N, me.Lazy = k, me.Memo = R, me.Portal = I, me.Profiler = z, me.StrictMode = q, me.Suspense = Q, me.SuspenseList = ee, me.isAsyncMode = H, me.isConcurrentMode = ce, me.isContextConsumer = J, me.isContextProvider = ge, me.isElement = L, me.isForwardRef = te, me.isFragment = be, me.isLazy = je, me.isMemo = le, me.isPortal = de, me.isProfiler = Ae, me.isStrictMode = we, me.isSuspense = T, me.isSuspenseList = ae, me.isValidElementType = v, me.typeOf = E;
  }()), me;
}
process.env.NODE_ENV === "production" ? ci.exports = Lm() : ci.exports = km();
var va = ci.exports;
function Wi(e) {
...
function jm(e, t, n, r, {
  ...
  let a = !1, u, l, d, c, f;
  function p(C, b) {
    return u = C, l = b, d = e(u, l), c = t(r, l), f = n(d, c, l), a = !0, f;
  }
  function g() {
  ...
  function h() {
    const C = e(u, l), b = !s(C, d);
    return d = C, b && (f = n(d, c, l)), f;
  }
  function A(C, b) {
    const v = !i(b, l), E = !o(C, u, b, l);
    return u = C, l = b, v && E ? g() : v ? m() : E ? h() : f;
  }
  return function(b, v) {
    return a ? A(b, v) : p(b, v);
  };
}
function Gm(e, t) {
  let {
  ...
  return process.env.NODE_ENV !== "production" && Vm(s, a, u), jm(s, a, u, e, i);
}
function Um(e, t) {
  const n = {};
  for (const r in e) {
...
function nl(e, t, n) {
  Wm(e) || Wi(`${n}() in ${t} must return a plain object. Instead received ${e}.`);
}
function di(e) {
  return function(n) {
    const r = e(n);
...
function Xm(e) {
  return e ? typeof e == "function" ? Ym(e) : zi(e, "mergeProps") : () => qm;
}
function Km() {
  const e = Am();
  let t = null, n = null;
...
function ol(e, t) {
  ...
  function d() {
    o++, n || (n = t ? t.addNestedSub(u) : e.subscribe(u), r = Km());
  }
  function c() {
...
const Jm = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", $r = Jm ? w.useLayoutEffect : w.useEffect;
function Aa(e, t) {
...
const Zm = ["reactReduxForwardedRef"];
let il = _m;
const Qm = (e) => {
  il = e;
}, e0 = [null, null], t0 = (e) => {
...
function o0(e, t, n, r, o, i, s, a, u, l, d) {
  if (!e)
    return () => {
    };
  let c = !1, f = null;
  const p = () => {
    ...
    A || (f = null), h === i.current ? s.current || l() : (i.current = h, u.current = h, s.current = !0, d());
  };
...
function sl(e, t, n, {
  ...
  const d = l, c = Hm(e), f = zm(t), p = Xm(n), g = !!e;
  return (h) => {
    if (process.env.NODE_ENV !== "production" && !va.isValidElementType(h))
      throw new Error(`You must pass a component to the function returned by connect. Instead received ${t0(h)}`);
    const A = h.displayName || h.name || "Component", C = `Connect(${A})`, b = {
    ...
    function v(B) {
      const [P, V, N] = w.useMemo(() => {
        const {
          reactReduxForwardedRef: T
        } = B, ae = gu(B, Zm);
        return [B.context, T, ae];
      }, [B]), k = w.useMemo(() => P && P.Consumer && // @ts-ignore
      va.isContextConsumer(/* @__PURE__ */ w.createElement(P.Consumer, null)) ? P : d, [P, d]), R = w.useContext(k), I = !!B.store && !!B.store.getState && !!B.store.dispatch, z = !!R && !!R.store;
      if (process.env.NODE_ENV !== "production" && !I && !z)
        throw new Error(`Could not find "store" in the context of "${C}". Either wrap the root component in a <Provider>, or pass a custom React context provider to <Provider> and the corresponding React context consumer to ${C} in connect options.`);
      const q = I ? B.store : R.store, Q = z ? R.getServerState : q.getState, ee = w.useMemo(() => Gm(q.dispatch, b), [q]), [K, se] = w.useMemo(() => {
        if (!g)
          return e0;
        const T = ol(q, I ? void 0 : R.subscription), ae = T.notifyNestedSubs.bind(T);
        return [T, ae];
      }, [q, I, R]), H = w.useMemo(() => I ? R : dn({}, R, {
        subscription: K
      }), [I, R, K]), ce = w.useRef(), J = w.useRef(N), ge = w.useRef(), L = w.useRef(!1);
      w.useRef(!1);
      const te = w.useRef(!1), be = w.useRef();
      $r(() => (te.current = !0, () => {
        te.current = !1;
      }), []);
      const je = w.useMemo(() => () => ge.current && N === J.current ? ge.current : ee(q.getState(), N), [q, N]), le = w.useMemo(() => (ae) => K ? o0(
        g,
        q,
        K,
        // @ts-ignore
...
`), T;
      ...
      return w.useMemo(() => g ? /* @__PURE__ */ w.createElement(k.Provider, {
        value: H
      }, Ae) : Ae, [k, Ae, H]);
    }
    const _ = w.memo(v);
    if (_.WrappedComponent = h, _.displayName = v.displayName = C, u) {
      const P = w.forwardRef(function(N, k) {
        return /* @__PURE__ */ w.createElement(_, dn({}, N, {
          reactReduxForwardedRef: k
        }));
      });
      return P.displayName = C, P.WrappedComponent = h, Da(P, h);
    }
    return Da(_, h);
  };
}
...
Qm(ji.useSyncExternalStore);
Cm(wi.unstable_batchedUpdates);
function a0(e, t) {
...
function al(e, t) {
  ...
  })[0], r = w.useRef(!0), o = w.useRef(n), i = r.current || !!(t && o.current.inputs && a0(t, o.current.inputs)), s = i ? o.current : {
    inputs: t,
    result: e()
  };
...
var ie = al, G = u0, l0 = process.env.NODE_ENV === "production", wo = "Invariant failed";
function _a(e, t) {
  if (!e) {
    if (l0)
      throw new Error(wo);
...
var ft = function(t) {
  ...
  var r = t.borderBox, o = t.border, i = t.margin, s = t.padding, a = c0(r, n);
  return qi({
    borderBox: a,
    border: o,
    margin: i,
...
const Kn = h0, m0 = process.env.NODE_ENV === "production", g0 = /[ \t]{2,}/g, D0 = /^[ \t]*/gm, xa = (e) => e.replace(g0, " ").replace(D0, "").trim(), E0 = (e) => xa(`
  %c@hello-pangea/dnd

  %c${xa(e)}

  %c👷‍ This is a development only message. It will be removed in production builds.
`), y0 = (e) => [E0(e), "color: #00C584; font-size: 1.2em; font-weight: bold;", "line-height: 1.5", "color: #723874;"], v0 = "__@hello-pangea/dnd-disable-dev-warnings";
function cl(e, t) {
  m0 || typeof window < "u" && window[v0] || console[e](...y0(t));
}
...
const C0 = process.env.NODE_ENV === "production", Na = "Invariant failed";
...
function D(e, t) {
  if (!e)
    throw C0 ? new Jn(Na) : new Jn(`${Na}: ${t || ""}`);
}
...
const sr = (e, t) => ({
  ...
  bottom: 0,
  left: 0
}, T0 = (e, t) => t ? sr(e, t.scroll.diff.displacement) : e, B0 = (e, t, n) => n && n.increasedBy ? {
  ...e,
  [t.end]: e[t.end] + n.increasedBy[t.line]
} : e, I0 = (e, t) => t && t.shouldClipSubject ? N0(t.pageMarginBox, e) : ft(e);
var hn = ({
  page: e,
  withPlaceholder: t,
  axis: n,
  ...
  const o = T0(e.marginBox, r), i = B0(o, n, t), s = I0(i, r);
  return {
    page: e,
    withPlaceholder: t,
    active: s
...
const hl = Re((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), ml = Re((e) => e.reduce((t, n) => (t[n.descriptor.id] = n, t), {})), eo = Re((e) => Object.values(e)), P0 = Re((e) => Object.values(e));
var nn = Re((e, t) => P0(t).filter((r) => e === r.descriptor.droppableId).sort((r, o) => r.descriptor.index - o.descriptor.index));
function Xi(e) {
...
var no = Re((e, t) => t.filter((n) => n.descriptor.id !== e.descriptor.id)), R0 = ({
  isMovingForward: e,
  draggable: t,
  destination: n,
  insideDestination: r,
...
var L0 = M0, lt = (e, t) => (n) => e <= n && n <= t, Dl = (e) => {
...
const $0 = (e, t) => {
  ...
  return sr(e, n);
}, j0 = (e, t, n) => t.subject.active ? n(t.subject.active)(e) : !1, G0 = (e, t, n) => n(t)(e), Ji = ({
  target: e,
  destination: t,
  viewport: n,
  ...
  const i = r ? $0(e, t) : e;
  return j0(i, t, o) && G0(i, n, o);
}, U0 = (e) => Ji({
  ...e,
  isVisibleThroughFrameFn: Dl
}), yl = (e) => Ji({
  ...e,
  isVisibleThroughFrameFn: k0
}), W0 = (e) => Ji({
  ...e,
...
function er({
  ...
  return e.reduce(function(a, u) {
    const l = H0(u, n), d = u.descriptor.id;
    if (a.all.push(d), !U0({
      target: l,
      destination: t,
      viewport: r,
...
var Y0 = ({
  ...
  const o = r.draggableId, i = n[o].page.borderBox.center, s = J0({
...
const vl = (e, t) => t.margin[e.start] + t.borderBox[e.size] / 2, Q0 = (e, t) => t.margin[e.end] + t.borderBox[e.size] / 2, Zi = (e, t, n) => t[e.crossAxisStart] + n.margin[e.crossAxisStart] + n.borderBox[e.crossAxisSize] / 2, Pa = ({
  axis: e,
  moveRelativeTo: t,
  isMoving: n
  ...
  moveRelativeTo: t,
  isMoving: n
}) => tn(e.line, t.marginBox[e.start] - Q0(e, n), Zi(e, t.marginBox, n)), eg = ({
  axis: e,
  moveInto: t,
  isMoving: n
...
const ng = ({
  ...
  return !n || !s ? i : s.type === "REORDER" ? tg({
    impact: e,
    draggable: t,
    draggables: r,
    droppable: n,
...
var og = ({
  ...
  const i = bl(t, $e(t.scroll.current, o)), s = n.frame ? Yi(n, $e(n.frame.scroll.current, o)) : n, a = e.displaced, u = er({
...
}, ig = (e, t) => $e(e.scroll.diff.displacement, t), Qi = ({
  pageBorderBoxCenter: e,
  draggable: t,
  viewport: n
}) => {
  const r = ig(n, e), o = tt(r, t.page.borderBox.center);
  ...
  if (!n.isEnabled)
    return null;
  const l = nn(n.descriptor.id, r), d = vn(t, n), c = R0({
    isMovingForward: e,
    draggable: t,
    destination: n,
    insideDestination: l,
...
const cg = (e, t, n) => {
  ...
  const o = ar(e.axis, t.displaceBy).point, i = cg(e, o, n), s = {
    placeholderSize: o,
    increasedBy: i,
  ...
  const a = i ? $e(r.scroll.max, i) : r.scroll.max, u = Al(r, a), l = hn({
    page: e.subject.page,
    withPlaceholder: s,
    axis: e.axis,
    frame: u
...
var fg = ({
  ...
  if (!u)
    return null;
  const l = nn(u.descriptor.id, o), d = lg({
    pageBorderBoxCenter: t,
    viewport: s,
    destination: u,
    insideDestination: l,
...
var mg = ({
  ...
  const n = hg(e.impact, e.dimensions.droppables), r = !!n, o = e.dimensions.droppables[e.critical.droppable.id], i = n || o, s = i.axis.direction, a = s === "vertical" && (t === "MOVE_UP" || t === "MOVE_DOWN") || s === "horizontal" && (t === "MOVE_LEFT" || t === "MOVE_RIGHT");
  if (a && !r)
    return null;
...
function Eg({
  ...
  return r.length ? r.length === 1 ? r[0].descriptor.id : Dg({
    pageBorderBox: e,
    draggable: t,
    candidates: r
  }) : null;
...
var bg = ({
  ...
  const a = n.axis, u = ar(n.axis, t.displaceBy), l = u.value, d = e[a.start], c = e[a.end], p = no(t, r).find((m) => {
    const h = m.descriptor.id, A = m.page.borderBox.center[a.line], C = Mt(h, s), b = Fl({
      displaced: o,
      id: h
    });
    return C ? b ? c <= A : d < A - l : b ? c <= A + l : d < A;
  }) || null, g = vg({
    draggable: t,
    closest: p,
    inHomeList: vn(t, n)
...
var Ag = ({
  ...
  const s = r.axis, a = ar(r.axis, e.displaceBy), u = a.value, l = t[s.start], d = t[s.end], f = no(e, o).find((g) => {
    const m = g.descriptor.id, h = g.page.borderBox, C = h[s.size] / Cg, b = Mt(m, i), v = Fl({
      displaced: n.displaced,
      id: m
    });
    return b ? v ? d > h[s.start] + C && d < h[s.end] - C : l > h[s.start] - u + C && l < h[s.end] - u - C : v ? d > h[s.start] + u + C && d < h[s.end] + u - C : l > h[s.start] + C && l < h[s.end] - C;
  });
  return f ? {
    displacedBy: a,
    displaced: n.displaced,
  ...
  const a = Sl(t.page.borderBox, e), u = Eg({
    pageBorderBox: a,
    draggable: t,
    droppables: r
  });
  if (!u)
    return L0;
  const l = r[u], d = nn(l.descriptor.id, n), c = yg(l, a);
  return Ag({
...
var _g = ({
  ...
  const s = r || e.viewport, a = n || e.dimensions, u = t || e.current.client.selection, l = tt(u, e.initial.client.selection), d = {
    offset: l,
    selection: u,
    borderBoxCenter: $e(e.initial.client.borderBoxCenter, l)
  }, c = {
    selection: $e(d.selection, s.scroll.current),
    borderBoxCenter: $e(d.borderBoxCenter, s.scroll.current),
    offset: $e(d.offset, s.scroll.diff.value)
  }, f = {
    client: d,
    page: c
  };
...
var Nl = ({
  ...
  const i = e.displaced, s = Sg(i.all, n), a = er({
    afterDragging: s,
    destination: r,
    displacedBy: e.displacedBy,
    viewport: t.frame,
...
var Ng = ({
  ...
  return e.map((o) => {
    const i = o.descriptor.droppableId, s = t[i], u = Og(s).scroll.diff.value, l = $e(r, u);
    return Ng({
      draggable: o,
      offset: l,
  ...
  ur();
  const n = t.modified.map((A) => {
    const C = e.dimensions.droppables[A.droppableId];
    return Yi(C, A.scroll);
  }), r = {
...
var Ig = (e = ka, t) => {
  ...
  if (t.type === "INITIAL_PUBLISH") {
    ...
    const {
      ...
      client: l,
      page: {
        selection: $e(l.selection, o.scroll.initial),
        borderBoxCenter: $e(l.selection, o.scroll.initial),
        offset: $e(l.selection, o.scroll.diff.value)
      }
  ...
  if (t.type === "PUBLISH_WHILE_DRAGGING")
    return e.phase === "COLLECTING" || e.phase === "DROP_PENDING" || (process.env.NODE_ENV !== "production" ? D(!1, `Unexpected ${t.type} received in phase ${e.phase}`) : D(!1)), Bg({
      state: e,
      published: t.payload
    });
  if (t.type === "MOVE") {
...
var Zg = (e) => ({
  ...
  })), t().phase !== "IDLE" && (process.env.NODE_ENV !== "production" ? D(!1, "Unexpected phase to start a drag") : D(!1)), n(ts()), n(Pg({
    draggableId: i,
    movementMode: a
  }));
  const d = {
...
}, Va = (e) => Rt(e, Me) ? void 0 : `translate(${e.x}px, ${e.y}px)`, mi = {
  moveTo: Va,
  drop: (e, t) => {
    const n = Va(e);
    if (n)
...
var nD = ({
  ...
  if (r >= $a)
    return Ll;
  const o = r / $a, i = gi + eD * o, s = n === "CANCEL" ? i * tD : i;
...
const lD = (e) => e.type === "DROP_COMPLETE" || e.type === "DROP_ANIMATE" || e.type === "FLUSH", cD = (e) => {
  const t = uD({
    onWindowScroll: (n) => {
      e.dispatch(Gg({
        newScroll: n
  ...
  return (n) => (r) => {
    !t.isActive() && r.type === "INITIAL_PUBLISH" && t.start(), t.isActive() && lD(r) && t.stop(), n(r);
  };
};
var dD = cD, fD = (e) => {
  let t = !1, n = !1;
...
const hD = (e, t) => e == null && t == null ? !0 : e == null || t == null ? !1 : e.droppableId === t.droppableId && e.index === t.index, mD = (e, t) => e == null && t == null ? !0 : e == null || t == null ? !1 : e.draggableId === t.draggableId && e.droppableId === t.droppableId, gD = (e, t) => {
  if (e === t)
    return !0;
...
var DD = (e, t) => {
  ...
  const o = (c, f) => {
    ...
    const m = !gD(c, r.lastCritical);
    m && (r.lastCritical = c);
    const h = !hD(r.lastLocation, p);
    h && (r.lastLocation = p);
    const A = !mD(r.lastCombine, g);
    if (A && (r.lastCombine = g), !m && !h && !A)
      return;
    const C = {
      ...br(c, r.mode),
      combine: g,
    ...
    n.add(() => {
      Pn("onDragUpdate", () => xo(e().onDragUpdate, C, t, Br.onDragUpdate));
    });
  }, u = () => {
...
const _D = (e) => e.type === "DROP_COMPLETE" || e.type === "DROP_ANIMATE" || e.type === "FLUSH";
var SD = (e) => (t) => (n) => (r) => {
  if (_D(r)) {
    e.stop(), n(r);
    return;
...
var xD = FD;
const ND = process.env.NODE_ENV !== "production" && typeof window < "u" && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({
...
var OD = ({
  ...
  announce: o,
  autoScroller: i
}) => Ku(Ig, ND(gm(Qg(n), AD(e), Zg(e), sD, vD, CD, xD, SD(i), dD, wD(t), ED(r, o))));
const No = () => ({
  additions: {},
  removals: {},
  modified: {}
...
var Vl = ({
  ...
  const e = kl(), t = jl(), n = e.y, r = e.x, o = $l(), i = o.clientWidth, s = o.clientHeight, a = r + i, u = n + s;
  return {
    frame: ft({
      top: n,
      left: r,
  ...
  ur();
  const r = BD(), o = r.scroll.current, i = e.droppable, s = n.droppable.getAllByType(i.type).map((d) => d.callbacks.getDimensionAndWatchScroll(o, t)), a = n.draggable.getAllByType(e.draggable.type).map((d) => d.getDimension(o)), u = {
    draggables: ml(a),
    droppables: hl(s)
  };
  return lr(), {
...
}, Gl = (e, t) => e.phase === "IDLE" ? !0 : e.phase !== "DROP_ANIMATING" || e.completed.result.draggableId === t ? !1 : e.completed.result.reason === "DROP", RD = (e) => {
  window.scrollBy(e.x, e.y);
};
const MD = Re((e) => eo(e).filter((t) => !(!t.isEnabled || !t.frame))), LD = (e, t) => MD(t).find((r) => (r.frame || (process.env.NODE_ENV !== "production" ? D(!1, "Invalid result") : D(!1)), _l(r.frame.pageMarginBox)(e))) || null;
var kD = ({
  center: e,
  destination: t,
  droppables: n
...
var VD = (e, t, n = () => nr) => {
  ...
  const i = $D(e, t, o);
  return i === 0 ? 0 : r ? Math.max(jD(i, n, o), os) : i;
}, Ua = ({
  container: e,
  distanceToEdges: t,
  dragStartTime: n,
...
const WD = pl((e) => e === 0 ? 0 : e > 0 ? 1 : -1), is = (() => {
...
var qD = ({
  ...
  const r = (a, u) => {
    const l = $e(a.current.client.selection, u);
    e({
      client: l
    });
  }, o = (a, u) => {
...
}, QD = (e) => (t) => `[${t}="${e}"]`, Rn = (e, t) => e.map((n) => {
  const r = n.styles[t];
  return r ? `${n.selector} { ${r} }` : "";
}).join(" "), eE = "pointer-events: none;";
var tE = (e) => {
  const t = QD(e), n = (() => {
    const a = `
      cursor: -webkit-grab;
...
const nE = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u" ? w.useLayoutEffect : w.useEffect;
var rt = nE;
const Oo = () => {
...
function rE(e, t) {
  const n = ie(() => tE(e), [e]), r = w.useRef(null), o = w.useRef(null), i = G(Re((c) => {
    const f = o.current;
  ...
  const a = G(() => i(n.dragging), [i, n.dragging]), u = G((c) => {
    if (c === "DROP") {
      i(n.dropAnimating);
      return;
    }
...
function oE(e) {
  const t = w.useRef({}), n = w.useRef(null), r = w.useRef(null), o = w.useRef(!1), i = G(function(f, p) {
    const g = {
      id: f,
      focus: p
    };
...
var uE = aE;
const lE = (e) => `rfd-announcement-${e}`;
function cE(e) {
  const t = ie(() => lE(e), [e]), n = w.useRef(null);
  return w.useEffect(function() {
    const i = document.createElement("div");
    return n.current = i, i.id = t, i.setAttribute("aria-live", "assertive"), i.setAttribute("aria-atomic", "true"), dn(i.style, uE), rr().appendChild(i), function() {
      setTimeout(function() {
        const u = rr();
...
function fE(e, t = Xl) {
  return ie(() => `${e}${t.separator}${dE++}`, [t.separator, e]);
}
function pE(e, t = Xl) {
  const n = F.useId();
  return ie(() => `${e}${t.separator}${n}`, [t.separator, e, n]);
}
var ls = "useId" in F ? pE : fE;
function hE({
  contextId: e,
  uniqueId: t
}) {
...
var oo = F.createContext(null), gE = {
...
}, EE = (e, t) => t.major > e.major ? !0 : t.major < e.major ? !1 : t.minor > e.minor ? !0 : t.minor < e.minor ? !1 : t.patch >= e.patch;
var yE = (e, t) => {
  const n = qa(e), r = qa(t);
  EE(n, r) || process.env.NODE_ENV !== "production" && Ee(`
    React version: [${r.raw}]
...
function bE() {
  dr(() => {
    yE(gE.react, F.version), vE(document);
  }, []);
}
function ds(e) {
  const t = w.useRef(e);
...
const AE = 9, wE = 13, fs = 27, Kl = 32, _E = 33, SE = 34, FE = 35, xE = 36, NE = 37, OE = 38, TE = 39, BE = 40, IE = {
  [wE]: !0,
  [AE]: !0
};
var Jl = (e) => {
  IE[e.keyCode] && e.preventDefault();
};
const PE = (() => {
...
function HE(e) {
  const t = w.useRef(Bo), n = w.useRef(Pt), r = G(function() {
    return t.current;
  }, []), o = G(function(p) {
    t.current = p;
  }, []), i = ie(() => ({
    ...
    const p = {
      ...
      completed: a,
      getPhase: r
    }, m = ut(window, zE(g), p), h = ut(window, WE(g), p);
    n.current = function() {
      m(), h();
    };
  }, [u, r, a]), d = G(function() {
...
const YE = ["input", "button", "textarea", "select", "option", "optgroup", "video", "audio"];
function Ql(e, t) {
  if (t == null)
    return !1;
  if (YE.includes(t.tagName.toLowerCase()))
    return !0;
...
var KE = (e) => ft(e.getBoundingClientRect()).center;
function JE(e) {
...
function ec(e, t) {
  return e == null ? null : e[ZE](t) ? e : ec(e.parentElement, t);
}
function QE(e, t) {
...
function iy({
  ...
  if (!tc({
    ...
    return null;
  const u = r.draggable.getById(o), l = ry(t, u.descriptor.id);
  if (!l)
    return process.env.NODE_ENV !== "production" && Ee(`Unable to find draggable element with id: ${o}`), null;
  if (s && !u.options.canDragInteractiveElements && XE(l, s))
    return null;
  ...
  function h(E) {
    ...
    c !== "PRE_DRAG" && (_(), process.env.NODE_ENV !== "production" ? D(!1, `Cannot lift in phase ${c}`) : D(!1)), n.dispatch(Rg(E.liftActionArgs)), c = "DRAGGING";
    function B(P, V = {
      shouldBlockNextClick: !1
    }) {
      if (E.cleanup(), V.shouldBlockNextClick) {
        const N = ut(window, [{
          eventName: "click",
          fn: oy,
          options: {
...
function ay({
  ...
  const i = [...o ? sy : [], ...r || []], s = w.useState(() => CE())[0], a = G(function(h, A) {
    or(h) && !or(A) && s.tryAbandon();
  }, [s]);
  rt(function() {
    let h = t.getState();
    return t.subscribe(() => {
...
function cy(e) {
  ...
  bE();
  const a = ds(e), u = G(() => uy(a.current), [a]), l = G(() => ly(a.current), [a]), d = cE(t), c = mE({
    contextId: t,
    text: i
  }), f = rE(t, o), p = G((N) => {
    Mn(s).dispatch(N);
  }, []), g = ie(() => ia({
    publishWhileDragging: Lg,
    updateDroppableScroll: Vg,
    updateDroppableIsEnabled: $g,
    updateDroppableIsCombineEnabled: jg,
    collectionStarting: kg
  }, p), [p]), m = sE(), h = ie(() => PD(m, g), [m, g]), A = ie(() => JD({
    scrollWindow: RD,
  ...
  }), [h.scrollDroppable, p, l]), C = oE(t), b = ie(() => OD({
    announce: d,
    autoScroller: A,
    dimensionMarshal: h,
    focusMarshal: C,
  ...
  const v = G(() => {
    const N = Mn(s);
    N.getState().phase !== "IDLE" && N.dispatch(ts());
  }, []), E = G(() => {
    const N = Mn(s).getState();
  ...
  n(_);
  const B = G((N) => Gl(Mn(s).getState(), N), []), P = G(() => Yt(Mn(s).getState()), []), V = ie(() => ({
    marshal: h,
    focus: C,
    contextId: t,
    canLift: B,
...
var hy = "useId" in F ? py : fy;
function Zb(e) {
  const t = hy(), n = e.dragHandleUsageInstructions || Br.dragHandleUsageInstructions;
  return F.createElement(A0, null, (r) => F.createElement(cy, {
    nonce: e.nonce,
    contextId: t,
    setCallbacks: r,
...
const Ka = {
  dragging: 5e3,
  dropAnimating: 4500
}, my = (e, t) => t ? zn.drop(t.duration) : e ? zn.snap : zn.fluid, gy = (e, t) => {
  if (e)
    return t ? tr.opacity.drop : tr.opacity.combining;
}, Dy = (e) => e.forceShouldAnimate != null ? e.forceShouldAnimate : e.mode === "SNAP";
function Ey(e) {
  const n = e.dimension.client, {
    offset: r,
    combineWith: o,
    dropping: i
  } = e, s = !!o, a = Dy(e), u = !!i, l = u ? mi.drop(r, s) : mi.moveTo(r);
  return {
    position: "fixed",
    top: n.marginBox.top,
...
function vy(e) {
  return e.type === "DRAGGING" ? Ey(e) : yy(e);
}
function by(e, t, n = Me) {
...
function Cy(e) {
  const t = ls("draggable"), {
    ...
    const g = o();
    return g || (process.env.NODE_ENV !== "production" ? D(!1, "Cannot get dimension when no ref is set") : D(!1)), by(n, g, p);
  }, [n, o]), d = ie(() => ({
    uniqueId: t,
    descriptor: n,
    options: u,
...
const Sy = (e) => {
  const t = w.useRef(null), n = G((_ = null) => {
    t.current = _;
  }, []), r = G(() => t.current, []), {
    contextId: o,
  ...
  const C = ie(() => f ? {
    ...
    h.type === "DRAGGING" && h.dropping && _.propertyName === "transform" && (F.version.startsWith("16") || F.version.startsWith("17") ? A() : wi.flushSync(A));
  }, [A, h]), v = ie(() => {
    const _ = vy(h), B = h.type === "DRAGGING" && h.dropping ? b : void 0;
    return {
      innerRef: n,
      draggableProps: {
...
const xy = (e) => e.combine ? e.combine.draggableId : null, Ny = (e) => e.at && e.at.type === "COMBINE" ? e.at.combine.draggableId : null;
function Oy() {
  const e = Re((o, i) => ({
    x: o,
    y: i
  ...
  return (o, i) => {
    if (or(o)) {
      if (o.critical.draggable.id !== i.draggableId)
        return null;
      const s = o.current.client.offset, a = o.dimensions.draggables[i.draggableId], u = nt(o.impact), l = Ny(o.impact), d = o.forceShouldAnimate;
    ...
    if (o.phase === "DROP_ANIMATING") {
      ...
      if (s.result.draggableId !== i.draggableId)
        return null;
      const a = i.isClone, u = o.dimensions.draggables[i.draggableId], l = s.result, d = l.mode, c = oc(l), f = xy(l), g = {
  ...
  const e = Re((s, a) => ({
    ...
    if (!d) {
      ...
      if (u.displaced.invisible[s])
        return null;
      const h = yn(l.displacedBy.point), A = e(h.x, h.y);
      return n(A, p, !0);
    }
    if (c)
      return r(p);
...
var My = Ry;
function sc(e) {
  return zr(ps).isUsingCloneFor === e.draggableId && !e.isClone ? null : F.createElement(My, e);
}
function Qb(e) {
...
const hs = (e) => (t) => e === t, Ly = hs("scroll"), ky = hs("auto"), Vy = hs("visible"), Ja = (e, t) => t(e.overflowX) || t(e.overflowY), $y = (e, t) => t(e.overflowX) && t(e.overflowY), ac = (e) => {
  const t = window.getComputedStyle(e), n = {
    overflowX: t.overflowX,
    overflowY: t.overflowY
  };
  return Ja(n, Ly) || Ja(n, ky);
}, jy = () => {
  if (process.env.NODE_ENV === "production")
    return !1;
  ...
  return $y(r, Vy) || process.env.NODE_ENV !== "production" && Ee(`
  ...
  `), !1;
}, uc = (e) => e == null ? null : e === document.body ? jy() ? e : null : e === document.documentElement ? null : ac(e) ? e : uc(e.parentElement);
var lc = uc, Gy = (e) => {
...
var Hy = ({
  ...
  const u = n.closestScrollable, l = zy(e, u), d = Gr(l, r), c = (() => {
    if (!u)
      return null;
    const p = ll(u), g = {
...
var Za = (e) => e.shouldPublishImmediately ? qy : Yy;
...
function Xy(e) {
  const t = w.useRef(null), n = zr(oo), r = ls("droppable"), {
    ...
    const _ = s.current, B = _.getDroppableRef();
    B || (process.env.NODE_ENV !== "production" ? D(!1, "Cannot collect without a droppable ref") : D(!1));
    const P = Uy(B), V = {
      ref: B,
      descriptor: a,
      env: P,
    ...
    }), k = P.closestScrollable;
    return k && (k.setAttribute(za.contextId, n.contextId), k.addEventListener("scroll", p, Za(V.scrollOptions)), process.env.NODE_ENV !== "production" && Gy(k)), N;
  }, [n.contextId, a, p, s]), m = G(() => {
    const v = t.current, E = Ar(v);
...
function rv(e) {
  dr(() => {
    Ro(e, ev), e.props.mode === "standard" && Ro(e, tv), e.props.mode === "virtual" && Ro(e, nv);
  });
}
class ov extends F.PureComponent {
  constructor(...t) {
    super(...t), this.state = {
...
const iv = (e) => {
  ...
  } = e, C = G(() => o.current, []), b = G((R = null) => {
    o.current = R;
  }, []), v = G(() => i.current, []), E = G((R = null) => {
    i.current = R;
  }, []);
  rv({
    props: e,
  ...
  const B = ie(() => F.createElement(ov, {
    ...
    contextId: n,
    onTransitionEnd: _
  })), [n, _, e.placeholder, e.shouldAnimatePlaceholder, E]), P = ie(() => ({
    innerRef: b,
    placeholder: B,
    droppableProps: {
  ...
  }), [n, a, B, b]), V = m ? m.dragging.draggableId : null, N = ie(() => ({
    droppableId: a,
    type: u,
    isUsingCloneFor: V
  }), [a, V, u]);
...
const eu = {
  ...
  return t;
}, Mo = (e, t) => e === t.droppable.type, tu = (e, t) => t.draggables[e.draggable.id], uv = () => {
  const e = {
    placeholder: null,
...
var eC = cv;
const dv = (e) => /* @__PURE__ */ w.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512", ...e }, /* @__PURE__ */ w.createElement("path", { d: "M0 117.66v346.32c0 11.32 11.43 19.06 21.94 14.86L160 416V32L20.12 87.95A32.006 32.006 0 000 117.66zM192 416l192 64V96L192 32v384zM554.06 33.16L416 96v384l139.88-55.95A31.996 31.996 0 00576 394.34V48.02c0-11.32-11.43-19.06-21.94-14.86z" })), Kt = (e, t, n, r, o) => {
  if (!r)
    throw new Error(o ?? `Invalid property path: ${t}
Couldn't access "${n}" in ${JSON.stringify(e)}`);
}, nu = (e) => typeof e == "object" && e !== null && !Array.isArray(e), Ir = (e) => Array.isArray(e), fc = (e, t) => e.filter((n, r) => r !== t), fv = (e, t, n, r = {}) => {
  ...
  return Ir(e) && o && c.length === 1 ? fc(e, c[0]) : $n(e, c, n, d);
}, $n = (e, t, n, r) => {
  ...
  if (i && typeof c == "string")
    return i.map((m) => $n(m, t, n, r));
  if (t.length === 1) {
    if (o && typeof c == "string") {
      const m = pv(o, c, n, r);
      return m ?? o;
    }
    return i && typeof c == "number" ? (hv(i, c, n, r), i) : (Kt(l, d, c, u), e);
  }
  const f = o || i || [];
  ...
  if (c in e) {
    ...
    return f[c] = $n(f[c], p, n, r), f;
  }
  var g;
  if (s) {
    const m = typeof p[0] == "number" ? [] : {};
    if (o)
      return f[c] = m, f[c] = $n(f[c], p, n, r), f;
    if (i && Array.isArray(f)) {
      f.push(m);
      const h = f.length - 1;
      return f[h] = $n(f[h], p, n, r), f;
    }
  }
  return Kt(l, d, c, u), f;
}, pv = (e, t, n, r) => {
  ...
  const r = Array.isArray(t) ? t : mv(t);
  if (r.length === 0)
    return e;
  const o = r[0];
...
}, mv = (e) => e.split(/(\.|\[\d+\])/).filter((t) => t !== "." && t !== "").map((t) => {
  const n = /\[(\d+)\]/.exec(t);
...
`:
  ...
  comment() {
    switch (oe) {
      case "*":
        S(), Z = "multiLineComment";
        return;
      case "/":
        S(), Z = "singleLineComment";
        return;
    }
    throw ve(S());
  },
...
`:
  ...
  decimalExponent() {
    switch (oe) {
      case "+":
      case "-":
        X += S(), Z = "decimalExponentSign";
        return;
    }
    if (Se.isDigit(oe)) {
      X += S(), Z = "decimalExponentInteger";
      return;
    }
    throw ve(S());
  },
...
`:
  ...
  beforePropertyName() {
    switch (oe) {
      case "$":
      case "_":
        X = S(), Z = "identifierName";
        return;
      case "\\":
        S(), Z = "identifierNameStartEscape";
        return;
      case "}":
        return ye("punctuator", S());
      case '"':
...
var Sv = function(t, n, r) {
  ...
  function d(m, h) {
    let A = h[m];
    switch (A != null && (typeof A.toJSON5 == "function" ? A = A.toJSON5(m) : typeof A.toJSON == "function" && (A = A.toJSON(m))), a && (A = a.call(h, m, A)), A instanceof Number ? A = Number(A) : A instanceof String ? A = String(A) : A instanceof Boolean && (A = A.valueOf()), A) {
      case null:
        return "null";
      case !0:
        return "true";
    ...
    if (typeof A == "number")
      return String(A);
    if (typeof A == "object")
      return Array.isArray(A) ? g(A) : f(A);
  }
  function c(m) {
    const h = {
      "'": 0.1,
    ...
    for (let v = 0; v < m.length; v++) {
      ...
      if (E < " ") {
        ...
        C += "\\x" + ("00" + _).substring(_.length);
        continue;
      }
      C += E;
    }
    const b = l || Object.keys(h).reduce((v, E) => h[v] < h[E] ? v : E);
    return C = C.replace(new RegExp(b, "g"), A[b]), b + C + b;
  }
  function f(m) {
    if (o.indexOf(m) >= 0)
...
` + h + "}";
  ...
  function p(m) {
    ...
    if (!Se.isIdStartChar(h))
      return c(m);
    for (let A = h.length; A < m.length; A++)
      if (!Se.isIdContinueChar(String.fromCodePoint(m.codePointAt(A))))
        return c(m);
    return m;
  }
  function g(m) {
...
` ? n + "." : n;
  ...
  return Object.entries(r).forEach(([i, s]) => {
    const a = (Array.isArray(s) ? s : [s]).reduce((u, l) => {
      ...
      if (typeof l == "string") {
        ...
        return typeof c == "string" ? Object.assign(Object.assign({}, u), { [Rv[i]]: c }) : Object.assign(Object.assign({}, u), c);
      }
      return Object.assign(Object.assign({}, u), l);
    }, {});
    o[i] = a;
  }), o;
}, Pv = (e) => !("styles" in e), Rv = { container: "backgroundColor", collection: "backgroundColor", collectionInner: "backgroundColor", collectionElement: "backgroundColor", property: "color", bracket: "color", itemCount: "color", string: "color", number: "color", boolean: "color", null: "color", input: "color", inputHighlight: "backgroundColor", error: "color", iconCollection: "color", iconEdit: "color", iconDelete: "color", iconAdd: "color", iconCopy: "color", iconOk: "color", iconCancel: "color" }, Mv = (e, t = 200) => typeof e == "string" ? e.length < t ? e : `${e.slice(0, t - 2).trim()}...` : e, fr = (e) => e.map((t) => t === "" ? String.fromCharCode(0) : t).join("."), Lv = ({ value: e, setValue: t, isEditing: n, path: r, setIsEditing: o, handleEdit: i, handleCancel: s, stringTruncate: a, showStringQuotes: u, nodeData: l }) => {
  ...
  }, className: "jer-value-string", style: d("string", l), children: [f, Mv(e, a), f] });
}, kv = ({ value: e, setValue: t, isEditing: n, path: r, setIsEditing: o, handleEdit: i, handleCancel: s, nodeData: a }) => {
...
}, $v = ({ value: e, isEditing: t, setIsEditing: n, handleEdit: r, handleCancel: o, nodeData: i }) => {
...
}, jv = ({ value: e, translate: t, isEditing: n, handleEdit: r, handleCancel: o, nodeData: i }) => {
...
}, Gv = ({ value: e, isEditing: t, handleEdit: n, handleCancel: r }) => {
...
}, Wv = ({ size: e, style: t, className: n }) => Te("svg", { viewBox: "0 0 24 24", fill: "currentColor", width: e, height: e, className: n, style: t, children: [x("path", { d: "M13 7h-2v4H7v2h4v4h2v-4h4v-2h-4z" }), x("path", { d: "M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z" })] }), zv = ({ size: e, style: t, className: n }) => Te("svg", { viewBox: "0 0 24 24", fill: "currentColor", width: e, height: e, className: n, style: t, transform: "translate(0, 0.5)", children: [x("path", { d: "M7 17.013l4.413-.015 9.632-9.54c.378-.378.586-.88.586-1.414s-.208-1.036-.586-1.414l-1.586-1.586c-.756-.756-2.075-.752-2.825-.003L7 12.583v4.43zM18.045 4.458l1.589 1.583-1.597 1.582-1.586-1.585 1.594-1.58zM9 13.417l6.03-5.973 1.586 1.586-6.029 5.971L9 15.006v-1.589z" }), x("path", { d: "M5 21h14c1.103 0 2-.897 2-2v-8.668l-2 2V19H8.158c-.026 0-.053.01-.079.01-.033 0-.066-.009-.1-.01H5V5h6.847l2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2z" })] }), Hv = ({ size: e, style: t, className: n }) => x("svg", { viewBox: "0 0 24 24", fill: "currentColor", width: e, height: e, className: n, style: t, children: x("path", { d: "M6 19a2 2 0 002 2h8a2 2 0 002-2V7H6v12m2.46-7.12l1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12M15.5 4l-1-1h-5l-1 1H5v2h14V4h-3.5z" }) }), qv = ({ size: e, style: t, className: n }) => Te("svg", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, viewBox: "0 0 24 24", width: e, height: e, className: n, style: t, children: [x("path", { d: "M9 2 H15 A1 1 0 0 1 16 3 V5 A1 1 0 0 1 15 6 H9 A1 1 0 0 1 8 5 V3 A1 1 0 0 1 9 2 z" }), x("path", { d: "M8 4H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2v-2M16 4h2a2 2 0 012 2v4M21 14H11" }), x("path", { d: "M15 10l-4 4 4 4" })] }), Yv = ({ size: e, style: t, className: n }) => Te("svg", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, viewBox: "0 0 24 24", width: e, height: e, className: n, style: t, children: [x("path", { d: "M22 11.08V12a10 10 0 11-5.93-9.14" }), x("path", { d: "M22 4L12 14.01l-3-3" })] }), Xv = ({ size: e, style: t, className: n }) => x("svg", { baseProfile: "tiny", viewBox: "0 0 24 24", fill: "currentColor", width: e, height: e, className: n, style: t, children: x("path", { d: "M12 4c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm-5 8c0-.832.224-1.604.584-2.295l6.711 6.711A4.943 4.943 0 0112 17c-2.757 0-5-2.243-5-5zm9.416 2.295L9.705 7.584A4.943 4.943 0 0112 7c2.757 0 5 2.243 5 5 0 .832-.224 1.604-.584 2.295z" }) }), Kv = ({ size: e, style: t, className: n }) => x("svg", { viewBox: "0 0 512 512", fill: "currentColor", width: e, height: e, className: n, style: t, children: x("path", { d: "M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" }) }), Jt = ({ name: e, nodeData: t, rotate: n }) => {
  var r, o, i, s, a, u, l;
  const { getStyles: d, icons: c } = Nt(), f = { size: "1.4em", className: "jer-icon" };
  switch (e) {
    case "add":
      return (r = c == null ? void 0 : c.add) !== null && r !== void 0 ? r : x(Wv, Object.assign({}, f, { style: d("iconAdd", t) }));
    case "edit":
      return (o = c == null ? void 0 : c.edit) !== null && o !== void 0 ? o : x(zv, Object.assign({}, f, { style: d("iconEdit", t) }));
    case "delete":
      return (i = c == null ? void 0 : c.delete) !== null && i !== void 0 ? i : x(Hv, Object.assign({}, f, { style: d("iconDelete", t), size: "1.45em" }));
    case "copy":
      return (s = c == null ? void 0 : c.copy) !== null && s !== void 0 ? s : x(qv, Object.assign({}, f, { style: d("iconCopy", t), size: "1.2em" }));
    case "ok":
      return (a = c == null ? void 0 : c.ok) !== null && a !== void 0 ? a : x(Yv, Object.assign({}, f, { style: Object.assign({ fontSize: "90%" }, d("iconOk", t)) }));
    case "cancel":
      return (u = c == null ? void 0 : c.cancel) !== null && u !== void 0 ? u : x(Xv, Object.assign({}, f, { style: Object.assign({ fontSize: "130%" }, d("iconCancel", t)) }));
    case "chevron":
      return (l = c == null ? void 0 : c.chevron) !== null && l !== void 0 ? l : x(Kv, { className: "jer-accordion-icon" + (n ? " jer-rotate-90" : ""), size: "1em", style: d("iconCollection", t) });
    default:
      return x(_i, {});
  }
  ...
  return w.useEffect(() => {
    ...
    let A, C = "value", b = "";
    r && ((h.ctrlKey || h.metaKey) === !0 ? (A = Jv(g), b = A, C = "path") : (A = m, b = o ? JSON.stringify(m, null, 2) : String(A)), navigator.clipboard.writeText(b)), typeof r == "function" && r({ value: A, stringValue: b, path: g, key: p, type: C });
...
}, gs = ({ onOk: e, onCancel: t, nodeData: n }) => Te("div", { className: "jer-confirm-buttons", children: [x("div", { onClick: e, children: x(Jt, { name: "ok", nodeData: n }) }), x("div", { onClick: t, children: x(Jt, { name: "cancel", nodeData: n }) })] }), Jv = (e) => e.reduce((t, n) => typeof n == "number" ? `${t}[${n}]` : t === "" ? n : `${t}.${n}`, ""), Zv = ["string", "number", "boolean", "null", "object", "array"], vc = (e = [], t) => {
...
}, areChildrenBeingEdited: () => !1 }), Qv = ({ children: e }) => {
  ...
  const { data: t, parentData: n, nodeData: r, onEdit: o, onDelete: i, onChange: s, onError: a, showErrorMessages: u, enableClipboard: l, restrictEditFilter: d, restrictDeleteFilter: c, restrictTypeSelection: f, searchFilter: p, searchText: g, showLabel: m, stringTruncate: h, showStringQuotes: A, indent: C, translate: b, customNodeDefinitions: v } = e, { getStyles: E } = Nt(), { currentlyEditingElement: _, setCurrentlyEditingElement: B, setCollapseState: P } = Ds(), [V, N] = w.useState(typeof t == "function" ? "**INVALID_FUNCTION**" : t), [k, R] = w.useState(null), { key: I, path: z } = r, q = vc(v, r), [Q, ee] = w.useState(Sr(t, q)), K = fr(z), se = w.useCallback((j) => {
    if (!s)
      return void N(j);
    const ue = s({ currentData: r.fullData, newValue: j, currentValue: V, name: I, path: z });
    N(ue);
  }, [s]);
  w.useEffect(() => {
    N(typeof t == "function" ? "**INVALID_FUNCTION**" : t), ee(Sr(t, q));
  }, [t, k]);
  const H = w.useMemo(() => !d(r), [r]), ce = w.useMemo(() => !c(r), [r]), J = w.useMemo(() => (j, ue) => {
    var Ce;
    Ce = j.message, u && (R(Ce), setTimeout(() => R(null), 2500)), console.warn("Error", Ce), a && a({ currentData: r.fullData, errorValue: ue, currentValue: V, name: I, path: z, error: j });
  }, [a, u]), { CustomNode: ge, customNodeProps: L, hideKey: te, showEditTools: be = !0, showOnEdit: je, showOnView: le } = q, de = [...Zv, ...v.filter(({ showInTypesSelector: j = !1, name: ue }) => j && !!ue).map(({ name: j }) => j)], Ae = w.useMemo(() => {
    if (typeof f == "boolean")
      return f ? [] : de;
    if (Array.isArray(f))
      return f;
    const j = f(r);
    return typeof j == "boolean" ? j ? [] : de : j;
  }, [r, f]);
  if (!bc("value", r, p, g))
    return null;
  const we = () => {
    ...
    o(j, z).then((ue) => {
      ue && J({ code: "UPDATE_ERROR", message: ue }, j);
    });
  }, T = () => {
    B(null), N(t), ee(Sr(t, q));
  }, ae = _ === K, M = _ === `key_${K}`, Le = typeof z.slice(-1)[0] != "number" && H && ce, Fe = !ae && k, Oe = ae && Ae.length > 0, _e = Q !== "invalid" && !k && be, ze = m && M, Ge = m && !M && !te, st = { value: V, parentData: n, setValue: se, isEditing: ae, setIsEditing: H ? () => B(K) : () => {
  }, handleEdit: we, handleCancel: T, path: z, stringTruncate: h, showStringQuotes: A, nodeData: r, translate: b }, Ze = ge && (ae && je || !ae && le) ? x(ge, Object.assign({}, e, { value: V, customNodeProps: L, setValue: se, handleEdit: we, handleCancel: T, handleKeyPress: (j) => {
    j.key === "Enter" ? we() : j.key === "Escape" && T();
  }, isEditing: ae, setIsEditing: () => B(K), getStyles: E })) : eb(Sr(t), st);
  return x("div", { className: "jer-component jer-value-component", style: { marginLeft: C / 2 + "em" }, children: Te("div", { className: "jer-value-main-row", style: { flexWrap: I.length > 10 ? "wrap" : "nowrap" }, children: [Ge && Te("span", { className: "jer-key-text", style: Object.assign(Object.assign({}, E("property", r)), { minWidth: `${Math.min(String(I).length + 1, 5)}ch`, flexShrink: I.length > 10 ? 1 : 0 }), onDoubleClick: () => Le && B(`key_${K}`), children: [I === "" ? x("span", { className: "jer-empty-string" }) : I, ":"] }), ze && x("input", { className: "jer-input-text jer-key-edit", type: "text", name: K, defaultValue: I, autoFocus: !0, onFocus: (j) => j.target.select(), onKeyDown: (j) => {
    j.key === "Enter" ? ((ue) => {
      if (B(null), I === ue || !n)
        return;
      const Ce = z.slice(0, -1);
      if (Object.keys(n).includes(ue))
        return void J({ code: "KEY_EXISTS", message: b("ERROR_KEY_EXISTS", r) }, ue);
      const Ue = Object.fromEntries(Object.entries(n).map(([yt, kt]) => yt === I ? [ue, kt] : [yt, kt]));
      o(Ue, Ce);
    })(j.target.value) : j.key === "Escape" && T();
  }, style: { width: String(I).length / 1.5 + 0.5 + "em" } }), Te("div", { className: "jer-value-and-buttons", children: [x("div", { className: "jer-input-component", children: Ze }), ae ? x(gs, { onOk: we, onCancel: T, nodeData: r }) : _e && x(yc, { startEdit: H ? () => B(K) : void 0, handleDelete: ce ? () => {
    i(V, z).then((j) => {
      j && J({ code: "DELETE_ERROR", message: j }, V);
    });
  } : void 0, enableClipboard: l, translate: b, nodeData: r }), Oe && Te("div", { className: "jer-select", children: [x("select", { name: `${I}-type-select`, className: "jer-type-select", onChange: (j) => ((ue) => {
    const Ce = v.find((Ue) => Ue.name === ue);
    if (Ce)
      o(Ce.defaultValue, z), ee(ue);
    else {
      const Ue = tb(V, ue, b("DEFAULT_NEW_KEY", r), q != null && q.CustomNode ? b("DEFAULT_STRING", r) : void 0);
      se(Ue), o(Ue, z), P({ path: z, collapsed: !1 }), ee(ue);
    }
  })(j.target.value), value: Q, children: Ae.map((j) => x("option", { value: j, children: j }, j)) }), x("span", { className: "focus" })] }), Fe && x("span", { className: "jer-error-slug", style: E("error", r), children: k })] })] }) });
}, Sr = (e, t) => t != null && t.CustomNode && (t != null && t.name) && t.showInTypesSelector ? t.name : typeof e == "string" ? "string" : typeof e == "number" ? "number" : typeof e == "boolean" ? "boolean" : e === null ? "null" : "invalid", eb = (e, t) => {
  const n = t.value;
  switch (e) {
    case "string":
      return x(Lv, Object.assign({}, t, { value: n }));
    case "number":
      return x(kv, Object.assign({}, t, { value: n }));
    case "boolean":
      return x(Vv, Object.assign({}, t, { value: n }));
    case "null":
      return x($v, Object.assign({}, t));
    case "object":
      return x(jv, Object.assign({}, t, { value: n }));
    case "array":
      return x(Gv, Object.assign({}, t));
    default:
  ...
  const { getStyles: s } = Nt(), { collapseState: a, setCollapseState: u, doesPathMatch: l, currentlyEditingElement: d, setCurrentlyEditingElement: c, areChildrenBeingEdited: f } = Ds(), { onEdit: p, onAdd: g, onDelete: m, onError: h, showErrorMessages: A, restrictEditFilter: C, restrictDeleteFilter: b, restrictAddFilter: v, collapseFilter: E, enableClipboard: _, searchFilter: B, searchText: P, indent: V, keySort: N, showArrayIndices: k, defaultValue: R, translate: I, customNodeDefinitions: z, useJSON5Editor: q } = i, Q = w.useMemo(() => q ? q instanceof Object ? (W) => Vo.stringify(W, q) : (W) => Vo.stringify(W, { space: 2 }) : (W) => JSON.stringify(W, null, 2), [q]), [ee, K] = w.useState(Q(t)), [se, H] = w.useState(null), ce = E(n), [J, ge] = w.useState(ce), L = Object.assign(Object.assign({}, n), { collapsed: J }), { path: te, key: be, size: je } = L, le = fr(te), de = w.useRef(!ce), [Ae, we] = w.useState(!1);
  w.useEffect(() => {
    K(Q(t));
  }, [t]), w.useEffect(() => {
    const W = E(L);
  ...
  const T = w.useMemo(() => !C(L), [L]), ae = w.useMemo(() => !b(L), [L]), M = w.useMemo(() => !v(L), [L]), Le = w.useMemo(() => (W) => typeof R != "function" ? R : R(W), [R]), { CustomNode: Fe, customNodeProps: Oe, CustomWrapper: _e, wrapperProps: ze = {}, hideKey: Ge, showEditTools: st = !0, showOnEdit: Ze, showOnView: j, showCollectionWrapper: ue = !0 } = w.useMemo(() => vc(z, L), []), Ce = w.useMemo(() => (W, ne) => {
    var Ie;
    Ie = W.message, A && (H(Ie), setTimeout(() => H(null), 2500)), console.warn("Error", Ie), h && h({ currentData: L.fullData, errorValue: ne, currentValue: t, name: be, path: te, error: W });
  }, [h, A]);
  if (!bc("collection", L, B, P) && L.level > 0)
    return null;
  const Ue = Array.isArray(t) ? "array" : "object", yt = Ue === "array" ? { open: "[", close: "]" } : { open: "{", close: "}" }, kt = getComputedStyle(document.documentElement).getPropertyValue("--jer-expand-transition-time"), rn = (W) => {
    W.key === "Enter" && (W.metaKey || W.shiftKey || W.ctrlKey) ? on() : W.key === "Escape" && vt();
  }, on = () => {
    try {
      const W = Vo.parse(ee);
      if (c(null), H(null), JSON.stringify(W) === JSON.stringify(t))
        return;
      p(W, te).then((ne) => {
        ne && Ce({ code: "UPDATE_ERROR", message: ne }, W);
      });
    } catch {
      Ce({ code: "INVALID_JSON", message: I("ERROR_INVALID_JSON", L) }, ee);
    }
  }, sn = te.length > 0 ? () => {
    m(t, te).then((W) => {
      W && Ce({ code: "DELETE_ERROR", message: W }, Hr(t, te));
    });
  } : void 0, vt = () => {
    c(null), H(null), K(Q(t));
  }, xe = d === le, Ot = d === `key_${le}`, an = typeof te.slice(-1)[0] == "number", bn = r !== null && T && M && ae && !an, pr = o === "when-closed" ? J : o, Vt = !xe && st, so = (k || !an) && !Ge && be !== void 0, ao = Fe && (xe && Ze || !xe && j), Ne = N && Ue === "object", bt = Object.entries(t).map(([W, ne]) => [Ue === "array" ? Number(W) : W, ne]);
  Ne && bt.sort(typeof N == "function" ? (W, ne) => N(W[0], ne[0]) : void 0);
  const uo = JSON.stringify(t, null, 2).replace(/\\n/g, `
`).split(`
`).length, Cn = de.current ? xe ? x("div", { className: "jer-collection-text-edit", children: Te("div", { children: [x(gc, { className: "jer-collection-text-area", name: le, value: ee, setValue: K, isEditing: xe, handleKeyPress: rn, styles: s("input", L) }), x("div", { className: "jer-collection-input-button-row", children: x(gs, { onOk: on, onCancel: vt, nodeData: L }) })] }) }) : bt.map(([W, ne], Ie) => {
    const Bt = { key: W, value: ne, path: [...te, W], level: te.length + 1, index: Ie, size: Xr(ne) ? Object.keys(ne).length : 1, parentData: t, fullData: L.fullData };
    return x("div", { className: "jer-collection-element", style: s("collectionElement", Bt), children: Xr(ne) ? x(wc, Object.assign({ data: ne, parentData: t, nodeData: Bt, showCollectionCount: o }, i), W) : x(Ac, Object.assign({ data: ne, parentData: t, nodeData: Bt }, i, { showLabel: Ue === "object" || k }), W) }, W);
  }) : null, Tt = !!ue && J;
  Tt || (de.current = !0);
  const An = Object.assign(Object.assign({}, i), { data: t, value: t, parentData: r, nodeData: L, setValue: (W) => Pr(void 0, void 0, void 0, function* () {
    return yield p(W, te);
  }), handleEdit: on, handleCancel: vt, handleKeyPress: rn, isEditing: xe, setIsEditing: () => c(le), getStyles: s }), hr = ao ? x(Fe, Object.assign({ customNodeProps: Oe }, An, { children: Cn })) : Cn, mr = Ot ? x("input", { className: "jer-input-text jer-key-edit", type: "text", name: le, defaultValue: be, autoFocus: !0, onFocus: (W) => W.target.select(), onKeyDown: (W) => {
    W.key === "Enter" ? ((ne) => {
      if (c(null), be === ne || !r)
        return;
      const Ie = te.slice(0, -1);
      if (Object.keys(r).includes(ne))
        return void Ce({ code: "KEY_EXISTS", message: I("ERROR_KEY_EXISTS", L) }, ne);
      const Bt = Object.fromEntries(Object.entries(r).map(([Sn, Fn]) => Sn === be ? [ne, Fn] : [Sn, Fn]));
      p(Bt, Ie);
    })(W.target.value) : W.key === "Escape" && vt();
  }, style: { width: String(be).length / 1.5 + 0.5 + "em" } }) : so && x("span", { className: "jer-key-text", style: s("property", L), onDoubleClick: () => bn && c(`key_${le}`), children: be === "" ? x("span", { className: te.length > 0 ? "jer-empty-string" : void 0 }) : `${be}:` }), wn = Vt && x(yc, { startEdit: T ? () => {
    de.current = !0, c(le), ge(!1);
  } : void 0, handleAdd: M ? (W) => {
    ge(!1);
    const ne = Le(L);
    Ue === "array" ? g(ne, [...te, t.length]).then((Ie) => {
      Ie && Ce({ code: "ADD_ERROR", message: Ie }, ne);
    }) : W in t ? Ce({ code: "KEY_EXISTS", message: I("ERROR_KEY_EXISTS", L) }, W) : g(ne, [...te, W]).then((Ie) => {
      Ie && Ce({ code: "ADD_ERROR", message: Ie }, ne);
    });
  } : void 0, handleDelete: ae ? sn : void 0, enableClipboard: _, type: Ue, nodeData: L, translate: I }), _n = Te("div", { className: "jer-component jer-collection-component", style: Object.assign({ marginLeft: (te.length === 0 ? 0 : V / 2) + "em" }, s("collection", L)), children: [ue ? Te("div", { className: "jer-collection-header-row", style: { position: "relative" }, children: [Te("div", { className: "jer-collection-name", children: [x("div", { className: "jer-collapse-icon", onClick: (W) => ((ne) => {
    if (ne.getModifierState("Alt"))
      return de.current = !0, void u({ collapsed: !J, path: te });
    d && d.includes(le) || (we(!0), de.current = !0, ge(!J), setTimeout(() => we(!1), 500));
  })(W), children: x(Jt, { name: "chevron", rotate: J, nodeData: L }) }), mr, !xe && x("span", { className: "jer-brackets jer-bracket-open", style: s("bracket", L), children: yt.open })] }), !xe && pr && x("div", { className: "jer-collection-item-count" + (pr ? " jer-visible" : " jer-hidden"), style: s("itemCount", L), children: je === 1 ? I("ITEM_SINGLE", Object.assign(Object.assign({}, L), { size: 1 }), 1) : I("ITEMS_MULTIPLE", L, je) }), x("div", { className: "jer-brackets" + (Tt ? " jer-visible" : " jer-hidden"), style: s("bracket", L), children: yt.close }), wn] }) : Ge ? x(_i, {}) : Te("div", { className: "jer-collection-header-row", style: { position: "relative" }, children: [mr, wn] }), Te("div", { className: "jer-collection-inner", style: Object.assign({ maxHeight: Tt ? 0 : f(le) ? void 0 : 3 * uo + "em", overflowY: Tt || Ae ? "hidden" : "visible", transition: `max-height ${kt}` }, s("collectionInner", L)), children: [hr, x("div", { className: xe ? "jer-collection-error-row" : "jer-collection-error-row-edit", children: se && x("span", { className: "jer-error-slug", style: s("error", L), children: se }) }), !xe && ue && x("div", { className: "jer-brackets jer-bracket-outside", style: s("bracket", L), children: yt.close })] })] });
  return _e ? x(_e, Object.assign({ customNodeProps: ze }, An, { children: _n })) : _n;
}, nb = { ITEM_SINGLE: "{{count}} item", ITEMS_MULTIPLE: "{{count}} items", KEY_NEW: "Enter new key", ERROR_KEY_EXISTS: "Key already exists", ERROR_INVALID_JSON: "Invalid JSON", ERROR_UPDATE: "Update unsuccessful", ERROR_DELETE: "Delete unsuccessful", ERROR_ADD: "Adding node unsuccessful", DEFAULT_STRING: "New data!", DEFAULT_NEW_KEY: "key" }, rb = (e, t) => (n, r, o) => ((i, s, a, u, l) => {
  if (s[u]) {
    const c = s[u](a);
    if (c !== null)
      return c;
  }
  const d = u in i ? i[u] : nb[u];
  return l === void 0 ? d : d == null ? void 0 : d.replace("{{count}}", String(l));
})(e, t, r, n, o), ob = ({ data: e, rootName: t = "root", onUpdate: n = () => {
}, onEdit: r = n, onDelete: o = n, onAdd: i = n, onChange: s, onError: a, showErrorMessages: u = !0, enableClipboard: l = !0, theme: d = "default", icons: c, indent: f = 3, collapse: p = !1, showCollectionCount: g = !0, restrictEdit: m = !1, restrictDelete: h = !1, restrictAdd: A = !1, restrictTypeSelection: C = !1, searchFilter: b, searchText: v, searchDebounceTime: E = 350, keySort: _ = !1, showArrayIndices: B = !0, showStringQuotes: P = !0, defaultValue: V = null, minWidth: N = 250, maxWidth: k = "min(600px, 90vw)", rootFontSize: R, stringTruncate: I = 250, translations: z = {}, className: q, id: Q, customText: ee = {}, customNodeDefinitions: K = [], useJSON5Editor: se = !1 }) => {
  const { getStyles: H, setTheme: ce, setIcons: J } = Nt(), { setCollapseState: ge } = Ds(), L = w.useCallback(Fr(p), [p]), te = w.useCallback(rb(z, ee), [z, ee]), [be, je] = w.useState(v), [le, de] = w.useState(e);
  w.useEffect(() => {
    d && ce(d), c && J(c);
  }, [d, c]), w.useEffect(() => {
    ge(null), de(e);
  ...
  const Ae = { key: t, path: [], level: 0, index: 0, value: le, size: Object.keys(le).length, parentData: null, fullData: le }, we = Fr(m), T = Fr(h), ae = Fr(A), M = sb(b), Le = { name: t, nodeData: Ae, onEdit: (Oe, _e) => Pr(void 0, void 0, void 0, function* () {
    const { currentData: ze, newData: Ge, currentValue: st, newValue: Ze } = $o(le, _e, Oe, "update");
    if (st === Ze)
      return;
    de(Ge);
    const j = yield r({ currentData: ze, newData: Ge, currentValue: st, newValue: Ze, name: _e.slice(-1)[0], path: _e });
    return j !== void 0 ? (de(ze), j === !1 ? te("ERROR_UPDATE", Ae) : j) : void 0;
  }), onDelete: (Oe, _e) => Pr(void 0, void 0, void 0, function* () {
    const { currentData: ze, newData: Ge, currentValue: st, newValue: Ze } = $o(le, _e, Oe, "delete");
    de(Ge);
    const j = yield o({ currentData: ze, newData: Ge, currentValue: st, newValue: Ze, name: _e.slice(-1)[0], path: _e });
    if (j !== void 0)
      return de(ze), j === !1 ? te("ERROR_UPDATE", Ae) : j;
  }), onAdd: (Oe, _e) => Pr(void 0, void 0, void 0, function* () {
    const { currentData: ze, newData: Ge, currentValue: st, newValue: Ze } = $o(le, _e, Oe, "add");
    de(Ge);
    const j = yield i({ currentData: ze, newData: Ge, currentValue: st, newValue: Ze, name: _e.slice(-1)[0], path: _e });
    if (j !== void 0)
      return de(ze), j === !1 ? te("ERROR_UPDATE", Ae) : j;
  }), onChange: s, onError: a, showErrorMessages: u, showCollectionCount: g, collapseFilter: L, restrictEditFilter: we, restrictDeleteFilter: T, restrictAddFilter: ae, restrictTypeSelection: C, searchFilter: M, searchText: be, enableClipboard: l, keySort: _, showArrayIndices: B, showStringQuotes: P, indent: f, defaultValue: V, stringTruncate: I, translate: te, customNodeDefinitions: K, parentData: null, useJSON5Editor: se }, Fe = Object.assign(Object.assign({}, H("container", Ae)), { minWidth: N, maxWidth: k });
  return Fe.fontSize = R ?? Fe.fontSize, x("div", { id: Q, className: "jer-editor-container " + q, style: Fe, children: Xr(le) ? x(wc, Object.assign({ data: le }, Le)) : x(Ac, Object.assign({ data: le, showLabel: !0 }, Le)) });
}, ib = (e) => x(Bv, { children: x(Qv, { children: x(ob, Object.assign({}, e)) }) }), $o = (e, t, n, r) => {
  if (t.length === 0)
    return { currentData: e, newData: n, currentValue: e, newValue: n };
  const o = r !== "add" ? Hr(e, t) : void 0;
  return { currentData: e, newData: fv(xv(e), t, n, { remove: r === "delete" }), currentValue: o, newValue: r !== "delete" ? n : void 0 };
}, Fr = (e) => typeof e == "boolean" ? () => e : typeof e == "number" ? ({ level: t }) => t >= e : e, sb = (e) => {
  if (e !== void 0)
  ...
  }), delete t.dashboard, delete t.rows, delete t.visualizations, delete t.label, delete t.activeDashboard), au(t), uu(t), su(t), ab(t)) : (delete t.runtime, delete t.formattedData, t.dataUrl && delete t.data), t;
};
const tC = ({ loadConfig: e, config: t, convertStateToConfig: n, onExpandCollapse: r = () => {
  ...
  const c = {
    ...
    map: ["Maps", "https://www.cdc.gov/wcms/4.0/cdc-wp/data-presentation/data-map.html", /* @__PURE__ */ F.createElement(dv, null)],
    "markup-include": [
      "Markup Include",
  ...
  return /* @__PURE__ */ F.createElement("div", { className: "input-group" }, e && /* @__PURE__ */ F.createElement("label", null, e), /* @__PURE__ */ F.createElement("div", { className: "cove-input__slider" + (n === "small" ? "--small" : n === "large" ? "--large" : "") + A() + (g ? " active" : ""), onClick: C }, /* @__PURE__ */ F.createElement("div", { className: "cove-input__slider-button" }), /* @__PURE__ */ F.createElement("div", { className: "cove-input__slider-track", style: g && r ? { backgroundColor: r } : null }), /* @__PURE__ */ F.createElement("input", { className: "cove-input--hidden", type: "checkbox", name: h(), checked: g || !1, readOnly: !0 })));
};
lb.propTypes = {
  /** Add label to the input field */
  label: Y.string,
  /** Select the preferred display style of the slider */
  sliderType: Y.oneOf(["flat", "block", "pill", "3d"]),
