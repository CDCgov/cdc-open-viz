import { f as cn, g as L, j as W, i as Y, k as ln } from "./storybook-string-CipJGmzE.es.js";
import { P as M } from "./storybook-index-Dm4aM_I4.es.js";
import { R as mn } from "./storybook-index-9_ikpx_Z.es.js";
import { g as hn } from "./storybook-_commonjsHelpers-BkfeUUK-.es.js";
function $(n, t) {
...
tn(pn).center;
const wn = Math.sqrt(50), Nn = Math.sqrt(10), vn = Math.sqrt(2);
function E(n, t, e) {
  const r = (t - n) / Math.max(0, e), i = Math.floor(Math.log10(r)), o = r / Math.pow(10, i), a = o >= wn ? 10 : o >= Nn ? 5 : o >= vn ? 2 : 1;
  let f, s, u;
...
function xn(n, t, e) {
  ...
  if (r)
    if (a < 0) for (let u = 0; u < f; ++u) s[u] = (o - u) / -a;
    else for (let u = 0; u < f; ++u) s[u] = (o - u) * a;
  else if (a < 0) for (let u = 0; u < f; ++u) s[u] = (i + u) / -a;
  else for (let u = 0; u < f; ++u) s[u] = (i + u) * a;
  return s;
}
function G(n, t, e) {
...
function C(n, t) {
  var e = typeof t, r;
  return t == null || e === "boolean" ? cn(t) : (e === "number" ? L : e === "string" ? (r = W(t)) ? (t = r, Y) : ln : t instanceof W ? Y : t instanceof Date ? Pn : Sn(t) ? An : Array.isArray(t) ? jn : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? Rn : L)(n, t);
}
function On(n, t) {
...
function Ln() {
  ...
  function h() {
    ...
    return a !== b && (a = En(n[0], n[m - 1])), f = m > 2 ? Tn : Fn, s = u = null, c;
  }
  function c(m) {
  ...
  return c.invert = function(m) {
    ...
    return arguments.length ? (n = Array.from(m, $n), h()) : n.slice();
  }, c.range = function(m) {
    return arguments.length ? (t = Array.from(m), h()) : t.slice();
  }, c.rangeRound = function(m) {
    return t = Array.from(m), e = On, h();
  }, c.clamp = function(m) {
...
var Vn = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function T(n) {
  if (!(t = Vn.exec(n))) throw new Error("invalid format: " + n);
  var t;
  return new V({
    fill: t[1],
    align: t[2],
...
function Kn(n) {
  var t = n.grouping === void 0 || n.thousands === void 0 ? Q : qn(_.call(n.grouping, Number), n.thousands + ""), e = n.currency === void 0 ? "" : n.currency[0] + "", r = n.currency === void 0 ? "" : n.currency[1] + "", i = n.decimal === void 0 ? "." : n.decimal + "", o = n.numerals === void 0 ? Q : Cn(_.call(n.numerals, String)), a = n.percent === void 0 ? "%" : n.percent + "", f = n.minus === void 0 ? "−" : n.minus + "", s = n.nan === void 0 ? "NaN" : n.nan + "";
  function u(c) {
    c = T(c);
    ...
    function K(l) {
      ...
      if (d === "c")
        ...
        l = +l;
        var R = l < 0 || 1 / l < 0;
        if (l = isNaN(l) ? s : X(Math.abs(l), N), B && (l = Bn(l)), R && +l == 0 && p !== "+" && (R = !1), v = (R ? p === "(" ? p : f : p === "-" || p === "(" ? "" : p) + v, g = (d === "s" ? nn[8 + rn / 3] : "") + g + (R && p === "(" ? ")" : ""), sn) {
...
function Un(n) {
  return z = Kn(n), en = z.format, on = z.formatPrefix, z;
}
function Wn(n) {
...
function Hn(n, t, e, r) {
  ...
  switch (r = T(r ?? ",f"), r.type) {
    case "s": {
      ...
      return r.precision == null && !isNaN(o = Yn(i, a)) && (r.precision = o), on(r, a);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      r.precision == null && !isNaN(o = Zn(i, Math.max(Math.abs(n), Math.abs(t)))) && (r.precision = o - (r.type === "e"));
      break;
    }
    case "f":
    case "%": {
      r.precision == null && !isNaN(o = Wn(i)) && (r.precision = o - (r.type === "%") * 2);
      break;
    }
  }
  return en(r);
...
var _n = an.exports;
const nt = /* @__PURE__ */ hn(_n);
var tt = ["top", "left", "transform", "className", "children", "innerRef"];
function q() {
...
function et(n) {
  var t = n.top, e = t === void 0 ? 0 : t, r = n.left, i = r === void 0 ? 0 : r, o = n.transform, a = n.className, f = n.children, s = n.innerRef, u = rt(n, tt);
  return /* @__PURE__ */ mn.createElement("g", q({
    ref: s,
    className: nt("visx-group", a),
